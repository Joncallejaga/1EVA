...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Return the number of fields in result set<br>&nbsp; $fieldcount=mysqli_num_fields($result);<br>&nbsp; printf(&quot;Result set has %d fields.\n&quot;,$fieldcount);<br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>&nbsp; }<br>
