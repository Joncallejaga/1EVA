...
<tr>
  <th>Changelog:</th>
  <td>The <em>raw</em> parameter was added in PHP 5.0<br><br>As of PHP 5.1, it is possible to use md5_file() with wrappers, e.g. <strong>
 md5_file(&quot;https://w3schools.com/..&quot;)</strong></td>
</tr>
</table>
