...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strip_tags">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>allow</em></td>
    <td>Optional. Specifies allowable tags. These tags will not be removed</td>
  </tr>
  </table>
...
<tr>
  <th>Changelog:</th>
  <td>As of PHP 5.0, this function is binary-safe<br>As of PHP 4.3, HTML comments are always stripped</td>
</tr>
</table>
<hr>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strip_tags2">Run example &raquo;</a>
</div>
<hr>
