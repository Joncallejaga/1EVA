...
&nbsp;&nbsp;}<br><br>// Table Persons already exists, so we should get an error<br>
 $sql=&quot;CREATE TABLE Persons (Firstname VARCHAR(30),Lastname VARCHAR(30),Age INT)&quot;<br>if (!mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; echo &quot;SQLSTATE error: &quot;. mysqli_sqlstate($con);<br>&nbsp; }<br>
...
<tr>
 ...
 <td style="width:80%">Returns a string that contains the SQLSTATE error code for the last error</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
