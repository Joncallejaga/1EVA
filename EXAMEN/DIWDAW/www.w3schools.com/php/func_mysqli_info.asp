...
&nbsp;&nbsp;}<br><br>// Perform queries<br>$sql1=&quot;CREATE TABLE testPersons LIKE Persons&quot;<br>mysqli_query($con,$sql1);<br>$sql2=&quot;INSERT INTO testPersons SELECT * FROM Persons ORDER BY LastName LIMIT 10&quot;<br>
mysqli_query($con,$sql2);<br><br>// Print info about most recently executed query<br>echo mysqli_info($con); <br>
...
<tr>
 ...
 <td style="width:80%">Returns a string that contains additional info about the most recently executed query</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
