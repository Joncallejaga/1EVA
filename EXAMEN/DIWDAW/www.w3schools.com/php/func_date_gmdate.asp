...
&lt;?php<br>
 // Prints the day<br>echo gmdate(&quot;l&quot;) . &quot;&lt;br&gt;&quot;;<br><br>// Prints the day, date, month, year, time, AM or PM<br>echo gmdate(&quot;l jS \of F Y h:i:s A&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_gmdate">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns a formatted date string on success. FALSE on failure + an E_WARNING</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>PHP 5.1.0: Valid range of timestamp is now from Fri, 13 Dec 1901 20:45:54 GMT to Tue, 19 Jan 2038 03:14:07 GMT. Before version 5.1.0 timestamp was limited from 01-01-1970 to 19-01-2038 on some systems (e.g. Windows).<br>PHP 5.1.1: Added constants of standard date/time formats that can be used to specify the format parameter</td>
</tr>
</table>
<hr>
