...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_explode">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    <li>Greater than 0 - Returns an array with a maximum of <em>limit</em>  element(s)</li>
    <li>Less than 0 - Returns an array except for the last <em>-limit</em>  elements()</li>
...
<div class="w3-code notranslate">
 ...
 <br>// positive limit<br>print_r(explode(',',$str,2));<br><br>// negative limit <br>print_r(explode(',',$str,-1));<br>?&gt; 
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_explode2">Run example &raquo;</a>
</div>
<hr>
