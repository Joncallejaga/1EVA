...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br><br>&nbsp; // Get field info for all fields<br>&nbsp; while ($fieldinfo=mysqli_fetch_field($result))<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; // Get field cursor position<br>&nbsp;&nbsp;&nbsp; $currentfield=mysqli_field_tell($result);<br>&nbsp;&nbsp;&nbsp; <br>&nbsp;&nbsp;&nbsp; printf(&quot;Column %d:\n&quot;, $currentfield);<br>&nbsp;&nbsp;&nbsp; printf(&quot;Name: %s\n&quot;, $fieldinfo-&gt;name);<br>&nbsp;&nbsp;&nbsp; printf(&quot;Table: %s\n&quot;, $fieldinfo-&gt;table);<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>&nbsp; }<br>
