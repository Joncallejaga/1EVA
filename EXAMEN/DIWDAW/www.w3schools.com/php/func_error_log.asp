...
<p><a href="php_ref_error.asp" class="w3-btn w3-white w3-border" title="PHP Error"> PHP Error Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Send error messages to the web server's error log and to a mail account:</p>
<div class="w3-code notranslate">
&lt;?php<br>
 // Send error message to the server log if error connecting to the database<br>if (!mysqli_connect(&quot;localhost&quot;,&quot;bad_user&quot;,&quot;bad_password&quot;,&quot;my_db&quot;)) {<br>&nbsp;&nbsp;&nbsp; error_log(&quot;Failed to connect to database!&quot;, 0);<br>}<br><br>// Send email to administrator if we run out of FOO<br>if (!($foo = allocate_new_foo())) {<br>&nbsp;&nbsp;&nbsp; error_log(&quot;Oh no! We are out of FOOs!&quot;, 1, &quot;admin@example.com&quot;);<br>}<br>?&gt;
</div>
<br>
</div>
<hr>
...
<table class="w3-table-all notranslate">
 ...
 Possible values:<ul>
    <li>0 - Default. Message is sent to PHP's system logger,  using the OS' system logging mechanism or a file, depending on what the error_log configuration is set  to in php.ini</li>
    <li>1 - Message is sent by email to the address in the <em>destination</em>  parameter </li>
  ...
  <tr>
    ...
    <td>Optional. Specifies the destination of the error message. This value depends on the value of the <em>type</em> parameter</td>
  </tr>
  <tr>
    <td><em>headers</em></td>
    <td>Optional. Only used if the <em>type</em> parameter is set to 1. Specifies additional headers, like From, Cc, and Bcc. Multiple headers should be separated with a CRLF (\r\n)</td>
  </tr>
</table>
...
<a href="php_ref_error.asp" class="w3-btn w3-white w3-border" title="PHP Error"> PHP Error Reference</a>
</div>
