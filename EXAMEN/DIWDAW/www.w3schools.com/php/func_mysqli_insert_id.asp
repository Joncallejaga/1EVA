...
VALUES ('Glenn','Quagmire',33)&quot;);<br><br>// Print auto-generated id<br>echo &quot;New record has id: &quot; . mysqli_insert_id($con); <br>
...
<tr>
 ...
 <td style="width:80%">Returns an integer with the value of the AUTO_INCREMENT field that was updated by the last query. If the number is &gt; max integer value, it will return a string. Returns zero if there were no update or no AUTO_INCREMENT field</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
