...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_localtime">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a Unix timestamp that defaults to the current local time, time(), if no <em>timestamp</em> is specified</td>
  </tr>
  <tr>
    <td><em>is_assoc</em></td>
    <td>Optional. Specifies whether to return an associative or indexed array. FALSE = the array returned is an indexed array. TRUE = the array returned is an associative array. FALSE is default.
...
<tr>
 ...
 <td style="width:80%">Returns an array that contains the components of a Unix timestamp </td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
