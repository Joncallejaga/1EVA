...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_rot13">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>Before PHP 4.3, the <em>string</em> was also modified, as if it was passed by reference</td>
</tr>
</table>
<hr>
