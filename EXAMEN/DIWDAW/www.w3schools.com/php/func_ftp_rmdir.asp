...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$dir = &quot;php/&quot;;<br>
 <br>// try to delete $dir<br>
 if (ftp_rmdir($ftp_conn, $dir))<br>&nbsp; {<br>&nbsp; echo &quot;Directory $dir deleted&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Problem deleting $dir&quot;;<br>&nbsp; }<br>
