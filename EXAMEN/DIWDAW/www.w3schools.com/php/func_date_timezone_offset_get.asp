...
&lt;?php<br>
 ...
 $dateTimeOslo=date_create(&quot;now&quot;,timezone_open(&quot;Europe/Oslo&quot;));<br>echo timezone_offset_get($tz,$dateTimeOslo);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_timezone_offset_get">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the timezone offset in seconds on success. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2+</td>
