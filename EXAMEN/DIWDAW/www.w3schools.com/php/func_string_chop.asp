...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_chop">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies which characters to remove from the string. <br>
 The following characters are removed if the charlist parameter is empty:<ul>
    <li>&quot;\0&quot; - NULL</li>
    <li>&quot;\t&quot; - tab</li>
    <li>&quot;\n&quot; - new line</li>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_chop2">Run example &raquo;</a>
