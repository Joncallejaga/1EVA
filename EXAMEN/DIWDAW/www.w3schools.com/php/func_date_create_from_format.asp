...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_create_from_format">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format to use. The following characters can be used in the <em>format</em> parameter string:
 <ul>
    ...
    <li>+ - If present, trailing data in the string will cause a warning,  not an error</li>
 </ul>
   </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Optional. Specifies the timezone of <em>time</em>. Default is the current timezone</td>
  </tr>
  </table>
