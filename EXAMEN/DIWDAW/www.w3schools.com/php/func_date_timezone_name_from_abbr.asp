...
&lt;?php<br>
 echo timezone_name_from_abbr(&quot;EST&quot;) . &quot;&lt;br&gt;&quot;;<br>echo timezone_name_from_abbr(&quot;&quot;,7200,0);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_tz_name_from_abbr">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the offset from GMT in seconds. Default is -1, which means that first found timezone corresponding to abbr is returned. Otherwise exact offset is searched. If not found, the first timezone with any offset is returned</td>
  </tr>
  <tr>
    <td><em>isdst</em></td>
    <td>
 Optional. Specifies daylight saving time indicator.<ul>
    <li>-1 = Default. Whether the timezone has daylight saving or not is not  taken into consideration when searching</li>
    <li>&nbsp;1 = Means that the <em>gmtoffset</em> is an offset with daylight saving in effect</li>
...
<tr>
 ...
 <td style="width:80%">Returns the timezone name on success. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.1.3+</td>
