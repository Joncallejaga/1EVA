...
&lt;?php<br>
 ...
 $diff=date_diff($date1,$date2);<br><br>// %a outputs the total number of days<br>echo $diff-&gt;format(&quot;Total number of days: %a.&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_interval_format">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format. The following characters can be used in the <em>format</em> parameter string:
 <ul>
    <li>% - Literal %</li>
   ...
   <p><strong>Note:</strong> Each format character must be prefixed by a %   sign!</p>
   </td>
  </tr>
  </table>
