...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_reset">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li><a href="func_array_each.asp">each()</a> - returns the current element key and value, and moves the internal pointer forward</li>
</ul>
<hr>
<h2>Syntax</h2>
...
<tr>
 ...
 <td style="width:80%">Returns the value of the first element in the array on success, or FALSE if the array is empty</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
