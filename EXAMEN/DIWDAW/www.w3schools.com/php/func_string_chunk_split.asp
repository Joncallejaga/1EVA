...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_chunk_split">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. A number that defines the length of the chunks. Default is 76</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Optional. A string that defines what to place at the end of each chunk. Default is \r\n</td>
  </tr>
  </table>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_chunk_split2">Run example &raquo;</a>
</div>
<hr>
