...
&nbsp;&nbsp;}<br><br>// Perform queries and print out affected rows<br>mysqli_query($con,&quot;SELECT * FROM Persons&quot;);<br>echo &quot;Affected rows: &quot; . mysqli_affected_rows($con);<br><br>
mysqli_query($con,&quot;DELETE FROM Persons WHERE Age&gt;32&quot;);<br>echo &quot;Affected rows: &quot; . mysqli_affected_rows($con);<br>
...
<tr>
 ...
 <td style="width:80%">An integer &gt; 0 indicates the number of rows affected. 0 indicates that no records were affected. -1 indicates that the query returned an error</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
