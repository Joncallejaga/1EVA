...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_filter_list">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an array of all supported filter names, or an empty array if there are no such filters</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2.0+</td>
