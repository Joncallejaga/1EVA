...
<tr>
 ...
 <td style="width:80%">Returns the ASCII character of the converted string, or FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.4.0+</td>
...
<tr>
  <th>Changelog:</th>
  <td>As of PHP 5.4.1, a warning is thrown if the string is of odd length. In PHP 5.4.0, the string was silently accepted, but the last byte was removed.<br><br>As of PHP 5.5.1, a warning is thrown if the string is invalid hexadecimal string.</td>
</tr>
</table>
<hr>
