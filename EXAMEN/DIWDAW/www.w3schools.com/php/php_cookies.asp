...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_advanced4" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Create a cookie named "username".</p>
<div class="exerciseprecontainer">
<pre>
<input name="ex1" maxlength="9" style="width: 96px;">("username", "John", time() + (86400 * 30), "/");
</pre>
</div>
<br>
