...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_replace">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>array2</em></td>
    <td>Optional. Specifies an array which will replace the values of <em>array1</em></td>
  </tr>
  <tr>
    <td><em>array3,...</em></td>
    <td>Optional. Specifies more arrays to replace the values of <em>array1 </em> and<em> array2, etc.</em> Values from later arrays will overwrite the previous ones.</td>
  </tr>
  </table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_replace2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_replace3">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_replace4">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_replace5">Run example &raquo;</a>
</div>
<hr>
