...
&lt;?php<br>
 $date=date_create();<br>date_date_set($date,2020,10,30);<br>echo date_format($date,&quot;Y/m/d&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_date_set">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>From PHP 5.3+; changed the return value from NULL to DateTime (on success)</td>
</tr>
</table>
<hr>
