...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_multisort">Run example &raquo;</a>
</div>
<hr>
  ...
  <tr>
    ...
    <td>Optional. Specifies the type to use, when comparing elements. Possible values:
     <ul>
      ...
      <li>SORT_LOCALE_STRING - Compare elements as string, based on the   current locale (can be changed using    <a href="func_string_setlocale.asp">setlocale()</a>)</li>
      <li>SORT_NATURAL - Compare elements as strings using &quot;natural   ordering&quot; like <a href="func_array_natsort.asp">natsort()</a></li>
      <li>SORT_FLAG_CASE - Can be combined (bitwise OR) with SORT_STRING   or SORT_NATURAL to sort strings case-insensitively</li>
     </ul>
    </td>
  </tr>
  <tr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_multisort2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_multisort3">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_multisort4">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_multisort5">Run example &raquo;</a>
</div>
<hr>
