...
&lt;?php<br>
 $date=date_create();<br>date_timestamp_set($date,1371803321);<br>echo date_format($date,&quot;U = Y-m-d H:i:s&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_timestamp_set">Run example &raquo;</a>
</div>
<hr>
