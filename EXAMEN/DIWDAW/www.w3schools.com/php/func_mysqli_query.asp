...
&nbsp;&nbsp;}<br><br>// Perform queries <br>mysqli_query($con,&quot;SELECT * FROM Persons&quot;);<br>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    <li>MYSQLI_USE_RESULT (Use this if we have to retrieve large amount of  data)</li>
...
<tr>
 ...
 <td style="width:80%">For successful SELECT, SHOW, DESCRIBE, or EXPLAIN queries it will return a mysqli_result object. For other successful queries it will return TRUE. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
