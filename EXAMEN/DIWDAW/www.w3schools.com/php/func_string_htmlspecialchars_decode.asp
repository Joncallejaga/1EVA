...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes and which document type to use.<p>The available quote styles are:</p>
 <ul>
...
<tr>
  <th>Changelog:</th>
  <td>The additional flags for specifying the used doctype; ENT_HTML401, ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 5.4<br></td>
</tr>
</table>
<hr>
...
&lt;?php<br>
$str = &quot;Jane &amp;amp; &amp;#039;Tarzan&amp;#039;&quot;;<br>
echo htmlspecialchars_decode($str, ENT_COMPAT); // Will only convert double quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars_decode($str, ENT_QUOTES); // Converts double and single quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars_decode($str, ENT_NOQUOTES); // Does not convert any quotes<br>
?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<div class="w3-code notranslate">
 &lt;?php<br>
 $str = 'I love &amp;quot;PHP&amp;quot;.';<br>echo htmlspecialchars_decode($str, ENT_QUOTES); // Converts double and single quotes<br>
 ?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
