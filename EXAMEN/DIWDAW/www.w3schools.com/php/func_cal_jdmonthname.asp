...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_jdmonthname">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies which calendar to convert the Julian Day Count to, and how the month name is to be returned. Mode values:
 <ul>
