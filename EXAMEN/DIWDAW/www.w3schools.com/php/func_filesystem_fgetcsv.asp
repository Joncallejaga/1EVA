...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>length</td>
    <td>Optional. Specifies the maximum length of a line. Must be greater than the longest line (in characters) in the CSV file. Omitting this parameter (or setting it to 0) the line length is not limited, which is slightly slower.<p><b>Note:</b> This parameter is required in versions prior to PHP 5</td>
  </tr>
  <tr>
    <td>separator</td>
    <td>Optional. A character that specifies the field separator. Default is comma ( , )</td>
  </tr>
  <tr>
    <td>enclosure</td>
    <td>Optional. A character that specifies the field enclosure character. Default is &quot;</td>
  </tr>
  </table>
<hr>
