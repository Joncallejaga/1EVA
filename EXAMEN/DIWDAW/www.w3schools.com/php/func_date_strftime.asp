...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_strftime">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns a string formatted according <em>format</em> using the given <em>timestamp</em>. Month and weekday names and other language-dependent strings respect the current locale set with setlocale()</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
