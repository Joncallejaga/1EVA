...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies a function to be called at the start of an element</td>
  </tr>
  <tr>
    <td>end</td>
    <td>Required. Specifies a function to be called at the end of an element</td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies a variable containing the name of the elements, that triggers this function, from the XML file as a string</td>
  </tr>
  <tr>
    <td>data</td>
    <td>Required. Specifies an array containing the elements attributes from the XML file as a string</td>
  </tr>
  </table>
