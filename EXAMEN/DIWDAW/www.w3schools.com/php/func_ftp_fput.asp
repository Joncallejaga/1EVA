...
&lt;?php<br>
 ...
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// open file for reading<br>$file = &quot;test.txt&quot;;<br>$fp = fopen($file,&quot;r&quot;);<br><br>// upload file<br>if (ftp_fput($ftp_conn, &quot;somefile.txt&quot;, $fp, FTP_ASCII))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully uploaded $file.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error uploading $file.&quot;;<br>&nbsp; }<br><br>// close this connection and file handler<br>ftp_close($ftp_conn);<br>
 fclose($fp);<br>?&gt;
</div>
</div>
<hr>
