...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sscanf">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  <li><a href="func_string_printf.asp">printf()</a> - outputs a formatted string</li>
  <li><a href="func_string_sprintf.asp">sprintf()</a> - writes a formatted string to a variable</li>
</ul>
<hr>
<h2>Syntax</h2>
...
<div class="w3-code notranslate">
 ...
 &lt;?php<br>$str = &quot;If you divide 4 by 2 you'll get 2&quot;;<br>$format = sscanf($str,&quot;%s %s %s %d %s %d %s %s %c&quot;);<br>print_r($format);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sscanf2">Run example &raquo;</a>
</div>
<hr>
