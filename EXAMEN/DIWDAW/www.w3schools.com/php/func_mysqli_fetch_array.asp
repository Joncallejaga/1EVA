...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 ...
 $row=mysqli_fetch_array($result,MYSQLI_NUM);<br>printf (&quot;%s (%s)\n&quot;,$row[0],$row[1]);<br><br>// Associative array<br>
 $row=mysqli_fetch_array($result,MYSQLI_ASSOC);<br>printf (&quot;%s (%s)\n&quot;,$row[&quot;Lastname&quot;],$row[&quot;Age&quot;]);<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies what type of array that should be produced. Can be one of the following values:<ul>
    <li>MYSQLI_ASSOC</li>
    <li>MYSQLI_NUM</li>
    <li>MYSQLI_BOTH</li>
 </ul>
...
<tr>
 ...
 <td style="width:80%">Returns an array of strings that corresponds to the fetched row. NULL if there are no more rows in result-set</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
