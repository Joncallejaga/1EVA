...
<p><strong>Tip:</strong> To view all available language codes, go to our <a href="../tags/ref_language_codes.asp" target="_blank">Language code reference.</a></p>
<hr>
<h2>Syntax</h2>
...
<table class="w3-table-all notranslate"> 
 ...
 <p>Padding and Flags:</p>
    <ul>
  <li>=<i>f</i> - Specifies the character (f) to be used as padding (Example: %=t this uses &quot;t&quot; as padding). Default is space</li>
 <li>^ - Removes the use of grouping characters</li>
  <li>+ or ( - Specifies how to show positive and negative numbers. If &quot;+&quot; is used, the local setting for + and - will be used (usually a sign in front of negative numbers, and nothing in front of positive numbers). If &quot;(&quot; is used, negative numbers are enclosed in parenthesis. Default is &quot;+&quot;</li>
  <li>! - Stops the use of currency symbols in the output string</li>
  <li>- If &quot;-&quot; is used, all fields are left-justified. Default is right-justified</li>
    </ul>

 <p>Field width:</p>
 <ul>
  <li><i>x</i> - Specifies the minimum field width (x). Default is 0</li>
  <li>#<i>x</i> - Specifies the maximum number (x) of digits expected to the left of the decimal point. This is used to keep formatted output aligned in the same columns. If the number of digits are bigger than x, this specification is ignored</li>
  <li>.<i>x</i> - Specifies the maximum number (x) of digits expected to the right of the decimal point. If x is 0, the decimal point and the digits to its right will not be shown. Default is local settings</li>
 </ul>
 ...
 <p><b>Note:</b> This function is affected by local settings.</p></td>
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The number to be inserted at the %-sign in the format string</td>
  </tr>
  </table>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the formatted string. Characters before and after the formatting string will be returned unchanged. Non-numeric number causes returning NULL and emitting E_WARNING</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.3.0+</td>
...
(******1234.57)</div><br></div>
<hr>
<p><a href="php_ref_string.asp" class="w3-btn w3-white w3-border" title="PHP String Reference">&#10094; PHP String Reference</a>
</div>
