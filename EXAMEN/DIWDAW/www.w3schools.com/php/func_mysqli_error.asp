...
&nbsp;&nbsp;}<br><br>// Perform a query, check for error<br>if (!mysqli_query($con,&quot;INSERT INTO Persons (FirstName)
VALUES ('Glenn')&quot;))<br>&nbsp; {<br>&nbsp; echo(&quot;Error description: &quot; . mysqli_error($con));<br>&nbsp; }<br>
...
<tr>
 ...
 <td style="width:80%">Returns a string with the error description. &quot;&quot; if no error occurred</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
