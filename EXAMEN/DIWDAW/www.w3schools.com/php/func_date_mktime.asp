...
&lt;?php<br>
 // Prints: October 3, 1975 was on a Friday<br>echo &quot;Oct 3, 1975 was on a &quot;.date(&quot;l&quot;, mktime(0,0,0,10,3,1975));<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_mktime">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>is_dst</em></td>
    <td>Optional. Set this parameter to 1 if the time is during daylight savings time (DST), 0 if it is not, or -1 (the default) if it is unknown. If it's unknown, PHP tries to find out itself (which may cause unexpected results).
 <b>Note:</b> This parameter became deprecated in PHP 5.1.0. The new timezone handling features should be used instead</td>
  </tr>
  </table>
...
<tr>
 ...
 PHP 5.1.0: The <em>is_dst</em> parameter was deprecated. If mktime() is called with no arguments, it now throws E_STRICT notice. Use the time() function instead.<br></td>
</tr>
</table>
<hr>
