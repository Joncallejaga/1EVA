...
<p><a href="php_ref_string.asp" class="w3-btn w3-white w3-border" title="PHP String Reference">&#10094; 
...
<div class="w3-code notranslate">
 &lt;?php<br>$str = '&lt;a href="https://www.w3schools.com"&gt;Go to 
  w3schools.com&lt;/a&gt;';<br>echo htmlentities($str);<br>
 ?&gt;</div>
...
<div class="w3-code notranslate">
  ...
  &lt;a href="https://www.w3schools.com"&gt;Go to w3schools.com&lt;/a&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_htmlentities">
 Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes, invalid encoding and the used document type.<p>The available quote styles are:</p>
 <ul>
 ...
 <ul>
    <li>ENT_IGNORE - Ignores invalid encoding instead of having the function  return an empty string. Should be avoided, as it may have security  implications.</li>
    <li>ENT_SUBSTITUTE - Replaces invalid encoding for a specified character  set with a Unicode Replacement Character U+FFFD (UTF-8) or &amp;#FFFD;  instead of returning an empty string.</li>
    <li>ENT_DISALLOWED - Replaces code points that are invalid in the  specified doctype with a Unicode Replacement Character U+FFFD (UTF-8) or  &amp;#FFFD;</li>
 </ul>
 ...
 <ul>
  ...
  <tr>
    ...
    <td>Optional. A string that specifies which character-set to use.<p>Allowed values are:</p>
 <ul>
     <li>UTF-8 - Default. ASCII compatible multi-byte 8-bit Unicode</li>
    <li>ISO-8859-1 - Western European</li>
    <li>ISO-8859-15 - Western European (adds the Euro sign + French and  Finnish letters missing in ISO-8859-1)</li>
 ...
 <p><b>Note:</b> Unrecognized character-sets will be ignored and replaced by ISO-8859-1 in versions prior to PHP 5.4. As of PHP 5.4, it will be ignored an replaced by UTF-8. </p>
  </td>
  </tr>
    <tr>
    <td><em>double_encode</em></td>
    <td>Optional. A boolean value that specifies whether to encode existing html entities or not. <ul>
...
<tr>
 ...
 <td style="width:80%">Returns the converted string<br><br>If the <em>string</em> contains invalid encoding, it will return an empty string, unless either the ENT_IGNORE or ENT_SUBSTITUTE flags are set</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>The default value for the <em>character-set</em> parameter was changed to UTF-8 in PHP 5<br><br>ENT_SUBSTITUTE, ENT_DISALLOWED, ENT_HTML401, ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>ENT_IGNORE was added in PHP 5.3<br><br>The <em>double_encode</em> parameter was added in PHP 5.2.3<br>
...
<p>Convert some characters to HTML entities: </p>
 <div class="w3-code notranslate">
  &lt;?php<br>
   $str = "Albert Einstein said: 'E=MC²'";<br>
...
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
  Albert Einstein said: 'E=MC&amp;sup2;'&lt;br&gt;<br>Albert Einstein said: 
  &amp;#039;E=MC&amp;sup2;&amp;#039;&lt;br&gt;<br>Albert Einstein said: 'E=MC&amp;sup2;'

</div>
<p>The browser output of the code above will be:</p>
<div class="w3-code notranslate">

  Albert Einstein said: 'E=MC²'<br>Albert Einstein said: 'E=MC²'<br>Albert 
  Einstein said: 'E=MC²'
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_htmlentities2">
 Run example &raquo;</a>
</div>
<br>
...
character-set: </p>
 <div class="w3-code notranslate">
  &lt;?php<br>$str = "My name is Øyvind Åsane. I'm Norwegian.";<br>echo  htmlentities($str, ENT_QUOTES, "UTF-8"); // Will only convert  double quotes (not single quotes), and uses the character-set Western  European<br>?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br>My name is &amp;Oslash;yvind &amp;Aring;sane. I&amp;#039;m Norwegian.<br>&lt;/body&gt;<br>&lt;/html&gt;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_htmlentities3">
 Run example &raquo;</a>
</div>
<hr>
<a href="php_ref_string.asp" class="w3-btn w3-white w3-border" title="PHP String Reference">&#10094; 
