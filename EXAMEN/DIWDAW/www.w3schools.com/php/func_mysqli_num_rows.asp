...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Return the number of rows in result set<br>&nbsp; $rowcount=mysqli_num_rows($result);<br>&nbsp; printf(&quot;Result set has %d rows.\n&quot;,$rowcount);<br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>&nbsp; }<br>
