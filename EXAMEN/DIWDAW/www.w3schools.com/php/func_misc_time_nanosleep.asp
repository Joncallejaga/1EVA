...
&nbsp;&nbsp;}<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_nanosleep">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the number of&nbsp; nanoseconds to delay the script (must be less than 1,000,000,000)</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">
 Returns TRUE on success, or FALSE on failure.<br><br>If the call was interrupted by a signal, an associative array will be returned with the number of seconds or nanoseconds remaining in the delay.<br>
  </td>
</tr>
<tr>
  <th>PHP Version:</th>
