...
&lt;?php<br>
 ...
 $summer=date_create(&quot;2013-06-30&quot;,timezone_open(&quot;Europe/Oslo&quot;));<br><br>echo date_offset_get($winter) . &quot; seconds.&lt;br&gt;&quot;;<br>echo date_offset_get($summer) . &quot; seconds.&quot;;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_offset_get">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the timezone in seconds from UTC on success. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2+</td>
