...
&lt;?php<br>
 $date=date_create();<br>date_isodate_set($date,2013,5);<br>echo date_format($date,&quot;Y-m-d&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_isodate_set">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <a href="func_date_date_create.asp">date_create()</a></td>
  ...
  <tr>
    <td><em>day</em></td>
    <td>Optional. Specifies the offset from the first day of the week. Default is 1</td>
  </tr>
  </table>
