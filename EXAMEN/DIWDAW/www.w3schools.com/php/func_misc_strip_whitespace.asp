...
<tr>
 ...
 <td style="width:80%">Returns the stripped source code on success, or an empty string on failure. <strong>Note:</strong> This function only returns an empty string on versions before PHP 5.0.1.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
