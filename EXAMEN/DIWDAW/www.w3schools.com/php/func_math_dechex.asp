...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_dechex">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">A string that contains the hexadecimal number of the decimal value</td>
</tr>
  <tr>
  <th>Return Type:</th>
  <td>String</td>
