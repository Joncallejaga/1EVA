...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>raw</em></td>
    <td>Optional. A boolean value that specifies hex or binary output format:<ul>
...
<tr>
  <th>Changelog:</th>
  <td>The <em>raw</em> parameter became optional in PHP 5.0<br><br>As of PHP 5.1, it is possible to use sha1_file() with wrappers, e.g. <strong>
 sha1_file(&quot;https://w3schools.com/..&quot;)</strong></td>
</tr>
</table>
<hr>
