...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <li>XML_OPTION_CASE_FOLDING - Specifies if case-folding is enabled.  Enabled by default. Can be 1 (TRUE) or 0 (FALSE)</li>
    <li>XML_OPTION_SKIP_TAGSTART - Specifies how many characters should be  skipped in the beginning of a tag name</li>
    <li>XML_OPTION_SKIP_WHITE - Specifies whether to skip values consisting  of whitespace characters. Can be 1 (TRUE) or 0 (FALSE)</li>
    <li>XML_OPTION_TARGET_ENCODING - Specifies which target encoding to use  in this XML parser. By default, it is set to the same as the  xml_parser_create() function. Supported target encodings are ISO-8859-1,  US-ASCII and UTF-8.</li>
 </ul>
  </td>
  </tr>
  <tr>
