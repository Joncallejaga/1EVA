...
<hr>
<a href="php_ref_xml.asp" class="w3-btn w3-white w3-border" title="PHP XML Reference">&#10094; Complete PHP XML Reference</a>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>handler</td>
    <td>Required. Specifies a function to be when the parser finds a notation declaration</td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>parser</td>
    <td>Required. Specifies a variable containing the XML parser calling the handler</td>
  </tr>
  <tr>
    <td>name</td>
    <td>Required. Specifies a variable containing the name of the entity</td>
  </tr>
  <tr>
    <td>base</td>
    <td>Required. Specifies a variable containing the base for resolving the system identifier (system_id) of the entity. Currently, this is always NULL</td>
  </tr>
  <tr>
    <td>system_id</td>
    <td>Required. Specifies a variable containing the system identifier for the entity</td>
  </tr>
  <tr>
    <td>public_id</td>
    <td>Required. Specifies a variable containing the public identifier for the entity</td>
  </tr>
  <tr>
    <td>notation</td>
    <td>Required. Specifies a variable containing the notation identifying the data type of the entity</td>
  </tr>
  </table>
<hr>
