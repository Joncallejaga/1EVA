...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$old_file = &quot;oldfile.txt&quot;;<br>
 $new_file = &quot;newfile.txt&quot;;<br><br>// try to rename $old_file to $new_file<br>
 if (ftp_rename($ftp_conn, $old_file, $new_file))<br>&nbsp; {<br>&nbsp; echo &quot;Renamed $old_file to $new_file&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Problem renaming $old_file to $new_file&quot;;<br>&nbsp; }<br>
