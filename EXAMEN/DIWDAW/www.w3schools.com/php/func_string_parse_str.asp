...
echo $name.&quot;&lt;br&gt;&quot;;<br>
 echo $age;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_parse_str">Run example &raquo;</a>
</div>
<hr>
...
<b>Note:</b> If the array parameter is not set, variables set by this function will overwrite existing variables of the same name.<p><b>Note:</b> The magic_quotes_gpc setting in the php.ini file affects the output of this 
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Optional. Specifies the name of an array to store the variables. This parameter indicates that the variables will be stored in an array.</td>
  </tr>
</table>
...
<tr>
  <th>Changelog:</th>
  <td>The <em>array</em> parameter was added in PHP 4.0.3</td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
...
print_r($myArray);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_parse_str2">Run example &raquo;</a>
</div>
<hr>
