...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_convert_cyr_string">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>from</em></td>
    <td>Required. A character that specifies what Cyrillic character-set to convert from</td>
  </tr>
  <tr>
    <td><em>to</em></td>
    <td>Required. A character that specifies what Cyrillic character-set to convert to</td>
  </tr>
  </table>
