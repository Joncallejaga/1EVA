...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strrpos">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  <li><a href="func_string_strpos.asp">strpos()</a> - Finds the position of the first occurrence of a string inside another string (case-sensitive)</li>
  <li><a href="func_string_stripos.asp">stripos() </a>- Finds the position of the first occurrence of a string inside another string (case-insensitive)</li>
  <li><a href="func_string_strripos.asp">strripos()</a> - Finds the position of the last occurrence of a string inside another string (case-insensitive)</li>
</ul>
<hr>
<h2>Syntax</h2>
...
<tr>
 ...
 <td style="width:80%">Returns the position of the last occurrence of a string inside another string, or FALSE if the string is not found. <strong>Note:</strong> String positions start at 0, and not 1.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>As of PHP 5.0, the <em>find</em> parameter may now be a string of more than one character<br><br>The <em>start</em> parameter was added in PHP 5.0</td>
</tr>
</table>
<hr>
