...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_hebrevc">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies maximum characters for each line. hebrev() will avoid breaking words if possible</td>
  </tr>
  </table>
