...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_product">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>As of PHP 5.3.6, the product of an empty array is 1. Before PHP 5.3.6, this function would return 0 for an empty array.</td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_product2">Run example &raquo;</a>
</div>
<hr>
