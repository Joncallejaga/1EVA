...
<div class="w3-code notranslate">
 &lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&lt;?xml version="1.0" standalone="yes"?&gt;<br>&lt;cars&gt;<br>&nbsp; &lt;car id="1"&gt;Volvo&lt;/car&gt;<br>&nbsp; &lt;car id="2"&gt;BMW&lt;/car&gt;<br>&nbsp; &lt;car id="3"&gt;Saab&lt;/car&gt; <br>&lt;/cars&gt;<br>XML;<br><br>$sxe=new SimpleXMLElement($xml);<br>echo $sxe-&gt;getName() . "&lt;br&gt;";<br>foreach ($sxe-&gt;children() as $child)<br>&nbsp; {<br>&nbsp; echo $child-&gt;getName() . "&lt;br&gt;";<br>&nbsp; }<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_simplexml_getname">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the name of the XML tag referenced by the SimpleXMLElement object, as a string</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.1.3+</td>
