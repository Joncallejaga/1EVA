...
<div class="w3-code notranslate">
 &lt;?php<br>function myfunction($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_diff_uassoc">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
 ...
 print_r($result);<br>
 ?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_diff_uassoc2">Run example &raquo;</a>
</div>
