...
<hr>
<a href="php_ref_zip.asp" class="w3-btn w3-white w3-border" title="PHP Zip File Reference">&#10094; Complete PHP Zip File Reference</a>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>zip</td>
    <td>Required. Specifies the zip resource to read (a zip file opened with zip_open() )</td>
  </tr>
  <tr>
    <td>zip_entry</td>
    <td>Required. Specifies the zip entry resource to open (a zip entry opened with zip_read() )</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>Optional. Specifies the type of access you require to the zip archive.<p><b>Note:</b> In PHP 5, mode is ignored and is always &quot;rb&quot;. This is because zip support in PHP is read only</td>
  </tr>
  </table>
<hr>
