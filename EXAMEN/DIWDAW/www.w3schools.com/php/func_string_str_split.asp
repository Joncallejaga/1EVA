...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_split">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the length of each array element. Default is 1</td>
  </tr>
  </table>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_split2">Run example &raquo;</a>
</div>
<hr>
