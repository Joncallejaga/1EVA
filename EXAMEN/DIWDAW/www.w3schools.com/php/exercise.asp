<script>var exnames = [], excounts = [], exheadings = [];exnames[0] = 'syntax';excounts[0] = '5';exheadings[0] = 'Syntax';exActiveNo = 0;exnames[1] = 'variables';excounts[1] = '2';exheadings[1] = 'Variables';exnames[2] = 'strings';excounts[2] = '3';exheadings[2] = 'Strings';exnames[3] = 'operators';excounts[3] = '4';exheadings[3] = 'Operators';exnames[4] = 'ifelse';excounts[4] = '4';exheadings[4] = 'If...Else';exnames[5] = 'switch';excounts[5] = '2';exheadings[5] = 'Switch';exnames[6] = 'loops';excounts[6] = '4';exheadings[6] = 'Loops';exnames[7] = 'functions';excounts[7] = '4';exheadings[7] = 'Functions';exnames[8] = 'arrays';excounts[8] = '8';exheadings[8] = 'Arrays';exnames[9] = 'forms';excounts[9] = '2';exheadings[9] = 'Forms';exnames[10] = 'dates';excounts[10] = '3';exheadings[10] = 'Dates';exnames[11] = 'advanced';excounts[11] = '6';exheadings[11] = 'Advanced';</script>
<!DOCTYPE html>
<html lang="en-US">
<head>
...
function needHint(x) {
    ...
    <meta property="og:url"           content="https://www.w3schools.com/PHP/exercise.asp" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="W3Schools PHP Exercise" />
    <meta property="og:description"   content="I completed all the PHP exercises on w3schools.com" />
</head>
<body>
...
<div><div onclick='openmenuitems(0)' class='exmenuitemheader active'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Syntax </div><div class='exmenulinks active'><a class='exbtn active' href='exercise.asp?filename=exercise_syntax1'><i class='fa fa-check active'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_syntax2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_syntax3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_syntax4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='exercise.asp?filename=exercise_syntax5'><i class='fa fa-check'></i> Exercise 5</a><a class='exbtn' href='php_syntax.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Syntax tutorial</a></div></div><div><div onclick='openmenuitems(1)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Variables </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_variables1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_variables2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='php_variables.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Variables tutorial</a></div></div><div><div onclick='openmenuitems(2)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Strings </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_strings1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_strings2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_strings3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='php_string.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Strings tutorial</a></div></div><div><div onclick='openmenuitems(3)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Operators </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_operators1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_operators2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_operators3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_operators4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='php_operators.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Operators tutorial</a></div></div><div><div onclick='openmenuitems(4)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP If...Else </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_ifelse1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_ifelse2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_ifelse3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_ifelse4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='php_if_else.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP If...Else tutorial</a></div></div><div><div onclick='openmenuitems(5)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Switch </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_switch1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_switch2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='php_switch.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Switch tutorial</a></div></div><div><div onclick='openmenuitems(6)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Loops </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_loops1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_loops2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_loops3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_loops4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='php_looping.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Loops tutorial</a></div></div><div><div onclick='openmenuitems(7)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Functions </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_functions1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_functions2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_functions3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_functions4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='php_functions.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Functions tutorial</a></div></div><div><div onclick='openmenuitems(8)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Arrays </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_arrays1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays5'><i class='fa fa-check'></i> Exercise 5</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays6'><i class='fa fa-check'></i> Exercise 6</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays7'><i class='fa fa-check'></i> Exercise 7</a><a class='exbtn' href='exercise.asp?filename=exercise_arrays8'><i class='fa fa-check'></i> Exercise 8</a><a class='exbtn' href='php_arrays.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Arrays tutorial</a></div></div><div><div onclick='openmenuitems(9)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Forms </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_forms1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_forms2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='php_forms.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Forms tutorial</a></div></div><div><div onclick='openmenuitems(10)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Dates </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_dates1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_dates2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_dates3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='php_date.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Dates tutorial</a></div></div><div><div onclick='openmenuitems(11)' class='exmenuitemheader'><i style='position:absolute;left:224px;padding-top:4px;' class='fa fa-check'></i>PHP Advanced </div><div class='exmenulinks'><a class='exbtn' href='exercise.asp?filename=exercise_advanced1'><i class='fa fa-check'></i> Exercise 1</a><a class='exbtn' href='exercise.asp?filename=exercise_advanced2'><i class='fa fa-check'></i> Exercise 2</a><a class='exbtn' href='exercise.asp?filename=exercise_advanced3'><i class='fa fa-check'></i> Exercise 3</a><a class='exbtn' href='exercise.asp?filename=exercise_advanced4'><i class='fa fa-check'></i> Exercise 4</a><a class='exbtn' href='exercise.asp?filename=exercise_advanced5'><i class='fa fa-check'></i> Exercise 5</a><a class='exbtn' href='exercise.asp?filename=exercise_advanced6'><i class='fa fa-check'></i> Exercise 6</a><a class='exbtn' href='php_arrays_multi.asp' style='font-size:80%;text-decoration:underline;'>Go to PHP Advanced tutorial</a></div></div>
<br>
<br>
<br>
<br>
...
<div id="id01" class="w3-modal" style="z-index:3;">
  <div class="w3-modal-content w3-card-4 w3-center">
    ...
    <div class="w3-container w3-padding">
      <p>This will reset the score of ALL 47 exercises.</p>
...
<div id="id02" class="w3-modal" style="z-index:3;">
  <div class="w3-modal-content w3-card-4 w3-padding w3-center">
    ...
    <div class="w3-container w3-padding">
      <h3>You have finished all 47&nbsp;PHP exercises.</h3>
      <p>Share your score on facebook:</p>
      
      <a href="https://www.facebook.com/sharer.php?u=https://www.w3schools.com/PHP/exercise.asp" target="_blank" title="Facebook"><span style="color:#3B5998;" class="fa fa-facebook-square fa-2x"></span></a>
      <br>
