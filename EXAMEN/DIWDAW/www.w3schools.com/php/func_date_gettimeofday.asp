...
&lt;?php<br>
 // Print the array from gettimeofday()<br>print_r(gettimeofday());<br><br>// Print the float from gettimeofday()<br>echo gettimeofday(true);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_gettimeofday">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. When set to TRUE, a float instead of an array is returned. Default is FALSE</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns an associative array by default, with the following array keys:<br>
<ul>
