...
<div class="w3-code notranslate">
 ...
 &lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>$txt = sprintf(&quot;There are %u million bicycles in %s.&quot;,$number,$str);<br>echo $txt;<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sprintf">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the string and how to format the variables in it.<p>Possible format values:</p>
<ul>
  ...
  <li>%F - Floating-point number (not local settings aware)</li>
 ...
 <p>Additional format values. These are placed between the % and the letter (example %.2f):</p>
 <ul>
  <li>+ (Forces both + and - in front of numbers. By default, only negative numbers are marked)</li>
    <li>' (Specifies what to use as padding. Default is space. Must be used  together with the width specifier.  Example: %'x20s (this uses &quot;x&quot; as padding)</li>
    <li>- (Left-justifies the variable value)</li>
    <li>[0-9] (Specifies the minimum width held of to the variable value)</li>
    <li>.[0-9] (Specifies the number of decimal digits or maximum string length)</li>
 </ul>
 <p><b>Note:</b> If multiple additional format values are used, they must be in the same order as above.</p></td>
  </tr>
  <tr>
    <td><em>arg1</em></td>
    <td>Required. The argument to be inserted at the first %-sign in the format string</td>
  </tr>
  <tr>
    <td><em>arg2</em></td>
    <td>Optional. The argument to be inserted at the second %-sign in the format string</td>
  </tr>
  <tr>
    <td><em>arg++</em></td>
    <td>Optional. The argument to be inserted at the third, fourth, etc. %-sign in the format string</td>
  </tr>
  </table>
<hr>
...
echo $txt;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sprintf2">Run example &raquo;</a>
</div>
<br>
...
echo $txt;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sprintf3">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 &lt;?php<br>$num1 = 123456789;<br>$num2 = -123456789;<br>$char = 50; // The ASCII Character 50 is 2<br><br>// Note: The format value &quot;%%&quot; returns a percent sign<br>echo sprintf(&quot;%%b = %b&quot;,$num1).&quot;&lt;br&gt;&quot;; // Binary number<br>echo sprintf(&quot;%%c = %c&quot;,$char).&quot;&lt;br&gt;&quot;; // The ASCII Character<br>
 echo sprintf(&quot;%%d = %d&quot;,$num1).&quot;&lt;br&gt;&quot;; // Signed decimal number<br>echo sprintf(&quot;%%d = %d&quot;,$num2).&quot;&lt;br&gt;&quot;; // Signed decimal number<br>echo sprintf(&quot;%%e = %e&quot;,$num1).&quot;&lt;br&gt;&quot;; // Scientific notation (lowercase)<br>echo sprintf(&quot;%%E = %E&quot;,$num1).&quot;&lt;br&gt;&quot;; // Scientific notation (uppercase)<br>echo sprintf(&quot;%%u = %u&quot;,$num1).&quot;&lt;br&gt;&quot;; // Unsigned decimal number (positive)<br>
 echo sprintf(&quot;%%u = %u&quot;,$num2).&quot;&lt;br&gt;&quot;; // Unsigned decimal number (negative)<br>
 echo sprintf(&quot;%%f = %f&quot;,$num1).&quot;&lt;br&gt;&quot;; // Floating-point number (local settings aware)<br>echo sprintf(&quot;%%F = %F&quot;,$num1).&quot;&lt;br&gt;&quot;; // Floating-point number (not local sett aware)<br>echo sprintf(&quot;%%g = %g&quot;,$num1).&quot;&lt;br&gt;&quot;; // Shorter of %e and %f<br>echo sprintf(&quot;%%G = %G&quot;,$num1).&quot;&lt;br&gt;&quot;; // Shorter of %E and %f<br>echo sprintf(&quot;%%o = %o&quot;,$num1).&quot;&lt;br&gt;&quot;; // Octal number<br>
 echo sprintf(&quot;%%s = %s&quot;,$num1).&quot;&lt;br&gt;&quot;; // String<br>echo sprintf(&quot;%%x = %x&quot;,$num1).&quot;&lt;br&gt;&quot;; // Hexadecimal number (lowercase)<br>echo sprintf(&quot;%%X = %X&quot;,$num1).&quot;&lt;br&gt;&quot;; // Hexadecimal number (uppercase)<br>echo sprintf(&quot;%%+d = %+d&quot;,$num1).&quot;&lt;br&gt;&quot;; // Sign specifier (positive)<br>echo sprintf(&quot;%%+d = %+d&quot;,$num2).&quot;&lt;br&gt;&quot;; // Sign specifier (negative)<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sprintf4">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 echo sprintf(&quot;[%'*8s]&quot;,$str1).&quot;&lt;br&gt;&quot;;<br>echo sprintf(&quot;[%8.8s]&quot;,$str2).&quot;&lt;br&gt;&quot;; <br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_sprintf5">Run example &raquo;</a>
</div>
<hr>
