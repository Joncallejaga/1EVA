...
<div class="w3-code notranslate">
 &lt;?php<br>$int = 100;<br><br>if (filter_var($int, FILTER_VALIDATE_INT)) {<br>&nbsp;&nbsp;&nbsp; echo("Variable is an integer");<br>} else {<br>&nbsp;&nbsp;&nbsp; echo("Variable is not an integer");<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_int">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
 &lt;?php<br>$int = 0;<br><br>if (filter_var($int, FILTER_VALIDATE_INT) === 0 || filter_var($int, FILTER_VALIDATE_INT)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable is an integer&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable is not an integer&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_int2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_int3">Run example &raquo;</a>
</div>
