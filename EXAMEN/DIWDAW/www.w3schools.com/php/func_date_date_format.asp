...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_format">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <a href="func_date_date_create.asp">date_create()</a></td>
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format for the date. The following characters can be used:
    <ul>
