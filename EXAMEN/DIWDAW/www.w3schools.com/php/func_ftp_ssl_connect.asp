...
&lt;?php<br>// set up basic SSL connection<br>$ftp_server = &quot;123.123.123.123&quot;;<br>
 $ftp_conn = ftp_ssl_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br><br>// login<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// then do something...<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>host</em></td>
    <td>Required. Specifies the FTP server address. Can be a domain address or an IP address. This parameter should not be prefixed with &quot;ftp://&quot; or have any trailing slashes</td>
  </tr>
  <tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port to connect to. Default is 21</td>
  </tr>
  <tr>
    <td><em>timeout</em></td>
    <td>Optional. Specifies the timeout for network operations. Default is 90 seconds</td>
  </tr>
</table>
<hr>
...
<tr>
  <th>PHP Changelog:</th>
  <td>In PHP 5.2.2 this function returns FALSE if it cannot use an SSL connection, instead of fallbacking to a non-SSL connection</td>
</tr>
</table>
<hr>
