...
&lt;?php<br>
 ...
 mysqli_ssl_set($con,&quot;key.pem&quot;,&quot;cert.pem&quot;,&quot;cacert.pem&quot;,NULL,NULL); <br><br>if (!mysqli_real_connect($con,&quot;localhost&quot;,&quot;my_user&quot;,&quot;my_password&quot;,&quot;my_db&quot;))<br>&nbsp; {<br>&nbsp; die(&quot;Connect Error: &quot; . mysqli_connect_error());<br>&nbsp; }<br>
 <br>// Some queries...<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>capath</em></td>
    <td>Required. Specifies the pathname to a directory that contains trusted SSL CA certificates in PEM format</td>
  </tr>
  <tr>
    <td><em>cipher</em></td>
    <td>Required. Specifies a list of allowable ciphers to use for SSL encryption</td>
  </tr>
  </table>
...
<tr>
 ...
 <a href="func_mysqli_real_connect.asp">mysqli_real_connect()</a> will return an error when you try to connect</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
