...
<div class="w3-code notranslate">
 ...
 &lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>$txt = vsprintf(&quot;There are %u million bicycles in %s.&quot;,array($number,$str));<br>echo $txt;<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_vsprintf">Run example &raquo;</a>
</div>
<hr>
...
<ul>
 ...
 <p><b>Note:</b> If multiple additional format values are used, they must be in the same order as above.</p></td>
  ...
  <tr>
    ...
    <td>Required. An array with arguments to be inserted at the % signs in the format string</td>
  </tr>
  </table>
<hr>
...
echo $txt;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_vsprintf2">Run example &raquo;</a>
</div>
<br>
...
echo $txt;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_vsprintf3">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_vsprintf4">Run example &raquo;</a>
</div>
<hr>
