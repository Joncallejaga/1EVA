...
error_reporting(E_ALL);<br><br>// Same as error_reporting(E_ALL);<br>ini_set(&quot;error_reporting&quot;, E_ALL);<br><br>// Report all errors except E_NOTICE<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>level</em></td>
    <td>Optional. Specifies the error-report level for the current script. <a href="php_ref_error.asp">Error numbers and named constants</a> are accepted.
 <strong>Note:</strong> Named constants are recommended to ensure compatibility for future PHP versions</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">Returns the old error reporting level or the current error reporting level if no <em>level</em> parameter is given</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0+</td>
