...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>zip_entry</td>
    <td>Required. Specifies the zip entry resource to read (a zip entry opened with zip_read() )</td>
  </tr>
  <tr>
    <td>length</td>
    <td>Optional. Specifies the number of bytes (uncompressed size) to return. Default is 1024</td>
  </tr>
  </table>
<hr>
