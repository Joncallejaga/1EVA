...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;serverfile.txt&quot;;<br>
 <br>// get size of $file<br>$fsize = ftp_size($ftp_conn, $file);<br>if ($fsize != -1)<br>&nbsp; {<br>&nbsp; echo &quot;$file is $fsize bytes.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error getting file size.&quot;;<br>&nbsp; }<br>
...
<tr>
 ...
 <td style="width:80%">Returns the file size in bytes on success, or -1 on error</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
