...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_jdtojewish">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>hebrew</em></td>
    <td>Optional. When set to TRUE it indicates Hebrew output format. FALSE is default</td>
  </tr>
  <tr>
    <td><em>fl</em></td>
...
<tr>
  <th>Changelog:</th>
  <td>The <em>hebrew</em> parameter was added in PHP 4.3, and the <em>fl</em> parameter was added in PHP 5.0</td>
</tr>
</table>
<hr>
