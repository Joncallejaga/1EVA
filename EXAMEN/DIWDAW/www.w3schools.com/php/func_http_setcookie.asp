...
<p><a href="php_ref_http.asp" class="w3-btn w3-white w3-border" title="PHP HTTP Reference">&#10094; PHP HTTP Reference</a></p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>expire</em></td>
    <td>Optional. Specifies when the cookie expires. The value: time()+86400*30, will set the cookie to expire in 30 days. If this parameter is omitted or set to 0, the cookie will expire at the end of the session (when the browser closes). Default is 0</td>
  </tr>
  <tr>
    <td><em>path</em></td>
    <td>Optional. Specifies the server path of the cookie.
    If set to &quot;/&quot;, the cookie will be available within the entire domain. If set to &quot;/php/&quot;, the cookie will only be available within the php directory and all sub-directories of php. The default value is the current directory that the cookie is being set in</td>
  </tr>
  <tr>
    <td><em>domain</em></td>
    <td>Optional. Specifies the domain name of the cookie. To make the cookie available on all subdomains of example.com, set domain to &quot;example.com&quot;. Setting it to www.example.com will make the cookie only available in the www subdomain</td>
  </tr>
  <tr>
    <td><em>secure</em></td>
    <td>Optional. Specifies whether or not the cookie should only be transmitted over a secure HTTPS connection. TRUE indicates that the cookie will only be set if a secure connection exists. Default is FALSE</td>
  </tr>
  <tr>
    <td><em>httponly</em></td>
    <td>Optional. If set to TRUE the cookie will be accessible only through the HTTP protocol (the cookie will not be accessible by scripting languages). This setting can help to reduce identity theft through XSS attacks. Default is FALSE</td>
  </tr>
</table>
<hr>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 5.5 - A Max-Age attribute was included in the Set-Cookie header sent to the client<br>PHP 5.2 - The httponly parameter was added</td>
</tr>
</table>
<hr>
...
<div class="w3-code notranslate">
 &lt;?php<br>$value = &quot;Hello world!&quot;;<br><br>// cookie will expire when the browser close<br>setcookie(&quot;myCookie&quot;, $value);<br><br>// cookie will expire in 1 hour<br>setcookie(&quot;myCookie&quot;, $value, time() + 3600);<br><br>// cookie will expire in 1 hour, and will only be available<br>// within the php directory + all sub-directories of php<br>setcookie(&quot;myCookie&quot;, $value, time() + 3600, &quot;/php/&quot;);<br>?&gt; <br>&lt;html&gt;<br>&lt;body&gt;<br><br>...some code...<br>
 <br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setcookie2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setcookie3">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 &lt;?php<br>// set the expiration date to one hour ago<br>setcookie(&quot;user&quot;, &quot;&quot;, time() - 3600);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie 'user' is deleted.&quot;;<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setcookie4">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 &lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(count($_COOKIE) &gt; 0) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies are enabled.&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies are disabled.&quot;;<br>}<br>?&gt;<br><br>
 &lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setcookie5">Run example &raquo;</a>
</div>
<hr>
<a href="php_ref_http.asp" class="w3-btn w3-white w3-border" title="PHP HTTP Reference">&#10094; PHP HTTP Reference</a>
</div>
