...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_switch1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Create a <code class="w3-codespan">switch</code> statement that will output "Hello"
if <code class="w3-codespan">$color</code> is "red", and "welcome"
if <code class="w3-codespan">$color</code> is "green".</p>
