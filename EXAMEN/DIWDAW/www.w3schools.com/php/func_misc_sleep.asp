...
echo date('h:i:s');<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_sleep">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>seconds</em></td>
    <td>Required. Specifies the number of seconds to delay the script</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">Returns 0 on success, or FALSE on error.<br><br>This function returns a non-zero value if the call was interrupted by a signal. On Windows, this value will always be <strong>192</strong>, which is the value of the WAIT_IO_COMPLETION constant within the Windows API. On other platforms, the return value will be the number of seconds left to sleep.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>Before PHP 5.3.4, this function always returns NULL when sleep has occurred on Windows.</td>
</tr>
</table>
<hr>
