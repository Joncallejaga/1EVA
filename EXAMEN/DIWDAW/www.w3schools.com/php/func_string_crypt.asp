...
<p>Constants:</p>
<ul>
  <li>[CRYPT_STD_DES] - Standard DES-based hash with two character salt from the alphabet &quot;./0-9A-Za-z&quot;. Using invalid characters in the salt will cause this function to fail.</li>
  <li>[CRYPT_EXT_DES] - Extended DES-based hash with a nine character salt consisting of an underscore followed by 4 bytes of iteration count and 4 bytes of salt. These are encoded as printable characters, 6 bits per character, least significant character first. The values 0 to 63 are encoded as &quot;./0-9A-Za-z&quot;. Using invalid characters in the salt will cause the function to fail.</li>
  <li>[CRYPT_MD5] - MD5 hashing with a 12 character salt starting with $1$</li>
  <li>[CRYPT_BLOWFISH] - Blowfish hashing with a salt starting with $2a$,&nbsp; $2x$, or $2y$, a two digit cost parameters &quot;$&quot;, and 22 characters from the alphabet &quot;./0-9A-Za-z&quot;. Using characters outside of the alphabet will cause this function to return a zero-length string. The &quot;$&quot; parameter is the base-2 logarithm of the iteration count for the underlying Blowfish-bashed hashing algorithmeter and must be in range 04-31. Values outside this range will cause the function to fail.</li>
  <li>[CRYPT_SHA_256] - SHA-256 hash with a 16 character salt starting with&nbsp; $5$. If the salt string starts with &quot;rounds=&lt;N&gt;$&quot;, the numeric value of N is used to indicate how many times the hashing loop should be executed, much like the cost parameter on Blowfish. The default number of rounds is 5000, there is a minimum of 1000 and a maximum of 999,999,999. Any selection of N outside this range will be truncated to the nearest limit.</li>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>salt</em></td>
    <td>Optional. A salt string to base the hashing on </td>
  </tr>
  </table>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the encoded string or a string that is shorter than 13 characters and is guaranteed to differ from the salt on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>$2x$ and $2y$ Blowfish modes were added in PHP 5.3.7 to deal with potential high-bit attacks. <br><br>The constants SHA-256 and SHA-512 were added in PHP 5.3.2.<br><br>As of PHP 5.3.2, Blowfish behaviour on invalid rounds returns the &quot;failure&quot; string (&quot;*0&quot; or &quot;*1&quot;), instead of falling back to DES.<br><br>As of PHP 5.3.0, PHP contains its own implementation for the MD5 crypt, Standard DES, Extended DES and the Blowfish algorithms and will use that if the system lacks of support for one or more of the algorithms. </td>
</tr>
</table>
<hr>
...
&lt;?php<br>// 2 character salt<br>
 ...
 // 4 character salt<br>if (CRYPT_EXT_DES == 1)<br>{<br>echo &quot;Extended DES: &quot;.crypt('something','_S4..some').&quot;\n&lt;br&gt;&quot;;<br>}<br>else<br>{<br>echo &quot;Extended DES not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// 12 character salt starting with $1$ <br>if (CRYPT_MD5 == 1)<br>{<br>echo &quot;MD5: &quot;.crypt('something','$1$somethin$').&quot;\n&lt;br&gt;&quot;; <br>}<br>else<br>{<br>echo &quot;MD5 not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// Salt starting with $2a$. The two digit cost parameter: 09. 22 characters <br>if (CRYPT_BLOWFISH == 1)<br>{<br>
 echo &quot;Blowfish: &quot;.crypt('something','$2a$09$anexamplestringforsalt$').&quot;\n&lt;br&gt;&quot;;
 <br>}<br>else<br>{<br>echo &quot;Blowfish DES not supported.\n&lt;br&gt;&quot;;<br>}<br><br>
 // 16 character salt starting with $5$. The default number of rounds is 5000.<br>if (CRYPT_SHA256 == 1) <br>{<br>echo &quot;SHA-256: &quot;.crypt('something','$5$rounds=5000$anexamplestringforsalt$').&quot;\n&lt;br&gt;&quot;; }<br>
 else<br>{<br>echo &quot;SHA-256 not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// 16 character salt starting with $6$. The default number of rounds is 5000.<br>
 if (CRYPT_SHA512 == 1) <br>{<br>echo &quot;SHA-512: &quot;.crypt('something','$6$rounds=5000$anexamplestringforsalt$'); <br>}<br>else<br>
 {<br>echo &quot;SHA-512 not supported.&quot;;<br>}<br>
?&gt;</div>
<p>The output of the code above could be (depending on the operating system):</p>
<div class="w3-code notranslate">

 Standard DES: stqAdD7zlbByI<br>Extended DES: _S4..someQXidlBpTUu6<br>MD5: $1$somethin$4NZKrUlY6r7K7.rdEOZ0w.<br>Blowfish: $2a$09$anexamplestringforsaleLouKejcjRlExmf1671qw3Khl49R3dfu<br>SHA-256: $5$rounds=5000$anexamplestringf$KIrctqsxo2wrPg5Ag/hs4jTi4PmoNKQUGWFXlVy9vu9<br>
 SHA-512: $6$rounds=5000$anexamplestringf$Oo0skOAdUFXkQxJpwzO05wgRHG0dhuaPBaOU/<br>
