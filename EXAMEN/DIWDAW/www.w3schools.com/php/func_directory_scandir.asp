...
<p><a href="php_ref_directory.asp" class="w3-btn w3-white w3-border" title="PHP Directory">&#10094; PHP Directory Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>List files and directories inside the images directory:</p>
<div class="w3-code notranslate">
&lt;?php<br>$dir = &quot;/images/&quot;;<br><br>// Sort in ascending order - this is default<br>$a = scandir($dir);<br><br>// Sort in descending order<br>$b = scandir($dir,1);<br><br>print_r($a);<br>print_r($b);<br>?&gt;</div>
<p>Result:</p>
<div class="w3-code notranslate">
 Array<br>(<br>[0] =&gt; .<br>[1] =&gt; ..<br>[2] =&gt; cat.gif<br>[3] =&gt; dog.gif<br>
 [4] =&gt; horse.gif<br>[5] =&gt; myimages<br>)<br>Array<br>(<br>[0] =&gt; myimages<br>[1] =&gt; horse.gif<br>[2] =&gt; dog.gif<br>[3] =&gt; cat.gif<br>[4] =&gt; ..<br>[5] =&gt; .<br>) 
</div>
<br>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the sorting order. Default sort order is alphabetical in ascending order (0). Set to SCANDIR_SORT_DESCENDING or 1 to sort in alphabetical descending order, or SCANDIR_SORT_NONE to return the result unsorted&nbsp; </td>
  </tr>
  <tr>
    <td><em>context</em></td>
    <td>Optional. Specifies the context of the directory handle. Context is a set of options that can modify the behavior of a stream</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns an array of files and directories on success. FALSE on failure. Throws an error of level E_WARNING if directory is not a directory</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.0+</td>
...
<a href="php_ref_directory.asp" class="w3-btn w3-white w3-border" title="PHP Directory">&#10094; PHP Directory Reference</a>
</div>
