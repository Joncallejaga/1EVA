...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_localeconv">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li>[p_sign_posn] - Formatting options:<ul>
    ...
    <li>1 - The + sign is placed in front of the quantity and  currency symbol</li>
    <li>2 - The + sign is placed after the quantity and currency symbol</li>
    <li>3 - The + sign is placed immediately in front of the  currency symbol</li>
  ...
  <li>[grouping] - Array displaying how numbers are grouped (example: 3 indicates 1 000 000)</li>
  <li>[mon_grouping] - Array displaying how monetary numbers are grouped (example: 2 indicates 1 00 00 00)</li>
</ul>
...
<tr>
 ...
 <td style="width:80%">Returns data based upon the current locale as set by setlocale()</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0.5+</td>
