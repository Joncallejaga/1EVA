...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strpbrk">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the string starting from the character found, otherwise it returns FALSE</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strpbrk2">Run example &raquo;</a>
</div>
<hr>
