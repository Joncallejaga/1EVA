...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_abs">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies a number. If the number is of type float, the return type is also float, otherwise it is integer</td>
  </tr>
  </table>
