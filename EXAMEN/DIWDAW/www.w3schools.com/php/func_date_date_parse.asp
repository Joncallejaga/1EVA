...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_parse">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an associative array containing information about the parsed date on success. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2+</td>
