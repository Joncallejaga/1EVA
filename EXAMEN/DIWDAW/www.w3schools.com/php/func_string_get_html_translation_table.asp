...
print_r (get_html_translation_table()); // HTML_SPECIALCHARS is default.<br>
 ?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_gethtmltranslationtab">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    <li>HTML_SPECIALCHARS - Default. Translates some characters that need  URL-encoding to be shown properly on a HTML page</li>
    <li>HTML_ENTITIES - Translates all characters that need URL-encoding to  be shown properly on a HTML page</li>
 </ul>
  </td>
  </tr>
  <tr>
 ...
 <p>The available quote styles are:</p>
 <ul>
    ...
    <li>ENT_NOQUOTES - Table will not contain entities for double and single  quotes</li>
 </ul>
...
<tr>
 ...
 <td style="width:80%">Returns the translation table as an array, with the original characters as keys and entities as values</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>The default value for the <em>character-set</em> parameter was changed to UTF-8 in PHP 5<br><br>The additional flags for specifying which doctype the table is for; ENT_HTML401, ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>The <em>character-set</em> parameter was added in PHP 5.3.4</td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
