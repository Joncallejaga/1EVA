...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_count_chars">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies the return modes. 0 is default. The different return modes are:<ul>
  <li>0 - an array with the ASCII value as key and number of occurrences as value</li>
  <li>1 - an array with the ASCII value as key and number of occurrences as value, only lists occurrences greater than zero</li>
  <li>2 - an array with the ASCII value as key and number of occurrences as value, only lists occurrences equal to zero are listed</li>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_count_chars2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_count_chars3">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 <br>foreach ($strArray as $key=&gt;$value)<br>&nbsp; {<br>echo "The character &lt;b&gt;'".chr($key)."'&lt;/b&gt; was found $value time(s)&lt;br&gt;";<br>&nbsp; }<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_count_chars4">Run example &raquo;</a>
</div>
<hr>
