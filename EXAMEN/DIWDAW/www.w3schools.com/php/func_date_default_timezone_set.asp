...
&lt;?php<br>
 date_default_timezone_set(&quot;Asia/Bangkok&quot;);<br>echo date_default_timezone_get();<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_default_tz_set">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the timezone to use, like &quot;UTC&quot; or &quot;Europe/Paris&quot;. List of valid timezones:
...
<tr>
 ...
 <td style="width:80%">Returns FALSE if the <em>timezone</em> is not valid. TRUE otherwise</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.1+</td>
...
<tr>
  <th>Changelog:</th>
  <td>From PHP 5.1.2+; This function started to validate the <em>timezone</em> parameter. From PHP 5.3+; Throws an E_WARNING instead of E_STRICT</td>
</tr>
</table>
<hr>
