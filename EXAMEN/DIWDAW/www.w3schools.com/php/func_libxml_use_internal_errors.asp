...
<hr>
<a href="php_ref_libxml.asp" class="w3-btn w3-white w3-border" title="PHP libxml Reference">&#10094; Complete PHP libxml Reference</a>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>user_errors</td>
    <td>Optional. Specifies if user error handling should be enabled. Default is FALSE</td>
  </tr>
  </table>
<br>
