...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>context</td>
    <td>Optional. Specifies the context of the file handle. Context is a set of options that can modify the behavior of a stream. Can be skipped by using NULL.</td>
  </tr>
  <tr>
    <td>start</td>
    <td>Optional. Specifies where in the file to start reading. This parameter was added in PHP 5.1</td>
  </tr>
  <tr>
    <td>max_length</td>
    <td>Optional. Specifies how many bytes to read. This parameter was added in PHP 5.1</td>
  </tr>
  </table>
<hr>
