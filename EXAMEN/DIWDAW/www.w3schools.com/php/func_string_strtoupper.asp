...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strtoupper">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  <li><a href="func_string_strtolower.asp">strtolower()</a> - converts a string to lowercase</li>
  <li><a href="func_string_lcfirst.asp">lcfirst()</a> - converts the first character of a string to lowercase</li>
  <li><a href="func_string_ucfirst.asp">ucfirst()</a> - converts the first character of a string to uppercase</li>
  <li><a href="func_string_ucwords.asp">ucwords() </a>- converts the first character of each word in a string to uppercase </li>
</ul>
<hr>
<h2>Syntax</h2>
