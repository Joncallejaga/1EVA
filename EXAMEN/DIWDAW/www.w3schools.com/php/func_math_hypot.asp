...
<h3>Example</h3>
<p>Calculate the hypotenuse of different right-angle triangles:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_hypot">Run example &raquo;</a>
</div>
<hr>
