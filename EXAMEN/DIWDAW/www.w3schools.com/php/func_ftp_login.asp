...
&lt;?php<br>// connect to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br><br>// login<br>if (@ftp_login($ftp_conn, $ftp_username, $ftp_userpass))<br>&nbsp; {<br>&nbsp; echo &quot;Connection established.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Couldn't establish a connection.&quot;;<br>&nbsp; }<br><br>// do something...<br><br>// close connection<br>ftp_close($ftp_conn); <br>?&gt;
</div>
</div>
<hr>
