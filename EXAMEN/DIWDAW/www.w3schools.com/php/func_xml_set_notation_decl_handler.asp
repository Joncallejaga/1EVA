...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies a variable containing the name of the notation declaration</td>
  </tr>
  <tr>
    <td>base</td>
    <td>Required. Specifies the base for resolving the system identifier (system_id) of the notation declaration. Currently, this is always NULL</td>
  </tr>
  <tr>
    <td>system_id</td>
    <td>Required. Specifies a variable containing the system identifier for the notation declaration</td>
  </tr>
  <tr>
    <td>public_id</td>
    <td>Required. Specifies a variable containing the public identifier for the notation declaration</td>
  </tr>
  </table>
<hr>
