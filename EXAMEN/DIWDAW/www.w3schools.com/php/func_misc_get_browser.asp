...
&lt;?php<br>echo $_SERVER['HTTP_USER_AGENT'];<br>$browser = get_browser();<br>
 print_r($browser);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_get_browser">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies the name of an HTTP user agent. Default is the value of $HTTP_USER_AGENT. You can bypass this parameter with NULL</td>
  </tr>
  <tr>
    <td><em>return_array</em></td>
    <td>Optional. If this parameter is set to TRUE, the function will return an array instead of an object</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns an object or an array with information about the user's browser on success, or FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
