...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strncasecmp">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Required. Specify the number of characters from each string to be used in the comparison</td>
  </tr>
  </table>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strncasecmp2">Run example &raquo;</a>
</div>
<hr>
