...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_repeat">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>repeat</em></td>
    <td>Required. Specifies the number of times the string will be repeated. Must be greater or equal to 0</td>
  </tr>
  </table>
