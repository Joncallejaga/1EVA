...
&lt;?php<br>
 $sun_info=date_sun_info(strtotime(&quot;2013-01-01&quot;),31.7667,35.2333);<br>foreach ($sun_info as $key=&gt;$val)<br>&nbsp; {<br>&nbsp; echo &quot;$key: &quot; . date(&quot;H:i:s&quot;,$val) . &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_sun_info">Run example &raquo;</a>
</div>
<hr>
