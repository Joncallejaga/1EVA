...
<p><a href="php_ref_array.asp" class="w3-btn w3-white w3-border" title="PHP Array Reference">&#10094; PHP Array Reference</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_each">Run example &raquo;</a>
</div>
<hr>
...
<p>Related methods:</p>
<ul>
  <li><a href="func_array_current.asp">current()</a> - returns the value of the current element in an array</li>
  <li><a href="func_array_end.asp">end()</a> - moves the internal pointer to, and outputs, the last element in the array</li>
  <li><a href="func_array_next.asp">next()</a> - moves the internal pointer to, and outputs, the next element in the array</li>
  <li><a href="func_array_prev.asp">prev()</a> - moves the internal pointer to, and outputs, the previous element in the array</li>
...
<tr>
 ...
 Returns the current element key and value. This element key and value is returned in an array with four elements. Two elements (1 and Value) for the element value, and two elements (0 and Key) for the element key. This function returns FALSE if there are no more array elements</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
&lt;?php<br>
 ...
 reset($people);<br><br>while (list($key, $val) = each($people))<br>&nbsp; {<br>&nbsp; echo &quot;$key =&gt; $val&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_each2">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
&lt;?php<br>
 $people = array(&quot;Peter&quot;, &quot;Joe&quot;, &quot;Glenn&quot;, &quot;Cleveland&quot;);<br><br>echo current($people) . &quot;&lt;br&gt;&quot;; // The current element is Peter<br>echo next($people) . &quot;&lt;br&gt;&quot;; // The next element of Peter is Joe<br>echo current($people) . &quot;&lt;br&gt;&quot;; // Now the current element is Joe<br>echo prev($people) . &quot;&lt;br&gt;&quot;; // The previous element of Joe is Peter<br>echo end($people) . &quot;&lt;br&gt;&quot;; // The last element is Cleveland<br>echo prev($people) . &quot;&lt;br&gt;&quot;; // The previous element of Cleveland is Glenn<br>echo current($people) . &quot;&lt;br&gt;&quot;; // Now the current element is Glenn<br>echo reset($people) . &quot;&lt;br&gt;&quot;; // Moves the internal pointer to the first element of the array, which is Peter<br>
 echo next($people) . &quot;&lt;br&gt;&quot;; // The next element of Peter is Joe<br><br>
 print_r (each($people)); // Returns the key and value of the current element (now Joe), and moves the internal pointer forward<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_internal_pointer">Run example &raquo;</a>
</div>
<hr>

<a href="php_ref_array.asp" class="w3-btn w3-white w3-border" title="PHP Array Reference">&#10094; PHP Array Reference</a>
</div>
