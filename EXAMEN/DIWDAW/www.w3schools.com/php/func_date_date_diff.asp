...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_diff">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a Boolean value. TRUE indicates that the interval/difference MUST be positive. Default is FALSE</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns a DateInterval object on success that represents the difference between the two dates. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.3+</td>
