...
&lt;?php<br>// connect to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br><br>// the two lines below is the same as: ftp_login($ftp_conn,&quot;john&quot;,&quot;secretpassword&quot;);<br>
 ftp_raw($ftp_conn, &quot;USER john&quot;);<br>ftp_raw($ftp_conn, &quot;PASS secretpassword&quot;);<br><br>?&gt;</div>
</div>
<hr>
