...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// then do something...<br><br>// close connection<br>ftp_close($ftp_conn); <br>?&gt;
</div>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>host</em></td>
    <td>Required. Specifies the FTP server to connect to. Can be a domain address or an IP address. This parameter should not be prefixed with &quot;ftp://&quot; or have any trailing slashes</td>
  </tr>
  <tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port of the FTP server. Default is port 21</td>
  </tr>
  <tr>
    <td><em>timeout</em></td>
    <td>Optional. Specifies the timeout for all subsequent network operations. Default is 90 seconds</td>
  </tr>
</table>
