...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// try to send SITE command<br>
 if (ftp_site($ftp_conn, &quot;chmod 777 serverfile.txt&quot;))<br>&nbsp; {<br>&nbsp; echo &quot;Command executed successfully&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Command failed&quot;;<br>&nbsp; }<br>
