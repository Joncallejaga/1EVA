...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>encoding</td>
    <td>Optional. Specifies the output encoding. Default in PHP 5.0.2 and newer is UTF-8<p>Possible values:</p>
 <ul>
    <li>ISO-8859-1</li>
    <li>UTF-8</li>
    <li>US-ASCII.</li>
 </ul>
 <p><b>Note:</b> In PHP 5, the input encoding is automatically detected. In PHP 4 and older versions, this paramterer specifies the character encoding for the input and output.</p>
 <p><b>Note: </b>In PHP 5.0.0 and 5.0.1, default output charset is ISO-8859-1.</td>
  </tr>
  <tr>
    <td>separator</td>
    <td>Optional. Specifies the output separator for tag name and namespace. Default is &quot; : &quot;</td>
  </tr>
  </table>
<hr>
