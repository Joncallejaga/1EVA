...
<p><a href="php_ref_math.asp" class="w3-btn w3-white w3-border" title="PHP Math Reference">&#10094; PHP Math Reference</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_round">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the number of decimal digits to round to. Default is 0</td>
  </tr>
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies a constant to specify the rounding mode:
 <ul>
    <li>PHP_ROUND_HALF_UP - Default. Rounds <em>number</em> up to <em>precision</em>  decimal, when it is half way there. Rounds 1.5 to 2 and -1.5 to -2</li>
    <li>PHP_ROUND_HALF_DOWN - Round <em>number</em> down to <em>precision</em>  decimal places, when it is half way there. Rounds 1.5 to 1 and -1.5 to -1</li>
    <li>PHP_ROUND_HALF_EVEN - Round <em>number</em> to <em>precision</em> decimal  places towards the next even value</li>
    <li>PHP_ROUND_HALF_ODD - Round <em>number</em> to <em>precision</em>  decimal places towards the next odd value</li>
 </ul>
   </td>
  </tr>
  </table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_round2">Run example &raquo;</a>
</div>
<br>
<div class="w3-example">
<h3>Example 2</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_round3">Run example &raquo;</a>
</div>
<hr>
<a href="php_ref_math.asp" class="w3-btn w3-white w3-border" title="PHP Math Reference">&#10094; PHP Math Reference</a>
</div>
