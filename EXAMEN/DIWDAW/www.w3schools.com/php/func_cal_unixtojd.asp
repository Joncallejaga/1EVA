...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_unixtojd">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the Julian Day number for a Unix timestamp (seconds since 1.1.1970), or for the current day if no <em>timestamp</em> is given</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
