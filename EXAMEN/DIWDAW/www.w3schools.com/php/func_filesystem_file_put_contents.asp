...
<ol>
  <li>If FILE_USE_INCLUDE_PATH is set, check the include path for a copy of *filename*</li>
  <li>Create the file if it does not exist</li>
  <li>Open the file</li>
  <li>Lock the file if LOCK_EX is set</li>
  <li>If FILE_APPEND is set, move to the end of the file. Otherwise, clear the file content</li>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the file to write to. If the file does not exist, this function will create one </td>
  </tr>
  <tr>
    <td>data</td>
    <td>Required. The data to write to the file. Can be a string, an array or a data stream</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>Optional. Specifies how to open/write to the file. Possible values:<ul>
