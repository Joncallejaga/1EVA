...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_nl2br">Run example &raquo;</a>
</div>
<hr>
...
<tr>
    <td><em>xhtml&nbsp;</em></td>
    <td>Optional. A boolean value that indicates whether or not to use XHTML compatible line breaks:
 <ul>
...
4.0.5 it inserts the XHTML compliant &lt;br /&gt;<br><br>The <em>xhtml</em> parameter was added in PHP 5.3.</td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_nl2br2">Run example &raquo;</a>
</div>
<hr>
