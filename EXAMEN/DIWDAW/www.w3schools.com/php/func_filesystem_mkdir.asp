...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>mode</td>
    <td>Optional. Specifies permissions. By default, the mode is 0777 (widest possible access).<p>The mode parameter consists of four numbers:</p>
 <ul>
 ...
 <ul>
  ...
  <tr>
    <td>recursive</td>
    <td>Optional. Specifies if the recursive mode is set (added in PHP 5)</td>
  </tr>
  <tr>
    <td>context</td>
    <td>Optional. Specifies the context of the file handle. Context is a set of options that can modify the behavior of a stream (added in PHP 5)</td>
  </tr>
  </table>
<hr>
