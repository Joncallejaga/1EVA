...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strcspn">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the length of the string (how much of the string to search)</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the number of characters found in a string before any part of the specified characters are found</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
&lt;?php<br>
echo strcspn(&quot;Hello world!&quot;,&quot;w&quot;,0,6); // The start position is 0 and the length of the search string is 6.<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strcspn2">Run example &raquo;</a>
</div>
<hr>
