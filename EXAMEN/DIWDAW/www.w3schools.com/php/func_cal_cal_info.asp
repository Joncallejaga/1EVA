...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_cal_info">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a number that indicates which calendar to return information about:
 <ul>
   ...
   <p><strong>Tip:</strong> If the <em>calendar</em> parameter is omitted,   cal_info() returns info about all calendars</p>
   </td>
  </tr>
  </table>
