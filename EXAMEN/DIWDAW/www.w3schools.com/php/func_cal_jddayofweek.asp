...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_jddayofweek">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <ul>
    <li>0 - Default. Returns the weekday as an integer (0=Sunday, 1=Monday,  etc.)</li>
    <li>1 - Returns the weekday as a string (Sunday, Monday, etc.)</li>
    <li>2 - Returns the weekday as a string, abbreviated form (Sun, Mon,  etc.)</li>
 </ul>
   </td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the Gregorian weekday as a string or integer (depends on the <em>mode</em> parameter)</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
