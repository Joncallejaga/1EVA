...
<p><a href="php_ref_filter.asp" class="w3-btn w3-white w3-border" title="PHP Filter Reference">&#10094; PHP Filter Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check if the variable $url is a valid URL:</p>
<div class="w3-code notranslate">
 &lt;?php<br>$url = &quot;https://www.w3schools.com&quot;;<br><br>if (filter_var($url, FILTER_VALIDATE_URL)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is a valid URL&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is not a valid URL&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_url">Run example &raquo;</a>
</div>
<hr>
...
<p>Possible&nbsp; flags:</p>
<ul>
  <li>FILTER_FLAG_SCHEME_REQUIRED - URL must be RFC compliant (like http://example)</li>
  <li>FILTER_FLAG_HOST_REQUIRED - URL must include host name (like http://www.example.com)</li>
  <li>FILTER_FLAG_PATH_REQUIRED - URL must have a path after the domain name (like www.example.com/example1/)</li>
...
<div class="w3-code notranslate">
 &lt;?php<br>$url = &quot;https://www.w3schools.com&quot;;<br><br>// Remove all illegal characters from a url<br>$url = filter_var($url, FILTER_SANITIZE_URL);<br>
 <br>// Validate url<br>if (filter_var($url, FILTER_VALIDATE_URL)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is a valid URL&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is not a valid URL&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_url2">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate">
 &lt;?php<br>$url = &quot;https://www.w3schools.com&quot;;<br><br>if (filter_var($url, FILTER_VALIDATE_URL, FILTER_FLAG_QUERY_REQUIRED)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is a valid URL&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$url is not a valid URL&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_url3">Run example &raquo;</a>
</div>

<hr>
<a href="php_ref_filter.asp" class="w3-btn w3-white w3-border" title="PHP Filter Reference">&#10094; PHP Filter Reference</a>
</div>
