...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>lock</td>
    <td>Required. Specifies what kind of lock to use.<p>Possible values:</p>
 <ul>
    <li>LOCK_SH - Shared lock (reader). Allow other processes to access the  file</li>
    <li>LOCK_EX - Exclusive lock (writer). Prevent other  processes from accessing the file</li>
