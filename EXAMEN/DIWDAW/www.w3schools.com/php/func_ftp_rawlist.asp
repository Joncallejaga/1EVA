...
<p><a href="php_ref_ftp.asp" class="w3-btn w3-white w3-border" title="PHP FTP Reference">&#10094; PHP FTP Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Get list of files with file information:</p>
<div class="w3-code notranslate">
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get the file list for /<br>$filelist = ftp_rawlist($ftp_conn, &quot;/&quot;);<br><br>// close connection<br>ftp_close($ftp_conn);<br>
...
array(3)<br> 
{<br>
[0] =&gt; string(57) &quot;drw-rw-rw- 1 user group 0 Jan 03 08:33 images&quot;<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the directory path. May include arguments for the LIST command. <strong>Tip:</strong> Use &quot;.&quot; to specify the current directory</td>
  </tr>
  <tr>
    <td><em>recursive</em></td>
    <td>Optional. By default, this function sends a &quot;LIST&quot; command to the server. However, if the recursive parameter is set to TRUE, it sends a &quot;LIST -R&quot; command</td>
  </tr>
</table>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an array where each element corresponds to one line of text. No parsing is performed</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<a href="php_ref_ftp.asp" class="w3-btn w3-white w3-border" title="PHP FTP Reference">&#10094; PHP FTP Reference</a>
</div>
