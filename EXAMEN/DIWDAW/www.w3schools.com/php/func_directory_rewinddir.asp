...
&lt;?php<br>$dir = &quot;/images/&quot;;<br><br>// Open a directory, and read its contents<br>if (is_dir($dir)){<br>&nbsp; if ($dh = opendir($dir)){<br>&nbsp;&nbsp;&nbsp; // List files in images directory<br>&nbsp;&nbsp;&nbsp; while (($file = readdir($dh)) !== false){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;filename:&quot; . $file . &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp; rewinddir();<br>&nbsp;&nbsp;&nbsp; // List once again files in images directory<br>&nbsp;&nbsp;&nbsp; while (($file = readdir($dh)) !== false){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;filename:&quot; . $file . &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp; closedir($dh);<br>&nbsp; }<br>}<br>?&gt;</div>
<p>Result:</p>
<div class="w3-code notranslate">
filename: cat.gif<br>
filename: dog.gif<br>
...
<table class="w3-table-all notranslate"> 
 ...
 <a href="func_directory_opendir.asp">opendir()</a>. If this parameter is not specified, the last link opened by opendir() is assumed</td>
  </tr>
  </table>
