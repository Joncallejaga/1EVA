...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_count_values">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an associative array, where the keys are the original array's values, and the values are the number of occurrences</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
