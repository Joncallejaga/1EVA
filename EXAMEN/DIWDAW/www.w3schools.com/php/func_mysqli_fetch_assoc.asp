...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 ...
 $row=mysqli_fetch_assoc($result);<br>printf (&quot;%s (%s)\n&quot;,$row[&quot;Lastname&quot;],$row[&quot;Age&quot;]);<br>
...
<tr>
 ...
 <td style="width:80%">Returns an associative array of strings representing the fetched row. NULL if there are no more rows in result-set</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
