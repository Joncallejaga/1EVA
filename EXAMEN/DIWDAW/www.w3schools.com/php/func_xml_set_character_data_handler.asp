...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>handler</td>
    <td>Required. Specifies a function to be used as an event handler</td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>data</td>
    <td>Required. Specifies a variable containing the character data from the XML file as a string</td>
  </tr>
  </table>
<hr>
