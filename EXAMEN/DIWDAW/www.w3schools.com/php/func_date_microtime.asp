...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_microtime">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. When set to TRUE it specifies that the function should return a float, instead of a string. Default is FALSE</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the string &quot;microsec sec&quot; by default, where sec is the number of seconds since the Unix Epoch (0:00:00 January 1, 1970 GMT), and microsec is the microseconds part. If the
 <em>get_as_float</em> parameter is set to TRUE, it returns a float representing the current time in seconds since the Unix epoch accurate to the nearest microsecond</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
