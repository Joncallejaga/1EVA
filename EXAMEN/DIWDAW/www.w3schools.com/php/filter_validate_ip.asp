...
<div class="w3-code notranslate">
 &lt;?php<br>$ip = &quot;127.0.0.1&quot;;<br><br>if (filter_var($ip, FILTER_VALIDATE_IP)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is a valid IP address&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is not a valid IP address&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_ip">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li>FILTER_FLAG_NO_RES_RANGE - The value must not be within a reserved range</li>
</ul>
<hr>
...
<div class="w3-code notranslate">
 &lt;?php<br>$ip = &quot;2001:0db8:85a3:08d3:1319:8a2e:0370:7334&quot;;<br><br>
  if (filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is a valid IPv6 address&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is not a valid IPv6 address&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_validate_ip2">Run example &raquo;</a>
</div>
