...
<h3>Example</h3>
<p>Filter the values of an array using a callback function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_filter">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies the callback function to use</td>
  </tr>
  <tr>
    <td><em>flag</em></td>
    <td>Optional. Specifies what arguments are sent to callback:
    <ul>
      <li>ARRAY_FILTER_USE_KEY - pass key as the only argument to callback (instead of 
    the value)</li>
      <li>ARRAY_FILTER_USE_BOTH - pass both value and key as arguments 
