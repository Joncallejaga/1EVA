...
<div class="w3-code notranslate">
  &lt;?php<br>$str = '&amp;lt;a href=&amp;quot;https://www.w3schools.com&amp;quot;&amp;gt;w3schools.com&amp;lt;/a&amp;gt;';<br>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    ...
    <li>ISO-8859-15 - Western European (adds the Euro sign + French and Finnish 
    letters missing in ISO-8859-1)</li>
...
<tr>
  <th>Changelog:</th>
  <td>The default value for the <em>character-set</em> parameter was changed to 
  UTF-8 in PHP 5<br><br>The additional flags for specifying the used doctype; 
  ENT_HTML401, ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>
  Support for multi-byte encodings was added in PHP 5.0<br></td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
...
<div class="w3-code notranslate">
  ...
  &lt;?php<br>
  $str = "Albert Einstein said: &amp;#039;E=MC&amp;sup2;&amp;#039;";<br>echo 
  html_entity_decode($str, ENT_COMPAT); // Will only convert double quotes<br>
  echo "&lt;br&gt;";<br>echo html_entity_decode($str, ENT_QUOTES); // Converts double 
  and single quotes<br>
  echo "&lt;br&gt;";<br>echo html_entity_decode($str, ENT_NOQUOTES); // Does not 
  convert any quotes<br>
  ?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
  Albert Einstein said: &amp;#039;E=MC²&amp;#039;&lt;br&gt;<br>Albert Einstein said: 'E=MC²'&lt;br&gt;<br>
  Albert Einstein said: &amp;#039;E=MC²&amp;#039;</div>
<p>The browser output of the code above will be:</p>
<div class="w3-code notranslate">
...
<div class="w3-code notranslate">
  ...
  echo html_entity_decode($str, ENT_QUOTES, "UTF-8");<br>
  ?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
