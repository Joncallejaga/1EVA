...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>target</td>
    <td>Required. Specifies a variable containing processing instruction target</td>
  </tr>
  <tr>
    <td>data</td>
    <td>Required. Specifies a variable containing processing instruction data</td>
  </tr>
 </table>
<hr>
