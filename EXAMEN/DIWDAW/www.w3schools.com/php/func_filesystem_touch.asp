...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>time</td>
    <td>Optional. Sets the time. The current system time is set by default</td>
  </tr>
  <tr>
    <td>atime</td>
    <td>Optional. Sets the access time. Default is the current system time if no parameters are set, or the same as the time parameter if that parameter is set</td>
  </tr>
  </table>
<hr>
