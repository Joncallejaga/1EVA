...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;somefile.txt&quot;;<br>
 <br>// get the last modified time<br>$lastchanged = ftp_mdtm($ftp_conn, $file);<br>if ($lastchanged != -1)<br>&nbsp; {<br>&nbsp; echo &quot;$file was last modified on : &quot; . date(&quot;F d Y H:i:s.&quot;,$lastchanged);<br>&nbsp; }<br>
 else<br>&nbsp; {<br>&nbsp; echo &quot;Could not get last modified&quot;;<br>&nbsp; }<br>
...
<tr>
 ...
 <td style="width:80%">Returns the last modified time as a Unix timestamp, or -1 on error</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
