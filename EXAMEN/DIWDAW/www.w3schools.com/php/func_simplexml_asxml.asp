...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_simplexml_asxml">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. If specified, the function writes the data to the file, instead of returning the string</td>
  </tr>
  </table>
...
<tr>
 ...
 filename</em> parameter is specified, it returns TRUE on success, FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.0.1+</td>
