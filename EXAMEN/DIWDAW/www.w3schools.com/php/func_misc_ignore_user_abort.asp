...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>setting</em></td>
    <td>Optional. TRUE ignores user aborts in a script (the script will continue to run). This is FALSE by default, meaning that client aborts will cause the script to stop running </td>
  </tr>
  </table>
