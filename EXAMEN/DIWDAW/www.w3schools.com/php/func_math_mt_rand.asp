...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_mt_rand">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">A random integer between <em>min</em> (or 0) and <em>max</em> (or mt_getrandmax() inclusive). Returns FALSE if <em>max</em> &lt; <em>min</em></td>
</tr>
<tr>
  <th>Return Type:</th>
  <td>Integer</td>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 4.2.0: Random number generator is seeded automatically<br>PHP 5.3.4: Issues an E_WARNING and returns FALSE if <em>max</em> &lt; <em>min</em></td>
</tr>
</table>
<hr>
