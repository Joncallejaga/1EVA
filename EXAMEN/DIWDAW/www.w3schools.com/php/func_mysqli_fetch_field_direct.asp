...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Get field information for &quot;Age&quot;<br>&nbsp; $fieldinfo=mysqli_fetch_field_direct($result,1);<br>
 <br>&nbsp; printf(&quot;Name: %s\n&quot;,$fieldinfo-&gt;name);<br>&nbsp; printf(&quot;Table: %s\n&quot;,$fieldinfo-&gt;table);<br>&nbsp; printf(&quot;max. Len: %d\n&quot;,$fieldinfo-&gt;max_length);<br><br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>}<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>fieldnr</em></td>
    <td>Required. Specifies the field number. Must be an integer between 0 and number of fields - 1</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns an object containing field definition information. FALSE if no info is available. The object has the following properties:
 <ul>
