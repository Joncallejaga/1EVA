...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strtolower">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  <li><a href="func_string_strtoupper.asp">strtoupper()</a> - converts a string to uppercase</li>
