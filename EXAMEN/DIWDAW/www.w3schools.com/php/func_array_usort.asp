...
&lt;?php<br>
 function my_sort($a,$b)<br>{<br>if ($a==$b) return 0;<br>return ($a&lt;$b)?-1:1;<br>}<br><br>$a=array(4,2,8,6);<br>usort($a,&quot;my_sort&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_usort">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The usort() function sorts an array using a user-defined comparison function.</p>
