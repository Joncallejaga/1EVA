...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_filter_id">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the filter ID on success, or FALSE if the filter does not exist</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2.0+</td>
...
available filters:</p>
<div class="w3-code notranslate">
 &lt;table&gt;<br>&nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;td&gt;Filter Name&lt;/td&gt;<br>&nbsp;&nbsp;&nbsp; &lt;td&gt;Filter ID&lt;/td&gt;<br>&nbsp; &lt;/tr&gt;<br>&nbsp; &lt;?php<br>&nbsp; foreach (filter_list() as $id =&gt;$filter) {<br>&nbsp;&nbsp;&nbsp; echo '&lt;tr&gt;&lt;td&gt;' . $filter . '&lt;/td&gt;&lt;td&gt;' . filter_id($filter) . '&lt;/td&gt;&lt;/tr&gt;';<br>&nbsp; }<br>?&gt;<br>
 &lt;/table&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_filter_id2">Run example &raquo;</a>
</div>
