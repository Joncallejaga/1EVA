...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strtr">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>from</em></td>
    <td>Required (unless array is used). Specifies what characters to change</td>
  </tr>
  <tr>
    <td><em>to</em></td>
    <td>Required (unless array is used). Specifies what characters to change into</td>
  </tr>
  <tr>
    <td><em>array</em></td>
    <td>Required (unless to and from is used). An array containing what to change from as key, and what to change to as value</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the translated string. <br>If the <em>array</em> parameter contains a key which is an empty string (&quot;&quot;), it will return FALSE.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strtr2">Run example &raquo;</a>
</div>
<hr>
