...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the name of the function to be run when an uncaught exception occurs. NULL can be passed instead, to reset this handler to its default state</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">A string that contains the previously defined exception handler, or NULL on error or if no previous handler was defined</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.0+</td>
...
<tr>
  <th>PHP Changelog:</th>
  <td>Previously, if NULL was passed then this function returned TRUE. It returns the previous handler since PHP 5.5</td>
</tr>
</table>
<hr>
