...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies on which error report level the user-defined error will be shown. Default is &quot;E_ALL&quot;</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A string that contains the previously defined error handler</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0.1+</td>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 5.5: The parameter <em>errorhandler</em> now accepts NULL<br>PHP 5.2: The error handler must return FALSE to populate $php_errormsg</td>
</tr>
</table>
<hr>
