...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>handler</td>
    <td>Required. Specifies a function to be called when the parser finds an external entity</td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies a variable containing the name of the external entity</td>
  </tr>
  <tr>
    <td>base</td>
    <td>Required. Specifies the base for resolving the system identifier (system_id) of the external entity. Currently, this is always NULL</td>
  </tr>
  <tr>
    <td>system_id</td>
    <td>Required. Specifies the system identifier for the external entity</td>
  </tr>
  <tr>
    <td>public_id</td>
    <td>Required. Specifies the public identifier for the external entity</td>
  </tr>
  </table>
<hr>
