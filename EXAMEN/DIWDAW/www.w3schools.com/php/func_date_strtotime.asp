...
<p><a href="php_ref_date.asp" class="w3-btn w3-white w3-border" title="PHP Date/Time">&#10094; PHP Date/Time Reference</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_strtotime">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>now</em></td>
    <td>Optional. Specifies the timestamp used as a base for the calculation of relative dates</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns a timestamp on success. FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>PHP 5.3.0: Now relative time formats such as this week, previous week, last week, and next week interprets a week period of Monday through Sunday, rather then a 7-day period relative to the current date/time<br>PHP 5.3.0: Now 24:00 is a valid format<br>PHP 5.2.7: In earlier versions, if requesting a given occurrence of a given weekday in a month where that weekday was the first day of the month it would incorrectly add one week to the returned timestamp. This has been corrected now<br>PHP 5.1.0: Returns FALSE on failure (earlier versions returns -1), and issues E_STRICT and E_NOTICE time zone errors<br>PHP 5.0.2: Now correctly computes &quot;now&quot; and other relative times from current time, not from today's midnight <br>PHP 5.0.0: Allows microseconds (but they are ignored)</td>
</tr>
</table>
<hr>

<a href="php_ref_date.asp" class="w3-btn w3-white w3-border" title="PHP Date/Time">&#10094; PHP Date/Time Reference</a>
</div>
