...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_substr_replace">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies how many characters should be replaced. Default is the same length as the string.<ul>
    <li>A positive number - The length of string to be replaced</li>
    <li>A negative number - How many characters should be left at end of string  after replacing</li>
...
<tr>
 ...
 <td style="width:80%">Returns the replaced string. If the string is an array then the array is returned</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_substr_replace2">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_substr_replace3">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_substr_replace4">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 ?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_substr_replace5">Run example &raquo;</a>
</div>
<hr>
