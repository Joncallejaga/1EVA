...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_convert_uudecode">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
 ...
 &lt;?php<br>$str = &quot;Hello world!&quot;;<br>// Encode the string<br>$encodeString = convert_uuencode($str);<br>echo $encodeString . &quot;&lt;br&gt;&quot;;<br><br>// Decode the string<br>$decodeString = convert_uudecode($encodeString);<br>echo $decodeString;<br>
 ?&gt; 
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_convert_encode_decode">Run example &raquo;</a>
</div>
<hr>
