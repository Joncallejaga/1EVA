...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_define">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies whether the constant name should be case-insensitive. Possible values:<ul>
  <li>TRUE - Case-insensitive</li>
  <li>FALSE - Default. Case-sensitive</li></ul></td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_define2">Run example &raquo;</a>
</div>
