...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_setlocale">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    ...
    <li>LC_CTYPE - Character classification and conversion (e.g. all  characters should be lower or upper-case)</li>
  ...
  <tr>
    ...
    <td>Required. Specifies what country/region to set the locale information to. Can be a string or an array. It is possible to pass multiple locations.<br><br>If the location is NULL or the empty string &quot;&quot;, the location names will be set from the values of environment variables with the same names as the constants above, or from &quot;LANG&quot;.<br><br>If the location is &quot;0&quot;, the location setting is not affected, only the current setting is returned.<br><br>If the location is an array, setlocale() will try each array element until it finds a valid language or region code. This is very useful if a region is known under different names on different systems.<p><b>Note:</b> To view all available language codes, go to our <a href="../tags/ref_language_codes.asp" target="_blank">Language code reference.</a></td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the current locale settings, or FALSE on failure. The return value depends on the system that PHP is running.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>Passing constant as a string was deprecated in PHP 4.2.0. Use the available constants instead. Passing them as a string will result in a warning message. <br><br>Passing multiple <em>locations</em> became possible in PHP 4.3.0.<br><br>If a string is passed to the constant parameter instead of one of the LC_ constants, this function throws an E_DREPRECATED notice as of PHP 5.3.0.</td>
</tr>
</table>
