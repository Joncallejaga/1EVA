...
<tr>
 ...
 <td style="width:80%">Returns an associative array describing the last error with keys: type, message, file, and line. Returns NULL if no error has occurred yet</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2+</td>
