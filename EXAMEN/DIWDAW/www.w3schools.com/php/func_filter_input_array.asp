...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies an array of filter arguments. A valid array key is a variable name, and a valid value is a filter name or ID, or an array specifying the filter, flags and options. This parameter can also be a single filter name/ID; then all values in the input array are filtered by the specified filter</td>
  </tr>
  <tr>
    <td><em>add_empty</em></td>
    <td>Optional. A Boolean value. When set to TRUE it add missing keys as NULL to the return value. Default value is TRUE</td>
  </tr>
  </table>
<hr>
...
<hr>
<a href="php_ref_filter.asp" class="w3-btn w3-white w3-border" title="PHP Filter Reference">&#10094; Complete PHP Filter Reference</a>
</div>
