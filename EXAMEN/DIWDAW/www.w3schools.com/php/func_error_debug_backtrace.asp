...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>options</em></td>
    <td>
 <p>Optional. Specifies a bitmask for the following options:<br>DEBUG_BACKTRACE_PROVIDE_OBJECT (Whether or not to populate the &quot;object&quot; index<br>DEBUG_BACKTRACE_IGNORE_ARGS (Whether or not to omit the &quot;args&quot; index, and all the function/method arguments, to save memory)</p>
   </td>
  </tr>
  <tr>
    <td><em>limit</em></td>
    <td>Optional. Limits the number of stack frames printed. By default (limit=0) it prints all stack frames </td>
  </tr>
</table>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 5.4: The optional parameter <em>limit</em> was added<br>PHP 5.3.6: The parameter <em>provide_object</em> was changed to <em>options</em> and additional option DEBUG_BACKTRACE_IGNORE_ARGS is added<br>PHP 5.2.5: The optional parameter <em>provide_object</em> was added<br>PHP 5.1.1: Added the current object as a possible return element<br></td>
</tr>
</table>
<hr>
