...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_merge_recursive">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_merge_recursive() function merges one or more arrays into one array.</p>
