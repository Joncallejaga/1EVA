...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get system type<br>if ($type = ftp_systype($ftp_conn))<br>&nbsp; {<br>&nbsp; echo &quot;System type is: $type&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Could not get system type.&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
...
<tr>
 ...
 <td style="width:80%">Returns the system type on success, or FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
