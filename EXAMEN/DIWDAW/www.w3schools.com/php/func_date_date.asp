...
&lt;?php<br>
 // Prints the day<br>echo date(&quot;l&quot;) . &quot;&lt;br&gt;&quot;;<br><br>// Prints the day, date, month, year, time, AM or PM<br>echo date(&quot;l jS \of F Y h:i:s A&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date">Run example &raquo;</a>
</div>
<hr>
