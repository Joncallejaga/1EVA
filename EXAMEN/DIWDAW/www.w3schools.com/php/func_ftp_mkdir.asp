...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$dir = &quot;images&quot;;<br>
 <br>// try to create directory $dir<br>if (ftp_mkdir($ftp_conn, $dir))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully created $dir&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error while creating $dir&quot;;<br>&nbsp; }<br>
