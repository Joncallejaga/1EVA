...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_shift">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the value of the removed element from an array, or NULL if the array is empty</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_shift2">Run example &raquo;</a>
</div>
<hr>
