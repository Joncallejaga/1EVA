...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_date_default_tz_get">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>From PHP 5.4+; The timezone is no longer guessed from information in OS, and the TZ variable is no longer used</td>
</tr>
</table>
<hr>
