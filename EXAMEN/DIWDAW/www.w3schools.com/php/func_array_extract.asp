...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_extract">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. The extract() function checks for invalid variable names and collisions with existing variable names. This parameter specifies how invalid and colliding names are treated.<p>Possible values:</p>
 <ul>
    <li>EXTR_OVERWRITE - Default. On collision, the existing variable is  overwritten</li>
    <li>EXTR_SKIP - On collision, the existing variable is not overwritten</li>
    <li>EXTR_PREFIX_SAME - On collision, the variable name will be given a  prefix</li>
    <li>EXTR_PREFIX_ALL - All variable names will be given a prefix</li>
    <li>EXTR_PREFIX_INVALID - Only invalid or numeric variable names will be  given a prefix</li>
    <li>EXTR_IF_EXISTS - Only overwrite existing variables in the current  symbol table, otherwise do nothing</li>
    <li>EXTR_PREFIX_IF_EXISTS - Only add prefix to variables if the same  variable exists in the current symbol table</li>
    <li>EXTR_REFS - Extracts variables as references. The imported variables  are still referencing the values of the array parameter</li>
 </ul>
    </td>
  </tr>
  <tr>
    <td><em>prefix</em></td>
    <td>Optional. If EXTR_PREFIX_SAME, EXTR_PREFIX_ALL, EXTR_PREFIX_INVALID or EXTR_PREFIX_IF_EXISTS are used in the extract_rules parameter, a specified prefix is required.
    <br><br>This parameter specifies the prefix. The prefix is automatically separated from the array key by an underscore character.</td>
  </tr>
</table>
<hr>
...
<tr>
 ...
 The <em>extract_rules</em> values EXTR_IF_EXISTS and EXTR_PREFIX_IF_EXISTS were added in PHP 4.2.<br><br>As of PHP 4.0.5, this function now returns the number of variables extracted.<br><br>The<em> extract_rules</em> value EXTR_PREFIX_INVALID was added in PHP 4.0.5.<br><br>As of PHP 4.0.5, the <em>
 extract_rules</em> value EXTR_PREFIX_ALL now includes numeric variables as well.</td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_extract2">Run example &raquo;</a>
</div>
<hr>
