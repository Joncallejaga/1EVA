...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_rand">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">A random integer between <em>min</em> (or 0) and <em>max</em> (or getrandmax() inclusive)</td>
</tr>
<tr>
  <th>Return Type:</th>
  <td>Integer</td>
