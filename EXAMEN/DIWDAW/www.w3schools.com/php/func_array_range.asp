...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_range">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>step</em></td>
    <td>Optional. Specifies the increment used in the range. Default is 1</td>
  </tr>
</table>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>The <em>step</em> parameter was added in PHP 5.0.<br><br>In PHP versions 4.1.0 through 4.3.2, this function sees numeric strings as strings and not integers. The numeric strings will be used for character sequences, e.g., &quot;5252&quot; is treated as &quot;5&quot;.<br><br>Support for character sequences and decrementing arrays was added in PHP 4.1.0. Character sequence values are limited to a length of one. If the length is higher than one, only the first character is used. Before this version, range() only generated incrementing integer arrays. </td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_range2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_range3">Run example &raquo;</a>
</div>
<hr>
