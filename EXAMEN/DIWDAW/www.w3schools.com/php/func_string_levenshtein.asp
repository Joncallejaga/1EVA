...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_levenshtein">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>insert</em></td>
    <td>Optional. The cost of inserting a character. Default is 1</td>
  </tr>
  <tr>
    <td><em>replace</em></td>
    <td>Optional. The cost of replacing a character. Default is 1</td>
  </tr>
  <tr>
    <td><em>delete</em></td>
    <td>Optional. The cost of deleting a character. Default is 1</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns the Levenshtein distance between the two argument strings or -1, if one of the strings exceeds 255 characters</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0.1+</td>
