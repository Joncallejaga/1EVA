...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strspn">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the number of characters found in the string that contains only characters from the <em>charlist</em> parameter.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strspn2">Run example &raquo;</a>
</div>
<hr>
