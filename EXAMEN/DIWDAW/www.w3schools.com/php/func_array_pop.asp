...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_pop">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the last value of <em>array</em>. If <em>array</em> is empty, or is not an array, NULL will be returned.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
