...
<div class="w3-code notranslate">
 &lt;?php<br>$str = "&lt;h1&gt;Hello World!&lt;/h1&gt;";<br><br>$newstr = filter_var($str, FILTER_SANITIZE_STRING);<br>echo $newstr;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_sanitize_string">
 Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
 ...
 <br>$newstr = filter_var($str, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);<br>echo $newstr;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_sanitize_string2">
 Run example &raquo;</a>
</div>
