...
<div class="w3-code notranslate">
 &lt;?php<br>// An array that represents a possible record set returned from a database<br>$a = array(<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 5698,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Peter',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Griffin',<br>&nbsp; ),<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 4767,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Ben',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Smith',<br>&nbsp; ),<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 3809,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Joe',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Doe',<br>&nbsp; )<br>);<br><br>$last_names = array_column($a, 'last_name');<br>print_r($last_names);<br>?&gt;
</div>
<p>Output:</p>
<div class="w3-code notranslate">Array<br>(<br>&nbsp; [0] =&gt; Griffin<br>&nbsp; [1] =&gt; Smith<br>&nbsp; [2] =&gt; Doe<br>)</div>
<br>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>column_key</td>
    <td>Required. An integer key or a string key name of the column of values to return. This parameter can also be NULL to return complete arrays (useful together with index_key to re-index the array)</td>
  </tr>
  <tr>
    <td>index_key</td>
...
<tr>
 ...
 <td style="width:80%">Returns an array of values that represents a single column from the input array </td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.5+</td>
...
<div class="w3-code notranslate">
 &lt;?php<br>// An array that represents a possible record set returned from a database<br>$a = array(<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 5698,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Peter',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Griffin',<br>&nbsp; ),<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 4767,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Ben',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Smith',<br>&nbsp; ),<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 3809,<br>&nbsp;&nbsp;&nbsp; 'first_name' =&gt; 'Joe',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Doe',<br>&nbsp; )<br>);<br><br>$last_names = array_column($a, 'last_name', 'id');<br>print_r($last_names);<br>
 ?&gt; </div>
<p>Output:</p>
<div class="w3-code notranslate">Array<br>(<br>&nbsp; [5698] =&gt; Griffin<br>&nbsp; [4767] =&gt; Smith<br>&nbsp; [3809] =&gt; Doe<br>)</div>
<br>
</div>
<hr>
