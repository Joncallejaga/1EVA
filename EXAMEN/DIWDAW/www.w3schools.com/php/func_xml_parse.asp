...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>end</td>
    <td>Optional. If this parameter is TRUE, the data in the &quot;xml&quot; parameter is the last piece of data sent in this parse.<p><b>Note:</b> Entity errors are reported at the end of the parse. And will only show if the &quot;end&quot; parameter is TRUE</td>
  </tr>
  </table>
<hr>
