...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>options</em></td>
    <td>The options to refresh. Can be one of more of the following (separated by OR):
 <ul>
    ...
    <li>MYSQLI_REFRESH_SLAVE - Resets the master server info, and restarts  the slave</li>
    <li>MYSQLI_REFRESH_MASTER - Removes the binary log files in the binary  log index, and truncates the index file</li>
 </ul>
   </td>
  </tr>
  </table>
