...
&lt;?php<br>
 echo(pow(2,4) . &quot;&lt;br&gt;&quot;);<br>echo(pow(-2,4) . &quot;&lt;br&gt;&quot;);<br>echo(pow(-2,-4) . &quot;&lt;br&gt;&quot;);<br>echo(pow(-2,-3.2));<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_pow">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 4.0.6: Will now return integer if possible. Earlier it only returned float<br>PHP 4.2.0: No warning is issued on errors</td>
</tr>
</table>
<hr>
