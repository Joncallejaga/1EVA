...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_sum">Run example &raquo;</a>
</div>
<hr>
...
<tr>
  <th>Changelog:</th>
  <td>PHP versions prior to 4.2.1 modified the passed array itself and converted strings to numbers (which often converted them to zero, depending on their value)</td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_sum2">Run example &raquo;</a>
</div>
<hr>
