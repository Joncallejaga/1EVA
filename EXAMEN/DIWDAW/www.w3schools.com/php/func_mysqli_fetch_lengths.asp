...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT * FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; $row=mysqli_fetch_row($result);<br><br>&nbsp; // Display field lengths<br>&nbsp; foreach (mysqli_fetch_lengths($result) as $i=&gt;$val)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; printf(&quot;Field %2d has length: %2d\n&quot;,$i+1,$val);<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>}<br>
...
<tr>
 ...
 <td style="width:80%">Returns an array if integer that represents the size of each field (column). FALSE if an error occurs</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
