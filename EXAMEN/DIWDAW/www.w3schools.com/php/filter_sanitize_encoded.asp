...
<p><a href="php_ref_filter.asp" class="w3-btn w3-white w3-border" title="PHP Filter Reference">&#10094; 
PHP Filter Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Encode special characters in the $url variable:</p>
<div class="w3-code notranslate">
 &lt;?php<br>$url="https://www.w3schoolsÅÅ.com";<br><br>$url = filter_var($url, FILTER_SANITIZE_ENCODED);<br>echo $url;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_sanitize_encoded">
 Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
 &lt;?php<br>$url="https://www.w3schoolsÅÅ.com";<br><br>$url = filter_var($url, FILTER_SANITIZE_ENCODED, FILTER_FLAG_STRIP_HIGH);<br>echo $url;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_sanitize_encoded2">
 Run example &raquo;</a>
</div>

<hr>
<a href="php_ref_filter.asp" class="w3-btn w3-white w3-border" title="PHP Filter Reference">&#10094; 
