...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_number_format">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The number to be formatted. If no other parameters are set, the number will be formatted without decimals and with comma (,) as the thousands separator.</td>
  </tr>
  <tr>
    <td><em>decimals</em></td>
    <td>Optional. Specifies how many decimals. If this parameter is set, the number will be formatted with a dot (.) as decimal point</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Optional. Specifies what string to use for thousands separator. Only the first character of separator is used. For example, &quot;xxx&quot; will give the same output as &quot;x&quot; <br><br><b>Note:</b> If this parameter is given, all other parameters are required as well</td>
  </tr>
  </table>
<hr>
...
<tr>
 ...
 <em>decimalpoint</em> and <em>separator</em>. Only the first byte of each separator was used in older versions.</td>
</tr>
</table>
<hr>
...
<div class="w3-code notranslate">
 ...
 echo $formattedNum;<br>$formattedNum = number_format($num, 2);<br>echo $formattedNum;<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_number_format2">Run example &raquo;</a>
</div>
<hr>
