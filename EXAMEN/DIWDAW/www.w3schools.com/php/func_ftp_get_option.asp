...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// could return 90<br>echo ftp_get_option($ftp_conn,FTP_TIMEOUT_SEC);<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the runtime option to return. Possible values:<ul>
    <li>FTP_TIMEOUT_SEC - Returns the timeout used for  network operations</li>
...
<tr>
 ...
 <td style="width:80%">Returns the value on success, or FALSE if the given option is not supported (a warning message is also thrown)</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.2+</td>
