...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_search">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>strict</em></td>
    <td>Optional. If this parameter is set to TRUE, then this function will search for identical elements in the array. Possible values:
...
<tr>
 ...
 <td style="width:80%">Returns the key of a value if it is found in the array, and FALSE otherwise. If the value is found in the array more than once, the first matching key is returned.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0.5+</td>
...
<tr>
  <th>Changelog:</th>
  <td>This function returns NULL if invalid parameters are passed to it (this applies to all PHP functions as of 5.3.0).<br><br>As of PHP 4.2.0, this function returns FALSE on failure instead of NULL.</td>
</tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_search2">Run example &raquo;</a>
</div>
<hr>
