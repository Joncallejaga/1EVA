...
&nbsp;&nbsp;}<br><br>// Check if server is alive<br>if (mysqli_ping($con))<br>&nbsp; {<br>&nbsp; echo &quot;Connection is ok!&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error: &quot;. mysqli_error($con);<br>&nbsp; }<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
