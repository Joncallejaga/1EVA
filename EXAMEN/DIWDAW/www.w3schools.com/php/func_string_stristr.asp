...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_stristr">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>search</em></td>
    <td>Required. Specifies the string to search for. If this parameter is a number, it will search for the character matching the ASCII value of the number</td>
  </tr>
  <tr>
    <td><em>before_search</em></td>
    <td>Optional. A boolean value whose default is &quot;false&quot;. If set to &quot;true&quot;, it returns the part of the string before the first occurrence of the <em>
...
<tr>
 ...
 <td style="width:80%">Returns the rest of the string (from the matching point), or FALSE, if the string to search for is not found.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>The <em>before_search</em> parameter was added in PHP 5.3<br><br>This function was made binary-safe in PHP 4.3</td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_stristr2">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_stristr3">Run example &raquo;</a>
</div>
<hr>
