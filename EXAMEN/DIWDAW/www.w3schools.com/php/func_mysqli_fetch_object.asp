...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
 <br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; while ($obj=mysqli_fetch_object($result))<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; printf(&quot;%s (%s)\n&quot;,$obj-&gt;Lastname,$obj-&gt;Age);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; // Free result set<br>&nbsp; mysqli_free_result($result);<br>}<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the name of the class to instantiate, set the properties of, and return</td>
  </tr>
  <tr>
    <td><em>params</em></td>
    <td>Optional. Specifies an array of parameters to pass to the constructor for <em>classname</em> objects</td>
  </tr>
  </table>
...
<tr>
 ...
 <td style="width:80%">Returns an object with string properties for the fetched row. NULL if there are no more rows in the result set</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
