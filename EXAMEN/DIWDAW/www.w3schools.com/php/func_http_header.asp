...
<hr>
<a href="php_ref_http.asp" class="w3-btn w3-white w3-border" title="PHP HTTP Reference">&#10094; Complete PHP HTTP Reference</a>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>replace</td>
    <td>Optional. Indicates whether the header should replace previous or add a second header. Default is TRUE (will replace). FALSE (allows multiple headers of the same type)</td>
  </tr>
  <tr>
    <td>http_response_code</td>
    <td>Optional. Forces the HTTP response code to the specified value (available in PHP 4.3 and higher)</td>
  </tr>
  </table>
<hr>
