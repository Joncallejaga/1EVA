...
&lt;?php<br>
 $con=mysqli_init();<br>if (!$con)<br>&nbsp; {<br>&nbsp; die(&quot;mysqli_init failed&quot;);<br>&nbsp; }<br><br>if (!mysqli_real_connect($con,&quot;localhost&quot;,&quot;my_user&quot;,&quot;my_password&quot;,&quot;my_db&quot;))<br>&nbsp; {<br>&nbsp; die(&quot;Connect Error: &quot; . mysqli_connect_error());<br>&nbsp; }<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port number to attempt to connect to the MySQL server</td>
  </tr>
  <tr>
    <td><em>socket</em></td>
  ...
  <tr>
    ...
    <ul>
      <li>MYSQLI_CLIENT_COMPRESS - Use compression protocol</li>
      <li>MYSQLI_CLIENT_FOUND_ROWS - Return number of matched rows (not affected rows)</li>
      <li>MYSQLI_CLIENT_IGNORE_SPACE - Allow spaces after function names. Make function names reserved words</li>
      <li>MYSQLI_CLIENT_INTERACTIVE - Allow interactive_timeout seconds of inactivity before closing connection</li>
      <li>MYSQLI_CLIENT_SSL - Use SSL encryption</li>
    </ul>
    </td>
  </tr>
  </table>
