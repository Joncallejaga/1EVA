...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_pad">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Required. Specifies the new string length. If this value is less than the original length of the string, nothing will be done</td>
  </tr>
  <tr>
    <td><em>pad_string</em></td>
    <td>Optional. Specifies the string to use for padding. Default is whitespace</td>
  </tr>
  <tr>
    <td><em>pad_type</em></td>
    <td>Optional. Specifies what side to pad the string.<p>Possible values:</p>
 <ul>
    <li>STR_PAD_BOTH - Pad to both sides of the string. If not an even  number, the right side gets the  extra padding</li>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_pad2">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_str_pad3">Run example &raquo;</a>
</div>
<hr>
