...
<div class="w3-code notranslate">
 &lt;?php<br>$email = &quot;john.doe@example.com&quot;;<br><br>if (filter_var($email, FILTER_VALIDATE_EMAIL)) {<br>&nbsp; echo(&quot;$email is a valid email address&quot;);<br>} else {<br>&nbsp; echo(&quot;$email is not a valid email address&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_filter_var">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the ID or name of the filter to use. Default is FILTER_DEFAULT, which results in no filtering </td>
  </tr>
  <tr>
    <td><em>options</em></td>
...
<tr>
 ...
 <td style="width:80%">Returns the filtered data on success, or FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5.2.0+</td>
...
<div class="w3-code notranslate">
 &lt;?php<br>$email = &quot;john.doe@example.com&quot;;<br><br>// Remove all illegal characters from email<br>$email = filter_var($email, FILTER_SANITIZE_EMAIL);<br>
 <br>// Validate e-mail<br>if (filter_var($email, FILTER_VALIDATE_EMAIL)) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$email is a valid email address&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$email is not a valid email address&quot;);<br>
 }<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_filter_var2">Run example &raquo;</a>
</div>
