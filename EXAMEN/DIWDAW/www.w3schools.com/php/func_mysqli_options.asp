...
&lt;?php<br>
 $con=mysqli_init();<br>if (!$con)<br>&nbsp; {<br>&nbsp; die(&quot;mysqli_init failed&quot;);<br>&nbsp; }<br><br>
 mysqli_options($con,MYSQLI_READ_DEFAULT_FILE,&quot;myfile.cnf&quot;);<br><br>if (!mysqli_real_connect($con,&quot;localhost&quot;,&quot;my_user&quot;,&quot;my_password&quot;,&quot;my_db&quot;))<br>&nbsp; {<br>&nbsp; die(&quot;Connect Error: &quot; . mysqli_connect_error());<br>&nbsp; }<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the option to set. Can be one of the following values:<ul>
    ...
    <li>MYSQLI_INIT_COMMAND - command to execute after connecting to MySQL  server</li>
    <li>MYSQLI_READ_DEFAULT_FILE - read options from named file instead of  my.cnf</li>
    <li>MYSQLI_READ_DEFAULT_GROUP - read options from named group from  my.cnf or the file specified in MYSQLI_READ_DEFAULT_FILE</li>
    <li>MYSQLI_SERVER_PUBLIC_KEY - RSA public key file used with SHA-256  based authentication</li>
 </ul>
   </td>
  </tr>
  <tr>
