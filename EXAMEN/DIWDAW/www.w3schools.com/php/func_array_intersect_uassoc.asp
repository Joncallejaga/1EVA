...
&lt;?php<br>
 function myfunction($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_intersect_uassoc">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an array containing the entries from <em>array1</em> that are present in all of the other arrays</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_intersect_uassoc2">Run example &raquo;</a>
</div>
