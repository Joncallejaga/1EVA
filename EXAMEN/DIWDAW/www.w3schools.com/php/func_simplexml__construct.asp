...
<p><a href="php_ref_simplexml.asp" class="w3-btn w3-white w3-border" title="PHP SimpleXML Reference">&#10094; PHP SimpleXML Reference</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_simplexml_construct">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>data</em></td>
    <td>Required. Specifies A well-formed XML string or the path or URL to an XML document if data_is_url is TRUE</td>
  </tr>
  <tr>
    <td><em>options</em></td>
    <td>Optional. Specifies additional Libxml parameters. Is set by specifying the option and 1 or 0 (TRUE or FALSE, e.g. LIBXML_NOBLANKS(1))<p>
 Possible values:</p>
 <ul>
    <li>LIBXML_COMPACT - Activate nodes allocation optimization (may  speed up application)</li>
    ...
    <li>LIBXML_NOEMPTYTAG - Expand empty tags (e.g. &lt;br/&gt; to &lt;br&gt;&lt;/br&gt;),  only available in the DOMDocument-&gt;save() and DOMDocument-&gt;saveXML()  functions</li>
    ...
    <li>LIBXML_PARSEHUGE - Sets XML_PARSE_HUGE flag, which relaxes any  hardcoded limit from the parser. This affects limits like maximum depth  of a document and limits of the size of text nodes</li>
    ...
    <li>LIBXML_DOTTED_VERSION - Get dotted libxml version (e.g. 2.6.5 or  2.6.17)</li>
 </ul>
  </td>
  </tr>
  <tr>
 ...
 data</em> is a path/URL to an XML document instead of string data. Default is FALSE</td>
  </tr>
  <tr>
    <td><em>ns</em></td>
  ...
  <tr>
    ...
    <td>Optional. Specifies a Boolean value. TRUE if <em>ns</em> is a prefix. FALSE if <em>ns</em> is a URI. Default is FALSE</td>
  </tr>
</table>
<hr>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 5.1.2: <em>options</em> and <em>data_is_url</em> parameters added.<br>PHP 5.2: <em>ns</em> and <em>is_prefix</em> parameters added.</td>
</tr>
</table>
<hr>
...
<div class="w3-code notranslate">
 &lt;?php<br>$xml=new SimpleXMLElement(&quot;note.xml&quot;, 0, TRUE);<br>echo $xml-&gt;asXML();<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_simplexml_construct2">Run example &raquo;</a>
</div>
<hr>
<a href="php_ref_simplexml.asp" class="w3-btn w3-white w3-border" title="PHP SimpleXML Reference">&#10094; PHP SimpleXML Reference</a>
</div>
