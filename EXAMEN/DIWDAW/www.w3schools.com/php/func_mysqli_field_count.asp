...
&nbsp;&nbsp;}<br><br>mysqli_query($con,&quot;SELECT * FROM Friends&quot;);<br>// Get number of columns - will always return 3<br>mysqli_field_count($con);<br>
...
<tr>
 ...
 <td style="width:80%">Returns an integer that represents the number of columns in the result set</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>5+</td>
