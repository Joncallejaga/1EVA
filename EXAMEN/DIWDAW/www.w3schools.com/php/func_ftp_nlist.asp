...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get file list of current directory<br>$file_list = ftp_nlist($ftp_conn, &quot;.&quot;);<br>var_dump($file_list);<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the directory to be listed. Use &quot;.&quot; to get the current directory</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">Returns an array of file names on success or FALSE on failure</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
