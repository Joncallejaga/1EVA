...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_time">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns an integer containing the current time as a Unix timestamp</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
