...
echo soundex($str);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_soundex">Run example &raquo;</a>
</div>
<hr>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_soundex2">Run example &raquo;</a>
</div>
<hr>
