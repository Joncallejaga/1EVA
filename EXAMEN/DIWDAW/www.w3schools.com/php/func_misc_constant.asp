...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_misc_constant">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the value of a constant, or NULL if the constant is not defined</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
