...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_cal_to_jd">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the calendar to convert from. Must be one of the following values:
 <ul>
    <li>CAL_GREGORIAN</li>
    <li>CAL_JULIAN</li>
    <li>CAL_JEWISH</li>
