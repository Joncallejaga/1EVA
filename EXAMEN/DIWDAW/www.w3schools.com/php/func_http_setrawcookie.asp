...
&lt;?php<br>
 ...
 setrawcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;);<br>// 86400 = 1 day<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie is set.&quot;;<br>
 ?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setrawcookie">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>expire</em></td>
    <td>Optional. Specifies when the cookie expires. The value: time()+86400*30, will set the cookie to expire in 30 days. If this parameter is not set, the cookie will expire at the end of the session (when the browser closes)</td>
  </tr>
  <tr>
    <td><em>path</em></td>
...
<div class="w3-code notranslate">
 &lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>$cookie_name = &quot;user&quot;;<br>if(!isset($_COOKIE[$cookie_name])) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' does not exist!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie is named: &quot; . $cookie_name . &quot;&lt;br&gt;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setrawcookie2">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 setrawcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>$cookie_name = &quot;user&quot;;<br>if(!isset($_COOKIE[$cookie_name])) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' does not exist!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie is named: &quot; . $cookie_name . &quot;&lt;br&gt;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setrawcookie3">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 unset($_COOKIE[$cookie_name]);<br>// empty value and expiration one hour before<br>$res = setrawcookie($cookie_name, '', time() - 3600);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie 'user' is deleted.&quot;;<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setrawcookie4">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 ...
 &lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_http_setrawcookie5">Run example &raquo;</a>
</div>
<hr>
