...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_array_key">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the key of the array element that is currently being pointed to by the internal pointer</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
