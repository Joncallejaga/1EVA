...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// set network operation timeout to 120 seconds<br>echo ftp_set_option($ftp_conn,FTP_TIMEOUT_SEC,120);<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the runtime option to set. Possible values:<ul>
...
<tr>
 ...
 <td style="width:80%">Returns TRUE if the option could be set, or FALSE if not (a warning message is also thrown)</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.2+</td>
