...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_end">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the value of the last element in the array on success, or FALSE if the array is empty</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
