...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_math_acos">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">The arc cosine of a number. Returns NAN if <em>number</em> is not in the range -1 to 1 </td>
</tr>
  <tr>
  <th>Return Type:</th>
  <td>Float</td>
