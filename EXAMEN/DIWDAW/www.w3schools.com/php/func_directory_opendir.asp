...
&lt;?php<br>$dir = &quot;/images/&quot;;<br><br>// Open a directory, and read its contents<br>if (is_dir($dir)){<br>&nbsp; if ($dh = opendir($dir)){<br>&nbsp;&nbsp;&nbsp; while (($file = readdir($dh)) !== false){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;filename:&quot; . $file . &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp; closedir($dh);<br>&nbsp; }<br>}<br>?&gt;</div>
<p>Result:</p>
<div class="w3-code notranslate">
filename: cat.gif<br>
filename: dog.gif<br>
...
<tr>
 ...
 <td style="width:80%">Returns the directory handle resource on success. FALSE on failure. Throws an error of level E_WARNING if path is not a valid directory, or if the directory cannot be opened due to permission restrictions or filesysytem errors. You can hide the error output of opendir() by adding '@' to the front of the function name</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0+</td>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 5.0: The path parameter now supports the <strong>ftp://</strong> URL wrapper</td>
</tr>
</table>
<hr>
