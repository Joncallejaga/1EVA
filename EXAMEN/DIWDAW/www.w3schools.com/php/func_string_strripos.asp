...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strripos">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li><a href="func_string_strrpos.asp">strrpos()</a> - Finds the position of the last occurrence of a string inside another string (case-sensitive)</li>
</ul>
<hr>
<h2>Syntax</h2>
