...
&lt;?php<br>// connect and login to FTP server<br>
 $ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or die(&quot;Could not connect to $ftp_server&quot;);<br>$login = ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;php/test.txt&quot;;<br>
 <br>// Try to set read and write for owner and read for everybody else<br>
 if (ftp_chmod($ftp_conn, 0644, $file) !== false)<br>&nbsp; {<br>&nbsp; echo &quot;Successfully chmoded $file to 644.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;chmod failed.&quot;;<br>&nbsp; }<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>mode</em></td>
    <td>Required. Specifies the new permissions.<p>This parameter consists of four numbers:</p>
 <ul>
 ...
 <p>Possible values (to set multiple permissions, add up the following numbers):</p>
 <ul>
