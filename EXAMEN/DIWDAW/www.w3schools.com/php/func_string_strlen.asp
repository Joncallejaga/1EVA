...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strlen">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the length of a string on success, and 0 if the string is empty</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
...
<tr>
  <th>Changelog:</th>
  <td>Before PHP 5.3.0, this function treated arrays as the string <em>Array</em>, thus returning a string length of 5 and emitting an E_NOTICE level error.</td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strlen2">Run example &raquo;</a>
</div>
<hr>
