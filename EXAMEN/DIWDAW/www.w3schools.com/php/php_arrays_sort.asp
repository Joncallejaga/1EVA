...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_arrays6" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Use the correct array method to sort the <code class="w3-codespan">$colors</code> array alphabetically.</p>
