...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>element</em></td>
    <td>Required. Specifies which element to return. Must be one of the following elements:<p>Time and Calendar:</p>
 <ul>
    ...
    <li>D_FMT - String that can be used as the format string for strftime()  to represent date</li>
    <li>T_FMT - String that can be used as the format string for strftime()  to represent time</li>
    ...
    <li>ERA_D_T_FMT - Date and time in alternate era format (string can be  used in strftime())</li>
 ...
 <ul>
  ...
  <li>NEGATIVE_SIGN -Negative value character</li>
    ...
    <li>P_SIGN_POSN - Formatting setting. Possible return values:<ul>
      ...
      <li>1 - The sign string is placed in front of the quantity and      currency symbol</li>
      <li>2 - The sign string is placed after the quantity and currency 
            symbol</li>
      <li>3 - The sign string is placed immediately in front of the      currency symbol</li>
 ...
 <ul>
    ...
    <li>GROUPING - Array displaying how numbers are grouped (example: 1  000 000)</li>
 </ul>
