...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the error message for this error. Max 1024 bytes in length</td>
  </tr>
  <tr>
...
<tr>
 ...
 <td style="width:80%">FALSE if wrong error type is specified, TRUE otherwise</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4.0.1+</td>
