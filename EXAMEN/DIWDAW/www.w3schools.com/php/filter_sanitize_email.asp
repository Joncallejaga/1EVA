...
<div class="w3-code notranslate">
 &lt;?php<br>$email = &quot;john(.doe)@exa//mple.com&quot;;<br><br>$email = filter_var($email, FILTER_SANITIZE_EMAIL);<br>echo $email;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_sanitize_email">Run example &raquo;</a>
</div>
<hr>
