...
<p><a href="php_ref_mail.asp" class="w3-btn w3-white w3-border" title="PHP Mail Reference">&#10094; PHP Mail Reference</a></p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>to</em></td>
    <td>Required. Specifies the receiver / receivers of the email</td>
  </tr>
  <tr>
    <td><em>subject</em></td>
    <td>Required. Specifies the subject of the email. <b>Note:</b> This parameter cannot contain any newline characters</td>
  </tr>
  <tr>
    <td><em>message</em></td>
    <td>Required. Defines the message to be sent. Each line should be separated with a LF (\n).
    Lines should not exceed 70 characters.
 <p><b>Windows note:</b> If a full stop is found on the beginning of a line in the message, it might be removed. To solve this problem, replace the full stop with a double dot:<br>
 &lt;?php<br>
 $txt = str_replace(&quot;\n.&quot;, &quot;\n..&quot;, $txt);<br>
 ?&gt;</p></td>
  </tr>
  <tr>
    <td><em>headers</em></td>
    <td>Optional. Specifies additional headers, like From, Cc, and Bcc. The additional headers should be separated with a CRLF (\r\n).
...
<tr>
 ...
 <td style="width:80%">Returns the hash value of the <em>address</em> parameter, or FALSE on failure. <b>Note:</b> Keep in mind that even if the email was accepted for delivery, it does NOT mean the email is actually sent and received!
  </td>
</tr>
<tr>
  <th>PHP Version:</th>
...
<tr>
  <th>PHP Changelog:</th>
  <td>PHP 4.3.0: (Windows only) All custom headers (like From, Cc, Bcc and Date) are supported, and are not case-sensitive.<br>PHP 4.2.3: The <em>
...
<hr>
<a href="php_ref_mail.asp" class="w3-btn w3-white w3-border" title="PHP Mail Reference">&#10094; Complete PHP Mail Reference</a>
</div>
