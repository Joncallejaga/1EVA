...
&nbsp; echo &quot;Failed to connect to MySQL: &quot; . mysqli_connect_error();<br>
 ...
 $lastname = mysqli_real_escape_string($con, $_POST['lastname']);<br>$age = mysqli_real_escape_string($con, $_POST['age']);<br><br>$sql=&quot;INSERT INTO Persons (FirstName, LastName, Age)<br>VALUES ('$firstname', '$lastname', '$age')&quot;;<br><br>if (!mysqli_query($con,$sql))
 {<br>&nbsp; die('Error: ' . mysqli_error($con));<br>}<br>echo &quot;1 record added&quot;;<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The string to be escaped. Characters encoded are NUL (ASCII 0), \n, \r, \, ', &quot;, and Control-Z.</td>
  </tr>
  </table>
