...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_similar_text">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>percent</em></td>
    <td>Optional. Specifies a variable name for storing the similarity in percent</td>
  </tr>
  </table>
...
echo $percent;<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_similar_text2">Run example &raquo;</a>
</div>
<hr>
