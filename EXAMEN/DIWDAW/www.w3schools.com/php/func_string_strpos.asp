...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_func_string_strpos">Run example &raquo;</a>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">Returns the position of the first occurrence of a string inside another string, or FALSE if the string is not found. <strong>Note:</strong> String positions start at 0, and not 1.</td>
</tr>
<tr>
  <th>PHP Version:</th>
  <td>4+</td>
