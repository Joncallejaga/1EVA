...
<ul style="font-size:16px;font-family:consolas,'Courier New', Courier, monospace">
  <li><a href="css3_flexbox.asp#flex-direction">flex-direction</a></li>
  <li><a href="css3_flexbox.asp#flex-wrap">flex-wrap</a></li>
  <li><a href="css3_flexbox.asp#flex-flow">flex-flow</a></li>
  <li><a href="css3_flexbox.asp#justify-content">justify-content</a></li>
  <li><a href="css3_flexbox.asp#align-items">align-items</a></li>
  <li><a href="css3_flexbox.asp#align-content">align-content</a></li>
</ul>
<hr>
...
<ul style="font-size:16px;font-family:consolas,'Courier New', Courier, monospace">
  <li><a href="css3_flexbox.asp#order">order</a></li>
  <li><a href="css3_flexbox.asp#flex-grow">flex-grow</a></li>
  <li><a href="css3_flexbox.asp#flex-shrink">flex-shrink</a></li>
  <li><a href="css3_flexbox.asp#flex-basis">flex-basis</a></li>
  <li><a href="css3_flexbox.asp#flex">flex</a></li>
  <li><a href="css3_flexbox.asp#align-self">align-self</a></li>
</ul>
<hr>
