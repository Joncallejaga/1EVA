    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        <div class='w3-col l3 m4'>
          ...
          <a class="w3-bar-item w3-button" href='default.asp'>Learn Graphics</a>
    ...
    <div id='nav_references' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        <div class='w3-col m4'>
          ...
          <a class="w3-bar-item w3-button" href='svg_reference.asp'>HTML SVG Reference</a>
          <a class="w3-bar-item w3-button" href='google_maps_reference.asp'>Google Maps Reference</a>
          <h3>Charsets</h3>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href='svg_examples.asp'>SVG Examples</a>
        </div>
        <div class='w3-col l3 m6'>
          <h3>JavaScript</h3>
        ...
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href='svg_examples.asp' target='_top'>SVG Examples</a>
        </div>
        <div class='w3-col l3 m6'>
          <h3>Quizzes</h3>
...
<a target="_top" href="../howto/howto_google_maps.asp">Maps Intro</a>
...
<a class="w3-left w3-btn" href="../tags/att_style_scoped.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="../howto/howto_google_maps.asp">Next &#10095;</a>
</div>
<hr>
<h2>Google Maps</h2>
<p><a href="../howto/howto_google_maps.asp">Google Maps</a> lets you embed maps in HTML.</p>
<!--
