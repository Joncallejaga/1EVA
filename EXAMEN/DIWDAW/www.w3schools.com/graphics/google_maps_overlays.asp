...
<p>The example below shows how to animate the marker with the animation property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var
...
<p>A Polyline is a line that is drawn through a series of coordinates in an ordered sequence.</p>
