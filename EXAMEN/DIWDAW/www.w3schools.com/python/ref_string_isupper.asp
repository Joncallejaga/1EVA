...
<html lang="en-US">
<head>
<title>Python String isupper() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isupper()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are in upper case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;THIS 
    IS NOW!&quot;<br><br>x = txt.isupper()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isupper">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isupper()</code> method returns True if all the 
characters are in upper case, otherwise False.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the texts are in upper case:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;Hello World!&quot;<br>b = &quot;hello 123&quot;<br>c = &quot;MY 
    NAME IS PETER&quot;<br>
    <br>print(a.isupper())<br>print(b.isupper())<br>print(c.isupper())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isupper2">Run example &raquo;</a>
</div>
