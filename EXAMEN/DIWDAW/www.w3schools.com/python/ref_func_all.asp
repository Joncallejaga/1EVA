...
<html lang="en-US">
<head>
<title>Python all() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">all()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all items in a list are True:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = [True, True, True]<br>
    x = all(mylist)
   </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_all">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">all()</code> function returns True if all items 
in an iterable are true, otherwise it returns False.</p>
<p>If the iterable object is empty, the <code class="w3-codespan">all()</code> 
function also returns True.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>An iterable object (list, tuple, dictionary)</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_all2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all items in a <em>tuple</em> are True:</p>
  <div class="w3-code notranslate pythonHigh">
    mytuple = (0, True, False)<br>
    x = all(mytuple)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_all_tuple">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all items in a <em>set</em> are True:</p>
  <div class="w3-code notranslate pythonHigh">
    myset = {0, 1, 0)<br>
    x = all(myset)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_all_set">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all items in a <em>dictionary</em> are True:</p>
  <div class="w3-code notranslate pythonHigh">
    mydict = {0 : "Apple", 1 : "Orange"}<br>
    x = all(mydict)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_all_dict">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> When used on a dictionary, the all() function checks if all the <em>keys</em> are true, not the <em>values</em>.</p>
</div>
...
<p><a href="ref_func_any.asp">The any() Function</a></p>
<hr>
