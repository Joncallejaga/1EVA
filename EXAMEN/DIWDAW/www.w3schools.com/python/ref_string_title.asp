...
<html lang="en-US">
<head>
<title>Python String title() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> title()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Make the first letter in each word upper case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Welcome to my world&quot;<br><br>x = txt.title()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_title">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">title()</code> method returns a string where 
the first character in every word is upper case. Like a header, or a title.</p>
<p>If the word contains a number or a symbol, the first letter after that will 
...
<div class="w3-example">
  ...
  <p>Make the first letter in each word upper case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Welcome to my 2nd world&quot;<br><br>x = txt.title()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_title2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Note that the first letter after a non-alphabet letter is converted into a 
  upper case letter:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;hello b2b2b2 and 3g3g3g&quot;<br><br>x = txt.title()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_title3">Run example &raquo;</a>
</div>
