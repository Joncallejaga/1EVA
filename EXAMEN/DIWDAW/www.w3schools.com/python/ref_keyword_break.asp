...
<html lang="en-US">
<head>
<title>Python break Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> break</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>End the loop if i is larger than 3:</p>
  <div class="w3-code notranslate pythonHigh">
    for i in range(9):<br>&nbsp; if i &gt; 3:<br>&nbsp;&nbsp;&nbsp; break<br>&nbsp; 
    print(i)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_break">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">break</code> keyword is used to break out a
<code class="w3-codespan">for</code> loop, or a <code class="w3-codespan">while</code> 
loop.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    i = 1<br>while i &lt; 9:<br>&nbsp; print(i)<br>&nbsp; if i == 3:<br>&nbsp;&nbsp;&nbsp; 
    break<br>&nbsp; i += 1</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_break2">Run example &raquo;</a>
</div>


<hr>
<h2>Related Pages</h2>
<p>Use the <code class="w3-codespan"><a href="ref_keyword_continue.asp">continue</a></code> 
keyword to end the current iteration in a loop, but continue with the next.</p>
