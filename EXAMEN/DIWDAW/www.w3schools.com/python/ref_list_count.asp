...
<html lang="en-US">
<head>
<title>Python List count() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> count()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of times the value "cherry" appears int the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>x = fruits.count("cherry")
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_count">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">count()</code> method returns the number of elements with the specified value.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Any type (string, number, list, tuple, etc.). The value to search for.</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of times the value 9 appears int the list:</p>
  <div class="w3-code notranslate pythonHigh">
    points = [1, 4, 2, 9, 7, 8, 9, 3, 1]<br><br>x = points.count(9)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_count2">Run example &raquo;</a>
</div>
