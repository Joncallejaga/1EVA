...
<html lang="en-US">
<head>
<title>Python float() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">float()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert the number 3 into a floating point number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    float(3)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_float">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">float()</code> function converts the specified 
value into a floating point number.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>value</em></td>
    <td>A number or a string that can be converted into a floating point number</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert a string into a floating point number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    float(&quot;3.500&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_float2">Run example &raquo;</a>
</div>
