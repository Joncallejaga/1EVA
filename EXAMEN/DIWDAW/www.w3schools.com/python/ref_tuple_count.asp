...
<html lang="en-US">
<head>
<title>Python Tuple count() Method</title>
<meta charset="utf-8">
...
<h1>Python Tuple<span class="color_h1"> count()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of times the value 5 appears in the tuple:</p>
  <div class="w3-code notranslate pythonHigh">
    thistuple = (1, 3, 7, 8, 7, 5, 4, 6, 8, 5)<br><br>x = thistuple.count(5)<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_tuple_count">Run example &raquo;</a>
</div>
...
times a specified value appears in the tuple.</p>
