...
<html lang="en-US">
<head>
<title>Python String replace() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> replace()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Replace the word &quot;bananas&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    txt &quot;I like bananas&quot;<br><br>x = txt.replace(&quot;bananas&quot;, &quot;apples&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_replace">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">replace()</code> method replaces a specified 
phrase with another specified phrase.</p>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> <em>All</em> occurrences of the specified phrase 
  will be replaced, if nothing else is specified.</p>
</div>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.replace(<em>oldvalue, newvalue, count</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>count</em></td>
    <td>Optional. A number specifying how many occurrences of the old value you 
    want to replace. Default is all occurences</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Replace all occurrence of the word &quot;one&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;one one was a race horse, two two was one too.&quot;<br><br>x = 
    txt.replace(&quot;one&quot;, &quot;three&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_replace2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Replace the two first occurrence of the word &quot;one&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;one one was a race horse, two two was one too.&quot;<br><br>x = 
    txt.replace(&quot;one&quot;, &quot;three&quot;, 2)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_replace3">Run example &raquo;</a>
</div>
