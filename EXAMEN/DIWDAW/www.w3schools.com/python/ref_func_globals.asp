...
<html lang="en-US">
<head>
<title>Python globals() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">globals()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Dispaly the global symbol table:</p>
  <div class="w3-code notranslate pythonHigh">
    x = globals()<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_globals">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">globals()</code> function returns the global 
symbol table as a dictionary.</p>
<p>A symbol table contains necessary information about the current program</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Get the filename of the current program:</p>
  <div class="w3-code notranslate pythonHigh">
    x = globals()<br>print(x[&quot;__file__&quot;])</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_globals2">Run example &raquo;</a>
</div>
