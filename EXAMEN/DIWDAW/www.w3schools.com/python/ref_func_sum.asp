...
<html lang="en-US">
<head>
<title>Python sum() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">sum()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add all items in a tuple, and return the result:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (1, 2, 3, 4, 5)<br>x = sum(a)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_sum">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">sum()</code> function returns a number, the sum 
of all items in an iterable.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Start with the number 7, and add all the items in a tuple to this number:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (1, 2, 3, 4, 5)<br>x = sum(a, 7)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_sum2">Run example &raquo;</a>
</div>
