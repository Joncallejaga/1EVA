...
<html lang="en-US">
<head>
<title>Python Set clear() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> clear()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove all elements from the <code class="w3-codespan">fruits</code> set:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>fruits.clear()<br><br>print(fruits)</div>
...
<p>The <code class="w3-codespan">clear()</code> method removes all elements in a 
set.</p>
