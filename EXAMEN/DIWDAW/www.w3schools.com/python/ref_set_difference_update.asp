...
<html lang="en-US">
<head>
<title>Python Set difference_update() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> difference_update()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove the items that exist in both sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>x.difference_update(y)
    <br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_difference_update">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">difference_update()</code> method removes the 
items that exist in both sets.</p>

<p>The <code class="w3-codespan">difference_update()</code> method is different 
from the <code class="w3-codespan">difference()</code> method, because the <code class="w3-codespan">difference()</code> 
method <em>returns a new set</em>, without the unwanted items, and the
<code class="w3-codespan">difference_update()</code> method <em>removes</em> the 
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.difference_update(<em>set</em>)
  </div>
</div>
