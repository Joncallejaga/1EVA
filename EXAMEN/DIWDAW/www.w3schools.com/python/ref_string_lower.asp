...
<html lang="en-US">
<head>
<title>Python String lower() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> lower()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Lower case the string:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello my FRIENDS&quot;<br><br>x = txt.lower()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_lower">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">lower()</code> method returns a string where 
all characters are lower case.</p>
