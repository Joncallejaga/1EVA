...
<html lang="en-US">
<head>
<title>Python String islower() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> islower()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are in lower case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;hello 
    world!&quot;<br><br>x = txt.islower()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_islower">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">islower()</code> method returns True if all the 
characters are in lower case, otherwise False.</p>
<p>Numbers, symbols and spaces are not checked, only alphabet characters.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the texts are in lower case:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;Hello world!&quot;<br>b = &quot;hello 123&quot;<br>c = &quot;mynameisPeter&quot;<br>
    <br>print(a.islower())<br>print(b.islower())<br>print(c.islower())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_islower2">Run example &raquo;</a>
</div>
