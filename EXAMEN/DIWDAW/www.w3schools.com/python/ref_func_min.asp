...
<html lang="en-US">
<head>
<title>Python min() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">min()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the lowest number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = min(5, 10)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_min">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">min()</code> function returns the item 
with the lowest value, or the item with the lowest value in an iterable.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the name with the lowest value, ordered alphabetically:</p>
  <div class="w3-code notranslate pythonHigh">
    x = min(&quot;Mike&quot;, &quot;John&quot;, &quot;Vicky&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_min2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the item in a tuple with the lowest value:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (1, 5, 3, 9)<br>x = min(a)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_min3">Run example &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>

<p>The <a href="ref_func_max.asp">max()</a> function, to return the highest value.</p>
<hr>
