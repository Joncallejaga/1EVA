...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    ...
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_split2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Use a hash tag as a separator:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;apple#banana#cherry#orange&quot;<br><br>x = txt.split(&quot;#")<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_split3">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;apple#banana#cherry#orange&quot;<br><br># setting the max parameter 
    to 1, will return a list with 2 elements!<br>x = txt.split(&quot;#&quot;, 1)<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_split4">Run example &raquo;</a>
</div>
