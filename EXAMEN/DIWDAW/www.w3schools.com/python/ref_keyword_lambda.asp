...
<html lang="en-US">
<head>
<title>Python lambda Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> lambda</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a function that adds 10 to any number you send:</p>
  <div class="w3-code notranslate pythonHigh">
    x = lambda a : a + 10<br><br>print(x(5))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_lambda">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">lambda</code> keyword is used to create small 
anonymous functions.</p>

<p>A <code class="w3-codespan">lambda</code> function can take any number of 
arguments, but can only have one expression.</p>
<p>The expression is evaluated and the result is returned.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>A lambda function with three arguments:</p>
  <div class="w3-code notranslate pythonHigh">
    x = lambda a, b, c : a + b + c<br><br>print(x(5, 6, 2))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_lambda2">Run example &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>
<p>Read more about lambda functions in our <a href="python_lambda.asp">Python 
Lambda Tutorial</a>.</p>
