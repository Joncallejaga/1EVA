...
<html lang="en-US">
<head>
<title>Python pow() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">pow()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the value of 4 to the power of 3 (same as 4 * 4 * 4):</p>
  <div class="w3-code notranslate pythonHigh">
    x = pow(4, 3)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_pow">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">pow()</code> function returns the value of x to the power of y (x<sup>y</sup>).</p>

<p>If a third parameter is present, it returns x to the power of y, modulus z.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>x</em></td>
    <td>A number, the base</td>
    </tr>
    <tr>
    <td><em>y</em></td>
    <td>A number, the exponent</td>
    </tr>
    <tr>
    <td><em>z</em></td>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the value of 4 to the power of 3, modulus 5 (same as (4 * 4 * 4) % 5):</p>
  <div class="w3-code notranslate pythonHigh">
    x = pow(4, 3, 5)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_pow2">Run example &raquo;</a>
</div>
