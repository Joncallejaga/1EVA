...
<html lang="en-US">
<head>
<title>Python finally Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> finally</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>The finally block will always be executed, no matter if the try block 
  raises an error or not:</p>
  <div class="w3-code notranslate pythonHigh">
    try:<br>&nbsp; x &gt; 3<br>except:<br>&nbsp; print(&quot;Something went wrong&quot;)<br>
    else:<br>&nbsp; print(&quot;Nothing went wrong&quot;)<br>finally:<br>&nbsp; print(&quot;The 
    try...except block is finished&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_finally">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">finally</code> keyword is used in try...except 
blocks. It defines a block of code to run when the try...except...else block is 
final.</p>
<p>The <code class="w3-codespan">finally</code> block will be executed no matter 
if the try block raises an error or not.</p>
