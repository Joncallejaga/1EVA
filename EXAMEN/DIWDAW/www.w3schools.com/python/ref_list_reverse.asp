...
<html lang="en-US">
<head>
<title>Python List reverse() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> reverse()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Reverse the order of the <code class="w3-codespan">fruit </code>list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>
    fruits.reverse()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_reverse">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">reverse()</code> method reverses the sorting 
...
<p>The buil-in function <a href="ref_func_reversed.asp">reversed()</a> returns a reversed iterator object.</p>
