...
<html lang="en-US">
<head>
<title>Python List extend() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> extend()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add the elements of <code class="w3-codespan">cars</code> to the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>
    cars = ['Ford', 'BMW', 'Volvo']<br><br>
    fruits.extend(cars)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_extend">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">extend()</code> method adds the specified list elements (or any iterable) to the end of the current list.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>list</em>.extend(<em>iterable</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add a tuple to the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>
    points = (1, 4, 5, 9)<br><br>
    fruits.extend(points)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_extend2">Run example &raquo;</a>
</div>
