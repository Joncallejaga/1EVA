...
<html lang="en-US">
<head>
<title>Python List append() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> append()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add an element to the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br>fruits.append("orange")
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_append">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">append()</code> method appends an element to the end of the list.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>elmnt</em></td>
    <td>Required. An element of any type (string, number, object etc.)</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add a list to a list:</p>
  <div class="w3-code notranslate pythonHigh">
    a = ["apple", "banana", "cherry"]<br>b = ["Ford", "BMW", "Volvo"]<br>a.append(b)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_append2">Run example &raquo;</a>
</div>
