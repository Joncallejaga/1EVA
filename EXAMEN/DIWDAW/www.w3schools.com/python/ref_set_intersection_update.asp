...
<html lang="en-US">
<head>
<title>Python Set intersection_update() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> intersection_update()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="python_ref_set.asp">&#10094; Set Methods</a>
</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove the items that is not present in both <code class="w3-codespan">x</code>, and set <code class="w3-codespan">y</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>x.intersection_update(y)
    <br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_intersection_update">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">intersection_update()</code> method removes the 
items that is not present in both sets (or in all sets if the comparison is done 
between more than two sets).</p>

<p>The <code class="w3-codespan">intersection_update()</code> method is different 
from the <code class="w3-codespan">intersection()</code> method, because the 
<code class="w3-codespan">intersection()</code> 
method <em>returns a new set</em>, without the unwanted items, and the
<code class="w3-codespan">intersection_update()</code> method <em>removes</em> the 
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.intersection_update(<em>set1, set2 ... etc</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>set2</em></td>
    <td>Optional. The other set to search for equal items in.<br>You can compare 
    as many sets you like.<br>Separate the sets with a comma</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Compare 3 sets, and return a set with items that is present in all 3 sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>y = {&quot;c&quot;, 
    &quot;d&quot;, &quot;e&quot;}<br>z = {&quot;f&quot;, 
    &quot;g&quot;, &quot;c&quot;}<br><br>x.intersection_update(y, z)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_intersection_update2">Run example &raquo;</a>
</div>
