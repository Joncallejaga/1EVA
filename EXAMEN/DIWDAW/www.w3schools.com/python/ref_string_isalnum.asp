...
<html lang="en-US">
<head>
<title>Python String isalnum() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isalnum()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are alphanumeric:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Company12&quot;<br><br>x = txt.isalnum()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isalnum">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isalnum()</code> method returns True if all the 
characters are alphanumeric, meaning alphabet letter (a-z) and numbers (0-9).</p>
<p>Example of characters that are not alphanumeric: (space)!#%&amp;? etc.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text is alphanumeric:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Company 12&quot;<br><br>x = txt.isalnum()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isalnum2">Run example &raquo;</a>
</div>
