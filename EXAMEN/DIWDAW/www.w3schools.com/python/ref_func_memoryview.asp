...
<html lang="en-US">
<head>
<title>Python memoryview() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">memoryview()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create and print a memoryview object:</p>
  <div class="w3-code notranslate pythonHigh">
    x = memoryview(b&quot;Hello&quot;)<br><br>print(x)<br><br>#return the Unicode of the 
    first character<br>print(x[0])<br><br>#return the Unicode of the second 
    character<br>print(x[1])<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_memoryview">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">memoryview()</code> function returns a memory view object from a specified object.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>obj</em></td>
    <td>A Bytes object or a Bytearray object.</td>
    </tr>
</tbody></table>
