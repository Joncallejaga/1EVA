...
<html lang="en-US">
<head>
<title>Python iter() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">iter()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create an iterator object, and print the items:</p>
  <div class="w3-code notranslate pythonHigh">
    x = iter([&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;])<br>print(next(x))<br>print(next(x))<br>
    print(next(x))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_iter">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">iter()</code> function returns 
...
<div class="w3-code w3-border notranslate">
  <div>
    iter(<em>object</em>, <em>subclass</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Optional. If the object is a callable object the iteration will stop 
    when the returned value is the same as the sentinel</td>
    </tr>
</tbody></table>
...
<p>The <a href="ref_func_reversed.asp">reversed()</a> function returns a reversed iterator object.</p>
