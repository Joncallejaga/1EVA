...
<html lang="en-US">
<head>
<title>Python bytes() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">bytes()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return an array of 4 bytes:</p>
  <div class="w3-code notranslate pythonHigh">
    x = bytes(4)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_bytes">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">bytes()</code> function returns a bytes 
object.</p>
<p>It can convert objects into bytes objects, or create empty bytes 
object of the specified size.</p>
<p>The difference between <code class="w3-codespan">bytes()</code> and
<code class="w3-codespan">bytearray()</code> is that <code class="w3-codespan">
bytes()</code> returns an object that cannot be modified, and
<code class="w3-codespan">bytearray()</code> returns an object that can be 
modified.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>x</em></td>
    <td>A source to use when creating the bytes object.<br><br>If it is an 
    integer, an empty bytes object of the specified size will be created.<br>
    <br>If it is a String, make sure you specify the encoding of the source.</td>
    </tr>
    <tr>
    <td><em>encoding</em></td>
    <td>The encoding of the string</td>
    </tr>
  <tr>
    <td><em>error</em></td>
    <td>Specifies what to do if the encoding fails.</td>
  </tr>
</tbody></table>
...
<p><a href="ref_func_bytearray.asp">The bytearray() Function</a></p>
