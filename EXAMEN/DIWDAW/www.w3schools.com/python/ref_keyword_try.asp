...
<html lang="en-US">
<head>
<title>Python try Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> try</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Try a block of code, and decide what to to if it raises an error:</p>
...
<p>The <code class="w3-codespan">try</code> keyword is used in try...except 
blocks. It defines a block of code test if it contains any errors.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Raise an error and stop the program when there is an error in the try 
  block:</p>
  <div class="w3-code notranslate pythonHigh">
    try:<br>&nbsp; x &gt; 3<br>except:<br>&nbsp; Exception(&quot;Something went wrong&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_try">Run example &raquo;</a>
</div>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_except.asp">except</a></code> 
keyword.</p>
