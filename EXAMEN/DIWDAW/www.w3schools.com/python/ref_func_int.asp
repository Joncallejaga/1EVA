...
<html lang="en-US">
<head>
<title>Python int() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">int()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert the number 3.5 into an integer:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    int(3.5)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_int">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">int()</code> function converts the specified 
value into an integer number.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>value</em></td>
    <td>A number or a string that can be converted into an integer number</td>
    </tr>
    <tr>
    <td><em>base</em></td>
    <td>A number representing the number format. Default value: 10</td>
    </tr>
</tbody></table>
