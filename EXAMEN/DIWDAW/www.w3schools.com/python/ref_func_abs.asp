...
<html lang="en-US">
<head>
<title>Python abs() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">abs()</span> Function</h1>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_abs">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">abs()</code> function returns the absolute 
value of the specified number.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the absolute value of a complex number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = abs(3+5j)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_abs_complex">Run example &raquo;</a>
</div>
