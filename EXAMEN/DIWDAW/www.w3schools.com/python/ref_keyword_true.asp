...
<html lang="en-US">
<head>
<title>Python True Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> True</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print the result of the comparison &quot;7 is larger than 6&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    print(7 &gt; 6)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_true">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">True</code> keyword is a Boolean value, and 
result of a comparison operation.</p>
<p>The <code class="w3-codespan">True</code> keyword is the same as 1 (<code class="w3-codespan">False</code> 
is the same as 0).</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Other comparisons that returns True:</p>
  <div class="w3-code notranslate pythonHigh">
    print(5 &lt; 6)<br><br>print(2 in [1,2,3])<br><br>print(5 is 5)<br>
    <br>print(5 == 5)<br><br>print(5 == 5 or 6 == 7)<br><br>print(5 == 5 and 7 
    == 7)<br><br>print(&quot;hello&quot; is not &quot;goodbye&quot;)<br><br>print(not(5 == 
    7))<br><br>
    print(4 not in [1,2,3])</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_true2">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_false.asp">False</a></code> 
keyword.</p>
