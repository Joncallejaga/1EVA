...
<html lang="en-US">
<head>
<title>Python Set difference() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> difference()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a set that contains the items that only exist in set
  <code class="w3-codespan">x</code>, and not in set <code class="w3-codespan">y</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>z = x.difference(y)
    <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_difference">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">difference()</code> method returns a set that 
contains the difference between two sets.</p>
<p>Meaning: The returned set contains items that exist only in the first set, 
and not in both sets.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.difference(<em>set</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Reverse the first example. Return a set that contains the items 
  that only exist in set <code class="w3-codespan">y</code>, and not in set
  <code class="w3-codespan">x</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>z = y.difference(x)
    <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_difference2">Run example &raquo;</a>
</div>
