...
<html lang="en-US">
<head>
<title>Python None Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> None</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Assign the value None to a variable:</p>
  <div class="w3-code notranslate pythonHigh">
    x = None<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_none">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">None</code> keyword is used to define a null 
value, or no value at all.</p>
<p>None is not the same as 0, False, or an empty string. None is a datatype of 
its own (NoneType) and only None can be None.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>If you do a boolean if test, what will happen? Is None True or False:</p>
  <div class="w3-code notranslate pythonHigh">
    x = None<br><br>if x:<br>&nbsp; print(&quot;Do you think None is True&quot;)<br>else:<br>&nbsp; 
    print(&quot;None is not True...&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_none2">Run example &raquo;</a>
</div>
