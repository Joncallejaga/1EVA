...
<html lang="en-US">
<head>
<title>Python set() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">set()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a set containing fruit names:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    set(('apple', 'banana', 'cherry'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">set()</code> function creates a set object.</p>
<p>The items in a set list are unordered, so it will appear in random order.</p>
<p>Read more about sets in the chapter <a href="python_sets.asp">Python 
Sets</a>.</p>
