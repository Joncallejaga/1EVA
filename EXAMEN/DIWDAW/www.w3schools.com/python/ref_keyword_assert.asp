...
<html lang="en-US">
<head>
<title>Python assert Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> assert</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Test if a condition returns True:</p>
  <div class="w3-code notranslate pythonHigh">
    x = &quot;hello&quot;<br><br>#if condition returns True, then nothing happens:<br>assert x == &quot;hello&quot;<br><br>#if condition returns 
    False, AssertionError is raised:<br>assert x == &quot;goodbye&quot;</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_assert">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">assert</code> keyword is used when debugging 
code.</p>

<p>The <code class="w3-codespan">assert</code> keyword lets you test if a 
condition in your code returns True, if not, the program will raise an 
AssertionError.</p>
<p>You can write a message to be written if the code returns False, check the 
example below.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Write a message if the condition is False:</p>
  <div class="w3-code notranslate pythonHigh">
    x = &quot;hello&quot;<br><br>#if condition returns 
    False, AssertionError is raised:<br>assert x == &quot;goodbye&quot;, &quot;x 
    should be 'hello'&quot;</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_assert2">Run example &raquo;</a>
</div>
