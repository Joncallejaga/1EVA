...
<html lang="en-US">
<head>
<title>Python Set intersection() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> intersection()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a set that contains the items that exist in both set
  <code class="w3-codespan">x</code>, and set <code class="w3-codespan">y</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>z = x.intersection(y)
    <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_intersection">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">intersection()</code> method returns a set that 
contains the similarity between two or more sets.</p>
<p>Meaning: The returned set contains only items that exist in both sets, or in 
all sets if the comparison is done with more than two sets.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.intersection(<em>set1, set2 ... etc</em>)
  </div>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    ...
    {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>y = {&quot;c&quot;, 
    &quot;d&quot;, &quot;e&quot;}<br>z = {&quot;f&quot;, 
    &quot;g&quot;, &quot;c&quot;}<br><br>result = x.intersection(y, z)<br><br>print(result)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_intersection2">Run example &raquo;</a>
</div>
