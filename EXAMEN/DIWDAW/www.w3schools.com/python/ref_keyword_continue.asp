...
<html lang="en-US">
<head>
<title>Python continue Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> continue</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Skip the iteration if the variable i is 3, but continue with the next iteration:</p>
  <div class="w3-code notranslate pythonHigh">
    for i in range(9):<br>&nbsp; if i == 3:<br>&nbsp;&nbsp;&nbsp; continue<br>&nbsp; 
    print(i)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_continue">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">continue</code> keyword is used to end the 
current iteration in a <code class="w3-codespan">for</code> loop (or a
<code class="w3-codespan">while</code> loop), and continues to the next 
iteration.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Use the continue keyword in a while loop:</p>
  <div class="w3-code notranslate pythonHigh">
    i = 0<br>while i &lt; 9:<br>&nbsp; i += 1<br>&nbsp; if i == 3:<br>&nbsp;&nbsp;&nbsp; 
    continue<br>&nbsp; print(i)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_continue2">Run example &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>
<p>Use the <code class="w3-codespan"><a href="ref_keyword_break.asp">break</a></code> 
keyword to end the loop completely.</p>
<p>Read more about for loops in our <a href="python_for_loops.asp">Python For Loops Tutorial</a>.</p>
<p>Read more about while loops in our <a href="python_while_loops.asp">Python While Loops Tutorial</a>.</p>
