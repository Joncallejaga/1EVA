...
<html lang="en-US">
<head>
<title>Python String partition() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> partition()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Search for the word &quot;bananas&quot;, and return a tuple with three elements:</p>
  <p>1 - everything before the &quot;match&quot;<br>2 - the &quot;match&quot;<br>3 - everything 
  after the &quot;match&quot;</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;I could eat bananas all day&quot;<br><br>x = txt.partition(&quot;bananas&quot;)<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_partition">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">partition()</code> method searches for a 
specified string, and splits the string into a tuple containing three elements.</p>
<p>The first element contains the part before the specified string.</p>
<p>The second element contains the specified string.</p>
<p>The third element contains the part after the string.</p>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> This method search for the <em>first</em> occurrence 
  of the specified string.</p>
</div>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.partition(<em>value</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>If the specified value is not found, the partition() method returns a tuple 
  containing: 1 - the whole string, 2 - an empty string, 3 - an empty string:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;I could eat bananas all day&quot;<br><br>x = txt.partition(&quot;apples&quot;)<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_partition2">Run example &raquo;</a>
</div>
