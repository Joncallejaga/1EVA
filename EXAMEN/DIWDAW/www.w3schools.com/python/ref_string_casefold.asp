...
<html lang="en-US">
<head>
<title>Python String casefold() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> casefold()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Make the string lower case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, And Welcome To My World!&quot;<br><br>x = txt.casefold()<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_casefold">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">casefold()</code> method returns a string where 
all the characters are lower case.</p>
<p>This method is similar to the <code class="w3-codespan">
<a href="ref_string_lower.asp">lower()</a></code> method, but the
<code class="w3-codespan">casefold()</code> method is 
...
converted using the <code class="w3-codespan">casefold()</code> method.</p>
