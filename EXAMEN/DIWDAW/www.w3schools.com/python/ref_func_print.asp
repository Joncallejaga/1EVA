...
<h1>Python <span class="color_h1">print()</span> Function</h1>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_print">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">print()</code> function prints the specified message to the screen, or other standard output device.</p>
<p>The message can be a string, or any other object, the object will be converted into 
a string before written to the screen.</p>
<hr>
...
<div class="w3-code w3-border notranslate">
  <div>
    print<em>(object(s)</em>, 
    separator=<em>separator</em>, end=<em>end</em>, file=<em>file</em>, flush=<em>flush</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Any object, and as many as you like. Will be converted to string before 
    printed</td>
    </tr>
    <tr>
    <td>sep='<em>separator</em>'</td>
    <td>Optional. Specify how to separate the objects, if there is more than 
    one. Default is ''</td>
    </tr>
    <tr>
    <td>end='<em>end</em>'</td>
    ...
    <tr>
    <td><em>file</em></td>
    <td>Optional. An object with a write method. Default is sys.stdout</td>
    </tr>
    <tr>
    <td><em>flush</em></td>
    <td>Optional. A Boolean, specifying if the output is flushed (True) or 
    buffered (False). Default is False</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print more than one object:</p>
  <div class="w3-code notranslate pythonHigh">
    print(&quot;Hello&quot;, &quot;how are you?&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_print2">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <p>Print a tuple:</p>
  <div class="w3-code notranslate pythonHigh">
    x = (&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;)<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_print3">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Print two messages, and specify the separator:</p>
  <div class="w3-code notranslate pythonHigh">
    print(&quot;Hello&quot;, &quot;how are you?&quot;, sep=&quot; ---&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_print4">Run example &raquo;</a>
</div>
