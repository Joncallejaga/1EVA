...
<h1>Python <span class="color_h1"> as</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Refer to the calendar module as c:</p>
  <div class="w3-code notranslate pythonHigh">
    import calendar as c<br><br>print(c.month_name[1])</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_as">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">as</code> keyword is used to create an alias.</p>
<p>In the example above, we create an alias, <code class="w3-codespan">c</code>, 
when importing the calendar module, and now we can refer to the calendar module 
by using <code class="w3-codespan">c</code> instead of <code class="w3-codespan">
calendar</code>.</p>
...
<p>The <code class="w3-codespan"><a href="ref_keyword_import.asp">import</a></code> keyword.</p>

<p>The <code class="w3-codespan"><a href="ref_keyword_from.asp">from</a></code> keyword.</p>

<p>Read more about modules in our <a href="python_modules.asp">Python 
Modules Tutorial</a>.</p>
