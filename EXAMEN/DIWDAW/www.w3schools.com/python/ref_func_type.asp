...
<html lang="en-US">
<head>
<title>Python type() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">type()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the type of these objects:</p>
  <div class="w3-code notranslate pythonHigh">
    a = ('apple', 'banana', 'cherry')<br>b = &quot;Hello World&quot;<br>c = 33<br><br>x = 
    type(a)<br>y = type(b)<br>z = type(c)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_type">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">type()</code> function returns the type of the 
specified object</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>Required. If only one parameter is specified, the type() function 
    returns the type of this object</td>
    </tr>
    <tr>
    <td><em>bases</em></td>
    <td>Optional. Specifies the base classes</td>
    </tr>
    <tr>
    <td><em>dict</em></td>
    <td>Optional. Specifies the namespace with the definition for the class</td>
    </tr>
</tbody></table>
