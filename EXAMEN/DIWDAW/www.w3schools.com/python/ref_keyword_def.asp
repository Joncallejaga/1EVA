...
<html lang="en-US">
<head>
<title>Python def Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> def</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create and execute a function:</p>
  <div class="w3-code notranslate pythonHigh">
    def my_function():<br>&nbsp; print(&quot;Hello from a function&quot;)<br><br>
    my_function()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_def">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">def</code> keyword is used to create, (or 
define) a function.</p>

<hr>

<h2>Related Pages</h2>
<p>Read more about functions in our <a href="python_functions.asp">Python Functions Tutorial</a>.</p>
