...
<html lang="en-US">
<head>
<title>Python except Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> except</span> Keyword</h1>

<p>
<a class="w3-btn w3-white w3-border" href="python_ref_keywords.asp">&#10094; Python Keywords</a>
</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>If the statement raises an error print &quot;Something went wrong&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    try:<br>&nbsp; x &gt; 3<br>except:<br>&nbsp; print(&quot;Something went wrong&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_except">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">except</code> keyword is used in try...except 
blocks. It defines a block of code to run if the try block raises an error.</p>
<p>You can define different blocks for different error types, and blocks to 
execute if nothing went wrong, see examples below.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Write one message if it is a NameError, and another if it is an 
  TypeError:</p>
  <div class="w3-code notranslate pythonHigh">
    x = &quot;hello&quot;<br><br>try:<br>&nbsp; x &gt; 3<br>except NameError:<br>&nbsp; 
    print(&quot;You have a variable that is not defined.&quot;)<br>except TypeError:<br>&nbsp; 
    print(&quot;You are comparing values of different type&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_except2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Try to execute a statement that raises an error, but none of the defined 
  error types (in this 
  case, a ZeroDivisionError):</p>
  <div class="w3-code notranslate pythonHigh">
    try:<br>&nbsp; x = 1/0<br>except NameError:<br>&nbsp; print(&quot;You have a 
    variable that is not defined.&quot;)<br>except TypeError:<br>&nbsp; print(&quot;You 
    are comparing values of different type&quot;)<br>except:<br>&nbsp; 
    print(&quot;Something else went wrong&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_except3">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Write a message if no errors were raised:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 1<br><br>try:<br>&nbsp; x &gt; 10<br>except NameError:<br>&nbsp; 
    print(&quot;You have a variable that is not defined.&quot;)<br>except TypeError:<br>&nbsp; 
    print(&quot;You are comparing values of different type&quot;)<br>else:<br>&nbsp; 
    print(&quot;The 'Try' code was executed without raising any errors!&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_except4">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_try.asp">try</a></code> 
keyword.</p>
<p>The <code class="w3-codespan"><a href="ref_keyword_finally.asp">finally</a></code> 
keyword.</p>
