...
<html lang="en-US">
<head>
<title>Python next() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">next()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create an iterator, and print the items one by one:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = iter([&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;])<br>x = 
    next(mylist)<br>print(x)<br>x = next(mylist)<br>print(x)<br>x = next(mylist)<br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_next">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">next()</code> function returns 
the next item in an iterator.</p>
<p>You can add a default return value, to return if the iterable has reached to 
its end.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    next(<em>iterable</em>, <em>default</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Required. An iterable object.</td>
    </tr>
    <tr>
    <td><em>default</em></td>
    <td>Optional. An default value to return if the iterable has reached to its 
    end.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a default value when the iterable has reached to its end:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = iter([&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;])<br>x = 
    next(mylist, &quot;orange&quot;)<br>print(x)<br>x = next(mylist, &quot;orange&quot;)<br>print(x)<br>x = 
    next(mylist, &quot;orange&quot;)<br>print(x)<br>x = next(mylist, &quot;orange&quot;)<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_next2">Run example &raquo;</a>
</div>
