...
<html lang="en-US">
<head>
<title>Python String splitlines() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> splitlines()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Split a string into a list where each line is a list item:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Thank 
    you for the music\nWelcome to the jungle&quot;<br><br>x = txt.splitlines()<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_splitlines">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">splitlines()</code> method splits a string into a 
list. The splitting is done at line breaks.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.splitlines(<em>keeplinebreaks</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>keeplinebreaks</em></td>
    <td>Optional. Specifies if the line breaks should be included (True), or not 
    (False). Default value is not (False)</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Split the string, but keep the line breaks:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Thank 
    you for the music\nWelcome to the jungle&quot;<br><br>x = txt.splitlines(True)<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_splitlines2">Run example &raquo;</a>
</div>
