...
<html lang="en-US">
<head>
<title>Python format() Function</title>
<meta charset="utf-8">
...
<div class='w3-card-2 topnav notranslate' id='topnav'>
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a class="w3-bar-item w3-button" href='default.asp' title='Python Tutorial'>PYTHON</a>
    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>
          ...
          <a class="w3-bar-item w3-button" href='default.asp'>Learn Python</a>
    ...
    <div id='nav_references' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col m4'>
          ...
          <a class="w3-bar-item w3-button" href='python_reference.asp'>Python Reference</a>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href='python_exercises.asp'>Python Exercises</a>
          <h3>XML</h3>
...
<h1>Python <span class="color_h1">format()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Format the number 0.5 into a percentage value:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    format(0.5, '%')<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_format">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">format()</code> function formats a specified 
value into a specified format.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>value</em></td>
    <td>A value of any format</td>
    </tr>
    <tr>
    <td><em>format</em></td>
    <td>The format you want to format the value into.<br>Legal values:<br>
    <code class="w3-codespan">'&lt;'</code> - Left aligns the result (within the available space)<br>
    <code class="w3-codespan">'&gt;'</code> - Right aligns the result (within the available space)<br>
    <code class="w3-codespan">'^'</code> - Center aligns the result (within the available space)<br>
    <code class="w3-codespan">'='</code> - Places the sign to the left most position<br>
    <code class="w3-codespan">'+'</code> - Use a sign to indicate if the result is positive or negative<br>
    <code class="w3-codespan">'-'</code> - Use a sign for negative values only<br>
    <code class="w3-codespan">' '</code> - Use a leading space for positive numbers<br>
    <code class="w3-codespan">','</code> - Use a comma as a thousand separator<br>
    <code class="w3-codespan">'_'</code> - Use a underscore as a thousand separator<br>
    <code class="w3-codespan">'b'</code> - Binary format<br>
    <code class="w3-codespan">'c'</code> - Converts the value into the corresponding unicode character<br>
    <code class="w3-codespan">'d'</code> - Decimal format<br>
    <code class="w3-codespan">'e'</code> - Scientific format, with a lower case e<br>
    <code class="w3-codespan">'E'</code> - Scientific format, with an upper case E<br>
    <code class="w3-codespan">'f'</code> - Fix point number format<br>
    <code class="w3-codespan">'F'</code> - Fix point number format, upper case<br>
    <code class="w3-codespan">'g'</code> - General format<br>
    <code class="w3-codespan">'G'</code> - General format (using a upper case E for scientific notations)<br>
    <code class="w3-codespan">'o'</code> - Octal format<br>
    <code class="w3-codespan">'x'</code> - Hex format, lower case<br>
    <code class="w3-codespan">'X'</code> - Hex format, upper case<br>
    <code class="w3-codespan">'n'</code> - Number format<br>
    <code class="w3-codespan">'%'</code> - Percentage format
    </td>
    </tr>
</tbody></table>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Format 255 into a hexadecimal value:</p>
  <div class="w3-code notranslate pythonHigh">
    x = format(255, 'x')
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_format2">Run example &raquo;</a>
</div>
...
<a href="default.asp">Python Tutorial</a><br>
</div>
</div>
<div class="w3-col l3 m6 s12">
<div class="top10">
...
<a href="python_reference.asp">Python Reference</a><br>
</div>
</div>
<div class="w3-col l3 m6 s12">
<div class="top10">
