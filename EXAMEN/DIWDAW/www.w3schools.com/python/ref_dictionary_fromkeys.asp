...
<html lang="en-US">
<head>
<title>Python Dictionary fromkeys() Method</title>
<meta charset="utf-8">
...
<h1>Python Dictionary <span class="color_h1">fromkeys()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a dictionary with 3 keys, all with the value 0:</p>
  <div class="w3-code notranslate pythonHigh">
    x = ('key1', 'key2', 'key3')<br>y = 0<br><br>thisdict = dict.fromkeys(x, y)<br>
    <br>print(thisdict)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_dictionary_fromkeys">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">fromkeys()</code> method returns a dictionary 
with the specified keys and values.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    dict.fromkeys(<em>keys, value</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>keys</em></td>
    <td>Required. An iterable specifying the keys of the new dictionary</td>
    </tr>
  <tr>
    <td><em>value</em></td>
    <td>Optional. The value for all keys. Default value is None</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Same example as above, but without specifying the value:</p>
  <div class="w3-code notranslate pythonHigh">
    x = ('key1', 'key2', 'key3')<br><br>thisdict = dict.fromkeys(x)<br><br>
    print(thisdict)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_dictionary_fromkeys2">Run example &raquo;</a>
</div>
