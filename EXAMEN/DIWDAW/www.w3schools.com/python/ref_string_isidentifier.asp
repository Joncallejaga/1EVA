...
<html lang="en-US">
<head>
<title>Python String isidentifier() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isidentifier()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the string is a valid identifier:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Demo&quot;<br><br>x = txt.isidentifier()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isidentifier">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isidentifier()</code> method returns True if the 
string is a valid identifier, otherwise False.</p>
<p>A string is considered a valid identifier if it only contains alphanumeric 
letters (a-z) and (0-9), or underscores (_). A valid identifier cannot start 
with a number, or contain any spaces.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the strings are valid identifiers:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;MyFolder&quot;<br>b = &quot;Demo002&quot;<br>c = &quot;2bring&quot;<br>d = &quot;my demo&quot;<br><br>print(a.isidentifier())<br>print(b.isidentifier())<br>print(c.isidentifier())<br>print(d.isidentifier())<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isidentifier2">Run example &raquo;</a>
</div>
