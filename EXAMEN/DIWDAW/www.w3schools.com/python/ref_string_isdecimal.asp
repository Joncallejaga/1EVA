...
<html lang="en-US">
<head>
<title>Python String isdecimal() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isdecimal()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the unicode object are decimals:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;\u0033&quot; #unicode 
    for 3<br><br>x = txt.isdecimal()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isdecimal">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isdecimal()</code> method returns True if all the 
characters are decimals (0-9).</p>
<p>This method is used on unicode objects.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the unicode are decimals:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;\u0030&quot; #unicode for 0<br>b = &quot;\u0047&quot; #unicode for 
    G<br><br>print(a.isdecimal())<br>print(b.isdecimal())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isdecimal2">Run example &raquo;</a>
</div>
