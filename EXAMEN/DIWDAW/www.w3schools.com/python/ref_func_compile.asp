...
<html lang="en-US">
<head>
<title>Python compile() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">compile()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Compile text as code, and the execute it:</p>
  <div class="w3-code notranslate pythonHigh">
    mytext = 'print(55)'<br>x = compile('mytext', 'test', 'eval')<br>exec(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_compile">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">compile()</code> function returns the specified 
source as a code object, ready to be executed.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    compile(<em>source</em>,
    <em>filename</em>, <em>mode</em>, <em>flag</em>, <em>dont_inherit</em>, <em>
    optimize</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>source</em></td>
    <td>Required. The source to compile, can be a String, a Bytes object, or an 
    AST object</td>
    </tr>
    <tr>
    <td><em>filename</em></td>
    <td>Required. The name of the file that the source comes from. If the source 
    does not come from a file, you can write whatever you like</td>
    </tr>
    <tr>
    <td><em>mode</em></td>
    <td>Required. Legal values:<br>eval - if the source is a single expression<br>
    exec - if the source is a block of statements<br>single - if the source is a 
    single interactive statement</td>
    </tr>
    <tr>
    <td><em>flags</em></td>
    <td>Optional. How to compile the source. Default 0</td>
    </tr>
    <tr>
    <td><em>dont-inherit</em></td>
    <td>Optional. How to compile the source. Default False</td>
    </tr>
    <tr>
    <td><em>optimize</em></td>
    <td>Optional. Defines the optimization level of the compiler. Default -1</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Compile more than one statement, and the execute it:</p>
  <div class="w3-code notranslate pythonHigh">
    mytext = 'print(55)\nprint(88)'<br>x = compile('mytext', 'test', 'exec')<br>exec(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_compile2">Run example &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>

<p><a href="ref_func_eval.asp">The eval() Function</a></p>
<p><a href="ref_func_exec.asp">The exec() Function</a></p>
