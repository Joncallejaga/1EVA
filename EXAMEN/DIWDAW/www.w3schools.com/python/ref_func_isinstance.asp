...
<html lang="en-US">
<head>
<title>Python isinstance() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">isinstance()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the number 5 is an integer:</p>
  <div class="w3-code notranslate pythonHigh">
    x = isinstance(5, int)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_isinstance">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isinstance()</code> function returns 
<code class="w3-codespan">True</code> if the specified object is of the 
specified type, otherwise <code class="w3-codespan">False</code>.</p>
<p>If the type parameter is a tuple, this function will return <code class="w3-codespan">True</code> if the 
object is <em>one </em>of the types in the tuple.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    isinstance(<em>object</em>, <em>type</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>Required. An object.</td>
    </tr>
    <tr>
    <td><em>type</em></td>
    <td>A type or a class, or a tuple of types and/or classes</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if "Hello" is one of the types described in the type parameter:</p>
  <div class="w3-code notranslate pythonHigh">
    x = isinstance(&quot;Hello&quot;, 
    (float, int, str, list, dict, tuple))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_isinstance2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if y is an instance of myObj:</p>
  <div class="w3-code notranslate pythonHigh">
class myObj:<br>
&nbsp;&nbsp;name = "John"<br>
<br>
y = myObj()<br>
<br>
x = isinstance(y, myObj)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_isinstance3">Run example &raquo;</a>
</div>
...
<p>The <a href="ref_func_issubclass.asp">issubclass()</a> function, to check if an object is a subclass of another object.</p>
<hr>
