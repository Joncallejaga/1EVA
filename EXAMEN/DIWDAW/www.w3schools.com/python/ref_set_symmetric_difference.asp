...
<html lang="en-US">
<head>
<title>Python Set symmetric_difference() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> symmetric_difference()</span> Method</h1>
...
<div class="w3-example">
  ...
  present in both sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
    <br>z = x.symmetric_difference(y) <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_symmetric_difference">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">symmetric_difference()</code> method returns a set that 
contains all items from both set, but not the items that are present in both 
sets.</p>
<p>Meaning: The returned set contains a mix of items that are not present in 
both sets.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.symmetric_difference(<em>set</em>)
  </div>
</div>
