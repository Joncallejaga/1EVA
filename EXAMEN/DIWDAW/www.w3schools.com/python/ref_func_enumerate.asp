...
<html lang="en-US">
<head>
<title>Python enumerate() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">enumerate()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert a tuple into an enumerate object:</p>
  <div class="w3-code notranslate pythonHigh">
    x = ('apple', 'banana', 'cherry')<br>
    y = enumerate(x)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_enumerate">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">enumerate()</code> function takes a collection 
(e.g. a tuple) and returns it as an enumerate object.</p>
<p>The <code class="w3-codespan">enumerate()</code> function adds a counter as 
the key of the enumerate object.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    enumerate(<em>iterable</em>, <em>start</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>An iterable object</td>
    </tr>
    <tr>
    <td><em>start</em></td>
    <td>A Number. Defining the start number of the enumerate object. Default 0</td>
    </tr>
</tbody></table>
