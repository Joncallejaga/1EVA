...
<html lang="en-US">
<head>
<title>Python issubclass() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">issubclass()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the class "myAge" is a subclass of "myObj":</p>
  <div class="w3-code notranslate pythonHigh">
    class myAge:<br>&nbsp; age = 36<br><br>class myObj(myAge):<br>&nbsp; name = 
    &quot;John&quot;<br>&nbsp; age = myAge<br><br>x = issubclass(myObj, myAge)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_issubclass">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">issubclass()</code> function returns 
<code class="w3-codespan">True</code> if the specified object is a subclass of 
the 
specified object, otherwise <code class="w3-codespan">False</code>.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    issubclass(<em>object</em>, <em>subclass</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>subclass</em></td>
    <td>A class object, or a tuple of class objects</td>
    </tr>
</tbody></table>
...
<p>The <a href="ref_func_isinstance.asp">isinstance()</a> function, to check if an object is of a certain type.</p>
