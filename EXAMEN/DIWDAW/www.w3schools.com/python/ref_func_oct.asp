...
<html lang="en-US">
<head>
<title>Python oct() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">oct()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert the number 12 into an octal value:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    oct(12)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_oct">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">oct()</code> function converts an integer into an octal string.</p>
<p>Octal strings in Python are prefixed with <code class="w3-codespan">0o</code>.</p>
