...
<h1>Python <span class="color_h1"> is</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if two objects are the same object:</p>
  <div class="w3-code notranslate pythonHigh">
    x = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>y = x<br><br>print(x is y)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_is">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">is</code> keyword is used to test if two 
variables refer to the same object.</p>

<p>The test returns True if the two objects are the same object.</p>
<p>The test returns False if they are not the same object, even if the two 
objects are 100% equal.</p>
<p>Use the == operator to test if two variables are equal.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Test two objects that are equal, but not the same object:</p>
  <div class="w3-code notranslate pythonHigh">
    x = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>
    y = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>print(x is y)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_is2">Run example &raquo;</a>
</div>
