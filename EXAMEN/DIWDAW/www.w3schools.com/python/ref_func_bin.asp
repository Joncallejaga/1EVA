...
<html lang="en-US">
<head>
<title>Python bin() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">bin()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the binary version of 36:</p>
  <div class="w3-code notranslate pythonHigh">
    x = bin(36)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_bin">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">bin()</code> function returns the binary version of a specified integer.</p>

<p>The result will always start with the prefix <code class="w3-codespan">0b</code>.</p>
