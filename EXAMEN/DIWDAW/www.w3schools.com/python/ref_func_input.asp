...
<html lang="en-US">
<head>
<title>Python input() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">input()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Ask for the user's name and print it:</p>
  <div class="w3-code notranslate pythonHigh">
    print('Enter your name:')<br>x = input()<br>print('Hello, ' + x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_input">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">input()</code> function allows user input.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>prompt</em></td>
    <td>A String, representing a default message before the input.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Use the prompt parameter to write a message before the input:</p>
  <div class="w3-code notranslate pythonHigh">
    x = input('Enter your name:')<br>print('Hello, ' + x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_input2">Run example &raquo;</a>
</div>
