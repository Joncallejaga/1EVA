...
<html lang="en-US">
<head>
<title>Python divmod() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">divmod()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Display the quotient and the remainder of 5 divided by 2:</p>
  <div class="w3-code notranslate pythonHigh">
    x = divmod(5, 2)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_divmod">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">divmod()</code> function returns a tuple 
containing the quotient&nbsp; and the remainder when argument1 (divident) is 
divided by argument2 (divisor).</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    divmod(<em>divident</em>, <em>divisor</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>divident</em></td>
    <td>A Number. The number you want to divide</td>
    </tr>
    <tr>
    <td><em>divisor</em></td>
    <td>A Number. The number you want to divide with</td>
    </tr>
</tbody></table>
