...
<html lang="en-US">
<head>
<title>Python ascii() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">ascii()</span> Function</h1>

<p>
<a class="w3-btn w3-white w3-border" href="python_ref_functions.asp">❮ Built-in 
Functions</a>
</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Escape non-ascii characters:</p>
  <div class="w3-code notranslate pythonHigh">
    x = ascii("My name is Ståle")
   </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_ascii">
  Run example »</a>
</div>
...
<p>The <code class="w3-codespan">ascii()</code> function returns a readable 
version of any object (Strings, Tuples, Lists, etc).</p>

<p>The <code class="w3-codespan">ascii()</code> function will replace any non-ascii 
characters with escape characters:</p>
<p><code class="w3-codespan">å</code> will be replaced with
<code class="w3-codespan">\xe5</code>.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>An object, like String, List, Tuple, Dictionary etc.</td>
  </tr>
</tbody></table>
