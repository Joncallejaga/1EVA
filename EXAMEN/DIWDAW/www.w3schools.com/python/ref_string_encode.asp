...
<html lang="en-US">
<head>
<title>Python String encode() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> encode()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="python_ref_string.asp">❮ String 
Methods</a>
</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>UTF-8 encode the string:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = "My name is Ståle"<br><br>x = txt.encode()<br><br>print()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_encode">
  Run example »</a>
</div>
...
<p>The <code class="w3-codespan">encode()</code> method encodes the string, 
using the specified encoding. If no encoding is specified, UTF-8 will be used.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.encode(encoding=<em>encoding</em>, errors=<em>errors</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>errors</em></td>
    <td>Optional. A String specifying the error method. Legal values are:<br>
<table>
<tr class="w3-light-gray"><td><code class="w3-codespan">'backslashreplace'</code></td><td>
 - uses a backslash instead of the character that could not be encoded</td></tr>

<tr class="w3-light-gray"><td><code class="w3-codespan">'ignore'</code></td><td>
 - ignores the characters that cannot be encoded</td></tr>

<tr class="w3-light-gray"><td><code class="w3-codespan">'namereplace'</code></td><td>
 - replaces the character with a text explaining the character</td></tr>

<tr class="w3-light-gray"><td><code class="w3-codespan">'strict'</code></td><td>
 - Default, raises an error on failure</td></tr>

<tr class="w3-light-gray"><td><code class="w3-codespan">'replace'</code></td><td>
 - replaces the character with a questionmark</td></tr>

<tr class="w3-light-gray"><td><code class="w3-codespan">'xmlcharrefreplace'</code></td><td>
 - replaces the character with an xml character</td></tr>
</table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>These examples uses ascii encoding, and a character that cannot be encoded, 
  showing the result with different errors:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = "My name is Ståle"<br><br>print(txt.encode(encoding="ascii",errors="backslashreplace")<br>
    print(txt.encode(encoding="ascii",errors="ignore")<br>print(txt.encode(encoding="ascii",errors="namereplace")<br>
    print(txt.encode(encoding="ascii",errors="replace")<br>print(txt.encode(encoding="ascii",errors="xmlcharrefreplace")<br>
    print(txt.encode(encoding="ascii",errors="strict")<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_encode2">
  Run example »</a>
</div>
