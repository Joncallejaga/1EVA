...
<html lang="en-US">
<head>
<title>Python list() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">list()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a list containing fruit names:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    list(('apple', 'banana', 'cherry'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">list()</code> function creates a list object.</p>
<p>A list object is a collection which is ordered and changeable.</p>
<p>Read more about list&nbsp; in the chapter: <a href="python_lists.asp">Python 
Lists</a>.</p>
