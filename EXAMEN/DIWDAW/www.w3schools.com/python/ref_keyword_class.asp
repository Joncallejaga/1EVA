...
<html lang="en-US">
<head>
<title>Python class Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> class</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a class named &quot;Person&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; name = &quot;John&quot;<br>&nbsp; age = 36</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_class">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">class</code> keyword is used to create a class.</p>
<p>A class is like an object constructor. See the example below to see how we 
can use it to create an object.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create an object named p1, using the class from the example above:</p>
  <div class="w3-code notranslate pythonHigh">
    p1 = Person()<br><br>print(p1.name)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_class2">Run example &raquo;</a>
</div>


<hr>
<h2>Related Pages</h2>
<p>Read more about classes and objects in our <a href="python_classes.asp">Python 
Classes/Objects Tutorial</a>.</p>
