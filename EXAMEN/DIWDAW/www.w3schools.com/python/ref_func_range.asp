...
<h1>Python <span class="color_h1">range()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a sequence of numbers from 0 to 5, and print each item in the 
  sequence:</p>
  <div class="w3-code notranslate pythonHigh">
    x = range(6)<br>for n in x:<br>&nbsp; print(n)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_range">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">range()</code> function returns a sequence of 
numbers, starting from 0 by default, and increments by 1 (by default), and ends 
at a specified number.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>stop</em></td>
    <td>Optional. An integer number specifying at which position to endt.</td>
    </tr>
    <tr>
    <td><em>step</em></td>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a sequence of numbers from 3 to 5, and print each item in the 
  sequence:</p>
  <div class="w3-code notranslate pythonHigh">
    x = range(3, 6)<br>for n in x:<br>&nbsp; print(n)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_range2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Create a sequence of numbers from 3 to 20, but increment by 2 instead of 1:</p>
  <div class="w3-code notranslate pythonHigh">
    x = range(3, 20, 2)<br>for n in x:<br>&nbsp; print(n)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_range3">Run example &raquo;</a>
</div>
