...
<html lang="en-US">
<head>
<title>Python String isnumeric() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isnumeric()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are numeric:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = 
    &quot;565543&quot;<br><br>x = txt.isnumeric()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isnumeric">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isumeric()</code> method returns True if all the 
characters are numeric (0-9), otherwise False.</p>
<p>Exponents, like &sup2; 
and &#xBE; are also considered to be numeric values.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the characters are numeric:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;\u0030&quot; #unicode for 0<br>b = &quot;\u00B2&quot; #unicode for &amp;sup2;<br>
    c = &quot;10km2&quot;<br><br>
    print(a.isnumeric())<br>print(b.isnumeric())<br>print(c.isnumeric())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isnumeric2">Run example &raquo;</a>
</div>
