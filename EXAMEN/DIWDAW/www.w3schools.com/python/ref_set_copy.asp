...
<html lang="en-US">
<head>
<title>Python Set copy() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> copy()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Copy the <code class="w3-codespan">fruits</code> set:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>x = fruits.copy()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_copy">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">copy()</code> method copies the set.</p>
