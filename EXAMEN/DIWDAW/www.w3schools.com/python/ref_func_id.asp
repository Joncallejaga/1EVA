...
<html lang="en-US">
<head>
<title>Python id() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">id()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the unique id of a tuple object:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    ('apple', 'banana', 'cherry')<br>y = id(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_id">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">id()</code> function returns a unique id for 
the specified object.</p>
<p>All objects in Python has its own unique id.</p>
<p>The id is assigned to the object when it is created.</p>
<p>The id is the object's memory address, and will be different for each time 
you run the program. (except for some object that has a constant unique id, like 
integers from -5 to 256)</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>Any object, String, Number, List, Class etc.</td>
    </tr>
</tbody></table>
