...
<html lang="en-US">
<head>
<title>Python locals() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">locals()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Dispaly the local symbol table:</p>
  <div class="w3-code notranslate pythonHigh">
    x = locals()<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_locals">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">locals()</code> function returns the local symbol table as a dictionary.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    x = locals()<br>print(x[&quot;__file__&quot;])</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_locals2">Run example &raquo;</a>
</div>
