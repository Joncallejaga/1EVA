...
<html lang="en-US">
<head>
<title>Python slice() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">slice()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a tuple and a slice object. Use the slice object to get only the two 
  first items of the tuple:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;, &quot;e&quot;, &quot;f&quot;, &quot;g&quot;, &quot;h&quot;)<br>x = slice(2)<br>print(a[x])<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_slice">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">slice()</code> function returns a slice object.</p>
<p>A slice object is used to specify how to slice a sequence. You can specify 
where to start the slicing, and where to end. You can also specify the step, 
which allows you to e.g. slice only every other item.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    slice(<em>start</em>, <em>end, step</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>start</em></td>
    <td>Optional. An integer number specifying at which position to start the 
    slicing. Default is 0</td>
    </tr>
    <tr>
    <td><em>end</em></td>
    <td>An integer number specifying at which position to end the slicing</td>
    </tr>
    <tr>
    <td><em>step</em></td>
    <td>Optional. An integer number specifying the step of the slicing. Default 
    is 1</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a tuple and a slice object. Start the slice object at position 3, 
  and slice to position 5, and return the result:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;, &quot;e&quot;, &quot;f&quot;, &quot;g&quot;, &quot;h&quot;)<br>x = slice(3, 
    5)<br>print(a[x])<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_slice2">Run example &raquo;</a>
</div>


<div class="w3-example">
  <h3>Example</h3>
  <p>Create a tuple and a slice object. Use the step parameter to return every 
  third item:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;, &quot;e&quot;, &quot;f&quot;, &quot;g&quot;, &quot;h&quot;)<br>x = slice(0, 
    8, 3)<br>print(a[x])<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_slice3">Run example &raquo;</a>
</div>
