...
<h1>Python g<span class="color_h1">lobal</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Declare a global variable inside a function, and use it outside 
  the function:</p>
  <div class="w3-code notranslate pythonHigh">
    #create a function:<br>def myfunction():<br>&nbsp; global x<br>&nbsp; x = 
    &quot;hello&quot;<br><br>#execute the function:<br>myfunction()<br><br>#x should now 
    be global, and accessible in the global scope.<br>print(x)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_global">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">global</code> keyword is used to create global 
variables from a no-global scope, e.g. inside a function.</p>
