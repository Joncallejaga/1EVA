...
<html lang="en-US">
<head>
<title>Python Dictionary keys() Method</title>
<meta charset="utf-8">
...
<h1>Python Dictionary<span class="color_h1"> keys()</span> Method</h1>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    ...
    &quot;year&quot;: 1964<br>}<br><br>x = car.keys()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_dictionary_keys">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">keys()</code> method returns a view object. 
The view object contains the keys of the dictionary, as a list.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>When an item is added in the dictionary, the view object also gets 
  updated:</p>
  <div class="w3-code notranslate pythonHigh">
    car = {<br>&nbsp; &quot;brand&quot;: &quot;Ford&quot;,<br>&nbsp; &quot;model&quot;: &quot;Mustang&quot;,<br>&nbsp; 
    &quot;year&quot;: 1964<br>}<br><br>x = car.keys()<br><br>car[&quot;color&quot;] = 
    &quot;white&quot;<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_dictionary_keys2">Run example &raquo;</a>
</div>
