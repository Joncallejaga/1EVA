...
<html lang="en-US">
<head>
<title>Python for Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> for</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print each number from 1 to 8:</p>
  <div class="w3-code notranslate pythonHigh">
    for x in range(1, 9):<br>&nbsp; 
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_for">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">for</code> keyword is used to create a
<code class="w3-codespan">for</code> loop.</p>
<p>It can be used to iterate through a sequence, like a list, tuple, etc.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Loop through all items in a list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>for x in fruits:<br>&nbsp; print(x)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_for2">Run example &raquo;</a>
</div>
...
keyword to break out of a loop.</p>
<p>Use the <code class="w3-codespan"><a href="ref_keyword_continue.asp">continue</a></code> 
keyword to end the current iteration, but continue with the next.</p>
