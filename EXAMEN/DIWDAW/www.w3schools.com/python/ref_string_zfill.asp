...
<html lang="en-US">
<head>
<title>Python String zfill() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> zfill()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Fill the string with zeros until it is 10 characters long:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;50&quot;<br><br>x = txt.zfill(10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_zfill">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">zfill()</code> method adds zeros (0) at the 
beginning of the string, until it reaches the specified length.</p>
<p>If the value of the len parameter is less than the length of the string, no 
filling is done.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>len</em></td>
    <td>Required. A number specifying the position of the element you want to 
    remove</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Fill the strings with zeros until they are 10 characters long:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;hello&quot;<br>b = &quot;welcome to the jungle&quot;<br>c = &quot;10.000&quot;<br><br>print(a.zfill(10))<br>print(b.zfill(10))<br>print(c.zfill(10))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_zfill2">Run example &raquo;</a>
</div>
