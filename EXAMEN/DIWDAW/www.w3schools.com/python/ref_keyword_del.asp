...
<html lang="en-US">
<head>
<title>Python del Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> del</span> Keyword</h1>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    class MyClass:<br>&nbsp; name = &quot;John&quot;<br><br>del myClass<br><br>print(myClass)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_del">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">del</code> keyword is used to delete objects. 
In Python everything is an object, so the <code class="w3-codespan">del</code> 
keyword can also be used to delete variables, lists, or parts of a list etc.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    x = &quot;hello&quot;<br><br>del x<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_del2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Delete the first item in a list:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>del x[0]<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_del3">Run example &raquo;</a>
</div>
