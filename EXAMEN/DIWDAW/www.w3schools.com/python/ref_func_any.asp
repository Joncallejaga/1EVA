...
<html lang="en-US">
<head>
<title>Python any() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">any()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if any of the items in a list are True:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = [False, True, False]<br>
    x = any(mylist)
   </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_any">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">any()</code> function returns True if any item in an iterable are true, otherwise it returns False.</p>
<p>If the iterable object is empty, the <code class="w3-codespan">any()</code> 
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if any item in a <em>tuple</em> is True:</p>
  <div class="w3-code notranslate pythonHigh">
    mytuple = (0, 1, False)<br>
    x = any(mytuple)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_any_tuple">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if any item in a <em>set</em> is True:</p>
  <div class="w3-code notranslate pythonHigh">
    myset = {0, 1, 0)<br>
    x = any(myset)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_any_set">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check if any item in a <em>dictionary</em> is True:</p>
  <div class="w3-code notranslate pythonHigh">
    mydict = {0 : "Apple", 1 : "Orange"}<br>
    x = any(mydict)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_any_dict">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> When used on a dictionary, the any() function checks if any 
  of the <em>keys</em> are true, not the <em>values</em>.</p>
</div>
...
<p><a href="ref_func_all.asp">The all() Function</a></p>
<hr>
