...
<html lang="en-US">
<head>
<title>Python not Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> not</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return True if the statement is not True:</p>
  <div class="w3-code notranslate pythonHigh">
    x = False<br><br>print(not x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_not">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">not</code> keyword is a logical operator.</p>

<p>The return value will be <code class="w3-codespan">True</code> if the 
statement(s) are not <code class="w3-codespan">True</code>, otherwise it will 
...
and <code class="w3-codespan"><a href="ref_keyword_and.asp">and</a></code> are also 
logical operators.</p>
