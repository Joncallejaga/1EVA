...
<html lang="en-US">
<head>
<title>Python open() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">open()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Open a file and print the content:</p>
  <div class="w3-code notranslate pythonHigh">
    f = open(&quot;demofile.txt&quot;, &quot;r&quot;)<br>print(f.read())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_open">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">open()</code> function opens a file, and 
returns it as a file object.</p>

<p>Read more about file handling in our chapters about <a href="python_file_handling.asp">File Handling</a>.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>file</em></td>
    <td>The path and name of the file</td>
    </tr>
    <tr>
    <td><em>mode</em></td>
    <td>A string, define which mode you want to open the file in:
...
<p>Learn how to open files in our <a href="python_file_open.asp">Read Files Tutorial</a></p>
<p>Learn how to write/create files in our <a href="python_file_write.asp">Write/Create Files Tutorial</a></p>
<p>Learn how to delete files in our <a href="python_file_remove.asp">Delete Files Tutorial</a></p>
