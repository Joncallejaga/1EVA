...
<html lang="en-US">
<head>
<title>Python List remove() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> remove()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove the &quot;banana&quot; element of the <code class="w3-codespan">fruit </code>list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>
    fruits.remove(&quot;banana&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_remove">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">remove()</code> method removes the first 
occurrence of the element with the specified value.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>elmnt</em></td>
    <td>Required. Any type (string, number, list etc.) The element you want to 
    remove</td>
  </tr>
</tbody></table>
