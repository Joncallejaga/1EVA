...
<html lang="en-US">
<head>
<title>Python getattr() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">getattr()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Get the value of the &quot;age&quot; property of the &quot;Person&quot; object:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; name = &quot;John&quot;<br>&nbsp; age = 36<br>&nbsp; country = &quot;Norway&quot;<br><br>
    x =
    getattr(Person, 'age')<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_getattr">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">getattr()</code> function returns the value of 
the 
specified attribute from the specified object.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    getattr(<em>object</em>, <em>attribute</em>, <em>default</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>The name of the attribute you want to get the value from</td>
    </tr>
    <tr>
    <td><em>default</em></td>
    <td>Optional. The value to return if the attribute does not exist</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Use the &quot;default&quot; parameter to write a message when the attribute does not 
  exist:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; name = &quot;John&quot;<br>&nbsp; age = 36<br>&nbsp; country = &quot;Norway&quot;<br><br>
    x =
    getattr(Person, 'page', 'my message')<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_getattr2">Run example &raquo;</a>
</div>
...
<p>The <a href="ref_func_delattr.asp">delattr()</a> function, to remove an attribute</p>
<p>The <a href="ref_func_hasattr.asp">hasattr()</a> function, to check if an attribute exist</p>
<p>The <a href="ref_func_setattr.asp">setattr()</a> function, to set the value 
of an attribute</p>
