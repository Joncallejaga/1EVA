...
<html lang="en-US">
<head>
<title>Python nonlocal Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> nonlocal</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Make a function inside a function, which uses the variable x as a non local 
  variable:</p>
  <div class="w3-code notranslate pythonHigh">
    def myfunc1():<br>&nbsp; x = &quot;John&quot;<br>&nbsp; def myfunc2():<br>&nbsp;&nbsp;&nbsp; 
    nonlocal x<br>&nbsp;&nbsp;&nbsp; x = &quot;hello&quot;<br>&nbsp; myfunc2() <br>&nbsp; 
    return x<br><br>print(myfunc1())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_nonlocal">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">nonlocal</code> keyword is used to work with 
variables inside nested functions, where the variable should not belong to the 
inner function.</p>

<p>Use the keyword <code class="w3-codespan">nonlocal</code> to declare that the 
variable is not local.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Same example as above, but without the nonlocal keyword:</p>
  <div class="w3-code notranslate pythonHigh">
    def myfunc1():<br>&nbsp; x = &quot;John&quot;<br>&nbsp; def myfunc2():<br>&nbsp;&nbsp;&nbsp; 
    x = &quot;hello&quot;<br>&nbsp; myfunc2() <br>&nbsp; return x<br><br>print(myfunc1())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_nonlocal2">Run example &raquo;</a>
</div>
...
<h2>Related Pages</h2>
<p>The keyword <code class="w3-codespan"><a href="ref_keyword_global.asp">global</a></code> 
is used to make global variables.</p>
