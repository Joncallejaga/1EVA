...
<html lang="en-US">
<head>
<title>Python frozenset() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">frozenset()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Freeze the list, and make it unchangeable:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = ['apple', 'banana', 'cherry']<br>x = frozenset(mylist)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_frozenset">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">frozenset()</code> function returns an 
unchangeable frozenset object (which is like a <code class="w3-codespan">set</code> object, only unchangeable).</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>An iterable object, like list, set, tuple etc.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Try to change the value of a frozenset item.</p>
  <p>This will cause an error:</p>
  <div class="w3-code notranslate pythonHigh">
    mylist = ['apple', 'banana', 'cherry']<br>x = frozenset(mylist)<br>x[1] = 
    &quot;strawberry&quot;
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_frozenset2">Run example &raquo;</a>
</div>
