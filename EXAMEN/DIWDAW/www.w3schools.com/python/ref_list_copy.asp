...
<html lang="en-US">
<head>
<title>Python List copy() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> copy()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Copy the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry', 'orange']<br><br>x = fruits.copy()
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_copy">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">copy()</code> method returns a copy of the specified list.</p>
