...
<html lang="en-US">
<head>
<title>Python raise Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> raise</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Raise an error and stop the program if x is lower than 0:</p>
  <div class="w3-code notranslate pythonHigh">
    x = -1<br><br>if x &lt; 0:<br>&nbsp; raise Exception(&quot;Sorry, no numbers below 
    zero&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_raise">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">raise</code> keyword is used to raise an 
exception.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Raise a TypeError if x is not an integer:</p>
  <div class="w3-code notranslate pythonHigh">
    x = &quot;hello&quot;<br><br>if not type(x) is int:<br>&nbsp; raise TypeError(&quot;Only 
    integers are allowed&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_raise2">Run example &raquo;</a>
</div>
