...
<h1>Python <span class="color_h1"> in</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if &quot;banana&quot; is present in the list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br><br>if &quot;banana&quot; in fruits:<br>&nbsp; 
    print(&quot;yes&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_in">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">in</code> keyword has two purposes:</p>

<p>The <code class="w3-codespan">in</code> keyword is used to check if a value 
is present in a sequence (list, range, string etc.).</p>

<p>The <code class="w3-codespan">in</code> keyword is also used to iterate 
through a sequence in a <code class="w3-codespan">for</code> loop:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Loop through a list and print the items:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
    <br>for x in fruits:<br>&nbsp; 
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_in2">Run example &raquo;</a>
</div>
