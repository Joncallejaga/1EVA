...
<html lang="en-US">
<head>
<title>Python object() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">object()</span> Function</h1>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    x = 
    object()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_object">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">object()</code> function returns 
an empty object.</p>
<p>You cannot add new properties or methods to this object.</p>
<p>This object is the base for all classes, it holds the built-in properties and 
methods which are default for all classes.</p>
