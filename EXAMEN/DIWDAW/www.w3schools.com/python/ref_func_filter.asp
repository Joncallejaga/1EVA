...
<h1>Python <span class="color_h1">filter()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the array with only values above 18:</p>
  <div class="w3-code notranslate pythonHigh">
    ages = [5, 12, 17, 18, 24, 32]<br><br>def myFunc(x):<br>&nbsp; if x &lt; 18:<br>&nbsp;&nbsp;&nbsp; 
    return False<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; return True<br><br>adults 
    = filter(myFunc, ages)<br><br>
    for x in adults:<br>&nbsp; print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_filter">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">filter()</code> function returns an iterator 
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>A Function to be run for each item in the iterable</td>
    </tr>
    <tr>
    <td><em>iterable</em></td>
    <td>The iterable to be filtered</td>
    </tr>
</tbody></table>
