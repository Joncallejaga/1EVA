...
<html lang="en-US">
<head>
<title>Python Set union() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> union()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a set that contains all items from both sets, duplicates are 
  excluded:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
    <br>z = x.union(y) <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_union">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">union()</code> method returns a set that 
contains all items from the original set, and all items from the specified sets.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.union(<em>set1, set2...</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>set1</em></td>
    <td>Required. The set to unify with</td>
    </tr>
  <tr>
    <td><em>set2</em></td>
    <td>Optional. The other set to unify with.<br>You can compare as many sets 
    as you like.<br>Separate each set with a comma</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Unify more than 2 sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>y = {&quot;f&quot;, &quot;d&quot;, &quot;a&quot;}<br>
    z = {&quot;c&quot;, &quot;d&quot;, &quot;e&quot;}<br>
    <br>
    result = x.union(y, z) <br><br>print(result)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_union2">Run example &raquo;</a>
</div>
