...
<html lang="en-US">
<head>
<title>Python chr() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">chr()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Get the character that represents the unicode 97:</p>
  <div class="w3-code notranslate pythonHigh">
    x = chr(97)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_chr">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">chr()</code> function returns the character 
that represents the specified unicode.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>number</em></td>
    <td>An integer representing a valid Unicode code point</td>
    </tr>
</tbody></table>
...
<p>Convert back to unicode with the <a href="ref_func_ord.asp">ord()</a> 
function.</p>
