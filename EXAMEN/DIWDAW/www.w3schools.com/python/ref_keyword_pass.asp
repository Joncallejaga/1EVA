...
<html lang="en-US">
<head>
<title>Python pass Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> pass</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a placeholder for future code:</p>
  <div class="w3-code notranslate pythonHigh">
    def myfunction:<br>&nbsp; pass</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_pass">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">pass</code> keyword is used as a placeholder.</p>
<p>If you have an empty function definition, like in the example above, you 
would get an error without the <code class="w3-codespan">pass</code> statement.</p>
<p>The <code class="w3-codespan">pass</code> keyword can also be used in empty 
class definitions.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Using the <code class="w3-codespan">pass</code> keyword in a
  <code class="w3-codespan">class</code> definition:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; pass</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_pass2">Run example &raquo;</a>
</div>
