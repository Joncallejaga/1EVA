...
<html lang="en-US">
<head>
<title>Python String rfind() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> rfind()</span> Method</h1>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Mi 
    casa, su casa.&quot;<br><br>x = txt.rfind(&quot;casa&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_rfind">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">rfind()</code> method finds the last 
occurrence of the specified value.</p>
<p>The <code class="w3-codespan">rfind()</code> method returns -1 if the value is not found.</p>

<p>The <code class="w3-codespan">rfind()</code> method is almost the same as the
<code class="w3-codespan"><a href="ref_string_rindex.asp">rindex()</a></code> 
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.rfind(<em>value, start, end</em>)
  </div>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>x = txt.rfind(&quot;e&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_rfind2">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>x = txt.rfind(&quot;e&quot;, 
    5, 10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_rfind3">Run example &raquo;</a>
</div>
