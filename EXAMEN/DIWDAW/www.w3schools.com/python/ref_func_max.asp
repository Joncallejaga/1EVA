...
<html lang="en-US">
<head>
<title>Python max() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">max()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the largest number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = max(5, 10)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_max">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">max()</code> function returns the item 
with the highest value, or the item with the highest value in an iterable.</p>
<p>If the values are strings, an alphabetically comparison is done.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>An iterable, with one or more items to compare</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the name with the highest value, ordered alphabetically:</p>
  <div class="w3-code notranslate pythonHigh">
    x = max(&quot;Mike&quot;, &quot;John&quot;, &quot;Vicky&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_max2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the item in a tuple with the highest value:</p>
  <div class="w3-code notranslate pythonHigh">
    a = (1, 5, 3, 9)<br>x = max(a)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_max3">Run example &raquo;</a>
</div>
...
<p>The <a href="ref_func_min.asp">min()</a> function, to return the lowest value.</p>
<hr>
