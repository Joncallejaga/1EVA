...
<html lang="en-US">
<head>
<title>Python while Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> while</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print x as long as x is less than 9:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 0<br><br>while x &lt; 9:<br>&nbsp; print(x)<br>&nbsp; x = x + 1</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_while">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">while</code> keyword is used to create a
<code class="w3-codespan">while</code> loop.</p>
<p>A while loop will continue until the statement is false.</p>

<hr>

<h2>Related Pages</h2>
<p>Use the <code class="w3-codespan"><a href="ref_keyword_for.asp">for</a></code> 
keyword to create a for loop.</p>
<p>Use the <code class="w3-codespan"><a href="ref_keyword_break.asp">break</a></code> 
keyword to break out of a loop.</p>
<p>Read more about while loops in our <a href="python_while_loops.asp">Python 
While Loops Tutorial</a>.</p>
