...
<html lang="en-US">
<head>
<title>Python String swapcase() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> swapcase()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Make the lower case letters upper case and the upper case letters lower 
  case:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello My Name Is PETER&quot;<br><br>x = txt.swapcase()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_swapcase">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">swapcase()</code> method returns a string where 
all the upper case letters are lower case and vice versa.</p>
