...
<html lang="en-US">
<head>
<title>Python String isdigit() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isdigit()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are digits:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;50800&quot;<br><br>x = txt.isdigit()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isdigit">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isdigit()</code> method returns True if all the 
characters are digits, otherwise False.</p>
<p>Exponents, like &sup2;, are also considered to be a digit.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text is alphabetic:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;\u0030&quot; #unicode for 0<br>b = &quot;\u00B2&quot; #unicode 
    for &sup2;<br><br>print(a.isdigit())<br>print(b.isdigit())</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isdigit2">Run example &raquo;</a>
</div>
