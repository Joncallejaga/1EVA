...
<html lang="en-US">
<head>
<title>Python String center() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> center()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print the word &quot;banana&quot;, taking up the space of 20 characters, with 
  &quot;banana&quot; in the middle:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;banana&quot;<br><br>x = txt.center(20)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_center">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">center()</code> method will center align the 
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.center(<em>length, character</em>)
  </div>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;banana&quot;<br><br>x = txt.center(20, &quot;O&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_center2">Run example &raquo;</a>
</div>
