...
<html lang="en-US">
<head>
<title>Python else Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> else</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print &quot;YES&quot; if x larger than 3, otherwise print &quot;NO&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 2<br>if x &gt; 3:<br>&nbsp; 
    print(&quot;YES&quot;)<br>else:<br>&nbsp; print(&quot;NO&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_else">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">else</code> keyword is used in conditional 
statements (if statements), and decides what to do if the condition is 
False.</p>

<p>The <code class="w3-codespan">else</code> keyword can also be use in 
try...except blocks, see example below.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Use the else keyword in a try...except block to define what to do if no 
  errors were raised:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 5<br><br>try:<br>&nbsp; x &gt; 10<br>except:<br>&nbsp; 
    print(&quot;Something went wrong&quot;)<br>else:<br>&nbsp; 
    print(&quot;The 'Try' code was executed without raising any errors!&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_else2">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_if.asp">if</a></code> 
keyword.</p>
<p>The <code class="w3-codespan"><a href="ref_keyword_elif.asp">elif</a></code> 
keyword.</p>
<p>Read more about conditional statements in our <a href="https://www.w3schools.com/python/python_conditionals.asp">Python Conditions Tutorial</a>.</p>
