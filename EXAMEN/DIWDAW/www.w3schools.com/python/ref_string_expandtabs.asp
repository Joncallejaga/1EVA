...
<html lang="en-US">
<head>
<title>Python String expandtabs() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> expandtabs()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Set the tab size to 2 whitespaces:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;H\te\tl\tl\to&quot;<br><br>x =&nbsp; txt.expandtabs(2)<br><br>print(x)<br>
    </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_expandtabs">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">expandtabsize()</code> method sets the tab size 
to the specified number of whitespaces.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.exandtabs(<em>tabsize</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>tabsize</em></td>
    <td>Optional. A number specifying the tabsize. Default tabsize is 8</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>See the result using different tab sizes:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;H\te\tl\tl\to&quot;<br><br>print(txt)<br>
    print(txt.expandtabs())<br>print(txt.expandtabs(2))<br>print(txt.expandtabs(4))<br>print(txt.expandtabs(10))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_expandtabs2">Run example &raquo;</a>
</div>
