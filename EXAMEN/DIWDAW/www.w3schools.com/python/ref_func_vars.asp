...
<html lang="en-US">
<head>
<title>Python vars() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">vars()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the __dict__ atribute of an object called Person:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; name = &quot;John&quot;<br>&nbsp; age = 36<br>&nbsp; country = 
    &quot;norway&quot;<br><br>x = vars(Person) </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_vars">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">vars()</code> function returns the __dic__ 
attribute of an object.</p>
<p>The __dict__ attribute is a dictionary containing the object's changeable 
attributes.</p>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> calling the <code class="w3-codespan">vars()</code> 
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>Any object with a __dict__attribute</td>
    </tr>
</tbody></table>
