...
<h1>Python <span class="color_h1">bytearray()</span> Function</h1>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_bytearray">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">bytearray()</code> function returns a bytearray 
object.</p>
<p>It can convert objects into bytearray objects, or create empty bytearray 
...
<div class="w3-code w3-border notranslate">
  <div>
    bytearray(<em>x, encoding, error</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>x</em></td>
    <td>A source to use when creating the bytearray object.<br><br>If it is an 
    integer, an empty bytearray object of the specified size will be created.<br>
...
<p><a href="ref_func_bytes.asp">The bytes() Function</a></p>
