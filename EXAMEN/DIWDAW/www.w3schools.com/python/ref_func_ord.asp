...
<html lang="en-US">
<head>
<title>Python ord() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">ord()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the iteger that represents the character &quot;h&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    x = ord(&quot;h&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_ord">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">ord()</code> function returns the number 
representing the unicode code of a specified character.</p>
<hr>
...
<p>Convert back to character with the <a href="ref_func_chr.asp">chr()</a> 
function.</p>
