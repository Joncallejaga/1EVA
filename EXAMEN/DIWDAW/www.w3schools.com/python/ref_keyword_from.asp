...
<html lang="en-US">
<head>
<title>Python from Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> from</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Import only the <em>time</em> section from the datetime module, and print 
  the time as if it was 15:00:</p>
  <div class="w3-code notranslate pythonHigh">
    from datetime import time<br><br>x = time(hour=15)<br><br>print(x)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_from">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">from</code> keyword is used to import only a 
specified section from a module.</p>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_import.asp">import</a></code> 
keyword.</p>
<p>The <code class="w3-codespan"><a href="ref_keyword_as.asp">as</a></code> 
keyword.</p>
