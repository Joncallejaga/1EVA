...
<html lang="en-US">
<head>
<title>Python String isalpha() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isalpha()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are letters:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;CompanyX&quot;<br><br>x = txt.isalpha()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isalpha">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isalpha()</code> method returns True if all the 
characters are alphabet letters (a-z).</p>
<p>Example of characters that are not alphabet letters: (space)!#%&amp;? etc.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Company10&quot;<br><br>x = txt.isalpha()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isalpha2">Run example &raquo;</a>
</div>
