...
<html lang="en-US">
<head>
<title>Python List clear() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> clear()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove all elements from the <code class="w3-codespan">fruits</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry', 'orange']<br><br>fruits.clear()
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_clear">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">clear()</code> method removes all the elements from a list.</p>
