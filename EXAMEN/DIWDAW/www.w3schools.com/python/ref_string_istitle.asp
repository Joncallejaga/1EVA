...
<html lang="en-US">
<head>
<title>Python String istitle() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> istitle()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if each word start with an upper case letter:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, And Welcome To My World!&quot;<br><br>x = txt.istitle()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_istitle">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">istitle()</code> method returns True if all 
words in a text start with a upper case letter, AND the rest of the word are 
lower case letters, otherwise False.</p>
...
<div class="w3-example">
  ...
  <p>Check if each word start with an upper case letter:</p>
  <div class="w3-code notranslate pythonHigh">
    a = &quot;HELLO, AND WELCOME TO MY WORLD&quot;<br>b = &quot;Hello&quot;<br>c = &quot;22 Names&quot;<br>d = 
    &quot;This Is %'!?&quot;<br><br>print(a.istitle())<br>print(b.istitle())<br>print(c.istitle())<br>
    print(d.istitle())<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_istitle2">Run example &raquo;</a>
</div>
