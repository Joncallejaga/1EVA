...
<html lang="en-US">
<head>
<title>Python String rsplit() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> rsplit()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Split a string into a list, using comma, followed by a space (, ) as the 
  separator:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;apple, banana, cherry&quot;<br><br>x = txt.rsplit(&quot;, &quot;)<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_rsplit">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">rsplit()</code> method splits a string into a 
list, starting from the right.</p>
<p>If no &quot;max&quot; is specified, this method will return the same as the
<code class="w3-codespan"><a href="ref_string_split.asp">split()</a></code> 
method.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.rsplit(<em>separator, max</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    Default value is a whitespace</td>
    </tr>
  <tr>
    <td><em>max</em></td>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Split the string into a list with maximum 2 items:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;apple, banana, cherry&quot;<br><br># setting the max parameter 
    to 1, will return a list with 2 elements!<br>x = txt.rsplit(&quot;, &quot;, 1)<br><br>
    print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_rsplit2">Run example &raquo;</a>
</div>
