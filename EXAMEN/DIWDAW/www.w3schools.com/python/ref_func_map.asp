...
<html lang="en-US">
<head>
<title>Python map() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">map()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Calculate the length of each word in the tuple:</p>
  <div class="w3-code notranslate pythonHigh">
    def myfunc(n):<br>&nbsp; return len(n)<br><br>x = map(myfunc, ('apple', 
    'banana', 'cherry'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_map">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">map()</code> function executes a specified 
function for each item in a iterable. The item is sent to the function as a 
parameter.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    map(<em>function</em>, <em>iterables</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Required. A sequence, collection or an iterator object. You can send as 
    many iterables as you like, just make sure the function has one parameter 
    for each iterable.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Make new fruits by sending two iterable objects into the function:</p>
  <div class="w3-code notranslate pythonHigh">
    def myfunc(a, b):<br>return a + b<br><br>x = map(myfunc, ('apple', 'banana', 
    'cherry'), ('orange', 'lemon', 'pineapple'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_map2">Run example &raquo;</a>
</div>
