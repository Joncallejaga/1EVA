...
<html lang="en-US">
<head>
<title>Python Set add() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> add()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Add an element to the <code class="w3-codespan">fruits</code> set:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>fruits.add("orange")
    <br><br>print(fruits)</div>
...
<p>The <code class="w3-codespan">add()</code> method adds an element to the set.</p>
<p>If the element already exists, the <code class="w3-codespan">add()</code> method does not add the element.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Try to add an element that already exists:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>fruits.add(&quot;apple&quot;)<br><br>
    print(fruits)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_add">Run example &raquo;</a>
</div>
