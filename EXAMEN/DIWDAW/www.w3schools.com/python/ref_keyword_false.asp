...
<html lang="en-US">
<head>
<title>Python False Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> False</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print the result of the comparison &quot;5 is larger than 6&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    print(5 &gt; 6)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_false">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">False</code> keyword is a Boolean value, and 
result of a comparison operation.</p>
<p>The <code class="w3-codespan">False</code> keyword is the same as 0 (<code class="w3-codespan">True</code> 
is the same as 1).</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Other comparisons that returns False:</p>
  <div class="w3-code notranslate pythonHigh">
    print(5 &gt; 6)<br><br>print(4 in [1,2,3])<br><br>print(&quot;hello&quot; is &quot;goodbye&quot;)<br>
    <br>print(5 == 6)<br><br>print(5 == 6 or 6 == 7)<br><br>print(5 == 6 and 6 
    == 7)<br><br>print(&quot;hello&quot; is not &quot;hello&quot;)<br><br>print(not(5 == 5))<br><br>
    print(3 not in [1,2,3])</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_false2">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_true.asp">True</a></code> 
keyword.</p>
<p>Read more about comparisons in our <a href="python_operators.asp">Python 
