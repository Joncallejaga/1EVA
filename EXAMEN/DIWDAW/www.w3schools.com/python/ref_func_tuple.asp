...
<html lang="en-US">
<head>
<title>Python tuple() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">tuple()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a tuple containing fruit names:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    tuple(('apple', 'banana', 'cherry'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_tuple">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">tuple()</code> function creates a tuple object.</p>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> You cannot change or remove items in a tuple.</p>
</div>
<p>Read more about sets in the chapter <a href="python_tuples.asp">Python Tuples</a>.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Required. A sequence, collection or an iterator object</td>
    </tr>
</tbody></table>
