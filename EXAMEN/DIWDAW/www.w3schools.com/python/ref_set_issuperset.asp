...
<html lang="en-US">
<head>
<title>Python Set issuperset() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> issuperset()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return True if all items set
  <code class="w3-codespan">y</code> are present in set <code class="w3-codespan">
  x</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;f&quot;, &quot;e&quot;, &quot;d&quot;, 
    &quot;c&quot;, &quot;b&quot;, &quot;a&quot;}<br>y = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>
    <br>z = x.issuperset(y) <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_issuperset">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">issuperset()</code> method returns True if all items 
in the specified set exists in the original set, otherwise it retuns False.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.issuperset(<em>set</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>What if not all items are present in the specified set?</p>
  <p>Return False if not all items in set
  <code class="w3-codespan">y</code> are present in set <code class="w3-codespan">
  x</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;f&quot;, &quot;e&quot;, &quot;d&quot;, 
    ...
    y = {&quot;a&quot;, &quot;b&quot;, &quot;c&quot;}<br>
    <br>z = x.issuperset(y) <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_issuperset2">Run example &raquo;</a>
</div>
