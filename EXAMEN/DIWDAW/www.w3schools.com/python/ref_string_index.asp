...
<html lang="en-US">
<head>
<title>Python String index() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> index()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Where in the text is the word &quot;welcome&quot;?:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>x = txt.index(&quot;welcome&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_index">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">index()</code> method finds the first 
occurrence of the specified value.</p>
<p>The <code class="w3-codespan">index()</code> method raises an exception if the value is not found.</p>

<p>The <code class="w3-codespan">index()</code> method is almost the same as the
<code class="w3-codespan"><a href="ref_string_find.asp">find()</a></code> 
method, the only difference is that the <code class="w3-codespan">find()</code> 
method returns -1 if the value is not found. (See example below)</p>
<hr>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.index(<em>value, start, end</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Where in the text is the first occurrence of the letter &quot;e&quot;?:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>x = txt.index(&quot;e&quot;)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_index2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Where in the text is the first occurrence of the letter &quot;e&quot; when 
  you only search between position 5 and 10?:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>x = txt.index(&quot;e&quot;, 
    5, 10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_index3">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>If the value is not found, the find() method returns -1, but the index() 
  method will raise an exception:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;Hello, welcome to my world.&quot;<br><br>
    print(txt.find(&quot;q&quot;))<br>print(txt.index(&quot;q&quot;))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_find_vs_index">Run example &raquo;</a>
</div>
