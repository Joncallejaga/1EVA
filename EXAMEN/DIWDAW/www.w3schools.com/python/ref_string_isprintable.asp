...
<html lang="en-US">
<head>
<title>Python String isprintable() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isprintable()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are printable:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = 
    &quot;Hello! Are you #1?&quot;<br><br>x = txt.isprintable()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isprintable">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isprintable()</code> method returns True if all the 
characters are printable, otherwise False.</p>
<p>Example of none printable character can be carriage return and line feed.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = 
    &quot;Hello!\nAre you #1?&quot;<br><br>x = txt.isprintable()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isprintable2">Run example &raquo;</a>
</div>
