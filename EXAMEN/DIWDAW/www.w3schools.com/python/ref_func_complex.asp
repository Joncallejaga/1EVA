...
<html lang="en-US">
<head>
<title>Python complex() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">complex()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert the number 3 and imaginary number 5 into a complex number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = complex(3, 5)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_complex">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">complex()</code> function returns a complex 
number by specifying a real number and an imaginary number.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>real</em></td>
    <td>Required. A number representing the real part of the complex number. 
    Default 0. The real number can also be a String, like this '3+5j', when this 
    is the case, the second parameter should be omitted.</td>
    </tr>
    <tr>
    <td><em>imaginary</em></td>
    <td>Optional. A number representing the imaginary part of the complex 
    number. Default 0.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert a string into a complex number:</p>
  <div class="w3-code notranslate pythonHigh">
    x = complex('3+5j')</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_complex2">Run example &raquo;</a>
</div>
