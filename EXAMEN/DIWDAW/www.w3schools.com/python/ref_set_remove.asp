...
<html lang="en-US">
<head>
<title>Python Set remove() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> remove()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove "banana" from the set:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br><br>fruits.remove(&quot;banana&quot;) <br>
    <br>print(fruits)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_remove">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">remove()</code> method removes the specified 
element from the set.</p>
<p>This method is different 
from the <code class="w3-codespan">discard()</code> method, because the 
<code class="w3-codespan">remove()</code> 
method <em>will raise an error</em> if the specified item does not exist, and 
the <code class="w3-codespan">discard()</code> method <em>will not</em>.</p>
