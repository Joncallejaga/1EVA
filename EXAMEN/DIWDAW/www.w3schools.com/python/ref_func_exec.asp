...
<html lang="en-US">
<head>
<title>Python exec() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">exec()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Execute a block of code:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 'name 
    = &quot;John&quot;\nprint(name)'<br>exec(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_exec">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">exec()</code> function executes the specified 
Python code.</p>

<p>The <code class="w3-codespan">exec()</code> function accepts large blocks of 
code, unlike the <code class="w3-codespan">eval()</code> function which only 
accepts a single expression</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    exec(<em>object</em>, <em>globals</em>, <em>locals</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>A String, or a code object</td>
    </tr>
    <tr>
    <td><em>globals</em></td>
    <td>Optional. A dictionary containing global parameters</td>
    </tr>
    <tr>
    <td><em>locals</em></td>
    <td>Optional. A dictionary containing local parameters</td>
    </tr>
</tbody></table>
