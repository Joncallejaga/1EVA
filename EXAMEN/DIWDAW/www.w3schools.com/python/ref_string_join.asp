...
<html lang="en-US">
<head>
<title>Python String join() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> join()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Join all items in a tuple into a string, using a hash tag as separator:</p>
  <div class="w3-code notranslate pythonHigh">
    myTuple = (&quot;John&quot;, &quot;Peter&quot;, &quot;Vicky&quot;)<br><br>x = &quot;#&quot;.join(myTuple)<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_join">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">join()</code> method takes all items in an iterable 
and joins them into one string.</p>
<p>A string must be specified as the separator.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>string</em>.join(<em>iterable</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Any iterable object were all the returned values are strings</td>
  </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Join all items in a dictionary into a string, using a the word &quot;TEST&quot; as separator:</p>
  <div class="w3-code notranslate pythonHigh">
    myDict = {&quot;name&quot;: &quot;John&quot;, &quot;country&quot;: &quot;Norway&quot;}<br>mySeparator = &quot;TEST&quot;<br><br>x 
    = mySeparator.join(myDict)<br><br>print(x)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_join2">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> When using a dictionary as an iterable, the returned values are the keys, not the values.</p>
</div>
