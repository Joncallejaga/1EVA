...
<html lang="en-US">
<head>
<title>Python Set updatenion() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> update()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Insert the items from set <code class="w3-codespan">y</code> into set
  <code class="w3-codespan">x</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
    <br>x.update(y) <br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_update">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">update()</code> method updates the current set, 
by adding items from another set.</p>
<p>If an item is present in both sets, only one 
appearance of this item will be present in the updated set.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>set</em></td>
    <td>Required. The set insert into the current set</td>
    </tr>
</tbody></table>
