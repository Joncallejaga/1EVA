...
<html lang="en-US">
<head>
<title>Python Set isdisjoint() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> isdisjoint()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return True if no items in set
  <code class="w3-codespan">x</code> is present in set <code class="w3-codespan">y</code>:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;facebook&quot;}<br>
    <br>z = x.isdisjoint(y) <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_isdisjoint">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isdisjoint()</code> method returns True if none 
of the items are present in both sets, otherwise it returns False.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.isdisjoint(<em>set</em>)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>What if no items are present in both sets?</p>
  <p>Return False if one ore more items are present in both sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>
y = {&quot;google&quot;, 
    &quot;microsoft&quot;, &quot;apple&quot;}<br><br>z = x.isdisjoint(y)
    <br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_isdisjoint2">Run example &raquo;</a>
</div>
