...
<html lang="en-US">
<head>
<title>Python callable() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">callable()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if a function is callable:</p>
  <div class="w3-code notranslate pythonHigh">
    def x():<br>&nbsp; a = 5<br><br>print(callable(x))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_callable">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">callable()</code> function returns True if the 
specified object is callable, otherwise it returns False.</p>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>The object you want to test if it is callable or not.</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>A normal variable is not callable:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 5<br><br>
    print(callable(x))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_callable2">Run example &raquo;</a>
</div>
