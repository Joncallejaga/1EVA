...
<html lang="en-US">
<head>
<title>Python and Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> and</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return True if both statements are True:</p>
  <div class="w3-code notranslate pythonHigh">
    x = (5 &gt; 3 and 5 &lt; 10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_and">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">and</code> keyword is a logical operator.</p>
<p>Logical operators are used to combine conditional statements.</p>

<p>The return value will only be <code class="w3-codespan">True</code> if both 
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Using the <code class="w3-codespan">and</code> keyword in an
  <code class="w3-codespan">if</code> statement:</p>
  <div class="w3-code notranslate pythonHigh">
    if 5 &gt; 3 and 5 &lt; 10:<br>&nbsp; print(&quot;Both statements are True&quot;)<br>else:<br>&nbsp; print(&quot;At 
    least one of the statements are False&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_and2">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The keywords <code class="w3-codespan"><a href="ref_keyword_or.asp">or</a></code>, 
