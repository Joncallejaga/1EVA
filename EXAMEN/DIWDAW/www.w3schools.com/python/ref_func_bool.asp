...
<html lang="en-US">
<head>
<title>Python bool() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">bool()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the boolean value of 1:</p>
  <div class="w3-code notranslate pythonHigh">
    x = bool(1)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_bool">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">bool()</code> function returns the boolean 
value of a specified object.</p>
<p>The object will always return True, unless:</p>
<p>The object is empty, like [], (), {}<br>The object is False<br>The object is 
0<br>The object is None</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>Any object, like String, List, Number etc.</td>
  </tr>
</tbody></table>
