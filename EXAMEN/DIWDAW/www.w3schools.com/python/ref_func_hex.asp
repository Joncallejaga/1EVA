...
<html lang="en-US">
<head>
<title>Python hex() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">hex()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert 255 into hexadecimal value:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 
    hex(255)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_hex">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">hex()</code> function converts the specified 
number into a hexadecimal value.</p>
<p>The returned string always starts with the prefix <code class="w3-codespan">0x</code>.</p>
