...
<html lang="en-US">
<head>
<title>Python String isspace() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> isspace()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if all the characters in the text are whitespaces:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = 
    &quot;&nbsp;&nbsp; &quot;<br><br>x = txt.isspace()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isspace">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">isspace()</code> method returns True if all the 
characters in a string are whitespaces, otherwise False.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    txt = 
    &quot;&nbsp;&nbsp; s&nbsp;&nbsp; &quot;<br><br>x = txt.isspace()<br>
    <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_isspace2">Run example &raquo;</a>
</div>
