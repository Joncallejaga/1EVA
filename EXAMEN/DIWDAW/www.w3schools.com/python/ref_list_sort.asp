...
<html lang="en-US">
<head>
<title>Python List sort() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> sort()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="python_ref_list.asp">&#10094; List Methods</a>
</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the list alphabetically:</p>
  <div class="w3-code notranslate pythonHigh">
    cars = ['Ford', 'BMW', 'Volvo']<br><br>
    cars.sort()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_sort">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">sort()</code> method sorts the list ascending 
by default.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>list</em>.sort(reverse=True|False, key=myFunc)
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the list descending:</p>
  <div class="w3-code notranslate pythonHigh">
    cars = ['Ford', 'BMW', 'Volvo']<br><br>
    cars.sort(reverse=True)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_sort2">Run example &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the list by the length of the values:</p>
  <div class="w3-code notranslate pythonHigh">
    # A function that returns the length of the value:<br>def myFunc(e):<br>&nbsp; return len(e)<br>
    <br>cars = ['Ford', 'Mitsubishi', 'BMW', 'VW']<br><br>
    cars.sort(key=myFunc)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_sort3">Run example &raquo;</a>
</div>


<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the list by the length of the values <em>and</em> reversed:</p>
  <div class="w3-code notranslate pythonHigh">
    # A function that returns the length of the value:<br>def myFunc(e):<br>&nbsp; return len(e)<br>
    <br>cars = ['Ford', 'Mitsubishi', 'BMW', 'VW']<br><br>
    cars.sort(reverse=True, key=myFunc)<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_sort4">Run example &raquo;</a>
</div>
