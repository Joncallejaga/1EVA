...
<html lang="en-US">
<head>
<title>Python Dictionary update() Method</title>
<meta charset="utf-8">
...
<h1>Python Dictionary <span class="color_h1">update()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Insert an item to the dictionary:</p>
  <div class="w3-code notranslate pythonHigh">
    car = {<br>&nbsp; &quot;brand&quot;: &quot;Ford&quot;,<br>&nbsp; &quot;model&quot;: &quot;Mustang&quot;,<br>&nbsp; 
    &quot;year&quot;: 1964<br>}<br>
    <br>car.update({&quot;color&quot;: &quot;White&quot;})<br><br>print(car)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_dictionary_update">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">update()</code> method inserts the specified 
items to the dictionary.</p>
<p>The specified items can be a dictionary, or an iterable object.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>dictionary</em>.update(<em>iterable</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>A dictionary or an iterable object with key value pairs, that will be 
    inserted to the dictionary</td>
    </tr>
</tbody></table>
