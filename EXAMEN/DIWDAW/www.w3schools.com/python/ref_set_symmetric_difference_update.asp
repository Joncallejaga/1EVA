...
<html lang="en-US">
<head>
<title>Python Set symmetric_difference_update() Method</title>
<meta charset="utf-8">
...
<h1>Python Set<span class="color_h1"> symmetric_difference_update()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove the items that are present in both sets, AND insert the items that 
  is not present in both sets:</p>
  <div class="w3-code notranslate pythonHigh">
    x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
    <br>x.symmetric_difference_update(y) <br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_set_symmetric_difference_update">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">symmetric_difference_update()</code> method 
updates the original set by removing items that are present in both sets, and 
inserting the other items.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>set</em>.symmetric_difference_update(<em>set</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>set</em></td>
    <td>Required. The set to check for matches in</td>
  </tr>
</tbody></table>
