...
<html lang="en-US">
<head>
<title>Python List insert() Method</title>
<meta charset="utf-8">
...
<h1>Python List<span class="color_h1"> insert()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Insert the value "orange" as the second elemnent of the <code class="w3-codespan">fruit</code> list:</p>
  <div class="w3-code notranslate pythonHigh">
    fruits = ['apple', 'banana', 'cherry']<br><br>
    fruits.insert(1, "orange")</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_list_insert">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">insert()</code> method inserts the specified value at the specified position.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    <em>list</em>.insert(<em>pos</em>, <em>elmnt</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>pos</em></td>
    <td>Required. A number specifying in which position to insert the value</td>
  </tr>
  <tr>
    <td><em>elmnt</em></td>
