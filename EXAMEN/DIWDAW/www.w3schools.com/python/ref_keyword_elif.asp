...
<html lang="en-US">
<head>
<title>Python elif Keyword</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1"> elif</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print &quot;YES&quot; if the variable i is a positive number, print &quot;WHATEVER&quot; if i 
  is 0, otherwise print &quot;NO&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    for i in range(-5, 5):<br>&nbsp; if i &gt; 0:<br>&nbsp;&nbsp;&nbsp; 
    print(&quot;YES&quot;)<br>&nbsp; elif i == 0:<br>&nbsp;&nbsp;&nbsp; print(&quot;WHATEVER&quot;)<br>&nbsp; 
    else:<br>&nbsp;&nbsp;&nbsp; print(&quot;NO&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_elif">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">elif</code> keyword is used in conditional 
statements (if statements), and is short for else if.</p>
