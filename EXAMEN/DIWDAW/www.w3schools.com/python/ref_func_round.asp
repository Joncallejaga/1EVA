...
<h1>Python <span class="color_h1">round()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Round a number to only two decimals:</p>
  <div class="w3-code notranslate pythonHigh">
    x = round(5.76543, 2)<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_round">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">round()</code> function returns a floating 
point number that is a rounded version of the specified number, with the 
specified number of decimals.</p>
<p>The default number of decimals is 0, meaning that the function will return 
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>digits</em></td>
    <td>Optional. The number of decimals to use when rounding the number. 
    Default is 0</td>
    </tr>
</tbody></table>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    x = round(5.76543)<br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_round2">Run example &raquo;</a>
</div>
