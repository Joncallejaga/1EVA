...
<h1>Python <span class="color_h1"> or</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return True if one of the statements are True:</p>
  <div class="w3-code notranslate pythonHigh">
    x = (5 &gt; 3 or 5 &gt; 10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_or">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">or</code> keyword is a logical operator.</p>
<p>Logical operators are used to combine conditional statements.</p>

<p>The return value will be <code class="w3-codespan">True</code> if one of 
the 
statements return <code class="w3-codespan">True</code>, otherwise it will 
return <code class="w3-codespan">False</code>.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Using the <code class="w3-codespan">or</code> keyword in an
  <code class="w3-codespan">if</code> statement:</p>
  <div class="w3-code notranslate pythonHigh">
    if 5 &gt; 3 or 5 &gt; 10:<br>&nbsp; print(&quot;At least one of the statements are 
    True&quot;)<br>else:<br>&nbsp; print(&quot;None of the statements are True&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_or2">Run example &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>
<p>The keywords <code class="w3-codespan"><a href="ref_keyword_and.asp">and</a></code>, 
and <code class="w3-codespan"><a href="ref_keyword_not.asp">not</a></code> are also 
logical operators.</p>
<p>Read more about operators in our <a href="python_operators.asp">Python 
Operators Tutorial</a>.</p>
