...
<h1>Python <span class="color_h1"> if</span> Keyword</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print &quot;YES&quot; if x larger than 3:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 5<br>if x &gt; 3:<br>&nbsp; 
    print(&quot;YES&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_if">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">if</code> keyword is used to create conditional 
statements (if statements), and allows you to execute a block of code only if a 
condition is True.</p>

<p>Use the <code class="w3-codespan">else</code> keyword to execute code if the 
condition is False, see example below.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print &quot;YES&quot; if x is larger than 6, otherwise print &quot;NO&quot;:</p>
  <div class="w3-code notranslate pythonHigh">
    x = 5<br>if x &gt; 6:<br>&nbsp; 
    print(&quot;YES&quot;)<br>else:<br>&nbsp; print(&quot;NO&quot;)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_keyword_if_else">Run example &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>The <code class="w3-codespan"><a href="ref_keyword_else.asp">else</a></code> 
keyword.</p>
