...
<html lang="en-US">
<head>
<title>Python hasattr() Function</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">hasattr()</span> Function</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check if the &quot;Person&quot; object has the &quot;age&quot; property:</p>
  <div class="w3-code notranslate pythonHigh">
    class Person:<br>&nbsp; name = &quot;John&quot;<br>&nbsp; age = 36<br>&nbsp; country = &quot;Norway&quot;<br><br>
    x = hasattr(Person, 'age')<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_hasattr">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">hasattr()</code> function returns 
<code class="w3-codespan">True</code> if the specified object has the specified 
attribute, otherwise <code class="w3-codespan">False</code>.</p>
...
<div class="w3-code w3-border notranslate">
  <div>
    hasattr(<em>object</em>, <em>attribute</em>)
  </div>
</div>
...
<table class="w3-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>The name of the attribute you want to check if exists</td>
    </tr>
</tbody></table>
