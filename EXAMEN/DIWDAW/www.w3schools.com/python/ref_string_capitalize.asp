...
<html lang="en-US">
<head>
<title>Python String capitalize() Method</title>
<meta charset="utf-8">
...
<h1>Python String<span class="color_h1"> capitalize()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Upper case the first letter in this sentence:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;hello, and welcome to my world.&quot;<br><br>x = txt.capitalize()<br><br>
    print (x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_capitalize">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">capitalize()</code> method returns a string 
where the first character is upper case.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>See what happens if the first character is a number:</p>
  <div class="w3-code notranslate pythonHigh">
    txt = &quot;36 is my age.&quot;<br><br>x = txt.capitalize()<br><br>
    print (x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_ref_string_capitalize2">Run example &raquo;</a>
</div>
