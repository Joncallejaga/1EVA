...
<div class="main w3-red" id="section1">
  ...
  <a href="howto_css_smooth_scroll.asp#section2" class="w3-button w3-light-grey">Click Me to Smooth Scroll to Section 2 Below</a>
  <p>Note: Remove the scroll-behavior property to remove smooth scrolling.</p>
</div>

<div class="main w3-yellow" id="section2">
  <h2>Section 2</h2>
  <a href="howto_css_smooth_scroll.asp#section1" class="w3-button w3-light-grey">Click Me to Smooth Scroll to Section 1 Above</a>
</div><hr>
