...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.normalize() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.normalize()</span> Method</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var x = path.normalize('Users/Refsnes/../Jackson');<br>
  <br>console.log(x);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_normalize" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.normalize() method resolves the specified path, fixing '..','\\\\' 
etc.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.normalize(<em>path</em>);</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>path</em></td>
  <td>Required. A string. The path you want to normalize.</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>A String, representing the normalized path</td>
</tr>
<tr>
