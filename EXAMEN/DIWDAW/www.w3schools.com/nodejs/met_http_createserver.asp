...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js http.createServer() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">http.createServer()</span> Method</h1>
<p>
<a class="w3-btn w3-white w3-border" href="ref_http.asp">&#10094; HTTP Module</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>The createServer method creates a server on your computer:</p>
<div class="w3-code notranslate jsHigh">
  var http = require('http');<br><strong>http.createServer</strong>(function (req, res) {<br>&nbsp; 
  res.writeHead(200, {'Content-Type': 'text/plain'});<br>&nbsp; res.write('Hello 
  World!');<br>&nbsp; res.end();<br>}).listen(8080);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_ref_http">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The http.createServer() method turns your computer into an HTTP server.</p>
<p>The http.createServer() method creates an <a href="obj_http_server.asp">HTTP 
Server object</a>.</p>
<p>The <a href="obj_http_server.asp">HTTP Server object</a> can listen to ports 
on your computer and execute a function, a
<a href="func_http_requestlistener.asp">requestListener</a>, each time a request is made.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  http.createServer(<em>requestListener</em>);</div></div>
<hr>
...
<tr>
  <td><em><a href="func_http_requestlistener.asp">requestListener</a></em></td>
  <td>Optional. Specifies a function to be executed every time the server gets 
  a request. This function is called a <a href="func_http_requestlistener.asp">
  requestListener</a>, and handles request from the user, as well as response 
  back to the user.</td>
</tr>
</table>
<hr>
...
<tbody><tr>
  ...
  <td><a href="obj_http_server.asp">HTTP Server object</a></td>
</tr>
<tr>
