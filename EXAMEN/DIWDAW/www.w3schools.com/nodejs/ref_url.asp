...
<h1>Node.js <span class="color_h1">URL</span> Module</h1>
<p>
...
<h3>Example</h3>
  <p>Parse the url string into a URL object and extract the href property:</p>
<div class="w3-code notranslate jsHigh">
  var http = require('http');<br>var url = require('url');<br>http.createServer(function (req, res) {<br>&nbsp; 
  res.writeHead(200, {'Content-Type': 'text/plain'});<br>&nbsp; var q = 
  url.parse(req.url, true);<br>&nbsp; res.write(q.href);<br>&nbsp; res.end();<br>}).listen(8080);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_ref_url">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The URL module provides a way of parsing the URL string.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the url module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var url = require('url');</div></div>
