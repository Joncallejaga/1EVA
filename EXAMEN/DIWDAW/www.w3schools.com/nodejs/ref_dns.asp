...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js DNS Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">DNS </span>Module</h1>
<p>
...
<h3>Example</h3>
<p>Look up a web address, and write it's IP address:</p>
  <div class="w3-code notranslate jsHigh">
    var dns = require('dns');<br>var w3 = dns.lookup('w3schools.com', function 
    (err, addresses, family) {<br>&nbsp; console.log(addresses);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_dns">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The DNS module provides a way of performing name resolutions.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the DNS module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var dns = require('dns');</div></div>
