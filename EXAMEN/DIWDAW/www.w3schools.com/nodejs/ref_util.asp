...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Util Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Util </span>Module</h1>
<p>
...
<h3>Example</h3>
<p>Format a string using the arguments "Linus" and "6":</p>

  <div class="w3-code notranslate jsHigh">
    var util = require('util');<br>var txt = 'Congratulate %s on his %dth 
    birthday!';<br>var result = util.format(txt, 'Linus', 6); <br><br>
    console.log(result);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_util">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Util module provides access to some utility functions.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the Util module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var util = require('util');<br></div></div>

<h2>Util Properties and Methods</h2>
