...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer lastIndexOf() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer lastIndexOf()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Return the last occurrence of the letter &quot;e&quot;:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('Hello, and welcome to Rome!');<br><br>console.log(buf.lastIndexOf('e'));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_lastindexof" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The lastIndexOf() method checks if a specified value is present in the buffer and 
returns the position.</p>
<p>If the specified value occurs more than once, only the position of the <em>
last</em> 
occurrence will be returned.</p>
<p>This method returns -1 if the value to search for never occurs.</p>
<p>See also: the<a href="met_buffer_indexof.asp"> indexOf()</a> method, which 
returns the <em>first</em> occurrence of the specified value.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.lastIndexOf(<em>value</em>, <em>start</em>, <em>encoding</em>);
</div>
<hr>
...
<tbody><tr>
  ...
  occurs for the last time, or -1 if it never occurs</td>
</tr>
<tr>
