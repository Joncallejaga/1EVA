...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.delimeter Property</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.delimeter</span> Property</h1>
<p>
...
<h3>Example</h3>
  <p>Return the delimiter used on the server:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>console.log(path.delimiter);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_delimiter" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.delimiter property returns the delimiter specified for the server.</p>
<p>; (semicolon) for Windows<br>: (colon) for POSIX</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.property;</div>
<hr>
...
<tbody><tr>
  ...
  <td>The delimiter, as a String</td>
</tr>
<tr>
