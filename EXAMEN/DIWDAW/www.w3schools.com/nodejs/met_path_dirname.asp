...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.dirname() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.dirname()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Get the directories from a file path:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var directories = path.dirname('/Users/Refsnes/demo_path.js');<br>
  console.log(directories);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_dirname" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.dirname() method returns the directories of a file path.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.dirname(<em>path</em>);</div>
<hr>
...
<tbody><tr>
  ...
  <td>The directories, as a String</td>
</tr>
<tr>
