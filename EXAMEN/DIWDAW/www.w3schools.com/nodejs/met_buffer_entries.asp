...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer endtries() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer entries()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Display the content of a Buffer, both index and byte:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>for (x of buf.entries()) {<br>&nbsp; 
  console.log(x);<br>}</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_entries" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The entries() method returns an iterator object, containing the index and 
byte value of each byte in a buffer object.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  <em>buffer</em>.entries();</div></div>
<hr>
...
<tbody><tr>
  ...
  <td>An iterator object containing an index-byte array for each byte in a 
  Buffer object</td>
</tr>
<tr>
