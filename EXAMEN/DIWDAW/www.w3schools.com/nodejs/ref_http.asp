...
<h1>Node.js <span class="color_h1">HTTP</span> Module</h1>
<p>
...
<p>The HTTP module provides a way of making Node.js transfer data over HTTP 
(Hyper Text Transfer Protocol).</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the HTTP module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var http = require('http');</div></div>

<h2>HTTP Properties and Methods</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_http_createserver.asp">createServer()</a></td>
