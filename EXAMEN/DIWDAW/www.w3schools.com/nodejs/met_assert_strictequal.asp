...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.strictEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.strictEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two values are not equal (in both value and type), an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.strictEqual(50, 50); //OK<br>assert.strictEqual(50, 
  &quot;50&quot;); /*AssertionError: 50 === '50' 
  */<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_strictequal">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.strictEqual() method tests if two values are equal, using the === 
operator.</p>
<p>If the two values are not equal, an assertion failure is being caused, and the program is terminated.</p>
<p>The === operator tests if the <em>values</em> are equal and if their <em>types</em> 
are 
equal.</p>
<p>To compare the values using the == operator, use the
<a href="met_assert_equal.asp">assert.equal() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.strictEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.strictEqual(50, &quot;50&quot;, &quot;My message goes here&quot;);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_strictequal_message">Run example &raquo;</a>
</div>
