...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Timers Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Timers</span> Module</h1>
<p>
...
<h3>Example</h3>
  <p>Write &quot;Hello&quot; every 500 milliseconds:</p>
<div class="w3-code notranslate jsHigh">
  var myInt = setInterval(function () {<br>&nbsp;&nbsp;&nbsp; console.log(&quot;Hello&quot;);<br>
  }, 500);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_timers" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Timers module provides a way scheduling functions to be called later at a 
given time.</p>
<p>The Timer object is a global object in Node.js, and it is not necessary to 
import it using the <code class="w3-codespan">require</code> keyword. </p>
<hr>

<h2>Timers Methods</h2>
