...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.byteLength() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.byteLength()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check the length of a buffer object:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.alloc(15);<br>var len = Buffer.byteLength(buf);<br>
  console.log(len);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_bytelength" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.byteLength() method returns the length of a specified string 
object, in bytes.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;Buffer.byteLength(<em>string, encoding</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>string</em></td>
  <td>Required. Specifies the object to calculate the length of. Supported types 
  are:<br>String<br>Buffer<br>TypedArray<br>DataView<br>ArrayBuffer</td>
  </tr>
  <tr>
  <td><em>encoding</em></td>
  <td>Optional. If the object is a string, this parameter specified its 
  encoding. Default encoding is &quot;utf8&quot;</td>
  </tr>
</table>
<hr>
...
<tbody><tr>
  ...
  <td>The number of bytes in the specified object</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Return the number of bytes in the sting &quot;abc&quot;:</p>
<div class="w3-code notranslate jsHigh">
  var len = Buffer.byteLength('abc');<br>console.log(len);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_bytelength2" target="_blank">Run example &raquo;</a>
</div>
