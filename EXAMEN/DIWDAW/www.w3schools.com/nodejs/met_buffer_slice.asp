...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer slice() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer slice()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Make a new buffer, based on parts from an existing bufffer:</p>
<div class="w3-code notranslate jsHigh">
  var x = Buffer.from('abcdef');<br>var y = x.slice(2,5);<br><br>console.log(y.toString());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_slice" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The slice() method returns a new buffer object, using parts of an existing 
buffer.</p>
<p>The <em>start</em> and <em>end</em> parameters specifies where to start and 
end the extraction. </p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.slice(<em>start</em>, <em>end</em>);
</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>start</em></td>
  <td>Optional. Where to start slicing. Default 0</td>
  </tr>
  <tr>
  <td><em>end</em></td>
  <td>Optional. Where to end the slice, default at the very end of the buffer</td>
  </tr>
  </table>
<hr>
