...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer fill() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer fill()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Fill the buffer with the letter 'a':</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.alloc(15);<br><br>buf.fill('a');<br><br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_fill" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The fill() method fills a buffer with the specified value.</p>
<p>You can fill the whole buffer or parts of the buffer, using the start and end 
parameters.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  <em>buffer</em>.fill(<em>value, start, end, encoding</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>value</em></td>
  <td>Required. A buffer to compare with</td>
  </tr>
  <tr>
  <td style="height: 23px"><em>start</em></td>
  <td style="height: 23px">Optional. Where to start the filling. Default 0</td>
  </tr>
  <tr>
  <td><em>end</em></td>
  <td>Optional. Where to end the filling. Default at the end of the buffer</td>
  </tr>
  <tr>
  <td><em>encoding</em></td>
  <td>Optional. The encoding of the value. Default &quot;utf8&quot;</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>The buffer object, with the new fillings.</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Fill parts of the buffer with the letter 'a':</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.alloc(15);<br><br>buf.fill('a', 5, 10);<br><br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_fill2" target="_blank">Run example &raquo;</a>
</div>
<hr>
