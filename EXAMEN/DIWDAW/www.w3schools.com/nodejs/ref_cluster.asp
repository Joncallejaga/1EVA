...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Cluster Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Cluster Process</span> Module</h1>
<p>
...
var cluster = require('cluster');<br><br>if (cluster.isWorker) {<br>&nbsp; 
    console.log('I am a worker');<br>} else {<br>&nbsp; console.log('I am a 
    master');<br>&nbsp; cluster.fork();<br>&nbsp; cluster.fork();<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cluster">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The cluster module provides a way of creating child processes that runs 
simultaneously and share the same server port.</p>
<p>Node.js runs single threaded programming, which is very memory efficient, but 
...
var cluster = require('cluster');</div></div>

<h2>Cluster Properties and Methods</h2>
