...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.deepEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.deepEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two objects, or their child objects, are not equal, an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>var z = { a = { n: 1 } };<br>assert.deepEqual(x, y); //OK<br>assert.deepEqual(x, 
  z); /*AssertionError: { a: { n: 0 } } deepEqual {a: { n: 1 } }*/<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_deepequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.deepEqual() method tests if two objects, and their child objects, are equal, using the == 
operator.</p>
...
<a href="met_assert_deepstrictequal.asp">assert.deepStrictEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.deepEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  { n: 1 } };<br>assert.deepEqual(x, z, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_deepequal_message" target="_blank">Run example &raquo;</a>
</div>
