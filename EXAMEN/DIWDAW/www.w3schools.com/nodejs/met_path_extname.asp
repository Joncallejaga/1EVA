...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.extname() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.extname()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Get the extension from a file path:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var ext = path.extname('/Users/Refsnes/demo_path.js');<br>
  console.log(ext);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_extname" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.extname() method returns the extension of a file path.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.extname(<em>path</em>);</div>
<hr>
...
<tbody><tr>
  ...
  <td>The extension, as a String</td>
</tr>
<tr>
