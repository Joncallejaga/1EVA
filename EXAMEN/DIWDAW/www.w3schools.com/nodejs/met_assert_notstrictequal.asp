...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.notStrictEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.notStrictEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two values are equal (both in value and type), an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.notEqual(50, 70); //OK<br>assert.notEqual(50, 
  &quot;50&quot;); //OK<br>assert.notEqual(50, 
  50); /*AssertionError: 50 != 50 
  */<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notstrictequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.notStrictEqual() method tests if two values are NOT equal, using the !== 
operator.</p>
<p>If the two values are equal, an assertion failure is being caused, and the program is terminated.</p>
<p>The !== operator tests if the <em>values</em> and the <em>types</em> are 
equal.</p>
<p>To compare the values using the != operator, use the
<a href="met_assert_notequal.asp">assert.notEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.notStrictEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.notStrictEqual(50, 50, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notstrictequal_message" target="_blank">Run example &raquo;</a>
</div>
