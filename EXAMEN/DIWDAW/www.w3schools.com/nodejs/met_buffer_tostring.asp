...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer toString() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer toString()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Display the buffer object as a string:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>console.log(buf.toString());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_tostring" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toString() method returns the buffer object according to the specified 
encoding.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.toString(<em>encoding, start</em>, <em>end</em>);
</div>
<hr>
...
<tr>
  ...
  <td>Optional. The encoding to use in the return value. Default 'utf8'</td>
  </tr>
  <tr>
  <td><em>start</em></td>
  <td>Optional. Where to start. Default 0</td>
  </tr>
  <tr>
  <td><em>end</em></td>
  <td>Optional. Where to end. Default at the very end of the buffer</td>
  </tr>
  </table>
<hr>
