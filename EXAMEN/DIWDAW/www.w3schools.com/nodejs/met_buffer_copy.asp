...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer copy() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer copy()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Copy one buffer into parts of another buffer:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('abcdefghijkl');<br>var buf2 = Buffer.from('HELLO');<br>
  <br>buf2.copy(buf1, 2);<br><br>console.log(buf1.toString());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_copy" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The copy() method copies data from one buffer object into another buffer 
object.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  <em>buffer</em>.copy(<em>target, targetStart, sourceStart, sourceEnd</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>target</em></td>
  <td>Required. The array of buffers to concat</td>
  </tr>
  <tr>
  <td><em>targetStart</em></td>
  <td>Optional. A number specifying where to begin copying to. Default 0</td>
  </tr>
  <tr>
  <td><em>sourceStart</em></td>
  <td>Optional. A number specifying where to begin copying from. Default 0</td>
  </tr>
  <tr>
  <td><em>sourceEnd</em></td>
  <td>Optional. A number specifying where to stop copying from. Default end of 
  buffer</td>
  </tr>
</table>
<hr>
...
<tbody><tr>
  ...
  <td>A number specifying the number of bytes copied</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Copy parts of a buffer into parts of another buffer:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('abcdefghijkl');<br>var buf2 = Buffer.from('HELLO');<br>
  <br>buf2.copy(buf1, 2, 0, 2);<br><br>console.log(buf1.toString());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_copy2" target="_blank">Run example &raquo;</a>
</div>
<hr>
