...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.join() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.join()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Join several segments into one path:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var x = path.join('Users', 'Refsnes', 'demo_path.js');<br>
  <br>console.log(x);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_join" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.join() method joins the specified path segments into one path.</p>
<p>You can specify as many path segments as you like.</p>
<p>The specified path segments must be strings, separated by comma.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.join(<em>paths</em>);</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>paths</em></td>
  <td>Required. Series of path segments to join into one path</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>A String, representing the joined path</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Add a '..' as one of the segments, and the join method will resolve it:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var x = path.join('Users', 'Refsnes', '..', 'demo_path.js');<br>
  <br>console.log(x);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_join2" target="_blank">Run example &raquo;</a>
</div>
<hr>
<p>
<a class="w3-btn w3-white w3-border" href="ref_path.asp">&#10094; Path Module</a>
