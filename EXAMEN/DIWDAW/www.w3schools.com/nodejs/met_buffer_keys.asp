...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer keys() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer keys()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Display the keys (indexes) of a Buffer object:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>for (x of buf.keys()) {<br>&nbsp; console.log(x);<br>
  }</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_keys" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The keys() method returns an iterator object, containing the key of each byte 
in a buffer object.</p>
<hr>
...
<tbody><tr>
  ...
  <td>An Iterator object, containing the keys of a buffer</td>
</tr>
<tr>
