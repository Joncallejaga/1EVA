...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Zlib Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Zlib </span>Module</h1>
<p>
...
<h3>Example</h3>
  <p>Compress a file (demofile.txt) into a gzip file (mygzipfile.txt.gz):</p>
  <div class="w3-code notranslate jsHigh">
    var zlib = require('zlib');<br>var fs = require('fs');<br><br>var gzip = 
    zlib.createGzip();<br>var r = fs.createReadStream('./demofile.txt');<br>var 
    w = fs.createWriteStream('./mygzipfile.txt.gz');<br>r.pipe(gzip).pipe(w);<br></div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Zlib module provides a way of zip and unzip files.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the Zlib module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var zlib = require('zlib');<br></div></div>

<h2>Zlib Properties and Methods</h2>
