...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer Module</title>
<meta charset="utf-8">
    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>
          ...
          <a class="w3-bar-item w3-button" href='default.asp'>Learn Node.js</a>
          <a class="w3-bar-item w3-button" href='nodejs_raspberrypi.asp'>Learn Raspberry Pi</a>          
          <h3>Web Building</h3>
...
<h1>Node.js <span class="color_h1">Buffer</span> Module</h1>
<p>
<a class="w3-btn w3-white w3-border" href="ref_modules.asp">&#10094; Built-in Modules</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>Convert the string &quot;abc&quot; into a stream of binary data:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br>console.log(buf);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_buffer">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The buffers module provides a way of handling streams of binary data.</p>
<p>The Buffer object is a global object in Node.js, and it is not necessary to 
import it using the <code class="w3-codespan">require</code> keyword. </p>
<hr>

<h2>Syntax</h2>
<p>The syntax for creating an empty Buffer of the length 15:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var buf = Buffer.alloc(15);</div></div>

<h2>Buffer Properties and Methods</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_buffer_alloc.asp">alloc()</a></td>
    <td>Creates a Buffer object of the specified length</td>
  </tr>
  <tr>
    <td><a href="met_buffer_allocunsafe.asp">allocUnsafe()</a></td>
  ...
  <tr>
    <td><a href="met_buffer_slice.asp">slice()</a></td>
  ...
  <tr>
    <td><a href="met_buffer_tostring.asp">toString()</a></td>
    <td>Returns a string version of a Buffer object</td>
  </tr>
  <tr>
    <td><a href="met_buffer_tojson.asp">toJSON()</a></td>
    <td>Returns a JSON version of a Buffer object</td>
  </tr>
  <tr>
    <td><a href="met_buffer_values.asp">values()</a></td>
    <td>Returns an array of values in a Buffer object</td>
  </tr>
  <tr>
    <td><a href="met_buffer_write.asp">write()</a></td>
