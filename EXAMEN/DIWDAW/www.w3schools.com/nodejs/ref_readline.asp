...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Readline Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Readline </span>Module</h1>
<p>
...
<h3>Example</h3>
<p>Open a file and return the content line by line:</p>
  <div class="w3-code notranslate jsHigh">
    var readline = require('readline');<br>var fs = require('fs');<br><br>var 
    myInterface = readline.createInterface({<br>&nbsp; input: 
    fs.createReadStream('demofile1.html')<br>});<br><br>var lineno = 0;<br>
    myInterface.on('line', function (line) {<br>&nbsp; lineno++;<br>&nbsp; 
    console.log('Line number ' + lineno + ': ' + line);<br>});<br>
    </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readline">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Readline module provides a way of reading a datastream, one line at a time.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the Readline module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var readline = require('readline');<br></div></div>

<h2>Readline Properties and Methods</h2>
