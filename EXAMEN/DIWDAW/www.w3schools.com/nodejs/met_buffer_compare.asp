...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.compare() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.compare()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check if two buffer objects are equal:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('abc');<br>var buf2 = Buffer.from('abc');<br>var x = 
  Buffer.compare(buf1, buf2);<br>console.log(x);<br><br>var buf1 = Buffer.from('a');<br>
  var buf2 = Buffer.from('b');<br>var x = Buffer.compare(buf1, buf2);<br>
  console.log(x);<br><br>var buf1 = Buffer.from('b');<br>var buf2 = Buffer.from('a');<br>
  var x = Buffer.compare(buf1, buf2);<br>console.log(x);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_compare" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The compare() method compares two buffer objects and returns a number 
defining their differences:</p>
<p>0 if they are equal<br>1 if buf1 is higher than buf2<br>-1 if buf1 is 
lower than buf2</p>
<p>This method can be used to sort arrays containing buffers.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;Buffer.compare(<em>buf1, buf2</em>);</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Use Buffer.compare() to sort an array of buffers:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('b');<br>var buf2 = Buffer.from('c');<br>var buf3 = 
  Buffer.from('a');<br>var arr = [buf1, buf2, buf3];<br><br>//The array before 
  sorting:<br>console.log(arr);<br><br>//Sort the array:<br>console.log(arr.sort(Buffer.compare));<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_compare2" target="_blank">Run example &raquo;</a>
</div>
