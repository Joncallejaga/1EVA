...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.isAbsolute() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.isAbsolute()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check if different strings are absolute paths:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>console.log(path.isAbsolute('/test/demo_path.js')); 
  //true<br>console.log(path.isAbsolute('test/demo_path.js')); //false<br>
  console.log(path.isAbsolute('C:\\test\\demo_path.js')); //true</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_isabsolute" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.isAbsolute() method returns <em>true</em> if the specified path is 
an absolute path, otherwise <em>false</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.isAbsolute(<em>path</em>);</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>path</em></td>
  <td>Required. The path to check</td>
  </tr>
  </table>
<hr>
