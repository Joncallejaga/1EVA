...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.alloc() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.alloc()</span> Method</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.alloc(15);<br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_alloc" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.alloc() method creates a new buffer object of the specified size.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;Buffer.alloc(<em>size, fill</em>, <em>encoding</em>);</div></div>
<hr>
...
<tr>
  <td><em>fill</em></td>
  <td>Optional. Specifies a value to fill the buffer with if specified, 
  otherwise the buffer is filled with 0 (zero-filled)</td>
</tr>
<tr>
  <td><em>encoding</em></td>
  <td>Optional. If the buffer values are strings, this parameter specifies the 
  encoding, default encoding is utf8. Supported values are:<br>&quot;ascii&quot;<br>&quot;utf8&quot;<br>
  &quot;utf16le&quot;<br>&quot;ucs2&quot;<br>&quot;base64&quot;<br>&quot;latin1&quot;<br>&quot;binary&quot;<br>&quot;hex&quot;</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Using the fill parameter:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.alloc(15, 'a');<br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_alloc_fill" target="_blank">Run example &raquo;</a>
</div>
