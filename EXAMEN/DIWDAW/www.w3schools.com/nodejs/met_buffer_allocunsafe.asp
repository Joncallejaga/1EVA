...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.allocUnsafe() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.allocUnsafe()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Create a 15 bytes buffer object: </p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.allocUnsafe(15);<br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_allocunsafe" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.allocUnsafe() method creates a new buffer object of the specified size.</p>
<p>This method differs from the <a href="met_buffer_alloc.asp">Buffer.alloc()</a> 
method because it creates a not-pre-filled buffer, and it may contain information from older buffers. That is why it is called <em>unsafe</em>.</p>
<p>To prevent this buffer from containing old data, you can use the 
<code class="w3-codespan">Buffer.fill()</code> method to pre-fill the buffer.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;Buffer.allocUnsafe(<em>size</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>size</em></td>
  <td>Required. Specifies the size of the buffer</td>
  </tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Empty an unsafe buffer:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.allocUnsafe(15);<br>console.log(buf);<br>//Empty the buffer:<br>
  buf.fill(0);<br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_allocunsafe_fill" target="_blank">Run example &raquo;</a>
</div>
