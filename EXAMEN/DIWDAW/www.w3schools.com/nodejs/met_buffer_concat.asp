...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.concat() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.concat()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Join three buffer objects into one:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('a');<br>var buf2 = Buffer.from('b');<br>var buf3 = 
  Buffer.from('c');<br>var arr = [buf1, buf2, buf3];<br><br>var buf = 
  Buffer.concat(arr);<br>console.log(buf);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_concat" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The concat() method joins all buffer objects in an array into one buffer 
object.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;Buffer.concat(<em>arr, length</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>length</em></td>
  <td>Optional. Specifies the length of the concatenated buffer</td>
  </tr>
</table>
<hr>
