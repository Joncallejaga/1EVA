...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Crypto Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Crypto</span> Module</h1>
<p>
...
<h3>Example</h3>
<p>Encrypt the text 'abc'</p>
  <div class="w3-code notranslate jsHigh">
    var crypto = require('crypto');<br><br>var mykey = crypto.createCipher('aes-128-cbc', 
    'mypassword');<br>var mystr = mykey.update('abc', 'utf8', 'hex')<br>mystr += 
    mykey.update.final('hex');<br><br>console.log(mystr); 
    //34feb914c099df25794bf9ccb85bea72</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_crypto_cipher">Run example &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Decrypt back to 'abc'</p>
  <div class="w3-code notranslate jsHigh">
    var crypto = require('crypto');<br><br>var mykey = crypto.createDecipher('aes-128-cbc', 
    'mypassword');<br>var mystr = mykey.update('34feb914c099df25794bf9ccb85bea72', 
    'hex', 'utf8')<br>mystr += mykey.update.final('utf8');<br><br>console.log(mystr); 
    //abc</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_crypto_decipher">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The crypto module provides a way of handling encrypted data.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the crypto module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var crypto = require('crypto');</div></div>

<h2>Crypto Properties and Methods</h2>
