...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer equals() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer equals()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Compare two buffer objects:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('abc');<br>var buf2 = Buffer.from('abc');<br>
  <br>console.log(buf1.equals(buf2));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_equals" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The equals() method compares two buffer objects and returns true if they are 
equal, otherwise false.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  <em>buffer</em>.equals(<em>buf</em>);</div></div>
<hr>
...
<h3>Example</h3>
  <p>Compare two buffer objects:</p>
<div class="w3-code notranslate jsHigh">
  var buf1 = Buffer.from('abc');<br>var buf2 = Buffer.from('abcd');<br>
  <br>console.log(buf1.equals(buf2);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_equals2" target="_blank">Run example &raquo;</a>
</div>
<hr>
