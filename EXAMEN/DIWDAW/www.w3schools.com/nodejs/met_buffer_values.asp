...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer values() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer values()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Display each value in a buffer object:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abcdef');<br><br>for (x of buf.values()) {<br>
  console.log(x);<br>}</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_values" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The values() method returns an iterator object, containing the value of each 
byte in a buffer object.</p>
<hr>
