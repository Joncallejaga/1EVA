...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js TLS Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">TLS </span>Module</h1>
<p>
...
<p>The TLS module provides a way of implementing TLS (Transport Layer Security) 
and SSL (Secure Socket Layer).</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the TLS module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var tls = require('tls');<br></div></div>
