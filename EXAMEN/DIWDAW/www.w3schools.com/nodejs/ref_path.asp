...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Path Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Path </span>Module</h1>
<p>
...
<h3>Example</h3>
  ...
  <div class="w3-code notranslate jsHigh">
    var path = require('path');<br>var filename = path.basename('/Users/Refsnes/demo_path.js');<br>console.log(filename);<br>
    </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_path">Run example &raquo;</a>
</div>
<hr>
...
var path = require('path');<br></div></div>

<h2>Path Properties and Methods</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_path_basename.asp">basename()</a></td>
    <td>Returns the last part of a path</td>
  </tr>
  <tr>
    <td><a href="met_path_delimeter.asp">delimiter</a></td>
    <td>Returns the delimiter specified for the platform</td>
  </tr>
  <tr>
    <td><a href="met_path_dirname.asp">dirname()</a></td>
    <td>Returns the directories of a part</td>
  </tr>
  <tr>
    <td><a href="met_path_extname.asp">extname()</a></td>
    <td>Returns the file extension of a path</td>
  </tr>
  <tr>
    <td><a href="met_path_format.asp">format()</a></td>
    <td>Formats a path object into a path string</td>
  </tr>
  <tr>
    <td><a href="met_path_isabsolute.asp">isAbsolute()</a></td>
    <td>Returns true if a path is an absolute path, 
    otherwise false</td>
  </tr>
  <tr>
    <td><a href="met_path_join.asp">join()</a></td>
    <td>Joins the specified paths into one</td>
  </tr>
  <tr>
    <td><a href="met_path_normalize.asp">normalize()</a></td>
