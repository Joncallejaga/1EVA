...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.notDeepStrictEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.notDeepStrictEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two objects, and their child objects, are equal (both in values and 
  types), an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>var z = { a = { n: '0' } };<br>assert.notDeepStrictEqual(x, z); //OK<br>assert.notDeepStrictEqual(x, 
  y); /*AssertionError: { a: { n: 0 } } notDeepStrictEqual {a: { n: 0 } }*/<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notdeepstrictequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.notDeepStrictEqual() method tests if two objects, and their child objects, are 
NOT equal, using the !== 
operator.</p>
<p>If the two objects are equal, an assertion failure is being caused, and the program is terminated.</p>
<p>The !== operator tests if both values <em>and types</em> are not equal.</p>
<p>To compare the objects using the != operator, use the
<a href="met_assert_notdeepequal.asp">assert.notDeepEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.notDeepStrictEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>assert.notDeepStrictEqual(x, y, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notdeepstrictequal_message" target="_blank">Run example &raquo;</a>
</div>
