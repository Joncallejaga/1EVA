...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer write() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer write()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Overwrite parts of an existing buffer:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abcdef');<br><br>buf.write('qq', 2);<br><br>console.log(buf.toString());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_write" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The write() method writes the specified string into a buffer, at the 
specified position.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.write(<em>value</em>, <em>start</em>, <em>bytes</em>, <em>encoding</em>);
</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>value</em></td>
  <td>Required. The string to insert</td>
  </tr>
  <tr>
  <td><em>start</em></td>
  <td>Optional. Where to start writing. Default 0</td>
  </tr>
  <tr>
  <td><em>bytes</em></td>
  <td>Optional. How many bytes to write. Default length of buffer minus start 
  position</td>
  </tr>
  <tr>
...
<tbody><tr>
  ...
  <td>A Number, representing the number of bytes written</td>
</tr>
<tr>
