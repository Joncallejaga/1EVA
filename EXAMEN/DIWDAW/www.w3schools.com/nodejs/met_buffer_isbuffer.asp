...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.isBuffer() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.isBuffer()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check if an object is a Buffer:</p>
<div class="w3-code notranslate jsHigh">
  var x = Buffer.from('abc');<br><br>console.log(Buffer.isBuffer(x));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_isbuffer" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.isBuffer() method returns <em>true</em> if the specified object is 
a Buffer, otherwise <em>false</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Buffer.isBuffer(<em>obj</em>);
</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>obj</em></td>
  <td>Required. The object to check if is a Buffer</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>A Boolean, <em>true</em> if the specified object is a Buffer, otherwise <em>
  false</em></td>
</tr>
<tr>
...
<h3>Example</h3>
  <p>Check if an object is a Buffer:</p>
<div class="w3-code notranslate jsHigh">
  var x = 'abc';<br><br>console.log(Buffer.isBuffer(x));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_isbuffer2" target="_blank">Run example &raquo;</a>
</div>
<hr>
<p>
<a class="w3-btn w3-white w3-border" href="ref_buffer.asp">&#10094; Buffer Module</a>
