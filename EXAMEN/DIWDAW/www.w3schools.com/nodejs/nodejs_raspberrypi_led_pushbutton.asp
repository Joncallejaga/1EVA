...
<p>Now it is time to build the circuit on our Breadboard. We will use the <a href="https://www.w3schools.com/nodejs/nodejs_raspberrypi_gpio_led.asp">circuit we created in the last chapter</a> as a starting point.</p>
