...
<h3>Example</h3>
  <p>Open a file, and output the content:</p>
<div class="w3-code notranslate jsHigh">
  var fs = require('fs');<br><br>fs.readFile('demofile.txt', 'utf8', function(err, data) {<br>&nbsp; 
  if (err) throw err;<br>&nbsp;&nbsp;console.log(data);<br>});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_fs">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The File System module provides a way of working with the computer's file 
system.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the File System module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var fs = require('fs');</div></div>

<h2>File System Methods</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>symlinkSync()</td>
    <td>Same as symlinc(), but synchronous instead of asynchronous</td>
  </tr>
  <tr>
    <td>truncate()</td>
    <td>Truncates a file</td>
  ...
  <tr>
    <td>writeSync()</td>
    <td>Same as write(), but synchronous instead of asynchronous</td>
  </tr>
  <tr>
    <td>writeSync()</td>
    <td>Same as write(), but synchronous instead of asynchronous</td>
