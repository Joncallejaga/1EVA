...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.notEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.notEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two values are equal, an error is thrown and the 
...
<div class="w3-code notranslate jsHigh">
  ...
  */<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.notEqual() method tests if two values are NOT equal, using the != 
operator.</p>
<p>If the two values are equal, an assertion failure is being caused, and the program is terminated.</p>
<p>To compare the values using the stricter !== operator, use the
<a href="met_assert_notstrictequal.asp">assert.notStrictEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.notEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.notEqual(50, 50, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notequal_message" target="_blank">Run example &raquo;</a>
</div>
