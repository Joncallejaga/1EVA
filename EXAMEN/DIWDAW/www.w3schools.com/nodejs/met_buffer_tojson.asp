...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer toJSON() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer toJSON()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Return the buffer object as&nbsp;a JSON object:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>console.log(buf.toJSON());</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_tojson" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toJSON() method returns a JSON object based on the Buffer object.</p>
<hr>
