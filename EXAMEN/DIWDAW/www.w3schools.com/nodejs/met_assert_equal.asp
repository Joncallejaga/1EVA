...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.equal() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.equal()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two values are not equal, an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.equal(50, 50); //OK<br>assert.equal(50, 
  &quot;50&quot;); //OK<br>assert.equal(50, 70); /*AssertionError: 50 == 70 
  */<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_equal">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.equal() method tests if two values are equal, using the == 
operator.</p>
...
<a href="met_assert_strictequal.asp">assert.strictEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.equal(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.equal(50, 70, &quot;My message goes here&quot;);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_equal_message">Run example &raquo;</a>
</div>
