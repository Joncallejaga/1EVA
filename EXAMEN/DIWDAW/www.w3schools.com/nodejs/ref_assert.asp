...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Assert Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Assert</span> Module</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert(5 &gt; 7);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_assert">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert module provides a way of testing expressions. If the expression 
evaluates to 0, or false, an assertion failure is being caused, and the program 
is terminated.</p>
...
var assert = require('assert');</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_assert.asp">assert()</a></td>
    <td>Checks if a value is true. Same as assert.ok()</td>
  </tr>
  <tr>
    <td><a href="met_assert_deepequal.asp">deepEqual()</a></td>
    <td>Checks if two values are equal</td>
  </tr>
  <tr>
    <td><a href="met_assert_deepstrictequal.asp">deepStrictEqual()</a></td>
  ...
  <tr>
    <td><a href="met_assert_equal.asp">equal()</a></td>
  ...
  <tr>
    <td><a href="met_assert_notdeepequal.asp">notDeepEqual()</a></td>
    <td>Checks if two values are not equal</td>
  </tr>
  <tr>
    <td><a href="met_assert_notdeepstrictequal.asp">notDeepStrictEqual()</a></td>
    <td>Checks if two values are not equal, using the strict not equal operator 
    (!==)</td>
  </tr>
  <tr>
    <td><a href="met_assert_notequal.asp">notEqual()</a></td>
    <td>Checks if two values are not equal, using the not equal operator (!=)</td>
  </tr>
  <tr>
    <td><a href="met_assert_notstrictequal.asp">notStrictEqual()</a></td>
    <td>Checks if two values are not equal, using the strict not equal operator 
    (!==)</td>
  </tr>
  <tr>
    <td><a href="met_assert_ok.asp">ok()</a></td>
    <td>Checks if a value is true</td>
  </tr>
  <tr>
    <td><a href="met_assert_strictequal.asp">strictEqual()</a></td>
    <td>Checks if two values are equal, using the strict equal operator (===)</td>
  </tr>
  <tr>
    <td>throws()</td>
