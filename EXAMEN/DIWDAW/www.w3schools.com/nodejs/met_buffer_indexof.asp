...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer indexOf() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer indexOf()</span> Method</h1>
<p>
<a class="w3-btn w3-white w3-border" href="ref_buffer.asp">&#10094; Buffer Module</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>Check if a buffer incudes the phrase &quot;welcome&quot;, and return the position:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('Hello, and welcome to Rome!');<br><br>console.log(buf.indexOf('welcome'));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_indexof" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The indexOf() method checks if a specified value is present in the buffer and 
returns the position.</p>
<p>This method returns -1 if the value to search for never occurs.</p>
<p>If the specified value occurs more than once, only the position of the first 
occurrence will be returned.</p>
<p>See also: the<a href="met_buffer_lastindexof.asp"> lastIndexOf()</a> method, which 
returns the <em>last</em> occurrence of the specified value.</p>

<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.indexOf(<em>value</em>, <em>start</em>, <em>encoding</em>);
</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>value</em></td>
  <td>Required. What to search for. Legal value types:<br>String<br>
  Buffer<br>Number (Integer)</td>
  </tr>
  <tr>
  <td><em>start</em></td>
  <td>Optional. Where to begin the search. Default 0</td>
  </tr>
  <tr>
  <td><em>encoding</em></td>
  <td>Optional. If the value is a string, this parameter is used to specify its encoding. Default &quot;utf8&quot;</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>A Number, representing the position where the specified search value 
  occurs for the first time, or -1 if it never occurs</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Return the first occurrence of the letter &quot;e&quot;:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('Hello, and welcome to Rome!');<br><br>console.log(buf.indexOf('e'));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_indexof2" target="_blank">Run example &raquo;</a>
</div>
<hr>
