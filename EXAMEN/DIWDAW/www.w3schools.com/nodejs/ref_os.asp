...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js OS Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">OS </span>Module</h1>
<p>
...
<h3>Example</h3>
  <p>Get information about the computer's operating system:</p>
  <div class="w3-code notranslate jsHigh">
    var os = require('os');<br>console.log(&quot;Platform: &quot; + os.platform());<br>
    console.log(&quot;Architecture: &quot; + os.arch());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_os">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The OS module provides information about the computer's operating system.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the OS module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var os = require('os');<br></div></div>

<h2>OS Properties and Methods</h2>
