...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer includes() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer includes()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check if a buffer incudes the phrase &quot;welcome&quot;:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('Hello, and welcome to Rome!');<br><br>console.log(buf.includes('welcome'));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_includes" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The includes() method checks if a specified value is included in the buffer.</p>
<p>Returns <em>true</em> if the values is included, otherwise <em>false</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>buffer</em>.includes(<em>value</em>, <em>start</em><em>, encoding</em>);
</div>
<hr>
