...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js HTTPS Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">HTTPS </span>Module</h1>
<p>
...
<h3>Example</h3>
  <p>Create a https server that listens on port 8080 of your computer.</p>
  <p>When port 8080 get accessed, write &quot;Hello World!&quot; back as a response:</p>
  <div class="w3-code notranslate jsHigh">
    var https = require('https');<br><br>https.createServer(function (req, res) 
    {<br>&nbsp; res.writeHead(200, {'Content-Type': 'text/plain'});<br>&nbsp; 
    res.write('Hello World!');<br>&nbsp; 
    res.end();<br>}).listen(8080);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_ref_https">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The HTTPS module provides a way of making Node.js transfer data over HTTP 
TLS/SSL protocol, which is the secure HTTP protocol.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the HTTPS module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var https = require('https');</div></div>

<h2>HTTPS Properties and Methods</h2>
