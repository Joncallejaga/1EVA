...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.isEncoding() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.isEncoding()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Check if the Buffer supports the utf8 encoding:</p>
<div class="w3-code notranslate jsHigh">
  console.log(Buffer.isEncoding('utf8'));<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_isencoding" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.isEncoding() method returns <em>true</em> if the specified encoding 
is supported.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Buffer.isEncoding(<em>encoding</em>);
</div>
<hr>
...
<tr>
  ...
  <td>Required. The encoding to test. Normally these encodings are supported in 
  Node.js:<br>&quot;ascii&quot;<br>&quot;utf8&quot;<br>&quot;utf16le&quot;<br>&quot;ucs2&quot;<br>&quot;base64&quot;<br>&quot;latin1&quot;<br>
  &quot;binary&quot;<br>&quot;hex&quot;t</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>A Boolean, <em>true</em> if the specified encoding is supported, otherwise <em>
  false</em></td>
</tr>
<tr>
...
<h3>Example</h3>
  <p>Check if the Buffer supports the utf8 encoding:</p>
<div class="w3-code notranslate jsHigh">
  console.log(Buffer.isEncoding('windows-1252'));</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_isencoding2" target="_blank">Run example &raquo;</a>
</div>
<hr>
<p>
<a class="w3-btn w3-white w3-border" href="ref_buffer.asp">&#10094; Buffer Module</a>
