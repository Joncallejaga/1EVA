...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js buffer length Property</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">buffer length</span> Property</h1>
<p>
...
<h3>Example</h3>
  <p>Return the size of a buffer:</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>console.log(buf.length);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_length" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The length property returns the size of a buffer, in bytes.</p>
<hr>
...
<tbody><tr>
  ...
  <td>A Number, representing the size of a buffer</td>
</tr>
<tr>
