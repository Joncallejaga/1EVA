...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Query String Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Query String</span> Module</h1>
<p>
...
<h3>Example</h3>
<p>Parse a query string into an object, and extract the year property:</p>
<div class="w3-code notranslate jsHigh">
  var querystring = require('querystring');<br>var q = 
  querystring.parse('year=2017&amp;month=february');<br>console.log(q.year);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_querystring">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Query String module provides a way of parsing the URL query string.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the Query String module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var querystring = require('querystring');</div></div>

<h2>Query String Methods</h2>
