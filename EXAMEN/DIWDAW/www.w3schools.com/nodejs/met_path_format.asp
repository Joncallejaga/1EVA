...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.format() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.format()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Format a path object into a string and return the result:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br>var obj = { dir: 'C:\\Users\\Refsnes', base: 'demo_path.js' 
  }<br><br>var p = path.format(obj);<br>console.log(p);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_format" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.format() method formats a path object into a path string.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.extname(<em>pathObject</em>);</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>pathObject</em></td>
  <td>Required. The path object to format</td>
  </tr>
  </table>
<hr>
