...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Events Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Events </span>Module</h1>
<p>
...
<h3>Example</h3>
<p>Make an event listener for an event called "scream", then provoke the event:</p>
  <div class="w3-code notranslate jsHigh">
    var events = require('events');<br>var eventEmitter = new 
    events.EventEmitter();<br><br>eventEmitter.on('scream', function() {<br>
    console.log('A scream is detected!');<br>});<br>eventEmitter.emit('scream');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_events">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Events module provides a way of working with events.</p>
<p>In Node.js, all events are an instance of the EventEmitter object</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the Events module, and creating an EventEmitter in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var events = require('events');<br>var eventEmitter = new events.EventEmitter();</div></div>

<h2>EventEmitter Properties and Methods</h2>
