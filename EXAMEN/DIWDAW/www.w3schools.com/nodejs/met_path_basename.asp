...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js path.basename() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">path.basename()</span> Method</h1>
<p>
<a class="w3-btn w3-white w3-border" href="ref_path.asp">&#10094; Path Module</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>Extract the filename from a file path:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var filename = path.basename('/Users/Refsnes/demo_path.js');<br>
  console.log(filename);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_basename" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The path.basename() method returns the filename part of a file path.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  <em>path</em>.basename(<em>path, extension</em>);</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>path</em></td>
  <td>Required. The file path to search in</td>
  </tr>
  <tr>
  <td><em>extension</em></td>
  <td>Optional. If the filename ends with the specified string, the specified 
  string is excluded from the result</td>
  </tr>
  </table>
<hr>
...
<tbody><tr>
  ...
  <td>The filename, as a String</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Extract the filename, but not the ".js" at the end:</p>
<div class="w3-code notranslate jsHigh">
  var path = require('path');<br><br>var filename = path.basename('/Users/Refsnes/demo_path.js', '.js');<br>
  console.log(filename);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_path_basename2" target="_blank">Run example &raquo;</a>
</div>
<hr>
