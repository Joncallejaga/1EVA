...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js requestListener() Function</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">requestListener()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="met_http_createserver.asp">&#10094; http.createServer</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>The requestListener function is the function that is executed each time the 
  server gets a request:</p>
<div class="w3-code notranslate jsHigh">
  var http = require('http');<br>http.createServer(<strong>function (req, res) {<br>&nbsp; 
  res.writeHead(200, {'Content-Type': 'text/plain'});<br>&nbsp; res.write('Hello 
  World!');<br>&nbsp; res.end();</strong><br><strong>}</strong>).listen(8080);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_ref_http">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The requestListener is a function that is called each time the server gets a 
request.</p>
<p>The requestListener function is passed as a parameter to the 
http.createServer() method.</p>
<p>The requestListener function handles <em>requests</em> from the user, and also the 
<em>response</em> back to the user</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
  function (<em>request</em>, <em>response</em>) {<br>}</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em><a href="https://www.w3schools.com/nodejs/obj_http_incomingmessage.asp">request</a></em></td>
  <td>The first parameter, the Request object, represents an 
  <a href="https://www.w3schools.com/nodejs/obj_http_incomingmessage.asp">IncomingMessage</a> 
  object.</td>
  </tr>
<tr>
  <td><em><a href="https://www.w3schools.com/nodejs/obj_http_serverresponse.asp">response</a></em></td>
  <td>The second parameter represents a <a href="https://www.w3schools.com/nodejs/obj_http_serverresponse.asp">ServerResponse</a> object, which has methods 
  for handling the response stream back to the user</td>
</tr>
</table>
<hr>
