...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.ok() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.ok()</span> Method</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.ok(50 &gt; 70);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_ok">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.ok() method tests if a given expression is true or not.</p>
<p>If the expression evaluates to 0, or false, an assertion failure is being caused, and the program is terminated.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.ok(<em>expression</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.ok(50 &gt; 70, &quot;My message goes here&quot;);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_ok_message">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>The assert.ok() method also throws an error if the expression evaluates to 0:</p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>assert.ok(50 - 50);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_ok_0">Run example &raquo;</a>
</div>
<hr>
