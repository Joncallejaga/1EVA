...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Stream Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Stream </span>Module</h1>
<p>
...
<h3>Example</h3>
  <p>Write to a writeable stream:</p>
  <div class="w3-code notranslate jsHigh">
    var http = require('http');<br><br>http.createServer(function (req, res) {<br>&nbsp; 
    res.writeHead(200, {'Content-Type': 'text/html'});<br>&nbsp; res.write('Hello 
    World!');<br>&nbsp; res.end();<br>}).listen(8080);<br>
    </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_ref_stream_writable">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Stream module provides a way of handling streaming data.</p>
<p>There are two types of streams: readable and writeable.</p>
<p>An example of a readable stream is the <em>response</em> object you get when 
working with the http.createServer() method.</p>
<p>An example of a writable stream is the <em>request</em> object you get when 
working with the http.createServer() method.</p>
<hr>

<h2>Syntax</h2>
<p>Some methods returns a readable/writable stream object, like 
http.createServer(), and if that is the case, you do not have to include the 
stream module.</p>
<p>Otherwise, the syntax for including the Stream module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var stream = require('stream');<br></div></div>

<h2>Readable Stream Properties and Methods</h2>
...
<h2>Writable Stream Properties and Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:24%">Method</th>
    <th>Description</th>
