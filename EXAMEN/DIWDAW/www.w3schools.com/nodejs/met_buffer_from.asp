...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Buffer.from() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Buffer.from()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>Creates a new buffer filled with the letters 'abc':</p>
<div class="w3-code notranslate jsHigh">
  var buf = Buffer.from('abc');<br><br>console.log(buf);</div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_buffer_from" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The Buffer.from() method creates a new buffer filled with the specified 
string, array, or buffer.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Buffer.from(<em>obj, encoding</em>);
</div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>obj</em></td>
  <td>Required. An object to fill the buffer with. Legal object types:<br>String<br>
  Array<br>Buffer<br>arrayBuffer</td>
  </tr>
  <tr>
  <td><em>encoding</em></td>
  <td>Optional. If the object is a string, this parameter is used to specify its encoding. Default &quot;utf8&quot;</td>
  </tr>
  </table>
<hr>
