...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.notDeepEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.notDeepEqual()</span> Method</h1>
<p>
...
<h3>Example</h3>
  <p>If two objects, and their child objects, are equal, an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>var z = { a = { n: 1 } };<br>assert.notDeepEqual(x, z); //OK<br>assert.notDeepEqual(x, 
  y); /*AssertionError: { a: { n: 0 } } notDeepEqual {a: { n: 0 } }*/<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notdeepequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.notDeepEqual() method tests if two objects, and their child objects, are 
NOT equal, using the != 
operator.</p>
...
<a href="met_assert_notdeepstrictequal.asp">assert.notDeepStrictEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.notDeepEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>assert.notDeepEqual(x, y, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_notdeepequal_message" target="_blank">Run example &raquo;</a>
</div>
