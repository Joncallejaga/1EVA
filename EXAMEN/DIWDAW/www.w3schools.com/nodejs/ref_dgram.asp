...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Datagram Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">Datagram </span> Module</h1>
<p>
...
<h3>Example</h3>
  <p>Make a file (&quot;demo_dgram.js&quot;) that listens for messages on port 8080:</p>
  <div class="w3-code notranslate jsHigh">
    var dgram = require('dgram');<br>var s = dgram.createSocket('udp4');<br>
    s.on('message', function(msg, rinfo) {<br>&nbsp; console.log('I got this 
    message: ' + msg);<br>});<br>s.bind(8080);</div>
  <p>Remember to initiate the file:</p>
  <div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;node demo_dgram.js
</div>
</div>
<div class="w3-example">
<h3>Example</h3>
  <p>Make a file (&quot;demo_dgram_send.js&quot;) that sends a message to port 8080:</p>
  <div class="w3-code notranslate jsHigh">
    var dgram = require('dgram');<br>var s = dgram.createSocket('udp4');<br>
    s.send(Buffer.from('abc'), 8080, 'localhost');</div>
  <p>Remember to initiate the file:</p>
  <div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;node demo_dgram_send.js
</div>
</div>

<div class="w3-example">
<h3>Result</h3>
  <p>When initiating the second file, the first Command window will now look like this:</p>
  <div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;node demo_dgram.js<br>
...
<p>The dgram module provides a way of working with Datagram sockets.</p>
<p>It can be used to send messages from one computer/server to another.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the dgram module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var dgram = require('dgram');</div></div>

<h2>Datagram Methods</h2>
