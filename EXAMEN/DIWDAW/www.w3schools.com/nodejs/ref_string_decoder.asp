...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js String Decoder Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">String Decoder </span>Module</h1>
<p>
...
<h3>Example</h3>
<p>Decode a stream of binary data (a buffer object) into a string:</p>
  <div class="w3-code notranslate jsHigh">
    var StringDecoder = require('string_decoder').StringDecoder;<br>var d = new 
    StringDecoder('utf8');<br>var b = Buffer('abc');<br><br>console.log(b); 
    //write buffer<br>console.log(d.write(b)); // write decoded buffer;<br>
    </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_string_decoder">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The String Decoder module provides a way of decoding Buffer objects into strings.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the String Decoder module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var StringDecoder = require('string_decoder').StringDecoder;<br></div></div>

<h2>String Decoder Properties and Methods</h2>
