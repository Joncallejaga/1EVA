...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js assert.deepStrictEqual() Method</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">assert.deepStrictEqual()</span> Method</h1>
<p>
<a class="w3-btn w3-white w3-border" href="ref_assert.asp">&#10094; Assert Module</a>
</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
  <p>If two objects, or their child objects, are not equal (both in value and 
  type), an error is thrown and the 
  program is terminated: </p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var y = { a = 
  { n: 0 } };<br>var z = { a = { n: '0' } };<br>assert.deepEqual(x, y); //OK<br>assert.deepEqual(x, 
  z); /*AssertionError: { a: { n: 0 } } deepStrictEqual {a: { n: '0' } }*/<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_deepstrictequal" target="_blank">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The assert.deepStrictEqual() method tests if two objects, and their child objects, are equal, using the === 
operator.</p>
<p>If the two objects are not equal, an assertion failure is being caused, and the program is terminated.</p>
<p>The === operator tests if the values <em>and the types</em> are equal.</p>
<p>To compare the objects using the == operator, use the
<a href="met_assert_deepequal.asp">assert.deepEqual() method</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
&nbsp;assert.deepStrictEqual(<em>value1, value2</em>, <em>message</em>);</div></div>
<hr>
...
<tr>
  ...
  <tr>
  <td><em>value1</em></td>
  <td>Required. Specifies the first value to be compared</td>
  </tr>
<tr>
  <td><em>value2</em></td>
  <td>Required. Specifies the second value to be compared</td>
</tr>
<tr>
  <td><em>message</em></td>
  <td>Optional. Specifies the error message to be assigned to the AssertionError. If 
  omitted, a default message is assigned </td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Using the message parameter:</p>
<div class="w3-code notranslate jsHigh">
  var assert = require('assert');<br>var x = { a = { n: 0 } };<br>var z = { a = 
  { n: '0' } };<br>assert.deepStrictEqual(x, z, &quot;My message goes here&quot;);<br></div>
  <a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_met_assert_deepstrictequal_message" target="_blank">Run example &raquo;</a>
</div>
