...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js VM Module</title>
<meta charset="utf-8">
...
<h1>Node.js <span class="color_h1">VM </span>Module</h1>
<p>
...
<h3>Example</h3>
  <p>Run some JavaScript code in a &quot;virtual machine&quot;:</p>
  <div class="w3-code notranslate jsHigh">
    var vm = require('vm');<br>var myObj = { name: 'John', age: 38 };<br>
    vm.createContext(myObj);<br><br>vm.runInContext('age += 1;', myObj);<br><br>
    console.log(myObj);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_vm">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The VM module provides a way of executing JavaScript on a virtual machine, 
almost like eval() in JavaScript.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax for including the VM module in your application:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
var vm = require('vm');<br></div></div>

<h2>TLS Properties and Methods</h2>
