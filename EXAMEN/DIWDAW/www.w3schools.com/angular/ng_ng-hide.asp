...
<h1>AngularJS <code class="w3-codespan">ng-hide</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-hide">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-hide</code> directive hides the HTML element if the expression evaluates to true.</p>
<p><code class="w3-codespan">ng-hide</code> is also a predefined CSS class in AngularJS, and sets 
the element's <code class="w3-codespan">display</code> to <code class="w3-codespan">none</code>.</p>
<hr>
