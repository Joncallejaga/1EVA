...
<h1>AngularJS <code class="w3-codespan">ng-focus</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-focus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-focus</code> directive tells AngularJS what to do when an HTML element gets focus.</p>
<p>The <code class="w3-codespan">ng-focus</code> directive from AngularJS will not override the element's original onfocus event, both will be executed.</p>
<hr>
