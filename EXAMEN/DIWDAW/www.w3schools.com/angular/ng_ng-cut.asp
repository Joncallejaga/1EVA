...
<h1>AngularJS <code class="w3-codespan">ng-cut</code> Directive</h1>
...
<h3>Example</h3>
<p>Execute an expression when the text of the input field is being cut:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-cut">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-cut</code> directive tells AngularJS what to do when you cut the text of an HTML element.</p>
<p>The <code class="w3-codespan">ng-cut</code> directive from AngularJS will not override the element's original oncut event,
both the <code class="w3-codespan">ng-cut</code> expression and the original oncut event will be executed.</p>
<hr>
