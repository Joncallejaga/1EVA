...
<h1>AngularJS <code class="w3-codespan">ng-mouseenter</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-mouseenter">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-mouseenter</code> directive tells AngularJS what to do when a 
mouse cursor enters the specific HTML element.</p>
<p>The <code class="w3-codespan">ng-mouseenter</code> directive from AngularJS will not override the element's original onmouseenter event, both will be executed.</p>
<hr>
