...
<h1>AngularJS <code class="w3-codespan">ng-style</code> Directive</h1>
...
<h3>Example</h3>
<p>Add some style with AngularJS, using an object with CSS keys and values:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-style">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-style</code> directive specifies the style attribute for the 
HTML element.</p>
<p>The value of the <code class="w3-codespan">ng-style</code> attribute must be an object, or an 
