...
<h1>AngularJS <code class="w3-codespan">ng-repeat</code> Directive</h1>
...
<br>
&lt;h1 ng-repeat="x in records"&gt;{{x}}&lt;/h1&gt;<br>
<br>
&lt;script&gt;<br>
...
<a target="_blank" href="tryit.asp?filename=try_ng_ng-repeat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-repeat</code> directive repeats a set of HTML, a given number of 
times.</p>
...
<p>If you have an collection of objects, the <code class="w3-codespan">ng-repeat</code> directive is 
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    Expression examples:<br><br><code class="w3-codespan">x in records</code><em><br><br></em><code class="w3-codespan">
...
<div class="w3-code notranslate">
<div class="htmlHigh">
&lt;table ng-controller="myCtrl" border="1"&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;tr ng-repeat="x in records"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;td&gt;{{x.Name}}&lt;/td&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;td&gt;{{x.Country}}&lt;/td&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;/tr&gt;<br>
&lt;/table&gt;<br>
...
<a target="_blank" href="tryit.asp?filename=try_ng_ng-repeat2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=try_ng_ng-repeat3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
