...
<h1>AngularJS <code class="w3-codespan">ng-class</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-class">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-class</code> directive dynamically binds one or more CSS classes to an HTML element.</p>
<p>The value of the <code class="w3-codespan">ng-class</code> directive can be a string, an object, or an array.</p>
<p>If it is a string, it should contain one or more, space-separated class names.</p>
<p>As an object, it should contain key-value pairs, where the key is the class name of the class you want to add, and the value is a boolean value. The class will only be added if the value is set to true.</p>
