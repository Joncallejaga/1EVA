...
<h1>AngularJS <code class="w3-codespan">uppercase</code> Filter</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ref_uppercase">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">uppercase</code> filter converts a string to uppercase letters.</p>
<hr>
