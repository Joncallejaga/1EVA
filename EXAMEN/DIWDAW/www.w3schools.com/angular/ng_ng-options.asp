...
<h1>AngularJS <code class="w3-codespan">ng-options</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-options">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-options</code> directive fills a &lt;select&gt; element with 
&lt;options&gt;.</p>
<p>The <code class="w3-codespan">ng-options</code> directive uses an array to fill the dropdown 
list. In many cases it would be easier to use the <code class="w3-codespan">ng-repeat</code> 
directive, but you have more flexibility when using the <code class="w3-codespan">ng-options</code> 
directive.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <em>value</em> in <em>array<br><br>label</em> disable when <em>disable</em> 
    ...
    disable when <em>disable</em> for <em>value</em> in <em>array</em> track by
