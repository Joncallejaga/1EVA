...
<h1>AngularJS <code class="w3-codespan">ng-csp</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-csp">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-csp</code> directive is used to change the security policy of AngularJS.</p>
<p>With the <code class="w3-codespan">ng-csp</code> directive set, AngularJS will not run any eval 
functions, and it will not inject any inline styles.</p>
<p>Setting the value of the <code class="w3-codespan">ng-csp</code> directive to <code class="w3-codespan">no-unsafe-eval</code>, 
will stop AngularJS from running any eval functions, but allow injecting inline 
styles.</p>
<p>Setting the value of the <code class="w3-codespan">ng-csp</code> directive to <code class="w3-codespan">
no-inline-style</code>, will stop AngularJS from injecting any inline styles, 
but allow eval functions.</p>
<p>Using the <code class="w3-codespan">ng-csp</code> directive is necessary when developing apps for 
Google Chrome Extensions or Windows Apps.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">ng-csp</code> directive does not affect 
...
run its own eval functions. It uses a compatibility mode which can slow down the 
