...
<h1>AngularJS <code class="w3-codespan">ng-dblclick</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-dblclick">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-dblclick</code> directive tells AngularJS what to do when an HTML 
element is double-clicked.</p>
<p>The <code class="w3-codespan">ng-dblclick</code> directive from AngularJS will not override the element's original ondblclick event,
both are executed.</p>
<hr>
