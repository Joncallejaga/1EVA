...
<h1>AngularJS <code class="w3-codespan">ng-keydown</code> Directive</h1>
...
<p>The <code class="w3-codespan">ng-keydown</code> directive tells AngularJS what to do when the 
keyboard is used on the specific HTML element.</p>
<p>The <code class="w3-codespan">ng-keydown</code> directive from AngularJS will not override the element's original onkeydown event, both will be executed.</p>
