...
<h1>AngularJS <code class="w3-codespan">ng-app</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-app">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-app</code> directive tells AngularJS that this is the root element of the 
AngularJS application.</p>
<p>All AngularJS applications must have a root element.</p>
<p>You can only have one <code class="w3-codespan">ng-app</code> directive in your HTML document. If more than 
one <code class="w3-codespan">ng-app</code> directive appears, the first appearance will be used.</p>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-app_module">Try it Yourself &raquo;</a>
</div>
<hr>
