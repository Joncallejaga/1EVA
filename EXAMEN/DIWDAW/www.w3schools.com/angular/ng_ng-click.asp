...
<h1>AngularJS <code class="w3-codespan">ng-click</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-click">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-click</code> directive tells AngularJS what to do when an HTML 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-click2">Try it Yourself &raquo;</a>
</div>
<hr>
