...
<h1>AngularJS <code class="w3-codespan">ng-model-options</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-model-options">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-model-options</code> directive is used to control the binding of an HTML form element 
and a variable 
in the scope.</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    : true|false} specify if the binding can happen if the value did not 
