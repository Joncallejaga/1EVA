...
<h1>AngularJS <code class="w3-codespan">ng-disabled</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-disabled</code> directive sets the disabled attribute of a form field (input, select, or textarea).</p>
<p>The form field will be disabled if the expression inside the <code class="w3-codespan">ng-disabled</code> attribute returns true.</p>
<p>The <code class="w3-codespan">ng-disabled</code> directive is necessary to be able to shift the 
value between <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>. In HTML, you cannot set 
the <code class="w3-codespan">disabled</code> attribute to <code class="w3-codespan">false</code> (the presence of the 
disabled attribute makes the element disabled, regardless of its value).</p>
<hr>
