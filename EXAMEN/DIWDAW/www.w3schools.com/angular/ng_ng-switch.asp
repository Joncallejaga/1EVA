...
<h1>AngularJS <code class="w3-codespan">ng-switch</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-switch">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-switch</code> directive lets you hide/show HTML elements 
depending on an expression.</p>
<p>Child elements with the <code class="w3-codespan">ng-switch-when</code> directive will be 
displayed if it gets a match, otherwise the element, and its children will be 
removed.</p>
<p>You can also define a default section, by using the <code class="w3-codespan">ng-switch-default</code> 
directive, to show a section if none of the other sections get a match.</p>
<hr>
