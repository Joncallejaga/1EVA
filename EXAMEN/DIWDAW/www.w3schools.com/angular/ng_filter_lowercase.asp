...
<h1>AngularJS <code class="w3-codespan">lowercase</code> Filter</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ref_lowercase">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">lowercase</code> filter converts a string to lowercase letters.</p>
<hr>
