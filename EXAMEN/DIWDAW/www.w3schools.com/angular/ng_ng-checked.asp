...
<h1>AngularJS <code class="w3-codespan">ng-checked</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-checked">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-checked</code> directive sets the checked attribute of a 
checkbox or a radiobutton.</p>
<p>The checkbox, or radiobutton, will be checked if the expression inside the
<code class="w3-codespan">ng-checked</code> attribute returns true.</p>
<p>The <code class="w3-codespan">ng-checked</code> directive is necessary to be able to shift the 
value between <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>. In HTML, you cannot set 
the <code class="w3-codespan">checked</code> attribute to <code class="w3-codespan">false</code> (the presence of the 
checked attribute makes the element checked, regardless of its value).</p>
<hr>
