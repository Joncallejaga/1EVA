...
<h1>AngularJS <code class="w3-codespan">ng-model</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-model">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-model</code> directive binds an HTML form element to a variable 
in the scope.</p>
...
<hr>
<h2>Related pages</h2>
<p>Angular Tutorial: <a href="angular_model.asp">ng-model Directive</a></p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="angular_ref_directives.asp">&#10094; AngularJS Reference</a>
</div>
