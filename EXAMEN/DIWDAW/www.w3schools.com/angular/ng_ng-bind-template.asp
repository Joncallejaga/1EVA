...
<h1>AngularJS <code class="w3-codespan">ng-bind-template</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-bind-template">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-bind-template</code> directive tells AngularJS to replace the 
content of an HTML element with the value of the given expressions.</p>
<p>Use the <code class="w3-codespan">ng-bind-template</code> directive when you want to bind more 
than one expression to your HTML element.</p>
<hr>
