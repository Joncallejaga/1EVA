...
<h1>AngularJS <code class="w3-codespan">ng-blur</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-blur">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-blur</code> directive tells AngularJS what to do when an HTML element loses focus.</p>
<p>The <code class="w3-codespan">ng-blur</code> directive from AngularJS will not override the element's original onblur event,
both the <code class="w3-codespan">ng-blur</code> expression and the original onblur event will be executed.</p>
<hr>
