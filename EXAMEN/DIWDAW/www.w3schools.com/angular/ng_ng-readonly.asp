...
<h1>AngularJS <code class="w3-codespan">ng-readonly</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-readonly">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-readonly</code> directive sets the readonly attribute of a form 
field (input or textarea).</p>
<p>The form field will be readonly if the expression inside the <code class="w3-codespan">ng-readonly</code> 
attribute returns true.</p>
<p>The <code class="w3-codespan">ng-readonly</code> directive is necessary to be able to shift the 
value between <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>. In HTML, you cannot set 
the <code class="w3-codespan">readonly</code> attribute to <code class="w3-codespan">false</code> (the presence of the 
readonly attribute makes the element readonly, regardless of its value).</p>
<hr>
