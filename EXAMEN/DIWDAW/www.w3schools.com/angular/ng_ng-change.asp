...
<h1>AngularJS <code class="w3-codespan">ng-change</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-change">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-change</code> directive tells AngularJS what to do when the 
value of an HTML element changes.</p>
<p>The <code class="w3-codespan">ng-change</code> directive requires a <code class="w3-codespan">ng-model</code> 
directive to be present.</p>
<p>The <code class="w3-codespan">ng-change</code> directive from AngularJS will not override the element's original onchange event,
both the <code class="w3-codespan">ng-change</code> expression and the original onchange event will be executed.</p>
<p>The <code class="w3-codespan">ng-change</code> event is triggered at every change in the value. 
It will not wait until all changes are made, or when the input field loses 
focus.</p>
<p>The <code class="w3-codespan">ng-change</code> event is only triggered if there is a actual 
