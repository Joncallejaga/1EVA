...
<h1>AngularJS <code class="w3-codespan">ng-paste</code> Directive</h1>
...
<h3>Example</h3>
<p>Execute an expression when text is pasted into the the input field:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-paste">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-paste</code> directive tells AngularJS what to do when text is 
pasted into an HTML element.</p>
<p>The <code class="w3-codespan">ng-paste</code> directive from AngularJS will not override the element's original onpaste event,
