...
<html lang="en-US">
<head>
<title>Angular ng-required Directive</title>
<meta charset="utf-8">
...
<h1>AngularJS <code class="w3-codespan">ng-required</code> Directive</h1>
...
<h3>Example</h3>
<p>Make the input field required:</p>
<div class="w3-code notranslate htmlHigh">
  
    Required:<br>&lt;input type=&quot;checkbox&quot; ng-model=&quot;myVar&quot;&gt;<br><br>&lt;input name=&quot;myInput&quot; 
    ng-model=&quot;myInput&quot; ng-required=&quot;myVar&quot;&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-required">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-required</code> directive sets the required attribute of a form 
field (input or textarea).</p>
<p>The form field will be required if the expression inside the <code class="w3-codespan">ng-required</code> 
attribute returns true.</p>
<p>The <code class="w3-codespan">ng-required</code> directive is necessary to be able to shift the 
value between <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>. In HTML, you cannot set 
the <code class="w3-codespan">required</code> attribute to <code class="w3-codespan">false</code> (the presence of the 
required attribute makes the element required, regardless of its value).</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
    &lt;input ng-required=&quot;<em>expression</em>&quot;&gt;&lt;/input&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression that will set the required attribute if it returns true.</td>
    </tr>
  </table>
</div>
<hr>
