...
<h1>AngularJS <code class="w3-codespan">ng-submit</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-submit">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-submit</code> directive specifies a function to run when the 
form is submitted.</p>
<p>If the form does not have an <code class="w3-codespan">action</code> <code class="w3-codespan">ng-submit</code> will 
