...
<h1>AngularJS <code class="w3-codespan">ng-copy</code> Directive</h1>
...
<h3>Example</h3>
<p>Execute an expression when the text of the input field is being copied:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-copy">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-copy</code> directive tells AngularJS what to do when an HTML element 
is being copied.</p>
<p>The <code class="w3-codespan">ng-copy</code> directive from AngularJS will not override the element's original oncopy event,
both the <code class="w3-codespan">ng-copy</code> expression and the original oncopy event will be executed.</p>
<hr>
