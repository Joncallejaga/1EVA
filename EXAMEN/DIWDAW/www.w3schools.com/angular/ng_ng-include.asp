...
<h1>AngularJS <code class="w3-codespan">ng-include</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-include">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-include</code> directive includes HTML from an external file.</p>
<p>The included content will be included as childnodes of the specified element.</p>
<p>The value of the <code class="w3-codespan">ng-include</code> attribute can also be an expression, 
