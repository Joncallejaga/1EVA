...
<h1>AngularJS <code class="w3-codespan">ng-class-even</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-class-even">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-class-even</code> directive dynamically binds one or more CSS 
classes to an HTML element, but will take effect only on every other (even) 
appearance of the HTML element.</p>
<p>The <code class="w3-codespan">ng-class-even</code> directive will only work if it is used 
together with the <code class="w3-codespan">ng-repeat</code> directive.</p>
<p>The <code class="w3-codespan">ng-class-even</code> directive is perfect for styling items in a 
