...
<h1>AngularJS <code class="w3-codespan">ng-selected</code> Directive</h1>
...
<h3>Example</h3>
<p>Set the <code class="w3-codespan">selected</code> attribute to <em>true</em>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-selected">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-selected</code> directive sets the selected attribute of an 
&lt;option&gt; element in a &lt;select&gt; list.</p>
<p>The option will be selected if the expression inside the <code class="w3-codespan">ng-selected</code> 
attribute returns true.</p>
<p>The <code class="w3-codespan">ng-selected</code> directive is necessary to be able to shift the 
value between <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>. In HTML, you cannot set 
the <code class="w3-codespan">selected</code> attribute to <code class="w3-codespan">false</code> (the presence of the 
selected attribute makes the element selected, regardless of its value).</p>
<hr>
