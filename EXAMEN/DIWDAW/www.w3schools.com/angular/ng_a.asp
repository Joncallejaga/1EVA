...
<h1>AngularJS <code class="w3-codespan">a</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_a">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>AngularJS modifies the default behavior of the <code class="w3-codespan">&lt;a&gt;</code> element.</p>
<p>AngularJS prevents the page from reloading when a user clicks on an <code class="w3-codespan">&lt;a&gt;</code> 
element with an empty <code class="w3-codespan">href</code> attribute.</p>
<hr>
