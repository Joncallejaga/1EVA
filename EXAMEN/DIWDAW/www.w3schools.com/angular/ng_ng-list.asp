...
<h1>AngularJS <code class="w3-codespan">ng-list</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-list">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-list</code> directive converts a string into an array of 
strings, using a comma as the default separator.</p>
<p>The <code class="w3-codespan">ng-list</code> directive also converts the other way around, if you 
have a array of strings you wish to display in an input field as a string, then 
put the <code class="w3-codespan">ng-list</code> directive on the input field.</p>
<p>The value of the <code class="w3-codespan">ng-list</code> attribute defines the separator.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><i>separator</i></td>
    <td>Optional, defines the separator, default value is <code class="w3-codespan">&quot;<code class="w3-codespan">, &quot;</code></code></td>
    </tr>
  </table>
</div>
<hr>
