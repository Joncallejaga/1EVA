...
<h1>AngularJS <code class="w3-codespan">ng-cloak</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-cloak">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-cloak</code> directive prevents the document from showing unfinished AngularJS code while AngularJS is being loaded.</p>
...
code are executed. Use the <code class="w3-codespan">ng-cloak</code> directive to prevent this.</p>
<hr>
...
<p>The <code class="w3-codespan">ng-cloak</code> directive has no parameters.</p>
