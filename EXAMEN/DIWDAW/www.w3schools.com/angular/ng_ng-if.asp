...
<h1>AngularJS <code class="w3-codespan">ng-if</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-if">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-if</code> directive removes the HTML element if the expression evaluates to false.</p>
<p>If the if statement evaluates to true, a copy of the Element is added in the DOM.</p>
<p>The <code class="w3-codespan">ng-if</code> directive is different from the ng-hide, which hides the display of the element, where the ng-if directive completely removes the
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    false. If it returns true, a copy of the element will be inserted instead.</td>
    </tr>
  </table>
</div>
<hr>
