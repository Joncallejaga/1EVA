...
<h1>AngularJS <code class="w3-codespan">ng-srcset</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-srcset">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-srcset</code> directive overrides the original srcset attribute 
of an element.</p>
<p>The <code class="w3-codespan">ng-srcset</code> directive should be used instead of <code class="w3-codespan">srcset</code> 
if you have AngularJS code inside the srcset value.</p>
<p>The <code class="w3-codespan">ng-srcset</code> directive makes sure the image is not displayed wrong before AngularJS has evaluated the code.</p>
<hr>
