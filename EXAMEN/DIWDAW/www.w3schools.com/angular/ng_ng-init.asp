...
<h1>AngularJS <code class="w3-codespan">ng-init</code> Directive</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_ng-init">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ng-init</code> directive evaluates the given expression(s).</p>
<p>The <code class="w3-codespan">ng-init</code> directive can add some unnecessary logic into the scope, and you are 
recommended to do your evaluations in a controller instead, see the <code class="w3-codespan">
