...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS writing-mode property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">writing-mode</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_writing-mode">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>TThe <code class="w3-codespan">writing-mode</code> property specifies whether lines of text are laid out horizontally or vertically.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.writingMode=&quot;vertical-rl&quot;</td>
  </tr>
</table>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">writing-mode</td>
    <td>48.0</td>
    <td>12.0</td>
    <td>41.0</td>
    <td>11.0</td>
...
writing-mode: horizontal-tb|vertical-rl|vertical-lr;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>horizontal-tb</td>
    <td>Let the content flow horizontally from left to right, vertically from 
    top to bottom</td>
  </tr>
  <tr>
    <td>vertical-rl</td>
    <td>Let the content flow vertically from top to bottom, horizontally from 
    right to left</td>
  </tr>
  <tr>
    <td>vertical-lr</td>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css3_text_effects.asp">CCSS Text Effects</a></p>
<br>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_word-wrap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
