...
<p><strong>Note:</strong> The :out-of-range selector only works for input elements with min and/or max attributes!</p>
...
<p>*In Edge, the :out-of-range property also incorrectly selects input elements without min/max attributes.</p>
<hr>
<h2>CSS Syntax</h2>
