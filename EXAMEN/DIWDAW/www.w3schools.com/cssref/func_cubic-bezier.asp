<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS cubic-bezier() function</title>
<meta charset="utf-8">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_cubic-bezier">Try it Yourself &raquo;</a>
<br>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cubic-bezier() function defines a Cubic Bezier curve.</p>
<p>A Cubic Bezier curve is defined by four points P0, P1, P2, and P3. P0 and P3 
are the start and the end of the curve and, in CSS these points are fixed as the 
coordinates are ratios. P0 is (0, 0) and represents the initial time and the 
initial state, P3 is (1, 1) and represents the final time and the final state.</p>
<p>The cubic-bezier() function can be used with the
<a href="css3_pr_animation-timing-function.asp">animation-timing-function</a> 
property and the <a href="css3_pr_transition-timing-function.asp">
transition-timing-function</a> property.&nbsp;</p>
...
cubic-bezier(<em>x1,y1,x2,y2</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>x1,y1,x2,y2</em></td>
    <td>Required. Numeric values. x1 and x2 must be a number from 0 to 1</td>
  </tr>
  </table>
<hr>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>
