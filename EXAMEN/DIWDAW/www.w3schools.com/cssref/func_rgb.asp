<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS rgb() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">rgb()</span> Function</h1>
...
<div class="w3-code notranslate cssHigh">
 #p1 {background-color:rgb(255,0,0);} /* red */<br>#p2 {background-color:rgb(0,255,0);} /* green */<br>#p3 {background-color:rgb(0,0,255);} /* blue */</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_rgb">Try it Yourself &raquo;</a>
<br>
</div>
<hr>
...
<p>An RGB color value is specified with: rgb(red, green, blue). Each parameter 
defines the intensity of that color and can be an integer between 0 and 255 or a 
percentage value (from 0% to 100%).</p>
<p>For example, the rgb(0,0,255) value is rendered as blue, because the blue 
parameter is set to its highest value (255) and the others are set to 0.</p>
...
rgb(<em>red, green, blue</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>red</em></td>
    <td>Defines the intensity of red as an integer between 0 and 255, or as a percentage value between 0% and 100%</td>
  </tr>
  <tr>
    <td><em>green</em></td>
    <td>Defines the intensity of green as an integer between 0 and 255, or as a percentage value between 0% and 100%</td>
  </tr>
  <tr>
    <td><em>blue</em></td>
    <td>Defines the intensity of blue as an integer between 0 and 255, or as a percentage value between 0% and 100%</td>
  </tr>
  </table>
<hr>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>
