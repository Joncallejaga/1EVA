<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS linear-gradient() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">linear-gradient()</span> Function</h1>
...
yellow, then to blue:</p>
<div class="w3-code notranslate cssHigh">
#grad {<br>
&nbsp; &nbsp; background-image: linear-gradient(red, yellow, blue);<br>
}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear">Try it Yourself &raquo;</a>
<br>
</div>
...
<p>The linear-gradient() function sets a linear gradient as the background 
image.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>direction</i></td>
    <td>Defines a starting point and a direction (or an angle) along with the gradient effect.</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>A linear gradient that starts from the left. It starts red, transitioning to blue:</p>
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: linear-gradient(to right, red , blue);<br>} </div>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: linear-gradient(to bottom right, red , blue);<br>} </div>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: linear-gradient(180deg, red, blue);<br>
 } </div>
...
<div class="w3-example">
<h3>Example</h3>
<p>A linear gradient with multiple color stops:</p>
<div class="w3-code notranslate cssHigh">
...
<div class="w3-example">
 <h3>Example</h3>
<p>A linear gradient with transparency:</p>
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: linear-gradient(to right, rgba(255,0,0,0), rgba(255,0,0,1));<br>} </div>
