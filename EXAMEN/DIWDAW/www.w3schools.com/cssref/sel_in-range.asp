...
<p><strong>Note:</strong> The :in-range selector only works for input elements with min and/or max attributes!</p>
...
<p>*In Edge, the :in-range property also incorrectly selects input elements without min/max attributes.</p>
<hr>
