<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS radial-gradient() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">radial-gradient()</span> Function</h1>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: radial-gradient(red, green, blue);<br>} </div>
...
<p>The radial-gradient() function sets a radial gradient as the background 
image.</p>

<p>A radial gradient is defined by its center.</p>
<p>To create a radial gradient you must define at least two color stops.</p>
...
background-image: radial-gradient(<em>shape size </em>at<em> position, start-color, ..., last-color</em>);
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>shape</i></td>
    <td>Defines the shape of the gradient. Possible values:
    <ul>
    <li>ellipse (default)</li>    
    <li>circle</li>
    </ul>
  </td>
  </tr>
  <tr>
    <td><em>size</em></td>
    <td>Defines the size of the gradient. Possible values: 
    <ul>
    <li>farthest-corner (default)</li>    
    <li>closest-side</li>
  ...
  <tr>
    ...
    <td>Defines the position of the gradient. Default is &quot;center&quot;</td>
  </tr>
  <tr>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: radial-gradient(red 5%, green 15%, blue 60%);<br>} </div>
...
<div class="w3-code notranslate cssHigh">
    #grad1 {<br>&nbsp; background-image: radial-gradient(closest-side at 60% 55%, blue, green, yellow, black);<br>}<br>
 <br>#grad2 {<br>
    &nbsp; background-image: radial-gradient(farthest-side at 60% 55%, blue, green, yellow, black);<br>} </div>
