...
<p><strong>Note:</strong> The <code class="w3-codespan">font-stretch</code> property 
will not work on just any font! It will only work if the font family has 
width-variant faces. The <code class="w3-codespan">font-stretch </code>property 
itself does not stretch a font.</p>
