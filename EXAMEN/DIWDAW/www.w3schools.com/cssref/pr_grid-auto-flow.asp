...
<div class="w3-code w3-border notranslate"><div>
  grid-auto-flow: 
  row|column|dense|row dense|column dense;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>dense</td>
    <td>Place items to fill any holes in the grid</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-flow&amp;preval=dense">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td>row dense</td>
    <td>Places items by filling each row, and fill any holes 
    in the grid</td>
  ...
  <tr>
    <td>column dense</td>
    <td>Places items by filling each column, and fill any 
