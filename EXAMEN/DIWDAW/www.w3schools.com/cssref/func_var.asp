<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS var() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">var()</span> Function</h1>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>First define a custom property named &quot;--main-bg-color&quot;, then use the var() 
function to insert the value of the custom property later in the style sheet:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_var">Try it Yourself &raquo;</a>
<br>
</div>
...
<p>The var() function is used to insert the value of a custom property instead 
of any part of a value of another property.</p>
...
<div class="w3-code w3-border notranslate"><div>
  var(<em>custom-property-name, value</em>)</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>custom-property-name</em></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use the var() function to insert several custom property values:</p>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_var2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css3_variables.asp">CSS Variables</a></p>
<hr>
