<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS repeating-radial-gradient() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">repeating-radial-gradient()</span> Function</h1>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp;&nbsp;&nbsp; background-image: repeating-radial-gradient(red, yellow 10%, green 15%);<br>} </div>
...
background-image: repeating-radial-gradient(<em>shape size </em>at<em> position, start-color, ..., last-color</em>);
</div></div>
