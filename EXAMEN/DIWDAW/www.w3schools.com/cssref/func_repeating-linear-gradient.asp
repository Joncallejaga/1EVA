<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS repeating-linear-gradient() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">repeating-linear-gradient()</span> Function</h1>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>A repeating linear gradient:</p>
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp;&nbsp;&nbsp; background-image: repeating-linear-gradient(red, yellow 10%, green 20%);<br>} </div>
...
<p>The numbers in the table specify the first browser version that fully supports the function.</p>
...
background-image: repeating-linear-gradient(<em>angle</em> | to <em>side-or-corner</em>, <em>color-stop1</em>, <em>
color-stop2, ...</em>);
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>angle</em></td>
    <td>Defines an angle of direction for the gradient. From 0deg to 360deg. Default is 180deg.</td>
  </tr>
  <tr>
    <td><em>side-or-corner</em></td>
    <td>Defines the position of the starting-point of the gradient line. It consists of two keywords: the first one indicates the horizontal side, left or right, and the second one the vertical side, top or bottom. The order is not relevant and each of the keyword is optional.</td>
  </tr>
  <tr>
    <td><em>color-stop1, color-stop2,...</em></td>
    <td>Color stops are the colors you want to render smooth transitions among. This value consists of a color value, followed by an optional stop position (a percentage between 0% and 100% or a length along the gradient axis).</td>
  </tr>
  </table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Different repeating linear gradients:</p>
<div class="w3-code notranslate cssHigh">
    #grad1 {<br>&nbsp;&nbsp;&nbsp; background-image: repeating-linear-gradient(45deg, 
    red, blue 7%, green 10%);<br>}<br><br>#grad2 {<br>&nbsp;&nbsp;&nbsp; background-image: repeating-linear-gradient(190deg, red, blue 7%, 
    green 10%);<br>}<br><br>#grad3 {<br>&nbsp;&nbsp;&nbsp; background-image: 
    repeating-linear-gradient(90deg, red, blue 7%, green 10%);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_repeating2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css3_gradients.asp">CSS Gradients</a></p>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>
</div>
