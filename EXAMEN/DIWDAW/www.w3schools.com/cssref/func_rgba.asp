<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS rgba() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">rgba()</span> Function</h1>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Define different RGB colors with opacity (RGBA):</p>
<div class="w3-code notranslate cssHigh">
 #p1 {background-color:rgba(255,0,0,0.3);} /* red with opacity*/<br>#p2 {background-color:rgba(0,255,0,0.3);} /* green with opacity */<br>#p3 {background-color:rgba(0,0,255,0.3);} /* blue with opacity */</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_rgba">Try it Yourself &raquo;</a>
<br>
</div>
<hr>
...
- which specifies the opacity of the color.</p>
...
rgba(<em>red, green, blue, alpha</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>alpha</em></td>
    <td>Defines the opacity as a number between 0.0 (fully transparent) and 1.0 (fully opaque)</td>
  </tr>
  </table>
<hr>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>
