<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS hsl() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">hsl()</span> Function</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_hsl">Try it Yourself &raquo;</a>
<br>
</div>
<hr>
...
<p>HSL stands for hue, saturation, and lightness - and represents a 
cylindrical-coordinate representation of colors.</p>
...
hsl(<em>hue, saturation, lightness</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>hue</em></td>
    <td>Defines a degree on the color wheel (from 0 to 360) - 0 (or 360) is red, 120 is green, 240 is blue</td>
  </tr>
  <tr>
