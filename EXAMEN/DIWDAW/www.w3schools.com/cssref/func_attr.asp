<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS attr() function</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">attr()</span> Function</h1>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>The following example inserts the value of the href attribute in parenthesis after each link:</p>
<div class="w3-code notranslate cssHigh">
a:after {<br>&nbsp;&nbsp;&nbsp; content: &quot; (&quot; attr(href) &quot;)&quot;;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_attr">Try it Yourself &raquo;</a>
<br>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The attr() function returns the value of an attribute of the selected elements.</p>
...
attr(<em>attribute-name</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. The name of the attribute of the HTML element(s)</td>
  </tr>
  </table>
<hr>
<p><a href="css_functions.asp" class="w3-btn w3-white w3-border" title="CSS Functions Reference">&#10094; CSS Functions Reference</a></p>
