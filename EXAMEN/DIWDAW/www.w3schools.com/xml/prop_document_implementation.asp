...
<a target="_blank" href="tryit.asp?filename=try_dom_implementation" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The implementation property returns the DOMImplementation object that handles the document.</p>
<h2>Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate">
