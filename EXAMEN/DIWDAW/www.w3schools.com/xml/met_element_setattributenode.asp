...
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setAttributeNode() method adds a new attribute node.</p>
<p>If an attribute with that name already exists in the element, it is replaced by the new one. If the new 
