...
<p><a target="_blank" href="tryit.asp?filename=try_dom_nodelist_item">item() - Loop through the items in a node list</a></p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_getnameditem2">getNamedItem() - Change an item's value</a></p>
<hr>
