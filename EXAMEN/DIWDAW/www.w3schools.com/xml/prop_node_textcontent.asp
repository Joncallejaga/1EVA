...
<a target="_blank" href="tryit.asp?filename=try_dom_node_textcontent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The textContent property sets or returns the textual content of a node and its descendants.</p>
<p>On setting, any child nodes are removed and replaced by a single Text node containing the string this property is set to.</p>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_node_textcontent_set">
