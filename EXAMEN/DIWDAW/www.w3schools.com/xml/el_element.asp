...
<hr>
<a href="schema_elements_ref.asp" class="w3-btn w3-white w3-border" title="XML Schema Reference">&#10094; Complete XML Schema Reference</a>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    indicates that this element is not required to be qualified with the namespace prefix. &quot;qualified&quot; indicates that this element must be 
...
<h3>Example 3</h3>
<p>This example is quite equal to Example 2, but here we have chosen to use the 
