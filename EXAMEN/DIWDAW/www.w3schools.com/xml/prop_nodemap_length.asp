...
1</div>
<a target="_blank" href="tryit.asp?filename=try_dom_nodemap_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_length">length - Return the number of nodes in a node list</a></p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_length2">length - Loop through the nodes in a node list</a></p>
<hr>
