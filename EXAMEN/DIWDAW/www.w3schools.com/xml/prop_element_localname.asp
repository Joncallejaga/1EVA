...
<a target="_blank" href="tryit.asp?filename=try_dom_localname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>&nbsp;&nbsp;&nbsp; if (this.readyState == 4 && this.status == 200) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myFunction(this);<br>&nbsp;&nbsp;&nbsp; }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br><br>// 
...
<a target="_blank" href="tryit.asp?filename=try_dom_localname2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
