...
&nbsp;&nbsp;&nbsp; var x, i, xmlDoc, txt;<br>
&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>
&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>
&nbsp;&nbsp;&nbsp; x = xmlDoc.getElementsByTagName('book');<br>
&nbsp;&nbsp;&nbsp; for(i = 0; i &lt; x.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += x.item(i).attributes[0].isId + &quot;&lt;br&gt;&quot;;<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = txt;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_attr_isid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
