...
<a href="xsl_functions.asp#xsltfunctions" class="w3-btn w3-white w3-border" title="XSLT Function Reference">&#10094; XSLT Function Reference</a>
<hr>

<h2>Definition and Usage</h2>
<p>The function-available() function returns a Boolean value that indicates whether the 
function specified is supported by the XSLT processor.</p>
<p>You may test the XSLT functions and the inherited XPath functions.</p>
<hr>
