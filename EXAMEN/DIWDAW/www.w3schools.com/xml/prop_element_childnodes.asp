...
<a href="dom_element.asp" class="w3-btn w3-white w3-border" title="Element Object Reference">&#10094; Element Object</a>
<hr>
...
<a target="_blank" href="tryit.asp?filename=try_dom_getelementsbytagname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>&nbsp;&nbsp;&nbsp; if (this.readyState == 4 && this.status == 200) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myFunction(this);<br>&nbsp;&nbsp;&nbsp; }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
...
<a target="_blank" href="tryit.asp?filename=try_dom_childnodes_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a href="https://www.w3schools.com/xml/dom_mozilla_vs_ie.asp">DOM Browsers</a> chapter in our XML DOM 
Tutorial.</p>
<hr>
