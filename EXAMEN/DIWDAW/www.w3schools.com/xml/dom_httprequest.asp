...
<div class='w3-card-2 topnav notranslate' id='topnav'>
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a class="w3-bar-item w3-button" href='default.asp' title='XML Tutorial'>XML</a>
    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>
          <h3>XML</h3>
          <a class="w3-bar-item w3-button" href='default.asp'>Learn XML</a>
          <a class="w3-bar-item w3-button" href='ajax_intro.asp'>Learn XML AJAX</a>
          <a class="w3-bar-item w3-button" href="dom_intro.asp">Learn XML DOM</a>
          <a class="w3-bar-item w3-button" href='xml_dtd_intro.asp'>Learn XML DTD</a>
          <a class="w3-bar-item w3-button" href='schema_intro.asp'>Learn XML Schema</a>
          <a class="w3-bar-item w3-button" href='xsl_intro.asp'>Learn XSLT</a>
          <a class="w3-bar-item w3-button" href='xpath_intro.asp'>Learn XPath</a>
          <a class="w3-bar-item w3-button" href='xquery_intro.asp'>Learn XQuery</a>
        </div>
      </div>
      <br>
    </div>
    <div id='nav_references' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col m4'>
          ...
          <h3>XML</h3>
          <a class="w3-bar-item w3-button" href='dom_nodetype.asp'>XML Reference</a>
          <a class="w3-bar-item w3-button" href='dom_http.asp'>XML Http Reference</a>
          <a class="w3-bar-item w3-button" href='xsl_elementref.asp'>XSLT Reference</a>
          <a class="w3-bar-item w3-button" href='schema_elements_ref.asp'>XML Schema Reference</a>
        </div>
        <div class='w3-col m4'>
          <h3>JavaScript</h3>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m6'>
          ...
          <h3>XML</h3>
          <a class="w3-bar-item w3-button" href='xml_examples.asp' target='_top'>XML Examples</a>
          <a class="w3-bar-item w3-button" href='xsl_examples.asp' target='_top'>XSLT Examples</a>
          <a class="w3-bar-item w3-button" href='xpath_examples.asp' target='_top'>XPath Examples</a>
          <a class="w3-bar-item w3-button" href='schema_example.asp' target='_top'>XML Schema Examples</a>
...
<form action="dom_httprequest.asp"> 
...
<p>A common JavaScript syntax for using it looks much like this:</p>
...
xhttp.send();</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_xmlhttprequest" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The first line in the example above creates an XMLHttpRequest object:</p>
...
<p>The <strong>readyState</strong> property holds the status of the 
XMLHttpRequest.</p>
<p>The <strong>onreadystatechange</strong> event is triggered every time the readyState changes.</p>
<p>During a server request, the readyState changes from 0 to 4:</p>
...
<p>In the onreadystatechange property, specify a function to be executed when 
...
<p>The responseText property returns the response as a string.</p>
<p>If you want to use the response as a text string, use the responseText 
property:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;demo&quot;).innerHTML = xmlhttp.responseText;</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_xmlhttprequest_responsetext" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>The responseXML Property</h2>
<p>The responseXML property returns the response as an XML DOM object.</p>
<p>If you want to use the response as an XML DOM object, use the responseXML property:</p>
...
xmlhttp.send();<br>
document.getElementById(&quot;demo&quot;).innerHTML = xmlhttp.responseText;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_xmlhttprequest_asyncfalse">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>XML Parser</h2>
<p>All modern browsers have a built-in XML parser. </p>
<p>The XML Document Object Model (the XML DOM) contains a lot of methods to access 
and edit XML.</p>
<p>However, before an XML document can be accessed, it must be 
loaded into an XML DOM object.</p>
<p>An XML parser can read plain text and convert it into an XML DOM object.</p>
<hr>
...
&nbsp;&nbsp;&nbsp; xmlhttp = new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;);<br>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_xmlhttprequest_ie" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Old versions of Internet Explorer (IE5 and IE6) do not support the DOMParser object.</p>
<p>To handle IE5 and IE6,  
...
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_suggest">Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_database">Retrieve content from a database</a><br>
...
<a href="xml_examples.asp">XML Examples</a><br>
</div>
</div>
<div class="w3-col l3 m6 s12">
<div class="top10">
