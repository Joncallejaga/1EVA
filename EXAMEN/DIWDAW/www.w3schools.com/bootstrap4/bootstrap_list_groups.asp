...
<div class="list-group" style="margin:20px 0">
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action">Action item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-success">Success item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-secondary">Secondary item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-info">Info item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-warning">Warning item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-danger">Danger item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-primary">Primary item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-dark">Dark item</a>
    <a href="bootstrap_list_groups.asp#" class="list-group-item list-group-item-action list-group-item-light">Light item</a>
</div>
