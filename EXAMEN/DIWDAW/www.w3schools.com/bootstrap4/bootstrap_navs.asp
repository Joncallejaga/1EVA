...
<ul class="nav nav-tabs" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="bootstrap_navs.asp#home" role="tab">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="bootstrap_navs.asp#menu1" role="tab">Menu 1</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="bootstrap_navs.asp#menu2" role="tab">Menu 2</a>
  </li>
</ul>
...
<ul class="nav nav-pills" role="pillist">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="pill" href="bootstrap_navs.asp#home1" role="pill">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="pill" href="bootstrap_navs.asp#menu12" role="pill">Menu 1</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="pill" href="bootstrap_navs.asp#menu22" role="pill">Menu 2</a>
  </li>
</ul>
