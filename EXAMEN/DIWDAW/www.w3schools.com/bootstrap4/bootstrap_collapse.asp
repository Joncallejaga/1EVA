...
<div id="accordion" style="margin: 20px 0">
    <div class="card">
      <div class="card-header">
        <a data-toggle="collapse" data-parent="#accordion" href="bootstrap_collapse.asp#collapseOne" class="card-link">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" data-parent="#accordion" href="bootstrap_collapse.asp#collapseTwo">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" data-parent="#accordion" href="bootstrap_collapse.asp#collapseThree">
