...
<div class='w3-card-2 topnav notranslate' id='topnav'>
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a class="w3-bar-item w3-button" href='default.asp' title='JavaScript Tutorial'>JAVASCRIPT</a>
    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>  
          <h3>JavaScript</h3>
          <a class="w3-bar-item w3-button" href='default.asp'>Learn JavaScript</a>
          <a class="w3-bar-item w3-button" href='../jquery/default.asp'>Learn jQuery</a>
          <a class="w3-bar-item w3-button" href='../angular/default.asp'>Learn AngularJS</a>
          <a class="w3-bar-item w3-button" href="js_json_intro.asp">Learn JSON</a>
          <a class="w3-bar-item w3-button" href='js_ajax_intro.asp'>Learn AJAX</a>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m6'>
          <h3>JavaScript</h3>
          <a class="w3-bar-item w3-button" href='js_examples.asp' target='_top'>JavaScript Examples</a>
          <a class="w3-bar-item w3-button" href='js_exercises.asp'>JavaScript Exercises</a>
          <a class="w3-bar-item w3-button" href='js_dom_examples.asp' target='_top'>HTML DOM Examples</a>
          <a class="w3-bar-item w3-button" href='../jquery/jquery_examples.asp' target='_top'>jQuery Examples</a>
          <a class="w3-bar-item w3-button" href='../angular/angular_examples.asp' target='_top'>AngularJS Examples</a>
          <a class="w3-bar-item w3-button" href='js_ajax_examples.asp' target='_top'>AJAX Examples</a>
...
<a class="w3-left w3-btn" href="js_events_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_exercises.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Window Object</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_openwindow">Open a new window when clicking on a button</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_openallwindow">Open a new window and control its appearance</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_blur">Blur and Focus a new window</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_close">Close the new window</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_closed">Checks whether the new window has been closed or not</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_opener">Write some text to the source (parent) window</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_moveby">Move the new window relative to its current position</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_win_moveto">Move the new window to the specified position</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_print">Print the current page</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_dom_window_resizeby">Resize a window by the specified pixels</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_dom_window_resizeto">Resize a window to a specified size</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_dom_window_scrollby">Scroll the content by the specified number of pixels</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_dom_window_scrollto">Scroll the content to a specified position</a><br>
</p>
<p><a href="js_window.asp" class="w3-btn w3-margin-top">Window explained</a></p>
<hr>

<h2>Screen Object</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_width">The visitor's screen: Width</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_height">The visitor's screen: Height</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_availwidth">The visitor's screen: Available Width</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_availheight">The visitor's screen: Available Height</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_colordepth">The visitor's screen: Color Depth</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_screen_pixeldepth">The visitor's screen: Pixel Depth</a><br>
</p>
<p><a href="js_window_screen.asp" class="w3-btn w3-margin-top">Screen explained</a></p>
<hr>

<h2>Location Object</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_host">Return the hostname and port of the current URL</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_href">Return the entire URL of the current page</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_pathname">Return the path name of the current URL</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_protocol">Return the protocol portion of the current URL</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_assign">Load a new document</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_loc_replace">Replace the current document</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_breakout">Break out of a frame</a>
</p>
<p><a href="js_window_location.asp" class="w3-btn w3-margin-top">Location explained</a></p>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_history_length">Display the number of URLs in the history list</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_history_back">Create a back button on a page</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_history_forward">Create a forward button on a page</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_history_go">Load a specific URL from the history list</a>
</p>
<p><a href="js_window_history.asp" class="w3-btn w3-margin-top">History explained</a></p>
<hr>

<h2>Navigator Object</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_cookieenabled">Is cookies enabled in the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_appcodename">What is the name of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_product">What is the engine name of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_appversion">What is the version information of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_useragent">What is user agent information of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_platform">What is the platform of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_language">What is the language of the visitor's browser?</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_nav_javaenabled">Is Java enabled in the visitor's browser?</a><br>
</p>
<p><a href="js_window_navigator.asp" class="w3-btn w3-margin-top">Navigator explained</a></p>
<hr>

<h2>Popup Boxes</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_alert">Display an alert box</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_alert2">Demonstrate line breaks in an alert box</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_confirm">Display a confirm box</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_prompt">Display a prompt box</a></p>
<p><a href="js_popup.asp" class="w3-btn w3-margin-top">Popup explained</a></p>
<hr>

<h2>Timing</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_timing1">Simple timing</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_timing2">Another simple timing</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_timing_infinite">Timing event in an infinite loop</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_timing_stop">Timing event in an infinite loop - with a Stop button</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_timing_clock">A clock created with a timing event</a><br>
<a target="_blank" href="tryit.asp?filename=tryjs_setinterval">Set and stop a timer with setInterval() and clearInterval()</a>
<p><a href="js_timing.asp" class="w3-btn w3-margin-top">Timing explained</a></p>
<hr>

<h2>Cookies</h2>
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_cookie_username">Create a welcome cookie</a><br>
<p><a href="js_cookies.asp" class="w3-btn w3-margin-top">Cookies explained</a></p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_events_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_exercises.asp">Next &#10095;</a>
...
<a href="default.asp">JavaScript Tutorial</a><br>
...
<a href="js_examples.asp">JavaScript Examples</a><br>
