...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="js_bitwise.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_errors.asp">Next &#10095;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_search" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
6
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_regexp_string_search" target="_blank">Try it Yourself &raquo;</a></div>
<hr>
...
<div class="w3-code notranslate">
Visit W3Schools!</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_regexp_string_replace" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_i">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>g</td>
    <td>Perform a global match (find all matches rather than stopping after the first match)</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_g">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>m</td>
    <td>Perform multiline matching</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_m">Try it &raquo;</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a style="float:right" target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_abc">Try it &raquo;</a></td>
  <tr>
    <td>[0-9]</td>
    <td>Find any of the digits between the brackets</td>
    <td><a style="float:right" target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_0-9">Try it &raquo;</a></td>
    <tr>
    <td>(x|y)</td>
    <td>Find any of the alternatives separated with |</td>
    <td><a style="float:right" target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_xy">Try it &raquo;</a></td>
  </tr>
</table>
...
<tr>
    <td>\d</td>
    <td>Find a digit</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_d">Try it &raquo;</a></td>
</tr>
<tr>
    <td>\s</td>
    <td>Find a whitespace character</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_s">Try it &raquo;</a></td>
</tr>
<tr>
    <td>\b</td>
    <td>Find a match at the beginning or at the end of a word</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_b">Try it &raquo;</a></td>
</tr>
<tr>
    <td>\uxxxx</td>
    <td>Find the Unicode character specified by the hexadecimal number xxxx</td>
    <td><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_ux">Try it &raquo;</a></td>
</tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td style="float:right"><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_n1">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>n*</td>
    <td>Matches any string that contains zero or more occurrences of <em>n</em></td>
    <td style="float:right"><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_n2">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>n?</td>
    <td>Matches any string that contains zero or one occurrences of <em>n</em></td>
     <td style="float:right"><a target="_blank" class="w3-btn tryitbtn w3-padding-small" href="tryit.asp?filename=tryjs_regexp_n3">Try it &raquo;</a></td>
 </tr>
</table>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_test" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<p>It searches a string for a specified pattern, and returns the found text as 
an object. </p>
...
<div class="w3-code notranslate jsHigh">
 /e/.exec(&quot;The best things in life are free!&quot;);
  ...
  <a target="_blank" href="tryit.asp?filename=tryjs_regexp_exec" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
