...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="js_this.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="js_const.asp">Next &#10095;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_scope_global" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_scope_local" target="_blank">Try it Yourself &raquo;</a>
</div>
...
&nbsp;&nbsp;&nbsp; // Here x is 2<br>}<br>
// Here x is 2</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_es6_var" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_scope" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_global" target="_blank">Try it Yourself &raquo;</a>
</div>
...
&nbsp;<br>
  var x = 3;<br>
  <br>// Now x is 3</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_redeclare_var" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_redeclare" target="_blank">Try it Yourself &raquo;</a>
</div>
...
Hoisting</a>)<p>You can use a variable before it is declared:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_hoisting_var" target="_blank">Try it Yourself &raquo;</a>
</div>


<p>Variables defined with <strong>let</strong> are not hoisted to the top.<p>Using a <strong>let</strong> variable before it is declared will result in a 
ReferenceError.</p>
