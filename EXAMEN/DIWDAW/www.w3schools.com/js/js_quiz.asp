...
<a class="w3-left w3-btn" href="js_exercises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_exam.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Good luck!</p>
<p><button onclick="document.location='/quiztest/quiztest.asp?qtest=JavaScript'" class="w3-btn w3-orange w3-text-white" style="margin-top:10px;padding:17px;font-size:17px">Start the JavaScript Quiz &#10095;</button></p>
</div>
