...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="js_let.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="js_debugging.asp">Next &#10095;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_value" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_object" target="_blank">Try it Yourself &raquo;</a>
</div>
...
const car = {type:"Fiat", model:"500", color:"white"};<br>car = {type:"Volvo", model:"EX60", color:"red"};&nbsp;&nbsp;&nbsp; // 
  ERROR</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_object_assign" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_array" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_array_assign" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
Hoisting</a>)<p>You can use a <strong>var </strong>variable before it is declared:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  carName = &quot;Volvo&quot;;&nbsp;&nbsp;&nbsp; // You CAN use carName here<br>
  var carName;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_const_hoisting_var" target="_blank">Try it Yourself &raquo;</a>
</div>


<p>Variables defined with <strong>const</strong> are not hoisted to the top.<p>A <strong>const</strong> 
