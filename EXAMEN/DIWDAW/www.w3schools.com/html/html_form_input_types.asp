...
<div class='w3-card-2 topnav notranslate' id='topnav'>
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a class="w3-bar-item w3-button" href='default.asp' title='HTML Tutorial'>HTML</a>
    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        <div class='w3-col l3 m4'>
          <h3>HTML and CSS</h3>
          <a class="w3-bar-item w3-button" href='default.asp'>Learn HTML</a>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        <div class='w3-col l3 m6'>
          <h3>HTML/CSS</h3>
          <a class="w3-bar-item w3-button" href='html_examples.asp'>HTML Examples</a>
          <a class="w3-bar-item w3-button" href='html_exercises.asp'>HTML Exercises</a>
...
<img style="float:right;" src="https://www.w3schools.com/images/compatible_edge2020.gif" title="Internet Explorer" alt="Internet Explorer" width="20"
height="20">
...
<img style="float:right;" src="https://www.w3schools.com/images/compatible_edge2020.gif" title="Internet Explorer" alt="Internet Explorer" width="20" height="20">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;form&gt;<br>&nbsp;
...
<img style="float:right;" src="https://www.w3schools.com/images/incompatible_firefox2020.gif" title="Firefox" alt="Firefox" width="20" height="20">
<img style="float:right;" src="https://www.w3schools.com/images/incompatible_edge2020.gif" title="Internet Explorer" alt="Internet Explorer" width="20" height="20">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
    &lt;form&gt;<br>&nbsp;
...
<a href="html_examples.asp">HTML Examples</a><br>
