...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_submit">Try it Yourself &raquo;</a>
...
<p>This event can only be used on &lt;form&gt; elements.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_submit_trigger">Try it</a>  
</div>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_submit">Try it</a>  
</div>
</div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the submit event is triggered</td>
  </tr>
  </table>
  <hr>
