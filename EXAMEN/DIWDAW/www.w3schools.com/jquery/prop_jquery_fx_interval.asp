...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_prop_jq_fx_interval" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the animation firing rate in milliseconds. Default is 13 milliseconds</td>
  </tr>
  </table>
<hr>
