...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_appendto">Try it Yourself &raquo;</a>
</div>
<hr>
...
current position, and inserted at the end of the selected elements.</td>
  ...
  <tr>
    <td><i>selector</i></td>
    <td>Required. Specifies on which elements to append the content to</td>
  </tr>
  </table>
  <hr>
