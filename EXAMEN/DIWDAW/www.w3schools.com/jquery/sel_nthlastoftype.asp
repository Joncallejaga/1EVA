...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_sel_nthlastoftype">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>n</em></td>
    <td>The index of each child to match.<br><br>Must be a number. The first element has the index number 1.<br>
   </td>
  </tr>
  ...
  <tr>
    <td><em>formula</em></td>
    <td>Specifies which child element(s) to be selected with a formula (<em>an</em> + <em>b</em>). Example: p:nth-last-child(3n+2) selects each 3rd paragraph, starting at the last 2nd paragraph</td>
  </tr>
