...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_unbind">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p style="color:red">The unbind() method was deprecated in version 3.0. Use the
<a href="event_off.asp">off()</a> method instead.</p>
...
<table class="w3-table-all notranslate"> 
 ...
 If this is the only parameter specified, all functions bound to the specified event will be removed.</td>
    </tr>
  <tr>
    <td><em>function</em></td>
    <td>Optional. Specifies the name of the function to unbind from the specified event for the element</td>
  </tr>
   <tr>
