...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_clearqueue">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li><a href="eff_dequeue.asp">dequeue()</a> - Removes the next function from the queue, and then executes the function</li>
</ul>
