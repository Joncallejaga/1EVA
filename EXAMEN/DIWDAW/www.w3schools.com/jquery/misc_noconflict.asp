...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_misc_noconflict" target="_blank">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <td>Optional. A Boolean value that specifies whether or not to release jQuery's control of ALL jQuery variables (including &quot;jQuery&quot;)</td>
    </tr>
 </table>
<hr>
<p><a href="jquery_ref_misc.asp" class="w3-btn w3-white w3-border" title="jQuery Misc Methods">&#10094; jQuery Misc Methods</a></p>
