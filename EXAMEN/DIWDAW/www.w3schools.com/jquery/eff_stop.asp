...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_stop">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>stopAll</em></td>
    <td>Optional. A Boolean value specifying whether or not to stop the queued animations as well. Default is false</td>
  </tr>
  <tr>
    <td><em>goToEnd</em></td>
    <td>Optional. A Boolean value specifying whether or not to complete all animations immediately. Default is false</td>
  </tr>
</table>
<hr>
