...
<p><span class="deprecated">The size() method was deprecated in version 1.8 and removed 
 in jQuery version 3.0. Use the <a href="prop_length.asp">length</a> property instead.</span></p>
