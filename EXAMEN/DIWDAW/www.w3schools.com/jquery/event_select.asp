...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_select_ref">Try it Yourself &raquo;</a>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_select_trigger">Try it</a>  
</div>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_select">Try it</a>  
</div>
</div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the select event is triggered</td>
  </tr>
  </table>
  <hr>
