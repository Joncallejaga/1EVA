...
<div class="w3-code notranslate jsHigh">
    ...
    $(&quot;p&quot;).bind(&quot;click&quot;, function(){<br>&nbsp;&nbsp;&nbsp; alert(&quot;The paragraph was clicked.&quot;);<br>});</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_bind_ref" target="_blank">Try it Yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p style="color:red">The bind() method was deprecated in version 3.0. Use the
<a href="event_on.asp">on()</a> method instead.</p>
...
<table class="w3-table-all notranslate"> 
 ...
 <br> Multiple event values are separated by space. Must be a valid event.</td>
  ...
  <tr>
    <td><em>map</em></td>
    <td>Specifies an event map (<em>{event:function, event:function, ...})</em> containing one or more events to attach to the elements, and functions to run when the event occurs</td>
  </tr>
</table>
<hr>
