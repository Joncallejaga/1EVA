...
<div class="w3-code notranslate jsHigh">
    ...
    if ($(&quot;p&quot;).parent().is(&quot;div&quot;)) {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Parent of p is div&quot;); <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_is">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies a selector expression, element or a jQuery object to match the current set of elements against. Returns true if there is at least one match from the given argument, and false if not.<br></td>
  </tr>
  <tr>
 ...
 <ul>
    ...
    <li>element - the current element (the &quot;this&quot; selector can also be  used)</li>
 </ul>
  </td>
  </tr>
</table>
