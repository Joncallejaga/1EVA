...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_toggle">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
 ...
 <b>Tip:</b> More easing functions are available in external plugins
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the toggle() method is completed<p>To learn more about callback, visit our <a href="jquery_callback.asp">jQuery Callback chapter</a></p>
  </td>
  </tr>
 </table>
  <hr>
