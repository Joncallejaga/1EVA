...
<a class="w3-left w3-btn" href="jquery_traversing_ancestors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jquery_traversing_siblings.asp">Next &#10095;</a>
</div>
<hr>
...
<p>This method only traverses a single level down the DOM tree.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_children">Try it Yourself &raquo;</a>
</div>
<p>You can also use an optional parameter to filter the search for children.</p>
<p>The following example returns all &lt;p&gt; elements with the class name &quot;first&quot;, that 
are direct children of &lt;div&gt;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;div&quot;).children(&quot;p.first&quot;);<br>}); </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_children2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_find">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_find2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Test Yourself with Exercises!</h2>
<p>
<a class="w3-btn" href="exercise.asp?filename=exercise_descendants1" target="_blank">Exercise 1 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_descendants2" target="_blank">Exercise 2 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_descendants3" target="_blank">Exercise 3 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_descendants4" target="_blank">Exercise 4 &raquo;</a>
</p>
<hr>
