...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_add">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>element</i></td>
    <td>Required. Specifies a selector expression, a jQuery object, one or more elements or an HTML snippet to be added to an existing group of elements</td>
  </tr>
  <tr>
    <td><em>context</em>&nbsp;</td>
    <td>Optional. Specifies the point in the document at which the selector expression should begin matching</td>
  </tr>
</table>
<br>
