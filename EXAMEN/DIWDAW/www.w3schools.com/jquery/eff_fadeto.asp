...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_fadeto">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
  ...
  <tr>
    <td><em>opacity</em></td>
    <td>Required. Specifies the opacity to fade to. Must be a number between 0.00 and 1.00</td>
  </tr>
  <tr>
    <td><em>easing</em></td>
 ...
 <b>Tip:</b> More easing functions are available in external plugins
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the fadeTo() method is completed
