...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_delegate" target="_blank">Try it Yourself &raquo;</a>
...
<p style="color:red">The delegate() method was deprecated in version 3.0. Use the
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies one or more child elements to attach the event handler to</td>
    </tr>
    <tr>
    <td><em>event</em></td>
