...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_misc_get" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td><i>index</i></td>
    <td>Optional. Specifies which of the matching elements to get (by index number)</td>
    </tr>
 </table>
<hr>
<p><a href="jquery_ref_misc.asp" class="w3-btn w3-white w3-border" title="jQuery Misc Methods">&#10094; jQuery Misc Methods</a></p>
