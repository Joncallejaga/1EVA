...
<div class="w3-code notranslate jsHigh">
    ...
    $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;li.start&quot;).prevUntil(&quot;li.stop&quot;).css({&quot;color&quot;: &quot;red&quot;, &quot;border&quot;: &quot;2px solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_prevuntil">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Related methods:</p>
<ul>
  <li><a href="traversing_prev.asp">prev()</a> -&nbsp; returns the previous sibling element of the selected element</li>
  <li><a href="traversing_prevall.asp">prevAll()</a> -&nbsp; returns all previous sibling elements of the selected element</li>
</ul>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>stop</i></td>
    <td>Optional. A selector expression, element or jQuery object indicating where to stop the search for previous matching siblings elements</td>
  </tr>
    <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the search for sibling elements between the <em>selector</em> and <em>stop</em><br><br><strong>Note:</strong> To return multiple siblings, separate each expression with a comma.</td>
  </tr>
</table>
<br>
