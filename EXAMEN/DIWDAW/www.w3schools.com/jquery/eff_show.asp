...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_show_hide">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the show effect. Default value is 400 milliseconds<p>Possible values:</p>
 <ul>
    <li>milliseconds </li>
    <li>&quot;slow&quot;</li>
    <li>&quot;fast&quot;</li>
