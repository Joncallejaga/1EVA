...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_removeattr">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies one or more attributes to remove. To remove several attributes, separate the attribute names with a space</td>
  </tr>
  </table>
<hr>
