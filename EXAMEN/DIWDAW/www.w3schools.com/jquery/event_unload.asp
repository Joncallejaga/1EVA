...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_unload">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the unload event is triggered</td>
  </tr>
  </table>
<hr>
<p><a href="jquery_ref_events.asp" class="w3-btn w3-white w3-border" title="jQuery Event Methods">&#10094; jQuery Event Methods</a></p>
