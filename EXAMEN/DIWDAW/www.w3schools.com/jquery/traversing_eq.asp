...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_eq">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required. Specifies the index of the element. Can either be a positive or negative number.<br><br><strong>Note:</strong> Using a negative number will start the index count from the end of the selected elements, instead of the beginning.</td>
  </tr>
</table>
<br>
