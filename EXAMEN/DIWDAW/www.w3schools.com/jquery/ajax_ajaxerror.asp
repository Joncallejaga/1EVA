...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_ajax_ajaxerror" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul><li><em>event</em> - contains the event object</li>
    ...
    <li><em>exc</em> - contains the JavaScript exception, if one occurred</li></ul>
    </td>
  </tr>
</table>
<hr>
