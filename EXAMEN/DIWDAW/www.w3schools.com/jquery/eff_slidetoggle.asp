...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_slidetoggle">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
 ...
 <b>Tip:</b> More easing functions are available in external plugins
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the slideToggle() method is completed
