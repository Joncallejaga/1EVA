...
<a class="w3-left w3-btn" href="jquery_animate.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jquery_callback.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The jQuery stop() method is used to stop animations or effects before it is finished.</p>
<button class="flip w3-btn w3-blue">Start sliding</button>
<button style="margin-left:15px;" id="stop" class="w3-btn w3-red">Stop sliding</button>
<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_stop_slide">Try it Yourself &raquo;</a>
</div>
<hr>
