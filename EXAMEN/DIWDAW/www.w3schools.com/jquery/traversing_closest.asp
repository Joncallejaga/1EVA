...
<div class="w3-code notranslate jsHigh">
    ...
    $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;span&quot;).closest(&quot;ul&quot;).css({&quot;color&quot;: &quot;red&quot;, &quot;border&quot;: &quot;2px solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="w3-code notranslate ancestors">body (great-great-grandparent)
  <div class="ex">div (great-grandparent)
    <ul> ul (second ancestor - second grandparent) <ul> ul (first ancestor -  first grandparent) <li> li (direct parent)&nbsp; <span class="ex">span</span> &nbsp;</ul>
&nbsp;</ul>  
  </div>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_closest">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li>Travels up the DOM tree and returns the first (single) ancestor that matches the passed expression</li>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Required. Specifies a selector expression, element or jQuery object to narrow down the ancestor search</td>
  </tr>
<tr>
    <td><i>context</i></td>
