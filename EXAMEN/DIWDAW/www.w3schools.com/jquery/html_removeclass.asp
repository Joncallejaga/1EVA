...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_removeclass">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies one or more class names to remove. To remove several classes, separate the class names with space<br><br>
