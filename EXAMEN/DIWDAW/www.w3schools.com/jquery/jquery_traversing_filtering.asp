...
<a class="w3-left w3-btn" href="jquery_traversing_siblings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jquery_ajax_intro.asp">Next &#10095;</a>
</div>
<hr>
<h2>The first(), last(), eq(), filter() and not() Methods</h2>
<p>The most basic filtering methods are first(), last() and eq(), which 
...
that match, or do not match, a certain criteria. </p>
<hr>
<h2>jQuery first() Method</h2>
<p>The first() method returns the first element of the specified elements.</p>
<p>The following example selects the first &lt;div&gt; 
element:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;div&quot;).first();<br>}); </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_first">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>jQuery last() Method</h2>
<p>The last() method returns the last element of the specified elements.</p>
<p>The following example selects the last &lt;div&gt; 
element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;div&quot;).last();<br>}); </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_last">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eq">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_filter">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_not">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Test Yourself with Exercises!</h2>
<p>
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering1" target="_blank">Exercise 1 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering2" target="_blank">Exercise 2 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering3" target="_blank">Exercise 3 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering4" target="_blank">Exercise 4 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering5" target="_blank">Exercise 5 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_filtering6" target="_blank">Exercise 6 &raquo;</a>
</p>
<hr>
