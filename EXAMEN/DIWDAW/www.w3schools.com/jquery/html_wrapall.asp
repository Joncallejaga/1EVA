...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_wrapall">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies what HTML element(s) to wrap around the selected elements<p>Possible values:</p>
 <ul>
    <li>HTML elements</li>
