...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_remove">Try it Yourself &raquo;</a>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_remove2">
Remove all &lt;p&gt; elements with class="test"</a><br>
Using the optional parameter to filter the elements to be removed.</p>
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_remove3">
