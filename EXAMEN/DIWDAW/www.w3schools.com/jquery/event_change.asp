...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_change_ref">Try it Yourself &raquo;</a>
</div>
<hr>
...
$(<i>selector</i>).change() <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_change_trigger">Try it</a></div>
</div>
<p>Attach a function to the change event:</p>
<div class="w3-code w3-border notranslate"><div>
  
    $(<i>selector</i>).change(<i>function</i>) <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjquery_event_change">Try it</a></div>
</div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the change event occurs for the selected elements</td>
  </tr>
  </table>
  <br>
