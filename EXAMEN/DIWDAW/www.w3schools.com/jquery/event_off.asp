...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_off" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>event</em></td>
    <td>Required. Specifies one or more events or namespaces to remove from the selected element(s).<br>
 <br>
 Multiple event values are separated by a space. Must be a valid event</td>
    </tr>
    <tr>
    <td><em>selector</em></td>
    <td>Optional. A selector which should match the one originally passed to the on() method when attaching event handlers</td>
    </tr>
   <tr>
  ...
  <tr>
    <td><em>map</em></td>
    <td>Specifies an event map (<em>{event:function, event:function, ...})</em> containing one or more event to attach to the elements, and functions to run when the events occur</td>
  </tr>
  </table>
<hr>
