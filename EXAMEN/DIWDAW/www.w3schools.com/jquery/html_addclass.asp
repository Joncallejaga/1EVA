...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_addclass">Try it Yourself &raquo;</a>
</div>
<hr>
...
$(<i>selector</i>).addClass(<i>classname</i>,function(<i>index,currentclass</i>))</div></div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <td>function(<i>index,currentclass</i>)</td>
    ...
    <li><i>currentclass</i> - Returns the current class name of the selected  element</li>
 </ul>
  </td>
  </tr>
</table>
