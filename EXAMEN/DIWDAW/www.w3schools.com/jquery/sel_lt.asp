...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_sel_lt">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
 ...
 Elements with an index lesser than the specified number is selected.</td>
  </tr>
  </table>
<hr>
<p><a href="jquery_ref_selectors.asp" class="w3-btn w3-white w3-border" title="jQuery Selectors">&#10094; jQuery Selectors</a></p>
