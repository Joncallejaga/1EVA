...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_slideup_slidedown">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the slide effect. Default value is 400 milliseconds<p>Possible values:</p>
 <ul>
    <li>milliseconds</li>
    <li>&quot;slow&quot;</li>
    <li>&quot;fast&quot;</li>
  ...
  <tr>
    <td><em>easing</em></td>
    <td>Optional. Specifies the speed of the element in different points of the animation. Default value is &quot;swing&quot;<p>Possible values:</p>
 <ul>
 ...
 <b>Tip:</b> More easing functions are available in external plugins.
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the slideDown() method is completed
