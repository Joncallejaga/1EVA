...
<a class="w3-left w3-btn" href="jquery_traversing_filtering.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jquery_ajax_load.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>jQuery AJAX Example</h3>
<div class="w3-code notranslate">
<div id="div1"><h2>Let jQuery AJAX Change This Text</h2></div>
<button id="btn1" type="button">Get External Content</button>
</div>
<a target="_blank" href="tryit.asp?filename=tryjquery_ajax_load" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
Facebook tabs.</p>
<p>You can learn more about AJAX in our <a href="../xml/ajax_intro.asp">AJAX tutorial</a>.<br>
</p>
<hr>
...
<p><b>Without jQuery, AJAX coding can be a bit tricky!</b><br><br>
...
for us, so that we can write AJAX functionality with only one single line of code.</p>
</div>
