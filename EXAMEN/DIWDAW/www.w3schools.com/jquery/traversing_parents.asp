...
<p><a href="jquery_ref_traversing.asp" class="w3-btn w3-white w3-border" title="jQuery HTML Methods">&#10094; jQuery Traversing Methods</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return all ancestor elements of &lt;span&gt;:</p>
<div class="w3-code notranslate jsHigh">
    $(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;span&quot;).parents().css({&quot;color&quot;: &quot;red&quot;, &quot;border&quot;: &quot;2px solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_parents">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li>Travels up the DOM tree and returns all ancestors that matches the passed expression</li>
...
<ul>
  ...
  <li>Travels up the DOM tree and returns the first ancestor that matches the passed expression</li>
  <li>The returned jQuery object contains zero or one element</li>
</ul>
<p><strong>Other related methods:</strong></p>
<ul>
  <li><a href="traversing_parent.asp">parent()</a> - returns the direct parent element of the selected element</li>
  <li><a href="traversing_parentsuntil.asp">parentsUntil()</a> - returns all ancestor elements between two given arguments</li>
</ul>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the search for ancestors<br><br><strong>Note:</strong> To return multiple ancestors, separate each expression with a comma.</td>
  </tr>
</table>
<br>
...
<hr>
<p><a href="jquery_ref_traversing.asp" class="w3-btn w3-white w3-border" title="jQuery HTML Methods">&#10094; jQuery 
