...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_html_set">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the new content for the selected elements (can contain HTML tags)</td>
  </tr>
   <tr>
