...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_trigger" target="_blank">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
 ...
 Can be a custom event, or any of the standard events
  ...
  <tr>
    ...
    <td>Optional. Additional parameters to pass on to the event handler.<br>
