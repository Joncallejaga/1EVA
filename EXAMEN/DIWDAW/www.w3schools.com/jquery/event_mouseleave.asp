...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_mouseenter_mouseleave">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseleave event is triggered</td>
  </tr>
  </table>
  <hr>
