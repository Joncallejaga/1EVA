...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
  ...
  <tr>
    <td><em>easing</em></td>
    <td>Optional. Specifies the speed of the element in different points of the effect. Default value is &quot;swing&quot;<p>Possible values:</p>
 <ul>
 ...
 <b>Tip:</b> More easing functions are available in external plugins
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the fadeToggle() method is completed
