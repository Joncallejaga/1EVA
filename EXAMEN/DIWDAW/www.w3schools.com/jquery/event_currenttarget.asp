...
<div class="w3-code notranslate jsHigh">
    $(&quot;h1, h2, p&quot;).click(function(event){<br>&nbsp;&nbsp;&nbsp; alert(event.currentTarget === this);<br>});   
</div>
<a target="_blank" href="tryit.asp?filename=tryjquery_event_currenttarget2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
