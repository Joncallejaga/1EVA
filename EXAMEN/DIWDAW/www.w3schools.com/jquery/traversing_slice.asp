...
<div class="w3-code notranslate jsHigh">
    ...
    $(&quot;p&quot;).slice(2)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_slice">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>start</i></td>
    <td>Required. Specifies where to start the selection of elements. The index numbers start at 0.<br><br><strong>Note:</strong> Using a negative number will select elements from the end of the selected elements, instead of the beginning.</td>
  </tr>
  <tr>
    <td><i>stop</i></td>
    <td>Optional. Specifies where to end the selection of elements. If omitted, the selection continues until the end of the set. The index numbers start at 0.<br><br><strong>Note:</strong> Using a negative number will select elements from the end of the selected elements, instead of the beginning.</td>
  </tr>
</table>
<br>
