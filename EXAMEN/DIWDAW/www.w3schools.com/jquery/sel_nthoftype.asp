...
<div class="w3-code notranslate jsHigh">
    ...
    $(&quot;p:nth-of-type(3)&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_sel_nthoftype">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>formula</em></td>
    <td>Specifies which child element(s) to be selected with a formula (<em>an</em> + <em>b</em>). <br>Example: p:nth-of-type(3n+2) selects each 3rd paragraph, starting at the 2nd paragraph</td>
  </tr>
