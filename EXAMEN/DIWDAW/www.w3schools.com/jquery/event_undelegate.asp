...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_event_undelegate" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p style="color:red">The undelegate() method was deprecated in version 3.0. Use the
<a href="event_off.asp">on()</a> method instead.</p>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>event</em></td>
    <td>Optional. Specifies one or more event types to remove handler functions from</td>
    </tr>
  <tr>
