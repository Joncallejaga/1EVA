...
<p><a href="jquery_ref_ajax.asp" class="w3-btn w3-white w3-border" title="jQuery AJAX Methods">&#10094; jQuery AJAX Methods</a></p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_ajax_ajax" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td>async</td>
    <td>A Boolean value indicating whether the request should be handled asynchronous or not. Default is true</td>
    </tr>
  <tr>
  ...
  <tr>
    <td>cache</td>
    <td>A Boolean value indicating whether the browser should cache the requested pages. Default is true</td>
    </tr>
  <tr>
  ...
  <tr>
    <td>global</td>
    <td>A Boolean value specifying whether or not to trigger global AJAX event handles for the request. Default is true</td>
    </tr>
  <tr>
    <td>ifModified</td>
    <td>A Boolean value specifying whether a request is only successful if the response has changed since the last request. Default is: false.</td>
    </tr>
  <tr>
    <td>jsonp</td>
  ...
  <tr>
    <td>processData</td>
    <td>A Boolean value specifying whether or not data sent with the request should be transformed into a query string. Default is true</td>
    </tr>
  <tr>
    <td>scriptCharset</td>
  ...
  <tr>
    <td>traditional</td>
    <td>A Boolean value specifying whether or not to use the traditional style of param serialization</td>
    </tr>
  <tr>
    <td>type</td>
...
<p>
<a href="tryit.asp?filename=tryjquery_ajax_ajax_async" target="_blank">Make an asynchronous AJAX request</a><br>
