...
<div class="w3-code notranslate jsHigh">
    ...
    $(&quot;p&quot;).not(&quot;.intro&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_traversing_not">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>criteria</i></td>
    <td>Optional. Specifies a selector expression, a jQuery object or one or more elements to be removed from a group of selected elements.<br><br>
 <strong>Tip:</strong> To specify multiple criteria, use comma.</td>
  </tr>
<tr>
    <td>function(<em>index</em>)</td>
    <td>Optional. Specifies a function to run for each element in a group. If it returns true, the element is removed. Otherwise, the element is kept.<ul>
