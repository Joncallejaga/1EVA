...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjquery_eff_fadeout_fadein">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the fading effect. Default value is 400 milliseconds<p>Possible values:</p>
 ...
 <b>Tip:</b> More easing functions are available in external plugins
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the fadeOut() method is completed
