...
<html lang="en-US">
<head>
<title>MS Access Year() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Year()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the year part of a specified date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Year(#05/17/2017#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_year&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Year() function returns the year part of a given date.</p>
<p>This function returns an integer between 100 and 9999.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the year part of today's date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Year(Date());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_year2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the year part of the &quot;BirthDay&quot; column in &quot;Employees&quot;:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Year(BirthDate) FROM Employees;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_year3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
