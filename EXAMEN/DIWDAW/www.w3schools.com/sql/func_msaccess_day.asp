...
<html lang="en-US">
<head>
<title>MS Access Day() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Day()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the day of the month for the date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Day(#05/17/2017#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_day&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Day() function returns the day of the month for a given date.</p>
<p>This function returns an integer between 1 and 31.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the day of the month for today's date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Day(Date());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_day2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the day of the month for the &quot;BirthDay&quot; column in &quot;Employees&quot;:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Day(BirthDate) FROM Employees;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_day3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
