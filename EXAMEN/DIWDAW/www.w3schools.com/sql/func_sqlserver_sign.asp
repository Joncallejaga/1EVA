...
<html lang="en-US">
<head>
<title>SQL Server SIGN() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">SIGN()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT SIGN(255.5);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sign" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The SIGN() function returns the sign of a number.</p>
<p>This function will return one of the following:</p>
<ul>
  <li>If number &gt; 0, it returns 1</li>
  <li>If number = 0, it returns 0</li>
  <li>If number &lt; 0, it returns -1</li>
</ul>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  SIGN(<em>number</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The number to return the sign for</td>
  </tr>
</table>
...
<div class="w3-code notranslate sqlHigh">
SELECT SIGN(-12); </div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sign2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
