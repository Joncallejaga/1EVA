...
<html lang="en-US">
<head>
<title>SQL Server ATN2() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ATN2()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the arc tangent of two values:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ATN2(0.50, 1);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_atn2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ATN2() function returns the arc tangent of two numbers.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>a, b</em></td>
    <td>Required. Two numeric values to calculate the arc tangent of</td>
  </tr>
</table>
...
<p>Return the arc tangent of two values:</p>
<div class="w3-code notranslate sqlHigh">
SELECT ATN2(-0.8, 2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_atn22" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
