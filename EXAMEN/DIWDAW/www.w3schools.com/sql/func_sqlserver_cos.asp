...
<html lang="en-US">
<head>
<title>SQL Server COS() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">COS()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT COS(2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cos" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
SELECT COS(PI());</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cos2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
