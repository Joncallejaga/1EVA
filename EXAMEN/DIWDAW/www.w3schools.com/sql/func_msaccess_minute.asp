...
<html lang="en-US">
<head>
<title>MS Access Minute() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Minute()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the minute part of a specified time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Minute(#14:48:23#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_minute&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Minute() function returns the minute part of a time/datetime.</p>
<p>This function returns an integer between 0 and 59.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Minute(<em>time</em>)</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the minute part of the current time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Minute(Now());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_minute2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the minute part of a specified datetime:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Minute(#24/10/2016 11:18:34 PM#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_minute3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
