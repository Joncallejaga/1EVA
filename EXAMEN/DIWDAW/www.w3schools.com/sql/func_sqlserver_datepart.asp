...
<div class="w3-code notranslate sqlHigh">
  SELECT DATEPART(year, '2017/08/25') AS DatePartInt;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datepart" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The DATEPART() function returns a specified part of a date.</p>
<p>This function returns the result as an integer value.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  DATEPART(<em>interval</em>, <em>date</em>)</div>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATEPART(yy, '2017/08/25') AS DatePartInt;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datepart2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>

<div class="w3-example">
<h3>Example</h3>
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATEPART(month, '2017/08/25') AS DatePartInt;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datepart3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATEPART(hour, '2017/08/25 08:36') AS DatePartInt;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datepart4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATEPART(minute, '2017/08/25 08:36') AS DatePartInt;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datepart5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
