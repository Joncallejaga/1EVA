...
<html lang="en-US">
<head>
<title>SQL Server DAY() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">DAY()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT DAY('2017/08/25') AS DayOfMonth;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_day" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The DAY() function returns the day of the month (from 1 to 31) for a specified date.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>date</em></td>
    <td>Required. The date to return the day of the month from</td>
  </tr>
  </table>
...
<p>Return the day of the month for a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DAY('2017/08/13 09:08') AS DayOfMonth;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_day2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
