...
<html lang="en-US">
<head>
<title>SQL Server REPLICATE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">REPLICATE()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT REPLICATE('SQL Tutorial', 5);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_replicate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The REPLICATE() function repeats a string a specified number of times.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
REPLICATE(<em>string, integer</em>)</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Repeat the text in CustomerName two times:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT REPLICATE(CustomerName, 2)<br>FROM Customers;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_replicate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
