...
<html lang="en-US">
<head>
<title>MS Access Min() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Min()</span> Function</h1>
...
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_min&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Min() function returns the minimum value in a set of values.</p>
<p><strong>Note:</strong> See also the <a href="func_msaccess_max.asp">Max()</a> function.</p>
