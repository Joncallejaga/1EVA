...
<html lang="en-US">
<head>
<title>SQL Server CAST() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">CAST()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Convert a value to an int datatype:</p>
<div class="w3-code notranslate sqlHigh">
SELECT CAST(25.65 AS int);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cast" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The CAST() function converts a value (of any type) into a specified datatype.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_sqlserver_convert.asp">
CONVERT()</a> function.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
CAST(<i>expression</i> 
  AS <i>datatype(length)</i>)</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Convert a value to a varchar datatype:</p>
<div class="w3-code notranslate sqlHigh">
SELECT CAST(25.65 AS varchar);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cast2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>

<div class="w3-example">
<h3>Example</h3>
<p>Convert a value to a datetime datatype:</p>
<div class="w3-code notranslate sqlHigh">
SELECT CAST('2017-08-25' AS datetime);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cast3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
