...
<html lang="en-US">
<head>
<title>MS Access IsNumeric() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">IsNumeric()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check whether the expression is a valid number:</p>
<div class="w3-code notranslate sqlHigh">
SELECT IsNumeric(1030);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnumeric&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The IsNumeric() function checks whether an expression is a valid number.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return TRUE if the expression is a valid number, otherwise FALSE:</p>
<div class="w3-code notranslate sqlHigh">
SELECT IsNumeric(&quot;Hello&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnumeric2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
SELECT IsNumeric(&quot;1030&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnumeric3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
