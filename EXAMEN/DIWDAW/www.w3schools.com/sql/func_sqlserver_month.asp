...
<html lang="en-US">
<head>
<title>SQL Server MONTH() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">MONTH()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT MONTH('2017/08/25') AS Month;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_month" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The MONTH() function returns the month part for a specified date (a number from 1 to 12).</p>
...
<p>Return the month part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT MONTH('2017/05/25 09:08') AS Month;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_month2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
