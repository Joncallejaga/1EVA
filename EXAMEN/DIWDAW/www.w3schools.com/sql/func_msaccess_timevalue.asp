...
<html lang="en-US">
<head>
<title>MS Access TimeValue() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">TimeValue()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return a time based on the given string:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT TimeValue(&quot;17:15:38&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_timevalue&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The TimeValue() function returns a time based on a string.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  TimeValue(<em>string</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. A string that represents a time (from 0:00:00 to 
    23:59:59)</td>
  </tr>
  </table>
...
<p>Return a time based on the given string:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT TimeValue(&quot;5:15:38 PM&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_timevalue2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
