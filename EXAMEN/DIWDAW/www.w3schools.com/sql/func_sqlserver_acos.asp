...
<html lang="en-US">
<head>
<title>SQL Server ACOS() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ACOS()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the arc cosine of a number:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ACOS(0.25);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_acos" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ACOS() function returns the arc cosine of a number.</p>
<p>The specified number must be between -1 to 1, otherwise 
this function returns NULL.&nbsp;</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  ACOS(<em>number</em>)</div>
...
<div class="w3-code notranslate sqlHigh">
SELECT ACOS(-0.8);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_acos2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
