...
<html lang="en-US">
<head>
<title>MS Access LCase() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">LCase()</span> Function</h1>
...
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_lcase&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The LCase() function converts a string to lower-case.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_msaccess_ucase.asp">
UCase()</a> function.</p>
