...
<html lang="en-US">
<head>
<title>MS Access Trim() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Trim()</span> Function</h1>
...
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_trim&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Trim() function removes both leading and trailing spaces from a string.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Trim(<em>string</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to strip both leading and trailing spaces from</td>
  </tr>
  </table>
