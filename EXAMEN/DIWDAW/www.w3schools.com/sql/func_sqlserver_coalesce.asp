...
<html lang="en-US">
<head>
<title>SQL Server COALESCE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">COALESCE()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  COALESCE(NULL, NULL, NULL, 'W3Schools.com', NULL, 'Example.com');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_coalesce" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The COALESCE() function returns the first non-null value in a list.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  COALESCE(<em>val1</em>, <em>
  val2</em>, <em>....</em>, <em>val_n</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>val1, val2, val_n</em></td>
    <td>Required. The values to test</td>
  </tr>
  </table>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  COALESCE(NULL, 1, 2, 'W3Schools.com');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_coalesce2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
