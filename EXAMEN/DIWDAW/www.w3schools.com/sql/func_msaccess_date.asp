...
<html lang="en-US">
<head>
<title>MS Access Date() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Date()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the current system date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT CustomerName, Date() AS CurrentDate<br>FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_date&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
