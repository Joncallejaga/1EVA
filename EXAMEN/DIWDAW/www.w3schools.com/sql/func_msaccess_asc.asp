...
<html lang="en-US">
<head>
<title>MS Access Asc() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Asc()</span> Function</h1>
...
<div class="w3-code notranslate sqlHigh">
 SELECT Asc(CustomerName) AS NumCodeOfFirstChar<br>FROM Customers; </div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_asc&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Asc() function returns the ASCII value for the specific character.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Asc(<em>character</em>)</div>
