...
<html lang="en-US">
<head>
<title>SQL Server REVERSE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">REVERSE()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT REVERSE('SQL Tutorial');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_reverse" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The REVERSE() function reverses a string and returns the result.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
REVERSE(<em>string</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>&nbsp;Required. The string to reverse</td>
  </tr>
  </table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Reverse the text in CustomerName:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT REVERSE(CustomerName)<br>FROM Customers;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_reverse2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
