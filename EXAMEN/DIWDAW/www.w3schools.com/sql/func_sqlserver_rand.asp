...
<html lang="en-US">
<head>
<title>SQL Server RAND() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">RAND()</span> Function</h1>
<p>
...
SELECT RAND();</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_rand" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The RAND() function returns a random number between 0 (inclusive) and 1 (exclusive).</p>
...
<div class="w3-code notranslate sqlHigh">
SELECT RAND(6);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_rand2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_rand3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_rand4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
