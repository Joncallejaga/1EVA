...
<html lang="en-US">
<head>
<title>SQL Server STR() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">STR()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return a number as a string:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT STR(185);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_str" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The STR() function returns a number as a string.</p>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  STR(<em>number</em>, <em>length</em>, <em>decimals</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The number to convert to a string</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. The length of the returning string. Default value is 10</td>
  </tr>
  <tr>
    <td><em>decimals</em></td>
    <td>Optional. The number of decimals to display in the returning string. Default value is 0</td>
  </tr>
  </table>
...
<p>Return a number as a string:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT STR(185.5);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_str2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return a number as a string:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT STR(185.476, 6, 2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_str3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
