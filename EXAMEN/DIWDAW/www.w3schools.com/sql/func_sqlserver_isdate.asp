...
<html lang="en-US">
<head>
<title>SQL Server ISDATE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ISDATE()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check if the expression is a valid date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISDATE('2017-08-25');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isdate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ISDATE() function checks an expression and returns 1 if it is a valid date, otherwise 
0.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The expression to test</td>
  </tr>
</table>
...
<p>Check if the expression is a valid date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISDATE('2017');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isdate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Check if the expression is a valid date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISDATE('Hello world!');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isdate3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
