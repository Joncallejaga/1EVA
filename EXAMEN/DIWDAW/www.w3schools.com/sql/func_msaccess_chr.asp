...
<html lang="en-US">
<head>
<title>MS Access Chr() Function</title>
<meta charset="utf-8">
...
<h1>MS Access C<span class="color_h1">hr()</span> Function</h1>
...
SELECT Chr(65) AS CodeToCharacter;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_chr&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Chr() function returns the character for the specified ASCII number code.</p>
