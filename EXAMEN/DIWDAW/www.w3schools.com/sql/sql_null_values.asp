...
<p>The IS NULL operator is used to test for 
...
<p>The IS NOT NULL operator is used to test for 
non-empty values (NOT NULL values).</p>

<div class="w3-panel w3-note">
<p>The following SQL lists all customers with a value in the &quot;Address&quot; 
field:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  ...
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_is_not_null" target="_blank">Try it Yourself &raquo;</a>
</div>
