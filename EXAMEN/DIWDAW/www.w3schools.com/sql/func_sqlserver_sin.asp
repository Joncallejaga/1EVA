...
<html lang="en-US">
<head>
<title>SQL Server SIN() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">SIN()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT SIN(2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sin" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
SELECT SIN(-1);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sin2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
