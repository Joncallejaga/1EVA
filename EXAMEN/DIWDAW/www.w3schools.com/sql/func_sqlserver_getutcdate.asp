...
<html lang="en-US">
<head>
<title>SQL Server GETUTCDATE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">GETUTCDATE()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  GETUTCDATE();</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_getutcdate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The GETDATE() function returns the current database system UTC date and time, in a 
