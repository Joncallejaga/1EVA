...
<html lang="en-US">
<head>
<title>SQL Server COT() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">COT()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT COT(6);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cot" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
SELECT COT(-2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_cot2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
