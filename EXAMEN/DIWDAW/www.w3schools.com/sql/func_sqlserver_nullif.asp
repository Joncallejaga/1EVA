...
<html lang="en-US">
<head>
<title>SQL Server NULLIF() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">NULLIF()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Compare two expressions:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT NULLIF(25, 25);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_nullif" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The NULLIF() function returns NULL if two expressions are equal, otherwise it 
returns the first expression.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  NULLIF(<em>expr1</em>, <em>expr2</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>expr1, expr2</em></td>
    <td>Required. The two expressions to be compared </td>
  </tr>
</table>
...
<p>Compare two expressions:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT NULLIF('Hello', 'Hello');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_nullif2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Compare two expressions:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT NULLIF('Hello', 'world');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_nullif3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Compare two expressions:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT NULLIF('2017-08-25', '2017-08-25');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_nullif4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
