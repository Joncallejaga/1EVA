...
<html lang="en-US">
<head>
<title>SQL Server CURRENT_TIMESTAMP Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">CURRENT_TIMESTAMP</span> Function</h1>
<p>
...
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_curr_timestamp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The CURRENT_TIMESTAMP function returns the current date and time, in a 
'YYYY-MM-DD hh:mm:ss.mmm' format.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_sqlserver_getdate.asp">GETDATE()</a> function.</p>
