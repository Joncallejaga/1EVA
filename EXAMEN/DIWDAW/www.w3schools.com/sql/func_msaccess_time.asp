...
<html lang="en-US">
<head>
<title>MS Access Time() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Time()</span> Function</h1>
...
<div class="w3-code notranslate sqlHigh">
  SELECT CustomerName, 
  Time() AS CurrentTime<br>FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_time&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
