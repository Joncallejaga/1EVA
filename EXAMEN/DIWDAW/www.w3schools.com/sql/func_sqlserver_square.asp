...
<html lang="en-US">
<head>
<title>SQL Server SQUARE() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">SQUARE()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT SQUARE(64);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_square" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The SQUARE() function returns the square of a number.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  SQUARE(<em>number</em>)</div>
...
<p>Return the square of a number:</p>
<div class="w3-code notranslate sqlHigh">
SELECT SQUARE(13);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_square2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
