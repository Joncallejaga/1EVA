...
<html lang="en-US">
<head>
<title>MS Access DateAdd() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">DateAdd()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Add two years to a specified date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DateAdd("yyyy", 2, #22/11/2017#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_dateadd&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The DateAdd() function adds a time/date interval to a date and then returns 
the date.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>date</em></td>
    <td>Required. The date to which the interval should be added</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add one year to the current system date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DateAdd("yyyy", 1, Date());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_dateadd2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Add 6 months to the employees' birth date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT LastName, DateAdd("m", 6, BirthDate) FROM Employees;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_dateadd3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
