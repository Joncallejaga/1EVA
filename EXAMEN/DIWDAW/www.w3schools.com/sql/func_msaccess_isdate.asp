...
<html lang="en-US">
<head>
<title>MS Access IsDate() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">IsDate()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check whether the expression can be converted to a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  IsDate(Now());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isdate&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The IsDate() function checks whether an expression can be converted to a 
date.</p>
<p>This function returns a Boolean value. TRUE (-1) indicates that the expression is a valid date, 
and FALSE (0) indicates that the expression is not a valid date.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  IsDate(<em>expression</em>)</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return TRUE if the expression is a valid date, otherwise FALSE:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT
  IsDate(&quot;Hello&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isdate2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
  SELECT
  IsDate(&quot;August 25, 2017&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isdate3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return TRUE if the expression is a valid date, otherwise FALSE:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT IsDate(#25/8/2017#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isdate4&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
