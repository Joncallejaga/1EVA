...
<html lang="en-US">
<head>
<title>MS Access Cos() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Cos()</span> Function</h1>
...
SELECT Cos(5) AS CosNum;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_cos&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
