...
<html lang="en-US">
<head>
<title>SQL Server PI() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">PI()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT PI();</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_pi" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The PI() function returns the value of PI.</p>
<p><strong>Note:</strong> Also look at the <a href="func_sqlserver_degrees.asp">DEGREES()</a> and 
<a href="func_sqlserver_radians.asp">RADIANS()</a> functions.</p>
...
<hr>
<p><a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
</div>
