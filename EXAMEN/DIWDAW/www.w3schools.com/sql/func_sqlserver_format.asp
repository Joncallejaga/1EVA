...
<html lang="en-US">
<head>
<title>SQL Server FORMAT() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">FORMAT()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  FORMAT('10/01/2018', 'MMMM DD, yyyy');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_format" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FORMAT() function formats a value with the specified format 
(and an optional culture in SQL Server 2017).</p>
<p>Use the FORMAT() function for formatting of date/time and number 
values as strings. For general data type conversions, use
<a href="func_sqlserver_cast.asp">CAST()</a> or
<a href="func_sqlserver_convert.asp">CONVERT()</a>.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. The value to be formatted</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. The format pattern</td>
  </tr>
  <tr>
    <td><em>culture</em></td>
    <td>Optional. Specifies a culture (from SQL Server 2017)</td>
  </tr>
  </table>
...
<tr>
 <th style="width:23%">Works in:</th>
  <td>SQL Server (starting with 2012), Azure SQL Database</td>
</tr>
</table>
<hr>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  FORMAT('123456789', '##-##-#####');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_format2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
