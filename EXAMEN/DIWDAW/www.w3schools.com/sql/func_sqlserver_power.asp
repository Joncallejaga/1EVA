...
<html lang="en-US">
<head>
<title>SQL Server POWER() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">POWER()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return 4 raised to the second power:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT POWER(4, 2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_power" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The POWER() function returns the value of a number raised to the power of another number.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  POWER(<em>a</em>, <em>b</em>)</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return 8 raised to the third power:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT POWER(8, 3);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_power2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
