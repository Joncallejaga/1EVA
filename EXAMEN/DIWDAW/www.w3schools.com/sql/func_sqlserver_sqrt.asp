...
<html lang="en-US">
<head>
<title>SQL Server SQRT() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">SQRT()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT SQRT(64);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sqrt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The SQRT() function returns the square of a number.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  SQRT(<em>number</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A positive number to calculate the square of</td>
  </tr>
  </table>
...
<div class="w3-code notranslate sqlHigh">
SELECT SQRT(13);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_sqrt2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
