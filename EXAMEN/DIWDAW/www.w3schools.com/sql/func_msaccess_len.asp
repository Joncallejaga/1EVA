...
<html lang="en-US">
<head>
<title>MS Access Len() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Len()</span> Function</h1>
...
<div class="w3-code notranslate sqlHigh">
  SELECT Len("SQL Tutorial") AS LengthOfString;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_len&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>string/varname</em></td>
    <td>Required. The string or variable name to return the length for</td>
  </tr>
  </table>
...
<div class="w3-code notranslate sqlHigh">
  SELECT Len(CustomerName) AS LengthOfString<br>FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_len2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
