...
<html lang="en-US">
<head>
<title>MS Access IsNull() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">IsNull()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check whether the expression is a Null value:</p>
<div class="w3-code notranslate sqlHigh">
SELECT IsNull(null);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnull&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The IsNull() function checks whether an expression contains Null (no data).</p>
<p>This function returns a Boolean value. TRUE (-1) indicates that the 
expression is a Null value, and FALSE (0) indicates that the expression is not a 
Null value.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return TRUE if the expression is a null value, otherwise FALSE:</p>
<div class="w3-code notranslate sqlHigh">
SELECT IsNull(&quot;Hello&quot;);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnull2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
SELECT IsNull(0);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_isnull3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
