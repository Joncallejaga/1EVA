...
<html lang="en-US">
<head>
<title>SQL Server ISNUMERIC() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ISNUMERIC()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Tests whether the expression is numeric:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISNUMERIC(4567);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isnumeric" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ISNUMERIC() function tests whether an expression is numeric.</p>
<p>This function returns 1 if the expression is numeric, otherwise it returns 0.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  ISNUMERIC(<em>expression</em>)</div>
...
<div class="w3-code notranslate sqlHigh">
  SELECT ISNUMERIC('4567');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isnumeric2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Tests whether the expression is numeric:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISNUMERIC('Hello world!');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isnumeric3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Tests whether the expression is numeric:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISNUMERIC(20*3);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isnumeric4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Tests whether the expression is numeric:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ISNUMERIC('2017-08-25');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_isnumeric5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
