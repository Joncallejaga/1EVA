...
<html lang="en-US">
<head>
<title>MS Access RTrim() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">RTrim()</span> Function</h1>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  RTrim("SQL Tutorial&nbsp;&nbsp;&nbsp; ") AS RightTrimmedString;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_rtrim&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The RTrim() function removes trailing spaces from a string.</p>
<p><strong>Note:</strong> See also the <a href="func_msaccess_ltrim.asp">LTrim()</a> function.</p>
