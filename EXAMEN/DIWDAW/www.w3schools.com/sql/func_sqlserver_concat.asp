...
<html lang="en-US">
<head>
<title>SQL Server CONCAT() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">CONCAT()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  CONCAT('W3Schools', '.com');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_concat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The CONCAT() function adds two or more strings together.</p>
<p><strong>Note:</strong> See also <a href="func_sqlserver_concat_with_plus.asp">
...
<div class="w3-code w3-border notranslate">
  ...
  string2</em>, <em>....</em>, <em>string_n</em>)</div>
...
<tr>
 <th style="width:23%">Works in:</th>
  <td>SQL Server (starting with 2012), Azure SQL Database, Azure SQL Data 
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  CONCAT('SQL', ' is', ' fun!'); </div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_concat2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  CONCAT('SQL', ' ', 'is', ' ', 'fun!');</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_concat3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
