...
<html lang="en-US">
<head>
<title>SQL Server DATENAME() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">DATENAME()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATENAME(year, '2017/08/25') AS DatePartString;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datename" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The DATENAME() function returns a specified part of a date.</p>
<p>This function returns the result as a string value.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  DATENAME(<em>interval</em>, <em>date</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>date</em></td>
    <td>Required. The date to use</td>
  </tr>
  </table>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATENAME(yy, '2017/08/25') AS DatePartString;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datename2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>

<div class="w3-example">
<h3>Example</h3>
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATENAME(month, '2017/08/25') AS DatePartString;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datename3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATENAME(hour, '2017/08/25 08:36') AS DatePartString;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datename4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Return a specified part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT DATENAME(minute, '2017/08/25 08:36') AS DatePartString;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_datename5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
