...
<html lang="en-US">
<head>
<title>MS Access Fix() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Fix()</span> Function</h1>
...
SELECT Fix(756.43) AS FixNum;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_fix&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Fix() function returns the integer part of a number.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Fix(<em>number</em>)</div>
...
<div class="w3-code notranslate sqlHigh">
  SELECT Fix(Price) AS FixNum FROM Products; </div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_fix2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
