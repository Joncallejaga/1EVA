...
<html lang="en-US">
<head>
<title>MS Access Hour() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Hour()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the hour for a specified time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Hour(#14:48:23#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_hour&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Hour() function returns the hour part of a time/datetime.</p>
<p>This function returns an integer between 0 and 23.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the hour for the current time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Hour(Now());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_hour2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the hour for a specified datetime:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Hour(#24/10/2016 11:18:34 PM#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_hour3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
