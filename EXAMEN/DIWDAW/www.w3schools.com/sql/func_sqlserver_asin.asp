...
<html lang="en-US">
<head>
<title>SQL Server ASIN() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ASIN()</span> Function</h1>
<p>
<a class="w3-btn w3-white w3-border" href="sql_ref_sqlserver.asp" title="MySQL Functions">
&#10094; SQL Server Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the arc sine of a number:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT ASIN(0.25);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_asin" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
SELECT ASIN(-0.8);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_asin2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
