...
<html lang="en-US">
<head>
<title>MS Access Str() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Str()</span> Function</h1>
...
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Str(42) AS ConvertToString;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_str&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
