...
<h3>Example</h3>
<p>Format a numeric expression to percent:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT Format(0.5, "Percent") AS FormattedNum; </div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_format_number&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Format() function formats a numeric value with the specified format.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. The numeric value to format</td>
  </tr>
  <tr>
    <td><em>format</em></td>
...
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_format_number2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
