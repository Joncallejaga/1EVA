...
<h1>SQL Server <span class="color_h1">ABS()</span> Function</h1>
<p>
...
SELECT Abs(-243.5) AS AbsNum;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_abs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
