...
<html lang="en-US">
<head>
<title>MS Access Second() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Second()</span> Function</h1>
<p><a href="sql_ref_msaccess.asp" class="w3-btn w3-white w3-border" title="MS Access Functions">&#10094; MS Access Functions</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the seconds part of a specified time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Second(#14:48:23#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_second&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Second() function returns the seconds part of a time/datetime.</p>
<p>This function returns an integer between 0 and 59.&nbsp;</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Second(<em>time</em>)</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>time</em></td>
    <td>Required. A numeric or string expression that can represent a valid 
    time/datetime</td>
  </tr>
  </table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the seconds part of the current time:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Second(Now());</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_second2&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the seconds part of a specified datetime:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT 
  Second(#24/10/2016 11:18:34 PM#);</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_second3&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
