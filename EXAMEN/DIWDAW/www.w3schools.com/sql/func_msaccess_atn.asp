...
<html lang="en-US">
<head>
<title>MS Access Atn() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Atn()</span> Function</h1>
...
SELECT Atn(5) AS AtnNum;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_atn&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Atn() function returns the arc tangent of a number.</p>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate">
  Atn(<em>number</em>)</div>
