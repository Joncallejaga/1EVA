...
<html lang="en-US">
<head>
<title>SQL Server EXP() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">EXP()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT EXP(1);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_exp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The EXP() function returns e raised to the power of a specified number.</p>
<p>The constant e (2.718281...), is the base of natural logarithms.</p>
<p><strong>Note:</strong> See also the <a href="func_sqlserver_log.asp">LOG()</a> function.</p>
...
<div class="w3-code notranslate sqlHigh">
SELECT EXP(2);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_exp2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
