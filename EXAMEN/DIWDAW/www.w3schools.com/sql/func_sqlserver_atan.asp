...
<html lang="en-US">
<head>
<title>SQL Server ATAN() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">ATAN()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT ATAN(2.5);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_atan" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ATAN() function returns the arc tangent of a number.</p>
...
<p>Return the arc tangent of a number:</p>
<div class="w3-code notranslate sqlHigh">
SELECT ATAN(-45.01);</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_atan2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
