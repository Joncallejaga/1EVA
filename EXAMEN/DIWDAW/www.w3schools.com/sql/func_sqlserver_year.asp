...
<html lang="en-US">
<head>
<title>SQL Server YEAR() Function</title>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">YEAR()</span> Function</h1>
<p>
...
<div class="w3-code notranslate sqlHigh">
  SELECT YEAR('2017/08/25') AS Year;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_year" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The YEAR() function returns the year part for a specified date.</p>
...
<p>Return the year part of a date:</p>
<div class="w3-code notranslate sqlHigh">
  SELECT YEAR('1998/05/25 09:08') AS Year;</div>
<a target="_blank" href="trysqlserver.asp?filename=trysql_func_sqlserver_year2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
