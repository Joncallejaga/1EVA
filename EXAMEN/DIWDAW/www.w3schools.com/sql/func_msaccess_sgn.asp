...
<html lang="en-US">
<head>
<title>MS Access Sgn() Function</title>
<meta charset="utf-8">
...
<h1>MS Access <span class="color_h1">Sgn()</span> Function</h1>
...
SELECT Sgn(243.5) AS SgnNum;</div>
<a target="_blank" href="trysql.asp?filename=trysql_func_ms_sgn&amp;ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Sgn() function returns the sign of a number.</p>
