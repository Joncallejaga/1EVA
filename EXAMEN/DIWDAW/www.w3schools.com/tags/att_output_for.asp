...
<p><a href="tag_output.asp" class="w3-btn w3-white w3-border" title="HTML output Tag Reference">&#10094; HTML &lt;output&gt; tag</a></p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies a space separated list of ids of one or more elements that  specifies the relationship between the result of the calculation, and  the elements used in the calculation</td>
  </tr>
</table>
<hr>
<a href="tag_output.asp" class="w3-btn w3-white w3-border" title="HTML output Tag Reference">&#10094; HTML &lt;output&gt; tag</a>
</div>
