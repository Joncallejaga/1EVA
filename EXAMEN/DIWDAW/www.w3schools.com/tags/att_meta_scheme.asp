...
<a target="_blank" href="tryit.asp?filename=tryhtml_meta_scheme" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Defines the format (or points to an URI that contains the information) of the value inside the content attribute</td>
  </tr>
  </table>
<hr>
