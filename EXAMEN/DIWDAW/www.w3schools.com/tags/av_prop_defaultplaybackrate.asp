...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_defaultplaybackrate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Indicates the default playback speed of the audio/video.<br>Example values:<ul><li>1.0 is normal speed</li>
