...
<html lang="en-US">
<head>
<title>HTML a ping Attribute</title>
<meta charset="utf-8">
...
<h1>HTML &lt;a&gt; <span class="color_h1">ping</span> Attribute</h1>
<p><a href="tag_a.asp" class="w3-btn w3-white w3-border" title="HTML a Tag Reference">&#10094; HTML &lt;a&gt; tag</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>When the user clicks on the w3schools.com/html link, notify w3schools.com/trackpings:</p>
...
<p>The ping attribute specifies a list of URLs to be notified if the user follows the hyperlink.</p>
<p>When the user clicks on the hyperlink, the ping attribute will send a short HTTP POST request to the specified URL.</p>
<p>This attribute is useful for monitoring/tracking.</p>
<hr>
...
<p>The ping attribute is new for the &lt;a&gt; tag in HTML5.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the URL to be notified if the user follows the hyperlink.  Must be a space separated list of one or more valid URLs</td>
  </tr>
</table>
<hr>
