...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>Specifies the number of columns a cell should span. <b>Note:</b> colspan=&quot;0&quot; tells the browser to span the cell to the last column of the column group (colgroup)</td>
  </tr>
  </table>
<hr>
