...
<p><a href="tag_link.asp" class="w3-btn w3-white w3-border" title="HTML link Tag Reference">&#10094; HTML &lt;link&gt; tag</a></p>
...
<table class="w3-table-all notranslate" id="table1"> 
  ...
  <tr>
    <td>alternate</td>
    <td>Provides a link to an alternate version of the document (i.e. print page, translated or mirror).<br>
 Example: &lt;link rel=&quot;alternate&quot; type=&quot;application/atom+xml&quot; title=&quot;W3Schools News&quot; href=&quot;/blog/news/atom&quot;&gt;</td>
  </tr>
  <tr>
    <td>author</td>
    <td>Provides a link to the author of the document</td>
    </tr>
  <tr>
    <td>dns-prefetch</td>
    <td>Specifies that the browser should preemptively perform DNS resolution for the target resource's origin</td>
    </tr>
  <tr>
    <td>help</td>
    <td>Provides a link to a help document. Example: &lt;link rel=&quot;help&quot; href=&quot;/help/&quot;&gt;</td>
    </tr>
  <tr>
    <td>icon</td>
    <td>Imports an icon to represent the document.<br>Example: &lt;link rel=&quot;icon&quot; href=&quot;/favicon.ico&quot; type=&quot;image/x-icon&quot;&gt;</td>
    </tr>
  <tr>
    <td>license</td>
    <td>Provides a link to copyright information for the document</td>
    </tr>
  <tr>
    <td>next</td>
    <td>Provides a link to the next document in the series</td>
    </tr>
  <tr>
    <td>pingback</td>
    <td>Provides the address of the pingback server that handles pingbacks to the current document</td>
    </tr>
  <tr>
    <td>preconnect</td>
    <td>Specifies that the browser should preemptively connect to the target resource's origin.</td>
    </tr>
  <tr>
    <td>prefetch</td>
    <td>Specifies that the browser should preemptively fetch and cache the target resource as it is likely to be required for a follow-up navigation</td>
    </tr>
  <tr>
    <td>preload</td>
    <td>Specifies that the browser agent must preemptively fetch and cache the target resource for current navigation according to the destination given by the &quot;as&quot; attribute (and the priority associated with that destination).</td>
    </tr>
  <tr>
    <td>prev</td>
    <td>Indicates that the document is a part of a series, and that the previous document in the series is the referenced document</td>
    </tr>
  <tr>
    <td>search</td>
    <td>Provides a link to a resource that can be used to search through the current document and its related pages.</td>
    </tr>
  <tr>
    <td>stylesheet</td>
...
<hr>
<a href="tag_link.asp" class="w3-btn w3-white w3-border" title="HTML link Tag Reference">&#10094; HTML &lt;link&gt; tag</a>
</div>
