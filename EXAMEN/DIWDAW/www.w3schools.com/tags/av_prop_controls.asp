...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_controls" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the controls are displayed, otherwise it returns false</td>
</tr>
<tr>
