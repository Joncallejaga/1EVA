...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>A file extension starting with the STOP character, e.g: .gif, .jpg, .png, .doc</td>
  </tr>
  <tr>
    <td>audio/*</td>
...
<hr>
<a href="tag_input.asp" class="w3-btn w3-white w3-border" title="HTML input Tag Reference">&#10094; HTML &lt;input&gt; tag</a></div>
