...
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onplaying = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The video is now playing&quot;);<br>};</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_playing" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onplaying=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_playing_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.onplaying=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_playing">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;playing&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_playing_el">Try it</a> </div></div>
...
<div class="w3-code notranslate jsHigh">
    ...
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onplaying = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The audio is now playing&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_playing2">Try it Yourself &raquo;</a>
</div>
<hr>
