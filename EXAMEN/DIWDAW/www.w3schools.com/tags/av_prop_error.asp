...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_error" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>The code property of the MediaError Object returns a number representing the error state of the audio/video:<ul><li>1  = MEDIA_ERR_ABORTED - fetching process aborted by user</li>
