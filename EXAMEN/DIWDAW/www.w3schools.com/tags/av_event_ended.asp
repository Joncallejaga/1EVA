...
<div class="w3-code notranslate jsHigh">
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onended = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The audio has ended&quot;);<br>};</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_ended" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onended=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ended_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.onended=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ended">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;ended&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ended_el">Try it</a> </div></div>
...
<p>Alert that the video has ended:</p>
 <div class="w3-code notranslate jsHigh">
     ...
     var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onended =  function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The video has ended&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_ended2">Try it Yourself &raquo;</a>
</div>
<hr>
