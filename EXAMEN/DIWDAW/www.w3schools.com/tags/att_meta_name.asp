...
<p><a href="tag_meta.asp" class="w3-btn w3-white w3-border" title="HTML meta Tag Reference">&#10094; HTML &lt;meta&gt; tag</a></p>
<div class="w3-example">

<h3>Example</h3>
<p>Use the name attribute to define a description, keywords, and the author of an HTML document. 
Also define the viewport to control the page's dimensions and scaling for 
different devices:</p>
...
<p>HTML5 introduced a method to let web designers take control over the 
viewport (the user's visible area of a web page), through the &lt;meta&gt; tag (See &quot;Setting The Viewport&quot; example below).</p>
<hr>
...
<table class="w3-table-all notranslate" id="table1">
  ...
  <tr>
    <td>author</td>
    <td>Specifies the name of the author of the document. Example:
  ...
  <tr>
    <td>description</td>
    <td>Specifies a description of the page. Search engines can pick up this description to show with the results of searches. Example:
  <div class="w3-code w3-border notranslate htmlHigh">
  ...
  <tr>
    <td>generator</td>
    <td>Specifies one of the software packages used to generate the document  (not used on hand-authored pages). Example:
  <div class="w3-code w3-border notranslate htmlHigh">
  ...
  <b>Tip:</b> Always specify keywords (needed by search engines to catalogize the page). Example:
  <div class="w3-code w3-border notranslate htmlHigh">
  ...
  <tr>
    <td>viewport</td>
    <td>Controls the viewport (the user's visible area of a web page).<br>
...
<div class="w3-note w3-panel"><p>You can read more about the viewport in our <a href="../css/css_rwd_viewport.asp">Responsive Web Design - The Viewport Tutorial</a>.</p>
</div>
  </td>
  </tr>
 </table>
...
<a href="tag_meta.asp" class="w3-btn w3-white w3-border" title="HTML meta Tag Reference">&#10094; HTML &lt;meta&gt; tag</a>
</div>
