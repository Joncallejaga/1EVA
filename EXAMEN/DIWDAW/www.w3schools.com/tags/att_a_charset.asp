...
<a target="_blank" href="tryit.asp?filename=tryhtml_a_charset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>The character-set of the linked document.<p>Common character sets:</p>
<ul>
