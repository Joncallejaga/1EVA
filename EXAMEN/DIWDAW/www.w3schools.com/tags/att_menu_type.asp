...
<p><a href="tag_menu.asp" class="w3-btn w3-white w3-border" title="HTML menu Tag Reference">&#10094; HTML &lt;menu&gt; tag</a></p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>list</td>
    <td>Default. Specifies a list menu. A list of commands (li elements),  that the user can perform or activate</td>
  </tr>
  <tr>
    <td>context</td>
    <td>Specifies a context menu. The menu must be activated before the user  can interact with the commands</td>
  </tr>
  <tr>
    <td>toolbar</td>
    <td>Specifies a toolbar menu. Active commands, allows the user to  interact with the commands immediately</td>
  </tr>
 </table>
<hr>
<a href="tag_menu.asp" class="w3-btn w3-white w3-border" title="HTML menu Tag Reference">&#10094; HTML &lt;menu&gt; tag</a>
</div>
