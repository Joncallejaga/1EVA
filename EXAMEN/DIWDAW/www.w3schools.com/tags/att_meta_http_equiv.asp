...
<table class="w3-table-all notranslate" id="table1">
  ...
  <p>&lt;meta http-equiv=&quot;default-style&quot; content=&quot;<em>the  document's preferred stylesheet</em>&quot;&gt;</p>
  <p><strong>Note:</strong> The value of the content attribute above must  match the value of the title attribute on a link element in the same  document, or it must match the value of the title attribute on a style  element in the same document.</p></td>
  </tr>
  <tr>
    <td>refresh</td>
  ...
  <p>Note: The value &quot;refresh&quot; should be used carefully, as it takes the  control of a page away from the user. Using &quot;refresh&quot; will cause a failure in
