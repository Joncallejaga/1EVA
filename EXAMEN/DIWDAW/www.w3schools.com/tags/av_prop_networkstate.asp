...
<div class="w3-code notranslate jsHigh">
    ...
    var vid = document.getElementById(&quot;myVideo&quot;);<br>alert(vid.networkState);</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_networkstate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  ...
  0  = NETWORK_EMPTY - audio/video has not yet been initialized</li>
    <li>1 = NETWORK_IDLE - audio/video is active and has selected a  resource, but is not using the network</li>
