...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_currentsrc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the current audio/video. Returns the entire URL, including the protocol (like http://). If no audio/video is set, an empty string is returned</td>
</tr>
</table>
<hr>
