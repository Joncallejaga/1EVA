...
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onloadeddata = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Browser has loaded the current frame&quot;);<br>};</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_loadeddata" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onloadeddata=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_loadeddata_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.onloadeddata=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_loadeddata">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;loadeddata&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_loadeddata_el">Try it</a> </div></div>
...
<div class="w3-code notranslate jsHigh">
    ...
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onloadeddata = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Browser has loaded the current frame&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_loadeddata2">Try it Yourself &raquo;</a>
</div>
<hr>
