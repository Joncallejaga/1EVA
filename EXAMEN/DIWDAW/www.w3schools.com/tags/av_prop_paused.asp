...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_paused" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio/video is paused. Otherwise it returns false</td>
</tr>
</table>
<hr>
