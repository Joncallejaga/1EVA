...
<p><a href="tag_select.asp" class="w3-btn w3-white w3-border" title="HTML select Tag Reference">&#10094; HTML &lt;select&gt; tag</a></p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>The number of visible options in the drop-down list. Default value is 1. If the multiple attribute is present, the default value is 4</td>
  </tr>
  </table>
<hr>
