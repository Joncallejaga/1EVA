...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_defaultmuted" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio/video is muted by default, otherwise it returns false</td>
</tr>
<tr>
  <th>Default Value:</th>
  <td>false</td>
