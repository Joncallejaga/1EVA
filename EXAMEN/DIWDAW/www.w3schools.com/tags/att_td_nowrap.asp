...
&nbsp; &lt;/tr&gt;<br>
&nbsp; &lt;tr&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;td nowrap&gt;<i>Never increase, beyond what is necessary, the number of entities required to explain anything</i>&lt;/td&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;td&gt;<i>Never increase, beyond what is necessary, the number of entities required to explain anything</i>&lt;/td&gt;<br>
&nbsp; &lt;/tr&gt;<br>
 &lt;/table&gt;
  
</div>
<a target="_blank" href="tryit.asp?filename=tryhtml_td_nowrap" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
