...
<a class="w3-left w3-btn" href="att_global_draggable.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_standardattributes.asp">HTML Global Attributes</a>
<a class="w3-right w3-btn" href="att_global_hidden.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>move</td>
    <td>Dropping the data will result in that the dragged data is moved to  the new location</td>
  </tr>
  <tr>
    <td>link</td>
...
<p>JavaScript Reference: <a href="../jsref/event_ondrag.asp">The ondrag Event</a></p>
