...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_playbackrate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Indicates the current playback speed of the audio/video.<br>Example values:<ul><li>1.0 is normal speed</li>
