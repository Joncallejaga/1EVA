...
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.oncanplay = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Can start playing video&quot;);<br>};</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_canplay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> oncanplay=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_canplay_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.oncanplay=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_canplay">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;canplay&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_canplay_el">Try it</a> </div></div>
...
<div class="w3-code notranslate jsHigh">
    ...
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.oncanplay = function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Can start playing audio&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_canplay2">Try it Yourself &raquo;</a>
</div>
<hr>
