...
<a target="_blank" href="tryit.asp?filename=tryhtml_a_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;a&gt; name attribute is not supported in HTML5. 
Use the <a href="ref_standardattributes.asp">id attribute</a> instead.</span></p>
<p>The name attribute specifies the name of an anchor.</p>
