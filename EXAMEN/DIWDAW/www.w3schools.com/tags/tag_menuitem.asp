...
<h1>HTML <span class="color_h1">&lt;menuitem&gt;</span> Tag</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="tag_menu.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<p><span class="deprecated">The &lt;menuitem&gt; tag is deprecated in HTML5.</span></p>
<p>The &lt;menuitem&gt; tag defines a command/menu item that the user can invoke from a popup menu.</p>
<hr>
...
<table class="browserref notranslate">
  <tr>
    ...
    <td><span class="deprecated">Not supported</span></td>
    <td>8.0<br>(for context menus)</td>
    <td><span class="deprecated">Not supported</span></td>
    <td><span class="deprecated">Not supported</span></td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="att_menuitem_checked.asp">checked</a></td>
    <td>checked</td>
    <td>Specifies that the command/menu item should be checked when the page loads. Only for type=&quot;radio&quot; or type=&quot;checkbox&quot;</td>
  </tr>
  <tr>
    <td>command</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><a href="att_menuitem_default.asp">default</a></td>
    <td>default</td>
    <td>Marks the command/menu item as being a default command</td>
  </tr>
  <tr>
    <td><a href="att_menuitem_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that the command/menu item should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_menuitem_icon.asp">icon</a></td>
    <td><i>URL</i></td>
    <td>Specifies an icon for the command/menu item</td>
  </tr>
  <tr>
    <td><a href="att_menuitem_label.asp">label</a></td>
    <td><i>text</i></td>
    <td>Required. Specifies the name of the command/menu item, as shown to the user</td>
  </tr>
  <tr>
    <td><a href="att_menuitem_radiogroup.asp">radiogroup</a></td>
    <td><i>groupname</i></td>
    <td>Specifies the name of the group of commands that will be toggled when the command/menu item itself is toggled. Only for type=&quot;radio&quot;</td>
  </tr>
  <tr>
    <td><a href="att_menuitem_type.asp">type</a></td>
    <td>checkbox<br>
 command<br>
 radio</td>
    <td>Specifies the type of command/menu item. Default is &quot;command&quot;</td>
  </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;menuitem&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;menuitem&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="../jsref/dom_obj_menuitem.asp">MenuItem Object</a></p>
<br>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="tag_menu.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
