...
<div class="w3-code notranslate jsHigh">
    // Get the &lt;video&gt; element with id="myVideo"<br>var vid = document.getElementById("myVideo");<br><br>// Assign an ontimeupdate event to the &lt;video&gt; element, and execute a function if the current playback position has changed<br>vid.ontimeupdate = function() {myFunction()};<br>
 <br>function myFunction() {<br>// Display the current position of the video in a &lt;p&gt; element with id="demo"<br>&nbsp;&nbsp;&nbsp; document.getElementById("demo").innerHTML = vid.currentTime;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_timeupdate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> ontimeupdate=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_timeupdate_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.ontimeupdate=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_timeupdate">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;timeupdate&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_timeupdate_el">Try it</a> </div></div>
<p><strong>Note:</strong> The <a href="../jsref/met_element_addeventlistener.asp">addEventListener()</a> method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>
...
<div class="w3-code notranslate jsHigh">
    ...
    // Get the &lt;audio&gt; element with id="myVideo"<br>var aud = document.getElementById("myVideo");<br><br>// Assign an ontimeupdate event to the &lt;audio&gt; element, and execute a function if the current playback position has changed<br>aud.ontimeupdate = function() {myFunction()};<br>
 <br>function myFunction() {<br>// Display the current position of the audio in a &lt;p&gt; element with id="demo"<br>&nbsp;&nbsp;&nbsp; document.getElementById("demo").innerHTML = aud.currentTime;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_timeupdate2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_av_event_timeupdate_currenttime">Try it Yourself &raquo;</a>
</div>
<hr>
