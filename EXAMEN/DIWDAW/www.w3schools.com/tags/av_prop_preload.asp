...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_preload" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>auto</td>   
    <td>Indicates that the audio/video should start loading as soon as the page loads</td>
    </tr>
    <tr>
    <td>metadata</td>
    <td>Indicates that only the metadata for the audio/video should be loaded when the page loads</td>
    </tr>
  <tr>
    <td>none</td>
    <td>Indicates that the audio/video should NOT start loading as soon as the page loads</td>
  </tr>
  </table>
