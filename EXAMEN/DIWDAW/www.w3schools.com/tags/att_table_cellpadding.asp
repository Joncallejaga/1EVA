...
<a target="_blank" href="tryit.asp?filename=tryhtml_table_cellpadding" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><a href="tryit.asp?filename=tryhtml_table_cellpadding_css" target="_blank">
CSS Example: Add padding to a table</a></p>
<p>In our CSS tutorial you can find more details about 
<a href="../css/css_table.asp">table padding</a>.</p>
<hr>
