...
<p><a href="tag_area.asp" class="w3-btn w3-white w3-border" title="HTML area Tag Reference">&#10094; HTML &lt;area&gt; tag</a></p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the coordinates of the top-left and bottom-right corner of the rectangle (shape=&quot;rect&quot;)</td>
  </tr>
  <tr>
    <td><i>x,y,radius</i></td>
    <td>Specifies the coordinates of the circle center and the radius (shape=&quot;circle&quot;)</td>
  </tr>
  <tr>
    <td><i>x1,y1,x2,y2,..,xn,yn</i></td>
    <td>Specifies the coordinates of the edges of the polygon. If the first and last coordinate pairs are not the same, the browser will add the last coordinate pair to close the polygon (shape=&quot;poly&quot;)</td>
  </tr>
  </table>
<hr>
<a href="tag_area.asp" class="w3-btn w3-white w3-border" title="HTML area Tag Reference">&#10094; 
HTML &lt;area&gt; tag</a>
</div>
