...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_volume" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Specifies the current volume of the audio/video. Must be a number between 0.0 and 1.0.<br><br>Example values:<ul><li>1.0 is highest volume (100%. This is default)</li>
