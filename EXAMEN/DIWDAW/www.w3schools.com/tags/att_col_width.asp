...
<p><a href="tag_col.asp" class="w3-btn w3-white w3-border" title="HTML col Tag Reference">&#10094; HTML &lt;col&gt; tag</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_col_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<p><a href="tryit.asp?filename=tryhtml_col_width_css" target="_blank">CSS 
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Shares the available pixels into parts. (e.g. A table is 100 px, the first column is 20 px, the second is 50%, the available pixels will then be 30px). One part is set like this: &quot;1*&quot;.<p>Example: If 30 px of space are available, you can have one  &quot;1*&quot; and one &quot;2*&quot;, which will be interpreted as 10 and 20 px (think  of 1* as one part, and 2* as two parts).</td>
  </tr>
  </table>
<hr>
<a href="tag_col.asp" class="w3-btn w3-white w3-border" title="HTML col Tag Reference">&#10094; HTML &lt;col&gt; tag</a>
</div>
