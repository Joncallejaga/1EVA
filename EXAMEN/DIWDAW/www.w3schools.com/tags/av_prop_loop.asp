...
<div class="w3-code notranslate jsHigh">
 ...
 vid.loop = true;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>true</td>
    <td>Indicates that the audio/video should start playing again when it is finished</td>
    </tr>
  <tr>
    <td>false</td>
    <td>Default. Indicates that the audio/video should NOT start playing again when it is finished</td>
  </tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio/video starts playing over again, every time it is finished. Otherwise it returns false</td>
</tr>
<tr>
  <th>Default Value:</th>
  <td>false</td>
