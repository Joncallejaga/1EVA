...
<div class="w3-code notranslate jsHigh">
    // Get the &lt;video&gt; element with id=&quot;myVideo&quot;<br>var vid = document.getElementById(&quot;myVideo&quot;);<br><br>// Set the current playback speed of the video to 0.3 (slow motion)<br>function setPlaySpeed() { <br>&nbsp;&nbsp;&nbsp; vid.playbackRate = 0.3;<br>} <br><br>// Assign a ratechange event to the &lt;video&gt; element, and execute a function if the playing speed of the video is changed. The function will alert some text<br>vid.onratechange = function() {myFunction()};<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The playing speed of the video was changed&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_ratechange" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
&lt;<em>audio|video</em> onratechange=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ratechange_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.onratechange=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ratechange">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audio|video</em>.addEventListener(&quot;ratechange&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhtml5_av_event_ratechange_el">Try it</a> </div></div>
