...
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_currenttime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>seconds</i></td>
    <td>Indicates the position for the playback of the audio/video, in seconds</td>
  </tr>
  </table>
