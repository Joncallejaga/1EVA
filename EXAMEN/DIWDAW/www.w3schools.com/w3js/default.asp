    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>  
          ...
          <a class="w3-bar-item w3-button" href="default.asp">Learn W3.JS</a>
    ...
    <div id='nav_references' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col m4'>
          ...
          <a class="w3-bar-item w3-button" href="w3js_references.asp">W3.JS Reference</a>
          <h3>Server Side</h3>
    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href="w3js_examples.asp" target='_top'>W3.JS Examples</a>
        </div>
        <div class='w3-col l3 m6'>
          <h3>Server Side</h3>
...
<a class="w3-left w3-button w3-green" href="../tags/att_style_scoped.asp">&#10094; Previous</a>
...
<p><a href="https://www.w3schools.com/w3js/w3js_referenses.asp">W3.JS References</a></p>
<hr>
...
<p>Or download <a href="../lib/w3.js" target="_blank">
