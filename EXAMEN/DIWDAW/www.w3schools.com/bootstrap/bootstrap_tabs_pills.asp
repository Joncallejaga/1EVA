...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_menu_list-inline&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<ul style="margin:20px 0 22px 0;" class="test1 nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="bootstrap_tabs_pills.asp#">Home</a></li>
  <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#">Menu 1</a></li>
  <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#">Menu 2</a></li>
  <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#">Menu 3</a></li>
</ul>
...
<ul style="margin:20px 0 22px 0;" class="test1 nav nav-tabs">
  <li data-toggle="tab" class="active"><a href="bootstrap_tabs_pills.asp#">Home</a></li>
  <li data-toggle="tab" class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="bootstrap_tabs_pills.asp#">Menu 1
    <span class="caret"></span></a>
    <ul class="dropdown-menu">
      <li><a href="bootstrap_tabs_pills.asp#">Submenu 1-1</a></li>
      <li><a href="bootstrap_tabs_pills.asp#">Submenu 1-2</a></li>
      <li><a href="bootstrap_tabs_pills.asp#">Submenu 1-3</a></li> 
    </ul>
  </li>
  <li data-toggle="tab"><a href="bootstrap_tabs_pills.asp#">Menu 2</a></li>
  <li data-toggle="tab"><a href="bootstrap_tabs_pills.asp#">Menu 3</a></li>
...
<ul style="margin:19px 0 15px 0;" class="test2 nav nav-pills">
  <li class="active"><a data-toggle="pill" href="bootstrap_tabs_pills.asp#">Home</a></li>
  <li><a data-toggle="pill" href="bootstrap_tabs_pills.asp#">Menu 1</a></li>
  <li><a data-toggle="pill" href="bootstrap_tabs_pills.asp#">Menu 2</a></li>
  <li><a data-toggle="pill" href="bootstrap_tabs_pills.asp#">Menu 3</a></li>
</ul>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_pills&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_pills_vertical&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <ul class="nav nav-pills nav-stacked test2">
        <li class="active"><a href="bootstrap_tabs_pills.asp#" data-toggle="tab">Home</a></li>
        <li><a href="bootstrap_tabs_pills.asp#" data-toggle="tab">Menu 1</a></li>
        <li><a href="bootstrap_tabs_pills.asp#" data-toggle="tab">Menu 2</a></li>
        <li><a href="bootstrap_tabs_pills.asp#" data-toggle="tab">Menu 3</a></li>
      </ul>
    </div>
...
<ul style="margin:16px 0 15px 0;" class="test2 nav nav-pills nav-stacked">
  <li data-toggle="pill" class="active"><a href="bootstrap_tabs_pills.asp#">Home</a></li>
  ...
  <li data-toggle="pill"><a href="bootstrap_tabs_pills.asp#">Menu 2</a></li>
  <li data-toggle="pill"><a href="bootstrap_tabs_pills.asp#">Menu 3</a></li>
</ul>
...
<ul style="margin:19px 0 18px 0;" class="nav nav-tabs test2">
    <li class="active"><a data-toggle="tab" href="bootstrap_tabs_pills.asp#home">Home</a></li>
    <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#menu1">Menu 1</a></li>
    <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#menu2">Menu 2</a></li>
    <li><a data-toggle="tab" href="bootstrap_tabs_pills.asp#menu3">Menu 3</a></li>
</ul>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_tabs_dynamic&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
