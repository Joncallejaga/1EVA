...
<div style="width:100%">
  ...
  <div class="dropdown" style="margin-bottom:14px">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="bootstrap_filters.asp#">HTML</a></li>
      <li><a href="bootstrap_filters.asp#">CSS</a></li>
      <li><a href="bootstrap_filters.asp#">JavaScript</a></li>
      <li><a href="bootstrap_filters.asp#">jQuery</a></li>
      <li><a href="bootstrap_filters.asp#">Bootstrap</a></li>
      <li><a href="bootstrap_filters.asp#">Angular</a></li>
    </ul>
  </div>
</div>
