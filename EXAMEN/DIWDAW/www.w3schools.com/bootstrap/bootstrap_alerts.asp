...
<div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;">
    <a href="bootstrap_alerts.asp#" class="close" data-dismiss="alert" aria-label="close" title="close">&times;</a>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_alerts&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Add the <code class="w3-codespan">alert-link</code> class to any links inside the alert box to create "matching colored links":</p>
  <div class="alert alert-success">
    <strong>Success!</strong> You should <a href="bootstrap_alerts.asp#" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-info">
    <strong>Info!</strong> You should <a href="bootstrap_alerts.asp#" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-warning">
    <strong>Warning!</strong> You should <a href="bootstrap_alerts.asp#" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-danger">
    <strong>Danger!</strong> You should <a href="bootstrap_alerts.asp#" class="alert-link">read this message</a>.
  </div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_alerts_link&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate htmlHigh">
 ...
 &lt;/div&gt;<br></div>
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_alerts_dismissible&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_alerts_fade&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
