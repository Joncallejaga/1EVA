...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="position:relative;z-index:1;">
  ...
  <!-- Controls -->
  <a class="left carousel-control" href="bootstrap_carousel.asp#myCarousel" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="bootstrap_carousel.asp#myCarousel" role="button" data-slide="next">
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_carousel&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="https://www.w3schools.com/bootstrap//tryit.asp?filename=trybs_carousel2&amp;stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
