...
<a class="w3-right w3-btn w3-green" href="whatis_google_fonts.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_google.jpg" style="width:110px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>Google Maps is a Google API</p>
<p>Google Fonts is a Google API</p>
<p>Google Charts is a Google API</p>
</div>
</div>
<hr>
<p class="intro">Learn how to add Google Maps to your web page.</p>
<hr>
...
<p>Start with a simple web page.</p>
<p>Add a &lt;div&gt; element where you want the map to display, and set the size of the map:</p>
...
&lt;div id=&quot;map&quot; style=&quot;width:100%;height:400px;&quot;&gt;My map will go here&lt;/div&gt;<br><br>
&lt;/body&gt;<br>&lt;html&gt;
</div>
</div>

<p>Add a JavaScript function to display the map:</p>
<div class="w3-example">
<h3>Example</h3>
...
<h2>Finally Add the Google API</h2>

<p>The functionality of the map is provided by a JavaScript library located at Google:</p>

<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
   &lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=YOUR_KEY&amp;callback=myMap&quot;&gt;&lt;/script&gt;<br></div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_google_maps" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Google Maps Tutorial</h2>
<p>Learn more about Google Maps in our <a href="../howto/howto_google_maps.asp">Google Maps Tutorial</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn w3-green" href="whatis_htmldom.asp">&#10094; Previous</a>
<a class="w3-right w3-btn w3-green" href="whatis_google_fonts.asp">Next &#10095;</a>
