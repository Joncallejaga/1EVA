...
<a class="w3-left w3-btn w3-green" href="whatis_responsive.asp">&#10094; Previous</a>
...
<hr>
<h2>JavaScript Quickstart Tutorial</h2>
<p>This tutorial will take a quick look at the most important JavaScript data types.</p>
<p>JavaScript variables can be:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_variables" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>JavaScript has only <b>one type</b> of number. Numbers can be written with or without decimals.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>
<a class="w3-btn" href="tryit.asp?filename=trywhatis_js_numbers" target="_blank">Try it yourself &raquo;</a>
</p>
</div>

<p>All numbers are stored as double precision floating point numbers.</p>
<p>The maximum number of decimals is 17, but floating point is not 
...
<p>
<a class="w3-btn" href="tryit.asp?filename=trywhatis_js_numbers_inaccurate" target="_blank">Try it yourself &raquo;</a>
</p>
</div>
...
<p>Strings <b>store text</b>. Strings are written inside quotes. You can use <b>single</b> or double <b>quotes</b>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_string_quotes">Try it Yourself &raquo;</a>
</div>

<p>The length of a string is found in the built in property <b>length</b>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var txt = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>var sln = txt.length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_string_length">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_objects_variable" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_objects_object" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>JavaScript Arrays</h2>
<p>JavaScript arrays are used to store multiple values in a single 
variable.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_array">Try it Yourself &raquo;</a>
</div>
...
particular task.</p>
<p>A JavaScript function is executed when 
...
<a target="_blank" href="tryit.asp?filename=trywhatis_js_functions" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>What can JavaScript Do?</h2>
<p>This section contains some examples of what JavaScript can do:</p>
<ul class="w3-ul w3-border w3-light-grey w3-card">
...
<p>One of many JavaScript HTML methods is <b>getElementById()</b>.</p>
<p>This example uses the method to &quot;find&quot; an HTML element (with id=&quot;demo&quot;) 
and changes the element content (<b>innerHTML</b>) to &quot;Hello 
JavaScript&quot;:</p>
