...
<img class="w3-margin-bottom" src="img_jquery.png" alt="jQuery" style="width:110px">
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_jquery_hide">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>jQuery Sliding</h2>
<p>With jQuery you can create sliding effects on HTML elements:</p>
<ul>
  <li>slideDown()</li>
  <li>slideUp()</li>
  <li>slideToggle()</li>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_jquery_slide">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_jquery_animation">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_jquery_dom_class">Try it Yourself &raquo;</a>
</div>
