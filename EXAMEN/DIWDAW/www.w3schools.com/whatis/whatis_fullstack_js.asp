...
<h1>What is Full stack JavaScript?</h1>
...
<p>Today the hottest buzzword is "Full Stack JavaScript".</p>

<p>The idea of "Full Stack JavaScript" is that all software in a web application, both client side and server side,
