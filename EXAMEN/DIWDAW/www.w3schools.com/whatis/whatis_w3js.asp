...
<div class="w3-cell w3-hide-small w3-center " style="padding:16px;width:150px">
<div class="w3-green w3-center w3-xxlarge" style="padding:4px;width:115px">W3<br>JS
</div>
</div>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=trywhatis_w3js_hide" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn" href="tryit.asp?filename=trywhatis_w3js_hide_style" target="_blank">With CSS &raquo;</a>
</p>
</div>

<hr>
<h2>What More Can W3.JS Do?</h2>
<ul class="w3-ul w3-border">
<li><a href="../w3js/w3js_slideshow.asp">Run HTML Slideshows</a></li>
<li><a href="../w3js/w3js_html_include.asp">Include (Import) HTML in HTML</a></li>
<li><a href="../w3js/w3js_sort.asp">Sort the Content of any HTML Element</a></li>
<li><a href="../w3js/w3js_filters.asp">Filter the Content of any HTML Element</a></li>
<li><a href="../w3js/w3js_display.asp">Display JavaScript Objects in HTML</a></li>
<li><a href="../w3js/w3js_http.asp">Read Data from Web Servers (Http Request)</a></li>
<li><a href="../w3js/w3js_hide.asp">Hide or Show any HTML Element</a></li>
<li><a href="../w3js/w3js_add_class.asp">Add or Remove Classes on any HTML Element</a></li>
<li><a href="../w3js/w3js_add_style.asp">Add CSS to any HTML Element</a></li></ul>
