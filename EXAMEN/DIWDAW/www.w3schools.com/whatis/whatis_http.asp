...
<p>Communication between client computers and web servers is done by sending 
<b>HTTP Requests</b> and receiving <b>HTTP Responses</b></p>
</div>
</div>
...
<p>Despite the XML and Http in the name, XHR is used with other protocols than HTTP,
and the data can be of many different types like 
<a href="whatis_html.asp">HTML</a>, <a href="whatis_css.asp">CSS</a>,
<a href="whatis_xml.asp">XML</a>, <a href="whatis_json.asp">JSON</a>, and plain text.</p>

<p>The XHR Object is a <b>Web Developers Dream</b>, because you can:</p>
<ul>
...
<p>The XHR Object is the underlying concept of <a href="whatis_ajax.asp"><b>AJAX</b></a> and
<a href="whatis_json.asp"><b>JSON</b></a>:</p>
<p><img src="img_ajax.gif" alt="AJAX"></p>
