...
<!DOCTYPE html>
<html lang="en-US">
<head><title>About Advertising</title>
<script>
function submitform()
{
var x="@"
...
<a class="w3-left w3-btn" href="about_privacy.asp">&#10094; Previous</a>
...
<div id="ad_form">
    <form>
      <div class="w3-input-group">
        ...
        <input type="text" id="ad_name" name="ad_name" class="w3-input w3-border" placeholder="Your name" />
      </div>
      <div class="w3-input-group w3-margin-top">
        <label for="ad_company">Company:</label>
        <input type="text" id="ad_company" name="ad_company" class="w3-input w3-border" placeholder="Your companyname" />
      </div>
      <div class="w3-input-group w3-margin-top">
        <label for="ad_email">Contact E-mail:</label>
        <input type="email" id="ad_email" name="ad_email" class="w3-input w3-border" placeholder="Your e-mail address" />
      </div>
      <div class="w3-input-group w3-margin-top">
        <label for="ad_desc">Ad description / Requirement / Question:</label>
        <textarea name="ad_desc" id="ad_desc" style="width:100%;height:200px;resize:vertical"></textarea>
      </div>
      <div class="w3-input-group w3-margin-top">
        <input type="button" class="w3-button w3-dark-grey" value=" Submit " onclick="sendAdform()" />
      </div>
    </form>
</div>
...
While using this site, you agree to have read and accepted our <a href="about_copyright.asp">terms of use</a>,
<a href="about_privacy.asp">cookie and privacy policy</a>.
<a href="about_copyright.asp">Copyright 1999-2018</a> by Refsnes Data. All Rights Reserved.<br>
