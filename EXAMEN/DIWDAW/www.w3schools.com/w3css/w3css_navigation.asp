...
<div class="w3-bar">
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black">Link 1</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black">Link 2</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-black">Link 3</a>
</div>
<br>
<div class="w3-bar">
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-green">Link 1</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-green">Link 2</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-green">Link 3</a>
</div>
<br>
<div class="w3-bar">
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-blue w3-hover-text-blue">Link 1</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-blue w3-hover-text-blue">Link 2</a>
  <a href="w3css_navigation.asp#" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar w3-hover-border-blue w3-hover-text-blue">Link 3</a>
</div>
<br>
<div class="w3-bar">
  <a href="w3css_navigation.asp#" style="border:5px solid white" class="w3-bar-item w3-button w3-hover-none w3-hover-border-green">Link 1</a>
  <a href="w3css_navigation.asp#" style="border:5px solid white" class="w3-bar-item w3-button w3-hover-none w3-hover-border-red">Link 2</a>
  <a href="w3css_navigation.asp#" style="border:5px solid white" class="w3-bar-item w3-button w3-hover-none w3-hover-border-blue">Link 3</a>
</div>
