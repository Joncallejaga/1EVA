...
<div class="w3-bar w3-border">
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">&laquo;</a>
  <a class="w3-bar-item w3-button w3-green" href="w3css_pagination.asp#">1</a>
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">2</a>
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">3</a>
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">4</a>
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">5</a>
  <a class="w3-bar-item w3-button" href="w3css_pagination.asp#">&raquo;</a>
</div>
</div>
