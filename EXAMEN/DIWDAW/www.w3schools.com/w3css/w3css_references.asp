...
<link rel="stylesheet" href="4/w3colors.css">
</head>
<body>
...
<div class="w3-col m4">
  <ul style="margin-top:0px;margin-bottom:0px">
    <li><a href="w3css_references.asp#container">Container</a></li>
    <li><a href="w3css_references.asp#table">Table</a></li>
    <li><a href="w3css_references.asp#card">Card</a></li>
    <li><a href="w3css_references.asp#responsive">Responsive</a></li>
    <li><a href="w3css_references.asp#layout">Layout</a></li>
    <li><a href="w3css_references.asp#navigation">Navigation</a></li>
    <li><a href="w3css_references.asp#button">Button</a></li>
  </ul>
</div>
<div class="w3-col m4">
  <ul style="margin-top:0px;margin-bottom:0px">
    <li><a href="w3css_references.asp#input">Input</a></li>
    <li><a href="w3css_references.asp#modal">Modal</a></li>
    <li><a href="w3css_references.asp#animation">Animation</a></li>
    <li><a href="w3css_references.asp#font">Font and Text</a></li>
    <li><a href="w3css_references.asp#display">Display</a></li>
    <li><a href="w3css_references.asp#effect">Effect</a></li>
    <li><a href="w3css_references.asp#backgroundcolor">Background Color</a></li>
  </ul>
</div>
<div class="w3-col m4">
 <ul style="margin-top:0px;margin-bottom:0px">
    <li><a href="w3css_references.asp#textcolor">Text Color</a></li>
    <li><a href="w3css_references.asp#hover">Hover</a></li>
    <li><a href="w3css_references.asp#round">Round</a></li>
    <li><a href="w3css_references.asp#padding">Padding</a></li>
    <li><a href="w3css_references.asp#margin">Margin</a></li>
    <li><a href="w3css_references.asp#border">Border</a></li>
  </ul>
</div>
</div>
<hr>
...
<table class="w3-table w3-bordered w3-striped w3-border">
 ...
 <tr>
  ...
  <td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3css_ref_content&amp;stacked=h">Try it</a></td>
 </tr>
 <tr>
  <td>w3-auto</td>
  <td>Container for responsive size centered content</td>
  <td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3css_ref_auto&amp;stacked=h">Try it</a></td>
 </tr>
 <tr>
  <td>w3-stretch</td>
  <td>Class that removes right and left margins</td>
  <td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3css_ref_stretch">Try it</a></td>
 </tr>
</table>
