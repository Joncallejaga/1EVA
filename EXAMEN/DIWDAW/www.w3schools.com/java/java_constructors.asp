...
<div class="w3-code notranslate javaHigh">
  // Create a MyClass class<br>public class MyClass {<br>&nbsp; int x;&nbsp; // 
  Create a class attribute<br><br>&nbsp; // Create a 
  <strong>class constructor</strong> for the MyClass class<br>&nbsp; 
  public MyClass() {<br>&nbsp;&nbsp;&nbsp; x = 5;&nbsp; // Set the initial value 
  for the class attribute x<br>&nbsp; }<br><br>&nbsp; public 
  static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new 
  MyClass(); // Create an object of class MyClass (This will <strong>call the 
  constructor</strong>)<br>&nbsp;&nbsp;&nbsp; System.out.println(myObj.x); // 
  Print the value of x<br>&nbsp; }<br>}<br><br>// Outputs 5<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_constructor">Run example &raquo;</a>
</div>
...
<p>Constructors in Java can also take paramaters, which is used to initialize 
attributes.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; int x;<br><br>&nbsp; 
  public MyClass(int y) {<br>&nbsp;&nbsp;&nbsp; x = y;<br>&nbsp; }<br><br>&nbsp; public 
  static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new 
  MyClass(5);<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x);<br>&nbsp; }<br>}<br><br>// Outputs 5<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_constructor_para">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class Car {<br>&nbsp; int modelYear;<br>&nbsp; String modelName;<br>
  <br>&nbsp; public Car(int year, String name) {<br>&nbsp;&nbsp;&nbsp; modelYear 
  = year;<br>&nbsp;&nbsp;&nbsp; modelName = name;<br>&nbsp; }<br><br>&nbsp; 
  public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; Car myCar = 
  new Car(1969, &quot;Mustang&quot;);<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myCar.modelYear + &quot; &quot; + myCar.modelName);<br>&nbsp; }<br>}<br><br>// Outputs 1969 Mustang<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_constructor_para2">Run example &raquo;</a>
</div>
