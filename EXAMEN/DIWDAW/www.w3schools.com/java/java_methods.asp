...
<hr>
<p class="intro">A method is a block of code which only runs when it is called.</p>
...
with the name of the method, followed by parantheses <strong>()</strong>. Java provides some pre-defined methods, such as <code class="w3-codespan">System.out.println()</code>, but you can also create your own methods to perform certain actions:</p>
...
parantheses <strong>()</strong> and a semicolon<strong>;</strong></p>
...
<div class="w3-code notranslate javaHigh">
  ...
  System.out.println(&quot;I just got executed!&quot;);<br>&nbsp; }<br><br>&nbsp; public static 
  void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; <strong>myMethod();</strong><br>&nbsp; }<br>}<br><br>// Outputs 
  &quot;I just got executed!&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method">Run example &raquo;</a>
</div>

<p>A method can also be called multiple times, if you want:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  class MyClass {<br>&nbsp; static void myMethod() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;I just got executed!&quot;);<br>&nbsp; }<br><br>&nbsp; public static 
  void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; <strong>myMethod();</strong><br>&nbsp;&nbsp;&nbsp; <strong>
  myMethod();</strong><br>&nbsp;&nbsp;&nbsp; <strong>myMethod();</strong><br>&nbsp; }<br>}<br><br>// 
  I just got executed!<br>// I just got executed!<br>// I just got executed!<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_multiple">Run example &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; static void myMethod(<strong>String fname</strong>) {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(fname + &quot; Refsnes&quot;);<br>&nbsp; }<br><br>&nbsp; public 
  static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; myMethod(&quot;Liam&quot;);<br>&nbsp;&nbsp;&nbsp; 
  myMethod(&quot;Jenny&quot;);<br>&nbsp;&nbsp;&nbsp; myMethod(&quot;Anja&quot;);<br>&nbsp; }<br>
  }<br>// Liam Refsnes<br>// Jenny Refsnes<br>// 
  Anja Refsnes<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_param">Run example &raquo;</a>
</div>
<hr>

<h2>Return Values</h2>
<p>The <code class="w3-codespan">void</code> keyword indicates that the method should not return a value. If you 
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; static <strong>int</strong> myMethod(int x) {<br>&nbsp;&nbsp;&nbsp; 
  <strong>return</strong> 5 + x;<br>&nbsp; }<br><br>&nbsp; public static void main(String[] args) 
  {<br>&nbsp;&nbsp;&nbsp; System.out.println(myMethod(3));<br>&nbsp; }<br>}<br>// Outputs 
  8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_void">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; static int myMethod(int x, int y) {<br>&nbsp;&nbsp;&nbsp; 
  return x + y;<br>&nbsp; }<br><br>&nbsp; public static void main(String[] args) 
  {<br>&nbsp;&nbsp;&nbsp; System.out.println(myMethod(5, 3));<br>&nbsp; }<br>}<br>
  // Outputs 8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_void2">Run example &raquo;</a>
</div>
<p>You can also store the result in a variable (recommended):</p>
...
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; static int myMethod(int x, int y) {<br>&nbsp;&nbsp;&nbsp; 
  return x + y;<br>&nbsp; }<br><br>&nbsp; public static void main(String[] args) 
  {<br>&nbsp;&nbsp;&nbsp; int z = myMethod(5, 3);<br>&nbsp;&nbsp;&nbsp; System.out.println(z);<br>&nbsp; }<br>}<br>
  // Outputs 8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_void3">Run example &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br><br>&nbsp; // Create a checkAge() method with an 
  integer variable called <strong>age</strong><br>&nbsp; static void checkAge(int age) {<br>
  <br>&nbsp;&nbsp;&nbsp; // If age is less than 18, print &quot;access denied&quot;<br>&nbsp;&nbsp;&nbsp; 
  if(age &lt; 18) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(&quot;Access 
  denied - You are not old enough!&quot;); <br><br>&nbsp;&nbsp;&nbsp; // If age 
  is greater than 18, print &quot;access granted&quot;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Access granted - You are old enough!&quot;); <br>&nbsp;&nbsp;&nbsp; 
  }<br><br>&nbsp; } <br><br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; 
  checkAge(20); // Call the checkAge method and pass along an age of 20<br>&nbsp; } <br>}<br>
  <br>// Outputs &quot;Access granted - You are old enough!&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_method_ifelse">Run example &raquo;</a>
</div>
