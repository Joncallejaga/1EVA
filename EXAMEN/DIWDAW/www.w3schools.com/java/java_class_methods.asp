...
<h3>Example</h3>
<p>Create a 
method named <code class="w3-codespan">myMethod()</code> in MyClass:</p>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; static void <strong>myMethod()</strong> {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Hello World!&quot;);<br>&nbsp; }<br>}<br>
 </div>
</div>

<p><code class="w3-codespan">myMethod()</code> prints a text (the action), when it is 
<strong>called</strong>. To 
call a method, write the method's name followed by two parantheses <strong>()</strong> and a semicolon<strong>;</strong></p>
<div class="w3-example">
<h3>Example</h3>
...
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; static void myMethod() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Hello World!&quot;);<br>&nbsp; }<br><br>&nbsp; public static 
  void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; <strong>myMethod();</strong><br>&nbsp; }<br>}<br><br>// Outputs 
  &quot;Hello World!&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_class_method">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_class_method_para">Run example &raquo;</a>
</div>
<div class="w3-note w3-panel">
</div>
<hr>

<h2>Static or Public</h2>
<p>In the examples above we used the <code class="w3-codespan">static</code> keyword for each method instead of <code class="w3-codespan">public</code>. A <code class="w3-codespan">static</code> method means that it belongs to the class, and cannot be accessed from outside of the class, unlike <code class="w3-codespan">public</code>. 
To access a method with an object, you must must declare the method as <code class="w3-codespan">public</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; <br>&nbsp; // Static method<br>&nbsp; <strong>static</strong> void myStaticMethod() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Static methods can be called without creating objects&quot;);<br>&nbsp; }<br>
  <br>&nbsp; // Public method<br>&nbsp; <strong>public</strong> void myPublicMethod() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Public methods must be called by creating objects&quot;);<br>&nbsp; }<br><br>}<br>
 </div>
</div>
...
<hr>
<h2>Access Methods With Objects</h2>
<p>Now that you know how to create classes and methods, we can start creating objects that we will use to access class methods.</p>
...
<div class="w3-code notranslate javaHigh">
  // Create a Car class<br>public
  class Car {<br>&nbsp;<br>&nbsp; // Create a fullThrottle() method<br>&nbsp; public void 
  fullThrottle() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;The car is going as fast as it can!&quot;);<br>&nbsp; }<br><br>&nbsp; // 
  Create a speed() method and add a parameter<br>&nbsp; 
  public void speed(int maxSpeed) {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Max speed is: &quot; + maxSpeed);<br>&nbsp; }<br>
  <br>&nbsp; // Inside main, call the methods on the myCar object<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
  Car 
  myCar = new Car();&nbsp;&nbsp;&nbsp;&nbsp; // Create a myCar 
  object<br>&nbsp;&nbsp;&nbsp; myCar.fullThrottle();&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;// Call the 
  fullThrottle() method<br>&nbsp;&nbsp;&nbsp; 
  myCar.speed(200);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; // Call the 
  speed() method<br>&nbsp; }<br>}<br> <br>// The car is going as fast as it can!<br>// Max speed is: 200<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_class_car">Run example &raquo;</a>
</div>

<h3>Example explained</h3>
<p>1) We created a custom <code class="w3-codespan">Car</code> class with the <code class="w3-codespan">class</code> keyword.</p>
<p>2) We created the <code class="w3-codespan">fullThrottle()</code> and <code class="w3-codespan">
speed()</code> 
methods in the <code class="w3-codespan">Car</code> class.</p>
...
<p>5) In order to use the <code class="w3-codespan">Car</code> class and its 
methods, we need to create an <strong>object</strong> of the <code class="w3-codespan">Car</code> Class.</p>
...
<p>7) By using the <code class="w3-codespan">new</code> keyword we created a <code class="w3-codespan">Car</code> object with the name
...
<p>To call a method in Java, write the method name followed by a set of parantheses <strong>()</strong>, followed by a semicolon (<code class="w3-codespan">;</code>).</p>
<p>A class must have a matching filename (<code class="w3-codespan">Car</code> and 
<strong>Car.java</strong>).</p>
</div>
<hr>
...
<h4>Car.java</h4>
<div class="w3-code notranslate javaHigh">
  public class Car {<br>&nbsp; public void fullThrottle() {<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;The car is going as fast as it can!&quot;);<br>&nbsp; }<br><br>&nbsp; public void 
  speed(int maxSpeed) {<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Max speed 
  is: &quot; + maxSpeed);<br>&nbsp; }<br>}<br>
 </div>
</div>
<div class="w3-example">
<h4>OtherClass.java</h4>
<div class="w3-code notranslate javaHigh">
  class 
  OtherClass {<br>&nbsp; 
  public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
  Car 
  myCar = new Car();&nbsp; &nbsp;&nbsp;&nbsp;// Create a myCar object<br>&nbsp;&nbsp;&nbsp; 
  myCar.fullThrottle();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Call the 
  fullThrottle() method<br>&nbsp;&nbsp;&nbsp; 
  myCar.speed(200);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Call the 
  speed() method<br>&nbsp; }<br>}<br>
 </div>
</div>
...
C:\Users\<em>Your Name</em>&gt;javac Car.java<br>
C:\Users\<em>Your Name</em>&gt;javac OtherClass.java
</div>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;java OtherClass
</div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="showjava.asp?filename=demo_class_two2">Run example &raquo;</a>
</div>
