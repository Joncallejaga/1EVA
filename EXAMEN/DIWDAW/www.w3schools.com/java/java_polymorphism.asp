...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class Animal {<br>&nbsp; public void animalSound() {<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;The animal makes a sound&quot;);<br>&nbsp; }<br>}<br><br>class Pig extends 
    Animal {<br>&nbsp; public void animalSound() {<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;The pig says: wee wee&quot;);<br>&nbsp; }<br>}<br><br>class Dog extends Animal 
    {<br>&nbsp; public void animalSound() {<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;The dog says: bow wow&quot;);<br>&nbsp; }<br>}</div>
</div>
...
<p>Now we can create <code class="w3-codespan">Pig</code> and <code class="w3-codespan">Cat</code> objects, and call the <code class="w3-codespan">animalSound()</code> method on both of them:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class Animal {<br>&nbsp; public void animalSound() {<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;The animal makes a sound&quot;);<br>&nbsp; }<br>}<br><br>class Pig extends Animal {<br>&nbsp; 
    public void animalSound() {<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;The 
    pig says: wee wee&quot;);<br>&nbsp; }<br>}<br><br>class Dog extends Animal {<br>&nbsp; public void animalSound() 
    {<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;The dog says: bow wow&quot;);<br>&nbsp; 
    }<br>}<br><br>class 
    MyMainClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
    Animal myAnimal = new Animal();&nbsp; // Create a Animal object<br>&nbsp;&nbsp;&nbsp; 
    Animal myPig = new Pig();&nbsp; // Create a Pig object<br>&nbsp;&nbsp;&nbsp; 
    Animal myDog = new Dog();&nbsp; // Create a Dog object<br><br>&nbsp;&nbsp;&nbsp; 
    myAnimal.animalSound();<br>&nbsp;&nbsp;&nbsp; myPig.animalSound();<br>&nbsp;&nbsp;&nbsp; 
    myDog.animalSound();<br>&nbsp; 
    }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_polymorphism">Run example &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_inheritance.asp">&#10094; Previous</a>
