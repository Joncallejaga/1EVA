...
<html lang="en-US">
<head>
<title>Java Inheritance (Subclass and Superclass)</title>
<meta charset="utf-8">
...
<h3>Example</h3>
  ...
  class Vehicle {<br>&nbsp; protected String brand = &quot;Ford&quot;;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
  // Vehicle attribute<br>&nbsp; public void honk() {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Vehicle method<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Tuut, tuut!&quot;);<br>&nbsp; 
  }<br>}<br><br>class Car extends Vehicle 
  {<br>&nbsp; private String modelName = &quot;Mustang&quot;;&nbsp;&nbsp;&nbsp; // Car attribute<br>&nbsp; 
  public static void main(String[] args) {<br><br>&nbsp;&nbsp;&nbsp; // Create a 
    myCar object<br>&nbsp;&nbsp;&nbsp; Car myCar = new Car();<br><br>&nbsp;&nbsp;&nbsp; 
  // Call the honk() method (from the Vehicle class) on the myCar object<br>&nbsp;&nbsp;&nbsp; 
    myCar.honk();<br><br>&nbsp;&nbsp;&nbsp; // Display the value of the brand 
  attribute (from the Vehicle class) and the value of the modelName from the Car 
  class<br>&nbsp;&nbsp;&nbsp; System.out.println(myCar.brand + &quot; &quot; + 
    myCar.modelName); <br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_inherit">Run example &raquo;</a>
</div>

<div class="w3-note w3-panel">
<p>Did you notice the <code class="w3-codespan">protected</code> modifier in Vehicle?</p>
<p>We set the <strong>brand</strong> attribute in <strong>Vehicle</strong> to a protected <a href="java_modifiers.asp">access 
modifier</a>. If it was set to private, the Car class would not be able to access 
it.</p>
<h4>Why Use Inheritance?</h4>
  <p>- It is useful for code reusability: reuse the attributes and methods of the existing class when you create a new class.</p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_packages.asp">&#10094; Previous</a>
