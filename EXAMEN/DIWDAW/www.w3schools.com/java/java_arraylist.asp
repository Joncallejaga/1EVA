...
grow or shrink an array, you have to create a new one). While an <code class="w3-codespan">ArrayList</code> can both grow 
and shrink. The syntax is also slightly different:</p>
...
<p>Create an <code class="w3-codespan">ArrayList</code> object called <strong>cars</strong> that will store strings:</p>
  <div class="w3-code notranslate javaHigh">
    import java.util.ArrayList; // import the 
    ArrayList class<br> <br>ArrayList&lt;String&gt; cars = new ArrayList&lt;String&gt;(); 
    // Create an ArrayList object</div>
</div>
<hr>

<h2>Add ArrayList Elements</h2>
<p>The <code class="w3-codespan">ArrayList</code> class includes many useful methods. For example, to add elements to the <code class="w3-codespan">ArrayList</code>, use the <code class="w3-codespan">add()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    import java.util.ArrayList;<br><br>public class MyClass {
    <br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; 
    ArrayList&lt;String&gt; cars = new ArrayList&lt;String&gt;();<br>&nbsp;&nbsp;&nbsp; cars.add(&quot;Volvo&quot;);<br>&nbsp;&nbsp;&nbsp; 
    cars.add(&quot;BMW&quot;);<br>&nbsp;&nbsp;&nbsp; cars.add(&quot;Ford&quot;);<br>&nbsp;&nbsp;&nbsp; 
    cars.add(&quot;Mazda&quot;);<br>&nbsp;&nbsp;&nbsp; System.out.println(cars);<br>&nbsp; } <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_add">Run example &raquo;</a>
</div>
<hr>

<h2>Access the Elements of an ArrayList</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_get">Run example &raquo;</a>
</div>
...
<h2>Change an ArrayList Element</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_set">Run example &raquo;</a>
</div>
<hr>

<h2>Remove an ArrayList Element</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_remove">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_clear">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_size">Run example &raquo;</a>
</div>
<hr>

<h2>Loop Through an ArrayList</h2>
<p>Loop through the ArrayList elements with a <code class="w3-codespan">for</code> loop, and use the <code class="w3-codespan">
...
<div class="w3-code notranslate javaHigh">
  ...
  cars.add(&quot;Volvo&quot;);<br>&nbsp;&nbsp;&nbsp; cars.add(&quot;BMW&quot;);<br>&nbsp;&nbsp;&nbsp; 
  cars.add(&quot;Ford&quot;);<br>&nbsp;&nbsp;&nbsp; cars.add(&quot;Mazda&quot;);<br>&nbsp;&nbsp;&nbsp; 
  for (int i = 0; i &lt; cars.size(); i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  System.out.println(cars.get(i));<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; } <br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_loop">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  ...
  System.out.println(i);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; } <br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_for_each">Run example &raquo;</a>
</div>
<hr>


<h2>Other Types</h2>
<p>Elements in an ArrayLists is actually objects. In the examples above, we created elements 
(objects) of type "String". Remember that a String in Java is an object (not a primitive type). To use other types, such as int, you must specify an equivalent wrapper class: <code class="w3-codespan">Integer</code>. For other primitive types, 
...
<p>Create an <code class="w3-codespan">ArrayList</code> to store numbers (add elements of type <code class="w3-codespan">Integer</code>):</p>
  <div class="w3-code notranslate javaHigh">
    import java.util.ArrayList;<br><br>public class MyClass {
    <br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; 
    ArrayList&lt;Integer&gt; myNumbers = new ArrayList&lt;Integer&gt;();<br>&nbsp;&nbsp;&nbsp; 
    myNumbers.add(10);<br>&nbsp;&nbsp;&nbsp; 
    myNumbers.add(15);<br>&nbsp;&nbsp;&nbsp; myNumbers.add(20;<br>&nbsp;&nbsp;&nbsp; 
    myNumbers.add(25);<br>&nbsp;&nbsp;&nbsp; System.out.println(myNumbers);<br>&nbsp; } <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_arraylist_integer">Run example &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_date.asp">&#10094; Previous</a>
