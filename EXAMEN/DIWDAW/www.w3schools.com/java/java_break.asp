...
<a class="w3-left w3-btn" href="java_for_loop.asp">&#10094; Previous</a>
...
<p>This example jumps out of the loop when i is equal to 4:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  for (int i = 0; i &lt; 10; i++) {<br>&nbsp; if (i == 4) {<br>&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp; }<br>&nbsp; System.out.println(i);<br>} <br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_break">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  for (int i = 0; i &lt; 10; i++) {<br>&nbsp; if (i == 4) {<br>&nbsp;&nbsp;&nbsp; 
  continue;<br>&nbsp; }<br>&nbsp; System.out.println(i);<br>} <br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_continue">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  ...
  int i = 0;<br>&nbsp;&nbsp;&nbsp; while (i &lt; 10) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  System.out.println(i);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i++;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (i == 4) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; } <br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_break_while">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_continue_while">Run example &raquo;</a>
</div>
