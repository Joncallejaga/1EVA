...
<html lang="en-US">
<head>
<title>Java Date and Time</title>
<meta charset="utf-8">
...
<td>Represents a time (hour, minute, second and microsecond (HH-mm-se-zzz))</td>
...
<td>Represents both a date and a time (yyyy-MM-dd-HH-mm-ss.zzz)</td>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    ...
    LocalDate class<br><br>public class MyClass {
    <br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; LocalDate myObj = LocalDate.now(); // Create a date object<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(myObj); // Display the current date<br>&nbsp; } <br>} </div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_date_localdate">Run example &raquo;</a>
</div>
<hr>

<h2>Display Current Time</h2>

<p>To display the current time (hour, minute, second, and microsecond), import the <code class="w3-codespan">java.time.LocalTime</code> class, and use its <code class="w3-codespan">now()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    import java.time.LocalTime; // import the 
    LocalTime class<br><br>public class MyClass {
    <br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; LocalTime myObj 
    = LocalTime.now();<br>&nbsp;&nbsp;&nbsp; System.out.println(myObj);<br>&nbsp; } <br>} </div>
<p>The output will be:</p>
<div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
<code>
<script>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_date_localtime">Run example &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    import java.time.LocalDateTime; // import the 
    LocalDateTime class<br><br>public class MyClass {
    <br>&nbsp; public static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; LocalDateTime 
    myObj = LocalDateTime.now();<br>&nbsp;&nbsp;&nbsp; System.out.println(myObj);<br>&nbsp; } <br>} </div>
<p>The output will be:</p>
<div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
<code>
<script>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_date_localdatetime">Run example &raquo;</a>
</div>
<hr>
...
The following example will remove both the &quot;T&quot; and microseconds from the date-time:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    import java.time.LocalDateTime; // Import the LocalDateTime class<br>import 
    java.time.format.DateTimeFormatter; // Import the DateTimeFormatter class<br>
    <br>public class MyClass {<br>&nbsp; public static void main(String[] args) 
    { <br>&nbsp;&nbsp;&nbsp; LocalDateTime myDateObj = LocalDateTime.now(); <br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;Before formatting: &quot; + myDateObj); <br>&nbsp;&nbsp;&nbsp; 
    DateTimeFormatter myFormatObj = DateTimeFormatter.ofPattern(&quot;dd-MM-yyyy 
    HH:mm:ss&quot;); <br><br>&nbsp;&nbsp;&nbsp; String formattedDate = 
    myDateObj.format(myFormatObj); <br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;After formatting: &quot; + formattedDate); <br>&nbsp; } <br>} </div>
<p>The output will be:</p>
<div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
<code>
<script>
...
var x = "After Formatting:" + " " +  d.getFullYear() + "-" + m + "-" + day + " " + h + ":" + n + ":" + s;
document.write(x);
</script>
</code>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_date_format">Run example &raquo;</a>
</div>
...
<td>&quot;1988-09-29&quot;</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_date_format">Try it &raquo;</a></td>
</tr>
<tr>
<td><i>dd/MM/yyyy</i></td>
<td>&quot;29/09/1988&quot;</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_date_formatter1">Try it &raquo;</a></td>
</tr>
<tr>
<td><i>dd-MMM-yyyy</i></td>
<td>&quot;29-Sep-1988&quot;</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_date_formatter2">Try it &raquo;</a></td>
</tr>
<tr>
<td><i>E, MMM dd yyyy</i></td>
<td>&quot;Thu, Sep 29 1988&quot;</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_date_formatter3">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
