...
<a class="w3-right w3-btn" href="java_math.asp">Next &#10095;</a>
</div>
<hr>
...
<p>A String contains a collection of characters surrounded by double quotes:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings">Run example &raquo;</a>
</div>
<hr>

<h2>Quotes Inside a String</h2>
<p>To use quotes inside a string, use single quotes (<code class="w3-codespan">'</code>):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String 
  answer1 = "It's alright";<br>String answer2 = "He is called 'Johnny'";</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_quotes">Run example &raquo;</a>
</div>
<hr>

<h2>String Length</h2>
<p>A String in Java is actually an object, which contains methods that can perform certain operations on strings. For example, the length of a string can be found with the <code class="w3-codespan">length()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String txt = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>int len = txt.length();<br>
  System.out.println(&quot;The length of the txt string is: &quot; + len);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_length">Run example &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String txt = &quot;Hello World&quot;;<br>System.out.println(txt.toUpperCase());&nbsp;&nbsp; 
  // Outputs &quot;HELLO WORLD&quot;<br>System.out.println(txt.toLowerCase());&nbsp;&nbsp; 
  // Outputs &quot;hello world&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_touppercase">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  ...
  System.out.println(txt.indexOf(&quot;locate&quot;)); // Outputs 7</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_indexof">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String firstName = &quot;John&quot;;<br>String lastName = &quot;Doe&quot;;<br>System.out.println(firstName 
  + &quot; &quot; + lastName); </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_conc">Run example &raquo;</a>
</div>
<div class="w3-note w3-panel"><p>Note that we have added an empty text (" ") to create a space between firstName and lastName on print.</p></div>
<p>You can also use the <code class="w3-codespan">concat()</code> method to concatenate two strings:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String firstName = &quot;John &quot;;<br>String lastName = &quot;Doe&quot;;<br>
  System.out.println(firstName.concat(lastName));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_conc2">Run example &raquo;</a>
</div>
<hr>
...
<p>WARNING!</p>
 <p>Java uses the + operator for both addition and concatenation.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_num1">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_num2">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  String x = &quot;10&quot;;<br>
  int y = 20;<br>
  String z = x + y;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// z will be 1020 (a 
  String) </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_num3">Run example &raquo;</a>
</div>
<!--
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_strings_new">Run example &raquo;</a>
</div>
...
You will learn more about objects in a later chapter.</p>
-->
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_operators.asp">&#10094; Previous</a>
