...
<a class="w3-right w3-btn" href="java_switch.asp">Next &#10095;</a>
</div>
<hr>
...
<h3 class="w3-light-grey w3-border" style="padding:6px 12px;margin-bottom:-16px;border-bottom:none!important">Syntax</h3>
<div class="w3-code w3-border notranslate">
  if (<em>condition</em>) {<br>&nbsp; <em>block of code to be executed if the 
  condition is <strong>true</strong></em><br>}</div>
...
<div class="w3-code notranslate javaHigh">
  if (20 &gt; 18) {<br>&nbsp; System.out.println(&quot;20 is greater than 18&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_if">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 20;<br>int y = 18;<br>if (x &gt; y) {<br>&nbsp; System.out.println(&quot;x is 
  greater than y&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_if2">Run example &raquo;</a>
</div>
...
<div class="w3-code w3-border notranslate">
  if (<em>condition</em>) {<br>&nbsp; <em>block of code to be executed if the 
  condition is <strong>true</strong></em><br>} else { <br>&nbsp; <em>block of code to be executed 
  if the condition is <strong>false</strong></em><br>}
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int time = 20;<br>if (time &lt; 18) {<br>&nbsp; System.out.println(&quot;Good 
  day.&quot;);<br>} else {<br>&nbsp; System.out.println(&quot;Good 
  evening.&quot;);<br>}<br>// Outputs &quot;Good evening.&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_if_else">Run example &raquo;</a>
</div>
<h4>Example explained</h4>
<p>In the example above, time (20) is greater than 18, so the condition is <code class="w3-codespan">false</code>, 
so we move on to the <code class="w3-codespan">else</code> condition and print to the screen "Good 
...
<h3 class="w3-light-grey w3-border" style="padding:6px 12px;margin-bottom:-16px;border-bottom:none!important">Syntax</h3>
<div class="w3-code w3-border notranslate">
  if (<em>condition1</em>) {<br>&nbsp; <em>block of code to be executed if 
  condition1 is <strong>true</strong></em><br>} else if (<em>condition2</em>) {<br>&nbsp; <em>block of 
  code to be executed if the condition1 is false and condition2 is <strong>true</strong></em><br>
  } else {<br>&nbsp; <em>block of code to be executed if the condition1 is false 
  and condition2 is <strong>false</strong></em><br>}</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int time = 22;<br>if (time &lt; 10) {<br>&nbsp; System.out.println(&quot;Good 
  morning.&quot;);<br>} else if (time &lt; 20) {<br>&nbsp; System.out.println(&quot;Good 
  day.&quot;);<br>} else {<br>&nbsp; System.out.println(&quot;Good evening.&quot;);<br>}<br>
  // Outputs &quot;Good evening.&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_if_else_if">Run example &raquo;</a>
</div>
<h4>Example explained</h4>
...
<h3 class="w3-light-grey w3-border" style="padding:6px 12px;margin-bottom:-16px;border-bottom:none!important">Syntax</h3>
<div class="w3-code w3-border notranslate">
  <em>variable</em> = (<em>condition</em>) ? <em>expressionTrue</em> : <em>
  expressionFalse</em>;</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int time = 20;<br>String result = (time &lt; 18) ? &quot;Good day.&quot; : &quot;Good evening.&quot;;<br>
  System.out.println(result);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_if_ternary">Run example &raquo;</a>
</div>
