...
<h3>Syntax</h3>
  <div class="w3-code notranslate javaHigh">
    import <em>package</em>.<em>name</em>.<em>Class</em>;   // Import a single class <br>
...
<p>Using the <code class="w3-codespan">Scanner</code> class to get user input:</p>
  <div class="w3-code notranslate javaHigh">
    import java.util.Scanner;<br><br>class MyClass {<br>&nbsp; public static 
    void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; Scanner myObj = new 
    Scanner(System.in);<br>&nbsp;&nbsp;&nbsp; String userName;<br><br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;Enter username&quot;);<br>&nbsp;&nbsp;&nbsp; userName = 
    myObj.nextLine(); <br><br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Username 
    is: &quot; + userName); <br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_api_scanner">Run example &raquo;</a>
</div>
<hr>
...
<p>To create your own package, you need to understand that Java use a file system directory to store them. Just like folders on your computer:</p>
<div class="w3-example">
<h3>Example</h3>
...
<h3>MyPackageClass.java</h3>
  <div class="w3-code notranslate javaHigh">
    package mypack;<br><br>class MyPackageClass { <br>&nbsp; public 
    static void main(String[] args) { <br>&nbsp;&nbsp;&nbsp; 
    System.out.println(&quot;This is my package!&quot;); <br>&nbsp; } <br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_package">Run example &raquo;</a>
</div>
