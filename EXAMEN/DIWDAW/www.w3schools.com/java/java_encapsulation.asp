...
<html lang="en-US">
<head>
<title>Java Encapsulation and Getters and Setters</title>
<meta charset="utf-8">
...
<ul>
<li>declare class variables/attributes as <code class="w3-codespan">private</code> (only 
accessible within the same class)</li>
<li>provide public <strong>setter</strong> 
and <strong>getter</strong> methods to access and update the value of a <code class="w3-codespan">private</code> 
variable</li>
</ul>
...
accessed within the same class (an outside class have no access to it). However, 
it is possible to access them if we provide public <strong>getter</strong> and <strong>setter</strong> methods.</p>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    public class Person {<br>&nbsp; private String name; // private = restricted 
    access<br><br>&nbsp; // Getter<br>&nbsp; public String getName() {<br>&nbsp;&nbsp;&nbsp; 
    return name;<br>&nbsp; }<br><br>&nbsp; // Setter<br>&nbsp; public void 
    setName(String newName) {<br>&nbsp;&nbsp;&nbsp; this.name = newName;<br>&nbsp; }<br>
    }</div>
</div>
<h4>Example explained</h4>
<p>The get method returns the value of the variable <strong>name</strong>.</p>
<p>The set method takes a parameter (<strong>newName</strong>) and assigns it to the
<strong>name</strong> variable. The <code class="w3-codespan">this</code> keyword is used to refer to the current 
object.</p>
<p>However, as the <strong>name</strong> variable is declared as <code class="w3-codespan">private</code>, we 
<strong>cannot</strong> access it from outside this class:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    public class 
    MyClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
    Person myObj = new Person();<br>&nbsp;&nbsp;&nbsp; myObj.name = &quot;John&quot;;&nbsp; 
    // error<br>&nbsp;&nbsp;&nbsp; System.out.println(myObj.name); // error&nbsp; <br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_getset_error">Run example &raquo;</a>
</div>
...
<p>Instead, we use the <code class="w3-codespan">getName()</code> and <code class="w3-codespan">setName()</code> methods to acccess and update the variable:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    public class 
    MyClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
    Person myObj = new Person();<br>&nbsp;&nbsp;&nbsp; myObj.setName(&quot;John&quot;); 
    // Set the value of the name variable to &quot;John&quot;<br>&nbsp;&nbsp;&nbsp; 
    System.out.println(myObj.getName());<br>&nbsp; }<br>}<br><br>// Outputs 
    &quot;John&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava_file.asp?filename=demo_getset">Run example &raquo;</a>
</div>
<hr>
...
<li>Class variables can be made <strong>read-only</strong> (if you omit the set method), or <strong>write-only</strong> (if you omit the get method)</li>
