...
<p>In the previous chapter, we used the term "variable" for x in the example (as shown below). It is actually an 
<strong>attribute</strong> of the class. Or you could say that class attributes are variables within a class:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a class called "<code class="w3-codespan">MyClass</code>&quot; with two attributes: <code class="w3-codespan">x</code> and <code class="w3-codespan">y</code>:</p>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x = 5;<br>&nbsp; int y = 3;<br>}<br>
 </div>
</div>
...
<p>The following example will create an object of the <code class="w3-codespan">MyClass</code> class, with the 
...
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x = 5;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_attributes">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  myObj.x = 40;<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_attributes2">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x = 10;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  myObj.x = 25; // x is now 25<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x); <br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_attributes3">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; <strong>final</strong> int x = 10;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new MyClass();<br>&nbsp;&nbsp;&nbsp; myObj.x = 25; // will generate an error: cannot assign a value to a 
  <strong>final</strong> 
  variable<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x); <br>&nbsp; }<br>}<br>
 </div>
...
<div class="w3-note w3-panel">
<p>The <code class="w3-codespan">final</code> keyword is useful when you want a variable to always store the same value.</p>
...
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; int x = 5;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj1 = new MyClass();&nbsp; 
  // Object 1<br>&nbsp;&nbsp;&nbsp; 
  MyClass myObj2 = new MyClass();&nbsp; // Object 2<br>&nbsp;&nbsp;&nbsp; myObj2.x = 25;<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj1.x);&nbsp; // Outputs 5<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj2.x);&nbsp; // Outputs 25<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_attributes_multi_obj">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class Person {<br>&nbsp; String fname = &quot;John&quot;;<br>&nbsp; String lname = 
  &quot;Doe&quot;;<br>&nbsp; int age = 24;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; Person myObj = new Person();<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Name: &quot; + myObj.fname + &quot; &quot; + myObj.lname);<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Age: &quot; + myObj.age);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_attributes_multiple">Run example &raquo;</a>
</div>
