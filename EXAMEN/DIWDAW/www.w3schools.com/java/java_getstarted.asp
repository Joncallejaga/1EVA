...
<p>If you do not have Java installed on your computer, you can download it for free from <a href="https://www.oracle.com/technetwork/java/javase/overview/index.html" target="_blank">oracle.com</a>.</p>
<hr>
...
-->
<button onclick="myAccFunction('DemoAcc')" class="w3-btn w3-block w3-left-align xx w3-border-bottom">Show how to install Java step-by-step with images &raquo;</button>
<div id="DemoAcc" class="w3-hide w3-light-grey w3-padding-16 w3-container">
<h2 style="margin-top:0">Step 1</h2>
<img src="system.png" class="w3-image">
</div>

<button onclick="myAccFunction('DemoAcc2')" class="w3-btn w3-block w3-left-align xx w3-border-bottom">Step 2 &raquo;</button>
<div id="DemoAcc2" class="w3-hide w3-light-grey w3-padding-16 w3-container">
<h2 style="margin-top:0">Step 2</h2>
<img src="system1.png" class="w3-image">
</div>
<button onclick="myAccFunction('DemoAcc3')" class="w3-btn w3-block w3-left-align xx w3-border-bottom">Step 3 &raquo;</button>
<div id="DemoAcc3" class="w3-hide w3-light-grey w3-padding-16 w3-container">
<h2 style="margin-top:0">Step 3</h2>
<img src="path2.png" class="w3-image">
</div>
<button onclick="myAccFunction('DemoAcc4')" class="w3-btn w3-block w3-left-align xx w3-border-bottom">Step 4 &raquo;</button>
<div id="DemoAcc4" class="w3-hide w3-light-grey w3-padding-16 w3-container">

<h2 style="margin-top:0">Step 4</h2>
<img src="path3.png" class="w3-image">
</div>
<button onclick="myAccFunction('DemoAcc5')" class="w3-btn w3-block w3-left-align xx w3-border-bottom">Step 5 &raquo;</button>
...
<p>Let's create our first Java file, called MyClass.java, which can be done in any text editor 
(like Notepad).</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  System.out.println(&quot;Hello World&quot;);<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava_file.asp?filename=demo_helloworld">Run example &raquo;</a>
</div>
...
<p>Save the code in Notepad as "MyClass.java". Open Command Prompt (cmd.exe), navigate to the directory where you saved your file, and type "javac 
MyClass.java":</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;javac MyClass.java
</div>
</div>
<p>This will compile your code. If there are no errors in the code, the command prompt will take you to the next line. 
Now, type "java MyClass" to run the file:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;java MyClass
</div>
</div>
