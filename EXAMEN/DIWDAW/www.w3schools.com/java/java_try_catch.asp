...
<html lang="en-US">
<head>
<title>Java Exceptions (Try...Catch)</title>
<meta charset="utf-8">
...
<h1>Java Exceptions - <span class="color_h1">Try...Catch</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_methods.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Exceptions</h2>
<p>When executing Java code, different errors can occur: coding errors made by the programmer, errors due to wrong input, 
or other unforeseeable things.</p>
<p>When an error occurs, Java will normally stop and generate an error message. The technical term for this is: Java will throw an <b>exception</b> (throw an error).</p>
<hr>

<h2>Java try and catch</h2>
<p>The <code class="w3-codespan">try</code> statement allows you to define a block of code to be 
tested for errors while it is being executed.</p>
<p>The <code class="w3-codespan">catch</code> statement allows you to define a block of code to 
be executed, if an error occurs in the try block.</p>
<p>The <code class="w3-codespan">try</code> and <code class="w3-codespan">catch</code> keywords 
come in pairs:</p>
...
<p>This example will generate an error, because <strong>myNumbers[10]</strong> does not exist.</p>

<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; public static void main(String[ ] args) {<br>&nbsp;&nbsp;&nbsp; int[] 
  myNumbers = new int[5];<br>&nbsp;&nbsp;&nbsp; System.out.println(myNumbers[10]);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_try_error">Run example &raquo;</a>
</div>
<p>The output (error) will be something like this:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
  Exception in thread &quot;main&quot; java.lang.ArrayIndexOutOfBoundsException: 10<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  at MyClass.main(MyClass.java:4)</div>
</div>

<p>If an error occur, we can use <code class="w3-codespan">try...catch</code> to catch the error and execute some code to handle it:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; public static void main(String[ ] args) {<br>&nbsp;&nbsp;&nbsp; 
  try {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; int[] 
  myNumbers = new int[5];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(myNumbers[10]);<br>&nbsp;&nbsp;&nbsp; 
  } catch (Exception e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Something went wrong.&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br>
  // Outputs &quot;Something went wrong.&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_try_catch">Run example &raquo;</a>
</div>
<hr>

<h2>Finally</h2>
<p>The <code class="w3-codespan">finally</code> statement lets you execute code, after <code class="w3-codespan">try...catch</code>, regardless of the result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
  try {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; int[] myNumbers = new int[5];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  System.out.println(myNumbers[10]);<br>&nbsp;&nbsp;&nbsp; } catch (Exception e) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(&quot;Something went 
  wrong.&quot;);<br>&nbsp;&nbsp;&nbsp; 
  } finally {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(&quot;The 'try 
  catch' is finished.&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br><br>
  // Something went wrong.<br>// The 'try catch' is finished.<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_try_catch_finally">Run example &raquo;</a>
</div>
<!--
<hr>
...
<p>The <code class="w3-codespan">throw</code> statement allows you to create a custom error.</p>
<p>The <code class="w3-codespan">throw</code> statement is used together with an <strong>exception type</strong>. There are many exception types available in Java: <code class="w3-codespan">ArithmeticException</code>, <code class="w3-codespan">ClassNotFoundException</code>, <code class="w3-codespan">ArrayIndexOutOfBoundsException</code>, <code class="w3-codespan">SecurityException</code>, etc.</p>
<p>The exception type is often used together with a custom <strong>method</strong>. Don't worry if you don't understand the example below, you will learn more about methods in the next chapter:</p>
...
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; static void checkAge(int age) { <br>&nbsp;&nbsp;&nbsp; if(age &lt; 18) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  throw new ArithmeticException(&quot;Access denied - You must be at least 18 years 
  old.&quot;); <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; System.out.println(&quot;Access granted - You are old 
  enough!&quot;); <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; } <br><br>&nbsp; public static void main(String[] args) { <br>
  &nbsp;&nbsp;&nbsp;
  checkAge(15); // Set age to 15 (which is below 18...)<br>&nbsp; } <br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_throw">Run example &raquo;</a>
</div>
<p>If <strong>age</strong> was 20, you would <strong>not</strong> get an exception:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    checkAge(20);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_throw2">Run example &raquo;</a>
</div>
