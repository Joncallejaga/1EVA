...
<h3>MyClass.java</h3>
<p>Create a class called "<code class="w3-codespan">MyClass</code>&quot; with a 
variable x:</p>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x = 5;<br>}<br>
 </div>
</div>
...
<p>In Java, an object is created from a class. We have already created the class named <code class="w3-codespan">MyClass</code>, 
so now we can use this to create objects.</p>
<p>To create an object of <code class="w3-codespan">MyClass</code>, 
...
<div class="w3-code notranslate javaHigh">
  ...
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass <strong>myObj</strong> = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_class">Run example &raquo;</a>
</div>
<hr>

<h2>Multiple Objects</h2>
<p>You can also create multiple objects of one class:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create two objects of <code class="w3-codespan">MyClass</code>:</p>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; int x = 5;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass <strong>myObj1</strong> = new MyClass();&nbsp; 
  // Object 1<br>&nbsp;&nbsp;&nbsp; 
  MyClass <strong>myObj2</strong> = new MyClass();&nbsp; // Object 2<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj1.x);<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj2.x);<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_class_multi_obj">Run example &raquo;</a>
</div>
...
<h4>MyClass.java</h4>
<div class="w3-code notranslate javaHigh">
  public class MyClass {<br>&nbsp; int x = 5;<br>}<br>
 </div>
</div>
<div class="w3-example">
...
<div class="w3-code notranslate javaHigh">
  class 
  OtherClass {<br>&nbsp; 
  public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass <strong>myObj</strong> = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x);<br>&nbsp; }<br>}<br>
 </div>
</div>
...
C:\Users\<em>Your Name</em>&gt;javac MyClass.java<br>
...
<div class="w3-padding notranslate w3-black w3-margin-top">
  <code>5</code></div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="showjava.asp?filename=demo_class_two">Run example &raquo;</a>
</div>
