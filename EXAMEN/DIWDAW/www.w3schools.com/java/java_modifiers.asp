...
<div class="w3-code notranslate javaHigh">
  <strong>public</strong> class MyClass</div>
</div>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_mod_public">Try it &raquo;</a></td>
</tr>
<tr>
<td><em>default</em></td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_mod_default">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava_file.asp?filename=demo_mod_public2">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">private</code></td>
<td>The code is only accessible within the declared class</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_access_mod">Try it &raquo;</a></td>
</tr>
<tr>
<td><em>default</em></td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_mod_default2">Try it &raquo;</a></td>
</tr>
<tr>
...
superclasses in the <a href="java_inheritance.asp">Inheritance chapter</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_mod_protected">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_access_mod">Run example &raquo;</a>
</div>
<hr>
-->
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava.asp?filename=demo_mod_final">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">abstract</code></td>
<td>The class cannot be used to create objects (To access an abstract class, it must be inherited from another class. You will learn more about inheritance in the <a href="java_inheritance.asp">Inheritance chapter</a>)</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="showjava_file.asp?filename=demo_mod_abstract">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
subclass (inherited from). You will learn more about inheritance in the <a href="java_inheritance.asp">Inheritance chapter</a></td>
</tr>
<tr>
...
<h2>Final</h2>
<p>If you don't want the ability to override existing attribute values, declare variables as <code class="w3-codespan">final</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public
  class MyClass {<br>&nbsp; <strong>final</strong> int x = 10;<br>&nbsp; <strong>final</strong> 
  double PI = 3.14;<br><br>&nbsp; public static void 
  main(String[] args) {<br>&nbsp;&nbsp;&nbsp; MyClass myObj = new MyClass();<br>&nbsp;&nbsp;&nbsp; 
  myObj.x = 50; // will generate an error: cannot assign a value to a 
  <strong>final</strong> 
  variable<br>&nbsp;&nbsp;&nbsp; myObj.PI = 25; // will generate an error: cannot assign a value to a 
  <strong>final</strong> 
  variable<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(myObj.x); <br>&nbsp; }<br>}<br>
 </div>
</div>
<hr>

<h2>Static</h2>
<p>A <code class="w3-codespan">static</code> method means that it belongs to the class, and cannot be accessed from outside of the class, unlike <code class="w3-codespan">public</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  public
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Code from filename: Person.java <br>// abstract class<br>abstract class 
  Person {<br>&nbsp; public String fname = &quot;John&quot;;<br>&nbsp; 
  public int age = 24;<br>&nbsp; public <strong>abstract</strong> void study(); // abstract 
  method <br>}<br><br>// Subclass (inherit 
  from Person)<br>class Student extends Person {<br>&nbsp; public int 
  graduationYear = 2018;<br>&nbsp; public void study() { // the body of the 
  abstract method is provided here<br>&nbsp;&nbsp;&nbsp; 
  System.out.println(&quot;Studying all day long&quot;);<br>&nbsp; }<br>}<br>
  // End code from filename: Person.java<br><br>// Code from filename: 
  MyClass.java<br>class MyClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; // create 
  an object of the Student class (which inherits attributes and methods from 
  Person)<br>&nbsp;&nbsp;&nbsp; Student myObj = new Student(); <br><br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Name: &quot; 
  + myObj.fname);<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Age: &quot; + myObj.age);<br>
  &nbsp;&nbsp;&nbsp;
  System.out.println(&quot;Graduation Year: &quot; + myObj.graduationYear);<br>
  &nbsp;&nbsp;&nbsp;
  myObj.study(); // call abstract method<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava_file.asp?filename=demo_mod_abstract2">Run example &raquo;</a>
</div>
