...
<a class="w3-right w3-btn" href="java_data_types.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  <em>type</em> <em>variable</em> = <em>value</em>;</div>
</div>
...
<em>variable</em> is the name of the variable (such as <strong>x</strong> or
...
<div class="w3-code notranslate javaHigh">
  String
  name = "John";<br>System.out.println(name);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  int myNum = 15;<br>System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables_int">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum;<br>myNum = 15;<br>System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables_int2">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum = 5;<br>float myFloatNum = 5.99f;<br>char myLetter = 'D';<br>boolean 
  myBool = true;<br>String myText = &quot;Hello&quot;;</div>
</div>
<div class="w3-note w3-panel">
<p>You will learn more about data types in the next chapter.</p>
</div>
<hr>

<h2>Display Variables</h2>
<p>The <code class="w3-codespan">println()</code> method is often used to display variables.</p>
<p>To combine both text and a variable, use the <code class="w3-codespan">+</code> character:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String name = &quot;John&quot;;<br>System.out.println(&quot;Hello &quot; + name);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables2">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String firstName = &quot;John &quot;;<br>String lastName = &quot;Doe&quot;;<br>String fullName = 
  firstName + lastName;<br>System.out.println(fullName); </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables3">Run example &raquo;</a>
</div>

<p>For numeric values, the <code class="w3-codespan">+</code> character works as a mathematical operator (notice that we use <code class="w3-codespan">int</code> (integer) variables here):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int
  x = 5;<br>int y = 6;<br>System.out.println(x + y); // Print the value of x + y </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables4">Run example &raquo;</a>
</div>
...
<ul>
 ...
 <li>Then we use the <code class="w3-codespan">println()</code> method to display the value of x + y, 
 which is <strong>11</strong></li>
</ul>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 5, y = 6, z = 50;<br>System.out.println(x + y + z);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_variables5">Run example &raquo;</a>
</div>

<hr>

<h2>Java Identifiers</h2>
<p>All Java <strong>variables</strong> must be
...
<ul>
  ...
  <li>Names must start with a lowercase letter and it cannot contain whitespace</li>
  <li>Reserved words (like Java keywords, such as <code class="w3-codespan">int</code> or 
  <code class="w3-codespan">String</code>) cannot be used as names</li>
</ul>
