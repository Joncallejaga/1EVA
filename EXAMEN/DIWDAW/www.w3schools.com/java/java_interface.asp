...
<p></p>
<p>An <code class="w3-codespan">interface</code> is an abstract <strong>class</strong> that is used to group related methods with 
&quot;empty&quot; bodies:</p>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    ...
    Animal {<br>&nbsp; public void animalSound(); // interface method (does not 
    have a body)<br>&nbsp; public void run(); // interface method (does not have 
    a body)<br>}</div>
</div>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    ...
    interface
    Animal {<br>&nbsp; public void animalSound(); // interface method (does not 
    have a body)<br>&nbsp; public void sleep(); // interface method (does not have 
    a body)<br>}<br>
    <br>// Pig &quot;implements&quot; the Animal interface<br>class Pig <strong>implements</strong> Animal {<br>&nbsp; 
    public void animalSound() {<br>&nbsp;&nbsp;&nbsp; // The body of 
    animalSound() is provided here<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;The 
    pig says: wee wee&quot;);<br>&nbsp; }<br>&nbsp; 
    public void sleep() {<br>&nbsp;&nbsp;&nbsp; // The body of sleep() is 
    provided here<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Zzz&quot;);<br>&nbsp; }<br>}<br><br>class 
    MyMainClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
    Pig myPig = new Pig();&nbsp; // Create a Pig object<br>&nbsp;&nbsp;&nbsp; myPig.animalSound();<br>&nbsp;&nbsp;&nbsp; 
    myPig.sleep();<br>&nbsp; 
    }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_interface">Run example &raquo;</a>
</div>
<div class="w3-note w3-panel">
<h4>Notes on Interfaces:</h4>
<ul>
<li>It <strong>cannot</strong> be used to create objects (in the example above, 
it is not possible to create an &quot;Animal&quot; object in the MyMainClass)</li>
  <li>Interface methods does not have a body - the 
...
details of an object (interface).</p>
  <p>Java does not support &quot;multiple inheritance&quot; (a class can only inherit from one superclass). However, it can be achieved 
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    interface
    FirstInterface {<br>&nbsp; public void myMethod(); // interface method<br>}<br>
    <br>interface
    SecondInterface {<br>&nbsp; public void myOtherMethod(); // interface method<br>}<br>
    <br>// DemoClass &quot;implements&quot; FirstInterface and SecondInterface<br>class 
    DemoClass implements<strong> FirstInterface, SecondInterface</strong> {<br>&nbsp; 
    public void myMethod() {<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Some 
    text..&quot;);<br>&nbsp; }<br>&nbsp; 
    public void myOtherMethod() {<br>&nbsp;&nbsp;&nbsp; System.out.println(&quot;Some 
    other text...&quot;);<br>&nbsp; }<br>}<br><br>class 
    MyMainClass {<br>&nbsp; public static void main(String[] args) {<br>&nbsp;&nbsp;&nbsp; 
    DemoClass myObj = new DemoClass();<br>&nbsp;&nbsp;&nbsp; myObj.myMethod();<br>&nbsp;&nbsp;&nbsp; 
    myObj.myOtherMethod();<br>&nbsp; 
    }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_interface_multi">Run example &raquo;</a>
</div>
