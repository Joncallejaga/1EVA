...
<h1>Java <span class="color_h1">Booleans</span></h1>
...
<p>For this, Java has a <code class="w3-codespan">boolean</code> data type, which can take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<hr>
...
<p>A <strong>Boolean expression</strong> is a Java expression that returns a Boolean value: <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<p>You can use a comparison operator, such as the <strong>greater than</strong> (<code class="w3-codespan">&gt;</code>) operator to find out if an expression (or a variable) is true:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>int y = 9;<br>System.out.println(x &gt; y); // returns true, because 10 is higher than 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_booleans1">Run example &raquo;</a>
</div>
<p>Or even easier:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  System.out.println(10 &gt; 9); // returns true, because 10 is higher than 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_booleans2">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>System.out.println(x == 10); // returns true, because the value 
  of x is equal to 10</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_booleans3">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  System.out.println(10 == 15); // returns false, because 10 is not equal to 15</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_booleans4">Run example &raquo;</a>
</div>
<div class="w3-panel w3-note">
<p>The Boolean value of an expression is the basis for all Java comparisons and conditions.</p>
<p>You will learn more about conditions in the next chapter.</p>
</div>
