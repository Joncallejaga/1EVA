    ...
    <div id='nav_tutorials' class='w3-bar-block w3-card-2' style="display:none;">
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m4'>
          ...
          <a class="w3-bar-item w3-button" href='default.asp'>Learn Java</a>
...
<h1>Java <span class="color_h1">Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables.asp">&#10094; Previous</a>
...
<div class="w3-code notranslate javaHigh">
  int myNum = 5;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // integer (whole number)<br>float myFloatNum = 5.99f;&nbsp;&nbsp;&nbsp; 
  // floating point number<br>char myLetter = 'D';&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // character<br>boolean 
  myBool = true;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // boolean<br>String myText = &quot;Hello&quot;;&nbsp;&nbsp;&nbsp;&nbsp; 
  // String</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_data_types">Run example &raquo;</a>
</div>
...
<ul>
 ...
 <li>Non-primitive data types - such as <a href="java_strings.asp">String</a>, <a href="java_arrays.asp">Arrays</a> and  <a href="java_classes.asp">Classes</a> (you will learn more about these in a later chapter)</li>
</ul>
...
<p>The are eight primitive data types in Java:</p>
...
<td>float</td>
<td>4 bytes</td>
<td>Stores fractional numbers from 3.4e&#8722;038 to 3.4e+038. Sufficient for 
storing 6 to 7 decimal digits</td>
</tr>
<tr>
<td>double</td>
<td>8 bytes</td>
<td>Stores fractional numbers from 1.7e&#8722;308 to 1.7e+038. Sufficient for 
...
<p><strong>Integer types</strong> stores whole numbers, positive or negative (such as 123 or -456), without decimals. 
Valid types are <code class="w3-codespan">byte</code>, <code class="w3-codespan">short</code>, <code class="w3-codespan">int</code> 
and <code class="w3-codespan">long</code>. Which type you should use, depends on the numeric value.</p>
<p><strong>Floating point types</strong> represents numbers with a fractional part, 
containing one or more decimals. There are two types: <code class="w3-codespan">float</code> and <code class="w3-codespan">double</code>.</p>
<div class="w3-note w3-panel">
<p>Even though there are many numeric types in Java, the most used for numbers 
...
<h2>Integer Types</h2>
<h3>Byte</h3>
<p>The <code class="w3-codespan">byte</code> data type can store whole numbers 
from -128 and 127. This can be used instead of <code class="w3-codespan">int</code> or other integer types to 
save memory when you are certain that the value will be within -128 and 127:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  byte myNum = 100;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_byte">Run example &raquo;</a>
</div>

<h3>Short</h3>
<p>The <code class="w3-codespan">short</code> data type can store whole numbers from -32768 to 32767:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  short myNum = 5000;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_short">Run example &raquo;</a>
</div>

<h3>Int</h3>
<p>The <code class="w3-codespan">int</code> data type can store whole numbers from -2147483648 to 2147483647. <!-- This is used when short and byte is not large enough. --> In general, and in our tutorial, the <code class="w3-codespan">int</code> data type is 
...
<div class="w3-code notranslate javaHigh">
  int myNum = 100000;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_int">Run example &raquo;</a>
</div>

<h3>Long</h3>
<p>The <code class="w3-codespan">long</code> data type can store whole numbers from -9223372036854775808 to 9223372036854775808. This is used when int is not large enough to store the value. Note that you should end the value with an "L":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  long myNum = 15000000000L;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_long">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
  <span style="color:mediumblue">float</span> myNum = <span style="color:red">5.75f</span>;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_float">Run example &raquo;</a>
</div>

<h3>Double</h3>
<p>The <code class="w3-codespan">double</code> data type can store fractional numbers from 1.7e&#8722;308 to 1.7e+038. Note that you should end the value with a "d":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
  <span style="color:mediumblue">double</span> myNum = <span style="color:red">19.99</span>d;<br>
  System.out.println(myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_double">Run example &raquo;</a>
</div>

<div class="w3-note w3-panel">
<p>Use <code class="w3-codespan">float</code> or <code class="w3-codespan">double</code>?</p>
...
<h3>Example</h3>
<div class="w3-code notranslate">
  <span style="color:mediumblue">float</span> f1 = <span style="color:red">35e3f</span>;<br>
  <span style="color:mediumblue">double</span> d1 = <span style="color:red">12E4</span>d;<br>
  System.out.println(f1);<br>
  System.out.println(d1);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_scientific">Run example &raquo;</a>
</div>
<hr>
<h2>Booleans</h2>
<p>A boolean data type is declared with the <code class="w3-codespan">boolean</code> keyword and can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  boolean isJavaFun = true;<br>boolean isFishTasty = false;<br>
  System.out.println(isJavaFun);&nbsp;&nbsp;&nbsp;&nbsp; // Outputs true<br>
  System.out.println(isFishTasty);&nbsp;&nbsp; // Outputs false </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_booleans">Run example &raquo;</a>
</div>
<p>Boolean values are mostly used for conditional testing, which you will learn more about in a later chapter.</p>
<hr>
<h2>Characters</h2>
<p>The <code class="w3-codespan">char</code> data type is used to store a 
...
<div class="w3-code notranslate javaHigh">
  char myGrade = 'B';<br>
  System.out.println(myGrade);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_char">Run example &raquo;</a>
</div>
<hr>

<h2>Strings</h2>
<p>The <code class="w3-codespan">String</code> data type is used to store a sequence of characters (text). String values must be surrounded by double quotes:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  String greeting = "Hello World";<br>System.out.println(greeting);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_type_string">Run example &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p>The String data type is so much used and integrated in Java, that some call it "the special 
<strong>ninth</strong> type".</p>
<p>A String in Java is actually a non-primitive data type, because it refers to 
an object. The String object has methods that is used to perform certain 
operations on strings. <strong>Don't worry if you don't understand the term "object" just yet</strong>. We will learn more about strings and objects in a later chapter.</p>
</div>
<hr>

<h2>Non-Primitive Data Types</h2>
<p>Non-primitive data types are called <strong>reference types</strong> because 
they refer to objects.</p>
<p>The main difference between primitive and non-primitive data types are:</p>

<ul>
<li>Primitive types are predefined (already defined) in Java. Non-primitive types are created by the programmer and not defined by Java (except for String).</li>
<li>Non-primitive types can be used to call methods to perform certain operations, while primitive types cannot.</li>
<li>A primitive type has always a value, while non-primitve types can be <strong>null</strong>.</li>
...
<p>Examples of non-primitive types are String, Arrays, Classes, Interface, etc. You will learn more about these in a later chapter.</p>
