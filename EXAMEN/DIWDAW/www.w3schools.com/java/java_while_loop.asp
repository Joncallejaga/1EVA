...
<div class="w3-code notranslate javaHigh">
  int i = 0;<br>while (i &lt; 5) {<br>
  &nbsp;&nbsp;System.out.println(i);<br>
&nbsp;&nbsp;i++;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_while_loop">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  int i = 0;<br>do {<br>
  &nbsp;&nbsp;System.out.println(i);<br>
&nbsp;&nbsp;i++;<br>}<br>while (i &lt; 5) ;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_do_while_loop">Run example &raquo;</a>
</div>
