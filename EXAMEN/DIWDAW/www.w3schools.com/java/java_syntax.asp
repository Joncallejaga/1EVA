...
<a class="w3-right w3-btn" href="java_comments.asp">Next &#10095;</a>
</div>
<hr>
...
In our example, we named the class <strong>MyClass</strong>. A class should always start with 
an uppercase first letter.</p>
<p><strong>Note:</strong> Java is case-sensitive: &quot;Hello&quot; and &quot;hello&quot; has 
different meaning.</p>
...
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  public static void <strong>main</strong>(String[] args)</div>
</div>
<p>Any code inside the <code class="w3-codespan">main()</code> method will be executed. You don't have to understand the keywords before and after main. You will get to know 
...
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  public static void main(String[] args) {<br>&nbsp;<strong> 
  System.out.println(&quot;Hello World&quot;);</strong><br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava_file.asp?filename=demo_helloworld">Run example &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p><strong>Note:</strong> In Java, each code statement must end with a semicolon.</p></div>
