...
<table style="border:0;width:100%">
  <tr>
    <td style="width:33%">
    <ul>
      <li><a href="asp_ref_vbscript_functions.asp#date">Date/Time functions</a></li>
      <li><a href="asp_ref_vbscript_functions.asp#conversion">Conversion functions</a></li>
      <li><a href="asp_ref_vbscript_functions.asp#format">Format functions</a></li>
    </ul>
    </td>
    <td style="width:33%">
    <ul>
      <li><a href="asp_ref_vbscript_functions.asp#math">Math functions</a></li>
      <li><a href="asp_ref_vbscript_functions.asp#array">Array functions</a></li>
    </ul>
    </td>
    <td style="width:34%">
    <ul>
      <li><a href="asp_ref_vbscript_functions.asp#string">String functions</a></li>
      <li><a href="asp_ref_vbscript_functions.asp#other">Other functions</a></li>
    </ul>
    </td>
  </tr>
</table>
