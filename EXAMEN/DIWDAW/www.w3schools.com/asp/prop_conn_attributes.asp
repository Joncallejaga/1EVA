...
<hr>
<a href="ado_ref_connection.asp" class="w3-btn w3-white w3-border" title="Connection Object Reference">&#10094; Complete Connection Object Reference</a>
<hr>
...
<hr>
<h2>Example - For a Connection object</h2><div class="w3-code w3-border notranslate"><div>
...
<hr>
<h2>Example - For a Field object</h2><div class="w3-code w3-border notranslate"><div>
...
<hr>
<h2>Example - For a Property object</h2><div class="w3-code w3-border notranslate"><div>
...
<h2>XactAttributeEnum Values</h2>
<table class="w3-table-all notranslate">
  <tr>
...
<h2>ParameterAttributesEnum Values</h2>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:30%">Constant</th>
    <th style="width:10%">Value</th>
...
<h2>FieldAttributeEnum Values</h2>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:30%">Constant</th>
    <th style="width:10%">Value</th>
...
<h2>PropertyAttributesEnum Values</h2>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:30%">Constant</th>
    <th style="width:10%">Value</th>
