...
<html lang="en-US">
<head>
<title>HTML DOM Input Text size Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">size</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_size2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the width of the text field, in characters. Default value  is 20</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of the text field, in number of characters</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the width of a text field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myText&quot;).size;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">30</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_size">Try it Yourself &raquo;</a>
</div>
<hr>
