...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms">Try it Yourself &raquo;</a>
</div>
...
source code.</p>
<p><strong>Tip:</strong> Use the <a href="coll_form_elements.asp">elements</a> 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;form&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An <a href="dom_obj_htmlcollection.asp">HTMLCollection</a> Object, representing all &lt;form&gt; elements in the document. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms4">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
 <p>Get the HTML content of the &lt;form&gt; element with id=&quot;myCarForm&quot; in the document:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.forms.namedItem(&quot;myCarForm&quot;).innerHTML;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms5">Try it Yourself &raquo;</a>
</div>
<br>
...
form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.forms;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].id + &quot;&lt;br&gt;&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms2">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 var x = document.forms[0];<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.elements[i].value + &quot;&lt;br&gt;&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_forms6">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="dom_obj_form.asp">HTML DOM Form Object</a></p>
<p>JavaScript reference: <a href="coll_form_elements.asp">Form elements Collection</a></p>
<p>HTML tutorial: <a href="../html/html_forms.asp">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_form.asp">HTML &lt;form&gt; tag</a></p>
<hr>
