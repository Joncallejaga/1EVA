...
<html lang="en-US">
<head>
<title>TouchEvent metaKey Property</title>
<meta charset="utf-8">
...
<h1>TouchEvent <span class="color_h1">metaKey</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out whether or not the &quot;META&quot; key was pressed when you touch the screen:</p>
<div class="w3-code notranslate jsHigh">
 if (event.metaKey) {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The META key was pressed!&quot;);<br>
 } else {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The META key was NOT pressed!&quot;);<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_metakey" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The metaKey property returns a Boolean value that indicates whether or not the &quot;META&quot; key was pressed when a 
touch event was triggered.</p>
<p><strong>Note:</strong> Many touch devices do not have an &quot;META&quot; key, and will
therefore always return false.</p>
<p>On Mac keyboards, the META key is represented by the the "Command/Cmd" ("&#8984;") key.</p>
...
<tr>
 ...
 <p>Possible values:</p>
 <ul>
    <li>true - The meta key was pressed</li>
    <li>false - The meta key was not pressed</li>
 </ul>
  </td>
</tr>
</table>
...
<p>HTML DOM reference: <a href="event_touch_altkey.asp">TouchEvent altKey Property</a></p>
<p>HTML DOM reference: <a href="event_touch_ctrlkey.asp">TouchEvent ctrlKey Property</a></p>
<p>HTML DOM reference: <a href="event_touch_shiftkey.asp">TouchEvent shiftKey Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_touchevent.asp" class="w3-btn w3-white w3-border" title="TouchEvent">&#10094; TouchEvent</a>
