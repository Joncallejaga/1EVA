...
<html lang="en-US">
<head>
<title>HTML DOM Dialog open Property</title>
 <meta charset="utf-8">
...
<h1>Dialog <span class="color_h1">open </span> Property</h1>
<p><a href="dom_obj_dialog.asp" class="w3-btn w3-white w3-border" title="Dialog Object Reference">&#10094; Dialog Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Open a dialog window:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myDialog&quot;).open = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_dialog_open" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The open property sets or returns whether a dialog should be open or 
not.</p>
<p>This property reflects the &lt;dialog&gt; open attribute.</p>
<p>When present, it specifies that the dialog element is active and that the 
user can interact with it.</p>
<p><strong>Note:</strong> The &lt;dialog&gt; element is new in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>dialogObject</em>.open</div></div>
<p>Set the open property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>dialogObject</em>.open = true|false
 </div></div>
...
<table class="w3-table-all notranslate"> 
 ...
 <ul>
    <li>true - The dialog window is open</li>
    <li>false - Default. The dialog window is not open</li>
 </ul>
   </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the dialog window is open, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a dialog window is open or not:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myDialog&quot;).open;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_dialog_open2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_dialog_open.asp">HTML &lt;dialog&gt; open attribute</a></p>
<hr>

<a href="dom_obj_dialog.asp" class="w3-btn w3-white w3-border" title="Dialog Object Reference">&#10094; Dialog Object</a>
</div>
