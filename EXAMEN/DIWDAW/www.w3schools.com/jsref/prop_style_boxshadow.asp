...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.boxShadow = &quot;10px 20px 30px blue&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_boxshadow">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Optional. The color of the shadow. The default value is black. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values.<br><br><strong>Note:</strong> In Safari (on PC) the color parameter is required. If you do not specify the color, the shadow is not displayed at all.</td>
  </tr>
  <tr>
    <td>inset</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_box-shadow.asp">box-shadow property</a></p>
<hr>
