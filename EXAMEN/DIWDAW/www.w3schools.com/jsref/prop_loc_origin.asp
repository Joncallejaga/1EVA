...
<html lang="en-US">
<head>
<title>Location origin Property</title>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">origin</span> Property</h1>
<p><a href="obj_location.asp" class="w3-btn w3-white w3-border" title="Location Object Reference">&#10094; Location Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the protocol, hostname and port number of a URL. Assume that the current URL is https://www.w3schools.com:4097/test.htm#part2:</p>
<div class="w3-code notranslate jsHigh">
 var x = location.origin;<br>
 </div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com:4097</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The origin property returns the protocol, hostname and port number of a URL.</p>
...
<div class="w3-code w3-border notranslate"><div>
 location.origin</div></div>
 
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the protocol (including ://), the domain name (or IP address) and port 
number (including the colon sign (:) of the URL. For URL's using the &quot;file:&quot; protocol, the 
return value differs between browsers</td>
</tr>
</table>
