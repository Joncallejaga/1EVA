...
<html lang="en-US">
<head>
<title>HTML DOM Input Text disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">disabled</span> Property</h1>
...
<div class="w3-code notranslate">
 <input type="text" disabled="disabled" value="Hello World!">
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the text field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_disabled">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 function disableTxt() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myText&quot;).disabled = true;<br>
 }<br><br>function undisableTxt() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myText&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
