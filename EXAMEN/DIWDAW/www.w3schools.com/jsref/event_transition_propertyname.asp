...
<h1>TransitionEvent <span class="color_h1">propertyName</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the property name associated with the transition:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).addEventListener(&quot;transitionend&quot;, myFunction);<br><br>function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; this.innerHTML = &quot;Property name is: &quot; + event.propertyName;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_transition_propertyname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The propertyName property returns the name of the CSS property associated 
with the transition, when a <a href="event_transitionend.asp">transitionevent</a> occurs.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.propertyName</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the transition</td>
</tr>
</table>
...
<p>HTML DOM reference: <a href="event_transition_elapsedtime.asp">TransitionEvent elapsedTime Property</a></p>
