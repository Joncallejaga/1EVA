...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM TableHeader Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_tabledata.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_tablerow.asp">Next &#10095;</a>
</div>
<hr>
...
var x = document.getElementById("myTh");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_th_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_th_create" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_tablehead_abbr.asp">abbr</a></td>
 ...
 style.background</a> instead.</span><br>Sets or returns the background image of a data cell<br></td>
  </tr>
  <tr>
    <td>bgColor</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_backgroundcolor.asp">
 style.backgroundColor</a> instead.</span><br>Sets or returns the background color of a table<br></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>height</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the height of a data cell<br>Use <a href="prop_style_height.asp">style.height</a> instead</td>
  </tr>
  <tr>
    <td>noWrap</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns whether the content in a cell can be wrapped<br>Use <a href="prop_style_whitespace.asp">
 style.whiteSpace</a> instead</td>
  ...
  <tr>
    <td>vAlign</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the vertical alignment of the content within a cell<br>Use <a href="prop_style_verticalalign.asp">style.verticalAlign</a> instead</td>
  </tr>
  <tr>
    <td>width</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the width of a data cell<br>Use <a href="prop_style_width.asp">style.width</a> instead</td>
  </tr>
</table>
