...
<a class="w3-left w3-btn" href="jsref_indexof.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_lastindexof" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><b>Note:</b> The string is searched from the end to the beginning, but returns the index starting at the beginning, at position 0.</p>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the position where the specified <em>searchvalue</em> occurs for the last time, or -1 if it never occurs</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_lastindexof2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="jsref_indexof.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
