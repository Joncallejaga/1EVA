...
<html lang="en-US">
<head>
<title>HTML DOM Input URL size Property</title>
 <meta charset="utf-8">
...
<h1>Input URL <span class="color_h1">size</span> Property</h1>
<p><a href="dom_obj_url.asp" class="w3-btn w3-white w3-border" title="Input URL Object Reference">&#10094; Input URL Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the width of a URL field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myURL&quot;).size = &quot;50&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_url_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The size property sets or returns the value of the size attribute of a URL field.</p>
<p>The size attribute specifies the width of an URL field (in number of 
characters).</p>
<p>The default value is 20.</p>
<p><strong>Tip:</strong> To set or return the maximum number of characters 
allowed in the password field, use the <a href="prop_url_maxlength.asp">
...
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.size</div></div>
<p>Set the size property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.size = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the width of the URL field, in number of characters. Default value is  20</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of the URL field, in number of characters</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Display the width of a URL field (in number of characters):</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myURL&quot;).size;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">30</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_url_size2">Try it Yourself &raquo;</a>
</div>
<hr>
