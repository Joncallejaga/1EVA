...
<h1>Embed <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_embed.asp" class="w3-btn w3-white w3-border" title="Embed Object Reference">&#10094; Embed Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the URL of an embedded file:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myEmbed&quot;).src;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/helloworld.swf</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_embed_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute in an embed element.</p>
<p>The src attribute specifies the address (URL) of the external file to embed.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>embedObject</em>.src</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>embedObject</em>.src =<em> URL</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>URL</em></td>
    <td>
 Specifies the address (URL) of the external file to embed.<br><br>Possible values:
 <ul>
    <li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/hello.swf&quot;)<br>
  </li>
    <li>A relative URL - points to a file within a web site (like src=&quot;hello.swf&quot;)</li>
 </ul>
   </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the embedded file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_embed_src.asp">HTML &lt;embed&gt; src attribute</a></p>
<hr>
