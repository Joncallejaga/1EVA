...
<html lang="en-US">
<head>
<title>HTML DOM Image naturalWidth Property</title>
 <meta charset="utf-8">
...
<div class="w3-code notranslate">
 107</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_naturalwidth" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The naturalWidth property returns the original width of an image.</p>
<p>For example, if you have an image that is originally 100 pixels wide. Then, 
you style the image with CSS/or by using the HTML &quot;width&quot; attribute to make it 
500 pixels wide. The naturalWidth property will return &quot;100&quot;, the
<a href="prop_img_width.asp">width</a> property however, will return 500.</p>
<p><strong>Tip:</strong> Use the <a href="prop_img_naturalheight.asp">naturalHeight</a> 
property to return the original height 
of an image, or the <a href="prop_img_height.asp">height</a> property to set or return the value of 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">naturalWidth</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>imageObject</em>.naturalWidth</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the original width of an image in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>The difference between the naturalWidth property and the width property:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myImg&quot;).naturalWidth;<br>var y = document.getElementById(&quot;myImg&quot;).width;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_naturalwidth_width">Try it Yourself &raquo;</a>
</div>
<hr>
