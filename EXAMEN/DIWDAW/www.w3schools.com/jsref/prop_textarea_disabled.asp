...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a text area should be disabled, or not.</p>
...
<p><strong>Tip:</strong> If you want the contents of a text area to be read-only. 
use the <a href="prop_textarea_readonly.asp">readOnly</a> property.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the text area is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_disabled">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 function disableTxt() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTextarea&quot;).disabled = true;<br>
 }<br><br>function undisableTxt() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTextarea&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_textarea_disabled.asp">HTML &lt;textarea&gt; disabled attribute</a></p>
<hr>
