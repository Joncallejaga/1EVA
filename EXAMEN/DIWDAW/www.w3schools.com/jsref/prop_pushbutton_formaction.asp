...
<html lang="en-US">
<head>
<title>HTML DOM Button formAction Property</title>
 <meta charset="utf-8">
...
<h1>Button <span class="color_h1">formAction</span> Property</h1>
<p><a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Button Object Reference">&#10094; Button Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the URL for where to send the form-data when a form is submitted:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).formAction;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">https://www.w3schools.com/action_page2.php</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_pushbutton_formaction">Try it Yourself &raquo;</a>
</div>
<hr>
...
submitted. This attribute overrides the HTML form's action attribute.</p>
...
<p><strong>Note:</strong> The formaction attribute is new for the &lt;button&gt; 
element in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formAction
</div></div>
<p>Set the formAction property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formAction = <em>URL</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>URL</em></td>
    <td>Specifies where to send the form-data. <strong>Note:</strong> this  will override the action attribute of the &lt;form&gt; element <p>Possible values:</p>
  <ul>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the formaction attribute of a button:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myBtn").formAction = &quot;/action_page2.php&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formaction2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example on returning the formAction property:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById("myBtn").formAction;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formaction3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_button_formaction.asp">HTML &lt;button&gt; formaction attribute</a></p>
<hr>

<a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Button Object Reference">&#10094; Button Object</a>
</div>
