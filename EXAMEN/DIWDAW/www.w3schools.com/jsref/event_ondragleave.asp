...
<a href="obj_dragevent.asp" class="w3-btn w3-white w3-border" title="DragEvent">&#10094; DragEvent</a>
</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_ondragenter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:25%;font-size:16px;text-align:left;">Event</th>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> ondragleave=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondragenter_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.ondragleave = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondragenter_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;dragleave&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondragenter_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><p><strong>Note:</strong> The <a href="met_element_addeventlistener.asp">addEventListener()</a> method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>
...
<div class="w3-code notranslate htmlHigh">
 &lt;p draggable=&quot;true&quot; id=&quot;dragtarget&quot;&gt;Drag me!&lt;/p&gt;<br><br>&lt;div class=&quot;droptarget&quot;&gt;Drop here!&lt;/div&gt;<br><br>&lt;script&gt;<br>/* ----------------- Events fired on the drag target ----------------- */<br><br>
 document.addEventListener(&quot;dragstart&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; // The dataTransfer.setData() method sets the data type and the value of the dragged data<br>&nbsp;&nbsp;&nbsp; event.dataTransfer.setData(&quot;Text&quot;, event.target.id);<br>
 <br>&nbsp;&nbsp;&nbsp; // Output some text when starting to drag the p element<br>
 &nbsp;&nbsp;&nbsp;
 document.getElementById(&quot;demo&quot;).innerHTML = &quot;Started to drag the p element.&quot;;<br><br>&nbsp;&nbsp;&nbsp; // Change the opacity of the draggable element<br>
 &nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;0.4&quot;;<br>});<br><br>// While dragging the p element, change the color of the output text<br>document.addEventListener(&quot;drag&quot;, function(event) {<br>
 &nbsp;&nbsp;&nbsp;
 document.getElementById(&quot;demo&quot;).style.color = &quot;red&quot;;<br>});<br><br>// Output some text when finished dragging the p element and reset the opacity<br>
 document.addEventListener(&quot;dragend&quot;, function(event) {<br>
 &nbsp;&nbsp;&nbsp;
 document.getElementById(&quot;demo&quot;).innerHTML = &quot;Finished dragging the p element.&quot;;<br>&nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;1&quot;;<br>});<br><br><br>/* ----------------- Events fired on the drop target ----------------- */<br><br>// When the draggable p element enters the droptarget, change the DIVS's border style<br>document.addEventListener(&quot;dragenter&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;3px dotted red&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>});<br><br>// By default, data/elements cannot be dropped in other elements. To allow a drop, we must prevent the default handling of the element<br>document.addEventListener(&quot;dragover&quot;, function(event) {<br>
 &nbsp;&nbsp;&nbsp;
 event.preventDefault();<br>});<br><br>// When the draggable p element leaves the droptarget, reset the DIVS's border style<br>
 document.addEventListener(&quot;dragleave&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;&quot;;<br>
 &nbsp;&nbsp;&nbsp;
 }<br>});<br><br>/* On drop - Prevent the browser default handling of the data (default is open as link on drop)<br>Reset the color of the output text and DIV's border color<br>Get the dragged data with the dataTransfer.getData() method<br>The dragged data is the id of the dragged element (&quot;drag1&quot;)<br>Append the dragged element into the drop element<br>*/<br>
 document.addEventListener(&quot;drop&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).style.color = &quot;&quot;;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var data = event.dataTransfer.getData(&quot;Text&quot;);<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.appendChild(document.getElementById(data));<br>&nbsp;&nbsp;&nbsp; }<br>});<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ondrag_all">Try it Yourself &raquo;</a>
</div>
<hr>
