...
<h1>JavaScript <span class="color_h1">if/else</span> Statement</h1>
...
<div class="w3-code notranslate jsHigh">
 var time = new Date().getHours(); <br>if (time &lt; 20) {<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_if" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The if/else statement is a part of JavaScript's &quot;Conditional&quot; Statements, 
...
<ul>
  ...
  <li>Use <b><a href="jsref_switch.asp">switch</a></b> to select one of many blocks of code to be executed</li>
</ul>
...
<h2>Syntax</h2>
<p>The <strong>if</strong> statement specifies a block of code to be 
executed if a condition is true:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
if (<i>condition</i>) {<br>
 <em>&nbsp;&nbsp;&nbsp; block of code to be executed if the condition is true<br>
 </em>}</div></div>
 
<p>The <strong>else</strong> statement specifies a block of code to be 
executed if the condition is false:</p>
<div class="w3-code w3-border notranslate jsHigh"><div>
if (<i>condition</i>) {<br>
 <em>&nbsp;&nbsp;&nbsp; block of code to be executed if the condition is true<br>
 </em>}
...
<p>The <strong>else if</strong> statement specifies a new condition if the 
...
<div class="w3-example">
<h3>Example</h3>
<p>If the time is less than 20:00, create a &quot;Good day&quot; 
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_if_else" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var time = new Date().getHours(); <br>if (time &lt; 10) {<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_if_elseif" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>If the first &lt;div&gt; element in the document has an id of &quot;myDIV&quot;, change its 
font-size:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName(&quot;DIV&quot;)[0];<br><br>if (x.id === &quot;myDIV&quot;) { <br>&nbsp;&nbsp;&nbsp; x.style.fontSize = &quot;30px&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_if_id" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Change the value of the source attribute (src) of an &lt;img&gt; element, if the user clicks on the image:</p>
<div class="w3-code notranslate jsHigh">
 &lt;img id=&quot;myImage&quot; onclick=&quot;changeImage()&quot; src=&quot;pic_bulboff.gif&quot; width=&quot;100&quot; height=&quot;180&quot;&gt;<br><br>&lt;script&gt;<br>function changeImage() {<br>&nbsp;&nbsp;&nbsp; var image = document.getElementById("myImage");<br>&nbsp;&nbsp;&nbsp; if (image.src.match(&quot;bulbon&quot;)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; image.src = &quot;pic_bulboff.gif&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; image.src = &quot;pic_bulbon.gif&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_if_else2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Display a message based on user input:</p>
 <div class="w3-code notranslate jsHigh">
  var letter = document.getElementById(&quot;myInput&quot;).value;<br>var text;<br>
  <br>// If the letter is &quot;c&quot;<br>if (letter === &quot;c&quot;) {<br>&nbsp;&nbsp;&nbsp;  text = &quot;Spot on! Good job!&quot;;<br><br>// If the letter is &quot;b&quot; or &quot;d&quot;<br>}  else if (letter === &quot;b&quot; || letter === &quot;d&quot;) {<br>&nbsp;&nbsp;&nbsp; text  = &quot;Close, but not close enough.&quot;;<br><br>// If the letter is anything  else<br>} else {<br>&nbsp;&nbsp;&nbsp; text = &quot;Waaay off..&quot;;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_if_prompt" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x, text;<br><br>// Get the value of the input field with id=&quot;numb&quot;<br>x = document.getElementById(&quot;numb&quot;).value;<br><br>// If x is Not a Number or less than 1 or greater than 10, output &quot;input is not valid&quot;<br>// If x is a number between 1 and 10, output &quot;Input OK&quot;<br><br>if (isNaN(x) || x &lt; 1 || x &gt; 10) {<br>&nbsp;&nbsp;&nbsp; text = &quot;Input not valid&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; text = &quot;Input OK&quot;;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_if_else3" target="_blank">Try it Yourself &raquo;</a>
</div>
