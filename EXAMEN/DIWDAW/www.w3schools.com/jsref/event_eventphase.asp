...
<html lang="en-US">
<head>
<title>eventPhase Event Property</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">eventPhase</span> Event Property</h1>
<p>
...
<p>The eventPhase event property returns a number that indicates which phase of 
the event flow is currently being evaluated.</p>
<p>The number is represented by 4 constants:</p>
<p class="auto-style1">0. NONE<br>1. CAPTURING_PHASE - The event flow is in capturing phase<br>
2. AT_TARGET - The event flow is in target phase, i.e. it is being evaluated at the event target<br>3. BUBBLING_PHASE - The event flow is in bubbling phase</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.eventPhase</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing which phase of the event flow is currently being evaluated
 <p>Possible values:</p>
 <p class="auto-style1">0. NONE<br>1. CAPTURING_PHASE - The event flow is in capturing phase<br>
 2. AT_TARGET - The event flow is in target phase<br>3. BUBBLING_PHASE - The event flow is in bubbling phase</p>
   </td>
  </tr>
  <tr>
