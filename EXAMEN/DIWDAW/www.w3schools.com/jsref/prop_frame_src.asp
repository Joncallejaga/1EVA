...
<h3>Example</h3>
<p>Change the URL of the document to embed in the iframe:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myFrame&quot;).src = &quot;https://wwf.org&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_iframe_src2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute in an iframe element.</p>
<p>The src attribute specifies the URL of the document to show in an iframe.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the document that is embedded in the iframe. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the document that is shown in an iframe:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFrame&quot;).src;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/default.asp</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_iframe_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_iframe_src.asp">HTML &lt;iframe&gt; src attribute</a></p>
<hr>
