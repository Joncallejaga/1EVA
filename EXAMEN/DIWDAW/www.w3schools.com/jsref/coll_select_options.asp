...
<p><a href="dom_obj_select.asp" class="w3-btn w3-white w3-border" title="Select Object Reference">&#10094; Select Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many options there are in a specific drop-down list:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById(&quot;mySelect&quot;).options.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
4</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options2">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The options collection returns a collection of all &lt;option&gt; elements in a drop-down list.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;option&gt; elements in the collection.<br><br>
 <strong>Note: </strong>This property is read-only</td>
  </tr>
  <tr>
    <td>selectedIndex</td>
    <td>Sets or returns the index of the selected &lt;option&gt; element in the collection (starts at 0)</td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:21%">Method</th>
    <th>Description</th>
  </tr>
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;option&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
    <td>[add(<i>option</i>[,<i>index</i>])]</td>
    <td>Adds an &lt;option&gt; element into the collection at the specified index. If no index is specified, it inserts the option at the end of the collection </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Returns the &lt;option&gt; element from the collection with the specified id.<br><br>
 <strong>Note:</strong> Returns null if the id does not exist</td>
    </tr>
  <tr>
    <td>remove(<i>index</i>)</td>
    <td>Removes the &lt;option&gt; element with the specified index from the collection</td>
    </tr>
</table>
<hr>
...
<table class="w3-table-all">
  <tr>
 <th style="width:21%;">DOM Version:</th>
  <td>Core Level 2 Document Object</td>
  </tr>
  <tr>
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLOptionsCollection Object, representing all &lt;option&gt; elements in the &lt;select&gt; element. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
 <p>Get the text of the first option (index 0) in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).options[0].text;</div>
   <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Apple</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options4">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
 <p>Get the text of the first option (index 0) in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).options.item(0).text;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Apple</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options5">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
 <p>Get the text of the option with id=&quot;orange&quot; in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).options.namedItem(&quot;orange&quot;).text;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Orange</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options6">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Add a &quot;Kiwi&quot; option at index position &quot;1&quot; in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;);<br>var c = document.createElement(&quot;option&quot;);<br>
 c.text = &quot;Kiwi&quot;;<br>x.options.add(c, 1);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options7">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options8">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all options in a drop-down list, and output the text of each 
option:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;);<br>var txt = &quot;&quot;;<br>
 var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.options[i].text + &quot;&lt;br&gt;&quot;;<br>
 }</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Choose an option in the drop-down list and output the text of the selected option in an 
element with id=&quot;demo&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;);<br>var i = x.selectedIndex;<br>
 document.getElementById(&quot;demo&quot;).innerHTML = x.options[i].text;</div>
    <p>The result could be:</p>
<div class="w3-code notranslate">
 Banana</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options_selindex">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the options in a drop-down list depending on the selected option in 
another drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var carsAndModels = {};<br>carsAndModels['VO'] = ['V70', 'XC60', 'XC90'];<br>
 carsAndModels['VW'] = ['Golf', 'Polo', 'Scirocco', 'Touareg'];<br>carsAndModels['BMW'] = ['M6', 'X5', 'Z3'];<br><br>function ChangeCarList() {<br>&nbsp;&nbsp;&nbsp; var carList = document.getElementById(&quot;car&quot;);<br>&nbsp;&nbsp;&nbsp; var modelList = document.getElementById(&quot;carmodel&quot;);<br>
 &nbsp;&nbsp;&nbsp;
 var selCar = carList.options[carList.selectedIndex].value;<br><br>&nbsp;&nbsp;&nbsp; while (modelList.options.length) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; modelList.remove(0);<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp;&nbsp;&nbsp; var cars = carsAndModels[selCar];<br>
 &nbsp;&nbsp;&nbsp;
 if (cars) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var i;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; cars.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var car = new Option(cars[i], i);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; modelList.options.add(car);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_options3">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_select.asp" class="w3-btn w3-white w3-border" title="Select Object Reference">&#10094; Select Object</a>
</div>
