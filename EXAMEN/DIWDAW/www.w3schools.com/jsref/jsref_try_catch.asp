...
<h1>JavaScript <span class="color_h1">try/catch/finally</span> Statement</h1>
...
<div class="w3-code notranslate htmlHigh">
 ...
 try {<br>&nbsp;&nbsp;&nbsp; adddlert(&quot;Welcome guest!&quot;);<br>}<br>catch(err) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = err.message;<br>}<br>&lt;/script&gt;<br>
 <br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_try_catch" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The try/catch/finally statement handles some or all of the errors that may 
occur in a block of code, while still running code.</p>
...
be executed, if an error occurs in the <strong>try</strong> block.</p>
<p>The <strong>finally</strong> statement lets you execute code, after try and 
catch, regardless of the result.</p>
<p><strong>Note:</strong> The catch and finally statements are both optional, 
but you need to use one of them (if not both) while using the try statement.</p>
<p><strong>Tip:</strong> When an error occurs, JavaScript will normally stop, and generate an error 
message. Use the <a href="jsref_throw.asp">throw</a> statement 
to create a custom error (throw an exception). If you use <strong>throw</strong> together with
<strong>try</strong> and <strong>catch</strong>, you can control program flow 
and generate custom error messages.</p>
<p>For more information about JavaScript errors, read out
<a href="../js/js_errors.asp">JavaScript Errors</a> Tutorial.</p>
...
<div class="w3-code w3-border notranslate jsHigh"><div>
 try {<br>&nbsp;&nbsp;&nbsp; <em>tryCode - Block of code to try<br></em>}<br>catch(<em>err</em>) {<br>&nbsp;&nbsp;&nbsp; <em>
 catchCode -
 Block of code to handle errors<br></em>} <br>finally {<br>&nbsp;&nbsp;&nbsp; <em>
 finallyCode - Block of code to be executed regardless of the try / catch result<br></em>}</div></div>
...
onclick=&quot;myFunction()&quot;&gt;Test Input&lt;/button&gt;<br>&lt;p id=&quot;message&quot;&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var message, x;<br>&nbsp;&nbsp;&nbsp; message = 
document.getElementById(&quot;message&quot;);<br>&nbsp;&nbsp;&nbsp; message.innerHTML = &quot;&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;x = 
document.getElementById(&quot;demo&quot;).value;<br>&nbsp;&nbsp;&nbsp; 
try { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
if(x == &quot;&quot;) throw &quot;is Empty&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
if(isNaN(x)) throw &quot;not a number&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
if(x &gt; 10) throw &quot;too high&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
if(x &lt; 5) throw &quot;too low&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
catch(err) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message.innerHTML = 
&quot;Input &quot; + err;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>&lt;/script&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_throw_error" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
document.getElementById(&quot;demo&quot;).value;<br>&nbsp;&nbsp;&nbsp; 
try { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
if(x == &quot;&quot;) throw &quot;Empty&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if(isNaN(x)) 
throw &quot;Not a number&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if(x &gt; 
10) throw &quot;Too high&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if(x &lt; 
5) throw &quot;Too low&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; catch(err) 
{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message.innerHTML = &quot;Error: &quot; + 
err + &quot;.&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; finally {<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;document.getElementById(&quot;demo&quot;).value = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_finally_error" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_errors.asp">JavaScript Errors</a></p>
<p>JavaScript Reference: <a href="jsref_throw.asp">JavaScript throw Statement</a></p>
<hr>
