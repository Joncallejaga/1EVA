...
<h1>Audio <span class="color_h1">currentSrc</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the current audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).currentSrc;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/horse.ogg</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_currentsrc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The currentSrc property returns the URL of the current audio.</p>
<p>If no audio is set, an empty string is returned.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Tip:</strong> Use the <a href="prop_audio_src.asp">src</a> property 
to set the URL of a audio file.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.currentSrc</div>
</div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the current audio. Returns the entire URL, including the protocol (like http://). If no audio is set, an empty string is returned</td>
</tr>
</table>
