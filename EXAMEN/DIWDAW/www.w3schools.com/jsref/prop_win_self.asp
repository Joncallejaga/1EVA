...
<div class="w3-code notranslate jsHigh">
 function myFunction() {<br>&nbsp;&nbsp;&nbsp; if (window.top != window.self) {<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;This window is NOT the topmost window!&quot;;<br>&nbsp;&nbsp;&nbsp; } else { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;This window is the topmost window!&quot;;<br>&nbsp;&nbsp;&nbsp; } <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_self_top" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The self property returns the current window.</p>
<p>The self property is often used in comparisons (like in the example above).</p>
