...
5</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_min" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> The <a href="jsref_max.asp">max()</a> method returns the number with the highest value.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the lowest number of the arguments, or <em>Infinity</em> if no arguments are given, or <em>NaN</em> if one or more arguments are not numbers</td>
</tr>
<tr>
...
-10<br>
1.5</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_min2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
