...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Input TimeObject</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_url.asp">Next &#10095;</a>
</div>
<hr>

<h2>Input Time Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The Input Time Object is new in HTML5.</div></p>
<p>The Input Time object represents an HTML &lt;input&gt; element with 
type=&quot;time&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;time&quot; 
do not show as any time field in Firefox, or in IE12 and earlier versions.</span></p>
<h3>Access an Input Time Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;time&quot; by using getElementById():</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myTime");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_get" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;time&quot;&gt; by searching through the <a href="coll_form_elements.asp">elements</a> collection of a form.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_create" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_input_time_autofocus.asp">autofocus</a></td>
    <td>Sets or returns whether a time field should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_defaultvalue.asp">defaultValue</a></td>
    <td>Sets or returns the default value of a time field</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_disabled.asp">disabled</a></td>
    <td>Sets or returns whether a time field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_input_time_form.asp">form</a></td>
  ...
  <tr>
    <td><a href="prop_input_time_max.asp">max</a></td>
    <td>Sets or returns the value of the max attribute of the time field</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_min.asp">min</a></td>
    <td>Sets or returns the value of the min attribute of the time field</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a time field</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_readonly.asp">readOnly</a></td>
    <td>Sets or returns whether the time field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_required.asp">required</a></td>
    <td>Sets or returns whether the time field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_step.asp">step</a></td>
    <td>Sets or returns the value of the step attribute of the time field</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_type.asp">type</a></td>
    <td>Returns which type of form element the time field is</td>
  </tr>
  <tr>
    <td><a href="prop_input_time_value.asp">value</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_input_time_stepdown.asp">stepDown()</a></td>
    <td>Decrements the value of the time field by a specified number</td>
    </tr>
  <tr>
    <td><a href="met_input_time_stepup.asp">stepUp()</a></td>
