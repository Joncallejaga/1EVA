...
<h3>Example</h3>
<p>Change the contents of a text area:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).value = &quot;Fifth Avenue, New York City&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_value2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the contents/text of the text area</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the contents of a text area:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">342 Alvin Road<br>Ducksburg</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_value">Try it Yourself &raquo;</a>
</div>
<hr>
