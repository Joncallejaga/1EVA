...
<html lang="en-US">
<head>
<title>MouseEvent screenX Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">screenX</span> Property</h1>
<p>
...
<p>The screenX property returns the horizontal coordinate (according to the users computer screen) of the mouse pointer when an event was triggered.</p>
<p><strong>Tip:</strong> To get the vertical coordinate (according to the 
screen) of the mouse pointer, 
use the <a href="event_screeny.asp">screenY</a> property.</p>
