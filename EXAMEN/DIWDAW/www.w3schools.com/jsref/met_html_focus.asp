...
<h1>HTML DOM <span class="color_h1">focus()</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Give focus to an &lt;a&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).focus();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_html_blur" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The focus() method is used to give focus to an element (if it can be focused).</p>
<p><strong>Tip:</strong> Use the <a href="met_html_blur.asp">blur()</a> method to remove focus from an element.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.focus()</div></div>
<h2>Parameters</h2>
...
<div class="w3-example">
<h3>Example</h3>
<p>Give focus to a text field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myText&quot;).focus();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_text_focus" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Give focus to a text field, immediately after the document window has been 
loaded:</p>
<div class="w3-code notranslate jsHigh">
 window.onload = function() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myText&quot;).focus();<br>};</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_html_focus_onload" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_onfocus.asp">onfocus event</a></p>
<hr>
