...
<a target="_blank" href="tryit.asp?filename=tryjsref_gethours" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getHours() method returns the hour (from 0 to 23) of the specified date and time.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_gethours2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<div class="w3-example">
<h3>Example</h3>
<p>Using getHours(), getMinutes(), and getSeconds() to display the time:</p>
<div class="w3-code notranslate jsHigh">
 function addZero(i) {<br>&nbsp;&nbsp;&nbsp; if (i &lt; 10) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i = &quot;0&quot; + i;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return i;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById(&quot;demo&quot;);<br>&nbsp;&nbsp;&nbsp; var h = addZero(d.getHours());<br>&nbsp;&nbsp;&nbsp; var m = addZero(d.getMinutes());<br>&nbsp;&nbsp;&nbsp; var s = addZero(d.getSeconds());<br>&nbsp;&nbsp;&nbsp; x.innerHTML = h + &quot;:&quot; + m + &quot;:&quot; + s;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_datetime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
