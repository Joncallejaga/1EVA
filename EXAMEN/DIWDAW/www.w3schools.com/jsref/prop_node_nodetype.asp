...
<h3>Example</h3>
 <p>Get the node type of the body element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myP&quot;).nodeType;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
1
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_nodetype" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>If the node is a text node, the nodeType property will return 3.</p>
<p>If the node is a comment node, the nodeType property will return 8.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the node type of the node</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<h3>Example</h3>
 <p>Get the node type of the &lt;body&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.body.nodeType;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 1</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_nodetype2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the node types of the &lt;body&gt; element's child nodes:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.body.childNodes;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; c.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + c[i].nodeType + &quot;&lt;br&gt;&quot;;<br>}<br><br>
 document.getElementById(&quot;demo&quot;).innerHTML = txt;</div>
<!--<p>The result of <em>txt </em>will be:</p>
<div class="w3-code notranslate jsHigh">
 3&nbsp;&nbsp;&nbsp; // text node<br>1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node<br>
 1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node<br>1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node<br>8&nbsp;&nbsp;&nbsp; // comment node<br>3&nbsp;&nbsp;&nbsp; // text node<br>
 1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node<br>1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node<br>1&nbsp;&nbsp;&nbsp; // element node<br>3&nbsp;&nbsp;&nbsp; // text node</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_nodetype3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
