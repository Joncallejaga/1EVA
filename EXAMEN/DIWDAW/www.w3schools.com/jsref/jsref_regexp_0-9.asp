...
<a target="_blank" href="tryit.asp?filename=tryjsref_regexp_0-9" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The [0-9] expression is used to find any character between the brackets.</p>
<p>The digits inside the brackets can be any numbers or span of numbers from 0 to 9.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_regexp_not_0-9.asp">[^0-9]</a> expression to find any 
character that is NOT a digit.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_regexp_0-9_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
