...
<h1>JavaScript Array <span class="color_h1">find()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var ages = [3, 10, 18, 20];<br><br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= 18;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.find(checkAdult);<br>}</div>
<!--<p>The result will be:</p>
<div class="w3-code notranslate">
 18</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_find">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The find() method returns the value of the first element in an array that pass a 
test (provided as a function).</p>
<p>The find() method executes the function once for each element present in the 
array:</p>
<ul>
  <li>If it finds an array element where the function returns a <em>true</em> value, find() returns the value of that array element (and does not check the remaining values)</li>
  <li>Otherwise it returns undefined</li>
</ul>
<p><strong>Note:</strong> find() does not execute the function for empty arrays.</p>
<p><strong>Note:</strong> find() does not change the original array.</p>
<hr>
...
<i>array</i>.find(<em>function(currentValue, index, arr),thisValue</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>Returns the array element value if any of the elements in the array pass the test, otherwise it returns undefined</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the value of the first element in the array that has a value above a 
specific number:</p>
<div class="w3-code notranslate htmlHigh">
 ...
 <br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= document.getElementById(&quot;ageToCheck&quot;).value;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.find(checkAdult);<br>}<br>
 &lt;/script&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_find2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
