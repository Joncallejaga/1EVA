...
<p><a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Display an alert box after 3 seconds (3000 milliseconds):</p>
<div class="w3-code notranslate jsHigh">
 setTimeout(function(){ alert(&quot;Hello&quot;); }, 3000);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
clearTimeout()</a> method to prevent the function from running.</p>
<hr>
...
setTimeout(<em>function, milliseconds, param1, param2, ...</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. The number of milliseconds to wait before executing the code. If omitted, the value 0 is used</td>
  </tr>
  <tr>
    <td><em>param1, param2, ...</em></td>
    <td>Optional. Additional parameters to pass to the <em>function</em> (Not supported in IE9 and earlier)</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the ID value of the timer that is set. Use this value with the clearTimeout() method to cancel the timer</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>You can also refer to &quot;named&quot; function; Display an alert box after 3 seconds (3000 milliseconds):</p>
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setTimeout(alertFunc, 3000);<br>}<br><br>function alertFunc() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Hello!&quot;);<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;txt&quot;);<br>setTimeout(function(){ x.value = &quot;2 seconds&quot; }, 2000);<br>setTimeout(function(){ x.value = &quot;4 seconds&quot; }, 4000);<br>setTimeout(function(){ x.value = &quot;6 seconds&quot; }, 6000);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setTimeout(function(){ alert(&quot;Hello&quot;) }, 3000);<br>
 }<br><br>function myStopFunction() {<br>&nbsp;&nbsp;&nbsp; clearTimeout(myVar);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout_cleartimeout" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Count forever - but with the ability to stop the count:</p>
<div class="w3-code notranslate jsHigh">
 function startCount()<br>function stopCount()</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout_cleartimeout2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 function startTime() {<br>&nbsp;&nbsp;&nbsp; var today = new Date();<br>&nbsp;&nbsp;&nbsp; var h = today.getHours();<br>&nbsp;&nbsp;&nbsp; var m = today.getMinutes();<br>&nbsp;&nbsp;&nbsp; var s = today.getSeconds();<br>
 &nbsp;&nbsp;&nbsp;
 ...
 }<br><br>function checkTime(i) {<br>&nbsp;&nbsp;&nbsp; if (i&lt;10) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i = &quot;0&quot; + i;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return i;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout_clock" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Pass parameters to the <em>alertFunc</em> function (does not work in IE9 and earlier):</p>
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myStartFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setTimeout(alertFunc, 2000, &quot;First param&quot;, &quot;Second param&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout_param" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>However, if you use an anonymous function, it will work in 
all browsers:</p>
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myStartFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setTimeout(function(){ alertFunc(&quot;First param&quot;, &quot;Second param&quot;); }, 2000);<br>
 }</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_settimeout_param2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>Window Object: <a href="met_win_cleartimeout.asp">clearTimeout() Method</a></p>
<p>Window Object: <a href="met_win_setinterval.asp">setInterval() Method</a></p>
<p>Window Object: <a href="met_win_clearinterval.asp">clearInterval() Method</a></p>
<hr>
<a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a>
</div>
