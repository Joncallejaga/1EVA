...
<h3>Example</h3>
 <p>Find out if an attribute has been specified or not:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_attr_specified" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The specified property returns true if the attribute is specified.</p>
<p>Returns true also if the attribute has been created but not been attached to an element yet.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the attribute is specified, otherwise false</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
