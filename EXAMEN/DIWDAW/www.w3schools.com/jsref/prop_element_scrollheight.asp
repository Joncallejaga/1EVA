...
<html lang="en-US">
<head>
<title>HTML DOM scrollHeight Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">scrollHeight</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the entire height and width of an element, including padding:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementById(&quot;content&quot;);<br>var y = elmnt.scrollHeight;<br>var x = elmnt.scrollWidth;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_scrollheight" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollHeight property returns the entire height of an element 
in pixels, including padding, but not the border, scrollbar or margin.</p>
<p><strong>Tip:</strong> Use the <a href="prop_element_scrollwidth.asp">
scrollWidth</a> property to return the entire width of an element.</p>
<p>The scrollWidth and scrollHeight properties return the entire height and 
width of an element, including the height and width that is not viewable (because of overflow).</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.scrollHeight</div></div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the entire height (vertically) of an element, in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using padding, border, scrollbar and margin to show how this affects the 
scrollWidth and scrollHeight property:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementById(&quot;content&quot;);<br>var y = elmnt.scrollHeight;<br>var x = elmnt.scrollWidth;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_scrollheight2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Return the scrollHeight and scrollWidth of an element and then set its height 
and width to the values returned from scrollHeight and scrollWidth:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementById(&quot;content&quot;);<br><br>function getFunction() {<br>&nbsp;&nbsp;&nbsp; var x = elmnt.scrollWidth;<br>&nbsp;&nbsp;&nbsp; var y = elmnt.scrollHeight;<br>}<br><br>function setFunction() {<br>&nbsp;&nbsp;&nbsp; elmnt.style.height = y.scrollHeight + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; elmnt.style.width = y.scrollWidth + &quot;px&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_scrollheight3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>
</div>
