...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Script Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_samp.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_section.asp">Next &#10095;</a>
</div>
<hr>
...
var x = document.getElementById("myScript");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_create" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_script_async.asp">async</a></td>
    <td>Sets or returns whether a script should be executed asynchronously as soon as it is available</td>
  </tr>    
  <tr>
    <td><a href="prop_script_charset.asp">charset</a></td>
  ...
  <tr>
    <td><a href="prop_script_defer.asp">defer</a></td>
    <td>Sets or returns whether a script should be executed when the page has finished parsing</td>
  </tr> 
  <tr>
    <td><a href="prop_script_src.asp">src</a></td>
    <td>Sets or returns the value of the src attribute of a script</td>
  </tr> 
  <tr>
    <td><a href="prop_script_text.asp">text</a></td>
    <td>Sets or returns the contents of all the text nodes that are children of a script</td>
  </tr> 
  <tr>
    <td><a href="prop_script_type.asp">type</a></td>
