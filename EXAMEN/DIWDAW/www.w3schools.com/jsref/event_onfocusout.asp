...
<h1><span class="color_h1">onfocusout</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when an input field is about to lose focus:</p>
<div class="w3-code notranslate htmlHigh">
&lt;input type=&quot;text&quot; 
onfocusout=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onfocusout" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onfocusout event occurs when an element is about to lose focus.</p>
<p><strong>Tip: </strong>The onfocusout event is similar to the
<a href="event_onblur.asp">onblur</a> event. 
...
the onfocusout event.</p>
<p><strong>Tip:</strong> Although Firefox does not support the onfocusout event, 
you can find out whether a child of an element loses focus or not, by using a 
capturing listener for the <a href="event_onblur.asp">onblur</a> event (using 
the optional <em>useCapture</em> parameter 
of the <a href="met_element_addeventlistener.asp">addEventListener()</a> 
method).</p>
<p><b>Tip:</b> The onfocusout event is the opposite of the
<a href="event_onfocusin.asp">onfocusin</a> event.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">onfocusout</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>52.0</td>
    <td>Yes</td>
...
<p><strong>Note:</strong> The onfocusout event <strong>may not</strong> work as expected in 
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onfocusout=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onfocusout_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<p>In JavaScript (may not work as expected in Chrome, Safari and Opera 15+):</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onfocusout = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onfocusout_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;focusout&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onfocusout_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
