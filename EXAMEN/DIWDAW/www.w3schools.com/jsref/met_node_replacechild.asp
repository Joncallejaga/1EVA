...
<h3>Example</h3>
 <p>Replace a text node in a &lt;li&gt; element in a list with a new text node:</p>
<div class="w3-code notranslate jsHigh">
 // Create a new text node called &quot;Water&quot;<br>var textnode = document.createTextNode(&quot;Water&quot;);<br>
 <br>// Get the first child node of an &lt;ul&gt; element<br>var item = document.getElementById(&quot;myList&quot;).childNodes[0];<br><br>// Replace the first child node of &lt;ul&gt; with the newly created text node<br>
 item.replaceChild(textnode, item.childNodes[0]);<br>
 <br>// <strong>Note:</strong> This example replaces only the Text node &quot;Coffee&quot; with a Text node &quot;Water&quot;</div>
<p>Before removing:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_replacechild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="met_node_removechild.asp">removeChild() </a>method to remove a child node from an element.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the replaced node</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Replace a &lt;li&gt; element in a list with a new &lt;li&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 // Create a new &lt;li&gt; element<br>var elmnt = document.createElement(&quot;li&quot;);<br><br>// Create a new text node called &quot;Water&quot;<br>
 var textnode = document.createTextNode(&quot;Water&quot;);<br><br>// Append the text node to &lt;li&gt;<br>elmnt.appendChild(textnode);<br><br>// Get the &lt;ul&gt; element with id=&quot;myList&quot;<br>var item = document.getElementById(&quot;myList&quot;);<br><br>// Replace the first child node (&lt;li&gt; with index 0) in &lt;ul&gt; with the newly created &lt;li&gt; element<br>item.replaceChild(elmnt, item.childNodes[0]);<br>
 <br>// <strong>Note:</strong> This example replaces the entire &lt;li&gt; element</div>
<p>Before removing:</p>
<div class="w3-code notranslate">
<ul><li>Coffee</li><li>Tea</li><li>Milk</li></ul>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_replacechild2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
