...
<p><a href="jsref_obj_date.asp" class="w3-btn w3-white w3-border" title="Date Object Reference">&#10094; JavaScript Date Object</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcmilliseconds" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCMilliseconds() method returns the milliseconds (from 0 to 999) of the specified date and time, according to universal time.</p>
...
<div class="w3-code notranslate jsHigh">
 var d = new Date(&quot;July 21, 1983 01:15:00:195&quot;);<br>var n = d.getUTCMilliseconds();</div>
<!--<p>The result of <em>n</em> could be:</p>
<div class="w3-code notranslate">
<script>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcmilliseconds2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using getHours(), getMinutes(), getSeconds(), and getMilliseconds() to 
display the UTC time (with milliseconds):</p>
<div class="w3-code notranslate jsHigh">
 function addZero(x, n) {<br>&nbsp;&nbsp;&nbsp; while (x.toString().length &lt; n) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = &quot;0&quot; + x;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return x;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById(&quot;demo&quot;);<br>&nbsp;&nbsp;&nbsp; var h = addZero(d.getUTCHours(), 2);<br>&nbsp;&nbsp;&nbsp; var m = addZero(d.getUTCMinutes(), 2);<br>&nbsp;&nbsp;&nbsp; var s = addZero(d.getUTCSeconds(), 2);<br>&nbsp;&nbsp;&nbsp; var ms = addZero(d.getUTCMilliseconds(), 3);<br>&nbsp;&nbsp;&nbsp; x.innerHTML = h + &quot;:&quot; + m + &quot;:&quot; + s + &quot;:&quot; + ms;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_datetime_millisec_utc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="jsref_obj_date.asp" class="w3-btn w3-white w3-border" title="Date Object Reference">&#10094; JavaScript Date Object</a>
</div>
