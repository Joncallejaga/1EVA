...
<h1>Geolocation <span class="color_h1">position</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_geo_position">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The position property returns the position and altitude of the device on Earth.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>position.coords</td>
    <td>Returns a Coordinates object that defines the current location</td>
  </tr>
  <tr>
    <td>position.timestamp</td>
    <td>Returns a DOMTimeStamp representing the time at which the location was 
    retrieved</td>
  </tr>
  </table>
<hr>
