...
document.getElementById(&quot;myDiv&quot;).style.borderStyle = &quot;solid&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderstyle">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  <li>One value, like: p {border-style: solid} - all four borders will be solid</li>
  <li>Two values, like: p {border-style: solid dotted} - top and bottom border will be solid, left and right border will be dotted</li>
  <li>Three values, like: p {border-style: solid dotted double}- top border will be solid, left and right border will be dotted, bottom border will be double</li>
  <li>Four values, like: p {border-style: solid dotted double dashed} - top border will be solid, right border will be dotted, bottom border will be double, left border will be dashed</li>
</ul>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.style.borderStyle = <i>value
 </i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>hidden</td>
    <td>The same as &quot;none&quot;, except in border conflict  resolution for table elements</td>
  </tr>
  <tr>
    <td>dotted</td>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDiv&quot;).style.borderStyle = &quot;dotted solid double dashed&quot;;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderstyle2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderstyle3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderstyle_all">Try it Yourself &raquo;</a>
</div>
<hr>
