...
<h3>Example</h3>
<p>Create a new number method that returns a number's half value:</p>
<div class="w3-code notranslate jsHigh">
Number.prototype.myMethod = function()
{<br>
&nbsp;&nbsp;&nbsp; return this.valueOf() / 2;<br>
};</div>
<p>Use the new method on a number:</p>
<div class="w3-code notranslate jsHigh">
var n = 55;<br>
var x = n.myMethod();
</div>
<!--<p>The result of x will be:</p>
<div class="w3-code notranslate">
27.5
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_prototype_number" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The prototype constructor allows you to add new properties and methods to 
JavaScript numbers.</p>
<p>When constructing a property, ALL numbers will be given the property, and its value, as default.</p>
<p>When constructing a method, ALL numbers will have this method available.</p>
...
<div class="w3-code w3-border notranslate"><div>
 Number.prototype.<em>name </em>=<em> value</em></div></div>
<hr>
