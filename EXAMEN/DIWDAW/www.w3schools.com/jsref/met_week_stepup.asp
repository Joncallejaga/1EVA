...
<html lang="en-US">
<head>
<title>HTML DOM Input Week stepUp() Method</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">stepUp()</span> Method</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Increment the value of a week field by 10 weeks:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).stepUp(10);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_stepup">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stepUp() method increments the value of the week field by a specified 
number.</p>
<p>This method will only have an affect on WEEKS (not years).</p>
<p><strong>Tip:</strong> To decrement the value, use the
<a href="met_week_stepdown.asp">stepDown()</a> method.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">stepUp()</td>
    <td>Yes</td>
    <td>12.0</td>
...
<p><strong>Note:</strong> In Safari, you must enter a week in the week field before you can increment the value.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.stepUp(<em>number</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the amount of weeks the week field should  increase.<br><br>If omitted, the weeks are incremented by &quot;1&quot;</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Increment the weeks by 1 (default):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).stepUp();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_stepup2">Try it Yourself &raquo;</a>
</div>
<hr>
