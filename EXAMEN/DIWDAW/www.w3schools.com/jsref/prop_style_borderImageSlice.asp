...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.borderImageSlice = &quot;50% 10%&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderimageslice_NOTEPAD">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">borderImageSlice</td>
    <td>Yes</td>
    <td>11.0</td>
    <td>Yes</td>
    <td>6.0</td>
...
<p>Look at the <a href="prop_style_borderImage.asp">borderImage</a> property instead!</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> <i>number</i></td>
    <td>Numbers represent pixels in the image (if the image is a raster image) or vector coordinates (if the image is a vector image)</td>
  </tr>
  <tr>
    <td> <i>%</i></td>
    <td>Percentages are relative to the size of the image: the width of the image for the horizontal offsets, the height for vertical offsets. Default value is 100%</td>
  </tr>
  <tr>
    <td> fill</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_border-image-slice.asp">border-image-slice property</a></p>
<hr>
