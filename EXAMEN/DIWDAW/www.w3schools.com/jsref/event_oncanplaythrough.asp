...
<h1><span class="color_h1">oncanplaythrough</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when a video can be played all the way through, without 
stopping:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video oncanplaythrough=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_oncanplaythrough" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The oncanplaythrough event occurs when the browser estimates it can play 
through the specified media without having to stop for buffering.</p>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> oncanplaythrough=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_oncanplaythrough_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.oncanplaythrough = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_oncanplaythrough_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;canplaythrough&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_oncanplaythrough_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when an audio can be played all the way through, without 
stopping:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;audio oncanplaythrough=&quot;myFunction()&quot;&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_oncanplaythrough_audio">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
