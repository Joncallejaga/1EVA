...
document.getElementById(&quot;myDiv&quot;).style.borderLeftColor = &quot;red&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderleftcolor">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">borderLeftColor</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the color of the left border. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values. Default color is black</td>
  </tr>
  <tr>
    <td>transparent</td>
    <td>The color of the left border is transparent (underlying content will shine through)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderleftcolor2">Try it Yourself &raquo;</a>
</div>
<hr>
