...
<h3>Example</h3>
<p>Get the code name of your browser:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_appcodename">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the code name of the browser</td>
</tr>
</table>
