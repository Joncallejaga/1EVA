...
<html lang="en-US">
<head>
<title>HTML DOM Audio seeking Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">seeking</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Show if the user is currently seeking in the audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;);<br>document.getElementById(&quot;mySpan&quot;).innerHTML = (&quot;Seeking: &quot; + x.seeking);</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 Seeking: true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_seeking" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The seeking property returns if the user is currently seeking in the audio.</p>
<p>Seeking is when you move/skip to a new position in the audio.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.seeking</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the user is currently seeking, otherwise it returns false</td>
  </tr>
</table>
