...
<html lang="en-US">
<head>
<title>HTML DOM Label htmlFor Property</title>
 <meta charset="utf-8">
...
<h1>Label <span class="color_h1">htmlFor</span> Property</h1>
<p><a href="dom_obj_label.asp" class="w3-btn w3-white w3-border" title="Label Object Reference">&#10094; Label Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the for attribute of a label:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLabel&quot;).htmlFor;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">male</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_label_htmlfor">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The htmlFor property sets or returns the value of the for attribute of a 
label.</p>
...
<h2>Syntax</h2>
<p>Return the htmlFor property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>labelObject</em>.htmlFor</div></div>
<p>Set the htmlFor property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>labelObject</em>.htmlFor = <em>id</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>id</i></td>
    <td>
  The id of the element the label is bound to</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the id of the element the label is bound to</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the value attribute of a label:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLabel&quot;).htmlFor = &quot;newValue&quot;;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_label_htmlfor2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_label_for.asp">HTML &lt;label&gt; for attribute</a></p>
<hr>

<a href="dom_obj_label.asp" class="w3-btn w3-white w3-border" title="Label Object Reference">&#10094; Label Object</a>
</div>
