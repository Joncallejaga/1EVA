...
<html lang="en-US">
<head>
<title>HTML DOM Input Button autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Input Button <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_button.asp" class="w3-btn w3-white w3-border" title="Input Button Object Reference">&#10094; Input Button Object</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_button_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autofocus property sets or returns whether an input button should automatically 
...
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.autofocus = true|false</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether an input button should get focus when the page loads, or not
  <ul>
      <li>true - The input button gets focus</li>
      <li>false - Default. The input button does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the input button automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
