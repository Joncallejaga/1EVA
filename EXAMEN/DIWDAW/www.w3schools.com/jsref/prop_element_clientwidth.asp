...
<h1>HTML DOM <span class="color_h1">clientWidth</span> Property</h1>
...
<p>The clientWidth property returns the viewable width of an element in 
...
<a href="prop_element_clientheight.asp">clientHeight</a> property.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.clientWidth</div></div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the viewable width of an element in pixels, including padding</td>
  </tr>
</table>
