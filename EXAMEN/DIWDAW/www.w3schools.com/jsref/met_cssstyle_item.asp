...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration item Method</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration item<span class="color_h1">() Method</span></h1>
...
<h3>Example</h3>
<p>Return the first CSS property name from the style declaration of the &quot;ex1&quot; 
element:</p>
<div class="w3-code notranslate jsHigh">
  var style = document.getElementById(&quot;ex1&quot;).style;<br>var propname = style.item(0);<br>
  alert(propname);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_item">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The item() method returns a CSS property name from a CSS declaration block, 
by index.</p>
...
<div class="w3-code w3-border notranslate"><div>
  style.item(<em>index</em>)</div></div>
...
<tr>
<td><em>index</em></td>
<td>Required. A number representing the index of the CSS property</td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A String, representing the name of the property</td>
  </tr>
  </table>
<hr>
<h2>More Examples</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Loop through all the element's style declarations:</p>
<div class="w3-code notranslate jsHigh">
for (i = 0; i &lt; elmnt.style.length; i++) {<br>&nbsp; txt += 
  elmnt.style.item(i)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_length_loop">Try it Yourself &raquo;</a>
</div>
<hr>
