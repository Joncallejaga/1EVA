...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.borderTopLeftRadius = &quot;25px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_bordertopleftradius">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">borderTopLeftRadius</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the shape of the top-left corner</td>
  </tr>
  <tr>
    <td><i>%</i></td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_border-top-left-radius.asp">border-top-left-radius property</a></p>
<hr>
