...
<h3>Example</h3>
 <p>Get the text content of an element:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;myBtn&quot;).textContent;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
Try it Yourself &raquo;
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_textcontent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The textContent property sets or returns the text content of the specified node,
<strong>and all its descendants</strong>.</p>
<p>If you <em>set</em> the textContent property, any child nodes are removed and 
replaced by a single Text node containing the specified string.</p>

<p><strong>Note:</strong> This property is similar to the <a href="prop_node_innertext.asp">innerText</a> property,
however there are some differences:</p>
<ul>
<li>textContent returns the text content of <strong>all</strong> elements, while innerText returns the content of all elements,
<strong>except</strong> for &lt;script&gt; and &lt;style&gt; elements.</li>
<li>innerText will not return the text of elements that are hidden with CSS (textContent will). <a target="_blank" href="tryit.asp?filename=tryjsref_node_textcontent_innertext" class="w3-btn btnsmall" style="float:none;vertical-align:top">Try it &raquo;</a></li>
</ul>

<p><strong>Tip:</strong> Sometimes this property can be used instead of the 
<a href="prop_node_nodevalue.asp">nodeValue</a> property, but remember that this property returns the text of all child nodes as well.</p>
<p><strong>Tip:</strong> To set or return the HTML content of an element, use the <a href="prop_html_innerhtml.asp">innerHTML</a> property.</p>
<hr>
...
<td><em>text</em></td>
<td>String</td>
<td>Specifies the text content of the specified node</td>
</tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text of the node and all its descendants. <br>
  Returns null if the element is a document, a document type, or a notation.</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Change the textual content of a &lt;p&gt; element with id=&quot;myP&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;demo&quot;).textContent = &quot;Paragraph changed!&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_textcontent_set" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Get all the textual content of an &lt;ul&gt; element with id=&quot;myList&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myList&quot;).textContent;</div>
<p>The value of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Coffee Tea</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_textcontent2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>This example demonstrates some of the differences between innerText, innerHTML and 
 textContent:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;p id=&quot;demo&quot;&gt;&nbsp;&nbsp; This element has extra spacing&nbsp;&nbsp;&nbsp;&nbsp; and contains &lt;span&gt;a span 
  element&lt;/span&gt;.&lt;/p&gt;<br><br>&lt;script&gt;<br>function getInnerText() {<br>&nbsp; 
  alert(document.getElementById(&quot;demo&quot;).innerText)<br>}<br><br>function getHTML() 
  {<br>&nbsp; alert(document.getElementById(&quot;demo&quot;).innerHTML)<br>}<br><br>function 
  getTextContent() {<br>&nbsp; alert(document.getElementById(&quot;demo&quot;).textContent)<br>
  }<br>&lt;/script&gt;</div>
