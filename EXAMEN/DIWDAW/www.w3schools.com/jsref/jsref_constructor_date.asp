...
<h3>Example</h3>
<p>The constructor property returns a date's constructor function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_constructor_date">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>In JavaScript, the constructor property returns the constructor function for an object.</p>
<p>The return value is a reference to the function, not the name of the function:</p>
<p>For JavaScript <strong>dates</strong> the constructor property returns
<strong>function Date() { [native code] }</strong></p>
