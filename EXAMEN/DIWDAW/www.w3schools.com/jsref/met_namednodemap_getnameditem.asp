...
<h3>Example</h3>
 <p>Get the value of the onclick attribute of a button element:</p>
<div class="w3-code notranslate jsHigh">
var btn = document.getElementsByTagName("BUTTON")[0];<br>btn.attributes.getNamedItem("onclick").value;</div>
<!--<p>The result of <em>btn</em> could be:</p>
<div class="w3-code notranslate">
myFunction()</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_getnameditem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getNamedItem() method returns the attribute node with the specified name from a NamedNodeMap object.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getNamedItem()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the attribute node with the specified name</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
