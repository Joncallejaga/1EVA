...
<html lang="en-US">
<head>
<title>HTML DOM Datalist options Collection</title>
<meta charset="utf-8">
...
<h1>Datalist <span class="color_h1">options</span> Collection</h1>
<p><a href="dom_obj_datalist.asp" class="w3-btn w3-white w3-border" title="Datalist Object Reference">&#10094; Datalist Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many options there are in a specific &lt;datalist&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;browsers&quot;).options.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datalist_options_length">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The options collection returns a collection of all the options in a &lt;datalist&gt; 
element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datalistObject</em>.options</div></div>
<h2>Properties</h2>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;option&gt; elements in the &lt;datalist&gt; element. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
 <p>Get the value of the first option (index 0) in a datalist:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;browsers&quot;).options[0].value;</div>
   <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Internet Explorer</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datalist_options_index">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
 <p>Get the value of the first option (index 0) in a datalist:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;browsers&quot;).options.item(0).value;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Internet Explorer</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datalist_options_item">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>name_or_id</em>)</p>
 <p>Get the value of the option with id=&quot;google&quot; in a datalist:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;browsers&quot;).options.namedItem(&quot;google&quot;).value;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Chrome</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datalist_options_nameditem">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all options in a datalist, and output the option values:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;);<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.options.length; i++) {<br>&nbsp; &nbsp; txt = txt + x.options[i].value + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">

 Internet Explorer<br>Firefox<br>Chrome<br>Opera<br>Safari</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datalist_options">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_datalist.asp" class="w3-btn w3-white w3-border" title="Datalist Object Reference">&#10094; Datalist Object</a>
</div>
