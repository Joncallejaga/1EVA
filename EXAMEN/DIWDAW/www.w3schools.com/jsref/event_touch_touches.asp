...
<html lang="en-US">
<head>
<title>TouchEvent touches Property</title>
<meta charset="utf-8">
...
<h1>TouchEvent <span class="color_h1">touches</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out how many fingers that touches the surface:</p>
<div class="w3-code notranslate jsHigh">
  function countTouches(event) {<br>&nbsp; var x = event.touches.length;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_touches" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The touches property returns an array of Touch objects, one for each finger 
that is currently touching the surface.</p>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_touch_targettouches.asp">TouchEvent 
targetTouches Property</a></p>
<hr>
<h2>More Examples</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Return the x- and y-coordinates of the touch:</p>
<div class="w3-code notranslate jsHigh">
  function showCoordinates(event) {<br>&nbsp; var x = event.touches[0].clientX;<br>&nbsp; 
  var y = event.touches[0].clientY;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_touches2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
