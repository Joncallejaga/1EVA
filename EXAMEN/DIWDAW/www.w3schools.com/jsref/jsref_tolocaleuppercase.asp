...
<a class="w3-left w3-btn" href="jsref_tolocalelowercase.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="jsref_obj_string.asp"><span class="w3-hide-small">JavaScript String </span>Reference</a>
<a class="w3-right w3-btn" href="jsref_tolowercase.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<div class="w3-code notranslate">
 HELLO WORLD!</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_tolocaleuppercase" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
method to convert a string to lowercase letters, according to the host's current 
locale.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the value of a string converted to uppercase according to the host's current locale</td>
</tr>
<tr>
