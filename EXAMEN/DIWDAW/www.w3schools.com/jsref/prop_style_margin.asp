...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDiv&quot;).style.margin = &quot;50px 10px 20px 30px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_margin">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  <li>One value, like: div {margin: 50px} - all four margins will be 50px</li>
  <li>Two values, like: div {margin: 50px 10px} - the top and bottom margins will be 50px, left and right margins will be 10px</li>
  <li>Three values, like: div {margin: 50px 10px 20px}- the top margin will be 50px, left and right margin will be 10px, bottom margin will be 20px</li>
  <li>Four values, like: div {margin: 50px 10px 20px 30px} - the top margin will be 50px, right margin will be 10px, bottom margin will be 20px, left margin will be 30px</li>
</ul>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_margin2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_margin3">Try it Yourself &raquo;</a>
</div>
<br>
