...
<html lang="en-US">
<head>
<title>HTML DOM Map areas Collection</title>
<meta charset="utf-8">
...
<h1>Map <span class="color_h1">areas</span> Collection</h1>
<p><a href="dom_obj_map.asp" class="w3-btn w3-white w3-border" title="Map Object Reference">&#10094; Map Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many &lt;area&gt; elements there are in a specific image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;planetmap&quot;).areas.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 3</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_map_areas" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The areas collection returns a collection of all &lt;area&gt; elements in an 
image-map.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the source code.</p>
<p><strong>Tip:</strong> To return a collection of all &lt;area&gt; elements that have a href attribute specified, use the 
<a href="coll_doc_links.asp">links</a> collection.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;area&gt; elements in the collection.<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;area&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Returns the &lt;area&gt; element from the collection with the specified id.<br><br>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;area&gt; elements in an image-map in the document. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
 <p>Get the URL of the first &lt;area&gt; element in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;planetmap&quot;).areas[0].href;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/sun.htm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_map_areas_index">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
 <p>Get the URL of the first &lt;area&gt; element in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;planetmap&quot;).areas.item(0).href;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/sun.htm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_map_areas_item">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
 <p>Get the URL of the &lt;area&gt; element with id=&quot;myArea&quot; in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;planetmap&quot;).areas.namedItem(&quot;myArea&quot;).href;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/mercur.htm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_map_areas_nameditem">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all &lt;area&gt; elements in an image-map and output the shape of each area:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;planetmap&quot;);<br>var txt = &quot;&quot;;<br>
 var i;<br>for (i = 0; i &lt; x.areas.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.areas[i].shape + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">

 rect<br>circle<br>circle</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_map_areas_shape">Try it Yourself &raquo;</a>
</div>
<hr>

<a href="dom_obj_map.asp" class="w3-btn w3-white w3-border" title="Map Object Reference">&#10094; Map Object</a>
</div>
