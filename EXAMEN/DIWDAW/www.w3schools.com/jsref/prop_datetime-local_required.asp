...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal required Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">required</span> Property</h1>
...
<h3>Example</h3>
<p>Find out if a local datetime field must be filled out before submitting a 
form:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_required">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The required property sets or returns whether a local datetime field must be filled out before submitting a form.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.required = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a local datetime field should be a required part of form submission.<ul>
      <li>true - The local datetime field is a required part of form   submission</li>
      <li>false - Default. The local datetime field is not a required part   of form submission</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the local datetime field is a required part of form submission, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a local datetime field to be a required part of form submission:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).required = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_required2">Try it Yourself &raquo;</a>
</div>
<hr>
