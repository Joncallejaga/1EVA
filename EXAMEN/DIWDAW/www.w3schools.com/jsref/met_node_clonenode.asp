...
<h3>Example</h3>
 <p>Copy a &lt;li&gt; element from one list to another:</p>
<div class="w3-code notranslate jsHigh">
 // Get the last &lt;li&gt; element (&quot;Milk&quot;) of &lt;ul&gt; with id=&quot;myList2&quot;<br>var itm = document.getElementById(&quot;myList2&quot;).lastChild;<br>
 <br>// Copy the &lt;li&gt; element and its child nodes<br>var cln = itm.cloneNode(true);<br><br>// Append the cloned &lt;li&gt; element to &lt;ul&gt; with id=&quot;myList1&quot;<br>document.getElementById(&quot;myList1&quot;).appendChild(cln);</div>
 <p>Before cloning:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_clonenode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip: </strong>Use the <a href="met_node_appendchild.asp">
appendChild()</a> or <a href="met_node_insertbefore.asp">insertBefore()</a> 
method to insert the cloned node to the document.</p>
<p><strong>Tip:</strong> Set the <em>deep</em> parameter value to true if you want to clone all descendants 
(children), otherwise false.</p>
<hr>
...
<td>Boolean</td>
<td>
Optional. Specifies whether all descendants of the node should be cloned.<br>

<ul>
  <li>true - Clone the node, its attributes, <em>and</em> its descendants</li>
  <li>false - Default. Clone only the node and its attributes<br></li>
</ul>
</td>
</tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the cloned node</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Copy a &lt;div&gt; element, including all its attributes and child elements, and 
append it to the document:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementsByTagName(&quot;DIV&quot;)[0];<br>var cln = elmnt.cloneNode(true);<br>document.body.appendChild(cln);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_clonenode2">Try it Yourself &raquo;</a>
</div>
<hr>
