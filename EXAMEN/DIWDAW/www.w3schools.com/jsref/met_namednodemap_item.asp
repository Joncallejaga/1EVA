...
<p><a href="dom_obj_attributes.asp" class="w3-btn w3-white w3-border" title="Attribute Object Reference">&#10094; Attribute Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the name of the first attribute of a &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName("BUTTON")[0].attributes.item(0).nodeName;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
onclick</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_item" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
at 0.</p>
<p><strong>Note:</strong> There are two ways to access an attribute node at the specified 
index in a NamedNodeMap:</p>
<div class="w3-example">
<h3>This syntax:</h3>
<div class="w3-code notranslate jsHigh">document.getElementsByTagName("BUTTON")[0].attributes.item(1);&nbsp;&nbsp; // The 2nd attribute<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_namednodemap_item2">Try it</a></div>
</div>
<br>
<div class="w3-example">
<h3>Will produce the same result as this syntax:</h3>
<div class="w3-code notranslate jsHigh">
 document.getElementsByTagName("BUTTON")[0].attributes[1];&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The 2nd attribute<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_namednodemap_item3">Try it</a></div>
</div>
<p>You can use whatever method you like, however, the most common method is [<em>index</em>].</p>
<p><strong>Tip:</strong> Use the <a href="prop_namednodemap_length.asp">length</a> 
property to return the number of nodes in a NamedNodeMap object.</p>
<hr>
...
<i>namednodemap</i>.item(<em>index</em>)<br><br>
 
 or simply:<br><br>
<i>namednodemap</i>[<i>index</i>]</div></div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the attribute node at the specified index.<br><br>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Change the value of a &lt;button&gt; element's second attribute:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementsByTagName(&quot;BUTTON&quot;)[0].attributes[1].value = &quot;newClass&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_item4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
