...
<h3>Example</h3>
 <p>Get the node type of the owner document of a &lt;p&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myP").ownerDocument.nodeType;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
9
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_ownerdocument" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">ownerDocument</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>The owner document of the node, as a Document object</td>
</tr>
<tr>
  <th>DOM Version</th>
