...
<html lang="en-US">
<head>
<title>HTML DOM Dialog showModal() Method</title>
<meta charset="utf-8">
...
<h1>Dialog <span class="color_h1">showModal()</span> Method</h1>
<p><a href="dom_obj_dialog.asp" class="w3-btn w3-white w3-border" title="Dialog Object Reference">&#10094; Dialog Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Show a dialog window:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDialog&quot;).showModal(); </div>
<a target="_blank" href="tryit.asp?filename=tryjsref_dialog_showmodal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The showModal() method shows the dialog.</p>
<p>When this method is used to show a dialog window, the user is not able to 
interact with other elements on the page. Use the show() method if you want the 
user to interact with other elements on the page whilst the dialog is shown.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">showModal()</td>
    <td>37.0</td>
