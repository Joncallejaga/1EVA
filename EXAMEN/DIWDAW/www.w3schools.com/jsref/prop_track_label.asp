...
<html lang="en-US">
<head>
<title>HTML DOM Track label Property</title>
 <meta charset="utf-8">
...
<p>The label property sets or returns the value of the label attribute of the track.</p>
<p>The label attribute specifies the label/title of the text track.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.label</div></div>
<p>Set the label property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.label = <em>label</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>label</em></td>
    <td>Specifies the label/title of the text track</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the label/title of the text track</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the label of text track:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myTrack").label = &quot;Norwegian&quot;;</div>
<br></div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_track_label.asp">HTML &lt;track&gt; label attribute</a></p>
<hr>
