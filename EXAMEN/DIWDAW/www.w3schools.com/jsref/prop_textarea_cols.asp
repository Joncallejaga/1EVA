...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_cols2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> You can also use the <a href="prop_style_width.asp">
style.width</a> property to set the width of a text area.</p>
<p><strong>Tip:</strong> Use the <a href="prop_textarea_rows.asp">rows</a> 
property, or the <a href="prop_style_height.asp">style.height</a> property to 
change the height of a text area.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of the text area, in characters</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the width of the text area, in characters:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).cols;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">50</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_cols">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the width of a text area using the style.width property:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).style.width = &quot;500px&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_cols_css">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the width and height of a text area using the cols and rows properties:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).cols = &quot;100&quot;;<br>document.getElementById(&quot;myTextarea&quot;).rows = &quot;10&quot;;</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the width and height of a text area using the style.width and 
style.height properties:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).style.width = &quot;500px&quot;;<br>document.getElementById(&quot;myTextarea&quot;).style.height = &quot;100px&quot;;</div>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_textarea_cols.asp">HTML &lt;textarea&gt; cols attribute</a></p>
<hr>
