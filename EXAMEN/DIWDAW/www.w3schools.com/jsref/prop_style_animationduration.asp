...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_animationduration">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies the length an animation takes to finish. Default value is 0, meaning there will be no animation</td>
  </tr>
    <tr>
    <td>initial</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_animation-duration.asp">animation-duration property</a></p>
<hr>
