...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal step Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">step</span> Property</h1>
...
<h3>Example</h3>
<p>Change the legal number intervals for seconds in a local date field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).step = &quot;10&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_step">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The step property sets or returns the value of the step attribute of a local 
datetime 
field.</p>
<p>The step attribute specifies the legal number intervals for seconds or 
milliseconds in a local datetime field (does not apply for days, months, years, hours or minutes).</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.step</div></div>
<p>Set the step property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.step = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the legal number intervals in the  local datetime field.
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the legal number intervals for milliseconds in a local date field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).step = &quot;.020&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_step2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get the legal number intervals for seconds in a local date field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).step;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">5</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_step3">Try it Yourself &raquo;</a>
</div>
<hr>
