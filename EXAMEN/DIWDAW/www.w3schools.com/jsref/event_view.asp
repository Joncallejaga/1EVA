...
<html lang="en-US">
<head>
<title>view Event Property</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">view</span> Event Property</h1>
<p><a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object Reference">&#10094; Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the event view:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.view;<br></div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">[object Window]</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_view" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The view event property returns a reference to the Window object where the event occured.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.view</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:23%">Return Value:</th>
  <td>A reference to the Window object</td>
  </tr>
  <tr>
