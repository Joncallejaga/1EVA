...
<html lang="en-US">
<head>
<title>HTML DOM Textarea wrap Property</title>
 <meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">wrap</span> Property</h1>
<p><a href="dom_obj_textarea.asp" class="w3-btn w3-white w3-border" title="Textarea Object Reference">&#10094; Textarea Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how the text in a text area should be wrapped when submitting a 
form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).wrap;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">hard // the text in the text area will contain newlines (if any) when submitted in a form</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_wrap">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The wrap property sets or returns the value of the wrap attribute of a 
text area.</p>
<p>The wrap attribute specifies how the text in a text area is to be wrapped 
when submitted in a form.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.wrap</div></div>
<p>Set the wrap property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.wrap = soft|hard</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>soft</td>
    <td>The text in the text area is not wrapped when submitted in a form.  This is default</td>
  </tr>
  <tr>
    <td>hard</td>
    <td>The text in the text area is wrapped (contains newlines) when submitted in a form.
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing how the text area wraps text when submitted in a form</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_textarea_wrap.asp">HTML &lt;textarea&gt; wrap attribute</a></p>
<hr>
