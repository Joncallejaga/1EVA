...
<h3>Example</h3>
 <p>Get the value of the class attribute of an &lt;h1&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName(&quot;H1&quot;)[0].getAttribute(&quot;class&quot;); </div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 democlass</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_getattribute1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getAttribute() method returns the value of the attribute with the specified name, of an element.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_getattributenode.asp">getAttributeNode()</a> method if you want to return the attribute as an Attr object.</p>
<hr>
...
<tr>
 <th style="width:20%;">Return Value:</th>
  <td>A String, representing the specified attribute's value.<br><br><strong>Note:</strong> If the attribute does not exist, the return value is <em>null</em> or an empty string (&quot;&quot;)</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Get the value of the target attribute of an &lt;a&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAnchor&quot;).getAttribute(&quot;target&quot;);</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
_blank
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_getattribute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the value of the onclick event attribute of a &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).getAttribute(&quot;onclick&quot;);</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 myFunction()</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_getattribute2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
