...
<html lang="en-US">
<head>
<title>HTML DOM getBoundingClientRect() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getBoundingClientRect()</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Return the size of an element and its position relative to the viewport:</p>
<div class="w3-code notranslate jsHigh">
  var rect = obj.getBoundingClientRect();<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_getboundingclientrect" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getBoundingClientRect() method returns the size of an element and its 
position relative to the viewport.</p>
<p>This method returns a DOMRect object with eight properties: left, top, right, 
bottom, x, y, width, height.</p>
<p><strong>Note:</strong> The amount of scrolling that has been done of the 
...
values every time the scrolling position changes.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.getBoundingClientRect()</div></div>
...
<tr>
 <th style="width:18%;">DOM Version:</th>
  <td>CSS Object Model (CSSOM) View Module</td>
</tr>
<tr>
 <th style="width:18%;">Return Value:</th>
  <td>A DOMRect object with eight properties: left, top, right, 
bottom, x, y, width, heigh.</td>
</tr>
</table>
