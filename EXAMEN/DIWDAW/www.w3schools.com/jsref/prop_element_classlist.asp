...
<html lang="en-US">
<head>
<title>HTML DOM classList Property</title>
<meta charset="utf-8">
  ...
  <div style="overflow:auto;">
    ...
    <div id='nav_references' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col m4'>
          <h3>JavaScript</h3>
          <a class="w3-bar-item w3-button" href='default.asp'>JavaScript Reference</a>
          <a class="w3-bar-item w3-button" href='default.asp'>HTML DOM Reference</a>
...
<h1>HTML DOM <span class="color_h1">classList</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Add the &quot;mystyle&quot; class to a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).classList.add(&quot;mystyle&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_add" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The classList property returns the class name(s) of an element, as a 
DOMTokenList object.</p>
<p>This property is useful to 
add, remove and toggle CSS classes on an element.</p>
<p>The classList property is read-only, however, you can modify it by using the 
add() and remove() methods.</p>
<p><strong>Cross-browser solution:</strong> The classList property is not supported in IE9 and earlier. However, you can 
use the <a href="prop_html_classname.asp">className</a> property or regular 
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.classList</div></div>
<h2>Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of <a> classes in the list.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Adds one or more class names to an element.<br><br>If the  specified class already exist, the class will not be added</td>
  </tr>
  <tr>
    <td>contains(<em>class</em>)</td>
    <td>
  Returns a Boolean value, indicating whether an element has the  specified class name.
  <p>Possible values:</p>
  <ul>
      <li>true - the element contains the specified class name</li>
      <li>false - the element does not contain the specified class name</li>
  </ul>
    </td>
  </tr>
  <tr>
    <td>item(<em>index</em>)</td>
    <td>Returns the class name with a specified index number from an  element. Index starts at 0.<br><br>Returns <em>null</em> if the index is  out of range</td>
  </tr>
  <tr>
    <td>remove(<em>class1, class2, ...</em>)</td>
    <td>Removes one or more class names from an element.<br><br>
  <strong>Note:</strong> Removing a class that does not exist, does NOT  throw an error</td>
  </tr>
  <tr>
    <td>toggle(<em>class, </em>true|false)</td>
    <td>Toggles between a class name for an element.<br><br>The first  parameter removes the specified class from an element, and returns  false. <br>If the class does not exist, it is added to the element, and the  return value is true.<br><br>The optional second parameter is a Boolean  value that forces the  class to be added or removed, regardless of whether or not it already  existed. For example:<br><br>Remove a class: <em>element</em>.classList.toggle(&quot;classToRemove&quot;, false); <br>Add a class:
  <em>element</em>.classList.toggle(&quot;classToAdd&quot;,  true);<br><br><strong>Note: </strong>The second parameter is not  supported in Internet Explorer or Opera 12 and earlier.</td>
  </tr>
...
<table class="w3-table-all">
 ...
 <th style="width:25%">Return Value:</th>
  <td>A DOMTokenList, containing a list of the class name(s) of an element</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add multiple classes to a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).classList.add(&quot;mystyle&quot;, &quot;anotherClass&quot;, &quot;thirdClass&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_add2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove a class from a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).classList.remove(&quot;mystyle&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_remove" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove multiple classes from a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).classList.remove(&quot;mystyle&quot;, &quot;anotherClass&quot;, &quot;thirdClass&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_remove2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Toggle between two classes for a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).classList.toggle(&quot;newClassName&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_toggle" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get the class name(s) of a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 &lt;div id=&quot;myDIV&quot; class=&quot;mystyle anotherClass thirdClass&quot;&gt;I am a DIV element&lt;/div&gt;<br><br>var x = document.getElementById(&quot;myDIV&quot;).classList;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 mystyle anotherClass thirdClass</div>
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_get" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many class names a &lt;div&gt; element has:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;).classList.length;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 3</div>
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first class name (index 0) of a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;).classList.item(0);</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 mystyle</div>
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_item" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if an element has a "mystyle" class:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;).classList.contains("mystyle");</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_contains" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if an element has a "mystyle" class. If so, remove another class 
name:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>if (x.classList.contains(&quot;mystyle&quot;)) {<br>&nbsp;&nbsp;&nbsp; x.classList.remove(&quot;anotherClass&quot;);<br>} else {<br>
 &nbsp;&nbsp;&nbsp; alert(&quot;Could not find it.&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_contains2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Toggle between classes to create a dropdown button:</p>
<div class="w3-code notranslate jsHigh">
 ...
 <br>/* myFunction toggles between adding and removing the show class, which is used to hide and show the dropdown content */<br>function myFunction() {<br>&nbsp; document.getElementById(&quot;myDropdown&quot;).classList.toggle(&quot;show&quot;);<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onclick_dropdown">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Fallback Example: add</h3>
<p>A cross-browser solution when using the classList.<strong>add()</strong> 
method, for IE9 and earlier:</p>
<div class="w3-code notranslate jsHigh">
  var x, name, arr;<br>x = document.getElementById(&quot;myDIV&quot;);<br>if (x.classList) 
  { <br>&nbsp;&nbsp;&nbsp; x.classList.add(&quot;mystyle&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; 
  name = &quot;mystyle&quot;;<br>&nbsp;&nbsp;&nbsp; arr = x.className.split(&quot; &quot;);<br>&nbsp;&nbsp;&nbsp; 
  if (arr.indexOf(name) == -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  x.className += &quot; &quot; + name;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_add_fallback" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Fallback Example: remove</h3>
<p>A cross-browser solution when using the classList.<strong>remove()</strong> 
method, for IE9 and earlier:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>if (x.classList) { <br>&nbsp;&nbsp;&nbsp; x.classList.remove(&quot;mystyle&quot;);<br>
 } else {<br>&nbsp;&nbsp;&nbsp; x.className = x.className.replace(/\bmystyle\b/g, &quot;&quot;); // For IE9 and earlier<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_remove_fallback" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Fallback Example: contains</h3>
<p>A cross-browser solution when using the classList.<strong>contains()</strong> 
method, for IE9 and earlier:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>if (x.classList) {<br>&nbsp;&nbsp;&nbsp; alert(x.classList.contains(&quot;mystyle&quot;));<br>} else {<br>&nbsp;&nbsp;&nbsp; alert(/\bmystyle\b/g.test(x.className)); // For IE9 and earlier<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_contains_fallback" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Fallback Example: toggle</h3>
<p>A cross-browser solution when using the classList.<strong>toggle()</strong> 
method, for IE9:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>if (x.classList) { <br>&nbsp;&nbsp;&nbsp; x.classList.toggle(&quot;mystyle&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; // For IE9<br>&nbsp;&nbsp;&nbsp; var classes = x.className.split(&quot; &quot;);<br>&nbsp;&nbsp;&nbsp; var i = classes.indexOf(&quot;mystyle&quot;);<br><br>&nbsp;&nbsp;&nbsp; if (i &gt;= 0) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; classes.splice(i, 1);<br>&nbsp;&nbsp;&nbsp; else <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; classes.push(&quot;mystyle&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.className = classes.join(&quot; &quot;); <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_classlist_toggle_fallback" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Create a sticky navigation bar:</p>
<div class="w3-code notranslate jsHigh">
  // Get the navbar<br>var navbar = document.getElementById(&quot;navbar&quot;);<br><br>// 
  Get the offset position of the navbar<br>var sticky = navbar.offsetTop;<br>
  <br>// Add the sticky class to the navbar when you reach its scroll position. Remove the sticky class when you leave the scroll position.<br>function myFunction() {<br>&nbsp; if (window.pageYOffset&nbsp; 
  &gt;= sticky) {<br>&nbsp;&nbsp;&nbsp; navbar.classList.add(&quot;sticky&quot;)<br>&nbsp; } 
  else {<br>&nbsp;&nbsp;&nbsp; navbar.classList.remove(&quot;sticky&quot;);<br>&nbsp; }<br>
  }<br>
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_prop_element_offsettop_sticky" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css_syntax.asp">CSS Syntax</a></p>
<p>CSS Reference: <a href="../cssref/sel_class.asp">CSS <em>.class</em> Selector</a></p>
<p>HTML DOM Reference: <a href="prop_html_classname.asp">HTML DOM className Property</a></p>
<p>HTML DOM Reference: <a href="met_document_getelementsbyclassname.asp">HTML DOM getElementsByClassName() Method</a></p>
<p>HTML DOM Reference: <a href="dom_obj_style.asp">HTML DOM Style Object</a></p>
<hr>

<a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a>
</div>
...
<a href="default.asp">JavaScript Reference</a><br>
