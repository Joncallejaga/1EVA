...
<div class="w3-code notranslate">
 2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_scripts">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;script&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;script&gt; elements in the document. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_scripts2">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 document.write(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_scripts3">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
 <p>Get the contents of the &lt;script&gt; element with id=&quot;myScript&quot; in the document:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_scripts4">Try it Yourself &raquo;</a>
</div>
<br>
...
script:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.scripts;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].id + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">

 myFirstScript<br>mySecondScript</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_scripts5">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>HTML reference: <a href="../tags/tag_script.asp">HTML &lt;script&gt; tag</a></p>
<hr>
