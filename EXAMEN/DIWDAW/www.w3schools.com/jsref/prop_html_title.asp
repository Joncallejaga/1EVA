...
<h3>Example</h3>
<p>Ge the title of an &lt;abbr&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAbbr&quot;).title;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 World Health Organization</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_title" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The title property sets or returns the value of the title attribute of an element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.title</div></div>
<p>Set the title property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.title = <em>text</em></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the title of the element</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the title of a &lt;p&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myP&quot;).title = &quot;The World's Largest Web Development Site&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_title2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_global_title.asp">HTML title Attribute</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>
</div>
