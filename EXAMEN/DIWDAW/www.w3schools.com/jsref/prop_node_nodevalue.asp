...
<h3>Example</h3>
 <p>Get the node value of the first &lt;button&gt; element in the document:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName("BUTTON")[0].childNodes[0].nodeValue;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
Try it Yourself &raquo;
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_nodevalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>If the node is an element node, the nodeValue property will return null.</p>
...
<p>For other node types, the nodeValue property will return different values for different node types.</p>
<p><strong>Tip:</strong> An alternative to the nodeValue property can be the <a href="prop_node_textcontent.asp">
textContent</a> property.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>value</em>&nbsp;</td>
    <td>
  Specifies the node value of the specified node</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the value of the node.
 <p>Possible values:</p>
 <ul>
    <li>Returns <em>null</em> for element nodes and document nodes</li>
    <li>Returns the value of the attribute for attribute nodes</li>
    <li>Returns the content for text nodes</li>
    <li>Returns the content for comment nodes</li>
 </ul>
  </td>
</tr>
<tr>
