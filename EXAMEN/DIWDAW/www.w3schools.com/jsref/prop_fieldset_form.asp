...
<html lang="en-US">
<head>
<title>HTML DOM Fieldset form Property</title>
 <meta charset="utf-8">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form that contains the fieldset.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A reference to the form element containing the fieldset. If the fieldset is not in a form, null is returned</td>
  </tr>
</table>
