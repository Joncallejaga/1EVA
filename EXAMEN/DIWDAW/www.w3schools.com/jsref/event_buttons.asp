...
<html lang="en-US">
<head>
<title>MouseEvent buttons Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">buttons</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out which mouse button(s) that was pressed when a mouse event was triggered:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.buttons;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The buttons property returns a number that indicates which mouse button or 
mouse buttons were 
pressed when a mouse event was triggered.</p>
<p>This property is mostly used together with the onmousedown event.</p>
<p><strong>Tip:</strong> Due to lack of browser support, you may want to look at 
the <a href="event_button.asp">button</a> property instead.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.buttons</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing one or more mouse buttons that were pressed when the mouse event occured. If more than one button is pressed, the values are combined to produce a new number (For example, if the left button (1) and the right button (2) are pressed, the returned value is 1+2, which is 3).<br><br>Possible values:
 <ul>
    <li>1 : Left mouse button</li>
    <li>2 : Right mouse button</li>
    <li>4 : Wheel button or middle button</li>
 ...
 <b>Note:</b> For a left-hand configured mouse, the return values are reversed</td>
</tr>
  <tr>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_button.asp">MouseEvent button Property</a></p>
<p>HTML DOM reference: <a href="event_which.asp">MouseEvent which Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_mouseevent.asp" class="w3-btn w3-white w3-border" title="MouseEvent">&#10094; MouseEvent</a>
