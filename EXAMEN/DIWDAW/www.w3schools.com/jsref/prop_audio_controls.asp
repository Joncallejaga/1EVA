...
<h1>Audio <span class="color_h1">controls</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Enable controls for an audio:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAudio&quot;).controls = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_controls" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The controls property sets or returns whether a audio should display standard 
audio controls.</p>
<p>This property reflects the &lt;audio&gt; controls attribute.</p>
<p>When present, it specifies that the audio controls should be displayed.</p>
<p>Audio controls should include:</p>
<ul>
  <li>Play</li>
  <li>Pause</li>
  <li>Seeking</li>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>audioObject</em>.controls</div></div>
<p>Set the controls property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>audioObject</em>.controls = true|false</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether a audio should have controls displayed, or not
<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if audio controls are displayed, otherwise it returns false</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio controls are displayed:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).controls;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_controls2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_audio_controls.asp">HTML &lt;audio&gt; controls attribute</a></p>
<hr>
