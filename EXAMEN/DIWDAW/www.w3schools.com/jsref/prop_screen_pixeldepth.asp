...
<h3>Example</h3>
<p>Get the color resolution of your screen:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Color Resolution: &quot; + screen.pixelDepth;</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_pixeldepth">Try it Yourself &raquo;</a>
</div>
...
visitor's screen.</p>
<p><b>Tip:</b> The pixelDepth property is not supported in Internet Explorer 9 
and earlier versions. However, the <a href="prop_screen_colordepth.asp">colorDepth</a> property 
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the color resolution, in bits per pixel.<br><br>Possible values:
<ul>
