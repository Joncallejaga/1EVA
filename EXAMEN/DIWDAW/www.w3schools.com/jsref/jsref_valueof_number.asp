...
<h3>Example</h3>
<p>Return the primitive value of a number:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_valueof_num" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The valueOf() method returns the primitive value of a number.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the primitive value of a number</td>
</tr>
<tr>
