...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_defaultstatus">Try it Yourself &raquo;</a>
</div>
<hr>
...
Chrome, Safari or Opera 15 and newer. To allow scripts to change the text of the status, 
...
<p><strong>Note:</strong> Opera 12 and earlier supports this property. 
However, support was removed in version 15.</p>
<p><strong>Note:</strong> Firefox removed this property in version 23.</p>
<hr>
