...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcminutes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcminutes2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using getUTCHours(), getUTCMinutes(), and getUTCSeconds() to display the 
universal time:</p>
<div class="w3-code notranslate jsHigh">
 function addZero(i) {<br>&nbsp;&nbsp;&nbsp; if (i &lt; 10) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i = &quot;0&quot; + i;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return i;<br>}<br>
 <br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById(&quot;demo&quot;);<br>&nbsp;&nbsp;&nbsp; var h = addZero(d.getUTCHours());<br>&nbsp;&nbsp;&nbsp; var m = addZero(d.getUTCMinutes());<br>&nbsp;&nbsp;&nbsp; var s = addZero(d.getUTCSeconds());<br>&nbsp;&nbsp;&nbsp; x.innerHTML = h + &quot;:&quot; + m + &quot;:&quot; + s;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_datetime_utc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
