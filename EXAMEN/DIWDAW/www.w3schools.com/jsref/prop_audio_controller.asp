...
<html lang="en-US">
<head>
<title>HTML DOM Audio controller Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">controller</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio has a media controller:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).controller;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_controller" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The controller property returns the current media controller of the audio.</p>
<p>By default the &lt;audio&gt; element does not have a media controller. If a media controller is specified, the controller property will return it as a MediaController object.</p>
<p><strong>Tip:</strong> Use the <a href="prop_audio_controls.asp">controls</a> 
property to set or return whether a audio should display standard video controls.</p>
<hr>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.controller</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the media controller of the audio.<p>
 MediaController Object properties/methods:</p>
 <ul>
    <li>buffered - get the buffered ranges of the audio</li>
    <li>seekable - get the seekable ranges of the audio</li>
    <li>duration - get the duration of the audio</li>
    <li>currentTime - get or set the current playback position of the audio</li>
    <li>paused - check if the audiois paused</li>
    <li>play() - play the audio</li>
    <li>pause() - pause the audio</li>
    <li>played - check if the audiohas been played</li>
    <li>defaultPlaybackRate - get or set the default playback rate of the  audio</li>
    <li>playbackRate - get or set the current playback rate of the audio</li>
    <li>volume - get or set the volume of the audio</li>
    <li>muted - get or set if the audio is muted</li>
 </ul>
    </td>
    </tr>
</table>
