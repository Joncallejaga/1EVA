...
<h3>Example</h3>
<p>Return the time portion of a Date object as a string, using locale conventions:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_tolocaletimestring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toLocaleTimeString() method returns the time portion of a Date object as a string, using locale conventions.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the time as a string</td>
</tr>
<tr>
