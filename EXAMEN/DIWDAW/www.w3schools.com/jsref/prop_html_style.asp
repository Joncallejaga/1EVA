...
<html lang="en-US">
<head>
<title>HTML DOM style Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">style</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Add a red color to an &lt;h1&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myH1").style.color = &quot;red&quot;; </div>
<!-- <p>Before setting the style:</p>
<div class="w3-code notranslate">
<h1 style="display:inline;">Hello World!</h1>
</div>
<p>After setting the style:</p>
<div class="w3-code notranslate">
<h1 style="display:inline;color:red;">Hello World!</h1>
</div>
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_style" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The style property returns a CSSStyleDeclaration object, which represents an 
element's style attribute.</p>
<p>The style property is used to get or set a specific style of an element using 
different CSS properties.</p>
<p><strong>Note:</strong> It is not possible to set styles by assigning a string 
to the style property, e.g. <em>element</em>.style = &quot;color: red;&quot;. 
To set the style of an element, append a &quot;CSS&quot; property to style and specify a 
value, like this:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh"><em>element</em>.style.backgroundColor = &quot;red&quot;;&nbsp;&nbsp; // set the background color of an element to red<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_element_style2">Try it</a>
</div>
</div>
<p>As you can see, the JavaScript syntax for setting CSS properties is slightly 
different than CSS (backgroundColor instead of background-color).</p>
<p>For a list of all available properties, see our <a href="dom_obj_style.asp">Style Object Reference</a>.</p>

<p><strong>Note:</strong> The style property only returns the CSS declarations set in the element's 
inline style attribute, e.g. <br>&lt;p style=&quot;color: red;&quot;&gt;. It is not possible to use 
this property to get information about style rules from the &lt;head&gt; section 
in the document or 
external style sheets. </p>
<p>However, you can access the &lt;style&gt; element from &lt;head&gt; by using document.getElementsByTagName():</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
var x = document.getElementsByTagName("STYLE")[0];&nbsp;&nbsp; // get the first &lt;style&gt; element <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_element_style3">Try it</a>
</div>
</div>

<p><strong>Note:</strong> It is recommended to use the style property instead of the <a href="met_element_setattribute.asp"><i>element</i>.setAttribute(&quot;style&quot;, 
&quot;...&quot;)</a> method, because the style property will not overwrite other CSS 
properties that may be specified in the style attribute.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return style properties:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.style.<em>property</em></div></div>
<p>Set style properties:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.style.<em>property</em> = <em>value</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>value</em></td>
    <td>
  Specifies the value of the specified property. For example, for  the borderBottom property:<br><br><em>element</em>.style.borderBottom = &quot;2px solid red&quot;;</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A CSSStyleDeclaration object, representing an element's style attribute</td>
  </tr>
  <tr>
 <th style="width:20%;">DOM Version</th>
  <td>Dom Level 2 CSS</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the value of a &lt;p&gt; element's top-border:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myP&quot;).style.borderTop;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 5px solid red</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_style4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>HTML DOM Reference: <a href="dom_obj_style.asp">Style Object Reference</a></p>
