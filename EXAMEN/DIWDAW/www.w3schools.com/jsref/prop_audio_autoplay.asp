...
<h1>Audio <span class="color_h1">autoplay</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio started to play as soon as it was ready:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).autoplay;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_autoplay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autoplay property sets or returns whether the audio should start playing as 
soon as it is loaded.</p>
<p>This property reflects the &lt;audio&gt; autoplay attribute.</p>
<p>When present, it specifies that the audio should automatically start playing 
as soon as it is loaded.</p>
<p><strong>Note:</strong> The &lt;audio&gt; element is new in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.autoplay</div></div>
<p>Set the autoplay property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>audioObject</em>.autoplay = true|false</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether an audio should automatically start playing as soon as it is loaded<ul>
  <li>true - Indicates that the audio should start playing as soon as it is loaded loaded</li>
  <li>false - Default. Indicates that the audio should NOT start playing as soon as it is loaded</li>
</ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio automatically starts playing, otherwise it returns false</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Enable autoplay, and reload the video:</p>
<div class="w3-code notranslate jsHigh">
 var
 x = document.getElementById(&quot;myAudio&quot;);<br>x.autoplay = true;<br>
 x.load();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_autoplay2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of how to create a &lt;video&gt; element and setting the autoplay 
property:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.createElement(&quot;AUDIO&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_autoplay3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_audio_autoplay.asp">HTML &lt;audio&gt; autoplay attribute</a></p>
<hr>

<a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a>
</div>
