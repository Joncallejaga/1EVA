...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDiv&quot;).style.padding = &quot;50px 10px 20px 30px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_padding">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  <li>One value, like: div {padding: 50px} - all four sides will have a padding of 50px</li>
  <li>Two values, like: div {padding: 50px 10px} - the top and bottom padding will be 50px, left and right padding will be 10px</li>
  <li>Three values, like: div {padding: 50px 10px 20px} - the top padding will be 50px, left and right padding will be 10px, bottom padding will be 20px</li>
  <li>Four values, like: div {padding: 50px 10px 20px 30px} - the top padding will be 50px, right padding will be 10px, bottom padding will be 20px, left padding will be 30px</li>
</ul>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_padding2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_padding3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_margin_padding">Try it Yourself &raquo;</a>
</div>
<hr>
