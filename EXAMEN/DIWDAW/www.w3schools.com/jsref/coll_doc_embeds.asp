...
<div class="w3-code notranslate">
 2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_embeds">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The embeds collection returns a collection of all &lt;embeds&gt; elements in the 
document.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;embed&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;embed&gt; elements in the document. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
