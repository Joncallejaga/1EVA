...
<a target="_blank" href="tryit.asp?filename=tryjsref_getfullyear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getFullYear() method returns the year (four digits for dates between year 
1000 and 9999) of the 
specified date. </p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the year of the specified date</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getfullyear2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
