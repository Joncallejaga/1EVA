...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration cssText Property</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration cssText<span class="color_h1"> </span> Property</h1>
...
<h3>Example</h3>
<p>Return the value of the inline style of a H1 element:</p>
<div class="w3-code notranslate jsHigh">
var elmnt = document.getElementsByTagName(&quot;h1&quot;)[0];<br>var x = elmnt.style.cssText;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_csstext">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">cssText</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.style.cssText</div></div>
<p>Set the cssText property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.style.cssText = <em>style</em></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  <td>Level 2 Style CSS</td>
  </tr>
  <tr>
 <th>Return Value:</th>
  <td>A String, representing the inline style of the specified element</td>
  </tr>
  </table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the text of the element's inline style declaration:</p>
<div class="w3-code notranslate jsHigh">
  document.getElementById(&quot;ex1&quot;).style.cssText = &quot;color: blue;&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_csstext2">Try it Yourself &raquo;</a>
</div>
<hr>
