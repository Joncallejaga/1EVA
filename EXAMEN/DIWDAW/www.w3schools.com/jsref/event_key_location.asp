...
<h1>KeyboardEvent <span class="color_h1">location</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the location of the key:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.location;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_location" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The location property returns a number that indicates the location of a key 
on the keyboard or device.</p>
<p>The number is represented by 4 constants:</p>
<p><strong>0. DOM_KEY_LOCATION_STANDARD:</strong></p>
<p>The key is not pressed on the right or left side of the 
keyboard, and was not pressed on the numeric keypad (this value represents 
almost every key on the keyboard, e.g. &quot;A&quot;, &quot;U&quot;, &quot;SPACE&quot; or &quot;5&quot;)</p>
<p><strong>1. DOM_KEY_LOCATION_LEFT:</strong></p>
<p>A left key was pressed (e.g. the left &quot;CTRL&quot; key or left 
&quot;ALT&quot; key on a standard 101 key US keyboard)</p>
<p ><strong>2. DOM_KEY_LOCATION_RIGHT:</strong></p>
<p>A right key was pressed (e.g. the right &quot;CTRL&quot; key or 
right &quot;CTRL&quot; key on a standard 101 key US keyboard)</p>
<p><strong>3. DOM_KEY_LOCATION_NUMPAD:</strong> </p>
<p>The key was pressed on the numeric keypad (e.g. the &quot;2&quot; 
key on the right side on a standard keyboard)</p>
<p><strong>Note:</strong> The location property can only be used on the 
<a href="event_onkeydown.asp">onkeydown</a> and <a href="event_onkeyup.asp">onkeyup</a> event, not 
<a href="event_onkeypress.asp">onkeypress</a>.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.location</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing the location of a key on the keyboard or device<p>The number is represented by 4 constants:</p>
 <p class="auto-style1">0. DOM_KEY_LOCATION_STANDARD<br>1. DOM_KEY_LOCATION_LEFT<br>2. DOM_KEY_LOCATION_RIGHT<br>3. DOM_KEY_LOCATION_NUMPAD</p>
  </td>
</tr>
  <tr>
