...
<html lang="en-US">
<head>
<title>HTML DOM Video currentSrc Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">currentSrc</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the current video:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).currentSrc;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/movie.mp4</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_currentsrc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The currentSrc property returns the URL of the current video.</p>
<p>If no video is set, an empty string is returned.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Tip:</strong> Use the <a href="prop_video_src.asp">src</a> property to set the URL of a video file.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.currentSrc</div>
</div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the current video. Returns the entire URL, including the protocol (like http://). If no video is set, an empty string is returned</td>
</tr>
</table>
