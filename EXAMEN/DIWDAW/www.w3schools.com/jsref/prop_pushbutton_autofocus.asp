...
<html lang="en-US">
<head>
<title>HTML DOM Button autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Button <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Button Object Reference">&#10094; Button Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a button automatically gets focus upon page load:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).autofocus;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_pushbutton_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autofocus property sets or returns whether a button should automatically 
get focus when the page loads, or not.</p>
<p>This property reflects the HTML autofocus attribute.</p>
<p><strong>Note:</strong> The autofocus attribute is new for the &lt;button&gt; 
element in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.autofocus = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a button should get focus when the page loads, or not
  <ul>
      <li>true - The button gets focus</li>
      <li>false - Default. The button does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the button automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_button_autofocus.asp">HTML &lt;button&gt; autofocus attribute</a></p>
<hr>
