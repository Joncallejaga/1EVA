...
<h1><span class="color_h1">onopen</span> Event</h1>
<p>
...
updates.<br>When (and if) a connection is established, output some text in a 
&lt;h1&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var source = new EventSource(&quot;demo_sse.php&quot;);<br>source.onopen = function() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myH1&quot;).innerHTML = &quot;Getting server updates&quot;;<br>};</div>
...
<p>The onopen event occurs when a connection with an event source is opened.</p>
<p><strong>Related events:</strong></p>
<ul>
  <li><a href="event_onmessage_sse.asp">onmessage</a> - Occurs when a message is received</li>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.onopen = function(){<i>myScript</i>};
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.addEventListener(&quot;open&quot;, <em>myScript</em>);
</div>
