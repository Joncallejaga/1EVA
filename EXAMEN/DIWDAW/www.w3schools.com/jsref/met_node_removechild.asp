...
<h3>Example</h3>
 <p>Remove the first &lt;li&gt; element from a list:</p>
<div class="w3-code notranslate jsHigh">
 var list = document.getElementById(&quot;myList&quot;);&nbsp;&nbsp; // Get the &lt;ul&gt; element with id=&quot;myList&quot;<br>
 list.removeChild(list.childNodes[0]);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Remove &lt;ul&gt;'s first child node (index 0)</div>
<p>Before removing:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> The removed child node is no longer part of the DOM. 
However, with the reference returned by this method, it is possible to insert 
the removed child to an element at a later time&nbsp; (See &quot;More Examples&quot;).</p>
<p><strong>Tip:</strong> Use the <a href="met_node_appendchild.asp">appendChild()</a> or 
<a href="met_node_insertbefore.asp">insertBefore()</a> method to 
insert the removed node into the same document. To insert it to another 
document, use the <a href="met_document_adoptnode.asp">document.adoptNode()</a> or 
<a href="met_document_importnode.asp">document.importNode()</a> method.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the removed node, or <em>null</em> if the node does not exist</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Find out if a list has any child nodes. If so, remove its first child node (index 0):</p>
<div class="w3-code notranslate jsHigh">
 // Get the &lt;ul&gt; element with id=&quot;myList&quot;<br>var list = document.getElementById(&quot;myList&quot;);<br><br>// If the &lt;ul&gt; element has any child nodes, remove its first child node<br>if (list.hasChildNodes()) {<br>&nbsp;&nbsp;&nbsp; list.removeChild(list.childNodes[0]);<br>}</div>
<p>Before removing:</p>
<div class="w3-code notranslate">
<ul><li>Coffee</li><li>Tea</li><li>Milk</li></ul>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Remove all child nodes of a list:</p>
<div class="w3-code notranslate jsHigh">
 // Get the &lt;ul&gt; element with id=&quot;myList&quot;<br>var list = document.getElementById(&quot;myList&quot;);<br>
 <br>// As long as &lt;ul&gt; has a child node, remove it<br>while (list.hasChildNodes()) {&nbsp;&nbsp; <br>
 &nbsp;&nbsp;&nbsp;
 list.removeChild(list.firstChild);<br>}</div>
<p>Before removing:</p>
<div class="w3-code notranslate">
<ul><li>Coffee</li><li>Tea</li><li>Milk</li></ul>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild_while" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Remove a &lt;li&gt; element with id=&quot;myLI&quot; from its parent element (without specifying its parent node):</p>
<div class="w3-code notranslate jsHigh">
 var item = document.getElementById(&quot;myLI&quot;);<br>item.parentNode.removeChild(item);<br></div>
<p>Before removing:</p>
<div class="w3-code notranslate">
<ul><li>Coffee</li><li>Tea</li><li>Milk</li></ul>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Remove a &lt;li&gt; element from its parent, and insert it again:</p>
<div class="w3-code notranslate jsHigh">
 var item = document.getElementById(&quot;myLI&quot;);<br><br>function removeLi() {<br>&nbsp;&nbsp;&nbsp; item.parentNode.removeChild(item);<br>}<br><br>function appendLi() {<br>&nbsp;&nbsp;&nbsp; var list = document.getElementById(&quot;myList&quot;);<br>&nbsp;&nbsp;&nbsp; list.appendChild(item);<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Remove a &lt;span&gt; element from its parent and insert it to an &lt;h1&gt; element in another document:</p>
<div class="w3-code notranslate jsHigh">
 var child = document.getElementById(&quot;mySpan&quot;);<br><br>function removeLi() {<br>&nbsp;&nbsp;&nbsp; child.parentNode.removeChild(child);<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var frame = document.getElementsByTagName(&quot;IFRAME&quot;)[0]<br>&nbsp;&nbsp;&nbsp; var h = frame.contentWindow.document.getElementsByTagName(&quot;H1&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var x = document.adoptNode(child);<br>&nbsp;&nbsp;&nbsp; h.appendChild(x);<br>
 }<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_removechild5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
