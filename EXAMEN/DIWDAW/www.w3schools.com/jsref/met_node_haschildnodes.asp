...
<h3>Example</h3>
 <p>Find out if an &lt;ul&gt; element has any child nodes:</p>
<div class="w3-code notranslate jsHigh">
 var list = document.getElementById(&quot;myList&quot;).hasChildNodes();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
<!--<p>The result of <em>list</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_haschildnodes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The hasChildNodes() method returns true if the specified node has any child nodes, otherwise false.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">hasChildNodes()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the node has child nodes, false otherwise</td>
  </tr>
  <tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Remove the first child node (index 0) inside an &lt;ul&gt; element, if the element has any child nodes:</p>
<div class="w3-code notranslate jsHigh">
 // Get the &lt;ul&gt; element with id="myList&quot;<br>var list = document.getElementById(&quot;myList&quot;);<br>
 <br>// If the &lt;ul&gt; element has any child nodes, remove its first child node<br>if (list.hasChildNodes()) {<br>&nbsp;&nbsp;&nbsp; list.removeChild(list.childNodes[0]);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_haschildnodes2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_node_childnodes.asp"><em>element</em>.childNodes() Method</a></p>
