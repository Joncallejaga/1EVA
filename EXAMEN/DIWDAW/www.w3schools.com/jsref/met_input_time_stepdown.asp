...
<html lang="en-US">
<head>
<title>HTML DOM Input Time stepDown() Method</title>
<meta charset="utf-8">
...
<h1>Input Time <span class="color_h1">stepDown()</span> Method</h1>
...
<h3>Example</h3>
<p>Decrement the value of a time field by 10 minutes:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTime&quot;).stepDown(10);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_stepdown">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stepDown() method decrements the value of the time field by a specified number.</p>
<p>This method will only have an affect on MINUTES (not hours, seconds or milliseconds).</p>
<p><strong>Tip:</strong> To increment the value, use the <a href="met_input_time_stepup.asp">stepUp()</a> method.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.stepDown(<em>number</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the amount of minutes the time field should  decrease.<br><br>If omitted, the minutes are decremented by &quot;1&quot;</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Decrement the minutes by 1 (default):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTime&quot;).stepDown();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_stepdown2">Try it Yourself &raquo;</a>
</div>
<hr>
