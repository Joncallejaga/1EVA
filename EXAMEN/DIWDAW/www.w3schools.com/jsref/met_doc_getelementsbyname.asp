...
<h3>Example</h3>
 <p>Get all elements with the specified name:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementsByName(&quot;fname&quot;);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_getelementsbyname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_getelementsbyname_length">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByName(&quot;animal&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; if (x[i].type == &quot;checkbox&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].checked = true;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_getelementsbyname_loop">Try it Yourself &raquo;</a>
</div>
<hr>
