...
<h3>Example</h3>
 <p>Find out if the &lt;body&gt; element has any attributes:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.body.hasAttributes()</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
false
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_hasattributes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
  ...
  <td>A Boolean, returns true if the node has attributes, otherwise false</td>
</tr>
<tr>
  <th>DOM Version</th>
