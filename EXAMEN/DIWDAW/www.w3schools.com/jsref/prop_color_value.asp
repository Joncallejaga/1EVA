...
<html lang="en-US">
<head>
<title>HTML DOM Input Color value Property</title>
 <meta charset="utf-8">
...
<h1>Input Color <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_color.asp" class="w3-btn w3-white w3-border" title="Input Color Object Reference">&#10094; Input Color Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the color of a color picker:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myColor&quot;).value = &quot;#FF8040&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_color_value">Try it Yourself &raquo;</a>
</div>
<hr>
...
color picker.</p>
<p>The value attribute specifies the color for the color picker.</p>
<p><strong>Note:</strong> If nothing is specified, the default color is #000000 (black).</p>
<hr>
...
<p><strong>Note:</strong> The &lt;input type=&quot;color&quot;&gt; element does not show any colorpicker in Internet Explorer and Safari.</p>
<hr>

<h2>Syntax</h2>
<p>Return the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>colorObject</em>.value
</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>colorObject</em>.value =<em> #hexvalue</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>#hexvalue</em></td>
    <td>
  Specifies a color for the color picker. <br><br>The value must be a  hexadecimal (hex) value: 3 double digit numbers, starting with a # sign  (like #FF8040).<br><br><strong>Note:</strong> Color keywords (like &quot;red&quot; or  &quot;blue&quot;) are not allowed.<br><br><strong>Note:</strong> Default color is  #000000 (black).</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a color</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the color of a color picker:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myColor&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">#ff0080</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_color_value2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>An example that shows the difference between the defaultValue and value property:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myColor&quot;);<br>var defaultVal = x.defaultValue;<br>var currentVal = x.value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_color_defaultvalue2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_colors.asp">HTML Colors</a></p>
<p>HTML tutorial: <a href="https://www.w3schools.com/html/html_colorvalues.asp">HTML Color Values (HEX)</a></p>
<p>HTML reference: <a href="../tags/att_input_value.asp">HTML &lt;input&gt; value attribute</a></p>
<hr>

<a href="dom_obj_color.asp" class="w3-btn w3-white w3-border" title="Input Color Object Reference">&#10094; Input Color Object</a>
</div>
