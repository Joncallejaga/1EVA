...
<html lang="en-US">
<head>
<title>HTML DOM Input Password value Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">value</span> Property</h1>
...
<h3>Example</h3>
<p>Get the value of the value attribute of a password field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myPsw&quot;).value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_value">Try it Yourself &raquo;</a>
</div>
<hr>
...
password field.</p>
<p>The value attribute contains the default value OR the value a user types in 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies the value of the password field</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the password of the password field</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_value2">Try it Yourself &raquo;</a>
</div>
<br>
