...
<h1>Video <span class="color_h1">buffered</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;);<br>document.getElementById(&quot;demo&quot;).innerHTML = &quot;Start: &quot; + x.buffered.start(0)<br>+ &quot; End: &quot; + x.buffered.end(0);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_buffered" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The buffered property returns a TimeRanges object.</p>
<p>The TimeRanges object represents the user's buffered ranges of the video.</p>
<p>A buffered range is a time-range of buffered video. The user gets several buffered ranges if he/she skips in the video.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.buffered</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the buffered parts of the video.<p>TimeRanges Object Properties:</p>
 <ul>
    <li>length - get the number of buffered ranges in the video</li>
