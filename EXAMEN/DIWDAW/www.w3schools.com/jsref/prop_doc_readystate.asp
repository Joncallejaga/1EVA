...
<div class="w3-code notranslate">
 complete</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_readystate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the status of the current document.<br><br>One of five values:
<ul>
