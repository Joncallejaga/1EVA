...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_usemap2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The useMap property sets or returns the value of the usemap attribute of an image.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the value of the usemap attribute of the image, including the hash character (&quot;#&quot;)</td>
  </tr>
</table>
...
<div class="w3-code notranslate">
 #planetmap</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_usemap" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_img_usemap.asp">HTML &lt;img&gt; usemap attribute</a></p>
<hr>
