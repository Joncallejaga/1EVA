...
<h1>JavaScript Error <span class="color_h1">message</span> Property</h1>
...
<h3>Example</h3>
<p>Return an error message (we have written &quot;alert&quot; as &quot;adddlert&quot; to 
deliberately produce an error):</p>
<div class="w3-code notranslate jsHigh">
 try {<br>&nbsp;&nbsp;&nbsp; adddlert(&quot;Welcome guest!&quot;);<br>}<br>catch(err) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = err.message;<br>}</div>
<!--<p>The result (depending on the browser) could be:</p>
<div class="w3-padding w3-white notranslate">
 adddlert is not defined</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_error_message" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The message property sets or returns an error message.</p>
<p><strong>Tip:</strong> Also see the <a href="prop_error_name.asp">name</a> property of the Error object.</p>
<hr>
...
<i>errorObj</i>.message</div></div>

<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing a description of an error (varies depending on the browser)</td>
</tr>
<tr>
