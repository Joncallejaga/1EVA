...
<h1>Audio <span class="color_h1">textTracks</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).textTracks.length;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_texttracks" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The textTracks property returns a TextTrackList object.</p>
<p>The TextTrackList object represents the available text tracks for the audio.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.textTracks</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the available text tracks for the the audio.<p>
 TextioTrackList Object:</p>
 <ul>
    <li>length - get the number of text tracks available in the audio</li>
 ...
 <p><strong>Note: </strong>The first available TextTrack object is <em>index</em> 0</p>
    ...
    <td>Represents a text track.<p>TextTrack Object Properties:</p>
 <ul>
    <li>kind - get the type of the text track (can be: &quot;subtitles&quot;,  &quot;caption&quot;, &quot;descriptions&quot;, &quot;chapters&quot;, or &quot;metadata&quot;) </li>
    ...
    <li>activeCues - get the currently active text track cues as a  TextTrackCueList object</li>
