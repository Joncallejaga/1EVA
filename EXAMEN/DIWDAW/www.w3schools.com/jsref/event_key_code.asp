...
<h1>KeyboardEvent <span class="color_h1">code</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return the key that was pressed:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.code;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_code" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The code property returns the key that triggered the event.</p>
<p><strong>Note:</strong> This property returns different values for different 
keyboard layouts.</p>
<p><strong>Tip:</strong> To make sure you return the correct character, use
<code class="w3-codespan"><a href="event_key_key.asp">event.key</a></code> 
instead</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A 
  String, representing the key that was pressed</td>
</tr>
  </table>
