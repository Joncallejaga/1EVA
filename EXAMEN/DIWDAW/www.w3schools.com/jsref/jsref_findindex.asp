...
<h1>JavaScript Array <span class="color_h1">findIndex()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var ages = [3, 10, 18, 20];<br><br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= 18;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.findIndex(checkAdult);<br>}</div>
<!--<p>The result will be:</p>
<div class="w3-code notranslate">
 2</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_findindex">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The findIndex() method returns the index of the first element in an array that pass a 
test (provided as a function).</p>
<p>The findIndex() method executes the function once for each element present in the 
array:</p>
<ul>
  <li>If it finds an array element where the function returns a <em>true</em> value, findIndex() returns the index of that array element (and does not check the remaining values)</li>
  <li>Otherwise it returns -1</li>
</ul>
<p><strong>Note:</strong> findIndex() does not execute the function for array 
elements without values.</p>
<p><strong>Note:</strong> findIndex() does not change the original array.</p>
<hr>
...
<i>array</i>.findIndex(<em>function(currentValue, index, arr), thisValue</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>Returns the array element index if any of the elements in the array pass the test, otherwise it returns -1</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the index of the first element in the array that has a value above a 
specific number:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;p&gt;Minimum age: &lt;input type=&quot;number&quot; id=&quot;ageToCheck&quot; value=&quot;18&quot;&gt;&lt;/p&gt;<br>
 &lt;button onclick=&quot;myFunction()&quot;&gt;Try it&lt;/button&gt;<br><br>&lt;p&gt;Any ages above: &lt;span id=&quot;demo&quot;&gt;&lt;/span&gt;&lt;/p&gt;<br><br>&lt;script&gt;<br>var ages = [4, 12, 16, 20];<br>
 <br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= document.getElementById(&quot;ageToCheck&quot;).value;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.findIndex(checkAdult);<br>}<br>
 &lt;/script&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_findindex2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
