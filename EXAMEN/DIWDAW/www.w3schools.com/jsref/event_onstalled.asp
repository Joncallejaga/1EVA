...
<h1><span class="color_h1">onstalled</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the browser is trying to get media data, but data 
is not available:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video onstalled=&quot;myFunction()&quot;&gt;</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The onstalled event occurs when the browser is trying to get media data, but 
...
<em>object</em>.onstalled = function(){<i>myScript</i>};
 </div></div>
<div class="w3-example">
