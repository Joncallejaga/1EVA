...
<h3>Example</h3>
<p>Get the number of milliseconds since 
midnight of January 1, 1970:</p>
<div class="w3-code notranslate jsHigh">
 var n = event.timeStamp;</div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_timestamp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timeStamp event property returns the number of milliseconds since 
midnight of January 1, 1970, when the event occured.</p>
<p>It can be used as a time stamp of when the event was triggered.</p>
<p>Not all systems provide this information, therefore, timeStamp may be not available for all systems/events.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the number of milliseconds since midnight of January 1, 1970</td>
  </tr>
  <tr>
