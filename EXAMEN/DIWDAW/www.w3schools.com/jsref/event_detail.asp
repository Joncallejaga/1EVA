...
<html lang="en-US">
<head>
<title>MouseEvent detail Property</title>
<meta charset="utf-8">
...
<h1>UiEvent <span class="color_h1">detail</span> Property</h1>
<p><a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object Reference">&#10094; Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many times the mouse was clicked in the same area:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.detail;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_detail" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The detail property returns a number with details about the event.</p>
<p>When used on onclick and ondblclick, the number indicates the current click 
count.</p>
<p>When used on onmousedown and onmouseup,the number indicates the current click 
count plus 1.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.detail</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing the number of clicks that happened in a short amount of time.<br><br><strong>Note:</strong> The returned value for a ondblclick event is always &quot;2&quot;<br><strong>Note:</strong> The returned value for a onmouseover or onmouseout event is always &quot;0&quot;</td>
</tr>
  <tr>
