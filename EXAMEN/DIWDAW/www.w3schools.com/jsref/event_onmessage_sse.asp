...
<h1><span class="color_h1">onmessage</span> Event</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object">&#10094; Event Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a new EventSource object, and specify the URL of the page sending the 
updates.<br>Each time an update is received, the onmessage event occurs. When an 
onmessage event occurs, put the received data into the &lt;div&gt; element with id=&quot;myDIV&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var source = new EventSource(&quot;demo_sse.php&quot;);<br>source.onmessage = function(event) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDIV&quot;).innerHTML += event.data + &quot;&lt;br&gt;&quot;;<br>};</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onmessage_sse">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onmessage event occurs when a message is received through an event 
source.</p>
<p>The event object for the onmessage event supports the following properties:</p>
<ul>
  <li>data - Contains the actual message</li>
  <li>origin - The URL of the document that invoked the event</li>
  <li>lastEventId - the identifier of the last message seen in the event stream</li>
</ul>
<p><strong>Related events:</strong></p>
<ul>
  <li><a href="event_onopen_sse.asp">onopen</a> - Occurs when a connection to the server is open</li>
  <li><a href="event_onerror_sse.asp">onerror</a> - Occurs when a problem occurs</li>
</ul>
<p>For more information about Server-Sent Events, read our
<a href="../html/html5_serversentevents.asp">HTML5 Server-Sent Events Tutorial</a>.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.onmessage = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmessage_sse" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><p>Using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.addEventListener(&quot;message&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmessage_sse_listener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Bubbles:</th>
  <td>No</td>
  </tr>
    <tr>
 <th style="width:20%">Cancelable:</th>
  <td>No</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the document that invoked the onmessage event:</p>
<div class="w3-code notranslate jsHigh">
 var source = new EventSource(&quot;demo_sse.php&quot;);<br>source.onmessage = function(event) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDIV&quot;).innerHTML = event.origin;<br>};</div>
<p>The result could be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmessage_sse2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
