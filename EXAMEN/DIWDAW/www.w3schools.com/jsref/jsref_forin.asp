...
<h1>JavaScript <span class="color_h1">for/in</span> Statement</h1>
...
<div class="w3-code notranslate">
 John Doe 25</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_forin" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The for/in statement loops through the properties of an object.</p>
<p>The block of code inside the loop will be executed once for each property.</p>
...
<p><strong>Note:</strong> Do not use the for/in statement to loop through arrays 
where index order is important. Use the <a href="jsref_for.asp">for</a> statement instead.</p>
...
<div class="w3-code w3-border notranslate jsHigh"><div>
 <i>for (var</i> in
 <i>object) {<br>&nbsp;&nbsp;&nbsp; code block to be executed<br>}</i></div></div>
