...
<h1>HTML DOM <span class="color_h1">console.error()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Write an error to the console:</p>
<div class="w3-code notranslate jsHigh">
console.error("You made a mistake&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_error" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.error() method writes an error message to the console.</p>
<p>The console is useful for testing purposes.</p>
<p><strong>Tip:</strong> When testing this method, be sure to have the console 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.error()</td>
    <td>Yes</td>
    <td>8.0</td>
    <td>4.0</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.error(<em>message</em>)</div>
</div>
...
<td>Required. The message or object to write as an error</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use an object as the error message:</p>
<div class="w3-code notranslate jsHigh">
var myObj = { firstname : "John", lastname : "Doe" };<br>
console.error(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_error2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use an Array as the error message:</p>
<div class="w3-code notranslate jsHigh">
var myArr = ["Orange", "Banana", "Mango", "Kiwi" ];<br>
console.error(myArr);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_error3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
