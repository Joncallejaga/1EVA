...
<h3>Example</h3>
 <p>Get the URI of the namespace for an XHTML document:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.documentElement.namespaceURI;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
http://www.w3.org/1999/xhtml
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_namespaceuri" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The namespaceURI property returns the URI of the specified node&#39;s namespce.</p>
<p><strong>Note:</strong> An element node inherits the namespace of its parent 
node, therefore, all elements in an XHTML document has the namespaceURI &quot;<a href="http://www.w3.org/1999/xhtml">http://www.w3.org/1999/xhtml</a>&quot;.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URI of the node's namespace, or <em>null</em> if the node is not in a namespace</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="met_node_isdefaultnamespace.asp"><em>node.</em>isDefaultNamespace() Method</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
