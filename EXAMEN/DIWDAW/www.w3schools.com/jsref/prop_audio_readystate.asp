...
<html lang="en-US">
<head>
<title>HTML DOM Audio readyState Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">readyState</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the current ready state of the audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).readyState;<br>
 document.getElementById(&quot;demo&quot;).innerHTML = x;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 4 // Indicates that there is enough data available to start playing</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_readystate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
audio.</p>
<p>The ready state indicates if the audio is ready to play or not.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.readyState</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>Represents the ready state of the audio element:<ul><li>
  0  = HAVE_NOTHING - no information whether or not the audio is ready</li>
    <li>1 = HAVE_METADATA - metadata for the audio is ready</li>
    <li>2 = HAVE_CURRENT_DATA - data for the current playback position is  available, but not enough data to play next frame/millisecond</li>
