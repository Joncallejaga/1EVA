...
<html lang="en-US">
<head>
<title>MouseEvent screenY Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">screenY</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get coordinates of the mouse pointer, relative to the screen, when the mouse button is clicked 
on an element:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.screenX;&nbsp;&nbsp;&nbsp;&nbsp; // Get the horizontal coordinate<br>var y = event.screenY;&nbsp;&nbsp;&nbsp;&nbsp; // Get the vertical coordinate<br>var coor = &quot;X coords: &quot; + x + &quot;, Y coords: &quot; + y;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_screenxy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The screenY property returns the vertical coordinate (according to the users computer screen) of the mouse pointer when an event was triggered.</p>
<p><strong>Tip:</strong> To get the horizontal coordinate (according to the screen) of the mouse pointer, use the <a href="event_screenx.asp">screenX</a> property.</p>
