...
<html lang="en-US">
<head>
<title>stopPropagation() Event Method</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">stopPropagation()</span> Event Method</h1>
<p>
...
<h3>Example</h3>
<p>Prevent any propagation of the same event:</p>
<div class="w3-code notranslate jsHigh">
  function func1(event) {<br>&nbsp; alert(&quot;DIV 1&quot;);<br>&nbsp; 
  event.stopPropagation();<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_stoppropagation" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">stopPropagation()</code> method prevents propagation of the same 
event from being called.</p>
<p>Propagation means bubbling up to parent elements <em>or</em> capturing down to child 
elements.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.stopPropagation()</div></div>
<h2>Parameters</h2>
