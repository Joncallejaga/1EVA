...
<html lang="en-US">
<head>
<title>HTML DOM Option label Property</title>
 <meta charset="utf-8">
...
<h1>Option <span class="color_h1">label</span> Property</h1>
<p><a href="dom_obj_option.asp" class="w3-btn w3-white w3-border" title="Option Object Reference">&#10094; Option Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the label value of an option in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myOption&quot;).label = &quot;newLabel&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_label3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The label property sets or returns the value of the label attribute in an 
option in a drop-down list.</p>
...
<h2>Syntax</h2>
<p>Return the label property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>optionObject</em>.label
</div></div>
<p>Set the label property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>optionObject</em>.label = <i>text</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a shorter version for the option</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the label of the option in the drop-down list. If the label attribute is not specified, it will return the &lt;option&gt; element's text content instead (same as the text property)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the label value of an option in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOption&quot;).label;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Mercedes</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_label">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Alert the label value of the selected option in a drop-down 
list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).selectedIndex;<br>alert(document.getElementsByTagName(&quot;option&quot;)[x].label);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_label2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_option_label.asp">HTML &lt;option&gt; label attribute</a></p>
<hr>

<a href="dom_obj_option.asp" class="w3-btn w3-white w3-border" title="Option Object Reference">&#10094; Option Object</a>
</div>
