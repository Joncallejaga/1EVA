...
<html lang="en-US">
<head>
<title>HTML DOM console.groupCollapsed() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.groupCollapsed()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a collapsed group of messages in the console:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.groupCollapsed();<br>console.log(&quot;Hello again, 
  this time inside a collapsed group!&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_groupcollapsed" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.groupCollapsed() method indicates the start of a collapsed message group.</p>
<p>Click the expand button to open the message group.</p>
<p>All messages will from now on be written inside this group.</p>
<p><strong>Tip:</strong> Use the <a href="met_console_groupend.asp">
console.groupEnd()</a> method to end the group.</p>
<p><strong>Tip:</strong> Use the <a href="met_console_group.asp">console.group()</a> method 
for not-collapsed message groups.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.groupCollapsed()</td>
    <td>6</td>
    <td>11.0</td>
    <td>9.0</td>
    <td>5.1</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.groupCollapsed(<em>label</em>)</div>
</div>
...
<td><em>label</em></td>
<td>String</td>
<td>Optional. A label for the group</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>End a group by using the console.groupEnd() method:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.groupCollapsed();<br>console.log(&quot;Hello again, 
  this time inside a collapsed group!&quot;);<br>console.groupEnd();<br>console.log(&quot;and we 
  are back.&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_groupcollapsed2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specifying a label for the collapsed group:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.groupCollapsed(&quot;myLabel&quot;);<br>console.log(&quot;Hello again, 
  this time inside a collapsed group, with a label!&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_groupcollapsed3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
