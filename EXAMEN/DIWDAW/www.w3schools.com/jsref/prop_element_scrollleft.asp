...
<h1>HTML DOM <span class="color_h1">scrollLeft</span> Property</h1>
...
<p>The scrollLeft property sets or returns the number of pixels an element's content is scrolled horizontally.</p>
<p><strong>Tip:</strong> Use the <a href="prop_element_scrolltop.asp">scrollTop</a> property to set or return the number 
of pixels an element's content is scrolled vertically.</p>
...
<h2>Syntax</h2>
<p>Return the scrollLeft property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.scrollLeft</div></div>
<p>Set the scrollLeft property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.scrollLeft =<em> pixels</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>pixels</em></td>
    <td>
     Specifies the number of pixels the element's content is scrolled  horizontally.<br><br>Special notes:  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of pixels that the element's content has been scrolled horizontally</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 ...
 <a href="prop_document_documentelement.asp">documentElement</a> property for these browsers<br>body.scrollLeft += 30;<br>
 body.scrollTop += 10;<br>html.scrollLeft += 30;<br>html.scrollTop += 10;</div>
