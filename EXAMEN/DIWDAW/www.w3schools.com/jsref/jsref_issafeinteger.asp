...
<html lang="en-US">
<head>
<title>JavaScript Number isSafeInteger() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">isSafeInteger()</span> Method</h1>
...
<h3>Example</h3>
<p>Check whether a value is a safe integer:</p>
<div class="w3-code notranslate jsHigh">
 Number.isSafeInteger(123) //true<br>Number.isSafeInteger(-123) //true<br>Number.isSafeInteger(5-2) //true<br>Number.isSafeInteger(0) //true<br>Number.isSafeInteger(0.5) //false<br>Number.isSafeInteger(Math.pow(2, 53)) //false<br>Number.isSafeInteger(Math.pow(2, 53) - 1) //true<br>Number.isSafeInteger('123') //false<br>Number.isSafeInteger(false) //false<br>Number.isSafeInteger(Infinity) //false<br>Number.isSafeInteger(-Infinity) //false<br>Number.isSafeInteger(0 / 0) //false</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_issafeinteger" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Number.isSafeInteger() method determines whether a value is a safe integer.</p>
<p>A safe integer is an integer that can be exactly represented as an IEEE-754 
double precision number (all integers from (2<sup>53</sup> - 1) to -(2<sup>53</sup> - 1))</p>
<p>This method returns true if the value is of the type Number, and a safe integer. Otherwise it returns false.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 Number.isSafeInteger(<em>value</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the value is a safe integer Number, otherwise it returns false</td>
</tr>
<tr>
