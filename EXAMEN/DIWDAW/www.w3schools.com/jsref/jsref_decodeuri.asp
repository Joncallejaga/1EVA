...
<div class="w3-code notranslate jsHigh">
 var uri = "my test.asp?name=ståle&amp;car=saab";<br>var enc = encodeURI(uri);<br>
 var dec = decodeURI(enc);<br>var res = enc + "&lt;br&gt;" + dec;</div>
<!--<p>The result of <em>res</em> will be:</p>
<div class="w3-code notranslate jsHigh">
 my%20test.asp?name=st%C3%A5le&amp;car=saab&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Encoded URI<br>my test.asp?name=ståle&amp;car=saab&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Decoded URI</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_decodeuri" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The decodeURI() function is used to decode a URI.</p>
<p><b>Tip:</b> Use the <a href="jsref_encodeuri.asp">encodeURI()</a> function to encode a URI.</p>
<hr>
