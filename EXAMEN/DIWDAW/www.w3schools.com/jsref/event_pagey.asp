...
<html lang="en-US">
<head>
<title>MouseEvent pageY Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">pageY</span> Property</h1>
<p>
...
<p>The pageY property returns the vertical coordinate (according to the 
document) of the mouse pointer when a mouse event 
was triggered.</p>
<p>The document is the web page.</p>
<p><strong>Tip:</strong> To get the horizontal coordinate (according to the 
document) of the mouse pointer, 
use the <a href="event_pagex.asp">pageX</a> property.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">pageY</td>
    <td>Yes</td>
    <td>12.0</td>    
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing the vertical coordinate of the mouse pointer, in pixels</td>
</tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of the differences between clientX and clientY and screenX 
and screenY:</p>
<div class="w3-code notranslate jsHigh">
 var pX = event.pageX;<br>var cX = event.clientX;<br>var pY = event.pageY;<br>var cY = event.clientY;<br>var coords1 = &quot;page - X: &quot; + pX + &quot;, Y coords: &quot; + pY;<br>var coords2 = &quot;client - X: &quot; + cX + &quot;, Y coords: &quot; + cY;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_pagexy_clientxy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_pagex.asp">MouseEvent pageX Property</a></p>
