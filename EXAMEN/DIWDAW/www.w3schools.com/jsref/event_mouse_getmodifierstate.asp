...
<html lang="en-US">
<head>
<title>MouseEvent getModifierState() Method</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">getModifierState()</span> Method</h1>
<p>
...
<h3>Example</h3>
<p>Is the Caps Lock key activated?</p>
<div class="w3-code notranslate jsHigh">
var x = event.getModifierState(&quot;CapsLock&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_getmodifierstate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getModifierState() method returns true if the specified modifier key was 
pressed, or activated.</p>
<p>Modifier keys that are activated only when they are being pressed down:</p>
<ul>
  <li>Alt</li>
  <li>AltGraph</li>
  <li>Control</li>
...
<p>Modifier keys that are activated when they are clicked, and deactivated when 
they are clicked again:</p>
<ul>
  <li>CapsLock</li>
  <li>NumLock</li>
  <li>ScrollLock</li>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getModifierState()</td>
    <td>30</td>
    <td>9.0</td>
    <td>15</td>
    <td>10.1</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.getModifierState(<em>modifierKey</em>)</div></div>
...
<tr>
  <td><em>modifierKey</em></td>
  <td>The key to check if is activated or not. Legal Values:<br>
  "Alt"<br>
  "AltGraph"<br>
  "CapsLock"<br>
  "Control"<br>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Boolean, true if the specified modifier key is activated, otherwise false.</td>
</tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Is the shift key breing pressed down?</p>
<div class="w3-code notranslate jsHigh">
 var x = event.getModifierState(&quot;Shift&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_getmodifierstate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_altkey.asp">MouseEvent altKey Property</a></p>
<p>HTML DOM reference: <a href="event_ctrlkey.asp">MouseEvent ctrlKey Property</a></p>
<p>HTML DOM reference: <a href="event_metakey.asp">MouseEvent metaKey Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
