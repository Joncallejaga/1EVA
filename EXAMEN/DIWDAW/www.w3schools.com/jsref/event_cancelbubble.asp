...
<html lang="en-US">
<head>
<title>cancelBubble() Event Method</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">cancelBubble()</span> Event Property</h1>
<p>
...
<h3>Example</h3>
<p>Prevent any bubbling of the current event:</p>
<div class="w3-code notranslate jsHigh">
  function func1(event) {<br>&nbsp; alert(&quot;DIV 1&quot;);<br>&nbsp; 
  event.cancelBubble = true;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_cancelbubble" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">cancelBubble()</code> method prevents the event-flow from bubbling up to parent elements.</p>
<p><strong>Tip:</strong> To prevent both bubbling up to parent elements and capturing down to child elements,
use the <code class="w3-codespan"><a href="event_stoppropagation.asp">stopPropagation()</a></code> method instead.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.cancelBubble = true|false</div></div>
<h2>Parameters</h2>
