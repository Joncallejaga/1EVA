...
<html lang="en-US">
<head>
<title>HTML DOM Dialog close() Method</title>
<meta charset="utf-8">
...
<h1>Dialog <span class="color_h1">close()</span> Method</h1>
...
<p>The close() method closes the dialog.</p>
<p><strong>Tip:</strong> This method is often used together with the <a href="met_dialog_show.asp">show()</a> method.</p>
<hr>
