...
<html lang="en-US">
<head>
<title>HTML DOM Anchor port Property</title>
 <meta charset="utf-8">
...
<div class="w3-code notranslate">
 4097</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_port" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
is the scheme's default port - like 80, or 443), some browsers will display 0 or 
nothing.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>anchorObject</em>.port
</div></div>
<p>Set the port property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>anchorObject</em>.port =<i> number</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the port number of a URL</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the port number of the URL</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the port number of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").port = &quot;80&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_port2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="prop_loc_port.asp">location.port Property</a></p>
<hr>
