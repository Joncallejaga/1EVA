...
<h3>Example</h3>
<p>Find out if a specific event can bubble or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.bubbles;<br></div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_bubbles" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The bubbles event property returns a Boolean value that indicates whether or not 
an event is a bubbling event.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>A Boolean, indicating whether the specified <em>event</em> is a bubbling event.
 <p>Possible values:</p>
 <ul>
    <li>true - The event can bubble up through the DOM</li>
    <li>false - The event  does not bubble </li>
 </ul>
  </td>
  </tr>
  <tr>
