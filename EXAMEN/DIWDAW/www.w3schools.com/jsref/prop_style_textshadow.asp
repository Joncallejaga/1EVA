...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myP&quot;).style.textShadow = &quot;5px 5px 1px #ff0000, 10px 10px 1px #0000ff&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_textshadow">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">textShadow</td>
    <td>Yes</td>
    <td>10.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete  list of possible color values</td>
  </tr>
  <tr>
    <td>initial</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing a comma-separated list of shadow effects applied to the text of the element</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS3</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_textshadow2">Try it Yourself &raquo;</a>
</div>
<hr>
