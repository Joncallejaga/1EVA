...
<html lang="en-US">
<head>
<title>HTML DOM Input Week disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Disable a week field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).disabled = true;</div>
<!--<p>The result will be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="week" value="2014-W15" disabled>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a week field should be disabled, or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.disabled = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a week field should be disabled, or not
  <ul>
      <li>true - The week field is disabled</li>
      <li>false - Default. The week field is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the week field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a week field is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myWeek&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_disabled2">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a week field:</p>
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myWeek&quot;).disabled = true;<br>
 }<br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myWeek&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
