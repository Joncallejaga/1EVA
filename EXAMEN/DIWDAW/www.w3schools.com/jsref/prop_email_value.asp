...
<html lang="en-US">
<head>
<title>HTML DOM Input Email value Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the email address of an email field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).value = &quot;steve@w3schools.com&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_value">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The value property sets or returns the value of the value attribute of an email field.</p>
<p>The value attribute specifies the default value OR the value a user types in (or a value set by a script).</p>
<p>The value can be a single e-mail address, or a list of e-mail addresses.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.value</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.value = <i>text</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a single e-mail address, or a list of e-mail addresses</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, or a comma-separated list of strings, representing a valid email address</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the email address of an email field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">johndoe@example.com</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_value2">Try it Yourself &raquo;</a>
</div>
<br>
