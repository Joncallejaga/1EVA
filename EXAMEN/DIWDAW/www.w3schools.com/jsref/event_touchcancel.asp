...
<h3>Example</h3>
<p>Execute a JavaScript when a touch is interrupted (for touch screens only):</p>
...
<p>The touchcancel event occurs when the touch event gets interrupted.</p>
<p>Different devices will interrupt a touch event at different actions, and it is considered good practice to include this event to clean up code if this "error" should occur.</p>
