...
<div class="w3-code notranslate jsHigh">
 Array.prototype.myUcase = function() {<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; this.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this[i] = this[i].toUpperCase();<br>&nbsp;&nbsp;&nbsp; }<br>};</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_prototype_array" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The prototype constructor allows you to add new properties and methods to the Array() object.</p>
<p>When constructing a property, ALL arrays will be given the property, and its value, as default.</p>
