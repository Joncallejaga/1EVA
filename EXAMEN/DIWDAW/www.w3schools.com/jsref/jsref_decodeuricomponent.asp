...
<p><a href="jsref_obj_global.asp" class="w3-btn w3-white w3-border" title="Function Reference">&#10094; 
JavaScript Global Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Decode a URI after encoding it:</p>
<div class="w3-code notranslate jsHigh">
 var uri = "https://w3schools.com/my test.asp?name=ståle&amp;car=saab";<br>var uri_enc = encodeURIComponent(uri);<br>var uri_dec = decodeURIComponent(uri_enc);<br>var res = uri_enc + "&lt;br&gt;" + uri_dec;
</div>
<!--<p>The result of <em>res</em> will be:</p>
<div class="w3-code notranslate">
 <span style="color:green">// Encoded URI</span><br>
 https%3A%2F%2Fw3schools.com%2Fmy%20test.asp%3Fname%3Dst%C3%A5le%26car%3Dsaab<br>
 <br><span style="color:green">// Decoded URI</span><br>
 https://w3schools.com/my test.asp?name=ståle&amp;car=saab</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_decodeuricomponent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The decodeURIComponent() function decodes a URI component.</p>
<p><b>Tip:</b> Use the <a href="jsref_encodeuricomponent.asp">encodeURIComponent()</a> function to encode a URI component.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the decoded URI</td>
</tr>
</table>
