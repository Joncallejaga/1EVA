...
<html lang="en-US">
<head>
<title>HTML DOM Select value Property</title>
 <meta charset="utf-8">
...
<h1>Select <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_select.asp" class="w3-btn w3-white w3-border" title="Select Object Reference">&#10094; Select Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the selected option to &quot;banana&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;mySelect&quot;).value = &quot;banana&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_value">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The value property sets or returns the value of the selected option in a 
drop-down list.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>selectObject</em>.value
</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>selectObject</em>.value = <i>value
 </i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>value</i></td>
    <td>Specifies the value of an &lt;option&gt; element in a drop-down list that  should get selected. If the value does not exist, the drop-down list  will display an empty option</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the value of the value attribute of an &lt;option&gt; element in the drop-down list. If the drop-down list allows multiple selections, the first selected option is returned. If there is no selected options, nothing is returned. </td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of a selected option in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_value2">Try it Yourself &raquo;</a>
</div>
<hr>
