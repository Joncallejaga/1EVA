...
<html lang="en-US">
<head>
<title>JavaScript function Statement</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">function</span> Statement</h1>
...
<div class="w3-code notranslate jsHigh">
 function myFunction() { // Declare a function<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World!&quot;;<br>}<br>&nbsp;<br>
 myFunction(); // Call the function</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_function" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The function statement declares a function.</p>
<p>A declared function is "saved for later use", and will be executed later, 
when it is invoked (called).</p>
<p>In JavaScript, functions are objects, and they have both properties and 
methods. </p>
<p>A function can also be defined using an expression (See
<a href="../js/js_function_definition.asp">Function Definitions</a>).</p>
<p>Read our JavaScript Tutorial to learn all you need to know about functions. 
Start with the introduction chapter about 
<a href="../js/js_functions.asp">JavaScript Functions</a> and
<a href="../js/js_scope.asp">JavaScript Scope</a>. For more detailed 
information, see our Function Section on
<a href="../js/js_function_definition.asp">Function Definitions</a>,
<a href="../js/js_function_parameters.asp">Parameters</a>,
<a href="../js/js_function_invocation.asp">Invocation</a> and
<a href="../js/js_function_closures.asp">Closures</a>.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_return.asp">return</a> statement 
to return a value from the function.</p>
...
<div class="w3-code w3-border notranslate jsHigh"><div>
 function <i><em>functionName</em></i>(<i><em>parameter</em>s</i>)<i> {<br>
...
<div class="w3-code notranslate jsHigh">
 function myFunction() {<br>&nbsp;&nbsp;&nbsp; return Math.PI;<br>}</div>
 <!--<p>The result will be:</p>
<div class="w3-code notranslate">
 3.141592653589793</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_return_pi" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return the product of a and b:</p>
<div class="w3-code notranslate jsHigh">
 function myFunction(a, b) {<br>&nbsp;&nbsp;&nbsp; return a * b;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_function1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>With functions, you can use the same code many times with different arguments, to produce different 
results.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_function2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Functions can be used as variables.</p>
 <p>Instead of:</p>
<div class="w3-code notranslate jsHigh">
temp = toCelsius(32);<br>text = &quot;The temperature is &quot; + temp + &quot; Centigrade&quot;;
</div>
<p>You can use:</p>
<div class="w3-code notranslate">
text = &quot;The temperature is &quot; + toCelsius(32) + &quot; Centigrade&quot;;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_function3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_function4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Click on a button to call a function, which will output &quot;Hello World&quot; in an 
element with id=&quot;demo&quot;:</p>
<div class="w3-code notranslate jsHigh">
 &lt;button onclick=&quot;myFunction()&quot;&gt;Click me&lt;/button&gt;<br><br>&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br>
 <br>&lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World&quot;;<br>}<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_function_click" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_function5" target="_blank">Try it Yourself &raquo;</a>
</div>
...
var z = x(4, 3);</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_function6" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_functions.asp">JavaScript Functions</a></p>
<p>JavaScript Tutorial: <a href="../js/js_scope.asp">JavaScript Scope</a></p>
<p>JavaScript Tutorial: <a href="../js/js_function_definition.asp">JavaScript Function Definitions</a></p>
<p>JavaScript Tutorial: <a href="../js/js_function_parameters.asp">JavaScript Function Parameters</a></p>
<p>JavaScript Tutorial: <a href="../js/js_function_invocation.asp">JavaScript Function Invocation</a></p>
<p>JavaScript Tutorial: <a href="../js/js_function_closures.asp">JavaScript Function Closures</a></p>
<p>JavaScript Reference: <a href="jsref_return.asp">JavaScript return Statement</a></p>
<hr>
