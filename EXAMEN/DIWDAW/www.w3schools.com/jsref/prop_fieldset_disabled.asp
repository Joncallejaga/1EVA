...
<html lang="en-US">
<head>
<title>HTML DOM Fieldset disabled Property</title>
 <meta charset="utf-8">
...
<h1>Fieldset <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_fieldset.asp" class="w3-btn w3-white w3-border" title="Fieldset Object Reference">&#10094; Fieldset Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Disable a fieldset:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myFieldset&quot;).disabled = true;<br>
 </div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled property sets or returns whether a group of related form 
elements (a fieldset) is disabled, or not.</p>
<p>If this property is set, the form elements in the fieldset are disabled.</p>
...
<p><strong>* </strong>Internet Explorer 11 and below, supports the disabled property on 
return. However, on set, the element appear disabled but the user can still interact with 
it.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>fieldsetObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>fieldsetObject</em>.disabled = true|false
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - The fieldset is disabled</li>
      <li>false - Default. The fieldset is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the fieldset is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a fieldset is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFieldset&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_disabled">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a fieldset:</p>
<div class="w3-code notranslate jsHigh">
 function disableField() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myFieldset&quot;).disabled = true;<br>
 }<br><br>function undisableFieldset() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myFieldset&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_fieldset_disabled.asp">HTML &lt;fieldset&gt; disabled attribute</a></p>
<hr>

<a href="dom_obj_fieldset.asp" class="w3-btn w3-white w3-border" title="Fieldset Object Reference">&#10094; Fieldset Object</a>
</div>
