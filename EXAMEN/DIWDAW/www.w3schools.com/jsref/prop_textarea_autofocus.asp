...
<html lang="en-US">
<head>
<title>HTML DOM Textarea autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_textarea.asp" class="w3-btn w3-white w3-border" title="Textarea Object Reference">&#10094; Textarea Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a text area automatically gets focus upon page load:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).autofocus;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The autofocus property sets or returns whether a text area should automatically get focus when the page loads, or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.autofocus = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - The text area gets focus</li>
      <li>false - Default. The text area does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the text area automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
