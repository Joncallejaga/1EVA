...
<a target="_blank" href="tryit.asp?filename=tryjsref_onblur" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a href="event_onfocusout.asp">onfocusout</a> event. The main difference is that the onblur event does not bubble. Therefore, if 
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onblur=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onblur_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onblur = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onblur_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;blur&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onblur_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
