...
<html lang="en-US">
<head>
<title>TouchEvent targetTouches Property</title>
<meta charset="utf-8">
...
<h1>TouchEvent <span class="color_h1">targetTouches</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out how many fingers that touches an element:</p>
<div class="w3-code notranslate jsHigh">
  function countTouches(event) {<br>&nbsp; var x = event.targetTouches.length;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_targettouches" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The targetTouches property returns an array of Touch objects, one for each finger 
that is touching the current target element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.targetTouches</div></div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 An 
  Array of Touch objects.</td>
</tr>
</table>

<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_touch_touches.asp">TouchEvent 
touches Property</a></p>
<hr>
<h2>More Examples</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Return the tag name of the current element:</p>
<div class="w3-code notranslate jsHigh">
  function getTagname(event) {<br>&nbsp; var x = event.touches[0].clientX;<br>&nbsp; 
  var y = event.touches[0].clientY;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_targettouches2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
