...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the document that loaded the current document. Returns the entire URL, including the protocol (like http://). If the current document was not opened through a link (for example, through a bookmark), an empty string is returned.</td>
</tr>
<tr>
  <th>DOM Version</th>
