...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcfullyear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCFullYear() method returns the year (four digits for dates between 
year 1000 and 9999) of the specified date, according to universal time. </p>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the year</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcfullyear2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
