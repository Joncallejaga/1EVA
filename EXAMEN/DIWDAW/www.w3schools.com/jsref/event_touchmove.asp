...
<h1><span class="color_h1">touchmove</span> Event</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_touchevent.asp" class="w3-btn w3-white w3-border" title="TouchEvent">&#10094; TouchEvent</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the user moves the finger over a P element (for touch screens only):</p>
<div class="w3-code notranslate htmlHigh">
&lt;p ontouchmove=&quot;myFunction(event)"&gt;Touch me!&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchmove2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The touchmove event occurs when the user moves the finger across the screen.</p>
<p>The touchmove event will be triggered once for each movement, and will continue to be triggered until the finger is released.</p>
<p><strong>Note:</strong> The touchmove event will only work on devices with a touch screen.</p>
<p><strong>Tip:</strong> Other events related to the touchstart event are:</p>
<ul>
  <li><a href="event_touchstart.asp">touchstart</a> - occurs when the user touches the screen</li>
  <li><a href="event_touchend.asp">touchend</a> - occurs when the user removes the finger from an element</li>
  <li><a href="event_touchcancel.asp">touchcancel</a> - occurs when the touch is interrupted</li>
</ul>
<hr>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> ontouchmove=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchmove" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.ontouchmove = <i>myScript</i>;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchmove_javascript" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;touchmove&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchmove_eventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
