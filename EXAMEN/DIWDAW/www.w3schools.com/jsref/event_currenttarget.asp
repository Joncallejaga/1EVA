...
<h3>Example</h3>
<p>Get the element whose event listeners triggered a specific event:</p>
<div class="w3-code notranslate jsHigh">
 alert(event.currentTarget);<br></div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_currenttarget" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The currentTarget event property returns the element whose event listeners triggered the event.</p>
<p>This is particularly useful during capturing and bubbling.</p>
<p>The currentTarget property always refers to the element whose 
event listener triggered the event, opposed to the <a href="event_target.asp">target</a> 
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>A reference to the object whose event listeners triggered the event</td>
  </tr>
  <tr>
