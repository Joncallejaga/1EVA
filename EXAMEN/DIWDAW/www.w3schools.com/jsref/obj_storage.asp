...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Storage Object</title>
<meta charset="utf-8">
...
<h1>The <span class="color_h1">Storage </span>Object</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="jsref_type_conversion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr>

<h2>Storage Object</h2>
<p>The Storage object of the Web Storage API provides access to the session 
storage or local storage for a particular domain. This allows you to read, 
add, modify, and delete stored data items.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_storage_key.asp">key(<em>n</em>)</a></td>
    <td>Returns the name of the <em>n</em>th key in the storage</td>
    </tr>
    <tr>
    <td><a href="prop_storage_length.asp">length</a></td>
    <td>Returns the number of data items stored in the Storage object</td>
    </tr>
  <tr>
    <td><a href="met_storage_getitem.asp">getItem(<em>keyname</em>)</a></td>
    <td>Returns the value of the specified key name</td>
    </tr>
  <tr>
    <td><a href="met_storage_setitem.asp">setItem(<em>keyname</em>, <em>value</em>)</a></td>
    <td>Adds that key to the storage, or update that key's value if it already 
    exists</td>
    </tr>
  <tr>
    <td><a href="met_storage_removeitem.asp">removeItem(<em>keyname</em>)</a></td>
    <td>Removes that key from the storage</td>
    </tr>
  <tr>
    <td><a href="met_storage_clear.asp">clear()</a></td>
    <td>Empty all key out of the storage</td>
    </tr>
</table>
<h2>Related Pages for Web Storage API</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="prop_win_localstorage.asp">window.localStorage</a></td>
    <td>Allows to save key/value pairs in a web browser. Stores the data with no 
    expiration date</td>
    </tr>
  <tr>
    <td><a href="prop_win_sessionstorage.asp">window.sessionStorage</a></td>
