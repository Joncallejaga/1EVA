...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript Global Reference</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="jsref_obj_error.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jsref_obj_json.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
It makes sense to call the list above <strong>global functions</strong> rather than <strong>global methods</strong>
because the functions are called globally and not any objects.
</p>
<p>Anyway, you can also call these functions methods, since they are methods of the global object where they run.
In a web browser, the global object is the browser window. Then isNaN() is actually a window method: window.isNaN().</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="jsref_obj_error.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jsref_obj_json.asp">Next &#10095;</a>
