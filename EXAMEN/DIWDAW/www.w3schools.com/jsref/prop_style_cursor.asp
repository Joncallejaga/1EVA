...
document.getElementById(&quot;myP&quot;).style.cursor = &quot;pointer&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_cursor">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.style.cursor = <i>value
 </i></div></div>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the displayed mouse cursor when the mouse pointer is over an element</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_cursor2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_cursor3">Try it Yourself &raquo;</a>
</div>
<hr>
