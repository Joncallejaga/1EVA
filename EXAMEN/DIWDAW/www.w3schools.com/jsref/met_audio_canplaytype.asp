...
<html lang="en-US">
<head>
<title>HTML DOM Audio canPlayType() Method</title>
<meta charset="utf-8">
...
<h1>Audio <span class="color_h1">canPlayType()</span> Method</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if your browser can play different types of audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.createElement(&quot;AUDIO&quot;);<br>isSupp = x.canPlayType(vidType+';codecs=&quot;'+codType+'&quot;'); </div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_canplaytype" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The canPlayType() method checks if the browser can play the specified audio 
type.</p>
<p>The canPlayType() method can return one of the following values:</p>
<ul>
  <li>&quot;probably&quot; - the browser most likely supports this audio type</li>
  <li>&quot;maybe&quot; - the browser might support this audio type</li>
  <li>&quot;&quot; - (empty string) the browser does not support this audio type</li>
</ul>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
  ...
  <em>audioObject</em>.canPlayType(<em>type</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>type</em></td>
    <td>Specifies the audio type (and optional codecs) to test support for.<br>
 <p>Common values:<br>
 <ul>
  <li>audio/mpeg</li>
    <li>audio/ogg</li>
 ...
 <p><strong>Note:</strong> This method can only return &quot;probably&quot; if codecs are included.</p>
</td>
</tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the level of support. Possible return values:
 <ul>
