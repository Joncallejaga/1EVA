...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_area_shape2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The shape attribute is used together with the coords attribute to specify the 
size, shape, and placement of an area.</p>
<p><strong>Tip:</strong> Use the <a href="prop_area_coords.asp">coords</a> 
property to set or return the value of the coords attribute of an area.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the shape type of the area</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the shape of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x =
...
<div class="w3-code notranslate">
 circle</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_shape" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_area_shape.asp">HTML &lt;area&gt; shape attribute</a></p>
<hr>
