...
<html lang="en-US">
<head>
<title>animationiteration Event</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">animationiteration</span> Event</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_animationevent.asp" class="w3-btn w3-white w3-border" title="AnimatioEvent">&#10094; AnimationEvent</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Do something with a &lt;div&gt; element when a CSS animation is repeated:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>// Code for Chrome, Safari and Opera<br>
 x.addEventListener(&quot;webkitAnimationIteration&quot;, myRepeatFunction);<br><br>// Standard syntax<br>x.addEventListener(&quot;animationiteration&quot;, myRepeatFunction);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_animationstart" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The animationiteration event occurs when a CSS animation is repeated.</p>
<p>If the CSS <a href="../cssref/css3_pr_animation-iteration-count.asp">animation-iteration-count</a> property is set to 
&quot;1&quot;, meaning that the 
animation will only be played one time, the animationiteration event does not 
occur. The animation needs to run more than once for this event to fire.</p>
<p>For more information about CSS Animations, see our tutorial on
<a href="../css/css3_animations.asp">CSS3 Animations</a>.</p>
<p>When a CSS animation plays, there are three events that can occur:</p>
<ul>
  <li><a href="event_animationstart.asp">animationstart</a> - occurs when the CSS animation has started</li>
  <li>animationiteration - occurs when the CSS animation is repeated</li>
  <li><a href="event_animationend.asp">animationend</a> - occurs when the CSS animation has completed</li>
</ul>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>4.0 webkit</td>
    <td>15.0 webkit<br>12.1</td>
  </tr>
</table>
<p><strong>Note:</strong> For Chrome, Safari and Opera, use the webkitAnimationIteration prefix.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 object.addEventListener(&quot;webkitAnimationIteration&quot;, <em>myScript</em>);&nbsp; // Code for Chrome, Safari and Opera<em><br>object</em>.addEventListener(&quot;animationiteration&quot;, <em>myScript</em>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Standard syntax<br></div></div>
<p><strong>Note:</strong> The <a href="met_element_addeventlistener.asp">addEventListener()</a> method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>
...
<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css3_animations.asp">CSS3 Animations</a></p>
<p>CSS Reference: <a href="../cssref/css3_pr_animation.asp">CSS3 animation Property</a></p>
<p>CSS Reference: <a href="../cssref/css3_pr_animation-iteration-count.asp">CSS3 animation-iteration-count Property</a></p>
<p>HTML DOM reference: <a href="prop_style_animation.asp">Style animation Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_animationevent.asp" class="w3-btn w3-white w3-border" title="AnimatioEvent">&#10094; AnimationEvent</a>
