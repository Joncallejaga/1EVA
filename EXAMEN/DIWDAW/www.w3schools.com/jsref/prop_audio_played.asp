...
<html lang="en-US">
<head>
<title>HTML DOM Audio played Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">played</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first played range (part) of the audio in seconds:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;);<br>document.getElementById(&quot;demo&quot;).innerHTML = &quot;Start: &quot; + x.played.start(0) <br>+ &quot; End: &quot; + x.played.end(0)</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 Start: 0 End: 2.162583</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_played" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The played property returns a TimeRanges object.</p>
<p>The TimeRanges object represents ranges of the audio that has already been played by the user.</p>
<p>A played range is a time-range of played audio. The user gets several played ranges if he/she skips in the audio.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.played</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the played parts of the audio.<p>TimeRanges Object Properties:</p>
 <ul>
    <li>length - get the number of played ranges in the audio</li>
