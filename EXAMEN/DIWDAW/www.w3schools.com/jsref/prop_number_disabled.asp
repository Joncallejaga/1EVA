...
<html lang="en-US">
<head>
<title>HTML DOM Input Number disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Number <span class="color_h1">disabled</span> Property</h1>
...
<h3>Example</h3>
<p>Disable a number field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myNumber&quot;).disabled = true;</div>
<!--<p>The result could be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="number" value="2" disabled>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_number_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a number field should be disabled, or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>numberObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>numberObject</em>.disabled = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - The number field is disabled</li>
      <li>false - Default. The number field is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the number field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a number field is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myNumber&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_number_disabled2">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a number field:</p>
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myNumber&quot;).disabled = true;<br>
 }<br><br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myNumber&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_number_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
