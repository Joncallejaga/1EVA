...
<html lang="en-US">
<head>
<title>HTML DOM Video controls Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">controls</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).controls = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_controls" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The controls property sets or returns whether a video should display standard video controls.</p>
<p>This property reflects the &lt;video&gt; controls attribute.</p>
<p>When present, it specifies that the video controls should be displayed.</p>
...
<p><strong>Note:</strong> The &lt;video&gt; element is new in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>videoObject</em>.controls</div></div>
<p>Set the controls property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.controls = true|false
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether a video should have controls displayed, or not
<ul>
  <li>true - Indicates that controls are displayed</li>
  <li>false - Default. Indicates that controls are NOT displayed</li>
</ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if video controls are displayed, otherwise it returns false</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the video controls are displayed:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).controls;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_controls2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Enable, disable and check controls status:</p>
<div class="w3-code notranslate jsHigh">
 var
 x = document.getElementById(&quot;myVideo&quot;);<br><br>function enableControls() { <br>&nbsp;&nbsp;&nbsp; x.controls = true;<br>&nbsp;&nbsp;&nbsp; x.load();<br>
 } <br> <br>
 function disableControls() { <br>&nbsp;&nbsp;&nbsp; x.controls = false;<br>&nbsp;&nbsp;&nbsp; x.load();<br>
 } <br> <br>function checkControls() { <br>&nbsp;&nbsp;&nbsp; alert(x.controls);<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_controls3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_controls.asp">HTML &lt;video&gt; controls attribute</a></p>
<hr>
