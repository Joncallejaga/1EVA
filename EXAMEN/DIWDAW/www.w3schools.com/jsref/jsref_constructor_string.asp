...
<h3>Example</h3>
<p>The constructor property returns the string's constructor function:</p>
<div class="w3-code notranslate jsHigh">
 var str = &quot;Hello World!&quot;;</div>
<!--<p>The constructor property returns:</p>
<div class="w3-code notranslate">
function String() { [native code] }</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_constructor_string" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
