...
<html lang="en-US">
<head>
<title>MouseEvent pageX Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">pageX</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Output the coordinates of the mouse pointer when the mouse button is clicked 
on an element:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.pageX;&nbsp;&nbsp;&nbsp;&nbsp; // Get the horizontal coordinate<br>var y = event.pageY;&nbsp;&nbsp;&nbsp;&nbsp; // Get the vertical coordinate<br>var coor = &quot;X coords: &quot; + x + &quot;, Y coords: &quot; + y;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_pagexy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The pageX property returns the horizontal coordinate (according to the 
document) of the mouse pointer when a mouse event 
was triggered.</p>
<p>The document is the web page.</p>
<p><strong>Tip:</strong> To get the vertical coordinate (according to the 
document) of the mouse pointer, 
use the <a href="event_pagey.asp">pageY</a> property.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Note:</strong> This property is non-standard, but works in most major 
browsers.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">pageX</td>
    <td>Yes</td>
    <td>12.0</td>    
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing the horizontal coordinate of the mouse pointer, in pixels</td>
</tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Output the coordinates of the mouse pointer while the mouse pointer moves 
over an element:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.pageX;<br>var y = event.pageY;&nbsp;<br>var coor = &quot;X coords: &quot; + x + &quot;, Y coords: &quot; + y;<br>document.getElementById(&quot;demo&quot;).innerHTML = coor;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_pagexy2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of the differences between pageX and pageY and screenX 
and screenY:</p>
<div class="w3-code notranslate jsHigh">
 var pX = event.screenX;<br>var cX = event.pageX;<br>var pY = event.screenY;<br>var cY = event.pageY;<br>var coords1 = &quot;page - X: &quot; + pX + &quot;, Y coords: &quot; + pY;<br>var coords2 = &quot;screen - X: &quot; + cX + &quot;, Y coords: &quot; + cY;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_screenxy_clientxy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_pagey.asp">MouseEvent pageY Property</a></p>
<p>HTML DOM reference: <a href="event_clientx.asp">MouseEvent clientX Property</a></p>
<p>HTML DOM reference: <a href="event_clienty.asp">MouseEvent clientY Property</a></p>
<p>HTML DOM reference: <a href="event_screenx.asp">MouseEvent screenX Property</a></p>
<p>HTML DOM reference: <a href="event_screeny.asp">MouseEvent screenY Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_mouseevent.asp" class="w3-btn w3-white w3-border" title="MouseEvent">&#10094; MouseEvent</a>
