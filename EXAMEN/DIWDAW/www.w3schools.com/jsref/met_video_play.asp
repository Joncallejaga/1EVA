...
<html lang="en-US">
<head>
<title>HTML DOM Video play() Method</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">play()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;); <br><br>function playVid()<br>&nbsp; { <br>&nbsp; x.play(); <br>&nbsp; } <br><br>function pauseVid()<br>&nbsp; {
 <br>&nbsp; x.pause(); <br>&nbsp; }</div>
...
<p>The play() method starts playing the current video.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="met_video_pause.asp">pause()</a> method.</p>
<p><strong>Tip:</strong> Use the <a href="prop_video_controls.asp">controls</a> 
property to display video controls (like play, pause, seeking, volume, etc, 
attached on the video).</p>
<hr>
