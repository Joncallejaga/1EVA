...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>integer</em></td>
    <td>
  Specifies  the index position of the option within a drop-down list</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the index position of the option within a drop-down list. The index starts at 0.</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 ...
 var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + &quot;\n&quot; + x.options[i].text + &quot; has index: &quot; + x.options[i].index;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_index2">Try it Yourself &raquo;</a>
</div>
<hr>
