...
<h3>Example</h3>
<p>Return the protocol of the current URL:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_loc_protocol">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the protocol of the current URL, including the colon (:)</td>
</tr>
</table>
