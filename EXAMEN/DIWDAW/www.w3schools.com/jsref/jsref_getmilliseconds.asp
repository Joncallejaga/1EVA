...
<a target="_blank" href="tryit.asp?filename=tryjsref_getmilliseconds" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_getmilliseconds2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using getHours(), getMinutes(), getSeconds(), and getMilliseconds() to 
display the time (with milliseconds):</p>
<div class="w3-code notranslate jsHigh">
 function addZero(x, n) {<br>&nbsp;&nbsp;&nbsp; while (x.toString().length &lt; n) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = &quot;0&quot; + x;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return x;<br>}<br>
 <br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById(&quot;demo&quot;);<br>&nbsp;&nbsp;&nbsp; var h = addZero(d.getHours(), 2);<br>&nbsp;&nbsp;&nbsp; var m = addZero(d.getMinutes(), 2);<br>&nbsp;&nbsp;&nbsp; var s = addZero(d.getSeconds(), 2);<br>&nbsp;&nbsp;&nbsp; var ms = addZero(d.getMilliseconds(), 3);<br>&nbsp;&nbsp;&nbsp; x.innerHTML = h + &quot;:&quot; + m + &quot;:&quot; + s + &quot;:&quot; + ms;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_datetime_millisec" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
