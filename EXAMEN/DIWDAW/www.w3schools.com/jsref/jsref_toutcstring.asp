...
<a target="_blank" href="tryit.asp?filename=tryjsref_toutcstring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the UTC date and time as a string</td>
</tr>
<tr>
