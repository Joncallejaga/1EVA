...
<p><a href="dom_obj_document.asp" class="w3-btn w3-white w3-border" title="Document Object Reference">&#10094; Document Object</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_class">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> You can use the <a href="prop_nodelist_length.asp">
...
<tr>
  <th>Return Value:</th>
  <td>A NodeList object, representing all elements in the document that matches the specified CSS selector(s). The NodeList is a static collection, meaning that changes in the DOM has NO effect in the collection. Throws a SYNTAX_ERR exception if the selector(s) is invalid</td>
</tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 // Get all &lt;p&gt; elements in the document<br>var x = document.querySelectorAll(&quot;p&quot;); <br><br>// Set the background color of the first &lt;p&gt; element<br>
 x[0].style.backgroundColor = &quot;red&quot;;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_p">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 ...
 document.querySelectorAll(&quot;p.example&quot;); <br><br>// Set the background color of the first &lt;p&gt; element with class=&quot;example&quot; (index 0)<br>
 x[0].style.backgroundColor = &quot;red&quot;;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_p_class">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_length">Try it Yourself &raquo;</a>
</div>
...
class=&quot;example&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.querySelectorAll(&quot;.example&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_loop">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x = document.querySelectorAll(&quot;p&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_loop_p">Try it Yourself &raquo;</a>
</div>
...
attribute:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.querySelectorAll(&quot;a[target]&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.border = &quot;10px solid red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_loop_target">Try it Yourself &raquo;</a>
</div>
...
element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.querySelectorAll(&quot;div &gt; p&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_gt">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x = document.querySelectorAll(&quot;h2, div, span&quot;);<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
...
<p>HTML DOM Reference: <a href="met_element_queryselectorall.asp"><em>element</em>.querySelectorAll()</a></p>
<hr>
