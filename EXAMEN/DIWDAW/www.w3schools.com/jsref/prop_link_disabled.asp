...
<html lang="en-US">
<head>
<title>HTML DOM Link disabled Property</title>
 <meta charset="utf-8">
...
<h1>Link <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_link.asp" class="w3-btn w3-white w3-border" title="Link Object Reference">&#10094; Link Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Disable the linked document:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myLink&quot;).disabled = true;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_link_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled property sets or returns whether the linked document is 
disabled, or not.</p>
<p>This property is currently only used with style sheet links.</p>
<p>When set to true, the linked style sheet will not have any effect.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>linkObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>linkObject</em>.disabled = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - The linked document is disabled<br>
   </li>
      <li>false - The linked document is not disabled<br>
   </li>
  </ul>
    </td>
  </tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the linked document is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the linked document is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLink&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 false</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_link_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_link.asp" class="w3-btn w3-white w3-border" title="Link Object Reference">&#10094; Link Object</a>
</div>
