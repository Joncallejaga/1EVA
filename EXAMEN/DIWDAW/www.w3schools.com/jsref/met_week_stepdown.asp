...
<html lang="en-US">
<head>
<title>HTML DOM Input Week stepDown() Method</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">stepDown()</span> Method</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Decrement the value of a week field by 10 weeks:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).stepDown(10);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_stepdown">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stepDown() method decrements the value of the week field by a specified 
number.</p>
<p>This method will only have an affect on WEEKS (not years).</p>
<p><strong>Tip:</strong> To increment the value, use the
<a href="met_week_stepup.asp">stepUp()</a> method.</p>
<hr>
...
<p><strong>Note:</strong> In Safari, you must enter a week in the week field before you can decrement the value.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.stepDown(<em>number</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the amount of weeks the week field should  decrease.<br><br>If omitted, the weeks are decremented by &quot;1&quot;</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Decrement the weeks by 1 (default):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).stepDown();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_stepdown2">Try it Yourself &raquo;</a>
</div>
<hr>
