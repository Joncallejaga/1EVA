...
<h3>Example</h3>
<p>Find out if cookies are enabled in your browser:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_cookieenabled">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, indicating whether cookies are enabled in the browser.<br>
 <br>Returns true if enabled, otherwise it returns false</td>
</tr>
</table>
...
<hr><a href="obj_navigator.asp" class="w3-btn w3-white w3-border" title="Navigator Object Reference">&#10094; Navigator Object</a>
</div>
