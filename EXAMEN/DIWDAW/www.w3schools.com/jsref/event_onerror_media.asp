...
<h3>Example</h3>
<p>Execute a JavaScript when an error occurs while media data of a video is 
being downloaded:</p>
...
<p>The onerror event occurs when an error occurred during the loading of an 
audio/video.</p>
...
<p><strong>Note:</strong> The onerror event is not supported in Internet Explorer 11 on Windows 7.</p>
<hr>
