...
<html lang="en-US">
<head>
<title>HTML DOM OptionGroup label Property</title>
 <meta charset="utf-8">
...
<h1>OptionGroup <span class="color_h1">label</span> Property</h1>
<p><a href="dom_obj_optgroup.asp" class="w3-btn w3-white w3-border" title="OptionGroup Object Reference">&#10094; OptionGroup Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the label/description of an option-group:</p>
 <div class="w3-code notranslate jsHigh">
  document.getElementById(&quot;myOptgroup&quot;).label = &quot;A Random Car Selection&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_optgroup_label2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The label property sets or returns the value of the label attribute of an 
option-group.</p>
<p>The label attribute specifies a label/description for an option-group.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>optiongroupObject</em>.label
</div></div>
<p>Set the label property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>optiongroupObject</em>.label = <em>text</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a label/description for the option-group</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the label of the option-group</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the label/description of an option-group:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOptgroup&quot;).label;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Swedish Cars</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_optgroup_label">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_optgroup_label.asp">HTML &lt;optgroup&gt; label attribute</a></p>
<hr>

<a href="dom_obj_optgroup.asp" class="w3-btn w3-white w3-border" title="OptionGroup Object Reference">&#10094; OptionGroup Object</a>
</div>
