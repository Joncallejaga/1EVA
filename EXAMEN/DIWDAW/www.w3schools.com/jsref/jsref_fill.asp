...
<html lang="en-US">
<head>
<title>JavaScript Array fill() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">fill()</span> Method</h1>
...
fruits.fill(&quot;Kiwi&quot;);</div>
<!--<p>The result of <em>fruits</em> will be:</p>
<div class="w3-code notranslate">
 Kiwi,Kiwi,Kiwi,Kiwi</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_fill" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The fill() method fills all the elements in an array with a static value.</p>
<p>It is possible to specify the index for starting and ending fill(). By 
default it changes the whole array.</p>
<hr>
...
<p><strong>Note:</strong> The fill() method is not supported in Internet 
...
<i>array</i>.fill(<em>value, start, end</em>)</div></div>
...
<tr>
 <th style="width:26%">Return Value:</th>
  <td>An Array, the changed array</td>
</tr>
<tr>
 <th style="width:26%">JavaScript Version:</th>
  <td>ECMAScript 6</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Fill the last two array elements with a static value:</p>
<div class="w3-code notranslate jsHigh">
var fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
fruits.fill(&quot;Kiwi&quot;, 2, 4);</div>
<!--<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Banana,Orange,Kiwi,Kiwi</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_fill2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
