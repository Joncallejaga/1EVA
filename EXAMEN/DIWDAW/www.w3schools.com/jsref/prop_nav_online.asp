...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_online">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, indicating whether the browser is in online or offline mode.<br>
 <br>Returns true if the browser is online, otherwise it returns false</td>
</tr>
</table>
