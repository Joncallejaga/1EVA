...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript JSON Reference</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">JSON Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="jsref_obj_global.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jsref_obj_math.asp">Next &#10095;</a>
</div>
<hr>

<h2>JSON <span style="font-size:80%">(<span class="auto-style1">J</span>ava<span class="auto-style1">S</span>cript 
<span class="auto-style1">O</span>bject <span class="auto-style1">N</span>otation)</span></h2>
...
<p>JavaScript Objects can be converted into JSON, and JSON can be converted back into JavaScript Objects.</p>
<p>This way we can work with the data as JavaScript objects, with no complicated 
parsing or translations.</p>
...
<div class="w3-code notranslate jsHigh">
  // a JavaScript object...:<br>var myObj =
{ &quot;name&quot;:&quot;John&quot;, 
  &quot;age&quot;:31, &quot;city&quot;:&quot;New York&quot; };<br>// ...converted into JSON:<br>var myJSON = 
  JSON.stringify(myObj);<br>// send JSON:<br>window.location = &quot;demo_json.php?x=&quot; + myJSON;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjson_send">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="jsref_parse_json.asp">parse()</a></td>
    <td>Parses a JSON string and returns a JavaScript object</td>
    </tr>
  <tr>
    <td><a href="jsref_stringify.asp">stringify()</a></td>
...
<ul>
  <li>a string</li>
  <li>a number</li>
  <li>an object (containing valid JSON values)</li>
  <li>an array</li>
  <li>a boolean</li>
  <li><em>null</em></li>
</ul>
...
<p>Receiving JSON:</p>
<div class="w3-code notranslate jsHigh">
  //myJSON is text received in JSON format.<br>//Convert JSON into a JavaScript 
  object:<br>var myObj = 
  JSON.parse(myJSON);<br>document.getElementById(&quot;demo&quot;).innerHTML = myObj.name;</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjson_receive" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>Storing data as JSON, using localStorage</p>
<div class="w3-code notranslate jsHigh">
  //Storing data:<br>myObj =
{ &quot;name&quot;:&quot;John&quot;, 
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjson_store" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Learn more about JSON in our <a href="../js/js_json_intro.asp">JSON tutorial</a>.</p>
