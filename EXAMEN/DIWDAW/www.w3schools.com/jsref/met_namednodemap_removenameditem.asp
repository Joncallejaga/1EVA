...
<h3>Example</h3>
 <p>Remove the type attribute from an input button:</p>
<div class="w3-code notranslate jsHigh">
var btn = document.getElementsByTagName("INPUT")[0];
<br>btn.attributes.removeNamedItem("type");</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_removenameditem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeNamedItem() method removes the node with the specified name in a NamedNodeMap object.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the removed attribute node</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
