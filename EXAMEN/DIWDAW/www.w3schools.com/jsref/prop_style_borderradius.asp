...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.borderRadius = &quot;25px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderradius">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the shape of the corners. Default value is 0</td>
  </tr>
  <tr>
    <td><i>%</i></td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_border-radius.asp">border-radius property</a></p>
<hr>
