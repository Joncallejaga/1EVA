...
<div class="w3-code notranslate jsHigh">
 ...
 alert(window.pageXOffset + window.pageYOffset);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_pagexoffset">Try it Yourself &raquo;</a>
</div>
...
<p><b>Note:</b> For IE8 and earlier, you can use &quot;document.documentElement.scrollLeft&quot; and &quot;document.documentElement.scrollTop&quot; 
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of pixels that the document has already been scrolled from the upper left corner of the window, horizontally and vertically</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>A cross-browser solution (using scrollLeft and scrollTop for IE8 and 
earlier):</p>
<div class="w3-code notranslate jsHigh">
 window.scrollBy(100, 100);<br><br>if (window.pageXOffset !== undefined) { // All browsers, except IE9 and earlier<br>&nbsp;&nbsp;&nbsp; alert(window.pageXOffset + window.pageYOffset);<br>} else { // IE9 and earlier<br>&nbsp;&nbsp;&nbsp; alert(document.documentElement.scrollLeft + document.documentElement.scrollTop);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_pagexoffset2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
