...
<h3>Example</h3>
<p>Get the total height of your screen:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Total Height: &quot; + screen.height;</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_height">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The height property returns the total height of the user's screen, in pixels.</p>
<p><strong>Tip:</strong> Use the <a href="prop_screen_width.asp">width</a> 
property to get the total width of the user's screen.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the total height of the user's screen, in pixels</td>
</tr>
</table>
