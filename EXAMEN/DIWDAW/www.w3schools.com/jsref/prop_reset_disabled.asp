...
<html lang="en-US">
<head>
<title>HTML DOM Input Reset disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Reset <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_reset.asp" class="w3-btn w3-white w3-border" title="Input Reset Object Reference">&#10094; Input Reset Object</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a reset button should be disabled, or not.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the reset button is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_disabled">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 function disable() {<br>&nbsp; document.getElementById(&quot;myReset&quot;).disabled = true;<br>
 }<br><br>function undisable() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myReset&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="dom_obj_reset.asp" class="w3-btn w3-white w3-border" title="Input Reset Object Reference">&#10094; Input Reset Object</a>
</div>
