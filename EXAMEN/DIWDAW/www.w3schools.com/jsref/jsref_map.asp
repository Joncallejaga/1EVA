...
<h1>JavaScript Array <span class="color_h1">map()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var numbers = [4, 9, 16, 25];<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; x = document.getElementById(&quot;demo&quot;)<br>&nbsp;&nbsp;&nbsp; x.innerHTML = numbers.map(Math.sqrt);<br>}</div>
<!--<p>The result will be:</p>
<div class="w3-code notranslate">
 2,3,4,5</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_map">Try it Yourself &raquo;</a>
</div>
...
<p>The map() method calls the provided function once for each element in an 
array, in order.</p>
<p><strong>Note:</strong> map() does not execute the function for array 
elements without values.</p>
<p><strong>Note:</strong> map() does not change the original array.</p>
<hr>
...
<i>array</i>.map(<em>function(currentValue, index, arr), thisValue</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. A function to be run for each element in the array.<br>Function arguments:
<table class="w3-table-all notranslate"> 
  <tr>
...
<div class="w3-code notranslate jsHigh">
 var numbers = [65, 44, 12, 4];<br><br>function multiplyArrayElement(num) {<br>&nbsp;&nbsp;&nbsp; return num * document.getElementById(&quot;multiplyWith&quot;).value;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = numbers.map(multiplyArrayElement);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_map2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Get the full name for each person in the array:</p>
<div class="w3-code notranslate jsHigh">
 var persons = [<br>&nbsp;&nbsp;&nbsp; {firstname : &quot;Malcom&quot;, lastname: &quot;Reynolds&quot;},<br>&nbsp;&nbsp;&nbsp; {firstname : &quot;Kaylee&quot;, lastname: &quot;Frye&quot;},<br>&nbsp;&nbsp;&nbsp; {firstname : &quot;Jayne&quot;, lastname: &quot;Cobb&quot;}<br>];<br><br><br>function getFullName(item, index) {<br>&nbsp;&nbsp;&nbsp; var fullname = [item.firstname,item.lastname].join(&quot; &quot;);<br>&nbsp;&nbsp;&nbsp; return fullname;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = persons.map(getFullName);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_map3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
