...
<a target="_blank" href="tryit.asp?filename=tryjsref_tan" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the tangent of an angle</td>
</tr>
<tr>
