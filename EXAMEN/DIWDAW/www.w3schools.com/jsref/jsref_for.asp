...
<html lang="en-US">
<head>
<title>JavaScript for Statement</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">for</span> Statement</h1>
<p><a href="jsref_statements.asp" class="w3-btn w3-white w3-border" title="JavaScript Statements Reference">&#10094; JavaScript Statements Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through a block of code five times:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; 5; i++) {<br>&nbsp;&nbsp;&nbsp; text += &quot;The number is &quot; + i + &quot;&lt;br&gt;&quot;;<br>}</div>
 <!--<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 The number is 0<br>The number is 1<br>The number is 2<br>The number is 3<br>
 The number is 4</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_for" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The for statement creates a loop that is executed as long as a condition is 
true.</p>
<p>The loop will continue to run as long as the condition is true. It will only 
stop when the condition becomes false.</p>
<p>JavaScript supports different kinds of loops:</p>
<ul>
  <li><b>for </b>- loops through a block of code a number of times</li>
  <li><b><strong><a href="jsref_forin.asp">for/in</a></strong> </b>- loops through the properties of an object</li>
  <li><b><a href="jsref_while.asp">while</a> </b>- loops through a block of code while a specified condition is true</li>
  <li><strong><a href="jsref_dowhile.asp">do/while</a></strong> - loops through a block of code once, and then repeats the loop while a specified condition is true</li>
</ul>

<p><strong>Tip:</strong> Use the <a href="jsref_break.asp">break</a> statement 
to break out of a loop, and the <a href="jsref_continue.asp">continue</a> 
statement to skip a value in the loop.</p>
<!--
<p>When to use <strong>while</strong> and when to use <strong>for</strong>? <br>
Use for loops to perform the same task over and over, when you know in advance 
how many times you want to repeat the loop. Use while loops when you do not know 
how many times you need to loop.</p>
-->
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;text-align:left;" class="auto-style1">Statement</th>
...
<div class="w3-code w3-border notranslate jsHigh"><div>
 <i>for (statement 1; statement 2; statement 3) {<br>&nbsp;&nbsp;&nbsp; code block to be executed<br>}</i></div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Loop through the indices of an array to collect the car names from the cars 
array:</p>
<div class="w3-code notranslate jsHigh">
var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var text = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; cars.length; i++) {<br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>
 }</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_for_arr" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Example above explained:</p>
<ul>
  <li>First, we set a variable before the loop starts (var i = 0;)</li>
  <li>Then, we define the condition for the loop to run. As long as the variable is less than the length of the array (which is 4), the loop will continue</li>
  <li>Each time the loop executes, the variable is incremented by one (i++)</li>
  <li>Once the variable is no longer less than 4 (array's length), the condition is false, and the loop will end</li>
</ul>
...
<div class="w3-code notranslate jsHigh">
var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var i;<br>for (i = 0, len = cars.length, text = &quot;&quot;; i &lt; len; i++) { <br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>
 }</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_s1" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Omit the first parameter (set values before the loop starts):</p>
<div class="w3-code notranslate jsHigh">
var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var i = 2;<br>var len = cars.length;<br>var text = &quot;&quot;;<br>for (; i &lt; len; i++) {<br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>
 }</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_s1_om" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the continue statement - Loop through a block of code, but skip the value of &quot;3&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;<br>var i;<br>for (i = 0; i &lt; 5; i++) {<br>&nbsp;&nbsp;&nbsp; if (i == 3) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; continue;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; text += &quot;The number is &quot; + i + &quot;&lt;br&gt;&quot;;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_continue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the break statement - Loop through a block of code, but exit the loop when the variable i is equal 
to &quot;3&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;<br>var i;<br>for (i = 0; i &lt; 5; i++) {<br>&nbsp;&nbsp;&nbsp; if (i == 3) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; text += &quot;The number is &quot; + i + &quot;&lt;br&gt;&quot;;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_break" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Omit the second parameter. In this example, we also use the <strong><a href="jsref_break.asp">break</a></strong> statement to exit the loop when i is equal to &quot;3&quot;&nbsp;(if the second parameter is omitted, you must provide a break 
inside the loop. Otherwise the loop will never end, and your browser will crash):</p>
 <div class="w3-code notranslate jsHigh">
  var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var text = &quot;&quot;;<br>
  var i;<br>for (i = 0; ; i++) {<br>&nbsp;&nbsp;&nbsp; if (i == 3) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  break;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; text += cars[i] +  &quot;&lt;br&gt;&quot;;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_s2_break" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through the indices of an array, in descending order (negative 
increment):</p>
<div class="w3-code notranslate jsHigh">
 var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var text = &quot;&quot;;<br>var i;<br>
 for (i = cars.length - 1; i &gt;= 0; i--) {<br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>
 }</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_for_s3_desc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Omit the last parameter, and increment the values inside the loop:</p>
<div class="w3-code notranslate jsHigh">
 var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var i = 0;<br>var len = cars.length;<br>for (; i &lt; len;) { <br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>
 &nbsp;&nbsp;&nbsp;
 i++;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_s3_om" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through the nodes of a NodeList object and change the background color of all &lt;p&gt; elements in the list:</p>
<div class="w3-code notranslate jsHigh">
 var myNodelist = document.getElementsByTagName(&quot;P&quot;);<br>var i;<br>for (i = 0; i &lt; myNodelist.length; i++) {<br>&nbsp;&nbsp;&nbsp; myNodelist[i].style.backgroundColor = &quot;red&quot;;<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_nodelist" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>An example of a nested loop (a loop inside a loop):</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i, j;<br><br>for (i = 0; i &lt; 3; i++) {<br>&nbsp;&nbsp;&nbsp; text += &quot;&lt;br&gt;&quot; + &quot;i = &quot; + i + &quot;, j = &quot;; <br><br>&nbsp;&nbsp;&nbsp; for (j = 10; j &lt; 15; j++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = text += j + &quot; &quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_for_nested" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_loop_for.asp">JavaScript For Loop</a></p>
<p>JavaScript Reference: <a href="jsref_forin.asp">JavaScript for ... in Statement</a></p>
<p>JavaScript Reference: <a href="jsref_break.asp">JavaScript break Statement</a></p>
<p>JavaScript Reference: <a href="jsref_continue.asp">JavaScript continue Statement</a></p>
<p>JavaScript Reference: <a href="jsref_while.asp">JavaScript while Statement</a></p>
<hr>

<a href="jsref_statements.asp" class="w3-btn w3-white w3-border" title="JavaScript Statements Reference">&#10094; JavaScript Statements Reference</a>
</div>
