...
<html lang="en-US">
<head>
<title>HTML DOM Fieldset name Property</title>
 <meta charset="utf-8">
...
<h1>Fieldset <span class="color_h1">name</span> Property</h1>
<p><a href="dom_obj_fieldset.asp" class="w3-btn w3-white w3-border" title="Fieldset Object Reference">&#10094; Fieldset Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the name attribute of a fieldset:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFieldset&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">personalia</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_name">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property sets or returns the value of the name attribute of a fieldset.</p>
<p>The name attribute specifies the name of the fieldset field, and is used to reference form-data after it has been submitted, or to reference the element in a JavaScript.</p>
<p><strong>Note:</strong> Only form elements with a name attribute will have their values passed when submitting a form.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>fieldsetObject</em>.name
</div></div>
<p>Set the name property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>fieldsetObject</em>.name = <em>name</em>
 </div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the fieldset</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the name attribute of a fieldset:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myFieldset&quot;).name = &quot;newName&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fieldset_name2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_fieldset_name.asp">HTML &lt;fieldset&gt; name attribute</a></p>
<hr>
