...
<html lang="en-US">
<head>
<title>KeyboardEvent which Property</title>
<meta charset="utf-8">
...
<h1>KeyboardEvent <span class="color_h1">which</span> Property</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_keyboardevent.asp" class="w3-btn w3-white w3-border" title="KeyboardEvent">&#10094; KeyboardEvent</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the Unicode value of the pressed keyboard key:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.which;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_which" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The which property returns the Unicode character code of the key that 
triggered the <a href="event_onkeypress.asp">onkeypress</a> event, or the 
Unicode key code of the key that triggered the <a href="event_onkeydown.asp">onkeydown</a> or 
<a href="event_onkeyup.asp">onkeyup</a> event.</p>
<p>The difference between the two code types:</p>
<ul>
  <li>Character codes - A number which represents an ASCII character</li>
  <li>Key codes - A number which represents an actual key on the keyboard</li>
</ul>
<p>These types do not always mean the same thing; for example, a lower case 
...
Examples&quot; below to better understand it.</p>
<p><strong>Tip:</strong> To find out if the user is pressing a printable key (e.g. 
...
LOCK&quot; or &quot;Home&quot;) use the onkeydown or onkeyup event.</p>
<p><strong>Note:</strong> The which property is not supported in IE8 and 
earlier. For these browser versions, you can use the
<a href="event_key_keycode.asp">keyCode</a> property. However, the keyCode 
property does not work on the onkeypress event in Firefox. For a cross-browser 
solution, you can use the following code:</p>

<div class="w3-code w3-border notranslate jsHigh"><div>
     var x = event.which || event.keyCode;&nbsp; // Use either <strong>which</strong> or <strong>keyCode</strong>,  depending on browser support</div></div>

<p><strong>Tip:</strong> For a list of all Unicode characters, please study our 
<a href="../charsets/ref_html_utf8.asp">Complete Unicode Reference</a>.</p>
<p><strong>Tip:</strong> If you want to convert the returned Unicode value into a 
character, use the <a href="jsref_fromcharcode.asp">fromCharCode()</a> method.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Note:</strong> Both the which 
...
<a href="event_key_key.asp">key</a> property instead (if available).</p>
<p><strong>Tip:</strong> If you want to find out whether the &quot;ALT&quot;, &quot;CTRL&quot;, 
&quot;META&quot; or &quot;SHIFT&quot; key was pressed when a key event occured, use the
<a href="event_key_altkey.asp">altKey</a>, <a href="event_key_ctrlkey.asp">
ctrlKey</a>, <a href="event_key_metakey.asp">metaKey</a> or
<a href="event_key_shiftkey.asp">shiftKey</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.which</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing either a Unicode character code or the Unicode key code</td>
</tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using onkeypress and onkeydown to demonstrate the differences between 
character codes and keyboard codes:</p>
<div class="w3-code notranslate jsHigh">
 &lt;input type=&quot;text&quot; onkeypress=&quot;uniCharCode(event)&quot; onkeydown=&quot;uniKeyCode(event)&quot;&gt;
 <br><br>function uniCharCode(event) {<br>&nbsp;&nbsp;&nbsp; var char = event.which || event.keyCode; // event.keyCode is used for IE8 and earlier<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Unicode CHARACTER code: &quot; + char;<br>}<br><br>function uniKeyCode(event) {<br>&nbsp;&nbsp;&nbsp; var key = event.which || event.keyCode; // event.keyCode is used for IE8 and earlier<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo2&quot;).innerHTML = &quot;Unicode KEY code: &quot; + key;<br>
 }<br></div>
 <p>When pressing the &quot;a&quot; key on the keyboard (not using caps lock), the result of <em>char</em> and <em>key </em>will be:</p>
<div class="w3-code notranslate">Unicode CHARACTER code: 97<br>Unicode KEY code: 65</div>

<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_which2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Alert some text if the user presses the Escape key:</p>
<div class="w3-code notranslate jsHigh">
 &lt;input type=&quot;text&quot; onkeydown=&quot;myFunction(event)&quot;&gt; <br><br>function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; var x = event.which || event.keyCode; // event.keyCode is used for IE8 and earlier<br>&nbsp;&nbsp;&nbsp; if (x == 27) {&nbsp; // 27 is the ESC key<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert (&quot;You pressed the Escape key!&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_which3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Convert the Unicode value into a character (does not work for function keys):</p>
<div class="w3-code notranslate jsHigh">
 var x = event.which || event.keyCode;&nbsp;&nbsp; // Get the Unicode value<br>
 var y = String.fromCharCode(x);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Convert the value into a character<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_which4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_key_key.asp">KeyboardEvent key Property</a></p>
<p>HTML DOM reference: <a href="event_key_keycode.asp">KeyboardEvent keyCode Property</a></p>
<p>HTML DOM reference: <a href="event_key_charcode.asp">KeyboardEvent charCode Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_keyboardevent.asp" class="w3-btn w3-white w3-border" title="KeyboardEvent">&#10094; KeyboardEvent</a>
