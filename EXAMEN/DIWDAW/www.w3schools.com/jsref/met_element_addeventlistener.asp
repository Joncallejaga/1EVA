...
<h3>Example</h3>
 <p>Attach a click event to a &lt;button&gt; element. When the user clicks on the button, output &quot;Hello World&quot; in a &lt;p&gt; element with id=&quot;demo&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, function(){<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World&quot;;<br>});</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="met_element_removeeventlistener.asp">removeEventListener()</a> method to remove an event 
handler that has been attached with the addEventListener() method.</p>
<p><strong>Tip:</strong> Use the <a href="met_document_addeventlistener.asp">
document.addEventListener()</a> method to attach an event handler to the 
document.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.addEventListener(<em>event</em>, <em>function</em>, <em>useCapture</em>)
</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:18%;">Changelog:</th>
  <td>The useCapture parameter became optional in Firefox 6 and Opera 11.60 (has always been optional for Chrome, IE and Safari)</td>
  </tr>
</table>
...
<p>You can also refer to an external &quot;named&quot; function.</p>
 <p>This example demonstrates how to execute a function when a user clicks on a &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, myFunction);<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World&quot;;<br>
 }<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>You can add many events to the same element, without overwriting existing 
events.</p>
 <p>This example demonstrates how to add two click events on the same &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, myFunction);<br>document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, someOtherFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener3">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>You can add events of different types to the same element.</p>
 <p>This example demonstrates how to add many events on the same &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;mouseover&quot;, myFunction);<br>document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, someOtherFunction);<br>
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;mouseout&quot;, someOtherFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener4">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, function() {<br>&nbsp;&nbsp;&nbsp; myFunction(p1, p2);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener_param">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Change the background color of a &lt;button&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).addEventListener(&quot;click&quot;, function(){<br>&nbsp;&nbsp;&nbsp; this.style.backgroundColor = &quot;red&quot;;<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener5">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the optional <em>useCapture</em> parameter to demonstrate the 
difference between bubbling and capturing:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDiv&quot;).addEventListener(&quot;click&quot;, myFunction, true);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener_capture">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 // Attach an event handler to &lt;div&gt;<br>document.getElementById(&quot;myDIV&quot;).addEventListener(&quot;mousemove&quot;, myFunction);<br><br>// Remove the event handler from &lt;div&gt;<br>document.getElementById(&quot;myDIV&quot;).removeEventListener(&quot;mousemove&quot;, myFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener_remove">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;);<br>if (x.addEventListener) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For all major browsers, except IE 8 and earlier<br>&nbsp;&nbsp;&nbsp; x.addEventListener(&quot;click&quot;, myFunction);<br>} else if (x.attachEvent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For IE 8 and earlier versions<br>&nbsp;&nbsp;&nbsp; x.attachEvent(&quot;onclick&quot;, myFunction);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_addeventlistener_crossbrowser">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_eventlistener.asp">HTML DOM EventListener</a></p>
<p>HTML DOM Reference: <a href="met_document_addeventlistener.asp">document.addEventListener()</a></p>
<hr>
