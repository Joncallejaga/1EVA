...
<html lang="en-US">
<head>
<title>HTML DOM console.group() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.group()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a group of messages in the console:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.group();<br>console.log(&quot;Hello again, 
  this time inside a group!&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_group" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.group() method indicates the start of a message group.</p>
...
<p><strong>Tip:</strong> Use the <a href="met_console_groupCollapsed.asp">console.groupCollapsed()</a> method to 
hide the message group (collapsed by default).</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.group()</td>
    <td>Yes</td>
    <td>11.0</td>
    <td>4.0</td>
    <td>4.0</td>
...
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.group();<br>console.log(&quot;Hello again, 
  this time inside a group!&quot;);<br>console.groupEnd();<br>console.log(&quot;and we 
  are back.&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_group2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specifying a label for the message group:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.group(&quot;myLabel&quot;);<br>console.log(&quot;Hello again, 
  this time inside a group, with a label!&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_group3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
