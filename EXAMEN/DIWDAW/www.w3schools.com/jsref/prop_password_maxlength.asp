...
<html lang="en-US">
<head>
<title>HTML DOM Input Password maxLength Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">maxLength</span> Property</h1>
...
<h3>Example</h3>
<p>Get the maximum number of characters allowed in a specific password field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myPsw&quot;).maxLength;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">8</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_maxlength">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the maximum number of characters allowed in the password field</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_maxlength2">Try it Yourself &raquo;</a>
</div>
<hr>
