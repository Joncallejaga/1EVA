...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal defaultValue Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">defaultValue</span> Property</h1>
...
<h3>Example</h3>
<p>Change the default value of a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).defaultValue = &quot;2015-01-02T11:42:13.510&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_defaultvalue">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The defaultValue property sets or returns the default value of a local datetime field.</p>
<p><b>Note:</b> The default value is the value specified in the HTML <a href="prop_datetime-local_value.asp">value</a> attribute.</p>
<p>The difference between the defaultValue and <a href="prop_datetime-local_value.asp">value</a> 
...
<p>The defaultValue property is useful when you want to find out whether the local datetime field have been changed.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.defaultValue
</div></div>
<p>Set the defaultValue property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.defaultValue = <i>value
 </i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>value</em></td>
    <td>
  Specifies the default value of the local datetime field</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the default value of the local datetime field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the default value of a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).defaultValue;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2014-11-16T15:25:33</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_defaultvalue2">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;);<br>var defaultVal = x.defaultValue;<br>var currentVal = x.value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_defaultvalue3">Try it Yourself &raquo;</a>
</div>
<hr>
