...
<a target="_blank" href="tryit.asp?filename=tryjsref_regexp_unicode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The \uxxxx character is used to find the Unicode character specified by a hexadecimal number xxxx.</p>
