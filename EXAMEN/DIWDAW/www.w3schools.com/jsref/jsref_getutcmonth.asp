...
<a target="_blank" href="tryit.asp?filename=tryjsref_getutcmonth" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCMonth() method returns the month (from 0 to 11) for the 
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the name of the month, according to universal time (not just a number):</p>
<div class="w3-code notranslate jsHigh">
var d = new Date()<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_date_getutcmonth" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
