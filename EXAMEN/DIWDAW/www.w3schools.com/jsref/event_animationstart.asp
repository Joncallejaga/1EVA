...
<html lang="en-US">
<head>
<title>animationstart Event</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">animationstart</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Do something with a &lt;div&gt; element when a CSS animation has started:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>// Code for Chrome, Safari and Opera<br>
 x.addEventListener(&quot;webkitAnimationStart&quot;, myStartFunction);<br><br>// Standard syntax<br>x.addEventListener(&quot;animationstart&quot;, myStartFunction);</div>
...
<p>The animationstart event occurs when a CSS animation has started to play.</p>
...
<ul>
  <li>animationstart - occurs when the CSS animation has started</li>
  <li><a href="event_animationiteration.asp">animationiteration</a> - occurs when the CSS animation is repeated</li>
...
<p><strong>Note:</strong> For Chrome, Safari and Opera, use the webkitAnimationStart prefix.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 object.addEventListener(&quot;webkitAnimationStart&quot;, <em>myScript</em>);&nbsp; // Code for Chrome, Safari and Opera<em><br>object</em>.addEventListener(&quot;animationstart&quot;, <em>myScript</em>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Standard syntax<br></div></div>
