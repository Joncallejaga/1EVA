...
<html lang="en-US">
<head>
<title>HTML DOM Output htmlFor Property</title>
<meta charset="utf-8">
...
<h1>Output <span class="color_h1">htmlFor</span> Property</h1>
<p><a href="dom_obj_output.asp" class="w3-btn w3-white w3-border" title="Output Object Reference">&#10094; Output Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the relationship between the result of the calculation, and the elements 
used in the calculation:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOutput&quot;).htmlFor;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">a b</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_output_htmlfor">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The htmlFor property returns the value of the for attribute of an 
&lt;output&gt; element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>outputObject</em>.htmlFor</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A reference to the relationship between the result of the calculation, and the elements used in the calculation</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_output_for.asp">HTML &lt;output&gt; for attribute</a></p>
<hr>
