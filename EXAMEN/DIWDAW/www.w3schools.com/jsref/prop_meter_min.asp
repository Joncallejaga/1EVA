...
<html lang="en-US">
<head>
<title>HTML DOM Meter min Property</title>
 <meta charset="utf-8">
...
<h1>Meter <span class="color_h1">min</span> Property</h1>
<p><a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the min attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myMeter&quot;).min = &quot;20&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_min2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The min property sets or returns the value of the min attribute in a gauge.</p>
<p>The min attribute specifies the lower bound of the gauge, and the value must 
be less than the max attribute value.</p>
<p>If unspecified, the default value is 0.</p>
<p><strong>Tip:</strong> The min attribute, together with the max attribute, 
specifies the full range of the gauge.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.min</div></div>
<p>Set the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.min = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies a floating point number that is the minimum value of the gauge. Default value is &quot;0&quot;</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing a floating point number that is the minimum value of the gauge</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the max attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myMeter&quot;).min;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 0</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_min" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_meter_min.asp">HTML &lt;meter&gt; min attribute</a></p>
<hr>

<a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a>
</div>
