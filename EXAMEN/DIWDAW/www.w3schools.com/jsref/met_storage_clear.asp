...
<html lang="en-US">
<head>
<title>Storage clear() Method</title>
<meta charset="utf-8">
...
<h1>Storage <span class="color_h1">clear()</span> Method</h1>
<p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_clear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The clear() method removes all the Storage Object item for this domain.</p>
<p>The clear() method belongs to the Storage Object, which can be either a
...
<p>Remove all session items:</p>
<div class="w3-code notranslate jsHigh">
  sessionStorage.clear();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_clear_session" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
