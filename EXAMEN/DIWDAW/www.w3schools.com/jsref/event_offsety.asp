...
<html lang="en-US">
<head>
<title>MouseEvent offsetY Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">offsetY</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Click inside a DIV and output the y-coordinate of the click, relative to the DIV element:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.offsetY;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_offsety" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">offsetY</code> property returns the y-coordinate 
of the mouse pointer, relative to the target element.</p>
<p><strong>Tip:</strong> To get the x-coordinate, 
use the <a href="event_offsetx.asp">offsetX</a> property.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">offsetY</td>
    <td>Yes</td>
    <td>6</td>
    <td>39</td>
    <td>Yes</td>
...
<hr>
<h2>Related Pages</h2>
<p>MouseEvent: <a href="event_offsetx.asp">offsetX</a> Property</p>
