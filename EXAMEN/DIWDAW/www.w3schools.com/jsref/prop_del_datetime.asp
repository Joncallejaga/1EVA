...
<html lang="en-US">
<head>
<title>HTML DOM del dateTime Property</title>
 <meta charset="utf-8">
...
<h1>del <span class="color_h1">dateTime</span> Property</h1>
<p><a href="dom_obj_del.asp" class="w3-btn w3-white w3-border" title="del Object Reference">&#10094; del Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the date and time of when some text was deleted:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myDel").dateTime;
</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 2011-11-15T22:55:03Z</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_del_datetime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The dateTime property sets or returns the value of the datetime attribute of a deleted text.</p>
<p>The datetime attribute specifies the date and time when the text was deleted.</p>
<p><b>Note:</b> The datetime attribute has no visual effect in ordinary web browsers, but can be used by screen readers.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>delObject</em>.dateTime
</div></div>
<p>Set the dateTime property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>delObject</em>.dateTime = <i>YYYY
...
<table class="w3-table-all">
  <tr>
 <th style="width:29%">Return Value:</th>
  <td>A String, representing the date and time of when the text was deleted</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the datetime attribute:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myDel&quot;).dateTime = &quot;2013-11-15T21:40:07Z&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_del_datetime2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_del_datetime.asp">HTML &lt;del&gt; datetime attribute</a></p>
<hr>

<a href="dom_obj_del.asp" class="w3-btn w3-white w3-border" title="del Object Reference">&#10094; del Object</a>
</div>
