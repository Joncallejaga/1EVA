...
<h1>JavaScript JSON <span class="color_h1">parse()</span> Method</h1>
<p><a href="jsref_obj_json.asp" class="w3-btn w3-white w3-border" title="JSON Object Reference">&#10094; JavaScript JSON Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Parse a string (written in JSON format) and return a JavaScript object:</p>
<div class="w3-code notranslate jsHigh">
 var obj = JSON.parse('{&quot;firstName&quot;:&quot;John&quot;, &quot;lastName&quot;:&quot;Doe&quot;}');</div>
 <a target="_blank" href="tryit.asp?filename=tryjsref_parse_json" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The JSON.parse() method parses a string and returns a JavaScript object.</p>
<p>The string has to be written in JSON format.</p>
<p>The JSON.parse() method can optionally transform the result with a 
function.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 JSON.parse(<em>string, function</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>string</em></td>
    <td>Required. A string written in JSON format</td>
    </tr>
  <tr>
    <td><em>reviver function</em></td>
    <td>Optional. A function used to transform the result. The function is called for each item. Any nested objects are transformed before the parent.<br><ul><li>If the function  returns a valid value, the item value is replaced with the transformed  value</li>
    <li>If the function returns null or undefined, the item is deleted</li>
 </ul>
   </td>
  </tr>
</table>
...
<h3>Example</h3>
<p>How to use the <em>reviver</em> function:</p>
<div class="w3-code notranslate jsHigh">
  /*replace the value of "city" to upper case:*/<br>
  var text =
  '{ &quot;name&quot;:&quot;John&quot;, &quot;age&quot;:&quot;39&quot;, &quot;city&quot;:&quot;New York&quot;}';<br>
  var obj = JSON.parse(text, function (key, value) {<br>&nbsp;&nbsp;&nbsp; if 
  (key == &quot;city&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return value.toUpperCase();<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  return value;<br>&nbsp;&nbsp;&nbsp; }});<br>
  <br>document.getElementById(&quot;demo&quot;).innerHTML = obj.name + &quot;, &quot; + obj.city;</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjson_parse_reviver" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Parsing JSON received from the server:</p>
<div class="w3-code notranslate jsHigh">
  ...
  xmlhttp.send();</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjson_ajax" target="_blank">Try it Yourself &raquo;</a>
  <p>Take a look at <a href="json_demo.txt" target="_blank">json_demo.txt</a></p>
</div>

<hr>
<a href="jsref_obj_json.asp" class="w3-btn w3-white w3-border" title="JSON Object Reference">&#10094; JavaScript JSON Object</a>
</div>
