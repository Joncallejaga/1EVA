...
<h1><span class="color_h1">preventDefault()</span> Event Method</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_event.asp" class="w3-btn w3-white w3-border" title="Event Objects">&#10094; Event Object</a>
</p>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).addEventListener(&quot;click&quot;, function(event){<br>&nbsp;&nbsp;&nbsp; event.preventDefault()<br>});<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_preventdefault" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The preventDefault() method cancels the event if it is cancelable, meaning 
that the default action that belongs to the event will not occur.</p>
<p>For example, this can be useful when:</p>
<ul>
...
<p><strong>Note:</strong> Not all events are cancelable. Use the 
<a href="event_cancelable.asp">cancelable</a> 
property to find out if an event is cancelable.</p>
<p><strong>Note:</strong> The preventDefault() method does not prevent further 
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.preventDefault()</div></div>
<h2>Parameters</h2>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  ...
  <tr>
 <th style="width:23%">DOM Version:</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>Prevent the default action of a checkbox:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myCheckbox&quot;).addEventListener(&quot;click&quot;, function(event){<br>&nbsp;&nbsp;&nbsp; event.preventDefault()<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_event_preventdefault2">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
