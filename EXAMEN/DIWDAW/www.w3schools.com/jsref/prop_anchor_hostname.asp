...
<div class="w3-code notranslate">
 www.example.com</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_hostname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hostname property sets or returns the hostname part of the href attribute 
value.</p>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the hostname of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").hostname = &quot;www.somenewexamplepage.com&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_hostname2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example of how to change the hostname of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").hostname = &quot;www.w3schools.com&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_hostname3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
