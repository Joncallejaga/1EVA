...
<html lang="en-US">
<head>
<title>HTML DOM Audio src Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of an audio file:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myAudio&quot;).src;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/horse.ogg</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute of an audio.</p>
...
<p>The src property is supported in all major browsers. However, the file format 
defined may not be supported in all browsers.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>audioObject</em>.src</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>audioObject</em>.src =<em> URL</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>URL</em></td>
    <td>
 Specifies the URL of the audio file.<br><br>Possible values:
 <ul>
    <li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/movie.ogg&quot;)<br>
  </li>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the audio file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_audio_src.asp">HTML &lt;audio&gt; src attribute</a></p>
<hr>
