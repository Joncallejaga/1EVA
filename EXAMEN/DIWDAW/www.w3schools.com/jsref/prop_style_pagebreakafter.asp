...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;footer&quot;).style.pageBreakAfter = &quot;always&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjsref_style_pagebreakafter.htm">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">pageBreakAfter</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>left</td>
    <td>Insert one or two page breaks after the element, so the next page is  considered a left page</td>
  </tr>
  <tr>
    <td>right</td>
    <td>Insert one or two page breaks after the element, so the next page is  considered a right page</td>
  </tr>
  <tr>
    <td>initial</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the page-break behavior after an element when printing</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
