...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Geolocation Object</title>
<meta charset="utf-8">
...
<h1>The <span class="color_h1">Geolocation</span> Object</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="obj_events.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="obj_history.asp">Next &#10095;</a>
</div>
<hr>

<h2>Geolocation Object</h2>
<p>The Geolocation object allows the user to provide their location to web 
applications. For privacy reasons, the user is asked for permission to report 
location information.</p>
<div class="w3-panel w3-note">
<p><b>Note:</b> This feature is available only in secure contexts (HTTPS).</p>
  <p><strong>Note:</strong><b> </b>Geolocation is most accurate for devices with GPS, like iPhone.</p>
</div>
<p>The Geolocation API is published through the
<a href="prop_nav_geolocation.asp">navigator.geolocation</a> object.</p>

<hr>

<h2>Geolocation Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_geo_coordinates.asp">coordinates</a></td>
    <td>Returns the position and altitude of the device on Earth</td>
  </tr>
  <tr>
    <td><a href="prop_geo_position.asp">position</a></td>
...
<h2>Geolocation Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
