...
<h3>Example</h3>
 <p>Insert a new &lt;li&gt; element before the first child element of an &lt;ul&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var newItem = document.createElement(&quot;LI&quot;);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create a &lt;li&gt; node<br>var textnode = document.createTextNode(&quot;Water&quot;);&nbsp;&nbsp;// Create a text node<br>newItem.appendChild(textnode);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Append the text to &lt;li&gt;<br><br>var list = document.getElementById(&quot;myList&quot;);&nbsp;&nbsp;&nbsp;&nbsp;// Get the &lt;ul&gt; element to insert a new node<br>list.insertBefore(newItem, list.childNodes[0]);&nbsp;&nbsp;// Insert &lt;li&gt; before the first child of &lt;ul&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_insertbefore" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The insertBefore() method inserts a node as a child, right before an existing child, which you specify.</p>
<p><strong>Tip:</strong> If you want to create a new list item, with text, remember to create the text as a Text node which 
you append to the &lt;li&gt; element, <em>then</em> insert &lt;li&gt; to the list.</p>
<p>You can also use the insertBefore method to insert/move an existing element (See &quot;More Examples&quot;).</p>
<hr>
...
<td>Node object</td>
<td>Required. The child node you want to insert the new node before. If set to
<code class="w3-codespan">null</code>, the insertBefore method will insert the <em>newnode</em> at the end</td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Node Object, representing the inserted node</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Move a &lt;li&gt; element from one list to another:</p>
<div class="w3-code notranslate jsHigh">
 var node = document.getElementById(&quot;myList2&quot;).lastChild;<br>var list = document.getElementById(&quot;myList1&quot;);<br>
 list.insertBefore(node, list.childNodes[0]);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_insertbefore2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
