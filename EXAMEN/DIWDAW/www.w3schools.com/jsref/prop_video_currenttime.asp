...
<html lang="en-US">
<head>
<title>HTML DOM Video currentTime Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">currentTime</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).currentTime = 5;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_currenttime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The currentTime property sets or returns the current position (in seconds) of the video playback.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.currentTime
</div></div>
<p>Set the currentTime property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.currentTime = <i>seconds</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>seconds</i></td>
    <td>Specifies the position for the playback of the video, in seconds</td>
  </tr>
</table>
