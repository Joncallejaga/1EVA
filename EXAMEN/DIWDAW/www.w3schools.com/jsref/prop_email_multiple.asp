...
<html lang="en-US">
<head>
<title>HTML DOM Input Email multiple Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">multiple</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if an email field accept multiple values/emails:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;myEmail&quot;).multiple;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_multiple">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The multiple property sets or returns whether an email field should accept 
multiple values/emails on form submission.</p>
<p>When set to true, it specifies that the user is allowed to enter more than 
one value/email in the email field.</p>
<p>This property reflects the HTML multiple attribute.</p>
<p><strong>Tip:</strong> On submit, separate each email with a comma, like: 
mail@example.com, mail2@example.com, mail3@example.com in the email field.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.multiple</div></div>
<p>Set the multiple property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.multiple = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether an email field should accept multiple emails on form  submission
  <ul>
      <li>true - The email field accept multiple emails</li>
      <li>false - Default. The email field does not accept multiple emails</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the email field accept multiple emails, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set an email field to allow multiple emails:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).multiple = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_multiple2">Try it Yourself &raquo;</a>
</div>
<hr>
