...
<html lang="en-US">
<head>
<title>HTML DOM Input Date type Property</title>
 <meta charset="utf-8">
...
<h1>Input Date <span class="color_h1">type</span> Property</h1>
<p><a href="dom_obj_date.asp" class="w3-btn w3-white w3-border" title="Input Date Object Reference">&#10094; Input Date Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return which type of form element the date field is:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDate&quot;).type;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">date</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_type">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The type property returns which type of form element the date field is.</p>
<hr>
...
date field/calendar in IE 11 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.type
</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of form element the date field is</td>
  </tr>
</table>
