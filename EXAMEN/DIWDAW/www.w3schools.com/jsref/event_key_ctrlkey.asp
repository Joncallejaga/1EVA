...
<html lang="en-US">
<head>
<title>KeyboardEvent ctrlKey Property</title>
<meta charset="utf-8">
...
<h1>KeyboardEvent <span class="color_h1">ctrlKey</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out whether or not the &quot;CTRL&quot; key was pressed when a keyboard key 
is pressed:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;demo&quot;);<br>if (event.ctrlKey) {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;The CTRL key was pressed!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;The CTRL key was NOT pressed!&quot;;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_ctrlkey" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Boolean, indicating whether the &quot;CTRL&quot; key was pressed when the key event occured.
 <p>Possible values:</p>
 <ul>
