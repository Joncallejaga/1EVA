...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration parentRule Property</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration parentRule<span class="color_h1"> </span> Property</h1>
...
<h3>Example</h3>
<p>Return the CSS declaration <em>and</em> the CSS selector:</p>
<div class="w3-code notranslate jsHigh">
  var s = document.styleSheets[0].rules[0].style;<br>var ruleObj = s.parentRule;<br>
  document.getElementById(&quot;demo&quot;).innerHTML = ruleObj.cssText;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_parentrule">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parentRule property returns a CSSRule Object representing a CSS rule-set 
(selector and declaration block).</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">parentRule</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<h2>Syntax</h2>
<p>Return the parentRule property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.parentRule</div></div>
<hr>
