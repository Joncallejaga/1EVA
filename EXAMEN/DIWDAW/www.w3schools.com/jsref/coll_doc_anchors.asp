...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_anchors" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;a&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;a&gt; elements in the document that have a name attribute. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<div class="w3-code notranslate">
 HTML Tutorial</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_anchors2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
