...
<html lang="en-US">
<head>
<title>HTML DOM Button formEnctype Property</title>
 <meta charset="utf-8">
...
<h1>Button <span class="color_h1">formEnctype</span> Property</h1>
<p><a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Button Object Reference">&#10094; Button Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return how form-data should be encoded before sending it to a server:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).formEnctype;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">text/plain</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_pushbutton_formenctype">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The formEnctype property sets or returns the value of the formenctype attribute 
of a button.</p>
<p>The formenctype attribute specifies how form-data should be encoded before 
sending it to a server. This attribute overrides the form's
enctype attribute.</p>
<p>The formenctype attribute is only used for buttons with type="submit".</p>
<p><strong>Note:</strong> The formenctype attribute is new for the &lt;button&gt; 
element in HTML5.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the formEnctype property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formEnctype
</div></div>
<p>Set the formEnctype property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formEnctype = &quot;application/x-www-form-urlencoded,multipart/form-data,text/plain&quot;</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of content that is used to submit the form to the server</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the formenctype attribute of a button from &quot;text/plain&quot; 
to &quot;application/x-www-form-urlencoded&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myBtn").formEnctype = &quot;application/x-www-form-urlencoded&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formenctype2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example on returning the formEnctype property:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById("myBtn").formEnctype;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formenctype3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_button_formenctype.asp">HTML &lt;button&gt; formenctype attribute</a></p>
<hr>
