...
<a href="met_win_open.asp">window.open()</a> method, which opens a new browser 
window.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>replace</td>
    <td>Optional. If set, the history entry for the new document inherits the history entry from the document which opened this document</td>
  </tr>
</table>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_open">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_open2">Try it Yourself &raquo;</a>
</div>
<hr>
