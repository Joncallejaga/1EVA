...
<h1>JavaScript <span class="color_h1">break</span> Statement</h1>
...
<p>The break statement exits a switch statement or a loop (for, for ... in, 
while, do ... while).</p>
<p>When the break statement is used with a switch statement, it breaks out of 
the switch block. This will stop the execution of more execution of code and/or 
case testing inside the block.</p>
<p>When the break statement is used in a loop, it breaks the loop and 
continues executing the code after the loop (if any).</p>
<p>The break statement can also be used with an optional label reference, to 
&quot;jump out&quot; of any JavaScript code block (see &quot;More Examples&quot; 
below).</p>
<p><strong>Note:</strong> Without a label reference, the break 
statement can only be used inside a loop or a switch.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>In this example we use a while loop together with the break statement.</p>
 <p>Loop through a block of code, but exit the loop when the variable i is equal 
to &quot;3&quot;:</p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<h3>Example</h3>
<p>Break out of a switch block to ensure that only one case is 
executed:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_break_switch" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the break statement with a label reference, to &quot;jump out&quot; of a 
JavaScript code block:</p>
<div class="w3-code notranslate jsHigh">
 var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var text = &quot;&quot;;<br><br>list: {<br>&nbsp;&nbsp;&nbsp; text += cars[0] + &quot;&lt;br&gt;&quot;; <br>&nbsp;&nbsp;&nbsp; text += cars[1] + &quot;&lt;br&gt;&quot;; <br>&nbsp;&nbsp;&nbsp; text += cars[2] + &quot;&lt;br&gt;&quot;;
 <br>&nbsp;&nbsp;&nbsp; break list;<br>&nbsp;&nbsp;&nbsp; text += cars[3] + &quot;&lt;br&gt;&quot;; <br>}</div>
<!--<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 BMW<br>Volvo<br>Saab</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_break_label" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the break statement with a label reference, to &quot;jump out&quot; of a nested 
for loop:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i, j;<br><br>Loop1: // The first for loop is labeled &quot;Loop1&quot;<br>for (i = 0; i &lt; 3; i++) {<br>text += &quot;&lt;br&gt;&quot; + &quot;i = &quot; + i + &quot;, j = &quot;;<br><br>&nbsp;&nbsp;&nbsp; Loop2: // The second for loop is labeled &quot;Loop2&quot;<br>&nbsp;&nbsp;&nbsp; for (j = 10; j &lt; 15; j++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (j === 12) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break Loop2;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = text += j + &quot; &quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<!--<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 i = 0, j = 10 11<br>i = 1, j = 10 11<br>i = 2, j = 10 11 </div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_break_label_nest" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>JavaScript Tutorial: <a href="../js/js_switch.asp">JavaScript Switch</a></p>
...
<p>JavaScript Reference: <a href="jsref_switch.asp">JavaScript switch Statement</a></p>
<hr>
