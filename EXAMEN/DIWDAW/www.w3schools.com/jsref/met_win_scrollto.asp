...
<h3>Example</h3>
<p>Scroll the document to the horizontal position &quot;500&quot;:</p>
<div class="w3-code notranslate jsHigh">
 window.scrollTo(500, 0);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_scrollto" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollTo() method scrolls the document to the specified coordinates.</p>
<p><strong>Tip:</strong> Use the <a href="met_win_scrollby.asp">scrollBy()</a> method to scroll a specified distance multiple times.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>xpos</em></td>
    <td>Number</td>
    <td>Required. The coordinate to scroll to, along the x-axis (horizontal), in pixels</td>
  </tr>
  <tr>
    <td><em>ypos</em></td>
    <td>Number</td>
    <td>Required. The coordinate to scroll to, along the y-axis (vertical), in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Scroll the document to position &quot;300&quot; horizontally and &quot;500&quot; vertically:</p>
<div class="w3-code notranslate jsHigh">
 window.scrollTo(300, 500);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_scrollto2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>Window Object: <a href="met_win_scrollby.asp">scrollBy() Method</a></p>
<hr>
