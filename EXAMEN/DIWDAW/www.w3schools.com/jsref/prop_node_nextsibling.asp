...
<h3>Example</h3>
 <p>Get the HTML content of the next sibling of a list item:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;item1&quot;).nextSibling.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Tea (second li)</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_nextsibling" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="prop_element_nextelementsibling.asp">nextElementSibling</a>, is that 
nextSibling returns 
the next sibling node as an element node, a text node or a comment node, while 
nextElementSibling returns the next sibling node as an element node (ignores text and comment nodes).</p>
<p>This property is read-only.</p>
<p><strong>Tip: </strong>Use the <a href="prop_node_previoussibling.asp">
previousSibling</a> property to return the previous node of the specified node, 
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the next sibling of the node, or <em>null </em>if there is no next sibling</td>
</tr>
<tr>
  <th>DOM Version</th>
