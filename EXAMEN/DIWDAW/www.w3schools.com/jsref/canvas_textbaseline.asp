...
<p><b>Note:</b> The textBaseline property may works differently in browsers, especially when using "hanging" or "ideographic".</p>
<hr>

<h2>Definition and Usage</h2>
<p>The textBaseline property sets or returns the current text baseline used when drawing text.</p>
<p>The illustration below demonstrates the various baselines supported by the textBaseline attribute:</p>
...
<hr>
<a href="dom_obj_canvas.asp" class="w3-btn w3-white w3-border" title="Canvas Object Reference">&#10094; Canvas Object</a>
</div>
