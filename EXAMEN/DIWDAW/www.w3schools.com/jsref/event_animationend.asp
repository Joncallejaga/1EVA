...
<html lang="en-US">
<head>
<title>animationend Event</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">animationend</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Do something with a &lt;div&gt; element when a CSS animation has ended:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br><br>// Code for Chrome, Safari and Opera<br>
 x.addEventListener(&quot;webkitAnimationEnd&quot;, myEndFunction);<br><br>// Standard syntax<br>x.addEventListener(&quot;animationend&quot;, myEndFunction);</div>
...
<p>The animationend event occurs when a CSS animation has completed.</p>
...
<ul>
  ...
  <li>animationend - occurs when the CSS animation has completed</li>
</ul>
<hr>
...
<p><strong>Note:</strong> For Chrome, Safari and Opera, use the webkitAnimationEnd prefix.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 object.addEventListener(&quot;webkitAnimationEnd&quot;, <em>myScript</em>);&nbsp; // Code for Chrome, Safari and Opera<em><br>object</em>.addEventListener(&quot;animationend&quot;, <em>myScript</em>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Standard syntax<br></div></div>
