...
<html lang="en-US">
<head>
<title>ontimeupdate Event</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">ontimeupdate</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the current playback position has changed:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video ontimeupdate=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ontimeupdate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ontimeupdate event occurs when the playing position of an audio/video has changed.</p>
...
<p><strong>Tip:</strong> The ontimeupdate event is often used together with the <a href="prop_video_currenttime.asp">
currentTime</a> property of the Audio/Video Object, which returns the current 
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> ontimeupdate=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ontimeupdate_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.ontimeupdate = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ontimeupdate_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;timeupdate&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ontimeupdate_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the current playback position of an audio has 
changed:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;audio ontimeupdate=&quot;myFunction()&quot;&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ontimeupdate_audio">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ontimeupdate_currenttime">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
