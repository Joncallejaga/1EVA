...
<html lang="en-US">
<head>
<title>HTML DOM Input Time disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Time <span class="color_h1">disabled</span> Property</h1>
...
<h3>Example</h3>
<p>Disable a time field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTime&quot;).disabled = true;</div>
<!--<p>The result could be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="time" value="16:30:00" disabled>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a time field should be 
disabled, or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.disabled = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - The time field is disabled</li>
      <li>false - Default. The time field is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the time field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a time field is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTime&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_disabled2">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a time field:</p>
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTime&quot;).disabled = true;<br>
 }<br><br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTime&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
