...
<html lang="en-US">
<head>
<title>HTML DOM Input Radio name Property</title>
 <meta charset="utf-8">
...
<h1>Input Radio <span class="color_h1">name</span> Property</h1>
<p><a href="dom_obj_radio.asp" class="w3-btn w3-white w3-border" title="Input Radio Object Reference">&#10094; Input Radio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the name of a radio button:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myRadio&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">colors</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_radio_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the radio button</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_radio_name2">Try it Yourself &raquo;</a>
</div>
<hr>
