...
<html lang="en-US">
<head>
<title>HTML DOM children Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">children</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get a collection of the &lt;body&gt; element's children:</p>
<div class="w3-code notranslate jsHigh">
 var c =
 document.body.children;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_children" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The children property returns a collection of an element's child elements, as an 
HTMLCollection object.</p>
<p>The elements in the collection are sorted as they appear in the source code and can be accessed by index numbers. The index starts at 0.</p>
<p><strong>Tip: </strong>You can use the length property of the HTMLCollection object to determine the number of child 
elements, then you can loop through all children and extract the info you want.</p>
<p>The difference between this property and
<a href="prop_node_childNodes.asp">childNodes</a>, is that childNodes contain all nodes, including text nodes and comment nodes, while children only contain 
element nodes. </p>
<hr>
...
<p><strong>*Note:</strong> The children property is fully supported in IE6 to 
IE8. However, in these versions, it returns element nodes AND comment nodes. IE9+ 
returns only element nodes.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.children</div></div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A live HTMLCollection object, representing a collection of element nodes. The elements in the returned collection are sorted as they appear in the source code</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out how many children a &lt;div&gt; element has:</p>
<div class="w3-code notranslate jsHigh">
 var c =
 document.getElementById(&quot;myDIV&quot;).children.length;</div>
<!--<p>The result of <em>c</em> will be:</p>
<div class="w3-code notranslate">
 2</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_children_length">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Change the background color of the second child element of a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.getElementById(&quot;myDIV&quot;).children;<br>c[1].style.backgroundColor = &quot;yellow&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_children2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the third child element (index 2) of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.getElementById(&quot;mySelect&quot;).children[2].text;</div>
<!--<p>The result of <em>c</em> will be:</p>
<div class="w3-code notranslate">
 Saab</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_children3">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all children of &lt;body&gt; and change their background color to red:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.body.children;<br>var i;<br>for (i = 0; i &lt; c.length; i++) {<br>&nbsp;&nbsp;&nbsp; c[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_children4">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_node_childnodes.asp">childNodes Property</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
