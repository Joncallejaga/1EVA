...
<h1>Audio <span class="color_h1">loop</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the audio to loop:</p>
<div class="w3-code notranslate jsHigh">
    document.getElementById(&quot;myAudio&quot;).loop = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The loop property sets or returns whether an audio should start playing over 
again when it is finished.</p>
<p>This property reflects the &lt;audio&gt; loop attribute.</p>
<p>When present, it specifies that the audio should start playing over again 
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.loop</div></div>
<p>Set the loop property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.loop = true|false</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>
 Specifies whether the audio should start playing over again, every time it is finished<ul>
    <li>true - Indicates that the audio should start playing again when it  is finished</li>
    <li>false - Default. Indicates that the audio should NOT start playing  again when it is finished</li>
 </ul>
   </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio starts playing over again, every time it is finished. Otherwise it returns false</td>
  </tr>
  <tr>
  <th>Default Value:</th>
  <td>false</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio should start playing over again every time it is 
finished, or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).loop;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_loop2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_audio_loop.asp">HTML &lt;audio&gt; loop attribute</a></p>
<hr>
