...
<html lang="en-US">
<head>
<title>StorageEvent key Property</title>
<meta charset="utf-8">
...
<h1>StorageEvent <span class="color_h1">key</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the name of the storage item that changed:</p>
<div class="w3-code notranslate jsHigh">
  window.addEventListener(&quot;storage&quot;, myFunction);<br><br>function myFunction(event) 
  {<br>&nbsp; var x = &quot;Key: &quot; + event.key;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = x;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_storage_key" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The key property returns the name of the changed storage item.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the storage item</td>
</tr>
</table>
