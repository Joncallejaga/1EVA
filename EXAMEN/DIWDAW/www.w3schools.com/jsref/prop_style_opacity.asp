...
<div class="w3-code notranslate jsHigh">
 document.getElementById("myDIV").style.opacity = "0.5";</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_opacity">
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_opacity.asp">opacity property</a></p>
<hr>
