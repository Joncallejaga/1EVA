...
<h3>Example</h3>
<p>Get the alternate text of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;venus&quot;).alt;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 A beautiful planet</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_alt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing an alternate text for the area</td>
</tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_area_alt2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_area_alt.asp">HTML &lt;area&gt; alt attribute</a></p>
<hr>
