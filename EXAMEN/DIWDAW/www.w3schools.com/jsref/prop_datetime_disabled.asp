...
<html lang="en-US">
<head>
<title>HTML DOM Input Datetime disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Datetime <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_datetime.asp" class="w3-btn w3-white w3-border" title="Input Datetime Object Reference">&#10094; Input Datetime Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Disable a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDatetime&quot;).disabled = true;</div>
<!--<p>The result could be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="datetime" value="2014-02-06T10:57Z" disabled>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a datetime field should be disabled, or not.</p>
...
<p><strong>Note:</strong> The &lt;input type=&quot;datetime&quot;&gt; element does not show any 
datetime field/calendar in any major browsers, except Safari.</p>
<hr>

<h2>Syntax</h2>
<p>Return the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.disabled = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a datetime field should be disabled, or not
  <ul>
      <li>true - The datetime field is disabled</li>
      <li>false - Default. The datetime field is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the datetime field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a datetime field is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDatetime&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_disabled2">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDatetime&quot;).disabled = true;<br>
 }<br><br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDatetime&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="dom_obj_datetime.asp" class="w3-btn w3-white w3-border" title="Input Datetime Object Reference">&#10094; Input Datetime Object</a>
</div>
