...
<h1>Video <span class="color_h1">canPlayType()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.createElement(&quot;VIDEO&quot;);<br>isSupp = x.canPlayType(vidType+';codecs=&quot;'+codType+'&quot;'); </div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_canplaytype" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The canPlayType() method checks if the browser can play the specified video 
type.</p>
...
<div class="w3-code w3-border notranslate"><div>
  ...
  <em>videoObject</em>.canPlayType(<em>type</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>type</em></td>
    <td>Specifies the video type (and optional codecs) to test support for.<br>
 <p>Common values:<br>
 <ul>
  <li>video/ogg</li>
    <li>video/mp4</li>
