...
<div class="w3-code notranslate jsHigh">
 var text;<br>var fruits = document.getElementById(&quot;myInput&quot;).value;<br><br>
 switch(fruits) {<br>&nbsp;&nbsp;&nbsp; case &quot;Banana&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Banana is good!&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
 &nbsp;&nbsp;&nbsp; case &quot;Orange&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;I am not a fan of orange.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; case &quot;Apple&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;How you like them apples?&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; default:<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 text = &quot;I have never heard of that fruit...&quot;;<br>}</div>
<!--<p>The result of <em>text</em> could be:</p>
<div class="w3-code notranslate">
 How you like them apples?</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_switch1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The switch statement is a part of JavaScript's &quot;Conditional&quot; Statements, 
...
solution for long, nested <a href="jsref_if.asp">if/else</a> statements.</p>
<p>The switch statement evaluates an expression. The value of the expression is then compared with the values of each case in the structure. If there is a match, the associated block of code is executed.</p>
<p>The switch statement is often used together with a break or a default keyword 
(or both). These are both optional:</p>
<p>The <strong>break</strong> keyword breaks out of the switch block. This will stop the execution of more execution of code and/or case testing inside 
the block. If break is omitted, the next code block in the switch statement is 
executed.</p>
<p>The <strong>default</strong> keyword specifies some code to run if there is no 
...
<div class="w3-example">
<h3>Example</h3>
<p>Use today's weekday number to calculate the weekday name (Sunday=0, Monday=1, Tuesday=2, 
...):</p>
<div class="w3-code notranslate jsHigh">
 var day;<br>switch (new Date().getDay()) {<br>
&nbsp;&nbsp;&nbsp;
case 0:<br>
&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; day = &quot;Sunday&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
...
case 6:<br>
&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; day = &quot;Saturday&quot;;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; default:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; day = &quot;Unknown Day&quot;;<br>
}</div>
<!--<p>The result of <em>day</em> will be:</p>
<div class="w3-code notranslate">
<script>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_switch" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>If today is neither Saturday nor Sunday, write a default message:</p>
<div class="w3-code notranslate jsHigh">
 var text;<br>switch (new Date().getDay()) {<br>
&nbsp;&nbsp;&nbsp;
case 6:<br>
&nbsp;
...
<a target="_blank" href="tryit.asp?filename=tryjsref_state_switch2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Sometimes you will want different cases to use the same code, or fall-through to a common default.</p>
 <p>Note that in this example, the cases share the same code block, and that the default case does not have to be the last case in a switch block (however, if <strong>default</strong> is NOT the last case in the switch block, remember to end it with a break).</p>
<div class="w3-code notranslate jsHigh">
 var text;<br>switch (new Date().getDay()) {<br>
&nbsp;&nbsp;&nbsp;
case 1:<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_switch3" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Using the switch statement to execute a block of code based on user input, from a prompt box:</p>
<div class="w3-code notranslate jsHigh">
 var text;<br>var favDrink = prompt(&quot;What's your favorite cocktail drink?&quot;);<br>
 switch(favDrink) {<br>&nbsp;&nbsp;&nbsp; case &quot;Martini&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Excellent choice! Martini is good for your soul.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; case &quot;Daiquiri&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Daiquiri is my favorite too!&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; case &quot;Cosmopolitan&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Really? Are you sure the Cosmopolitan is your favorite?&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; default:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;I have never heard of that one..&quot;;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_state_switch4" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_if_else.asp">JavaScript If...Else Statements</a></p>
<p>JavaScript Tutorial: <a href="../js/js_switch.asp">JavaScript Switch Statement</a></p>
<p>JavaScript Reference: <a href="jsref_if.asp">JavaScript if/else Statement</a></p>
