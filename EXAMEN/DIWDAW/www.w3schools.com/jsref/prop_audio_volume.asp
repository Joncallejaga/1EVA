...
<html lang="en-US">
<head>
<title>HTML DOM Audio volume Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">volume</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set audio volume to 20%:</p>
<div class="w3-code notranslate jsHigh">
    document.getElementById(&quot;myAudio&quot;).volume = 0.2;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_volume" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The volume property sets or returns the audio volume of an audio, from 0.0 (silent) to 1.0 (loudest).</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.volume</div></div>
<p>Set the volume property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.volume =<em> number</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies the audio volume of the audio. Must be a number between 0.0 to 1.0<br>Example values:
 <ul>
    <li>1.0 is highest volume (100%. This is default)</li>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the audio volume of the audio</td>
  </tr>
  <tr>
  <th>Default Value:</th>
  <td>1.0</td>
