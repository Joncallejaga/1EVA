...
<h1>JavaScript Array <span class="color_h1">from()</span> Method</h1>
...
var myArr = Array.from(&quot;ABCDEFG&quot;);<br>
  </div>
<a target="_blank" href="tryit.asp?filename=tryjsref_from" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Array.from() method returns an Array object from any object with a length 
property or an iterable object.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
  Array.from(<em>object, mapFunction, thisValue</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>object</em></td>
    <td>Required. The object to convert to an array</td>
    </tr>
  <tr>
    <td><em>mapFunction</em></td>
    <td>Optional. A map function to call on each item of the array</td>
    </tr>
  <tr>
    <td><em>thisValue</em></td>
    <td>Optional. A value to use as <em>this</em> when executing the <em>
    mapFunction</em></td>
  </tr>
</table>
<hr>
