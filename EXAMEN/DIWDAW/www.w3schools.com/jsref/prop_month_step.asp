...
<html lang="en-US">
<head>
<title>HTML DOM Input Month step Property</title>
 <meta charset="utf-8">
...
<h1>Input Month <span class="color_h1">step</span> Property</h1>
<p><a href="dom_obj_month.asp" class="w3-btn w3-white w3-border" title="Input Month Object Reference">&#10094; Input Month Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the legal month intervals:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myMonth&quot;).step = &quot;2&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_step">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The step property sets or returns the value of the step attribute of a month 
field.</p>
<p>The step attribute specifies the legal month intervals to choose from when the 
user <strong>opens the calendar</strong> in the month field.</p>
<p>For example, if step = &quot;2&quot;, you can only select every second month 
in the calendar (like January, March, May).</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>monthObject</em>.step</div></div>
<p>Set the step property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>monthObject</em>.step = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the legal month intervals. Default is 1 month.<br><br><strong>
  Examples:</strong><br><br>If step=&quot;2&quot;, you can only select every  second  month in the month calendar.<br><br>If step=&quot;5&quot;, you can only select every  fifth month in the month calendar.</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the legal month intervals</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the legal month intervals:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myMonth&quot;).step;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">3</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_step2">Try it Yourself &raquo;</a>
</div>
<hr>
