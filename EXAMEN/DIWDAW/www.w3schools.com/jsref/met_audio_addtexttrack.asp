...
<html lang="en-US">
<head>
<title>HTML DOM Audio addTextTrack() Method</title>
<meta charset="utf-8">
...
<h1>Audio <span class="color_h1">addTextTrack()</span> Method</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Add a new text track to the audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;);<br>var y = x.addTextTrack(&quot;caption&quot;);<br>
 y.addCue(new TextTrackCue(&quot;Test text&quot;, 01.000, 04.000,&quot;&quot;,&quot;&quot;,&quot;&quot;,true));</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_addtexttrack" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addTextTrack() method creates and returns a new TextTrack object.</p>
<p>The new TextTrack object is added to the list of text tracks for the audio element.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
  <em>audioObject</em>.addTextTrack(<em>kind</em>,<em> label</em>,<em> language</em>)
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>label</em></td>
    <td>A string specifying the label for the text track. Is used to  identify the text track for the users</td>
  </tr>
  <tr>
    <td><em>language</em></td>
    <td>A two-letter language code that specifies the language of the text track.<br>
  To view all available language codes, go to our <a href="../tags/ref_language_codes.asp">Language code reference</a></td>
  </tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A TextTrack Object, representing the new text track</td>
</tr>
</table>
