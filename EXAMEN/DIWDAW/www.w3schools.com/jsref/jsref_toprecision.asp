...
<a target="_blank" href="tryit.asp?filename=tryjsref_toprecision" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Optional. The number of digits. If omitted, it returns the entire number (without any formatting)</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing a number formatted to the specified precision</td>
</tr>
<tr>
...
<!--<p>The result of a,b,c,d will be:</p>
<div class="w3-code notranslate">
<script>
var num = 13.3714;
...
<a target="_blank" href="tryit.asp?filename=tryjsref_toprecision2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_toprecision3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
