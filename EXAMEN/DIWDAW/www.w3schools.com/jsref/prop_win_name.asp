...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_name">Try it Yourself &raquo;</a>
</div>
...
<p>This property is often used to modify the name of a window, after the window has been created.</p>
<p><strong>Note:</strong> The name of the window is often used for setting targets for hyperlinks and forms. However, this is not required, as windows do not need to have names.</p>
<hr>
...
<td>String</td>
<td>
Specifies the name of the window</td>
</tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the window.<br><br><strong>Note:</strong> If the name is not specified, this property returns &quot;view&quot;</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the name of the current window to &quot;myWindowName&quot;:</p>
<div class="w3-code notranslate jsHigh">
 window.name = &quot;myWindowName&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_name2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
