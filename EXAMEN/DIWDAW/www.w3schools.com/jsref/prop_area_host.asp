...
<h3>Example</h3>
<p>Return the hostname and port number of the URL for a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById(&quot;venus&quot;).host;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 www.w3schools.com:80</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_host" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the hostname and port number of the URL for a specific area in an 
image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;venus&quot;).host = &quot;www.example.com:300&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_area_host2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
