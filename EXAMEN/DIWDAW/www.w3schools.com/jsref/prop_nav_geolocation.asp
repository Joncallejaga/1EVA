...
<html lang="en-US">
<head>
<title>Navigator geolocation Property</title>
<meta charset="utf-8">
...
<h1>Navigator <span class="color_h1">geolocation</span> Property</h1>
<p><a href="obj_navigator.asp" class="w3-btn w3-white w3-border" title="Navigator Object Reference">&#10094; Navigator Object</a></p>
...
Latitude: 40.7242737<br>Longitude: -73.9802387</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_geolocation">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The geolocation property returns a <a href="obj_geolocation.asp">Geolocation object</a> that can be used to 
locate the user's position.</p>
<p>Since this can compromise user privacy, the position is not available unless 
the user approves it.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p>For more information about Gelocation, visit our
<a href="../html/html5_geolocation.asp">HTML5 Gelocation Tutorial.</a></p>
<hr>
...
<p><strong>Note:</strong> Geolocation is much more accurate for devices with GPS, like 
a smartphone.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 navigator.geolocation</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A reference to the Geolocation object</td>
</tr>
</table>

<hr>
<a href="obj_navigator.asp" class="w3-btn w3-white w3-border" title="Navigator Object Reference">&#10094; Navigator Object</a>
</div>
