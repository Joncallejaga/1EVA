...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Ol Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_object.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_optgroup.asp">Next &#10095;</a>
</div>
<hr>
...
var x = document.getElementById("myOl");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_create" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>compact</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_lineheight.asp">style.lineHeight</a> instead.</span> <br>Sets or returns whether the list should render smaller than normal, or not</td>
  </tr>
  <tr>
    <td><a href="prop_ol_reversed.asp">reversed</a></td>
    <td>Sets or returns whether the list order should be descending or not</td>
  </tr>
   <tr>
    <td><a href="prop_ol_start.asp">start</a></td>
    <td>Sets or returns the value of the start attribute of an ordered list</td>
  </tr>
 <tr>
    <td><a href="prop_ol_type.asp">type</a></td>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_ol.asp">HTML &lt;ol&gt; tag</a></p>
