...
<html lang="en-US">
<head>
<title>HTML DOM Input Month stepUp() Method</title>
<meta charset="utf-8">
...
<h1>Input Month <span class="color_h1">stepUp()</span> Method</h1>
<p><a href="dom_obj_month.asp" class="w3-btn w3-white w3-border" title="Input Month Object Reference">&#10094; Input Month Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Increment the value of a month field by 3 months:</p>
<div class="w3-code notranslate">
 document.getElementById(&quot;myMonth&quot;).stepUp(3);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_stepup">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stepDown() method increments the value of the month field by a specified 
number.</p>
<p>This method will only have an affect on MONTHS (not years).</p>
<p><strong>Tip:</strong> To decrement the value, use the
<a href="met_month_stepdown.asp">stepDown()</a> method.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the amount of months the month field should  increase.<br><br>If omitted, the months are incremented by &quot;1&quot;</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Increment the value of a month field by 1 (default):</p>
<div class="w3-code notranslate">
 document.getElementById(&quot;myMonth&quot;).stepUp();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_stepup2">Try it Yourself &raquo;</a>
</div>
<hr>
