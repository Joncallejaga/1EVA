...
<html lang="en-US">
<head>
<title>HTML DOM Input Week max Property</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">max</span> Property</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the maximum week and year allowed for a week field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myWeek&quot;).max;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2014-W19</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_max">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The max property sets or returns the value of the max attribute of a week field.</p>
<p>The max attribute specifies the maximum value (week and year) for a week field.</p>
<p><strong>Tip:</strong> The max attribute is often used together with the min attribute 
to create a range of legal values.</p>
<p><strong>Tip:</strong> To set or return the value of the min attribute, use 
the <a href="prop_week_min.asp">min</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.max
</div></div>
<p>Set the max property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.max =<em> YYYY-</em>W<em>WW</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the maximum week and year allowed. Explanation of  components:
  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the maximum week and year allowed</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the maximum week and year allowed:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).max = &quot;2014-W35&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_max2">Try it Yourself &raquo;</a>
</div>
<hr>
