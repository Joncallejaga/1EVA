...
<html lang="en-US">
<head>
<title>HTML DOM console.clear() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.clear()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Clear all messages in the console:</p>
<div class="w3-code notranslate jsHigh">
console.clear();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_clear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.clear() method clears the console.</p>
<p>The console.clear() method will also write a message in the console: &quot;Console 
was cleared&quot;.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.clear()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>48</td>
    <td>Yes</td>
...
<hr>
<p>
<a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>
</div>
