...
<h3>Example</h3>
<p>Get the element that triggered a specific event:</p>
<div class="w3-code notranslate jsHigh">
 alert(event.target);<br></div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The target property gets the element on which the event originally occurred, 
opposed to the <a href="event_currenttarget.asp">currentTarget</a> property, 
which always refers to the element whose event listener triggered the event.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>A reference to the object on which the event originally occured</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the <em>event</em>.target property together with the <em>element</em>.tagName 
property to find out which element triggered a specified event:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.target.tagName;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_event_target">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
