...
<a target="_blank" href="tryit.asp?filename=tryjsref_valueof_date" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The valueOf() method returns the primitive value of a Date object.</p>
<p><b>Note:</b> The primitive value is returned as the number of millisecond since midnight January 1, 1970 UTC.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the number of milliseconds between the date object and midnight January 1, 1970 UTC</td>
</tr>
<tr>
