...
<h3>Example</h3>
<p>Get the total width of your screen:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Total Width: &quot; + screen.width;</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_width">Try it Yourself &raquo;</a>
</div>
...
pixels.</p>
<p><strong>Tip:</strong> Use the <a href="prop_screen_height.asp">height</a> 
property to get the total height of the user's screen.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the total width of the user's screen, in pixels</td>
</tr>
</table>
