...
<html lang="en-US">
<head>
<title>HTML DOM nextElementSibling Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">nextElementSibling</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;item1&quot;).nextElementSibling.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Tea (second li)</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_nextelementsibling" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nextElementSibling property returns the element immediately following the specified 
element, in the same tree level.</p>
<p>The difference between this property and
<a href="prop_node_nextsibling.asp">nextSibling</a>, is that nextSibling returns 
...
<p><strong>Tip: </strong>Use the <a href="prop_element_previouselementsibling.asp">
previousElementSibling</a> property to return the previous element of the 
specified element.</p>
...
<em>node</em>.nextElementSibling</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the next sibling of an element, or <em>null </em>if there is no next sibling</td>
</tr>
<tr>
  <th>DOM Version</th>
