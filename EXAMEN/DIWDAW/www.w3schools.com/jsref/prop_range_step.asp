...
<html lang="en-US">
<head>
<title>HTML DOM Input Range step Property</title>
 <meta charset="utf-8">
...
<h1>Input Range <span class="color_h1">step</span> Property</h1>
<p><a href="dom_obj_range.asp" class="w3-btn w3-white w3-border" title="Input Range Object Reference">&#10094; Input Range Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the step attribute:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myRange&quot;).step = &quot;25&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_range_step2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The step property sets or returns the value of the step attribute of a slider 
control.</p>
<p>The step attribute specifies the size of each movement (an increment or jump 
between values) of the slider control.</p>
<p>The step attribute is used to limit down the amount of allowed values.</p>
<p><strong>Tip:</strong> The step attribute can be used together with the max 
...
<div class="w3-code w3-border notranslate"><div>
 <em>rangeObject</em>.step</div></div>
<p>Set the step property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>rangeObject</em>.step = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the size of each movement (an increment or jump between  values) of the slider control.<br>Default is &quot;1&quot;</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the increment between values</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Display the value of the step attribute of a slider control:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myRange&quot;).step;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">10</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_range_step">Try it Yourself &raquo;</a>
</div>
<hr>
