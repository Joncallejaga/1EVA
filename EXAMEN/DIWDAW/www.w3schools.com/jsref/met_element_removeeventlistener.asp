...
<h3>Example</h3>
 <p>Remove a &quot;mousemove&quot; event that has been attached with the addEventListener() method:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_element_addeventlistener_remove" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeEventListener() method removes an event handler that has been 
attached with the <a href="met_element_addeventlistener.asp">addEventListener()</a> 
method.</p>
...
above (myFunction).</p>
<p>Anonymous functions, like &quot;<em>element</em>.removeEventListener(&quot;<em>event</em>&quot;, 
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.removeEventListener(<em>event</em>, <em>function</em>, <em>useCapture</em>)
</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:18%;">Changelog:</th>
  <td>The useCapture parameter became optional in Firefox 6 and Opera 12.0 (has always been optional for Chrome, IE and Safari)</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br>if (x.removeEventListener) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// For all major browsers, except IE 8 and earlier<br>&nbsp;&nbsp;&nbsp; x.removeEventListener(&quot;mousemove&quot;, myFunction);<br>} else if (x.detachEvent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For IE 8 and earlier versions<br>&nbsp;&nbsp;&nbsp; x.detachEvent(&quot;onmousemove&quot;, myFunction);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_removeeventlistener_crossbrowser">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_eventlistener.asp">HTML DOM EventListener</a></p>
<p>JavaScript Reference: <a href="met_document_removeeventlistener.asp">document.removeEventListener()</a></p>
<hr>
