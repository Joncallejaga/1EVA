...
<html lang="en-US">
<head>
<title>HTML DOM Input Text defaultValue Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">defaultValue</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_defaultvalue2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="prop_text_value.asp">value</a> 
attribute.</p>
<p>The difference between the defaultValue and <a href="prop_text_value.asp">value</a> 
...
contents of a text field have been changed.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>textObject</em>.defaultValue = <i>value
 </i></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the default value of the text field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the default value of a text field:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_defaultvalue">Try it Yourself &raquo;</a>
</div>
<br>
