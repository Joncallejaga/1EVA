...
<h1><span class="color_h1">touchend</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the user releases the touch (for touch screens only):</p>
<div class="w3-code notranslate htmlHigh">
&lt;p ontouchend=&quot;myFunction(event)"&gt;Touch me!&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchend" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The touchend event occurs when the user removes the finger from an element.</p>
<p><strong>Note:</strong> The touchend event will only work on devices with a touch screen.</p>
<p><strong>Tip:</strong> Other events related to the touchend event are:</p>
<ul>
  <li><a href="event_touchstart.asp">touchstart</a> - occurs when the user touches an element</li>
...
<em>object</em>.ontouchend = <i>myScript</i>;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchend_javascript" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;touchend&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchend_eventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
