...
<h1>JavaScript String <span class="color_h1">endsWith()</span> Method</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="jsref_concat_string.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="jsref_obj_string.asp"><span class="w3-hide-small">JavaScript String </span>Reference</a>
<a class="w3-right w3-btn" href="jsref_fromcharcode.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_endswith" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">endsWith()</code> method determines whether a string ends with the 
characters of a specified string.</p>
<p>This method returns <code class="w3-codespan">true</code> if the string ends with the characters, and <code class="w3-codespan">false</code> if not.</p>
<p><b>Note:</b> The <code class="w3-codespan">endsWith()</code> method is case sensitive.</p>
<hr>
...
<i>string</i>.endsWith(<em>searchvalue</em>,<em> length</em>)</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:25%">Return Value:</th>
  <td>A Boolean. Returns <code class="w3-codespan">true</code> if the string ends with the value, otherwise it returns <code class="w3-codespan">false</code></td>
  </tr>
  <tr>
...
<div class="w3-example">
<p>Check if a string ends with "world", assuming the string is 11 characters 
long:</p>
 <div class="w3-code notranslate jsHigh">
var str = &quot;Hello world, welcome to the universe.&quot;;<br>
...
true
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_endswith2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="jsref_concat_string.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
