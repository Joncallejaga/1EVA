...
<html lang="en-US">
<head>
<title>HTML DOM Input Time readOnly Property</title>
 <meta charset="utf-8">
...
<h1>Input Time <span class="color_h1">readOnly</span> Property</h1>
...
<h3>Example</h3>
<p>Set a time field to read-only:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTime&quot;).readOnly = true;</div>
<!--<p>The result will be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="time" readonly>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_readonly">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The readOnly property sets or returns whether a input field should be 
read-only, or not.</p>
...
use the <a href="prop_input_time_disabled.asp">disabled</a> property instead.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.readOnly</div></div>
<p>Set the readOnly property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.readOnly = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a time field should be  read-only, or not
  <ul>
      <li>true - The time field is read-only</li>
      <li>false - Default. The time field is not read-only</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the time field is read-only, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a time field is read-only or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTime&quot;).readOnly;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_readonly2">Try it Yourself &raquo;</a>
</div>
<hr>
