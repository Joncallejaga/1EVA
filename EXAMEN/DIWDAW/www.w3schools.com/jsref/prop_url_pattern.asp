...
<html lang="en-US">
<head>
<title>HTML DOM Input URL pattern Property</title>
 <meta charset="utf-8">
...
<h1>Input URL <span class="color_h1">pattern</span> Property</h1>
<p><a href="dom_obj_url.asp" class="w3-btn w3-white w3-border" title="Input URL Object Reference">&#10094; Input URL Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the value of the pattern attribute of a URL field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myURL&quot;).pattern;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">https?://.+</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_url_pattern">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pattern property sets or returns the value of the pattern attribute of a 
URL field.</p>
<p>The pattern attribute specifies a regular expression that the URL field's 
value is checked against.</p>
<p><strong>Tip:</strong> Use the global HTML 
<a href="../tags/att_global_title.asp">title</a> attribute or the DOM <a href="prop_html_title.asp">title</a> 
property to describe the pattern to help the user.</p>
<p><b>Tip:</b> Learn more about <a href="../js/js_regexp.asp">Regular Expressions</a> in our JavaScript 
Tutorial.</p>
<p><strong>Tip:</strong> Also see our <a href="jsref_obj_regexp.asp">Complete 
...
<hr>
<h2>Syntax</h2>
<p>Return the pattern property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.pattern</div></div>
<p>Set the pattern property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.pattern = <em>regexp</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>regexp</em></td>
    <td>
  Specifies a regular expression that the URL field's value is checked  against</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a regular expression</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the pattern of a URL field to only accept URL's that start with 
http(s)://www.facebook.com/:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myURL&quot;).pattern = &quot;http://www\.facebook\.com\/(.+)|https://www\.facebook\.com\/(.+)&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_url_pattern2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_pattern.asp">HTML &lt;input&gt; pattern Attribute</a></p>
<hr>
