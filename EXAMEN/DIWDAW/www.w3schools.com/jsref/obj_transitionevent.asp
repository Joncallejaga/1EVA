...
<!DOCTYPE html>
<html lang="en-US">
<head><title>The TransistionEvent</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">TransitionEvent</span></h1>
<p>
...
<hr>
<h2>The TransitionEvent Object</h2>
<p>Events that occur when a CSS transition runs, belongs to the TransitionEvent Object.</p>
<hr>
<h2>TransitionEvent Properties and Methods</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="event_transition_propertyname.asp">propertyName</td>
    <td>Returns the name of the transition</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>pseudoElement</td>
    <td>Returns the name of the pseudo-element of the transition</td>
  </tr>
  </table>
<hr>

<h2>Inherited Properties and Methods</h2>
<p>The TransitionEvent inherits all the properties and methods from:</p>
<p><a href="obj_event.asp">The Event Object</a></p>
<hr>

<h2>Event Types</h2>
<p>These event types belongs to the TransitionEvent Object: </p>
