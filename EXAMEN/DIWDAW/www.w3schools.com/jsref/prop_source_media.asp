...
<html lang="en-US">
<head>
<title>HTML DOM Source media Property</title>
 <meta charset="utf-8">
...
<h1>Source <span class="color_h1">media</span> Property</h1>
<p><a href="dom_obj_source.asp" class="w3-btn w3-white w3-border" title="Source Object Reference">&#10094; Source Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return what media/device a specific file is optimized for:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("mySource").media;
</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 screen and (min-width:320px)</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_source_media" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The media property sets or returns the value of the media attribute in 
a &lt;source&gt; element.</p>
<p>The media attribute specifies the type of media resource (what media/device 
the file is optimized for). </p>
<p>The browser can use the media attribute to determine whether it can play the 
file or not. If it cannot, it can choose not to download it.</p>
<p><strong>Note:</strong> The &lt;source&gt; element 
is new in HTML5.</p>
<hr>
...
<p><strong>Note:</strong> The HTML <strong>media attribute however, is NOT</strong> supported in any of 
...
<div class="w3-code w3-border notranslate"><div>
 <em>sourceObject</em>.media</div></div>
<p>Set the media property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>sourceObject</em>.media =<i> value</i></div></div>
<p><strong>Note:</strong> This property can accept several values.</p>
...
<table class="w3-table-all">
  <tr>
 <th style="width:22%">Return Value:</th>
  <td>A String, representing the indented type of the media resource</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_source_media.asp">HTML &lt;source&gt; media attribute</a></p>
<hr>

<a href="dom_obj_source.asp" class="w3-btn w3-white w3-border" title="Source Object Reference">&#10094; Source Object</a>
</div>
