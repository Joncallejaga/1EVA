...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_animationfillmode">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default value. The animation will not apply any styles to the target before or after it is executing</td>
  </tr>
  <tr>
    <td>forwards</td>
    <td>After the animation ends (determined by animation-iteration-count), the animation will apply the property values for the time the animation ended</td>
  </tr>
  <tr>
    <td>backwards</td>
    <td>The animation will apply the property values defined in the keyframe that will start the first iteration of the animation, during the period defined by animation-delay. These are either the values of the from keyframe (when animation-direction is &quot;normal&quot; or &quot;alternate&quot;) or those of the to keyframe (when animationDirection is &quot;reverse&quot; or &quot;alternate-reverse&quot;)</td>
  </tr>
  <tr>
    <td>both</td>
    <td>The animation will follow the rules for both forwards and backwards. That is, it will extend the animation properties in both directions </td>
  </tr>
    <tr>
    <td>initial</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_animation-fill-mode.asp">animation-fill-mode property</a></p>
<hr>
