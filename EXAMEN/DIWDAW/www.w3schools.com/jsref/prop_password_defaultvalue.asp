...
<html lang="en-US">
<head>
<title>HTML DOM Input Password defaultValue Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">defaultValue</span> Property</h1>
<p><a href="dom_obj_password.asp" class="w3-btn w3-white w3-border" title="Input Password Object Reference">&#10094; Input Password Object</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_defaultvalue2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="prop_password_value.asp">value</a> 
attribute.</p>
<p>The difference between the defaultValue and <a href="prop_password_value.asp">value</a> 
property, is that defaultValue contains 
the default/initial password of the password field, while value is the current 
password of 
the password field after some changes have been made. If there are no changes, 
...
contents of a password field have been changed.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>passwordObject</em>.defaultValue = <i>value
 </i></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the default value of the password field</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_defaultvalue">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myPsw&quot;);<br>var defaultVal = x.defaultValue;<br>var currentVal = x.value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_defaultvalue3">Try it Yourself &raquo;</a>
</div>
<hr>
