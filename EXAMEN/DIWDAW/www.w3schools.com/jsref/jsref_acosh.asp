...
<html lang="en-US">
<head>
<title>JavaScript acosh() Method</title>
<meta charset="utf-8">
...
<a target="_blank" href="tryit.asp?filename=tryjsref_acosh" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The acosh() method returns the hyperbolic arccosine of a number.</p>
<p><b>Note:</b> If the parameter x is less than 1, the method will return NaN.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, or NaN if the parameter is less than 1</td>
</tr>
<tr>
