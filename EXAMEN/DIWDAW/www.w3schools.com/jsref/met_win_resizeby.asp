...
<div class="w3-code notranslate jsHigh">
 function openWin() {<br>&nbsp;&nbsp;&nbsp; myWindow = window.open(&quot;&quot;, &quot;&quot;, &quot;width=100, height=100&quot;);&nbsp; // Opens a new window<br>}<br><br>function resizeWin() {<br>&nbsp;&nbsp;&nbsp; myWindow.resizeBy(250, 250);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Resizes the new window<br>
 &nbsp;&nbsp;&nbsp;
 myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Sets focus to the new window<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_resizeby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The resizeBy() method resizes a window by the specified amount, relative to its current size.</p>
...
<ul>
  <li><a href="met_win_resizeto.asp">resizeTo()</a> - Resizes the window to the specified width and height</li>
  <li><a href="met_win_moveby.asp">moveBy()</a> - Moves a window relative to its current position</li>
  <li><a href="met_win_moveto.asp">moveTo()</a> - Moves a window to the specified position</li>
</ul>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>height</em></td>
    <td>Number</td>
    <td>Required. A positive or a negative number that specifies how many pixels to resize the height by</td>
  </tr>
</table>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_win_resizeby2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Using the resizeBy() method together with resizeTo():</p>
 <div class="w3-code notranslate jsHigh">
  function resizeWinTo() {<br>&nbsp;&nbsp;&nbsp; myWindow.resizeTo(800, 600);<br>
  &nbsp;&nbsp;&nbsp;
  myWindow.focus();<br>}<br><br>function resizeWinBy() {<br>
  &nbsp;&nbsp;&nbsp;
  myWindow.resizeBy(-100, -50);<br>&nbsp;&nbsp;&nbsp; myWindow.focus();<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_resizeby_resizeto" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Resize the topmost browser window with 100px each way (works only in IE and 
Safari):</p>
 <div class="w3-code notranslate jsHigh">
  top.resizeBy(100, 100);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_resizeby4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
