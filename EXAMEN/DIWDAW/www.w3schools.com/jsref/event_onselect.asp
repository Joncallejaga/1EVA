...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onselect">Try it Yourself &raquo;</a>
</div>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onselect=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onselect_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onselect = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onselect_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;select&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onselect_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate jsHigh">
 // Select the contents of a text field<br>function mySelectFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myText&quot;).select();<br>}<br><br>// Alert some text when the text in the text field has been selected<br>function myAlertFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;You selected some text!&quot;);<br>
 }<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onselect2">Try it Yourself &raquo;</a>
</div>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object">&#10094; Event Object</a>
