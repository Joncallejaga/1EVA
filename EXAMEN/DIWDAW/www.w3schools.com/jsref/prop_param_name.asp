...
<html lang="en-US">
<head>
<title>HTML DOM Parameter name Property</title>
 <meta charset="utf-8">
...
<h1>Parameter <span class="color_h1">name</span> Property</h1>
<p><a href="dom_obj_param.asp" class="w3-btn w3-white w3-border" title="Parameter Object Reference">&#10094; Parameter Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the name of a &lt;param&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myParam&quot;).name</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">autoplay</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_param_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
parameters for the plugin specified with the &lt;object&gt; tag.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>parameterObject</em>.name
</div></div>
<p>Set the name property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>parameterObject</em>.name = <em>name</em>
 </div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the parameter</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_param_name.asp">HTML &lt;param&gt; name attribute</a></p>
<hr>
