...
<h1>Ol <span class="color_h1">reversed</span> Property</h1>
<p><a href="dom_obj_ol.asp" class="w3-btn w3-white w3-border" title="Ol Object Reference">&#10094; Ol Object</a>
</p>
<div class="w3-example">
<h3>Example</h3>
<p>Set the list order to descending:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myOl&quot;).reversed = true;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_reversed">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The reversed property sets or returns whether the list order should be 
descending or not.</p>
<p>When set to true, the list order will be descending (9, 8, 7...), instead of 
ascending (1, 2 , 3...).</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the reversed property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>olObject</em>.reversed</div></div>
<p>Set the reversed property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>olObject</em>.reversed = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
   <li style="height: 16px">true - The list order is descending</li>
      <li>false - Default. The list order is not descending (it is   ascending)</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the list order is descending, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the list order is descending or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOl&quot;).reversed;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">false</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_reversed2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_ol_reversed.asp">HTML &lt;ol&gt; reversed attribute</a></p>
<hr>
