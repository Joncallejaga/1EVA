...
<html lang="en-US">
<head>
<title>HTML DOM Input Email size Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">size</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the width of an email field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).size = &quot;50&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The size property sets or returns the value of the size attribute of an email field.</p>
<p>The size attribute specifies the width of an email field (in number of characters).</p>
<p>The default value is 20.</p>
<p><strong>Tip:</strong> To set or return the maximum number of characters 
allowed in the password field, use the <a href="prop_email_maxlength.asp">maxLength</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.size</div></div>
<p>Set the size property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.size = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the width of the email field, in number of characters. Default value is  20</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of the email field, in number of characters</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Display the width of an email field (in number of characters):</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).size;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">30</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_size2">Try it Yourself &raquo;</a>
</div>
<hr>
