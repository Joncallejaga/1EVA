...
<html lang="en-US">
<head>
<title>HTML DOM Input Password select() Method</title>
<meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">select()</span> Method</h1>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_password_select" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The select() method is used to select the content of a password field.</p>
<hr>
