...
<a target="_blank" href="tryit.asp?filename=tryjsref_getmonth" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getMonth() method returns the month (from 0 to 11) for the specified date, according to local time.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_date_getmonth" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
