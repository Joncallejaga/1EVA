...
<html lang="en-US">
<head>
<title>HTML DOM console.count() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.count()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Write to the console the number of time the console.count() is called inside 
the loop:</p>
<div class="w3-code notranslate jsHigh">
  for (i = 0; i &lt; 10; i++) {<br>&nbsp; console.count();<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_count" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>Writes to the console the number of times that particular console.count() is 
called.</p>
<p>You can add a label that will be included in the console view.</p>
<p>See more examples in the bottom of this page.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.count()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>30</td>
    <td>Yes</td>
...
<td><em>label</em></td>
<td>String</td>
<td>Optional. If present,&nbsp; the method counts the number of times 
console.count() has been called with this <em>label</em>.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Call console.count() two times and see the result:</p>
<div class="w3-code notranslate jsHigh">
console.count();<br>console.count();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_count2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Call console.log two times, with a label, and see the result:</p>
<div class="w3-code notranslate jsHigh">
console.count(&quot;myLabel&quot;);<br>console.count(&quot;myLabel&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_count3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
