...
<html lang="en-US">
<head>
<title>HTML DOM lastElementChild Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">lastElementChild</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the HTML content of the last child element of an &lt;ul&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myList&quot;).lastElementChild.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Tea</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_lastelementchild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The lastElementChild property returns the last child element of the specified 
element.</p>
<p>The difference between this property and
<a href="prop_node_lastchild.asp">lastChild</a>, is that lastChild returns 
...
<p><strong>Tip: </strong>Use the <a href="prop_element_children.asp">children</a> 
property to return any child element of a specified element.</p>
<p><strong>Tip:</strong> To return the first child element of a specified element, use 
the <a href="prop_element_firstelementchild.asp">firstElementChild</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.lastElementChild</div></div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the last child element of an element, or <em>null </em>if there are no child elements</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 3 Element Traversal</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the tag name of the last child element of a &lt;div&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
 var x = document.getElementById(<span style="color:mediumblue;">&quot;myDIV&quot;</span>).lastElementChild.tagName;<br>document.getElementById(&quot;demo&quot;).innerHTML = x;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 SPAN</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_lastelementchild2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the last child element of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).lastElementChild.text;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Volvo</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_lastelementchild3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
