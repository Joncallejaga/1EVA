...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjsref_style_orphans.htm">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.style.orphans<i> = &quot;number</i>|initial|inherit&quot;
</div></div>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the minimum number of lines to print at the bottom of the page</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
