...
<h1>Video <span class="color_h1">muted</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Turn off sound for a video:</p>
<div class="w3-code notranslate jsHigh">
  
    document.getElementById(&quot;myVideo&quot;).muted = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_muted" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The muted property sets or returns whether the audio output of the video 
should be muted (sound turned off).</p>
<p>This property reflects the &lt;video&gt; muted attribute.</p>
<p>When present, it specifies that the audio output of the video should be 
muted.</p>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>videoObject</em>.muted</div></div>
<p>Set the muted property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.muted = true|false
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether the audio output of the video should be muted, or not<ul>
  <li>true - Indicates that the sound should should be turned OFF for the video</li>
  <li>false - Default. Indicates that the sound should be turned ON for the video</li>
</ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio output of the video is muted, otherwise it returns false</td>
  </tr>
  <tr>
  <th>Default Value:</th>
  <td>false</td>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).muted;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_muted2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_muted.asp">HTML &lt;video&gt; muted attribute</a></p>
<hr>
