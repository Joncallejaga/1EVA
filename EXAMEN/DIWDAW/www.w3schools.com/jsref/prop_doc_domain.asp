...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_domain">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the domain name of the server that loaded the current document, or null if the domain of the document cannot be identified</td>
</tr>
<tr>
  <th>DOM Version</th>
