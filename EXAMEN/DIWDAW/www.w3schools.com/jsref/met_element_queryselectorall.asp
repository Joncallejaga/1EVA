...
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of the first element with class=&quot;example&quot; inside of 
a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all elements inside div with class=&quot;example&quot;<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;.example&quot;);&nbsp; <br><br>
 // Set the background color of the first element with class=&quot;example&quot; (index 0) in div<br>
 x[0].style.backgroundColor = &quot;red&quot;;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_class">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The querySelectorAll() method returns a collection of an element's child 
elements that match a specified CSS selector(s), as a static NodeList object.</p>
<p>The NodeList object represents a collection of nodes. The nodes can be 
accessed by index numbers. The index starts at 0.</p>
<p><strong>Tip: </strong>You can use the <a href="prop_nodelist_length.asp">length</a> property of the NodeList object to determine the number of 
child nodes that matches the specified selector, then you can loop through all nodes and extract the info you want.</p>
<p>For more information about CSS Selectors, visit our
<a href="../css/css_syntax.asp">CSS Selectors Tutorial</a> and our
<a href="../cssref/css_selectors.asp">CSS Selectors Reference</a>.</p>
<hr/>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.querySelectorAll(<em>CSS selectors</em>)</div></div>
...
<a href="../cssref/css_selectors.asp">CSS Selectors Reference</a>.</td>
</tr>
</table>
<hr>
...
<tr>
  <th>Return Value:</th>
  <td>A NodeList object, representing all descendant elements of the current element that matches a specified CSS selector(s). The NodeList is a static collection, meaning that changes in the DOM has NO effect in the collection. <br><br><strong>Note:</strong> Throws a SYNTAX_ERR exception if the specified selector(s) is invalid</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get all &lt;p&gt; elements inside a &lt;div&gt; element, and set the background color of the 
first &lt;p&gt; element (index 0):</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all p elements inside div<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;p&quot;);&nbsp; <br><br>
 // Set the background color of the first &lt;p&gt; element (index 0) in div<br>
 x[0].style.backgroundColor = &quot;red&quot;;&nbsp;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_p">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get all &lt;p&gt; elements in a &lt;div&gt; with class=&quot;example&quot;, and set the background of the 
first &lt;p&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all p elements with class=&quot;example&quot; inside div<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;p.example&quot;);&nbsp; <br><br>
 // Set the background color of the first &lt;p&gt; element with class=&quot;example&quot; (index 0) in div<br>
 x[0].style.backgroundColor = &quot;red&quot;;&nbsp;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_p_class">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many elements with class=&quot;example&quot; there are in a 
&lt;div&gt; element (using the length 
property of the NodeList object):</p>
<div class="w3-code notranslate jsHigh">
 /* Get the element with id=&quot;myDIV&quot; (a div), then get all p elements with class=&quot;example&quot; inside div, and return the number of elements found */<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;.example&quot;).length;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_length">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all elements with class=&quot;example&quot; in a &lt;div&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all elements with class=&quot;example&quot; inside div<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;.example&quot;);<br>
 <br>// Create a for loop and set the background color of all elements with class=&quot;example&quot; in div<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_loop">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all &lt;p&gt; elements in a &lt;div&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all p elements inside div<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;p&quot;);<br>
 <br>// Create a for loop and set the background color of all p elements in div<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_loop_p">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the border style of all &lt;a&gt; elements in a &lt;div&gt; element that have a &quot;target&quot; 
attribute:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all &lt;a&gt; elements with a &quot;target&quot; attribute inside div<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;a[target]&quot;);<br>
 <br>// Create a for loop and set the border of all &lt;a&gt; elements with a target attribute in div<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.border = &quot;10px solid red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_queryselectorall_loop_target">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all &lt;h2&gt;, &lt;div&gt; and &lt;span&gt; elements in 
a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 // Get the element with id=&quot;myDIV&quot; (a div), then get all &lt;h2&gt;, &lt;div&gt; and &lt;span&gt; elements inside &lt;div&gt;<br>var x = document.getElementById(&quot;myDIV&quot;).querySelectorAll(&quot;h2, div, span&quot;);<br>
 <br>// Create a for loop and set the background color of all &lt;h2&gt;, &lt;div&gt; and &lt;span&gt; elements in &lt;div&gt;<br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_queryselectorall_multiple">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css_syntax.asp">CSS Selectors</a></p>
<p>CSS Reference: <a href="../cssref/css_selectors.asp">CSS Selectors Reference</a></p>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_nodelist.asp">JavaScript HTML DOM Node List</a></p>
<p>HTML DOM Reference: <a href="met_element_queryselector.asp"><em>element</em>.querySelector()</a></p>
