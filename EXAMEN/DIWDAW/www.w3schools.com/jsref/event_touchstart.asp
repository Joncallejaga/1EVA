...
<h1><span class="color_h1">touchstart</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the user touches a P element (for touch screens only):</p>
<div class="w3-code notranslate htmlHigh">
&lt;p ontouchstart=&quot;myFunction(event)"&gt;Touch me!&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchstart" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The touchstart event occurs when the user touches an element.</p>
<p><strong>Note:</strong> The touchstart event will only work on devices with a touch screen.</p>
...
<ul>
  ...
  <li><a href="event_touchmove.asp">touchmove</a> - occurs when the user moves the finger across the screen</li>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> ontouchstart=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchstart" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<em>object</em>.ontouchstart = <i>myScript</i>;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchstart_javascript" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;touchstart&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_touchstart_eventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
