...
<html lang="en-US">
<head>
<title>HTML DOM Legend form Property</title>
 <meta charset="utf-8">
...
<h1>Legend <span class="color_h1">form</span> Property</h1>
<p><a href="dom_obj_label.asp" class="w3-btn w3-white w3-border" title="Label Object Reference">&#10094; Label Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the id of the form containing the &lt;legend&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLegend&quot;).form.id;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">myForm</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_legend_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The form property returns a reference to the form that contains the legend.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>legendObject</em>.form
</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A reference to the form element containing the legend. If the legend is not in a form, null is returned</td>
  </tr>
</table>
