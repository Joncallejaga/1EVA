...
<html lang="en-US">
<head>
<title>HTML DOM Audio pause() Method</title>
<meta charset="utf-8">
...
<h1>Audio <span class="color_h1">pause()</span> Method</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>An audio player with play and pause buttons:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;); <br><br>function playAudio() { <br>&nbsp;&nbsp;&nbsp; x.play(); <br>} <br><br>function pauseAudio() {
 <br>&nbsp;&nbsp;&nbsp; x.pause(); <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_pause" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pause() method halts (pauses) the currently playing audio.</p>
<p><strong>Tip:</strong> This method is often used together with the 
<a href="met_audio_play.asp">play()</a> 
method.</p>
<p><strong>Tip:</strong> Use the <a href="prop_audio_controls.asp">controls</a> property to display audio controls 
(like play, pause, seeking, volume, etc, attached on the audio).</p>
<hr>
