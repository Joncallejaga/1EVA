...
<html lang="en-US">
<head>
<title>HTML DOM Button formMethod Property</title>
 <meta charset="utf-8">
...
<h1>Button <span class="color_h1">formMethod</span> Property</h1>
<p><a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Button Object Reference">&#10094; Button Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Return which HTTP method to use when sending the form-data:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).formMethod;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">post</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_pushbutton_formmethod">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The formMethod property sets or returns the value of the formmethod attribute 
of a button.</p>
<p>The formmethod attribute specifies which HTTP method to use when sending the 
form-data. This attribute overrides the form's method attribute.</p>
...
<p><strong>Note:</strong> The formmethod attribute is new for the &lt;button&gt; 
element in HTML5.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the formMethod property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formMethod
</div></div>
<p>Set the formMethod property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>buttonObject</em>.formMethod = get|post</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the HTTP method that is used to submit the form to the server</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById("myBtn").formMethod = &quot;post&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formmethod2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example on returning the formMethod property:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myBtn").formMethod;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_pushbutton_formmethod3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_button_formmethod.asp">HTML &lt;button&gt; formmethod attribute</a></p>
<hr>
