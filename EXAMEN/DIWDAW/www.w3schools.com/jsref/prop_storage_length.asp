...
<html lang="en-US">
<head>
<title>Storage length Property</title>
<meta charset="utf-8">
...
<h1>Storage <span class="color_h1">length</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the number of local storage item for this domain:</p>
<div class="w3-code notranslate jsHigh">
  var x = localStorage.length;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of items stored in the browsers 
Storage Object, for this particular domain..</p>
<p>The length property belongs to the Storage Object, which can be either a <a href="prop_win_localstorage.asp">localStorage</a> object or a
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A Integer, representing the number of stored items</td>
  </tr>
  </table>
...
<p>Get the number of session storage item for this domain:</p>
<div class="w3-code notranslate jsHigh">
  var x = sessionStorage.length;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_length_session" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
