...
<a target="_blank" href="tryit.asp?filename=tryjsref_form_reset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The reset() method resets the values of all elements in a form (same as clicking the Reset button).</p>
<p><strong>Tip:</strong> Use the <a href="met_form_submit.asp">submit()</a> method to submit the form.</p>
<hr>
