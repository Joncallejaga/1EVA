...
<a target="_blank" href="tryit.asp?filename=tryjsref_round" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> 2.49 will be rounded down (2), and 2.5 will be rounded up 
(3).</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A number, representing the nearest integer</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_round2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
