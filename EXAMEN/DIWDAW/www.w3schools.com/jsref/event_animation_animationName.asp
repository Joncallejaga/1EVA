...
<html lang="en-US">
<head>
<title>AnimationEvent animationName Property</title>
<meta charset="utf-8">
...
<h1>AnimationEvent <span class="color_h1">animationName</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the animation name associated with an animation:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br>x.addEventListener(&quot;animationstart&quot;, myStartFunction);<br><br>function myStartFunction(event) {<br>&nbsp;&nbsp;&nbsp; this.innerHTML = &quot;Animation-name is: &quot; + event.animationName;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_animation_animationname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The animationName property returns the name of the animation, when an 
animation event occurs.</p>
<p>The name of the animation is the value of the <a href="../cssref/css3_pr_animation-name.asp">animation-name</a> 
CSS property.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.animationName</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the animation</td>
</tr>
</table>
...
<p>HTML DOM reference: <a href="event_animation_elapsedtime.asp">AnimationEvent elapsedTime Property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_animation.asp">CSS3 animation Property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_animation-name.asp">CSS3 animation-name Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_animationevent.asp" class="w3-btn w3-white w3-border" title="AnimatioEvent">&#10094; AnimationEvent</a>
