...
<html lang="en-US">
<head>
<title>HTML DOM Dialog show() Method</title>
<meta charset="utf-8">
...
<h1>Dialog <span class="color_h1">show()</span> Method</h1>
<p><a href="dom_obj_dialog.asp" class="w3-btn w3-white w3-border" title="Dialog Object Reference">&#10094; Dialog Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Show and close a dialog window:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDialog&quot;); <br><br>function showDialog() { <br>&nbsp;&nbsp;&nbsp; x.show(); <br>} <br><br>function closeDialog() {
 <br>&nbsp;&nbsp;&nbsp; x.close(); <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_dialog_show_close" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The show() method shows the dialog.</p>
<p>When this method is used to show a dialog window, the user is still able to 
interact with other elements on the page. If you do not want the user to 
interact with things other than the dialog, use the showModal() method.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="met_dialog_close.asp">close()</a> method.</p>
<hr>
