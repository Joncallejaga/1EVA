...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_screenleft">Try it Yourself &raquo;</a>
</div>
...
<p><b>Note:</b> For Firefox, use &quot;<a href="prop_win_screenx.asp">window.screenX</a>&quot; and &quot;<a href="prop_win_screenx.asp">window.screenY</a>&quot; 
(See &quot;More Examples&quot; for a cross-browser solution).</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the horizontal and vertical distance of the window relative to the screen, in pixels</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Cross browser solution (using screenX and screenY for IE8 and earlier):</p>
<div class="w3-code notranslate jsHigh">
