...
<html lang="en-US">
<head>
<title>createEvent() Event Method</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">createEvent()</span> Event Method</h1>
<p>
...
<h3>Example</h3>
<p>Simulate a mouseover event:</p>
<div class="w3-code notranslate jsHigh">
  var x = document.createEvent(&quot;MouseEvent&quot;);<br>x.initMouseEvent(&quot;mouseover&quot;, 
  true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);<br>
  <br>document.getElementById(&quot;myDiv&quot;).dispatchEvent(x);<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_createevent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">createEvent()</code> method creates an event 
object.</p>
<p>The event can be of any legal event type, and must be initialized before use.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
  document.createEvent(<em>type</em>)</div></div>
...
<tr>
<td><em>type</em></td>
<td>Required. A String that specifies the type of the event.<br><br>Possible 
values:<br><br>AnimationEvent<br>ClipboardEvent<br>DragEvent<br>FocusEvent<br>
HashChangeEvent<br>InputEvent<br>KeyboardEvent<br>MouseEvent<br>
PageTransitionEvent<br>PopStateEvent<br>ProgressEvent<br>StorageEvent<br>
TouchEvent<br>TransitionEvent<br>UiEvent<br>WheelEvent<br></td>
</tr>
</table>
