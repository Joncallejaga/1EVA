...
<html lang="en-US">
<head>
<title>HTML DOM Input Password placeholder Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">placeholder </span> Property</h1>
<p><a href="dom_obj_password.asp" class="w3-btn w3-white w3-border" title="Input Password Object Reference">&#10094; Input Password Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the placeholder text of a password field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myPassword&quot;).placeholder = &quot;Type your password&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_placeholder">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The placeholder property sets or returns the value of the placeholder attribute of a 
password field.</p>
<p>The placeholder attribute specifies a short hint that describes the expected 
value of a password field (e.g. a sample value or a short description of the 
expected format).</p>
<p>The short hint is displayed in the password field before the user enters a 
value.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the placeholder property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>passwordObject</em>.placeholder</div></div>
<p>Set the placeholder property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>passwordObject</em>.placeholder = <em>text</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a short hint (one word or a short phrase) that describes the  expected value of the password field</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a short hint that describes the expected value of the password field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the placeholder text of a password field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myPassword&quot;).placeholder;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Your password</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_placeholder2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_placeholder.asp">HTML &lt;input&gt; placeholder attribute</a></p>
<hr>

<a href="dom_obj_password.asp" class="w3-btn w3-white w3-border" title="Input Password Object Reference">&#10094; Input Password Object</a>
</div>
