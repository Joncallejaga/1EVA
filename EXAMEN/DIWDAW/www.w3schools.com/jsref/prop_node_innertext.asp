...
<h1>HTML DOM <span class="color_h1">innerText</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the inner text of an element:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;myBtn&quot;).innerText;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_innertext" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The innerText property sets or returns the text content of the specified node,
<strong>and all its descendants</strong>.</p>
<p>If you <em>set</em> the innerText property, any child nodes are removed and 
replaced by a single Text node containing the specified string.</p>

<p><strong>Note:</strong> This property is similar to the <a href="prop_node_textcontent.asp">textContent</a> property,
...
<em>node</em>.innerText</div></div>
<p>Set the text content of a node:</p>
<div class="w3-code w3-border notranslate"><div>
<em>node</em>.innerText = <em>text</em></div></div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the &quot;rendered&quot; text content of a node and all its descendants</td>
</tr>
</table>
<hr>
