...
<h3>Example</h3>
<p>The constructor property returns a regular expression's constructor function:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_regexp_constructor" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>For JavaScript <strong>regular expressions</strong> the constructor property 
returns <strong>function RegExp() { [native code] }</strong></p>
