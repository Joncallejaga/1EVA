...
<html lang="en-US">
<head>
<title>HTML DOM Input Reset value Property</title>
 <meta charset="utf-8">
...
<h1>Input Reset <span class="color_h1">value</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_value2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text displayed on the reset button</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the text displayed on a Reset button:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myReset&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Reset form</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_value">Try it Yourself &raquo;</a>
</div>
<hr>
