...
<html lang="en-US">
<head>
<title>HTML DOM Input Radio form Property</title>
 <meta charset="utf-8">
...
<h1>Input Radio <span class="color_h1">form</span> Property</h1>
<p><a href="dom_obj_radio.asp" class="w3-btn w3-white w3-border" title="Input Radio Object Reference">&#10094; Input Radio Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the id of the form containing the &lt;input type="radio"&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_radio_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form that contains the radio button.</p>
