...
<h1>WheelEvent <span class="color_h1">deltaY</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return whether the user scrolls up or down:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var y = event.deltaY;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_wheel_deltay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">deltaY</code> property returns a positive value 
when scrolling down, and a negative value when scrolling up, otherwise 0.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deltaY</td>
    <td>31</td>
    <td>yes</td>
    <td>17</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A 
  Double, indicating the scrolling direction of the mouse wheel</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Scroll inside a DIV to make it bigger/smaller:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var y = event.deltaY;<br>&nbsp; var 
  currentSize = event.target.style.width;<br>&nbsp; if (y &gt; 0) {<br>&nbsp;&nbsp;&nbsp; 
  newSize = parseInt(currentSize) + 10;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  newSize = parseInt(currentSize) - 10;<br>&nbsp; }<br>&nbsp; 
  event.target.style.width = newSize + &quot;px&quot;;<br>&nbsp; event.target.style.height 
  = newSize + &quot;px&quot;;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_wheel_deltay2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
