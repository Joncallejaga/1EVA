...
<h3>Example</h3>
<p>Get the available height of your screen:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Available Height: &quot; + screen.availHeight;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
<script>
document.write("Available Height: " + screen.availHeight);
</script></div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_availheight">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> To get the width of the screen (excluding the Windows 
Taskbar), use the <a href="prop_screen_availwidth.asp">availWidth</a> property.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the height of the user's screen, in pixels</td>
</tr>
</table>
