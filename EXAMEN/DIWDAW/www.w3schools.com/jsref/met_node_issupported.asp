...
<h3>Example</h3>
 <p>Check if the feature Core, version 2.0, is supported for the &lt;button&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_issupported" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isSupported() method checks if a specified feature is supported for the specified node.</p>
<p><strong>Note:</strong> This method is obsolete in many browsers. Try to avoid 
using it.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isSupported()</td>
...
<p><strong>Note:</strong> This method was supported in Chrome, Firefox and Opera before, but they no longer support it.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the feature is supported, otherwise false</td>
  </tr>
<tr>
  <th>DOM Version</th>
