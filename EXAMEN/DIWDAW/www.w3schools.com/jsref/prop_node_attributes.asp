...
<h3>Example</h3>
 <p>Find out how many attributes a &lt;button&gt; element have:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myBtn&quot;).attributes.length;</div>
...
<p>The attributes property returns a collection of the specified node&#39;s attributes, as a NamedNodeMap 
object.</p>
<p>The nodes can be accessed by index numbers, and the index starts at 0.</p>
<p>
<strong>Tip: </strong>Numerical indexing is useful for going through all of an 
element's attributes: You can use the <a href="prop_namednodemap_length.asp">length</a> property of the NamedNodeMap object to determine the number of attributes, then you can loop through all attributes nodes and extract the info you want.
</p>
<p>
<strong>Tip: </strong>HTML attributes are attribute nodes, with all the 
<a href="dom_obj_attributes.asp">properties and methods</a> available for the 
Attribute object.
</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A NamedNodeMap object, representing a collection of node's attributes</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myBtn").attributes[1].name;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 onclick</div>-->
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myImg&quot;);<br>var txt = &quot;&quot;;<br>
