...
<html lang="en-US">
<head>
<title>ondurationchange Event</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">ondurationchange</span> Event</h1>
<p><a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object Reference">&#10094; Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the duration of a video has changed:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video ondurationchange=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondurationchange" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondurationchange event occurs when the duration of the audio/video is changed.</p>
<p><strong>Note:</strong> When the audio/video is loaded, the duration will 
change from "NaN" to the actual duration of the audio/video.</p>
<p>During the loading process of an audio/video, the following events occur, in 
this order:</p>
<ol>
  <li><a href="event_onloadstart.asp">onloadstart</a></li>
  <li>ondurationchange</li>
  <li><a href="event_onloadedmetadata.asp">onloadedmetadata</a></li>
  <li><a href="event_onloadeddata.asp">onloadeddata</a></li>
  <li><a href="event_onprogress.asp">onprogress</a></li>
  <li><a href="event_oncanplay.asp">oncanplay</a></li>
  <li><a href="event_oncanplaythrough.asp">oncanplaythrough</a><br></li>
</ol>
<hr>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> ondurationchange=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondurationchange_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.ondurationchange = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondurationchange_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;durationchange&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ondurationchange_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the audio is starting to load:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;audio ondurationchange=&quot;myFunction()&quot;&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ondurationchange_audio">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Event Object Reference">&#10094; Event Object</a>
</div>
