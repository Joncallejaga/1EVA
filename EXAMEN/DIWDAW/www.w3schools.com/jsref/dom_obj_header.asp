...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Header Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_head.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_heading.asp">Next &#10095;</a>
</div>
<hr>

<h2>Header Object <img src="https://www.w3schools.com/images/html5_badge20.png" alt="HTML5"></h2>
<p>The Header Object is new in HTML5.</p>
...
var x = document.getElementById("myHeader");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_header_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var x = document.createElement("HEADER");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_header_create" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html5_semantic_elements.asp">HTML5 Semantic Elements</a></p>
<p>HTML reference: <a href="../tags/tag_header.asp">HTML &lt;header&gt; tag</a></p>
