...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_text3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text of the option element</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 var x = selTag.options[selTag.selectedIndex].text;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_text">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get the text of all options in a drop-down list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;);<br>var txt = &quot;All options: &quot;;<br>
 var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + &quot;\n&quot; + x.options[i].text;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_text2">Try it Yourself &raquo;</a>
</div>
<hr>
