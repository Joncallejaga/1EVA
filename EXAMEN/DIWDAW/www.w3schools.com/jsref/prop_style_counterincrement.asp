...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_counterincrement">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">counterIncrement</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>id number</i></td>
    <td>The <i>id</i> defines which counter that should be incremented. The <i>number</i> sets how much the counter will increment on each occurrence of the selector. The default increment is 1. 0 or negative values, are allowed. If the <i>id</i> refers to a counter that has not been initialized by counter-reset, the default initial value is 0</td>
  </tr>
    <tr>
    <td>initial</td>
