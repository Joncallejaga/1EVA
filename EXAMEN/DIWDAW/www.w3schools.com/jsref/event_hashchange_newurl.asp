...
<html lang="en-US">
<head>
<title>HashChangeEvent newURL Property</title>
<meta charset="utf-8">
...
<h1>HashChangeEvent <span class="color_h1">newURL</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>When the hash has been changed, get the URL we are navigating to:</p>
...
<p>The newURL property returns the URL of the document, after the hash 
(anchor part) has been changed.</p>
<p>This is the URL that was navigated to. To get the URL that was navigated away 
from, use the <a href="event_hashchange_oldurl.asp">oldURL</a> 
property.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">newURL</td>
    <td>5.0</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.newURL</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A String, representing the URL that was navigated to</td>
</tr>
</table>
