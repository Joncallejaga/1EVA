...
<h3>Example</h3>
<p>The constructor property returns a number's constructor function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_constructor_num">Try it Yourself &raquo;</a>
</div>
<hr>
