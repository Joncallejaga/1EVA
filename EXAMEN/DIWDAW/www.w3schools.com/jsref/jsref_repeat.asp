...
<h1>JavaScript String <span class="color_h1">repeat()</span> method</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="jsref_match.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="jsref_obj_string.asp"><span class="w3-hide-small">JavaScript String </span>Reference</a>
<a class="w3-right w3-btn" href="jsref_replace.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_repeat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The repeat() method returns a new string with a specified number of copies of 
the string it was called on.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, a new string containing copies of the original string</td>
</tr>
<tr>
