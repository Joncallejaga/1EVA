...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_size2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> In Chrome and Safari, the size attribute may not work 
as expected for size=&quot;2&quot; and size=&quot;3&quot;.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the number of visible options in a drop-down list. If the  value is greater than 1, but lower than the total number of options in  the list, the browser will add a scroll bar to indicate that there are  more options to view.</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of visible options in the drop-down list</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_select_size.asp">HTML &lt;select&gt; size attribute</a></p>
<hr>
