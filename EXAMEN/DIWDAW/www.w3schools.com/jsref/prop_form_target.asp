...
<h3>Example</h3>
<p>Change where to display the response that is received after submitting a form 
(open the response in a new window instead of the same frame as it was clicked):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myForm&quot;).target = &quot;_blank&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_target2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The target property sets or returns the value of the target attribute in a form.</p>
<p>The target attribute specifies a name or a keyword that indicates where to display the response that is received after submitting the form.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing where to display the response that is received after submitting the form</td>
  </tr>
</table>
...
_self</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_form_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_form_target.asp">HTML &lt;form&gt; target attribute</a></p>
<hr>
