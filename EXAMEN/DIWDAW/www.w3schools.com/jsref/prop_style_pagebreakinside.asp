...
document.getElementById(&quot;footer&quot;).style.pageBreakInside = &quot;avoid&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjsref_style_pagebreakinside.htm">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">pageBreakInside</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the page-break behavior inside an element when printing</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
