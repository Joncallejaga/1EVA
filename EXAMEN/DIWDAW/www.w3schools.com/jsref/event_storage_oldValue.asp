...
<html lang="en-US">
<head>
<title>StorageEvent oldValue Property</title>
<meta charset="utf-8">
...
<h1>StorageEvent <span class="color_h1">oldValue</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the old value of the storage item that changed:</p>
<div class="w3-code notranslate jsHigh">
  window.addEventListener(&quot;storage&quot;, myFunction);<br><br>function myFunction(event) 
  {<br>&nbsp; var x = &quot;Old Value: &quot; + event.oldValue;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = x;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_storage_oldvalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The oldValue property returns the old value of the changed storage item.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.oldValue</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the old value of the storage item</td>
</tr>
</table>
...
Property</a></p>
<p>StorageEvent reference: <a href="event_storage_storagearea.asp">The storageArea 
Property</a></p>
