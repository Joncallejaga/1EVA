...
<html lang="en-US">
<head>
<title>Storage getItem() Method</title>
<meta charset="utf-8">
...
<h1>Storage <span class="color_h1">getItem()</span> Method</h1>
<p>
...
<h3>Example</h3>
<p>Get the value of the specified local storage item:</p>
<div class="w3-code notranslate jsHigh">
  var x = localStorage.getItem("mytime");</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_getitem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getItem() method returns value of the specified Storage Object item.</p>
<p>The getItem() method belongs to the Storage Object, which can be either a
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getItem()</td>
    <td>4</td>
    <td>8</td>
    <td>3.5</td>
    <td>4</td>
...
<div class="w3-code w3-border notranslate">
  <div>
    localStorage.getItem(<em>keyname</em>)
  </div>
</div>
Or:
<div class="w3-code w3-border notranslate">
  <div>
    sessionStorage.getItem(<em>keyname</em>)
  </div>
</div>
...
<tr>
<td><em>keyname</em></td>
<td>Required. A String specifying the name of the key you want to get the value of<br></td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:18%;">Return Value:</th>
  <td>A String, representing the value of the specified key</td>
  </tr>
  </table>
...
<p>Get the value of the specified session storage item:</p>
<div class="w3-code notranslate jsHigh">
  var x = sessionStorage.getItem(&quot;test1&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_getitem_session" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>You can also get the value by using dot notation (<em>obj</em>.<em>key</em>):</p>
<div class="w3-code notranslate jsHigh">
  var x = sessionStorage.test1;</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>You can also get the value like this:</p>
<div class="w3-code notranslate jsHigh">
  var x = sessionStorage["test1"];</div>
...
<p>Web Storage Reference: <a href="met_storage_setitem.asp">setItem() Method</a></p>
