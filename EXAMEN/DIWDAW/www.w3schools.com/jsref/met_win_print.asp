...
<a target="_blank" href="tryit.asp?filename=tryjsref_print" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The print() method prints the contents of the current window.</p>
<p>The print() method opens the Print Dialog Box, which lets the user to select preferred printing options.</p>
<hr>
