...
<h1>Audio <span class="color_h1">currentTime</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set time position to 1 second:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAudio&quot;).currentTime = 1;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_currenttime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The currentTime property sets or returns the current position (in seconds) of the audio 
playback.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.currentTime
</div></div>
<p>Set the currentTime property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.currentTime =<i> seconds</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>seconds</i></td>
    <td>Specifies the position for the playback of the audio, in seconds</td>
  </tr>
</table>
