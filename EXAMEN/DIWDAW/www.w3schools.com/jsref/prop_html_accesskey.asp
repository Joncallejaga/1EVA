...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).accessKey = &quot;w&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_accesskey" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The accessKey property sets or returns the accesskey attribute of an element.</p>
...
<p>However, in most browsers the shortcut key can be set to another combination of keys.</p>
...
<h2>Syntax</h2>
<p>Return the accessKey property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.accessKey</div></div>
<p>Set the accessKey property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.accessKey =<em> character</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the shortcut key to activate/focus the element</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A character from the keyboard</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the accesskey of a link:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAnchor&quot;).accessKey;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 w</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_accesskey2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML Reference: <a href="../tags/att_global_accesskey.asp">HTML accesskey Attribute</a></p>
<hr>
