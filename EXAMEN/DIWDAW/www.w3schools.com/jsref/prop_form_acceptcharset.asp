...
ISO-8859-1</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_form_acceptcharset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">acceptCharset</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>A space- or comma-separated list of one or more character encodings that are to be used for the form submission.
    <p>Common values:</p>
 <ul>
    <li>UTF-8 - Character encoding for Unicode</li>
    <li>ISO-8859-1 - Character encoding for the Latin alphabet</li>
 </ul>
 <p>In theory, any character encoding can be used, but no browser understands all of them. The more widely a character encoding is used, the better the chance that a browser will understand it.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the character set(s) that the server should use for form submission</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_acceptcharset2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_form_accept_charset.asp">HTML &lt;form&gt; accept-charset attribute</a></p>
<hr>
