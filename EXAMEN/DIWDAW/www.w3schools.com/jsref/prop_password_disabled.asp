...
<html lang="en-US">
<head>
<title>HTML DOM Input Password disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">disabled</span> Property</h1>
...
<div class="w3-code notranslate">
 <input type="password" value="somepassword" disabled>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a password field should be disabled, or not.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a  password field should be disabled or not.
  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the password field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-code notranslate">false</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_disabled">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 function disablePsw() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myPsw&quot;).disabled = true;<br>
 }<br><br>function undisablePsw() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myPsw&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
