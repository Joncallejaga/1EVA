...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onreset">Try it Yourself &raquo;</a>
</div>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onreset=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onreset_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onreset = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onreset_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;reset&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onreset_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myInput&quot;);<br>alert(&quot;Before reset, the text was: &quot; + x.value);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onreset2">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 // Reset the value of all elements in a form with id=&quot;myForm&quot;<br>function myResetFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myForm&quot;).reset();<br>}<br><br>// Alert some text when the form is reset<br>function myAlertFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The form was reset&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onreset3">Try it Yourself &raquo;</a>
</div>
<hr>
