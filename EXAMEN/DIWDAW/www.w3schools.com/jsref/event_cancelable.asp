...
<h3>Example</h3>
<p>Find out if a specific event is cancelable:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.cancelable;<br></div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_cancelable" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cancelable event property returns a Boolean value indicating whether or not 
an event is a cancelable event.</p>
<p>The event is cancelable if it is possible to prevent the events default action.</p>
<p>To cancel an event, use the <a href="event_preventdefault.asp">preventDefault()</a> method.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>A Boolean, indicating whether the specified <em>event</em> is a cancelable event.
 <p>Possible values:</p>
 <ul>
    <li>true - The event is cancelable</li>
    <li>false - The event is not cancelable</li>
 </ul>
  </td>
  </tr>
  <tr>
