...
<h3>Example</h3>
<p>Get the version of your browser:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_platform">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing platform of the browser. <br><br>Possible values:
<ul>
  <li>HP-UX</li>
  <li>Linux i686</li>
  <li>Linux armv7l</li>
