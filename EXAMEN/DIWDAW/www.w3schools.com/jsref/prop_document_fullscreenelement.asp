...
<html lang="en-US">
<head>
<title>HTML DOM fullscreenElement Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">fullscreenElement</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the element that is currently in fullscreen mode:</p>
<div class="w3-code notranslate jsHigh">
  var elem = document.fullscreenElement;</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The fullscreenElement property returns the current element that is displayed 
in fullscreen mode, or <strong>null</strong> when not in fullscreen.</p>
<p><strong>Note:</strong> This property requires specific prefixes 
...
<p>The numbers in the table specify the first browser version that fully supports the property. 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">fullscreenElement</td>
    <td>45.0 (webkit)</td>
    <td>11.0 (ms)</td>
    <td>47.0 (moz)</td>
    <td>5.1 (webkit)</td>
...
<div class="w3-code notranslate jsHigh">
  if (<br>&nbsp; 
  document.fullscreenElement || /* Standard syntax */<br>&nbsp; 
  document.webkitFullscreenElement || /* Chrome, Safari and Opera syntax */<br>&nbsp; 
  document.mozFullScreenElement ||/* Firefox syntax */<br>&nbsp; 
  document.msFullscreenElement /* IE/Edge syntax */<br>) {<br>...<br>}</div>
</div>
...
<div class="w3-code w3-border notranslate"><div>
 document.fullscreenElement</div></div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>Returns the <em>element</em> that is currently in fullscreen mode, or
  <strong>null</strong> if fullscreen mode is not available</td>
  </tr>
</table>
