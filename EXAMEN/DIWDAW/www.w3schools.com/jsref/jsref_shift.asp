...
<a target="_blank" href="tryit.asp?filename=tryjsref_shift" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The shift() method removes the first item of an array.</p>
<p><b>Note:</b> This method changes the length of the array.</p>
<p><b>Note:</b> The return value of the shift method is the removed item.</p>
...
<tr>
  ...
  <td>Any type*, representing the removed array item. *An array item can be a string, a number, an array, a boolean, or any other object types that are allowed in an array.</td>
  <td><a target="_blank" href="tryit.asp?filename=tryjsref_shift_return" class="w3-btn btnsmall">Try it &raquo;</a>
</td>
</tr>
<tr>
