...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Optional. What to write to the output stream. Multiple arguments can be listed and they will be appended to the document in order of occurrence</td>
  </tr>
</table>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
all existing HTML.</p>
 <p>In this example we illustrate what happens when we put document.write() inside a function. When the function is invoked, all HTML elements will be overwritten and replaced with the new, specified text:</p>
<div class="w3-code notranslate jsHigh">
 // This should be avoided:<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.write(&quot;Hello World!&quot;);<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
&lt;/body&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_writeln" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_doc_write6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
