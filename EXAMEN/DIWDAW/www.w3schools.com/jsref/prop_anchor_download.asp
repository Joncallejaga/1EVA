...
<h3>Example</h3>
<p>Display the value of the download attribute of a link:</p>
...
<div class="w3-code notranslate">
 w3logo</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_download" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> The download attribute is new for the &lt;a&gt; element in HTML5.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>filename</i></td>
    <td>
  Specifies some text to be used as the filename (no need to specify the  file extension - the browser will automatically detect the correct file  extension and add it to the file, e.g. .img, .pdf. .txt, .html, etc.).  If omitted, the original filename is used.</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the downloaded file</td>
</tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").download = &quot;newValue&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_download2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
