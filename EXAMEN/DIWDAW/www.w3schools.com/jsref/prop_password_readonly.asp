...
<html lang="en-US">
<head>
<title>HTML DOM Input Password readOnly Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">readOnly</span> Property</h1>
...
<h3>Example</h3>
<p>Set a password field to read-only:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myPsw&quot;).readOnly = true;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_readonly2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the password field is read-only, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_readonly">Try it Yourself &raquo;</a>
</div>
<hr>
