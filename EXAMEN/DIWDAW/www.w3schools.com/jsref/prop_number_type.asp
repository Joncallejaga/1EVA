...
<html lang="en-US">
<head>
<title>HTML DOM Input Number type Property</title>
 <meta charset="utf-8">
...
<h1>Input Number <span class="color_h1">type</span> Property</h1>
...
<h3>Example</h3>
<p>Return which type of form element the number field is:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myNumber&quot;).type;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">number</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_number_type">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>For an input number, this property will always return &quot;number&quot;.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>numberObject</em>.type</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of form element the number field is</td>
  </tr>
</table>
