...
<html lang="en-US">
<head>
<title>HTML DOM Input Text name Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">name</span> Property</h1>
<p><a href="dom_obj_text.asp" class="w3-btn w3-white w3-border" title="Input Text Object Reference">&#10094; Input Text Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the name of a text field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myText&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">fname</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the text field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of a text field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myText&quot;).name = &quot;username&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_name2">Try it Yourself &raquo;</a>
</div>
<br>
