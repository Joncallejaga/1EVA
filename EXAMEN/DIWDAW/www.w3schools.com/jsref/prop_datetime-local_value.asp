...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal value Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">value</span> Property</h1>
...
<h3>Example</h3>
<p>Set a local date and time for a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).value = &quot;2014-01-02T11:42:13.510&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_value">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The value attribute specifies a local date and time for the datetime field.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.value</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.value =<i> YYYY-MM-DDThh:mm:ss.ms</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the date and time. Explanation of components:<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the date and time of the local datetime field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the local date and time of a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2014-11-16T15:25:33</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_value2">Try it Yourself &raquo;</a>
</div>
<br>
