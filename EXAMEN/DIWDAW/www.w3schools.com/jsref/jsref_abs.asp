...
<a target="_blank" href="tryit.asp?filename=tryjsref_abs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the absolute value of the specified number, or NaN if the value is not a number, or 0 if the value is <em>null</em></td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_abs2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
