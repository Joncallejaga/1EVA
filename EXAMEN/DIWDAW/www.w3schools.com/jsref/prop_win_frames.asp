...
<h3>Example</h3>
<p>Change the location of the first &lt;iframe&gt; element (index 0) in the current 
window:</p>
<div class="w3-code notranslate jsHigh">
 window.frames[0].location = &quot;https://www.w3schools.com/jsref/&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_frames">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The frames property returns an array-like object, which represents all 
&lt;iframe&gt; elements in the 
current window.</p>
<p>The &lt;iframe&gt; elements can be accessed by index numbers. The index starts at 
0.</p>
<p><b>Tip:</b> Use <a href="prop_win_length.asp">frames.length</a> to find the number of frames.</p>
<p><strong>Note:</strong> This property will also work for &lt;frame&gt; elements. 
However, the &lt;frame&gt; element is not supported in HTML5.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>Returns a reference to the Window object, representing all frames in the current 
window</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Loop through all frames on a page, and change the location of all frames to 
&quot;w3schools.com&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var frames = window.frames;<br>var i;<br><br>for (i = 0; i &lt; frames.length; i++) {<br>&nbsp;&nbsp;&nbsp; frames[i].location = &quot;https://www.w3schools.com&quot;;<br>
 }
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_frames2">Try it Yourself &raquo;</a>
</div>
<hr>
