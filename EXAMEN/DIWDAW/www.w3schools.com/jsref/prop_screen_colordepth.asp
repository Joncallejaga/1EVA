...
<h3>Example</h3>
<p>Get the bit depth of the color palette:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Color Depth: &quot; + screen.colorDepth;</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_colordepth">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the bit depth of the color palette for displaying images, in bits per pixel.<br><br>Possible values:
<ul>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_screen_colordepth2">Try it Yourself &raquo;</a>
</div>
