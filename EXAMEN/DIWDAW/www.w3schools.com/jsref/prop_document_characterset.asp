...
<html lang="en-US">
<head>
<title>HTML DOM characterSet Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">characterSet</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.characterSet;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
  windows-1252</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_document_characterset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The characterSet property returns the character encoding for the document.</p>
<p>The character encoding is the character set used for rendering the document, 
which may differ from the encoding specified by the page (the user can override 
the encoding).</p>
<p>The characterSet property returns the character encoding at the time of parsing, and will return <em>null</em> if the document is created in memory.</p>
<p>For more information on character sets, visit our
<a href="../charsets/default.asp">HTML Charsets Reference</a>.</p>
<p><strong>Note:</strong> This property is an alias of
<a href="prop_document_inputencoding.asp">document.inputEncoding</a> and 
document.charset.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">characterSet</td>
    <td>45.0</td>
    <td>9.0</td>
    <td>44.0</td>
    <td>9.0</td>
