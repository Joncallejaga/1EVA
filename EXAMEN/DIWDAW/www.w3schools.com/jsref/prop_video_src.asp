...
<h1>Video <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the URL of a video:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).src = &quot;mov_bbb.ogg&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_src2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute of a video.</p>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>videoObject</em>.src</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.src =<em> URL</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>URL</em></td>
    <td>
 Specifies the URL of the video file.<br><br>Possible values:
 <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the video file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of a video:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myVideo&quot;).src;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/movie.ogg</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_src.asp">HTML &lt;video&gt; src attribute</a></p>
<hr>
