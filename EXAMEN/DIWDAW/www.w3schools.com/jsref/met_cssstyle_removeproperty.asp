...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration removeProperty Method</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration removeProperty<span class="color_h1">() Method</span></h1>
...
<h3>Example</h3>
<p>Remove the color property:</p>
<div class="w3-code notranslate jsHigh">
  var declaration = document.styleSheets[0].cssRules[0].style;<br>var 
  removedvalue = declaration.removeProperty(&quot;color&quot;);<br>alert(removedvalue);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_removeproperty">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The removeProperty() method removes the specified CSS property from a CSS declaration block.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">removeProperty()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.removeProperty(<em>propertyname</em>)</div></div>
...
<td>Required. A String representing the name of the property to remove</td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A String, representing the old value of the removed property</td>
  </tr>
  </table>
<hr>
