...
<html lang="en-US">
<head>
<title>HTML DOM requestFullscreen() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">requestFullscreen()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
  ...
  example): */<br>var elem = document.getElementById(&quot;myvideo&quot;); <br><br>/* When 
  the openFullscreen() function is executed, open the video in fullscreen.<br>
  Note that we must include prefixes for different browsers, as they don't 
  support the requestFullscreen property yet */<br>function openFullscreen() {<br>&nbsp; 
  ...
  { /* Chrome, Safari and Opera */<br>&nbsp;&nbsp;&nbsp; 
  elem.webkitRequestFullscreen();<br>&nbsp; } else if (elem.msRequestFullscreen) 
  { /* IE/Edge */<br>&nbsp;&nbsp;&nbsp; elem.msRequestFullscreen();<br>&nbsp; }<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_requestfullscreen" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The requestFullscreen() method opens an element in fullscreen mode.</p>
<p><strong>Note:</strong> This method requires specific prefixes 
to work in different browsers (see Browser Support below).</p>

<p><strong>Tip:</strong> Use the <a href="met_element_exitfullscreen.asp">exitFullscreen()</a> method to cancel fullscreen mode.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.requestFullscreen()</div></div>
<h2>Parameters</h2>
...
<h2>More Examples</h2>
<p>To open the HTML page in fullscreen, use the <code class="w3-codespan">document.documentElement</code> instead of <code class="w3-codespan">document.getElementById("<em>element</em>")</code>. 
In this example, we also use a close function to close the fullscreen:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  /* Get the documentElement (&lt;html&gt;) to display the page in fullscreen */<br>
  ...
  document.msExitFullscreen();<br>&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_requestfullscreen_exit" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_element_requestfullscreen_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
