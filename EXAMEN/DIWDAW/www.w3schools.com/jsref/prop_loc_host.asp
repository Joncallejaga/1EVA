...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_loc_host">Try it Yourself &raquo;</a>
</div>
<hr>
...
<td>String</td>
<td>
Specifies the hostname and port number of the URL</td>
</tr>
</table>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the domain name and port number, or the IP address of a URL</td>
</tr>
</table>
