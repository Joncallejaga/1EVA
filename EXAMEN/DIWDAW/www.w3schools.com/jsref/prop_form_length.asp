...
<div class="w3-code notranslate">
 3</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_form_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of elements in the form</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 ...
 var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.elements[i].value + &quot;&lt;br&gt;&quot;;<br>
 }<br>
 document.getElementById(&quot;demo&quot;).innerHTML = txt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_length2">Try it Yourself &raquo;</a>
</div>
<hr>
