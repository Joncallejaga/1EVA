...
<h1>HTML DOM <span class="color_h1">contains()</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Find out if a &lt;span&gt; element is a descendant of a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var span = document.getElementById(&quot;mySPAN&quot;);<br>var div = document.getElementById(&quot;myDIV&quot;).contains(span);</div>
<!--<p>The result of <em>div</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_contains" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The contains() method returns a Boolean value indicating whether a node is a 
descendant of a specified node.</p>
<p>A descendant can be a child, grandchild, great-grandchild, and so on.</p>
<hr>
...
<i>node</i>.contains(<i>node</i>)</div></div>
...
<td>Required. Specifies the node that may be contained by (a descendant of) a 
specified node</td>
</tr>
</table>
...
<tr>
 ...
 <ul>
    <li>true - The node is a descendant</li>
    <li>false - The node is NOT a descendant</li>
 </ul>
  </td>
</tr>
</table>
