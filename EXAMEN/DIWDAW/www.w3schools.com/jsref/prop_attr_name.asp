...
<h3>Example</h3>
 <p>Get the name of an attribute:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName("BUTTON")[0].attributes[0].name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 onclick
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_attr_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> You can use the <a href="prop_attr_value.asp">attr.value</a> property to get the value of an attribute.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the attribute</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
