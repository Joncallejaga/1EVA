...
<html lang="en-US">
<head>
<title>StorageEvent url Property</title>
<meta charset="utf-8">
...
<h1>StorageEvent <span class="color_h1">url</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the URL of page where the storage item was changed:</p>
<div class="w3-code notranslate jsHigh">
  window.addEventListener(&quot;storage&quot;, myFunction);<br><br>function myFunction(event) 
  {<br>&nbsp; var x = event.url;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = x;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_storage_url" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The url property returns the url of the page where the storage item was 
changed.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.url</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the url of the page where the storage item was 
  changed</td>
</tr>
</table>
...
Property</a></p>
<p>StorageEvent reference: <a href="event_storage_storageArea.asp">The storageArea Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_storageevent.asp" class="w3-btn w3-white w3-border" title="StorageEvent">&#10094; StorageEvent</a>
