...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjsref_style_widows.htm">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The widows property sets or returns the minimum number of lines for an element that must be 
visible at the top of a page (for printing or print preview).</p>
<p>The widows property only affects block-level elements.</p>
<p><b>Tip:</b> widows:5 means that at least 5 lines must be visible below the page break.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.style.widows<i> = &quot;number</i>|initial|inherit&quot;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>An integer that specifies the minimum number of visible lines.  Negative values are not allowed. The  default value is 2</td>
  </tr>
  <tr>
    <td>initial</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the minimum number of lines to print at the top of the page</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
