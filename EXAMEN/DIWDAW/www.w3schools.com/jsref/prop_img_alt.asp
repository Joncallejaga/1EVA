...
<a target="_blank" href="tryit.asp?filename=tryjsref_img_alt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
displayed.</p>
<p><b>Tip:</b> If you want to create a tooltip for an image, use the global title 
attribute.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>text</i></td>
    <td>
  Specifies an alternate text for an image.<br><br>Guidelines for the alt  text:
  <ul>
      <li>The text should describe the image if the image contains   information<br></li>
      <li>The text should explain where the link goes if the   image is inside an &lt;a&gt; element<br></li>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the alternate text of the image</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_alt2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_img_alt.asp">HTML &lt;img&gt; alt attribute</a></p>
<hr>
