...
<html lang="en-US">
<head>
<title>HTML DOM Title text Property</title>
 <meta charset="utf-8">
...
<h1>Title <span class="color_h1">text</span> Property</h1>
<p><a href="dom_obj_title.asp" class="w3-btn w3-white w3-border" title="Title Object Reference">&#10094; Title Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the text of the document's title:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName(&quot;TITLE&quot;)[0].text;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 HTML DOM Objects</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_title_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The text property sets or returns the text of the document's title.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>titleObject</em>.text
</div></div>
<p>Set the text property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>titleObject</em>.text = <i>text</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>text</i></td>
    <td>
  Specifies the text of the document's title</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text of the document's title</td>
  </tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the text of the document's title:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementsByTagName(&quot;TITLE&quot;)[0].text = &quot;A new title text..&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_title_text2">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_title.asp" class="w3-btn w3-white w3-border" title="Title Object Reference">&#10094; Title Object</a>
</div>
