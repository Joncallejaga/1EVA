...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit value Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">value</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_value2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text displayed on the submit button</td>
  </tr>
</table>
...
<div class="w3-code notranslate">Submit form</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_value">Try it Yourself &raquo;</a>
</div>
<hr>
