...
<html lang="en-US">
<head>
<title>HTML DOM exitFullscreen() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">exitFullscreen()</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Open the HTML page in fullscreen mode, and close it with a click of a button:</p>
<div class="w3-code notranslate jsHigh">
  ...
  document.msExitFullscreen();<br>&nbsp; }<br>}</div>
...
<p>The exitFullscreen() method cancels an element in fullscreen mode.</p>
<p><strong>Note:</strong> This method requires specific prefixes 
to work in different browsers (see Browser Support below).</p>
<p><strong>Tip:</strong> Use the <a href="met_element_requestfullscreen.asp">requestFullscreen()</a> method to open an element in fullscreen mode.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.exitFullscreen()</div></div>
<h2>Parameters</h2>
...
<p>You can use CSS to style the page when it is in fullscreen mode:</p>
<div class="w3-example">
<h3>Example</h3>
