...
<html lang="en-US">
<head>
<title>HTML DOM Video readyState Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">readyState</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).readyState;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_video_readystate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The readyState property returns the current ready state of the video.</p>
<p>The ready state indicates if the video is ready to play or not.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.readyState</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>Represents the ready state of the video element:<ul><li>
  0  = HAVE_NOTHING - no information whether or not the video is ready</li>
    <li>1 = HAVE_METADATA - metadata for the video is ready</li>
