...
<html lang="en-US">
<head>
<title>HTML DOM Track src Property</title>
 <meta charset="utf-8">
...
<h1>Track <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_track.asp" class="w3-btn w3-white w3-border" title="Track Object Reference">&#10094; Track Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the track file:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myTrack").src;
</div>
<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/subtitles_en.vtt</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute of the 
track.</p>
<p>The src attribute specifies the URL of the track file.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.src</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.src =<em> URL</em></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the track file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the URL of the track file:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myTrack").src = &quot;subtitles_no.vtt&quot;;</div>
<br></div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_track_src.asp">HTML &lt;track&gt; src attribute</a></p>
<hr>
