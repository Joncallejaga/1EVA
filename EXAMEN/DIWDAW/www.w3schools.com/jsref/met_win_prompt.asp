...
<h3>Example</h3>
<p>Display a prompt box which ask the user for her/his name, and output a 
message:</p>
<div class="w3-code notranslate jsHigh">
 var person = prompt(&quot;Please enter your name&quot;, &quot;Harry Potter&quot;);<br><br>if (person != null) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; &quot;Hello &quot; + person + &quot;! How are you today?&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_prompt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
method, as it prevents the user from accessing other parts of the page until the 
box is closed.</p>
<p>The prompt() method returns the input value if the user clicks &quot;OK&quot;. If the user clicks &quot;cancel&quot; the method returns null.</p>
<hr>
...
&quot;cancel&quot;, <em>null</em> is returned. If the user clicks OK without entering any text, an 
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the switch statement together with prompt() to execute a block of code 
based on user input:</p>
<div class="w3-code notranslate jsHigh">
 var text;<br>var favDrink = prompt(&quot;What's your favorite cocktail drink?&quot;);<br>
 switch(favDrink) {<br>&nbsp;&nbsp;&nbsp; case &quot;Martini&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Excellent choice! Martini is good for your soul.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; case &quot;Daiquiri&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Daiquiri is my favorite too!&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; case &quot;Cosmopolitan&quot;:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;Really? Are you sure the Cosmopolitan is your favorite?&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; default:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; text = &quot;I have never heard of that one..&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_switch4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>Window Object: <a href="met_win_alert.asp">alert() Method</a></p>
<p>Window Object: <a href="met_win_confirm.asp">confirm() Method</a></p>
<hr>
