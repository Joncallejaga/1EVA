...
document.getElementById(&quot;myDiv&quot;).style.borderBottomColor = &quot;red&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderbottomcolor">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the color of the bottom border. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values. Default color is black</td>
  </tr>
  <tr>
    <td>transparent</td>
    <td>The color of the bottom border is transparent (underlying content will shine through)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderbottomcolor2">Try it Yourself &raquo;</a>
</div>
<hr>
