...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Body Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_blockquote.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_br.asp">Next &#10095;</a>
</div>
<hr>
...
var x = document.getElementsByTagName("BODY")[0];</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_body_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>aLink</td>
    <td><span class="deprecated">Not supported in HTML5. See <a href="../cssref/sel_active.asp">CSS :active Selector</a> instead.</span>
 <br>Sets or returns the color of an active link in a document</td>
  ...
  <tr>
    <td>link</td>
    <td><span class="deprecated">Not supported in HTML5. See <a href="../cssref/sel_link.asp">CSS :link Selector</a> instead.</span> <br>Sets or returns the color of unvisited links in a document</td>
  </tr>
  <tr>
    <td>text</td>
  ...
  <tr>
    <td>vLink</td>
    <td><span class="deprecated">Not supported in HTML5. See <a href="../cssref/sel_visited.asp">CSS :visited Selector</a> instead.</span>
