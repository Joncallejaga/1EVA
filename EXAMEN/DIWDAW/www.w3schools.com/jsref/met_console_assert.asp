...
<html lang="en-US">
<head>
<title>HTML DOM console.assert() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.assert()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Write a message to the console, only if the first argument is <em>false</em>:</p>
<div class="w3-code notranslate jsHigh">
console.assert(document.getElementById("demo"), "You have no element with ID 'demo'");</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_assert" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.assert() method writes a message to the console, but only if an expression evaluates to <em>false</em>.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.assert()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>28</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.assert(<em>expression</em>, <em>message</em>)</div>
</div>
...
<td>Required. The message or object to write in the console</td>
</tr>
<tr>
<td><em>message</em></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Write an object to the console:</p>
<div class="w3-code notranslate jsHigh">
var myObj = { firstname : "John", lastname : "Doe" };<br>
console.assert(document.getElementById("demo"), myObj;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_assert2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Write an Array to the console:</p>
<div class="w3-code notranslate jsHigh">
var myArr = ["Orange", "Banana", "Mango", "Kiwi" ];<br>
console.assert(document.getElementById("demo"), myArr;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_assert3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
