...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">disabled</span> Property</h1>
...
-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled property sets or returns whether a submit button should be disabled, or not.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the submit button is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_disabled">Try it Yourself &raquo;</a>
</div>
<hr>
