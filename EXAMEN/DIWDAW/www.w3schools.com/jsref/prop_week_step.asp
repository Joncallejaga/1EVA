...
<html lang="en-US">
<head>
<title>HTML DOM Input Week step Property</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">step</span> Property</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the legal week intervals:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).step = &quot;2&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_step">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The step property sets or returns the value of the step attribute of a week 
field.</p>
<p>The step attribute specifies the legal week intervals to choose from when the 
user <strong>opens the calendar</strong> in a week field.</p>
<p>For example, if step = &quot;2&quot;, you can only select every second week in the 
calendar.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.step</div></div>
<p>Set the step property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.step = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the legal week intervals. Default is 1 week.<br><br><strong>
  Examples:</strong><br><br>If step=&quot;2&quot;, you can only select every second  week in the week calendar.<br><br>If step=&quot;10&quot;, you can only select  every tenth week in the week calendar.</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the legal week intervals</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the legal week intervals:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myWeek&quot;).step;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">3</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_step2">Try it Yourself &raquo;</a>
</div>
<hr>
