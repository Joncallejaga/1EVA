...
<h1>Video <span class="color_h1">volume</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
    document.getElementById(&quot;myVideo&quot;).volume = 0.2;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_volume" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The volume property sets or returns the audio volume of a video, from 0.0 (silent) to 1.0 (loudest).</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.volume</div></div>
<p>Set the volume property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.volume = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies the audio volume of the video. Must be a number between 0.0 to 1.0<br>Example values:
 <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the audio volume of the video</td>
  </tr>
  <tr>
  <th>Default Value:</th>
  <td>1.0</td>
