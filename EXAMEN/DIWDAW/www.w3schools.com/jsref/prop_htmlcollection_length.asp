...
<html lang="en-US">
<head>
<title>HTMLCollection length Property</title>
<meta charset="utf-8">
...
<h1>HTMLCollection <span class="color_h1">length</span> Property</h1>
...
<h3>Example</h3>
 ...
 <div class="w3-code notranslate jsHigh">
   function myFunction() {<br>&nbsp; var l = document.getElementsByTagName(&quot;P&quot;).length;<br>&nbsp; 
   alert(l);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">length()</code> property returns the number of elements in a HTMLCollection.</p>
<p>This property is read-only.</p>
<p>This element is useful when you want to loop through a HTMLCollection.</p>
...
<h2>Return Value</h2>
<p>A Number, representing the number of elements in a HTMLCollection.</p>
...
<div class="w3-code notranslate jsHigh">
  ...
  x.length; i++) {<br>&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_length_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
