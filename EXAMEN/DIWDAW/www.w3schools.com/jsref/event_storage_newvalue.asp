...
<html lang="en-US">
<head>
<title>StorageEvent newValue Property</title>
<meta charset="utf-8">
...
<h1>StorageEvent <span class="color_h1">newValue</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the new value of the storage item that changed:</p>
<div class="w3-code notranslate jsHigh">
  window.addEventListener(&quot;storage&quot;, myFunction);<br><br>function myFunction(event) 
  {<br>&nbsp; var x = &quot;Value: &quot; + event.newValue;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = x;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_storage_newvalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The newValue property returns the new value of the changed storage item.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.newValue</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the new value of the storage item</td>
</tr>
</table>
