...
<a target="_blank" href="tryit.asp?filename=tryjsref_sort" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The sort order can be either alphabetic or numeric, and either ascending (up) or descending 
(down).</p>
<p>By default, the sort() method sorts the values as strings in alphabetical 
and ascending order.</p>
<p>This works well for strings (&quot;Apple&quot; comes before &quot;Banana&quot;). However, if 
numbers are sorted as strings, &quot;25&quot; is bigger than &quot;100&quot;, because &quot;2&quot; is bigger 
than &quot;1&quot;.</p>
<p>Because of this, the sort() method will produce an incorrect result when sorting 
numbers.</p>
<p>You can fix this by providing a &quot;compare function&quot; (See &quot;Parameter 
Values&quot; 
below).</p>
...
<i>array</i>.sort(<em>compareFunction</em>)</div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Sort numbers in an array in ascending order:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjsref_sort2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sort numbers in an array in descending order:</p>
<div class="w3-code notranslate jsHigh">
var points = [40, 100, 1, 5, 25, 10];<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_sort3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get the highest value in an array:</p>
<div class="w3-code notranslate jsHigh">
 var points = [40, 100, 1, 5, 25, 10];<br>points.sort(function(a, b){return b-a});&nbsp;&nbsp;&nbsp; // Sort the numbers in the array in descending order<br>// The first item in the array (points[0]) is now the highest value<br>
</div>
<!--<p>The result of points[0] will be:</p>
<div class="w3-code notranslate">
 100</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_sort_high" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get the lowest value in an array:</p>
<div class="w3-code notranslate jsHigh">
 var points = [40, 100, 1, 5, 25, 10];<br>points.sort(function(a, b){return a-b});&nbsp;&nbsp;&nbsp; // Sort the numbers in the array in ascending order<br>// The first item in the array (points[0]) is now the lowest value<br>
</div>
<!--<p>The result of points[0] will be:</p>
<div class="w3-code notranslate">
 1</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_sort_low" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sort an array alphabetically, and then reverse the order of the sorted items 
(descending):</p>
<div class="w3-code notranslate jsHigh">
var fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
fruits.sort();<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_sort4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
