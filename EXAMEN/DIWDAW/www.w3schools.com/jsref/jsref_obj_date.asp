...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript Date Reference</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="jsref_obj_boolean.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="jsref_obj_error.asp">Next &#10095;</a>
</div>
<hr>

<h2>Date Object</h2>
<p>The Date object is used to work with dates and times.</p>
<p>Date objects are created with <strong>new Date()</strong>.</p>
...
<p>For a tutorial about date and times, read our <a href="../js/js_dates.asp">JavaScript Date 
Tutorial</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>getYear()</td>
    <td><span class="deprecated">Deprecated.</span> Use the <a href="jsref_getfullyear.asp">getFullYear()</a> method instead</td>
  </tr>
    <tr>
    <td><a href="jsref_now.asp">now()</a></td>
  ...
  <tr>
    <td>setYear()</td>
    <td><span class="deprecated">Deprecated.</span> Use the <a href="jsref_setfullyear.asp">setFullYear()</a> method instead</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>toGMTString()</td>
    <td><span class="deprecated">Deprecated.</span> Use the <a href="jsref_toutcstring.asp">toUTCString()</a> method instead</td>
  </tr>
  <tr>
