...
<html lang="en-US">
<head>
<title>HTML DOM parentElement Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">parentElement</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the node name of the parent element of a &lt;li&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLI&quot;).parentElement.nodeName;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">UL</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_parentelement" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The parentElement property returns the parent element of the specified 
element.</p>
<p>The difference between parentElement and <a href="prop_node_parentnode.asp">parentNode</a>, is that parentElement 
returns <em>null</em> if the parent node is not an element node:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">document.body.parentNode; // Returns the &lt;html&gt; element<br>document.body.parentElement; // Returns the &lt;html&gt; element<br><br>document.documentElement.parentNode; // Returns the Document node<br>document.documentElement.parentElement; // Returns null (&lt;html&gt; does not have a parent ELEMENT node)</div>
</div>

<p>In most cases, it does not matter which property you use, however, parentNode 
is probably the most popular.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>node</em>.parentElement</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>An Element object, representing the parent element node of a node, or <em>null </em>if the node has no parent</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>DOM Level 4 Element Object</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Click on an element (&lt;span&gt;) to hide its parent element (&lt;div&gt;):</p>
<div class="w3-code notranslate htmlHigh">
 &lt;div&gt;<br>&nbsp; &lt;span onclick=&quot;this.parentElement.style.display = 'none';&quot;&gt;x&lt;/span&gt;<br>&lt;/div&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_parentelement_hide">Try it Yourself &raquo;</a>
</div>
