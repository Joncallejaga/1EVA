...
<h1>Video <span class="color_h1">height</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the height of a video:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).height = &quot;500&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_height" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The height property sets or returns the value of the height attribute of a video.</p>
<p>The height attribute specifies the height of a video, in pixels.</p>
<p><strong>Tip:</strong> Always specify both the height and width attributes for 
videos. If height and width are set, the space required for the video is 
reserved when the page is loaded. However, without these attributes, the browser 
does not know the size of the video, and cannot reserve the appropriate space to 
it. The effect will be that the page layout will change during loading (while 
the video loads).</p>
<p><strong>Note:</strong> Do not rescale video with the height and width 
attributes! Downsizing a large video with the height and width attributes forces 
a user to download the original video (even if it looks small on the page). The 
correct way to rescale a video is with a program, before using it on a page.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>videoObject</em>.height</div></div>
<p>Set the height property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.height = <em>pixels</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>pixels</em></td>
    <td>
 Specifies the height of the video, in pixels (i.e. width=&quot;100&quot;)</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the height of the video, in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the height of the video:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myVideo&quot;).height;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 240</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_height2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_height.asp">HTML &lt;video&gt; height attribute</a></p>
<hr>
