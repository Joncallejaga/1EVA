...
<html lang="en-US">
<head>
<title>HTML DOM Input FileUpload value Property</title>
 <meta charset="utf-8">
...
<h1>Input FileUpload <span class="color_h1">value</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_value">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the path or the name of the selected file</td>
  </tr>
</table>
