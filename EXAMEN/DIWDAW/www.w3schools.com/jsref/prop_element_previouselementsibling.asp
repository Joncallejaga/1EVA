...
<h1>HTML DOM <span class="color_h1">previousElementSibling</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;item2&quot;).previousElementSibling.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Coffee (first li)</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_previouselementsibling" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The previousElementSibling property returns the previous element of the specified 
element, in the same tree level.</p>
<p>The difference between this property and
<a href="prop_node_previoussibling.asp">previousSibling</a>, is that 
...
<p><strong>Tip: </strong>Use the <a href="prop_element_nextelementsibling.asp">
nextElementSibling</a> property to return the next element of the specified 
element.</p>
...
<em>node</em>.previousElementSibling</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the previous sibling of an element, or <em>null </em>if there is no previous sibling</td>
</tr>
<tr>
  <th>DOM Version</th>
