...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit type Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">type</span> Property</h1>
...
<h3>Example</h3>
<p>Find out which type of form element the Submit button is:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySubmit&quot;).type;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">submit</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_type">Try it Yourself &raquo;</a>
</div>
<hr>
