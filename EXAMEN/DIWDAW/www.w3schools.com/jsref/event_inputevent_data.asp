...
<h1>InputEvent <span class="color_h1">data</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return the input data from a text field:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var x = event.data;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_inputevent_data" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">data</code> property returns the character that 
was inserted with the event.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A 
  String, indicating which character that was inserted</td>
</tr>
</table>
