...
<h3>Example</h3>
<p>Get the browser's engine name:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_product">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> This property may not work as expected: All browsers 
returns &quot;Gecko&quot;.</p>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the engine name of the browser</td>
</tr>
</table>
