...
<html lang="en-US">
<head>
<title>HTML DOM Input Reset form Property</title>
 <meta charset="utf-8">
...
<h1>Input Reset <span class="color_h1">form</span> Property</h1>
<p><a href="dom_obj_reset.asp" class="w3-btn w3-white w3-border" title="Input Reset Object Reference">&#10094; Input Reset Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the id of the form containing the &lt;input type="reset"&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reset_form">Try it Yourself &raquo;</a>
</div>
<hr>
