...
<a target="_blank" href="tryit.asp?filename=tryjsref_ceil" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the nearest integer when rounding upwards</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_ceil2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
