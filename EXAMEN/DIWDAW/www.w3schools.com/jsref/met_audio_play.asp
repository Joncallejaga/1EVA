...
<html lang="en-US">
<head>
<title>HTML DOM Audio play() Method</title>
<meta charset="utf-8">
...
<h1>Audio <span class="color_h1">play()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 ...
 <br>&nbsp;&nbsp;&nbsp; x.pause(); <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_play" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The play() method starts playing the current audio.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="met_audio_pause.asp">pause()</a> method.</p>
<p><strong>Tip:</strong> Use the <a href="prop_audio_controls.asp">controls</a> 
property to display audio controls (like play, pause, seeking, volume, etc, 
attached on the audio).</p>
<hr>
