...
<html lang="en-US">
<head>
<title>HTML DOM Input Color type Property</title>
 <meta charset="utf-8">
...
<h1>Input Color <span class="color_h1">type</span> Property</h1>
<p><a href="dom_obj_color.asp" class="w3-btn w3-white w3-border" title="Input Color Object Reference">&#10094; Input Color Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out which type of form element the color picker is:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myColor&quot;).type;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">color</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_color_type">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The type property returns which type of form element the color picker is.</p>
<p>For a color picker this property will always return &quot;color&quot;.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>colorObject</em>.type
</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of form element the color picker is</td>
  </tr>
</table>
