...
<html lang="en-US">
<head>
<title>HTML DOM Area origin Property</title>
 <meta charset="utf-8">
...
<h1>Area <span class="color_h1">origin</span> Property</h1>
<p><a href="dom_obj_area.asp" class="w3-btn w3-white w3-border" title="Area Object Reference">&#10094; Area Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the protocol, hostname and port number of the URL for a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;venus&quot;).origin;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com:80</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_origin" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The origin property returns the protocol, hostname and port number of the 
href attribute value.</p>
<p>The href attribute specifies the destination of a link in an area.</p>
<p><strong>Note:</strong> If the port number is not specified in the URL (or if it 
...
<div class="w3-code w3-border notranslate"><div>
 <em>areaObject</em>.origin</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the protocol (including ://), the domain name (or IP address) and port number (including the colon sign (:) of the URL. For URL's using the file: protocol, the return value differs between browsers</td>
</tr>
</table>
...
<h2>Related Pages</h2>
<p>JavaScript reference: <a href="prop_loc_origin.asp">location.origin Property</a></p>
<hr>
