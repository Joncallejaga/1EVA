...
<a target="_blank" href="tryit.asp?filename=tryjsref_onerror" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> When used on audio/video media, related events that occurs when there is some kind of 
disturbance to the media loading process, are:</p>
<ul>
  <li><a href="event_onabort_media.asp">onabort</a></li>
  <li>onemptied</li>
  <li><a href="event_onstalled.asp">onstalled</a></li>
  <li><a href="event_onsuspend.asp">onsuspend</a></li>
</ul>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onerror=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onerror_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onerror = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onerror_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;error&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onerror_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
