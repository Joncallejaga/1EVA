...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_loc_reload">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>By default, the reload() method reloads the page from the cache, but you can force 
it to reload the page from the server by setting the <em>forceGet</em> parameter to
...
<ul>
  ...
  <li>true - Reloads the current page from the server</li>
</ul>
  </td>
</tr>
</table>
