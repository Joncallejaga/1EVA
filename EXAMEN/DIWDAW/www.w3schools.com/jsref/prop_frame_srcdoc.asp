...
<html lang="en-US">
<head>
<title>HTML DOM IFrame srcdoc Property</title>
 <meta charset="utf-8">
...
<h1>IFrame <span class="color_h1">srcdoc</span> Property</h1>
<p><a href="dom_obj_frame.asp" class="w3-btn w3-white w3-border" title="IFrame Object Reference">&#10094; IFrame Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the HTML content that is shown in an iframe:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myFrame&quot;).srcdoc = &quot;&lt;p&gt;Some new content inside the iframe!&lt;/p&gt;&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_iframe_srcdoc2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The srcdoc property sets or returns the value of the srcdoc attribute in an iframe element.</p>
<p>The srcdoc attribute specifies the HTML content of the page to shown in the 
inline frame.</p>
<p><strong>Tip:</strong> This attribute is expected to be used together with the 
sandbox and seamless attributes.</p>
<p>If a browser supports the srcdoc attribute, it will override the content 
specified in the src attribute (if present).</p>
<p>If a browser does NOT support the srcdoc attribute, it will show the file 
specified in the src attribute instead (if present).</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the srcdoc property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>iframeObject</em>.srcdoc</div></div>
<p>Set the srcdoc property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>iframeObject</em>.srcdoc =<em> HTML_code</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>
 Specifies the HTML content to show in the iframe. Must be valid HTML syntax</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the HTML content that is shown in the iframe (if any)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the HTML content that is shown in an iframe:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFrame&quot;).srcdoc;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Hello world!</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_iframe_srcdoc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_iframe_srcdoc.asp">HTML &lt;iframe&gt; srcdoc attribute</a></p>
<hr>

<a href="dom_obj_frame.asp" class="w3-btn w3-white w3-border" title="IFrame Object Reference">&#10094; IFrame Object</a>
</div>
