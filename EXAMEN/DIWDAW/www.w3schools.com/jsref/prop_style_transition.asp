...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_transition">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The transition property is a shorthand property for the four transition properties:</p>
<p>transitionProperty, transitionDuration, transitionTimingFunction, and transitionDelay.</p>
<p><b>Note:</b> Always specify the transitionDuration property, otherwise the duration is 0,
and the transition will have no effect.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>10.0</td>
    <td>16.0</td>
    <td>6.1<br>3.1&nbsp;WebkitTransition</td>
    <td>12.1</td>
  </tr>
</table>
<hr>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_transition.asp">transition property</a></p>
<hr>
