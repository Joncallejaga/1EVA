...
<h1>Audio <span class="color_h1">ended</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio has ended:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).ended;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_ended" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ended property returns whether the playback of the audio has ended.</p>
<p>An audio has ended when the playback position is at the end of the audio.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.ended</div></div>
