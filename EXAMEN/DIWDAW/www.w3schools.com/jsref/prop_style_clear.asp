...
document.getElementById(&quot;myP&quot;).style.clear = &quot;left&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_clear">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Allows floating objects on both sides of the element. This is  default</td>
  </tr>
  <tr>
    <td>left</td>
  ...
  <tr>
    <td>both</td>
    <td>No floating objects allowed on either the left or right side of the  element</td>
  </tr>
  <tr>
    <td>initial</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing the position of an element relative to floating objects</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS1</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_clear2">Try it Yourself &raquo;</a>
</div>
<hr>
