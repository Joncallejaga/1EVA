...
<html lang="en-US">
<head>
<title>HTML DOM Node firstChild Property</title>
<meta charset="utf-8">
...
<h3>Example</h3>
 <p>Get the HTML content of the first child node of an &lt;ul&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myList&quot;).firstChild.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Coffee</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_firstchild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The difference between this property and
<a href="prop_element_firstelementchild.asp">firstElementChild</a>, is that 
...
the first child node as an element node (ignores text and comment nodes).</p>
<p><strong>Note:</strong> Whitespace inside elements is considered as text, and 
text is considered as nodes (See &quot;More Examples&quot;).</p>
<p>This property is read-only.</p>
<p><strong>Tip: </strong>Use the <a href="prop_node_childnodes.asp"><em>element</em>.childNodes</a> 
property to return any child node of a specified node. childNodes[0] will 
produce the same result as firstChild.</p>
<p><strong>Tip:</strong> To return the last child node of a specified node, use 
the <a href="prop_node_lastchild.asp">lastChild</a> property.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the first child of a node, or <em>null </em>if there are no child nodes</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>In this example, we demonstrate how whitespace may interfere with this property.</p>
 <p>Get the node name of the first child node of a &lt;div&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;!-- <br>Whitespace inside elements is considered as text, and text is considered as nodes<br>In this example, there is whitespace before &lt;p&gt;, before &lt;span&gt; and after &lt;span&gt;<br>Therefore, the first child node of &lt;div&gt; is a #text node, and not the &lt;p&gt; element you expected <br>--&gt;<br><br>&lt;div id=&quot;myDIV&quot;&gt;<br>&nbsp; &lt;p&gt;Looks like first child&lt;/p&gt;<br>&nbsp; &lt;span&gt;Looks like last Child&lt;/span&gt;<br>&lt;/div&gt;<br><br>
 &lt;script&gt;<br>var x = document.getElementById(&quot;myDIV&quot;).firstChild.nodeName;<br>document.getElementById(&quot;demo&quot;).innerHTML = x; <br>&lt;/script&gt;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 #text</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_firstchild2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>However, if we remove the whitespace from the source, there are no #text 
nodes in &lt;div&gt;, which will make the &lt;p&gt; element the first child node:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;div id=&quot;myDIV&quot;&gt;&lt;p&gt;First child&lt;/p&gt;&lt;span&gt;Last Child&lt;/span&gt;&lt;/div&gt;<br><br>
 &lt;script&gt;<br>var x = document.getElementById(&quot;myDIV&quot;).firstChild.nodeName;<br>document.getElementById(&quot;demo&quot;).innerHTML = x;<br>&lt;/script&gt;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 P</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_firstchild3">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the first child node of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).firstChild.text;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Audi</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_firstchild4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_node_lastchild.asp"><em>node.</em>lastChild Property</a></p>
<p>HTML DOM reference: <a href="prop_node_childnodes.asp"><em>node.</em>childNodes Property</a></p>
<p>HTML DOM reference: <a href="prop_node_parentnode.asp"><em>node.</em>parentNode Property</a></p>
<p>HTML DOM reference: <a href="prop_node_nextsibling.asp"><em>node.</em>nextSibling Property</a></p>
<p>HTML DOM reference: <a href="prop_node_previoussibling.asp"><em>node.</em>previousSibling Property</a></p>
<p>HTML DOM reference: <a href="prop_node_nodename.asp"><em>node.</em>nodeName Property</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
