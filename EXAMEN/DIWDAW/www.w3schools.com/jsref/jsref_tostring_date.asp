...
<a target="_blank" href="tryit.asp?filename=tryjsref_tostring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The toString() method converts a Date object to a string.</p>
<p><b>Note:</b> This method is automatically called by JavaScript whenever a Date object needs to be displayed as a string.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the date and time as a string</td>
</tr>
<tr>
