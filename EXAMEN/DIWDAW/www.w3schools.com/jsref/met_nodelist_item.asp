...
<h3>Example</h3>
 <p>Get the HTML content of the first &lt;p&gt; element (index 0) inside the document:</p>
 <div class="w3-code notranslate jsHigh">
  var nodelist = document.getElementsByTagName(&quot;P&quot;).item(0).innerHTML;</div>
<!--<p>The result of <em>nodelist</em> will be:</p>
<div class="w3-code notranslate">
 The first p element in the document.</div>-->
<a target="_blank" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item_doc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The item() method returns a node at the specified index in a NodeList object.</p>
<p>The nodes are sorted as they appear in the source code, and the index starts 
at 0.</p>
<p>A Node object's collection of child nodes is an example of a NodeList object.</p>
<p><strong>Note:</strong> There are two ways to access a node at the specified index in a node list:</p>
<div class="w3-example">
<h3>This syntax:</h3>
<div class="w3-code notranslate jsHigh">document.body.childNodes.item(0);&nbsp;&nbsp;&nbsp; // The first child node of &lt;body&gt;<a target="_blank" class="w3-btn btnsmall" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item">Try it</a></div>
</div>
<br>
<div class="w3-example">
<h3>Will produce the same result as this syntax:</h3>
<div class="w3-code notranslate jsHigh">document.body.childNodes[0];&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; // The first child node of &lt;body&gt;<a target="_blank" class="w3-btn btnsmall" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item2">Try it</a></div>
</div>
<p>You can use whatever method you like, however, the most common method is [<em>index</em>].</p>
<p><strong>Tip:</strong> Use the <a href="prop_nodelist_length.asp">length</a> 
property to return the number of nodes in a NodeList object.</p>
<hr>
...
<i>nodelist</i>.item(<em>index</em>)<br><br>
 <strong>or simply:</strong><br><br>
<i>nodelist</i>[<i>index</i>]</div></div>
...
<td><em>index</em></td>
<td>Number</td>
<td>Required. The index of the node you want to return, in the node list.<br>
<br><strong>Note:</strong> The index starts at 0</td>
</tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the node at the specified index.<br><br>
 <strong>Note:</strong> Returns <em>null</em> if the index number is out of range</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Get the HTML content of the first &lt;p&gt; element (index 0) inside a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);<br>var nodelist = div.getElementsByTagName(&quot;P&quot;)[0].innerHTML;</div>
<!--<p>The result of <em>nodelist</em> will be:</p>
<div class="w3-code notranslate">
 First p element in div.</div>-->
<a target="_blank" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item_p" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Change the HTML content of the first &lt;p&gt; element (index 0) inside a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);<br>div.getElementsByTagName(&quot;P&quot;)[0].innerHTML = &quot;Paragraph changed&quot;;</div>
<a target="_blank" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item_p2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all elements with class=&quot;child&quot; in a &lt;div&gt; element, and change their background color:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);<br>var nodelist = div.getElementsByClassName(&quot;child&quot;);<br><br>var i;<br>for (i = 0; i &lt; nodelist.length; i++) {<br>&nbsp;&nbsp;&nbsp; nodelist[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" href="https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM Reference: <a href="prop_nodelist_length.asp"><em>nodelist</em>.length Property</a></p>
<p>HTML DOM Reference: <a href="prop_node_childnodes.asp"><em>element</em>.childNodes Property</a></p>
<p>HTML DOM Reference: <a href="met_element_getelementsbyclassname.asp"><em>element</em>.getElementsByClassName() Method</a></p>
<p>HTML DOM Reference: <a href="met_element_getelementsbytagname.asp"><em>element</em>.getElementsByTagName() Method</a></p>
<p>HTML DOM Reference: <a href="met_element_queryselectorall.asp"><em>element</em>.querySelectorAll() Method</a></p>
<p>HTML DOM Reference: <a href="met_document_getelementsbyclassname.asp">document.getElementsByClassName() Method</a></p>
<p>HTML DOM Reference: <a href="met_doc_getelementsbyname.asp">document.getElementsByName() Method</a></p>
<p>HTML DOM Reference: <a href="met_document_getelementsbytagname.asp">document.getElementsByTagName() Method</a></p>
<p>HTML DOM Reference: <a href="met_document_queryselectorall.asp">document.querySelectorAll() Method</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
