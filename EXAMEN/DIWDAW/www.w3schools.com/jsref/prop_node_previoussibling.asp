...
<h3>Example</h3>
 <p>Get the HTML content of the previous sibling of a list item:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;item2&quot;).previousSibling.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Coffee (first li)</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_previoussibling" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="prop_element_previouselementsibling.asp">previousElementSibling</a>, is that 
previousSibling returns 
the previous sibling node as an element node, a text node or a comment node, while 
previousElementSibling returns the previous sibling node as an element node (ignores text and comment nodes).</p>
<p>This property is read-only.</p>
<p><strong>Tip: </strong>Use the <a href="prop_node_nextsibling.asp">nextSibling</a> 
property to return the next node of the specified node, in the same tree level.</p>
<p><strong>Tip: </strong>Use the <a href="prop_node_childnodes.asp">childNodes</a> 
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the previous sibling of the node, or <em>null </em>if there is no previous sibling</td>
</tr>
<tr>
  <th>DOM Version</th>
