...
<h1>Embed <span class="color_h1">width</span> Property</h1>
<p><a href="dom_obj_embed.asp" class="w3-btn w3-white w3-border" title="Embed Object Reference">&#10094; Embed Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the width of an embedded file to 500 pixels:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myEmbed&quot;).width = &quot;500&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_embed_width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The width property sets or returns the value of the width attribute in an &lt;embed&gt; element.</p>
<p>The width attribute specifies the width of the embedded content, in pixels.</p>
<p><strong>Tip:</strong> Use the <a href="prop_embed_height.asp">height</a> property to set or return the value of the height attribute in an &lt;embed&gt; element.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>embedObject</em>.width</div></div>
<p>Set the width property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>embedObject</em>.width = <em>pixels</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>pixels</em></td>
    <td>
 Specifies the width of the embedded content in pixels (e.g. width=&quot;100&quot;)</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of the embedded content, in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the width of an embedded file:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myEmbed&quot;).width;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 200</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_embed_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_embed_width.asp">HTML &lt;embed&gt; width attribute</a></p>
<hr>
