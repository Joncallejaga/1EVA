...
<html lang="en-US">
<head>
<title>HTML DOM Input FileUpload disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input FileUpload <span class="color_h1">disabled</span> Property</h1>

<p><a href="dom_obj_fileupload.asp" class="w3-btn w3-white w3-border" title="Input FileUpload Object Reference">&#10094; Input FileUpload Object</a></p>
...
-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a file upload button should be disabled, or not.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a  file upload button  should be disabled or not.
  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the file upload button is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_disabled">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myFile&quot;).disabled = true;<br>
 }<br><br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myFile&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>
