...
<div class="w3-code notranslate jsHigh">
 ...
 document.getElementById("myDIV").style.animationName = "myNEWmove";</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_animationname">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_animation-name.asp">animation-name property</a></p>
<hr>
