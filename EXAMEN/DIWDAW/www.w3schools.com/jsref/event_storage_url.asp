...
<h1><span class="color_h1">storage</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a function whenever there is a change in the window's storage area:</p>
<div class="w3-code notranslate jsHigh">
  window.addEventListener(&quot;storage&quot;, myFunction);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_storage_storage" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The storage event occurs when there is a change in the window's change area.</p>
...
<div class="w3-code w3-border notranslate"><div>
  window.addEventListener(&quot;storage&quot;, myScript);</div></div>
