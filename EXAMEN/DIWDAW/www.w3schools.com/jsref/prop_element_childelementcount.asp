...
<html lang="en-US">
<head>
<title>HTML DOM childElementCount Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">childElementCount</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Find out how many child elements a &lt;div&gt; element has:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;myDIV&quot;).childElementCount;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_childelementcount" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The childElementCount property returns the number of child elements an 
element has.</p>
<p><strong>Note:</strong> The returned value contains the number of child 
<strong>element</strong> nodes, not the number of all child nodes (like text and comment nodes).</p>
...
<p><strong>Tip:</strong> The childElementCount property will produce the same 
result as <em>element</em>.children.length.</p>
<hr>
...
<em>node</em>.childElementCount</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of child elements of an element</td>
</tr>
<tr>
  <th>DOM Version</th>
