...
<h1>Video <span class="color_h1">textTracks</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).textTracks.length;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_texttracks" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The textTracks property returns a TextTrackList object.</p>
<p>The TextTrackList object represents the available text tracks for the video.</p>
<p>Each available text track is represented by a TextTrack Object.</p>
<hr>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.textTracks</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the available text tracks for the the video.<p>
 TextioTrackList Object:</p>
 <ul>
    <li>length - get the number of text tracks available in the video</li>
