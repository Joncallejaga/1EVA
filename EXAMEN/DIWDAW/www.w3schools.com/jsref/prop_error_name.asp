...
<html lang="en-US">
<head>
<title>JavaScript Error name Property</title>
<meta charset="utf-8">
...
<h1>JavaScript Error <span class="color_h1">name</span> Property</h1>
<p><a href="jsref_obj_error.asp" class="w3-btn w3-white w3-border" title="JavaScript Error Reference">&#10094; JavaScript Error Reference</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the error name (we have written &quot;alert&quot; as &quot;adddlert&quot; to 
deliberately produce an error):</p>
<div class="w3-code notranslate jsHigh">
 try {<br>&nbsp;&nbsp;&nbsp; adddlert(&quot;Welcome guest!&quot;);<br>}<br>catch(err) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = err.name;<br>}</div>
<!--<p>The result would be:</p>
<div class="w3-padding w3-white notranslate">
 ReferenceError</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_error_name" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property sets or returns the name of an error.</p>
<p>Six different values can be returned by the error name property:</p>
<table class="w3-table-all">
<tr><th>Error Name</th><th>Description</th><th style="width:10%">Try it</th></tr>
<tr><td>EvalError</td><td>An error has occurred in the eval() function. <strong>Note:</strong> Newer versions of JavaScript does not throw any EvalError. Use <strong>SyntaxError</strong> instead.</td><td>&nbsp;</td></tr>
<tr><td>RangeError</td><td>A number &quot;out of range&quot; has occurred</td><td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjsref_error_range">Try it &raquo;</a></td></tr>
<tr><td>ReferenceError</td><td>An illegal reference has occurred</td><td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjsref_error_reference">Try it &raquo;</a></td></tr>
<tr><td>SyntaxError</td><td>A syntax error has occurred</td><td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjsref_error_syntax">Try it &raquo;</a></td></tr>
<tr><td>TypeError</td><td>A type error has occurred</td><td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjsref_error_type">Try it &raquo;</a></td></tr>
<tr><td>URIError</td><td>An error in encodeURI() has occurred</td><td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjsref_error_uri">Try it &raquo;</a></td></tr>
</table>
<p><strong>Tip:</strong> Also see the <a href="prop_error_message.asp">message</a> property of the Error object.</p>
<hr>
...
<i>errorObj</i>.name</div></div>

<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the name of the error</td>
</tr>
<tr>
...
<hr>
<a href="jsref_obj_error.asp" class="w3-btn w3-white w3-border" title="JavaScript Error Reference">&#10094; JavaScript Error Reference</a>
</div>
