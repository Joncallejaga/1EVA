...
<a href="obj_pagetransitionevent.asp" class="w3-btn w3-white w3-border" title="PageTransitionEvent">&#10094; PageTransitionEvent</a>
</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_onpageshow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
cached, you can use the <a href="event_pagetransition_persisted.asp">persisted</a> property of the PageTransitionEvent object. 
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onpageshow=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onpageshow_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onpageshow = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onpageshow_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;pageshow&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onpageshow_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><p><strong>Note:</strong> The <a href="met_element_addeventlistener.asp">addEventListener()</a> method is not supported in Internet Explorer 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_onpageshow_persisted">Try it Yourself &raquo;</a>
</div>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
