...
<h1><span class="color_h1">onpagehide</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the user is navigating away from a webpage:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;body onpagehide=&quot;myFunction()&quot;&gt;</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The onpagehide event occurs when the user is navigating away from a webpage.</p>
<p>There are several ways to navigate away from a page. E.g. by clicking on a link, refreshing the page, submitting a form, closing the browser window, etc.</p>
<p>The onpagehide event is sometimes used instead of the 
<a href="event_onunload.asp">onunload</a> event, as 
the onunload event causes the page to not be cached.</p>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onpagehide=&quot;<i>myScript</i>&quot;&gt;</div></div>
<div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onpagehide = function(){<i>myScript</i>};
 </div></div>
<div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;pagehide&quot;, <em>myScript</em>);</div></div>
