...
<!DOCTYPE html>
<html lang="en-US">
<head><title>The MouseEvent</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">MouseEvent</span></h1>
<p>
...
<h2>The MouseEvent Object</h2>
<p>Events that occur when the mouse interacts with the HTML document belongs to the MouseEvent Object.</p>
<hr>
<h2>MouseEvent Properties and Methods</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Returns true if the specified key is activated</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="event_offsetx.asp">offsetX</a></td>
    <td>Returns the horizontal coordinate of the mouse pointer relative to the 
    position of the edge of the target element</td>
  </tr>
  <tr>
    <td><a href="event_offsety.asp">offsetY</a></td>
    <td>Returns the vertical coordinate of the mouse pointer relative to the 
    position of the edge of the target element</td>
  </tr>
  <tr>
...
<p>The MouseEvent inherits all the properties and methods from:</p>
<p><a href="obj_uievent.asp">The UiEvent</a></p>
<p><a href="obj_event.asp">The Event Object</a></p>
<hr>

<h2>Event Types</h2>
<p>These event types belongs to the MouseEvent Object: </p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
  <td><a href="event_onmouseenter.asp">onmouseenter</a></td>
  <td>The event occurs when the pointer is moved onto an element</td>
  </tr>
  <tr>
  <td><a href="event_onmouseleave.asp">onmouseleave</a></td>
