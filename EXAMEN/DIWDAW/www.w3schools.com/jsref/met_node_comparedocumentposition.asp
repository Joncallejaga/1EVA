...
<h3>Example</h3>
 <p>Find out where one paragraph is positioned compared to another paragraph:</p>
<div class="w3-code notranslate jsHigh">
 var p1 = document.getElementById(&quot;p1&quot;);<br>
 var p2 = document.getElementById(&quot;p2&quot;);<br> 
 var x = p1.compareDocumentPosition(p2);</div>
 <!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
4</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_compdocpos" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">compareDocumentPosition()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
