...
<html lang="en-US">
<head>
<title>HTML DOM console.info() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.info()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Write a message to the console:</p>
<div class="w3-code notranslate jsHigh">
console.info("Hello world!");</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_info" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.info() method writes a message to the console.</p>
<p><strong>Tip:</strong> When testing the console methods, be sure to have the console 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.info()</td>
    <td>Yes</td>
    <td>8.0</td>
    <td>4.0</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.info(<em>message</em>)</div>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using an object as the message:</p>
<div class="w3-code notranslate jsHigh">
var myObj = { firstname : "John", lastname : "Doe" };<br>
console.info(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_info2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using an array as the message:</p>
<div class="w3-code notranslate jsHigh">
var myArr = ["Orange", "Banana", "Mango", "Kiwi" ];<br>
console.info(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_info3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
