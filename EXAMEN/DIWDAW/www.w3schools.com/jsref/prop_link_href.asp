...
<h3>Example</h3>
<p>Return the URL of the linked document:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLink&quot;).href;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
https://www.w3schools.com/jsref/styles.css</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_link_href" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the linked document. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_link_href2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_link_href.asp">HTML &lt;link&gt; href attribute</a></p>
<hr>
