...
<html lang="en-US">
<head>
<title>HTML DOM TableRow deleteCell() Method</title>
 <meta charset="utf-8">
...
<h1>TableRow <span class="color_h1">deleteCell()</span> Method</h1>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_tr_deletecell" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The deleteCell() method deletes a cell in the current table row.</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_insertcell.asp">insertCell()</a> method to 
insert a cell in the 
current table row.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deleteCell()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>tablerowObject</em>.deleteCell(<i>index</i>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required in Firefox and Opera, optional in IE, Chrome and Safari. An integer (starts at 0) that specifies the position of the cell to delete in the current row.  The value of 0 results in that the first cell will be deleted.  The value of -1 can also be used; which result in that the last cell will be deleted.<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_deletecell2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_deletecell3">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_deletecell4">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_insertcell">Try it Yourself &raquo;</a>
</div>
<hr>
