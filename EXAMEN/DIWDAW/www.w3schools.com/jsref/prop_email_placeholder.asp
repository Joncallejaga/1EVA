...
<html lang="en-US">
<head>
<title>HTML DOM Input Email placeholder Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">placeholder </span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the placeholder text of an email field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).placeholder = &quot;Your Email address&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_placeholder">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The placeholder property sets or returns the value of the placeholder attribute of an 
email field.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.placeholder</div></div>
<p>Set the placeholder property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.placeholder = <em>text</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a short hint (one word or a short phrase) that describes the  expected value of the email field</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a short hint that describes the expected value of the email field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the placeholder text of an email field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).placeholder;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Email</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_placeholder2">Try it Yourself &raquo;</a>
</div>
<hr>
