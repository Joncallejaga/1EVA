...
<html lang="en-US">
<head>
<title>HTML DOM Input FileUpload multiple Property</title>
 <meta charset="utf-8">
...
<h1>Input FileUpload <span class="color_h1">multiple</span> Property</h1>
<p><a href="dom_obj_fileupload.asp" class="w3-btn w3-white w3-border" title="Input FileUpload Object Reference">&#10094; Input FileUpload Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a user can select more than one file with the file upload button:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFile&quot;).multiple;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_multiple">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The multiple property sets or returns whether more than one file can be 
selected with the file upload button.</p>
<p>When set to true, it specifies that the user is allowed to select more than 
one file.</p>
<p>This property reflects the HTML multiple attribute.</p>
<p><strong>Tip:</strong> To select multiple files, hold down the CTRL or SHIFT 
key while selecting.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>fileuploadObject</em>.multiple</div></div>
<p>Set the multiple property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>fileuploadObject</em>.multiple = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether more than one file can be selected with the file  upload button
  <ul>
      <li>true - The file upload button accept multiple selection of files</li>
      <li>false - Default. The file upload button does not accept multiple   files</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if more than one file can be selected with the file upload button, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Allow the user to select multiple files:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).multiple = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_multiple2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_multiple.asp">HTML &lt;input&gt; multiple attribute</a></p>
<hr>

<a href="dom_obj_fileupload.asp" class="w3-btn w3-white w3-border" title="Input FileUpload Object Reference">&#10094; Input FileUpload Object</a>
</div>
