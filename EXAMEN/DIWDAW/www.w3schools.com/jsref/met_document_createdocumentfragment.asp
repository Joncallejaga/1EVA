...
<a target="_blank" href="tryit.asp?filename=tryjsref_document_createdocfrag" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A DocumentFragment object, representing the created DocumentFragment node</td>
  </tr>
<tr>
