...
<html lang="en-US">
<head>
<title>type Event Property</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">type</span> Event Property</h1>
<p>
...
<h3>Example</h3>
<p>Return the type of event that was triggered:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.type;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_type" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The type event property returns the type of the triggered event.</p>
<hr>
...
<em>event</em>.type</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the type of the event</td>
  </tr>
  <tr>
