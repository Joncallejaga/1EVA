...
<h1>HTML DOM <span class="color_h1">firstElementChild</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the HTML content of the first child element of an &lt;ul&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myList&quot;).firstElementChild.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Coffee</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_firstelementchild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The firstElementChild property returns the first child element of the specified 
element.</p>
<p>The difference between this property and
<a href="prop_node_firstchild.asp">firstChild</a>, is that firstChild returns 
...
produce the same result as firstElementChild.</p>
<p><strong>Tip:</strong> To return the last child element of a specified element, use 
the <a href="prop_element_lastelementchild.asp">lastElementChild</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.firstElementChild</div></div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the first child element of an element, or <em>null </em>if there are no child elements</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the tag name of the first child element of a &lt;div&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
 var x = document.getElementById(<span style="color:mediumblue;">&quot;myDIV&quot;</span>).firstElementChild.tagName;<br>document.getElementById(&quot;demo&quot;).innerHTML = x;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 P</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_element_firstelementchild2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the first element node of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).firstElementChild.text;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Audi</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_firstelementchild3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
