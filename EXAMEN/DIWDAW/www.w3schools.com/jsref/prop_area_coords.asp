...
<h3>Example</h3>
<p>Get the coordinates for a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;venus&quot;).coords;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 124,58,8</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_coords" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The coords attribute is used together with the shape attribute to specify the 
size, shape, and placement of an area.</p>
<p><b>Tip:</b> The coordinates of the top-left corner of an area are 0,0.</p>
<p><strong>Tip:</strong> Use the <a href="prop_area_shape.asp">shape</a> 
property to set or return the value of the shape attribute of an area.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>If the shape attribute is set to &quot;poly&quot;, it specifies the coordinates of the edges of the polygon. If the first and last coordinate pairs are not the same, the browser must add the last coordinate pair to close the polygon</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a comma-separated list of coordinates</td>
</tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_area_coords2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_area_coords.asp">HTML &lt;area&gt; coords attribute</a></p>
<hr>
