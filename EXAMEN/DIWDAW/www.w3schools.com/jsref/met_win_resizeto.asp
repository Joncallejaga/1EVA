...
<h3>Example</h3>
<p>Open a new window, and set its width and height to 250px:</p>
<div class="w3-code notranslate jsHigh">
 function openWin() {<br>&nbsp;&nbsp;&nbsp; myWindow = window.open(&quot;&quot;, &quot;&quot;, &quot;width=100, height=100&quot;);&nbsp; // Opens a new window<br>}<br><br>function resizeWin() {<br>&nbsp;&nbsp;&nbsp; myWindow.resizeTo(250, 250);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Resizes the new window<br>
 &nbsp;&nbsp;&nbsp;
 myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Sets focus to the new window<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_resizeto" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
