...
<a target="_blank" href="tryit.asp?filename=tryjsref_table_deleterow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deleteRow()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required in Firefox and Opera, optional in IE, Chrome and Safari. An integer that specifies the position of the row to delete (starts  at 0). The value of 0 results in that the first row will be deleted.<br>
  <br>The value of -1 can also be used; which result in that the last  row will be deleted.<br>
  <br>
  This parameter is required in Firefox and Opera, but optional in Internet  Explorer, Chrome and Safari.<br>
  <br>
  If this parameter is omitted, deleteRow() removes the last row in IE and  the first row in Chrome and Safari.</td>
  </tr>
</table>
<hr>
...
<div class="w3-code notranslate jsHigh">
 function deleteRow(r) {<br>&nbsp;&nbsp;&nbsp; var i = r.parentNode.parentNode.rowIndex;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTable&quot;).deleteRow(i);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_deleterow2">Try it Yourself &raquo;</a>
</div>
