...
<h1><span class="color_h1">onwaiting</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the video stops because it needs to buffer the next 
frame:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video onwaiting=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onwaiting" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onwaiting event occurs when the video stops because it needs to buffer 
the next frame.</p>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onwaiting=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onwaiting_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onwaiting = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onwaiting_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;waiting&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onwaiting_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
