...
<html lang="en-US">
<head>
<title>HTML DOM scrollIntoView() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">scrollIntoView</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Scroll the element with id="content" into the visible area of the browser window:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementById(&quot;content&quot;);<br>
  elmnt.scrollIntoView();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_scrollintoview" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollIntoView() method scrolls the specified element into the visible area of the browser window.</p>
<hr>
...
<em>element</em>.scrollIntoView(<em>alignTo</em>)</div></div>
<h2>Parameters</h2>
...
<td><em>alignTo</em></td>
<td>Boolean</td>
<td>Optional. A boolean value that indicates the type of the align:
<p>true - the top of the element will be aligned to the top of the visible area of the scrollable ancestor</p>
<p>false - the bottom of the element will be aligned to the bottom of the visible area of the scrollable ancestor.</p>
<p>If omitted, it will scroll to the top of the element.</p>
<strong>Note:</strong> Depending on the layout of other elements, some elements may not be scrolled completely to the top or to the bottom.
</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Scroll to the top or to the bottom of an element:</p>
<div class="w3-code notranslate jsHigh">
  var elmnt = document.getElementById(&quot;content&quot;);<br><br>function scrollToTop() 
  {<br>&nbsp;&nbsp;&nbsp; elmnt.scrollIntoView(true); // Top<br>}<br><br>function scrollToBottom() {<br>&nbsp;&nbsp;&nbsp; 
  elmnt.scrollIntoView(false); // Bottom<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_scrollintoview2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
