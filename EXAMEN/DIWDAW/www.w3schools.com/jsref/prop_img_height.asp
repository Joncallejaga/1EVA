...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_height2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>This property can also return the height of an image that has been styled 
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the height of the image, in pixels</td>
  </tr>
</table>
...
<div class="w3-code notranslate">
 98</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_height" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the height of an image that has been styled with CSS:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myImg").height;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_height4">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_img_height.asp">HTML &lt;img&gt; height attribute</a></p>
<hr>
