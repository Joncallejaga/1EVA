...
<h3>Example</h3>
 <p>Add the class attribute with the value of &quot;democlass&quot; to a &lt;h1&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementsByTagName(&quot;H1&quot;)[0].setAttribute(&quot;class&quot;, &quot;democlass&quot;);</div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_element_setattribute1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The setAttribute() method adds the specified attribute to an element, and 
gives it the specified value.</p>
<p>If the specified attribute already exists, only the value is set/changed.</p>
<p><strong>Note:</strong> Although it is possible to add the style attribute 
with a value to an element with this method, it is recommended that you use 
<a href="dom_obj_style.asp">properties of the Style object</a> instead for 
inline styling, because this will not overwrite other CSS properties that may be 
specified in the style attribute:</p>
<div class="w3-example">
<h3>Bad:</h3>
<div class="w3-code notranslate jsHigh"><em>element</em>.setAttribute(&quot;style&quot;, &quot;background-color: red;&quot;);</div>
</div>

<div class="w3-example">
<h3>Good:</h3>
<div class="w3-code notranslate jsHigh"><em>element</em>.style.backgroundColor = &quot;red&quot;;</div>
</div>

<p><strong>Tip: </strong>Use the <a href="met_element_removeattribute.asp">removeAttribute()</a> method to remove an attribute from an element.</p>
<p><strong>Tip:</strong> See also the <a href="met_element_setattributenode.asp">setAttributeNode()</a> method.</p>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Change an input field to an input button:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjsref_element_setattribute" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Add a href attribute with a value of &quot;www.w3schools.com&quot; 
to an 
&lt;a&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).setAttribute(&quot;href&quot;, &quot;https://www.w3schools.com&quot;); </div>
<p>Before setting the attribute:</p>
<div class="w3-white w3-padding notranslate">
<span>Go to w3schools.com</span>
</div>
<p>After setting the attribute:</p>
<div class="w3-white w3-padding notranslate">
<a href="../index.html">Go to w3schools.com</a>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_setattribute2" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Find out if an &lt;a&gt; element has a target attribute. If so, change the value of the target attribute to "_self":</p>
<div class="w3-code notranslate jsHigh">
 // Get the &lt;a&gt; element with id="myAnchor"<br>var x = document.getElementById("myAnchor");&nbsp; <br><br>// If the &lt;a&gt; element has a target attribute, set the value to "_self"<br>if (x.hasAttribute("target")) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>&nbsp;&nbsp;&nbsp; x.setAttribute("target", "_self");<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_hasattribute2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML Tutorial: <a href="../html/html_attributes.asp">HTML Attributes</a></p>
<p>HTML DOM Reference: <a href="met_element_getattribute.asp">getAttribute() Method</a></p>
<p>HTML DOM Reference: <a href="met_element_hasattribute.asp">hasAttribute() Method</a></p>
<p>HTML DOM Reference: <a href="met_element_removeattribute.asp">removeAttribute() Method</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference">&#10094; Element Object</a></p>
</div>
