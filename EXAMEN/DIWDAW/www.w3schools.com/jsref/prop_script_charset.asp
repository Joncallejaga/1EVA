...
<html lang="en-US">
<head>
<title>HTML DOM Script src Property</title>
 <meta charset="utf-8">
...
<h1>Script <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_script.asp" class="w3-btn w3-white w3-border" title="Script Object Reference">&#10094; Script Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the character set used in an external script file:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myScript&quot;).charset</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">UTF-8</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_charset">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The charset property sets or returns the value of the charset attribute of a script.</p>
<p>The charset attribute specifies the character encoding used in an external 
script file.</p>
<p>The charset attribute is used when the character encoding in an external 
script file differs from the encoding in the HTML document.</p>
<p><strong>Note:</strong> The charset attribute is only for external scripts 
(can only be used if the src attribute is present).</p>
<hr>
...
<hr>
<h2>Syntax</h2>
<p>Return the charset property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.charset
</div></div>
<p>Set the charset property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.charset =<em> charset</em></div></div>
...
<ul>
 ...
 <p>Look at our <a target="_blank" href="https://www.w3schools.com/jsref/ref_charactersets.asp">Character-sets reference</a> for a complete list of character sets.</p>
  </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the external script file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_script_charset.asp">HTML &lt;script&gt; charset attribute</a></p>
<hr>
