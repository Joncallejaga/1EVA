...
<h1>Window <span class="color_h1">matchMedia()</span> Method</h1>
<p><a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the screen/viewport is less than or greater than 700 pixels wide:</p>
<div class="w3-code notranslate jsHigh">
 if 
(window.matchMedia(&quot;(max-width: 700px)&quot;).matches) {<br>&nbsp;&nbsp;&nbsp; /* The viewport is 
  less than, or equal to, 700 pixels wide */<br>} else {<br>&nbsp;&nbsp;&nbsp; /* The viewport is greater than 700 pixels wide */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_matchmedia" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The window.matchMedia() method returns a MediaQueryList object representing the results of the specified CSS media query string.</p>
<p>The value of the matchMedia() method can be any of the media features of the <a href="../cssref/css3_pr_mediaquery.asp">CSS @media rule</a>, like min-height, min-width, orientation, etc.</p>
<p>The <strong>MediaQueryList</strong> object has two properties and two methods:</p>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>matches</td>
    <td>Used to check the results of a query. Returns a boolean value: true if the document matches the media query list, otherwise false</td>
  </tr>
    <tr>
    <td>media</td>
    <td>A String, representing the serialized media query list</td>
  </tr>
</table>

<p>The first example on this page only runs the specified CSS media query and compares it to the current window state 
<strong>once</strong>. To use window.matchMedia() in a responsive manner, to 
make your code react to a CSS media query <strong>whenever</strong> the window 
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>addListener(<em>functionref</em>)</td>
    <td>Adds a new listener function, which is executed whenever the media 
    query's evaluated result changes</td>
  </tr>
    <tr>
    <td>removeListener(<em>functionref</em>)</td>
    <td>Removes a previously added listener function from the media query list. 
    Does nothing if the specified listener is not already in the list</td>
  </tr>
</table>
...
<i>window</i>.matchMedia(<em>mediaQueryString</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>mediaQueryString</em></td>
    <td>Required. A string representing the media query for which to return a new MediaQueryList object</td>
  </tr>
</table>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A MediaQueryList object representing the results of the specified CSS media query string.</td>
</tr>
</table>
...
<div class="w3-code notranslate jsHigh">
  ...
  <br>var x = window.matchMedia(&quot;(min-width: 700px)&quot;)<br>myFunction(x) // Call 
  listener function at run time<br>x.addListener(myFunction) // Attach listener 
  function on state changes</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_matchmedia2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
