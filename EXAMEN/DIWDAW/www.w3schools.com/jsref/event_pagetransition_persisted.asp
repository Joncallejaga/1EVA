...
<html lang="en-US">
<head>
<title>PageTransitionEvent persisted Property</title>
<meta charset="utf-8">
...
<h1>PageTransitionEvent <span class="color_h1">persisted</span> Property</h1>
<p>
...
<p>The persisted property returns a Boolean value that indicates if the webpage 
is loaded directly from the server, or if the page is cached, when an
<a href="event_onpageshow.asp">
onpageshow</a> or <a href="event_onpagehide.asp">onpagehide</a> event occurs.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">persisted</td>
    <td>Yes</td>
    <td>11.0</td>
    <td>Yes</td>
    <td>5.0</td>
...
<tr>
 ...
 <p>Possible values:</p>
 <ul>
    <li>true - The page is cached by the browser</li>
    <li>false - The page is NOT cached by the browser</li>
 </ul>
  </td>
</tr>
</table>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_onpageshow.asp">The onpageshow Event</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_pagetransitionevent.asp" class="w3-btn w3-white w3-border" title="PageTransitionEvent">&#10094; PageTransitionEvent</a>
