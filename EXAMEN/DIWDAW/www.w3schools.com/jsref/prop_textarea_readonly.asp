...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_readonly2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The readOnly property sets or returns whether the contents of a text area 
should be read-only.</p>
<p>In a read-only text area, the content cannot be changed, but a user can tab to it, or highlight and copy the content from it.</p>
<p>This property reflects the HTML readonly attribute.</p>
<p><strong>Tip: </strong>To prevent the user from interacting with the text area, use the <a href="prop_textarea_disabled.asp">disabled</a> property instead.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the text area is read-only, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_readonly">Try it Yourself &raquo;</a>
</div>
<hr>
