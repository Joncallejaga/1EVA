...
<html lang="en-US">
<head>
<title>HTML DOM scrollWidth Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">scrollWidth</span> Property</h1>
...
<p>The scrollWidth property returns the entire width of an element 
in pixels, including padding, but not the border, scrollbar or margin.</p>
<p><strong>Tip:</strong> Use the <a href="prop_element_scrollheight.asp">
scrollHeight</a> property to return the entire height of an element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.scrollWidth</div></div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the entire width (horizontally) of an element, in pixels</td>
  </tr>
</table>
