...
<h1>Video <span class="color_h1">ended</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the video has ended:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).ended;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_ended" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ended property returns whether the playback of the video has ended.</p>
<p>A video has ended when the playback position is at the end of the video.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.ended</div></div>
