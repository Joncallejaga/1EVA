...
<html lang="en-US">
<head>
<title>Window frameElement Property</title>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">frameElement</span> Property</h1>
<p><a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the current window is in an &lt;iframe&gt;. If so, change its URL to 
&quot;w3schools.com&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var frame = window.frameElement;&nbsp; // Get the &lt;iframe&gt; element of the window<br><br>if (frame) {&nbsp;&nbsp; // If the window is in an &lt;iframe&gt;, change its source<br>&nbsp;&nbsp;&nbsp; frame.src = &quot;https://www.w3schools.com/&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_frameelement">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The frameElement property returns the &lt;iframe&gt; element in which the 
current window is inserted.</p>
<p>If the document window is not placed within an &lt;iframe&gt;, the return value of this property is <em>null</em>.</p>
<p><strong>Note:</strong> This property will also work for &lt;frame&gt; elements. However, the &lt;frame&gt; element is not supported 
in HTML5.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">frameElement</td>
    <td>18.0</td>
    <td>6.0</td>
    <td>1.0</td>
    <td>Yes</td>
...
window.frameElement</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>An IFrame object, which is the host of the current window in the parent document, otherwise <em>null</em></td>
</tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="dom_obj_frame.asp">HTML DOM IFrame Object</a></p>
