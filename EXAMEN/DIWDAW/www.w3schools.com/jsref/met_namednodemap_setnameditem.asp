...
<h3>Example</h3>
 <p>Set a H1's class attribute:</p>
<div class="w3-code notranslate jsHigh">
var h = document.getElementsByTagName(&quot;H1&quot;)[0];<br>
var typ = document.createAttribute(&quot;class&quot;);<br>
typ.value = &quot;democlass&quot;;<br>
h.attributes.setNamedItem(typ);;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_setnameditem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setNamedItem() method adds the specified node to the NamedNodeMap.</p>
<p>If the node already exists, it will be replaced, and the replaced node will be the return value, otherwise the return value will be <em>null</em>.</p>
<p><strong>Tip:</strong> Instead of working with attribute nodes, you could use 
the <a href="met_element_setattribute.asp"><em>element</em>.setAttribute()</a> 
method to add an attribute with a value to an element.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the replaced node (if any), otherwise <em>null</em></td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
