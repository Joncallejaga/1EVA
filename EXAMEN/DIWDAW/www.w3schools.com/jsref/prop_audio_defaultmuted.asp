...
<h1>Audio <span class="color_h1">defaultMuted</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the audio to be muted by default:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAudio&quot;).defaultMuted = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_defaultmuted" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The defaultMuted property sets or returns whether the audio should be muted by default.</p>
...
<a href="prop_audio_muted.asp">muted</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.defaultMuted</div></div>
<p>Set the defaultMuted property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>audioObject</em>.defaultMuted = true|false</div></div>
...
<table class="w3-table-all notranslate">
 ...
 <ul>
    <li>true - Indicates that the audio is muted by default</li>
    <li>false - Default. Indicates that the audio is NOT muted by default</li>
 </ul>
   </td>
  </tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio is muted by default, otherwise it returns false</td>
</tr>
<tr>
  <th>Default Value:</th>
  <td>false</td>
