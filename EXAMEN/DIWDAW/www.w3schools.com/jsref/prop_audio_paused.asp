...
<html lang="en-US">
<head>
<title>HTML DOM Audio paused Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">paused</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the audio is paused:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).paused;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_paused" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The paused property returns whether the audio is paused.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.paused</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the audio is paused. Otherwise it returns false</td>
</tr>
</table>
