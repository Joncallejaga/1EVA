...
<a target="_blank" href="tryit.asp?filename=tryjsref_form_enctype" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing how form-data should be encoded before sending it to the server</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_enctype2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_form_enctype.asp">HTML &lt;form&gt; enctype attribute</a></p>
<hr>
