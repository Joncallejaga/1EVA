...
<html lang="en-US">
<head>
<title>HTML DOM Input Text readOnly Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">readOnly</span> Property</h1>
<p><a href="dom_obj_text.asp" class="w3-btn w3-white w3-border" title="Input Text Object Reference">&#10094; Input Text Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set a text field to read-only:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myText&quot;).readOnly = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_readonly2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the text field is read-only, otherwise it returns false</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_readonly">Try it Yourself &raquo;</a>
</div>
<hr>
