...
<html lang="en-US">
<head>
<title>WheelEvent deltaX Property</title>
<meta charset="utf-8">
...
<h1>WheelEvent <span class="color_h1">deltaX</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return whether the user scrolls left or right:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var x = event.deltaX;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_wheel_deltax" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">deltaX</code> property returns a positive value 
...
left and right, and will always return 0.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deltaX</td>
    <td>31</td>
    <td>yes</td>
    <td>17</td>
