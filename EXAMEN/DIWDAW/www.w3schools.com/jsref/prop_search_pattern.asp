...
<html lang="en-US">
<head>
<title>HTML DOM Input Search pattern Property</title>
 <meta charset="utf-8">
...
<h1>Input Search <span class="color_h1">pattern</span> Property</h1>
...
<h3>Example</h3>
<p>Get the value of the pattern attribute of a search field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySearch&quot;).pattern;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">[^'\x22]+</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_search_pattern">Try it Yourself &raquo;</a>
</div>
<hr>
...
search field.</p>
<p>The pattern attribute specifies a regular expression that the search field's 
...
<div class="w3-code w3-border notranslate"><div>
 <em>searchObject</em>.pattern</div></div>
<p>Set the pattern property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>searchObject</em>.pattern = <em>regexp</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>regexp</em></td>
    <td>
  Specifies a regular expression that the text field's value is checked  against</td>
  </tr>
</table>
