...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit formEnctype Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">formEnctype</span> Property</h1>
...
<h3>Example</h3>
<p>Find out how form-data should be encoded before submitting it to a server:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySubmit&quot;).formEnctype;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">text/plain</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_formenctype">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The formenctype attribute specifies how form-data should be encoded when 
submitting it to the server (only for forms with method=&quot;post&quot;). </p>
<p>The formenctype attribute overrides the enctype attribute of the &lt;form&gt; 
element.</p>
<p><strong>Note:</strong> The formenctype attribute is new for the &lt;input&gt; 
...
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formEnctype
</div></div>
<p>Set the formEnctype property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formEnctype = &quot;application/x-www-form-urlencoded,multipart/form-data,text/plain&quot;</div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the formenctype attribute of a submit button to &quot;application/x-www-form-urlencoded&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("mySubmit").formEnctype = &quot;application/x-www-form-urlencoded&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_submit_formenctype2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_formenctype.asp">HTML &lt;input&gt; formenctype attribute</a></p>
<hr>
