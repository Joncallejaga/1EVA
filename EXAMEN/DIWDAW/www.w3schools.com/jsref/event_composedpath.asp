...
<html lang="en-US">
<head>
<title>composedPath() Event Method</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">composedPath()</span> Event Method</h1>
<p>
...
<h3>Example</h3>
<p>What is the event flow of the current event:</p>
<div class="w3-code notranslate jsHigh">
  function func1(event) {<br>&nbsp; alert(event.composedPath());<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_composedpath" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">composedPath()</code> method returns an array 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">composedPath()</td>
    <td>53</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.composedPath()</div></div>
<h2>Parameters</h2>
...
<table class="w3-table-all">
 ...
 <th style="width:23%">Return Value:</th>
  <td>An Array of HTML elements</td>
  </tr>
  </table>
