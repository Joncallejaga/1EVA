...
<html lang="en-US">
<head>
<title>JavaScript sinh() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">sinh()</span> Method</h1>
<p><a href="jsref_obj_math.asp" class="w3-btn w3-white w3-border" title="Math Object Reference">&#10094; JavaScript Math Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the hyperbolic sine of a number:</p>
<div class="w3-code notranslate jsHigh">
Math.sinh(3);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_sinh" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The sinh() method returns the hyperbolic sine of a number.</p>
<hr>
