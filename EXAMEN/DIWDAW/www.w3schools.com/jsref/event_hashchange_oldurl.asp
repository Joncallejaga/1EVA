...
<html lang="en-US">
<head>
<title>HashChangeEvent oldURL Property</title>
<meta charset="utf-8">
...
<h1>HashChangeEvent <span class="color_h1">oldURL</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>When the hash has been changed, get the URL we navigated away from:</p>
<div class="w3-code notranslate jsHigh">
 event.oldURL;</div>
<p>The result could be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onhashchange</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_hashchange_newurl" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The oldURL property returns the URL of the document, before the hash 
(anchor part) was changed.</p>
<p>This is the URL that was navigated away from. To get the URL that was 
navigated to, use the 
<a href="event_hashchange_newurl.asp">newURL</a> 
property.</p>
<p>This property is read-only.</p>
<p><strong>Tip:</strong> To set or return the hash of a URL, use the
<a href="prop_loc_hash.asp">location.hash</a> property.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">oldURL</td>
    <td>5.0</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.oldURL</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A String, representing the URL that was navigated from</td>
</tr>
</table>
