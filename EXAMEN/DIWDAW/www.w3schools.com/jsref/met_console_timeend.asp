...
<html lang="en-US">
<head>
<title>HTML DOM console.timeEnd() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.timeEnd()</span> Method</h1>
...
<p>The console.timeEnd() method ends a timer, and writes the result in the console view.</p>
<p>This method allows you to time certain operations in your code for testing 
purposes.</p>
<p>Use the <a href="met_console_time.asp">console.time()</a> method to start the 
timer.</p>
<p>Use the <em>label</em> parameter to specify which timer to end.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.timeEnd()</td>
    <td>Yes</td>
    <td>11</td>
    <td>10</td>
    <td>4</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.timeEnd(<em>label</em>)</div>
</div>
...
<td><em>label</em></td>
<td>String</td>
<td>Optional. The name of the timer to end</td>
  </tr>
</table>
