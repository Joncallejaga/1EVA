...
<a target="_blank" href="tryit.asp?filename=tryjsref_str_big" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="marked">The big() method is not standard, and may not work as expected in all 
browsers.</span></p>
