...
<p><a href="dom_obj_table.asp" class="w3-btn w3-white w3-border" title="Table Object Reference">&#10094; Table Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many rows there are in a table:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTable&quot;).rows.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 2</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_table_rows" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="met_table_insertrow.asp">insertRow()</a> method to create a new row (&lt;tr&gt;).</p>
<p><strong>Tip:</strong> Use the <a href="met_table_deleterow.asp">deleteRow()</a> method to remove a row.</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_insertcell.asp">insertCell()</a> method to create a new cell (&lt;td&gt;).</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_deletecell.asp">deleteCell()</a> method to delete a cell.</p>
<p><strong>Tip:</strong> Use the <a href="coll_table_cells.asp">cells</a> collection to return a collection of all &lt;td&gt; or &lt;th&gt; elements in a table.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;tr&gt; elements in the collection.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;tr&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Returns the &lt;tr&gt; element from the collection with the specified id.<br><br>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;tr&gt; elements in the &lt;table&gt; element. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_rows_index">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_rows_item">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_rows_nameditem">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_rows_cells">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_tr.asp">HTML &lt;tr&gt; tag</a></p>
<p>JavaScript reference: <a href="dom_obj_tablerow.asp">HTML DOM TableRow Object</a></p>
<hr>

<a href="dom_obj_table.asp" class="w3-btn w3-white w3-border" title="Table Object Reference">&#10094; Table Object</a>
</div>
