...
<h1>InputEvent <span class="color_h1">inputType</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return the type of input the event was about:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var x = event.inputType;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_inputevent_inputType" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">inputType</code> property returns the type of change that was done by the event.</p>

<p>Possible values:</p>
"insertText"<br>
"insertReplacementText"<br>
"insertLineBreak"<br>
"insertParagraph"<br>
...
"insertFromPaste"<br>
"insertTranspose"<br>
"insertCompositionText"<br>
"insertFromComposition"<br>
"insertLink"<br>
"deleteByComposition"<br>
"deleteCompositionText"<br>
"deleteWordBackward"<br>
"deleteWordForward"<br>
"deleteSoftLineBackward"<br>
"deleteSoftLineForward"<br>
"deleteEntireSoftLine"<br>
"deleteHardLineBackward"<br>
"deleteHardLineForward"<br>
"deleteByDrag"<br>
"deleteByCut"<br>
"deleteByContent"<br>
"deleteContentBackward"<br>
"deleteContentForward"<br>
"historyUndo"<br>
"historyRedo"<br>
"formatBold"<br>
"formatItalic"<br>
"formatUnderline"<br>
"formatStrikethrough"<br>
"formatSuperscript"<br>
"formatSubscript"<br>
"formatJustifyFull"<br>
"formatJustifyCenter"<br>
"formatJustifyRight"<br>
"formatJustifyLeft"<br>
"formatIndent"<br>
"formatOutdent"<br>
"formatRemove"<br>
"formatSetBlockTextDirection"<br>
"formatSetInlineTextDirection"<br>
"formatBackColor"<br>
"formatFontColor"<br>
"formatFontName"<br>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A 
  String, indicating what kind of action that was done</td>
</tr>
</table>
<hr>
<h2>Related Pages</h2>
<p>Dom Document <a href="met_document_execcommand.asp">execCommand()</a> Method</p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_inputevent.asp" class="w3-btn w3-white w3-border" title="InputEvent">&#10094; InputEvent</a>
