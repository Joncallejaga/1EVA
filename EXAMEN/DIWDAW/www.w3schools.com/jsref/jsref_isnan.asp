...
<p><a href="jsref_obj_global.asp" class="w3-btn w3-white w3-border" title="Function Reference">&#10094; JavaScript Global Functions</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check whether a value is NaN:</p>
<div class="w3-code notranslate jsHigh">
 isNaN(123) //false<br>isNaN(-1.23) //false<br>isNaN(5-2) //false<br>isNaN(0) //false<br>isNaN('123') //false<br>isNaN('Hello') //true<br>isNaN('2005/12/12') //true<br>isNaN('') //false<br>isNaN(true) //false<br>isNaN(undefined) //true<br>isNaN('NaN') //true<br>isNaN(NaN) //true<br>isNaN(0 / 0) //true</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_isnan" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>This function is different from the Number specific
<a href="jsref_isnan_number.asp">Number.isNaN()</a> method.</p>
<p>The global isNaN() 
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Function</th>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the value is NaN, otherwise it returns false</td>
</tr>
<tr>
...
<hr>
<a href="jsref_obj_global.asp" class="w3-btn w3-white w3-border" title="Function Reference">&#10094; JavaScript Global Functions</a>
</div>
