...
<html lang="en-US">
<head>
<title>HTML DOM fullscreenEnabled() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">fullscreenEnabled()</span> Method</h1>
<p>
<a href="dom_obj_document.asp" class="w3-btn w3-white w3-border" title="Document Object Reference">&#10094; Document Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Show a &lt;video&gt; element in fullscreen mode:</p>
<div class="w3-code notranslate jsHigh">
  /* Get the element you want displayed in fullscreen */ <br>var elem = 
  document.getElementById(&quot;myvideo&quot;);<br><br>/* Function to open fullscreen mode 
  */<br>function openFullscreen() {<br>&nbsp; /* If fullscreen mode is 
  available, show the element in fullscreen */<br>&nbsp; if (document.fullscreenEnabled) 
  { <br>&nbsp;&nbsp;&nbsp; /* Show the element in fullscreen */<br>&nbsp;&nbsp;&nbsp; 
  elem.requestFullscreen();<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_document_fullscreenenabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The fullscreenEnabled() method returns a Boolean value indicating whether the document can be viewed in fullscreen mode.</p>
<p>The fullscreenEnabled() method returns true if fullscreen mode is available, otherwise false. <strong>Note:</strong> This method requires specific prefixes 
to work in different browsers (see Browser Support below).</p>
<p><strong>Tip:</strong> Use the <a href="met_element_requestfullscreen.asp"><em>element</em>.requestFullscreen()</a> method to view an element in fullscreen mode.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_exitfullscreen.asp"><em>element</em>.exitFullscreen()</a> method to cancel fullscreen mode.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the method. 
<strong>Note:</strong> Each browser requires a specific prefix (see parentheses):</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">fullscreenEnabled()</td>
    <td>45.0 (webkit)</td>
    <td>11.0 (ms)</td>
    <td>47.0 (moz)</td>
    <td>5.1 (webkit)</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using prefixes for cross-browser code:</p>
<div class="w3-code notranslate jsHigh">
  /* If fullscreen mode is available, then do something */ <br>if (<br>&nbsp; 
  document.fullscreenEnabled || /* Standard syntax */<br>&nbsp; 
  document.webkitFullscreenEnabled || /* Chrome, Safari and Opera syntax */<br>&nbsp; 
  document.mozFullScreenEnabled ||/* Firefox syntax */<br>&nbsp; 
  document.msFullscreenEnabled/* IE/Edge syntax */<br>) {<br>...<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_document_fullscreenenabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code w3-border notranslate"><div>
 document.fullscreenEnabled()</div></div>
<h2>Parameters</h2>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean value, indicating whether the document can be viewed in fullscreen mode:<br>
  
  <ul>
   <li>true - The document <strong>can</strong> be viewed in full-screen mode</li>
   <li>false - The document <strong>can not</strong> be viewed in full-screen mode</li>
 </ul></td>
  </tr>
</table>
