...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit formAction Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">formAction</span> Property</h1>
<p><a href="dom_obj_submit.asp" class="w3-btn w3-white w3-border" title="Input Submit Object Reference">&#10094; Input Submit Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the file that will process the input control when the a form 
is submitted:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySubmit&quot;).formAction;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">https://www.w3schools.com/action_page2.php</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_formaction">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The formAction property sets or returns the value of the formaction attribute 
of a submit button.</p>
<p>The formaction attribute specifies the URL of the file that will process the 
input control when the form is submitted. </p>
<p>The formaction attribute overides the action attribute of the &lt;form&gt; element.</p>
<p><strong>Note:</strong> In the example above, Internet Explorer and Opera 12 
(and earlier versions) returns &quot;action_page2.php&quot;, while Firefox, Opera 15+, 
Chrome, and Safari returns the entire URL: &quot;https://www.w3schools.com/action_page2.php&quot;.</p>
<p><strong>Note:</strong> The formaction attribute is new for the &lt;input&gt; 
element with type=&quot;submit&quot; in HTML5.</p>
<hr>
...
<hr>
<h2>Syntax</h2>
<p>Return the formAction property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formAction
</div></div>
<p>Set the formAction property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formAction = <em>URL</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>URL</em></td>
    <td>Specifies the URL of the file that will process the input control  when the form is submitted<br>
  <br><strong>
  Note:</strong> this  will override the action attribute of the &lt;form&gt; element. <p>Possible values:</p>
  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL for where to send the form-data</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the URL for where to send the form-data:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("mySubmit").formAction = &quot;/action_page2.php&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_submit_formaction2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_formaction.asp">HTML &lt;input&gt; formaction attribute</a></p>
<hr>

<a href="dom_obj_submit.asp" class="w3-btn w3-white w3-border" title="Input Submit Object Reference">&#10094; Input Submit Object</a>
</div>
