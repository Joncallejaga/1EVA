...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">columnFill</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>balance</td>
    <td>Default value. Columns are balanced. Browsers should minimize the variation in column length</td>
  </tr>
  <tr>
    <td>auto</td>
...
<p>CSS reference: <a href="../cssref/css3_pr_column-fill.asp">column-fill property</a></p>
<hr>
