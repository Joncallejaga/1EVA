...
<html lang="en-US">
<head>
<title>HTML DOM Video controller Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">controller</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the video has a media controller:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).controller;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_controller" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The controller property returns the current media controller of the video.</p>
<p>By default the &lt;video&gt; element does not have a media controller. If a media controller is specified, the controller property will return it as a MediaController object.</p>
<p><strong>Tip:</strong> Use the <a href="prop_video_controls.asp">controls</a> 
property to set or return whether a video should display standard video controls.</p>
<hr>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.controller</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the media controller of the video.<p>
 MediaController Object properties/methods:</p>
 <ul>
    <li>buffered - get the buffered ranges of the video</li>
    <li>seekable - get the seekable ranges of the video</li>
    <li>duration - get the duration of the video</li>
    <li>currentTime - get or set the current playback position of the  video</li>
    <li>paused - check if the video is paused</li>
    <li>play() - play the video</li>
    <li>pause() - pause the video</li>
    <li>played - check if the video has been played</li>
    <li>defaultPlaybackRate - get or set the default playback rate of the  video</li>
    <li>playbackRate - get or set the current playback rate of the  video</li>
    <li>volume - get or set the volume of the video</li>
    <li>muted - get or set if the video is muted</li>
 </ul>
    </td>
    </tr>
</table>
