...
<html lang="en-US">
<head>
<title>HTML DOM Link sizes Property</title>
 <meta charset="utf-8">
...
<h1>Link <span class="color_h1">sizes</span> Property</h1>
<p><a href="dom_obj_link.asp" class="w3-btn w3-white w3-border" title="Link Object Reference">&#10094; Link Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the size of the linked icon:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLink&quot;).sizes;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 16x16</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_link_sizes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The sizes property returns the value of the sizes attribute of the linked 
resource.</p>
<p>The sizes attribute specifies the sizes of icon for visual media, and is only 
used if rel=&quot;icon&quot;.</p>
<p><strong>Note:</strong> The sizes attribute is currently not supported in any 
...
<div class="w3-code w3-border notranslate"><div>
 <em>linkObject</em>.sizes</div></div>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_link_sizes.asp">HTML &lt;link&gt; sizes attribute</a></p>
<hr>
