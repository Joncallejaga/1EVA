...
<h1>HTML DOM <span class="color_h1">console.trace()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Show the trace of how the code ended up here:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; myOtherFunction();<br>}<br><br>function 
  myOtherFunction() {<br>&nbsp; console.trace();<br>}</div>
  <a target="_blank" href="tryit.asp?filename=tryjsref_console_trace" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.trace() method displays a trace that show how the code ended up 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.trace()</td>
    <td>Yes</td>
    <td>11</td>
    <td>10</td>
    <td>4</td>
