...
<h3>Example</h3>
<p>Get the language code of a link:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myAnchor").hreflang;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 us-en</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_hreflang" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies a two-letter language code that represents the language of  the linked document.</td>
  </tr>
</table>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the language of the linked document</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the language code of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").hreflang = &quot;fr&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_hreflang2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
