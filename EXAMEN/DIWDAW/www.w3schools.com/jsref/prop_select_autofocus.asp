...
<html lang="en-US">
<head>
<title>HTML DOM Select autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Select <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_select.asp" class="w3-btn w3-white w3-border" title="Select Object Reference">&#10094; Select Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a drop-down list automatically gets focus upon page load:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).autofocus;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_select_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autofocus property sets or returns whether a drop-down list should automatically get focus when the page loads, or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>selectObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>selectObject</em>.autofocus = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies whether a 
    drop-down list should get focus when the page loads, or not
  <ul>
      <li>true - The drop-down list gets focus</li>
      <li>false - Default. The drop-down list does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the drop-down list automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_select_autofocus.asp">HTML &lt;select&gt; 
autofocus attribute</a></p>
<hr>
