...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>x% y%</i></td>
    <td>The x value indicates the horizontal position and the  y value indicates the vertical position. The top left corner is 0% 0%. The right  bottom corner is 100% 100%. If you only specify one value, the other  value will be 50%.</td>
  </tr>
  <tr>
    <td><i>xpos ypos</i></td>
    <td>The x value indicates the horizontal position and the  y value indicates the vertical position. The top left corner is 0 0.  Units can be pixels (0px 0px) or any other CSS units. If you only  specify one value, the other value will be 50%. You can mix % and units</td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myDiv&quot;).style.backgroundPosition = &quot;center bottom&quot;; </div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_backgroundposition2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_backgroundposition3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_backgroundposition4">Try it Yourself &raquo;</a>
</div>
<hr>
