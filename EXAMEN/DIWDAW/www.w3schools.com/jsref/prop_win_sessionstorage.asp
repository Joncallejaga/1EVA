...
<html lang="en-US">
<head>
<title>Window sessionStorage Property</title>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">sessionStorage</span> Property</h1>
<p><a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a sessionStorage name/value pair with name=&quot;lastname&quot; and value=&quot;Smith&quot;, 
then retrieve the value of &quot;lastname&quot; and insert it into the element with 
id=&quot;result&quot;:</p>
<div class="w3-code notranslate jsHigh">
// Store<br>sessionStorage.setItem(&quot;lastname&quot;, &quot;Smith&quot;);<br>// Retrieve<br>
document.getElementById(&quot;result&quot;).innerHTML = sessionStorage.getItem(&quot;lastname&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_sessionstorage">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The localStorage and sessionStorage properties allow to save key/value pairs 
in a web browser.</p>
<p>The sessionStorage object stores data for only one session (the data is 
deleted when the browser tab is closed).</p>

<p><strong>Tip:</strong> Also look at the <a href="prop_win_localstorage.asp">localStorage</a> property which stores 
data with no expiration date. The data will not be deleted when the browser is 
closed, and will be available the next day, week, or year.</p>
<hr>
...
window.sessionStorage</div></div>

<p><strong>Syntax for SAVING data to sessionStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  sessionStorage.setItem(&quot;key&quot;, &quot;value&quot;);</div></div>

<p><strong>Syntax for READING data from sessionStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  var lastname = sessionStorage.getItem(&quot;key&quot;);</div></div>

<p><strong>Syntax for REMOVING saved data from sessionStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  sessionStorage.removeItem(&quot;key&quot;);</div></div>

<p><strong>Syntax for REMOVING ALL saved data from sessionStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  sessionStorage.clear();</div></div>

<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Storage object</td>
</tr>
</table>
...
<div class="w3-code notranslate jsHigh">
  if (sessionStorage.clickcount) {<br>&nbsp; &nbsp; sessionStorage.clickcount = Number(sessionStorage.clickcount) 
  + 1;<br>} else {<br>&nbsp;&nbsp;&nbsp; sessionStorage.clickcount = 1;<br>}<br>
  document.getElementById(&quot;result&quot;).innerHTML = &quot;You have clicked the button &quot; +<br>
  sessionStorage.clickcount + &quot; time(s) in this session.&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_sessionstorage2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
