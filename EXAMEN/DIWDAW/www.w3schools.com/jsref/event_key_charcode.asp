...
<h1>KeyboardEvent <span class="color_h1">charCode</span> Property</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
 var x = event.charCode;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_charcode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The charCode property returns the Unicode character code of the key that triggered the <a href="event_onkeypress.asp">onkeypress</a> event.</p>
<p>The Unicode character code is the number of a character (e.g. the number &quot;97&quot; 
represents the letter &quot;a&quot;).</p>
...
<p><strong>Tip:</strong> If you want to convert the Unicode value into a 
character, use the <a href="jsref_fromcharcode.asp">fromCharCode()</a> method.</p>
<p><strong>Note:</strong> If this property is used on 
<a href="event_onkeydown.asp">onkeydown</a> or <a href="event_onkeyup.asp">onkeyup</a> 
events, the returned value is always &quot;0&quot;.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Note:</strong> The charCode property is not supported in IE8 and 
earlier. However, for these browser versions, you can use the
<a href="event_key_keycode.asp">keyCode</a> property. Or, for a cross-browser 
solution, you could use the following code:</p>

<div class="w3-code w3-border notranslate jsHigh"><div>
     var x = event.charCode || event.keyCode;&nbsp;// Use either   <strong>charCode</strong> or <strong>keyCode</strong>,  depending on browser support</div></div>

<p><strong>Tip:</strong> You can also use the keyCode property to detect special keys (e.g. &quot;caps lock&quot; or arrow keys). However, both the keyCode 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">charCode</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.charCode</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing the Unicode character code</td>
</tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>A cross-browser solution to get the Unicode value of the pressed keyboard key:</p>
<div class="w3-code notranslate jsHigh">
 // Use charCode if the browser supports it, otherwise use keyCode (for IE8 and earlier)<br>var x = event.charCode || event.keyCode;<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_charcode2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Alert some text if the user presses the &quot;O&quot; key:</p>
<div class="w3-code notranslate jsHigh">
 function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; var x = event.charCode || event.keyCode;<br>&nbsp;&nbsp;&nbsp; if (x == 111 || x == 79) { // o is 111, O is 79<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert(&quot;You pressed the 'O' key!&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_charcode3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Convert the Unicode value into a character:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.charCode || evt.keyCode;&nbsp;&nbsp; // Get the Unicode value<br>
 var y = String.fromCharCode(x);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Convert the value into a character<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_charcode4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
