...
<html lang="en-US">
<head>
<title>HTML DOM Input Date min Property</title>
 <meta charset="utf-8">
...
<h1>Input Date <span class="color_h1">min</span> Property</h1>
<p><a href="dom_obj_date.asp" class="w3-btn w3-white w3-border" title="Input Date Object Reference">&#10094; Input Date Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the minimum date allowed for a date field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDate&quot;).min;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">1980-01-01</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The min property sets or returns the value of the min attribute of a date field.</p>
<p>The min attribute specifies the minimum value (date) for a date field.</p>
<p><strong>Tip:</strong> Use the min attribute together with the max attribute to create a range of legal values.</p>
<p><strong>Tip:</strong> To set or return the value of the max attribute, use the <a href="prop_date_max.asp">max</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.min</div></div>
<p>Set the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.min =<em> YYYY-MM-DD</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the minimum date allowed for the date field.<br> <br>Explanation of components:<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the minimum date allowed</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the minimum date:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDate&quot;).min = &quot;1999-01-01&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_min2">Try it Yourself &raquo;</a>
</div>
<hr>
