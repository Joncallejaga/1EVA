...
<html lang="en-US">
<head>
<title>HTML DOM Input FileUpload form Property</title>
 <meta charset="utf-8">
...
<h1>Input FileUpload <span class="color_h1">form</span> Property</h1>
...
<h3>Example</h3>
<p>Get the id of the form containing the &lt;input type="file"&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form containing the file upload button.</p>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A reference to the form element containing the file upload button. If the file upload button is not 
