...
<h3>Example</h3>
<p>Return the querystring part of a URL. Assume that the current URL is https://www.w3schools.com/submit.htm?email=someone@example.com:</p>
...
<p>The search property sets or returns the querystring part of a URL, including the question mark (?).</p>
<p>The querystring part is the part of the URL after the 
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the querystring part of a URL, including the question mark (?)</td>
</tr>
</table>
