...
<html lang="en-US">
<head>
<title>HTML DOM Input Password autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">autofocus</span> Property</h1>
...
<h3>Example</h3>
<p>Find out if a password field automatically gets focus upon page load:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The autofocus property sets or returns whether a passworld field should automatically 
...
<div class="w3-code w3-border notranslate"><div>
 <em>passwordObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>passwordObject</em>.autofocus = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a password field should get focus when the page loads,  or not
  <ul>
      <li>true - The password field gets focus</li>
      <li>false - Default. The password field does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the password field automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
