...
<h3>Example</h3>
<p>Change the URL of an image:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myImg&quot;).src = &quot;hackanm.gif&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_src2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the image. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/compman.gif</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_img_src.asp">HTML &lt;img&gt; src attribute</a></p>
<hr>
