...
<div class="w3-code notranslate">
 stylesheet</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_link_rel" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>alternate</td>
    <td>Linked page is an alternative version of the current  document</td>
  </tr>
  <tr>
    <td>appendix</td>
    <td>Linked page is the appendix page for the current  document</td>
  </tr>
  <tr>
    <td>chapter</td>
  ...
  <tr>
    <td>offline</td>
    <td>Refers to a location that contains a path to the CDF  file</td>
  </tr>
  <tr>
    <td>prev</td>
  ...
  <tr>
    <td>start</td>
    <td>Refers to the first page (used  by search engines to show the first page)</td>
  </tr>
  <tr>
    <td>stylesheet</td>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a space-separated list of relationship types</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_link_rel.asp">HTML &lt;link&gt; rel attribute</a></p>
<hr>
