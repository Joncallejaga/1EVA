...
<h3>Example</h3>
<p>Return the smallest positive number possible in JavaScript:</p>
...
<div class="w3-code notranslate">
5e-324</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_min_value" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The MIN_VALUE property returns the smallest positive number possible in JavaScript.</p>
<p>This static property has a value of 5e-324.</p>
<p><b>Note:</b> Numbers smaller than this are converted to 0.</p>
<p><b>Note:</b> MIN_VALUE is the value closest to 0. The most negative number is the negative MAX_NUMBER.</p>
<hr>
...
<p>Using x.MIN_VALUE, where x is a number or a Number object, will return 
undefined:</p>
<div class="w3-example">
<h3>Example</h3>
...
<div class="w3-code notranslate">
 undefined</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_min_value_obj" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
