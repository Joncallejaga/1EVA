...
<html lang="en-US">
<head>
<title>HTML DOM Script async Property</title>
 <meta charset="utf-8">
...
<h1>Script <span class="color_h1">async</span> Property</h1>
<p><a href="dom_obj_script.asp" class="w3-btn w3-white w3-border" title="Script Object Reference">&#10094; Script Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a script was executed asynchronously as soon as it was available:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myScript&quot;).async</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_async">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The async property sets or returns whether a script should be executed 
asynchronously as soon as it is available, or not.</p>
<p>This property reflects the async attribute of the &lt;script&gt; tag.</p>
<p><strong>Note:</strong> The async attribute is only for external scripts (and 
should only be used if the src attribute is present).</p>
<p><strong>Note:</strong> There are several ways an external script can be 
executed:</p>
<ul>
...
<hr>
<h2>Syntax</h2>
<p>Return the async property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.async
</div></div>
<p>Set the async property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.async = true|false</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a script should be executed asynchronously as soon as  it is available, or not<ul>
      <li>true - The script will be executed asynchronously as soon as it   is available</li>
      <li>false - The script will not be executed asynchronously as soon   as it is available</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the script is executed asynchronously as soon as it is available, otherwise it returns false</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_script_async.asp">HTML &lt;script&gt; async attribute</a></p>
<hr>

<a href="dom_obj_script.asp" class="w3-btn w3-white w3-border" title="Script Object Reference">&#10094; Script Object</a>
</div>
