...
<html lang="en-US">
<head>
<title>HTML DOM Input URL autocomplete Property</title>
 <meta charset="utf-8">
...
<h1>Input URL <span class="color_h1">autocomplete</span> Property</h1>
<p><a href="dom_obj_url.asp" class="w3-btn w3-white w3-border" title="Input URL Object Reference">&#10094; Input URL Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set autocomplete in a URL field to off:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myURL&quot;).autocomplete = &quot;off&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_url_autocomplete" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autocomplete property sets or returns the value of the autocomplete attribute in a 
URL field.</p>
<p>When autocomplete is on, the browser automatically complete values based on values that the user has entered before.</p>
<p><strong>Tip:</strong> In some browsers you may need to activate an 
autocomplete function for this to work (Look under &quot;Preferences&quot; in the browser's menu).</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the autocomplete property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.autocomplete</div></div>
<p>Set the autocomplete property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>urlObject</em>.autocomplete = &quot;on|off&quot;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>off</td>
    <td>The user must enter a value into each URL field for every use. The browser does not automatically complete entries</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the state of autocompletion</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the state of autocompletion:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myURL&quot;).autocomplete;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 on</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_url_autocomplete2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_autocomplete.asp">HTML &lt;input&gt; autocomplete Attribute</a></p>
<hr>
