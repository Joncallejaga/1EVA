...
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
setInterval(<em>function, milliseconds, param1, param2, ...</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. The intervals (in milliseconds) on how often to execute the code. If the value is less than 10, the value 10 is used</td>
  </tr>
  <tr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the ID value of the timer that is set. Use this value with the clearInterval() method to cancel the timer</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>You can also refer to a &quot;named&quot; function; Alert &quot;Hello&quot; every 3 seconds (3000 milliseconds):</p>
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setInterval(alertFunc, 3000);<br>}<br><br>function alertFunc() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Hello!&quot;);<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var myVar = setInterval(myTimer, 1000);<br><br>function myTimer()
 {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var t = d.toLocaleTimeString();<br>
 &nbsp;&nbsp;&nbsp;
 document.getElementById(&quot;demo&quot;).innerHTML = t;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using clearInterval() to stop time in the previous example:</p>
<div class="w3-code notranslate jsHigh">
 var myVar = setInterval(myTimer, 1000);<br><br>function myTimer()
 {<br>&nbsp;&nbsp;&nbsp; var d = new Date();<br>&nbsp;&nbsp;&nbsp; var t = d.toLocaleTimeString();<br>
 &nbsp;&nbsp;&nbsp;
 document.getElementById(&quot;demo&quot;).innerHTML = t;<br>}<br><br>function myStopFunction()
 {<br>&nbsp;&nbsp;&nbsp; clearInterval(myVar);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval_clearinterval" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using setInterval() and clearInterval() to create a dynamic progress bar:</p>
<div class="w3-code notranslate jsHigh">
 function move() {<br>&nbsp; var elem = document.getElementById(&quot;myBar&quot;); <br>&nbsp; var width = 0;<br>&nbsp; var id = setInterval(frame, 10);<br>&nbsp; function frame() {<br>&nbsp;&nbsp;&nbsp; if (width == 100) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; clearInterval(id);<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width++; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; elem.style.width = width + '%';
 <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval_progressbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Toggle between two background colors once every 300 milliseconds:</p>
<div class="w3-code notranslate jsHigh">
 var myVar = setInterval(setColor, 300);<br><br>function setColor() {<br>&nbsp;&nbsp;&nbsp; var x = document.body;<br>&nbsp;&nbsp;&nbsp; x.style.backgroundColor = x.style.backgroundColor == &quot;yellow&quot; ? &quot;pink&quot; : &quot;yellow&quot;;<br>}<br><br>
 function stopColor() {<br>&nbsp;&nbsp;&nbsp; clearInterval(myVar);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval_clearinterval2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myStartFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setInterval(alertFunc, 2000, &quot;First param&quot;, &quot;Second param&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval_param" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>However, if you use an anonymous function, it will work in 
all browsers:</p>
<div class="w3-code notranslate jsHigh">
 var myVar;<br><br>function myStartFunction() {<br>&nbsp;&nbsp;&nbsp; myVar = setInterval(function(){ alertFunc(&quot;First param&quot;, &quot;Second param&quot;); }, 2000);<br>
 }</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_setinterval_param2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>Window Object: <a href="met_win_clearinterval.asp">clearInterval() Method</a></p>
<p>Window Object: <a href="met_win_settimeout.asp">setTimeout() Method</a></p>
