...
<h1>JavaScript <span class="color_h1">throw</span> Statement</h1>
...
<p>The throw statement throws (generates) an error.</p>
...
<p>The technical term for this is: <strong>throw an exception</strong>.</p>
...
<p>If you use throw together with <a href="jsref_try_catch.asp">try and 
catch</a>, you can control program 
flow and generate custom error messages..</p>
<p>For more information about JavaScript errors, read our <a href="../js/js_errors.asp">JavaScript Errors</a> Tutorial.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 throw <em>expression</em>;</div></div>
...
<p>JavaScript Reference: <a href="jsref_try_catch.asp">JavaScript try/catch/finally Statement</a></p>
<hr>
