...
<html lang="en-US">
<head>
<title>HTML DOM isContentEditable Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">isContentEditable</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myP&quot;).isContentEditable;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_body_iscontenteditable">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isContentEditable property returns whether the content of an 
element is editable or not.</p>
<p>This property is read-only.</p>
<p><strong>Tip:</strong> Use the <a href="prop_html_contenteditable.asp">contentEditable</a> property to change the editable 
state of an element.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the 
isContentEditable property.</p>
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isContentEditable</td>
    <td>11.0</td>
    <td>5.5</td>
    <td>3.0</td>
    <td>3.2</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.isContentEditable
</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the content of an element is editable, otherwise it returns false</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_html_contenteditable.asp"><em>element</em>.contentEditable property</a></p>
