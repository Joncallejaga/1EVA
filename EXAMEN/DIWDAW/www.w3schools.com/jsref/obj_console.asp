...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Console Object</title>
<meta charset="utf-8">
...
<h1>The <span class="color_h1">Console </span>Object</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="dom_obj_attributes.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="dom_obj_document.asp">Next &#10095;</a>
</div>
<hr>

<h2>Console Object</h2>
<p>The Console object provides access to the browser's debugging console.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_console_assert.asp">assert()</a></td>
    <td>Writes an error message to the console if the assertion is false</td>
    </tr>
  <tr>
    <td><a href="met_console_clear.asp">clear()</a></td>
    <td>Clears the console</td>
    </tr>
  <tr>
    <td><a href="met_console_count.asp">count()</a></td>
    <td>Logs the number of times that this particular call to count() has been 
    called</td>
    </tr>
  <tr>
    <td><a href="met_console_error.asp">error()</a></td>
    <td>Outputs an error message to the console</td>
    </tr>
  <tr>
    <td><a href="met_console_group.asp">group()</a></td>
  ...
  <tr>
    <td><a href="met_console_groupcollapsed.asp">groupCollapsed()</a></td>
