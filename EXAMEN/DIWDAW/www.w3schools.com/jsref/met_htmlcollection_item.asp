...
<html lang="en-US">
<head>
<title>HTMLCollection item() Method</title>
<meta charset="utf-8">
...
<h1>HTMLCollection <span class="color_h1">item()</span> Method</h1>
<p><a href="dom_obj_htmlcollection.asp" class="w3-btn w3-white w3-border" title="HTMLCollection Object"> HTMLCollection</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the HTML content of the first &lt;p&gt; element of this document:</p>
 <div class="w3-code notranslate jsHigh">
   function myFunction() {<br>&nbsp; var x = document.getElementsByTagName(&quot;P&quot;).item(0);<br>&nbsp; 
   alert(x.innerHTML);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_item" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">item()</code> method returns the element at the specified index in an 
HTMLCollection.</p>
<p>The Elements are sorted as they appear in the source code, and the index starts 
at 0.</p>
<p>A shorthand method can also be used, and will produce the same result:</p>

<div class="w3-example">

<div class="w3-code notranslate"><span class="jsHigh">var x = document.getElementsByTagName(&quot;P&quot;)[0];</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_htmlcollection_item2">Try it</a></div>
</div>
...
<div class="w3-code w3-border notranslate">
  <div>
    <i>HTMLCollection</i>.item(<em>index</em>)
  </div>
</div>
OR:
<div class="w3-code w3-border notranslate">
  <div>
    <i>HTMLCollection</i>[<i>index</i>]
  </div>
</div>
...
<td><em>index</em></td>
<td>Number</td>
<td>Required. The index of the element you want to return.<br>
...
<h2>Return Value</h2>
<p>An <a href="dom_obj_all.asp">Element</a> object, representing the element at the specified index.</p>
<p>Returns <em>null</em> if the index number is out of range</p>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Change the HTML content of the first &lt;p&gt; element:</p>
<div class="w3-code notranslate jsHigh">
  document.getElementsByTagName(&quot;P&quot;).item(0).innerHTML = &quot;Paragraph changed&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_item_p2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all elements with class=&quot;myclass&quot;, and change their background color:</p>
<div class="w3-code notranslate jsHigh">
  var x = document.getElementsByClassName(&quot;myclass&quot;);<br><br>for (i = 0; i &lt; 
  x.length; i++) {<br>&nbsp; x.item(i).style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_item_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the HTML content of the first &lt;p&gt; element inside a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);<br>var x = div.getElementsByTagName(&quot;P&quot;).item(0).innerHTML;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_item_p" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>HTMLCollection: <a href="prop_htmlcollection_length.asp">length</a> Property</p>
<p>HTML Element: <a href="met_element_getelementsbyclassname.asp">getElementsByClassName()</a> Method</p>
<p>HTML Element: <a href="met_element_getelementsbytagname.asp">getElementsByTagName()</a> Method</p>
<hr>
<p><a href="dom_obj_htmlcollection.asp" class="w3-btn w3-white w3-border" title="HTMLCollection Object"> HTMLCollection</a></p>
</div>
