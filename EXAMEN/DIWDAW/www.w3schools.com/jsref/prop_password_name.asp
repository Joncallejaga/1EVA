...
<html lang="en-US">
<head>
<title>HTML DOM Input Password name Property</title>
 <meta charset="utf-8">
...
<h1>Input Password <span class="color_h1">name</span> Property</h1>
...
<h3>Example</h3>
<p>Get the name of a password field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myPsw&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">pw</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the password field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of a password field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myPsw&quot;).name = &quot;newPasswordName&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_password_name2">Try it Yourself &raquo;</a>
</div>
<hr>
