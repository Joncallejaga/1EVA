...
<html lang="en-US">
<head>
<title>HTML DOM Meter high Property</title>
 <meta charset="utf-8">
...
<h1>Meter <span class="color_h1">high</span> Property</h1>
<p><a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the high attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myMeter&quot;).high = &quot;60&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_high2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The high property sets or returns the value of the high attribute in a gauge.</p>
<p>The high attribute specifies the range where the gauge's value is considered 
to be a high value. This value must be less than the max attribute value, and 
greater than the low and min attribute values.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the high property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.high</div></div>
<p>Set the high property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.high = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies a floating point number that is considered to be a high value</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing a floating point number that is considered to be a high value</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the high attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myMeter&quot;).high;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 95</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_high" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_meter_high.asp">HTML &lt;meter&gt; high attribute</a></p>
<hr>
