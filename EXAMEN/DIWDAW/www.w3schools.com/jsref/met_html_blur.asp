...
<h1>HTML DOM <span class="color_h1">blur()</span> Method</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Remove focus from an &lt;a&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).blur();</div>
...
<p>The blur() method is used to remove focus from an element.</p>
<p><strong>Tip:</strong> Use the <a href="met_html_focus.asp">focus()</a> method to 
give focus to an element.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.blur()</div></div>
<h2>Parameters</h2>
...
<div class="w3-example">
<h3>Example</h3>
<p>Remove focus from a text field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myText&quot;).blur();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_text_focus" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_onblur.asp">onblur event</a></p>
<hr>
