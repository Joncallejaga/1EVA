...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_cookie">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cookie property sets or returns all name/value pairs of cookies in the current document.</p>
<p>For more information about cookies, read our <a href="../js/js_cookies.asp">JavaScript Cookies Tutorial</a>.</p>
<hr>
...
<ul>
  <li><strong>expires=<em>date</em></strong> - Optional. Specifies the date in GMT format (See the Date.toUTCString method). If not specified, the cookie is deleted when the browser is closed</li><br>
  <li><strong>path=<em>path</em></strong> - Optional. Tells the browser what path to the directory the cookie belongs to, (e.g., '/', '/dir'). <strong>Note:</strong> The path must be absolute. If not specified, the cookie belongs to the current page</li><br>
  <li><strong>domain=<em>domainname</em></strong> - Optional. Specifies the domain of your site (e.g., 'example.com', '.example.com' (includes all subdomains), 'subdomain.example.com'). If not specified, the domain of the current document will be used</li><br>
  <li><strong>secure </strong>- Optional. Tells the browser to use a secure protocol (https) for sending the cookie to the server</li>
</ul>
...
<a href="jsref_encodeuricomponent.asp">encodeURIComponent()</a> method to ensure 
that they don't</td>
</tr>
</table>
...
<tr>
 <th style="width:18%">Return Value:</th>
  <td>A String, containing the name/value pairs of cookies in the document</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<hr>
<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_cookies.asp">JavaScript Cookies</a></p>
<hr>
