...
<h1>The <span class="color_h1">Event</span> Object</h1>
<p>
...
<h2>Event Object</h2>
<p>All event objects in the DOM are based on the Event Object.</p>
<p>Therefore, all other event objects (like <a href="obj_mouseevent.asp">MouseEvent</a> and <a href="obj_keyboardevent.asp">KeyboardEvent</a>) has access to the Event Object's properties and 
methods.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="event_cancelbubble.asp">cancelBubble</a></td>
    <td>Sets or returns whether the event should propagate up the hierarchy or 
    not</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="event_composedpath.asp">composedPath()</a></td>
    <td>Returns the event's path</td>
  </tr>
  <tr>
...
<h2>Event Types</h2>
<p>These event types belongs to the Event Object: </p>
...
<table class="w3-table-all notranslate">
  ...
  <td>The event occurs when a page has started printing</td>
  </tr>
  <tr>
