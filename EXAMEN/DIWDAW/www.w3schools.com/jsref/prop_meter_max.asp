...
<html lang="en-US">
<head>
<title>HTML DOM Meter max Property</title>
 <meta charset="utf-8">
...
<h1>Meter <span class="color_h1">max</span> Property</h1>
<p><a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the max attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myMeter&quot;).max = &quot;80&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_max2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The max property sets or returns the value of the max attribute in a gauge.</p>
<p>The max attribute specifies the upper bound of the gauge, and the value must 
be greater than the min attribute value.</p>
<p>If unspecified, the default value is 1.</p>
<p><strong>Tip:</strong> The max attribute, together with the min attribute, 
...
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.max</div></div>
<p>Set the max property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.max =<em> number</em></div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies a floating point number that is the maximum value of the gauge. Default value is &quot;1&quot;</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing a floating point number that is the maximum value of the gauge</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myMeter&quot;).max;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 100</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_max" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_meter_max.asp">HTML &lt;meter&gt; max attribute</a></p>
<hr>
