...
<h3>Example</h3>
<p>Get the browser window&#39;s height and width:</p>
<div class="w3-code notranslate jsHigh">
 var w = window.outerWidth;<br>var h = window.outerHeight;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_outerheight">Try it Yourself &raquo;</a>
</div>
...
<p>The outerWidth property returns the outer width of the browser window, including all interface elements 
(like toolbars/scrollbars).</p>

<p>The outerHeight property returns the outer height of the browser window, including all interface elements 
(like toolbars/scrollbars).</p>
<p>These properties are read-only.</p>

<p><strong>Tip:</strong> Use the <a href="prop_win_innerheight.asp">
innerWidth and innerHeight</a> properties to get the width/height of the 
window's content area (the window/frame without toolbars).</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width and/or the height of the browser's window, including all interface elements, in pixels</td>
</tr>
</table>
