...
<h3>Example</h3>
<p>Return the protocol of the URL for a specific area in an 
image-map:</p>
...
<div class="w3-code notranslate">
 http:</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_protocol" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the protocol part of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("venus").protocol = &quot;mailto:&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_area_protocol2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
