...
<html lang="en-US">
<head>
<title>JavaScript debugger Statement</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">debugger</span> Statement</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = 15 * 5;<br>debugger;<br>document.getElementbyId(&quot;demo&quot;).innerHTML = x; </div> 
<a target="_blank" href="tryit.asp?filename=tryjsref_state_debugger" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The debugger statement stops the execution of JavaScript, and calls (if 
available) the debugging function.</p>
<p>Using the debugger statement has the same function as setting a breakpoint in 
the code.</p>
<p>Normally, you activate debugging in your browser with the F12 key, and select 
&quot;Console&quot; in the debugger menu.</p>
<p><strong>Note:</strong> If no debugging is available, the debugger statement 
has no effect.</p>
<p>For more information about debugging in JavaScript, and how to activate 
debugging if your browser does not support it, read our
<a href="../js/js_debugging.asp">JavaScript Debugging</a> Tutorial.</p>
...
<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_debugging.asp">JavaScript Debugging</a></p>
<hr>
