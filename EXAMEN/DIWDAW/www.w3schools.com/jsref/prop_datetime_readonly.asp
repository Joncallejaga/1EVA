...
<html lang="en-US">
<head>
<title>HTML DOM Input Datetime readOnly Property</title>
 <meta charset="utf-8">
...
<h1>Input Datetime <span class="color_h1">readOnly</span> Property</h1>
...
<h3>Example</h3>
<p>Set a datetime field to read-only:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDatetime&quot;).readOnly = true;</div>
<!--<p>The result will be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="datetime" readonly>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_readonly">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The readOnly property sets or returns whether a datetime field should be 
read-only, or not.</p>
<p>A read-only field cannot be modified. However, a user can tab to it, 
highlight it, and copy the text from it.</p>
<p>This property reflects the HTML readonly attribute.</p>
<p><strong>Tip:</strong> To prevent the user from interacting with the field, 
use the <a href="prop_datetime_disabled.asp">disabled</a> property instead.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.readOnly</div></div>
<p>Set the readOnly property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.readOnly = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a datetime field should be  read-only, or not
  <ul>
      <li>true - The datetime field is read-only</li>
      <li>false - Default. The datetime field is not read-only</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the datetime field is read-only, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a datetime field is read-only or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDatetime&quot;).readOnly;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_readonly2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_readonly.asp">HTML &lt;input&gt; readonly attribute</a></p>
<hr>
