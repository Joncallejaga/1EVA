...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.backgroundSize = &quot;60px 120px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_backgroundsize">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>length</em></td>
    <td>Sets the width and height of the background image. The first value sets the width, the second value sets the height. If only one value is given, the second is set to &quot;auto&quot;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td> cover</td>
    <td>Scale the background image to be as large as possible so that the background area is completely covered by the background image. Some parts of the background image may not be in view within the background positioning area</td>
  </tr>
  <tr>
    <td> contain</td>
    <td>Scale the image to the largest size such that both its width and its height can fit inside the content area</td>
  </tr>
  <tr>
    <td>initial</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_background-size.asp">background-size property</a></p>
<hr>
