...
<h3>Example</h3>
 <p>Check if two list items in two different lists are equal:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_node_isequalnode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<li>They have the same Node Type</li>
  <li>They have the same nodeName, NodeValue, localName, nameSpaceURI and prefix</li>
  <li>They have the same childNodes with all the descendants</li>
  <li>They have the same attributes and attribute values (the attributes does not have be in the same order)</li>
</ul>
<p><strong>Tip:</strong> Use the <a href="met_node_issamenode.asp">isSameNode() method</a> to determine if two nodes are the same node.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isEqualNode()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<i>node</i>.isEqualNode(<i>node</i>)</div>
</div>
...
<tr>
 <th style="width:20%;">Return Value:</th>
  <td>A Boolean, returns true if the two nodes are equal, otherwise false</td>
</tr>
<tr>
  <th>DOM Version</th>
