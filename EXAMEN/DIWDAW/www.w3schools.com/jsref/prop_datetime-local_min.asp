...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal min Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">min</span> Property</h1>
...
<h3>Example</h3>
<p>Get the minimum date and time allowed for a local datetime field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).min;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2000-10-06T22:22:55</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The min property sets or returns the value of the min attribute of a local datetime field.</p>
<p>The min attribute specifies the minimum value (date and time) for a local datetime field.</p>
<p><strong>Tip:</strong> Use the min attribute together with the max attribute to create a range of legal values.</p>
<p><strong>Tip:</strong> To set or return the value of the max attribute, use the <a href="prop_datetime-local_max.asp">max</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.min</div></div>
<p>Set the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.min =<i> YYYY-MM-DDThh:mm:ss.ms</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the minimum date and time allowed for the local datetime field.  <br><br>Explanation of components:<ul>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).min = &quot;2006-05-05T16:15:23&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_min2">Try it Yourself &raquo;</a>
</div>
<hr>
