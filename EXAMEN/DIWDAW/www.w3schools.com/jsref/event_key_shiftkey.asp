...
<h1>KeyboardEvent <span class="color_h1">shiftKey</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out whether or not the &quot;SHIFT&quot; key was pressed when a keyboard 
key is pressed:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;demo&quot;);<br>if (event.shiftKey) {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;The SHIFT key was pressed!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;The SHIFT key was NOT pressed!&quot;;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_shiftkey" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:19%">Return Value:</th>
  <td>
 A Boolean, indicating whether the &quot;SHIFT&quot; key was pressed when the key event occured.
 <p>Possible values:</p>
 <ul>
  ...
  <tr>
 <th style="width:19%">DOM Version:</th>
...
<p>HTML DOM reference: <a href="event_key_metakey.asp">KeyboardEvent metaKey Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_keyboardevent.asp" class="w3-btn w3-white w3-border" title="KeyboardEvent">&#10094; KeyboardEvent</a>
