...
<html lang="en-US">
<head>
<title>defaultPrevented Event Property</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">defaultPrevented</span> Event Property</h1>
<p>
...
<h3>Example</h3>
<p>Prevent a link from opening the URL, and check if preventDefault() was called:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor&quot;).addEventListener(&quot;click&quot;, function(event){<br>&nbsp;&nbsp;&nbsp; event.preventDefault()<br>&nbsp;&nbsp;&nbsp; alert(&quot;Was preventDefault() called: &quot; + event.defaultPrevented);<br>});<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_defaultprevented" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The defaultPrevented event property checks whether the
<a href="event_preventdefault.asp">preventDefault()</a> method was called for 
the event.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.defaultPrevented</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, indicating whether the preventDefault() method was called for the event.
 <p>Possible values:</p>
 <ul>
    <li>true - The preventDefault() method was called for the event</li>
    <li>false - The preventDefault() method was not called for the event</li>
 </ul>
   </td>
  </tr>
  <tr>
