...
<h3>Example</h3>
 <p>Find out if the defined namespace is the default namespace:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.documentElement.isDefaultNamespace(&quot;http://www.w3.org/1999/xhtml&quot;);</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
true
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_isdefaultnamespace" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isDefaultNamespace() method returns true if the specified namespace is default, otherwise false.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isDefaultNamespace()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<th style="text-align:left;width:11%;">Type</th>    
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the namespace is default, otherwise false</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_node_namespaceuri.asp"><em>node.</em>namespaceURI Property</a></p>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="Element Object Reference"> Element Object</a></p>
</div>
