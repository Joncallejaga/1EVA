...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myForm&quot;).action = &quot;/action_page.php&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_action2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>formObject</em>.action = <i>URL</i>
 </div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of where to send the form-data when a form is submitted</td>
  </tr>
</table>
...
<div class="w3-code notranslate">
 https://www.w3schools.com/action_page.php</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_form_action" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> In the example above, Internet Explorer 7 and earlier 
versions returns &quot;/action_page.php&quot;, while IE 8+, Firefox, Opera, 
Chrome, and Safari returns the entire URL: &quot;https://www.w3schools.com/action_page.php&quot;.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_form_action.asp">HTML &lt;form&gt; action attribute</a></p>
<hr>
