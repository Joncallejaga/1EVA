...
<h3>Example</h3>
 <p>Find out if an attribute is the element's ID attribute or not:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_attr_isid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isId property returns true if the attribute is of type ID, otherwise it returns false.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isId</td>
...
<p><strong>Note:</strong> This property was supported in Chrome, Firefox and Safari 5+, but support has been removed.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the attribute is of type ID, otherwise false</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 3</td>
