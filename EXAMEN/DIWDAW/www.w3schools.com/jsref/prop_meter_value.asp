...
<html lang="en-US">
<head>
<title>HTML DOM Meter value Property</title>
 <meta charset="utf-8">
...
<h1>Meter <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the value attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myMeter&quot;).value = &quot;50&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_value2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The value property sets or returns the value of the value attribute in a gauge.</p>
<p>The value attribute specifies the current, or &quot;measured&quot;, value of 
the gauge, and must be between the min and max attribute values.</p>
<p>The value attribute is a required attribute for the &lt;meter&gt; tag.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.value</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.value = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies a floating point number that is the current value of the gauge</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing a floating point number that is the current value of the gauge</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the value attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myMeter&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 65</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_value" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_meter_value.asp">HTML &lt;meter&gt; value attribute</a></p>
<hr>
