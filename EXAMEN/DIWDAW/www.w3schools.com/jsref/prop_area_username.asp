...
<html lang="en-US">
<head>
<title>HTML DOM Area username Property</title>
 <meta charset="utf-8">
...
<h1>Area <span class="color_h1">username</span> Property</h1>
<p><a href="dom_obj_area.asp" class="w3-btn w3-white w3-border" title="Area Object Reference">&#10094; Area Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the username part of the URL for a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;venus&quot;).username;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 johnsmith</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_username" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The username property sets or returns the username part of the href attribute value.</p>
<p>The href attribute specifies the destination of a link in an area.</p>
<p>In a URL, the username part is the username entered by the user. It is 
specified after the protocol and before the password part.</p>
<p><strong>Example:</strong> 
<a href="https://johnsmith:smith123@www.example.com%20(johnsmith%20is%20the%20username%20and%20smith123%20is%20the%20password">https://<strong>johnsmith</strong>:smith123@www.example.com
(johnsmith is the username and smith123 is the password</a>).</p>
<p><strong>Tip:</strong> Use the <a href="prop_area_password.asp">password</a> property to set or return the password 
part of the href attribute value.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the username property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>areaObject</em>.username
</div></div>
<p>Set the username property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>areaObject</em>.username =<i> username</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies the  username part of a URL</td>
  </tr>
</table>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the username part of the URL</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the username part of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;venus&quot;).username = &quot;newUsername&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_area_username2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<a href="dom_obj_area.asp" class="w3-btn w3-white w3-border" title="Area Object Reference">&#10094; Area Object</a>
</div>
