...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_disabled2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether an option in a drop-down list 
should be disabled, or not.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether an  option in a drop-down list should be disabled or not.
  <ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the option is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;pets&quot;).options[1].disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_option_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_option_disabled.asp">HTML &lt;option&gt; disabled attribute</a></p>
<hr>
