...
<h3>Example</h3>
<p>Return the hostname of the URL for a specific area in an image-map:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_area_hostname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the hostname of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;venus&quot;).host = &quot;www.example.com&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_area_hostname2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
