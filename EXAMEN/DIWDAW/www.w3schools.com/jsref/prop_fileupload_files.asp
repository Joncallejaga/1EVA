...
<html lang="en-US">
<head>
<title>HTML DOM Input FileUpload files Property</title>
 <meta charset="utf-8">
...
<h1>Input FileUpload <span class="color_h1">files</span> Property</h1>
...
<h3>Example</h3>
<p>Select one or more files with the file upload button, and display some 
information about the selected file(s):</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFile&quot;);<br>var txt = &quot;&quot;;<br>if ('files' in x) {<br>&nbsp;&nbsp;&nbsp; if (x.files.length == 0) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt = &quot;Select one or more files.&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; for (var i = 0; i &lt; x.files.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += &quot;&lt;br&gt;&lt;strong&gt;&quot; + (i+1) + &quot;. file&lt;/strong&gt;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var file = x.files[i];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if ('name' in file) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += &quot;name: &quot; + file.name + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if ('size' in file) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += &quot;size: &quot; + file.size + &quot; bytes &lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }<br>
 } <br>document.getElementById (&quot;demo&quot;).innerHTML = txt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_fileupload_files">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The files property returns a FileList object, representing the file or files selected with the file upload button.</p>
<p>Through the FileList object, you can get the the name, size and the contents of the files</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>fileuploadObject</em>.files
</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A FileList object that represents the selected file or files</td>
  </tr>
</table>
