...
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_complete" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
an image.</p>
<p>If the image is finished loading, the complete property returns true. If the 
image is not finished loading, this property returns false.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean that indicates whether the browser is finished loading the image or not. Returns true if the loading is finished, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
 &lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Image loaded: &quot; + document.getElementById(&quot;myImg&quot;).complete);<br>}<br>&lt;/script&gt;<br><br>&lt;body onload=&quot;myFunction()&quot;&gt;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_complete2">Try it Yourself &raquo;</a>
</div>
<hr>
