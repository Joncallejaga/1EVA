...
<p><a href="jsref_obj_boolean.asp" class="w3-btn w3-white w3-border" title="JavaScript Boolean Reference">&#10094; JavaScript Boolean Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>The constructor property returns a booleans's constructor function:</p>
<div class="w3-code notranslate jsHigh">
var bool = false;<br>
</div>
<!--<p>The constructor property returns:</p>
<div class="w3-code notranslate">
function Boolean() { [native code] }</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_constructor_boolean" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>In JavaScript, the constructor property returns the constructor function for 
an object.</p>
<p>The return value is a reference to the 
function, not the name of the function:</p>
<p>For JavaScript <strong>numbers</strong> the constructor property returns
<strong>function Number() { [native code] }</strong></p>
<p>For JavaScript <strong>strings</strong> the constructor property returns
<strong>function String() { [native code] }</strong></p>
<p>For JavaScript <strong>booleans</strong> the constructor property returns
<strong>function Boolean() { [native code] }</strong></p>
<hr>
...
<tr>
 ...
 <td width="77%">function Boolean() { [native code] }</td>
</tr>
<tr>
...
<hr>
<a href="jsref_obj_boolean.asp" class="w3-btn w3-white w3-border" title="JavaScript Boolean Reference">&#10094; JavaScript Boolean Reference</a>
</div>
