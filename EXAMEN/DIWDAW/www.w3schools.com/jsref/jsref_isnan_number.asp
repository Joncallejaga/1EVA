...
<html lang="en-US">
<head>
<title>JavaScript Number isNaN() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">isNaN()</span> Method</h1>
<p><a href="jsref_obj_number.asp" class="w3-btn w3-white w3-border" title="JavaScript Number Reference">&#10094; JavaScript Number Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check whether a value is NaN:</p>
<div class="w3-code notranslate jsHigh">
 Number.isNaN(123) //false<br>Number.isNaN(-1.23) //false<br>Number.isNaN(5-2) //false<br>Number.isNaN(0) //false<br>Number.isNaN('123') //false<br>Number.isNaN('Hello') //false<br>Number.isNaN('2005/12/12') //false<br>Number.isNaN('') //false<br>Number.isNaN(true) //false<br>Number.isNaN(undefined) //false<br>Number.isNaN('NaN') //false<br>Number.isNaN(NaN) //true<br>Number.isNaN(0 / 0) //true</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_isnan_number" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Number.isNaN() method determines whether a value is NaN (Not-A-Number).</p>
<p>This method returns true if the value is of the type Number, and equates to NaN. Otherwise it returns false.</p>
<p>Number.isNaN() is different from the global <a href="jsref_isnan.asp">isNaN()</a> 
function. The global isNaN() 
function converts the tested value to a Number, then tests it.</p>
<p>Number.isNaN() does not convert the values to a Number, and will not return 
true for any value that is not of the type Number.</p>
<p><strong>Tip:</strong> In JavaScript, the value NaN is considered a type of 
number.</p>
<hr>
...
<tr>
    ...
    <th style="width:15%;" class="bsEdge" title="Edge"></th>
...
<div class="w3-code w3-border notranslate"><div>
 Number.isNaN(<em>value</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the value is Number.NaN, otherwise it returns false</td>
</tr>
<tr>
...
<hr>
<a href="jsref_obj_number.asp" class="w3-btn w3-white w3-border" title="JavaScript Number Reference">&#10094; JavaScript Number Reference</a>
</div>
