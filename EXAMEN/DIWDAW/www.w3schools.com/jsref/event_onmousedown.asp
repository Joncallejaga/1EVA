...
<a target="_blank" href="tryit.asp?filename=tryjsref_onmousedown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>In HTML:</p>
<div class="w3-code notranslate htmlHigh">
&lt;<i>element</i> onmousedown=&quot;<i>myScript</i>&quot;&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmousedown_html" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.onmousedown = function(){<i>myScript</i>};
 
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmousedown_dom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><div class="w3-example">
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
<em>object</em>.addEventListener(&quot;mousedown&quot;, <em>myScript</em>);
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_onmousedown_addeventlistener" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<p><a href="tryit.asp?filename=tryjsref_onmousedown_param" target="_blank">
...
<p><a target="_blank" href="tryit.asp?filename=tryjsref_onmousedown2">Alert which mouse button that was pressed</a><br>
Alert which mouse button the user pressed.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjsref_event_srcelement">Alert the element the user clicked on</a><br>
