...
<html lang="en-US">
<head>
<title>AnimationEvent elapsedTime Property</title>
<meta charset="utf-8">
...
<h1>AnimationEvent <span class="color_h1">elapsedTime</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out how many seconds an animation has been running:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDIV&quot;);<br>x.addEventListener(&quot;animationiteration&quot;, myRepeatFunction);<br><br>function myRepeatFunction(event) {<br>&nbsp;&nbsp;&nbsp; this.innerHTML = &quot;Elapsed time: &quot; + event.elapsedTime;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_animation_elapsedtime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The elapsedTime property returns the number of seconds an animation has been 
running, when an animation event occurs.</p>
<p><strong>Note:</strong> The return value is not affected if the animation is 
paused (by using the animation-delay CSS property).</p>
<p><strong>Note:</strong> For the <a href="event_animationstart.asp">animationstart</a> event, this property 
always returns 
&quot;0&quot;.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">elapsedTime</td>
    <td>Yes</td>
    <td>10.0</td>
    <td>6.0</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.elapsedTime</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of seconds an animation has been running</td>
</tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_animationstart.asp">The animationstart Event</a></p>
<p>HTML DOM reference: <a href="event_animationiteration.asp">The animationiteration Event</a></p>
<p>HTML DOM reference: <a href="event_animationend.asp">The animationend Event</a></p>
<p>HTML DOM reference: <a href="event_animation_animationname.asp">AnimationEvent animationName Property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_animation.asp">CSS3 animation Property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_animation-duration.asp">CSS3 animation-duration Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_animationevent.asp" class="w3-btn w3-white w3-border" title="AnimatioEvent">&#10094; AnimationEvent</a>
