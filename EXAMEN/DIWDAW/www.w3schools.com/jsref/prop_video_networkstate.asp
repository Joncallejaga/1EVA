...
<html lang="en-US">
<head>
<title>HTML DOM Video networkState Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">networkState</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).networkState;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 1&nbsp; // The video is active and has selected a resource, but is not using the network</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_networkstate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The networkState property returns the current network state (activity) of the video.</p>
<hr>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.networkState</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>Represents the current network state of the video element:<ul><li>
  0  = NETWORK_EMPTY - video has not yet been initialized</li>
    <li>1 = NETWORK_IDLE - video is active and has selected a  resource, but is not using the network</li>
    <li>2 = NETWORK_LOADING - browser is downloading data</li>
    <li>3 = NETWORK_NO_SOURCE - no video source found</li></ul>
    </td>
    </tr>
</table>
