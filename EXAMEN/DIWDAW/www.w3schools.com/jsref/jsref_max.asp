...
10</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_max" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> The <a href="jsref_min.asp">min()</a> method returns the number with the lowest value.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the highest number of the arguments, or <em>-Infinity</em> if no arguments are given, or <em>NaN</em> if one or more arguments are not numbers</td>
</tr>
<tr>
...
-5<br>
2.5</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_max2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
