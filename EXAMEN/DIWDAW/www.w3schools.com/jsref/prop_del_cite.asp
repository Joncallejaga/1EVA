...
<html lang="en-US">
<head>
<title>HTML DOM del cite Property</title>
 <meta charset="utf-8">
...
<h1>del <span class="color_h1">cite</span> Property</h1>
<p><a href="dom_obj_del.asp" class="w3-btn w3-white w3-border" title="del Object Reference">&#10094; del Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the URL to a document that explains why some text was deleted:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myDel").cite;
</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 http://www.example.com/example/why_deleted.htm</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_del_cite" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>delObject</em>.cite
</div></div>
<p>Set the cite property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>delObject</em>.cite = <i>URL</i>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>
  Specifies the source URL to the document that explains why the text was  deleted.<br>
  <br>Possible values:
  <ul>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the cite attribute:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myDel&quot;).cite = &quot;http://www.example.com/whywedeletedsometext.htm&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_del_cite2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_del_cite.asp">HTML &lt;del&gt; cite attribute</a></p>
<hr>
