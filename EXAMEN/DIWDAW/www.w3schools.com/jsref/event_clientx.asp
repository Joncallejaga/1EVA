...
<h1>MouseEvent <span class="color_h1">clientX</span> Property</h1>
<p>
...
<p>The clientX property returns the horizontal coordinate (according to the client area) of the mouse pointer when a mouse event 
was triggered.</p>
<p>The client area is the current window.</p>
<p><strong>Tip:</strong> To get the vertical coordinate (according to the client 
area) of the mouse pointer, 
use the <a href="event_clienty.asp">clientY</a> property.</p>
