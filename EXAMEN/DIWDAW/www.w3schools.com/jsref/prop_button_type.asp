...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_inputbutton_type">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>For an input button this property will always return &quot;button&quot;.</p>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of form element the input button is</td>
  </tr>
</table>
