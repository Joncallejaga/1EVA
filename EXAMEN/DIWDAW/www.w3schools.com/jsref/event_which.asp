...
<h1>MouseEvent <span class="color_h1">which</span> Property</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
 alert("You pressed button: " + event.which)<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_which" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The which property returns a number that indicates which mouse button was 
pressed when a mouse event was triggered.</p>
<p>This property is mostly used together with the onmousedown event.</p>
<p><strong>Note:</strong> The values returned by this property are the same as 
those returned by the <a href="event_button.asp">button</a> property plus one.</p>
...
<tr>
 ...
 <b>Note:</b> For a left-hand configured mouse, the return values are reversed.
  </td>
</tr>
  <tr>
