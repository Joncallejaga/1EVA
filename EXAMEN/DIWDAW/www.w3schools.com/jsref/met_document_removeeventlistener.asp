...
<a target="_blank" href="tryit.asp?filename=tryjsref_document_addeventlistener_remove" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a href="met_element_removeeventlistener.asp"><em>element</em>.removeEventListener()</a> 
...
<div class="w3-code w3-border notranslate"><div>
 document.removeEventListener(<em>event</em>, <em>function</em>, <em>useCapture</em>)
</div></div>
...
<div class="w3-code notranslate jsHigh">
 if (document.removeEventListener) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// For all major browsers, except IE 8 and earlier<br>&nbsp;&nbsp;&nbsp; document.removeEventListener(&quot;mousemove&quot;, myFunction);<br>} else if (document.detachEvent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For IE 8 and earlier versions<br>&nbsp;&nbsp;&nbsp; document.detachEvent(&quot;onmousemove&quot;, myFunction);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_document_removeeventlistener_crossbrowser">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_eventlistener.asp">HTML DOM EventListener</a></p>
<p>JavaScript Reference: <a href="met_element_removeeventlistener.asp"><em>element</em>.removeEventListener()</a></p>
<hr>
