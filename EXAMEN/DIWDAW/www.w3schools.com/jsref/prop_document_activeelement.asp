...
<div class="w3-code notranslate">
 BUTTON</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_document_activeelement" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="met_html_focus.asp"><em>element</em>.focus()</a> method.</p>
...
<p><strong>Note:</strong> For iOS, elements that are not &lt;input type="text"&gt;, 
will not get focus assigned to them. The property will then return BODY or null.</p>
<hr>
