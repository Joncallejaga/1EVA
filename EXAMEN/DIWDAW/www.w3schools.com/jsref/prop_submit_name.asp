...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit name Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">name</span> Property</h1>
...
<h3>Example</h3>
<p>Get the value of the name attribute of a Submit button:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySubmit&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">submit1</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the submit button</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the name attribute of a Submit button:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;mySubmit&quot;).name = &quot;newName&quot;;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_name2">Try it Yourself &raquo;</a>
</div>
<hr>
