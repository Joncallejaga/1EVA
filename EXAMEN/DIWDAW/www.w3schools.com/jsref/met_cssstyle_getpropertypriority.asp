...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration getPropertyPriority Method</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration getPropertyPriority<span class="color_h1">() Method</span></h1>
...
<h3>Example</h3>
<p>Return whether or not the color property has the &quot;important!&quot; priority 
set:</p>
<div class="w3-code notranslate jsHigh">
var declaration = document.styleSheets[0].cssRules[0].style;<br>var 
  priority = declaration.getPropertyPriority(&quot;color&quot;);<br>alert(priority);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_getpropertypriority">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The getPropertyPriority() method returns whether or not the specified CSS property has the &quot;important!&quot; priority 
set.</p>
<p>If this method returns &quot;important&quot;, the important qualifier is set.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getPropertyPriority()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.getPropertyPriority(<em>propertyname</em>)</div></div>
...
<td>Required. A String representing the name of the property to check<br></td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A String, representing the priority, or an empty string if it does not 
  exists</td>
  </tr>
  </table>
