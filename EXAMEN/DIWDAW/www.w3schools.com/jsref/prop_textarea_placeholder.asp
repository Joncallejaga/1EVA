...
<html lang="en-US">
<head>
<title>HTML DOM Textarea placeholder Property</title>
 <meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">placeholder</span> Property</h1>
<p><a href="dom_obj_textarea.asp" class="w3-btn w3-white w3-border" title="Textarea Object Reference">&#10094; Textarea Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the placeholder text of a text area:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).placeholder = &quot;Where do you live?&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_placeholder">Try it Yourself &raquo;</a>
</div>
<hr>
...
value of a text area (e.g. a sample value or a short description of the 
expected format).</p>
<p>The hint is displayed in the text area when it is empty, and disappears when 
the field gets focus.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.placeholder</div></div>
<p>Set the placeholder property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>textareaObject</em>.placeholder = <em>text</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>text</em></td>
    <td>
  Specifies a short hint (one word or a short phrase) that describes the  expected value of the text area</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing a short hint that describes the expected value of the text area</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the placeholder text of a text area:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).placeholder;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">Your address..</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_placeholder2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_textarea_placeholder.asp">HTML &lt;textarea&gt; placeholder attribute</a></p>
<hr>
