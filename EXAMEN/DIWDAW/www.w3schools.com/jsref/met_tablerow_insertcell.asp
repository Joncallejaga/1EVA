...
<html lang="en-US">
<head>
<title>HTML DOM TableRow insertCell() Method</title>
 <meta charset="utf-8">
...
<h1>TableRow <span class="color_h1">insertCell()</span> Method</h1>
<p><a href="dom_obj_tablerow.asp" class="w3-btn w3-white w3-border" title="TableRow Object Reference">&#10094; TableRow Object</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_tr_insertcell" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">insertCell()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>tablerowObject</em>.insertCell(<i>index</i>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required in Firefox and Opera, optional in IE, Chrome and Safari. A number (starts at 0) that specifies the position of the new cell in the current row.  The value of 0 results in that the new cell will be inserted at the  first position. The value of -1 can also be used; which results in that the new cell will be  inserted at the last position.<br><br>
  If this parameter is omitted, insertCell() inserts the new cell at the  last position in IE and at the first position in Chrome and Safari.<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_insertcell2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_insertcell3">Try it Yourself &raquo;</a>
</div>
...
x.innerHTML = &quot;New cell&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_insertcell4">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_tr_deletecell">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_insertrow">Try it Yourself &raquo;</a>
</div>
<hr>

<a href="dom_obj_tablerow.asp" class="w3-btn w3-white w3-border" title="TableRow Object Reference">&#10094; TableRow Object</a>
</div>
