...
<h1>Video <span class="color_h1">poster</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the poster image of a video:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).poster = &quot;/images/w3schoolscomlogo.png&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_poster" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The poster property sets or returns the value of the poster attribute of a video.</p>
<p>The poster attribute specifies an image to be shown while the video is 
downloading, or until the user hits the play button. If this is not included, 
the first frame of the video will be used instead.</p>
<hr>
...
<hr>
<h2>Syntax</h2>
<p>Return the poster property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.poster</div></div>
<p>Set the poster property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.poster = <em>URL</em></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the poster image. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of the poster image:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).poster;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/w3javascript.gif</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_poster2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_poster.asp">HTML &lt;video&gt; poster attribute</a></p>
<hr>
