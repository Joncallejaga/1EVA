...
<div class="w3-code notranslate">
 nofollow</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_rel" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>anchorObject</em>.rel = &quot;<i>value</i>&quot;</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
   ...
   <tr>
    <td>noreferrer</td>
    <td>Specifies that the browser should not send a HTTP referer header if the user follows the hyperlink</td>
  </tr>
  <tr>
    <td>prefetch</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the relationship between the current document and the linked document</td>
</tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_anchor_rel2">Try it Yourself &raquo;</a>
</div>
<hr>
