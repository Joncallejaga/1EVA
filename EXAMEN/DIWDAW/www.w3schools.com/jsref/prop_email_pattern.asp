...
<html lang="en-US">
<head>
<title>HTML DOM Input Email pattern Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">pattern</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the value of the pattern attribute of an email field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).pattern;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_pattern">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pattern property sets or returns the value of the pattern attribute of an 
email field.</p>
<p>The pattern attribute specifies a regular expression that the email field's 
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.pattern</div></div>
<p>Set the pattern property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.pattern = <em>regexp</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>regexp</em></td>
    <td>
  Specifies a regular expression that the email field's value is checked  against</td>
  </tr>
</table>
