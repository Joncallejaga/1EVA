...
<h1>Video <span class="color_h1">load()</span> Method</h1>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_video_load" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The load() method re-loads the video element.</p>
<p>The load() method is used to update the video element after changing the source or other settings.</p>
<hr>
