...
<html lang="en-US">
<head>
<title>JavaScript Number isInteger() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">isInteger()</span> Method</h1>
...
<h3>Example</h3>
<p>Check whether a value is an integer:</p>
<div class="w3-code notranslate jsHigh">
 Number.isInteger(123) //true<br>Number.isInteger(-123) //true<br>Number.isInteger(5-2) //true<br>Number.isInteger(0) //true<br>Number.isInteger(0.5) //false<br>Number.isInteger('123') //false<br>Number.isInteger(false) //false<br>Number.isInteger(Infinity) //false<br>Number.isInteger(-Infinity) //false<br>Number.isInteger(0 / 0) //false</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_isinteger" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Number.isInteger() method determines whether a value an integer.</p>
<p>This method returns true if the value is of the type Number, and an integer 
(a number without decimals). Otherwise it returns false.</p>
<hr>
...
<p><strong>Note:</strong> The Number.isInteger() method is not supported in Internet 
Explorer 11 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
 Number.isInteger(<em>value</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the value is an integer Number, otherwise it returns false</td>
</tr>
<tr>
