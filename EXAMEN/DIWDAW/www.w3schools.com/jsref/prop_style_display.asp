...
<p><a href="dom_obj_style.asp" class="w3-btn w3-white w3-border" title="Style Object Reference">&#10094; Style Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Set a &lt;div&gt; element to not be displayed:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myDIV&quot;).style.display = &quot;none&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_display">Try it Yourself &raquo;</a>
</div>
<hr>
...
similar to the <a href="prop_style_visibility.asp">visibility</a> property. However, if you set <code class="w3-codespan">display:none</code>, it hides 
the entire element, while <code class="w3-codespan">visibility:hidden</code> means that the contents of the 
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.style.display = <i>value
 </i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>compact</td>
    <td>Element is rendered as a block-level or inline  element. Depends on context</td>
  </tr>
  <tr>
    <td>flex</td>
  ...
  <tr>
    <td>inline-table</td>
    <td>Element is rendered as an inline table (like  &lt;table&gt;), with no line break before or after the table</td>
  </tr>
  <tr>
    <td>list-item</td>
  ...
  <tr>
    <td>marker</td>
    <td>This value sets content before or after a box to be a  marker (used with :before and  :after pseudo-elements. Otherwise this value is identical to &quot;inline&quot;)</td>
  </tr>
  <tr>
    <td>none</td>
  ...
  <tr>
    <td>run-in</td>
    <td>Element is rendered as block-level or inline  element. Depends on context</td>
  </tr>
  <tr>
    <td>table</td>
    <td>Element is rendered as a block table (like  &lt;table&gt;), with a line break before and after the table</td>
  </tr>
  <tr>
    <td>table-caption</td>
    <td>Element is rendered as a table caption (like  &lt;caption&gt;)</td>
  </tr>
  <tr>
    <td>table-cell</td>
    <td>Element is rendered as a table cell (like  &lt;td&gt; and &lt;th&gt;)</td>
  </tr>
  <tr>
    <td>table-column</td>
    <td>Element is rendered as a column of cells  (like &lt;col&gt;)</td>
  </tr>
  <tr>
    <td>table-column-group</td>
    <td>Element is rendered as a group of one or more  columns (like &lt;colgroup&gt;)</td>
  </tr>
  <tr>
    <td>table-footer-group</td>
    <td>Element is rendered as a table footer  row (like &lt;tfoot&gt;)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>table-row</td>
    <td>Element is rendered as a table row (like  &lt;tr&gt;)</td>
  </tr>
  <tr>
    <td>table-row-group</td>
    <td>Element is rendered as a group of one or more  rows (like &lt;tbody&gt;)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_display2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Toggle between hiding and showing an element:</p>
<div class="w3-code notranslate jsHigh">
 function myFunction() {<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById('myDIV');<br>&nbsp;&nbsp;&nbsp; if (x.style.display === 'none') {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.display = 'block';<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.display = 'none';<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_display_toggle">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 function myFunction(x)&nbsp; {<br>&nbsp;&nbsp;&nbsp; var whichSelected = x.selectedIndex;<br>&nbsp;&nbsp;&nbsp; var sel = x.options[whichSelected].text;<br>&nbsp;&nbsp;&nbsp; var elem = document.getElementById(&quot;mySpan&quot;);<br>
 &nbsp;&nbsp;&nbsp;
 elem.style.display = sel;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_display3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_display4">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a href="dom_obj_style.asp" class="w3-btn w3-white w3-border" title="Style Object Reference">&#10094; Style Object</a>
</div>
