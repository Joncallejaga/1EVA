...
<html lang="en-US">
<head>
<title>HTML DOM Progress max Property</title>
 <meta charset="utf-8">
...
<h1>Progress <span class="color_h1">max</span> Property</h1>
<p><a href="dom_obj_progress.asp" class="w3-btn w3-white w3-border" title="Progress Object Reference">&#10094; Progress Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the maximum value in a progress bar:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myProgress&quot;).max = &quot;50&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_progress_max" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The max property sets or returns the value of the max attribute of a 
progress bar.</p>
<p>The max attribute specifies how much work the task requires in total before 
it can be considered complete.</p>
<p><strong>Note:</strong> The &lt;progress&gt; element is new in HTML5.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>progressObject</em>.max</div></div>
<p>Set the max property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>progressObject</em>.max =<em> number</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <th style="width:20%">Value</th>
   ...
   <tr>
    <td><em>number</em></td>
    <td>Specifies how much work the task requires in total before it can be considered complete</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A floating point number, representing how much work the task requires in total</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the maximum value of a progress bar:</p>
<div class="w3-code notranslate jsHigh ">
 var x = document.getElementById(&quot;myProgress&quot;).max;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">100</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_progress_max2">Try it Yourself &raquo;</a>
</div>
<br>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_progress_max.asp">HTML &lt;progress&gt; max attribute</a></p>
<hr>

<a href="dom_obj_progress.asp" class="w3-btn w3-white w3-border" title="Progress Object Reference">&#10094; Progress Object</a>
</div>
