...
<html lang="en-US">
<head>
<title>JavaScript trunc() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">trunc()</span> Method</h1>
...
<p>The trunc() method returns the integer part of a number.</p>
<p><strong>Note:</strong> This method will NOT round the number up/down to the nearest ingeger, but simply remove the decimals.</p>
<hr>
