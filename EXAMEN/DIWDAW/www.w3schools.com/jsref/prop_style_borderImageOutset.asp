...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDIV&quot;).style.borderImageOutset = &quot;5px 10px 20px 15px&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderimageoutset_NOTEPAD">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">borderImageOutset</td>
    <td>Yes</td>
    <td>11.0</td>
    <td>Yes</td>
    <td>6.0</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_border-image-outset.asp">border-image-outset property</a></p>
<hr>
