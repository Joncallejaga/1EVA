...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit form Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">form</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_form">Try it Yourself &raquo;</a>
</div>
<hr>
