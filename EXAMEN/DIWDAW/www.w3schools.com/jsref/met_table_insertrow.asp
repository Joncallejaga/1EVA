...
<div class="w3-code notranslate jsHigh">
 // Find a &lt;table&gt; element with id=&quot;myTable&quot;:<br>var table = document.getElementById(&quot;myTable&quot;);<br><br>// Create an empty &lt;tr&gt; element and add it to the 1st position of the table:<br>var row = table.insertRow(0);<br><br>// Insert new cells (&lt;td&gt; elements) at the 1st and 2nd position of the &quot;new&quot; &lt;tr&gt; element:<br>var cell1 = row.insertCell(0);<br>var cell2 = row.insertCell(1);<br><br>// Add some text to the new cells:<br>
 cell1.innerHTML = &quot;NEW CELL1&quot;;<br>cell2.innerHTML = &quot;NEW CELL2&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_table_insertrow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> A &lt;tr&gt; element must contain one or more &lt;th&gt; or &lt;td&gt; elements.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">insertRow()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required in Firefox and Opera, optional in IE, Chrome and Safari. A number that specifies the position of the row to insert (starts  at 0). The value of 0 results in that the new row will be inserted at  the first position.<p>The value of -1 can also be used, this results in a new row being inserted at the last position.</p>
  This parameter is required in Firefox and Opera, but optional in Internet  Explorer, Chrome and Safari.
  <br><br>If this parameter is omitted, insertRow() inserts a new row at the last  position in Chrome, IE, Firefox and Opera, and  at the first position in Safari. </td>
  </tr>
</table>
<hr>
...
<div class="w3-code notranslate jsHigh">
 function myCreateFunction() {<br>&nbsp;&nbsp;&nbsp; var table = document.getElementById(&quot;myTable&quot;);<br>&nbsp;&nbsp;&nbsp; var row = table.insertRow(0);<br>&nbsp;&nbsp;&nbsp; var cell1 = row.insertCell(0);<br>&nbsp;&nbsp;&nbsp; var cell2 = row.insertCell(1);<br>&nbsp;&nbsp;&nbsp; cell1.innerHTML = &quot;NEW CELL1&quot;;<br>&nbsp;&nbsp;&nbsp; cell2.innerHTML = &quot;NEW CELL2&quot;;<br>}<br><br>
 function myDeleteFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTable&quot;).deleteRow(0);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_insert_deleterow">Try it Yourself &raquo;</a>
</div>
<hr>
