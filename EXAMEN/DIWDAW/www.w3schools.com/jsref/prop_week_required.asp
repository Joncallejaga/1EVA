...
<html lang="en-US">
<head>
<title>HTML DOM Input Week required Property</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">required</span> Property</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a week field must be filled out before submitting a 
form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myWeek&quot;).required;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_required">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The required property sets or returns whether a week field must be 
...
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.required
</div></div>
<p>Set the required property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.required = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a week field should be a required part of form submission.<ul>
      <li>true - The week field is a required part of form   submission</li>
      <li>false - Default. The week field is not a required part   of form submission</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the week field is a required part of form submission, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a week field to be a required part of form submission:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).required = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_required2">Try it Yourself &raquo;</a>
</div>
<hr>
