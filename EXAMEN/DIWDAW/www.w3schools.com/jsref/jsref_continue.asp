...
<h1>JavaScript <span class="color_h1">continue</span> Statement</h1>
...
<p>The continue statement breaks one iteration (in the loop) if a specified 
condition occurs, and continues with the next iteration in the loop.</p>
<p>The difference between continue and the <a href="jsref_break.asp">break</a> 
statement, is instead of&nbsp;&quot;jumping out&quot; of a loop, the continue statement 
&quot;jumps over&quot; one iteration in the loop.</p>
<p>However, when the continue statement is executed, it behaves differently for 
different types of loops:</p>
<ul>
  <li>In a <strong>while</strong> loop, the condition is tested, and if it is true, the loop is executed again</li>
  <li>In a <strong>for loop</strong>, the increment expression (e.g. i++) is first evaluated, and then the condition is tested to find out if another iteration should be done</li>
</ul>
<p>The continue statement can also be used with an optional label reference.</p>
...
<div class="w3-code w3-border notranslate"><div>
 continue;</div></div>
<p>Using the optional label reference:</p>
<div class="w3-code w3-border notranslate"><div>
 continue<i> labelname;</i></div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>In this example we use a while loop together with the continue statement.</p>
 <p>Loop through a block of code, but skip the value of &quot;3&quot;:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i = 0;<br>while (i &lt; 5) {<br>&nbsp;&nbsp;&nbsp; i++;<br>&nbsp;&nbsp;&nbsp; if (i === 3) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; continue;<br>&nbsp;&nbsp;&nbsp; }<br>text += &quot;&lt;br&gt;The number is &quot; + i;<br>}</div>
<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 The number is 1<br>The number is 2<br>The number is 4<br>The number is 5</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_continue2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through a block of code, but skip the numbers 2 and 3 (using the OR 
operator):</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i;<br>for (i = 1; i &lt; 8; i++) {<br>&nbsp;&nbsp;&nbsp; if (i === 2 || i === 3) continue;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML += i + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 1<br>4<br>5<br>6<br>7</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_continue_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>In this example we use a for loop together with the continue statement.</p>
 <p>Loop through an array, but skip the array's element &quot;Saab&quot;:</p>
 <div class="w3-code notranslate jsHigh">
  var cars = [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Saab&quot;, &quot;Ford&quot;];<br>var text = &quot;&quot;<br>var i;<br>for (i = 0; i &lt; cars.length; i++) {<br>&nbsp;&nbsp;&nbsp; if (cars[i] === &quot;Saab&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; continue;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; text += cars[i] + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 BMW<br>Volvo<br>Ford</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_state_continue_arr" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the continue statement with a label reference, to skip a value in a nested 
for loop:</p>
<div class="w3-code notranslate jsHigh">
 var text = &quot;&quot;;<br>var i, j;<br><br>Loop1: // The first for loop is labeled &quot;Loop1&quot;<br>for (i = 0; i &lt; 3; i++) {<br>text += &quot;&lt;br&gt;&quot; + &quot;i = &quot; + i + &quot;, j = &quot;;<br><br>&nbsp;&nbsp;&nbsp; Loop2: // The second for loop is labeled &quot;Loop2&quot;<br>&nbsp;&nbsp;&nbsp; for (j = 10; j &lt; 15; j++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (j === 12) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; continue Loop2;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = text += j + &quot; &quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<!--<p>The result of <em>text</em> will be:</p>
<div class="w3-code notranslate">
 i = 0, j = 10 11 13 14<br>i = 1, j = 10 11 13 14<br>i = 2, j = 10 11 13 14 </div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_continue_label_nest" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_break.asp">JavaScript Break and Continue</a></p>
...
<p>JavaScript Tutorial: <a href="jsref_break.asp">JavaScript break Statement</a></p>
