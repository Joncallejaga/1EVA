...
document.getElementById(&quot;myDiv&quot;).style.borderColor = &quot;red&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_bordercolor">Try it Yourself &raquo;</a>
</div>
...
<ul>
  <li>One value, like: p {border-color: red} - all four borders will be red</li>
  <li>Two values, like: p {border-color: red transparent} -  top and bottom border will be red, left and right border will be transparent</li>
  <li>Three values, like: p {border-color: red green blue}- top border will be red, left and right border will be green, bottom border will be blue</li>
  <li>Four values, like: p {border-color: red green blue yellow} - top border will be red, right border will be green, bottom border will be blue, left border will be yellow</li>
</ul>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the color of the border. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values. Default color is black</td>
  </tr>
  <tr>
    <td>transparent</td>
    <td>The color of the border is transparent (underlying content will shine through)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_bordercolor2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_bordercolor3">Try it Yourself &raquo;</a>
</div>
<hr>
