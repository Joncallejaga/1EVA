...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration getPropertyValue Method</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration getPropertyValue<span class="color_h1">() Method</span></h1>
...
<h3>Example</h3>
<p>Return the value of the color property:</p>
<div class="w3-code notranslate jsHigh">
var declaration = document.styleSheets[0].cssRules[0].style;<br>var 
  propvalue = declaration.getPropertyValue(&quot;color&quot;);<br>alert(propvalue);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_getpropertyvalue">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The getPropertyValue() method returns the value of the specified CSS property.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getPropertyValue()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>object</em>.getPropertyValue(<em>propertyname</em>)</div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A String, representing the value of the property</td>
  </tr>
  </table>
