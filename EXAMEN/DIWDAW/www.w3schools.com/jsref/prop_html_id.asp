...
<h3>Example</h3>
<p>Get the id of an element:</p>
<div class="w3-code notranslate jsHigh">
  var x = document.getElementsByClassName(&quot;anchors&quot;)[0].id;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 myAnchor</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_id" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The id property sets or returns the id of an element (the value of an element's id 
attribute).</p>
<p>An ID should be unique within a page, and is often used to return the element 
using the
<a href="met_document_getelementbyid.asp">document.getElementById()</a> method.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.id</div></div>
<p>Set the id property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.id = <em>id</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>id</em></td>
    <td>
  Specifies the id of an element</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the ID of an element</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the id of an element:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;demo&quot;).id = &quot;newid&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_id2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_element_id3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css_syntax.asp">CSS Syntax</a></p>
<p>CSS Reference: <a href="../cssref/sel_id.asp">CSS <em>#id</em> Selector</a></p>
<p>HTML DOM Reference: <a href="met_document_getelementbyid.asp">HTML DOM getElementById() Method</a></p>
<hr>
