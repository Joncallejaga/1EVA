...
<html lang="en-US">
<head>
<title>HTML DOM Map name Property</title>
 <meta charset="utf-8">
...
<div class="w3-code notranslate">
 planetmap</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_map_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property sets or returns the value of the name attribute of an 
image-map.</p>
<p>The name attribute specifies the name of an image-map. </p>
<p>The name attribute is 
associated with the &lt;img&gt;'s usemap attribute and creates a relationship between 
the image and the map.</p>
<p><strong>Note:</strong> When setting the name property, you should also 
set the &lt;img&gt;'s usemap attribute - if not, the relationship between the 
image and the map will no longer exist (clickable areas will no longer be clickable).</p>
<p><strong>Note:</strong> In HTML5, the id attribute of the &lt;map&gt; element must 
have the same value as the name attribute (and it cannot be null or empty).</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>mapObject</em>.name
</div></div>
<p>Set the name property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>mapObject</em>.name = <i>name</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>name</i></td>
    <td>
  Specifies the name of an image-map</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the image-map</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of an image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("planetmap").name = &quot;newMapName&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_map_name2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_map_name.asp">HTML &lt;map&gt; name attribute</a></p>
<hr>
