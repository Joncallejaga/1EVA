...
<h1>JavaScript Array <span class="color_h1">isArray()</span> Method</h1>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_isarray" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isArray() method determines whether an object is an array.</p>
<p>This function returns true if the object is an array, and false if not.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 Array.isArray<em>(obj</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the object is an array, otherwise it returns false</td>
</tr>
<tr>
