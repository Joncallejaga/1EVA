...
<h1>JavaScript Array <span class="color_h1">reduceRight()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var numbers = [65, 44, 12, 4];<br><br>function getSum(total, num) {<br>&nbsp;&nbsp;&nbsp; return total + num;<br>}<br>function myFunction(item) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = numbers.reduceRight(getSum);<br>}</div>
<!--<p>The result will be:</p>
<div class="w3-code notranslate">
 125</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reduceright">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <span class="color_h1">reduceRight</span>() method reduces the array to a 
single value.</p>
<p>The reduceRight() method executes a provided function for each value of the array 
(from right-to-left).</p>
<p>The return value of the function is stored in an accumulator (result/total).</p>
<p><strong>Note:</strong> <span class="color_h1">reduceRight</span>() does not execute the function for array 
...
<i>array</i>.<span class="color_h1">reduceRight</span>(<em>function(total, currentValue, currentIndex, arr), initialValue</em>)</div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Subtract the numbers, right-to-left, and display the sum:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;button onclick=&quot;myFunction()&quot;&gt;Try it&lt;/button&gt;<br><br>&lt;p&gt;Sum of numbers in array: &lt;span id=&quot;demo&quot;&gt;&lt;/span&gt;&lt;/p&gt;<br><br>&lt;script&gt;<br>var numbers = [2, 45, 30, 100];<br><br>function getSum(total, num) {<br>&nbsp;&nbsp;&nbsp; return total - num;<br>}<br>
 function myFunction(item) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = numbers.reduceRight(getSum);<br>}<br>&lt;/script&gt;
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_reduceright2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
