...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_outlineoffset">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">outlineOffset</td>
    <td>Yes</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_outline-offset.asp">outline-offset property</a></p>
<hr>
