...
<h3>Example</h3>
 <p>Get the number of attributes of a &lt;button&gt; element:</p>
...
<div class="w3-code notranslate">
 2</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of nodes in a NamedNodeMap object.</p>
<p>A Node object's attributes is an example of a NamedNodeMap object.</p>
<p>This property is read-only.</p>
<p><strong>Tip:</strong> Use the <a href="met_namednodemap_item.asp">item()</a> method to return a node at the specified index in a NamedNodeMap object.</p>
<hr>
...
<tr>
 ...
 <td width="75%">A Number, representing the number of attribute nodes in the nodemap</td>
</tr>
<tr>
  <th>DOM Version</th>
  <td>Core Level 1</td>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all attributes of a &lt;button&gt; element and output the name of each attribute:</p>
<div class="w3-code notranslate jsHigh">
 var txt = &quot;&quot;;<br>var x = document.getElementById(&quot;myBtn&quot;).attributes;<br><br>var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt += &quot;Attribute name: &quot; + x[i].name + &quot;&lt;br&gt;&quot;;<br>}</div>
<!--<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
 Attribute name: id<br>Attribute name: onclick<br>Attribute name: class</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_namednodemap_length2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many attributes an &lt;img&gt; element have:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myImg").attributes.length;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 5</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_attributes3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all attributes of an &lt;img&gt; element and output each attribute's name and value:</p>
<div class="w3-code notranslate jsHigh">
 var txt = &quot;&quot;;<br>var x = document.getElementById(&quot;myImg&quot;);<br><br>
 var i;<br>for (i = 0; i &lt; x.attributes.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.attributes[i].name + &quot; = &quot; + x.attributes[i].value + &quot;&lt;br&gt;&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_attributes4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
