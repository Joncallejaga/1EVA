...
<html lang="en-US">
<head>
<title>HTML DOM Input Text form Property</title>
 <meta charset="utf-8">
...
<h1>Input Text <span class="color_h1">form</span> Property</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_text_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form that contains the text field.</p>
