...
<html lang="en-US">
<head>
<title>HTML DOM Form noValidate Property</title>
 <meta charset="utf-8">
...
<h1>Form <span class="color_h1">noValidate</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;).noValidate;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true // the form-data should not be validated on submission</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_form_novalidate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The noValidate property sets or returns whether the form-data should be 
validated or not, on submission.</p>
<p>By default, form-data inside &lt;form&gt; elements will be validated on submission.</p>
<p>When set to true, this property adds the &quot;novalidate&quot; attribute to the 
&lt;form&gt; element, and specifies that the form-data should not be validated on submission.</p>
<p><strong>Note:</strong> The novalidate attribute is new for the &lt;form&gt; element in HTML5.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the noValidate property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>formObject</em>.noValidate</div></div>
<p>Set the noValidate property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>formObject</em>.noValidate = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      ...
      <li>false - The form-data should be validated</li>
  </ul>
    </td>
  </tr>
</table>
...
<p>Set the noValidate property:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myForm&quot;).noValidate = true;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_form_novalidate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_form_novalidate.asp">HTML &lt;form&gt; novalidate attribute</a></p>
<hr>
