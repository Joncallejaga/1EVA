...
window:</p>
<div class="w3-code notranslate jsHigh">
 function openWin() {<br>&nbsp;&nbsp;&nbsp; myWindow = window.open(&quot;https://www.w3schools.com&quot;, &quot;_blank&quot;, &quot;width=200, height=100&quot;);<br>
 }<br><br>function closeWin() {<br>&nbsp;&nbsp;&nbsp; myWindow.close();<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_close2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
