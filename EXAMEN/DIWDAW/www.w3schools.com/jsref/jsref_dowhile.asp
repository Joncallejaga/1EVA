...
<html lang="en-US">
<head>
<title>JavaScript do/while Statement</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">do/while</span> Statement</h1>
...
<div class="w3-code notranslate">
 ...
 The number is 4</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_state_dowhile" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The do/while statement creates a loop that executes a block of code once, 
before checking if the condition is true, then it will repeat the loop as long 
as the condition is true.</p>
<p>The do/while statement is used when you want to run a loop <strong>at least 
one time</strong>, no matter what.</p>
...
<ul>
  ...
  <li><strong>do/while</strong> - loops through a block of code once, and then repeats the loop while a specified condition is true</li>
</ul>
...
<p>The numbers in the table specify the first browser version that fully supports the statement.</p>
