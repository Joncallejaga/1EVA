...
<h1>HTMLCollection <span class="color_h1">namedItem()</span> Method</h1>
<p><a href="dom_obj_htmlcollection.asp" class="w3-btn w3-white w3-border" title="HTMLCollection Object"> HTMLCollection</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the content of the P element with ID "myElement":</p>
 <div class="w3-code notranslate jsHigh">
   function myFunction() {<br>&nbsp; var x = document.getElementsByTagName(&quot;P&quot;).namedItem("myElement");<br>&nbsp; 
   alert(x.innerHTML);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_nameditem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">namedItem()</code> method returns the element 
with the specified ID, or name, in an HTMLCollection.</p>
<p>A shorthand method can also be used, and will produce the same result:</p>

<div class="w3-example">

<div class="w3-code notranslate"><span class="jsHigh">var x = document.getElementsByTagName(&quot;P&quot;)<strong>[&quot;myElement&quot;]</strong>;</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjsref_htmlcollection_nameditem2">Try it</a></div>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">namedItem()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate">
  <div>
    <i>HTMLCollection</i>.namedItem(<em>name</em>)
  </div>
</div>
OR:
<div class="w3-code w3-border notranslate">
  <div>
    <i>HTMLCollection</i>[name]
  </div>
</div>
...
<tr>
<td><em>name</em></td>
<td>Required. The value of the id attribute, or name attribute, of the element you want to return.</td>
</tr>
</table>
<hr>
...
<h2>Return Value</h2>
<p>An <a href="dom_obj_all.asp">Element</a> object, representing the element at 
with specified ID or name.</p>
<p>Returns <em>null</em> if the element does not exist.</p>

<hr>


<h2>Related Pages</h2>
<p>HTMLCollection: <a href="met_htmlcollection_item.asp">item()</a> Method</p>
<p>HTMLCollection: <a href="https://www.w3schools.com/jsref/met_htmlcollection_length.asp">length</a> Property</p>
<hr>
<p><a href="dom_obj_htmlcollection.asp" class="w3-btn w3-white w3-border" title="HTMLCollection Object"> HTMLCollection</a></p>
</div>
