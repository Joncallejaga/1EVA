...
<html lang="en-US">
<head>
<title>isTrusted Event Property</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">isTrusted</span> Event Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out if a specific event is trusted:</p>
<div class="w3-code notranslate jsHigh">
 function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; if (&quot;isTrusted&quot; in event) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (event.isTrusted) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert (&quot;The &quot; + event.type + &quot; event is trusted.&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert (&quot;The &quot; + event.type + &quot; event is not trusted.&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert (&quot;The isTrusted property is not supported by your browser&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_istrusted" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isTrusted event property returns a Boolean value indicating whether the 
event is trusted or not.</p>
<p><strong>Note:</strong> In Chrome, Firefox and Opera, the event is trusted if it is invoked by the user, and not 
trusted if it is invoked by a script. In IE, all events are trusted except those 
that are created with the createEvent() method.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">isTrusted</td>
    <td>46.0</td>
    <td>9.0</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.isTrusted</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean, indicating whether the event is trusted or not
 <p>Possible values:</p>
 <ul>
    <li>true - The event is trusted</li>
    <li>false - The event is not trusted</li>
 </ul>
   </td>
  </tr>
  <tr>
