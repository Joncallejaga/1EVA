...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_inputbutton_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the input button</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of a button:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myBtn&quot;).name = &quot;newButtonName&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_inputbutton_name2">Try it Yourself &raquo;</a>
</div>
<hr>
