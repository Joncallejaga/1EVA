...
<html lang="en-US">
<head>
<title>HTML DOM Details open Property</title>
 <meta charset="utf-8">
...
<h1>Details <span class="color_h1">open</span> Property</h1>
<p><a href="dom_obj_details.asp" class="w3-btn w3-white w3-border" title="Details Object Reference">&#10094; Details Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Show additional details:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDetails&quot;).open = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_details_open2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The open property sets or returns whether additional details/information should be 
visible (open) to the user, or not.</p>
<p>This property reflects the HTML open attribute.</p>
<p>When set to true, the details will be visible (open) to the user.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the open property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>detailsObject</em>.open
</div></div>
<p>Set the open property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>detailsObject</em>.open = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <ul>
      <li>true - Details will be visible</li>
      <li>false - Details will not be visible</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the details are visible, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if additional details are visible (open) to the user, or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDetails&quot;).open;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_details_open">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Toggle between opening and closing the additional details:</p>
<div class="w3-code notranslate jsHigh">
 function openDetails() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDetails&quot;).open = true;<br>
 }<br><br>function closeDetails() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDetails&quot;).open = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_details_open3">Try it Yourself &raquo;</a>
</div>
<hr>

<a href="dom_obj_details.asp" class="w3-btn w3-white w3-border" title="Details Object Reference">&#10094; Details Object</a>
</div>
