...
<html lang="en-US">
<head>
<title>JavaScript Number isFinite() Method</title>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">isFinite()</span> Method</h1>
...
<h3>Example</h3>
<p>Check whether a value is a finite number:</p>
<div class="w3-code notranslate jsHigh">
 Number.isFinite(123) //true<br>Number.isFinite(-1.23) //true<br>Number.isFinite(5-2) //true<br>Number.isFinite(0) //true<br>Number.isFinite('123') //false<br>Number.isFinite('Hello') //false<br>Number.isFinite('2005/12/12') //false<br>Number.isFinite(Infinity) //false<br>Number.isFinite(-Infinity) //false<br>Number.isFinite(0 / 0) //false</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_isfinite_number" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Number.isFinite() is different from the global <a href="jsref_isfinite.asp">isFinite()</a> 
function. The global isFinite() 
function converts the tested value to a Number, then tests it.</p>
<p>Number.isFinite() does not convert the values to a Number, and will not return 
...
<div class="w3-code w3-border notranslate"><div>
 Number.isFinite(<em>value</em>)</div></div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Boolean. Returns true if the value is a finite Number, otherwise it returns false</td>
</tr>
<tr>
