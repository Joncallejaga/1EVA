...
<html lang="en-US">
<head>
<title>HTML DOM Ol start Property</title>
 <meta charset="utf-8">
...
<h1>Ol <span class="color_h1">start</span> Property</h1>
<p><a href="dom_obj_ol.asp" class="w3-btn w3-white w3-border" title="Ol Object Reference">&#10094; Ol Object</a>
</p>
<div class="w3-example">
<h3>Example</h3>
<p>Set the start value of the ordered list to &quot;75&quot;:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myOl&quot;).start = &quot;75&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_start">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The start property sets or returns the value of the start attribute of an 
ordered list.</p>
...
<hr>
<h2>Syntax</h2>
<p>Return the start property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>olObject</em>.start</div></div>
<p>Set the start property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>olObject</em>.start = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the start value of the first item in the ordered list</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the start value of the first list item in the ordered list</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the first list item in the ordered list:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOl&quot;).start;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">50</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_start2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the start value of the ordered list to &quot;5&quot;, when using roman 
numbers (type=&quot;I&quot;):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myOl&quot;).start = &quot;5&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_ol_start3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_ol_start.asp">HTML &lt;ol&gt; start attribute</a></p>
<hr>
