...
<html lang="en-US">
<head>
<title>HTML DOM ins cite Property</title>
 <meta charset="utf-8">
...
<h1>ins <span class="color_h1">cite</span> Property</h1>
<p><a href="dom_obj_ins.asp" class="w3-btn w3-white w3-border" title="ins Object Reference">&#10094; ins Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the URL to a document that explains why some text was inserted:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myIns").cite;
</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 http://www.example.com/example/why_inserted.htm</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_ins_cite" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cite property sets or returns the value of the cite attribute of an 
inserted text.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>insObject</em>.cite
</div></div>
<p>Set the cite property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>insObject</em>.cite = <i>URL</i>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>
  Specifies the source URL to the document that explains why the text was  inserted/changed.<br>
  <br>Possible values:
     <ul>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById("myIns&quot;).cite = &quot;http://www.example.com/whyweinsertedsometext.htm&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_ins_cite2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_ins_cite.asp">HTML &lt;ins&gt; cite attribute</a></p>
<hr>
