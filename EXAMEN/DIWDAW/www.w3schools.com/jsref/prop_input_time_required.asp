...
<html lang="en-US">
<head>
<title>HTML DOM Input Time required Property</title>
 <meta charset="utf-8">
...
<h1>Input Time <span class="color_h1">required</span> Property</h1>
...
<h3>Example</h3>
<p>Find out if a time field must be filled out before submitting a 
form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTime&quot;).required;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_required">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The required property sets or returns whether a time field must be filled out before submitting a form.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.required
</div></div>
<p>Set the required property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>timeObject</em>.required = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a time  field should be a required part of form submission.<ul>
      <li>true - The time field is a required part of form   submission</li>
      <li>false - Default. The time field is not a required part   of form submission</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the time field is a required part of form submission, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a time field to be a required part of form submission:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTime&quot;).required = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_time_required2">Try it Yourself &raquo;</a>
</div>
<hr>
