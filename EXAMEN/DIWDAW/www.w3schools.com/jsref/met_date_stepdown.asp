...
<html lang="en-US">
<head>
<title>HTML DOM Input Date stepDown() Method</title>
<meta charset="utf-8">
...
<h1>Input Date <span class="color_h1">stepDown()</span> Method</h1>
<p><a href="dom_obj_date.asp" class="w3-btn w3-white w3-border" title="Input Date Object Reference">&#10094; Input Date Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Decrement the value of a date field by 5 days:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDate&quot;).stepDown(5);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_stepdown">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stepDown() method decrements the value of the date field by a specified 
number.</p>
<p>This method will only have an affect on DAYS (not month and year).</p>
<p><strong>Tip:</strong> To increment the value, use the
<a href="met_date_stepup.asp">stepUp()</a> method.</p>
<hr>

<h2>Browser Support</h2>
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;text-align:left;">Method</th>
...
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.stepDown(<em>number</em>)</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the amount of days the date field should  decrease.<br><br>If omitted, the days are decremented by &quot;1&quot;</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Decrement the days by 1 (default):</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDate&quot;).stepDown();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_stepdown2">Try it Yourself &raquo;</a>
</div>
<hr>
