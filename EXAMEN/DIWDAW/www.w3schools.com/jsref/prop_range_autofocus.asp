...
<html lang="en-US">
<head>
<title>HTML DOM Input Range autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Input Range <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_range.asp" class="w3-btn w3-white w3-border" title="Input Range Object Reference">&#10094; Input Range Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a slider control automatically gets focus upon page load:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myRange&quot;).autofocus;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_range_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The autofocus property sets or returns whether a slider control should 
...
<div class="w3-code w3-border notranslate"><div>
 <em>rangeObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>rangeObject</em>.autofocus = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a slider control should get focus when the page loads,  or not
  <ul>
      <li>true - The slider control gets focus</li>
      <li>false - Default. The slider control does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the slider control automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
