...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_transitionduration">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The transitionDuration property sets or returns how many seconds (s) or milliseconds 
(ms) a transition effect takes to complete.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>10.0</td>
    <td>16.0</td>
    <td>6.1<br>3.1&nbsp;WebkitTransitionDuration</td>
    <td>12.1</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies how many seconds or milliseconds a transition effect takes to complete. Default value is 0, meaning there will be no effect</td>
  </tr>
    <tr>
    <td>initial</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_transition-duration.asp">transition-duration property</a></p>
<hr>
