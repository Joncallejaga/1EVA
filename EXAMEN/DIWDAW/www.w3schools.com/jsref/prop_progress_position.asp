...
<html lang="en-US">
<head>
<title>HTML DOM Progress position Property</title>
 <meta charset="utf-8">
...
<h1>Progress <span class="color_h1">position</span> Property</h1>
<p><a href="dom_obj_progress.asp" class="w3-btn w3-white w3-border" title="Progress Object Reference">&#10094; Progress Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the current position of the progress bar:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myProgress&quot;).position;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">0.22</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_progress_position">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The position property returns the current position of the progress bar. </p>
<p>The value of this property is the result of dividing the current value (specified 
with the value 
attribute) by the maximum value (specifies with the max attribute).</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>progressObject</em>.position</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A floating point number, representing the current position of the progress bar</td>
  </tr>
</table>
