...
<h3>Example</h3>
<p>Get the name of a text area:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myTextarea&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">comment</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the text area</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of a text area:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myTextarea&quot;).name = &quot;newTxtName&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_textarea_name2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_textarea_name.asp">HTML &lt;textarea&gt; name attribute</a></p>
<hr>
