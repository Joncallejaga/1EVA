...
<html lang="en-US">
<head>
<title>WheelEvent deltaMode Property</title>
<meta charset="utf-8">
...
<h1>WheelEvent <span class="color_h1">deltaMode</span> Property</h1>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_wheelevent.asp" class="w3-btn w3-white w3-border" title="WheelEvent">&#10094; WheelEvent</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the length unit of the delta values:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var x = event.deltaMode;<br>&nbsp; // 0 
  = pixels<br>&nbsp; // 1 = lines<br>&nbsp; // 2 = pages<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_wheel_deltamode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">deltaMode</code> property returns a number 
representing the length unit of the scrolling values (<code class="w3-codespan"><a href="event_wheel_deltax.asp">deltaX</a></code>, 
<code class="w3-codespan"><a href="event_wheel_deltay.asp">deltaY</a></code>, and 
<code class="w3-codespan"><a href="event_wheel_deltaz.asp">deltaZ</a></code>).</p>
<p>0 = pixels<br>1 = lines<br>2 = pages</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deltaMode</td>
    <td>31</td>
    <td>yes</td>
    <td>17</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A 
  Number, indicating the length unit of the delta values<br>Possible values:<br>
  0 = pixels<br>1 = lines<br>2 = pages</td>
</tr>
</table>

<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_wheel_deltax.asp">WheelEvent deltaX Property</a></p>
<p>HTML DOM reference: <a href="event_wheel_deltay.asp">WheelEvent deltaY Property</a></p>
<p>HTML DOM reference: <a href="event_wheel_deltaz.asp">WheelEvent deltaZ Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_wheelevent.asp" class="w3-btn w3-white w3-border" title="WheelEvent">&#10094; WheelEvent</a>
