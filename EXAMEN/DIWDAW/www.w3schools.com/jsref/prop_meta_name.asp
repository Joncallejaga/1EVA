...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName(&quot;META&quot;);<br>var txt = &quot;&quot;;<br>
 var i;<br>for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + &quot;Name of &quot;+(i+1)+&quot;. meta tag: &quot;+x[i].name+&quot;&lt;br&gt;&quot;;<br>
 }</div>
<!--<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
 Name of 1. meta tag: description<br>Name of 2. meta tag: keywords<br>Name of 3. meta tag: author</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meta_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property sets or returns a name for the information in the content attribute.</p>
<p>The value of the name attribute depends on the value of the content attribute.</p>
...
<a href="http://wiki.whatwg.org/wiki/MetaExtensions" target="_blank">WHATWG Wiki MetaExtensions page</a>.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>generator</td>
    <td>Specifies one of the software packages used to generate the document  (not used on hand-authored pages)<br><br>
  Example:
  &lt;meta name="generator" content="FrontPage 4.0"&gt;</td>
  </tr>
  <tr>
    <td>keywords</td>
    <td>Specifies a comma-separated list of keywords - relevant to the page  (Informs search engines what the page is about).<br><br>
  <b>Tip:</b> Always specify keywords (needed by search engines to catalogize the page).<br><br>
  Example:
  &lt;meta name="keywords" content="HTML, meta tag, tag  reference"&gt;</td>
  </tr>
 </table>
 <h2>Return Value</h2>
<table class="w3-table-all notranslate">
