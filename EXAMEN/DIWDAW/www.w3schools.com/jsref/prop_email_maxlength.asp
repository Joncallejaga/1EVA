...
<html lang="en-US">
<head>
<title>HTML DOM Input Email maxLength Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">maxLength</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the maximum number of characters allowed in a specific email field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).maxLength;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">30</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_maxlength">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The maxLength property sets or returns the value of the maxlength attribute of an email field.</p>
<p>The maxLength attribute specifies the maximum number of characters allowed in the email field.</p>
<p>The default value is 524288.</p>
<p><strong>Tip:</strong> To set or return the width of an email field, in number 
of characters, use the <a href="prop_email_size.asp">size</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.maxLength</div></div>
<p>Set the maxLength property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.maxLength = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>
  Specifies the maximum number of characters allowed in the email field.  Default value is 524288</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the maximum number of characters allowed in the email field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the maximum number of characters allowed in an email field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).maxLength = &quot;8&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_maxlength2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_maxlength.asp">HTML &lt;input&gt; maxlength attribute</a></p>
<hr>
