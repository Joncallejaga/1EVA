...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal type Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">type</span> Property</h1>
<p><a href="dom_obj_datetime-local.asp" class="w3-btn w3-white w3-border" title="Input DatetimeLocal Object Reference">&#10094; Input DatetimeLocal Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return which type of form element the local datetime field is:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).type;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">datetime-local</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_type">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The type property returns which type of form element the local datetime field is.</p>
<p><strong>Note:</strong> In the example above, Internet Explorer and Firefox 
returns &quot;text&quot;, instead of &quot;datetime-local&quot;.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.type</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the type of form element the local datetime field is</td>
  </tr>
</table>
