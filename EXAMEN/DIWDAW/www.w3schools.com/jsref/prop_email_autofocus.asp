...
<html lang="en-US">
<head>
<title>HTML DOM Input Email autofocus Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">autofocus</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if an email field automatically gets focus upon page load:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).autofocus;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_autofocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The autofocus property sets or returns whether an email field  
should automatically get focus when the page loads, or not.</p>
...
<p>The autofocus property is supported in all major browsers.</p>
<p><strong>Note:</strong> The autofocus property is not supported in Internet 
Explorer 9 and earlier versions, or in Opera 12 and earlier versions.</p>
<p><strong>Note:</strong> The &lt;input type=&quot;email&quot;&gt; element is not 
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.autofocus
</div></div>
<p>Set the autofocus property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.autofocus = &quot;true|false&quot;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether an email field should get focus when the page loads,  or not
  <ul>
      <li>true - The email field gets focus</li>
      <li>false - Default. The email field does not get focus</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the email field automatically gets focus when the page loads, otherwise it returns false</td>
  </tr>
</table>
...
<a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</div>
