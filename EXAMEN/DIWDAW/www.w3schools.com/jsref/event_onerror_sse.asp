...
<h3>Example</h3>
<p>Do something if a problem occurs with the event stream:</p>
<div class="w3-code notranslate jsHigh">
 var source = new EventSource(&quot;demo_sse.php&quot;);<br>source.onerror = function() {<br>&nbsp;&nbsp;&nbsp; // Do something to handle error<br>};</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The onerror event occurs when an error occurs with the event source.</p>
<p>An error usually occurs when a connection is disrupted. If this happens, the 
EventSource object will automatically attempt to reconnect to the server. </p>
