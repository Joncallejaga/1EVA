...
<html lang="en-US">
<head>
<title>HTML DOM Video audioTracks Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">audioTracks</span> Property</h1>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).audioTracks.length;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_audiotracks" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The audioTracks property returns a AudioTrackList object.</p>
<p>The AudioTrackList object represents the available audio tracks for the video.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>videoObject</em>.audioTracks</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Represents the available audio tracks for the video.<p>
