...
<html lang="en-US">
<head>
<title>HTML DOM Input Datetime min Property</title>
 <meta charset="utf-8">
...
<h1>Input Datetime <span class="color_h1">min</span> Property</h1>
...
<h3>Example</h3>
<p>Get the minimum date and time allowed for a datetime field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDatetime&quot;).min;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2000-01-01T22:57Z</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The min property sets or returns the value of the min attribute of a datetime 
field.</p>
<p>The min attribute specifies the minimum value (date and time) for a datetime field.</p>
<p><strong>Tip:</strong> Use the min attribute together with the max attribute 
to create a range of legal values.</p>
<p><strong>Tip:</strong> To set or return the value of the max attribute, use 
the <a href="prop_datetime_max.asp">max</a> property.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.min</div></div>
<p>Set the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimeObject</em>.min =<i> YYYY-MM-DDThh:mm:ssTZD</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em><i>YYYY-MM-DDThh:mm:ssTZD</i></em></td>
    <td>
  Specifies the minimum date and/or time  allowed for the datetime field. <br><br>Explanation of components:<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the minimum date and time allowed</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the minimum date and time:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDatetime&quot;).min = &quot;2010-01-01T21:57Z&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime_min2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_min.asp">HTML &lt;input&gt; min attribute</a></p>
<hr>
