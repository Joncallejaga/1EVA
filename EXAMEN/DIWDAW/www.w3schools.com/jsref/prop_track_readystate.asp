...
<html lang="en-US">
<head>
<title>HTML DOM Track readyState Property</title>
 <meta charset="utf-8">
...
<h1>Track <span class="color_h1">readyState</span> Property</h1>
<p><a href="dom_obj_track.asp" class="w3-btn w3-white w3-border" title="Track Object Reference">&#10094; Track Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the current ready state of the track resource:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myTrack").readyState;
</div>
<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 2 // Indicates that the text track has been loaded with no errors</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The readyState property returns the current ready state of the track resource.</p>
<p>The ready state indicates that the resource is ready to play or not.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.readyState</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the ready state of the track resource:<ul><li>
  0  = NONE - the text track's cues have not been obtained</li>
    ...
    <li>3 = ERROR - the text track was enabled, but when the user agent  attempted to obtain it, something failed. Some or all of the cues are  likely missing and will not be obtained</li>
  </ul>
    </td>
  </tr>
</table>
