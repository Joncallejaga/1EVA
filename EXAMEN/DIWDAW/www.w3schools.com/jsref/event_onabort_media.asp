...
<h1><span class="color_h1">onabort</span> Event</h1>
<p>
...
<h3>Example</h3>
<p>Execute a JavaScript when the loading of a video is aborted:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;video onabort=&quot;myFunction()&quot;&gt;</div>
<br></div>
<hr>

<h2>Definition and Usage</h2>
<p>The onabort event occurs when the loading of an audio/video is aborted.</p>
...
<ul>
  <li>onemptied</li>
  <li><a href="event_onerror_media.asp">onerror</a></li>
...
<p><strong>Note:</strong> The onabort event is not supported in Internet Explorer 11 on Windows 7.</p>
<hr>
...
<em>object</em>.onabort = function(){<i>myScript</i>};
 </div></div>
<div class="w3-example">
