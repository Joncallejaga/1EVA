...
<html lang="en-US">
<head>
<title>HTML DOM Audio preload Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">preload</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if and how the author thinks that the audio should be loaded when 
the page loads:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).preload;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 none // The audio should NOT be loaded when the page loads</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_preload" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The preload property sets or returns the value of the preload attribute of a 
audio.</p>
<p>The preload attribute specifies if and how the author thinks that the audio 
should be loaded when the page loads.</p>
...
<p><strong>Note:</strong> The preload attribute is ignored if the autoplay attribute 
is present.</p>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>audioObject</em>.preload</div></div>
<p>Set the preload property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>audioObject</em>.preload = &quot;auto|metadata|none&quot;</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>auto</td>
    <td>The author thinks that the browser should load the entire audio when the page loads</td>
  </tr>
  <tr>
    <td>metadata</td>
  ...
  <tr>
    <td>none</td>
    <td>The author thinks that the browser should NOT load the audio when the page loads</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing what data should be preloaded (if any). Possible return values are &quot;auto&quot;, &quot;metadata&quot;, or &quot;none&quot;. See &quot;Property Values&quot; for what the values mean</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of how to set different property values:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAudio&quot;).preload = &quot;none&quot;;<br>document.getElementById(&quot;myaudio&quot;).preload = &quot;auto&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_preload2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_audio_preload.asp">HTML &lt;audio&gt; preload attribute</a></p>
<hr>
