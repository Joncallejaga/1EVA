...
<h3>Example</h3>
 <p>Get a collection of the &lt;body&gt; element's child nodes:</p>
<div class="w3-code notranslate jsHigh">
 var c =
 document.body.childNodes;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_node_childnodes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The childNodes property returns a collection of a node's child nodes, as a NodeList object.</p>
...
text is considered as nodes. Comments are also considered as nodes.</p>
<p><strong>Tip: </strong>You can use the <a href="prop_nodelist_length.asp">length</a> property of the NodeList object to determine the number of child nodes, then you can loop through all child nodes and extract the info you want.</p>
<p>This property is read-only.</p>
<p><strong>Tip:</strong> To return a collection of a node's element nodes 
(excluding text and comment nodes), use the <a href="prop_element_children.asp">
children</a> property.</p>
<p><strong>Tip:</strong> <em>element</em>.childNodes[0] will produce the same 
result as the <a href="prop_node_firstchild.asp">firstChild</a> property.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A NodeList object, representing a collection of nodes. The nodes in the returned collection are sorted as they appear in the source code</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out how many child nodes a &lt;div&gt; element has:</p>
<div class="w3-code notranslate jsHigh">
 var c =
 document.getElementById(&quot;myDIV&quot;).childNodes.length;</div>
<!--<p>The result of <em>c</em> will be:</p>
<div class="w3-code notranslate">
 5</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_childnodes_length">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Change the background color of the second child node (index 1) of a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.getElementById(&quot;myDIV&quot;).childNodes;<br>c[1].style.backgroundColor = &quot;yellow&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_childnodes2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the third child node (index 2) of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var c = document.getElementById(&quot;mySelect&quot;).childNodes[2].text;</div>
<!--<p>The result of <em>c</em> will be:</p>
<div class="w3-code notranslate">
 Saab</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_childnodes3">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
