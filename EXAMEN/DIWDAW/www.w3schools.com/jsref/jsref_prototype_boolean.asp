...
<h3>Example</h3>
<p>Make a new method for JavaScript booleans:</p>
<div class="w3-code notranslate jsHigh">
 Boolean.prototype.myColor = function() {<br>&nbsp;&nbsp;&nbsp; if (this.valueOf() == true) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return &quot;green&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return = &quot;red&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>};</div>
<p>Create a boolean, then call myColor():</p>
<div class="w3-code notranslate jsHigh">
var a = true;<br>
 var b = a.myColor();</div>
<!--<p>The value of b is now:</p>
<div class="w3-code notranslate">
 green </div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_prototype_boolean" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The prototype constructor allows you to add new properties and methods to 
JavaScript booleans.</p>
<p>When constructing a property, ALL booleans will be given the property, and its value, as default.</p>
