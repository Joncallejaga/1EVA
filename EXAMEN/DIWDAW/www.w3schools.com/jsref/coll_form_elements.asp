...
<p><a href="dom_obj_form.asp" class="w3-btn w3-white w3-border" title="Form Object Reference">&#10094; Form Object</a></p>

<div class="w3-example">
<h3>Example</h3>
 <p>Find out how many elements there are in a specified &lt;form&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;).elements.length;</div>
 <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 3</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_elements_length">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> The elements collection returns all <strong>elements</strong> inside the &lt;form&gt; element, not all &lt;form&gt; elements in the document. To get all &lt;form&gt; elements in the document, use the <a href="coll_doc_forms.asp">document.forms</a> collection instead.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the element in &lt;form&gt; with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLFormsControlCollection Object, representing all elements in a &lt;form&gt; element. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
 <p>Get the value of the first element (index 0) in a form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;).elements[0].value;</div>
   <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Donald</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_elements_index">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
 <p>Get the value of the first element (index 0) in a form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;).elements.item(0).value;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Donald</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_elements_item">Try it Yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
 <p>Get the value of the element with name=&quot;fname&quot; in a form:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;).elements.namedItem(&quot;fname&quot;).value;</div>
  <p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Donald</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_elements_nameditem">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all elements in a form and output the value of each element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myForm&quot;);<br>var txt = &quot;&quot;;<br>
 var i;<br>for (i = 0; i &lt; x.length; i++)
 {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.elements[i].value + &quot;&lt;br&gt;&quot;;<br>
 }<br>
...
Duck<br>
Submit</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_form_elements">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="dom_obj_form.asp" class="w3-btn w3-white w3-border" title="Form Object Reference">&#10094; Form Object</a>
</div>
