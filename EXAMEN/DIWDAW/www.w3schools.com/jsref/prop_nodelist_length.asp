...
<h3>Example</h3>
 <p>Find out how many &lt;p&gt; elements there are in the document:</p>
<div class="w3-code notranslate jsHigh">
 var nodelist = document.getElementsByTagName(&quot;P&quot;).length;</div>
<!--<p>The result of <em>nodelist</em> will be:</p>
<div class="w3-code notranslate">
 4</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_nodelist_length_doc" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of nodes in a NodeList object.</p>
<p>A Node object's collection of child nodes is an example of a NodeList object.</p>
<p>The length property is useful when you want to loop through the nodes in a node list (See &quot;More Examples&quot; below).</p>
<p>This property is read-only.</p>
<p><strong>Tip:</strong> Use the <a href="met_nodelist_item.asp">item()</a> method to return a node at the specified index in a NodeList object.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the number of nodes in the nodelist</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Find out how many &lt;p&gt; elements there are inside a &lt;div&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Get the &lt;div&gt; element with id=&quot;myDIV&quot;<br>var nodelist = div.getElementsByTagName(&quot;P&quot;).length;&nbsp; // Get the number of &lt;p&gt; elements inside &lt;div&gt;</div>
<!--<p>The result of <em>nodelist</em> will be:</p>
<div class="w3-code notranslate">
 3</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_nodelist_length_p" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through all &lt;p&gt; elements inside a &lt;div&gt; element, and change the background color of each &lt;p&gt;:</p>
<div class="w3-code notranslate jsHigh">
 var div = document.getElementById(&quot;myDIV&quot;);<br>var nodelist = div.getElementsByTagName(&quot;P&quot;);<br><br>var i;<br>for (i = 0; i &lt; nodelist.length; i++) {<br>&nbsp;&nbsp;&nbsp; nodelist[i].style.backgroundColor = &quot;red&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_nodelist_length_p_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Return the number of child nodes of the &lt;body&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var nodelist = document.body.childNodes.length;</div>
<!--<p>The result of <em>nodelist</em> will be:</p>
<div class="w3-code notranslate">
 12</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_nodelist_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Loop through the child nodes of &lt;body&gt; and output the node name of each child node:</p>
<div class="w3-code notranslate jsHigh">
 var nodelist = document.body.childNodes;<br><br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; nodelist.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + nodelist[i].nodeName + &quot;&lt;br&gt;&quot;;<br>}</div>
<!--<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
 #comment<br>#text<br>P<br>#text<br>BUTTON<br>#text<br>P<br>#text<br>P<br>#text<br>
 SCRIPT<br>#text</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_nodelist_length_childloop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM Reference: <a href="met_nodelist_item.asp"><em>nodelist</em>.item() Method</a></p>
