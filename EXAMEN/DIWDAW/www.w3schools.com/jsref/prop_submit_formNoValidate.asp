...
<html lang="en-US">
<head>
<title>HTML DOM Input Submit formNoValidate Property</title>
 <meta charset="utf-8">
...
<h1>Input Submit <span class="color_h1">formNoValidate</span> Property</h1>
<p><a href="dom_obj_pushbutton.asp" class="w3-btn w3-white w3-border" title="Input Submit Object Reference">&#10094; Input Submit Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Find out if the form-data should be validated or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySubmit&quot;).formNoValidate;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">true // the form-data should not be validated when submitted</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_submit_formnovalidate">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The formNoValidate property sets or returns whether the form-data should be 
validated or not, when submitted.</p>
<p>This property reflects the formnovalidate attribute.</p>
<p>When set to true, this property adds the &quot;formnovalidate&quot; attribute to the 
submit button, and specifies that the form-data should not be 
validated when submitted. This overrides the form's novalidate attribute.</p>
<p><strong>Note:</strong> The formnovalidate attribute is new for the &lt;input&gt; 
...
<hr>
<h2>Syntax</h2>
<p>Return the formNoValidate property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formNoValidate</div></div>
<p>Set the formNoValidate property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>submitObject</em>.formNoValidate = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether the form-data should be validated or not (when  submitted)<ul>
      <li>true - The form-data should not be validated</li>
      <li>false - Default. The form-data should be validated</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the form-data should not be validated, otherwise it returns false</td>
  </tr>
</table>
...
<p>Set the formNoValidate property:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("mySubmit").formNoValidate = false;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_submit_formnovalidate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_formnovalidate.asp">HTML &lt;input&gt; formnovalidate attribute</a></p>
<hr>
