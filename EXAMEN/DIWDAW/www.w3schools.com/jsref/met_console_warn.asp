...
<h1>HTML DOM <span class="color_h1">console.warn()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Write a warning to the console:</p>
<div class="w3-code notranslate jsHigh">
console.warn("This is a warning!&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_warn" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.warn()</td>
    <td>Yes</td>
    <td>8.0</td>
    <td>4.0</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
  console.warn(<em>message</em>)</div>
</div>
...
<td>Required. The message or object to write as a waringr</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use an object as the warning message:</p>
<div class="w3-code notranslate jsHigh">
var myObj = { firstname : "John", lastname : "Doe" };<br>
console.warn(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_warn2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use an Array as the warning message:</p>
<div class="w3-code notranslate jsHigh">
var myArr = ["Orange", "Banana", "Mango", "Kiwi" ];<br>
console.warn(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_warn3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
