...
<a target="_blank" href="tryit.asp?filename=tryjsref_gettime" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getTime() method returns the number of milliseconds between midnight of January 1, 1970 and the specified date.</p>
<hr>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the number of milliseconds since midnight January 1, 1970</td>
</tr>
<tr>
...
-->
<a target="_blank" href="tryit.asp?filename=tryjsref_gettime_year" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
