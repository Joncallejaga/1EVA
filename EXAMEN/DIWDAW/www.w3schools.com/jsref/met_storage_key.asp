...
<html lang="en-US">
<head>
<title>Storage key() Method</title>
<meta charset="utf-8">
...
<h1>Storage <span class="color_h1">key()</span> Method</h1>
<p>
...
<h3>Example</h3>
<p>Get the name of the first local storage item:</p>
<div class="w3-code notranslate jsHigh">
  var x = localStorage.key(0);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_key" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The key() method returns name of the key with the specified index.</p>
<p>The key() method belongs to the Storage Object, which can be either a
...
<div class="w3-code w3-border notranslate">
  <div>
    localStorage.key(<em>index</em>)
  </div>
</div>
Or:
<div class="w3-code w3-border notranslate">
  <div>
    sessionStorage.key(<em>index</em>)
  </div>
</div>
...
<tr>
<td><em>index</em></td>
<td>Required. A Number representing the index of the key you want to get the 
name of<br></td>
</tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:18%;">Return Value:</th>
  <td>A String, representing the name of the specified key</td>
  </tr>
  </table>
...
<p>The same example, but using session storage instead of local storage.</p>
  <p>Get the name of the first storage item:</p>
<div class="w3-code notranslate jsHigh">
  var x = sessionStorage.key(0);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_key_session" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through each local storage item and display the names:</p>
<div class="w3-code notranslate jsHigh">
for (i = 0; i &lt; localStorage.length; i++) {<br>&nbsp; x = localStorage.key(i);<br>&nbsp; 
  document.getElementById(&quot;demo&quot;).innerHTML += x;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_storage_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>StorageEvent reference: <a href="event_storage_key.asp">The key Property</a></p>
<hr>
<p>
<a href="obj_storage.asp" class="w3-btn w3-white w3-border" title="Storage Object">&#10094; Storage Object</a>
</p>
