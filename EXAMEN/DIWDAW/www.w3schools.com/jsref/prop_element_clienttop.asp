...
<h1>HTML DOM <span class="color_h1">clientTop</span> Property</h1>
...
<p>The clientTop property returns the width of the top border of an element, in pixels.</p>
<p>This property does not include the element's top padding or top margin.</p>
<p><strong>Tip:</strong> You can also use the
<a href="prop_style_bordertopwidth.asp">style.borderTopWidth</a> property to 
return the width of an element's top border.</p>
<p><strong>Tip:</strong> To return the width of the left border of an element, 
use the <a href="prop_element_clientleft.asp">clientLeft</a> property.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.clientTop</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of an element's top border, in pixels</td>
  </tr>
</table>
