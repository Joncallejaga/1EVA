...
<a target="_blank" href="tryit.asp?filename=tryjsref_parse" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the number of milliseconds between the specified date-time and midnight January 1, 1970</td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_parse2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
