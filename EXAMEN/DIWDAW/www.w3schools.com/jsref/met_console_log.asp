...
<html lang="en-US">
<head>
<title>HTML DOM console.log() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.log()</span> Method</h1>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_console_log" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The console.log() method writes a message to the console.</p>
...
console.log(myObj);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_log2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
console.log(myArr);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_log3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
