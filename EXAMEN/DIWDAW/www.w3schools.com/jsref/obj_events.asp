...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Event Objects</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">Event</span> Objects</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dom_obj_event.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="obj_geolocation.asp">Next &#10095;</a>
</div>
<hr>

<h2>Event Objects</h2>
<p>When an event occur in HTML, the event belongs to a certain event object, 
like a mouse click event belongs to the MouseEvent object.</p>
<hr>
<h2>The Event Object</h2>
<p>All event objects are based on the Event Object, and inherits all of it's 
properties and methods</p>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:20%">Event Object</th>
    <th>Description</th>
  </tr>
  <tr>
...
<h2>Other Event Objects</h2>
<p>These are the most common event objects: </p>
