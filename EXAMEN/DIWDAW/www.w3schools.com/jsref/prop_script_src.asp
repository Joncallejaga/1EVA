...
<h3>Example</h3>
<p>Get the URL of an external script file:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myScript&quot;).src</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">https://www.w3schools.com/jsref/demo_script_src.js</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_src">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The src property sets or returns the value of the src attribute of a script.</p>
...
<p><strong>Note:</strong> The external script file cannot contain the &lt;script&gt; 
tag.</p>
<p><strong>Note:</strong> Point to the external script file exactly where you 
would have written the script.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.src
</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.src =<em> URL</em></div></div>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_script_src.asp">HTML &lt;script&gt; src attribute</a></p>
<hr>
