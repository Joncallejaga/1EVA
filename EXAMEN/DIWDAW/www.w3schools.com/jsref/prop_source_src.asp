...
<html lang="en-US">
<head>
<title>HTML DOM Source src Property</title>
 <meta charset="utf-8">
...
<h1>Source <span class="color_h1">src</span> Property</h1>
<p><a href="dom_obj_source.asp" class="w3-btn w3-white w3-border" title="Source Object Reference">&#10094; Source Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the URL of a media file:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("mySource").src;
</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 https://www.w3schools.com/jsref/horse.mp3</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_source_src" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute in 
a &lt;source&gt; element.</p>
<p>The src attribute specifies the URL of the media file to play.</p>
<p><strong>Note:</strong> The &lt;source&gt; element 
is new in HTML5.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier versions, only returns 
the file name(e.g. horse.mp3), instead of the URL (https://www.w3schools.com/jsref/horse.mp3).</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>sourceObject</em>.src
</div></div>
<p>Set the src property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>sourceObject</em>.src =<i> URL</i></div></div>
  ...
  <th style="width:20%">Value</th>
    ...
    <tr>
      ...
      <td>Specifies the URL of the media file.<p>Possible values:</p>
        <ul>
       <li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/horse.mp3&quot;)</li>
       <li>A relative URL - points to a file within a web site (like href=&quot;horse.mp3&quot;)</li>
        </ul>
   </td>
    </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the media file. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_source_src.asp">HTML &lt;source&gt; src attribute</a></p>
<hr>
