...
<html lang="en-US">
<head>
<title>FocusEvent relatedTarget Property</title>
<meta charset="utf-8">
...
<h1>FocusEvent <span class="color_h1">relatedTarget</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the related element of the element that triggered an onfocus event:</p>
<div class="w3-code notranslate jsHigh">
 function getRelatedElement(event) { <br>&nbsp;&nbsp;&nbsp; alert(event.relatedTarget.tagName);<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_focus_relatedtarget" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The relatedTarget property returns the element related to the element that  triggered the focus/blur event.</p>
<ul>
  <li>For <a href="event_onfocus.asp">onfocus</a> and <a href="event_onfocusin.asp">onfocusin</a> events, the related element is the element that LOST focus.</li>
  <li>For <a href="event_onblur.asp">onblur</a> and <a href="event_onfocusout.asp">onfocusout</a> events, the related element is the element that GOT focus.</li>
</ul>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.relatedTarget</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A reference to the related element, or <em>null</em> if there is no related element</td>
</tr>
  <tr>
