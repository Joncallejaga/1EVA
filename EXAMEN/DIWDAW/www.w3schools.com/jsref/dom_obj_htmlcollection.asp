...
<!DOCTYPE html>
<html lang="en-US">
<head><title>DOM HTMLCollection</title>
<meta charset="utf-8">
...
<h1>DOM <span class="color_h1">HTMLCollection</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="obj_history.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="obj_location.asp">Next &#10095;</a>
</div>
<hr>

<h2>The HTMLCollection Object</h2>
<p>An HTMLCollection object is an array-like list of HTML elements.</p>
<p>Methods like the getElementsByTagName() returns an HTMLCollection.</p>
<hr>

<h2>Properties and Methods</h2>
<p>The following properties and methods can be used on a HTMLCollection object:</p>
...
<tr>
  <td><a href="prop_htmlcollection_length.asp">length</a></td>
...
<h3>Example</h3>
 <p>Get an HTMLCollection:</p>
 <div class="w3-code notranslate jsHigh">
  var x = document.getElementsByTagName(&quot;P&quot;);<br>//returns a 
   collection of all the P elements in the document</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
 <p>Write the number of &lt;P&gt; elements in the document:</p>
 <div class="w3-code notranslate jsHigh">
  var x = document.getElementsByTagName(&quot;P&quot;);<br>document.write(x.length);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
 <p>Loop through every element in an HTMLCollection:</p>
 <div class="w3-code notranslate jsHigh">
   x = document.getElementsByTagName(&quot;*&quot;);<br>l = x.length;<br>for (i = 0; i &lt; 
   l; i++) {<br>&nbsp; document.write(x[i].tagName + &quot;&lt;br&gt;&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_htmlcollection_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
