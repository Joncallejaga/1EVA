...
<html lang="en-US">
<head>
<title>stopImmediatePropagation() Event Method</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">stopImmediatePropagation()</span> Event Method</h1>
<p>
...
<h3>Example</h3>
<p>When clicking on a button, execute the first event handler, and stop the rest 
of the event handlers from being executed:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;);<br>x.addEventListener(&quot;click&quot;, myFunction);<br>x.addEventListener(&quot;click&quot;, someOtherFunction);<br>
 <br>function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; alert (&quot;Hello World!&quot;);<br>&nbsp;&nbsp;&nbsp; event.stopImmediatePropagation();<br>} <br><br>// This function will not be executed<br>function someOtherFunction() {<br>&nbsp;&nbsp;&nbsp; alert (&quot;I will not get to say Hello World&quot;); <br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_stopimmediatepropagation" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The stopImmediatePropagation() method prevents other listeners of the same 
event from being called.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.stopImmediatePropagation()</div></div>
<h2>Parameters</h2>
