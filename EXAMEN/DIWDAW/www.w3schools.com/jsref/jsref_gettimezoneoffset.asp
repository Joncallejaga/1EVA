...
<a target="_blank" href="tryit.asp?filename=tryjsref_gettimezoneoffset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A Number, representing the time difference between UTC and Local Time, in minutes</td>
</tr>
<tr>
