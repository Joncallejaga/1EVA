...
<a class="w3-left w3-btn" href="jsref_repeat.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="jsref_obj_string.asp"><span class="w3-hide-small">JavaScript String </span>Reference</a>
<a class="w3-right w3-btn" href="jsref_search.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<!--<p><a href="jsref_obj_string.asp" class="w3-btn w3-white w3-border" title="JavaScript String Reference">&#10094; JavaScript String Reference</a></p>-->
...
<a target="_blank" href="tryit.asp?filename=tryjsref_replace" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> If you are replacing a value (and not a <em>regular 
expression</em>), only the first instance of the value will be replaced. To 
replace all occurrences of a specified value, use the global (g) modifier (see 
&quot;More Examples&quot; below).</p>
<p>Read more about regular expressions in our <a href="../js/js_regexp.asp">RegExp Tutorial</a> and our <a href="jsref_obj_regexp.asp">RegExp Object Reference</a>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Perform a <strong>global</strong> replacement:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjsref_replace2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Perform a global, <strong>case-</strong><em><strong>insensitive</strong></em> replacement:</p>
<div class="w3-code notranslate jsHigh">
var str = &quot;Mr Blue has a blue house and a blue car&quot;;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_replace3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using a <strong>function</strong> to return the replacement text:</p>
<div class="w3-code notranslate jsHigh">
var str = &quot;Mr Blue has a blue house and a blue car&quot;;<br>var res = str.replace(/blue|house|car/gi, function (x) {<br>&nbsp;&nbsp;&nbsp; return x.toUpperCase();<br>});</div>
<!--<p>The result of <em>res</em> will be:</p>
<div class="w3-code notranslate">
 Mr BLUE has a BLUE HOUSE and a BLUE CAR.</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_replace4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
