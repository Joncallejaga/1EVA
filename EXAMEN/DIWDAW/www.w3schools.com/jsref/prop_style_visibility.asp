...
document.getElementById(&quot;myP&quot;).style.visibility = &quot;hidden&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_visibility">Try it Yourself &raquo;</a>
</div>
<hr>
...
similar to the <a href="prop_style_display.asp">display</a> property. However, the difference is that if you set <code class="w3-codespan">display:none</code>, it hides 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>collapse</td>
    <td>When used on a table row or cell, the element is not visible (same as &quot;hidden&quot;)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<tr>
  <th>Return Value:</th>
  <td>A String, representing whether the content of an element is displayed or not</td>
</tr>
<tr>
  <th>CSS Version</th>
  <td>CSS2</td>
...
<div class="w3-code notranslate jsHigh">
 function myFunction() {<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById('myDIV');<br>&nbsp;&nbsp;&nbsp; if (x.style.visibility === 'hidden') {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.visibility = 'visible';<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.visibility = 'hidden';<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_visibility_toggle">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 ...
 <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_visibility2">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_visibility3">Try it Yourself &raquo;</a>
</div>
<hr>
