...
<h3>Example</h3>
<p>Find out how many &lt;iframe&gt; elements there are in the window:</p>
<div class="w3-code notranslate jsHigh">
 var x = window.length;</div>
<!--<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
 3</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_length">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of &lt;iframe&gt; elements in the current window.</p>
...
<tr>
 ...
 <td width="75%">A Number, representing the number of frames in the current window</td>
</tr>
</table>
