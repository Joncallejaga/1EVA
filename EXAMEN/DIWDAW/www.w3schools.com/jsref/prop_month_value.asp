...
<html lang="en-US">
<head>
<title>HTML DOM Input Month value Property</title>
 <meta charset="utf-8">
...
<h1>Input Month <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_month.asp" class="w3-btn w3-white w3-border" title="Input Month Object Reference">&#10094; Input Month Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the month and year for a month field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myMonth&quot;).value = &quot;2014-02&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_value">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The value property sets or returns the value of the value attribute of a month field.</p>
<p>The value attribute specifies a month and year for the month field.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>monthObject</em>.value</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>monthObject</em>.value = <i>YYYY
 -MM</i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>YYYY-MM</i></td>
    <td>
  Specifies the  month and year. Explanation of components:<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the month and year of the month field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the month and year of a month field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myMonth&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">1997-11</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_value2">Try it Yourself &raquo;</a>
</div>
<br>
