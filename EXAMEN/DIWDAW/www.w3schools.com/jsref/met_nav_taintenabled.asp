...
<a target="_blank" href="tryit.asp?filename=tryjsref_nav_taintenabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The taintEnabled() method was removed in JavaScript version 1.2, and should be avoided to 
prevent run-time errors in the future.</span></p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">taintEnabled()</td>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, indicating whether the browser has data tainting enabled.<br>
 <br>Returns true if data tainting is supported and enabled, otherwise it returns false</td>
</tr>
</table>
