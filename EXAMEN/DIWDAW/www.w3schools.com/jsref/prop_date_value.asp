...
<html lang="en-US">
<head>
<title>HTML DOM Input Date value Property</title>
 <meta charset="utf-8">
...
<h1>Input Date <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_date.asp" class="w3-btn w3-white w3-border" title="Input Date Object Reference">&#10094; Input Date Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set a date for a date field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDate&quot;).value = &quot;2014-02-09&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_value">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The value property sets or returns the value of the value attribute of a date field.</p>
<p>The value attribute specifies a date for the date field.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.value
</div></div>
<p>Set the value property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.value =<em> YYYY-MM-DD</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  Specifies a date for the date field.<br> <br>Explanation of components:<ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the date of the date field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the date of a date field:</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById(&quot;myDate&quot;).value;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2000-05-05</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_value2">Try it Yourself &raquo;</a>
</div>
<br>
