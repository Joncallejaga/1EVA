...
<p>The applets collection returns a collection of all &lt;applet&gt; elements in the document.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;applet&gt; element from the collection with the specified index (starts at 0).<br><br><strong>Note:</strong> Returns null if the index number is out of range</td>
    </tr>
  <tr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%;">Return Value:</th>
  <td>An HTMLCollection Object, representing all &lt;applet&gt; elements in the document. The elements in the collection are sorted as they appear in the source code</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_applet.asp">HTML &lt;applet&gt; tag</a></p>
