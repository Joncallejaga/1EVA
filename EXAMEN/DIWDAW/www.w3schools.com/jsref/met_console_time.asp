...
<html lang="en-US">
<head>
<title>HTML DOM console.time() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.time()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>How long does it take to perform a for-loop 100.000 times:</p>
<div class="w3-code notranslate jsHigh">
  console.time();<br>for (i = 0; i &lt; 100000; i++) {<br>&nbsp; // some code<br>}<br>
  console.timeEnd();</div>
  <a target="_blank" href="tryit.asp?filename=tryjsref_console_time" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.time() method starts a timer in the console view.</p>
<p>This method allows you to time certain operations in your code for testing 
purposes.</p>
<p>Use the <a href="met_console_timeend.asp">console.timeEnd()</a> method to end the timer and display the result in 
the console.view.</p>
<p>Use the <em>label</em> parameter to name the timer, then you are able to have 
many timers on the same page.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.time()</td>
    <td>Yes</td>
    <td>11</td>
    <td>10</td>
    <td>4</td>
...
<td><em>label</em></td>
<td>String</td>
<td>Optional. Use the label parameter to give the timer a name</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the <em>label</em> parameter:</p>
<div class="w3-code notranslate jsHigh">
  console.time(&quot;test1&quot;);<br>for (i = 0; i &lt; 100000; i++) {<br>&nbsp; // some code<br>}<br>
  console.timeEnd(&quot;test1&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_time2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Which is fastest, the for loop or the while loop?</p>
<div class="w3-code notranslate jsHigh">
  var i;<br>console.time(&quot;test for loop&quot;);<br>for (i = 0; i &lt; 100000; i++) {<br>&nbsp; 
  // some code<br>}<br>console.timeEnd(&quot;test for loop&quot;);<br><br>i = 0;<br>
  console.time(&quot;test while loop&quot;);<br>while (i &lt; 1000000) {<br>&nbsp; i++<br>}<br>
  console.timeEnd(&quot;test while loop&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_time3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
