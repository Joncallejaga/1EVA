...
<html lang="en-US">
<head>
<title>HTML DOM Input DatetimeLocal name Property</title>
 <meta charset="utf-8">
...
<h1>Input DatetimeLocal <span class="color_h1">name</span> Property</h1>
...
<h3>Example</h3>
<p>Get the name of a local datetime field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myLocalDate&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">bdaytime</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_name">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> Only form elements with a name attribute will have 
their values passed when submitting a form.</p>
<hr>
...
<p><strong>Note:</strong> The &lt;input type=&quot;datetime-local&quot;&gt; element is 
not supported in Internet Explorer or Firefox.</p>
<hr>

<h2>Syntax</h2>
<p>Return the name property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.name</div></div>
<p>Set the name property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>datetimelocalObject</em>.name = <em>name</em>
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>name</em></td>
    <td>
  Specifies the name of the local datetime field</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the local datetime field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the name of a local datetime field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myLocalDate&quot;).name = &quot;newDatetimeName&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_datetime-local_name2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_name.asp">HTML &lt;input&gt; name attribute</a></p>
<hr>
