...
<h3>Example</h3>
<p>Change the destination (URL) of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").href = &quot;http://www.cnn.com/&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_href2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the URL of the link. Returns the entire URL, including the protocol (like http://)</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the URL of a link:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myAnchor").href;
</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
https://www.w3schools.com/js/</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_href" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example of how to get the URL of a link (a relative URL):</p>
<div class="w3-code notranslate jsHigh">
 var x =
 document.getElementById("myAnchor").href;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_href3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
