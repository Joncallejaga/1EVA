...
<html lang="en-US">
<head>
<title>HTML DOM Video playbackRate Property</title>
 <meta charset="utf-8">
...
<h1>Video <span class="color_h1">playbackRate</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Set a video to play in slow motion:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).playbackRate = 0.5;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_playbackrate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The playbackRate property sets or returns the current playback speed of the video.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.playbackRate</div></div>
 <p>Set the playbackRate property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>videoObject</em>.playbackRate = <em>playbackspeed</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Indicates the current playback speed of the video.<br>Example values:<ul><li>1.0 is normal speed</li>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a video to play fast:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myVideo&quot;).playbackRate = 5;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_playbackrate2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
