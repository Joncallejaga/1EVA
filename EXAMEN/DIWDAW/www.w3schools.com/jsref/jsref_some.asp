...
<h1>JavaScript Array <span class="color_h1">some()</span> Method</h1>
...
<div class="w3-code notranslate jsHigh">
 var ages = [3, 10, 18, 20];<br><br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= 18;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.some(checkAdult);<br>}</div>
<!--<p>The result will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_some">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The some() method checks if any of the elements in an array pass a 
test (provided as a function).</p>
<p>The some() method executes the function once for each element present in the 
array:</p>
<ul>
  <li>If it finds an array element where the function returns a <em>true</em> value, some() returns true (and does not check the remaining values)</li>
  <li>Otherwise it returns false</li>
</ul>
<p><strong>Note:</strong> some() does not execute the function for array 
elements without values.</p>
<p><strong>Note:</strong> some() does not change the original array.</p>
<hr>
...
<i>array</i>.some(<em>function(currentValue, index, arr), thisValue</em>)</div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Check if any of the values in the <em>ages</em> array are a specific number or over:</p>
<div class="w3-code notranslate htmlHigh">
 ...
 <br>function checkAdult(age) {<br>&nbsp;&nbsp;&nbsp; return age &gt;= document.getElementById(&quot;ageToCheck&quot;).value;<br>}<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = ages.some(checkAdult);<br>}<br>
 &lt;/script&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_some2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
