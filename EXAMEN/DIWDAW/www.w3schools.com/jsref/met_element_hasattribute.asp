...
<h3>Example</h3>
 <p>Find out if a &lt;button&gt; element has an onclick attribute:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myBtn&quot;).hasAttribute(&quot;onclick&quot;);</div>
 <!--<p>The result of <em>x </em>will be:</p>
<div class="w3-code notranslate">
true
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_hasattribute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The hasAttribute() method returns true if the specified attribute exists, otherwise it returns false.</p>
<p><strong>Tip:</strong> Use <a href="met_element_setattribute.asp">
setAttribute()</a> to add a new attribute or change the value of an existing 
attribute on an element.</p>
<hr>
...
<tr>
 <th style="width:20%;">Return Value:</th>
  <td>A Boolean, returns true if the element has attributes, otherwise false</td>
</tr>
<tr>
