...
<html lang="en-US">
<head>
<title>HTML DOM clientLeft Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">clientLeft</span> Property</h1>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the width of a &lt;div&gt; element's top and left border:</p>
<div class="w3-code notranslate jsHigh">
 var elmnt = document.getElementById(&quot;myDIV&quot;);<br>var txt = &quot;Border top width: &quot; + elmnt.clientTop + &quot;px&lt;br&gt;&quot;;<br>txt += &quot;Border left width: &quot; + elmnt.clientLeft + &quot;px&quot;;</div>
<!--<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
 Border top width: 15px<br>Border left width: 10px</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_clientleft_clienttop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The clientLeft property returns the width of the left border of an element, in pixels.</p>
<p>This property does not include the element's left padding or the left margin.</p>
<p><strong>Tip:</strong> You can also use the
<a href="prop_style_borderleftwidth.asp">style.borderLeftWidth</a> property to return the width of an element's left border.</p>
<p><strong>Note:</strong> For Chrome, Firefox and Opera on Windows, if the element has a 
<strong>scrollbar</strong> (set by the CSS 
<a href="../cssref/pr_pos_overflow.asp">overflow</a> property), and if the text direction of that element is right-to-left 
(set by the CSS <a href="../cssref/pr_text_direction.asp">direction</a> property), this property includes the width of the 
...
the left border width.</p>
<p><strong>Tip:</strong> To return the width of the top border of an element, 
use the <a href="prop_element_clienttop.asp">clientTop</a> property.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.clientLeft</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the width of an element's left border, in pixels</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>In this example, the text direction of &lt;div&gt; is right-to-left, and it has a 
scrollbar:</p>
<div class="w3-code notranslate jsHigh">
 var left = document.getElementById(&quot;myDIV&quot;).clientLeft;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_clientleft_scrollbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<p><a href="dom_obj_all.asp" class="w3-btn w3-white w3-border" title="HTMLElement Object Reference">&#10094; Element Object</a></p>
</div>
