...
{<br>
&nbsp;&nbsp;&nbsp;
myWindow = window.open('', '', 'width=200, height=100');&nbsp;&nbsp;&nbsp; // Opens a new window<br>
&nbsp;&nbsp;&nbsp;
...
{<br>
&nbsp;&nbsp;&nbsp;
myWindow.moveBy(250, 250);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Moves the new window <br>
&nbsp;&nbsp;&nbsp;
myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Sets focus to the new window<br>
}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_moveby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<ul>
  ...
  <li><a href="met_win_resizeby.asp">resizeBy()</a> - Resizes the window by the specified pixels</li>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Number</td>
    <td>Required. A positive or negative number that specifies the amount of pixels to move the window horizontally</td>
  </tr>
   <tr>
    <td><em>y</em></td>
    <td>Number</td>
    <td>Required. A positive or negative number that specifies the amount of pixels to move the window vertically</td>
  </tr>
</table>
<hr>
...
<div class="w3-code notranslate jsHigh">
 function moveWinTo() {<br>&nbsp;&nbsp;&nbsp; myWindow.moveTo(150, 150);<br>&nbsp;&nbsp;&nbsp; myWindow.focus();<br>
 }<br><br>function moveWinBy() {<br>&nbsp;&nbsp;&nbsp; myWindow.moveBy(75, 50);<br>
 &nbsp;&nbsp;&nbsp;
 myWindow.focus();<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_moveby_moveto" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
