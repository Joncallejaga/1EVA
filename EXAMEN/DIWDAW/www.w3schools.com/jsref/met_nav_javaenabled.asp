...
<h3>Example</h3>
<p>Find out if your browser has Java enabled:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_javaenabled">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, indicating whether the browser has Java enabled.<br><br>Returns true if enabled, false if not.</td>
</tr>
</table>
