...
<div class="w3-code notranslate jsHigh">
 ...
 <br>// Create an empty &lt;thead&gt; element and add it to the table:<br>var header = table.createTHead();<br><br>// Create an empty &lt;tr&gt; element and add it to the first position of &lt;thead&gt;:<br>var row = header.insertRow(0);&nbsp;&nbsp;&nbsp;&nbsp; <br><br>// Insert a new cell (&lt;td&gt;) at the first position of the &quot;new&quot; &lt;tr&gt; element:<br>var cell = row.insertCell(0);<br>
 <br>// Add some bold text in the new cell:<br>cell.innerHTML = &quot;&lt;b&gt;This is a table header&lt;/b&gt;&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_table_createthead" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">createTHead()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code notranslate jsHigh">
 function myCreateFunction() {<br>&nbsp;&nbsp;&nbsp; var table = document.getElementById(&quot;myTable&quot;);<br>&nbsp;&nbsp;&nbsp; var header = table.createTHead();<br>&nbsp;&nbsp;&nbsp; var row = header.insertRow(0);<br>&nbsp;&nbsp;&nbsp; var cell = row.insertCell(0);<br>&nbsp;&nbsp;&nbsp; cell.innerHTML = &quot;&lt;b&gt;This is a table header&lt;/b&gt;&quot;;<br>}<br><br>function myDeleteFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myTable&quot;).deleteTHead();<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_table_create_deletethead">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_thead.asp">HTML &lt;thead&gt; tag</a></p>
<hr>
