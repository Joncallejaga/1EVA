...
<a class="w3-left w3-btn" href="jsref_touppercase.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="jsref_obj_string.asp"><span class="w3-hide-small">JavaScript String </span>Reference</a>
<a class="w3-right w3-btn" href="jsref_valueof_string.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<div class="w3-code notranslate">
 Hello World!</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_trim" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the string with removed whitespace from both ends</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>For browsers that do not support the trim() method, you can remove whitespaces from 
both sides of a string with a regular expression:</p>
<div class="w3-code notranslate jsHigh">
 function myTrim(x) {<br>&nbsp;&nbsp;&nbsp; return x.replace(/^\s+|\s+$/gm,'');<br>}<br><br>
 function myFunction() {<br>&nbsp;&nbsp;&nbsp; var str = myTrim(&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hello World!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;);<br>&nbsp;&nbsp;&nbsp; alert(str);<br>
 }<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_trim2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
