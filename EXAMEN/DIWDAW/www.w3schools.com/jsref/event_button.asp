...
<html lang="en-US">
<head>
<title>MouseEvent button Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">button</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out which mouse button that was pressed when a mouse event was triggered:</p>
<div class="w3-code notranslate jsHigh">
 alert("You pressed button: " + event.button)<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_mouse_button" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The button property returns a number that indicates which mouse button was pressed when a mouse event 
was triggered.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.button</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Number, representing which mouse button that was pressed when the mouse event occured.<br><br>Possible values:
 <ul>
    <li>0 : Left mouse button</li>
    <li>1 : Wheel button or middle button (if present)</li>
    <li>2 : Right mouse button</li>
 </ul>
 <p><strong>Note:</strong> Internet Explorer 8 and earlier has different return values:</p>
 <ul>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_buttons.asp">MouseEvent buttons Property</a></p>
