...
<html lang="en-US">
<head>
<title>KeyboardEvent keyCode Property</title>
<meta charset="utf-8">
...
<h1>KeyboardEvent <span class="color_h1">keyCode</span> Property</h1>
<p>
...
<div class="w3-code notranslate jsHigh">
 var x = event.keyCode;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_keycode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The keyCode property returns the Unicode character code of the key that 
...
<p><strong>Note:</strong> In Firefox, the keyCode property does not work on the 
onkeypress event (will only return 0). For a cross-browser solution, use the
<a href="event_key_which.asp">which</a> property together with keyCode, e.g:</p>
...
<p><strong>Note:</strong> Both the keyCode 
...
<a href="event_key_keycode.asp">key</a> property instead (if available).</p>
...
<div class="w3-code notranslate jsHigh">
 ...
 <br><br>function uniCharCode(event) {<br>&nbsp;&nbsp;&nbsp; var char = event.which || event.keyCode;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Unicode CHARACTER code: &quot; + char;<br>}<br><br>function uniKeyCode(event) {<br>&nbsp;&nbsp;&nbsp; var key = event.keyCode;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo2&quot;).innerHTML = &quot;Unicode KEY code: &quot; + key;<br>
 }<br></div>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_keycode2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 &lt;input type=&quot;text&quot; onkeydown=&quot;myFunction(event)&quot;&gt; <br><br>function myFunction(event) {<br>&nbsp;&nbsp;&nbsp; var x = event.keyCode;<br>&nbsp;&nbsp;&nbsp; if (x == 27) {&nbsp; // 27 is the ESC key<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert (&quot;You pressed the Escape key!&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_keycode3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 var x = event.keyCode;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Get the Unicode value<br>
 var y = String.fromCharCode(x);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Convert the value into a character<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_key_keycode4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
...
<p>HTML DOM reference: <a href="event_key_which.asp">KeyboardEvent which Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_keyboardevent.asp" class="w3-btn w3-white w3-border" title="KeyboardEvent">&#10094; KeyboardEvent</a>
