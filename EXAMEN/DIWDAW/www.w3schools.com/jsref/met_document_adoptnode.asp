...
<div class="w3-code notranslate jsHigh">
 var frame = document.getElementsByTagName(&quot;IFRAME&quot;)[0]<br>var h = frame.contentWindow.document.getElementsByTagName(&quot;H1&quot;)[0];<br>var x = document.adoptNode(h);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_document_adoptnode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> Use the <a href="met_node_clonenode.asp"><em>element</em>.cloneNode()</a> method to copy a node, without removing it, from the current document.</p>
<hr>
