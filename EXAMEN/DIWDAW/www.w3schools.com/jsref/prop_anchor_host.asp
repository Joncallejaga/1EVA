...
<div class="w3-code notranslate">
 www.example.com:4097</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_host" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The host property sets or returns the hostname and port part of the href attribute value.</p>
<p><strong>Note:</strong> If the port number is not specified in the URL (or if it is the scheme's default port - like 80, or 443), some browsers will not display 
the port number.</p>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the hostname and port number of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").host = &quot;www.somenewexamplepage.com:344&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_host2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example of how to change the hostname and port number of a link:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myAnchor").host = &quot;www.w3schools.com:80&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_anchor_host3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
