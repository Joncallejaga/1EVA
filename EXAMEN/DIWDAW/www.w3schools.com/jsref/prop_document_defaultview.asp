...
<html lang="en-US">
<head>
<title>HTML DOM defaultView Property</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">defaultView</span> Property</h1>
<p><a href="dom_obj_document.asp" class="w3-btn w3-white w3-border" title="Document Object Reference">&#10094; Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the document's window object:</p>
<div class="w3-code notranslate jsHigh">
  var x =
 document.defaultView;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_defaultview">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">defaultView</code> property returns the document's 
<a href="obj_window.asp">Window</a> Object.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">defaultView</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<div class="w3-code w3-border notranslate"><div>
 document.defaultView</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>The document's <a href="obj_window.asp">Window</a> Object</td>
  </tr>
  <tr>
  <th>DOM Version</th>
...
<div class="w3-code notranslate jsHigh">
 var x =
 document.defaultView;<br>var w = x.innerWidth;<br>var h = x.innerHeight;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_doc_defaultview2">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM <a href="obj_window.asp">Window Object</a></p>
<hr>
