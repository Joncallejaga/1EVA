...
<a target="_blank" href="tryit.asp?filename=tryjsref_win_statusbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> Opera 12 and earlier supports this property. However, support was removed in version 15.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the text displayed in the status bar</td>
</tr>
</table>
