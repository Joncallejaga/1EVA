...
<html lang="en-US">
<head>
<title>WheelEvent deltaZ Property</title>
<meta charset="utf-8">
...
<h1>WheelEvent <span class="color_h1">deltaZ</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Return whether the user scrolls in or out (along the z-axis):</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(event) {<br>&nbsp; var z = event.deltaZ;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_wheel_deltaz" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">deltaZ</code> property returns a positive value 
when scrolling in, and a negative value when scrolling out, 
otherwise 0.</p>
<p><strong>Note:</strong> Most mouse devices do not have the ability to scroll 
along the z-axis, and will always return 0.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">deltaZ</td>
    <td>31</td>
    <td>yes</td>
    <td>17</td>
