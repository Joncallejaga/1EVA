...
<a target="_blank" href="tryit.asp?filename=tryjsref_toisostring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">toISOString()</td>
    <td>Yes</td>
    <td>9</td>
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
 <th style="width:23%">Return Value:</th>
  <td>A String, representing the date and time using the ISO standard format</td>
</tr>
<tr>
