...
<html lang="en-US">
<head>
<title>MouseEvent relatedTarget Property</title>
<meta charset="utf-8">
...
<h1>MouseEvent <span class="color_h1">relatedTarget</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Get the element the cursor just exited:</p>
<div class="w3-code notranslate jsHigh">
 &lt;p onmouseover=&quot;getRelatedElement(event)&quot;&gt;Mouse over this paragraph.&lt;/p&gt;<br>
 <br>&lt;script&gt;<br>function getRelatedElement(event) { <br>&nbsp;&nbsp;&nbsp; alert(&quot;The cursor just exited the &quot; + event.relatedTarget.tagName + &quot; element.&quot;);<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=try_dom_event_relatedtarget" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The relatedTarget property returns the element related to the element that  triggered the mouse event.</p>
<p>The relatedTargert property can be used with the mouseover event to indicate the element the 
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A reference to the related element</td>
</tr>
  <tr>
