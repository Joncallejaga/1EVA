...
<h1>Output <span class="color_h1">form</span> Property</h1>
<p><a href="dom_obj_output.asp" class="w3-btn w3-white w3-border" title="Output Object Reference">&#10094; Output Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the id of the form containing the &lt;output&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myOutput&quot;).form.id;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">myForm</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_output_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form containing the &lt;output&gt; element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>outputObject</em>.form</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A reference to the &lt;form&gt; element containing the &lt;output&gt; element. If the &lt;output&gt; element is not in a form, null is returned</td>
  </tr>
</table>
