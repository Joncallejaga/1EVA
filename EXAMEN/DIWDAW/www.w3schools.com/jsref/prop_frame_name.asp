...
<h3>Example</h3>
<p>Get the name of an iframe:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFrame&quot;).name;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 iframe_a</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_iframe_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property sets or returns the value of the name attribute in an iframe element.</p>
<p>The name attribute specifies the name of an iframe, and can be used to 
reference the element in a JavaScript, or as the value of the target attribute 
of an &lt;a&gt; or &lt;form&gt; element, or the formtarget attribute of an &lt;input&gt; or 
&lt;button&gt; element.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>iframeObject</em>.name = <em>name</em>
 </div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the iframe</td>
  </tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_iframe_name2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_iframe_name.asp">HTML &lt;iframe&gt; name attribute</a></p>
<hr>
