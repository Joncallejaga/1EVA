...
<html lang="en-US">
<head>
<title>HTML DOM Meter low Property</title>
 <meta charset="utf-8">
...
<h1>Meter <span class="color_h1">low</span> Property</h1>
<p><a href="dom_obj_meter.asp" class="w3-btn w3-white w3-border" title="Meter Object Reference">&#10094; Meter Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the low attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myMeter&quot;).low = &quot;60&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_low2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The low property sets or returns the value of the low attribute in a gauge.</p>
<p>The low attribute specifies the range where the gauge's value is considered 
to be a low value. This value must be greater than the min attribute value, and 
less than the high and max attribute values.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the low property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.low</div></div>
<p>Set the low property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>meterObject</em>.low = <em>number</em>
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>
 Specifies a floating point number that is considered to be a low value</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing a floating point number that is considered to be a low value</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the low attribute in a gauge:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myMeter&quot;).low;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 40</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_meter_low" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_meter_low.asp">HTML &lt;meter&gt; low attribute</a></p>
<hr>
