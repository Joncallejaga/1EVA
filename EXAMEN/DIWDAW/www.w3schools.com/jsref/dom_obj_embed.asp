...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Embed Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_em.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_fieldset.asp">Next &#10095;</a>
</div>
<hr>

<h2>Embed Object <img src="https://www.w3schools.com/images/html5_badge20.png" alt="HTML5"></h2>
<p>The Embed Object is new in HTML5.</p>
...
var x = document.getElementById("myEmbed");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_embed_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var x = document.createElement("EMBED");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_embed_create" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_object.asp">HTML Plug-ins</a></p>
<p>HTML reference: <a href="../tags/tag_embed.asp">HTML &lt;embed&gt; tag</a></p>
