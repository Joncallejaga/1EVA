...
<h3>Example</h3>
 <p>Get the HTML content of the last child node of an &lt;ul&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myList&quot;).lastChild.innerHTML;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Tea</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_lastchild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a href="prop_element_lastelementchild.asp">lastElementChild</a>, is that lastChild returns 
...
child node as an element node (ignores text and comment nodes).</p>
...
property to return any child node of a specified node.</p>
<p><strong>Tip:</strong> To return the first child node of a specified node, use 
the <a href="prop_node_firstchild.asp">firstChild</a> property.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A Node object, representing the last child of a node, or <em>null </em>if there are no child nodes</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>In this example, we demonstrate how whitespace may interfare with this property.</p>
 <p>Get the node name of the last child node of a &lt;div&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;!-- <br>Whitespace inside elements is considered as text, and text is considered as nodes<br>In this example, there is whitespace before &lt;p&gt;, before &lt;span&gt; and after &lt;span&gt;<br>Therefore, the last child node of &lt;div&gt; is a #text node, and not the &lt;span&gt; element you expected <br>--&gt;<br><br>&lt;div id=&quot;myDIV&quot;&gt;<br>&nbsp; &lt;p&gt;Looks like first child&lt;/p&gt;<br>&nbsp; &lt;span&gt;Looks like last Child&lt;/span&gt;<br>&lt;/div&gt;<br><br>
 &lt;script&gt;<br>var x = document.getElementById(&quot;myDIV&quot;).lastChild.nodeName;<br>document.getElementById(&quot;demo&quot;).innerHTML = x;<br>&lt;/script&gt;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 #text</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_lastchild2">Try it Yourself &raquo;</a>
</div>
<br>
...
nodes in &lt;div&gt;, which will make the &lt;span&gt; element the last child node:</p>
<div class="w3-code notranslate htmlHigh">
...
<div class="w3-code notranslate">
 SPAN</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_node_lastchild3">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
 <p>Get the text of the last child node of a &lt;select&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;mySelect&quot;).lastChild.text;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 Volvo</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_node_lastchild4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="prop_node_firstchild.asp"><em>node.</em>firstChild Property</a></p>
