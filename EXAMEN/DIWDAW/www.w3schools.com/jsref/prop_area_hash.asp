...
<h3>Example</h3>
<p>Return the anchor part of the URL for a specific area in an 
image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;venus&quot;).hash;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 #description</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_area_hash" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the anchor part of a specific area in an image-map:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("venus").hash = &quot;newhashvalue&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_area_hash2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
