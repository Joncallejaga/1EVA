...
<html lang="en-US">
<head>
<title>HTML DOM Track srclang Property</title>
 <meta charset="utf-8">
...
<p>The srclang property sets or returns the value of the srclang attribute of the 
track.</p>
...
<h2>Syntax</h2>
<p>Return the srclang property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.srclang</div></div>
<p>Set the srclang property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>trackObject</em>.srclang = <em>language_code</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies a two-letter language code that specifies the language of  the track text data</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the language code of the text track data</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the language code of the track text data:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById("myTrack").srclang = &quot;no&quot;;</div>
<br></div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_track_srclang.asp">HTML &lt;track&gt; srclang attribute</a></p>
<hr>
