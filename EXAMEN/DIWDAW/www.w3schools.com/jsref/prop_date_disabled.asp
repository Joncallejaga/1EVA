...
<html lang="en-US">
<head>
<title>HTML DOM Input Date disabled Property</title>
 <meta charset="utf-8">
...
<h1>Input Date <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_date.asp" class="w3-btn w3-white w3-border" title="Input Date Object Reference">&#10094; Input Date Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Disable a date field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myDate&quot;).disabled = true;</div>
<!--<p>The result could be:</p>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
 <input type="date" value="2014-02-09" disabled>
</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_disabled">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a date field should be 
disabled, or not.</p>
<p>A disabled element is unusable and un-clickable. Disabled elements are 
usually rendered in gray by default in browsers. </p>
<p>This property reflects the HTML disabled attribute.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>inputdateObject</em>.disabled = true|false</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a date field should be disabled, or not
  <ul>
      <li>true - The date field is disabled</li>
      <li>false - Default. The date field is not disabled</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the date field is disabled, otherwise it returns false</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out if a date field is disabled or not:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myDate&quot;).disabled;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_disabled2">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-example">
<h3>Example</h3>
<p>Disable and undisable a date field:</p>
<div class="w3-code notranslate jsHigh">
 function disableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDate&quot;).disabled = true;<br>
 }<br><br>function undisableBtn() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myDate&quot;).disabled = false;<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_input_date_disabled3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_input_disabled.asp">HTML &lt;input&gt; disabled attribute</a></p>
<hr>
