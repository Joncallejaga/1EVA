...
<h1>Video <span class="color_h1">autoplay</span> Property</h1>
<p><a href="dom_obj_video.asp" class="w3-btn w3-white w3-border" title="Video Object Reference">&#10094; Video Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if the video started to play as soon as it was ready:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;).autoplay;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_video_autoplay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The autoplay property sets or returns whether a video should start playing as 
soon as it is loaded.</p>
<p>This property reflects the &lt;video&gt; autoplay attribute.</p>
<p>When present, it specifies that the video should automatically start playing 
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>videoObject</em>.autoplay</div></div>
<p>Set the autoplay property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>videoObject</em>.autoplay = true|false
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether a video should automatically start playing as soon as it is loaded<ul>
  <li>true - Indicates that the video should start playing as soon as it is loaded loaded</li>
  <li>false - Default. Indicates that the video should NOT start playing as soon as it is loaded</li>
</ul>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the video automatically starts playing, otherwise it returns false</td>
  </tr>
  <tr>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myVideo&quot;);<br>x.autoplay = true;<br>
 x.load();</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_autoplay3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
...
property:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.createElement(&quot;VIDEO&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_video_autoplay2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_video_autoplay.asp">HTML &lt;video&gt; autoplay attribute</a></p>
<hr>
