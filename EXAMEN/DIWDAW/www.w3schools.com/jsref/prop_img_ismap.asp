...
<html lang="en-US">
<head>
<title>HTML DOM Image isMap Property</title>
 <meta charset="utf-8">
...
<h1>Image <span class="color_h1">isMap</span> Property</h1>
<p><a href="dom_obj_image.asp" class="w3-btn w3-white w3-border" title="Image Object Reference">&#10094; Image Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if an image is part of a server-side image-map:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myImg&quot;).isMap;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 true</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_img_ismap" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isMap property sets or returns whether an image should be part of a server-side image-map (an image-map is an image with clickable areas), or not.</p>
<p>When clicking on a server-side image-map, the click coordinates are sent to the server as a URL query string.</p>
<p>This property reflects the HTML ismap attribute.</p>
<p><strong>Note:</strong> The ismap attribute is only allowed if the &lt;img&gt; element is a descendant of an &lt;a&gt; element with a valid href attribute.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the isMap property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>imageObject</em>.isMap</div></div>
<p>Set the isMap property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>imageObject</em>.isMap = true|false
 </div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td>true|false</td>
    <td>Specifies whether the image should be part of a server-side image-map, or not   <ul>
      <li>true - The image will be part of a server-side image-map</li>
      <li>false -The image will NOT be part of a server-side image-map</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the image is part of a server-side image-map, otherwise it returns false</td>
  </tr>
</table>
...
<p>Set the isMap property:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myImg&quot;).isMap = true;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_img_ismap2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_img_ismap.asp">HTML &lt;img&gt; ismap attribute</a></p>
<hr>
<a href="dom_obj_image.asp" class="w3-btn w3-white w3-border" title="Image Object Reference">&#10094; Image Object</a>
</div>
