...
<html lang="en-US">
<head>
<title>HTML DOM Input Email defaultValue Property</title>
 <meta charset="utf-8">
...
<h1>Input Email <span class="color_h1">defaultValue</span> Property</h1>
<p><a href="dom_obj_email.asp" class="w3-btn w3-white w3-border" title="Input Email Object Reference">&#10094; Input Email Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the default value of an email field:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myEmail&quot;).defaultValue = &quot;steve@w3schools.com&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_defaultvalue">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The defaultValue property sets or returns the default value of an email field.</p>
<p><b>Note:</b> The default value is the value specified in the HTML
<a href="prop_email_value.asp">value</a> attribute.</p>
<p>The difference between the defaultValue and <a href="prop_email_value.asp">value</a> 
...
email field have been changed.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.defaultValue
</div></div>
<p>Set the defaultValue property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>emailObject</em>.defaultValue = <i>value
 </i></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>value</em></td>
    <td>
  Specifies the default value of the email field</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the default value of the email field</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the default value of an email field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;).defaultValue;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">johndoe@example.com</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_defaultvalue2">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myEmail&quot;);<br>var defaultVal = x.defaultValue;<br>var currentVal = x.value;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_email_defaultvalue3">Try it Yourself &raquo;</a>
</div>
<hr>
