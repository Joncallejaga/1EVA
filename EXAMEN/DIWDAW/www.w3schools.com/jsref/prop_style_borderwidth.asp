...
document.getElementById(&quot;myDiv&quot;).style.borderWidth = &quot;thick&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderwidth">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  <li>One value, like: p {border-width: thick} - all four borders will be thick</li>
  <li>Two values, like: p {border-width: thick thin} - the top and bottom border will be thick, left and right border will be thin</li>
  <li>Three values, like: p {border-width: thick thin medium}- the top border will be thick, left and right border will be thin, bottom border will be medium</li>
  <li>Four values, like: p {border-width: thick thin medium 10px} - the top border will be thick, right border will be thin, bottom border will be medium, left border will be 10px</li>
</ul>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderwidth2">Try it Yourself &raquo;</a>
</div>
<br>
...
value:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;myDiv&quot;).style.borderWidth = &quot;1px 5px 10px 20px&quot;;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderwidth3">Try it Yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_style_borderwidth4">Try it Yourself &raquo;</a>
</div>
<hr>
