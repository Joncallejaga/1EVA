...
<h3>Example</h3>
<p>Get the name of your browser:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_appname">Try it Yourself &raquo;</a>
</div>
...
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>navigator.appName</div></div>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the name of the browser. <br><br>The returned value varies from different browsers:
<ul>
  <li>IE11, Firefox, Chrome and Safari returns &quot;Netscape&quot;</li>
  <li>IE 10 and earlier versions return &quot;Microsoft Internet Explorer&quot;</li>
