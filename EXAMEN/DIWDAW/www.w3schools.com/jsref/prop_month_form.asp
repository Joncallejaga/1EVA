...
<html lang="en-US">
<head>
<title>HTML DOM Input Month form Property</title>
 <meta charset="utf-8">
...
<h1>Input Month <span class="color_h1">form</span> Property</h1>
<p><a href="dom_obj_month.asp" class="w3-btn w3-white w3-border" title="Input Month Object Reference">&#10094; Input Month Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the id of the form containing the &lt;input type=&quot;month&quot;&gt; element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myMonth&quot;).form.id;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">myForm</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_month_form">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form containing the month field.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>monthObject</em>.form</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A reference to the form element containing the month field. If the month field is not in a form, null is returned</td>
  </tr>
</table>
