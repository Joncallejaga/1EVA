...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myAnchor1&quot;).tabIndex = &quot;3&quot;;<br>
 document.getElementById(&quot;myAnchor2&quot;).tabIndex = &quot;2&quot;;<br>
 document.getElementById(&quot;myAnchor3&quot;).tabIndex = &quot;1&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_html_tabindex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The tabIndex property sets or returns the value of the tabindex attribute of an element.</p>
<p>The tabindex attribute specifies the tab order of an element (when the &quot;tab&quot; 
button is used for navigating).</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the tabIndex property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.tabIndex</div></div>
<p>Set the tabIndex property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>HTMLElementObject</em>.tabIndex =<em> number</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Specifies the tabbing order of the element (1 is first). <br><br>
  <strong>Note:</strong> If the number is negative, the element will be  removed from the tab order</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Number, representing the tab order of the element</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the tab order of the first &lt;a&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementsByTagName(&quot;A&quot;)[0].tabIndex;<br>
 document.getElementById(&quot;demo&quot;).innerHTML = x;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 2</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_html_tabindex2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_global_tabindex.asp">HTML tabindex Attribute</a></p>
<hr>
