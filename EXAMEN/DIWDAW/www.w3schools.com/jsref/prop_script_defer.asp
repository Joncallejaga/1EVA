...
<html lang="en-US">
<head>
<title>HTML DOM Script defer Property</title>
 <meta charset="utf-8">
...
<h1>Script <span class="color_h1">defer</span> Property</h1>
<p><a href="dom_obj_script.asp" class="w3-btn w3-white w3-border" title="Script Object Reference">&#10094; Script Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out if a script was executed when a page was finished parsing:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myScript&quot;).defer</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">true</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_script_defer">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The defer property sets or returns whether a script should be executed when a 
page has finished parsing, or not.</p>
<p>This property reflects the defer attribute of the &lt;script&gt; tag.</p>
<p><strong>Note:</strong> The defer attribute is only for external scripts (and 
...
<hr>
<h2>Syntax</h2>
<p>Return the defer property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.defer
</div></div>
<p>Set the defer property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>scriptObject</em>.defer = true|false
 </div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>true|false</td>
    <td>
  Specifies whether a script should be executed when the page has finished  parsing, or not<ul>
      <li>true - The script is executed when the page has finished parsing</li>
      <li>false - The script will not be executed when the page has   finished parsing</li>
  </ul>
    </td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A Boolean, returns true if the script is executed when the page has finished parsing, otherwise it returns false</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_script_defer.asp">HTML &lt;script&gt; defer attribute</a></p>
<hr>
