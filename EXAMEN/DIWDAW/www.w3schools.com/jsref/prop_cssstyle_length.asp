...
<html lang="en-US">
<head>
<title>CSSStyleDeclaration length Property</title>
 <meta charset="utf-8">
...
<h1>CSSStyleDeclaration length<span class="color_h1"> </span> Property</h1>
...
<h3>Example</h3>
<p>Return the number of styles set on the H1 element:</p>
<div class="w3-code notranslate jsHigh">
var elmnt = document.getElementsByTagName(&quot;h1&quot;)[0];<br>var x = style.length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_cssstyle_length">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The length property returns the number of style declarations set for the 
specified element.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the length property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>element</em>.style.length</div></div>
<hr>
...
<table class="w3-table-all">
 ...
 <th style="width:25%;">DOM Version:</th>
  ...
  <tr>
 <th>Return Value:</th>
  <td>A Integer, representing the number of style declaration set for the element</td>
  </tr>
  </table>
<hr>
<h2>More Examples</h2>
