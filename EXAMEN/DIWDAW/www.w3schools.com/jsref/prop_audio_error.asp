...
<html lang="en-US">
<head>
<title>HTML DOM Audio error Property</title>
 <meta charset="utf-8">
...
<h1>Audio <span class="color_h1">error</span> Property</h1>
<p><a href="dom_obj_audio.asp" class="w3-btn w3-white w3-border" title="Audio Object Reference">&#10094; Audio Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the error state of an audio:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myAudio&quot;).error.code;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_audio_error" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The error property returns a MediaError object.</p>
<p>The MediaError object has a code property containing the error state of the audio.</p>
...
<div class="w3-code w3-border notranslate">
 <div>
  <em>audioObject</em>.error.code</div></div>
<h2>Return Value</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>The code property of the MediaError Object returns a number representing the error state of the audio:<ul><li>1  = MEDIA_ERR_ABORTED - fetching process aborted by user</li>
    <li>2 = MEDIA_ERR_NETWORK - error occurred when downloading</li>
    <li>3 = MEDIA_ERR_DECODE - error occurred when decoding</li>
    <li>4 = MEDIA_ERR_SRC_NOT_SUPPORTED - audio not supported</li></ul>
    </td>
    </tr>
  </table>
