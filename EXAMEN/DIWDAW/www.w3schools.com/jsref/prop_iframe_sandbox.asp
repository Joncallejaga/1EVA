...
<html lang="en-US">
<head>
<title>HTML DOM IFrame sandbox Property</title>
 <meta charset="utf-8">
...
<h1>IFrame <span class="color_h1">sandbox</span> Property</h1>
<p><a href="dom_obj_frame.asp" class="w3-btn w3-white w3-border" title="Frame/IFrame Object Reference">&#10094; IFrame Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the value of the sandbox attribute:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myFrame&quot;).sandbox;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 allow-scripts</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_iframe_sandbox" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The sandbox property returns the value of the sandbox attribute in an iframe element.</p>
<p>The sandbox attribute is used to enable security restrictions for iframes with 
untrusted content (such as scripts and forms).</p>
<p>If specified as an empty string (sandbox=&quot;&quot;), the sandbox attribute enables a 
set of extra restrictions for the content in the inline frame.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>iframeObject</em>.sandbox</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
  <tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the value of the sandbox attribute</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_iframe_sandbox.asp">HTML &lt;iframe&gt; sandbox attribute</a></p>
<hr>
