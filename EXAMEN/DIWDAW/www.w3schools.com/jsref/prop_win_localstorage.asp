...
<h1>Window <span class="color_h1">localStorage</span> Property</h1>
<p><a href="obj_window.asp" class="w3-btn w3-white w3-border" title="Window Object Reference">&#10094; Window Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a localStorage name/value pair with name=&quot;lastname&quot; and value=&quot;Smith&quot;, 
...
document.getElementById(&quot;result&quot;).innerHTML = localStorage.getItem(&quot;lastname&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_win_localstorage">Try it Yourself &raquo;</a>
</div>
...
in a web browser.</p>
<p>The localStorage object stores data with no expiration date. The data 
will not be deleted when the browser is closed, and will be available the next 
day, week, or year.</p>
<p>The localStorage property is read-only.</p>

<p><strong>Tip:</strong> Also look at the <a href="prop_win_sessionstorage.asp">sessionStorage</a> property which stores 
data for one session (data is lost when the browser tab is closed).</p>
<hr>
...
window.localStorage</div></div>

<p><strong>Syntax for SAVING data to localStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  localStorage.setItem(&quot;key&quot;, &quot;value&quot;);</div></div>

<p><strong>Syntax for READING data from localStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  var lastname = localStorage.getItem(&quot;key&quot;);</div></div>

<p><strong>Syntax for REMOVING data from localStorage:</strong></p>
<div class="w3-code w3-border notranslate"><div>
  localStorage.removeItem(&quot;key&quot;);</div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>The following example counts the number of times a user has clicked a button:</p>
<div class="w3-code notranslate jsHigh">
  if (localStorage.clickcount) {<br>&nbsp;&nbsp;&nbsp; localStorage.clickcount = Number(localStorage.clickcount) 
  + 1;<br>} else {<br>&nbsp;&nbsp;&nbsp; localStorage.clickcount = 1;<br>}<br>
  document.getElementById(&quot;result&quot;).innerHTML = &quot;You have clicked the button &quot; +<br>
  localStorage.clickcount + &quot; time(s).&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_win_localstorage2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
