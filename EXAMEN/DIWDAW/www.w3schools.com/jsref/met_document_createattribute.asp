...
<a target="_blank" href="tryit.asp?filename=tryjsref_document_createattribute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="prop_attr_value.asp"><em>attribute</em>.value</a> property to set the value of the attribute.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_setattributenode.asp"><em>element.</em>setAttributeNode()</a> method to add the newly created attribute to an element.</p>
<p><strong>Tip:</strong> Often, you will want to use the
<a href="met_element_setattribute.asp"><em>element</em>.setAttribute()</a> method instead of the createAttribute() method.</p>
<hr>
