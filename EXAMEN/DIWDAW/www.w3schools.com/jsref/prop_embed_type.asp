...
<h1>Embed <span class="color_h1">type</span> Property</h1>
<p><a href="dom_obj_embed.asp" class="w3-btn w3-white w3-border" title="Embed Object Reference">&#10094; Embed Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the MIME type of the embedded content:</p>
<div class="w3-code notranslate jsHigh">
var x = document.getElementById("myEmbed&quot;).type;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 application/x-shockwave-flash</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_embed_type" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The height property sets or returns the value of the type attribute in an &lt;embed&gt; element.</p>
...
<div class="w3-code w3-border notranslate"><div>
 ...
 <em>embedObject</em>.type</div></div>
<p>Set the type property:</p>
<div class="w3-code w3-border notranslate"><div>

 <em>embedObject</em>.type =<em> MIME_type</em></div></div>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the MIME type of the embedded content</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_embed_type.asp">HTML &lt;embed&gt; type attribute</a></p>
<hr>
