...
<html lang="en-US">
<head>
<title>HTML DOM console.groupEnd() Method</title>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">console.groupEnd()</span> Method</h1>
<p><a href="obj_console.asp" class="w3-btn w3-white w3-border" title="Console Reference">&#10094; Console Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>End a message group by using the console.groupEnd() method:</p>
<div class="w3-code notranslate jsHigh">
  console.log(&quot;Hello world!&quot;);<br>console.group();<br>console.log(&quot;Hello again, 
  this time inside a group!&quot;);<br><strong>console.groupEnd();</strong><br>console.log(&quot;and we 
  are back.&quot;);</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_console_groupend" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The console.groupEnd() method indicates the end of a message group.</p>
<p><strong>Tip:</strong> Use the <a href="met_console_group.asp">console.group()</a> method to 
start a message group.</p>
<p><strong>Tip:</strong> Use the <a href="met_console_groupCollapsed.asp">console.groupCollapsed()</a> method to 
start a collapsed message group.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">console.groupend()</td>
    <td>Yes</td>
    <td>11.0</td>
    <td>4.0</td>
    <td>4.0</td>
