...
<!DOCTYPE html>
<html lang="en-US">
<head><title>HTML DOM Canvas Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="dom_obj_pushbutton.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_obj_caption.asp">Next &#10095;</a>
</div>
<hr>

<h2>Canvas Object <img src="https://www.w3schools.com/images/html5_badge20.png" alt="HTML5"></h2>
<p>The Canvas Object is new in HTML5.</p>
...
var x = document.getElementById("myCanvas");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_canvas_get" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var x = document.createElement("CANVAS");</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_canvas_create" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Adds a new point and creates a line from that point to the last specified point in the canvas</td>
  </tr>
  <tr>
...
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html5_canvas.asp">HTML5 Canvas</a></p>
<p>HTML reference: <a href="../tags/tag_canvas.asp">HTML &lt;canvas&gt; tag</a></p>
