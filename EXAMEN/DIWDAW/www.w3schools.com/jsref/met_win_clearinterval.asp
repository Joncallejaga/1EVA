...
<h3>Example</h3>
<p>Display the current time (the setInterval() method will execute the &quot;myTimer&quot; function 
once every 1 second).</p>
  <p>Use clearInterval() to 
stop the time:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjsref_win_clearinterval" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
use a variable when creating the interval method:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>var</em></td>
    <td>Required. The name of the timer returned by the setInterval() method</td>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Toggle between two background colors once every 300 milliseconds, until it is 
stopped by clearInterval():</p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-code notranslate jsHigh">
 function move() {<br>&nbsp; var elem = document.getElementById(&quot;myBar&quot;); <br>&nbsp; var width = 0;<br>&nbsp; var id = setInterval(frame, 100);<br>&nbsp; function frame() {<br>&nbsp;&nbsp;&nbsp; if (width == 100) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; clearInterval(id);<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width++; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; elem.style.width = width + '%';
 <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
