...
<h3>Example</h3>
 <p>Get the tagName of an element:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById("myP").tagName;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
 P
</div>-->
<a target="_blank" href="tryit.asp?filename=tryjsref_element_tagname" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> You can also use the <a href="prop_node_nodename.asp">nodeName</a> property to return the tag name of an element. The difference is that nodeName also returns attribute nodes, text nodes, comment nodes.</p>
<hr>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the tag name of the element in uppercase</td>
</tr>
<tr>
  <th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Using the tagName property together with the <em>event</em>.target property to find out which element triggered a specified event:</p>
<div class="w3-code notranslate jsHigh">
 var x = event.target.tagName;</div>
<a target="_blank" href="tryit.asp?filename=tryjsref_element_tagname2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
