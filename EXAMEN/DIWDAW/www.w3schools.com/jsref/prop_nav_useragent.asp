...
<h3>Example</h3>
<p>The user-agent header sent by your browser is:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_nav_useragent">Try it Yourself &raquo;</a>
</div>
...
<tr>
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the user agent string for the current browser</td>
</tr>
</table>
