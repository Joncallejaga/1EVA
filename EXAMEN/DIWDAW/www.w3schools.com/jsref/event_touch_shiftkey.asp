...
<html lang="en-US">
<head>
<title>TouchEvent shiftKey Property</title>
<meta charset="utf-8">
...
<h1>TouchEvent <span class="color_h1">shiftKey</span> Property</h1>
<p>
...
<h3>Example</h3>
<p>Find out whether or not the &quot;SHIFT&quot; key was pressed when you touch the screen:</p>
<div class="w3-code notranslate jsHigh">
 if (event.shiftKey) {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The SHIFT key was pressed!&quot;);<br>
 } else {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The SHIFT key was NOT pressed!&quot;);<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryjsref_event_touch_shiftkey" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The shiftKey property returns a Boolean value that indicates whether or not the &quot;SHIFT&quot; key was pressed when a 
touch event was triggered.</p>
<p><strong>Note:</strong> On many devices th SHIFT key is represented by the the ("&#8679;") key.</p>
...
<div class="w3-code w3-border notranslate"><div>
 <em>event</em>.shiftKey</div></div>
<h2>Technical Details</h2>
<table class="w3-table-all">
<tr>
 <th style="width:20%">Return Value:</th>
  <td>
 A Boolean, indicating whether the &quot;SHIFT&quot; key was pressed when the 
  touch event occurred.
 <p>Possible values:</p>
 <ul>
    <li>true - The shift key was pressed</li>
    <li>false - The shift key was not pressed</li>
 </ul>
  </td>
</tr>
</table>
...
<p>HTML DOM reference: <a href="event_touch_metakey.asp">TouchEvent metaKey Property</a></p>
<hr>
<p>
<a href="dom_obj_event.asp" class="w3-btn w3-white w3-border" title="Events">&#10094; DOM Events</a>
<a href="obj_touchevent.asp" class="w3-btn w3-white w3-border" title="TouchEvent">&#10094; TouchEvent</a>
