...
<html lang="en-US">
<head>
<title>HTML DOM Input Week min Property</title>
 <meta charset="utf-8">
...
<h1>Input Week <span class="color_h1">min</span> Property</h1>
<p><a href="dom_obj_week.asp" class="w3-btn w3-white w3-border" title="Input Week Object Reference">&#10094; Input Week Object</a>
</p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the minimum week and year allowed for a week field:</p>
<div class="w3-code notranslate jsHigh">
 var x = document.getElementById(&quot;myWeek&quot;).min;</div>
<!--<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">2014-W12</div>-->
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The min property sets or returns the value of the min attribute of a week 
field.</p>
<p>The min attribute specifies the minimum value (week and year) for a week field.</p>
<p><strong>Tip:</strong> The min attribute is often used together with the max attribute 
to create a range of legal values.</p>
<p><strong>Tip:</strong> To set or return the value of the max attribute, use 
the <a href="prop_week_max.asp">max</a> property.</p>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.min</div></div>
<p>Set the min property:</p>
<div class="w3-code w3-border notranslate"><div>
 <em>weekObject</em>.min = <em>YYYY-</em>W<em>WW</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>YYYY-</em>W<em>WW</em></td>
    <td>
  Specifies the minimum week and year allowed. Explanation of  components:
  <ul>
      <li>YYYY - year (e.g. 2011)</li>
      <li>The literal string &quot;-W&quot; indicates &quot;week&quot;</li>
      <li>WW - week (in the range of 1 to 52 or 53 (depending on the   particular year), e.g. 01 for the first week of the year)</li>
  </ul>
  Example: 2014-W15</td>
  </tr>
</table>
...
<table class="w3-table-all">
 ...
 <th style="width:20%">Return Value:</th>
  <td>A String, representing the minimum week and year allowed</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the minimum week and year allowed:</p>
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;myWeek&quot;).min = &quot;2014-W16&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjsref_week_min2">Try it Yourself &raquo;</a>
</div>
<hr>
