...
<p>Font Awesome 5 has a PRO edition with 4358 icons, and a FREE edition with 1414 icons. This tutorial will concentrate on the FREE edition.</p>
<p>To use the Free Font Awesome 5 icons, add the following &lt;link&gt; element inside the &lt;head&gt; 
section of your HTML page and display icons by using a class attribute with the prefix <code class="w3-codespan">fas</code> followed by the the icon's name.</p>
...
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
  ...
  &lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;i class="fas fa-clock"&gt;&lt;/i&gt;<br>
  <br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<p>Results in:</p>
<div class="w3-white">
...
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
   ...
   1&lt;/div&gt;<br>&lt;div&gt;&lt;i class="fas fa-band-aid fa-fw"&gt;&lt;/i&gt; Icon 3&lt;/div&gt;<br>&lt;div&gt;&lt;i 
   ...
   class="fas fa-band-aid"&gt;&lt;/i&gt; Icon 3&lt;/div&gt;<br>&lt;div&gt;&lt;i class="fab fa-bluetooth-b"&gt;&lt;/i&gt; Icon 
   3&lt;/div&gt;</div>
<p>Results in:</p>
<div class="w3-white">
