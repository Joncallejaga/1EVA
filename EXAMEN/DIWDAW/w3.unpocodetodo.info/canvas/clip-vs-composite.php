...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos; clip() versus globalCompositeOperation = &#34;source-atop&#34;" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, clip(), regi&oacute;n de recorte, region de recorte, combinar trazados, globalCompositeOperation, source-atop, pajarito, regordete, Google chrome anti-alias"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar un pajarito" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/clip-vs-composite.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos; clip() versus globalCompositeOperation = &#34;source-atop&#34;" /> 
  
  <title>Dibujar un pajarito</title>
  ...
  <link rel="canonical" href="clip-vs-composite.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="clip-vs-composite.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="clip-vs-composite.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="clip-vs-composite">
<h2 class="page_title">Dibujar un pajarito<br><small>o clip versus globalCompositeOperation</small></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar un pajarito&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip-vs-composite.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip-vs-composite.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip-vs-composite.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Vamos a practicar un poco lo que hemos aprendido hasta ahora, dibujando un pajarito regordete, que al inicio 
nos causar&aacute; problemas en <mark>Google Chrome</mark>. Pero &iexcl;no tem&aacute;is! porque bien est&aacute; lo que bien acaba.</p>
...
<p><em class="gem">Vea <a class="link_to" target="_blank" href="http://canvas/chuleta.php">la chuleta</a> con las propiedades y metodos() de canvas.</em></p>

<div class="row">
<div  class="large-12 columns">
<h4>Dibujar pajarito con clip()</h4>
<p>Empezaremos dibujando la colita, el pico y las patas. Despu&eacute;s esbozaremos un circulo con el radio de <code>70px</code> y, llamaremos el m&eacute;todo <code>clip()</code> para convertirlo en una nueva 
<mark>regi&oacute;n de recorte</mark> ( <em class="gem">clipping region</em> ), que representar&aacute; el cuerpo del pajarito. Dentro dibujaremos barriguita, ala, y todo lo dem&aacute;s.</p>
...
<div class="row">
<div class="large-12 columns">
<p>Todo parece funcionar muy bien, pero en <mark>Google Chrome</mark> el borde del cuerpo ( la regi&oacute;n de recorte ) aparece pixelado y muy feo ( por culpa del <a class="link_to" target="_blank" href="http://youtu.be/hqi0114mwtY">Anti Aliasing</a> ) y <mark>NO lo podemos arreglar con un borde</mark>, 
ya que de esta manera el borde aparecer&iacute;a entre el cuerpo y la colita y las dem&aacute;s cosas.</p>
<h4>Dibujar pajarito con "source-atop"</h4>
<p>Borramos las l&iacute;neas de c&oacute;digo que definen la regi&oacute;n de recorte ( <em class="gem">las lineas 34-37 del ejemplo anterior</em> ), y enseguida despu&eacute;s de dibujar el cuerpo del pajarito escribimos esta l&iacute;nea de c&oacute;digo:<br>
<code>ctx.globalCompositeOperation = "source-atop";</code><br>
Utilizando <code>"source-atop"</code> haremos que todos los trazados dibujados despu&eacute;s ( <em class="gem">source</em> ) sean visibles solo encima del cuerpo del animal ( <em class="gem">destination</em> ).<br></p>
</div>
</div>
...
<p>Et voila!... podr&iacute;a decirse que tenemos un pajarito perfecto.</p>    
