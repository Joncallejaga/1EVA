...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo crear texto con reflejo utilizando los m&eacute;todos translate() y scale()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, font, text, escribir, texto con reflejo,texto reflejado, translate(), scale(), globalAlpha, fillText()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Texto con reflejo" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/reflejo.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo crear texto con reflejo utilizando los m&eacute;todos translate() y scale()." /> 
  
  <title>Texto con reflejo</title>
  ...
  <link rel="canonical" href="reflejo.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="reflejo.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="reflejo">
<h2 class="page_title">Texto con reflejo</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Texto con reflejo&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Freflejo.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Freflejo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Freflejo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para crear texto con reflejo utilizaremos otros dos métodos de <code>&lt;canvas&gt;</code> <em class="gem"><a class="link_to" href="transform.php">translate()</a></em> y <em class="gem"><a class="link_to" href="transform.php">scale()</a></em>. También aplicaremos transparencia con <em class="gem"><a class="link_to" href="globalAlpha.php">globalAlpha.</a></em></p>
</div>

<div class="large-12 columns"><!--id="chuleta"-->
...
var ctx = canvas.getContext("2d");
			if (ctx) {
					...
					// el segundo par&aacute;metro de scale es un n&uacute;mero negativo
					ctx.scale(1, -1);
					// transparencia
					ctx.globalAlpha = 0.1;
