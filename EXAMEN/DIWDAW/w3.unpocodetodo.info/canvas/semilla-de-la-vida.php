...
<head>
  ...
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, combinar trazados, globalCompositeOperation, xor, la semilla de la vida"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Semilla de la vida con &#34;xor&#34;" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/semilla-de-la-vida.php" /> 
  ...
  <title>Semilla de la vida con &#34;xor&#34;</title>
  ...
  <link rel="canonical" href="semilla-de-la-vida.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="semilla-de-la-vida.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="semilla-de-la-vida.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="semilla-de-la-vida">

<div class="row">
<div  class="large-12 columns">
<h2 class="page_title">Semilla de la vida con &#34;xor&#34;</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Semilla de la vida con &#34;xor&#34;&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsemilla-de-la-vida.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsemilla-de-la-vida.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsemilla-de-la-vida.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La Semilla de la Vida es el nombre que se da a una figura geom&eacute;trica compuesta de 6 c&iacute;rculos completes, 
todos del mismo di&aacute;metro, que para algunos tiene un significado m&iacute;stico y esot&eacute;rico. 
Aqu&iacute; nos interesa solo como dibujarla, ya que nos permite practicar con la propiedad <code>globalCompositeOperation</code> d<code>e &lt;canvas&gt;</code>.</p>
<p>Empezamos esbozando un circulo imaginario con el centro en la esquina superior izquierda del <code>&lt;canvas&gt;</code>  (<code>var cX = 0, cY = 0</code>) con un radio de 60px ( <code>var r  = 60;</code>). No hay que trazarlo. Solo servir&aacute; de gu&iacute;a.</p>
<p>Trasladamos el contexto en el centro del canvas: <code>ctx.translate(ctx.canvas.width/2,ctx.canvas.height/2);</code></p>
<p>Para dibujar la "semilla de la vida" necesitamos 6 c&iacute;rculos cuyos centros est&aacute;n dispuestos equidistantemente en la circunferencia del circulo gu&iacute;a, o sea formando un &aacute;ngulo <strong>"a"</strong> de 60&deg; entre ellos. Recordemos que en radianes <code>60&deg; = Math.PI/3</code>.</p>
<p>Observamos que podemos escribir un <mark>bucle for</mark> para construir los 6 circulos.</p>
<p>Para el centro del primer circulo el &aacute;ngulo <code>a = (Math.PI/3)*0</code> radianes.<br>
  Para el centro del segundo circulo el &aacute;ngulo <code>a = (Math.PI/3)*1</code> radianes.<br>
  Para el centro del tercer circulo el &aacute;ngulo <code>a = (Math.PI/3)*2</code> radianes.<br>
  etc...</p>
<p>Falta encontrar las coordenadas de los centros, y la f&oacute;rmula ya la conocemos:<br>
  <code>X = cX+r*cos(a);</code><br>
  <code>Y = cY+r*sin(a);</code><br>
  donde:<br />
  - <strong>"a"</strong> es el &aacute;ngulo calculado anteriormente,<br />
  - <strong>"r"</strong> es el radio y <br />
  - <strong>"cX"</strong> e <strong>"cY"</strong> son las coordenadas del centro del circulo gu&iacute;a.</p>
<p>Al final dibujamos los c&iacute;rculos utilizando el m&eacute;todo <code>arc()</code>, y combinamos cada circulo con el circulo anterior utilizando <code>ctx.globalCompositeOperation = "xor";</code></p>
...
for( var i=0; i < 6; i++ ){
	...
	<span class="com">// dibujamos los circulos</span>
	ctx.beginPath();
	ctx.arc(X, Y, r, 0, 2 * Math.PI);
	ctx.fill();
	<span class="com">//combinamos trazados con xor</span>
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="260" id="lienzo">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
        <article>
         <canvas width="250" height="260" id="lienzo">Su navegador no soporta canvas :( </canvas>        </article>
</div>
