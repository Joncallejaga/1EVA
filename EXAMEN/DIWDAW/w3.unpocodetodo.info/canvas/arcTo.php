...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear esquinas redondeadas con el m&eacute;todo arcTo() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, curva, curvas,m&eacute;todo arcTo, metodo arcTo(),esquinas redondeadas, radio, tangentes,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El m&eacute;todo arcTo" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/arcTo.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear esquinas redondeadas con el m&eacute;todo arcTo() en el canvas de HTML5." /> 
  
  <title>El m&eacute;todo arcTo</title>
  ...
  <link rel="canonical" href="arcTo.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="arcTo.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="arcTo">
<h2 class="page_title">El m&eacute;todo arcTo</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El m&eacute;todo arcTo&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FarcTo.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FarcTo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FarcTo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>
En el <code>&lt;canvas&gt;</code> podemos crear esquinas redondeadas utilizando el m&eacute;todo <code>arcTo()</code>. <del>La mala noticia es que <span class="str">Opera no soporta el m&eacute;todo <code>arcTo()</code></span></del>.</p>
...
<img src="images/arcTo.png" width="250" height="300" alt="arcTo"  style="float:right;" />
<h4>La propiedad arcTo()</h4>
<p>La propiedad <code>arcTo()</code> crea un arco entre dos tangentes. Los par&aacute;metros utilizados son:</p>
<ul class="no-bullet">
<li><code>x1, y1 </code> las coordenadas x e y del primer punto de control.</li>
<li><code>x2, y2 </code> las coordenadas x e y del primer segundo de control.</li>
<li><code>r</code> representa el radio de la curvatura.</li>
</ul>

<p>Empezamos a dibujar en el punto cuyas coordenadas son: <code>x0, y0</code>.<br>
La primera tangente va del punto (<code>x0, y0</code>) al punto (<code>x1, y1</code>).<br>
La segunda tangente va del punto (<code>x1, y1</code>) al punto (<code>x2, y2</code>).
</p>
<br style="clear:both;" />
<h4>Esquinas redondeadas con arcTo</h4>
</div>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="arcos" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
	...
	var canvas = document.getElementById("arcos");
		...
		var ctx = canvas.getContext("2d");
			if (ctx) {
				   // define el r&aacute;dio
						 var r = 20;
						 // las coordenadas del rect&aacute;ngulo;
							var x0 = 50, y0 = 50;
							var x1 = 200, y1 = 50;
							var x2 = 200, y2 = 150;
							var x3 = 50, y3 = 150;
							...
							ctx.beginPath();
							ctx.moveTo(x3,y3-r);
							// dibuja un rect&aacute;ngulo con esquinas redondeadas
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="arcos" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>
<p>Para entender mejor lo que pasa:</p>
 <div class="large-12 g_panel demo">
 <article>
<canvas id="arcos1" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>
...
<p><a href="../index.html">w3.unpo&lt;code&gt;todo.info</a> utiliza una estructura generada con <a target="_blank" href="http://foundation.zurb.com/">foundation</a></p>
  ...
  <script>
	...
	var canvas1 = document.getElementById("arcos1");
		...
		var ctx1 = canvas1.getContext("2d");
			if (ctx1) {
						 var r = 20;
							...
							ctx1.moveTo(x3,y3-r);
							ctx1.arcTo(x0,y0,x1,y1,r);
							ctx1.stroke();
							
							ctx1.beginPath();
							ctx1.strokeStyle = "orange"; 
							ctx1.moveTo(x0+r,y0);
							ctx1.arcTo(x1,y1,x2,y2,r);
							ctx1.stroke(); 
							
							ctx1.beginPath();
							ctx1.strokeStyle = "green";
							ctx1.moveTo(x1,y1+r);
							ctx1.arcTo(x2,y2,x3,y3,r);
							ctx1.stroke(); 
							
							ctx1.beginPath();
							ctx1.strokeStyle = "blue";
							ctx1.moveTo(x2-r,y2);
							ctx1.arcTo(x3,y3,x0,y0,r);
							ctx1.stroke(); 
			}
		}</script><script>
