...
<head>
  ...
  <meta name="description" content="Crear una imagen reflejada en canvas es muy f&aacute;cil. El secreto est&aacute; en..." />
  <meta name="keywords" content="canvas,HTML5, javascript,imagen, scale, redimensionar, translate, trasladar, reflejo, reflejar, onload"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Im&aacute;genes reflejadas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/imagen-reflejada.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Crear una imagen reflejada en canvas es muy f&aacute;cil. El secreto est&aacute; en..." /> 
  
  <title>Im&aacute;genes reflejadas</title>
  ...
  <link rel="canonical" href="imagen-reflejada.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="imagen-reflejada.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="imagen-reflejada.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="imagen-reflejada"><h2 class="page_title">Im&aacute;genes reflejadas</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Im&aacute;genes reflejadas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagen-reflejada.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagen-reflejada.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagen-reflejada.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Crear una imagen reflejada en canvas es muy f&aacute;cil. El secreto est&aacute; en redimensionar el contexto del  canvas para darle la vuelta: <code>ctx.scale(<strong class="str">-1</strong>,1);</code> pero primero tenemos que trasladar el contexto exactamente dos alturas de imagen (<code>2*this.height</code>). De otra manera el contexto quedar&aacute; totalmente fuera del lienzo.</p><blockquote><pre>ctx.translate(0, 2*this.height);ctx.scale(-1,1);</pre></blockquote><p>Veamos el c&oacute;digo:<br>Primero definimos el canvas <code>c</code>, el contexto <code>ctx</code> y guardamos la anchura y la altura del mismo en dos variables: <code>cw</code> para la anchura y <code>ch</code> para la altura.</p><blockquote><pre>var c = document.getElementById("c");var ctx = c.getContext("2d");var cw = c.width = 250,cx=cw/2;var ch = c.height = 358,cy=ch/2;</pre></blockquote><p>A continuaci&oacute;n necesitamos especificar la imagen que queremos utilizar.</p><blockquote><pre>var img = new Image();<span class="com">// define el valor del atributo src para la nueva imagen</span>img.src = "lo-que-fuera.jpg";</pre></blockquote><p>Las im&aacute;genes tardan en cargarse, y aunque esta demora fuera de solo una fracci&oacute;n de segundo, probar a utilizar una imagen inexistente, resultar&iacute;a en error. Para que esto no pase tenemos que escribir una funci&oacute;n an&oacute;nima que dibuja la imagen con <code>drawImage()</code>, y enlazar esta funci&oacute;n como retrollamada ( <em class="gem">callback</em> ) al evento <code>onload</code>.</p><p>En este caso la palabra clave <code>this</code> se refiere a la nueva imagen. </p><blockquote><pre>img.<strong class="str">onload</strong> = function() {ctx.drawImage(this, 0, 0);     <strong class="str">ctx.translate(0, 2*this.height);</strong><strong class="str">ctx.scale(1,-1);</strong>ctx.drawImage(this, 0, 0);}</pre></blockquote><p data-height="400" data-theme-id="11360" data-slug-hash="9f464840cd3064c7d03026fb6a02b5e0" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/9f464840cd3064c7d03026fb6a02b5e0/'>Imagen reflejada</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><p>En el caso que queremos reflejar la imagen horizontalmente, el c&oacute;digo tendr&iacute;a este aspecto: </p><blockquote><pre>img.<strong class="str">onload</strong> = function() {ctx.drawImage(this, 0, 0);<strong class="str">ctx.translate(2*this.width,0);</strong><strong class="str">ctx.scale(-1,1);</strong>ctx.drawImage(this, 0, 0);}</pre></blockquote><p data-height="266" data-theme-id="11360" data-slug-hash="59cf0ab5ea2aa937bd57a6939cf2f274" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/59cf0ab5ea2aa937bd57a6939cf2f274/'>Imagen reflejada</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="imagenes.php">Trabajar con im&aacute;genes</a></em></li><li>- <em class="gem">Im&aacute;genes reflejadas</em></li><li>- <em class="gem"><a class="link_to" href="manipulate.php">Manipular im&aacute;genes</a></em></li><li>- <em class="gem"><a class="link_to" href="negativo.php">El negativo de una imagen</a></em></li><li>- <em class="gem"><a class="link_to" href="blancoynegro.php">Im&aacute;genes en blanco y negro</a></em></li><li>- <em class="gem"><a class="link_to" href="sepia.php">Im&aacute;genes en sepia</a></em></li><li>- <em class="gem"><a class="link_to" href="canvas-blending.php">Modos de fusi&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="data_uri.php">Que son los data:uri</a></em></li><li>- <em class="gem"><a class="link_to" href="toDataURL.php">Crear data:uri desde canvas</a></em></li><li>- <em class="gem"><a class="link_to" href="faviconos-js.php">Faviconos con canvas</a></em></li></ul></article></div></div>
