...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo dibujar l&iacute;neas discontinuas en canvas. " />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, animaci&oacute;n, setLineDash, lineDashOffset, getLineDash, marching ants, hormigas que marchan, hormigas andadoras, l&iacute;neas discontinuas"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="L&iacute;neas discontinuas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/lineas-discontinuas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo dibujar l&iacute;neas discontinuas en canvas. " /> 
  
  <title>L&iacute;neas discontinuas</title>
  ...
  <link rel="canonical" href="lineas-discontinuas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="lineas-discontinuas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="lineas-discontinuas.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="lineas-discontinuas">
<h2 class="page_title">L&iacute;neas discontinuas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=L&iacute;neas discontinuas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Flineas-discontinuas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Flineas-discontinuas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Flineas-discontinuas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Tambi&eacute;n podemos dibujar l&iacute;neas discontinuas en &lt;canvas&gt; utilizando el m&eacute;todo  <code>setLineDash()</code>.</p>
...
<tr>
  ...
  <tr class="old">
   ...
   <tr>
    <td>setLineDash()</td>
    <td>context.setLineDash();</td>
    <td>M&eacute;todo que se utiliza para crear l&iacute;neas discontinuas.</td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td>getLineDash();</td>
    <td>context.getLineDash();</td>
    <td>Propiedad que especifica el desplazamiento (offset) inicial de una l&iacute;nea discontinua.</td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td>lineDashOffset</td>
    <td>context.lineDashOffset;</td>
    <td>M&eacute;todo que devuelve la lista de valores utilizada para crear una l&iacute;nea discontinua. Ejemplo: <code>console.log(context.getLineDash());</code></td>
    <td>&nbsp;</td>
  </tr>
...
<h4 id="h4_1">El m&eacute;todo setLineDash()</h4>

<p>Podemos dibujar l&iacute;neas discontinuas en &lt;canvas&gt; utilizando el m&eacute;todo  <code>setLineDash()</code>, que toma como argumento una lista de n&uacute;meros separados por comas, que definen el patr&oacute;n a seguir.<br>
Por ejemplo <code>ctx.setLineDash([10, 5])</code> define una l&iacute;nea compuesta por fragmentos de l&iacute;nea de 10px separados por espacios de 5px.<br>
Para <strong>desactivar las l&iacute;neas discontinuas</strong> podemos utilizar <code>ctx.setLineDash([])</code>, como en el siguiente ejemplo, o podemos utilizar los m&eacute;todos <a class="link_to" target="_blank" href="save-restore.php">save() y restore()</a> para aislar la parte de c&oacute;digo que establece el patr&oacute;n de l&iacute;neas discontinuas.<br>
Vea algunos ejemplos:</p>
...
<h4>La propiedad lineDashOffset</h4>
<p>Una propiedad relacionada es <code>ctx.lineDashOffset</code>, que especifica el desplazamiento ( <em class="gem">offset</em> ) inicial como en el siguiente ejemplo:</p>

<div class="large-12 g_panel html">
        <article>
        
        <pre><code class="language-markup"><canvas id="c1" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>
...
ctx1.moveTo(0, cy + 10);
ctx1.lineTo(cw, cy + 10);
ctx1.stroke();</code></pre>
        </article>
</div>
<p>Las dos l&iacute;neas son iguales, solo que la segunda tiene un desplazamiento <code>ctx.lineDashOffset = 9;</code></p>
<div class="large-12 g_panel resultado">
 <article>
<canvas id="c1" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>

<h4 id="h4_2">Hormigas andadoras</h4>
<p>Podemos utilizar la propiedad <code>ctx.lineDashOffset</code> para realizar animaciones de tipo &quot;hormigas que marchan&quot; ( <em class="gem">marching ants</em> ) </p>
...
<div class="large-12 g_panel html">
        ...
        <pre><code class="language-markup"><canvas id="canvas" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>
...
requestId = window.requestAnimationFrame(Animacion);</code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
 <article>
<canvas id="canvas" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>
<p><em class="gem">Lea m&aacute;s acerca de <a class="link_to" target="_blank" href="animaciones-en-canvas.php">requestAnimationFrame</a></em></p>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="line.php">Trazar una l&iacute;nea</a></em></li><li>- <em class="gem"><a class="link_to" href="lineCap.php">Puntas de l&iacute;nea (lineCap)</a></em></li><li>- <em class="gem"><a class="link_to" href="lineJoin.php">Uniones de l&iacute;nea</a></em></li><li>- <em class="gem">L&iacute;neas discontinuas</em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- MDN: <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/API/CanvasRenderingContext2D/setLineDash">CanvasRenderingContext2D.setLineDash()</a><br>
- MDN: <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/API/CanvasRenderingContext2D/getLineDash">CanvasRenderingContext2D.lineDashOffset</a><br>
- MDN: <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/API/CanvasRenderingContext2D/lineDashOffset">CanvasRenderingContext2D.lineDashOffset</a><br>- Vea la <a class="link_to" target="_blank" href="chuleta.php">chuleta</a> de canvas.<br>
...
requestId = window.requestAnimationFrame(Animacion);</script><script>
