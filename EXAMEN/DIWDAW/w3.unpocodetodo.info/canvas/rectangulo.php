...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar rect&aacute;ngulos en el canvas de HTML5 con rect(), fillRect()y  strokeRect()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, dibujar rect&aacute;ngulos, dibujar rectangulos, rect(), fillRect(), strokeRect(), clearRect() fillStyle, strokeStyle, lineWidth"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Rect&aacute;ngulos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/rectangulo.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar rect&aacute;ngulos en el canvas de HTML5 con rect(), fillRect()y  strokeRect()." /> 
  
  <title>Rect&aacute;ngulos</title>
  ...
  <link rel="canonical" href="rectangulo.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="rectangulo.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="rectangulo.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">Rect&aacute;ngulos</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Rect&aacute;ngulos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Frectangulo.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Frectangulo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Frectangulo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Los rect&aacute;ngulos son por ahora las &uacute;nicas formas geometricas primitivas soportadas por <code>&lt;canvas&gt;</code>. 
O sea: podemos dibujar rect&aacute;ngulos utilizando m&eacute;todos y propiedades especificas.</p>
...
<tbody>
  ...
  <tr>
    ...
    <td>Determina (sets) o devuelve (returns) la grosor de la l&iacute;nea.</td>
    <td>1</td>
  </tr>
    <tr class="old">
    <td>strokeStyle</td>
  ...
  <tr>
    ...
    <td>Dibuja un rect&aacute;ngulo desde un punto (x,y).</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>clearRect();</td>
...
<h4 id="h4_1">Dibujar un rect&aacute;ngulo</h4>
<p><strong>Veamos un ejemplo.</strong> A continuaci&oacute;n queremos dibujar un rect&aacute;ngulo. Utilizamos <code>lineWidth</code> y <code>strokeStyle</code> para establecer el estilo de l&iacute;nea, y <code>fillStyle</code>  para establecer el tipo de relleno<!--, y utilizamos, como siempre, el m&eacute;todo <code>beginPath()</code> para empezar el trazado-->.<br />
Para esbozar y dibujar el rect&aacute;ngulo utilizamos el m&eacute;todo <code>strokeRect()</code> y para el esbozar y rellenar el m&eacute;todo <code>fillRect()</code>
.</p>

<blockquote><pre>contexto.strokeRect(x,y,anchura,altura);
contexto.fillRect(x,y,anchura,altura);
</pre></blockquote>
<p>Donde:<br />
- <code>x</code> e <code>y</code> representan las coordenadas de la esquina izquierda arriba del rect&aacute;ngulo,<br />
- <code>anchura</code> representa la anchura del rect&aacute;ngulo y <br />
- <code>altura</code> representa la altura del rect&aacute;ngulo</p>

<p>Observe por favor que esta vez no necesitamos utilizar <code>stroke()</code> para marcar el rect&aacute;ngulo, ya que <code>strokeRect()</code> define y dibuja el rect&aacute;ngulo en el 
mismo tiempo. Lo mismo pasa con <code>fillRect()</code> que define y rellena el rect&aacute;ngulo a la vez.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup"><canvas id="lienzo" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>	
	    </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>
<p>Tambi&eacute;n podemos utilizar el m&eacute;todo <code>rect()</code> solo para definir el rect&aacute;ngulo. Exactamente como en el caso de <code>strokeRect()</code> y 
<code>fillRect()</code>, el m&eacute;todo <code>rect()</code> toma cuatro argumentos: las coordenadas de la esquina izquierda arriba, la anchura y la altura del rect&aacute;ngulo.</p>
<blockquote><pre>contexto.rect(x,y,anchura,altura);</pre></blockquote>
<p>En este caso habr&aacute; que utilizar <code>stroke()</code> para marcar, y/o <code>fill()</code> para rellenar el rect&aacute;ngulo.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup"><canvas id="lienzo1" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>	
		</article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo1" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>

<h4 id="h4_2">Borrar con clearRect()</h4>
<p>Para limpiar el canvas podemos utilizar el m&eacute;todo <code>clearRect()</code>. Exactamente como <code>rect()</code> o <code>strokeRect()</code>, <code>clearRect()</code> toma cuatro atributos: <code>x, y, anchura</code> y <code>altura</code>, 
pero en lugar de dibujar un rect&aacute;ngulo, est&aacute; borrando del <code>&lt;canvas&gt;</code> los pixeles situados dentro.</p>
<p>El m&eacute;todo <code>clearRect()</code> es muy &uacute;til, especialmente en animaciones, cuando utilizamos <code>clearRect()</code> para limpiar el canvas entre fotogramas.</p> 
<p>En el siguiente ejemplo el <code>&lt;canvas&gt;</code> tiene una imagen de fondo asignada con el <code>CSS</code>. 
Despu&eacute;s de haber dibujado un rect&aacute;ngulo, utilizamos el m&eacute;todo <code>clearRect()</code> para borrar parte de este.</p>    

<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup"><canvas id="lienzo2" width="250" height="232" style="background-image:url(images/enfeinada250.jpg)">Su navegador no soporta canvas :( </canvas></code></pre>	
		</article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo2" width="250" height="232" style="background-image:url(images/enfeinada250.jpg)">Su navegador no soporta canvas :( </canvas> </article>
</div>
