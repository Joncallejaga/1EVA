...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Escoger el tipo de uni&oacute;n entre l&iacute;neas en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, lineJoin,uni&oacute;n de l&iacute;nea, union de linea, uniones, miter, round, bevel, miterLimit, uni&oacute;n en angulo, union en angulo, uni&oacute;n redondeada,union redondeada, uni&oacute;n en bisel, union en bisel"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Uniones de l&iacute;nea" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/lineJoin.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Escoger el tipo de uni&oacute;n entre l&iacute;neas en el canvas de HTML5." /> 
  
  <title>Uniones de l&iacute;nea</title>
  ...
  <link rel="canonical" href="lineJoin.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="lineJoin.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="lineJoin">
<h2 class="page_title">Uniones de l&iacute;nea</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Uniones de l&iacute;nea&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineJoin.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineJoin.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineJoin.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos dibujar un trazado en el <code>&lt;canvas&gt;</code> conectando lineas y curvas. Al conectar dos l&iacute;neas podemos escoger tambi&eacute;n el tipo de uni&oacute;n.</p>
...
<tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td>Determina <em class="gem">(sets)</em> o devuelve <em class="gem">(return)</em>  el aspecto de las juntas en miter.
...
<p><strong>Veamos un ejemplo</strong>. A continuaci&oacute;n dibujamos 3 trazados iguales, cada una con otro tipo de uni&oacute;n. 
El trazado de arriba tiene una uni&oacute;n en &aacute;ngulo <code>(ctx.lineJoin = "miter";)</code>, el del medio es redondeado 
<code>(	ctx.lineJoin = "round";)</code>, mientras que el tercer trazado tiene una uni&oacute;n en bisel <code>(ctx.lineJoin = "bevel";)</code>. 
Si no especificamos el tipo de uni&oacute;n, este es por defecto en &aacute;ngulo (<code>"miter"</code>).</p>
<p>Hay tambien una propiedad <code>miterLimit</code> que representa la distancia entre la parte interna y la parte externa del &aacute;ngulo donde 
las dos l&iacute;neas se encuentran. Puede tomar valores entre 1 (punta roma, aspecto biselado) y 5 (punta en angulo). Utilizando  <code>miterLimit</code> 
podemos tramsformar una punta en angulo <code>"miter"</code> en una punta biselada. ( Vea el &uacute;ltimo trazado - en rojo, donde <code>ctx.miterLimit=1;</code> ).</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="juntas1" width="250" height="500">Su navegador no soporta canvas :( </canvas></code></pre>	
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="juntas1" width="250" height="500">Su navegador no soporta canvas :( </canvas> </article>
</div>
