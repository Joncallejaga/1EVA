...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como rellenar un trazado con fillStyle, fill(), fillRect() y fillText() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, fillStyle, fill(), fillRect() y fillText(), color, colorear"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Color de relleno" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/fill.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como rellenar un trazado con fillStyle, fill(), fillRect() y fillText() en el canvas de HTML5." /> 
  ...
  <link rel="canonical" href="fill.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="fill.php#"><span></span></a></li>
          </ul>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Color de relleno&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ffill.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ffill.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ffill.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos rellenar las formas geometricas dibujadas en el <code>&lt;canvas&gt;</code> utilizando el m&eacute;todo <code>fill()</code>.
Para los rect&aacute;ngulos podemos utilizar el m&eacute;todo <code>fillRect()</code> y para el texto: el m&eacute;todo <code>fillText().</code>
<br />Previamente tenemos que especificar el estilo de relleno <code>fillStyle</code>, ya sea color, gradiente o patr&oacute;n. 
Si no especificamos un estilo de relleno, este ser&aacute; por defecto negro.</p>
...
<p><strong>Veamos un ejemplo</strong>. A continuaci&oacute;n queremos dibujar un tri&aacute;ngulo. Utilizamos como siempre el m&eacute;todo <code>beginPath()</code> 
para empezar el trazado. Utilizamos el m&eacute;todo <code>moveTo()</code> para mover el &quot;lapiz&quot; hasta el origen de nuestro trazado; 
esbozamos dos de los tres lados utilizando el m&eacute;todo <code>lineTo()</code>. No es necesario cerrar el trazado. Tampoco es necesario trazarlo.<br />
Utilizamos <code>fillStyle</code> para definir el relleno ( amarillo en este caso ), y utlilizamos el m&eacute;todo <code>fill()</code> para rellenar de color el tri&aacute;ngulo.</p>
<p>Para rellenar de color un <a class="link_to" target="_blank" href="rectangulo.php">rect&aacute;ngulo</a> es mucho m&aacute;s f&aacute;cil. Sencillamente definimos el relleno con <code>fillStyle</code> y despu&eacute;s utilizamos 
el m&eacute;todo <code>fillRect(x,y,anchura,altura)</code> para rellenar el rect&aacute;ngulo.</p>
<p>Para <a class="link_to" target="_blank" href="text.php">texto</a> utilizamos el m&eacute;todo <code>fillText(text,x,y,maxWidth)</code>. !OJO&iexcl; el par&aacute;metro <mark>opcional</mark> <code>maxWidth</code> no se admite en Safari.</p>
	...
	var canvas = document.getElementById("lienzo");
		...
		var ctx = canvas.getContext("2d");
			if (ctx) {
				...
				ctx.lineTo(70, 100);
				ctx.fill();
				// dibujamos y rellenamos un rect&aacute;ngulo
				ctx.fillStyle = "#b00";
