...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear gradientes lineales con createLinearGradient() y addColorStop() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, relleno, gradiente lineal, trazados, createLinearGradient(), addColorStop()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Gradiente lineal" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/createLinearGradient.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear gradientes lineales con createLinearGradient() y addColorStop() en el canvas de HTML5." /> 
  
  <title>Gradiente lineal</title>
  ...
  <link rel="canonical" href="createLinearGradient.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="createLinearGradient.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="createLinearGradient.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="createLinearGradient">
<h2 class="page_title">Gradiente lineal</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Gradiente lineal&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateLinearGradient.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateLinearGradient.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateLinearGradient.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El gradiente lineal se puede utilizar como relleno para formas geom&eacute;tricas, l&iacute;neas y texto dentro del <code>&lt;canvas&gt;</code>.</p>
...
<div class="large-12">
<p>Los gradientes lineales son definidos por una l&iacute;nea imaginaria que nos da la direcci&oacute;n del gradiente.<br />
El m&eacute;todo <code>createLinearGradient(x0,y0,x1,y1)</code> toma cuatro argumentos.<br /> 
Los primeros dos argumentos (<code>x0,y0</code>) representan  las coordenadas del origen de nuestra l&iacute;nea, mientras que los siguientes dos 
argumentos (<code>x1,y1</code>)  representan  las coordenadas del punto donde esta l&iacute;nea acaba.
</p>
<p>El m&eacute;todo <code>addColorStop(stop,color)</code> toma dos argumentos.<br />
El primer argumento, <code>stop</code>, puede tomar valores desde <code>0.0</code> hasta <code>1.0</code>, y representa una posici&oacute;n a lo largo del vector gradiente definido anteriormente con m&eacute;todo <code>createLinearGradient()</code>.
...
(<em class="gem"> <a class="link_to" href="../utiles/colores-alfabeticamente.php">nombres de colores</a>, valores 
<a class="link_to" href="../css3/hex.php">hex</a>, <a class="link_to" href="../css3/rgb.php">rgb, rgba</a>, 
<a class="link_to" href="../css3/hsl.php">hsl, hsla</a></em>).</p>

<p><strong>Veamos un ejemplo</strong>. A continuaci&oacute;n queremos dibujar un rect&aacute;ngulo que cubrir&aacute; todo el lienzo, desde la esquina izquierda arriba (<code> x = 0, y = 0 </code>) hasta la esquina derecha abajo ( <code>x = canvas.width, y = canvas.height</code> ).
Utilizando el m&eacute;todo <code>createLinearGradient()</code> creamos el vector gradiente, estableciendo el punto de partida del vector ( <code>x0 = 0, y0 = 0</code> ), y el punto donde este acaba ( <code>x1 = canvas.width, y1 = 0</code> ). 
Este es un gradiente lineal <mark>horizontal</mark>, ya que el vector es paralelo al eje x.<br />
Utilizamos el m&eacute;todo  <code>addColorStop()</code> seis veces para crear algo parecido a un arco iris.<br />
Al final utilizamos este gradiente como estilo de relleno (<code>ctx.fillStyle = grd;</code>) para nuestro rect&aacute;ngulo.</p>
