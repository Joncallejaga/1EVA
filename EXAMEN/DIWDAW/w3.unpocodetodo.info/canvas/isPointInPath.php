...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Detectar si un punto se encuentra en un trazado dado con isPointInPath()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, trazado, isPointInPath()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="M&eacute;todo isPointInPath" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/isPointInPath.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Detectar si un punto se encuentra en un trazado dado con isPointInPath()." /> 
  
  <title>M&eacute;todo isPointInPath</title>
  ...
  <link rel="canonical" href="isPointInPath.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="isPointInPath.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="isPointInPath.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="isPointInPath">
<h2 class="page_title">M&eacute;todo isPointInPath</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=M&eacute;todo isPointInPath&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FisPointInPath.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FisPointInPath.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FisPointInPath.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El m&eacute;todo <code>isPointInPath(x,y)</code> detecta si un punto cuyas coordenadas son <code>x</code> e <code>y</code> se encuentra dentro de un trazado dado.</p>
...
<p>A continuaci&oacute;n dibujamos un trazado en el <code>&lt;canvas&gt;</code>, y utilizamos el m&eacute;todo  <code>isPointInPath()</code> en una <mark>sentencia condicional<code> if</code></mark>.<br>
<mark>Si</mark> ( <code>if</code> ) el punto se encuentra en el trazado, dibujamos un peque&ntilde;o circulo con el centro en el punto.</p>
<blockquote><pre>
if (ctx.<span class="str">isPointInPath</span>(px, py)) {
   ctx.beginPath();
   ctx.arc(px, py, 4, 0, 2 * Math.PI);
}
</pre></blockquote>  
<p>De lo contrario ( <code>else</code> ) dibujamos un peque&ntilde;o rect&aacute;ngulo.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="250" height="220">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
if (canvas && canvas.getContext) {
  ...
  if (ctx) {
    ...
    // queremos saber si el punto p est&aacute; en el trazado.
    // sus coordenadas son:
    var px = 100, py = 90;
...
<p>S&iacute;, el punto cuyas coordenadas son px = 100, py = 90 se encuentra dentro del trazado.</p>
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="250" height="220">Su navegador no soporta canvas :( </canvas> </article>
</div>
<p>&nbsp;</p>
<h4>Otro ejemplo</h4>
<p>Para obtener la posici&oacute;n del rat&oacute;n encima del <code>&lt;canvas&gt;</code> hemos escrito la funci&oacute;n <code>oMousePos()</code> que devuelve un objeto con las coordenadas <code>x</code> e <code>y</code> del rat&oacute;n.<br>
Esta funci&oacute;n utiliza el m&eacute;todo <em class="gem"><a target="_blank" class="link_to" href="https://developer.mozilla.org/es/docs/DOM/element.getBoundingClientRect">getBoundingClientRect()</a></em>.</p>
<blockquote><pre>
...
<p>Tambi&eacute;n hemos escrito la funci&oacute;n 
  <code>marcarPos()</code> que da formato al <code>&lt;div id="output"&gt;</code> donde apuntamos el valor de las coordenadas del rat&oacute;n.</p>
<p>Utilizamos el m&eacute;todo <em class="gem"><a target="_blank" class="link_to" href="https://developer.mozilla.org/es/docs/DOM/elemento.addEventListener">addEventListener()</a></em> 
para detectar el movimiento del rat&oacute;n (<code>"mousemove"</code>) encima del <code>&lt;canvas&gt;</code>. 
La funci&oacute;n <code>marcarPos()</code> detecta la posici&oacute;n del rat&oacute;n encima del trazado, utilizando <code>isPointInPath</code>, y marca las coordenadas de este.</p>
<blockquote><pre>
function marcarPos(output, x, y) {
  if (ctx.<span class="str">isPointInPath</span>(x, y)) {
...
<div id="container" style="position:relative; width:250px; height:220px; margin:0 auto 30px;">
<canvas id="lienzo1" width="250" height="220">Su navegador no soporta canvas :( </canvas>
...
<div id="output" style="position:absolute; padding:5px;"></div>
 ...
 <p class="text-center"><em class="gem">Pase por encima del trazado para obtener la posici&oacute;n actual del rat&oacute;n.</em></p>
 </article>
</div>
