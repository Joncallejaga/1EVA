...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar una elipse con bezierCurveTo() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, elipse, curvas, curvas de B&eacute;zier, curvas de Bezier, bezierCurveTo()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar una elipse" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/elipse.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar una elipse con bezierCurveTo() en el canvas de HTML5." /> 
  
  <title>Dibujar una elipse</title>
  ...
  <link rel="canonical" href="elipse.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="elipse.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="elipse">
<h2 class="page_title">Dibujar una elipse</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar una elipse&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Felipse.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Felipse.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Felipse.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En este momento podemos dibujar una elipse en canvas, utilizando el m&eacute;todo <code>ellipse()</code>. 
La mala noticia es que <span class="str">este m&eacute;todo funciona solo en Chrome y versiones modernas de Opera.</span></p>
...
<h4 id="ellipse">Dibujar una elipse con ellipse()</h4>
<p>El m&eacute;todo <code>ellipse()</code> tiene la siguiente sintaxis:</p>
<blockquote><pre>ctx.ellipse(centroX, centroY, radioX, radioY, rotacion, ap, af, cR);</pre></blockquote>


<p>Donde:<br />
  - <code>centroX</code> y <code>centroY</code> son las coordenadas del centro, <br />
  - <code>radioX</code> y <code>radioY</code> representan el radio en x y el radio en y,<br />
  - la <code>rotacion</code> representa el &aacute;ngulo de rotaci&oacute;n del eje horizontal (en radianes),<br />
  - <code>ap</code> es el &aacute;ngulo de partida ( en radianes ),<br />
  - <code>af</code> es el &aacute;ngulo final ( en radianes ), y<br />
  - <code>cR</code> ( contra reloj ) es la direcci&oacute;n.</p>
<p>Exactamente como en el caso de <a class="link_to" target="_blank" href="arc.php">arc()</a>, el parametro <code>cR</code> puede tomar dos valores:<br />
  - <code>true</code> ( verdadero, o sea: en sentido contrario al de las agujas del reloj ) y<br />
  - <code>false</code> ( falso, o sea: en el sentido de las agujas del reloj ).</p>
  
  <div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup"><canvas id="lienzo" width="250" height="170">Su navegador no soporta canvas :( </canvas></code></pre>        
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="250" height="170">Su navegador no soporta canvas :( </canvas> </article>
</div>



<h4 id="bezier">Dibujar una elipse utilizando curvas de B&eacute;zier</h4>
<p>Mientras tanto podemos utilizar curvas de B&eacute;zier para dibujar elipses. El internet es una <em class="gem"><a class="link_to" target="_blank" href="http://stackoverflow.com/questions/2172798/how-to-draw-an-oval-in-html5-canvas#answer-2173084">fuente ilimitada de recursos</a></em> donde podemos encontrar de todo, incluso funciones
que nos facilitan dibujar elipses. </p>



<img src="images/elipse.png" alt="Dibujar una elipse en el canvas" style="float:left; padding-right:10px;">
<p>Para dibujar una elipse necesitamos cuatro <a class="link_to" target="_blank" href="bezier.php">curvas de B&eacute;zier</a>, una para cada cuadrante. 
Para determinar el desplazamiento horizontal y vertical (<em class="gem"> offset </em>) de los puntos de control, 
y por tanto la curvatura de la elipse, utilizamos una constante llamada <code>kappa</code>.<br />
La funci&oacute;n <code>dibujarElipse(ctx, x, y, w, h)</code>, que tenemos que escribir, toma seis argumentos: 
<code>ctx</code> reprezenta el contexto del <code>&lt;canvas&gt;</code>, 
<code>x</code> e <code>y</code> representan las coordenadas del punto de origen, mientras que
<code>w</code> y <code>h</code> representan la anchura ( w ) y respectivamente la altura ( h ) de nuestra elipse. 
El par&aacute;metro <code>lw</code> representa la grosor de la l&iacute;nea, definida con <code>lineWidth</code>.<br />
Las otras coordenadas las calculamos en funci&oacute;n de <code>x, y, w</code> y <code>h</code>.</p>
<p><strong>Consejo:</strong> Pruebe modificar el valor de <code>kappa</code>. Si <code>kappa = 1</code> obtenemos un rectangulo con las esquinas ligeramente redondeadas.
Si <code>kappa = 0</code> el rezultado ser&aacute; un rombo.</p>
<p><em class="gem">Para saber m&aacute;s acerca de <code>kappa</code> visite la p&aacute;gina de Adam Stanislav <a class="link_to" target="_blank" href="http://whizkidtech.redprince.net/bezier/circle/">Drawing a circle with B&eacute;zier Curve</a></em></p>
<!--<p></p>
<div class="large-12 g_panel html">
        <article>								
...
<p data-height="400" data-theme-id="11360" data-slug-hash="5109ecd030d00672970e24c40e1c2d00" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/5109ecd030d00672970e24c40e1c2d00/">5109ecd030d00672970e24c40e1c2d00</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p>
<script async src="http://assets.codepen.io/assets/embed/ei.js"></script>

<p><em class="gem">También podemos dibujar una elipse <a target="_blank" class="link_to" href="otras-curvas.php#h4_1">utilizando el método lineTo()</a></em></p>      
</section>
</article>
