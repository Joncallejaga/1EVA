...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo escribir en el canvas de HTML5; c&oacute;mo medir texto con measureText." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, font, text, escribir, measureText"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Medir texto" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/measureText.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo escribir en el canvas de HTML5; c&oacute;mo medir texto con measureText." /> 
  
  <title>Medir texto</title>
  ...
  <link rel="canonical" href="measureText.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="measureText.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="measureText.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="measureText">
<h2 class="page_title">Medir texto</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Medir texto&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FmeasureText.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FmeasureText.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FmeasureText.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El m&eacute;todo <code>measureText()</code> devuelve un objeto que contiene la anchura del texto especificado entre par&eacute;ntesis.<br>
En el siguiente ejemplo utilizamos el m&eacute;todo <code>measureText()</code> para calcular el tama&ntilde;o de fuente  para que el texto escogido quepa en el <code>&lt;canvas&gt;</code></p>
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="120" id="lienzo">Su navegador no soporta canvas :( </canvas>
<form>
<div id="form">
<select id="citas">
		...
		var ctx = canvas.getContext("2d");
			if (ctx) {
				...
				while( anchuraTexto > canvas.width-20 ){
					// reducimos el tama&ntilde;o del texto con 1 px
				tamanoTexto--;	
				ctx.font = tamanoTexto+"px Georgia";	
...
<button type="button" class="tiny" id="boton">Enviar!</button>
         ...
         <p class="text-center"><em class="gem">Escoge tu cita favorita y haz clic en "Enviar!"</em></p>
         </div>
        </article>
</div>     
