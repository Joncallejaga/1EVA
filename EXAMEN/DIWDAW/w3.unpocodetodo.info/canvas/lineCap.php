...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dar formato a las puntas de l&iacute;nea el canvas de HTML5 con lineCap." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, lineCap, butt, round ,square, lineCap, line caps"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Puntas de l&iacute;nea (lineCap)" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/lineCap.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dar formato a las puntas de l&iacute;nea el canvas de HTML5 con lineCap." /> 
  
  <title>Puntas de l&iacute;nea (lineCap)</title>
  ...
  <link rel="canonical" href="lineCap.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="lineCap.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="lineCap">
<h2 class="page_title">Puntas de l&iacute;nea (lineCap)</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Puntas de l&iacute;nea (lineCap)&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineCap.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineCap.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FlineCap.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para dibujar lineas en el <code>&lt;canvas&gt;</code>, adem&aacute;s de los metodos que ya hemos visto, podemos utilizar la propiedad <code>lineCap</code> para dar formato a las puntas de l&iacute;nea.
Los valores que puede tomar  <code>lineCap</code> son <code>"butt"</code> <em class="gem">(tope)</em>, <code>"round"</code> <em class="gem">(redondeado)</em> y <code>"square"</code> <em class="gem">(cuadrado)</em></p>
...
<p>Veamos un ejemplo. A continuaci&oacute;n dibujamos 3 l&iacute;neas del mismo tama&ntilde;o, cada una con otro tipo de punta. 
La l&iacute;nea de arriba tiene una punta de l&iacute;nea normal <code>(ctx.lineCap = "butt";)</code>, la del medio tiene una punta de l&iacute;nea 
redondeada <code>(ctx.lineCap = "round";)</code>, mientras que la de abajo tiene una punta de l&iacute;nea cuadrada <code>(ctx.lineCap = "square";)</code>.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="juntas" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>	
        </article>
</div>  
	...
	var canvas = document.getElementById("juntas");
		...
		var ctx = canvas.getContext("2d");
			if (ctx) {
				ctx.lineWidth = 25;
				ctx.strokeStyle = "#00f";
				// la l&iacute;nea de arriba
				ctx.beginPath();
				ctx.lineCap = "butt";
				ctx.moveTo(25, 50);
				ctx.lineTo(225, 50);
				ctx.stroke();
				// la l&iacute;nea del medio
				ctx.beginPath();
				ctx.lineCap = "round";
				ctx.moveTo(25, 100);
				ctx.lineTo(225, 100);
				ctx.stroke();
				// la l&iacute;nea de abajo
				ctx.beginPath();
				ctx.lineCap = "square";
				ctx.moveTo(25, 150);
				ctx.lineTo(225, 150);
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="juntas" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>     
