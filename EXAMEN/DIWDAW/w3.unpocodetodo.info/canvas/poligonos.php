...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un p&oacute;ligono regular en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, pol&iacute;gonos, poligonos regulares,galer&iacute;a de pol&iacute;gonos regulares, dibujar un hexagono, circulo, circulos, circunferencia, radianes, for loop, bucle for, fillStyle, beginPath(), lineTo(), fill(), closePath(), circunferencia, radio, radianes,triangulo equilatero, cuadrado, pentagono, hexagono, heptagono, octagono, eneagono, decagono, endecagono, dodecagono, tridecagono, tetradecagono"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Pol&iacute;gonos regulares" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/poligonos.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un p&oacute;ligono regular en el canvas de HTML5." /> 
  ...
  <link rel="canonical" href="poligonos.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="poligonos.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="poligonos.php#top">&#8682;</a></b>
</div>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Pol&iacute;gonos regulares&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fpoligonos.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fpoligonos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fpoligonos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
Los pol&iacute;gonos regulares se pueden inscribir perfectamente en una circunferencia.</p>
<p>Para dibujar un pol&iacute;gono regular, ( o cualquier otro trazado ) necesitamos definir algunas propiedades del contexto</p>
<blockquote><p>ctx.fillStyle = "#6ab150";<br>
  ctx.strokeStyle = "black";<br>
  ctx.lineWidth = 3;</p></blockquote>
<p>Todos los pol&iacute;gonos regulares se pueden inscribir en una circunferencia. Por lo tanto definimos la posici&oacute;n del centro ( <code>X,Y</code> ) y el radio  ( <code>R</code> ) de este c&iacute;rculo:</p>
<blockquote><p>var X = canvas.width/2;<br>
  var Y = canvas.height / 2;<br>
  var R = 100;</p></blockquote>
<p>Y lo m&aacute;s importante: definimos el n&uacute;mero de lados ( <code>L</code> ) del pol&iacute;gono.</p>
<blockquote><p>var L = 5;</p></blockquote>
<p>Todos los &aacute;ngulos centrales de un pol&iacute;gono regular son iguales entre si ( <code>72&deg;</code> ) y su valor en radianes ( <code>rad</code> ) puede obtenerse a partir del n&uacute;mero de lados <strong>L</strong> del pol&iacute;gono:</p>
<blockquote><p>var rad= 2*Math.PI / L</p></blockquote>
<p>Para dibujar el trazado utilizamos un bucle for ( <code>for loop</code> ), donde con cada paso del bucle dibujamos un lado del pol&iacute;gono.</p>
...
<p>No se olvide que para calcular las coordenadas de un punto en la circunferencia de un c&iacute;rculo utilizamos las siguientes f&oacute;rmulas:<br />
<code>var x = centroX + radio * Math.cos(a);<br />
var y = centroY + radio * Math.sin(a);</code></p></p>
	...
	var canvas = document.getElementById("lienzo");
		...
		var contexto = canvas.getContext("2d");
			if (contexto) {
					...
					var R = 100;
					// el n&uacute;mero de lados del pol&iacute;gono
					var L = 5;
					// si L == 5 el &aacute;ngulo es de 2&pi;/6 o sea 60&deg;
					var rad = (2*Math.PI)/L;	
					// dibuja el trazado 
					contexto.beginPath();
							for( var i = 0; i < L; i++ ){
...
<p>El pent&aacute;gono ha salido muy bien, pero no estar&iacute;a nada mal poder girarlo alrededor de su centro. Para esto tenemos que utilizar otros dos m&eacute;todos del contexto: 
  <em class="gem"><a class="link_to" href="transformaciones.php#h4_1">translate()</a></em> y <em class="gem"><a class="link_to" href="transformaciones.php#h4_2">rotate()</a></em>.</canvas>
  <p>El m&eacute;todo <code>rotate()</code> gira los trazados alrededor del origen del contexto ( <code>x=0, y=0</code> ). Para girar un trazado alrededor de su centro:<br />
- lo construimos en el origen ( <code>x=0, y=0</code> )<br />
- lo giramos con <code>rotate()</code><br />
- lo trasladamos con <code>translate()</code> en el punto deseado, por ejemplo en el centro del <code>&lt;canvas&gt;</code>.</p>
...
var canvas1 = document.getElementById("lienzo1");
		...
		var ctx = canvas1.getContext("2d");
			if (ctx) {
					...
					var L = 5;
					// si L == 6 el &aacute;ngulo es de 2&pi;/6 o sea 60&deg;
					var rad = (2*Math.PI)/L;
...
<p>Solo con cambiar el valor del n&uacute;mero de lados del trazado ( la variable <strong>L</strong> ) podemos conseguir cualquiera de estos pol&iacute;gonos regulares.</p>
<div class="row">
<div  class="large-12 text-center">
 ...
 <canvas class="poligonos" id="Canvas13" width="120" height="150">Su navegador no soporta canvas :( </canvas>
 <canvas class="poligonos" id="Canvas14" width="120" height="150">Su navegador no soporta canvas :( </canvas>
...
<p><em class="gem">
- C&oacute;mo dibujar <a class="link_to" href="arc.php">arcos y c&iacute;rculos</a><br>- Vea la <a class="link_to" target="_blank" href="chuleta.php">chuleta</a> de canvas.<br>
...
var canvas1 = document.getElementById("lienzo1");
	 ...
	 var lienzo = document.getElementById("Canvas"+i);
		...
		var ctx = lienzo.getContext("2d");
			if (ctx) {
				dibujaUnPoligono(lienzo,ctx,i);
				}
			}
		}

	function dibujaUnPoligono(lienzo,ctx,L){
	var 	poligonosRy =[
		"T. equil\341tero",
		"Cuadrado",
		"Pent\341gono",
		...
		"Tetradec\341gono"];	
            ...
            ctx.fillStyle = "#333";
            ctx.fillText(poligonosRy[j-3],0,50);
												ctx.fillText("L = "+j,0,65);
