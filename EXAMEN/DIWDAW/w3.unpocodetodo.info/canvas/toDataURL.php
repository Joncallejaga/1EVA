...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como generar c&oacute;digo data:uri con toDataURL() en el canvas de HTML5. Im&aacute;genes data:uri." />
  ...
  <meta property="og:title" content="Crear data:uri desde canvas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/toDataURL.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como generar c&oacute;digo data:uri con toDataURL() en el canvas de HTML5. Im&aacute;genes data:uri." /> 
  
  <title>Crear data:uri desde canvas</title>
  ...
  <link rel="canonical" href="toDataURL.php"> 
 
  <style>.canvastext p{margin-bottom:0;}.canvastext img{border:none;}
</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="toDataURL.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="toDataURL.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="toDataURL">
<h2 class="page_title">Crear data:uri desde canvas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Crear data:uri desde canvas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtoDataURL.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtoDataURL.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtoDataURL.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El m&eacute;todo <code>toDataURL(tipo)</code> convierte el contenido del <code>&lt;canvas&gt;</code> en una imagen <code>data:uri</code>. El par&aacute;metro entre par&eacute;ntesis indica el tipo de imagen y puede tomar uno de los siguientes valores:</p>
<blockquote><ul class="no-bullet">
<li>image/gif (imagen GIF)</li>
<li>image/jpeg (imagen JPEG)</li>
<li>image/png (imagen Portable Network Graphics)</li>
<li>image/svg+xml (imagen vectorial SVG)</li> 
<li>image/x-icon (imagen favorite icon)</li><!--http://stackoverflow.com/questions/6964144/dynamically-generated-favicon--> 
</ul></blockquote>
<p>Si no especificamos ning&uacute;n tipo de imagen, el m&eacute;todo <code>toDataURL()</code> toma <code>"image/png"</code> por defecto.<br>
A continuaci&oacute;n queremos dibujar en el <code>&lt;canvas&gt;</code> la imagen de un icono para enlaces. Es importante que la imagen sea muy peque&ntilde;a.<br>
Una vez dibujada la imagen podemos convertirla en data:uri utilizando el m&eacute;todo <code>toDataURL()</code>:
<blockquote><pre>var url = canvas.toDataURL();</pre></blockquote>
<p>Tambi&eacute;n sacamos el c&oacute;digo de <code>data:uri</code> en pantalla, de donde lo podemos copiar para utilizarlo luego en el c&oacute;digo:</p>
<blockquote><pre>document.getElementById("output").innerHTML = url;</pre></blockquote>
<p>Asimismo asignamos el <code>data:uri</code> resultante como valor del atributo <code>src</code> de una imagen:</p>
<blockquote><pre>document.getElementById("img").src = url;</pre></blockquote>

<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
<p>canvas: </p>
<canvas width="11" height="12" id="lienzo">Su navegador no soporta canvas :( </canvas>
<div id="output"></div>
<p>imagen: </p>
<img alt="data:uri test" id="img" width="11" height="12" src="http://w3.unpocodetodo.info/canvas/noImg" /></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
        <article>
        <div class="canvastext" style="margin-left:0;">
	
<p>canvas: </p>
<canvas width="11" height="12" id="lienzo">Su navegador no soporta canvas :( </canvas>
<div id="output"></div>
<p>imagen: </p>
<img alt="data:uri test" id="img" width="11" height="12" src="http://w3.unpocodetodo.info/canvas/noImg" />        </div>
        </article>
</div>
