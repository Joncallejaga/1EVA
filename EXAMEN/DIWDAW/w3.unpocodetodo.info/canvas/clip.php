...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear regiones de recorte (clipping region) con clip() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, clip(), regiones de recorte, clipping region, drawImage, Google chrome anti-alias"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Regiones de recorte" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/clip.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear regiones de recorte (clipping region) con clip() en el canvas de HTML5." /> 
  
  <title>Regiones de recorte</title>
  ...
  <link rel="canonical" href="clip.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="clip.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="clip">
<h2 class="page_title">Regiones de recorte <small>(clipping region)</small></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Regiones de recorte&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fclip.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El <code>&lt;canvas&gt;</code> de <code>HTML5</code> nos da la posibilidad de crear regiones de recorte ( <em class="gem">clipping regions</em> ), y para esto utilizamos el m&eacute;todo <code>clip()</code>. 
( Hay un cierto parecido entre una regi&oacute;n de recorte en el<code> &lt;canvas&gt;</code> y una m&aacute;scara de Photoshop. )</p>
...
<p>Inicialmente el entero <code>&lt;canvas&gt;</code> es por defecto una regi&oacute;n de recorte. 
Para definir una nueva regi&oacute;n, dibujamos un trazado con la forma y el tama&ntilde;o deseados. Despu&eacute;s llamamos el m&eacute;todo <code>clip()</code> que transformar&aacute; el trazado previamente dibujado en una nueva regi&oacute;n de recorte, 
reemplazando de esta manera, la regi&oacute;n de recorte anterior ( o sea: el <code>&lt;canvas&gt;</code> mismo ).</p>
<p><strong>Importante</strong>: el contexto de <code>&lt;canvas&gt;</code> no acepta m&aacute;s que una sola regi&oacute;<strong></strong>n de recorte. </p>
<p>En el siguiente ejemplo esbozamos un circulo con el radio de 100px y, llamamos el m&eacute;todo <code>clip()</code> para convertirlo en una nueva regi&oacute;n de recorte.</p>
<blockquote><pre>
ctx.arc(125,120,100,0,2*Math.PI);
ctx.clip();
</pre></blockquote>
<p>Despu&eacute;s insertamos una imagen. Lea este capitulo para saber c&oacute;mo utilizar <a class="link_to" target="_blank" href="imagenes.php">im&aacute;genes en el canvas</a></p>
<blockquote><pre>
var img=new Image();
...
<p>La imagen aparece recortada.</p>
</div>
</div><!--<div class="row">-->
...
<div class="large-12 g_panel resultado">
        <article>
		<canvas width="250" height="240" id="lienzo">Su navegador no soporta canvas :( </canvas>        </article>
</div>
<!--<div class="row">
<div class="large-12 columns">

<p>Todo parece funcionar muy bien, pero en <mark>Google Chrome</mark> el borde de nuestra imagen aparece pixelado y muy feo.
Para arreglar este desperfecto, echamos mano de otros dos m&eacute;todos de <code>&lt;canvas&gt;</code>:<br> 
<em class="gem"><a class="link_to" href="/canvas/save-restore.php">save()</a></em> ( <em class="gem">guardar</em> ) y  
<em class="gem"><a class="link_to" href="/canvas/save-restore.php">restore()</a></em> ( <em class="gem">restaurar</em> ).</p>
<h4>Arreglar desperfectos <small>( soluci&oacute;n patosa )</small></h4>
<p>El m&eacute;todo <code>save()</code> guardar&aacute; el estado del contexto de <code>&lt;canvas&gt;</code>, el de antes de definir la nueva regi&oacute;n de recorte. 
El m&eacute;todo <code>restore()</code> restaurar&aacute; este estado, per tal de poder dibujar de nuevo en el <code>&lt;canvas&gt;</code>, como lo habr&iacute;amos hecho al principio. <br>
Despu&eacute;s de restaurar el estado inicial del contexto podemos dibujar un borde ( blanco en este caso ) alrededor de nuestra imagen, que arreglar&aacute; dicho desperfecto.</p>
</div>
</div>
...
<div class="large-12 g_panel resultado">
        <article>
       <canvas width="250" height="240" id="lienzo1">Su navegador no soporta canvas :( </canvas>        </article>
</div>
<p>Y s&iacute;, funciona. Pero, esta no es m&aacute;s que una chapuza, y la verdad es que lo podemos hacer mucho mejor.</p>-->
<div class="row">
<div class="large-12 columns">
<h4>Arreglar desperfectos <small>( con globalCompositeOperation )</small></h4>
<p>Todo parece funcionar muy bien, pero en <mark>Google Chrome</mark> el borde de nuestra imagen aparece pixelado y muy feo.
Para arreglar este desperfecto, en lugar de <code>clip()</code> podemos utilizar la propiedad <code>globalCompositeOperation</code>.
Para saber m&aacute;s acerca de <code>globalCompositeOperation</code> por favor lea el siguiente capitulo acerca de <em class="gem"><a class="link_to" href="globalCompositeOperation.php">combinar trazados</a></em></p>
</div>
</div>
...
<p>Et voila: ahora tenemos un borde perfecto, incluso en Google Chrome.</p>
<div class="large-12 g_panel resultado">
        <article>
       <canvas width="250" height="240" id="lienzo2">Su navegador no soporta canvas :( </canvas>        </article>
</div>          
