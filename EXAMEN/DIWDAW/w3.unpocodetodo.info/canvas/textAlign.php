...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo escribir en el canvas de HTML5; c&oacute;mo alinear el texto horizontalmente con textAlign." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, font, text, escribir,  textAlign"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Alineaci&oacute;n horizontal" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/textAlign.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. C&oacute;mo escribir en el canvas de HTML5; c&oacute;mo alinear el texto horizontalmente con textAlign." /> 
  
  <title>Alineaci&oacute;n horizontal</title>
  ...
  <link rel="canonical" href="textAlign.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="textAlign.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="textAlign.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">Alineaci&oacute;n horizontal</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Alineaci&oacute;n horizontal&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtextAlign.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtextAlign.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FtextAlign.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>textAlign</code> especifica el tipo de alineaci&oacute;n horizontal del texto.
Puede tomar una de las siguientes valores: <code>center</code> ( <em class="gem">centrar texto</em> ), <code>left</code> ( <em class="gem">alinear texto a la izquierda</em>), 
<code>right</code> ( <em class="gem">alinear texto a la derecha</em> ), <code>start</code> y <code>end</code>. <br>
En idiomas como el castellano, con un sistema de escritura de izquierda a derecha, <code>start == left</code>
 y 
<code>end == right</code>, 
mientras que en idiomas con sistemas de escritura de derecha a izquierda, como el hebreo, pasa todo lo contrario: start es lo mismo que right y end es lo mismo que left.</p>
...
<tr>
  ...
  <tr>
    ...
    <td>Especifica el tipo de alineaci&oacute;n horizontal del texto.</td>
    <td>start</td>
  </tr>
  <tr class="old">
    <td>textBaseline</td>
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="200" height="190" id="lienzo">Su navegador no soporta canvas :( </canvas></code></pre>
...
<div class="large-12 g_panel resultado">
        <article>
        <canvas width="200" height="190" id="lienzo">Su navegador no soporta canvas :( </canvas>        <br />
		</article>
</div>
