...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como aplicar sombras en el canvas de HTML5 con rect(), fillRect()y  strokeRect()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, shadowColor, shadowBlur, shadowOffsetX, shadowOffsetY"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Aplicar sombras" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/sombras.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como aplicar sombras en el canvas de HTML5 con rect(), fillRect()y  strokeRect()." /> 
  
  <title>Aplicar sombras</title>
  ...
  <link rel="canonical" href="sombras.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="sombras.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="sombras">
<h2 class="page_title">Aplicar sombras</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Aplicar sombras&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsombras.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsombras.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsombras.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Las sombras pueden ser aplicadas a todos los trazados que dibujamos en el <code>&lt;canvas&gt;</code>.<br>
Hay cuatro propiedades que determinan las caracter&iacute;sticas de las sombras: <code>shadowColor</code> ( el color ), <code>shadowBlur</code> ( el desenfoque ), 
<code>shadowOffsetX</code> ( el desplazamiento horizontal ) y <code>shadowOffsetY</code> ( el desplazamiento vertical ).<br>
Las propiedades <code>shadowOffsetX</code> y <code>shadowOffsetY</code> pueden tomar valores tanto positivas ( la sombra cae hacia la derecha y abajo ) como negativas ( hacia la izquierda y arriba ).
</p>
...
<p><strong>Veamos un ejemplo.</strong> A continuaci&oacute;n aplicamos una sombra tanto a un rect&aacute;ngulo como a un texto.<br />
Para esto establecemos primero el desenfoque:</p>
<blockquote><pre>ctx.shadowBlur=5;</pre></blockquote>
<p>el desplazamiento ( <em class="gem">offset</em> ) en x e y:</p>
<blockquote><pre>ctx.shadowOffsetX=2;
ctx.shadowOffsetY=2;</pre></blockquote>
<p>y el color de la sombra:</p>
<blockquote><pre>ctx.shadowColor=&quot;#333&quot;;</pre></blockquote>
<p>La sombra definida ser&aacute; aplicada a todos los trazados que dibujamos a continuaci&oacute;n. Para que esto no pase podemos utilizar <a class="link_to" target="_blank" href="save-restore.php">los m&eacute;todos save() y restore()</a>.</p>
<p>Antes de definir la sombra guardamos el contexto con <code>save()</code>.</p>
<blockquote><pre>ctx.save();</pre></blockquote>
<p>A continuación van los trazados con sombra ( el cuadrado y el texto ).<br />Antes de dibujar el <mark>texto sin sombra</mark> restablecemos los valores iniciales del contexto con <code>restore()</code>.</p>
<blockquote><pre>ctx.restore();</pre></blockquote>


<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="250" height="230">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="250" height="230">Su navegador no soporta canvas :( </canvas> </article>
</div>


<p><em class="gem">Lea m&aacute;s acerca de c&oacute;mo <a class="link_to" target="_blank" href="text.php">escribir en el canvas</a></em></p>
