...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como cerrar un trazado con closePath() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, closePath(), cerrar un trazado, trazados"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Cerrar un trazado" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/closePath.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como cerrar un trazado con closePath() en el canvas de HTML5." /> 
  
  <title>Cerrar un trazado</title>
  ...
  <link rel="canonical" href="closePath.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="closePath.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="closePath.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="closePath">
<h2 class="page_title">Cerrar un trazado</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Cerrar un trazado&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FclosePath.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FclosePath.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FclosePath.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos dibujar formas geometricas en el <code>&lt;canvas&gt;</code> conectando varias l&iacute;neas en un trazado.
Para cerrar el trazado podemos dibujar una l&iacute;nea que une el el &uacute;ltimo punto con el origen de nuestro trazado, 
o podemos utilizar el m&eacute;todo <code>closePath()</code> (cerrar trazado) y dejar que el <code>HTML5</code> lo haga para nosotros.</p>
...
<tr>
  ...
  <tr class="old">
    ...
    <td>Cierra una l&iacute;nea poligonal.</td>
    <td>&nbsp;</td>
  </tr>    
  <tr class="old">
    <td>stroke()</td>
...
para empezar el trazado y el m&eacute;todo <code>moveTo()</code> para mover el &quot;lapiz&quot; hasta el origen de nuestro trazado. 
Esbozamos dos de los tres lados utilizando el m&eacute;todo <code>lineTo()</code>, y cerramos el trazado utilizando el 
m&eacute;todo <code>closePath()</code>. Al final hay que utilizar <code>stroke()</code> para marcar el trazado.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="juntas" width="250" height="240">Su navegador no soporta canvas :( </canvas></code></pre>        
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="juntas" width="250" height="240">Su navegador no soporta canvas :( </canvas> </article>
</div>
