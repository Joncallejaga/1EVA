...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Los m&eacute;todos save() y restore()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, save(), restore()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="M&eacute;todos save y restore" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/save-restore.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Los m&eacute;todos save() y restore()." /> 
  
  <title>M&eacute;todos save y restore</title>
  ...
  <link rel="canonical" href="save-restore.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="save-restore.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="save-restore.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">M&eacute;todos save y restore</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=M&eacute;todos save y restore&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsave-restore.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsave-restore.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fsave-restore.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El contexto del <code>&lt;canvas&gt;</code> almacena lo que llamamos en ingles <em class="gem">"the drawing state"</em> y que podemos traducir como <mark>el estado del contexto</mark>.</p>
...
<p>El estado del contexto puede ser manipulado a trav&eacute;s de <code>JavaScript</code>, y recoge los valores actuales de <code>lineWidth</code>, <code>strokeStyle</code>, <code>fillStyle</code>, <code>lineCaps</code>, etc…
Tambi&eacute;n recoge los valores de las entradas de la matriz actual de transformaci&oacute;n. <br>
Estos valores pueden ser guardados con el m&eacute;todo <code>save()</code>, y pueden ser recuperados con el m&eacute;todo <code>restore()</code>.<br>
Al guardar un estado, este se almacena encima de los anteriores en una pila y cuando llamamos el m&eacute;todo <code>restore()</code>, este recupera el &uacute;ltimo estado guardado, lo quita de la pila y lo transforma en el actual estado del contexto.<br>
En otras palabras: el &uacute;ltimo estado guardado es el primer recuperado. Veamos un ejemplo.</p>
...
var canvas = document.getElementById("lienzo");
 if (canvas && canvas.getContext) {
   ...
   if (ctx) {
     ...
     ctx.save() // guarda el 1&deg; estado

     ctx.fillStyle = "#999";
     ctx.fillRect(15, 15, X - 30, Y - 30);
     ctx.save(); // guarda el 2&deg; estado

     ctx.fillStyle = "#ccc";
     ctx.fillRect(30, 30, X - 60, Y - 60);
     ctx.save(); // guarda el 3&deg; estado

     ctx.fillStyle = "#eee";
     ctx.fillRect(45, 45, X - 90, Y - 90);

     ctx.restore(); // recupera el 3&deg; estado
     ctx.fillRect(60, 60, X - 120, Y - 120);

     ctx.restore(); // recupera el 2&deg; estado
     ctx.fillRect(75, 75, X - 150, Y - 150);

     ctx.restore(); // recupera el 1&deg; estado
