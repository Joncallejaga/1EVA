...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar c&iacute;rculos y segmentos circulares en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, arco, arcos, circulo, c&iacute;rculo, c&iacute;rculos, circulo, circulos, segmentos circulares, arc(), lineWidth, strokeStyle, fillStyle, beginPath(), arcTo(),fill(), stroke(), circumferencia, radio, radianes"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Arcos y c&iacute;rculos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/arc.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar c&iacute;rculos y segmentos circulares en el canvas de HTML5." /> 
  
  <title>Arcos y c&iacute;rculos</title>
  ...
  <link rel="canonical" href="arc.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="arc.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="arc">
<h2 class="page_title">Arcos y c&iacute;rculos</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Arcos y c&iacute;rculos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Farc.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Farc.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Farc.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para dibujar c&iacute;rculos o segmentos circulares, utilizamos una serie de m&eacute;todos() y propiedades de <code>&lt;canvas&gt;</code>.</p>
...
<tbody>
 ...
 <tr class="old">
  ...
  <tr>
    <td>arc()</td>
    <td>context.arc(x, y, r, ap, af , cR)</td>
    <td>
    Define un segmento circular.<br />
    x y  = coordenadas centro<br />
    r = radio<br />
    ap = &aacute;ngulo de partida en radianes<br />
    af = &aacute;ngulo final en radianes<br />
    cR = <strong>opcional</strong>; sentido contra reloj: true | false
    </td>
    <td>&nbsp;</td>
  </tr>
    <tr>
...
<img src="images/arc.png" alt="Arcos y c&iacute;rculos en el canvas de HTML5" style="float:right;">
<p>En el canvas para trabajar con &aacute;ngulos, utilizamos <mark>radianes</mark>.
Un circulo completo tiene 2&pi; radianes, con lo cual podemos escribir:
<code>360&deg; = 2&pi; rad;</code><br /> o si hablamos JavaScript: <code>2*Math.PI;</code><br />
Para convertir grados sexagesimales a radianes utilizamos la siguiente f&oacute;rmula:<br />
<code>radianes = (&pi; / 180) * grados;</code><br />
lo que traducido a JavaScript es:<br />
<code>var radianes = (Math.PI / 180) * grados;</code></p>
</div>
<h4>Dibujar un arco</h4>
<img src="images/antiClockwise.png" alt="antiClockwise" style="float:left; padding-right:20px;">
<p>Para dibujar un arco utilizamos el m&eacute;todo <code>arc(x, y, r, ap, af, aC)</code>, donde<br />
- <code>x</code> e <code>y</code> son las coordenadas del centro,<br />
- <code>ap</code> es el &aacute;ngulo de partida ( <em class="gem">en radianes</em> ),<br />
- <code>af</code> es el &aacute;ngulo final ( <em class="gem">en radianes</em> ), y<br />
- <code>cR</code> (  <em class="gem">contra reloj</em> ) es la direcci&oacute;n.</p> 
<p>El parametro <code>cR</code> puede tomar dos valores:<br />
- <code>true</code> ( <em class="gem">verdadero, o sea: en sentido contrario al de las agujas del reloj</em> ) y<br />
- <code>false</code> ( <em class="gem">falso, o sea: en el sentido de las agujas del reloj</em> ).</p>
<br style="clear:both;" />
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="arco" width="250" height="150">Su navegador no soporta canvas :( </canvas></code></pre>	
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="arco" width="250" height="150">Su navegador no soporta canvas :( </canvas> </article>
</div>

<h4>Dibujar un c&iacute;rculo</h4>
<p>Para dibujar un c&iacute;rculo hay que trazar un arco de 360&deg; ( 2&pi; radianes ). Para esto utilizamos el m&eacute;todo <code>arc()</code>.</p>
<blockquote><pre>contexto.<span class="str">arc</span>(X,Y,r,0,2*Math.PI);</pre></blockquote>
<p>Donde:<br /> 
- <code>X</code> e <code>Y</code> son las coordenadas del centro,<br />
- <code>r</code> es el radio del circulo,<br />
- el &aacute;ngulo de partida <code>ap = 0</code> y<br />
- el &aacute;ngulo final (en radianes) <code>af = 2*Math.PI</code> ( o sea: 360º )</p>
<div class="large-12 g_panel html">
        <article>								
...
<div class="large-12">
<h4>M&aacute;s geometr&iacute;a</h4>
<p>Para calcular las coordenadas de un punto en la circunferencia de un c&iacute;rculo utilizamos las siguientes f&oacute;rmulas:<br />
<code>var x = centroX + r * Math.cos(a);<br />
var y = centroY + r * Math.sin(a);</code><br />

Donde <code>centroX</code> y <code>centroY</code> son las coordenadas del centro del c&iacute;rculo;<br />
<code>r</code> es el radio del c&iacute;rculo;<br />
y <code>a</code> es el &aacute;ngulo entre el punto <code>0&pi;</code> y este punto.
</p>
<h4>Dibujar un sector circular</h4>
<p>A continuaci&oacute;n vamos a dibujar un sector circular de 60&deg;, donde el &aacute;ngulo de partida <code>ap = 60&deg;</code> y el &aacute;ngulo final <code>af = 120&deg;</code>.<br>
  Necesitamos definir algunas variables:<br>
  El centro del circulo (X,Y) cuyo sector vamos a dibujar, y el radio R de este.</p>
  <blockquote><p>
  var X = canvas.width/2;<br>
  var Y = 30;<br>
  var R = 140;
  </p></blockquote>
  <p>El &aacute;ngulo de partida ap y el &aacute;ngulo final af</p>
  <blockquote><p>
  var ap = (Math.PI / 180) * 60;<br>
  var af = (Math.PI / 180) * 120;
  </p></blockquote>
  <p>Las coordenadas del punto de partida en la circunferencia</p>
  <blockquote><p>
  var Xap = X+R * Math.cos(ap);<br>
  var Yap = Y+R * Math.sin(ap);
  </p></blockquote>
  
  <p>Tambi&eacute;n hay que definir el color de relleno <code>fillStyle</code> y el color del borde <code>strokeStyle</code>.
  Veamos el c&oacute;digo.</p>
</div>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="sectorCircular" width="250" height="200">Su navegador no soporta canvas :( </canvas></code></pre>	        
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
				...
				if (canvas && canvas.getContext) {
					...
					if (ctx) {
						...
						var Y = 30;
						var R = 140;
						// El &aacute;ngulo de partida ap y el &aacute;ngulo final af
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="sectorCircular" width="250" height="200">Su navegador no soporta canvas :( </canvas> </article>
</div>
