...
<head>
  ...
  <meta name="description" content="En canvas HTML5 utilizamos la propiedad globalCompositeOperation para combinar dos im&aacute;genes " />
  <meta name="keywords" content="canvas, HTML5, globalCompositeOperation,modos de fusi&oacute;n, blending modes,  multiply, screen, overlay, darken, lighten, color-dodge, color-burn, hard-light, soft-light, difference, exclusion, hue, saturation, color, luminosity"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Modos de fusi&oacute;n" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/canvas-blending.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="En canvas HTML5 utilizamos la propiedad globalCompositeOperation para combinar dos im&aacute;genes " /> 
  
  <title>Modos de fusi&oacute;n</title>
  ...
  <link rel="canonical" href="canvas-blending.php"> 
 
  <style>.large-12.text-center{ margin-bottom:30px;}
.demo:after, .demo:before{ content:''; display:block;}
.demo:after{ clear:both;}
#lienzo{display:block; margin:0 auto;}

p.center{ text-align:center; font-style: italic; font-family: serif; margin-bottom:0;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="canvas-blending.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="canvas-blending.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="canvas-blending">
<h2 class="page_title">Modos de fusi&oacute;n</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Modos de fusi&oacute;n&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fcanvas-blending.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fcanvas-blending.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fcanvas-blending.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><strong>Nota</strong>: <em class="gem">Los los modos de fusi&oacute;n en <code>&lt;canvas&gt;</code> son una tecnolog&iacute;a experimental. Por favor consulte el <a class="link_to" target="_blank" href="http://caniuse.com/#feat=canvas-blending">soporte en los navegadores</a> para esta propiedad.</em></p>
<p>En im&aacute;genes digitales los modos de fusi&oacute;n ( <em class="gem">blend modes</em> ) son utilizados para determinar como se fusionan dos capas. Para cada pixel, el color del elemento ( el color de origen o <em class="gem">source color</em> ) se combina o se fusiona ( <em class="gem">is blended</em> ) con el color del fondo ( <em class="gem">the backdrop</em> ) para crear un nuevo color; y como que el color de cada pixel tiene un valor num&eacute;rico, hay un gran n&uacute;mero de posibles combinaciones.<br />El modo de fusi&oacute;n por defecto en la mayor&iacute;a de aplicaciones, simplemente esconde la capa inferior ( <em class="gem">de destino</em> ). </p>
...
<div class="large-12 text-center">
  <img src="../css3/images/photoshop-bm.png" width="661" height="547" alt="Phptoshop blending options" /> </div>
  
<h4></h4>
<p><strong>En CSS3</strong> podemos utilizar <a class="link_to" target="_blank" href="../css3/blending-modes.php">background-blend-mode</a> para combinar dos im&aacute;genes de fondo, o una imagen y un color.</p>

<h4>Modos de fusi&oacute;n en canvas<br /><small>Un ejemplo de exclusi&oacute;n</small></h4>
<p>En <code>&lt;canvas&gt;</code> utilizamos la propiedad <a class="link_to" target="_blank" href="globalCompositeOperation.php">globalCompositeOperation</a> con este prop&oacute;sito.
Por coherencia los valores que puede tomar <code>globalCompositeOperation</code> son iguales a las que utilizamos en CSS:</p>
<blockquote><pre>
"color", "color-burn", "color-dodge", "darken", "difference", "exclusion", "hard-light", "hue", "lighten", "luminosity", "multiply", "overlay", "saturation", "screen", "soft-light"</pre></blockquote>

<p>En el siguiente ejemplo utilizamos el modo de fusi&oacute;n de tipo "<code>exclusion</code>".</p>
<blockquote><pre>context.globalCompositeOperation = "exclusion";</pre></blockquote>
<p>El modo de fusi&oacute;n "<code>exclusion</code>" resta el valor del color m&aacute;s oscuro del valor del color m&aacute;s claro. Por ejemplo una fusi&oacute;n con una capa blanca produce el negativo de la imagen. Y una fusi&oacute;n con una capa negra deja la imagen sin cambiar.</p>
<p>Para que haya fusi&oacute;n necesitamos dos im&aacute;genes – l&oacute;gico.
La primera imagen es un JPEG que dibujamos en el canvas utilizando el m&eacute;todo <code>drawImage()</code></p>
<blockquote><pre>
<span class="com">// crea una nueva imagen</span>
var img=new Image(); 
<span class="com">// establece el valor del atributo src de la nueva imagen</span>
img.src = "images/enfeinada240.jpg";
<span class="com">// cuando la imagen se ha cargado</span>
img.onload = function() {
<span class="com">// dibuja la imagen en el canvas</span>
context.<span class="str">drawImage(this, 0, 0)</span>;
}</pre></blockquote>
<p>La segunda imagen es un rect&aacute;ngulo que rellenamos con un gradiente lineal:</p>

<blockquote><pre><span class="com">// define el tect&aacute;ngulo a dibujar</span>
context.rect(0, 0, canvas.width, canvas.height);
<span class="com">// crea un gradiente lineal vertical</span>
var grd = context.createLinearGradient(0, 0, 0, canvas.height);
grd.addColorStop(0,"#F06");
grd.addColorStop(1,"black");
<span class="com">// define el relleno del rect&aacute;ngulo</span>
context.fillStyle = grd;
<span class="com">// dibuja el rect&aacute;ngulo</span>
context.fill();</pre></blockquote>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<canvas id="lienzo" width="240" height="240">Por favor... Actualiza tu navegador.</canvas></code></pre>
        </article>
</div> 
	...
	var canvas = document.getElementById("lienzo");	
				if (canvas && canvas.getContext) {
					...
					if (context) {console.log("habemus context")
					   // utilizamos el modo de fusi&oacute;n de tipo "exclusion"
...
<canvas id="lienzo" width="240" height="240">Por favor... Actualiza tu navegador.</canvas>        </article>
</div>         
      

<p>Como ya hemos dicho el <code>&lt;canvas&gt;</code> cuenta con varios m&eacute;todos de fusi&oacute;n, tantos como en el CSS.</p>
<blockquote><pre>
"color", "color-burn", "color-dodge", "darken", "difference", "exclusion", "hard-light", "hue", "lighten", "luminosity", "multiply", "overlay", "saturation", "screen", "soft-light"</pre></blockquote>

<p>Veamos como quedan.</p>
...
<div class="large-12 g_panel js">
        <article>								
		<pre><code class="language-javascript">var body = document.querySelector(".demo")
