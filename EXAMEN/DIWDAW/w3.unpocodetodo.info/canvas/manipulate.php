...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Manipular im&aacute;genes. Como podemos dibujar una imagen sencilla partiendo desde cero en el canvas de HTML5 con data y createImageData()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, data, createImageData(), putImageData()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Manipular im&aacute;genes" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/manipulate.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Manipular im&aacute;genes. Como podemos dibujar una imagen sencilla partiendo desde cero en el canvas de HTML5 con data y createImageData()." /> 
  
  <title>Manipular im&aacute;genes</title>
  ...
  <link rel="canonical" href="manipulate.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="manipulate.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="manipulate.php#top">&#8682;</a></b>
</div>
...
 <div class="large-12 g_panel"><article><section id="manipulate"><h2 class="page_title">Manipular im&aacute;genes</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Manipular im&aacute;genes&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fmanipulate.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fmanipulate.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fmanipulate.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El <code>&lt;canvas&gt;</code> nos permite modificar, uno por uno, los p&iacute;xeles de una imagen.Para esto tenemos a nuestra disposici&oacute;n tres propiedades y tres m&eacute;todos() de <code>&lt;canvas&gt;</code><br><strong>Importante</strong>: si queremos experimentar manipulando im&aacute;genes en el <code>&lt;canvas&gt;</code> tenemos que hacerlo en un sitio web de verdad, como por ejemplo <em class="gem">locahost</em>.</p><div class="large-12"><!--id="chuleta"--><table class="cheatsheet"><thead><tr>    <th>&nbsp;</th>    <th>JavaScript</th>    <th>Descripci&oacute;n</th>    <th>Defecto</th>  </tr> </thead> <tbody>     <tr>      <td>width</td>      <td>imgData.width</td>      <td>Devuelve el ancho del objeto ImageData, en p&iacute;xeles</td>      <td>&nbsp;</td>    </tr>    <tr>      <td>height</td>      <td>imgData.height</td>      <td>Devuelve la altura del objeto ImageData, en p&iacute;xeles</td>      <td>&nbsp;</td>    </tr>    <tr>      <td>data</td>      <td>imageData.data</td>      <td>Devuelve un objeto conteniendo todos los datos del objeto ImageData.      <!--Returns an object that contains image data of a specified ImageData object--></td>      <td>&nbsp;</td>    </tr>    <tr>      <td>createImageData()</td>      <td>context.createImageData(ancho, alto);</td>      <td>Crea un nuevo objeto ImageData en blanco. Toma dos argumentos: la anchura y la altura del objeto creado      <!--Los valores de los p&iacute;xeles del nuevo objeto son negro transparente por defecto.--></td>      <td>&nbsp;</td>    </tr>        <tr>      <td>createImageData()</td>      <td>context.createImageData(imgData);</td>      <td>Crea un nuevo objeto ImageData con las mismas dimensiones que el objeto especificado por el argumanto imgData.      <!--Los valores de los p&iacute;xeles del nuevo objeto son negro transparente por defecto.--></td>      <td>&nbsp;</td>    </tr>    <tr>      <td>getImageData()</td>      <td>context.getImageData ( x, y, ancho, alto );</td>      <td>Devuelve un objeto ImageData que copia los datos de los p&iacute;xeles del rect&aacute;ngulo especificado.      <!--Returns an ImageData object that copies the pixel data for the specified rectangle on a canvas--></td>      <td>&nbsp;</td>    </tr>    <tr>      <td>putImageData()</td>      <td>context.putImageData( imgData, x, y, <mark title="opcional">[dirtyX, dirtyY, dirtyWidth, dirtyHeight]</mark> );</td>      <td>Pone los datos de la imagen (de un objeto ImageData especificado) de nuevo en el canvas      <!--Puts the image data (from a specified ImageData object) back onto the canvas--></td>      <td>&nbsp;</td>    </tr>  </tbody></table></div><p><em class="gem">Vea <a class="link_to" target="_blank" href="chuleta.php">la chuleta</a> con las propiedades y metodos() de canvas.</em></p><div class="row"><div  class="large-12 columns"><h4 id="h4_0">Un poco de teor&iacute;a</h4><img src="images/pixelManipulation.png" width="250" height="150" alt="4 bytes pixels" style="float:right;"><p>Los p&iacute;xeles de una imagen "en crudo" tienen una "anchura" de 4 bytes, uno por cada componente R G B A. ( <em class="gem">Red (rojo), Green (verde), Blue (azul) y Alpha (transparencia)</em> ).   Accediendo uno por uno los pixeles de una imagen podemos modificar estos componentes de color, y por tanto manipular el aspecto de las im&aacute;genes en el <code>&lt;canvas&gt;</code>.<br><strong>Ojo:</strong> por razones de seguridad la imagen manipulada y el <code>&lt;script&gt;</code> que la manipula tienen que provenir de la misma p&aacute;gina web. De otra manera el acceso al <code>&lt;script&gt;</code> ser&aacute; denegado y el navegador levantar&aacute; una excepci&oacute;n de seguridad.</p></div></div><!--<div class="row">--><div class="row"><div  class="large-12 columns"><h4 id="h4_1">Un ejemplo f&aacute;cil</h4><p>A continuaci&oacute;n dibujamos un cuadrado utilizando el m&eacute;todo <code>createImageData()</code>. Ya lo se, ser&iacute;a mucho m&aacute;s f&aacute;cil dibujarlo con <code>fillRect()</code>, pero es solo para demonstrar como podemos dibujar una imagen sencilla partiendo pr&aacute;cticamente desde cero.</p><ul class="no-bullet">  <li>1. El m&eacute;todo <code>createImageData(anchura , altura)</code> crea un nuevo objeto <code>ImageData</code> en blanco, de anchura y altura dadas.</li>  <li>2. En el siguiente paso iremos de pixel en pixel modificando uno por uno el valor de los componentes RGBA.<br>  Como ya hemos visto cada pixel tiene una "anchura" de 4 bytes, donde el primer byte representa el rojo, el segundo representa el verde, el tercero el azul y el cuarto es el componente alpha o el grado de transparencia.<br>  Siendo bytes pueden tomar valores entre 0 y 255.<br>  En el siguiente ejemplo manipulamos cada pixel para que:<br>  <ul style="margin-left:10%">  <li>el rojo = 255; (100%)</li>  <li>el verde = 0;(ausente)</li>  <li>el azul = 0; (ausente)</li>  <li>alpha = 255; (totalmente opaco)</li>  </ul>  </li>  <li>3. Despu&eacute;s de manipular los pixeles volvemos a colocar la imagen en el <code>&lt;canvas&gt; </code>con <code>putImageData()</code>.<br>  El m&eacute;todo <code>putImageData()</code> toma ( en este caso ) tres argumentos: la imagen manipulada y las coordenadas x e y de donde poner la imagen en el <code>&lt;canvas&gt;</code></li>  </ul></div></div><!--<div class="row">--><div class="large-12 g_panel html">        <article>										<pre><code class="language-markup"><canvas width="250" height="120" id="lienzo">Su navegador no soporta canvas :( </canvas></code></pre>        </article></div>  <div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">		var canvas = document.getElementById("lienzo");				if (canvas && canvas.getContext) {				var ctx = canvas.getContext("2d");				if (ctx) {					// 1. crea un objeto ImageData en blanco;					var imgData=ctx.createImageData(100,100);					// 2. para cada pixel modifica el valor de los componentes RGBA;					for (var i = 0; i < imgData.data.length; i+= 4)							{							imgData.data[i+0]=255;	// rojo = 100%;							imgData.data[i+1]=0;	// verde - ausente;							imgData.data[i+2]=0;	// azul - ausente;							imgData.data[i+3]=255;	// alpha - opaco;							}					// 3. coloca la nueva imagen en el canvas;							ctx.putImageData(imgData,75,10);				}		}</code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>		<canvas width="250" height="120" id="lienzo">Su navegador no soporta canvas :( </canvas>        </article></div><h4>ImageData.width e ImageData.heught</h4><p>En el ejemplo anterior hemos utilizado la propiedad <code>data</code> del objeto <a target="_blank" class="link_to" href="https://developer.mozilla.org/es/docs/Web/API/ImageData"> ImageData</a>  que representa un array unidimensional que contiene los datos <code>rgba</code> de cada pixel. La longitud de este array es igual al n&uacute;mero de pixeles multiplicado por 4. ( Ya hemos visto que cada pixel tiene una "anchura" de 4 bytes. )</p><p>Otra manera de hacer lo mismo es utilizando las propiedades <code>width</code> ( <em class="gem">anchura</em> ) y <code>height</code> ( <em class="gem">altura</em> ) del objeto <code>ImageData</code>.</p><p>Si en el ejemplo anterior hemos utilizado un solo bucle for, ahora necesitamos utilizar dos bucles for anidados: uno para las coordenadas en <code>x</code> y otro para las coordenadas en <code>y</code> de cada pixel.</p><blockquote><pre>for (var y = 0; y &lt; imgData.height; y ++) { <span class = "com">//imgData.height = 250</span>     for (var x = 0; x &lt; imgData.width; x ++) { <span class = "com">//imgData.width = 250</span>        <span class = "com">// aqu&iacute; va el c&oacute;digo</span>     }}</pre></blockquote><p>La f&oacute;rmula para encontrar el &iacute;ndex de los datos en el array <code>ImageData.data</code> es:</p><blockquote><pre>var i = (y*imgData.width + x)*4;</pre></blockquote><p>Todo lo dem&aacute;s queda igual que antes:</p><blockquote><pre>for (var y = 0; y &lt; imgData.height; y ++) { <span class = "com">//imgData.height = 250</span>   for (var x = 0; x &lt; imgData.width; x ++) { <span class = "com">//imgData.width = 250</span>       <span class="str">var i = (y*imgData.width + x)*4;</span>      imgData.data[<span class="str">i</span> + 0] = 255; <span class = "com">// rojo = 100%;</span>    imgData.data[<span class="str">i</span> + 1] = 0; <span class = "com">// verde - ausente;</span>    imgData.data[<span class="str">i</span> + 2] = 0; <span class = "com">// azul - ausente;</span>    imgData.data[<span class="str">i</span> + 3] = 255; <span class = "com">// alpha - opaco;</span>  }  }ctx.putImageData(imgData,75,75);</pre></blockquote><p>Vea el c&oacute;digo en <a href="http://codepen.io">CodePen</a></p><p data-height="369" data-theme-id="11360" data-slug-hash="c9f23907760b729f7e11a2d3d6ab4512" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="imgData.width, imgData.heigh*" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/c9f23907760b729f7e11a2d3d6ab4512/">imgData.width, imgData.heigh*</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="imagenes.php">Trabajar con im&aacute;genes</a></em></li><li>- <em class="gem"><a class="link_to" href="imagen-reflejada.php">Im&aacute;genes reflejadas</a></em></li><li>- <em class="gem">Manipular im&aacute;genes</em></li><li>- <em class="gem"><a class="link_to" href="negativo.php">El negativo de una imagen</a></em></li><li>- <em class="gem"><a class="link_to" href="blancoynegro.php">Im&aacute;genes en blanco y negro</a></em></li><li>- <em class="gem"><a class="link_to" href="sepia.php">Im&aacute;genes en sepia</a></em></li><li>- <em class="gem"><a class="link_to" href="canvas-blending.php">Modos de fusi&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="data_uri.php">Que son los data:uri</a></em></li><li>- <em class="gem"><a class="link_to" href="toDataURL.php">Crear data:uri desde canvas</a></em></li><li>- <em class="gem"><a class="link_to" href="faviconos-js.php">Faviconos con canvas</a></em></li></ul></article></div></div>
