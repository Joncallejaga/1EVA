...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear gradientes radiales con createRadialGradient() y addColorStop() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, relleno, gradiente radial, trazados, createRadialGradient(), addColorStop()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Gradiente radial" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/createRadialGradient.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como crear gradientes radiales con createRadialGradient() y addColorStop() en el canvas de HTML5." /> 
  
  <title>Gradiente radial</title>
  ...
  <link rel="canonical" href="createRadialGradient.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="createRadialGradient.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="createRadialGradient.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="createRadialGradient">
<h2 class="page_title">Gradiente radial</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Gradiente radial&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateRadialGradient.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateRadialGradient.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2FcreateRadialGradient.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El gradiente radial ( o circular ) se puede utilizar como relleno para formas geom&eacute;tricas, l&iacute;neas y texto dentro del <code>&lt;canvas&gt;</code>.</p>
...
<p>Para definir los gradientes radiales con el m&eacute;todo <code>createRadialGradient()</code> utilizamos dos c&iacute;rculos imaginarios. 
El gradiente radial parte desde la circunferencia del primer circulo, y se va hacia la circunferencia del segundo.<br />
El m&eacute;todo <code>createRadialGradient(x0,y0,r0,x1,y1,r1)</code> toma seis argumentos.
Los tres primeros definen el primer circulo imaginario, <code>x0</code> e <code>y0</code> siendo las coordenadas del centro, mientras que <code>r0</code> representa el 
radio del circulo.<br />
Los siguientes tres argumentos definen, de la misma manera, el segundo circulo.
</p>
<p>El m&eacute;todo <code>addColorStop(stop,color)</code> toma dos argumentos.<br />
El primer argumento, <code>stop</code>, puede tomar valores desde <code>0.0</code> hasta <code>1.0</code>, y representa una 
posici&oacute;n a lo largo del vector gradiente definido anteriormente con m&eacute;todo <code>createLinearGradient()</code>.
Podemos utilizar el m&eacute;todo <code>addColorStop()</code> tantas veces como creamos necesario.<br />
El segundo argumento representa el color, que puede tomar cualquier valor aceptado en el <code>CSS</code> 
(<em class="gem"> <a class="link_to" href="../utiles/colores-alfabeticamente.php">nombres de colores</a>, 
valores <a class="link_to" href="../css3/hex.php">hex</a>, <a class="link_to" href="../css3/rgb.php">rgb, rgba</a>, 
<a class="link_to" href="../css3/hsl.php">hsl, hsla</a></em>).</p>

<p><strong>Veamos un ejemplo</strong>. A continuaci&oacute;n dibujamos un rect&aacute;ngulo que cubre todo el lienzo, 
desde la esquina izquierda arriba (<code> x = 0, y = 0 </code>) hasta la esquina derecha abajo ( <code>x = canvas.width, y = canvas.height</code> ).<br />
Utilizando el m&eacute;todo <code>createRadialGradient()</code> creamos un gadiente radial, que utilizamos luego para rellenar este rect&aacute;ngulo.<br />
<!--Al final dibujamos dos circulos que coincidan con los dos circulos imaginarios que hemos utilizado para definir el gradiente.--></p>


</div>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="250" height="255">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="250" height="255">Su navegador no soporta canvas :( </canvas> </article>
</div>
<h4>Un ejemplo útil</h4>
<p>Podemos escribir una función que crea un gradiente radial, y utilizar esta función y utilizar esta función para crear varias pelotas de distinto tamaño.</p>
<blockquote><pre>
function Grd(x, y, r) {
...
<p data-height="400" data-theme-id="11360" data-slug-hash="4ca5731090284f055d29dc7b47287101" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/4ca5731090284f055d29dc7b47287101/">radial gradient</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p>
