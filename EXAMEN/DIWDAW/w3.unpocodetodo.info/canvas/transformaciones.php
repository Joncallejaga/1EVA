...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como mover objetos con translate(), redimensionar con scale() y girar con rotate()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, mover, translate(), redimensionar, scale(), girar, rotate()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Transformaciones" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/transformaciones.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como mover objetos con translate(), redimensionar con scale() y girar con rotate()." /> 
  ...
  <link rel="canonical" href="transformaciones.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="transformaciones.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="transformaciones.php#top">&#8682;</a></b>
</div>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Transformaciones&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftransformaciones.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftransformaciones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftransformaciones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Las transformaciones son muy importantes a la hora de manipular los trazados . El <code>&lt;canvas&gt;</code> de <code>HTML5</code> viene de fabrica con tres tipos de transformaciones: 
<code>tanslate()</code>, <code>scale()</code> y <code>rotate()</code>, adem&aacute;s de otros dos m&eacute;todos que nos permiten hacer transformaciones a medida: <code>transform()</code> y <code>setTransform()</code>.<br>
<strong>Importante:</strong> las transformaciones son <mark>aditivas</mark>, o sea: cada transformaci&oacute;n se sumar&aacute; a la transformaci&oacute;n anterior.</p>
...
<p>El m&eacute;todo <code>translate()</code> mueve el origen<code> (0,0)</code> del <code>&lt;canvas&gt;</code> en un punto dado.
A continuaci&oacute;n vamos a dibujarun rect&aacute;ngulo con <code>fillRect()</code>. Situamos el rect&aacute;ngulo en el origen del <code>&lt;canvas&gt;</code>, aplicaremos el m&eacute;todo <code>translate()</code> y volvemos a dibujar otro rect&aacute;ngulo igual. Veamos que pasa.
</p>
</div>
</div><!--<div class="row">-->
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="240" id="lienzo">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
        <article><canvas width="250" height="240" id="lienzo">Su navegador no soporta canvas :( </canvas></article>
</div>
<div class="row">
<div  class="large-12 columns">
<h4 id="h4_2">Girar con rotate()</h4>
<p>El m&eacute;todo <code>rotate()</code> gira los trazados posteriores con un &aacute;ngulo dado ( en radianes ).
 El punto alrededor del cual gira coincide con el origen del contexto <code>(0,0)</code>. 
Si queremos que un trazado gire alrededor de otro punto, tenemos que trasladar el origen del contexto en este punto antes de girar.</p>
<p>A continuaci&oacute;n utilizamos un <code>bucle for</code> ( <em class="gem">for loop</em> ) para dibujar una s&eacute;rie de rect&aacute;ngulos. 
Despu&eacute;s de cada rect&aacute;ngulo giramos el contexto 20&deg; (<code>Math.PI/9</code>) en el sentido del reloj.<br> 
Como que las transformaciones son cumulativas, y los rect&aacute;ngulos giran alrededor del origen del contexto, al final tendremos algo parecido a un abanico de rect&aacute;ngulos.</p></div>
</div><!--<div class="row">-->

<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="240" id="lienzo1">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
<div class="large-12 g_panel resultado">
        <article><canvas width="250" height="240" id="lienzo1">Su navegador no soporta canvas :( </canvas> </article>
</div>

<div class="row">
<div  class="large-12 columns">
<h4 id="h4_3">Cambiar el centro de rotaci&oacute;n</h4>
<p>Si queremos que un trazado gire alrededor de otro punto ( que no sea el la esquina izquierda arriba del <code>&lt;canvas&gt; </code>) tenemos que trasladar el origen del contexto en el punto deseado.<br>
A continuaci&oacute;n trasladamos el origen en el centro del canvas ( <code>ctx.translate(cw/2, ch/2);</code> ), y el contexto es transparente ( <code>ctx.globalAlpha=0.4</code> ).
Utilizamos un <code>bucle for</code> (<em class="gem"> for loop</em> ) para dibujar una s&eacute;rie de cuadrados azules.  Despu&eacute;s de dibujar cada cuadrado giramos el contexto 60º ( <code>ctx.rotate(Math.PI/3);</code> ) en el sentido del reloj.</p>

<blockquote><pre>
for( var i = 0; i&lt;6; i++){
<span class="com">//dibujamos un nuevo rectangulo</span>
ctx.fillRect(-w,-h,w,h);
ctx.strokeRect(-w,-h,w,h);
<span class="com">// giramos 60 grados</span>
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="240" id="lienzo2">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
<div class="large-12 g_panel resultado">
        <article><canvas width="250" height="240" id="lienzo2">Su navegador no soporta canvas :( </canvas></article>
</div>

<div class="row">
<div  class="large-12 columns">
<h4 id="h4_4">Redimensionar con scale()</h4>
<p>El m&eacute;todo <code>scale(h,v)</code> reduce o ampl&iacute;a a escala el dibujo actual, donde h representa la escala horizontal, y v la escala vertical. 
Por ejemplo: si h = 0.5 la altura se ver&aacute; reducida a un 50%. Si por el contrario v = 2, la anchura aumentara a 200% de su valor inicial. 
Veamos un ejemplo.</p>
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="100" id="lienzo3">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
var canvas3 = document.getElementById("lienzo3");
				if (canvas3 && canvas3.getContext) {
					...
					if (ctx3) {
						ctx3.fillStyle = "#f00";
						ctx3.lineWidth=5;
						// dibuja el rect&aacute;ngulo peque&ntilde;o
						ctx3.strokeRect(12,15,25,15);
						ctx3.fillRect(12,15,25,15);
						// redimensiona
						ctx3.scale(5,2.5);
						// el mismo c&oacute;digo que dibuj&oacute; el rect&aacute;ngulo peque&ntilde;o  
						// dibuja ahora el rect&aacute;ngulo grande
						ctx3.strokeRect(12,15,25,15);
						ctx3.fillRect(12,15,25,15);
					}
				}</code></pre>
...
<div class="large-12 g_panel resultado">
        <article><canvas width="250" height="100" id="lienzo3">Su navegador no soporta canvas :( </canvas>  </article>
</div>
