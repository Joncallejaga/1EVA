...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un &oacute;valo con arc() y scale() en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, &oacute;valo, ovalo, curvas, arc(), scale(), deformar, aplastar"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar un &oacute;valo" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/ovalo.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un &oacute;valo con arc() y scale() en el canvas de HTML5." /> 
  
  <title>Dibujar un &oacute;valo</title>
  ...
  <link rel="canonical" href="ovalo.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="ovalo.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="ovalo">
<h2 class="page_title">Dibujar un &oacute;valo</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar un &oacute;valo&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fovalo.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fovalo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fovalo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Un &oacute;valo, en geometr&iacute;a, es un c&iacute;rculo aplastado que se asemeja a una forma ovoide o el&iacute;ptica. 
A diferencia de otras curvas, el t&eacute;rmino &oacute;valo no est&aacute; claramente definido, y muchas curvas diferentes son llamadas &oacute;valos. 
Su forma no se aparta mucho de la de una circunferencia o una elipse.</p>
...
<p><em class="gem">Vea <a class="link_to" target="_blank" href="chuleta.php">la chuleta</a> con las propiedades y metodos() de canvas.</em><br>
<em class="gem">M&aacute;s informaci&oacute;n acerca de los m&eacute;todos <a class="link_to" target="_blank" href="save-restore.php">save() y restore()</a>.</em></p>

<p>Para dibujar un &oacute;valo, dibujaremos un <a class="link_to" target="_blank" href="arc.php">c&iacute;rculo</a>, que aplastaremos luego, utilizando el m&eacute;todo <a class="link_to" target="_blank" href="transformaciones.php#h4_4">scale()</a>.<br />
</p>
<p>El m&eacute;todo <code>scale(x,y)</code> reduce o ampl&iacute;a a escala el dibujo actual, y acepta dos par&aacute;metros: la deformaci&oacute;n en <code>x</code>, y la deformaci&oacute;n en <code>y</code>. 
Por ejemplo: si y = 0.5 la altura se ver&aacute; reducida a un 50%. Si por el contrario x = 2, la anchura aumentara a 200% de su valor inicial. 
En nuestro caso queremos que la anchura aumente a 200% de su valor inicial, y la altura quede sin cambiar.</p>
<blockquote><pre>ctx.scale(<span class="str">2</span>, 1);</pre></blockquote>
<p><strong>Importante:</strong> para centrar el &oacute;valo resultante hemos dibujado el circulo original hacia la izquierda.</p>
<blockquote><pre>ctx.arc( <span class="str">centroX/2</span>, centroY, radio, 0, 2 * Math.PI );</pre></blockquote>
	...
	var canvas = document.getElementById("lienzo");
		...
		var ctx = canvas.getContext("2d");
			if (ctx) {
					...
					ctx.scale(2, 1);
					// dibujamos un c&iacute;rculo que ser&aacute; aplastado en un &oacute;valo
					ctx.beginPath();
					ctx.arc( centroX / 2, centroY, radio, 0, 2 * Math.PI );
					// restauramos el estado inicial, el de antes de modificar la escala
					// de esta manera el borde no ser&aacute; aplastado
					ctx.restore();
					// trazamos el borde
					ctx.lineWidth = 15;
					ctx.strokeStyle = "#00f";
