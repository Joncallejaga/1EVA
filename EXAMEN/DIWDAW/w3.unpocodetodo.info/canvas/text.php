...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como escribir en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, font, textAlign, textBaseline, fillText(), strokeText(), measureText()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Escribiendo en el canvas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/text.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como escribir en el canvas de HTML5." /> 
  
  <title>Escribiendo en el canvas</title>
  ...
  <link rel="canonical" href="text.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="text.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="text">
<h2 class="page_title">Escribiendo en el canvas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Escribiendo en el canvas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftext.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftext.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Ftext.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="row">
<div  class="large-12 columns"><h4 id="h4_2">La propiedad font</h4>
<p>Determina las propiedades del texto, las mismas que utilizamos en CSS, y en este mismo orden: <code>font-style, font-variant, font-weight, font-size</code> y <code>font-family</code>. 
Podemos utilizar todas estas propiedades o solo algunas de ellas.</p><p>Ejemplos:</p>
<blockquote><pre>
context.font="2em Verdana";
context.font="italic small-caps bold 12px arial";
context.font="italic bold 12pt Times New Roman, serif ";</pre>
</blockquote>
</div>
...
<div class="row">
<div  class="large-12 columns"><h4 id="h4_1">strokeText ( bordeado de texto ) y fillText ( relleno de texto )</h4>

<p>El canvas transforma el texto en un trazado, y exactamente como con los dem&aacute;s trazados podemos utilizar <code>lineWidth, strokeStyle</code> y <code>fillStyle</code>, 
adem&aacute;s de m&eacute;todos() espec&iacute;ficos como <code>fillText()</code>, para rellenar el texto (de color, gradiente o patr&oacute;n ), y <code>strokeText()</code>, para dibujar un borde alrededor del texto.</p>
<p>La sintaxis para estos dos m&eacute;todos es:</p>
<blockquote><pre>
context.fillText(text,x,y,maxWidth);
context.strokeText(text,x,y,maxWidth);
</pre></blockquote>
<p>Donde:<br />
- <code>text</code> representa el texto que queremos escribir;<br />
- <code>x</code> e <code>y</code> representan las coordenadas de la esquina izquierda arriba del texto;<br />
- <code>maxWidth</code> es un par&aacute;metro opcional y representa la anchura m&aacute;xima del texto.
</p>
</div>
</div><!--<div class="row">-->
...
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas width="250" height="150" id="lienzo">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
        <article>
        <canvas width="250" height="150" id="lienzo">Su navegador no soporta canvas :( </canvas>		</article>
</div>
