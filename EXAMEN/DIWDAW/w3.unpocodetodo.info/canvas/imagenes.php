...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Utilizando im&aacute;genes en el canvas de HTML5 con drawImage()." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, drawImage(), dibujar im&aacute;genes, imagen, onload, dibujar imagenes,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Trabajar con im&aacute;genes" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/imagenes.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Utilizando im&aacute;genes en el canvas de HTML5 con drawImage()." /> 
  
  <title>Trabajar con im&aacute;genes</title>
  ...
  <link rel="canonical" href="imagenes.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="imagenes.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="imagenes"><h2 class="page_title">Trabajar con im&aacute;genes</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Trabajar con im&aacute;genes&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagenes.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagenes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fimagenes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Tambi&eacute;n podemos utilizar im&aacute;genes en el canvas.Lo podemos hacer utilizando las reglas del <code>CSS</code> para establecer una imagen como fondo del canvas ( <code>canvas{ background-image:url(img.png);} </code> ) , o lo podemos hacer <mark>de manera din&aacute;mica</mark> utilizando m&eacute;todos() y propiedades especificas.</p><div class="large-12"><!--id="chuleta"--><table class="cheatsheet"><thead><tr>    <th>&nbsp;</th>    <th>JavaScript</th>    <th>Descripci&oacute;n</th>    <th>Defecto</th>  </tr>  </thead>  <tbody>    <tr>      <td>drawImage()</td>      <td>context.drawImage(img,x,y);</td>      <td>Dibuja una imagen en el canvas desde el punto <code>(x,y)</code></td>      <td>&nbsp;</td>    </tr>    <tr>      <td>drawImage()</td>      <td>context.drawImage(img,x,y,w,h);</td>      <td>Dibuja una imagen en el canvas desde el punto <code>(x,y)</code>, donde <code>w</code> y <code>h</code> son el ancho y el alto de la imagen, respectivamente.</td>      <td>&nbsp;</td>    </tr>    <tr>      <td>drawImage()</td>      <td>context.drawImage(img,sx,sy,sw,sh,x,y,w,h);</td>      <td>Recorta la imagen empezando desde un punto (<code>sx, sx</code>),  <code>sw</code> y <code>sh</code> siendo el ancho y el alto de la  zona recortada.<br />          Dibuja esta imagen en el canvas desde el punto <code>(x, y</code>), <code>w</code> y <code>h</code> siendo el ancho y el alto de la imagen resultante.</td>      <td>&nbsp;</td>    </tr>  </tbody></table></div><p><em class="gem">Vea <a class="link_to" target="_blank" href="chuleta.php">la chuleta</a> con las propiedades y metodos() de canvas.</em></p><p>En este segundo supuesto, podemos utilizar:</p><ul class="no-bullet"> <li>-	una imagen desde archivo.</li><li>-	una imagen ya existente en la p&aacute;gina.</li><li>-	una imagen dibujada en otro canvas.</li></ul><p>Tambi&eacute;n podemos <mark>redimensionar, recortar o reposicionar</mark> esta imagen.Veamos como y vayamos por partes.</p><h4>Imagen desde archivo.</h4><p>Cuando queremos utilizar una imagen desde un archivo, hay que llamar el m&eacute;todo <code>drawImage()</code> solo cuando la imagen se haya cargado (<code>img.onload</code> ), ya que las im&aacute;genes pueden cargarse lentamente, y probar a utilizar una imagen inexistente, resultar&iacute;a en error.<br />Para que esto no pase, tenemos que escribir una funci&oacute;n an&oacute;nima que utiliza <code>drawImage()</code>, y enlazar esta funci&oacute;n como retrollamada ( <em class="gem">callback</em> ) al evento <code>onload</code>.</p><p>A continuaci&oacute;n utilizamos em m&eacute;todo <code>drawImage(img,x,y)</code> en su forma m&aacute;s sencilla: con solo tres argumentos.</p><div class="large-12 g_panel html">        		        <article>										<pre><code class="language-markup"><canvas id="lienzo" width="250" height="232">Su navegador no soporta canvas :( </canvas></code></pre>        </article></div>  <div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">window.onload = function() {var canvas = document.getElementById("lienzo");		if (canvas && canvas.getContext) {		var ctx = canvas.getContext("2d");			if (ctx) {					var img=new Image();					img.src = "images/enfeinada250.jpg";					img.onload = function() {					ctx.drawImage(this, 0, 0);					}			 }		}}</code></pre>        </article></div><div class="large-12 g_panel resultado"> <article> <canvas id="lienzo" width="250" height="232">Su navegador no soporta canvas :( </canvas> </article></div><h4>La imagen ya existente en la p&aacute;gina<br><small>( reposicionar y redimensionar una imagen )</small></h4><p>Si la imagen ya existe en la p&aacute;gina, podemos almacenar su valor en una variable ( mediante <code>document.getElementById()</code>, por ejemplo ), y podemos utilizar esta variable con el m&eacute;todo <code>drawImage()</code> para dibujar la imagen en el <code>&lt;canvas&gt;</code>.</p><blockquote><pre>var img = document.getElementById("img");</pre></blockquote><p>Como ya hemos adelantado, tambi&eacute;n podemos   <mark>reposicionar y redimensionar</mark> la imagen.<br>  En el siguiente ejemplo hemos reducido tanto la anchura como la altura de la imagen a la mitad , y la hemos posicionado en el centro del <code>&lt;canvas&gt;</code>.<br>  Para esto hemos utilizado el m&eacute;todo <code>drawImage(img,x,y,w,h)</code> junto con cinco argumentos.   El m&eacute;todo <code>drawImage</code> dibuja una imagen (<code>img</code>) en el canvas desde el punto <code>(x,y)</code>, donde <code>w</code> y <code>h</code> son el ancho y el alto de la imagen, respectivamente.</p><div class="large-12 g_panel html">        <article>										<pre><code class="language-markup"><img id="img" src="images/enfeinada250.jpg" width="250" height="232" alt="enfeinada" /><canvas id="lienzo1" width="250" height="232">Su navegador no soporta canvas :( </canvas></code></pre>        </article></div>  <div class="large-12 g_panel js">        <article>		<pre><code class="language-javascript">window.onload = function() {	var canvas1 = document.getElementById("lienzo1");		if (canvas1 && canvas1.getContext) {		var ctx1 = canvas1.getContext("2d");			if (ctx1) {					var img1 = document.getElementById("img");					var x = ( canvas1.width - (img1.width/2) ) /2;					var y = ( canvas1.height - (img1.height/2) ) /2;					var w = img1.width/2;					var h = img1.height/2;					ctx1.drawImage( img1, x, y ,w, h );			 }		}}</code></pre>                </article></div><div class="large-12 g_panel resultado"> <article> <div class="canvasdiv"><img id="img" src="images/enfeinada250.jpg" width="250" height="232" alt="enfeinada" /><canvas id="lienzo1" width="250" height="232">Su navegador no soporta canvas :( </canvas> </div> </article></div><h4>Imagen desde otro canvas<br><small>( recortar reposicionar y redimensionar una imagen )</small></h4><p>Tambi&eacute;n podemos utilizar una imagen previamente dibujada en otro <code>&lt;canvas&gt;</code>.</p><blockquote><pre>var img3 = canvas2;</pre></blockquote>  <p>En el siguiente ejemplo hemos utilizado la imagen de <code>&lt;canvas id="lienzo2"&gt;</code> que hemos recortado y redimensionado antes de colocarla en el  <code>&lt;canvas id="lienzo3"&gt;</code>.<br></p><div class="large-12">  <div class="large-6 columns">    <img src="images/before.png" width="250" height="232" alt="antes" class="right"> </div><div class="large-6 columns">     <img src="images/after.png" width="250" height="232" alt="despues" id="despues" class="left"></div></div><p>&nbsp;</p><div class="large-12"><p>Para esto hemos utilizado el m&eacute;todo <code>drawImage(img,sx,sy,sw,sh,x,y,w,h)</code> junto con nueve atributos.<br>Este m&eacute;todo recorta la imagen (<code>img</code>) empezando desde un punto (<code>sx, sy</code>),  <code>sw</code> y <code>sh</code> siendo el ancho y el alto de la zona recortada. A continuaci&oacute;n dibuja esta imagen en el canvas desde el punto (<code>x, y</code>), donde <code>w</code> y <code>h</code> son el ancho y el alto de la imagen resultante.</p></div><div class="large-12 g_panel html">        <article>										<pre><code class="language-markup"><canvas id="lienzo2" width="250" height="232">Su navegador no soporta canvas :( </canvas><canvas id="lienzo3" width="250" height="232">Su navegador no soporta canvas :( </canvas></code></pre>        </article></div>  <div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">window.onload = function() { // de este canvas copiamos la imagen	var canvas2 = document.getElementById("lienzo2");		if (canvas2 && canvas2.getContext) {		var ctx2 = canvas2.getContext("2d");			if (ctx2) {				var img2 = document.getElementById("img");				ctx2.drawImage( img2,0,0 );		}}		// a este canvas pegamos la imagen recortada			var canvas3 = document.getElementById("lienzo3");		if (canvas3 && canvas3.getContext) {		var ctx3 = canvas3.getContext("2d");			if (ctx3) {					var img3 = canvas2;																		var sx = 50;					var sy = 40;					var sw = 140;					var sh = 140;																										var x = 75;					var y = 79;					var w = 100;					var h = 100;																		ctx3.drawImage( img3,sx,sy,sw,sh, x,y,w,h );				}		}}</code></pre>        </article></div><div class="large-12 g_panel resultado"><article><div class="canvasdiv"><canvas id="lienzo2" width="250" height="232">Su navegador no soporta canvas :( </canvas><canvas id="lienzo3" width="250" height="232">Su navegador no soporta canvas :( </canvas></div></article></div><p>Vea esta aplicaci&oacute;n en <a class="link_to" target="_blank" href="http://codepen.io/enxaneta/pen/EKxMYo/">codepen</a>: recortar una imagen en canvas HTML5.</p><p data-height="500" data-theme-id="11360" data-slug-hash="EKxMYo" data-default-tab="result" data-user="enxaneta" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/EKxMYo/">Crop image</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem">Trabajar con im&aacute;genes</em></li><li>- <em class="gem"><a class="link_to" href="imagen-reflejada.php">Im&aacute;genes reflejadas</a></em></li><li>- <em class="gem"><a class="link_to" href="manipulate.php">Manipular im&aacute;genes</a></em></li><li>- <em class="gem"><a class="link_to" href="negativo.php">El negativo de una imagen</a></em></li><li>- <em class="gem"><a class="link_to" href="blancoynegro.php">Im&aacute;genes en blanco y negro</a></em></li><li>- <em class="gem"><a class="link_to" href="sepia.php">Im&aacute;genes en sepia</a></em></li><li>- <em class="gem"><a class="link_to" href="canvas-blending.php">Modos de fusi&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="data_uri.php">Que son los data:uri</a></em></li><li>- <em class="gem"><a class="link_to" href="toDataURL.php">Crear data:uri desde canvas</a></em></li><li>- <em class="gem"><a class="link_to" href="faviconos-js.php">Faviconos con canvas</a></em></li></ul></article></div></div>
