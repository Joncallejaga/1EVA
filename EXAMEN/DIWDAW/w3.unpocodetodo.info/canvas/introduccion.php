...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos.Una introducci&oacute;n. Que es el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, getContext(), canvas.width, canvas.height"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Canvas - una introducci&oacute;n" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/introduccion.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos.Una introducci&oacute;n. Que es el canvas de HTML5." /> 
  
  <title>Canvas - una introducci&oacute;n</title>
  ...
  <link rel="canonical" href="introduccion.php"> 
...
<h2 class="page_title">Canvas - una introducci&oacute;n</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Canvas - una introducci&oacute;n&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fintroduccion.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fintroduccion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fintroduccion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La etiqueta <code>&lt;canvas&gt;</code> se utiliza para dibujar gr&aacute;ficos. Cualquier texto dentro de este elemento se mostrar&aacute; solo en los navegadores que no soportan <code>&lt;canvas&gt;</code>.
<br />El canvas cuenta con varias m&eacute;todos() y propiedades. A continuaci&oacute;n algunas de ellas.</p>
<div class="large-12"><!--id="chuleta"-->

<table class="canvas cheatsheet">
<thead>
<tr>
    <th><!--M&eacute;todos y propiedades--></th>
    <th>JavaScript</th>
...
<tbody>
 <tr>
    <td>width</td>
    <td>canvas.width</td>
    <td>Determina (sets) o devuelve (returns) la anchura del canvas</td>
    <td>300</td>
  </tr>
   <tr>
    <td>height</td>
    <td>canvas.height</td>
    <td>Determina (sets) o devuelve (returns) la altura del canvas</td>
    <td>150</td>
  </tr>
 <tr>
    <td>getContext()</td>
...
<!--<p>Cualquier texto dentro del elemento <code>&lt;canvas&gt;</code> se mostrar&aacute; en los navegadores que no soportan <code>&lt;canvas&gt;</code>.</p>-->
<div class="large-12 g_panel html">
        <article>	
        <pre><code class="language-markup"><canvas id="Canvas1" width="250" height="220">Su navegador no soporta canvas :( </canvas></code></pre>							
        </article>
</div>  
<p>Sin embargo, el elemento <code>&lt;canvas&gt;</code> no tiene habilidad de dibujo en s&iacute; mismo, siendo s&oacute;lo un contenedor para gr&aacute;ficos. Por esto es importante que el<code> &lt;canvas&gt;</code> tenga asignado un <code>id</code>, ya que habr&aacute; que manipularlo a trav&eacute;s de <code>JavaScript</code>. Utilizaremos <code>document.getElementById</code> para encontrar el canvas.</p>
<p>El m&eacute;todo <code>getContext()</code> devuelve un objeto ( puede llamar este objeto como quiera; a continuaci&oacute;n lo llamaremos <code>ctx</code> ) que proporciona m&eacute;todos() y propiedades para dibujar en el <code>canvas</code>.</p>     
...
window.onload = function() {
	...
	var canvas = document.getElementById("Canvas1");
	 // si existe el canvas y si tiene el m&eacute;todo getContext
		if (canvas && canvas.getContext) {
		// utilice el m&eacute;todo getContext para recuperar el contexto del canvas
...
<h4 id="coordenadas">El sistema de coordenadas</h4>
<p>Para dibujar necesitaremos saber las coordenadas <code>x</code> e <code>y</code> de los puntos utilizados. Por ejemplo el c&oacute;digo para dibujar un <a class="link_to" target="_blank" href="rectangulo.php">rect&aacute;ngulo</a> es <code>rect(x,y,w,h)</code>, donde <code>x</code> e <code>y</code> son las coordenadas de la esquina izquierda arriba, <code>w</code> es la anchura y <code>h</code> es la altura del rect&aacute;ngulo.<br />
En el <code>&lt;canvas&gt;</code>:<br /> 
- El punto cuyas coordenadas son: <code>x=0; y=0;</code> se corresponde con la esquina izquerda arriba del canvas.<br />
- Abajo en la esquina derecha <code>x=canvas.width; y=canvas.height;</code>.</p>
<p>Pase el rat&oacute;n sobre el siguiente <code>&lt;canvas&gt;</code> para ver sus coordenadas <code>x</code> e <code>y</code>:</p>
...
<div id="output" style="position:absolute; padding:5px; min-width:100px;"></div>
</div>
  <p class="text-center"><em class="gem">Pase por encima del canvas para obtener la posici&oacute;n actual del <strong>rat&oacute;n</strong>.</em></p>
</article>
</div>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="chuleta.php">Canvas - la chuleta</a></em></li><li>- <em class="gem">Canvas - una introducci&oacute;n</em></li></ul></article></div></div>
