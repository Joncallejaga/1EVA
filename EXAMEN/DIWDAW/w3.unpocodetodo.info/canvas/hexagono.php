...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un hex&aacute;gono en el canvas de HTML5." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, hex&aacute;gono, hexagono, dibujar un hexagono, circulo, circulos, circunferencia, arc(), radianes, for loop, bucle for, fillStyle, beginPath(), lineTo(), fill(), closePath(), circunferencia, radio, radianes"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar un hex&aacute;gono" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/canvas/hexagono.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar un hex&aacute;gono en el canvas de HTML5." /> 
  
  <title>Dibujar un hex&aacute;gono</title>
  ...
  <link rel="canonical" href="hexagono.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="hexagono.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="hexagono">
<h2 class="page_title">Dibujar un hex&aacute;gono</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar un hex&aacute;gono&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fhexagono.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fhexagono.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcanvas%2Fhexagono.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Un <em class="gem"><a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/Hex%C3%A1gono">hex&aacute;gono regular</a></em> es un pol&iacute;gono con 6 lados iguales y 6 &aacute;ngulos iguales (120&deg;).<br>
  Para construir un hex&aacute;gono trazaremos un circulo imaginario con el radio <code>R</code> y el centro en un punto (<code>X,Y</code>) que en nuestro caso este punto coincide con el centro del <code>&lt;canvas&gt;</code>.<br>
  A continuaci&oacute;n tenemos que encontrar 6 puntos equidistantes situados en la circunferencia. Estos puntos est&aacute;n situados a 60&deg; uno de otro. Si unimos estos puntos conseguimos un hex&aacute;gono.</p>
<p>Para calcular las coordenadas de un punto en la circunferencia de un c&iacute;rculo utilizaremos las siguientes f&oacute;rmulas:</p>
  <blockquote><pre>
  var x = X + R * Math.cos(a);
  var y = Y + R * Math.sin(a);</pre></blockquote>
  <p>Donde<br />
  - <code>X</code> e <code>Y</code> son las coordenadas del centro del c&iacute;rculo;<br>
  - <code>R</code> es el radio del c&iacute;rculo, y<br>
  - <code>a</code> es el &aacute;ngulo entre el punto 0&pi; y este punto. No hay que olvidar que en el <code>&lt;canvas&gt;</code> tenemos que utilizar radianes. Sesenta grados en radianes son:</p>
  <blockquote><pre>var rad = (Math.PI / 180) * 60;</pre></blockquote> 
<p>Como que los 6 puntos son equidistantes podemos utilizar un <mark>bucle for</mark> ( <code>for loop</code> ) para trazar el hex&aacute;gono.</p>
  <blockquote><pre>
  ctx.beginPath();
  for( var i = 0; i&lt;6; i++ ){
  ...
  <p>ceramos el trazado y rellenamos:</p>
  <blockquote><p>ctx.closePath();<br>
  ctx.fill(); </p></blockquote>
