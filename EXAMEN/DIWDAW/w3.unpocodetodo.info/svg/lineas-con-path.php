...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar l&iacute;neas con path." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, path, instrucciones de control, commands, moveto, lineto, horizontal lineto, vertical lineto, stroke-dasharray,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar l&iacute;neas con path" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/lineas-con-path.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar l&iacute;neas con path." /> 
  
  <title>Dibujar l&iacute;neas con path</title>
  ...
  <link rel="canonical" href="lineas-con-path.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="lineas-con-path.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="lineas-con-path.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="lineas-con-path"><h2 class="page_title">Dibujar l&iacute;neas con path</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar l&iacute;neas con path&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Flineas-con-path.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Flineas-con-path.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Flineas-con-path.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12"><!--id="chuleta"--><p>Para dibujar una l&iacute;nea con <code>&lt;path&gt;</code> podemos utilizar una de estas <mark>instrucciones de control</mark> ( <em class="gem">commands</em> )</p><table class="svg"><tbody>  <tr>  <td>M(absoluto)<br>m(relativo)</td>  <td> moveto<br>    <span class="normal">Mueve el "lapiz" en este punto (x,y). No dibuja ning&uacute;na l&iacute;nea</span></td>  <td>Mx,y</td></tr>  <tr>   <td>L(absoluto)<br>l(relativo)</td>   <td>lineto<br>    <span class="normal">Dibuja una l&iacute;nea desde el punto actual (x,y) hasta este punto (x1,y1)</span></td>  <td>Lx1,y1</td></tr>  <tr>  <td>H(absoluto)<br>h(relativo)</td>  <td>horizontal lineto<br>    <span class="normal">Dibuja una l&iacute;nea horizontal desde el punto actual (x,y) hasta un punto (x1,y)</span></td>  <td>Hx1</td></tr>  <tr>   <td>V(absoluto)<br>v(relativo)</td>   <td>vertical lineto<br>    <span class="normal">Dibuja una l&iacute;nea vertical desde el punto actual (x,y) hasta un punto (x,y1)</span></td>  <td>Vy1</td>  </tr>  <tr>  <td>Z<br>z</td>  <td>closepath<br>    <span class="normal">Cierra el trazado</span></td>  <td>Z</td>  </tr>  </tbody></table></div><h4>Veamos un ejemplo:</h4><div class="large-12 g_panel html">        <article>										<pre><code class="language-markup"><svg width="250" height="200" viewBox="0 0 250 200"> <path d="m50,60 l140,-25 v125 h-160 z" style="stroke:#CC3366; stroke-width:3; fill:none;" stroke-dasharray="6,3,3,3"/></svg></code></pre>	        </article></div>  <div class="large-12 g_panel resultado"> <article><svg width="250" height="200" viewBox="0 0 250 200"> <path d="m50,60 l140,-25 v125 h-160 z" style="stroke:#CC3366; stroke-width:3; fill:none;" stroke-dasharray="6,3,3,3"/></svg> </article></div><p>En el ejemplo anterior hemos empezado a dibujar en el punto <code>x=50,y=60</code>. Para mover el &quot;l&aacute;piz&quot; a este punto hemos utilizado <code>m50,60</code>.</p><blockquote><p>d=&quot;<strong class="str">m50,60</strong> l140,-25 v125 h-160 z&quot;</p></blockquote><p>Aunque <code>m</code> es una instrucci&oacute;n de control relativa, como que se trata del primer punto del trazado, podemos utilizar tanto <code>m</code> como <code>M</code>. <br />A continuaci&oacute;n queremos dibujar una l&iacute;nea, y para esto podemos utilizar <code>L</code> o <code>l</code> como <code>instrucci&oacute;n de control</code>. En el ejemplo anterior hemos trazado una primera l&iacute;nea desde <code>x=50,y=60</code> ( punto definido anteriormente con <code>m</code> ) hasta <code>x +=140,y -=250</code>. Utilizamos coordenadas relativas, y por tanto :</p><blockquote><p>d=&quot;m50,60 <strong class="str">l140,-25</strong> v125 h-160 z&quot;</p></blockquote><p>En <code>SVG</code> podemos dibujar l&iacute;neas verticales especificando solo el valor del par&aacute;metro <code>y</code>, ya que el <code>x</code> queda igual. Para dibujar l&iacute;neas verticales podemos utilizar una de estas instrucciones  de control: <code>V</code> ( si utilizamos coordenadas absolutas ) o <code>v</code> ( si utilizamos coordenadas relativas ).</p><blockquote><p>d=&quot;m50,60 l140,-25 <strong class="str">v125</strong> h-160 z&quot;</p></blockquote><p>De la misma manera podemos dibujar l&iacute;neas horizontales especificando solo el valor del par&aacute;metro <code>x</code>, ya que el <code>y</code> queda igual. Para dibujar l&iacute;neas horizontales podemos utilizar una de estas instrucciones  de control: <code>H</code> o <code>h</code></p><blockquote><p>d=&quot;m50,60 l140,-25 v125 <strong class="str">h-160</strong> z&quot;</p></blockquote><p>Para acabar cerramos el trazado utilizando closepath ( <code>Z</code> o <code>z</code> )</p><blockquote><p>d=&quot;m50,60 l140,-25 v125 h-160 <strong class="str">z</strong>&quot;</p></blockquote> </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="trazados.php">Trazados SVG</a></em></li><li>- <em class="gem">Dibujar l&iacute;neas con path</em></li><li>- <em class="gem"><a class="link_to" href="cuadratic-bezier.php">Curvas cuadr&aacute;ticas de B&eacute;zier</a></em></li><li>- <em class="gem"><a class="link_to" href="cubic-bezier.php">Curvas c&uacute;bicas de B&eacute;zier</a></em></li><li>- <em class="gem"><a class="link_to" href="arcos-elipticos.php">Arcos elipticos</a></em></li><li>- <em class="gem"><a class="link_to" href="elipse-con-path.php">Dibujar una elipse con path</a></em></li></ul></article></div></div>
