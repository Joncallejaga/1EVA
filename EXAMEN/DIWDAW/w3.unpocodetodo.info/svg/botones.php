...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. C&oacute;mo crear botones con &iacute;conos SVG." />
  <meta name="keywords" content="SVG, HTML5, CSS3, &iacute;conos, bot&oacute;n, imagen de fondo"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="&Iacute;conos SVG" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/botones.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. C&oacute;mo crear botones con &iacute;conos SVG." /> 
  
  <title>&Iacute;conos SVG</title>
  ...
  <link rel="canonical" href="botones.php"> 
 
  <style>.resultado p{text-align:center;}
.boton:hover{color:white;}
#svg1.g_panel.html:before {
content: "contacto.svg";
}
#ejemploSVG{ display: inline-block; border:none; position:relative; top:5px;}
#botones form{ width: 100%; border:1px solid #d9d9d9; padding:10px; float:left;}
...
#botones .tomato{ background-color:tomato; 
		 border-color:hsl(9,80%,50%);
		 background-image: url(imagenes-svg/borrar.svg);}
#botones .tomato:hover{ background-color:hsl(9,80%,50%);}

#botones .verde{ background-color:hsl(124,35%,55%); 
		 border-color:hsl(124,20%,50%);
		 background-image: url(imagenes-svg/carrito.svg);}
#botones .verde:hover{ background-color:hsl(124,20%,50%);}		 

#botones .fucsia, #botones .enviar{background-color:hsl(340,60%,50%); 
        border-color:hsl(340,60%,45%);
		background-image: url(imagenes-svg/izquierda.svg);
		} 
#botones .derecha, #botones .enviar{background-image: url(imagenes-svg/derecha.svg);
		background-position: calc(100% - 10px) 5px;
		padding:5px 20px 5px 0;}
#botones .fucsia:hover, #botones .enviar:hover{ background-color:hsl(340,60%,45%);}

#botones .naranja{ background-color:hsl(39,100%,50%); 
		 border-color:hsl(33,100%,50%);
		 background-image: url(imagenes-svg/me-gusta.svg);}
#botones .naranja:hover{ background-color:hsl(33,100%,50%);}	
</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="botones.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="botones">
<h2 class="page_title">&Iacute;conos SVG</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=&Iacute;conos SVG&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fbotones.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fbotones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fbotones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Crear un juego de botones </h4>
<p>Los botones son muy importantes en HTML, y todos sabemos, realizan acciones importantes con los formularios que los contengan. 
  Podemos utilizar botones <code>&lt;botton&gt;</code> o <code>&lt;input&gt;</code> per&oacute; tambi&eacute;n los podemos crear de otro elemento como por ejemplo <code>&lt;a&gt;</code> o incluso <code>&lt;span&gt;</code>.</p>

<p>A continuaci&oacute;n queremos crear un juego de botones ( <em class="gem">flat buttons</em> ) que utilizan iconos SVG como elemento decorativo. Podemos crear nosotros el icono SVG, o podemos utilizar uno ya creado. Google, por ejemplo, tiene publicados much&iacute;simos &iacute;conos SVG que podemos coger y utilizar libremente.</p>
<p><em class="gem">Google Material Icons: <a class="link_to" target="_blank" href="http://google.github.io/material-design-icons/">http://google.github.io/material-design-icons/</a>
</em></p>
<div class="large-12 g_panel resultado">
        <article>
        
<p><span class="boton">nosotros</span> <span class="boton grande">nosotros</span> </p>
<p><span class="boton tomato">borrar</span> <span class="boton grande tomato">borrar</span></p>
<p><span class="boton verde">carrito</span> <span class="boton grande verde">carrito</span></p>
<p><span class="boton naranja">naranja</span> <span class="boton grande naranja">naranja</span></p>
<p><span class="boton fucsia">izquierda</span> <span class="boton fucsia derecha">derecha</span></p>
        </article>
</div>

<p>Empezamos creando un fichero llamado <code>contacto.svg</code> donde ponemos el c&oacute;digo para <a class="link_to" target="_blank" href="imagenes-svg/contacto.svg">el icono SVG</a>. Si sigue este enlace no ver&aacute; nada, ya que el relleno del trazado es blanco ( <code>fill= "white"</code> ), pero el c&oacute;digo sigue all&aacute;, y si lo abre en vista de c&oacute;digo podr&aacute; verlo: 
<svg id="ejemploSVG" width="24" height="24" viewBox="0 0 24 24">
...
<div class="large-12 g_panel html" id="svg1">
        <article>
        <pre><code class="language-markup">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <path fill="white" d="M16 11c1.66 0 2.99-1.34 2.99-3s-1.33-3-2.99-3c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3s-1.33-3-2.99-3c-1.66 0-3 1.34-3 3s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5v2.5h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45v2.5h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
</svg>
</code></pre>								
        </article>
</div>
<p>En el <strong>HTML</strong> creamos el bot&oacute;n utilizando un elemento <code>&lt;span&gt;</code>, pero tambi&eacute;n podemos utilizar un elemento <code>&lt;a&gt;</code> con este prop&oacute;sito. </p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><p><span class="boton">contacto</span></p></code></pre>        
        </article>
</div> 
<p>En el <strong>CSS</strong> lo m&aacute;s importante es esto: utilizar <code>contacto.svg</code> - el fichero creado anteriormente - como imagen de fondo.</p>
<blockquote><pre>
background-image: url(imagenes-svg/<span class="str">contacto.svg</span>);
</pre></blockquote> 
<p>Es muy probable que la imagen SVG sea demasiado grande (  <code>width= "24" height= "24"</code> ), pero esto tiene arreglo. El CSS3 cuenta con la propiedad <a class="link_to" target="_blank" href="../css3/background-size.php">background-size</a> que nos permite redimensionar las im&aacute;genes de fondo. </p>
<blockquote><pre>background-size:<span class="str">20px 20px</span>;</pre></blockquote>
...
.boton:hover{ background-color:#007095;}</code></pre>
        </article>
</div>
<div class="large-12 g_panel resultado">
        <article>
        <p><span class="boton">contacto</span></p>        </article>
</div>
<h4>Botones grandes</h4>
<p>Queremos crear tambi&eacute;n unos botones grandes, donde los &iacute;conos SVG sean tambi&eacute;n m&aacute;s grandes. No hay ning&uacute;n problema. Sabemos que las im&aacute;genes SVG se redimensionan con elegancia, es lo que las hace tan atractivas.<br />
Para esto en el CSS creamos una clase <code>.grande</code> que redimensiona el boton creado anteriormente.</p>
<blockquote><pre>background-size:<span class="str">25px 25px</span>;</pre></blockquote>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><p><span class="boton grande">contacto</span></p></code></pre>
        </article>
</div> 
<div class="large-12 g_panel css">
        <article>
...
<div class="large-12 g_panel resultado">
        <article>
        <p><span class="boton grande">contacto</span></p>        </article>
</div>

<h4>Puede un &lt;span&gt; enviar un formulario?</h4>

<p>Claro que s&iacute;: utilizando JavaScript: Un bucle for recorre todos los elementos cuya clase es <code>.enviar</code>. Al hacer clic en uno de estos elementos el formulario al cual pertenece es enviado gracias al m&eacute;todo <code>submit()</code>.</p>
<blockquote><pre>elBoton.addEventListener("click", function(){formulario.<span class="str">submit()</span>});</pre></blockquote>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
<div class="large-4 columns">
<form id="formulario1" action="botones.php">
  <p>Nombre: <input type="text" name="nombre1">
  Apellido: <input type="text" name="apellido1"></p>
  <p><span id="enviar1" class="boton enviar">Enviar</span></p>
</form>
</div>
<div class="large-4 columns">
<form id="formulario2" action="botones.php">
  <p>Nombre: <input type="text" name="nombre2">
  Apellido: <input type="text" name="apellido2"></p>
  <p><span id="enviar2" class="boton enviar">Enviar</span></p>
</form>
</div>
<div class="large-4 columns">
<form id="formulario3" action="botones.php">
  <p>Nombre: <input type="text" name="nombre3">
  Apellido: <input type="text" name="apellido3"></p>
  <p><span id="enviar3" class="boton enviar">Enviar</span></p>
</form>
</div>
</code></pre>
        </article>
