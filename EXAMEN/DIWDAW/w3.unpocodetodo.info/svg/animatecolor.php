...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como animar el color de relleno utilizando el elemento animate." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, animateColor, obsoleto, animate, attributeName, fill, attributeType, freeze, values, dur, repeatCount, indefinite, "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Animar el color" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/animatecolor.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como animar el color de relleno utilizando el elemento animate." /> 
  
  <title>Animar el color</title>
  ...
  <link rel="canonical" href="animatecolor.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animatecolor.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animatecolor.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="animatecolor">
<h2 class="page_title">Animar el color</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Animar el color&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatecolor.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatecolor.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatecolor.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El elemento &lt;animateColor&gt; se utilizaba antes para controlar el cambio del color en el tiempo. Actualmente este elemento es obsoleto, y para animar el color de relleno utilizamos el elemento <code>&lt;animate&gt;</code>.</p>

<h4>Un ejemplo b&aacute;sico</h4>
<p>A continuaci&oacute;n haremos que el color ( <code>attributeName="fill"  attributeType="CSS"</code> ) de un rect&aacute;ngulo cambie de verde ( <code>from="#6ab150"</code> ) a amarillo 
( <code>to="#ffff00"</code> ) durante un per&iacute;odo de 5 segundos ( <code>dur="5s"</code> ).  Despu&eacute;s de los 5 segundos la animaci&oacute;n quedar&aacute; congelada ( <code>fill="freeze"</code> ).</p>
<div class="large-12 g_panel html">
        <article>	
        <pre><code class="language-markup">
<svg width="250" height="120">
  <rect x="75" y="20" width="100" height="80" style="stroke:#000;stroke-width:5; fill :#6ab150" >
    <animate attributeType="CSS"
      attributeName="fill"
      from="#6ab150" to="#ffff00"
      dur="5s"
	  begin ="0s; click"
      fill="freeze" />
  </rect>
...
<p>Esta vez queremos animar el color de relleno ( <code>attributeName="fill"</code> ) de un c&iacute;rculo. El color de relleno ( <code>fill :#6ab150</code> ) aparece como valor del 
...
<blockquote><p>values="<span class="str">#6ab150</span>; #ffff00; <span class="str">#6ab150"</span></p></blockquote>
<p>Por favor observe que el primer y el &uacute;ltimo valor son iguales ( <code>#6ab150</code> ). Esto permite una transici&oacute;n suave entre las varias etapas de la animaci&oacute;n.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="120">
  <circle cx="125" cy="60" r="50" style="fill:#6ab150; stroke:#000;stroke-width:5;" >
