...
<head>
  ...
  <meta name="description" content="Como crear una animaci&oacute;n de tipo hormigas andadoras ( marching ants ) en SVG." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5,hormigas andadoras,marching ants,stroke-dasharray,stroke-dashoffset"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Hormigas andadoras" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/hormigas-andadoras.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Como crear una animaci&oacute;n de tipo hormigas andadoras ( marching ants ) en SVG." /> 
  
  <title>Hormigas andadoras</title>
  ...
  <link rel="canonical" href="hormigas-andadoras.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="hormigas-andadoras.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="hormigas-andadoras.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="hormigas-andadoras">
<h2 class="page_title">Hormigas andadoras</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Hormigas andadoras&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fhormigas-andadoras.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fhormigas-andadoras.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fhormigas-andadoras.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos utilizar el atributo <a class="link_to" target="_blank" href="lineas.php#dasharray">stroke-dashoffset</a> para crear una animaci&oacute;n de tipo hormigas andadoras ( <em class="gem">marching ants</em> ). B&aacute;sicamente tenemos que animar el valor de <code>stroke-dashoffset</code> como en los siguientes ejemplos.</p>
<h4>El SVG</h4>
<p>El SVG para los dos siguientes ejemplos es lo mismo: un rect&aacute;ngulo dibujado con polygon, sin relleno (<code>fill:none</code>), con un borde de color negro (<code>stroke:#000</code>) de 3 pixeles (<code>stroke-width:3</code>). El valor del atributo <code>stroke-dasharray: 30,15</code>. Esto quiere decir que el patr&oacute;n de l&iacute;neas discontinuas utilizado esta formado por fragmentos de l&iacute;nea de 30, seguidos por espacios de 15. O sea el tama&ntilde;o del fragmento a repetir es de <strong>45</strong>.</p>
<blockquote><pre>&lt;svg width="250" height="250" viewBox="0 0 250 250"&gt;
  ...
  &gt;&lt;/polygon&gt;
  &lt;/svg&gt;</pre></blockquote>
<h4>Hormigas andadoras con CSS</h4>

<p>En el siguiente ejemplo utilizo la librer&iacute;a <a class="link_to" target="_blank" href="https://leaverou.github.io/prefixfree/">-prefix-free</a> as&iacute; que no necesito utilizar prefijos.</p>
<p>En el CSS primero designamos el nombre de la animaci&oacute;n: <code>hormigasAndadoras</code>, la duraci&oacute;n: <code>.5s</code>, la funci&oacute;n temporizador: <code>linear</code>, y el n&uacute;mero de iteraciones: <code>infinite</code>.</p>
<blockquote><pre>polygon{
      animation-name: hormigasAndadoras;
      animation-duration: .5s;
      animation-timing-function: linear;
      animation-iteration-count: infinite;
  }</pre></blockquote>
<p>Que tambi&eacute;n podemos escribir as&iacute;:</p>
<blockquote><pre>polygon{
      animation: hormigasAndadoras .5s linear infinite;
  }</pre></blockquote>
<p>A continuaci&oacute;n creamos las fotogramas para la animaci&oacute;n hormigasAndadoras: pr&aacute;cticamente tenemos que animar el valor de <code>stroke-dashoffset</code> de 0 a 45 (45 es el tama&ntilde;o del fragmento a repetir ).</p>
<blockquote><pre>@keyframes hormigasAndadoras {   
...
<p data-height="350" data-theme-id="11360" data-slug-hash="29d45206620eda9f2ec0ab540cc42cc0" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="hormigas andadoras CSS" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/29d45206620eda9f2ec0ab540cc42cc0/">hormigas andadoras CSS</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p>
<script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>

<h4>Hormigas andadoras con javascript</h4>

<p>En JavaScript es todav&iacute;a m&aacute;s f&aacute;cil. Podemos utilizar el m&eacute;todo <a class="link_to" target="_blank" href="../canvas/animaciones-en-canvas.php">requestAnimationFrame</a> para animar el valor del atributo <code>stroke-dashoffset</code> de esta manera:<br>
Tenemos una variable llamada <code>dashoffset</code> cuyo valor es <code>0</code>. Con cada fotograma el valor de <code>dashoffset</code> crece ( <code>dashoffset += 2;</code> ). Al final hacemos al atributo <code>stroked-dashoffset</code> del <code>polygon</code> igual al valor de la variable <code>dashoffset</code>.</p>
<blockquote><pre>polygon.style.strokeDashoffset = dashoffset;</pre></blockquote>
<p data-height="320" data-theme-id="11360" data-slug-hash="d773efb193652282d1472d6f9a048b10" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="hormigas andadoras JS" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/d773efb193652282d1472d6f9a048b10/">hormigas andadoras JS</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p>
<script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>
