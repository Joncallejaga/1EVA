...
<head>
  ...
  <meta property="og:title" content="Gr&aacute;ficos circulares (2)" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/graficos-circulares2.php" /> 
  ...
  <title>Gr&aacute;ficos circulares (2)</title>
  ...
  <link rel="canonical" href="graficos-circulares2.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="graficos-circulares2.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="graficos-circulares2.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="graficos-circulares2">
<h2 class="page_title">Gr&aacute;ficos circulares (2)</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Gr&aacute;ficos circulares (2)&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fgraficos-circulares2.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fgraficos-circulares2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fgraficos-circulares2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Ir a <a class="link_to" target="_blank"  href="graficos-circulares1.php">Gr&aacute;ficos circulares (1)</a></em></p>

<h4>A&ntilde;adir una amimaci&oacute;n con &lt;set&gt;</h4>
<p>Adem&aacute;s de dibujar los sectores circulares, queremos a&ntilde;adir una animaci&oacute;n muy sencilla: cada vez que pasamos con el rat&oacute;n por encima de uno de los sectores circulares, queremos que aparezca, como una sombra, un arco de c&iacute;rculo del mismo color, pero con una opacidad de 40%.<br />
Para esto dibujamos un trazado <code>&lt;path id="sombra". . .</code> cuyos atributos <code>stroke-opacity="0.4"</code> y  <code>stroke-width="0"</code>. </p>
<blockquote><pre>
&lt;path id="sombra" d="M119, 54 A100,100 0 0, 1250,150" fill="none" stroke="#FCCA03" 
 	<strong class="str">stroke-opacity="0.4"</strong> 
 	<strong class="str">stroke-width="0"</strong> &gt;&lt;/path&gt;
</pre></blockquote>
<p>Ya que la grosor de l&iacute;nea <code>stroke-width="0"</code>, el trazado ser&aacute; pr&aacute;cticamente invisible.</p>
<p><strong>Importante</strong>: tanto el trazado que dibuja el "gajo" como el trazado que dibuja la "sombra" tienen una identificaci&oacute;n (&nbsp;<code>id</code>&nbsp;) para poder  referenciarlos despu&eacute;s, utilizando los atributos <code>begin</code> y <code>end</code> de <a class="link_to" target="_blank" href="animate-set-repeat.php#set">&lt;set&gt;</a> . </p>
<blockquote>
<pre>
&lt;path id= "<strong class="str">gajo</strong>" d="M150, 150 L119,54 A100,100 0 0, 1 250,150 z". . .
&lt;path id= "<strong class="str">sombra</strong>"         d="M119,54 A100,100 0 0, 1 250,150". . .      
</pre>
</blockquote>
<p>Dentro del elemento <code>&lt;path id="sombra"</code> aparece anidado un elemento <a class="link_to" target="_blank" href="animate-set-repeat.php#set">&lt;set&gt;</a> que hace que la grosor de l&iacute;nea ( <code>attributeName = "stroke-width"</code> ) cambie a 15px ( <code>to="15"</code> ) cada vez que pasamos con el rat&oacute;n por encima ( <code>mouseenter</code> ). La animaci&oacute;n acaba cuando el rat&oacute;n se sale ( <code>mouseleave</code> ) fuera del gajo o de la sombra.</p>
<blockquote>
<pre>
...
<svg width="300" height="200" >
   <path id="gajo" d="M150, 150 L119,54 A100,100 0 0, 1 250,150 z" fill="#FCCA03" stroke="#fff" stroke-width="2"></path>
   <path id="sombra" d="M119,54 A100,100 0 0, 1 250,150" fill="none" stroke="#FCCA03" stroke-opacity="0.4" stroke-width="0">
      <set attributeName="stroke-width" attributeType="XML" 
           to="15" 
           begin="gajo.mouseenter; sombra.mouseenter;" 
           end="gajo.mouseleave; sombra.mouseleave;" ></set>
   </path>
   <text x= "150" y="180" text-anchor= "middle">Por favor, pase por encima con el rat&oacute;n</text>
</svg></code></pre>								
        </article>
</div>  
...
<p>A continuaci&oacute;n escribiremos las funciones necesarias para conseguir este efecto.</p>
<h4>La funci&oacute;n dSombra</h4>
<p>Muy parecida a la funci&oacute;n <code>dGajo</code>, la funci&oacute;n <code>dSombra</code> calcula el par&aacute;metro <code>d</code> de <code>&lt;path&gt;</code> para dibujar un arco de c&iacute;rculo entre los puntos <code>ap</code> y <code>af</code>.</p>
<blockquote><pre>
...
<p>Crea un nuevo elemento <code>&lt;path&gt;</code> y establece los atributos necesarios para dibujar la "sombra". En el caso de id utiliza la variable <code>i</code> del bucle <code>for</code> para atribuir una identificaci&oacute;n &uacute;nica a cada arco de c&iacute;rculo que dibujamos: </p>
<blockquote>
  <p>nuevaSombra.setAttributeNS( null, "id", "sombra"+<strong class="str">i</strong> ).</p></blockquote>
<p>Despu&eacute;s de adjuntar ( <em class="gem">append</em> ) el nuevo elemento al DOM  como hijo del lienzo SVG.</p>
<blockquote><p>lienzoSVG.appendChild( nuevaSombra );</p></blockquote>
<p>creamos un nuevo elemento <code>&lt;set&gt;</code> y lo dotamos con los atributos necesarios.<br />
Finalmente adjuntamos ( <em class="gem">append</em> ) el nuevo elemento al DOM, como hijo de <code>nuevaSombra</code>.</p>
...
<span class="str">nuevaSombra.appendChild(sombraSet);</span>
}</pre></blockquote>


<h4>La funci&oacute;n nuevoGajo</h4>
<p>Modificamos ligeramente la funci&oacute;n <code>nuevoGajo</code>  a&ntilde;adiendo otro atributo: <code>id</code>, que exactamente como en el caso de <code>nuevaSombra</code> utiliza la variable <code>i</code> del bucle <code>for</code> para generar una identificaci&oacute;n &uacute;nica.</p>
<blockquote><pre>
function nuevoGajo (ap,af,color,<strong class="str">i</strong>){
var nuevoGajo=document.createElementNS ("http:\/\/www.w3.org/2000/svg","path");
<strong class="str">nuevoGajo.setAttributeNS (null,"id", "gajo"+i);</strong>
...
<p>Ahora cada vez que pasamos con el rat&oacute;n por encima de uno de los sectores circulares ( <code>"gajo"+i+".mouseover;</code> ),o por encima de la "sombra" ( <code>sombra"+i+".mouseover;</code> ) aparece, como una sombra, un arco de c&iacute;rculo del mismo color, pero con una opacidad de 40%.</p>
<!--<div class="large-12 g_panel html">
        <article>
...
<svg id="lienzoSVG" width="260" height="250" ></svg> </article>
</div>
<p>A continuaci&oacute;n <a class="link_to" href="graficos-circulares3.php">a&ntilde;adiremos una leyenda</a>.</p>
