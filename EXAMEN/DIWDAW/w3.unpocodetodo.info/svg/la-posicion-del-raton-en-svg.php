...
<head>
  ...
  <meta name="description" content="Como detectar la posici&oacute;n del rat&oacute;n encima de de un lienzo SVG" />
  <meta name="keywords" content="javaScript, createSVGPoint(),  SVGPoint,  getScreenCTM(), addEventListener(),la posici&oacute;n del rat&oacute;n, la posicion del raton"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La posici&oacute;n del rat&oacute;n" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/la-posicion-del-raton-en-svg.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Como detectar la posici&oacute;n del rat&oacute;n encima de de un lienzo SVG" /> 
  ...
  <link rel="canonical" href="la-posicion-del-raton-en-svg.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="la-posicion-del-raton-en-svg.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="la-posicion-del-raton-en-svg.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="la-posicion-del-raton-en-svg"><h2 class="page_title">La posici&oacute;n del rat&oacute;n en SVG</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La posici&oacute;n del rat&oacute;n&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fla-posicion-del-raton-en-svg.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fla-posicion-del-raton-en-svg.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fla-posicion-del-raton-en-svg.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12"><p>Para encontrar la posici&oacute;n del rat&oacute;n encima del lienzo SVG podemos utilizar <a class="link_to" target="_blank" href"http://w3.unpocodetodo.info/canvas/mouse-position.php">la siguiente funci&oacute;n</a> :</p><div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">function oMousePos(svg, evt) {      var ClientRect = svg.getBoundingClientRect();                return { //objeto                x: Math.round(evt.clientX - ClientRect.left),                y: Math.round(evt.clientY - ClientRect.top)      }}</code></pre></article></div><p>Esta funci&oacute;n puede ser &uacute;til si el tama&ntilde;o del lienzo SVG coincide con el tama&ntilde;o del contenido de este ( <code>viewBox</code> ):</p><blockquote><pre>&lt;svg width = "<span class="str">400</span>" height="<span class="str">200</span>" viewBox="0 0 <span class="str">400</span> <span class="str">200</span>"  &gt;. . . &lt;/svg&gt;</pre></blockquote><p>El problema es que SVG significa <em class="gem">gr&aacute;ficos vectoriales expandibles</em>, y por lo tanto el tama&ntilde;o del lienzo no coincide casi nunca con el tama&ntilde;o del contenido.<br> Imag&iacute;nese un elemento SVG cuya anchura es igual a la anchura del elemento padre.</p><blockquote><pre>&lt;svg width = "<span class="str">100%</span>" viewBox="0 0 <span class="str">400</span> <span class="str">200</span>"  &gt;. . . &lt;/svg&gt;</pre></blockquote><p>En una p&aacute;gina web adaptativa ( <em class="gem">responsive</em> ) el tama&ntilde;o del elemento SVG var&iacute;a, pero no su contenido cuya anchura se queda siempre 400 unidades de usuario o p&iacute;xeles. En este caso necesitamos una manera de detectar la posici&oacute;n del rat&oacute;n en funci&oacute;n de las coordenadas del contenido.</p><h4>Detectar la posici&oacute;n del rat&oacute;n</h4>  <p>Sin m&aacute;s pre&aacute;mbulos esta es la funci&oacute;n que vamos a utilizar para detectar la posici&oacute;n del rat&oacute;n encima de un lienzo SVG:</p><div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">function oMousePosSVG(evento) {      var p = svg.createSVGPoint();      p.x = evento.clientX;      p.y = evento.clientY;      var ctm = svg.getScreenCTM().inverse();      var p =  p.matrixTransform(ctm);      return p;}</code></pre></article></div><h5>La explicaci&oacute;n del c&oacute;digo:</h5>  <p>Primero creamos un nuevo punto SVG:</p><blockquote><pre>var point = svg.createSVGPoint();</pre></blockquote><p>En JavaScript el m&eacute;todo <code>createSVGPoint()</code> crea un nuevo objeto <a class="link_to" target="_blank" href="https://developer.mozilla.org/en/docs/Web/API/SVGPoint">SVGPoint</a> inicializado en el origen ( esquina izquierda arriba ) del lienzo SVG.</p> <blockquote><pre>var p = svg.createSVGPoint();</pre></blockquote><p>Queremos que este punto represente la posici&oacute;n del rat&oacute;n:</p><blockquote><pre>p.x = evento.clientX;p.y = evento.clientY;</pre></blockquote><p>El nuevo punto creado tiene asociado el m&eacute;todo <code>matrixTransform()</code> que aplica una matriz de transformaci&oacute;n de tipo  2*3 y devuelve el nuevo punto transformado.</p>  <blockquote><pre>p = p.matrixTransform(ctm);</pre></blockquote>  <p>Para obtener la matriz de transformaci&oacute;n necesaria ( <code>ctm</code> ) utilizamos el m&eacute;todo <a class="link_to" target="_blank" href="https://msdn.microsoft.com/enus/library/hh535760(v=vs.85).aspx">getScreenCTM()</a></p><blockquote><pre>var ctm = svg.getScreenCTM().inverse();</pre></blockquote><p>La funci&oacute;n devuelve el nuevo punto transformado:</p><blockquote><pre>return p</pre></blockquote><h5>Un ejemplo b&aacute;sico</h5><p>En este ejemplo utilizamos el m&eacute;todo <code>addEventListener()</code> para registrar el movimiento del rat&oacute;n ( <code>mousemove</code> ) encima del lienzo SVG. La funci&oacute;n <code>oMousePosSVG()</code> detecta la posici&oacute;n del rat&oacute;n y la saca en pantalla como <code>innerHTML</code> del elemento <code>#salida</code>.</p>  <p data-height="350" data-theme-id="11360" data-slug-hash="3b428584d443de1fbe0142213c4dc24e" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="La posici&oacute;n del rat&oacute;n en SVG*" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/3b428584d443de1fbe0142213c4dc24e/">La posici&oacute;n del rat&oacute;n en SVG*</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>      </div>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="viewport-y-viewbox.php">Viewport y viewBox</a></em></li><li>- <em class="gem"><a class="link_to" href="preserveaspectratio.php">Guardar las proporciones</a></em></li><li>- <em class="gem"><a class="link_to" href="espaciodenombres.php">Espacios de nombre en SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="crear_elementos_svg_con_javascript.php">Crear elementos SVG con JS</a></em></li><li>- <em class="gem"><a class="link_to" href="algunos-metodos-js-en-svg.php">M&eacute;todos JavaScript para SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="css-svg1.php">SVG con estilo</a></em></li><li>- <em class="gem">La posici&oacute;n del rat&oacute;n</em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- Un punto SVG: <a class="link_to" target="_blank" href="https://developer.mozilla.org/en/docs/Web/API/SVGPoint">SVGPoint</a><br>
- el m&eacute;todo <a class="link_to" target="_blank" href="https://msdn.microsoft.com/enus/library/hh535760(v=vs.85).aspx">getScreenCTM()</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
