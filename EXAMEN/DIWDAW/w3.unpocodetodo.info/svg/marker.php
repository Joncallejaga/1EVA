...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como marcar un trazado utilizando el elemento marker. Definir un marcador." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, marcador, marker, marker-start, marker-mid, marker-end, markerWidth, markerHeight, refX, refY, orient, orient= auto"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Marcadores" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/marker.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como marcar un trazado utilizando el elemento marker. Definir un marcador." /> 
  ...
  <link rel="canonical" href="marker.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="marker.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="marker"><h2 class="page_title">Marcadores</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Marcadores&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fmarker.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fmarker.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fmarker.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El elemento <code>&lt;marker&gt;</code> ( <em class="gem">marcador</em> ) se utiliza para marcar el principio (<code> marker-start</code> ) el medio ( <code>marker-mid</code> ) y/o el fin ( <code>marker-end</code> ) de un trazado SVG ( <code>path</code>, <code>line</code>, <code>polyline</code> o <code>polygon</code> ).</p><!--<div id="chuleta" class="large-12">  <table class="svg"><thead><tr>    <th>&nbsp;</th>    <th></th>    <th>Descripci&oacute;n</th>  </tr></thead><tbody>  <tr class="old">    <td>&nbsp;</td>    <td>&nbsp;</td>    <td>&nbsp;</td>  </tr>  </tbody></table></div>--><h4>Definir un marcador</h4><p>Para definir un marcador utilizamos el elemento <code>&lt;marker&gt;</code>. El trazado que aparece dentro representa el marcador. </p><blockquote><p>&lt;marker id="flecha" markerWidth="6" markerHeight="6" refX="4" refY="3" orient="auto"<br>   fill="none" stroke="black"&gt;<br>  <strong class="str">&lt;path d="M 0 0 L 4 3 L 0 6" /&gt;</strong><br>  &lt;/marker&gt;</p></blockquote><p>Un marcador aparece en pantalla solo si lo utilizamos como tal, y aunque no aparezca por s&iacute; solo en un documento, es mejor ponerlo dentro del elemento <code>&lt;defs&gt;</code>.</p><p>Un marcador es un rect&aacute;ngulo transparente dentro del cual aparece el s&iacute;mbolo utilizado como marcador. Los atributos <code>markerWidth</code> y <code>markerHeight</code> controlan la anchura y la altura de este rect&aacute;ngulo.</p><blockquote><p>&lt;marker id="flecha" <strong class="str">markerWidth="6" markerHeight="6"</strong> refX="4" refY="3" orient="auto"<br>   fill="none" stroke="black"&gt;<br>  &lt;path d="M 0 0 L 4 3 L 0 6" /&gt;<br>  &lt;/marker&gt;</p></blockquote><p>Si no especificado de otra manera, el marcador se conecta al trazado por su esquina izquierda arriba. En la mayor&iacute;a de los casos no es lo que queremos. Para rectificar, echaremos mano de otros dos atributos: <code>refX</code> y <code>refY</code>. Estos dos atributos representan las coordenadas del punto de referencia por el cual el marcador se conecta al trazado.</p><blockquote><p>&lt;marker id="flecha" markerWidth="6" markerHeight="6" <strong class="str">refX="4" refY="3"</strong> orient="auto"<br>   fill="none" stroke="black"&gt;<br>  &lt;path d="M 0 0 L 4 3 L 0 6" /&gt;<br>  &lt;/marker&gt;</p></blockquote><p>El atributo <code>orient</code> indica como hay que girar el marcador para que tenga la orientaci&oacute;n deseada.<br>Si <code>orient = "auto"</code>, el SVG calcula el &aacute;ngulo para que el <mark>eje x</mark> del marcador tenga la misma orientaci&oacute;n que el trazado que marcamos.</p><blockquote><p>&lt;marker id="flecha" markerWidth="6" markerHeight="6"  refX="4" refY="3" <strong class="str">orient="auto"</strong><br>   fill="none" stroke="black"&gt;<br>  &lt;path d="M 0 0 L 4 3 L 0 6" /&gt;<br>  &lt;/marker&gt;</p></blockquote> <p>Si no nos gusta el resultado, podemos indicar al SVG el &aacute;ngulo de rotaci&oacute;n deseado.</p><p>En el siguiente ejemplo definimos como marcador una punta de flecha. Observamos que la punta cambia de orientaci&oacute;n y tambi&eacute;n de tama&ntilde;o ( en funci&oacute;n del valor de <code>stroke-width</code> ).</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><svg width="200" height="100"  viewBox="0 0 200 100">  <defs>    <marker id="flecha" refX="4" refY="3" markerWidth="6" markerHeight="6" orient="auto" fill="none" stroke="black">      <path d="M 0 0 L 4 3 L 0 6" />    </marker>  </defs>  <line x1="50" y1="80" x2="90" y2="20" fill="none" stroke="black" stroke-width="1" marker-end="url(#flecha)"></line>  <line x1="60" y1="80" x2="180" y2="20" fill="none" stroke="black" stroke-width="3" marker-end="url(#flecha)"></line></svg></code></pre>								        </article></div> <div class="large-12 g_panel resultado"> <article><svg width="200" height="100"  viewBox="0 0 200 100">  <defs>    <marker id="flecha0" refX="4" refY="3" markerWidth="6" markerHeight="6" orient="auto" fill="none" stroke="black">      <path d="M 0 0 L 4 3 L 0 6" />    </marker>  </defs>  <line x1="50" y1="80" x2="90" y2="20" fill="none" stroke="black" stroke-width="1" marker-end="url(#flecha0)"></line>  <line x1="60" y1="80" x2="180" y2="20" fill="none" stroke="black" stroke-width="3" marker-end="url(#flecha0)"></line></svg> </article></div><!--<p>A continuaci&oacute;n utilizamos tres marcadores diferentes para marcar el principio (<code> marker-start</code> ) el medio ( <code>marker-mid</code> ) yel fin ( <code>marker-end</code> ) del trazado.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"></code></pre>								        </article></div> <div class="large-12 g_panel resultado"> <article> </article></div><!--<div class="large-12 g_panel resultado"> <article> </article></div>--><h4>Los marcadores de tipo marker-mid</h4><p>Los marcadores de tipo <code>marker-mid</code> aparecen al principio y al fin ce cada segmento de una polil&iacute;nea ( <code>polyline</code> ) o de un trazado ( <code>path</code> ).</p><h5>Veamos un ejemplo:</h5><p>Para marcar los puntos de inflexi&oacute;n de una polil&iacute;nea creamos un marcador circular utilizando un elemento <code>&lt;circle&gt;</code>.</p><blockquote><pre>&lt;marker id="circulo" markerWidth="4" markerHeight="4" refX="2" refY="2"&gt;	&lt;circle r="2" cx="2" cy="2" fill="#6ab150"  /&gt;   &lt;/marker&gt;</pre></blockquote><p>El  marcador tiene una anchura y una altura de 4 unidades (<code> markerWidth="4" markerHeight="4"</code> ), y se conecta al trazado por su centro ( <code>refX="2" refY="2"</code> ).</p><p>Pero lo podemos hacer mejor. Utilizando <code>overflow="visible"</code>, un circulo con el centro en el origen del marcador ser&aacute; completamente visible. En este caso ya no necesitamos especificar las coordenadas del centro del circulo ( que por defecto son <code>cx="0" cy ="0"</code> ), ni las dimensiones del marcador, que por defecto son <code>markerWidth="3" y markerHeight="3"</code>. Tampoco necesitamos especificar los atributos <code>refX</code> y <code>refY</code>, ya que por defecto el marcador se conecta al trazado por su esquina derecha arriba – ahora el centro del circulo.</p><blockquote><pre>&lt;marker id="circulo" <span class="str">overflow="visible"</span> &gt;	&lt;circle r="2" fill="#6ab150"  /&gt;   &lt;/marker&gt;</pre></blockquote><p data-height="235" data-theme-id="11360" data-slug-hash="8282dbb94efe006b4560735cbb2530f6" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" data-pen-title="SVG marker #1" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/8282dbb94efe006b4560735cbb2530f6/">SVG marker #1</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>En el ejemplo anterior hemos utilizado <code>marker-mid</code> como <mark>atributo presentacional</mark>. Tambien lo podemos utilizar como propiedad CSS:</p><blockquote><pre>&lt;polyline points=". . . "           style=". . .; <span class="str">marker-mid</span>:url(#circulo);"&gt;&lt;/polyline&gt;</pre></blockquote><p>Todav&iacute;a m&aacute;s: a diferencia de los atributos presentacionales en CSS existe una forma abreviada para especificar todos los tipos de marcadores en una sola declaraci&oacute;n: </p><blockquote><pre>&lt;polyline points=". . . "           style=". . .; <span class="str">marker</span>:url(#circulo);"&gt;&lt;/polyline&gt;</pre></blockquote><p>¡Ojo! la propiedad marker puede ser utilizada solo en CSS y <strong>NO</strong> como atributo presentacional.</p><p data-height="235" data-theme-id="11360" data-slug-hash="2ef4c834247463695b3128573e7d7c13" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" data-pen-title="SVG marker #2" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/2ef4c834247463695b3128573e7d7c13/">SVG marker #2</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="documentos-estructurados.php">Documentos estructurados</a></em></li><li>- <em class="gem"><a class="link_to" href="grupo.php">Agrupar y reutilizar</a></em></li><li>- <em class="gem"><a class="link_to" href="symbol.php">S&iacute;mbolos</a></em></li><li>- <em class="gem">Marcadores</em></li><li>- <em class="gem"><a class="link_to" href="imagenes.php">El elemento image</a></em></li><li>- <em class="gem"><a class="link_to" href="enlaces.php">Enlaces externos</a></em></li><li>- <em class="gem"><a class="link_to" href="switch.php">El elemento switch</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank"  href="http://www.w3.org/TR/SVG/painting.html#MarkerElement">Markers</a><br>
- Sara Soueidan: <a class="link_to" target="_blank"  href="http://sarasoueidan.com/blog/structuring-grouping-referencing-in-svg/">Structuring, Grouping, and Referencing in SVG</a> - The &lt;g&gt;, &lt;use&gt;, &lt;defs&gt; and &lt;symbol&gt; Elements.<br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
