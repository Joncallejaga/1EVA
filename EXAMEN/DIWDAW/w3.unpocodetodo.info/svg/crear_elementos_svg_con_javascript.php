...
<head>
  ...
  <meta name="description" content="C&oacute;mo crear elementos svg, symbol, path y use con JavaScript " />
  <meta name="keywords" content="SVG, crear, javascript, namespace, esp&aacute;cio de nombre, symbol, use, path"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Crear elementos SVG con JS" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/crear_elementos_svg_con_javascript.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo crear elementos svg, symbol, path y use con JavaScript " /> 
  
  <title>Crear elementos SVG con JS</title>
  ...
  <link rel="canonical" href="crear_elementos_svg_con_javascript.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="crear_elementos_svg_con_javascript.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="crear_elementos_svg_con_javascript.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="crear_elementos_svg_con_javascript">
<h2 class="page_title">Crear elementos SVG con JavaScript</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Crear elementos SVG con JS&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fcrear_elementos_svg_con_javascript.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fcrear_elementos_svg_con_javascript.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fcrear_elementos_svg_con_javascript.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12">
  <p>En HTML podemos crear nuevos elementos de manera din&aacute;mica utilizando javascript y el m&eacute;todo <code>createElement</code>:</p>
...
<p>Crear nuevos elementos en SVG es un poco diferente ya que tenemos que utilizar <a class="link_to" target="_blank" href="espaciodenombres.php">espacios de nombre</a>. Para crear un nuevo elemento SVG utilizamos el m&eacute;todo <code>createElementNS</code> donde NS viene de Namespace (espacio de nombre en ingl&eacute;s).</p>

<h4>Crear un nuevo elemento &lt;svg&gt;</h4>
  
<p>Para crear un nuevo elemento svg  necesitamos utilizar el espacio de nombre de este: <a class="link_to" target="_blank" href="http://www.w3.org/2000/svg">http://www.w3.org/2000/svg</a>. Como que el espacio de nombre no cambia podemos guardarlo en una constante javascript:</p>
...
<p>A continuaci&oacute;n podemos establecer algunos atributos del elemento SVG como por ejemplo <code>viewBox</code> o <code>width</code> y <code>hight</code>. &iexcl;OJO! <code>viewBox</code> va en <mark>camelCase</mark>.</p>
...
<p>al final podemos anexar el nuevo elemento SVG al DOM: </p>
...
<h4>Crear un nuevo elemento &lt;symbol&gt;</h4>

<p>Un elemento <a class="link_to" target="_blank" href="symbol.php">&lt;symbol&gt;</a> se utiliza para agrupar elementos SVG con el prop&oacute;sito de reutilizarlos m&aacute;s tarde. Para crear un elemento <code>&lt;symbol&gt;</code> utilizamos como hasta ahora, el espacio de nombre de SVG </p>
...
symbol.appendChild(trazado);</code></pre></article></div>


  
<h4>Crear un nuevo elemento &lt;use&gt</h4>


<p>Crear un nuevo elemento <a class="link_to" target="_blank" href="grupo.php">&lt;use&gt;</a> con JavaScript es un poco m&aacute;s complicado ya que necesitamos otro espacio de nombre para <mark>XML Linking Language (XLink)</mark>: <a class="link_to" target="_blank"  href="http://www.w3.org/1999/xlink">http://www.w3.org/1999/xlink</a>.</p>


<p>Exactamente como antes podemos guardar el espacio de nombre en una constante JavaScript:</p>
...
<p>Vea todo esto en Codepen</p>
<p data-height="300" data-theme-id="11360" data-slug-hash="2dcf3e9fc979704e0342cd058e6a82c8" data-default-tab="js,result" data-user="enxaneta" data-pen-title="Crear elementos svg, symbol, y use con JavaScript*******" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/2dcf3e9fc979704e0342cd058e6a82c8/">Crear elementos svg, symbol, y use con JavaScript*******</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p>
