...
<head>
  ...
  <meta name="description" content="Algunos m&eacute;todos JavaScript &uacute;tiles para el desarollo de aplicaciones SVG." />
  <meta name="keywords" content="JavaScript, SVG, m&eacute;todos, getBBox(),getTotalLength(),getPointAtLength()"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="M&eacute;todos JavaScript para SVG" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/algunos-metodos-js-en-svg.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Algunos m&eacute;todos JavaScript &uacute;tiles para el desarollo de aplicaciones SVG." /> 
  
  <title>M&eacute;todos JavaScript para SVG</title>
  ...
  <link rel="canonical" href="algunos-metodos-js-en-svg.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="algunos-metodos-js-en-svg.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="algunos-metodos-js-en-svg.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="algunos-metodos-js-en-svg"><h2 class="page_title">M&eacute;todos JavaScript para SVG</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=M&eacute;todos JavaScript para SVG&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falgunos-metodos-js-en-svg.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falgunos-metodos-js-en-svg.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falgunos-metodos-js-en-svg.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12">  <h4>El m&eacute;todo getBBox()</h4>  <p>El m&eacute;todo <code>getBBox()</code> devuelve el tama&ntilde;o y las coordenadas de la caja delimitadora ( bounding box ) de un elemento o un grupo de elementos SVG. Devuelve un objeto <code>SVGRect</code> con este aspecto:</p>    <blockquote> <pre>SVGRect {    <code>height</code>: 198.15249633789062    <code>width</code>: 208.07460021972656    <code>x</code>: 10.05737590789795    <code>y</code>: 17.5419979095459}</pre></blockquote>        <p>donde <code>height</code> representa la altura de la caja delimitadora, y <code>width</code> representa la anchura; <code>x</code> e <code>y</code> representan las coordenadas de la esquina izquierda arriba de la caja. Probablemente este es el m&eacute;todo que m&aacute;s utilizo para depuraci&oacute;n en SVG.</p><p>En el siguiente ejemplo estoy utilizando el m&eacute;todo <code>getBBox()</code> para dibujar un rect&aacute;ngulo rojo alrededor de mi gato.</p><p data-height="300" data-theme-id="11360" data-slug-hash="ff90c35389cb8cc3ea2786489ada1c55" data-default-tab="js,result" data-user="enxaneta" data-pen-title="SVG element.getBBox()******" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/ff90c35389cb8cc3ea2786489ada1c55/">SVG element.getBBox()******</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://static.codepen.io/assets/embed/ei.js"></script>  <h4>El m&eacute;todo getTotalLength()</h4>  <p>El m&eacute;todo <code>getTotalLength()</code> devuelve el valor calculado de la longitud total de un trazado SVG.</p><p>En el siguiente ejemplo utilizo la longitud total del trazado <code>#flor</code> para crear una animaci&oacute;n donde un l&aacute;piz invisible dibuja una flor.  Si mira el c&oacute;digo CSS puede ver  dos propiedades cuyo valor es de 1318.824. Este valor representa la longitud total del trazado conseguido utilizando el m&eacute;todo <code>getTotalLength();</code></p><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">stroke-dasharray:1318.824;stroke-dashoffset:1318.824;</code></pre></article></div>       <p>¿De donde lo he sacado? Si mira el JavaScript ver&aacute; esto:</p><div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">console.log(flor.getTotalLength());</code></pre></article></div><p><em class="gem">Lea m&aacute;s acerca de c&oacute;mo animar trazados SVG <a class="link_to" target="_blank" href="svg-loader.php">Crear un sencillo loader SVG</a></em></p><p>Haz click para reanudar la animaci&oacute;n.</p>  <p data-height="300" data-theme-id="11360" data-slug-hash="511a0281fd522880d5f4047299ba18f5" data-default-tab="js,result" data-user="enxaneta" data-pen-title="SVG m&eacute;todo getTotalLength****" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/511a0281fd522880d5f4047299ba18f5/">SVG m&eacute;todo getTotalLength****</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://static.codepen.io/assets/embed/ei.js"></script>    <h4>El m&eacute;todo getPointAtLength()</h4><p>El m&eacute;todo <code>getPointAtLength()</code> devuelve las coordenadas <code>x</code> e <code>y</code> de un punto en el trazado situado a una longitud dada.</p>  <p>En el siguiente ejemplo utilizo un slider para desplazar un punto (circulo <code>#deslizador</code>) siguiendo el trazado <code>#flor</code>. Para calcular la posici&oacute;n del punto en el trazado utilizo el m&eacute;todo <code>getPointAtLength()</code>.</p>  <p data-height="300" data-theme-id="11360" data-slug-hash="b604c775ff3689ef6fb13dacafc28562" data-default-tab="js,result" data-user="enxaneta" data-pen-title="SVG m&eacute;todo getPointAtLength()" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/b604c775ff3689ef6fb13dacafc28562/">SVG m&eacute;todo getPointAtLength()</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://static.codepen.io/assets/embed/ei.js"></script> </div>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="viewport-y-viewbox.php">Viewport y viewBox</a></em></li><li>- <em class="gem"><a class="link_to" href="preserveaspectratio.php">Guardar las proporciones</a></em></li><li>- <em class="gem"><a class="link_to" href="espaciodenombres.php">Espacios de nombre en SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="crear_elementos_svg_con_javascript.php">Crear elementos SVG con JS</a></em></li><li>- <em class="gem">M&eacute;todos JavaScript para SVG</em></li><li>- <em class="gem"><a class="link_to" href="css-svg1.php">SVG con estilo</a></em></li><li>- <em class="gem"><a class="link_to" href="la-posicion-del-raton-en-svg.php">La posici&oacute;n del rat&oacute;n</a></em></li></ul></article></div></div>
