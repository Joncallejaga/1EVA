...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos.SVG - una introducci&oacute;n. Que es el SVG." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, introducci&oacute;n"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="SVG - una introducci&oacute;n" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/introduccion.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos.SVG - una introducci&oacute;n. Que es el SVG." /> 
  
  <title>SVG - una introducci&oacute;n</title>
  ...
  <link rel="canonical" href="http://w3.unpocodetodo.info/svg/introduccion.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="introduccion.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="introduccion.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">SVG - una introducci&oacute;n</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=SVG - una introducci&oacute;n&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fintroduccion.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fintroduccion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fintroduccion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Que significa SVG</h4>
<p><strong>SVG</strong> es el acr&oacute;nimo de <em class="gem">Scalable Vector Grafics</em> ( graficos vectoriales expandibles ), un estandard <strong>W3C</strong> ( <em class="gem">World Wide Web Consortium</em> ), basado en <strong>XML</strong> ( <em class="gem">e<strong>X</strong>tensible <strong>M</strong>arkup <strong>L</strong>anguage</em>). Utilizamos <strong>SVG</strong> para crear im&aacute;genes vectoriales bidimensionales.<br />
El <strong>SVG</strong> es una normativa abierta ( <em class="gem">open standard</em> ) y fue desarrollado por el <strong>W3C</strong> desde 1999.<br />
Hoy en d&iacute;a <a target="_blank" class="link_to" href="http://caniuse.com/%23search=svg">la mayor&iacute;a de los navegadores</a> son capaces de reproducir graficos SVG exactamente como reproducen una imagen.</p>

<h4>A diferencia de canvas</h4>
<p>A diferencia de <em class="gem"><a class="link_to" target="_blank" href="../canvas/introduccion.php">&lt;canvas&gt;</a></em> donde los gr&aacute;ficos son dibujados de manera program&aacute;tica, en el <strong>SVG</strong> los elementos 
pertenecen al <strong>DOM</strong> ( <em class="gem">Document Object Model</em> ). Por ejemplo: si queremos dibujar un circulo, el circulo es en realidad una etiqueta ( <em class="gem">tag</em> )
<code> &lt;circle&gt;</code>, y un <code>&lt;script&gt;</code> puede referirse al circulo y lo puede manipular, casi de la misma manera como puede manipular un <code>&lt;div&gt;</code>.</p>

<h4>El sistema de coordenadas en SVG</h4>
<p>El origen del sistema de coordenadas en SVG, exactamente como en <em class="gem"><a class="link_to" target="_blank" href="../canvas/introduccion.php">&lt;canvas&gt;</a></em> es la <mark>esquina izquierda arriba</mark> del lienzo SVG. Por lo tanto el eje Y aparece al rev&eacute;s, comparado con un sistema normal de coordenadas .</p>


<h4>Un documento SVG</h4>
<!--http://www.w3schools.com/xml/xml_namespaces.asp-->
<p>Podemos f&aacute;cilmente crear documentos SVG utilizando esta estructura:</p>
...
&lt;svg version="1.1" xmlns="http://www.w3.org/2000/svg"
				   ...
				   <!-- el contenido del docunento SVG-->
&lt;/svg></code></pre>
        </article>
</div>
<p><em class="gem">Para entender el porqu&eacute; de esta estructura lea acerca de los <a class="link_to" target="_blank" href="espaciodenombres.php">espacios de nombre en SVG</a> y acerca de <a class="link_to" target="_blank" href="viewport-y-viewbox.php">viewport y viewbox</a></em></p>
 <p>El documento tiene que llevar la extensi&oacute;n <code>.svg</code> ( <em class="gem">ejemplo.svg</em> )<br />
 El documento SVG puede ser <a class="link_to" target="_blank" href="test.svg">abierto directamente en el navegador</a>.</p>




<h4>SVG en el HTML5</h4>
<p>Con la llegada de HTML5, podemos incrustar elementos SVG directamente en las p&aacute;ginas HTML, y en este caso ya no es necesario declarar los espacios de nombre.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
&lt;!DOCTYPE html>
&lt;html>
&lt;title>SVG dibujar un c&iacute;rculo</title>
&lt;body>
...
<p>La anchura y la altura del elemento <code>&lt;svg&gt;</code> pueden ser definidos con los atributos <code>width</code> y <code>height</code> como en el ejemplo anterior,
pero tambi&eacute;n podemos utilizar el <code>CSS</code> con este prop&oacute;sito.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
...
<p>Una imagen SVG comienza con una etiqueta <code>&lt;svg&gt;</code>. Es el contenedor ( el lienzo ) donde vamos a poner los gr&aacute;ficos que dibujamos.</p>
<p>La anchura y la altura del elemento<code> &lt;svg&gt;</code> pueden ser definidos con los atributos <code>width</code> y <code>height</code> respectivamente. 
Tambi&eacute;n podemos utilizar el <code>CSS</code> con este prop&oacute;sito.</p>
<p>El elemento <code>&lt;circle&gt;</code> se utiliza para dibujar un c&iacute;rculo.</p>
<p>Los atributos <code>cx</code> y <code>cy</code> representan las coordenadas <code>x</code> e <code>y</code> del centro del c&iacute;rculo. Si <code>cx</code> y <code>cy</code> se omiten,
 el centro del c&iacute;rculo est&aacute; en el punto <code>x=0, y=0</code> ( esquina izquierda arriba del lienzo SVG ).<br>
  El atributo <code>r</code> define el radio del c&iacute;rculo  ( en este caso <code>40px</code> ).<br>
  El atributo <code>stroke</code> define el color del trazado ( del borde ).<br>
  El atributo <code>stroke-width</code>  define el grosor del trazado ( en este caso <code>4px</code> ).<br>
  El atributo <code>fill</code> define el color de relleno. ( en este caso <code>&#35;6ab150</code> ).</p>
<p>Al final cerramos el contenedor SVG: <code>&lt;/svg&gt; </code>.</p>
