...
<head>
  ...
  <meta name="description" content="Como animar trazados SVG utilizando el evento wheel." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5,stroke-dasharray,stroke-dashoffset, animar trazados,animaci&oacute;n,evento wheel,la rueda del rat&oacute;n"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Animar trazados con wheel" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/animar-trazados-con-wheel.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Como animar trazados SVG utilizando el evento wheel." /> 
  
  <title>Animar trazados con wheel</title>
  ...
  <link rel="canonical" href="animar-trazados-con-wheel.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animar-trazados-con-wheel.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animar-trazados-con-wheel.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="animar-trazados-con-wheel"><h2 class="page_title">Animar trazados con wheel</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Animar trazados con wheel&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimar-trazados-con-wheel.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimar-trazados-con-wheel.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimar-trazados-con-wheel.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12"><p>El evento Wheel se dispara cuando movemos la rueda del rat&oacute;n. Podemos utilizar este evento para animar trazados SVG.En el siguiente ejemplo tenemos un rect&aacute;ngulo dibujado con <code>polygon</code>, pero podemos utilizar tambi&eacute;n rect o <code>polyline</code> o incluso <code>path</code>.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;svg width="250" height="250" viewBox="0 0 250 250"&gt;     &lt;polygon points="50,50 200,50 200,200 50 200"               style="fill:none;                     stroke:#000;                     stroke-width:30;                     stroke-linecap:round;                     stroke-linejoin:round;"              &gt;&lt;/polygon&gt;&lt;/svg&gt;</code></pre>					        </article></div>	<p>Para animar el trazado vamos a utilizar el atributos <code>stroke-dasharray</code>, que dibuja l&iacute;neas discontinuas en SVG y <code>stroke-dashoffset</code> que especifica el desplazamiento inicial al crear l&iacute;neas discontinuas.</p><h4>Un ejemplo f&aacute;cil</h4><p>El rect&aacute;ngulo cuyo borde queremos animar tiene un per&iacute;metro de <code>600px</code> (150 * 4). As&iacute; que necesitamos que el valor de <code>stroke-dasharray = 600</code>. Esto quiere decir que el patr&oacute;n de l&iacute;neas discontinuas utilizado est&aacute; formado por fragmentos de l&iacute;nea de <code>600px</code> seguidos por espacios de <code>600px</code>. En el JavaScript guardamos este valor en una variable, y tambi&eacute;n establecemos el valor de <code>stroke-dasharray</code> en CSS.</p><blockquote><pre>var dasharray = 600;svg.style.strokeDasharray = dasharray;</pre></blockquote><p>En JavaScript utilizamos <code>strokeDasharray</code> en lugar de <code>stroke-dasharray</code>, porque, ya se sabe: para referirnos a una propiedad CSS en JavaScript debemos utilizar CamelCase.</p><p>Tambi&eacute;n establecemos el valor del atributo <code>stroke-dashoffset = 600</code>. Esto quiere decir que la primera raya del patr&oacute;n aparece a <code>600px</code> (en este caso) del inicio del trazado. Pr&aacute;cticamente no hay raya a la vista.</p><h4>El evento Wheel</h4><p>El evento <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/Reference/Events/wheel">wheel</a> se dispara al mover la rueda del rat&oacute;n. Para ver todas las propiedades y m&eacute;todos de este evento podemos escribir:</p><blockquote><pre>document.addEventListener("wheel", function(<span class="str">e</span>) { console.log(<span class="str">e</span>); }, false);</pre></blockquote><p>y consultar lo que sale en la consola del navegador. </p><p>El comportamiento predeterminado del evento <code>wheel</code> es desplazar ( normalmente ) hacia abajo o hacia arriba al elemento de destino del evento ( <em class="gem">event target</em> ), el documento en este caso. Para que esto no pase tenemos que prevenir el comportamiento por defecto utilizando </p><blockquote><pre>e.preventDefault();</pre></blockquote><p>Pero lo que nos interesa en este momento es la propiedad <code>deltaY</code>: que representa el valor del desplazamiento vertical. Podemos utilizar este valor para modificar el valor del atributo <code>stroke-dashoffset</code> (<code>strokeDashoffset</code> en JavaScript): </p><blockquote><pre>var dashoffset = 600;. . . . . . . . . . .<span class="str">dashoffset -= e.deltaY;</span>. . . . . . . . . . .svg.style.strokeDashoffset = dashoffset;</pre></blockquote><p>Tambi&eacute;n tenemos que limitar el valor de <code>stroke-dashoffset</code> par que no sea nunca m&aacute;s grande de 600 o mas pequeño de 0:</p><blockquote><pre>if (dashoffset &gt; 0 &amp;&amp; e.deltaY &gt; 0 ||       dashoffset &lt; 600 &amp;&amp; e.deltaY &lt; 0) {      dashoffset -= e.deltaY;   }if(dashoffset &lt; 0)dashoffset = 0;if(dashoffset &gt; 600)dashoffset = 600;</pre></blockquote><p data-height="370" data-theme-id="11360" data-slug-hash="ebe173efa43d1bb5b7ac133f48292255" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="event wheel stroke-dashoffset" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/ebe173efa43d1bb5b7ac133f48292255/">event wheel stroke-dashoffset</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>Y lo interesante es que podemos hacer lo mismo con texto:</p><p data-height="370" data-theme-id="11360" data-slug-hash="c7791761ff3baa79472ccded3309b3d6" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="evento wheel stroke-dashoffset*" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/c7791761ff3baa79472ccded3309b3d6/">evento wheel stroke-dashoffset*</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>Otro ejemplo que utiliza el evento <code>wheel</code>. El SVG es algo m&aacute;s complicado pero, como puede, ver el JavaScript queda casi sin cambiar.</p><p data-height="370" data-theme-id="11360" data-slug-hash="d1afccece949d70cc812c5a3e857a952" data-default-tab="js,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Have a coffee" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/d1afccece949d70cc812c5a3e857a952/">Have a coffee</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></div>           </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="arrastrar-y-soltar.php">Arrastrar y soltar en SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="arrastrar-y-soltar2.php">Arrastrar y soltar en SVG (2)</a></em></li><li>- <em class="gem"><a class="link_to" href="poligonos-regulares.php">Pol&iacute;gonos regulares</a></em></li><li>- <em class="gem"><a class="link_to" href="dibujar-estrellas.php">Dibujar estrellas</a></em></li><li>- <em class="gem"><a class="link_to" href="hormigas-andadoras.php">Hormigas andadoras</a></em></li><li>- <em class="gem">Animar trazados con wheel</em></li><li>- <em class="gem"><a class="link_to" href="svg-loader.php">loader SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="botones.php">&Iacute;conos SVG</a></em></li><li>- <em class="gem"><a class="link_to" href="yinyang.php">Yin y Yang con path</a></em></li><li>- <em class="gem"><a class="link_to" href="on-scroll.php">Animaciones on scroll</a></em></li><li>- <em class="gem"><a class="link_to" href="gajo.php">Dibujar un sector circular</a></em></li><li>- <em class="gem"><a class="link_to" href="rueda-cromatica.php">Rueda crom&aacute;tica</a></em></li><li>- <em class="gem"><a class="link_to" href="graficos-circulares1.php">Gr&aacute;ficos circulares (1)</a></em></li><li>- <em class="gem"><a class="link_to" href="graficos-circulares3.php">Gr&aacute;ficos circulares (3)</a></em></li><li>- <em class="gem"><a class="link_to" href="graficos-circulares4.php">Gr&aacute;ficos circulares (4)</a></em></li><li>- <em class="gem"><a class="link_to" href="graficos-circulares2.php">Gr&aacute;ficos circulares (2)</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- El evento <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/Reference/Events/wheel">wheel</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
