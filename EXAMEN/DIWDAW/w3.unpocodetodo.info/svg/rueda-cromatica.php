...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Construir una rueda crom&aacute;tica con SVG" />
  <meta name="keywords" content="SVG, sector circular,colores HSL, path,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Rueda crom&aacute;tica" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/rueda-cromatica.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Construir una rueda crom&aacute;tica con SVG" /> 
  
  <title>Rueda crom&aacute;tica</title>
  ...
  <link rel="canonical" href="rueda-cromatica.php"> 
 
  <style>
.g_panel.js article{max-height:100%}
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="rueda-cromatica.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="rueda-cromatica.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="rueda-cromatica">
<h2 class="page_title">Rueda crom&aacute;tica</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Rueda crom&aacute;tica&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Frueda-cromatica.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Frueda-cromatica.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Frueda-cromatica.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" target="_blank" href="gajo.php">Dibujar un sector circular</a></em></p>
<p>Si sabemos dibujar un sector circular lo dem&aacute;s es muy f&aacute;cil. Para construir la rueda crom&aacute;tica necesitamos 360 sectores circulares de 1º cada, cuyo relleno <code>fill</code>  tiene como valor un color HSL. Para dibujar cada sector circular utilizamos el elemento <code>&lt;path&gt;</code>.</p>
<p><em class="gem">Que son los <a class="link_to" target="_blank" href="../css3/hsl.php">colores HSL</a></em></p>

<p>Empezamos calculando algunas variables necesarias. Queremos poder modificar el tama&ntilde;o del lienzo SVG y del gr&aacute;fico, sin tener que volver a calcular el centro del circulo. 
  Para esto obtenemos una referencia al lienzo SVG y la almacenamos en una variable ( <code>var lienzoSVG</code> ). Ahora podemos calcular la anchura y la altura del lienzo SVG, y todo lo dem&aacute;s.</p>
<div class="large-12 g_panel js">
        <article><pre><code class="language-javascript">
...
var r = (w/2) -10;</code></pre>
        </article>
</div>


<p>A continuaci&oacute;n definimos algunas funciones necesarias: la funci&oacute;n <code>dGajo</code> que calcula el valor del par&aacute;metro <code>d</code> para <code>&lt;path&gt;</code> y la funci&oacute;n nuevoGajo crea un nuevo elemento <code>&lt;path&gt;</code> ( el nuevo sector circular )  y lo adjunta al lienzo SVG.</p>
<p>La funci&oacute;n <code>dGajo</code> calcula el valor del parametro d para <code>path:</code></p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">function dGajo(ap,af){
...
<p>La funci&oacute;n <code>nuevoGajo</code> crea un nuevo elemento <code>path</code> y lo adjunta al lienzo SVG: </p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">function nuevoGajo(ap,af, color){
...
<p>NOTA: <em class="gem">para entender la funci&oacute;n dGajo y nuevoGajo por favor lea este articulo: <a class="link_to" target="_blank" href="gajo.php">Dibujar un sector circular</a></em></p>
<p>Ahora viene lo interesante. Queremos construir 360 sectores circulares de 1º cada. El relleno <code>fill</code> de estos sectores circulares es un color HSL.</p>

<h4>Hablemos un poco de colores HSL</h4>
<p>La sintaxis para los colores HSL es: hsl( hue, saturation%, lightness% ) </p><blockquote><pre>&lt;path fill = &quot;hsl(180,100%,50%)&quot; . . .</pre></blockquote>
<p>El primer par&aacute;metro hue ( <em class="gem">hsl(<strong class="str">180</strong>,100%,50%)</em> ) puede tomar valores de 0 a 359 ya que se trata de un &aacute;ngulo en la rueda de los colores: un azul en este caso. <br />
  Podemos conseguir varios tonos de este color, modificando la saturaci&oacute;n ( <em class="gem">hsl(180,<strong class="str">100%,</strong>50%</em>) ) o podemos crear colores m&aacute;s claros o m&aacute;s oscuros modificando la luminosidad ( ( <em class="gem">hsl(180,100%,<strong class="str">50%</strong>)</em> ), pero lo que realmente nos interesa para construir una rueda crom&aacute;tica es el primer par&aacute;metro: hue.<br />
  Si queremos construir una rueda crom&aacute;tica, con cada grado, con cada nuevo sector circular, el valor del componente hue del color se ve incrementado en un punto. O sea tenemos que escribir un bucle for que calcula el color HSL y dibuja el nuevo sector circular.</p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
for( var i = 0; i &lt; 360; i++){
  var ap = i; // el &aacute;ngulo inicial
  var af = i+1; // el &aacute;ngulo final
...
<p>Al final a&ntilde;adimos unas cuantas l&iacute;neas m&aacute;s de c&oacute;digo, para que al hacer clic en uno de los sectores circulares que componen la rueda de los colores podamos recuperar el c&oacute;digo hsl del color.</p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
...
<svg id = "lienzoSVG" height="250" width="250">
</svg></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
...
// la funci&oacute;n dGajo calcula el valor del parametro d para path
...
// la funci&oacute;n nuevoGajo crea un nuevo elemento path	y lo adjunta al lienzo SVG 
...
<div class="large-12 g_panel resultado" id="ruedaCromatica">
 <article>
