...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos Escribiendo en el SVG con text." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, texto, text, l&iacute;nea base, stroke, stroke-width, fill, font-family, font-size, letter-spacing, word-spacing, text-decoration."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Escribiendo en el SVG" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/texto.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos Escribiendo en el SVG con text." /> 
  
  <title>Escribiendo en el SVG</title>
  ...
  <link rel="canonical" href="texto.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="texto.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="texto">
<h2 class="page_title">Escribiendo en el SVG</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Escribiendo en el SVG&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ftexto.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ftexto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ftexto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para escribir en el SVG utilizamos el elemento <code>&lt;text&gt;</code>. En el siguiente ejemplo la l&iacute;nea roja dibujada con <code>&lt;path&gt;</code> representa la l&iacute;nea base del texto ( <em class="gem">alignment baseline</em> ).</p>
<p><strong>Definici&oacute;n:</strong> <em class="gem">En tipograf&iacute;a y caligraf&iacute;a la <a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/L&iacute;nea_de_base_(tipograf&iacute;a)">l&iacute;nea base</a>
es la l&iacute;nea sobre la que se asientan la mayor&iacute;a de las letras y por debajo de la cual se extienden los trazos descendentes.</em></p>

<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="60" viewBox="0 0 250 60">
   <text x="30" y="40" style="font-family: Consolas">l&iacute;nea base del texto</text>
   <path class="linea_base" d="m30,40 h180" style="stroke:#f00; stroke-width:.5; fill:none;" />
</svg></code></pre>								
        </article>
</div>  
...
<p>El elemento<code> &lt;text&gt;</code> puede ser utilizado junto con una serie de atributos entre los cuales los m&aacute;s importantes son <code>x</code> e <code>y</code>. 
  En este ejemplo el atributo <code>x</code> representa la coordenada horizontal del punto donde empieza el texto. 
  Tanto la <code>x</code> como la <code>y</code> coinciden con el punto de partida de la <mark>l&iacute;nea base</mark> del texto ( la l&iacute;nea roja trazada con <code>&lt;path&gt;</code> ).</p>
<blockquote><pre>
  &lt;text x = "30</strong>" y = "<strong class="str">40</strong>" style="font-family: Consolas">línea base del texto&lt;/text>
  &lt;path class= "linea_base" d= "m<strong class="str">30,40</strong> h180" style="stroke:#f00;. . .</pre></blockquote>

<h4>stroke, stroke-width, fill</h4>
<p>El atributo <code>fill</code> decide el color de relleno del texto, y de cualquier objeto SVG. Si no definimos el color de relleno, este es por defecto negro.<br>
  El atributo <code>stroke</code> pone, letra por letra, un borde al texto. Por defecto el texto, y todos los dem&aacute;s objetos SVG, no tienen borde.<br>
  El atributo <code>stroke-width</code> define la anchura del borde. </p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="160" viewBox="0 0 250 160">
   <text x="20" y="50" fill="#f00" style="font-size: 40px">relleno rojo</text>
   <text x="20" y="90" fill="none" stroke="#000" style="font-size: 40px">borde negro</text>
   <text x="10" y="130" fill="none" stroke="#000" stroke-width="2" style="font-size: 40px">borde de 2px</text>
</svg></code></pre>								
        </article>
</div>  
...
<h4>font-family, font-size,<br><small>letter-spacing, word-spacing, text-decoration...</small></h4>
<p>El texto SVG acepta una serie de atributos conocidos desde CSS como: <code>font-family</code>, <code>font-size</code>, <code>letter-spacing</code>, <code>word-spacing</code>, <code>text-decoration</code>...
  Pueden der utilizados tanto como atributos ( <code>font-size="18"</code> )  o como propiedades CSS ( <code>style="font-size:18px"</code> )</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="90" viewBox="0 0 250 90">
  <text x="20" y="30" fill="#f00" font-size="18">atributo</text>
  <text x="20" y="60" fill="#00f" style="font-size:18px">propiedad CSS</text>
</svg></code></pre>								
        </article>
</div>  
...
<p>A continuaci&oacute;n damos una lista indicativa y no exhaustiva con los atributos que pueden ser utilizados con <code>&lt;text&gt;</code>.</p>
<table class="svg">
<thead>
    <tr>
      <th>Atributo</th>
  ...
  <tr>
      <td>stroke</td>
      <td>style = "stroke: #000000";<br>
      o<br>
      stroke = "black"</td>
      <td>El color de la l&iacute;nea que dibuja un borde alrededor del texto. Por defecto el texto tiene solo color de relleno. Al ponerle un borde, el texto aparece como negrita.</td>
      </tr>
    <tr>
      <td>stroke-width</td>
      ...
      o<br>
      stroke-width = "2"</td>
      <td>El grosor de l&iacute;nea que dibuja un borde alrededor del texto.</td>
      </tr>
    <tr>
      <td>fill</td>
      <td>style = "fill: #00ff00;"<br>
      o<br>
      fill="#00ff00"</td>
      <td>El color de relleno del texto.</td>
      </tr>
    <tr>
      <td>rotate</td>
    ...
    <tr>
      ...
      <td>La familia de fuente a utilizar .</td>
      </tr>
    <tr>
      <td>font-size</td>
      <td>style = "font-size:16px;"</td>
      <td>El tama&ntilde;o de fuente.</td>
      </tr>
    <tr>
      <td>kerning</td>
      <td>style = "kerning:2;"</td>
      <td>Espaciado entre letras.</td>
      </tr>
    <tr>
      <td>letter-spacing</td>
      <td>style = "letter-spacing:3;"</td>
      <td>Espaciado entre letras; similar a  kerning.</td>
      </tr>
    <tr>
      <td>word-spacing </td>
      <td>style = "word-spacing:3;"</td>
      <td>Espaciado entre palabras.</td>
      </tr>
    <tr>
      <td>text-decoration </td>
      <td>style = "text-decoration: underline;"</td>
      <td>Decoraci&oacute;n de texto. Puede tomar uno de estos valores: underline, overline<br class="hide-for-large">o line-through.</td>
      </tr>
    <tr>
      <td>text-anchor</td>
      <td>style = "text-anchor: start"</td>
      <td>start, middle, end</td>
      </tr>
<!--    <tr>
      <td>alignment-baseline</td>
      <td>alignment-baseline: baseline</td>
      <td>baseline | before-edge | text-before-edge | middle | central | after-edge | text-after-edge | ideographic | alphabetic | hanging | mathematical</td>
      <td>baseline</td>
    </tr>-->
    <tr>
      <td>dominant-baseline</td>
      <td>dominant-baseline: middle</td>
      <td>auto | use-script | no-change | reset-size | ideographic | alphabetic | hanging | mathematical | central | middle |<br class="hide-for-large">text-after-edge | text-before-edge | inherit</td>
      </tr>
    <tr>
      <td>baseline-shift</td>
      <td>baseline-shift:  super;</td>
      <td>auto | baseline |<br class="hide-for-large"> sup | sub | <em class="gem">porcentaje</em> | <em class="gem">extensi&oacute;n</em> | inherit</td>
      </tr>
    <tr>
      <td>text<br class="hide-for-large">Length</td>
      <td>textLength = "150"</td>
      <td><em class = "gem">n&uacute;mero</em></td>
      </tr>
    <tr>
      <td>length<br class="hide-for-large">Adjust</td>
      <td>lengthAdjust = "spacing"</td>
      <td>spacing | spacingAndGlyphs
        <!--<br>Utilizado junto con textLength para especificar si hay que ajustar solo el espaciado entre letras, o ajustar tanto el espaciado como el tama&ntilde;o de texto--></td>
      </tr>
    <tr>
      <td>writing-mode</td>
      <td>style = "writing-mode: tb;"</td>
      <td>tb (Top to Bottom  =  de arriba a abajo);<br>rl (right to left =<br class="hide-for-large"> de derecha a izquierda );<br>lr (left to right =<br class="hide-for-large"> de izquierda a derecha);</td>
      </tr>
    <tr>
      <td>start<br class="hide-for-large">Offset</td>
      <td>startOffset = "30%"</td>
      <td>porcentaje</td>
      </tr>
    <tr>
      <td>glyph-orientation-vertical</td>
      <td>glyph-orientation-vertical = "90"</td>
      <td>grados<br class="hide-for-large">sexagesimales</td>
      </tr>
    <tr>
      <td>glyph-orientation-horizontal</td>
      <td>glyph-orientation-horizontal = "270"</td>
      <td>grados<br class="hide-for-large">sexagesimales</td>
      </tr>
    ...
    <tr>
      ...
      <td>rtl (right to left);<br class="hide-for-large">ltr (left to right);</td>
      </tr>
  </tbody>
</table>
</div>
