...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar formas geom&eacute;tricas primitivas en SVG. C&iacute;rculos, elipses, rect&aacute;ngulos, pol&iacute;gonos y polil&iacute;neas" />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, dibujar, circulo, circle, elipse, rect&aacute;ngulo, rectangulo, rect, poligono, polygon, polilinea, polyline"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Formas geom&eacute;tricas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/formas-geometricas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar formas geom&eacute;tricas primitivas en SVG. C&iacute;rculos, elipses, rect&aacute;ngulos, pol&iacute;gonos y polil&iacute;neas" /> 
  
  <title>Formas geom&eacute;tricas</title>
  ...
  <link rel="canonical" href="formas-geometricas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="formas-geometricas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="formas-geometricas.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="formas-geometricas">
<h2 class="page_title">Formas geom&eacute;tricas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Formas geom&eacute;tricas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fformas-geometricas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fformas-geometricas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fformas-geometricas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El SVG nos permite dibujar varias <em class="gem"><a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/Primitiva_geométrica">formas geom&eacute;tricas primitivas</a></em>.</p>
...
<tbody>
  <tr>
    <td>&lt;circle&gt;</td>
    <td>&lt;circle cx ="50" cy ="75" r ="40" stroke ="black" stroke-width ="4" fill ="#6ab150" /&gt;</td>
    <td>Dibuja un c&iacute;rculo</td>
  </tr>
  <tr>
    <td>&lt;ellipse&gt;</td>
    <td>&lt;ellipse cx ="100" cy ="75" rx ="50" ry ="50" fill ="#6ab150" stroke ="red" stroke-width ="5" /&gt;</td>
    <td>Dibuja una elipse</td>
  </tr>
  <tr>
    <td>&lt;rect&gt;</td>
    <td>&lt;rect x ="10" y ="10" height ="100" width ="100" style ="stroke:#000; fill: #6ab150"/&gt;</td>
    <td>Dibuja un rect&aacute;ngulo</td>
  </tr>
  <tr>
    <td>&lt;rect&gt;</td>
    <td>&lt;rect x ="10" y ="120" height ="100" width ="100" rx ="10" <strong class="str">ry  ="10"</strong> style ="stroke:#000; fill: #6ab150"/&gt;</td>
    <td>Dibuja un rect&aacute;ngulo con esquinas redondeadas</td>
  </tr>
  <tr>
    <td>&lt;polygon&gt;</td>
...
<!--  <tr>
    <td>&lt;line&gt;</td>
<td>&lt;line x1 ="10" y1 ="10" x2 ="200" y2 ="10" stroke="black" stroke-width ="2"&gt; </td>
    <td>Dibuja una l&iacute;nea desde <code>x1,y1</code> hasta <code>x2,y2</code>. </td>
  </tr>-->
  <tr>
    <td>&lt;polyline&gt;</td>
...
<h4 id="circle">C&iacute;rculo</h4>
<p>En <code>SVG</code> el elemento <code>&lt;circle&gt;</code> es utilizado para dibujar c&iacute;rculos. Los atributos <code>cx</code> y <code>cy</code> definen las coordenadas del centro y el atributo <code>r</code> define el radio del c&iacute;rculo.  Si <code>cx</code> y <code>cy</code> no est&aacute;n especificados, el centro del c&iacute;rculo est&aacute; en el origen del canvas, el punto cuyas coordenadas son: <code>x=0</code>, <code>y=0</code> ( la esquina izquierda arriba del lienzo SVG ).</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <circle cx="125" cy="75" r="40" stroke="black" stroke-width="4" fill="#6ab150" />
</svg></code></pre>
        </article>
</div>  
...
<h4 id="elipse">Elipse</h4>
<p>En <code>SVG</code> para dibujar una elipse utilizamos el elemento <code>&lt;elipse&gt;</code>. Los atributos <code>cx</code> y <code>cy</code> definen las coordenadas del centro 
mientras que los atributos <code>rx</code> y <code>ry</code> definen los radios horizontal ( <code>rx</code> ) y vertical ( <code>ry</code> ) respectivamente.<br>
Si <code>rx = ry</code> el resultado es un c&iacute;rculo. En el siguiente ejemplo <code>rx &gt; ry</code>,  lo que hace que la elipse sea m&aacute;s ancha que alta. Huelga decir que si <code>rx</code> == <code>ry</code> el resultado es un c&iacute;rculo.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <ellipse cx="125" cy="75" rx="70" ry="50" fill="#6ab150" stroke="red" stroke-width="5" />
</svg></code></pre>
        </article>
</div>  
...
<h4 id="rect">Rect&aacute;ngulo</h4>
<p>Para dibujar un rect&aacute;ngulo podemos utilizar el elemento <code>&lt;rect&gt;</code>. Los atributos <code>x</code> e <code>y</code> definen las coordenadas de la esquina arriba izquierda del rect&aacute;ngulo, mientras que 
los atributos <code>height</code> y <code>width</code> definen la anchura y la altura del mismo.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <rect x="70" y="25" height="100" width="120" style="stroke:#000; fill: #6ab150"/>
</svg></code></pre>
        </article>
</div>  
<div class="large-12 g_panel resultado">
...
<h4>Rect&aacute;ngulos con esquinas redondeadas</h4>
<p>Podemos crear rect&aacute;ngulos con esquinas redondeadas declarando otros dos atributos: 
<code>rx</code> y <code>ry</code>, donde, exactamente como en el caso de las elipses, <code>rx</code> representa el radio horizontal, y <code>ry</code> el radio vertical.<br>
Si no declaramos <code>ry</code> se considera que <code>ry = rx</code>.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <rect x="70" y="25" height="100" width="120" rx="15" style="stroke:#000; fill: #6ab150"/>
</svg></code></pre>
        </article>
</div>  
<div class="large-12 g_panel resultado">
...
<h4 id="polygon">Pol&iacute;gono</h4>
<p>En <code>SVG</code> podemos dibujar tambi&eacute;n pol&iacute;gonos. El  elemento <code>&lt;polygon&gt;</code> dibuja l&iacute;neas entre los puntos definidos por el atributo <code>points</code>. 
En el siguiente ejemplo empezamos a dibujar en el punto <!--cuyos coordenados son --><code>x = 125</code>, <code>y = 10</code>.</p>
  <blockquote><p>&lt;polygon points ="<strong class="str">125,10</strong> 175,130 75,130"...</p></blockquote>
  <p>el segundo punto tiene las coordenadas <code>x = 175</code>, <code>y = 130</code>.</p>
  <blockquote><p>&lt;polygon points ="125,10 <strong class="str">175,130</strong> 75,130"...</p></blockquote>
  <p>Observe por favor que la coma aparece solo entre el <code>x</code> y el <code>y</code>. Los puntos est&aacute;n separados entre s&iacute; por un espacio.</p>
<div class="large-12 g_panel html">
        <article>								
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <polygon points="125,10 175,130 75,130" style="fill:#6ab150;stroke:#003300;stroke-width:3" />
</svg></code></pre>
        </article>
</div>  
...
<h4 id="polyline">Polil&iacute;nea</h4>
<p>Parece que la &uacute;nica diferencia entre <code>&lt;polygon&gt;</code> y <code>&lt;polyline&gt;</code> es que el <code>&lt;polygon&gt;</code> cierra el trazado, mientras que <code>&lt;polyline&gt;</code> no.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="150" viewBox="0 0 250 150">
   <polyline points="125,10 175,130 75,130" style="fill:#6ab150;stroke:#003300;stroke-width:3" />
</svg></code></pre>								
        </article>
</div>  
...
<p><em class="gem">
- La  especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/shapes.html">Basic Shapes</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
