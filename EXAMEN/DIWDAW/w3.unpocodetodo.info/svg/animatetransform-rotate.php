...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Girar con animateTransform. Dibujar una cinta de magnet&oacute;fono que gira, y un cron&oacute;metro SVG." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, animaciones, animateTransform, rotate, girar, cinta de magnet&oacute;fono, cron&oacute;metro, reloj, stroke-dasharray"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Girar con animateTransform" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/animatetransform-rotate.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Girar con animateTransform. Dibujar una cinta de magnet&oacute;fono que gira, y un cron&oacute;metro SVG." /> 
  
  <title>Girar con animateTransform</title>
  ...
  <link rel="canonical" href="animatetransform-rotate.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animatetransform-rotate.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animatetransform-rotate.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="animatetransform-rotate">
<h2 class="page_title">Girar con animateTransform</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Girar con animateTransform&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatetransform-rotate.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatetransform-rotate.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatetransform-rotate.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para facilitar las cosas es aconsejable poner los objetos que deseamos girar en el origen del lienzo SVG ( <code>x="0" y="0"</code> ), y despu&eacute;s trasladar el objeto all&aacute; donde nos apetezca.</p>
<h4>Una cinta de magnet&oacute;fono</h4>
<p>A continuaci&oacute;n queremos dibujar una cinta de magnet&oacute;fono, de las de antes. Para esto dibujamos un circulo sin relleno: <code>fill:none</code> con un borde muy grueso: <code>stroke-width:40</code>. 
Utilizamos el atributo <code>stroke-dasharray:42, 42;</code> para que el borde sea una l&iacute;nea discontinua.</p>
<p><em class="gem">Lea m&aacute;s acerca del atributo <a class="link_to" target="_blank" href="lineas.php#dasharray">stroke-dasharray</a></em></p>
<p><strong>Sugerencia del chef</strong>: para un sabor distinto pruebe tambi&eacute;n:
  <code>stroke-dasharray:9, 9;</code> 
  <code>stroke-dasharray:14, 14;</code>  o
  <code>stroke-dasharray:18, 18</code> </p>
<p>Para darle al c&iacute;rculo un movimiento giratorio utilizamos el elemento <code>&lt;animateTransform&gt;</code>. Queremos animar el atributo <code>transform</code> ( <code>attributeName="transform"</code> ), un atributo de tipo XML ( <code>attributeType="xml"</code> ). Tambi&eacute;n tenemos que especificar el tipo de transformaci&oacute;n: <code>type="rotate"</code>. Se trata de un movimiento giratorio de 
360&deg; o sea <code>from="0" to="360"</code>. Otra posibilidad es utilizar el atributo <code>by="360"</code> en lugar de los atributos <code>from</code> y <code>to</code>. 
Una vuelta completa dura 5 segundos ( <code>dur="5s"</code> ) y la animaci&oacute;n se repite de forma indefinida ( <code>repeatCount = "indefinite</code>" ).<br>
Tambi&eacute;n dibujamos un peque&ntilde;o c&iacute;rculo rojo para marcar el centro de la "cinta magn&eacute;tica", y otro c&iacute;rculo ( <code>radio r="70"</code> ) para marcar el borde exterior.<br>
Ninguno de estos c&iacute;rculos no tiene declarados los atributos <code>cx</code> y <code>cy</code>. Si esto pasa el SVG considera que <code>cx="0"</code> y <code>cy="0"</code>, y dibuja los 
c&iacute;rculos con el centro en el origen del lienzo SVG. Esto nos viene de maravilla porque, ya lo sabemos, el movimiento giratorio pasa alrededor de este punto. Lo que tenemos que hacer es 
envolver todos estos c&iacute;rculos en un elemento <code>&lt;g&gt;</code> y trasladar el grupo en el centro del lienzo.</p>
<blockquote><p>&lt;g transform= "translate(125, 100)" &gt;</p></blockquote>
<div class="large-12 g_panel html">
        <article>	
        <pre><code class="language-markup">
<svg width="250" height="200">
  <g transform="translate(125, 100)"> 
    <circle r="70" style="fill:none;stroke:black"/>
    <circle r="40" style="fill:none;stroke:black; stroke-width:40; stroke-dasharray:42, 42;"><!-- 9, 14, 18, 42-->
      <animateTransform attributeType="xml" attributeName="transform" type="rotate" by="360" dur="5s" repeatCount="indefinite" />
    </circle>
    <circle r="4" style="fill:red" />
  </g>
</svg></code></pre>							
        </article>
</div>
...
<h4>Cron&oacute;metro SVG</h4> 
<p>Podemos f&aacute;cilmente construir un cron&oacute;metro SVG utilizando <code>&lt;animateTransform&gt;</code>. <br>
Despu&eacute;s de dibujar el disco del reloj ( <code>&lt;circle r= "70" . . . </code>) y los marcadores de tiempo, dibujamos las manillas del reloj.<br>
  Una l&iacute;nea de <code>50px</code> de larga y una anchura <code>stroke-width = 3</code> marca las horas. Esta l&iacute;nea hace un giro completo ( <code>by="360"</code> ) en 12 horas ( <code>dur ="12h"</code> ).<br>
  Otra l&iacute;nea larga de <code>55px</code> y con una anchura <code>stroke-width = 2</code> marca los minutos. Esta l&iacute;nea hace un giro completo ( <code>by="360"</code> ) en 1 hora ( <code>dur ="60min"</code> ).<br>
  Finalmente la l&iacute;nea que marca los segundos ( <code>60px</code> de larga, <code>stroke-width = 1</code> ) hace un giro completo ( <code>by="360"</code> ) en 1 minuto ( <code>dur ="60s"</code> ).</p>
<p>Como en el ejemplo anterior, dibujamos todos los componentes del cron&oacute;metro en el origen del lienzo SVG ( <code>x="0" y="0"</code> ), los envolvemos en un elemento <code>&lt;g&gt;</code> 
y los trasladamos en el centro del lienzo.</p>
<blockquote><p>&lt;g transform= "translate(125,100)"&gt;</p></blockquote>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
<svg width="250" height="200">
  <g transform="translate(125,100)">
    <title>Reloj</title>
    <circle r="70" fill="#fefeef" stroke="darkOrange" stroke-width="2" />
    <g>
      <title>Marcadores de tiempo</title>
      <line x1="60" y1="0" x2="67" y2="0" stroke="#6ab150" />
      <line x1="52" y1="30" x2="58" y2="34" stroke="#6ab150" />
      <line x1="30" y1="52" x2="34" y2="58" stroke="#6ab150" />
      <line x1="0" y1="60" x2="0" y2="67" stroke="#6ab150" />
      <line x1="-30" y1="52" x2="-34" y2="58" stroke="#6ab150" />
      <line x1="-52" y1="30" x2="-58" y2="34" stroke="#6ab150" />
      <line x1="-60" y1="0" x2="-67" y2="0" stroke="#6ab150" />
      <line x1="-52" y1="-30" x2="-58" y2="-34" stroke="#6ab150" />
    ...
    <g>
      <title>Las manillas del reloj</title>
      <line id="segundos" y2="-60" stroke="gold" stroke-width="1">
        <animateTransform attributeType="xml" attributeName="transform" type="rotate" repeatCount="indefinite" dur="60s" by="360" />
      </line>
      <line id="minutos" y2="-55" stroke="gold" stroke-width="2">
        <animateTransform attributeType="xml" attributeName="transform" type="rotate" repeatCount="indefinite" dur="60min" by="360" />
      </line>
      <line id="horas" y2="-50" stroke="gold" stroke-width="3">
        <animateTransform attributeType="xml" attributeName="transform" type="rotate" repeatCount="indefinite" dur="12h" by="360" />
      </line>
    </g>
  </g>
</svg></code></pre>
