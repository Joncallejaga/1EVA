...
<head>
  ...
  <meta name="description" content="El filtro feTurbulence&gt crea una imagen semitransparente, que puede ser utilizada junto con otros filtros para crear un efecto como de ondas al agua" />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, filtros SVG, feTurbulence, turbulence, fractalNoise,type, baseFrequency, numOctaves,seed, stitchTiles"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="feTurbulence" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/feturbulence.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El filtro feTurbulence&gt crea una imagen semitransparente, que puede ser utilizada junto con otros filtros para crear un efecto como de ondas al agua" /> 
  ...
  <link rel="canonical" href="feturbulence.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="feturbulence.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="feturbulence.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="feturbulence"><h2 class="page_title">feTurbulence</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=feTurbulence&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ffeturbulence.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ffeturbulence.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Ffeturbulence.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12">  <p>El filtro <code>&lt;feTurbulence&gt;</code> crea una imagen semitransparente, que puede ser utilizada junto con otros filtros para crear un efecto como de ondas al agua, y puede aceptar estos atributos:</p>  <h4>Atributos</h4><p><code>type</code>: puede tomar uno de estos dos valores: <code>turbulence</code> o <code>fractalNoise</code>. El valor por defecto es <code>turbulence</code>.</p><p><code>baseFrequency</code>: puede tomar como valor uno o dos n&uacute;meros. Si el valor son dos n&uacute;meros, el primero representa la frecuencia base en x y el segundo la frecuencia base en y. Si toma como valor un solo n&uacute;mero, la frecuencia base en x es igual a la frecuencia base en y. El valor por defecto de <code>baseFrequency</code> es 0.</p><p><code>numOctaves</code>: toma como valor un n&uacute;mero integro, y representa el n&uacute;mero de octavas utilizado para calcular el grado de detalle del ruido. El valor por defecto es 1. Un n&uacute;mero excesivamente grande puede producir una sobrecarga de la CPU.</p><p>En el siguiente ejemplo pruebe variar el valor <code>numOctaves</code> para valores muy peque&ntilde;os de la frecuencia base.</p><p data-height="650" data-theme-id="11360" data-slug-hash="NbEvLr" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="feTurbulence baseFrequency & numOctaves" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/NbEvLr/">feTurbulence baseFrequency & numOctaves</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p><code>seed</code>: es un n&uacute;mero integro utilizado para calcular la distribuci&oacute;n aleatoria. El valor por defecto es 1. Si los dem&aacute;s atributos son id&eacute;nticos, utilizamos el mismo valor de <code>seed</code> para generar dos im&aacute;genes iguales.</p>    <p data-height="300" data-theme-id="11360" data-slug-hash="yVQEWQ" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="SVG feTurbulence seed" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/yVQEWQ/">SVG feTurbulence seed</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p><code>stitchTiles</code>: Utilizado para intentar una transici&oacute;n suave en los bordes.</p><h4>Un caso pr&aacute;ctico</h4><p>La parte interesante viene ahora, porque podemos combinar este filtro con otro, por ejemplo <code>feDisplacementMap</code> para conseguir una imagen deformada.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;svg width="400" height="267" viewBox="0 0 600 400"     xmlns="http://www.w3.org/2000/svg">  &lt;filter id="displacementFilter">    &lt;feTurbulence type="turbulence" baseFrequency="0.01 .05"        numOctaves="1" result="turbulence" seed="53"/>    &lt;feDisplacementMap in2="turbulence" in="SourceGraphic"        scale="50" xChannelSelector="R" yChannelSelector="B"/>  &lt;/filter>  &lt;image xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="moon.jpg" width="600" height="400" x="-15" y= "-15"  filter="url(#displacementFilter)" />&lt;/svg>		        </code></pre>        </article></div><p data-height="370" data-theme-id="11360" data-slug-hash="38545fbe2f760857948266b63731e16f" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" data-pen-title="feTurbulence #1*" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/38545fbe2f760857948266b63731e16f/">feTurbulence #1*</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>Y tambi&eacute;n podemos animar este filtro, en concreto podemos animar el valor de <code>baseFrequency</code> para conseguir un efecto de ondas al agua.</p><div class="large-12 g_panel js">        <article>        <pre><code class="language-javascript">var filtro = document.querySelector("#displacementFilter feTurbulence");var fotogramas = 0;var rad = Math.PI / 180;function AnimarBaseFrequency() {  //baseFrequency="0.01 .1"  bfx = 0.01;// baseFrequency en x  bfy = .1; // baseFrequency en y  fotogramas += .5  bfx += 0.001 * Math.cos(fotogramas * rad);  bfy += 0.005 * Math.sin(fotogramas * rad);  //baseFrequency  bf = bfx.toString() + ' ' + bfy.toString();  filtro.setAttributeNS(null, 'baseFrequency', bf);  window.requestAnimationFrame(AnimarBaseFrequency);}window.requestAnimationFrame(AnimarBaseFrequency);		        </code></pre>        </article></div><p data-height="300" data-theme-id="11360" data-slug-hash="6145e2c8c907f2f09ebea67f1ca95426" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" data-pen-title="feTurbulence #2*" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/6145e2c8c907f2f09ebea67f1ca95426/">feTurbulence #2*</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p><em class="gem">Vea tambi&eacute;n <a class="link_to" target="_blank" href="http://codepen.io/enxaneta/pen/oYMxqe?editors=0010">este otro ejemplo</a> un poco m&aacute;s complejo.</em></p></div>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="filtros1.php">Filtros SVG - una introducci&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="fecomposite.php">feComposite</a></em></li><li>- <em class="gem"><a class="link_to" href="feblend.php">feBlend</a></em></li><li>- <em class="gem"><a class="link_to" href="feMorphology.php">feMorphology</a></em></li><li>- <em class="gem"><a class="link_to" href="fecolormatrix.php">feColorMatrix</a></em></li><li>- <em class="gem"><a class="link_to" href="fecomponenttransfer.php">feComponentTransfer</a></em></li><li>- <em class="gem"><a class="link_to" href="feConvolveMatrix.php">feConvolveMatrix</a></em></li><li>- <em class="gem">feTurbulence</em></li><li>- <em class="gem"><a class="link_to" href="feimage.php">feImage y feTile</a></em></li><li>- <em class="gem"><a class="link_to" href="fedisplacementmap.php">feDisplacementMap</a></em></li><li>- <em class="gem"><a class="link_to" href="filtros-svg-goo.php">Cosas pegajosas (goo)</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- w3.org: El filtro <a class="link_to" target="_blank" href="https://www.w3.org/TR/SVG/filters.html">Filter Effects</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
