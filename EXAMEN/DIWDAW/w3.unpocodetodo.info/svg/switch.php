...
<head>
  ...
  <meta name="description" content="Documentos estructurados en SVG. El elemento &lt;switch&gt;" />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, documentos estructurados, switch, systemLanguage,idiomas, c&oacute;digo ISO 639-3 de identificaci&oacute;n"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El elemento switch" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/switch.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Documentos estructurados en SVG. El elemento &lt;switch&gt;" /> 
  
  <title>El elemento switch</title>
  ...
  <link rel="canonical" href="switch.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="switch.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="switch"><h2 class="page_title">El elemento switch</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El elemento switch&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fswitch.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fswitch.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fswitch.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12"><p>El elemento <code>&lt;switch&gt;</code> en SVG funciona como un condicional, que nos permite intercambiar el contenido de este en funci&oacute;n de si un atributo eval&uacute;a como verdadero ( <code>true</code> ) o falso ( f<code>alse</code> ).Los atributos condicionales que pueden ser utilizados con <code>&lt;switch&gt;</code> son:</p><ul class="no-bullet"><li> - <a class="link_to" target="_blank" href="https://www.w3.org/TR/SVG/struct.html%23ConditionalProcessingRequiredFeaturesAttribute">requiredFeature</a></li><li> - <a class="link_to" target="_blank" href="https://www.w3.org/TR/SVG/struct.html%23ConditionalProcessingRequiredExtensionsAttribute">requiredExtensions</a></li><li> - <a class="link_to" target="_blank" href="https://www.w3.org/TR/SVG/struct.html%23ConditionalProcessingSystemLanguageAttribute">systemLanguage</a></li></ul><p>T&iacute;picamente utilizamos el elemento <code>&lt;switch&gt;</code> para mostrar diferentes im&aacute;genes, elementos de texto u otros elementos SVG en funci&oacute;n del lenguaje escogido por el usuario. Para esto necesitamos utilizar el atributo <code>systemLanguage</code>.</p><p><em class="gem">Cada idioma posee su <a class="link_to" target="_blank" href="http://www.lingoes.net/en/translator/langcode.htm">c&oacute;digo ISO 639-3 de identificaci&oacute;n.</a></em></p><p>En el siguiente ejemplo queremos mostrar en pantalla la bandera espa&ntilde;ola si lenguaje escogido por el usuario es el espa&ntilde;ol ( un grupo de rect&aacute;ngulos ):</p><blockquote>  <pre><strong>&lt;switch&gt;</strong>&lt;g <span class="str">systemLanguage="es"</span>&gt;	&lt;rect x ="0" y ="0" height ="11" width ="46" style ="fill: red"/&gt;	&lt;rect x ="0" y ="11" height ="11" width ="46" style ="fill: gold"/&gt;	&lt;rect x ="0" y ="22" height ="11" width ="46" style ="fill: red"/&gt;&lt;/g&gt;</pre></blockquote><p>la bandera de Francia ( otro grupo de rect&aacute;ngulos ),  para los franc&oacute;fonos.</p><blockquote><pre>&lt;g <span class="str">systemLanguage="fr"</span>&gt;	&lt;rect x ="0" y ="0" height ="33" width ="46" style ="fill: red"/&gt;	&lt;rect x ="15" y ="0" height ="33" width ="46" style ="fill: white"/&gt;	&lt;rect x ="31" y ="0" height ="33" width ="46" style ="fill: blue"/&gt;&lt;/g&gt;</pre></blockquote><p>la bandera americana ( una imagen ) para los angl&oacute;fonos.</p><blockquote><pre>&lt;g <span class="str">systemLanguage="en"</span>&gt;	&lt;image xmlns:xlink="USA.gif" height="33" width="46" x="0" y="0"&gt;&lt;/image&gt;&lt;/g&gt;</pre></blockquote><p>Los dem&aacute;s ver&aacute;n en pantalla un mensaje ( texto ) que dice &quot;NO FLAG&quot; ( <em class="gem">no hay bandera</em> ).</p><blockquote><pre><span class="com">&lt;!-- El valor por defecto --&gt;</span>&lt;g&gt;	&lt;text x="23" y="16" dominant-baseline="central" text-anchor="middle"&gt;	NO FLAG	&lt;/text&gt;&lt;/g&gt;<strong>&lt;/switch&gt;</strong></pre></blockquote><p>Observe por favor que en este caso el grupo <code>&lt;g&gt;</code> no lleva el atributo <code>systemLanguage</code> y es el &uacute;ltimo elemento dentro de <code>&lt;switch&gt;</code>. Si los dem&aacute;s grupos eval&uacute;an a falso ( el idioma escogido por el usuario no es ni el espa&ntilde;ol, ni el ingles, ni el franc&eacute;s ) el SVG mostrar&aacute; en pantalla este &uacute;ltimo grupo, el &uacute;nico que eval&uacute;a a verdadero. De lo contrario mostrar&aacute; el objeto SVG del grupo cuyo idioma se corresponde con el lenguaje escogido por el usuario.</p><p data-height="265" data-theme-id="light" data-slug-hash="6a6f38d722de363bab09bf5f4ce4712d" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/6a6f38d722de363bab09bf5f4ce4712d/">SVG switch systemLanguage</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="documentos-estructurados.php">Documentos estructurados</a></em></li><li>- <em class="gem"><a class="link_to" href="grupo.php">Agrupar y reutilizar</a></em></li><li>- <em class="gem"><a class="link_to" href="symbol.php">S&iacute;mbolos</a></em></li><li>- <em class="gem"><a class="link_to" href="marker.php">Marcadores</a></em></li><li>- <em class="gem"><a class="link_to" href="imagenes.php">El elemento image</a></em></li><li>- <em class="gem"><a class="link_to" href="enlaces.php">Enlaces externos</a></em></li><li>- <em class="gem">El elemento switch</em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La  esp. w3.org: <a class="link_to" target="_blank"  href="https://www.w3.org/TR/SVG/struct.html#SwitchElement">Document Structure</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
