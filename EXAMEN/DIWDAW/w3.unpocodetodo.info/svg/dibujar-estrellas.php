...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar  estrellas en SVG." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, dibujar, estrellas, poligonos regulares, script, javaScript, setAttribute, fill-rule, evenodd."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar estrellas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/dibujar-estrellas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como dibujar  estrellas en SVG." /> 
  ...
  <link rel="canonical" href="dibujar-estrellas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="dibujar-estrellas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="dibujar-estrellas.php#top">&#8682;</a></b>
</div>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar estrellas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdibujar-estrellas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdibujar-estrellas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdibujar-estrellas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Las estrellas que dibujaremos a continuaci&oacute;n son pol&iacute;gonos estrellados, y pueden trazarse &quot;sin levantar el l&aacute;piz&quot;.<br>
  Para dibujar el trazado utilizaremos la misma t&eacute;cnica que hemos utilizado para dibujar <a class="link_to" target="_blank" href="poligonos-regulares.php">pol&iacute;gonos regulares</a>, con una sola diferencia: suponiendo que queremos dibujar una estrella de 5 puntas, despu&eacute;s de calcular la posici&oacute;n de estas, uniremos los puntos de dos en dos ( <code>paso = 2</code> ): 1 con 3, 3 con 5, 5 con 2, 2 con 4 y 4 con 1.</p>
<p>Para dibujar estrellas podemos utilizar tanto el elemento <code>&lt;polygon&gt;</code>, como el elemento <code>&lt;polyline&gt;</code></p>
...
<polygon id="estrella" points="" style="fill:#6ab150; stroke:#003300; stroke-width:3;" transform ="rotate(-90 125 100)" fill-rule="evenodd" />
</svg></code></pre>								
        </article>
</div>
...
estrella.setAttribute("points", points(cx, cy, r, lados,paso));</code></pre>
        </article>
</div>
...
<p>Solo con cambiar el valor del n&uacute;mero de <code>lados</code> y el <code>paso</code>  podemos conseguir cualquiera de estos estrellas. Para unas estrellas "llenas" de color borre el atributo <code>fill-rule="evenodd"</code> de <code>&lt;polygon&gt;</code>.</p>
<div id="ex" class="large-12 text-center">

<svg width="120" height="160">
 <polygon transform="" id="poligono0" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
 <text id="lados0" x="60" y="130" text-anchor="middle" font-size="15"></text>
 <text id="text0" x="60" y="150" text-anchor="middle" font-size="15"></text>
</svg>  

<svg width="120" height="160">
 <polygon transform="" id="poligono1" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
 <text id="lados1" x="60" y="130" text-anchor="middle" font-size="15"></text>
 <text id="text1" x="60" y="150" text-anchor="middle" font-size="15"></text>
</svg>  

<svg width="120" height="160">
 <polygon transform="" id="poligono2" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
 <text id="lados2" x="60" y="130" text-anchor="middle" font-size="15"></text>
 <text id="text2" x="60" y="150" text-anchor="middle" font-size="15"></text>
</svg>  

<svg width="120" height="160">
 <polygon transform="" id="poligono3" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono4" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono5" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono6" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono7" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono8" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono9" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono10" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
<svg width="120" height="160">
 <polygon transform="" id="poligono11" points="" style="fill:#6ab150; stroke:#003300;stroke-width:3;" fill-rule= "evenodd" />
...
for(var j = 0; j<poligonosRy.length; j++){
var poligono = document.getElementById("poligono"+j);	
var textLados = document.getElementById("lados"+j);
var text = document.getElementById("text"+j);
var lados = poligonosRy[j].L;
var paso = poligonosRy[j].paso;
// modifica el valor del atributo points utilizando la funci&oacute;n points.
poligono.setAttribute("points", points(60, 60, 50, lados,paso));
poligono.setAttribute("transform", "rotate(-90 60 60)");
textLados.innerHTML = "lados = "+poligonosRy[j].L;
text.innerHTML = "paso = "+poligonosRy[j].paso;
}
</script><script>
