...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como crear enlaces hacia otras p&aacute;ginas web." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, enlaces, a, el elemento a, xlink:href, xlink:show, new, replace, target, _blank, _self, _parent, _top, URL"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Enlaces externos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/enlaces.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Como crear enlaces hacia otras p&aacute;ginas web." /> 
  ...
  <link rel="canonical" href="enlaces.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="enlaces.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="enlaces"><h2 class="page_title">Enlaces externos</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Enlaces externos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fenlaces.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fenlaces.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fenlaces.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El SVG permite crear enlaces hacia otros destinos ( otras p&aacute;ginas web ). Para esto, exactamente como en el HTML, utilizamos el elemento <code>&lt;a&gt;</code>. Sin embargo la sintaxis es algo diferente:</p><div class="large-12 g_panel html">        <article>	        <pre><code class="language-markup"><svg width="250" height="50" viewBox="0 0 250 50"> <a xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">		<text x="125" y="30" text-anchor="middle">Canvas - una introducci&oacute;n</text> </a></svg></code></pre>							        </article></div> <div class="large-12 g_panel resultado"> <article><svg width="250" height="50" viewBox="0 0 250 50"> <a xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">		<text x="125" y="30" text-anchor="middle">Canvas - una introducci&oacute;n</text> </a></svg> </article></div><div class="large-12"><!--id="chuleta"--><table class="svg"><thead>    <tr>      <th>Atributo</th>      <th>Ejemplo</th>      <th>Valores</th>      </tr>  </thead>  <tbody>  <tr>    <td>xlink:href</td>    <td>xlink:href = "https://www.yahoo.es"</td>    <td><em class="gem">URL</em></td>    </tr>  <tr>    <td>xlink:show</td>    <td>xlink:show = "new"</td>    <td>new | replace </td>    </tr>  <tr>    <td>target</td>    <td>target="_blank"</td>    <td>_blank | _self | _parent | _top</td>    </tr></tbody></table></div><p>Adem&aacute;s de <code>xlink:href</code> podemos utilizar tambi&eacute;n el atributo <code>xlink:show</code>.<br>Para que la p&aacute;gina enlazada se abra en una nueva ventana utilizamos <code>xlink:show = "new"</code>. Tambi&eacute;n podemos utilizar <code>target="_blank"</code> con la misma finalidad.<br>Para que la p&aacute;gina enlazada se abra en la misma ventana, reemplazando la actual utilizamos <code>xlink:show = "replace"</code>.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><svg width="250" height="50" viewBox="0 0 250 50">  <a xlink:show="new" xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">    <text x="125" y="30" text-anchor="middle">Canvas - una introducci&oacute;n</text>  </a></svg></code></pre>								        </article></div> <div class="large-12 g_panel resultado"> <article><svg width="250" height="50" viewBox="0 0 250 50">  <a xlink:show="new" xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">    <text x="125" y="30" text-anchor="middle">Canvas - una introducci&oacute;n</text>  </a></svg> </article></div><p>Tambi&eacute;n podemos utilizar formas geom&eacute;tricas como enlaces.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><svg width="250" height="110" viewBox="0 0 250 110">		<text x="32" y="60" >Canvas - una introducci&oacute;n</text>		<a xlink:show="new" xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">		<rect x="25" y="30" width="200" height="50" fill="rgba(100,255,100,.3)" />		</a></svg></code></pre>							        </article></div> <div class="large-12 g_panel resultado"> <article><svg width="250" height="110" viewBox="0 0 250 110">		<text x="32" y="60" >Canvas - una introducci&oacute;n</text>		<a xlink:show="new" xlink:href="http://w3.unpocodetodo.info/canvas/introduccion.php">		<rect x="25" y="30" width="200" height="50" fill="rgba(100,255,100,.3)" />		</a></svg> </article></div>          </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="documentos-estructurados.php">Documentos estructurados</a></em></li><li>- <em class="gem"><a class="link_to" href="grupo.php">Agrupar y reutilizar</a></em></li><li>- <em class="gem"><a class="link_to" href="symbol.php">S&iacute;mbolos</a></em></li><li>- <em class="gem"><a class="link_to" href="marker.php">Marcadores</a></em></li><li>- <em class="gem"><a class="link_to" href="imagenes.php">El elemento image</a></em></li><li>- <em class="gem">Enlaces externos</em></li><li>- <em class="gem"><a class="link_to" href="switch.php">El elemento switch</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- w3.org: <a class="link_to" target="_blank"  href="http://www.w3.org/TR/SVG11/linking.html#Links">Links out of SVG content: the "a" element</a><br>
