...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Animaciones acumulativas." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, animaciones, acumulativas, el atributo additive, sum, replace, el atributo accumulate, sum, none."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Animaciones acumulativas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/accumulate-additive.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Animaciones acumulativas." /> 
  
  <title>Animaciones acumulativas</title>
  ...
  <link rel="canonical" href="accumulate-additive.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="accumulate-additive.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="accumulate-additive.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="accumulate-additive">
<h2 class="page_title">Animaciones acumulativas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Animaciones acumulativas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Faccumulate-additive.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Faccumulate-additive.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Faccumulate-additive.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>El atributo additive</h4>
<p>El atributo <code>additive</code> controla si la animaci&oacute;n es o no aditiva. Puede tomar dos valores: <code>sum</code>, en cual caso la animaci&oacute;n es aditiva, 
o <code>replace</code>, y en este caso la nueva animaci&oacute;n substituye a la anterior.</p>
<p>En los siguientes ejemplos el texto <code>&lt;text&gt;</code> es redimensionado </p>
<blockquote><pre>&lt;animateTransform attributeName="transform"<strong class="str">type="scale"</strong>...</pre></blockquote>
<p>y luego girado 25&deg; en el sentido del reloj.</p>
<blockquote><pre>&lt;animateTransform attributeName="transform" <strong class="str">type="rotate"</strong> from= "-25" to= "0"...</pre></blockquote>
<p>La &uacute;nica diferencia entre los dos ejemplos es que en el primero utilizamos <code>additive="sum"</code>. Esto hace que los efectos de las dos animaciones ( <code>scale</code> y <code>rotate</code> ) 
se sumen y el texto es redimensionado y girado a la vez.<br>
En el segundo ejemplo no utilizamos el atributo <code>additive</code> ( cuyo valor por defecto es <code>additive="replace"</code> ) y en este caso la segunda animaci&oacute;n ( <code>rotate</code> )
reemplaza a la primera animaci&oacute;n ( <code>scale</code> ) y el texto es girado pero no redimensionado.</p>
...
<svg width="250" height="200">
 <g transform="translate(10,110)">
  <text x="0" y="0" style="font-size: 12px;" 
    transform="rotate(-25)" >
    additive="sum"
...
<h4>El atributo accumulate</h4>
<p>El atributo <code>accumulate</code> controla si la animaci&oacute;n es o no cumulativa.<br>
Si <code>accumulate="sum"</code>, cada repetici&oacute;n de la animaci&oacute;n ( o la animaci&oacute;n ulterior ) se suma a la anterior. Decimos que la animaci&oacute;n es cumulativa.<br>
Si <code>accumulate="none"</code>, la animaci&oacute;n no es cumulativa.</p>
<h6>Donde utilizarlo </h6>
<p>Imaginemos una animaci&oacute;n que empieza al hacer clic ( <code>begin="click"</code> ) y se repite 5 veces: <code>repeatCount="5"</code>. Por ejemplo un rect&aacute;ngulo cuya anchura crece de 
0 a 25px en el plazo de 1 segundo.<br>
Si utilizamos <code>accumulate="sum"</code> la anchura del rect&aacute;ngulo se incrementa 5 veces en 25px ( en total 125px ). Si no utilizamos <code>accumulate="sum"</code> o si utilizamos 
<code>accumulate="none"</code> la anchura del rect&aacute;ngulo aumenta en 25px, pero con cada repetici&oacute;n vuelve al valor inicial. El resultado es un parpadeo desagradable.</p>
<p>Observe por favor que en el siguiente ejemplo utilizamos<code> additive="sum"</code>. Esto hace que la anchura del rect&aacute;ngulo al inicio de la animaci&oacute;n sea igual a la anchura declarada del rect&aacute;ngulo 
( <code>width="50"</code> ). Si no utilizamos <code>additive="sum"</code> la animaci&oacute;n empieza desde 0.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="100">
<rect height="50" width="50" fill="#6ab150">
  <animate attributeName="width" from="0px" to="25px" dur="1s" begin="click"
           additive="sum" accumulate="sum" repeatCount="5" fill="freeze"/>
</rect>
</svg></code></pre>								
        </article>
</div>
<p>Haz clic en el rect&aacute;ngulo para que la animaci&oacute;n empiece. </p>
<div class="large-12 g_panel resultado">
 <article>
...
<h6>Otro ejemplo</h6>
<p>La siguiente animaci&oacute;n empieza al hacer clic en el circulo rojo ( <code>begin="click"</code> ). La animaci&oacute;n se hace con <code>&lt;animataMotion&gt;</code> y el circulo sigue una 
trayectoria dibujada con path ( <em class="gem"><a class="link_to" target="_blank"  href="cubic-bezier.php">una curva c&uacute;bica de B&eacute;zier</a></em> ) que utiliza 
coordenadas relativas. La animaci&oacute;n se repite 3 veces ( <code>repeatCount="3"</code> ). Al utilizar <code>acumulate="sum"</code> obtenemos un efecto de pelota que rebota.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup">
<svg width="250" height="100">
<circle r="10" fill="red" cx="10" cy="88" >
   <animateMotion id="am" path="m0 0 c 30 -40 70 -40 76 0" dur=".5s"
      accumulate="sum" repeatCount="3" fill="freeze" begin="click" />
</circle>
</svg></code></pre>
        </article>
</div>
<p>Haz clic en el c&iacute;rculo rojo para que la animaci&oacute;n empiece. </p>
<div class="large-12 g_panel resultado">
 <article>
...
<p><em class="gem">
- La  esp. w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/animate.html#AdditionAttributes">Attributes that control whether animations are additive</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
