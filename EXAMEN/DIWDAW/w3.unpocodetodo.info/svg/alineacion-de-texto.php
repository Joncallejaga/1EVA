...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Alineaci&oacute;n de texto" />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, dominant-baseline, auto, use-script, no-change, reset-size, ideographic, alphabetic, hanging, mathematical, central, middle, text-after-edge, text-before-edge, inherit, glyph-orientation-vertical, glyph-orientation-horizontal, text-anchor, writing-mode, glifos."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Alineaci&oacute;n de texto" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/alineacion-de-texto.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Alineaci&oacute;n de texto" /> 
  
  <title>Alineaci&oacute;n de texto</title>
  ...
  <link rel="canonical" href="alineacion-de-texto.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="alineacion-de-texto.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="alineacion-de-texto.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="alineacion-de-texto">
<h2 class="page_title">Alineaci&oacute;n de texto</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Alineaci&oacute;n de texto&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falineacion-de-texto.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falineacion-de-texto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Falineacion-de-texto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El elemento <code>&lt;text&gt;</code> nos permite alinear el texto relativamente a una l&iacute;nea horizontal ( <code>dominant-baseline</code> ) o vertical ( <code>text-anchor</code> ), nos permite cambiar la orientaci&oacute;n de las letras ( <code>glyph-orientation</code> ), incluso nos permite decidir el modo de escritura ( <code>writing-mode</code> ): de izquierda a derecha o de arriba abajo.</p>
<div class="large-12">
...
<!--    <tr>
      ...
      <td>rtl (right to left);ltr (left to right);</td>
      <td>ltr</td>
    </tr>
--> <tr>
      <td>text-anchor</td>
    ...
    <tr>
      ...
      <td>tb (Top to Bottom = de arriba a abajo);<br>rl (right to left = de derecha a izquierda );<br>lr (left to right = de izquierda a derecha);</td>
      </tr>
  </tbody>
</table>
</div>
...
<h4>La propiedad dominant-baseline</h4>
<p>La propiedad <code>dominant-baseline</code> se utiliza para alinear el texto verticalmente, relativo a una l&iacute;nea horizontal, y puede tomar uno de estos valores: </p>
<blockquote><p>dominant-baseline = "auto | use-script | no-change | reset-size | ideographic | alphabetic | hanging | mathematical | central | middle | text-after-edge | text-before-edge | inherit"</p></blockquote>
<p>Sin duda alguna los m&aacute;s utilizados son <code>alphabetic</code>, <code>central</code>, <code>middle</code> y <code>hanging</code>.  Veamos un ejemplo pr&aacute;ctico:</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="380" height="130" viewBox="0 0 380 130">
			<path d="M10,60 L370,60" style="stroke:rgb(255,0,0);stroke-width:1" />
			<text writing-mode="lr" dominant-baseline="alphabetic" x="20" y="60">alphabetic</text>
			<text writing-mode="lr" dominant-baseline="central" x="120" y="60">central</text>
			<text writing-mode="lr" dominant-baseline="middle" x="220" y="60">middle</text>
			<text writing-mode="lr" dominant-baseline="hanging" x="300" y="60">hanging</text>
</svg>
</code></pre>								
        </article>
</div>  
...
<p><em class="gem">La  especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/text.html#DominantBaselineProperty">dominant-baseline property</a></em></p>


<h4>La propiedad text-anchor</h4>
<p>Utilizamos la propiedad text-anchor para alinear horizontalmente el texto, relativo a un punto dado ( cuyas coordenadas son x e y ).<br />En este caso el texto aparece alineado relativamente al punto cuyas coordenadas son <code>x="125" y="70"</code>. </pre>
<blockquote><pre>&lt;text <strong class="str">x=&quot;125&quot; y=&quot;70&quot;</strong> text-anchor=&quot;middle&quot;<strong>&gt;</strong>middle&lt;/text&gt;</pre></blockquote>
<p>Veamos un ejemplo.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="130" viewBox="0 0 250 130">
			<path d="M125,10 L125,120" style="stroke:rgb(255,0,0);stroke-width:1" />
			<text writing-mode="lr" text-anchor="start" x="125" y="40">start</text>
			<text writing-mode="lr" text-anchor="middle" x="125" y="70">middle</text>
			<text writing-mode="lr" text-anchor="end" x="125" y="100">end</text>
</svg>
</code></pre>								
        </article>
</div>  
...
<p><em class="gem">La  especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/text.html#TextAnchorProperty">text-anchor property</a></em></p>

<h4>La orientaci&oacute;n de los glifos
<br><small>glyph-orientation-vertical y
glyph-orientation-horizontal</small></h4>
<p><em class="gem str">En este momento esta característica no está bien soportada en ningún navegador.</em></p>
<p>Dos propiedades controlan la orientaci&oacute;n de los <em class="gem"><a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/Glifo">glifos</a></em> ( en tipograf&iacute;a, un glifo es una representaci&oacute;n gr&aacute;fica de un car&aacute;cter, por ejemplo una letra o un s&iacute;mbolo ): 
<code>glyph-orientation-vertical</code> y <code>glyph-orientation-horizontal</code>.<br />
  El valor de estos atributos de texto es un &aacute;ngulo, normalmente 0&deg; o 90&deg;, pero puede ser tambi&eacute;n de 180&deg; y 270&deg;. Los valores intermediarios son ignorados.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="200" viewBox="0 0 250 200">
			<path d="M10,10 L240,10" style="stroke:rgb(255,0,0);stroke-width:1" />
			<text x="80" y="10" writing-mode="tb" glyph-orientation-vertical="0">Vertical</text>
			<text x="170" y="10" writing-mode="tb" glyph-orientation-vertical="90">Vertical</text>
			<text x="120" y="110" writing-mode="lr" glyph-orientation-horizontal="0">Horizontal</text>
			<text x="60" y="180" writing-mode="lr" glyph-orientation-horizontal="270">Horizontal</text>
</svg>
</code></pre>								
        </article>
</div>  
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="texto.php">Escribiendo en el SVG</a></em></li><li>- <em class="gem">Alineaci&oacute;n de texto</em></li><li>- <em class="gem"><a class="link_to" href="tspan.php">El elemento tspan</a></em></li><li>- <em class="gem"><a class="link_to" href="texto-en-un-trazado.php">Texto en un trazado</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La esp. w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/text.html#GlyphOrientation">Glyph orientation within a text run</a><br>
- La  esp. w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/text.html">Text</a><br>- Optimize el c&oacute;digo SVG con <a class="link_to" target="_blank" href="https://jakearchibald.github.io/svgomg/">SVG Optimiser</a><br>
