...
<head>
  ...
  <meta name="description" content="Ejemplo de animaci&oacute;n SVG: c&oacute;mo crear un sencillo SVG loader ( es mucho m&aacute;s sencillo de lo que parece )." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, loader, circulo, circle, stroke-dasharray, animaci&oacute;n, animate, circunferencia, JavaScript"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="loader SVG" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/svg-loader.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Ejemplo de animaci&oacute;n SVG: c&oacute;mo crear un sencillo SVG loader ( es mucho m&aacute;s sencillo de lo que parece )." /> 
  ...
  <link rel="canonical" href="svg-loader.php"> 
 
  <style>svg{border:1px solid #d9d9d9; margin:0 auto;
.no-before:before{ content:none;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="svg-loader.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="svg-loader.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="svg-loader">
<h2 class="page_title">Crear un sencillo loader SVG</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=loader SVG&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsvg-loader.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsvg-loader.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsvg-loader.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Crear un loader SVG es mucho m&aacute;s sencillo de lo que parece. En este caso la animaci&oacute;n dura 10 segundos ( <code>dur = "10s"</code> ) y se repite indefinidamente ( <code>repeatCount="indefinite"</code> )</p>
<h4>Que queremos conseguir</h4>
<div class="large-12 g_panel no-before">
        <article>
...
<circle id="circulo" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" stroke-dasharray="0 471.23889803846896" >
	<animate id="circuloA"
		   ...
		   begin="0s"  dur="10s" repeatCount="indefinite" ></animate> 
</circle>
</svg>								
        </article>
</div> 
<h4>C&oacute;mo hacerlo</h4>
<p>Primero dibujamos un circulo. El circulo tiene un borde de color azul ( <code>stroke="#abcdef"</code> ) de 40px ( <code>stroke-width="40"</code> ) y es discontinuo ( utilizamos <a class="link_to" target="_blank" href="lineas.php#dasharray">stroke-dasharray</a> ).</p>
<blockquote><pre>&lt;circle id="circulo" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" stroke-dasharray="0 472" /&gt;</pre></blockquote>
<p><em class="gem">Recuerde c&oacute;mo <a class="link_to" target="_blank" href="formas-geometricas.php">dibujar un circulo en SVG</a></em></p>
<p>Para dibujar l&iacute;neas discontinuas en SVG utilizamos  el atributo <code>stroke-dasharray</code>.  El valor de <code>stroke-dasharray</code> es una sucesi&oacute;n de n&uacute;meros, separados por comas o espacios, que define el patr&oacute;n a seguir.
Por ejemplo si <code>stroke-dasharray="10  5"</code> la l&iacute;nea ser&aacute; compuesta por fragmentos de l&iacute;nea de 10px separados por espacios de 5px.</p>
  
<p><em class="gem">Lea m&aacute;s acerca de <a class="link_to" target="_blank" href="lineas.php#dasharray">bordes discontinuos en SVG</a></em></p> 

<p>En nuestro caso queremos que el valor inicial de <code>stroke-dasharray="0 471.23889803846896"</code>, o sea l&iacute;neas de 0px seguidas de espacios muy grandes. El segundo par&aacute;metro ( <code>471.23889803846896</code> ) es el valor exacto de la circunferencia del circulo<!--, calculado, como si no, con JavaScript-->.</p>
<blockquote><pre>&lt;circle id="circulo" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" <span class="str">stroke-dasharray="0 471.23889803846896"</span> /&gt;</pre></blockquote>

<p>Queremos animar al atributo <code>stroke-dasharray</code>, desde el valor inicial ( <code>stroke-dasharray="0 471.23889803846896"</code> ) hasta un valor final ( <code>stroke-dasharray="471.23889803846896 0"</code> ) cuando  habr&aacute; una sola l&iacute;nea larga que cubrir&aacute; toda la circunferencia del circulo, seguida de un espacio pr&aacute;cticamente nulo.</p>
<p>Para esto hay que anidar dentro del elemento<code> &lt;circle&gt;</code> un elemento <code>&lt;animate&gt;</code> cuyos atributos <code>from</code> ( <em class="gem">desde</em> ) y <code>to</code> ( <em class="gem">hasta</em> ) definen los valores entre los cuales queremos animar el borde.</p>
<blockquote><pre>&lt;circle id="circulo" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" stroke-dasharray="10 5" &gt;
&lt;animate id="circuloA"
    attributeType="XML"
    attributeName="stroke-dasharray"
    <span class="str">from="0 471.23889803846896 "
    to="471.23889803846896 0"</span>
    begin="0s"
    dur="10s"
    fill="freeze"/&gt; 
&lt;/circle&gt;</pre></blockquote>

<h4>Utilizando JavaScript para calcular la circunferencia </h4>
<p>Sabemos que la circunferencia <code>C</code> de un circulo es <code>C = 2πr</code>, donde <code>r</code> es el radio del circulo. Esto traducido a JavaScript es:</p>
<blockquote><pre>var C=2*Math.PI*r;</pre></blockquote>
<p>Podemos escribir una funci&oacute;n que calcula la circunferencia relativo al radio del circulo <code>&lt;circle id="circulo" &gt;</code>, y la utiliza para establecer el valor de <code>stroke-dasharray</code>, y de los atributos <code>from</code> y <code>to</code> de la animaci&oacute;n <code>&lt;animate id="circuloA" &gt;</code>. En el HTML el valor de estos atributos es nulo ( <code>""</code> )</p>
<p><strong>Observaci&oacute;n</strong>: el id de la animaci&oacute;n es igual al id del circulo +A.</p>

<blockquote><pre>&lt;circle id="<span class="str">circulo</span>" cx="130" cy="130"  . . . . " &gt; 
&lt;animate id="<span class="str">circuloA</span>" . . . . . .</pre>
</blockquote>
...
circunferencia("circulo2");</code></pre>
        </article>
</div>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg id="lienzoSVG" height="250" width="250" viewBox="0 0 250 250">
<circle id="circulo2" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" stroke-dasharray="" >
	<animate id="circulo2A"
		   attributeType="XML" 
		   attributeName="stroke-dasharray" 
		   from="" 
		   to=""
...
<svg id="lienzoSVGR" height="250" width="250" viewBox="0 0 250 250">
<circle id="circulo2R" cx="130" cy="130" r="75" stroke="#abcdef" stroke-width="40" fill="transparent" stroke-dasharray="" >
	<animate id="circulo2RA"
		   attributeType="XML" 
		   attributeName="stroke-dasharray" 
		   from="" 
		   to=""
...
<h4>&iquest;Que m&aacute;s podemos hacer con esto?</h4>
<p>Podemos construir un cronómetro o incluso un <a class="link_to" target="_blank" href="ejemplos/animation-dashry.php">reloj</a>, con la precisión y exactitud de una herramienta digital y la utilidad de una clepsidra.</p>
...
function circunferencia(Id) {
  ...
  a.setAttribute("to", C + " 0");
  esteId.setAttribute("stroke-dasharray", "0 " + C);
}circunferencia("circulo2R");</script><script>
