...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos.Como crear s&iacute;mbolos en el SVG con el elemento symbol." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, s&iacute;mbolos, symbol, viewBox, preserveAspectRatio, use. "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="S&iacute;mbolos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/symbol.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos.Como crear s&iacute;mbolos en el SVG con el elemento symbol." /> 
  
  <title>S&iacute;mbolos</title>
  ...
  <link rel="canonical" href="symbol.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="symbol.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="symbol"><h2 class="page_title">S&iacute;mbolos</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=S&iacute;mbolos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsymbol.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsymbol.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fsymbol.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El elemento <code>&lt;symbol&gt;</code> es otra manera de agrupar objetos en SVG. A diferencia de <code>&lt;g&gt;</code> ( <em class="gem">group</em> ) el elemento <code>&lt;symbol&gt;</code> aparece en pantalla solo si lo instanciamos  con <code>&lt;use&gt;</code>, y aunque no aparece en pantalla por si solo, es recomendable ponerlo, junto con las dem&aacute;s definiciones,  dentro del elemento <code>&lt;defs&gt;</code>.</p><h4>Un ejemplo sencillo</h4><p>En el siguiente ejemplo agrupamos dentro del elemento <code>&lt;symbol&gt;</code> siete c&iacute;rculos y un trazado para representar una flor. Solo el &uacute;ltimo circulo tiene definidos los atributos <code>fill</code> ( <em class="gem">relleno</em> ) y <code>stroke</code> ( <em class="gem">trazo</em> ). Los dem&aacute;s c&iacute;rculos heredan estos atributos de <code>&lt;use&gt;</code>.</p><div class="large-12 g_panel html">        <article>	        <pre><code class="language-markup"><svg width="100" height="100" viewBox="0 0 100 100" xmlns:xlink="http://www.w3.org/1999/xlink"> <defs>  <symbol id="flor0" viewBox="0 0 100 100">    <title>Flor</title>    <desc>la descripci&oacute;n va aqu&iacute;</desc>    <circle cx="75" cy="50" r="20"></circle>    <circle cx="63" cy="75" r="20"></circle>    <circle cx="38" cy="75" r="20"></circle>    <circle cx="25" cy="50" r="20"></circle>    <circle cx="38" cy="25" r="20"></circle>    <circle cx="63" cy="25" r="20"></circle>    <path d="M55,48 a20,20 0 1,1 40,0"></path>    <circle cx="50" cy="50" r="15" fill="gold" stroke="#990"></circle>  </symbol></defs><use xlink:href="#flor0" fill="CornflowerBlue" stroke="#900"></use></svg></code></pre>							        </article></div>  <div class="large-12 g_panel resultado"> <article><svg width="100" height="100" viewBox="0 0 100 100" xmlns:xlink="http://www.w3.org/1999/xlink"> <defs>  <symbol id="flor1" viewBox="0 0 100 100">    <title>Flor</title>    <desc>la descripci&oacute;n va aqu&iacute;</desc>    <circle cx="75" cy="50" r="20"></circle>    <circle cx="63" cy="75" r="20"></circle>    <circle cx="38" cy="75" r="20"></circle>    <circle cx="25" cy="50" r="20"></circle>    <circle cx="38" cy="25" r="20"></circle>    <circle cx="63" cy="25" r="20"></circle>    <path d="M55,48 a20,20 0 1,1 40,0"></path>    <circle cx="50" cy="50" r="15" fill="gold" stroke="#990"></circle>  </symbol></defs><use xlink:href="#flor1" fill="CornflowerBlue" stroke="#900"></use></svg> </article></div><h4>Simbolos redimensionados</h4><p>A diferencia de <code>&lt;g&gt;</code>, el elemento <code>&lt;symbol&gt;</code> soporta los atributos <a class="link_to" target="_blank" href="viewport-y-viewbox.php">viewBox</a> y <a class="link_to" target="_blank" href="preserveaspectratio.php">preserveAspectRatio</a>, y por tanto una vez dibujado un s&iacute;mbolo podemos generar replicas de dimensiones variables.</p><p>En el siguiente ejemplo utilizamos el mismo s&iacute;mbolo del ejemplo anterior, solo que esta vez tiene declarado el atributo <code>viewBox</code>.</p><blockquote><p>&lt;symbol id="floral" <strong class="str">viewBox="0 0 100 100"</strong>&gt;</p></blockquote><p>Esto quiere decir que el s&iacute;mbolo, que es un rect&aacute;ngulo, tiene una anchura de 100px y una altura de 100px. La flor, exactamente como en el ejemplo anterior, aparece dibujada en el centro de este rect&aacute;ngulo. Adem&aacute;s, para que las cosas sean m&aacute;s claras, el s&iacute;mbolo incluye un rect&aacute;ngulo transparente con un borde rojo que marca el margen del mismo.</p><p>A continuaci&oacute;n reutilizamos el s&iacute;mbolo con <code>&lt;use&gt;</code>. En este caso el elemento <code>&lt;use&gt;</code> tiene declarado cuatro atributos m&aacute;s: <code>width</code> ( <em class="gem">anchura</em> )  <code>height</code> ( <em class="gem">altura</em> ) y las coordenadas del punto de inserci&oacuten <code>x</code> e <code>y</code>. <br>Si reutilizamos con <code>&lt;use&gt;</code> un grupo de elementos <code>&lt;g&gt;</code>, los atributos  <code>width</code> y <code>height</code> no afectan a la imagen resultante.  Por lo contrario, en el caso de <code>&lt;symbol&gt;</code>, que ya tiene declarado el atributo <code>viewBox</code>, utilizar los atributos  <code>width</code> y <code>height</code> resulta en un s&iacute;mbolo redimensionado.</p><p>En lo que concierne el punto de inserci&oacute;n <code>x,y</code>, este se corresponde con la esquina izquierda arriba del s&Iacute;mbolo ( el peque&ntilde;o circulo rojo del siguiente ejemplo ).</p><div class="large-12 g_panel html">        <article>								        <pre><code class="language-markup"><svg width="100" height="100" viewBox="0 0 100 100"  xmlns:xlink="http://www.w3.org/1999/xlink"> <defs>  <symbol id="floral2" viewBox="0 0 100 100">    <title>Flor</title>    <desc>la descripción va aquí</desc>    <circle cx="75" cy="50" r="20"></circle>    <circle cx="63" cy="75" r="20"></circle>    <circle cx="38" cy="75" r="20"></circle>    <circle cx="25" cy="50" r="20"></circle>    <circle cx="38" cy="25" r="20"></circle>    <circle cx="63" cy="25" r="20"></circle>    <path d="M55,48 a20,20 0 1,1 40,0"></path>    <circle cx="50" cy="50" r="15" fill="gold" stroke="#990"></circle>    <rect stroke="#f00" fill="none" width="100" height="100"></rect>  </symbol></defs><use xlink:href="#floral2" fill="CornflowerBlue" stroke="#900"></use></svg><svg width="200" height="200" viewBox="0 0 200 200" xmlns:xlink="http://www.w3.org/1999/xlink">  <use xlink:href="#floral2" fill="tomato" stroke="#900" x="25" y="25" width="150" height="150"></use> <circle cx="25" cy="25" r="3" fill="red" ></circle></svg></code></pre>                </article></div>  <div class="large-12 g_panel resultado"> <article><svg width="100" height="100" viewBox="0 0 100 100"  xmlns:xlink="http://www.w3.org/1999/xlink"> <defs>  <symbol id="floral3" viewBox="0 0 100 100">    <title>Flor</title>    <desc>la descripción va aquí</desc>    <circle cx="75" cy="50" r="20"></circle>    <circle cx="63" cy="75" r="20"></circle>    <circle cx="38" cy="75" r="20"></circle>    <circle cx="25" cy="50" r="20"></circle>    <circle cx="38" cy="25" r="20"></circle>    <circle cx="63" cy="25" r="20"></circle>    <path d="M55,48 a20,20 0 1,1 40,0"></path>    <circle cx="50" cy="50" r="15" fill="gold" stroke="#990"></circle>    <rect stroke="#f00" fill="none" width="100" height="100"></rect>  </symbol></defs><use xlink:href="#floral3" fill="CornflowerBlue" stroke="#900"></use></svg><svg width="200" height="200" viewBox="0 0 200 200" xmlns:xlink="http://www.w3.org/1999/xlink">  <use xlink:href="#floral3" fill="tomato" stroke="#900" x="25" y="25" width="150" height="150"></use> <circle cx="25" cy="25" r="3" fill="red" ></circle></svg> </article></div>   </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
...
<p><em class="gem">
- La  esp. w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/struct.html#SymbolElement">The symbol element</a><br>
