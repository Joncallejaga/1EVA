...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Animar con animateMotion." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, animaciones, animateMotion, path, el sentido del reloj, el atributo rotate, auto, auto-reverse."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Animar con animateMotion" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/animatemotion.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Animar con animateMotion." /> 
  
  <title>Animar con animateMotion</title>
  ...
  <link rel="canonical" href="animatemotion.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animatemotion.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animatemotion.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="animatemotion">
<h2 class="page_title">Animar con animateMotion</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Animar con animateMotion&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatemotion.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatemotion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fanimatemotion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Hemos visto que <code>&lt;animateTransform&gt;</code> nos permite animar objetos SVG en l&iacute;nea recta.</p>
<blockquote><p>attributeName="transform" type="translate"</p></blockquote>
<p>El elemento <code>&lt;animateMotion&gt;</code> nos permite, adem&aacute;s de esto, animar objetos SVG a lo largo de trayectorias complejas definidas con <code>&lt;path&gt;</code>.</p>
<h4>Un ejemplo b&aacute;sico</h4>
<p>En el siguiente ejemplo dibujamos un circulo azul con <code>&lt;path&gt;</code>, y un peque&ntilde;o tri&aacute;ngulo rojo con <code>&lt;polygon&gt;</code>.<br>
Para simplificar las cosas dibujamos tanto el trazado <code>&lt;path&gt;</code> como el tri&aacute;ngulo <code>&lt;polygon&gt;</code> a partir del origen del lienzo SVG, lo ponemos todo en un contenedor com&uacute;n <code>&lt;g&gt;</code> y trasladamos el contenedor en el punto donde queremos que est&eacute;.</p>
<blockquote><p>&lt;g transform= "translate(55,100)" &gt;</p></blockquote>
<p>Queremos animar el peque&ntilde;o tri&aacute;ngulo rojo a lo largo del c&iacute;rculo dibujado con <code>&lt;path&gt;</code>. Para esto anidamos dentro del elemento <code>&lt;polygon&gt;</code> ( el tri&aacute;ngulo ) un elemento <code>&lt;animateMotion&gt;</code>. El atributo <code>path</code> de <code>&lt;animateMotion&gt;</code> define la trayectoria a seguir por el tri&aacute;ngulo, y su valor es igual al valor del atributo <code>d</code> de <code>&lt;path&gt;</code>.<br>
Observamos que el tri&aacute;ngulo se mueve en el sentido contrario del reloj. Si miramos con atenci&oacute;n el valor del atributo <code>path</code>  nos damos cuenta que el trazado fue dibujado en este sentido.</p>
<blockquote><p>path="m0,0 a70,70 0 1, <strong class="str">0</strong> 0,-1 z"</p></blockquote>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="200">
<g transform="translate(55,100)">
<path style="stroke: #00f;stroke-width:3; fill: none;" d="m0,0 a70,70 0 1, 0 0,-1 z" />
<polygon points="0,0 -10,-10 -10,10" style="fill: #ff0000;">								
<animateMotion path="m0,0 a70,70 0 1, 0 0,-1 z" dur="10s" rotate="auto" repeatCount="indefinite" />
</polygon>  
</g>	
</svg></code></pre>								
        </article>
...
<p><em class="gem">Dibujar arcos elipticos con <a class="link_to" target="_blank" href="arcos-elipticos.php">&lt;path&gt;</a></em></p>

<p>En el siguiente ejemplo haremos que el peque&ntilde;o tri&aacute;ngulo rojo se desplace en el sentido del reloj. Para esto dibujamos el trazado ( el c&iacute;rculo azul ) en este sentido:</p>
<blockquote><p>
path= "m0,0 a70,70 0 1, <strong class="str">1</strong> 0,-1 z" // en el sentido del reloj<br>
path= "m0,0 a70,70 0 1, <strong class="str">0</strong> 0,-1 z"// en el sentido contrario</p></blockquote>
<p>Otro cambio respecto al ejemplo anterior es que en lugar de utilizar el atributo <code>path</code> para definir la trayectoria del tri&aacute;ngulo, utilizamos el elemento <code>&lt;mpath&gt;</code>para referenciar el trazado a seguir.</p>
<blockquote><p>&lt;mpath xlink:href= "#path" /&gt;</p></blockquote>
...
<path id="path" d="m0,0 a70,70 0 1,1 0,-1 z" style="stroke: #00f;stroke-width:2; fill: none;"/>
<polygon points="0,0 -10,-10 -10,10" style="fill: #ff0000;">
...
<h4>El atributo rotate</h4>
<p>En los ejemplos anteriores hemos utilizado con <code>&lt;animateMotion&gt;</code> el atributo <code>rotate</code>. </p>
<blockquote><p>&lt;animateMotion dur="10s" <strong class="str">rotate="auto"</strong> repeatCount="indefinite" &gt;</p></blockquote>
<p>Esto hizo que el triangulo rojo, adem&aacute;s de seguir la trayectoria referenciada, se ladeara autom&aacute;ticamente hasta quedar alineado con el pendiente de la trayectoria.<br>
  Si no utilizamos <code>rotate="auto"</code> el triangulo sigue desplaz&aacute;ndose por la trayectoria referenciada, pero ya no se ladea.</p>
<div class="large-12 g_panel html">
        <article><pre><code class="language-markup">
<svg width="250" height="125" viewBox="0 0 400 200">
<path id="bezier" d="m25,50 q80,150 175,50 t180,25" style="stroke:blue; stroke-width:2; fill:none;"/>
<polygon points="0,0 -10,0 0,-20 10,0" style="fill: #ff0000;">
<animateMotion begin="0s" dur="10s" repeatCount="indefinite">
<mpath xlink:href="#bezier"/>
</animateMotion>
</polygon> 
</svg></code></pre>								
        </article>
...
<p>El atributo rotate puede tomar los siguientes valores</p>
<blockquote><p>rotate = <em class="gem">n&uacute;mero</em> | auto | auto-reverse</p></blockquote>
<p>En el siguiente ejemplo hay dos tri&aacute;ngulos iguales: uno rojo y uno anaranjado.<br>Para el triangulo rojo <code>rotate="auto"</code>, mientras que para el triangulo anaranjado <code>rotate="auto-reverse"</code>.<br>
Si el valor del atributo rotate es n&uacute;mero, por ejemplo <code>rotate="30"</code> SVG entiende que tiene que girar el objeto animado unos 30&deg;. <mark>Por lastima esto parece no funcionar en algunos navegadores</mark>.</p>

<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<svg width="250" height="125" viewBox="0 0 400 200">
<path id="bezier1" d="m25,50 q80,150 175,50 t180,25" style="stroke:blue; stroke-width:3; fill:none;"/>
<polygon points="0,0 -10,0 0,-20 10,0" style="fill: #ff0000;">
<animateMotion begin="0s" dur="10s" rotate="auto" repeatCount="indefinite" >
<mpath xlink:href="#bezier1"/>
</animateMotion>
</polygon> 
