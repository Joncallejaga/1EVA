...
<head>
  ...
  <meta name="description" content="En SVG hay una serie de elementos prescindibles, que sin embargo, son de gran utilidad estructural y sem&aacute;ntica." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, documentos estructurados, &lt;g&gt;, &lt;defs&gt;, &lt;title&gt;, &lt;desc&gt;, &lt;use&gt;, &lt;image&gt;, &lt;a&gt;, &lt;switch&gt;"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Documentos estructurados" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/documentos-estructurados.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="En SVG hay una serie de elementos prescindibles, que sin embargo, son de gran utilidad estructural y sem&aacute;ntica." /> 
  
  <title>Documentos estructurados</title>
  ...
  <link rel="canonical" href="documentos-estructurados.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="documentos-estructurados.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="documentos-estructurados.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="documentos-estructurados"><h2 class="page_title">Documentos estructurados</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Documentos estructurados&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdocumentos-estructurados.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdocumentos-estructurados.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fdocumentos-estructurados.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En SVG hay una serie de elementos prescindibles, que sin embargo, son de gran utilidad estructural y sem&aacute;ntica y ofrecen claridad y accesibilidad.</p><div class="large-12"><!--id="chuleta"-->    <table class="svg"><thead><tr>    <th>Elemento</th>    <th style="width:50%;">Ejemplo</th>    <th>Descripci&oacute;n</th>    </tr>  </thead>  <tbody>  <tr>    <td>&lt;g&gt;</td>    <td><pre><span class="str">&lt;g&gt;</span> &lt;rect x ="0" y...../&gt; &lt;polygon points ="35,0..../&gt;<span class="str">&lt;/g&gt;</span></pre></td>    <td>El elemento <code>&lt;g&gt;</code> es un contenedor utilizado para agrupar objetos.</td>    </tr>    <tr>    <td>&lt;defs&gt;</td>    <td><pre><span class="str">&lt;defs&gt;</span>  &lt;g id="paraReutilizar"&gt;.......  &lt;/g&gt;<span class="str">&lt;/defs&gt;</span></pre></td>    <td>Los elementos definidos dentro de <code>&lt;defs&gt;</code> no aparecen en pantalla pero pueden ser utilizados m&aacute;s tarde con <code>&lt;use&gt</code>;</td>    </tr>    <tr>    <td>&lt;title&gt;</td>    <td><pre>&lt;g&gt; <span class="str">&lt;title&gt;flecha&lt;/title&gt;</span> &lt;rect x ="0" y...../&gt; &lt;polygon points ="35,0..../&gt;&lt;/g&gt;</pre></td>    <td>Cada elemento SVG puede tener un titulo <code>&lt;title&gt;</code>. Este elemento no aparece en pantalla, aunque tiene importancia sem&aacute;ntica.</td>    </tr>    <tr>    <td>&lt;desc&gt;</td>    <td><pre>&lt;g&gt; <span class="str">&lt;desc&gt;la descripci&oacute;n va aqu&iacute;&lt;/desc&gt;</span>   &lt;rect x ="0" y...../&gt; &lt;polygon points ="35,0..../&gt;&lt;/g&gt;</pre></td>    <td>Cada elemento SVG puede tener una descripci&oacute;n <code>&lt;desc&gt;</code>. Este elemento no aparece en pantalla, aunque tiene importancia sem&aacute;ntica.</td>    </tr>    <tr>    <td>&lt;use&gt;</td>    <td><pre>&lt;defs&gt;  &lt;g id="paraReutilizar"&gt;.......&lt;/g&gt;&lt;defs&gt;&lt;use<span class="str"> xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#paraReutilizar" ... /&gt;</span></pre></td>    <td>Elementos ya definidos pueden ser utilizados y reutilizados ulteriormente con <code>&lt;use&gt;</code></td>    </tr>  <tr>    <td>&lt;image&gt;</td>    <td><pre>&lt;image <span class="str">xmlns:xlink="http://www.w3.org/1999/xlink xlink:href</span> ="imagen.jpg" height="240" width="250" x="15" y="10"&gt;&lt;/image&gt;</pre></td>    <td>El elemento <code>&lt;image&gt;</code> es utilizado para insertar im&aacute;genes.</td>    </tr>    <tr>    <td>&lt;a&gt;</td>    <td><pre>&lt;a <span class="str">xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href</span> ="http://w3.unpocodetodo.info"&gt; &lt;text x="125" y="30" &gt;   Canvas - una introducci&oacute;n   &lt;/text&gt;&lt;/a&gt;</pre></td>    <td>Permite crear enlaces hacia otros destinos.</td>    </tr>    <tr>    <td>&lt;switch&gt;</td>    <td><pre><span class="str">&lt;switch&gt;</span>&lt;g <span class="str">systemLanguage</span>="es"&gt;...&lt;/g&gt;&lt;g <span class="str">systemLanguage</span>="en"&gt;...&lt;/g&gt;<span class="str">&lt;/switch&gt;</span></pre></td>    <td>El elemento <code>&lt;switch&gt;</code> funciona como un condicional.</td>    </tr>  </tbody></table></div><p><em class="gem">Vea <a class="link_to" target="_blank" href="../canvas/chuleta.php">la chuleta</a> con las propiedades y metodos() de canvas.</em></p><div class="large-12"><h4>Definiciones con &lt;defs&gt;</h4><p>En SVG podemos definir objetos para reutilizarlos m&aacute;s tarde. Es recomendable, aunque no imprescindible guardar los elementos que queremos reutilizar dentro de un elemento <code>&lt;defs&gt;</code> (definiciones). Los elementos que aparecen definidos dentro del elemento <code>&lt;defs&gt;</code> no aparecen en pantalla, pero pueden ser referenciados utilizados y reutilizados ulteriormente con <code>&lt;use&gt;</code>. Para esto normalmente se los asigna una identificaci&oacute;n (<code>id</code>).</p><p data-height="265" data-theme-id="light" data-slug-hash="11aea92f348977dca279ae75f83f75e2" data-default-tab="html,result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/11aea92f348977dca279ae75f83f75e2/">11aea92f348977dca279ae75f83f75e2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h4>Titulos y descripciones</h4><p>Cada elemento SVG, puede tener un titulo <code>&lt;title&gt;</code> y una descripci&oacute;n <code>&lt;desc&gt;</code>, y aunque estos elementos no aparecen en pantalla, ofrecen claridad y son importantes de punto de vista sem&aacute;ntico. En el ejemplo anterior el grupo <code>&lt;g id="flecha"&gt;</code> tiene asignado un titulo: <code>&lt;title&gt;Flecha&lt;/title&gt;</code> y una descripci&oacute;n: <code>&lt;desc&gt;flecha apuntando a la derecha&lt;/desc&gt;</code>.</p><p><em class="gem">Lea m&aacute;s acerca de grupos en SVG: <a class="link_to" target="_blank" href="grupo.php">Agrupar y reutilizar</a></em></p></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem">Documentos estructurados</em></li><li>- <em class="gem"><a class="link_to" href="grupo.php">Agrupar y reutilizar</a></em></li><li>- <em class="gem"><a class="link_to" href="symbol.php">S&iacute;mbolos</a></em></li><li>- <em class="gem"><a class="link_to" href="marker.php">Marcadores</a></em></li><li>- <em class="gem"><a class="link_to" href="imagenes.php">El elemento image</a></em></li><li>- <em class="gem"><a class="link_to" href="enlaces.php">Enlaces externos</a></em></li><li>- <em class="gem"><a class="link_to" href="switch.php">El elemento switch</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La  esp. w3.org: <a class="link_to" target="_blank"  href="https://www.w3.org/TR/SVG/struct.html#DescriptionAndTitleElements">Document Structure</a><br>
