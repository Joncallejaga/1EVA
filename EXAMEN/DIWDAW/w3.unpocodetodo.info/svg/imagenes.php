...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Utilizar im&aacute;genes en el SVG. El elemento image." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, imagen, image, xlink:href, transformaciones, transform, scale, rotate, yin yang."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El elemento image" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/imagenes.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 SVG con material de consulta y ejemplos. Utilizar im&aacute;genes en el SVG. El elemento image." /> 
  
  <title>El elemento image</title>
...
<div class="large-12 g_panel"><article><section id="imagenes"><h2 class="page_title">El elemento image</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El elemento image&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fimagenes.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fimagenes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2Fimagenes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Utilizar im&aacute;genes en el SVG</h4><p>En el SVG el elemento <code>&lt;image&gt;</code> es utilizado para insertar im&aacute;genes. Utilizamos el elemento <code>&lt;image&gt;</code> casi como a <code>&lt;rect&gt;</code>, o sea: especificamos tanto las coordenadas <code>x</code> e <code>y</code> de la esquina izquierda arriba, como la anchura ( <code>width</code> ) y altura ( <code>height</code> ) de la imagen. Tambi&eacute;n hay que especificar la imagen a insertar, y esto lo hacemos con <code>xlink:href</code>.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><svg width="280" height="260"  viewBox="0 0 280 260">  <image xlink:href="images/arboc.jpg" height="240" width="250" x="15" y="10"/></svg></code></pre>								        </article></div> <div class="large-12 g_panel resultado"> <article><svg width="280" height="260"  viewBox="0 0 280 260">  <image xlink:href="images/arboc.jpg" height="240" width="250" x="15" y="10"/></svg> </article></div><p>Las im&aacute;genes pueden ser transformadas utilizando el atributo <a class="link_to" target="_blank"  href="transform.php">transform</a>. El atributo <code>transform</code> puede tomar como valor una o varias de las <a class="link_to" target="_blank"  href="transform.php">funciones de transformaci&oacute;n</a> conocidas. ( <code>translate, rotate, scale...</code> )<br>En el siguiente ejemplo reducimos la imagen a la mitad </p><blockquote><p>transform="<strong class="str">scale(.5)</strong> rotate(-45)"</p></blockquote><p>y la giramos 45&deg; en el sentido contrario del reloj</p> <blockquote><p>transform="scale(.5) <strong class="str">rotate(-45)</strong>"</p></blockquote><div class="large-12 g_panel html">        <article>	        <pre><code class="language-markup"><svg width="280" height="180"  viewBox="0 0 280 180">  <image transform="scale(.5) rotate(-45)" xlink:href="images/arboc.jpg" height="240" width="250" x="-50" y="200"/></svg></code></pre>							        </article></div>  <div class="large-12 g_panel resultado"> <article><svg width="280" height="180"  viewBox="0 0 280 180">  <image transform="scale(.5) rotate(-45)" xlink:href="images/arboc.jpg" height="240" width="250" x="-50" y="200"/></svg> </article></div><h4>Insertar archivos .svg</h4><p>Adem&aacute;s de im&aacute;genes <code>.jpg</code> o <code>.png</code> tambi&eacute;n podemos insertar archivos ( im&aacute;genes ) <code>.svg</code><!--<br><em class="gem">Vea el archivo <a class="link_to" target="_blank" href="test.svg">.svg</a> utilzado.</em>--></p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><svg width="250" height="200"  viewBox="0 0 250 200"><image xlink:href="test.svg" height="200" width="250"/></svg></code></pre>								        </article></div>  <div class="large-12 g_panel resultado"> <article><svg width="250" height="200"  viewBox="0 0 250 200"><image xlink:href="test.svg" height="200" width="250"/></svg> </article></div><p>Tambi&eacute;n en el HTML podemos insertar im&aacute;genes generadas con <code>&lt;svg&gt;</code></p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><img style="height:200px; width:250px;" src="test.svg" alt="archivo SVG"></code></pre>								        </article></div>  <div class="large-12 g_panel resultado"> <article><img style="height:200px; width:250px;" src="test.svg" alt="archivo SVG"> </article></div>         </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="documentos-estructurados.php">Documentos estructurados</a></em></li><li>- <em class="gem"><a class="link_to" href="grupo.php">Agrupar y reutilizar</a></em></li><li>- <em class="gem"><a class="link_to" href="symbol.php">S&iacute;mbolos</a></em></li><li>- <em class="gem"><a class="link_to" href="marker.php">Marcadores</a></em></li><li>- <em class="gem">El elemento image</em></li><li>- <em class="gem"><a class="link_to" href="enlaces.php">Enlaces externos</a></em></li><li>- <em class="gem"><a class="link_to" href="switch.php">El elemento switch</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La  esp. w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/SVG11/struct.html#ImageElement">The &lt;image&gt; element</a><br>
