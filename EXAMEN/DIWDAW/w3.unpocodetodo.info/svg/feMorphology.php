...
<head>
  ...
  <meta name="description" content="El filtro feMorphology afecta ( modifica ) la forma ( o sea la morfolog�a ) de un objeto." />
  <meta name="keywords" content="SVG, Scalable Vector Graphics, HTML5, filtros SVG, filter, feMorphology, operator, erode, dilate, radius, feFlood, feComposite, feMerge, feMergeNode"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="feMorphology" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/svg/feMorphology.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El filtro feMorphology afecta ( modifica ) la forma ( o sea la morfolog�a ) de un objeto." /> 
  ...
  <link rel="canonical" href="feMorphology.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="feMorphology.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="feMorphology.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="feMorphology"><h2 class="page_title">feMorphology</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=feMorphology&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2FfeMorphology.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2FfeMorphology.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fsvg%2FfeMorphology.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12">  <p>El filtro <code>&lt;feMorphology&gt;</code> afecta ( modifica ) la forma ( o sea la morfolog&iacute;a ) de un objeto.    El atributo <code>operator</code> de <code>&lt;feMorphology&gt;</code> puede tomar uno de estos dos valores:</p>  <ul class="no-bullet">    <li>- <code>erode</code> que disminuye y</li>    <li>- <code>dilate</code> que amplia. </li>  </ul>  <p>El atributo <code>radius</code> especifica el tama&ntilde;o de la deformaci&oacute;n.</p>  <p>Veamos un ejemplo b&aacute;sico:</p> <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">  &lt;svg viewBox="-250 0 500 180" width="500" height="180"&gt;      &lt;filter id="erosionar"&gt;        &lt;feMorphology operator="erode" radius="1"/&gt;      &lt;/filter&gt;      &lt;filter id="dilatar"&gt;        &lt;feMorphology operator="dilate" radius="2"/&gt;      &lt;/filter&gt;      &lt;g text-anchor="middle"&gt;      &lt;text y="1em"&gt;Texto normal&lt;/text&gt;      &lt;text y="2em" filter="url(#erosionar)"&gt;texto reducido&lt;/text&gt;      &lt;text y="3em" filter="url(#dilatar)"&gt;texto ampliado&lt;/text&gt;      &lt;/g&gt;  &lt;/svg&gt;</code></pre></article></div>   <p>No hay mucho que comentar aqu&iacute;. Si quiere puede jugar con este ejemplo en <a class="link_to" target="_blank" href="https://codepen.io/enxaneta/pen/9108cc63e4e15543f4e1ba70a62dbd7b">Codepen</a></p><p data-height="300" data-theme-id="11360" data-slug-hash="9108cc63e4e15543f4e1ba70a62dbd7b" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="feMorphology #1" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/9108cc63e4e15543f4e1ba70a62dbd7b/">feMorphology #1</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>     <h4>Un caso pr&aacute;ctico:<br>   <small>Texto subrayado con espacios alrededor de los descendentes.</small></h4>  <p>En tipograf&iacute;a el descendente ( no descendiente ) de una letra en min&uacute;sculas es aquella parte que va por debajo de la llamada l&iacute;nea base, como por ejemplo el rabo de la <em class="gem">p</em> de la <em class="gem">j</em> o de la <em class="gem">q</em>.    Por razones est&eacute;ticas y claridad es interesante poder subrayar texto dejando espacios alrededor de los descendentes. En SVG podemos utilizar un filtro para conseguir este efecto:</p>    <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">     &lt;svg width="600" height="100"&gt;      &lt;filter id="subrayado" primitiveUnits="objectBoundingBox"&gt;        &lt;feMorphology in="SourceGraphic" operator="dilate" radius="0.015" result="contorno"&gt;&lt;/feMorphology&gt;        &lt;feFlood flood-color="blue" width="1" height="0.01" x="0" y="0.90" result="linea"&gt;&lt;/feFlood&gt;        &lt;feComposite in="linea" in2="contorno" operator="out" result="subrayado"&gt;&lt;/feComposite&gt;         &lt;feMerge&gt;          &lt;feMergeNode in="subrayado"&gt;&lt;/feMergeNode&gt;          &lt;feMergeNode in="SourceGraphic"&gt;&lt;/feMergeNode&gt;        &lt;/feMerge&gt;      &lt;/filter&gt;      &lt;text filter="url(#subrayado)" x="300" y="60" text-anchor="middle" &gt;Un pastel de higos y almendras&lt;/text&gt;&lt;/svg&gt;</code></pre></article></div><p data-height="211" data-theme-id="11360" data-slug-hash="258748411ffda0dac99e68fbf0a668be" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="SVF texto subrayado*" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/258748411ffda0dac99e68fbf0a668be/">SVF texto subrayado*</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><h5>La explicaci&oacute;n del c&oacute;digo</h5><p>Utilizamos <code>filterUnits="objectBoundingBox"</code>, por lo cual las dimensiones del filtro se dan en porcentajes respecto al tama&ntilde;o de la caja lindante ( <em>the bounding box</em> ).</p>  <blockquote><pre>&lt;filter id="subrayado" primitiveUnits="objectBoundingBox"&gt;</pre></blockquote><p>El filtro primitivo <code>feMorphology</code> amplia las letras del texto, el tama&ntilde;o de la deformaci&oacute;n siendo <code>radius="0.015"</code>.</p>  <blockquote><pre>&lt;feMorphology in="SourceGraphic" operator="dilate" radius="0.015" result="contorno"&gt;&lt;/feMorphology&gt;</pre></blockquote><p>El filtro primitivo <code>&lt;feFlood&gt;</code> crea una l&iacute;nea azul, de hecho un rect&aacute;ngulo con una altura muy peque&ntilde;a ( <code>height="0.01"</code> ) y una anchura que mide lo mismo que el texto ( <code>width = 1</code> )</p><blockquote><pre>&lt;feFlood flood-color="blue" width="1" height="0.01"  x="0" y="0.90" result="linea"&gt;&lt;/feFlood&gt;</pre></blockquote><p>El filtro primitivo <code>&lt;feComposite&gt;</code> combina el texto con la l&iacute;nea. El <code>operator</code> utilizado es "<code>out</code>", lo que quiere decir que el texto dilatado recorta la l&iacute;nea azul, justo al rev&eacute;s de como lo har&iacute;a <code>clipPath</code>.</p><blockquote><pre>&lt;feComposite in="linea" in2="contorno" operator="out" result="<strong>subrayado</strong>"&gt; &lt;/feComposite&gt;</pre></blockquote><p>Finalmente utilizamos <code>&lt;feMerge&gt</code>; para combinar el subrayado con el texto o sea el grafico de origen al cual le aplicamos el filtro:</p><blockquote><pre>&lt;filter id="<span class="str">subrayado</span>" primitiveUnits="objectBoundingBox" &gt;. . . . . . . . . .   &lt;feMerge&gt;       &lt;feMergeNode in="subrayado"&gt;&lt;/feMergeNode&gt;       &lt;feMergeNode in="SourceGraphic"&gt;&lt;/feMergeNode&gt;   &lt;/feMerge&gt;&lt;/filter&gt;&lt;text filter="url(#<span class="str">subrayado</span>)" x="300" y="60" text-anchor="middle" &gt;Un pastel de higos y almendras&lt;/text&gt;</pre></blockquote><p> Si quiere puede jugar con este ejemplo en <a class="link_to" target="_blank" href="https://codepen.io/enxaneta/pen/258748411ffda0dac99e68fbf0a668be">Codepen</a></p></div>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
