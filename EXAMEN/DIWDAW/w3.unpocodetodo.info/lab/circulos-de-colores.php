...
<head>
  ...
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, patrones, c&iacute;rculos, circulos, circulos de colores, naranja, verde, patron geometrico, estilo retro"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="C&iacute;rculos de colores" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/circulos-de-colores.php" /> 
  ...
  <title>C&iacute;rculos de colores</title>
  ...
  <link rel="canonical" href="circulos-de-colores.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="circulos-de-colores.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="circulos-de-colores.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="circulos-de-colores">
<h2 class="page_title">C&iacute;rculos de colores</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=C&iacute;rculos de colores&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fcirculos-de-colores.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fcirculos-de-colores.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fcirculos-de-colores.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>A continuaci&oacute;n dibujamos en el <code>&lt;canvas&gt;</code> un patr&oacute;n geom&eacute;trico, al estilo retro.  
Para ser m&aacute;s exactos ser&aacute;n 50 grupos de c&iacute;rculos conc&eacute;ntricos cuyos posici&oacute;n dimensiones y colores ser&aacute;n decididas al azar.</p>
<p><em class="gem">M&aacute;s informaci&oacute;n acerca de como dibujar un <a class="link_to" href="../canvas/arc.php">c&iacute;rculo</a>.</em></p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="500" height="450">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">// el array de los colores utilizados
...
if (canvas && canvas.getContext) {
  ...
  if (ctx) {
    ...
    // y rellena un rect&aacute;ngulo del tamaño del canvas con este color
    ctx.fillRect(0, 0, canvas.width, canvas.height);
    // construye 50 grupos de c&iacute;rculos conc&eacute;ntricos						
    for (var index = 0; index < 50; index++) {
      ...
      for (var i = 0; i <= 4; i++) {
        ...
        //el m&aacute;s grande al inicio, el m&aacute;s peque&ntilde;o al final
		var radio =  r*(5-i); 
...
<div class="large-12 g_panel resultado" id="elcanvas">
 <article>
<canvas id="lienzo" width="500" height="450">Su navegador no soporta canvas :( </canvas> </article>
</div>
...
<p><a href="../index.html">w3.unpo&lt;code&gt;todo.info</a> utiliza una estructura generada con <a target="_blank" href="http://foundation.zurb.com/">foundation</a></p>
  ...
  <script>// el array de los colores utilizados
var coloresRy = new Array('#3D0726', '#6E5813', '#F39523', '#F5681C', '#F33C2F');
// el canvas
var canvas = document.getElementById('lienzo');
if (canvas && canvas.getContext) {
