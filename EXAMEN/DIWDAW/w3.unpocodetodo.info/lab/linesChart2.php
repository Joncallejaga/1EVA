...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un  graficos de l&iacute;neas - segunda parte. Ejemplo pr&aacute;ctico." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, graficos de l&iacute;neas, histogramas, line chart, leyenda, laboratorio"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="A&ntilde;adir una leyenda" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/linesChart2.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un  graficos de l&iacute;neas - segunda parte. Ejemplo pr&aacute;ctico." /> 
  ...
  <link rel="canonical" href="linesChart2.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="linesChart2.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="linesChart2.php#top">&#8682;</a></b>
</div>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=A&ntilde;adir una leyenda&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart2.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="http://w3.unpocodetodo.info/linesChart1.php">gr&aacute;ficos de l&iacute;neas (1)</a></em></p>
<h4>A&ntilde;adir los dem&aacute;s navegadores</h4>
<p>A continuaci&oacute;n queremos dibujar los gr&aacute;ficos para los dem&aacute;s navegadores. 
Para esto escribimos un bucle for que recorre todas las propiedades ( navegadores ) del objeto oData ( <code>for(var nav in oData)</code> ), y reemplazamos <code>oData["Firefox"]</code> del ejemplo anterior con <code>oData[nav]</code> – donde <code>nav</code> es una variable que almacena  el nombre del navegador.</p>
...
<p>Tambi&eacute;n hemos escrito una funci&oacute;n que dibuja la leyenda.<br>
La funci&oacute;n recorre el objeto <code>oData</code> ,dibuja un peque&ntilde;o rect&aacute;ngulo del color del navegador ( <code>oData[nav]["color"]</code> ) y escribe al lado el nombre del navegador.</p>
<div class="large-12 g_panel js">
        <article>
               <pre><code class="language-javascript">
function laLeyenda() {
...
<div class="large-12 g_panel html">
        <article>								
		 <pre><code class="language-markup"><canvas id="lienzo" width="600" height="300">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div> 
<div class="large-12 g_panel js">
        <article>
...
<canvas id="lienzo" width="600" height="300">Su navegador no soporta canvas :( </canvas> </div></article>
</div>
<p>Para mejorar el gr&aacute;fico a&ntilde;adiremos un r&oacute;tulo flotante con el nombre del navegador, el a&ntilde;o y el porcentaje de usuarios. <em class="gem"><a class="link_to" href="linesChart3.php">Contin&uacute;a leyendo</a>...</em></p>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="linesChart1.php">Gr&aacute;ficos de l&iacute;neas (1)</a></em></li><li>- <em class="gem">A&ntilde;adir una leyenda</em></li><li>- <em class="gem"><a class="link_to" href="linesChart3.php">A&ntilde;adir un r&oacute;tulo flotante</a></em></li></ul></article></div></div>
