...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n de cubos, utilizando ina imagen generada en un canvas flotante (buffer canvas)." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, patrones, cubos, patron de cubos,bufferCanvas, buffer canvas, offscreen canvas, canvas flotante, createElement, "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Patr&oacute;n de cubos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/patron-de-cubos.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n de cubos, utilizando ina imagen generada en un canvas flotante (buffer canvas)." /> 
  
  <title>Patr&oacute;n de cubos</title>
  ...
  <link rel="canonical" href="patron-de-cubos.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="patron-de-cubos.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="patron-de-cubos.php#top">&#8682;</a></b>
</div>
...
<!--<style>
#lienzo{ background-color:#b3bedd;}</style>-->
 
<div class="large-12 g_panel">
<article>
<section id="patron-de-cubos">
<h2 class="page_title">Patr&oacute;n de cubos</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Patr&oacute;n de cubos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpatron-de-cubos.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpatron-de-cubos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpatron-de-cubos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Dibujar un "cubo"</h4>
<p>Observamos que para dibujar un cubo, o algo que se parezca a un cubo, podemos dibujar un hex&aacute;gono dividido en 3 rombos. Cada rombo representa una de las tres caras visibles del cubo.<br>
Por lo tanto seria aconsejable entender primero <em class="gem"><a class="link_to" href="../canvas/hexagono.php">como dibujar un hex&aacute;gono</a></em>.<br>
Para dibujar el cubo utilizamos 2 <mark>bucles for</mark> ( for loops ). El primer bucle ( <code>var i</code> ) construye cada rombo.<br>
Utilizamos un segundo bucle for ( <code>var j</code> ) para construir los tres rombos que representan las tres caras visibles del cubo.</p>

<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="cubo" width="69" height="80">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="cubo" width="69" height="80">Su navegador no soporta canvas :( </canvas> </article>
</div>
<h4>Patr&oacute;n de cubos</h4>
<p>Para dibujar el patr&oacute;ns utilizaremos la misma estrat&eacute;gia que hemos utilizado para dibujar el <em class="gem"><a class="link_to" href="http://w3.unpocodetodo.info/canvas/panal.php">panal de abejas</a></em>, con la &uacute;nica diferencia que en 
lugar de dibujar el cubo una y otra vez,  lo dibujaremos una sola vez en un <code>&lt;canvas&gt;</code> flotante, que se encuentra fuera de pantalla 
( <em class="gem">offscreen canvas</em> ) y utilizaremos la imagen generada para crear el patr&oacute;n.</p>



<h5>El &lt;canvas&gt; flotante</h5>
<p>Para crear el <code>&lt;canvas&gt;</code> flotante ( <code>bufferCanvas</code> ) utilizamos el m&eacute;todo <code>createElement</code>:</p>
<blockquote><p>var bufferCanvas = document.createElement("canvas");</p></blockquote>
<p>Esto crea un elemento <code>&lt;canvas&gt;</code> que se encuentra fuera de la pantalla, ya que todav&iacute;a no pertenece al DOM.<br>
A continuaci&oacute;n definimos tanto el contexto:</p>
<blockquote><p>bufferCanvasCtx = bufferCanvas.getContext("2d");</p></blockquote>
<p>como la altura y la anchura del canvas:</p>
<blockquote><p>bufferCanvasCtx.canvas.width = Math.sqrt(3)*R;<br>
bufferCanvasCtx.canvas.height = 2*R;</p></blockquote>
<p>Para entender las formulas utilizadas por favor vea primero <em class="gem"><a class="link_to" href="http://w3.unpocodetodo.info/canvas/panal.php">como dibujar un panal de abejas</a></em>. 
Tenga en cuenta que esta vez hemos girado el hex&aacute;gono unos 90&deg;.<br>
Utilizaremos este canvas flotante para dibujar el cubo, un cubo como el que ya hemos dibujado m&aacute;s arriba, y utilizaremos esta imagen para crear el patr&oacute;n.</p>
<div class="large-12 g_panel html">
        <article>								
...
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
	// el radio R del c&iacute;rculo circunscrito
	var R = 40;
	// la gama de colores elegida 
	var colores = ["#dde2f0", "#506ab1", "#b3bedd"];
	// las coordinadas del centro del c&iacute;rculo circunscrito
	var X = 0;
	var Y = 0;
	//el canvas flotante
	...
	if (canvas && canvas.getContext) {
	  ...
	  if (ctx) {
	    ...
	    var yoffset = (3 * R) / 2;
	    // para unas juntas perfectas y sin costuras recalculamos el tama&ntilde;o del canvas
	    ...
	    // Utilizaremos el canvas flotante como imagen para crear el patr&oacute;n.												
...
<p>Para recuperar la imagen utilice <em class="gem"><a class="link_to" href="../canvas/toDataURL.php">toDataURL</a></em><br>
<strong>Nota:</strong> Firefox nos permite abrir y guardar la imagen generada haciendo clic con el bot&oacute;n derecho del rat&oacute;n, y escogiendo la opci&oacute;n deseada.</p>  
