...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n que imita una placa met&aacute;lica con perforaciones" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, patrones, placa met&aacute;lica, placa metalica, perforaciones, agujeros"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Placa met&aacute;lica" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/placa-metalica.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n que imita una placa met&aacute;lica con perforaciones" /> 
  
  <title>Placa met&aacute;lica</title>
  ...
  <link rel="canonical" href="placa-metalica.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="placa-metalica.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="placa-metalica.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="placa-metalica">
<h2 class="page_title">Placa met&aacute;lica</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Placa met&aacute;lica&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fplaca-metalica.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fplaca-metalica.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fplaca-metalica.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>A continuaci&oacute;n vamos a dibujar un patr&oacute;n que imita el aspecto de una placa met&aacute;lica perforada.<br>
  Empezamos definiendo el radio del circulo imaginario que contiene el "agujero".</p>
  <blockquote><p>var R = 8;<br>
  el di&aacute;metro del agujero ser&aacute;:<br>
  var D = 2*R;</p></blockquote>
  <p>Para unas juntas perfectas y sin costuras recalculamos el tama&ntilde;o del <code>&lt;canvas&gt;</code>. 
  Tanto el ancho como el alto del <code>&lt;canvas&gt;</code> tiene que ser un m&uacute;ltiplo del di&aacute;metro. 
  Para esto echamos mano de <code>Math.round</code> que redondea un n&uacute;mero al entero m&aacute;s cercano.</p>
  <blockquote><p>canvas.width = Math.round( canvas.width/D )*D;<br>
  canvas.height = Math.round( canvas.height/D )*D;</p></blockquote>
<p>Ahora que tenemos todo esto definido podemos <mark>dibujar la placa base</mark> que ser&aacute; un rect&aacute;ngulo del tama&ntilde;o del <code>&lt;canvas&gt;</code>. 
Como fondo ( <a class="link_to" target="_blank" href="../canvas/fill.php">fillStyle</a> ) utilizamos un gradiente radial creado con <a class="link_to" target="_blank" href="../canvas/createRadialGradient.php">createRadialGradient()</a>.<br>
A continuaci&oacute;n podemos dibujar los "agujeros". <br>
Para esto utilizamos un <mark>bucle for</mark> (<code>for loop</code>) para distribuir los agujeros en una fila horizontal:</p>
<blockquote><p>for( var j = R; j < W*1.1; j+= D ){ ...<br>donde W = canvas.width.
<br>Utilizamos W*1.1 para no quedarnos con huecos en los bordes del canvas. </p></blockquote> 
<p>Empleamos otro <mark>bucle for</mark> (<code>for loop</code> ) para perforar varias filas de agujeros.</p>
<blockquote><p>for( var i = 0; i < H*1.1; i+= D ){ ...<br>donde H = canvas.height.</p></blockquote>
<p> Tenemos que tener en cuenta que cada segunda fila tendr&aacute; un desplazamiento lateral offset = R.<br>
Tambi&eacute;n haremos que el radio del "agujero" sea un poco mas peque&ntilde;o que R (<code>R-1</code>)</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="500" height="400">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
...
if (canvas && canvas.getContext) {
  ...
  if (ctx) {
    var R = 8; // el radio
    var D = R * 2; // el di&aacute;metro

    // para unas juntas perfectas y sin costuras recalculamos el tama&ntilde;o del canvas
    // tanto el ancho como el alto del canvas tiene que ser un m&uacute;ltiplo del di&aacute;metro
    ...
    for (var i = 0; i < H * 1.1; i += D) {
      ...
      for (var j = 0; j < W * 1.1; j += D) {
        // cada segunda hilera tendr&aacute; un desplazamiento lateral = R
        offset = (offset == 0) ? R : 0;
...
<div class="large-12 g_panel resultado">
 <article>
<canvas id="lienzo" width="500" height="400">Su navegador no soporta canvas :( </canvas> </article>
</div>
