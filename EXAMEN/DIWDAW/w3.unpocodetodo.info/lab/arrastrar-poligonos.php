...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar , arrastrar y soltar varios pol&iacute;gonos en el canvas de HTML5" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, arrastrar, soltar, arrastrar y soltar, dibujarUnaEstrella, dibujar una estrella, oMousePos, eventos del rat&oacute;n, eventos del raton, mousedown, mousemove, mouseup, mouseout, addEventListener, getBoundingClientRect, isPointInPath, pol&iacute;gonos regulares, paso, dibujarUnPoligono,  dibujar un pol&iacute;gono,  objeto, array, array de objetos"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Arrastrar pol&iacute;gonos" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/arrastrar-poligonos.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar , arrastrar y soltar varios pol&iacute;gonos en el canvas de HTML5" /> 
  
  <title>Arrastrar pol&iacute;gonos</title>
  ...
  <link rel="canonical" href="arrastrar-poligonos.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="arrastrar-poligonos.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="arrastrar-poligonos.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="arrastrar-poligonos">
<h2 class="page_title">Arrastrar pol&iacute;gonos</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Arrastrar pol&iacute;gonos&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-poligonos.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-poligonos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-poligonos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="arrastrar-estrellas.php">Arrastrar estrellas</a></em></p>
<!--<div class="large-12">
</div>id="chuleta"-->
<p>&iquest;Por qu&eacute; no volvernos locos? &iexcl;Perdamos la cabeza! En lugar de dibujar solo estrellas podemos dibujar todo tipo de <em class="gem"><a class="link_to" href="../canvas/poligonos.php">pol&iacute;gonos regulares</a></em>, y arrastrarlos y soltarlos por all&iacute;.<br>
Habr&aacute; que hacer muy pocos cambios.  En primer lugar tendremos que modificar la funci&oacute;n <code>dibujarUnaEstrella()</code> por tal de poder dibujar toda clase de <em class="gem"><a class="link_to" href="../canvas/poligonos.php">pol&iacute;gonos regulares</a></em> y <em class="gem"><a class="link_to" href="../canvas/estrellas.php">estrellas</a></em>. 
Le vamos a cambiar tambi&eacute;n el nombre en <code>dibujarUnPoligono()</code>.</p>
<p>La funci&oacute;n<code> dibujarUnPoligono()</code> toma 6 argumentos: las coordinadas <code>X</code> e <code>Y</code>, el radio<code> R</code>, el n&uacute;mero de lados del pol&iacute;gono <code>L</code>, el paso, y el <code>color</code>.
El <code>paso = 1</code> para pol&iacute;gonos convexos y <code>paso &gt; 1</code> para pol&iacute;gonos c&oacute;ncavos o estrellas. En el caso de los pol&iacute;gonos c&oacute;ncavos <code>L % paso  != 0</code></p>
...
<p>La funci&oacute;n <code>dibujarEstrellas()</code> pasar&aacute; a llamarse <code>dibujarPoligonos()</code></p>
<div class="large-12 g_panel js">
        <article>
                <pre><code class="language-javascript">
...
<p>Tambi&eacute;n habr&aacute; que reescribir el array que almacena los pol&iacute;gonos ( <code>poligonosRy</code> ):</p>
<div class="large-12 g_panel js">
        <article>
              <pre><code class="language-javascript">
var poligonosRy = [
