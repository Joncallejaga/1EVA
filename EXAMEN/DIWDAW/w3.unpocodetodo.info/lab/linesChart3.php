...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un graficos de l&iacute;neas - tercera parte. Ejemplo pr&aacute;ctico." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, graficos de l&iacute;neas, histogramas, line chart,la posicion del raton,isPointInPath, addEventListener, mousemove, getBoundingClientRect laboratorio"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="A&ntilde;adir un r&oacute;tulo flotante" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/linesChart3.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un graficos de l&iacute;neas - tercera parte. Ejemplo pr&aacute;ctico." /> 
  ...
  <link rel="canonical" href="linesChart3.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="linesChart3.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="linesChart3.php#top">&#8682;</a></b>
</div>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=A&ntilde;adir un r&oacute;tulo flotante&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart3.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FlinesChart3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="http://w3.unpocodetodo.info/linesChart2.php">gr&aacute;ficos de l&iacute;neas (2)</a></em></p>
<!--<div class="large-12">
</div>id="chuleta"-->
<h4>La funci&oacute;n oMousePos </h4>
<p>Puede ver la descripci&oacute;n de esta funci&oacute;n a <em class="gem"><a class="link_to" href="../canvas/mouse-position.php">la posici&oacute;n del rat&oacute;n</a></em>. 
Lo que hay que saber es que devuelve un objeto con las coordenadas del rat&oacute;n.</p>
...
<p>Cuando el rat&oacute;n pasa por encima del <code>&lt;canvas&gt;</code> la funci&oacute;n rotulador llama la funci&oacute;n <code>oMousePos()</code> que detecta la posici&oacute;n del rat&oacute;n y devuelve un objeto con las coordenadas x e y de este.<br>
  Si el rat&oacute;n ( cuyas coordenadas son <code>mousePos.x</code> y <code>mousePos.y</code> ) esta encima del peque&ntilde;o c&iacute;rculo</p>
  <blockquote><pre>if (ctx.isPointInPath(mousePos.x, mousePos.y)){...}</pre></blockquote>
<p>la funci&oacute;n <code>rotulador()</code>:<br>
  - escribe el rotulo<br>
  - hace visible el rotulo ( <code>rotulo.style.display="block";</code> )<br>
  - define la posici&oacute;n del rotulo ( enganchado al rat&oacute;n )<br>
  <strong>Observaci&oacute;n</strong>: Para que el m&eacute;todo <a class="link_to" target="_blank" href="../canvas/isPointInPath.php">isPointInPath()</a> funcione, tenemos que volver a esbozar el peque&ntilde;o c&iacute;rculo.</p>
<div class="large-12 g_panel js">
        <article>
<pre><code class="language-javascript">
function rotulador(o, nav, ano) {
  if (typeof window.addEventListener === "function") {
    canvas.addEventListener("mousemove", function(evt) {
      ...
      ctx.beginPath();
      // esboza de nuevo el peque&ntilde;o c&iacute;rculo
      ctx.arc(o, 270 - (oData[nav][ano] * 60) / 15, 5, 0, 2 * Math.PI);

      if (ctx.isPointInPath(mousePos.x, mousePos.y)) {
        rotulo.innerHTML = nav + " - " + ano + "<br>" + oData[nav][ano] + "%";
...
<div id="contenedor" style="position:relative; width:600px; height:300px; margin:0 auto;">
    <canvas id="lienzo" width="600" height="300"></canvas>
    <div id="rotulo" style=" display:none; position:absolute; padding:5px; background:white; border:1px solid #d9d9d9; font-size:80%;"></div>
</div></code></pre>
        </article>
</div>
<div class="large-12 g_panel js">
...
<p>Al pasar por encima de los "nodos" aparece un rotulo con el nombre del navegador, el a&ntilde;o y el porcentaje correspondiente de usuarios.</p>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="linesChart1.php">Gr&aacute;ficos de l&iacute;neas (1)</a></em></li><li>- <em class="gem"><a class="link_to" href="linesChart2.php">A&ntilde;adir una leyenda</a></em></li><li>- <em class="gem">A&ntilde;adir un r&oacute;tulo flotante</em></li></ul></article></div></div>
