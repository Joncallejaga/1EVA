...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un grafico circular - segunda parte. Ejemplo pr&aacute;ctico." />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, graficos circulares, graficos de sectores, graficos de tarta, graficos de pastel, pie chart, laboratorio, leyenda"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="A&ntilde;adir una leyenda" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/pieChart3.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un grafico circular - segunda parte. Ejemplo pr&aacute;ctico." /> 
  
  <title>A&ntilde;adir una leyenda</title>
  ...
  <link rel="canonical" href="pieChart3.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="pieChart3.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="pieChart3.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="pieChart3">
<h2 class="page_title">A&ntilde;adir una leyenda</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=A&ntilde;adir una leyenda&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart3.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="pieChart2.php">gr&aacute;ficos  circulares (2)</a></em></p>
<!--<h4>A&ntilde;adir una leyenda al gráfico</h4>-->
<p>Para a&ntilde;adir una leyenda tenemos que reorganizar un poco las cosas. Vamos a mover el gr&aacute;fico circular unos 75px hacia la derecha. De esta manera creamos el espacio necesario para la leyenda.</p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
// desplaza el gr&aacute;fico unos 75px hacia la derecha
var offset = 75;
// las coordenadas del centro del gr&aacute;fico
var X = (canvas.width / 2) - offset;
var Y = canvas.height / 2;
</code></pre>
        </article>
</div>
<p>Tambi&eacute;n tenemos que escribir una funci&oacute;n, <code>laLeyenda()</code>, que hace exactamente esto: crea la leyenda.
</p>
<h4>laLeyenda( )</h4>
<p>Las variables <code>lx</code> y <code>ly</code> representan las coordenadas de la esquina derecha arriba de la leyenda.<br>
Tambi&eacute;n hay que definir algunas propiedades del <a class="link_to" href="../canvas/text.php">texto</a>: </p>
<blockquote><p>ctx.textBaseline="top";<br>
ctx.font="12px Verdana";</p></blockquote>
<p>A continuaci&oacute;n para cada propiedad del objeto oData <code>for(var propiedad in oData)</code> dibujamos una l&iacute;nea de la leyenda ( casilla y texto ).<br>
En paralelo restamos el valor de esta propiedad de <code>otrosValue</code> ( inicialmente el valor de <code>otrosValue = 100</code>, o sea 100% ).
De esta manera al final del bucle tendremos calculado el porcentaje de usuarios que utilizan otros navegadores.<br>
...
function laLeyenda() {
  ...
  for (var propiedad in oData) {
	...
	// dibuja el texto
    ctx.fillStyle = '#333';
    // la descripci&oacute;n: navegador y porcentaje de usuarios
    ...
    // calcula el valor de ly para la siguiente l&iacute;nea
    ly += 23;
  }
...
if (canvas && canvas.getContext) {
  ...
  if (ctx) {
    ...
    function dibujarGrafico() {
      // dibuja la base del gr&aacute;fico
      ctx.fillStyle = '#ddd';
      ctx.moveTo(X, Y);
...
<p><em class="gem"><a class="link_to" href="pieChart4.php">Contin&uacute;a leyendo</a>...</em></p>
