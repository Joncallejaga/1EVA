...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Resortes en canvas" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, animaci&oacute;n, animacion sencilla, animaci&oacute;n en &aacute;ngulo, velocidad,aceleraci&oacute;n,fricci&oacute;n, resorte, mousemove,mouseleave"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Resortes en canvas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/animacion-y-resortes.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Resortes en canvas" /> 
  
  <title>Resortes en canvas</title>
  ...
  <link rel="canonical" href="animacion-y-resortes.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animacion-y-resortes.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animacion-y-resortes.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="animacion-y-resortes"><h2 class="page_title">Resortes en canvas</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Resortes en canvas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fanimacion-y-resortes.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fanimacion-y-resortes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fanimacion-y-resortes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12"><p>Cuando utilizamos curvas de velocidad (easing) la velocidad de la pelota es proporcional con la distancia. En el caso de los resortes (springs) <mark>la aceleraci&oacute;n es proporcional con la distancia</mark>.</p>  <h4>Resortes en una sola dimensi&oacute;n</h4><p>A continuaci&oacute;n utilizamos <a class="link_to" target="_blank" href="animacion-sencilla.php#objetos">la misma pelota de siempre</a>:</p><blockquote><pre>function Pelota(r) {   this.r = r;   this.x = 2 * r;   this.y = cy;   this.destino_x = cx;    this.destino_y = this.y;    this.vx = 0;   this.color = "#6ab150";}</pre></blockquote><p>Necesitamos establecer un valor para el resorte</p><blockquote><pre>var resorte = .01;<span class="com">// spring</span></pre></blockquote><p>Calculamos la distancia entre el centro de la pelota <code>this.x</code> y el punto de destino <code>this.destino_x</code>:</p><blockquote><pre>var distancia = (this.destino_x - this.x);</pre></blockquote><p>En el caso de los resortes (springs) la aceleraci&oacute;n es proporcional con la distancia.</p><blockquote><pre><span class="str">var aceleracion = distancia * resorte;</span></pre></blockquote><p>Despu&eacute;s todo va como antes: a la velocidad de la pelota <code>this.vx</code> le sumamos la aceleraci&oacute;n: </p><blockquote><pre>this.vx += aceleration;</pre></blockquote><p>y a la posici&oacute;n de la pelota <code>this.x</code> le sumamos la velocidad.</p><blockquote><pre>this.x += this.vx;</pre></blockquote><p data-height="350" data-theme-id="11360" data-slug-hash="fa262c0c8ef822199345a93247fce40d" data-default-tab="result" data-user="enxaneta" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/fa262c0c8ef822199345a93247fce40d/">resortes* #1</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h4>Resortes y fricci&oacute;n</h4><p>Lo que hemos visto hasta ahorra es muy interesante pero las cosas no pasan as&iacute; en realidad. Para que las cosas parezcan reales tenemos que tener en cuenta la <a class="link_to" target="_blank" href="animacion-y-friccion.php">fricci&oacute;n</a>. En el siguiente ejemplo la funci&oacute;n <code>actualizar</code> se ocupa de este aspecto. Esta vez trabajamos en dos dimensiones.</p><blockquote><pre>Pelota.prototype.actualizar = function() {  var distanciaX = (this.destino_x - this.x);  var distanciaY = (this.destino_y - this.y);  var accelerationX = distanciaX * resorte;  var accelerationY = distanciaY * resorte;  this.vx += accelerationX;  this.vy += accelerationY;  <span class="str">  this.vx *= friccion;  this.vy *= friccion;</span>        this.x += this.vx;  this.y += this.vy;}</pre></blockquote><p data-height="350" data-theme-id="11360" data-slug-hash="a111a333c5b8b3a25648255ba9bda0d8" data-default-tab="result" data-user="enxaneta" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/a111a333c5b8b3a25648255ba9bda0d8/">resortes + fricci&oacute;n* #2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h4>Siguiendo al rat&oacute;n</h4><p>Tambi&eacute;n podemos utilizar el easing para crear un movimiento un poco extra&ntilde;o siguiendo el rat&oacute;n. Para esto primero hemos de a&ntilde;adir una funci&oacute;n que nos ayuda obtener <a class="link_to" target="_blank" href="../canvas/mouse-position.php">la posici&oacute;n del rat&oacute;n encima del canvas</a></p><blockquote><pre>function oMousePos(canvas, evt) {    var ClientRect = canvas.getBoundingClientRect();    return {       x: Math.round(evt.clientX - ClientRect.left),      y: Math.round(evt.clientY - ClientRect.top)	}}</pre></blockquote><p>Queremos detectar la posici&oacute;n del rat&oacute;n encima del canvas, cuando el rat&oacute;n pase por encima (on <code>"mousemove"</code>,):</p><blockquote><pre>canvas.addEventListener(<span class="str">"mousemove"</span>, function(evt) {   m = oMousePos(canvas, evt); },false);</pre></blockquote><p>Tambi&eacute;n queremos que la pelota vuelva en el centro del canvas (<code>cx</code>,<code>cy</code>) cuando el rat&oacute;n salga del canvas (on <code>"mouseleave"</code>):</p><blockquote><pre>canvas.addEventListener(<span class="str">"mouseleave"</span>, function() {   m = {x:cx,y:cy};   },false);</pre></blockquote><p><strong>Y aqu&iacute; viene la parte importante</strong>: en el c&oacute;digo de antes reemplazamos las coordenadas del punto de destino (<code>this.destino_x</code>, <code>this.destino_y</code>) con las coordenadas del rat&oacute;n (<code>m.x</code>,<code>m.y</code>). Y ya est&aacute;.</p><p data-height="350" data-theme-id="11360" data-slug-hash="82c424c2d50ba91fc4aabc9f9d46db97" data-default-tab="result" data-user="enxaneta" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/82c424c2d50ba91fc4aabc9f9d46db97/">resortes + fricci&oacute;n + rat&oacute;n* #3</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script></div>           </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="animaciones-en-canvas.php">requestAnimationFrame</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-sencilla.php">Animaci&oacute;n sencilla</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-y-velocidad.php">Animaci&oacute;n y velocidad</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-ida-vuelta.php">Animaci&oacute;n de ida vuelta</a></em></li><li>- <em class="gem"><a class="link_to" href="animar-particulas.php">Animar particulas</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-copos.php">Copos de nieve</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-conectar-particulas.php">Conectar particulas</a></em></li><li>- <em class="gem"><a class="link_to" href="dejar-rastro.php">Dejar rastro</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-fuente-de-particulas.php">Fuente de particulas</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-y-aceleracion.php">Animaci&oacute;n y aceleraci&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="animaciones-lanzar-la-pelota.php">Lanzar la pelota</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-y-friccion.php">Animaci&oacute;n y fricci&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-y-easing.php">Animaci&oacute;n y easing</a></em></li><li>- <em class="gem"><a class="link_to" href="animacion-circular-easing.php">Easing circular</a></em></li><li>- <em class="gem">Resortes en canvas</em></li><li>- <em class="gem"><a class="link_to" href="viscosidad.php">Viscosidad</a></em></li></ul></article></div></div>
