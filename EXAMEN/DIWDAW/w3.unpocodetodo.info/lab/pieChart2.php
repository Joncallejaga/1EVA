...
<head>
  ...
  <meta property="og:title" content="M&aacute;s sectores circulares" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/pieChart2.php" /> 
  ...
  <title>M&aacute;s sectores circulares</title>
  ...
  <link rel="canonical" href="pieChart2.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="pieChart2.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="pieChart2.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">M&aacute;s sectores circulares</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=M&aacute;s sectores circulares&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart2.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2FpieChart2.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="pieChart1.php">gr&aacute;ficos  circulares (1)</a></em></p>
<!--<h4>M&aacute;s sectores circulares</h4>-->
<p>A continuaci&oacute;n vamos a dibujar los otros sectores circulares ( para Firefox, Chrome, Safari y Opera ). 
Para esto vamos a utilizar la funci&oacute;n <code>sectorCircular()</code> que hemos escrito anteriormente.<br>
Tenemos que tener en cuenta que cada nuevo sector circular empieza donde acaba el anterior ( <code>var ap = af</code> ).</p>
...
<p>Dibujando los sectores circulares uno por uno observamos que el c&oacute;digo se repite de manera mon&oacute;tona y previsible. 
Lo que quiere decir que podemos ponerlo todo en una funci&oacute;n ( <code>dibujarGrafico()</code> )</p>
...
<p>Y es as&iacute; como queda el c&oacute;digo:</p>
<div class="large-12 g_panel js">
        <article>
        <pre><code class="language-javascript">
window.onload = function() {
  ...
  if (canvas && canvas.getContext) {
    ...
    if (ctx) {
      ...
      // llama la funci&oacute;n dibujarGrafico;
      dibujarGrafico();
    }
  }
}</code></pre>
...
<p><em class="gem"><a class="link_to" href="pieChart3.php">Contin&uacute;a leyendo</a>...</em></p>
