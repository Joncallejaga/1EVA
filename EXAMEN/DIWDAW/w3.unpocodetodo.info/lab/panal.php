...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n que imita un panal de abejas" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, patrones, panal, abejas, panal de abejas, hex&aacute;gonos, hexagonos"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Panal de abejas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/panal.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como construir un patr&oacute;n que imita un panal de abejas" /> 
  
  <title>Panal de abejas</title>
  ...
  <link rel="canonical" href="panal.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="panal.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="panal">
<h2 class="page_title">Panal de abejas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Panal de abejas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpanal.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpanal.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Fpanal.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>A continuaci&oacute;n vamos a dibujar un patr&oacute;n que imita un panal de abejas. Un panal es una estructura formada por celdillas hexagonales que comparten paredes. 
Por lo tanto dibujamos una por una las celdillas hexagonales, dejando un peque&ntilde;o espacio ( la pared ) entre ellas. 
En el siguiente ejemplo el espaciado de celda es de 1 px ( <code>var espaciado = 1;</code> ) pero puede ser modificado f&aacute;cilmente, sin que esto afecte la estructura del panal.</p>
<p><em class="gem">Como dibujar un <a class="link_to" href="../canvas/hexagono.php">hex&aacute;gono</a></em></p>
<p>Empezamos definiendo algunas variables necesarias:</p>
<blockquote><pre>
<span class="com">// El radio:</span>
var R = 30;
<span class="com">// El di&aacute;metro:</span>
var D = R*2;
</pre></blockquote>
  <div class="row">
  <div class="large-6 columns text-center"><img src="images/hexagono.png" width="250" height="240" alt="hexagono"></div>
  <div class="large-6 columns text-center"><img src="images/hex_offset.png" width="250" height="230" alt="hexagonos"></div>
  </div>
<p>Ya que la segunda fila de celdillas esta desplazada tanto en x ( horizontalmente ) como en y ( verticalmente ) relativamente a la fila anterior, calculamos dos variables m&aacute;s:</p>
<blockquote><pre>
<span class="com">// El desplazamiento en y:</span>
var yoffset = Math.sqrt(3) / 2 * R;
<span class="com">// El desplazamiento en x:</span>
var xoffset = (3*R)/2;
</pre></blockquote>
<p>Para unas juntas perfectas y sin costuras recalculamos el tama&ntilde;o del <code>&lt;canvas&gt;</code>. El ancho como el alto del <code>&lt;canvas&gt;</code> tiene que ser un 
m&uacute;ltiplo del di&aacute;metro.</p>
<blockquote><pre>canvas.width = Math.round(canvas.width/D)*D;</pre></blockquote>
<p>El alto del <code>&lt;canvas&gt;</code> tiene que ser un m&uacute;ltiplo de la altura del hex&aacute;gono.</p>
<blockquote><pre>
canvas.height = Math.round(canvas.height/(2*yoffset))*(2*yoffset);</pre></blockquote>
<p>Tambi&eacute;n definimos el color de relleno de las celdillas (<code>fillStyle</code>), el color de los bordes (<code>strokeStyle</code>) y el ancho de los bordes (<code>lineWidth</code>).</p>

<p>Para que el c&oacute;digo sea m&aacute;s eficiente escribimos una funci&oacute;n que dibuja los hex&aacute;gonos uno por uno. Es importante redefinir dentro de la funci&oacute;n el valor de <code>canvas</code> y del contexto <code>ctx</code>.</p>
...
<p><em class="gem">Para entender mejor la funci&oacute;n <code>dibujarHexagono()</code> vea como dibujar un <a class="link_to" href="../canvas/hexagono.php">hex&aacute;gono</a></em></p>



<p>Utilizamos un 
  <mark>bucle for</mark> (<code>for loop</code>) para dibujar las primeras dos filas de celdillas, y otro <mark>bucle for</mark> (<code>for loop</code>) para repetirlo todo en y.</p>
<div class="large-12 g_panel html">
        <article>								
		<pre><code class="language-markup"><canvas id="lienzo" width="350" height="300">Su navegador no soporta canvas :( </canvas></code></pre>
        </article>
</div>  
<div class="large-12 g_panel js">
        <article>
...
<div class="large-12 g_panel resultado">
 <article><canvas id="lienzo" width="350" height="300">Su navegador no soporta canvas :( </canvas></article>
</div>
<p>Para recuperar la imagen utilice <em class="gem"><a class="link_to" href="../canvas/toDataURL.php">toDataURL</a></em></p>
