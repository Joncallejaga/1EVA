...
<head>
  ...
  <meta name="description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar , arrastrar y soltar estrellas en el canvas de HTML5" />
  <meta name="keywords" content="tutorial, canvas, lienzo, HTML5, javaScript, arrastrar, soltar, arrastrar y soltar, dibujarUnaEstrella, dibujar una estrella, oMousePos, eventos del rat&oacute;n, eventos del raton, mousedown, mousemove, mouseup, mouseout, addEventListener, getBoundingClientRect, isPointInPath,globalAlpha, dibujarLasEstrellas, dibujar estrellas, delta, objeto, array, array de objetos"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Arrastrar estrellas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/lab/arrastrar-estrellas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Tutorial HTML5 canvas con material de consulta y ejemplos. Como dibujar , arrastrar y soltar estrellas en el canvas de HTML5" /> 
  
  <title>Arrastrar estrellas</title>
  ...
  <link rel="canonical" href="arrastrar-estrellas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="arrastrar-estrellas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="arrastrar-estrellas.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="arrastrar-estrellas">
<h2 class="page_title">Arrastrar estrellas</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Arrastrar estrellas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-estrellas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-estrellas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Flab%2Farrastrar-estrellas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Esta es una continuaci&oacute;n de <a class="link_to" href="arrastrar-y-soltar.php">Arrastrar y soltar</a></em></p>
<!--<div class="large-12">
</div>id="chuleta"-->
<p>A continuaci&oacute;n haremos lo mismo, pero esta vez vamos a dibujar y arrastrar varias estrellas. <br>
Cada estrella ser&aacute; definida por sus coordenadas: las coordenadas <code>X</code> e <code>Y</code> del centro de la estrella y el radio <code>R</code>.  
Tambi&eacute;n especificaremos el <code>color</code> de cada estrella y una propiedad m&aacute;s: <code>bool</code> que es un booleano que nos permite identificar la estrella que movemos (<code>bool = true</code>) de las dem&aacute;s estrellas (<code>bool = false</code>)</p>
<p>Con las coordinadas y dem&aacute;s caracter&iacute;sticas de cada estrella vamos a construir un objeto, y vamos a almacenar todos estos objetos en un array de estrellas (<code>estrellasRy</code>)<br>
Vamos a ordenar este array con <code>sort()</code> por el tama&ntilde;o del radio (<code>R</code>) de cada estrella.</p>
...
<p>Para que sea evidente que pasa con una estrella cuando acaba debajo de otra m&aacute;s grande, todos los trazados del <code>&lt;canvas&gt;</code> tienen una opacidad de 85% (<code>ctx.globalAlpha=0.85</code>).</p>
<h4>Redibujar todas las estrellas</h4>
<p>Habr&aacute; que tener en cuenta que despu&eacute;s de limpiar el <code>&lt;canvas&gt;</code> con <em class="gem"><a class="link_to" href="../canvas/rectangulo.php#h4_2">clearRect()</a></em>, tenemos que redibujar todas las estrellas del "firmamento". 
Por lo tanto tenemos que escribir una funci&oacute;n <code>dibujarEstrellas()</code> que haga exactamente esto: redibujar todas las estrellas.</p>
<div class="large-12 g_panel js">
        <article>
                <pre><code class="language-javascript">
...
<p>A continuaci&oacute;n haremos lo mismo, pero esta vez vamos a dibujar y arrastrar varias tipos de pol&iacute;gonos. <em class="gem"><a class="link_to" href="arrastrar-poligonos.php">Contin&uacute;a leyendo</a>...</em></p>
