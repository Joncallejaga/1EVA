...
<head>
  ...
  <meta name="description" content="Las pseudo clases first-child, last-child, only-child, first-of-type, last-of-type, only-of-type" />
  <meta name="keywords" content="css, selectores, pseudo clases, pseudo elementos, primero, &uacute;ltimo, &uacute;nico, hijo, child, de su tipo, type, first-child, last-child, only-child, first-of-type, last-of-type, only-of-type"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El primero, el &uacute;ltimo, el &uacute;nico" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selectores-first-last-only.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Las pseudo clases first-child, last-child, only-child, first-of-type, last-of-type, only-of-type" /> 
  
  <title>El primero, el &uacute;ltimo, el &uacute;nico</title>
  ...
  <link rel="canonical" href="selectores-first-last-only.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selectores-first-last-only.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selectores-first-last-only.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="selectores-first-last-only"><h2 class="page_title">El primero, el &uacute;ltimo, el &uacute;nico</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El primero, el &uacute;ltimo, el &uacute;nico&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-first-last-only.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-first-last-only.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-first-last-only.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>La pseudo clase :first-child</h4><p>La pseudo clase <code>:first-child</code> se utiliza para seleccionar y dar estilo a un elemento HTML si es el <mark>primer hijo</mark> de su padre. Por ejemplo podemos tener una lista <code>&lt;ul</code>&gt; cuyos elementos <code>&lt;li&gt; </code>tienen <code>margin:0</code>  y un borde de 1px. Para no sobreponer bordes podemos dibujar solo los bordes derecho izquierdo e inferior de cada elemento <code>&lt;li&gt;</code>, y utilizar li:first-child para dibujar el borde superior del primer elemento.</p><blockquote><pre>li{  border:1px solid;  border-top:none;}li:first-child{  border-top: 1px solid;}</pre></blockquote><h4>La pseudo clase :last-child</h4><p>La pseudo clase <code>:last-child </code>se utiliza para seleccionar y dar estilo a un elemento HTML si es el <mark>&uacute;ltimo hijo</mark> de su padre. La primera cosa que me viene en mente es un ejemplo parecido al ejemplo anterior, solo que esta vez para no sobreponer bordes voy a dibujar solo los bordes derecho izquierdo e superior de cada elemento <code>&lt;li&gt;</code>, y utilizar li:last-child para dibujar el borde inferior del &uacute;ltimo elemento.</p><blockquote><pre>li{   border:1px solid;   border-bottom:none;}li:first-child{   border-bottom: 1px solid;}</pre></blockquote><h4>La pseudo clase :only-child</h4><p>La pseudo clase :only-child se utiliza para seleccionar y dar estilo a un elemento HTML que es el &uacute;nico hijo de su padre. </p><p>Podemos lograr lo mismo utilizando dos pseudo clases juntas, por ejemplo <code>:first-child:last-child</code> o <code>:nth-child(1):nth-last-child(1)</code>, con la &uacute;nica diferencia que dos selectores juntos tienen una especificidad m&aacute;s alta.</p><h4>La pseudo clase :first-of-type</h4><p>La pseudo clase <code>:first-of-type</code> se utiliza para seleccionar y dar estilo a un elemento HTML si es el <mark>primer elemento de su typo </mark>dentro del contenedor padre.</p><blockquote><pre>&lt;article&gt;    &lt;h1&gt;Un titulo&lt;/h1&gt;    &lt;p&gt;Primer p&aacute;rrafo.&lt;/p&gt;    &lt;p&gt;Segundo p&aacute;rrafo. &lt;/p&gt;&lt;/article&gt;</pre></blockquote><p>Para seleccionar y dar estilo al primer p&aacute;rrafo utilizamos:</p><blockquote><pre>p:first-of-type{color:#555;}</pre></blockquote><h4>La pseudo clase :last-of-type</h4><p>La pseudo clase <code>:last-of-type </code>se utiliza para seleccionar y dar estilo a un elemento HTML si es el <mark>&uacute;ltimo elemento de su tipo</mark> dentro del contenedor padre.</p><p>En el ejemplo de arriba, para seleccionar y dar estilo al &uacute;ltimo p&aacute;rrafo utilizamos:</p><blockquote><pre>p:last-of-type{color:#333;}</pre></blockquote><h4>La pseudo clase :only-of-type</h4><p>La pseudo clase :only-of-type selecciona y da estilo a un elemento HTML si es el <mark>&uacute;nico elemento de su tipo </mark>dentro del contenedor padre.</p><p>Todas estas pseudo clases pueden ser concadenadas con otras pseudo clases o pseudo elementos como por ejemplo <code>::before</code> y <code>::after</code>.</p></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-12 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="selector-nth-child.php">El en&eacute;simo hijo</a></em></li><li>- <em class="gem">El primero, el &uacute;ltimo, el &uacute;nico</em></li><li>- <em class="gem"><a class="link_to" href="selectores-before-after.php">::before y ::after</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-checked.php">El selector :checked</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-target.php">El selector :target</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-empty.php">El selector :empty</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-not.php">El selector :not()</a></em></li><li>- <em class="gem"><a class="link_to" href="seleccion.php">El selector  ::selection</a></em></li><li>- <em class="gem"><a class="link_to" href="placeholder.php">Marcadores de posici&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="pseudo-elemento-first-letter.php">La primera letra</a></em></li><li>- <em class="gem"><a class="link_to" href="link_visited_hover_active.php">:link, :visited, :hover y :active</a></em></li></ul></article></div></div>
