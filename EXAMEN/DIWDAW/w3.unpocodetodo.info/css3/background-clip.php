...
<head>
  ...
  <meta name="description" content="La propiedad background-clip de CSS especifica hasta donde se extiende el fondo ( background ) de un elemento, ya sea color o imagen." />
  <meta name="keywords" content="background-clip,  border-box, padding-box, content-box, imagen de fondo, background, mascaras de texto"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="background-clip" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/background-clip.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad background-clip de CSS especifica hasta donde se extiende el fondo ( background ) de un elemento, ya sea color o imagen." /> 
  ...
  <link rel="canonical" href="background-clip.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="background-clip.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="background-clip.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">background-clip</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=background-clip&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-clip.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-clip.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-clip.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<!--<h4>Primero recordemos el modelo de caja</h4>
<p>Las partes que componen cada caja son el contenido ( <em class="gem">content</em> ), el relleno ( <em class="gem">padding</em> ) el borde ( <em class="gem">border</em> ) y el margen ( <em class="gem">margin</em> ).</p>
<div class="large-6 push-3 text-center"><img src="images/box-model.png" width="410" height="270" alt="box-model"></div>



<h4>La propiedad background-clip</h4>-->
<p>La propiedad <code>background-clip</code> de CSS3 especifica  hasta donde se extiende el fondo ( <em class="gem">background</em> ) de un elemento, ya sea color o imagen. 
Por defecto el fondo ( <em class="gem">background</em> ) se extiende hasta el limite externo del borde.</p>
<p>En los siguientes ejemplos utilizamos un borde discontinuo ( <code>dashed</code> ) muy grueso ( <code>20px</code> ) verde oscuro ( <code>#050</code> ). 
  Como que el borde es discontinuo podemos ver hasta donde se extiende el color de fondo.</p>
<p><em class="gem">Lea m&aacute;s sobre <a class="link_to" target="_blank" href="box-sizing.php">el modelo de caja en el CSS3</a></em></p>
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkclip"><p>el valor por defecto</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkclip"><p>el valor por defecto</p></div>        </article>
</div> 
<h4>Sintaxis</h4>
<p>El valor de la propiedad background-clip puede ser una de estas palabras clave:</p>


<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">background-clip: border-box | padding-box | content-box  | text | inherit;
</em>
</p>
</article>
</div>
...
<h4>border-box</h4>
<p>Si <code>background-clip: border-box;</code> el fondo ( <em class="gem">background</em> ) se extiende hasta el limite externo del borde.</p>
...
#borderBox{background-clip:border-box;}</code></pre>							
        </article>
</div>       
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkclip" id="borderBox"><p>border-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado center">
        <article>
        <div class="bkclip" id="borderBox"><p>border-box</p></div>        </article>
</div> 

<h4>padding-box</h4>
<p>Si <code>background-clip: padding-box;</code> el  fondo ( <em class="gem">background</em> ) se extiende hasta el limite externo del relleno ( <em class="gem">padding</em> ).</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.bkclip{
...
#paddingBox{background-clip:padding-box;}</code></pre>								
        </article>
</div>       
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkclip" id="paddingBox"><p>padding-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkclip" id="paddingBox"><p>padding-box</p></div>        </article>
</div> 

<h4>content-box</h4>
<p>Si <code>background-clip: content-box;</code> el  fondo ( <em class="gem">background</em> ) aparece solo dentro del ( <em class="gem">clipped to</em> ) contenido de la caja.</p>
<p><strong>Observaci&oacute;n</strong>: el espacio en blanco que queda entre el contenido y el borde representa el relleno ( <code>padding:20px</code> ) de la caja.</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.bkclip{
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkclip" id="contentBox"><p>content-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkclip" id="contentBox"><p>content-box</p></div>        </article>
</div> 


<h4>Crear mascaras de texto</h4>
<p>En el CSS3, exactamente como en Photoshop, o en <a class="link_to" target="_blank"  href="http://w3.unpocodetodo.info/svg/introduccion.php">SVG</a>, podemos crear mascaras de texto. O casi. De hecho Firefox todav&iacute;a no nos deja hacerlo.</p>
<p>En el siguiente ejemplo utilizamos el titular <code>&lt;h1 class="panal"&gt;</code> para crear una mascara de texto. Para esto – ya lo sabemos – el texto tiene que ser transparente ( <code>color:transparent;</code> ).<br />
  El problema es que <code>background-clip: text;</code> no funciona en el Firefox, y como que el texto es transparente, los usuarios de este navegador ver&iacute;an solo el "panal" de fondo ( <code>background-image:url(images/panal.jpg);</code> ).</p>
<h6>Hablemos de text-fill-color</h6>
<p>La propiedad <code>text-fill-color</code> permite, exactamente como la propiedad <code>color</code>, especificar el color de relleno del texto. Si las dos propiedades est&aacute;n especificadas, la propiedad <code>text-fill-color</code> tendr&aacute; prioridad sobre la propiedad <code>color</code>. <br />
En el siguiente ejemplo utilizamos la propiedad <code>-webkit-text-fill-color</code> que  tiene prioridad sobre la propiedad <code>color</code> solo en los navegadores basados en <code>–webkit-</code>. Firefox en cambio ignora las propiedades que tienen el prefijo<code> –webkit-</code>, y toma en consideraci&oacute;n solo la propiedad <code>color</code>: exactamente lo que necesitamos.</p>
<p><span class="str">NOTA:</span> <strong>background-clip: text</strong> no funciona en Firefox.</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
h1#panal {
