...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3: pseudo-clases. Seleccionar al en&eacute;simo hijo con  :nth-child." />
  <meta name="keywords" content="tutorial, html5, css, css3, pseudo-class, pseudo-clases, nth-child, nth-last-child, nth-of-type, nth-last-of-type, selectores nth-child concatenados,hijos impares, :nth-child(odd),hijos pares, :nth-child(even), :nth-child(an+b),"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El en&eacute;simo hijo" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selector-nth-child.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3: pseudo-clases. Seleccionar al en&eacute;simo hijo con  :nth-child." /> 
  
  <title>El en&eacute;simo hijo</title>
  ...
  <link rel="canonical" href="selector-nth-child.php"> 
 
  <style>
.resultado ul{width:200px; margin: 0 auto; padding:0;}  
.resultado li{ 
...
th{ color:white!important; background-color:#CC3366;}
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selector-nth-child.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selector-nth-child.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="selector-nth-child">
<h2 class="page_title">El en&eacute;simo hijo</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El en&eacute;simo hijo&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-nth-child.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-nth-child.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-nth-child.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Seleccionar al en&eacute;simo hijo con  :nth-child()</h4>
<p>En el CSS3 podemos seleccionar al en&eacute;simo hijo de una caja padre utilizando el selector <code>:nth-child</code> ( de hecho una pseudo-clase ).
  Por ejemplo: dada una lista <code>&lt;ul&gt;</code> de 5 art&iacute;culos,  <code>li:nth-child(3)</code> selecciona el tercer art&iacute;culo de la lista.</p>
...
<ul id="ul1">
   <li>art&iacute;culo 1</li>
   <li>art&iacute;culo 2</li> 
   <li>art&iacute;culo 3</li>
   <li>art&iacute;culo 4</li>
   <li>art&iacute;culo 5</li>
</ul></code></pre>
        </article>
</div>       
...
<p>Pero el selector <code>:nth-child</code> puede hacer mucho m&aacute;s que esto.</p> 
<h4>Utilizando palabras clave</h4>
<p>Podemos seleccionar los hijos <mark>impares</mark> ( <code>odd</code> ) o <mark>pares</mark> ( <code>even</code> ) utilizando las palabras clave <code>odd</code> o <code>even</code>.
  Por ejemplo: dada la misma lista <code>&lt;ul&gt;</code> de 5 art&iacute;culos ,  <code>li:nth-child( even )</code> selecciona los art&iacute;culos 2 y 4, ( los amarillos ) mientras que <code>li:nth-child( odd )</code> selecciona los art&iacute;culos 1, 3 y 5 ( los azules ).</p>
...
<h4>Utilizando f&oacute;rmulas <small>:nth-child( an+b )</small></h4>
<p>Tambi&eacute;n podemos utilizar f&oacute;rmulas, lo que es fant&aacute;stico e inusual si pensamos que esto es CSS. Por ejemplo <code>li:nth-child(2n)</code> selecciona todos los hijos pares, mientras que  <code>li:nth-child(3n)</code> selecciona cada hijo cuyo &iacute;ndice es un m&uacute;ltiplo de 3.</p>
  <div class="large-12 g_panel css">
        <article>								
		<pre><code class="language-css">
#ul3 li:nth-child( 2n ){ background-color:LightSkyBlue;}
...
<p>Pero podemos hacer cosas todav&iacute;a m&aacute;s complicadas y m&aacute;s interesantes: <code>li:nth-child(2n+1)</code> selecciona los elementos 1, 3, 5 y 7 de la siguiente lista.</p>
  <div class="large-12 g_panel css">
        <article>								
		<pre><code class="language-css">
#ul4 li:nth-child( 2n+1 ){ background-color:LightSkyBlue;}
...
<ul id="ul4">
   ...
   <li>art&iacute;culo 4</li>
   <li>art&iacute;culo 5</li>
   <li>art&iacute;culo 6</li>
   <li>art&iacute;culo 7</li>
</ul></code></pre>
        </article>
</div>       
<div class="large-12 g_panel resultado">
...
<p><strong>&iquest;Como lo hace? y &iquest;qu&eacute; significa n</strong>? 
  El par&aacute;metro <code>n</code> es un <mark>contador</mark> que empieza a 0. Para entender porque <code>li:nth-child(2n+1)</code> selecciona los elementos 1, 3, 5 y 7 miremos la siguiente tabla:</p>

<table class="text-center">
  <tr>
    <th width="110" valign="top">El par&aacute;metro n</th>
    <th width="110" valign="top">2n+1</th>
    <th width="110" valign="top">=</th>
  </tr>
  <tr>
    <td width="110" valign="top">0</td>
    <td width="110" valign="top">2*0+1</td>
    <td width="110" valign="top">1</td>
  </tr>
  <tr>
    <td width="110" valign="top">1</td>
    <td width="110" valign="top">2*1+1</td>
    <td width="110" valign="top">3</td>
  </tr>
  <tr>
    <td width="110" valign="top">2</td>
    <td width="110" valign="top">2*2+1</td>
    <td width="110" valign="top">5</td>
  </tr>
  <tr>
    <td width="110" valign="top">3</td>
    <td width="110" valign="top">2*3+1</td>
    <td width="110" valign="top">7</td>
  </tr>
</table>

<p>La formula que hemos utilizado se puede escribir as&iacute;: <code>nth-child(an+b)</code>. En el ejemplo anterior <code>a</code> = 2, y <code>b</code>=1. Los par&aacute;metros <code>a</code> y <code>b</code> son n&uacute;meros enteros y pueden tomar tanto valores positivos como negativos. <br />
  <a target="_blank" class="link_to" href="http://www.sitepoint.com">www.sitepoint.com</a>  p&uacute;blica, en un <a target="_blank" class="link_to" href="http://www.sitepoint.com/web-foundations/understanding-nth-child-pseudo-class-expressions/#understandingnthchildexpressions__tbl_resultsetsfornthchildpseudoclassexpressions">art&iacute;culo interesante</a> acerca del selector <code>nth-child</code>, esta tabla muy &uacute;til con los valores resultantes para <code>nth-child(an+b)</code>:</p>
...
<h4>Utilizando varios selectores nth-child concatenados</h4>

<p>En el siguiente ejemplo utilizamos dos selectores <code>nth-child</code> concatenados. El primer selector</p>
<blockquote><p>li:nth-child(-n+16)</p></blockquote>
<p>selecciona las primeras 16 autonom&iacute;as de la lista. Si concatenamos otro selector, por ejemplo:</p>
<blockquote><p>li:nth-child(-n+16)<span class="str">:nth-child( 2n+4 )</span></p> </blockquote>
<p>de las primeras 16 autonom&iacute;as ( el primer selector ) seleccionamos solo los elementos pares ( <span class="str">2n</span>+4 ) , empezando con el cuarto ( 2n+<span class="str">4</span> ).</p>
<div class="large-12 g_panel css">
        <article>								
		<pre><code class="language-css">
#autonomias li:nth-child(-n+16){ background-color:Gold;}
...
<h4>Alternancia de etiquetas</h4>
<p>Utilizar una lista puede ser bastante ilustrativo, pero veamos que pasa si utilizamos una alternancia de t&iacute;tulos ( headers ) y p&aacute;rrafos.</p>
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<div id="enesimoHijo">
  <h6>Hijo 1 ( encabezado h6 )</h6>
  <p>hijo 2 ( p&aacute;rafo 1 )</p>
  <p>hijo 3 ( p&aacute;rafo 2 )</p>
  <p>hijo 4 ( p&aacute;rafo 3 )</p>
  <h6>Hijo 5 ( encabezado h6 )</h6>
  <p>hijo 6 ( p&aacute;rafo 4 )</p>
  <p>hijo 7 ( p&aacute;rafo 5 )</p>
</div>
</code></pre>
        </article>
</div>
...
<p>Mirando la tabla de arriba llegamos a la conclusi&oacute;n que <code>p:nth-child(2n+1)</code> tiene que seleccionar los hijos 1, 3, 5 y 7. &iquest;Qu&eacute; pas&oacute;? Los encabezados <code></code> son tambi&eacute;n hijos del <code>&lt;div id=&quot;enesimoHijo&quot;&gt;</code>, pero nosotros seleccionamos solo los parafos que cumplen la condici&oacute;n.<br />
  Si queremos seleccionar los p&aacute;rrafos  1, 3, 5. . .  tenemos que utilizar otro selector <code>:nth-of-type </code>( el en&eacute;simo de su tipo ).</p>
...
<h4>Otras pseudo-clases</h4>
<p>En el CSS3 hay otras pseudo-clases que permiten seleccionar de la misma manera m&uacute;ltiples elementos seg&uacute;n su posici&oacute;n en el DOM ( <em class="gem">Document Object Model</em> ). Estas pseudo-clases son:</p>
...
<thead>
  ...
  <tr>
    ...
    <td>Selecciona cada&nbsp;<code>&lt;p&gt;</code>&nbsp;que sea el segundo <code>&lt;p&gt;</code> hijo de su padre.</td>
  </tr>
  <tr>
    <td>:nth-last-of-type(n)</td>
    <td>p:nth-last-of-type(2)</td>
    <td>Selecciona todos los&nbsp;<code>&lt;p&gt;</code>&nbsp;que sean el pen&uacute;ltimo <code>&lt;p&gt;</code> hijo de su padre. ( El   segundo a partir del &uacute;ltimo )</td>
  </tr>
  </tbody>
</table>       
