...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Crear mascaras de texto con -webkit-background-clip : text. NOTA: background-clip: text no funciona en Firefox." />
  <meta name="keywords" content="tutorial, html5, css, css3, mascaras de texto, -webkit-background-clip, -webkit-text-fill-color"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Crear mascaras de texto" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/mascaras-de-texto.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Crear mascaras de texto con -webkit-background-clip : text. NOTA: background-clip: text no funciona en Firefox." /> 
  
  <title>Crear mascaras de texto</title>
  ...
  <link rel="canonical" href="mascaras-de-texto.php"> 
...
p#nota{text-align:center; color:red;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="mascaras-de-texto.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="mascaras-de-texto.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="mascaras-de-texto">
<h2 class="page_title">Crear mascaras de texto</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Crear mascaras de texto&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fmascaras-de-texto.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fmascaras-de-texto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fmascaras-de-texto.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En el CSS3, exactamente como en Photoshop, o en <a class="link_to" target="_blank"  href="http://w3.unpocodetodo.info/svg/introduccion.php">SVG</a>, podemos crear mascaras de texto. O casi. De hecho Firefox todavía no nos deja hacerlo.</p>
<p>En el siguiente ejemplo utilizamos el titular <code>&lt;h1 class="panal"&gt;</code> para crear una mascara de texto. Para esto – ya lo sabemos – el texto tiene que ser transparente ( <code>color:transparent;</code> ).<br />
  El problema es que <code>background-clip: text;</code> no funciona en el Firefox, y como que el texto es transparente, los usuarios de este navegador verían solo el "panal" de fondo ( <code>background-image:url(images/panal.jpg);</code> ).</p>
...
p#nota{text-align:center; color:red;}</code></pre>								
        </article>
</div>       
