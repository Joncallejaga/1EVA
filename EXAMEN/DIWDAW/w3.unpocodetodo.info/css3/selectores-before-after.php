...
<head>
  ...
  <meta name="description" content="Los pseudo-elementos ::before y ::after  insertan contenido, delante (before) y detr&aacute;s (after) del contenido de un element
o html." />
  <meta name="keywords" content="tutorial, html5, css, css3,pseudo-elementos, before, after, insertar contenido, diacr�ticos, s&iacute;mbolos, contador"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="::before y ::after" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selectores-before-after.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Los pseudo-elementos ::before y ::after  insertan contenido, delante (before) y detr&aacute;s (after) del contenido de un element
o html." /> 
  ...
  <link rel="canonical" href="selectores-before-after.php"> 
 
  <style>p[class^=ejemplo]{ padding-left:1em;}div#pila, div#pila1 { -moz-box-sizing: content-box; -webkit-box-sizing: content-box; box-sizing: content-box; }.resultado ul{	list-style:none;	display:block;	width:15em;	}p.ejemplo1::before {   content : "OJO: ";   color : #d14;   }  p.ejemplo2::before {   content : "Atenci\0f3n: ";   color : #d14;   }ul.falso-ol{ 	counter-reset:index;}.falso-ol li{    counter-increment: index;}.falso-ol li::before {   content:counter(index);    margin:.5em .5em .5em 1em;   color : #d14;}ul.falso-ol1{ 	counter-reset:index1;}.falso-ol1 li{    counter-increment: index1;}.falso-ol1 li::before {   content:counter(index1, decimal) ".";    margin:.5em .5em .5em 1em;   color : #d14;   }div#pila{   width:200px;   height:100px;  background-color:yellow;   color:#ccc;  margin:0 auto;  position:relative;}div#pila::before{  content:"::before";   width:200px;   height:100px;   background-color:red;   display:block;   position:absolute;   top:25px;   left:25px;}div#pila::after{  content:"::after";    width:200px;   height:100px;   background-color:blue;   display:block;   position:absolute;   top: 50px;   left:50px;}div#pila1{   width:200px;   height:100px;  background-color:yellow;   color:#ccc;  margin:0 auto;  position:relative;  padding-top:60px;  text-align:center;  z-index:1;}div#pila1::before{  content:"";   width:200px;   height:100px;   background-color:red;   display:block;   position:absolute;   top:25px;   left:25px;  z-index:-1;}div#pila1::after{  content:"";    width:200px;   height:100px;   background-color:blue;   display:block;   position:absolute;   top: 50px;   left:50px;  z-index:-1;}.clearfix:before,.clearfix:after {    content: "";    display: table;}.clearfix:after {    clear: both;}.clearfix {    background: #f5f5f5;	width:280px;	margin:0 auto;}.flotado {    float: left;     width: 100px;     height: 50px;     margin: 20px;     background: #d9d9d9;}p.floats {    margin-top: 20px;	text-align:center;}p.atributo::before{content:attr(data-title); color:#f00; margin-left:1em;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selectores-before-after.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selectores-before-after.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="selectores-before-after"><h2 class="page_title">::before y ::after</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=::before y ::after&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-before-after.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-before-after.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselectores-before-after.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Los pseudo-elementos <code>::before</code> y <code>::after</code> ( existen desde CSS2 ) insertan contenido, mediante CSS, delante ( <code>before</code> ) y respectivamente detr&aacute;s ( <code>after</code> ) del contenido de un elemento html.<br /></p><blockquote><p>li::before{ content: "contenido";}</p></blockquote><p>Los pseudo-elementos tienen que tener un contenido aunque sea solo una cadena de texto vacía.</p><blockquote><p>li::before{ content: "";}</p></blockquote><p>Y lo mejor es que podemos dar formado a estos pseudo-elementos mediante CSS.</p><h4>&iquest;Tengo que poner los dos puntos dobles?</h4><p>Los dos puntos dobles ( <code>::</code> ) fueron introducidos en el CSS3 como un intento de hacer una distinci&oacute;n entre las :pseudo-clases (<code>:link</code>, <code>:visited</code>, <code>:active</code>, <code>:hover</code>, <code>:focus</code>, <code>:first-child</code>, <code>:lang</code>) y los ::pseudo-elementos (<code>::first-letter</code>, <code>::first-line</code>, <code>::before</code>, <code>::after</code>). Por suerte no pasa nada si no ponemos los dos puntos dobles delante de los pseudo-elementos ( <code>::before </code>), ya que la mayor&iacute;a de los navegadores entienden el formato antiguo introducido en el CSS2 ( <code>:before</code> ). Es m&aacute;s: IE8 parece no entender los dos puntos dobles ( <code>::before</code> ), pero s&iacute; entiende los dos puntos ( <code>:before</code> ).</p><h4>El valor del elemento insertado puede ser:</h4><blockquote><p><strong class="normal">una cadena de texto:</strong> li::before { content: "texto";}<br /><strong class="normal">una imagen:</strong> li::before { content: url(flecha.gif);}<br /><strong class="normal">un contador:</strong> li::before { content: counter(index);}<br /><strong class="normal">el valor de un atributo:</strong> p::before { content: attr(title);}</p></blockquote><p>Tambi&eacute;n puede:</p><blockquote><p><strong class="normal">abrir y cerrar comillas:</strong> span::before { content:open-quote;} span::after { content:close-quote;}<br /><strong class="normal">o restablecer el valor inicial:</strong> span::before{ content: initial;}</p></blockquote><h4>Insertar un cadena de texto</h4><p>Veamos como insertar una cadena de texto delante de un p&aacute;rrafo:</p>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">p.ejemplo1::before {   content : "OJO: ";   color : #d14;   }</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="ejemplo1">Ejemplo de p&aacute;rrafo con texto insertado delante.</p></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <p class="ejemplo1">Ejemplo de p&aacute;rrafo con texto insertado delante.</p>        </article></div><h4>Texto con diacr&iacute;ticos o s&iacute;mbolos</h4><p>Pr&aacute;cticamente podemos insertar cualquier car&aacute;cter especial, y para insertarlo tenemos que escribir su <a class="link_to" target="_blank" href="../utiles/glyphs.php">c&oacute;digo hexadecimal precedido por el car&aacute;cter de escape ( \ )</a>. En el siguiente ejemplo para escribir la <strong>&oacute;</strong> de <strong>atenci&oacute;n</strong> utilizamos este c&oacute;digo: <code>\0f3</code>.</p><p><em class="gem">Una <a class="link_to" target="_blank" href="../utiles/glyphs.php">lista de caracteres especiales y el codigo hex para utilizar con los pseudoselectores <code>::before</code> y <code>::after</code> en el css.</a></em></p>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">  p.ejemplo2::before {   content : "Atenci\0f3n: ";   color : #d14;   }</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="ejemplo2">Ejemplo de p&aacute;rrafo con texto insertado delante.</p></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <p class="ejemplo2">Ejemplo de p&aacute;rrafo con texto insertado delante.</p>        </article></div><h4>Insertar un contador</h4><p>Los contadores en CSS son variables que pueden ser manipuladas e incrementadas con reglas CSS como <code>counter-reset</code>, <code>counter-increment</code> y <code>counter</code></p><h5>counter-reset</h5><blockquote><p>ul{ counter-reset: <span class="str">index</span>;}</p></blockquote><p>En este caso la propiedad <code>counter-reset</code> pone a 0 el contador CSS dentro de la lista <code>&lt;ul class="falso-ol"&gt;</code>. La palabra <code>index</code> utilizada con counter-reset es un identificador.</p><h5>counter-increment</h5><blockquote><p>.falso-ol li {counter-increment : <span class="str">index</span>;}</p></blockquote><p>Con esta regla la propiedad <code>counter-increment</code> incrementa el valor del contador "<code>index</code>"</p><h5>counter</h5><blockquote><p>.falso-ol li::before {content : counter(<span class="str">index</span>);}</p></blockquote><p>Finalmente la propiedad <code>counter</code> saca en pantalla el valor del contador.</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">ul.falso-ol{ 	counter-reset:index;}.falso-ol li{    counter-increment: index;}.falso-ol li::before {   content:counter(index);    margin:.5em .5em .5em 1em;   color : #d14;}</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><ul class="falso-ol">  <li><a href="../svg/trazados.php">Trazados SVG</a></li>  <li><a href="../svg/lineas-con-path.php">Dibujar l&iacute;neas con path</a></li>  <li><a href="../svg/cuadratic-bezier.php">Curvas cuadr&aacute;ticas de B&eacute;zier</a></li>  <li><a href="../svg/cubic-bezier.php">Curvas c&uacute;bicas de B&eacute;zier</a></li>  <li><a href="../svg/arcos-elipticos.php">Arcos elipticos</a></li>  <li><a href="../svg/elipse-con-path.php">Dibujar una elipse con path</a></li></ul></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <ul class="falso-ol">  <li><a href="../svg/trazados.php">Trazados SVG</a></li>  <li><a href="../svg/lineas-con-path.php">Dibujar l&iacute;neas con path</a></li>  <li><a href="../svg/cuadratic-bezier.php">Curvas cuadr&aacute;ticas de B&eacute;zier</a></li>  <li><a href="../svg/cubic-bezier.php">Curvas c&uacute;bicas de B&eacute;zier</a></li>  <li><a href="../svg/arcos-elipticos.php">Arcos elipticos</a></li>  <li><a href="../svg/elipse-con-path.php">Dibujar una elipse con path</a></li></ul>        </article></div><p>Tambi&eacute;n podemos especificar el formato de los n&uacute;meros del contador, utilizando las mismas palabras clave que las utilizadas con la propiedad <code>list-style-type</code>: <br /><code>armenian</code>, <code>cjk-ideographic</code>, <code>decimal</code>, <code>decimal-leading-zero</code>, <code>hebrew</code>, <code>hiragana-iroha</code>, <code>katakana</code>, <code>katagana-iroha</code>, <code>lower-alpha</code>, <code>lower-greek</code>, <code>lower-latin</code>, <code>lower-roman</code>, <code>upper-alpha</code>, <code>upper-latin</code>, <code>upper-roman</code>.</p><blockquote><p>content:counter(index, <span class="str">decimal</span>);</p></blockquote><p>¡Pero lo podemos hacer m&aacute;s f&aacute;cil utilizando listas ordenadas &lt;ol&gt;! <br />Si y NO. <br />Si queremos dar formato a los n&uacute;meros de una lista – y quien no lo quiso alguna vez? – lo podemos hacer utilizando el pseudo-elemento <code>::before</code>.</p><h4>Combinando valores</h4><p>En el ejemplo anterior seria interesante poder a&ntilde;adir un punto detr&aacute;s de cada numero.Podemos combinar varios valores separ&aacute;ndolas por un espacio en blanco.</p><blockquote><p>content:counter(index, decimal) <span class="str">"."</span>;</p></blockquote>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">ul.falso-ol1{ 	counter-reset:index1;}.falso-ol1 li{    counter-increment: index1;}.falso-ol1 li::before {   content:counter(index1, decimal) ".";    margin:.5em .5em .5em 1em;   color : #d14;   }</code></pre>        </article></div><div class="large-12 g_panel html">        <article>       <pre><code class="language-markup"><ul class="falso-ol1">  <li><a href="../svg/trazados.php">Trazados SVG</a></li>  <li><a href="../svg/lineas-con-path.php">Dibujar l&iacute;neas con path</a></li>  <li><a href="../svg/cuadratic-bezier.php">Curvas cuadr&aacute;ticas de B&eacute;zier</a></li>  <li><a href="../svg/cubic-bezier.php">Curvas c&uacute;bicas de B&eacute;zier</a></li>  <li><a href="../svg/arcos-elipticos.php">Arcos elipticos</a></li>  <li><a href="../svg/elipse-con-path.php">Dibujar una elipse con path</a></li></ul></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <ul class="falso-ol1">  <li><a href="../svg/trazados.php">Trazados SVG</a></li>  <li><a href="../svg/lineas-con-path.php">Dibujar l&iacute;neas con path</a></li>  <li><a href="../svg/cuadratic-bezier.php">Curvas cuadr&aacute;ticas de B&eacute;zier</a></li>  <li><a href="../svg/cubic-bezier.php">Curvas c&uacute;bicas de B&eacute;zier</a></li>  <li><a href="../svg/arcos-elipticos.php">Arcos elipticos</a></li>  <li><a href="../svg/elipse-con-path.php">Dibujar una elipse con path</a></li></ul>        </article></div><h4>El valor de un atributo</h4><p>En el siguiente ejemplo insertamos el valor del atributo <code>data-title</code> delante del p&aacute;rafo.</p><blockquote><p>p::before { content:attr(title);}</p></blockquote><p>Es interesante remarcar que esta vez para insertar s&iacute;mbolos o diacriticos hay que utilizar el nombre mnemot&eacute;cnico ( &amp;oacute; ) o el c&oacute;digo num&eacute;rico decimal ( &amp;#243; ) o hex ( &amp;#xf3; ) del glifo.</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">p.atributo::before{content:attr(data-title); color:#f00; margin-left:1em;}</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="atributo" data-title="Atenci&amp;oacute;n: ">Esto es peligroso.</p></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <p class="atributo" data-title="Atenci&oacute;n: ">Esto es peligroso.</p>        </article></div><h4>Como van apilados los pseudo-elementos</h4><p>En el siguiente ejemplo los pseudo-elementos <code>::before</code> y <code>::after</code> insertan contenido, mediante CSS, delante ( <code>before</code> ) y respectivamente detr&aacute;s ( <code>after</code> ) del contenido del <code>&lt;div id="pila"&gt;</code>. Los dos pseudo-elementos tienen <code>display:block</code>, y las dimensiones <code>width</code> y <code>height</code> iguales a las del <code>&lt;div id="pila"&gt;</code>. Manipulamos la posici&oacute;n de los pseudo-elementos para que las cosas sean claras. Observamos que <code>&lt;div id="pila"&gt;</code> se queda detr&aacute;s del pseudo-elemento <code>::before</code>, mientras que el pseudo-elemento <code>::after</code> aparece encima del pseudo-elemento <code>::before</code>.</p>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">div#pila{   width:200px;   height:100px;  background-color:yellow;   color:#ccc;  margin:0 auto;  position:relative;}div#pila::before{  content:"::before";   width:200px;   height:100px;   background-color:red;   display:block;   position:absolute;   top:25px;   left:25px;}div#pila::after{  content:"::after";    width:200px;   height:100px;   background-color:blue;   display:block;   position:absolute;   top: 50px;   left:50px;}</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><div id="pila"> Contenido</div></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article style="height:180px;">        <div id="pila"> Contenido</div>        </article></div><p>A continuaci&oacute;n especificamos para cada elemento el valor de <code>z-index</code> de esta manera: para la caja ( <code>div id="pila"</code> ): <code>z-index = 1</code> y para los pseudo-elementos: <code>z-index = -1</code>. El resultado: solo el contenido de <code>&lt;div id="pila"&gt;</code> aparece encima de los pseudo-elementos.</p>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">div#pila1{   width:200px;   height:100px;  background-color:yellow;   color:#ccc;  margin:0 auto;  position:relative;  padding-top:60px;  text-align:center;  z-index:1;}div#pila1::before{  content:"";   width:200px;   height:100px;   background-color:red;   display:block;   position:absolute;   top:25px;   left:25px;  z-index:-1;}div#pila1::after{  content:"";    width:200px;   height:100px;   background-color:blue;   display:block;   position:absolute;   top: 50px;   left:50px;  z-index:-1;}</code></pre>        </article></div><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><div id="pila1"> Contenido</div></code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article style="height:200px;">        <div id="pila1"> Contenido</div>        </article></div><h4 id="clearfix">Limpiar los floats</h4><p>La propiedad <code>float</code> especifica si una caja  tiene que flotar o no. Esto ya lo sabemos. Tambi&eacute;n sabemos que es muy importante limpiar los floats para que los elementos posteriores a una caja flotada dejen de hacer cosas extra&ntilde;as. El m&eacute;todo tradicional es insertar un elemento  - por ejemplo un salto de l&iacute;nea: <code>&lt;br class="clearfloats"&gt;</code> - que limpie los floats.</p><blockquote><p>.clearfloats{ clear:both;}</p></blockquote><p><a class="link_to" target="_blank" href="http://nicolasgallagher.com/micro-clearfix-hack/">Nicolas Gallagher</a> tiene un m&eacute;todo mejor que utiliza los pseudo-elementos <code>::befor</code>e y <code>::after</code>.<br />Solamante hay que aplicar una clase – por ejemplo <code>.clearfix</code> – a la caja padre.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><div class="clearfix">    <div class="flotado"></div>    <div class="flotado"></div></div><p class="floats">p&aacute;rafo test</p></code></pre>        </article></div>       <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">.clearfix:before,.clearfix:after {    content: "";    display: table;}.clearfix:after {    clear: both;}.clearfix {    background: #f5f5f5;	width:280px;	margin:0 auto;}.flotado {    float: left;     width: 100px;     height: 50px;     margin: 20px;     background: #d9d9d9;}p.floats {    margin-top: 20px;	text-align:center;}</code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <div class="clearfix">    <div class="flotado"></div>    <div class="flotado"></div></div><p class="floats">p&aacute;rafo test</p>        </article></div>    </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
...
<p><em class="gem">
- Una <a class="link_to" target="_blank" href="../utiles/glyphs.php">lista de caracteres especiales y el codigo hex para utilizar con los pseudoselectores ::before y ::after en el css.</a><br />
- <a class="link_to" target="_blank" href="http://nicolasgallagher.com/multiple-backgrounds-and-borders-with-css2/">Multiple Backgrounds and Borders with CSS 2.1</a> (con los pseudo-elementos ::before y ::after)<br />
- Y m&aacute;s cosas: <a class="link_to" target="_blank" href="http://css-tricks.com/pseudo-element-roundup/">A Whole Bunch of Amazing Stuff Pseudo Elements Can Do</a><br />
- La especificaci&oacute;n w3.org:  <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-content/#contents">CSS3 Generated and Replaced Content Module</a></em></p>
</article></div></div>
