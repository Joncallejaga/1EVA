...
<head>
  ...
  <meta name="description" content="Variables CSS - un caso pr&aacute;ctico: crear un juego de botones." />
  <meta name="keywords" content="CSS, variables CSS, em, px,hsl, botones, button"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Un caso pr&aacute;ctico: botones" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/variables-css-botones.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Variables CSS - un caso pr&aacute;ctico: crear un juego de botones." /> 
  
  <title>Un caso pr&aacute;ctico: botones</title>
  ...
  <link rel="canonical" href="variables-css-botones.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="variables-css-botones.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="variables-css-botones.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="variables-css-botones"><h2 class="page_title">Un caso pr&aacute;ctico: botones</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Un caso pr&aacute;ctico: botones&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fvariables-css-botones.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fvariables-css-botones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fvariables-css-botones.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>A continuaci&oacute;n quiero crear un juego de botones utilizando variables CSS. Exactamente como en los dem&aacute;s ejemplos el c&oacute;digo puede funcionar sin variables pero el uso de variables aporta claridad y reduce la verbosidad del c&oacute;digo.</p><p>Para comenzar quiero que los botones sean iguales en todos sus aspectos excepto el tama&ntilde;o. Para esto en el c&oacute;digo voy a utilizar em en lugar de px porque de esta manera puedo f&aacute;cilmente cambiar el tama&ntilde;o del bot&oacute;n solo con cambiar el tama&ntilde;o de fuente.</p><blockquote><pre>button{    font-size:18px;    padding:<span class="com">/*9px 18px*/</span>.5em 1em;    margin:<span class="com">/*4px*/</span>.22em;    border-radius:<span class="com">/*4px*/</span>.22em;    color:#fff;    border: .1em solid  hsl( 211, 40%,52%);    background: linear-gradient(hsl( 211, 40%,70%), hsl( 211, 40%,52%));    text-shadow:-.05em -.05em .05em hsl( 211, 40%,20%);  }</pre></blockquote><p>Esto de por si ya se comporta como una variable.</p>     <p data-height="300" data-theme-id="11360" data-slug-hash="1378501df4fa16c930dc7f66bcd52359" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Botones y variables CSS #1" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/1378501df4fa16c930dc7f66bcd52359/">Botones y variables CSS #1</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>    <p>Cambiar el color de estos botones es un poco m&aacute;s complicado. En el ejemplo anterior he necesitado 4 colores diferentes adem&aacute;s del color para la fuente ( <code>#fff</code> ):</p><p>- un color para el borde:</p> <blockquote><pre>border: .1em solid  hsl( <span class="str">211</span>, <span class="str">40</span>%,52%);</pre></blockquote><p>- otro color para la sombra que aplicamos al texto:</p> <blockquote><pre>text-shadow:-.05em -.05em .05em hsl(<span class="str">211</span>, <span class="str">40</span>%,20%);</pre></blockquote><p>- finalmente dos colores m&aacute;s para crear el gradiente lineal:</p> <blockquote><pre>background: linear-gradient(hsl(<span class="str">211</span>, <span class="str">40</span>%,70%), hsl(<span class="str">211</span>, <span class="str">40</span>%,52%));</pre></blockquote><p>Mirando con atenci&oacute;n estos colores podemos ver que todos son <a class="link_to" target="_blank" href="hsl.php">colores hsl</a> que comparten el mismo valor para el matiz ( <code>211</code> )  y para la saturaci&oacute;n ( <code>40</code> ), y lo &uacute;nico que difiere es la luminosidad. As&iacute; que podemos construir estos colores a partir de otros variables: <code>--hue</code> ( matiz ) y <code>--saturation</code>.</p><blockquote><pre>--colorA: hsl( <span class="str">var(--hue),</span> calc(<span class="str">var(--saturation)</span> * 1%), 70%);</pre></blockquote><p data-height="300" data-theme-id="11360" data-slug-hash="76a29e6d3105c2d3306038a52b2d7f86" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Botones y variables CSS #2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/76a29e6d3105c2d3306038a52b2d7f86/">Botones y variables CSS #2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="variables-css.php">Variables CSS - lo b&aacute;sico</a></em></li><li>- <em class="gem">Un caso pr&aacute;ctico: botones</em></li><li>- <em class="gem"><a class="link_to" href="variables-css-sliders.php">Otro caso pr&aacute;ctico: sliders</a></em></li><li>- <em class="gem"><a class="link_to" href="galeria-de-imagenes-css1.php">Galer&iacute;a de im&aacute;genes css</a></em></li></ul></article></div></div>
