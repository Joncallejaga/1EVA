...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como aplicar una sombra al texto, con text-shadow." />
  ...
  <meta property="og:title" content="Texto con sombra" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/text-shadow.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como aplicar una sombra al texto, con text-shadow." /> 
  
  <title>Texto con sombra</title>
  ...
  <link rel="canonical" href="text-shadow.php"> 
...
#text2 .negativo{text-shadow:1px -10px 1px #f00;}#text3{text-align:center;text-shadow:10px 10px 5px #f00;}#text4{text-align:center;text-shadow: rgb(255,0,0) 10px 10px 5px;}#text5{text-align:center;text-shadow: #f00 10px 10px 5px , -10px -10px 5px #00f;}.large-4.columns h4{margin:50px auto;}.large-4.columns h4 .negativo{display:block; padding-top:1em;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="text-shadow.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="text-shadow.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">Texto con sombra</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Texto con sombra&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftext-shadow.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftext-shadow.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftext-shadow.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En el <code>CSS3</code> hay dos propiedades que generan sombras: <code>text-shadow</code> y <code>box-shadow</code>. Practicamente el mismo perro con distinto collar. Analicemos primero el texto sombreado ( <code>text-shadow</code> ).</p>

<div class="row"> 
<div class="large-12 columns">
<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">text-shadow: <span>desplazamiento horizontal</span> <span>desplazamiento vertical</span> <span>desenfoque</span> <span>color</span>;</em>
</p>
</article>
</div>
</div>
...
<h4>Desplazamiento horizontal <em class="gem">(h-shadow)</em></h4>
<p>En el siguiente ejemplo la sombra tiene un desplazamiento vertical muy peque&ntilde;o. De esta manera, el desplazamiento horizontal ( <em class="gem">positivo: 10px; negativo: -10px</em> ) es muy evidente.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
#text1{text-align:center;text-shadow:10px 1px 1px #ccc; line-height:1.5em;}
#text1 .negativo{text-shadow:-10px 1px 1px #ccc;}</code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
		<h4 id="text1">positivo<br /><span class="negativo">negativo</span></h4>
		</article>
</div>
 
<p>Para el desplazamiento vertical podemos utilizar tanto valores positivos como negativos.<br />
Los valores positivos desplazar&aacute;n la sombra hacia la derecha, mientras que  los valores negativos desplazaran la sombra hacia la izquierda.</p>
<h4>Desplazamiento vertical <em class="gem">(h-shadow)</em></h4>
<p>En el siguiente ejemplo la sombra tiene un desplazamiento horizontal muy peque&ntilde;o. De esta manera, el desplazamiento vertical ( <em class="gem">positivo: 10px; negativo: -10px</em> ) es muy evidente.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
#text2{text-align:center;text-shadow:1px 10px 1px #f00; line-height:2em;}
#text2 .negativo{text-shadow:1px -10px 1px #f00;}</code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <h4 id="text2">positivo<br /><span class="negativo">negativo</span></h4>
		</article>
</div>

<p>Para el desplazamiento horizontal podemos utilizar tanto valores positivos como negativos.<br />
Los valores positivos desplazar&aacute;n la sombra hacia abajo, mientras que  los valores negativos desplazaran la sombra hacia arriba.
</p>

<h4>Desenfoque <em class="gem">(blur)</em></h4>
<p>Probemos ahorra el desenfoque ( <em class="gem">5px</em> )... que hace exactamente esto: difumina la sombra. 
Esta vez la sombra est&aacute; desplazada tanto horizontalmente como verticalmente 10px.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#text3{text-align:center;text-shadow:10px 10px 5px #f00;}</code></pre>
        </article>
</div>
...
<h4>Color</h4>
<p>En lo que concierne el color, podemos utilizar colores <em class="gem"><a href="../utiles/conversor.php">hex, rgb, hsl</a></em> o los <em class="gem"><a href="../utiles/colores-alfabeticamente.php">nombres de los colores en ingles</a></em>.<br />
Es interesante saber que tambi&eacute;n podemos poner el color delante.
</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#text4{text-align:center;text-shadow: rgb(255,0,0) 10px 10px 5px;}</code></pre>
        </article>
</div>
...
<!--<p><em class="gem">Escoge tus <a class="link_to" target="_blank" href="http://localhost/gabi_w3/w3/colores/colorpicker.php">colores</a>; encuentra tus <a class="link_to" target="_blank" href="http://localhost/gabi_w3/w3/colores/matices.php">matices</a></em></p>-->  
<h4>Dos o m&aacute;s sombras <em class="gem">¡Ooh La La!</em></h4>
<p>Y si queremos, podemos, aunque no se si debemos ( es cuesti&oacute;n de gustos ) aplicar varias sombras - debidamente separadas por una coma (&nbsp;,&nbsp;).</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#text5{text-align:center;text-shadow: #f00 10px 10px 5px , -10px -10px 5px #00f;}</code></pre>
        </article>
</div>
...
<p>Vea un ejemplo de <a class="link_to" target="_blank" href="ejemplos/texto3d.html">texto tridimensional</a> aplicando varias sombras con <code>text-shadow</code>. Utilice "Ver c&oacute;digo fuente" del men&uacute; de su navegador para encontrar y estudiar el c&oacute;digo.</p>
