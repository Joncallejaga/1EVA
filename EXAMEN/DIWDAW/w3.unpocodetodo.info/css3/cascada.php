...
<head>
  ...
  <meta name="description" content="Acerca de la Cascada y la Especificidad, dos de los conceptos b�sicos del CSS" />
  <meta name="keywords" content="CSS, Cascada, Especificidad, estilos por defecto, atributos de presentaci&oacute;n, hojas de estilo externas, style, inline,important,
"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Cascada y especificidad" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/cascada.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Acerca de la Cascada y la Especificidad, dos de los conceptos b�sicos del CSS" /> 
  ...
  <link rel="canonical" href="cascada.php"> 
 
  <style>.h4{font-family: 'Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif;font-weight: 300;color: #009999;font-size:23px;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="cascada.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="cascada"><h2 class="page_title">Cascada y especificidad</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Cascada y especificidad&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcascada.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcascada.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcascada.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h3>Estilos en cascada</h3><p>Uno de los conceptos b&aacute;sicos del CSS, <mark>la cascada</mark> es un algoritmo utilizado para determinar la prevalencia de algunas reglas CSS sobre otras.</p><h4>1. Los estilos por defecto</h4><p>Si no escribimos ni una l&iacute;nea de CSS, los elementos de un documento HTML tienen los estilos que "vienen de fabrica", o sea los estilos por defecto y los <mark>estilos espec&iacute;ficos de cada navegador</mark>.<br>  Tambi&eacute;n los usuarios pueden especificar algunos estilos como por ejemplo el tamaño de fuente.</p>  <h4>2. Los atributos de presentaci&oacute;n</h4><p>A continuaci&oacute;n en la cascada vienen los atributos de presentaci&oacute;n, como por ejemplo los atributos <code>width</code> y <code>height</code> de una imagen o de un elemento SVG.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;img src="emoji.gif" alt="un emoji" height="24" width="24" /&gt;</code></pre></article></div><p>Tambi&eacute;n atributos de presentaci&oacute;n son algunos atributos de los elementos <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/svg/introduccion.php">SVG</a> como <code>fill</code>, <code>stroke</code>, <code>stroke-width</code> . . . etc.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;circle cx="50" cy="75" r="40" stroke="black" stroke-width="4" fill="#6ab150" /&gt;</code></pre></article></div><p>Estos atributos tienen una especificidad muy baja ( 0, 0, 0, 0 ) y son f&aacute;cilmente sobreescritos con reglas CSS.</p><h4>3. Las hojas de estilo externas</h4><p>Utilizando hojas de estilo externas los autores sobreescriben los estilos por defecto y los atributos de presentaci&oacute;n.<br>Para enlazar una hoja de estilos externa utilizamos el elemento <code>&lt;link&gt;</code> en el <code>&lt;head&gt;</code> del documento.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;link rel="stylesheet" type="text/css" href="estilos.css"&gt;</code></pre></article></div><p>Alternativamente podemos utilizar la regla-at <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/CSS/%40import">@import</a> que  permite importar reglas desde otras hojas de estilo. Estas reglas deben preceder a todos los otros tipos de reglas, excepto a las reglas <code>@charset</code>.</p><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">@import url("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css");</code></pre></article></div><h4>4. Los estilos del documento</h4><p>Los estilos del documento (  contenidos dentro de un elemento <code>&lt;style&gt;</code> ) sobreescriben las reglas CSS de las hojas externas i a su turno pueden ser sobreescritos por:</p> <h4>5. los estilos CSS en l&iacute;nea</span> ( <em class="gem">inline</em> ).</h4><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;div id="cuadrado" style="left:500px;top:10px;" &gt;&lt;/div&gt;</code></pre></article></div><h4>6.Trasformaciones, animaciones y transiciones</h4><p>Para sobreescribir los estilos CSS "inline" podemos utilizar <mark>trasformaciones</mark>:</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">#cuadrado{ transform: translate(100px, 50px);}</code></pre></article></div><p>Tambi&eacute;n podemos utilizar <mark>animaciones y transiciones</mark>. <h4>6.1. !important</h4>Otra manera de sobreescribir los estilos CSS "inline" es utilizando la instrucci&oacute;n <code>!important</code>:</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;div style="background: red;"&gt;. . . </code></pre></article></div><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">div[style] {/* selecciona los div que tienen un atributo style*/     background: yellow !important;}</code></pre></article></div><p><strong>¡OJO!</strong> La declaraci&oacute;n <code>!important</code> no tiene una especificidad propia.</p><h4>6.2. Javascript</h4><p>Asimismo podemos utilizar <mark>javascript</mark> para cambiar los estilos en l&iacute;nea de manera din&aacute;mica.</p><div class="large-12 g_panel js">        <article>										<pre><code class="language-javascript">cuadrado.setAttribute('style', 'background: blue !important');</code></pre></article></div><p><strong>¡OJO!</strong> En este caso JavaScript borra cualquier otros estilos inline del elemento y los reemplaza con las nuevas reglas.</p><h3>Especificidad</h3><p>Los navegadores utilizan la especificidad para decidir que reglas CSS aplicar a los elementos.</p><p>La especificidad de un selector tiene 4 niveles: 0, 0, 0, 0</p><h4>Elementos y pseudo-elementos</h4><p>La especificidad del selector de un <mark>elemento HTML</mark> o de un <mark>pseudo-elemento</mark> es 0, 0, 0, 1<br>Por ejemplo: ( ::first-letter es un pseudo-elemento )</p>  <div class="large-12 g_panel css">        <article>										<pre><code class="language-css">  p{font-size: 1em;}             /*especificidad = 0, 0, 0, 1*/  p em {font-style: italic;}     /*especificidad = 0, 0, 0, 2 */  p{ color:#222; }               /*especificidad = 0, 0, 0, 1*/  p::first-letter{ color:#f22; } /*especificidad = 0, 0, 0, 2*/</code></pre></article></div>  <h4>Clases y pseudo-clases y selectores de atributos</h4><p>La especificidad de una <mark>clase</mark> o <mark>pseudo-clase</mark> es 0, 0, 1, 0<br>Por ejemplo:</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">h2.colorado {color: red;} /* especificidad = 0, 0, 1, 1 */</code></pre></article></div><p>Tambi&eacute;n los selectores de <mark>atributos</mark> tienen la misma especificidad, por ejemplo los encabezados h2 que tengan un atributo title tienen una especificidad = 0, 0, 1, 1. ( 0, 0, 0, 1 por el <code>h2</code> y 0, 0, 1, 0 por el atributo )</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">h2[title] {color: #333;} /* especificidad = 0, 0, 1, 1 */</code></pre></article></div><h4>Identificadores ( <code>id</code> )</h4><p>La especificidad de los identificadores es 0, 1, 0, 0<br>Por ejemplo:</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">h2#colorado {color: red;} /* especificidad = 0, 1, 0, 1 */</code></pre></article></div><p><strong>¡OJO!</strong> En este otro caso el encabezado que tiene un atributo <code>id='colorado'</code> y tiene una especificidad 0, 0, 1, 1</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">h2[id='colorado'] {color: red;} /* especificidad = 0, 0, 1, 1 */</code></pre></article></div><h4>Estilos en l&iacute;nea</h4><p>Los estilos en l&iacute;nea tienen la m&aacute;s alta especificidad: 1, 0, 0, 0</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;h2 style="color:red;"&gt;</code></pre></article></div><h4>Algo importante</h4><p>En CSS podemos utilizar la declaraci&oacute;n <code>!important</code> para decir que una declaraci&oacute;n es muy importante.</p><p>Podemos poner la declaraci&oacute;n <code>!inportant</code> en el CSS</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">h2{color:red !important;}</code></pre></article></div><p>Tambi&eacute;n la podemos poner en un bloque de estilo "<em class="gem">inline</em>"</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;h2 style="color:red !important;"&gt;</code></pre></article></div><p>La declaraci&oacute;n <code>!important</code> no tiene una especificidad propia. CSS eval&uacute;a las declaraciones importantes aparte de las declaraciones que no son importantes.</p><h4>Especificidad 0 y sin especificidad</h4><p>El selector universal ( <code>*</code> ) tiene especificidad 0, 0, 0, 0<br>Tambi&eacute;n los atributos de presentaci&oacute;n tienen especificidad 0, 0, 0, 0</p><p>Los valores heredados de los elementos padres no tienen especificidad alguna, ni tan solo 0, 0, 0, 0<br>Esto tiene su importancia, ya que los valores con especificidad 0, 0, 0, 0 se imponen sobre los valores heredados de los elementos padres. Por ejemplo:</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup">&lt;p&gt;Este es un p&aacute;rrafo negro que contiene un elemento &lt;span&gt;SPAN&lt;/span&gt; rojo.&lt;/p&gt;</code></pre></article></div><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">*{color:#f00}p{color:black}</code></pre></article></div><p>En este caso el elemento <code>&lt;span&gt;</code> hereda el color negro del p&aacute;rrafo ( sin especificidad ), pero el selector universal ( especificidad 0, 0, 0, 0 ) dice que todos los elementos tienen color rojo. En este caso el selector con especificidad 0 se impone sobre el valor heredado ( sin especificidad ) y el elemento <code>&lt;span&gt;</code> tiene color rojo.</p></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="chuletacss3.php">Referencia CSS3</a></em></li><li>- <em class="gem"><a class="link_to" href="chuleta-selectores-css3.php">Selectores CSS</a></em></li><li>- <em class="gem"><a class="link_to" href="unidades-css.php">Unidades CSS</a></em></li><li>- <em class="gem">Cascada y especificidad</em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- MDN: <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Learn/CSS/Introduction_to_CSS/Cascada_y_herencia">Cascada y herencia</a><br></em></p>
</article></div></div>
