...
<head>
  ...
  <meta name="description" content="La propiedad flex-direction es una propiedad del contenedor flex, y establece la direcci&oacute;n de los elementos hijos ( &iacute;tems flex )." />
  <meta name="keywords" content="flexbox, flex-box, contenedor flex, caja flex, direcci&oacute;n, propiedad flex-direction, row, row-reverse, column, column-reverse, eje horizontal, eje vertical, eje principal, main axis, eje transversa, cross axis, HTML5, CSS3"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="flex-direction" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-direction.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad flex-direction es una propiedad del contenedor flex, y establece la direcci&oacute;n de los elementos hijos ( &iacute;tems flex )." /> 
  ...
  <link rel="canonical" href="flex-direction.php"> 
...
.flex-container{
	...
	/* hace que el elemento sea un contenedor flex */
	display:-webkit-flex; 
	display: -ms-flexbox; 
	display: flex;
...
.flex-item{
	...
	margin:5px;
    /* alinea los p&aacute;rafos dentro del .flex-item */
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-direction.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-direction.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad flex-direction</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=flex-direction&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-direction.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-direction.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-direction.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>flex-direction</code> es <span class="str">una propiedad del contenedor flex</span>.</p>

<p>En una caja flex podemos colocar los elementos en cualquier direcci&oacute;n: horizontalmente ( <code>row</code> ) o verticalmente ( <code>column</code> ), en el sentido l&oacute;gico o en el sentido contrario ( <code>-reverse</code> ).<br />Para hacerlo utilizamos la propiedad <code>flex-direction</code>, que establece cual es el eje principal de la caja y por lo tanto la direcci&oacute;n de los elementos hijos.</p>

<div class="row">
<div class="large-6 column text-center">
<h4>flex-direction:row</h4>
<img src="images/flex-row.gif" width="342" height="236" alt="caja flex" /></div>
<div class="large-5 pull-1 column text-center">
<h4>flex-direction:column</h4><img src="images/flex-column.gif" width="257" height="298" alt="caja flex" /></div>
</div>
<p><strong class="str">Muy importante:</strong>  <code>flex-direction: row</code> establece el eje horizontal como eje principal ( <em class="gem">main axis</em> ), y el eje vertical como eje transversal ( <em class="gem">cross axis</em> ). <br />
  Si <code>flex-direction: column</code> pasa todo lo contrario: el eje vertical es el eje principal ( <em class="gem">main axis</em> ) mientras que el eje horizontal es el  eje transversal ( <em class="gem">cross axis</em> ) .<br />
  Esto es realmente muy importante ya que las propiedades de flexbox controlan la alineaci&oacute;n de los &iacute;tems flex a lo largo de estos ejes.</p>
<p>La propiedad <code>flex-direction</code> puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor { flex-direction: row | row-reverse | column | column-reverse; }</em>
</p>
</article>
</div>

<p><code>row</code> ( el valor por defecto ): coloca los elementos flex horizontalmente ( <em class="gem">row = fila</em> ). En idiomas como el castellano, con un sistema de escritura de izquierda a derecha ( <em class="gem">ltr – left to right</em> ), los elementos flex se colocan tambi&eacute;n de izquierda a derecha.</p>
<p><code>row-reverse</code>: coloca los elementos flex horizontalmente pero en sentido contrario ( de derecha a izquierda en idiomas como el castellano. )</p>
<p><code>column</code>: coloca los elementos flex verticalmente y de arriba abajo ( <em class="gem">tb -  top to bottom</em> ).</p>
<p><code>column-reverse</code>: coloca los elementos flex verticalmente y de abajo arriba ( <em class="gem">bottom to top </em> ).</p>
...
<!--<h4>La propiedad flex-flow</h4>
<p>La propiedad <code>flex-flow</code> es <span class="str">una propiedad del contenedor flex</span>.</p>
<p>Para que podamos escribir menos c&oacute;digo, el CSS nos permite abreviar las dos propiedades: <code>flex-direction</code> y <a class="link_to" target="_blank" href="/css3/flex-wrap.php">flex-wrap</a> ( opcional ) en una sola: <code>flex-flow</code>. El valor por defecto es <code>row nowrap</code>.</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor {flex-flow: flex-direction [flex-wrap]; }</em>
</p>
</article>
</div>
<blockquote><pre>.flex-container{ 
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#flex-direction-property">the flex-direction property</a><br />
