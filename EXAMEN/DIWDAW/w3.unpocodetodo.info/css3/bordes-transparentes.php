...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3.  C&oacute;mo crear bordes transparentes con background-clip." />
  <meta name="keywords" content="tutorial, html5, css, css3, background-clip"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Bordes transparentes" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/bordes-transparentes.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3.  C&oacute;mo crear bordes transparentes con background-clip." /> 
  
  <title>Bordes transparentes</title>
  ...
  <link rel="canonical" href="bordes-transparentes.php"> 
...
#padding_box{background-clip: padding-box;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="bordes-transparentes.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="bordes-transparentes.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="bordes-transparentes">
<h2 class="page_title">Bordes transparentes</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Bordes transparentes&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbordes-transparentes.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbordes-transparentes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbordes-transparentes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<!--<h4>Bordes transparentes</h4>-->
<p>Para hacer que los bordes de una caja sean transparentes tenemos que hacer los bordes transparentes. ¡Es obvio! ¡Es de Pere Grullo!<br />
Podemos hacer los bordes transparentes utilizando un color <a class="link_to" target="_blank" href="rgb.php#alpha1">rgba</a>. En este caso los bordes ser&aacute;n negros con una opacidad de 50%.</p>
<blockquote><p>border: 15px solid rgba(0, 0, 0, <strong class="str">0.5</strong>);</p></blockquote>
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="caja-texto"><p>Fue como si el sol de la tarde, que se quebraba, al ponerse entre las nubes de agua, en amarillos cristales, le encendiese una aurora tras sus tiznadas l&aacute;grimas. Acarici&eacute; a Platero y, como pude, lo enganch&eacute; a la carretilla, delante del borrico miserable. En el arroyo grande que la lluvia hab&iacute;a dilatado hasta la vi&ntilde;a, nos encontramos, atascada, una vieja carretilla, perdida toda bajo su carga de hierba y de naranjas. Lo llamo dulcemente: &iquest;Platero? y viene a m&iacute; con un trotecillo alegre que parece que se r&iacute;e en no s&eacute; qu&eacute; cascabeleo ideal. Era vano su esfuerzo, como el de los ni&ntilde;os valientes, como el vuelo de esas brisas cansadas del verano que se caen, en un desmayo, entre las flores. Ojal&aacute; el coraz&oacute;n les bastara a ellos dos como a m&iacute; me basta.</p><div class="bordes-transparentes">
    <p>Esta caja NO tiene bordes transparentes.</p>
  </div>
</div></code></pre>
        </article>
</div>
<div class="large-12 g_panel resultado">
        <article style="white-space: normal; padding:10px 10px 0 10px;">
        <div class="caja-texto"><p>Fue como si el sol de la tarde, que se quebraba, al ponerse entre las nubes de agua, en amarillos cristales, le encendiese una aurora tras sus tiznadas l&aacute;grimas. Acarici&eacute; a Platero y, como pude, lo enganch&eacute; a la carretilla, delante del borrico miserable. En el arroyo grande que la lluvia hab&iacute;a dilatado hasta la vi&ntilde;a, nos encontramos, atascada, una vieja carretilla, perdida toda bajo su carga de hierba y de naranjas. Lo llamo dulcemente: &iquest;Platero? y viene a m&iacute; con un trotecillo alegre que parece que se r&iacute;e en no s&eacute; qu&eacute; cascabeleo ideal. Era vano su esfuerzo, como el de los ni&ntilde;os valientes, como el vuelo de esas brisas cansadas del verano que se caen, en un desmayo, entre las flores. Ojal&aacute; el coraz&oacute;n les bastara a ellos dos como a m&iacute; me basta.</p><div class="bordes-transparentes">
    <p>Esta caja NO tiene bordes transparentes.</p>
  </div>
</div>        </article>
</div>
<p>Sin embargo al hacerlo el borde sigue opaco, aunque gris en lugar de negro. Esto pasa porque, 
  <mark>por defecto</mark>, el fondo blanco de la caja ( <code>background-color:white;</code> ) 
  <mark>se extiende hasta el limite externo del borde</mark>. Para que esto no pase, tenemos que hacer que el fondo se extienda solo hasta el limite externo del relleno ( <code>padding</code> ), y para esto hay que utilizar la propiedad  <a class="link_to" target="_blank" href="background-clip.php">background-clip</a>.</p>
<blockquote><p>background-clip:padding-box;</p></blockquote>
...
#padding_box{background-clip: padding-box;}</code></pre>								
        </article>
</div>       
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="caja-texto"><p>Fue como si el sol de la tarde, que se quebraba, al ponerse entre las nubes de agua, en amarillos cristales, le encendiese una aurora tras sus tiznadas l&aacute;grimas. Acarici&eacute; a Platero y, como pude, lo enganch&eacute; a la carretilla, delante del borrico miserable. En el arroyo grande que la lluvia hab&iacute;a dilatado hasta la vi&ntilde;a, nos encontramos, atascada, una vieja carretilla, perdida toda bajo su carga de hierba y de naranjas. Lo llamo dulcemente: &iquest;Platero? y viene a m&iacute; con un trotecillo alegre que parece que se r&iacute;e en no s&eacute; qu&eacute; cascabeleo ideal. Era vano su esfuerzo, como el de los ni&ntilde;os valientes, como el vuelo de esas brisas cansadas del verano que se caen, en un desmayo, entre las flores. Ojal&aacute; el coraz&oacute;n les bastara a ellos dos como a m&iacute; me basta.</p>
  <div class="bordes-transparentes" id="padding_box">
    <p>Esta caja tiene bordes transparentes.</p>
  </div>
</div></code></pre>
        </article>
</div>
