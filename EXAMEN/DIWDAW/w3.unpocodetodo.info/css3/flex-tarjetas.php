...
<head>
  ...
  <meta name="description" content="Lo que queremos conseguir es una serie de tarjetas de igual tama�o, colocadas en cuadricula." />
  <meta name="keywords" content="Flexbox, cajas flexibles, pinterest, display: flex, flex-direction, justify-content, flex-wrap"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Cuadricula flexbox" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-tarjetas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Lo que queremos conseguir es una serie de tarjetas de igual tama�o, colocadas en cuadricula." /> 
  
  <title>Cuadricula flexbox</title>
  ...
  <link rel="canonical" href="flex-tarjetas.php"> 
 
  <style>.g_panel.resultado article #pinTerest{    white-space: normal;}#pinTerest {  width: 16em;  margin: 0 auto;  padding:0;  font-size: 16px;  line-height:1.25;  font-family: Arial, Helvetica, sans-serif;}#pinTerest .CreditTitle { margin:0;}#pinTerest h3.pin.GridTitle {  color: #333;  font-size: .9em!important;  font-weight: bold!important;    font-size: .9rem;  font-weight: bold;  text-transform: uppercase;}.pinWrapper {  padding: 0;  border: 1px solid #d9d9d9;  border-radius: 6px;  overflow: hidden;  background-color: white;  margin: .5em;}.pinWrapper p {  font-size: .8em;}.pin {  padding: .8em;}.CreditTitle {  border-top: 1px solid #e0e0e0;}.pinImage img {  width: 100%;}/* FLEXBOX */.pinWrapper {  display: flex;  flex-direction: column;  justify-content: space-between;  flex: 0 1 calc(50% - 1em);}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-tarjetas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-tarjetas.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="flex-tarjetas"><h2 class="page_title">Cuadricula flexbox</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Cuadricula flexbox&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-tarjetas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-tarjetas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-tarjetas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Lo que queremos conseguir es una serie de tarjetas de igual tama&ntilde;o, colocadas en cuadricula. ( vea este <a target="_blank" class="link_to" href="http://codepen.io/enxaneta/pen/ZQjLEm">ejemplo en codepen.io</a> )   Quien lo haya intentado utilizando cajas flotantes sabe que no es nada f&aacute;cil, sobretodo si queremos crear estas cajas de manera din&aacute;mica.</p><h4>Estructura de una tarjeta</h4><p>Primero dibujamos la "tarjeta" que tiene mas o menos esta estructura ( inspirada en las tarjetas de <a target="_blank" class="link_to" href="https://es.pinterest.com/">pinterest.com</a> pero mucho m&aacute;s sencilla ):  Dentro del envoltorio <code>&lt;div class ="pinWrapper "&gt;</code> hay dos elementos:   un <code>&lt;div class ="pinImage "&gt;</code> para la imagen y la descripci&oacute;n de esta,  y   un p&aacute;rafo<code> &lt;p class="pin CreditTitle"&gt;</code> para acreditar la proveniencia de la imagen.  </p><blockquote><pre>&lt;div class="pinWrapper"&gt<span class="com">&lt;!-- un div para la imagen y la descripci&oacute;n de esta--&gt</span>&lt;div class="pinImage"&gt;    &lt;img src="http://www.placecage.com/236/293" alt="Nicolas Cage"&gt;    &lt;h3 class="pin GridTitle"&gt;Pablo Picasso&lt;/h3&gt;&lt;!-- opcional --&gt;    &lt;p class="pin Description"&gt;Don Quixote. Uno de mis dibujos favoritos, quiz&aacute;s por mi predilecci&oacute;n por el hidalgo indomable.&lt;/p&gt;  &lt;/div&gt;<span class="com">&lt;!-- un párafo para acreditar la proveniencia de la imagen --&gt</span>  &lt;p class="pin CreditTitle"&gt;&lt;strong&gt;Pinned from&lt;/strong&gt;:&lt;br&gt;  Uploaded by user&lt;/p&gt;&lt;/div&gt;</pre></blockquote><p>Esta estructura tan sencilla nos permite crear f&aacute;cilmente el HTML de manera din&aacute;mica, utilizando php o javascript, o lo que queramos.</p><h4>Los estilos para el envoltorio</h4><blockquote><pre>.pinWrapper {    display: flex;    flex-direction: column;    justify-content: space-between;    flex: 0 1 calc(50% - 1em);}</pre></blockquote><p>Despu&eacute;s de dar al envoltorio una serie de estilos b&aacute;sicos, lo transformamos en una caja flexible utilizando:</p><blockquote><pre>display: flex;</pre></blockquote><p>Dentro de esta caja queremos colocar los elementos en direcci&oacute;n vertical por lo cual necesitamos uitilizar la propiedad <em class="gem"><a target="_blank" class="link_to" href="flex-direction.php">flex-direction</a></em>:</p><blockquote><pre>flex-direction: column;</pre></blockquote><p>Tambi&eacute;n queremos que el p&aacute;rrafo para acreditar la proveniencia de la imagen <code>&lt;p class="pin CreditTitle"&gt;</code> est&eacute; siempre a la parte de abajo. La soluci&oacute;n es utilizar la propiedad <em class="gem"><a target="_blank" class="link_to" href="flex-justify-content.php">justify-content</a></em><blockquote><pre>justify-content: space-between;</pre></blockquote>   <p>Finalmente escribimos esta l&iacute;nea de c&oacute;digo: <code>flex: 0 1 calc(50% - 1em);</code> que tambi&eacute;n la podemos escribir as&iacute;:</p><blockquote><pre><span class="com">/*flex-grow:0;*/</span>  flex-shrink:1;  flex-basis: calc(50% - 1em);</pre></blockquote><p>Recuerde que <em class="gem">la propiedad <a target="_blank" class="link_to" href="flex-abreviado.php">flex</a> nos permite abreviar tres propiedades: flex-grow, flex-shrink y flex-basis en una sola.</em></p><p>Esto traducido al castellano quiere decir que:</p> <ul class="no-bullet">  <li><strong>1.</strong> Las tarjetas no pueden crecer <code>flex-grow:0;</code>.</li>  <li><strong>2.</strong> Las tarjetas pueden contraerse lo que fuera necesario para acomodarse dentro del contenedor: <code>flex-shrink:1;</code></li>  <li><strong>3.</strong> Asimismo damos a la tarjeta una anchura de 50% del contenedor, o sea de la galer&iacute;a. Para esto podemos utilizar la propiedad <code>width:50%</code>, pero dentro de una caja flex es aconsejable utilizar <code>flex-basis:50%</code>. De estos 50% restamos <code>1em</code> que equivale a un margen <code>margin:.5em</code>;</li> </ul><blockquote><pre>flex-basis: calc(50% - 1em);</pre></blockquote><h5>Veamos el c&oacute;digo:</h5><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">.pinWrapper {  padding: 0;  border: 1px solid #d9d9d9;  border-radius: 6px;  overflow: hidden;  background-color: white;  margin: .5em;}.pinWrapper p {  font-size: .8em;}.pin {  padding: .8em;}.CreditTitle {  border-top: 1px solid #e0e0e0;}.pinImage img {  width: 100%;}/* FLEXBOX */.pinWrapper {  display: flex;  flex-direction: column;  justify-content: space-between;  flex: 0 1 calc(50% - 1em);}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><div class="pinWrapper"><div class="pinImage">    <img src="http://www.placecage.com/236/225" alt="Nicolas Cage">    <h3 class="pin GridTitle">Pablo Picasso</h3><!-- opcional -->    <p class="pin Description">Don Quixote. Uno de mis dibujos favoritos, quiz&aacute;s por mi predilecci&oacute;n por el hidalgo indomable.</p>  </div>  <p class="pin CreditTitle"><strong>Pinned from</strong>:<br>  Uploaded by user</p></div>	</code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <div id="pinTerest">        <div class="pinWrapper"><div class="pinImage">    <img src="http://www.placecage.com/236/225" alt="Nicolas Cage">    <h3 class="pin GridTitle">Pablo Picasso</h3><!-- opcional -->    <p class="pin Description">Don Quixote. Uno de mis dibujos favoritos, quiz&aacute;s por mi predilecci&oacute;n por el hidalgo indomable.</p>  </div>  <p class="pin CreditTitle"><strong>Pinned from</strong>:<br>  Uploaded by user</p></div>	         </div>        </article></div><p><em class="gem">Las im&aacute;genes utilizadas provienen de <a target="_blank" class="link_to" href="http://www.placecage.com">www.placecage.com</a> una plataforma que nos permite emplear f&aacute;cilmente im&aacute;genes marcadoras de posici&oacute;n.</em></p></p><h4>Los estilos para la galer&iacute;a de im&aacute;genes</h4><p>Tambi&eacute;n la galer&iacute;a tiene una estructura HTML muy sencilla: dentro del  <code>&lt;div id="pinTerest"&gt;</code>  ( la galer&iacute;a ) aparecen anidadas las tarjetas <code>&lt;div class="pinWrapper"&gt;</code>; y nada m&aacute;s.</p><blockquote><pre>&lt;div class=&quot;pinTerest&quot;&gt;    &lt;div class=&quot;pinWrapper&quot;&gt;&lt;/div&gt;    &lt;div class=&quot;pinWrapper&quot;&gt;&lt;/div&gt;    &lt;div class=&quot;pinWrapper&quot;&gt;&lt;/div&gt;    &lt;div class=&quot;pinWrapper&quot;&gt;&lt;/div&gt;    . . . . . . .&lt;/div&gt;</pre></blockquote><p>Despu&eacute;s de dar a la galer&iacute;a una serie de estilos b&aacute;sicos, la transformamos en una caja flexible, utilizando <code>display: flex;</code>. Dentro de esta caja queremos colocar los elementos en direcci&oacute;n horizontal por lo cual podemos escribir <code>flex-direction: row;</code> pero no es necesario ya que <code>row</code> es el valor que toma por defecto la propiedad <code>flex-direction</code>.<br>La propiedad <a target="_blank" class="link_to" href="flex-wrap.php">flex-wrap</a>  especifica si puede haber un cambio de l&iacute;nea ( <code>wrap</code> ) o no ( <code>nowrap</code> – el valor por defecto ). Si no hay cambio de l&iacute;nea todos los elementos aparecen apretados y aplastados para que quepan en una sola hilera. Para que esto no pase utilizamos  <code>flex-wrap: wrap</code>.</p><blockquote><pre>#pinTerest {      display: flex;    flex-wrap: wrap;  }</pre></blockquote>    <h4>@media queries</h4><p>Cuando trabajamos con <a target="_blank" class="link_to"  href="media-query.php">@media queries</a> es mejor empezar por los estilos para las pantallas peque&ntilde;as. Es por esto que las tarjetas tienen una anchura base de 50%: <code>flex-basis: calc(50% - 1em);</code></p>  <blockquote><pre>.pinWrapper {    display: flex;    flex-direction: column;    justify-content: space-between;    <strong class="str">flex: 0 1 calc(50% - 1em);</strong>  }</pre></blockquote>  <p>En pantallas m&aacute;s grandes queremos cambiar la anchura base ( <code>flex-basis</code> ) de las tarjetas para que quepan 3, 4 o 5 tarjetas en una fila:</p>  <blockquote><pre><p>@media screen and ( min-width:30em) {    .pinWrapper {      flex: 0 1 calc(<strong class="str">33%</strong> - 1em); <span class="com">/* 3 tarjetas en fila*/</span>    }  }<p>@media screen and ( min-width:48em) {    .pinWrapper {      flex: 0 1 calc(<strong class="str">25%</strong> - 1em); <span class="com">/* 4 tarjetas en fila*/</span>    }  }<p>@media screen and ( min-width:62em) {    .pinWrapper {      flex: 0 1 calc(<strong class="str">20%</strong> - 1em); <span class="com">/* 5 tarjetas en fila*/</span>    }  }</pre></blockquote><p data-height="569" data-theme-id="11360" data-slug-hash="ZQjLEm" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/ZQjLEm/'>Responsive Image Gallery With Flexbox</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><p><em class="gem">Las im&aacute;genes utilizadas provienen de <a target="_blank" class="link_to" href="http://www.placecage.com">www.placecage.com</a> una plataforma que nos permite uzar f&aacute;cilmente im&aacute;genes marcadoras de posici&oacute;n.</em></p></p></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="flex-box.php">Flexbox - una introducci&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-direction.php">flex-direction</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-wrap.php">flex-wrap</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-items.php">align-items</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-justify-content.php">justify-content</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-content.php">align-content</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-self.php">align-self</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-abreviado.php">flex</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-order.php">order</a></em></li><li>- <em class="gem"><a class="link_to" href="ejemplos/flexbox-playground.html">Entender flexbox</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-modernizr.php">C&oacute;mo utilizar Modernizr</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-menu.php">Men&uacute; b&aacute;sico flexbox</a></em></li><li>- <em class="gem">Cuadricula flexbox</em></li><li>- <em class="gem"><a class="link_to" href="flex-maquetacion.php">Maquetaci&oacute;n flex</a></em></li></ul></article></div></div>
