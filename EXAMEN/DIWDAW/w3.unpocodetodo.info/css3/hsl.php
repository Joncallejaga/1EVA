...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como especificar los colores hsl y hsla." />
  <meta name="keywords" content="colores, color, colores hsl, colores hsla, hue, matiz, saturation, saturaci&oacute;n, saturacion, lightness, luminosidad, transparencia, alpha"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Colores hsl y hsla" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/hsl.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como especificar los colores hsl y hsla." /> 
  
  <title>Colores hsl y hsla</title>
  ...
  <link rel="canonical" href="hsl.php"> 
 
  <style>#lienzoSVG{border:none;}path{cursor:pointer;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="hsl.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="hsl">
<h2 class="page_title">Colores hsl y hsla</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Colores hsl y hsla&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fhsl.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fhsl.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fhsl.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Como una novedad en el <strong>CSS3</strong> ya podemos utilizar los <strong>colores hsl</strong> en nuestras hojas de estilo.<br>
A diferencia de los colores <strong>hex</strong> o<strong> rgb</strong>, los colores <strong>hsl</strong> son mucho m&aacute;s intuitivos y mas f&aacute;cil de utilizar, y ya veremos porque.<br>
</p>
<div class="row"> 
...
div{background-color:hsl(0,100%,50%)/* hsl( hue, saturation%, lightness% )*/;}</code></pre>
</article>
</div>
</div>
</div>
<p><strong>Pero &iquest;que son los colores hsl?</strong><br>
<strong>HSL</strong> es el acr&oacute;nimo de <mark>hue</mark> <em class="gem">( matiz )</em>,
<mark>saturation</mark> <em class="gem">( saturaci&oacute;n )</em>, 
<mark>lightness</mark> <em class="gem">( luminosidad )</em>.<br>
Mir&eacute;moslos detenidamente y por partes:</p>
<h4>Hue <small>( matiz )</small></h4>
<p>Pensemos un momento en la rueda de los colores. Cada grado de esta rueda es un color. De aqu&iacute; que <strong>"hue"</strong> es un n&uacute;mero de 0 a 359. A lo largo de los 360&deg; el color cambia de rojo ( 0&deg; ) a verde (120&deg;) a azul ( 240&deg;) y de nuevo a rojo ( 360&deg; ). </p>
<div class="row"> 
<div class="large-12 columns">
<div class="text-center">
<svg id="lienzoSVG" height="250" width="250"></svg>
<p><em class="gem">Puedes hacer clic en la rueda de los colores  para ver el valor <code>hsl</code>  del color.</em></p>
</div><!--<div  id="rotate">-->
</div>

</div><!--<div class="row"> -->
<p>Conociendo el valor <strong>"hue"</strong> de un color podemos calcular f&aacute;cilmente, casi de manera intuitiva, el <strong>color complementario</strong> de este: o sea el color diametralmente opuesto.<br>
</p>
<blockquote><p><span class="normal">Por ejemplo: </span><br>El c&oacute;digo hsl para rojo es <code>hsl(0,100%, 50%)</code>, donde H = 0;<br>
El par&aacute;metro H del color complementario ( diametralmente opuesto ) ser&aacute; de 180, o sea <code>hsl(180,100%,50%)</code>, un color a medio camino entre verde y azul.
</p></blockquote>
<p>Por colores tr&iacute;adicos entendemos un grupo de tres colores situados a 120&deg; uno del otro en el c&iacute;rculo crom&aacute;tico.<br>
De nuevo: calcular los <strong>colores tr&iacute;adicos</strong> es una tarea casi imposible si conocemos solo el c&oacute;digo <strong>hex</strong> o <strong>rgb</strong> de nuestro color, pero vuelve a ser una tarea muy f&aacute;cil si conocemos el c&oacute;digo <strong>hsl</strong> de nuestro color. </p>
<blockquote><p><span class="normal">Por ejemplo: </span><br>En el caso del rojo <code>hsl(0,100%,50%)</code> los otros dos colores tr&iacute;adicos son: verde <code>hsl(120,100%,50%)</code> y azul <code>hsl(240,100%,50%)</code></p></blockquote>

<p><em class="gem">Convierte facilmente tus colores  <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/utiles/converso%C2%A1.php">de hex a rgb a hsl</a></em></p>
<h4>Saturation <small>( saturaci&oacute;n )</small></h4>
<p>La saturaci&oacute;n de un color se representa en porcientos. Por lo cual la <strong>saturaci&oacute;n</strong> puede tomar valores de 100% a 0% ( grises ).</p>
...
<h4>Lightness <small>( luminosidad )</small></h4>
<p>Representamos la luminosidad de un color en porcientos. Por lo cual la <strong>luminosidad</strong> puede tomar valores entre 100% ( blanco ) y 0% ( falta de color o sea negro ).

<table class="color">
  <tr>
  <td style="background-color:hsl(0,100%,100%)">100%</td>
  <td style="background-color:hsl(0,100%,90%)">90%</td>
  <td style="background-color:hsl(0,100%,80%)">80%</td>
  <td style="background-color:hsl(0,100%,70%)">70%</td>
  <td style="background-color:hsl(0,100%,60%)">60%</td>
  <td style="background-color:hsl(0,100%,50%)">50%</td> 
  <td style="background-color:hsl(0,100%,40%)">40%</td> 
  <td style="background-color:hsl(0,100%,30%)">30%</td> 
  <td style="background-color:hsl(0,100%,20%)">20%</td>
  <td style="background-color:hsl(0,100%,10%)">10%</td>
  <td style="background-color:hsl(0,100%,0%)">0%</td>
  </tr>
</table>


<h4>Colores hsla</h4>
<p>Adem&aacute;s de los c&oacute;digos <code>hsl</code> podemos utilizar los c&oacute;digos <code>hsla</code> donde <strong>a</strong>, exactamente como en el caso de los colores <em class="gem"><a class="link_to" href="rgb.php">rgba</a></em>, representa el valor alpha.</p>
<blockquote><p>background-color: hsla(0, 100%, 50%, .8);</p></blockquote>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="rgb.php">Colores rgb y rgba</a></em></li><li>- <em class="gem"><a class="link_to" href="hex.php">Colores hex</a></em></li><li>- <em class="gem">Colores hsl y hsla</em></li><li>- <em class="gem"><a class="link_to" href="transparencias.php">Opacidad y transparencias</a></em></li><li>- <em class="gem"><a class="link_to" href="current-color.php">currentColor</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- El soporte de los <a class="link_to" target="_blank" href="http://caniuse.com/css3-colors">colores CSS3 en los navegadores</a><br>
- Convierta f&aacute;cilmente los colores  <a class="link_to" href="../utiles/conversor.php">hex en rgb o hsl</a> y vicevarsa.
</em></p>
</article></div></div>
