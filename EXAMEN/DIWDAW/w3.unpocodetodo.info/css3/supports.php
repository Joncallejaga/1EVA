...
<head>
  ...
  <meta name="description" content="La regla-at &#64;supports nos permite detectar si el navegador del usuario soporta o no las nuevas funcionalidades de CSS." />
  <meta name="keywords" content="regla-at, at-rule,CSS, palabras clave, not, or, and"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La regla-at &#64;supports" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/supports.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La regla-at &#64;supports nos permite detectar si el navegador del usuario soporta o no las nuevas funcionalidades de CSS." /> 
  
  <title>La regla-at &#64;supports</title>
  ...
  <link rel="canonical" href="supports.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="supports.php#"><span></span></a></li>
          </ul>
...
<div class="large-12 g_panel"><article><section id="supports"><h2 class="page_title">La regla-at &#64;supports</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La regla-at &#64;supports&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsupports.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsupports.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsupports.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La regla-at <code>&#64;supports</code> nos permite detectar si el navegador del usuario soporta o no las nuevas funcionalidades de CSS.</p><h4>¿Como funciona?</h4><p>En el siguiente ejemplo el CSS aplica las reglas entre llaves ( { } ) solo si el navegador soporta <code>display: flex</code>. De lo contrario las ignora por completo. </p><blockquote><pre><span class="com">/* si el navegador soporta display: flex */</span>&#64;supports (display: flex) {<span class="com">/* entonces aplica estas reglas: */</span>      .elemento {          display: flex;          <span class="com">/* y las dem&aacute;s reglas */</span>      }  }</pre></blockquote>  <h4>Algunas palabras clave</h4><p><strong>¡OJO!</strong> Es importante dejar un espacio en blanco delante y detr&aacute;s de las palabras clave.</p><h5>La palabra clave <strong>not</strong></h5><p>En el siguiente ejemplo el CSS aplica las reglas entre llaves ( { } ) solo si el navegador <strong>NO</strong> soporta <code>display: flex</code>.</p><blockquote><pre><span class="com">/* si el navegador NO soporta display: flex */</span>&#64;supports not (display: flex) {<span class="com">/* entonces aplica estas reglas: */</span>      .elemento {          display: table;          <span class="com">/* y las dem&aacute;s reglas */</span>      }  }</pre></blockquote><p>Podemos verificar m&uacute;ltiples caracter&iacute;sticas utilizando las palabras clave and y/o or</p><h5>La palabra clave <strong>or</strong></h5><p>En el siguiente ejemplo el CSS aplica las reglas entre llaves ( { } ) si el navegador cumple al menos una de las condiciones entre par&eacute;ntesis, o sea si el navegador soporta <code>display: -webkit-flex</code> o <code>display: -moz-flex</code> o <code>display: flex</code>.</p><blockquote><pre>&#64;supports (display: -webkit-flex) <span class="str">or</span>          (display: -moz-flex) <span class="str">or</span>          (display: flex) {                  .elemento {                      display: -webkit-flex;                      display: -moz-flex;                      display: flex;                      <span class="com">/*aqu&iacute; van las reglas */</span>      }  }</pre></blockquote><h5>La palabra clave <strong>and</strong></h5><p>En el siguiente ejemplo el CSS aplica las reglas entre llaves ( { } ) solo si el navegador soporta tanto la propiedad <code>column-count</code> como la propiedad <code>break-before</code>.</p><blockquote><pre>&#64;supports (column-count : 3) <span class="str">and</span> (break-before: right) {        <span class="com">/*aqu&iacute; van las reglas */</span>  }</pre></blockquote><h5>Utilizando varias palabras clave</h5><p>Podemos concatenar m&uacute;ltiples condiciones utilizando varias palabras clave. La sintaxis utilizada en este caso se parece mucho con la de otros lenguajes de programaci&oacute;n.</p><blockquote><pre>&#64;supports <span class="str">not</span> (...) <span class="str">and</span> ((...) <span class="str">or</span> (...)) { /* ... */ }&#64;supports (...) <span class="str">or</span> (...) (<span class="str">not</span> (...)) { /* ... */ }</pre></blockquote><h4>El soporte en los navegadores</h4> <p>El soporte en los navegadores para <a class="link_to" target="_blank" href="http://caniuse.com/#search=CSS.supports">la regla-at &#64;supports</a> es muy bueno.</p>            </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="at-import.php">La regla-at &#64;import</a></em></li><li>- <em class="gem"><a class="link_to" href="at-namespace.php">La regla-at &#64;namespace</a></em></li><li>- <em class="gem"><a class="link_to" href="font-face.php">La declaraci&oacute;n @font-face</a></em></li><li>- <em class="gem"><a class="link_to" href="at-keyframes.php">La regla-at &#64;keyframes</a></em></li><li>- <em class="gem"><a class="link_to" href="media-query.php">&#64;media-query</a></em></li><li>- <em class="gem">La regla-at &#64;supports</em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- Sara Soueidan: <a class="link_to" target="_blank" href="http://tympanus.net/codrops/css_reference/supports/">&#64;supports</a><br>
- David Walsh: <a class="link_to" target="_blank" href="https://davidwalsh.name/css-supports">&#64;supports</a><br>
- Chris Mills: <a class="link_to" target="_blank" href="https://dev.opera.com/articles/native-css-feature-detection/">Native CSS Feature Detection via the &#64;supports</a> Rule<br>
- MDN en espa&ntilde;ol: <a class="link_to" target="_blank" href="https://developer.mozilla.org/es/docs/Web/CSS/&#64;supports">&#64;supports</a><br></em></p>
</article></div></div>
