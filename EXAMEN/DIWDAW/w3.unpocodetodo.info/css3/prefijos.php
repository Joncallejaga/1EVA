...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Utilizar prefijos en CSS3. Que pasar&aacute; con mi c&oacute;digo cuando los navegadores dejen de utilizar los prefijos?" />
  <meta name="keywords" content="tutorial, html5, css, css3, vendor prefixes, prefijos,  motor de renderizado, browser engine, -moz, -o, -webkit"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Prefijos ( vendor prefixes )" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/prefijos.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Utilizar prefijos en CSS3. Que pasar&aacute; con mi c&oacute;digo cuando los navegadores dejen de utilizar los prefijos?" /> 
  
  <title>Prefijos ( vendor prefixes )</title>
  ...
  <link rel="canonical" href="prefijos.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="prefijos.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="prefijos">
<h2 class="page_title">Prefijos<small> (vendor prefixes)</small></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Prefijos ( vendor prefixes )&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fprefijos.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fprefijos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fprefijos.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Cada <em class="gem"><a target="_blank" class="link_to" href="http://es.wikipedia.org/wiki/Motor_de_renderizado">motor de renderizado</a> ( browser engine )</em> tiene sus propios prefijos, los m&aacute;s notables siendo:</p>
<blockquote><ul class="no-bullet">
<li><span class="normal">-moz-</span> para Firefox y los dem&aacute;s navegadores de Gecko,</li>
<li><span class="normal">-webkit-</span> para los navegadores WebKit: Chrome, Safari, etc.</li>
<li><span class="normal">-ms-</span> para Microsoft (Internet Explorer),</li>
<li><span class="normal">-o-</span> para Presto, el antiguo motor de Opera.</li>
</ul></blockquote>
<h6>Pero &iquest;Porque tantos prefijos?</h6>
<p>En el css3 hay nuevas propiedades que est&aacute;n todav&iacute;a en estado experimental. 
  Los navegadores tienen varias maneras de interpretar el css, y varios niveles de soporte para los estandartes <a target="_blank" class="link_to" href="http://www.w3.org/">W3C</a>. <br />
Los <mark>prefijos</mark> <em class="gem">( vendor prefixes )</em> se utilizan con estas propiedades cuando sea necesario para conseguir un aspecto consistente y uniforme en todos los navegadores.</p>
<h6>&iquest;Como utilizar los prefijos?</h6>
<p>Vamos a ver un ejemplo: si queremos que nuestro fondo sea un degradado linear, es así como tenemos que hacerlo, al menos en este momento. M&aacute;s tarde esperemos que ser&aacute; mucho m&aacute;s f&aacute;cil.</p>
...
<div class="large-12 g_panel resultado">
        <article>
        <div class="linear-gradient" style="height:200px; width:90%; margin:0 auto;"></div>
        </article>
</div>


<h6>&iquest;Que pasar&aacute; con mi c&oacute;digo cuando los navegadores dejen de utilizar los prefijos?</h6>
<p>Los navegadores antiguos utilizar&aacute;n la primera l&iacute;nea de c&oacute;digo que entienden, o sea la que lleva su prefijo, e ignorar&aacute;n las otras l&iacute;neas de c&oacute;digo 
( que no saben como interpretar ). Por de otra parte los navegadores nuevos, que ya no necesitan prefijos, se quedar&aacute;n (seg&uacute;n las reglas del css) con la &uacute;ltima l&iacute;nea de c&oacute;digo, 
la de la propiedad sin prefijo.</p>

<p><em class="gem">Si queremos saber que prefijos tenemos que utilizar, podemos consultar :  <a class="link_to" target="_blank" href="http://caniuse.com">caniuse.com</a>.<br />
(por ejemplo: informaci&oacute;n acerca del soporte de <a class="link_to" target="_blank" href="http://caniuse.com/#search=linear-gradient">linear-gradient</a> en los navegadores).</em></p>
...
<p><em class="gem">
- <a class="link_to" target="_blank" href="http://cssprefixer.appspot.com/">css Prefixer</a> - un programa que escribe los prefijos.<br />
- pero esto es mucho mejor: <a class="link_to" target="_blank" href="http://leaverou.github.io/prefixfree/">-prefix-free</a> - Made by <a class="link_to" target="_blank"  href="http://lea.verou.me/">Lea Verou</a> with care.</em></p>
</article></div></div>
