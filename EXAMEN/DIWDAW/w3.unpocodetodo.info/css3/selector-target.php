...
<head>
  ...
  <meta name="description" content="C&oacute;mo dar formato al elemento de destino utilizando el selector :target de CSS3" />
  <meta name="keywords" content="tutorial, html5, css, css3, selector,pseudo-selector, pseudo-clase, pseudo-class, target, enlazar, elemento de destino, elemento enlazado,galer&iacute;a de im&aacute;genes "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El selector :target" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selector-target.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo dar formato al elemento de destino utilizando el selector :target de CSS3" /> 
  
  <title>El selector :target</title>
  ...
  <link rel="canonical" href="selector-target.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selector-target.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selector-target.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="selector-target">
<h2 class="page_title">El selector :target</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El selector :target&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-target.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-target.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-target.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>El selector :target</h4>
<p>Todos sabemos c&oacute;mo enlazar a un elemento con un <code>id</code> especificado dentro de una p&aacute;gina ( !OJO&iexcl;: el atributo <code>name</code> ya no es compatible con HTML5 ).</p>
<blockquote><p>
...
<p>Vea un ejemplo de <a class="link_to" target="_blank" href="ejemplos/target.html">como utilizar el pseudo-selector <code>:target</code></a><br /> 
Vea una sencilla <a class="link_to" target="_blank" href="ejemplos/galeria-target.html">galeria de im&aacute;genes</a> hecha utilizando  el pseudo-selector <code>:target</code></p> 
