...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Con transiciones de CSS3, podemos aplicar un efecto de animaci&oacute;n al cambiar de un estilo a otro, sin el uso de Flash o JavaScript." />
  <meta name="keywords" content="tutorial, html5, css, css3, propiedad, transition-property, duraci&oacute;n, duracion, transition-duration, funci&oacute;n de temporizador, transition-timing-function, linear, ease, ease-in, ease-out, ease-in-out, cubic-bezier(n,n,n,n) demora, transition-delay"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Transiciones" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/transitions.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Con transiciones de CSS3, podemos aplicar un efecto de animaci&oacute;n al cambiar de un estilo a otro, sin el uso de Flash o JavaScript." /> 
  ...
  <link rel="canonical" href="transitions.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="transitions.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="transitions.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">Transiciones</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Transiciones&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransitions.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransitions.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransitions.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Con transiciones de CSS3, podemos aplicar un efecto de animaci&oacute;n al cambiar de un estilo a otro, sin el uso de Flash o JavaScript.</p>
<div class="row"> 
<div class="large-12 columns">
<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">transition: <span>propiedad</span> <span>duraci&oacute;n</span> <span>funci&oacute;n de temporizador ( opcional )</span> <span>demora ( opcional )</span>;</em><br />
</p>
</article>
</div>
</div>
</div><!--SINTAXIS-->
<blockquote><p><span class="normal"><strong>transition</strong> representa la notaci&oacute;n abreviada de cuatro propiedades:</span><br />
<strong>propiedad</strong> ( transition-property )<br />
Especifica la lista de propiedades (separadas por comas) que modificaran su valor durante la transici&oacute;n<br />

<strong>duraci&oacute;n</strong> (transition-duration)<br />
Especifica el n&uacute;mero de segundos (s) o milisegundos (ms) entre el comienzo y el fin de la transici&oacute;n.<br />

<strong>funci&oacute;n de temporizador</strong> ( transition-timing-function )<br />
Par&aacute;metro opcional. Especifica como varia la velocidad durante la transici&oacute;n.
<br />
<strong>demora</strong> ( transition-delay )<br />
Par&aacute;metro opcional. Especifica el n&uacute;mero de segundos (s) o milisegundos (ms) antes de empezar la transici&oacute;n.</p>
</blockquote>
<h4>Propiedades y duraci&oacute;n</h4>
<p>Empezamos con un ejemplo f&aacute;cil: al pasar por encima ( <code>:hover</code> ) del <code>&lt;div id="transicion"&gt;</code> el color de fondo ( <code>background-color</code> ) cambiar&aacute; de rojo ( <code>#ff0000</code> ) a azul ( <code>#0000ff</code> ) en una transici&oacute;n ( <code>transition</code> ) de 3 segundos.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#transicion {
  height: 100px;
  width: 100px;
  background-color: #ff0000;
  -webkit-transition: background-color 3s;
...
<div id="transicion" style="margin:100px auto;"></div>


</div>
</div>  

<p>Si queremos que dos o m&aacute;s propiedades cambien durante la transici&oacute;n, separaremos las propiedades con una coma (&nbsp;,&nbsp;).</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#propiedades {
  height: 100px;
  width: 100px;
  background-color: #ff0000;
  -webkit-transition: background-color 3s, border-radius 3s;
...
<div id="propiedades" style="margin:100px auto;"></div>


</div>
</div> 

<p>Podemos desglosar la propiedad <code>transition</code> ( abreviada ) del ejemplo anterior, utilizando las propiedades <code>transition-property</code> y <code>transition-duration</code>.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#desglosado {
  height: 100px;
  width: 100px;
  background-color: #ff0000;
  -webkit-transition-property: background-color, border-radius;
...
<div id="desglosado" style="margin:100px auto;"></div>
...
<h4 id="easing">Funci&oacute;n de temporizador<br /><small>( transition-timing-function )</small></h4>
<p>La funci&oacute;n de temporizador que especifica la curva de velocidad del efecto de transici&oacute;n, es un par&aacute;metro opcional y puede tomar los siguientes valores:<br><code>linear</code> | <code>ease</code> | <code>ease-in</code> | <code>ease-out</code> | <code>ease-in-out</code> | <code>cubic-bezier(n,n,n,n)</code>.<br>
Si no especificada, la funci&oacute;n de temporizador toma por defecto el valor de  <code>linear</code>.</p>
<div class="row"> 
<div class="large-12 columns">
<div class="g_panel">
        <article>
        <p><em class="gem">
        <strong>linear</strong>:<br />el efecto de transici&oacute;n pasa con la misma velocidad de principio a fin (equivalente a: cubic-bezier(0,0,1,1))<br /> 
        <strong>ease</strong>:<br />la transici&oacute;n es lenta al inicio, despu&eacute;s r&aacute;pida, despu&eacute;s lenta de nuevo (equivalente a: cubic-bezier(0.25,0.1,0.25,1))<br /> 
        <strong>ease-in</strong>:<br />la transici&oacute;n es lenta al inicio (equivalente a: cubic-bezier(0.42,0,1,1))<br /> 
        <strong>ease-out</strong>:<br />la transici&oacute;n es lenta al final(equivalente a: cubic-bezier(0,0,0.58,1))<br />
        <strong>ease-in-out</strong>:<br />la transici&oacute;n es lenta al inicio y al final (equivalente a: cubic-bezier(0.42,0,1,1))<br />
...
<div id="temporizador" style="margin:100px auto;"></div>


</div>
</div>     
<p><em class="gem">Para entender mejor la funci&oacute;n <a class="link_to" target="_blank" href="http://cubic-bezier.com">cubic-bezier()</a> ( Made by <a class="link_to" target="_blank" href="http://lea.verou.me/">Lea Verou</a> with care. )</em></p> 


<h4>Demora <small>( transition-delay )</small></h4>
<p>La propiedad <code>transition-delay</code> especifica el n&uacute;mero de segundos ( s ) o milisegundos ( ms ) antes de empezar la transici&oacute;n.<br />
En el siguiente ejemplo la transici&oacute;n tardar&aacute; 1 segundo en empezar.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
...
<div id="demora" style="margin:100px auto;"></div>
