...
<head>
  ...
  <meta name="description" content="La funci&oacute;n calc() de CSS3 nos permite realizar operaciones matem&aacute;ticas sencillas como: sumar, restar, multiplicar y divisi&oacute;n." />
  <meta name="keywords" content="tutorial, html5, css, css3, calc(), sumar, restar, multiplicar y divisi&oacute;n"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La funci&oacute;n calc()" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/calc.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La funci&oacute;n calc() de CSS3 nos permite realizar operaciones matem&aacute;ticas sencillas como: sumar, restar, multiplicar y divisi&oacute;n." /> 
  
  <title>La funci&oacute;n calc()</title>
  ...
  <link rel="canonical" href="calc.php"> 
 
  <style>.calcTest{ -moz-box-sizing: content-box; -webkit-box-sizing: content-box; box-sizing: content-box; }
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="calc.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="calc">
<h2 class="page_title">La funci&oacute;n calc()</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La funci&oacute;n calc()&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcalc.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcalc.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcalc.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La funci&oacute;n <code>calc()</code> de CSS3 nos permite realizar operaciones matem&aacute;ticas sencillas como: sumar ( <code>+</code> ), restar ( <code>-</code> ), multiplicar ( <code>*</code> ) o dividir ( <code>/</code> ), y puede ser utilizada siempre que se trate de valores num&eacute;ricos c&oacute;mo: longitud, frecuencia, duraci&oacute;n, &aacute;ngulo o n&uacute;mero.</p>
<blockquote><pre>section {
      height: <span class="str">calc</span>(100% - 2*10px);
  }
</pre></blockquote>
<p>Se nos dijo de peque&ntilde;os que no es posible "sumar manzanas con naranjas". La funci&oacute;n <code>calc()</code> hace esto posible: podemos sumar, restar, o lo que sea, pixeles ( <code>px</code> ) con <code>em</code>, porcentajes ( <code>%</code> ) con pixeles ( <code>px</code> ), ya que una de las habilidades de <code>calc()</code> es mezclar unidades.</p>
<p>En el siguiente ejemplo queremos construir dos cajas ( <code>&lt;div class="calcTest"&gt;</code> ) cuyo tama&ntilde;o var&iacute;a en funci&oacute;n del tama&ntilde;o de la caja contenedor (<code>&lt;div id="contenedorCalc"&gt;</code> )</p>
<p>Para ser m&aacute;s exactos: la altura de <code>.calcTest</code> es igual a la altura del contenedor <code>#contenedorCalc</code> ( 100% ) de la cual restamos el margen ( 2*10px ), el padding ( 2*10px ), y el borde ( 2px ).</p>
<blockquote><pre>height: calc(100% - 2*10px - 2*20px - 2px);</pre></blockquote>
<p>Calculamos la anchura de las cajas  <code>.calcTest</code>: la mitad del ancho del contenedor <code>#contenedorCalc</code> ( 50% ) menos el margen, el padding  y el borde.</p>
<blockquote><pre>width:  calc(50% - 2*10px - 2*20px - 2px);</pre></blockquote>
...
<div id="contenedorCalc"> 	
   <div class="calcTest"></div>     
   <div class="calcTest"></div> 
</div></code></pre>
        </article>
</div>
<p>Pruebe redimensionar la pagina.</p>
...
<h4>Calcular la posici&oacute;n del background</h4>
<p>Podemos posicionar las im&aacute;genes de fondo relativamente a la esquina izquierda arriba de la caja con <code>background-position</code>. Esto ya lo sabemos.</p>
<blockquote><pre>background-position: x y;</pre></blockquote>
<p>Utilizando la funci&oacute;n <code>calc()</code> podemos posicionar las im&aacute;genes de fondo tambi&eacute;n relativamente a la esquina derecha abajo: algo muy &uacute;til en el caso de las p&aacute;ginas adaptativas.</p>
<blockquote><pre>background-position: calc(100% - x) calc(100% - y);</pre></blockquote>
<p>En el siguiente ejemplo posicionamos un grano de caf&eacute; a 20px de la esquina derecha abajo.</p>
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup">
<div id="contenedorCalc1"> 	
   <div class="calcTest calcImg"></div>     
   <div class="calcTest calcImg"></div> 
</div></code></pre>
        </article>
</div>
