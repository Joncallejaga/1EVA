...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como aplicar una sombra a una caja con  box-shadow." />
  <meta name="keywords" content="tutorial, html5, css, css3, sombra, shadow, box shadow, cajas con sombra, sombras css,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Cajas con sombra" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/box-shadow.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como aplicar una sombra a una caja con  box-shadow." /> 
  
  <title>Cajas con sombra</title>
  ...
  <link rel="canonical" href="box-shadow.php"> 
 
  <style>
.resultado article .caja{display:block; height:100px; width:100px; background:#FF9;margin:0 auto;}
#caja2,#caja3{display:inline-block;}#caja2{margin-left:calc(50% - 105px); margin-right:10px;}#caja1{box-shadow: 0px 0px 5px 1px black;}#caja2{box-shadow: 0px 10px 10px black;}
#caja3{box-shadow: 0px 10px 10px -6px black;}#caja4{box-shadow: 0px 0px 10px 0px #333 inset;}
.caja span{display: block; position:relative; top:40px; text-align:center;}.sombra_svg {
	position: relative;
	margin:auto;
	display:-webkit-flex; 
	display: -ms-flexbox; 
...
}#fix{display:block; width:6.1em; margin:0 auto 1em;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="box-shadow.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="box-shadow.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">Cajas con sombra</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Cajas con sombra&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbox-shadow.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbox-shadow.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbox-shadow.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Todo lo que sabemos acerca de <em class="gem"><a href="text-shadow.php" class="link_to">text-shadow</a></em> puede ser aplicado a <code>box-shadow</code>. Es como si fuera la misma propiedad con otro nombre. Sin embargo hay algunos toques especiales.
...
<article>
<p class="sintaxis"><em class="gem">box-shadow: <span>desplazamiento horizontal</span> <span>desplazamiento vertical</span> <span>desenfoque</span> <span class="error">extension</span> <span>color</span>  <span class="error">inset</span>;</em>
</p>
</article>
</div>
<p><em class="gem">Para desplazamiento horizontal, desplazamiento vertical, desenfoque y color consulte por favor <a href="text-shadow.php" class="link_to">Texto con sombra</a>.</em></p>
</div>
</div>

<h6>Extension <em class="gem">(spread)</em></h6>
<p>Analicemos este ejemplo donde tanto el desplazamiento horizontal como el vertical tienen el valor 0. La sombra quedar&iacute;a debajo de la caja, si no fuera por la extensi&oacute;n ( 1px en este caso ).</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#caja1{box-shadow: 0px 0px 5px 1px black;}</code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
		<div class="caja" id="caja1"><span>#caja1</span></div>
		</article>
</div>
<p>La extensi&oacute;n acepta valores negativas como en el siguiente ejemplo donde la <code>#caja3</code> tiene el mismo estilo que la <code>#caja2</code> pero con una extensi&oacute;n negativa (-6px) de la sombra.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#caja2{box-shadow: 0px 10px 10px black;}
#caja3{box-shadow: 0px 10px 10px -6px black;}</code></pre>
        </article>
</div>
<div class="large-12 g_panel resultado">
        <article>
        <div class="caja"  id="caja2"><span>#caja2</span></div>
        <div class="caja"  id="caja3"><span>#caja3</span></div>
        </article>
</div>


<h6>Sombra interior <em class="gem">(inset)</em></h6>
<p>Tambi&eacute;n podemos aplicar una sombra interior a nuestra caja utilizando la palabra clave <code>inset</code>.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#caja4{box-shadow: 0px 0px 10px 0px #333 inset;}</code></pre>
        </article>
</div>
<div class="large-12 g_panel resultado">
        <article>
        <div class="caja" id="caja4"><span>#caja4</span></div>
		</article>
</div>

<h4 id="drop_shadow">Ponle una sombra con drop-shadow</h4>
<p>Pero no siempre tenemos cajas regulares. Pensemos un momento en un bocadillo ( como elemento de vi&ntilde;eta ). En el siguiente ejemplo para dibujar un bocadillo utilizamos una caja rectangular  <code>&lt;div class="sombra_svg"&gt;</code>  y un pseudo-elemento <code>::before</code> para dibujar la flecha. Si queremos ponerle una sombra normal ( <code>box- shadow:1px 1px 2px #333;</code> ) la flecha queda sin sombra. Podemos darle una sombra al <code>::before</code>, pero en este caso la sombra aparece marcada por encima del bocadillo :(. La soluci&oacute;n: utilizar  <code>filter: drop-shadow()</code>.</p>
<p><em class="gem">Lea m&aacute;s sobre <a target="_blank" class="link_to" href="filtros.php">filtros en CSS</a></em></p> 
...
<div class="large-12 g_panel css">
        <article>								
		<pre><code class="language-css">.sombra_svg {
	position: relative;
	margin:auto;
	display:-webkit-flex; 
	display: -ms-flexbox; 
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="sombra_svg"><span>&iexcl;Soy un bocadillo!</span></div></code></pre>
        </article>
</div>
<div class="large-12 g_panel resultado">
        <article>
        <div id="fix">
        <div class="sombra_svg"><span>&iexcl;Soy un bocadillo!</span></div>         </div>
        </article>
</div>
<h4 id="modal">Ventana modal</h4>
<p>Otra aplicaci&oacute;n practica sería utilizar sombras para oscurecer el fondo detr&aacute;s de una ventana modal. En este caso queremos utilizar una sombra semitransparente ( <code>rgba(0,0,0,.75)</code> ) cuya extensi&oacute;n es de <code>50vmax</code> ( 1vmax equivale a una cent&eacute;sima parte del lado m&aacute;s grande de la ventana )</p>
<blockquote><pre>.modal{ box-shadow: 0 0 0 50vmax rgba(0,0,0,.75);} </pre></blockquote>
<p data-height="425" data-theme-id="11360" data-slug-hash="meEGyo" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/meEGyo/'>CSS modal</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p>
