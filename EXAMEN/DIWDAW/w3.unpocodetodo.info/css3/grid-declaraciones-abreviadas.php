...
<head>
  ...
  <meta name="description" content="El grid layout. Las propiedades grid-template y grid." />
  <meta name="keywords" content="display, grid, inline-grid, subgrid, grid-template-columns, grid-template-rows,fr,grid-template-areas,grid-rows-gap, grid-column-gap, grid-gap,grid-auto-flow,row, column, row dense, column dense, grid-auto-columns, grid-auto-rows,justify-items, align-items, start, end, center, stretch, justify-content, align-content,space-around, space-between,space-evenly, grid-template, grid, shorthand."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="grid-template y grid" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/grid-declaraciones-abreviadas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El grid layout. Las propiedades grid-template y grid." /> 
  
  <title>grid-template y grid</title>
  ...
  <link rel="canonical" href="grid-declaraciones-abreviadas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="grid-declaraciones-abreviadas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="grid-declaraciones-abreviadas.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="grid-declaraciones-abreviadas"><h2 class="page_title">Las propiedades grid-template y grid</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=grid-template y grid&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-declaraciones-abreviadas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-declaraciones-abreviadas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-declaraciones-abreviadas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h3>La propiedad grid-template</h3><p>La propiedad <code>grid-template</code> es el m&eacute;todo abreviado ( <em class="gem">shorthand</em> ) para declarar las propiedades <code>grid-template-rows</code>, <code>grid-template-columns</code> y <code>grid-template-areas</code> en una sola l&iacute;nea de c&oacute;digo. La <a class="link_to" target="_blank" href="https://www.w3.org/TR/css3-grid-layout/#explicit-grid-shorthand">especificaci&oacute;n</a> nos dice que su valor puede ser:</p><blockquote><pre>none | [ &lt;‘grid-template-rows’&gt; / &lt;‘grid-template-columns’&gt; ] |[ &lt;line-names>? &lt;string&gt; &lt;track-size&gt;? &lt;line-names&gt;? ]+ [ / &lt;explicit-track-list&gt; ]?</pre></blockquote><p>Veamos que quiere decir.</p><h5>none</h5><p>El valor de grid-template puede ser <code>none</code>. En este caso no hay filas ni columnas ni l&iacute;neas. Tampoco hay &aacute;reas del grid definidas.</p><blockquote><pre>grid-template: none;</pre></blockquote><h5>[ &lt;‘grid-template-rows’&gt; / &lt;‘grid-template-columns’&gt; ]</h5><p>Esto define primero las filas ( <em class="gem">rows</em> ) y despu&eacute;s las columnas ( <em class="gem">columns</em> ) en una sola declaraci&oacute;n.<br>Ejemplos:</p><blockquote><pre>grid-template:  1fr 2fr <span class="str">/</span> 1fr 1fr  1fr;</pre></blockquote><p>es equivalente de:</p><blockquote><pre>grid-template-rows:  1fr 2fr;grid-template-columns:  1fr 1fr  1fr;</pre></blockquote><p>Veamos otro ejemplo. Esta vez tambi&eacute;n definimos las l&iacute;neas del grid. ( Como ya se sabe el nombre de las l&iacute;neas que definimos aparece entre corchetes. )</p><blockquote><pre>grid-template:  [r1] 1fr [r2] 2fr [r3]              <span class="str">/</span> [c1] 1fr [c2] 1fr [c3] 1fr [c4];</pre></blockquote><p>es equivalente de:</p><blockquote><pre>grid-template-rows:[r1] 1fr [r2] 2fr [r3];grid-template-columns:  [c1] 1fr [c2] 1fr [c3] 1fr [c4];</pre></blockquote><p data-height="300" data-theme-id="11360" data-slug-hash="ed66988de30a4bd0747ed4f10b9dd416" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Grid  grid-template #1*" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/ed66988de30a4bd0747ed4f10b9dd416/">Grid  grid-template #1*</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><h5>&lt;line-names&gt;? &lt;string&gt; &lt;track-size&gt;? &lt;line-names&gt;? ]+ [ / &lt;explicit-track-list&gt; ]?</h5><p>Tambi&eacute;n podemos definir las &aacute;reas junto con las filas y las columnas. Los nombres de l&iacute;nea son opcionales ( <em class="gem">&lt;line-names&gt;<span class="str">?</span></em> ). Tambi&eacute;n opcional es el tama&ntilde;o del carril ( <em class="gem">&lt;track-size&gt;<span class="str">?</span></em> ). En el siguiente ejemplo, como siempre, los nombres de las &aacute;reas del grid ( <em class="gem">&lt;string&gt;</em> ) aparecen entre comillas. Los nombres de las l&iacute;neas del grid ( <em class="gem">&lt;line-names&gt;</em> ) aparecen entre corchetes.</p><p>La primera parte de la declaraci&oacute;n establece la estructura de filas ( <em class="gem">rows</em> ). A continuaci&oacute;n aparece el separador, una barra oblicua ( / ) y despu&eacute;s viene la parte que establece la estructura de columnas.  Definimos las &aacute;reas del grid en la primera parte de la declaraci&oacute;n, junto con los dem&aacute;s par&aacute;metros que establecen la estructura de filas.</p><blockquote><pre>grid-template: [r1a] <span class="str">"a   a   c"</span>  1fr [r1b] <span class="com">/*primera fila*/</span>               [r2a] <span class="str">"b   b   c"</span>  2fr [r2b] <span class="com">/*segunda fila*/</span>               [r3a] <span class="str">"f   f   f"</span> .5fr [r3b] <span class="com">/*tercera fila*/</span>             <span class="str">/</span> [c1] 20% [c2] 1fr [c3] 40%;  <span class="com">/*la estructura de columnas*/</span></pre></blockquote><p>esto es equivalente a:</p><blockquote><pre>  grid-template-rows:    [r1a]  1fr [r1b r2a]  2fr [r2b r3a] .5fr [r3b];  grid-template-columns: [c1] 20% [c2] 1fr [c3] 40%;  grid-template-areas:   "a   a   c"                         "b   b   c"                         "f   f   f";</pre></blockquote><p data-height="300" data-theme-id="11360" data-slug-hash="bded4f4d16456502548fd6fd0d6e0f36" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Grid  grid-template #2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/bded4f4d16456502548fd6fd0d6e0f36/">Grid  grid-template #2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><h3> La propiedad grid</h3><p>La propiedad grid es el m&eacute;todo abreviado ( <em class="gem">shorthand</em> ) para establecer las propiedades <code>grid-template-rows</code>, <code>grid-template-columns</code>, <code>grid-template-areas</code>, <code>grid-auto-rows</code>, <code>grid-auto-columns</code>, <code>grid-auto-flow</code>, <code>grid-column-gap</code> y <code>grid-row-gap</code> en una sola declaraci&oacute;n.<br>Si una de estas propiedades no aparece en la declaraci&oacute;n, esta tomar&aacute; el valor por defecto. Recordemos el valor predeterminado de estas propiedades.<br>Esto es normal; pasa siempre cuando utilizamos declaraciones abreviadas. Lo extra&ntilde;o es que la propiedad <code>grid</code> no nos da la oportunidad de declarar el espaciado de celda ( <code>grid-column-gap</code> y <code>grid-row-gap</code> ). Por lo cual siempre despu&eacute;s de <code>grid</code> ( la propiedad <code>grid</code>  ) el valor de <code>grid-gap</code> ser&aacute; <code>0</code>. Tampoco podemos declarar un valor para <code>grid-auto-rows</code> y <code>grid-auto-columns</code>. As&iacute; que despu&eacute;s de <code>grid</code> el valor de estas dos propiedades ser&aacute; <code>auto</code>.</p><blockquote><pre>grid-template-rows: nonegrid-template-columns: nonegrid-template-areas: nonegrid-auto-rows: autogrid-auto-columns: autogrid-auto-flow: rowgrid-column-gap: 0grid-row-gap: 0</pre></blockquote><h5>La sintaxis de grid</h5><p>Esto es lo que encontramos si leemos la <a href="https://www.w3.org/TR/css3-grid-layout/%23grid-shorthand">especificaci&oacute;n</a>:</p><blockquote><pre>&lt;'grid-template'&gt; | &lt;'grid-template-rows'&gt; / [ auto-flow &amp;&amp; dense? ] &lt;'grid-auto-columns'&gt;? |[ auto-flow &amp;&amp; dense? ] &lt;'grid-auto-rows'&gt;? / &lt;'grid-template-columns'&gt;</pre></blockquote><p>Lo que dice todo esto es que la propiedad <code>grid</code> puede tener la misma sintaxis que <code>grid-template</code>. O sea: podemos utilizar <code>grid</code> en lugar de <code>grid-template</code>, con la &uacute;nica diferencia que <code>grid</code> pondr&aacute; a 0 el valor de <code>grid-gap</code>.</p><blockquote><pre>&lt;'grid-template'&gt;</pre></blockquote> <p data-height="300" data-theme-id="11360" data-slug-hash="b5cfc373b974e4f8e909b2ea1fe8b563" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="Grid  grid #1" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/b5cfc373b974e4f8e909b2ea1fe8b563/">Grid  grid #1</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>Adem&aacute;s la propiedad <code>grid</code> puede tener estas otras dos sintaxis:</p><blockquote><pre>&lt;'grid-template-rows'&gt; / [ auto-flow &amp;&amp; dense? ] &lt;'grid-auto-columns'&gt;? |[ auto-flow &amp;&amp; dense? ] &lt;'grid-auto-rows'&gt;? / &lt;'grid-template-columns'&gt;</pre></blockquote><p>Para entender de que va, veamos algunos ejemplos:</p><blockquote><pre>grid: 1fr .5fr / <span class="str">auto-flow</span> 50%;</pre></blockquote><p>es equivalente de:</p><blockquote><pre>  grid-template-rows:1fr .5fr;  grid-auto-flow:column;  grid-auto-columns:50%;  grid-gap:0;</pre></blockquote>  <p data-height="300" data-theme-id="11360" data-slug-hash="3e6afbb0371f0da944638882101372f5" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="GRID auto-flow* #1" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/3e6afbb0371f0da944638882101372f5/">GRID auto-flow* #1</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>    <p>Y esto:</p><blockquote><pre>grid: 1fr .5fr / auto-flow <span class="str">dense</span> 33%;</pre></blockquote><p>es equivalente de:</p><blockquote><pre>  grid-template-rows:1fr .5fr;  grid-auto-flow:column <span class="str">dense</span>;  grid-auto-columns:50%;  grid-gap:0;</pre></blockquote><p>Otro ejemplo:</p><blockquote><pre>grid: <span class="str">auto-flow</span> 50% /1fr .5fr;</pre></blockquote><p>es equivalente de:</p><blockquote><pre>  grid-template-columns:1fr .5fr;  grid-auto-flow:row;  grid-auto-rows:50%;  grid-gap:0;</pre></blockquote>  <p data-height="300" data-theme-id="11360" data-slug-hash="395091b93bf94d76dfe2657f073e64b5" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="GRID auto-flow* #2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/395091b93bf94d76dfe2657f073e64b5/">GRID auto-flow* #2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>  <p>Y esto:</p><blockquote><pre>grid: auto-flow <span class="str">dense</span> 50% /1fr .5fr;</pre></blockquote><p>es equivalente de:</p><blockquote><pre>  grid-template-columns:1fr .5fr;  grid-auto-flow:row <span class="str">dense</span>;  grid-auto-rows:50%;  grid-gap:0;</pre></blockquote>  <h5>La palabra clave auto-flow</h5><p>En todos estos casos, la palabra clave <code>auto-flow</code> establece un flujo autom&aacute;tico para la caja grid. Si <code>auto-flow</code> aparece junto con los dem&aacute;s par&aacute;metros que establecen la estructura de columnas, esto equivale a <code>grid-auto-flow: column</code>. Lo mismo pasa para filas. En este caso la palabra clave <code>auto-flow</code> equivale a <code>grid-auto-flow: row</code>. Al lado de <code>auto-flow</code> puede aparecer, o no, la palabra clave <code>dense</code>.</p><p><em class="gem">Lea m&aacute;s acerca de <a class="link_to" target="_blank" href="grid-contenedor.php#gAutoFlow">grid-auto-flow</a></em>.</p></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="grid-contenedor.php">Propiedades del contenedor </a></em></li><li>- <em class="gem">grid-template y grid</em></li><li>- <em class="gem"><a class="link_to" href="grid-items.php">Propiedades de los &iacute;tems</a></em></li><li>- <em class="gem"><a class="link_to" href="grid-palabras-clave.php">Algunas palabras clave</a></em></li></ul></article></div></div>
