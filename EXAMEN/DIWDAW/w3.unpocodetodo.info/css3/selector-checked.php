...
<head>
  ...
  <meta name="description" content="C&oacute;mo dar formato al &lt;input&gt; marcado ( checked ) utilizando el selector :checked. El apa&ntilde;o de la etiqueta &lt;label&gt;" />
  <meta name="keywords" content="tutorial, html5, css, css3, selector, pseudo-selector, pseudo-clase, pseudo-class, input, radio, checkbox, casilla de verificaci&oacute;n, activar, desactivar, marcar, desmarcar, checked, galer&iacute;a de im&aacute;genes "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El selector :checked" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selector-checked.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo dar formato al &lt;input&gt; marcado ( checked ) utilizando el selector :checked. El apa&ntilde;o de la etiqueta &lt;label&gt;" /> 
  
  <title>El selector :checked</title>
  ...
  <link rel="canonical" href="selector-checked.php"> 
 
  <style>
form.demo{ width:100px; margin:0 auto;}
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selector-checked.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selector-checked.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="selector-checked">
<h2 class="page_title">El selector :checked</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El selector :checked&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-checked.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-checked.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-checked.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>El selector :checked</h4>
<p>En el html el atributo <code>checked</code> puede ser utilizado con <code>&lt;input type = "checkbox"&gt;</code> para indicar que la casilla está marcada, o con <code>&lt;input type = "radio"&gt;</code> para indicar que el boton está activado.</p>
<blockquote><p>
&lt;input type = "checkbox" <span class="str">checked</span> &gt;<br />
&lt;input type = "radio" <span class="str">checked</span> &gt;
</p></blockquote>
<p>En el CSS3 podemos dar formato al <code>&lt;input&gt;</code> marcado ( <code>checked</code> ) utilizando el selector <code>:checked</code>.</p>
<h4>El apaño de la etiqueta &lt;label&gt;</h4>
<p>Para vincular una etiqueta <code>&lt;label&gt;</code> con un elemento de entrada <code>&lt;input&gt;</code>,  el valor del atributo <code>for</code> de <code>&lt;label&gt;</code> tiene que ser igual al valor del atributo <code>id</code> del <code>&lt;input&gt;</code>. Esto proporciona una mejora de usabilidad especialmente en el caso de las casillas de verificación <code>&lt;input type = "checkbox"&gt;</code>  y los botones de radio <code>&lt;input type = "radio"&gt;</code>, ya que al hacer clic en el <code>&lt;label&gt;</code>, podemos activar o desactivar ( marcar o desmarcar ) el <code>&lt;input&gt;</code>. </p>
...
<form class="demo">
  ...
  <label for="m">Se&ntilde;or</label>
  <br>
  <input type="radio" name="sexo" id="h" value="h">  
  <label for="h">Se&ntilde;ora</label>
</form>
</code></pre>
        </article>
</div>       
...
<p>Podemos dar formato a la etiqueta <code>&lt;label&gt;</code> dependiendo de si el botón de radio esta activado o no.</p>
<blockquote>
  <p>input[type=radio]:checked + label { color: red;}</p></blockquote>
<p>El selector <code>+</code> selecciona la etiqueta <code>&lt;label&gt;</code> situada inmediatamente después de un  botón de radio activado <code>&lt;input&nbsp;type="radio" checked&gt;</code>. </p>
...
<form class="demo activado">
  ...
  <label for="m1">Se&ntilde;or</label>
  <br>
  <input type="radio" name="sexo1" id="h1" value="h">  
  <label for="h1">Se&ntilde;ora</label>
</form>
</code></pre>
        </article>
</div> 
...
<p>Incluso podemos esconder los botones de radio ( <code>position: absolute; left: -1000em;</code> ) dejando visible solo la etiqueta <code>&lt;label&gt;</code>. Al hacer clic en la etiqueta, esta cambia de color. El resultado parece adquirido vía JavaScript.</p>
...
<form class="demo escondido">
  ...
  <label for="m2">Se&ntilde;or</label>
  <br>
  <input type="radio" name="sexo2" id="h2" value="h">  
  <label for="h2">Se&ntilde;ora</label>
</form>
</code></pre>
        </article>
</div> 
...
<p><a class="link_to" target="_blank" href="ejemplos/checked-tabs1.html">Fichas con pesta&ntilde;as</a> ( tabs ) realizados con HTML5 y el selector <code>:checked</code> de CSS3.<br />
  <a class="link_to" target="_blank" href="ejemplos/paneles-checked.html">Paneles desplegables</a> realizados con HTML5 y CSS3. Utiliza el selector <code>:checked</code> y <code>@keyframes</code>.<br />
Vea una <a class="link_to" target="_blank" href="ejemplos/galeria-checked.html">galer&iacute;a de im&aacute;genes</a> realizada solo con HTML5 y CSS3. Utiliza el selector <code>:checked</code>.</p>
