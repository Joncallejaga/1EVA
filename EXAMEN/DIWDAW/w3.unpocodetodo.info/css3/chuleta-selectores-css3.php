...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. La chuleta con los selectores css" />
  <meta name="keywords" content="tutorial, html5, css, css3,referencia css, chuleta css, selectores css"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Selectores CSS" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/chuleta-selectores-css3.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. La chuleta con los selectores css" /> 
  ...
  <link rel="canonical" href="chuleta-selectores-css3.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="chuleta-selectores-css3.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="chuleta-selectores-css3.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="chuleta-selectores-css3"><h2 class="page_title">Selectores CSS</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Selectores CSS&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fchuleta-selectores-css3.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fchuleta-selectores-css3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fchuleta-selectores-css3.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En el CSS hay dos tipos de "pseudo-cosas": <mark>pseudo-clases</mark> y <mark>pseudo-elementos</mark>.</p><p>Las pseudo-clases (<code>:link</code>, <code>:visited</code>, <code>:active</code>, <code>:hover</code>, <code>:focus</code>, <code>:first-child</code>, <code>:lang</code>... )   act&uacute;an como si a&ntilde;adieran una clase al elemento.<br>Los pseudo-elementos (<code>::first-letter</code>, <code>::first-line</code>, <code>::before</code>, <code>::after</code>) act&uacute;an como si nuevos elementos fueran insertados en el documento.</p><p>Los dos puntos dobles ( <code>::</code> ) fueron introducidos en el CSS3 como un intento de hacer una distinción entre las :pseudo-clases y los ::pseudo-elementos. Por suerte no pasa nada si no ponemos los dos puntos dobles delante de los pseudo-elementos ( <code>::before </code>), ya que la mayoría de los navegadores entienden el formato antiguo introducido en el CSS2 ( <code>:before</code> ). Es m&aacute;s: IE8 parece no entender los dos puntos dobles ( <code>::before</code> ), pero sí entiende los dos puntos ( <code>:before</code> ).</p><p><em class="gem">Una tabla inspirada por <a target="_blank" class="link_to" href="http://www.w3schools.com/cssref/css_selectors.asp">w3schools - CSS Selector Reference</a></em></p><table class="cheatsheet selectors">  <thead>    <tr>      <th>Selector</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>      <th>CSS</th>    </tr>    </thead>    <tbody>    <tr>      <td>.class</td>      <td>.laClase</td>      <td>Selecciona todos los elementos con <code>class="laClase"</code></td>      <td>1</td>    </tr>    <tr>      <td>#id</td>      <td>#elId</td>      <td>Selecciona todos los elementos con  <code>id="elId"</code></td>      <td>1</td>    </tr>    <tr>      <td>*</td>      <td>*</td>      <td>Selector comodin. Selecciona todos los elementos.</td>      <td>2</td>    </tr>    <tr>      <td>element</td>      <td>p</td>      <td>Selecciona todos los elementos <code>&lt;p&gt;</code></td>      <td>1</td>    </tr>    <tr>      <td>element,element</td>      <td>div,p</td>      <td>Selecciona todos los elementos <code>&lt;div&gt;</code> y <code>&lt;p&gt;</code> </td>      <td>1</td>    </tr>    <tr>      <td>element element</td>      <td>div p</td>      <td>Selecciona todos los elementos <code>&lt;p&gt;</code> dentro de los elementos <code>&lt;div&gt;</code></td>      <td>1</td>    </tr>    <tr>      <td>element&gt; element</td>      <td>div&gt; p</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> cuyo padre es un <code>&lt;div&gt;</code></td>      <td>2</td>    </tr>    <tr>      <td>element+element</td>      <td>div+p</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> situados inmediatamente despu&eacute;s de un <code>&lt;div&gt;</code></td>      <td>2</td>    </tr>    <tr>      <td>[attribute]</td>      <td>[target]</td>      <td>Selecciona todos los elementos con un atributo <code>target.</code></td>      <td>2</td>    </tr>    <tr>      <td>[attribute=value]</td>      <td>[target=_blank]</td>      <td>Selecciona todos los elementos con un atributo <code>target="_blank"</code></td>      <td>2</td>    </tr>    <tr>      <td>[attribute~=value]</td>      <td>[title~=primero]</td>      <td>Selecciona todos los elementos con un atributo <code>title</code> que contiene <code>"primero"</code> de una lista de palabras separadas por espacios:<br>      ( selecciona: <code>title = "primero parafo"</code>, <code>title = "primero titulo"</code>, etc...  )</td>      <td>2</td>    </tr>    <tr>      <td>[attribute|=value]</td>      <td>[lang|=en]</td>      <td>Selecciona todos los elementos con un atributo <code>lang</code> que empieza con <code>"en"</code> de una lista de elementos separados por guiones:<br>      ( selecciona: <code>lang = "en"</code>, <code>lang = "en-US"</code> y <code>lang = "en-cockney"</code>  )      </td>      <td>2</td>    </tr>    <tr>      <td>:link</td>      <td>a:link</td>      <td>Selecciona todos los enlaces no visitados</td>      <td>1</td>    </tr>    <tr>      <td>:visited</td>      <td>a:visited</td>      <td>Selecciona todos los enlaces visitados</td>      <td>1</td>    </tr>    <tr>      <td>:active</td>      <td>a:active</td>      <td>Selecciona todos los enlaces activos</td>      <td>1</td>    </tr>    <tr>      <td>:hover</td>      <td>a:hover</td>      <td>Selecciona todos los enlaces al pasar por encima.</td>      <td>1</td>    </tr>    <tr>      <td>:focus</td>      <td>input:focus</td>      <td>Selecciona el elemento <code>&lt;input&gt;</code> enfocado.</td>      <td>2</td>    </tr>    <tr>      <td>:first-letter</td>      <td>p:first-letter</td>      <td>Selecciona la primera letra de cada <code>&lt;p&gt;</code>.</td>      <td>1</td>    </tr>    <tr>      <td>:first-line</td>      <td>p:first-line</td>      <td>Selecciona la primera l&iacute; de cada <code>&lt;p&gt;</code>.</td>      <td>1</td>    </tr>    <tr>      <td>:first-child</td>      <td>p:first-child</td>      <td>Selecciona cada <code>&lt;p&gt;</code> que sea el primer hijo de su padre.</td>      <td>2</td>    </tr>    <tr>      <td>:before</td>      <td>p:before</td>      <td>Inserta contenido delante de cada elemento<code>&lt;p&gt;</code></td>      <td>2</td>    </tr>    <tr>      <td>:after</td>      <td>p:after</td>      <td>Inserta contenido despu&eacute;s de cada elemento<code>&lt;p&gt;</code></td>      <td>2</td>    </tr>    <tr>      <td>:lang(language)</td>      <td>p:lang(es)</td>      <td>Selecciona cada <code>&lt;p&gt;</code> con un atributo <code>lang="es"</code> ( espa&ntilde;ol )</td>      <td>2</td>    </tr>    <tr>      <td>element1~element2</td>      <td>p~ul</td>      <td>Selecciona cada <code>&lt;ul&gt;</code> precedido por un <code>&lt;p&gt;</code> </td>      <td>3</td>    </tr>    <tr>      <td>[attribute^=value]</td>      <td>a[src^="https"]</td>      <td>Selecciona todos los  <code>&lt;a&gt;</code> con un atributo <code>src</code> que empieza con<code>"https"</code>.</td>      <td>3</td>    </tr>    <tr>      <td>[attribute$=value]</td>      <td>a[src$=".pdf"]</td>      <td>Selecciona todos los <code>&lt;a&gt;</code>con un atributo <code>src</code> que acaba con<code> </code>".pdf"</td>      <td>3</td>    </tr>    <tr>      <td>[attribute*=value]</td>      <td>a[src*="css3"]</td>      <td>Selecciona todos los <code>&lt;a&gt;</code> con un atributo <code>src</code> que contiene "css3"</td>      <td>3</td>    </tr>    <tr>      <td>:first-of-type</td>      <td>p:first-of-type</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el primer &lt;p&gt; hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:last-of-type</td>      <td>p:last-of-type</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el &uacute;ltimo &lt;p&gt; hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:only-of-type</td>      <td>p:only-of-type</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el &uacute;nico &lt;p&gt; hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:only-child</td>      <td>p:only-child</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el &uacute;nico hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:nth-child(n)</td>      <td>p:nth-child(2)</td>      <td>Selecciona cada <code>&lt;p&gt;</code> que sea el segundo hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:nth-last-child(n)</td>      <td>p:nth-last-child(2)</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el pen&uacute;ltimo hijo de su padre. ( El segundo a partir del &uacute;ltimo )</td>      <td>3</td>    </tr>    <tr>      <td>:nth-of-type(n)</td>      <td>p:nth-of-type(2)</td>      <td>Selecciona cada <code>&lt;p&gt;</code> que sea el segundo &lt;p&gt; hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:nth-last-of-type(n)</td>      <td>p:nth-last-of-type(2)</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el pen&uacute;ltimo &lt;p&gt; hijo de su padre. ( El segundo a partir del &uacute;ltimo )      </td>      <td>3</td>    </tr>    <tr>      <td>:last-child</td>      <td>p:last-child</td>      <td>Selecciona todos los <code>&lt;p&gt;</code> que sean el &uacute;ltimo hijo de su padre.</td>      <td>3</td>    </tr>    <tr>      <td>:root</td>      <td>:root</td>      <td>Selecciona el elemento ra&iacute;z de los documentos.<br>      En HTML el elemento ra&iacute;z es siempre el <code>&lt;html.&gt;</code></td>      <td>3</td>    </tr>    <tr>      <td>:empty</td>      <td>p:empty</td>      <td>Selecciona cada <code>&lt;p&gt;</code> qu <strong>NO</strong> tenga elementos hijos ( Esto implica que tampoco puede tener texto. )</td>      <td>3</td>    </tr>    <tr>      <td>:target</td>      <td>#news:target</td>      <td>El selector de destino :target se puede usar para aplicar estilos al elemento de destino activo.</td>      <td>3</td>    </tr>   <!-- <tr>      <td>:enabled</td>      <td>input:enabled</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> que permiten la escritura.</td>      <td>3</td>    </tr>    <tr>      <td>:disabled</td>      <td>input:disabled</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> deshabilitados ( que no permiten la escritura )</td>      <td>3</td>    </tr>    <tr>      <td>:checked</td>      <td>input:checked</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> marcados ( checked )</td>      <td>3</td>    </tr>-->    <tr>      <td>:not(selector)</td>      <td>:not(p)</td>      <td>Selecciona todos los elementos que NO sean un p&aacute;rafo ( <code>&lt;p&gt;</code> ).</td>      <td>3</td>    </tr>    <tr>      <td>::selection</td>      <td>::selection</td>      <td><p>Selecciona la parte de un elemento seleccionada por el usuario.</p></td>      <td> </td>    </tr>  </tbody></table><h4>Pseudo-clases para UI ( interfaz de usuario )</h4><p>Afecta a los elementos de interfaz de usuario, como por ejemplo los elementos de formulario.</p><table class="cheatsheet selectors">  <thead>      <tr>      <th>Selector</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>      </tr>    </thead>    <tbody>    <tr>      <td>:enabled</td>      <td>input:enabled</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> que están habilitados ( permiten la escritura ).</td>      </tr>    <tr>      <td>:disabled</td>      <td>input:disabled</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> deshabilitados ( que no permiten la escritura )</td>      </tr>    <tr>      <td>:checked</td>      <td>input:checked</td>      <td>Selecciona todos los elementos <code>&lt;input&gt;</code> ( botones de radio o casillas de verificación ) marcados ( <code>checked</code> )</td>      </tr>    <tr>      <td>:indeterminate</td>      <td>input:indeterminate</td>      <td>Se refiere a las casillas de verificación o botones de radio que no están ni activadas ( <code>checked</code> ) ni desactivadas ( <code>unchecked</code> )<br>  <strong>&iexcl;OJO!</strong><br>        En HTML no existe un atributo "<em class="gem">indeterminate</em>". Es posible hacer que una casilla de verificación sea indeterminate, solo a través de javascript:<br>  <code>checkbox.indeterminate = true;</code></td>      </tr>    <tr>      <td>:default</td>      <td>input:default ~ label{<br>      border:1px solid red;<br>      }</td>      <td>Se refiere a las casillas de verificación o botones de radio que están habilitados por defecto. ( No cambia al marcar otra casilla ).</td>      </tr>    <tr>      <td>:valid</td>      <td>input[required]:valid{<br>  box-shadow: green;<br>}</td>      <td>Se refiere a los elementos de formulario que cumplen los requisitos necesarios.</td>      </tr>     <tr>      <td>:invalid</td>      <td>input[required]:invalid{<br>  box-shadow: red;<br>}</td>      <td>Se refiere a los elementos de formulario que <strong>NO</strong> cumplen los requisitos necesarios.</td>      </tr>      <tr>      <td>:in-range</td>      <td>input:in-range</td>      <td>Selecciona los elementos cuyo valor esta dentro de los limites establecidos ( por los atributos <code>min</code> y <code>max</code> )<br>        <code>&lt;input type="number" min="1" max="10" value="5"&gt;</code></td>      </tr>      <tr>      <td>:out-of-range</td>      <td>input:out-of-range</td>      <td>Selecciona los elementos cuyo valor esta fuera de los limites establecidos ( por los atributos <code>min</code> y <code>max</code> )<br>        <code>&lt;input type="number" min="1" max="10" value="15"&gt;</code></td>      </tr>         <tr>      <td>:required</td>      <td>input:required</td>      <td>Selecciona los elementos de formulario obligatorios ( que tienen un atributo <code>required</code> )</td>      </tr>     <tr>      <td>:optional</td>      <td>input:optional</td>      <td>Selecciona los elementos de formulario opcionales ( que no tienen un atributo required )</td>      </tr>     <tr>      <td>:read-write</td>      <td>input:read-write</td>      <td>Selecciona los elementos de formulario que pueden ser editados por el usuario (elementos <code>contenteditable = "true"</code> o elementos input que no tienen un atributo <code>readonly</code> ).</td>      </tr>    <tr>      <td>:read-only</td>      <td>input:read-only</td>      <td>Selecciona los elementos de formulario que <strong>NO</strong> pueden ser editados por el usuario (elementos input que tienen un atributo <code>readonly</code> ).</td>      </tr>          </tbody></table></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="chuletacss3.php">Referencia CSS3</a></em></li><li>- <em class="gem">Selectores CSS</em></li><li>- <em class="gem"><a class="link_to" href="unidades-css.php">Unidades CSS</a></em></li><li>- <em class="gem"><a class="link_to" href="cascada.php">Cascada y especificidad</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- La especificaci&oacute;n w3.org: <a class="link_to" href="http://www.w3.org/TR/css3-selectors/">Selectors Level 3</a></em></p>
</article></div></div>
