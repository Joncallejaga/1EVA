...
<head>
  ...
  <meta name="description" content="La propiedad resize (redimensionar) en CSS" />
  <meta name="keywords" content="CSS, resize, redimensionar, textarea, horizontal, vertical, both, overflow"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La propiedad resize" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/la-propiedad-resize.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad resize (redimensionar) en CSS" /> 
  
  <title>La propiedad resize</title>
  ...
  <link rel="canonical" href="la-propiedad-resize.php"> 
 
  <style>iframe{ margin-bottom:2em; }
.textarea-test{ width: 10em; height:5em; }
.desactivado{resize: none;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="la-propiedad-resize.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="la-propiedad-resize.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="la-propiedad-resize">
<h2 class="page_title">La propiedad resize</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La propiedad resize&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fla-propiedad-resize.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fla-propiedad-resize.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fla-propiedad-resize.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En CSS existe una propiedad llamada <code>resize</code> ( redimensionar ), y los elementos <code>&lt;textarea&gt;</code>, por definici&oacute;n tienen <code>resize: both;</code>. O sea: podemos redimensionar tanto la altura como la anchura del elemento agarrando y estirando la esquina abajo derecha de este.</p> 
<p><textarea class="textarea-test">Ag&aacute;rralo y est&iacute;ralo por la esquina abajo derecha.</textarea></p>
<p>Podemos desactivar este comportamiento utilizando  <code>resize: none</code>.</p>
 <blockquote><pre> textarea {
    resize: none; 
  }</pre></blockquote>
<p><textarea class="textarea-test desactivado">resize: none;</textarea></p>
<p>Por de otra parte los dem&aacute;s elementos tienen por defecto <code>resize: none</code>, o sea: no son redimensionables; pero podemos transformar <mark>casi</mark> cualquier otro elemento en un elemento redimensionable con dos condiciones:<br>
1. El overflow del elemento <strong>NO</strong> tiene que ser <code>visible</code>.<br>
2. La propiedad <code>resize</code> tiene que tomar uno de estos valores: <code>horizontal</code>, <code>vertical</code> o <code>both</code> ( redimensionable en ambas direcciones ).</p>
<blockquote><pre>.redimensionable {
    width:10em;
    height:6em;
    margin:1em;
    border:1px solid #d9d9d9;
    <span class="com">/* overflow puede tomar cualquier valor excepto visible*/</span>
    <span class="str">overflow:hidden;</span>
    <span class="com">/*resize puede ser: horizontal, vertical o both */</span>
    <span class="str">resize:both;</span>
  }</pre></blockquote>
  
<h4>Un falso textarea</h4>
<p>Ahora podemos f&aacute;cilmente transformar el <code>div.redimensionable</code> en un <mark>falso textarea</mark> utilizando el atributo <code>contenteditable="true"</code>. Esto hace que el contenido de este div sea editable.</p>
<blockquote><pre>&lt;div class="redimensionable" <span class="str">contenteditable="true"</span> &gt;&lt;/div&gt;</pre></blockquote>

<h4>Hay excepciones</h4>
<p>Un elemento <code>&lt;img&gt</code> no puede ser transformado en un elemento redimensionable, pero podemos ponerlo dentro de otro elemento redimensionable, un <code>&lt;div&gt;</code> por ejemplo.</p>



<p data-height="380" data-theme-id="11360" data-slug-hash="a64c4182692b6e8f35dcf6d5ee362f27" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" data-pen-title="CSS resize & contenteditable" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/a64c4182692b6e8f35dcf6d5ee362f27/">CSS resize & contenteditable</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p>
<script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script>

<h4>En JavaScript</h4>
<p>Por lastima en este momento en JavaScript no existe ning&uacute;n evento que detecte si el tama&ntilde;o de un elemento ha cambiado.</p>
