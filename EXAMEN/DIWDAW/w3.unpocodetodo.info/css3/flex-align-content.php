...
<head>
  ...
  <meta name="description" content="La propiedad align-content es una propiedad del contenedor flex y controla el alineamiento de los elementos flex cuando los elementos ocupan varias l&iacute;neas." />
  <meta name="keywords" content="flexbox, flex-box, contenedor flex, align-content, flex-start, flex-end, center, space-between, space-around, stretch, IE10,�ms-flex-line-pack, start, end, justify"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="align-content" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-align-content.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad align-content es una propiedad del contenedor flex y controla el alineamiento de los elementos flex cuando los elementos ocupan varias l&iacute;neas." /> 
  ...
  <link rel="canonical" href="flex-align-content.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-align-content.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-align-content.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad align-content</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=align-content&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-content.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-content.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-content.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos controlar el alineamiento de los elementos de una caja flexible ( <em class="gem">flexbox</em> ) a lo largo de su <a class="link_to" target="_blank" href="flex-direction.php">eje principal</a> con <a class="link_to" target="_blank" href="flex-justify-content.php">justify-content</a> o a lo largo de su <a class="link_to" target="_blank" href="flex-direction.php">eje transversal</a> con <a class="link_to" target="_blank" href="flex-align-items.php">align-items</a>. <br />
  Pero, a veces, los elementos de la caja flex pueden ocupar varias l&iacute;neas ( vea <a class="link_to" target="_blank" href="flex-wrap.php">flex-wrap</a> ). En este caso podemos controlar el alineamiento de los elementos flex utilizando la propiedad <code>align-content</code>.</p>
<p>La propiedad <code>align-content</code> es <span class="str">una propiedad del contenedor flex</span> y puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor { align-content: flex-start | flex-end | center | space-between | space-around | stretch; }</em>
</p>
</article>
</div>

<p><code>flex-start</code>: los elementos aparecen agrupados al principio ( <em class="gem">start</em> ) del eje transversal.</p>
<p><code>flex-end</code>: los elementos aparecen agrupados al final ( <em class="gem">end</em> ) del eje transversal.</p>
<p><code>center</code>: los elementos aparecen agrupados al centro ( <em class="gem">center</em> ).</p>
<p><code>stretch</code> ( el valor por defecto ): los elementos aparecen estirados ( <em class="gem">stretched</em> ) para ocupar el espacio restante.</p>
<p><code>space-between</code>: los elementos aparecen distribuidos uniformemente: al principio, en el centro y al final del contenedor flex.</p>
<p><code>space-around</code>: los elementos aparecen distribuidos uniformemente, y con un espacio igual entre ellos.</p>

<div class="large-12 text-center"><img class="flex-img" src="images/flex-align-content.gif" width="459" height="246" alt="flex align-content" /></div>
<h4>Para los usuarios de IE10 </h4>
<p>Para que los usuarios de IE10 tengan una experiencia similar utilizamos la propiedad <code>–ms-flex-line-pack </code>cuyos posibles valores son:</p>
<p>
<code>start</code> ( en lugar de <code>flex-start</code> )<br />
<code>end</code> ( en lugar de <code>flex-end</code> )<br />
<code>center</code><br />
<code>stretch</code><br />
<code>justify</code> ( en lugar de <code>space-between</code> y  <code>space-around</code> )</p>

<h4>align-content: flex-start</h4>
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al principio ( <em class="gem">start</em> ) del eje transversal de la caja flex utilizamos <code>align-content: flex-start;</code></p>
<blockquote>
<pre>
.flex-container.flex-start{
	-webkit-align-content: flex-start;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container flex-start">
...
<h4>align-content: flex-start</h4>
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al final ( <em class="gem">end</em> ) del eje transversal de la caja flex utilizamos <code>align-content: flex-end;</code></p>
<blockquote>
<pre>
.flex-container.flex-end{
	-webkit-align-content: flex-end;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container flex-end">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados en el centro ( <em class="gem">center</em> ) de la caja flex utilizamos <code>align-content: center;</code></p>
<blockquote>
<pre>
.flex-container.center{
	-webkit-align-content: center;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container center">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) de la caja flex aparezcan  estirados ( <em class="gem">stretched</em> )  ocupando el espacio restante, utilizamos <code>align-content: stretch;</code></p>
<blockquote>
<pre>
.flex-container.stretch{
	-webkit-align-content: stretch;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container stretch">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<p>Si utilizamos <code>align-content: space-between;</code> los elementos ( <em class="gem">items</em> ) aparecen distribuidos uniformemente: al principio, en el centro y al final del contenedor flex.</p>
<blockquote>
<pre>
.flex-container.space-between{
	-webkit-align-content: space-between;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container space-between">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<p>Si utilizamos <code>align-content: space-around;</code> los elementos ( <em class="gem">items</em> ) aparecen distribuidos uniformemente, y con un espacio igual entre ellos.</p>
<blockquote>
<pre>
.flex-container.space-around{
	-webkit-align-content: space-around;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container space-around">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#align-content-property">the align-content property</a><br />
