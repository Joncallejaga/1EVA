...
<head>
  ...
  <meta name="description" content="La propiedad flex es una propiedad de los &iacute;tems flex que controla sus dimensiones. Abrevia las propiedades: flex-grow, flex-shrink ( opcional ) y flex-basis ( opcional ) en una sola." />
  <meta name="keywords" content="flexbox, flex-box, &iacute;tems flex, flex, abreviado, flex-grow, flex-shrink, flex-basis"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="flex" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-abreviado.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad flex es una propiedad de los &iacute;tems flex que controla sus dimensiones. Abrevia las propiedades: flex-grow, flex-shrink ( opcional ) y flex-basis ( opcional ) en una sola." /> 
  ...
  <link rel="canonical" href="flex-abreviado.php"> 
...
img.flex-img{ margin-bottom:2em;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-abreviado.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-abreviado.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="flex-abreviado">
<h2 class="page_title">La propiedad flex</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=flex&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-abreviado.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-abreviado.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-abreviado.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>flex</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex.</p>
<p>Para que podamos escribir menos c&oacute;digo, el CSS nos permite abreviar las tres propiedades: <a href="flex-abreviado.php#flexGrow">flex-grow</a>, <a href="flex-abreviado.php#flexShrink">flex-shrink</a> ( opcional ) y <a href="flex-abreviado.php#flexBasis">flex-basis</a> ( opcional )  en una sola: <code>flex</code>. El valor por defecto es <code>flex: 0 1 auto</code>.</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.item { flex: flex-grow [flex-shrink]  [flex-basis]; }</em>
</p>
</article>
</div>
...
<p>Veamos las tres propiedades:</p>

<h4 id="flexGrow">La propiedad flex-grow</h4> 
<p>La propiedad <code>flex-grow</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex.</p>
<p>La propiedad <code>flex-grow</code> establece cuanto puede crecer un elemento flex en relaci&oacute;n al resto de elementos de la misma caja flex. Su valor es un n&uacute;mero. <br />
El valor por defecto de <code>flex-grow: 0</code>, lo que quiere decir que el elemento no puede crecer. Si todos los &iacute;tems de una caja tienen el mismo valor de <code>flex-grow</code>, por ejemplo <code>flex-grow:1</code>; quiere decir que todos los &iacute;tems tienen que crecer  en igual proporci&oacute;n, hasta ocupar todo el espacio disponible.</p>
<blockquote><pre>
.flex-item{
    -webkit-flex-grow: 0;
    -ms-flex-grow:0;
...
<p><strong>Veamos un ejemplo:</strong> los contenedores <code>.flex-container</code> tienen una anchura <code>height: 250px</code>. Anidados dentro de cada contenedor hay 4 &iacute;tems ( elementos flex ) cuya anchura declarada es de 10%. Esto genera un espacio restante de 60%.</p>
<p>Queremos que el segundo contenedor <code>.flex-container</code> quede completamente ocupado. Decidimos que el segundo &iacute;tem crecer&aacute; ocupando una parte del espacio restante ( <code>flex-grow:1</code> ), y el cuarto elemento dos partes ( <code>flex-grow:2</code> ). Los dem&aacute;s elementos siguen igual.</p>
...
<h4 id="flexShrink">La propiedad flex-shrink</h4> 
<p>La propiedad <code>flex-shrink</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex.</p>
<p>La propiedad <code>flex-shrink</code> establece cuanto puede disminuir un elemento flex en relaci&oacute;n al resto de elementos de la misma caja flex. Su valor es un n&uacute;mero. <br />
  El valor por defecto de <code>flex-shrink: 1</code>, lo que quiere decir que los elementos de una caja flex disminuir&aacute;n en igual proporci&oacute;n, por tal de acomodarse dentro de la caja.</p>
...
<p><strong>Veamos un ejemplo</strong>: los dos contenedores <code>.flex-container</code> tienen una anchura <code>height: 250px</code>. Anidados dentro de cada contenedor hay 4 &iacute;tems ( elementos flex ) cuya anchura declarada es de 40%, y no puede haber <a class="link_to" target="_blank" href="flex-wrap.php">cambio de l&iacute;nea</a> ( por defecto  <code>flex-wrap: nowrap</code> ). Esto genera un exceso de 60%. Si no hacemos nada  todos los &iacute;tems disminuir&aacute;n por igual ( el primer contenedor ).</p>
<p>En el segundo contenedor <code>.flex-container</code> decidimos que el tercer &iacute;tem disminuir&aacute; dos veces m&aacute;s que los dem&aacute;s elementos ( <code>flex-shrink: 2;</code>)</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.flex-container{
...
<h4 id="flexBasis">La propiedad flex-basis</h4>
<p>La propiedad <code>flex-basis</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex.</p>
<p>La propiedad <code>flex-basis</code> especifica el valor inicial del tama&ntilde;o principal de un elemento flex, antes de que est&eacute; redimensionado con <code>flex-grow</code> o <code>flex-shrink</code>.</p>
<p><strong>Recuerde que</strong>: el tama&ntilde;o principal  de un elemento flex es la anchura en contenedores horizontales - donde  <code>flex-direction: row;</code> o la altura en contenedores verticales  - donde  <code>flex-direction: column</code>.</p>
<p>El valor por defecto de  es <code>flex-basis: auto</code>. En este caso la anchura base del &iacute;tem es igual a la anchura declarada ( <code>width</code> ) del elemento, o en su defecto, la anchura calculada por el navegador en base a su contenido.</p>
<blockquote><pre>
.item {
...
<p>En el siguiente ejemplo los &iacute;tems flex ( <code>.flex-item </code>) tienen una anchura <code>width:10%</code>. Para el cuarto elemento de la segunda caja ( <code>.flex-basis50</code> ) establecemos <code>flex-basis:50%</code>. Observamos como <code>flex-basis</code> sobrescribe la anchura declarada del elemento. </p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.flex-container{
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#flex-property">The flex Shorthand</a><br />
