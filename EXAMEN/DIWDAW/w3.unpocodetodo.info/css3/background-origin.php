...
<head>
  ...
  <meta name="description" content="La propiedad background-origin es utilizada para determinar como se calcula la posici&oacute;n de la imagen de fondo de una caja en CSS3" />
  <meta name="keywords" content="background-origin, border-box, padding-box, content-box, imagen de fondo, background-image, background-position"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="background-origin" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/background-origin.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad background-origin es utilizada para determinar como se calcula la posici&oacute;n de la imagen de fondo de una caja en CSS3" /> 
  ...
  <link rel="canonical" href="background-origin.php"> 
...
.bkorigin p{ color: #fff!important; text-shadow : 1px 1px 1px #000; text-align:center;}
.bkorigin {
	width:200px; 
	height:200px; 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="background-origin.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="background-origin.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">background-origin</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=background-origin&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-origin.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-origin.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-origin.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<!--<h4>La propiedad background-origin</h4>-->
<p>La propiedad <code>background-origin</code> es utilizada para determinar como se calcula la posici&oacute;n ( <code>background-position</code> ) de la imagen de fondo ( <code>background-image</code> ).
Por defecto la imagen de fondo empieza al margen exterior del relleno ( <code>padding</code> ).</p>
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkorigin"><p>el valor por defecto</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkorigin"><p>el valor por defecto</p></div>        </article>
</div> 
<h4>Sintaxis</h4>
<p>Exactamente como en el caso de la propiedad <a class="link_to" target="_blank" href="background-clip.php">background-clip</a>,  los valores que puede tomar la propiedad <code>background-origin</code> son:</p>


<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">background-origin: border-box | padding-box | content-box  | inherit;
</em>
</p>
</article>
</div>
...
<h4>border-box</h4>
<p>Si <code>background-origin: border-box;</code> la imagen de fondo empieza al margen exterior del borde y por debajo de este ( es muy evidente en el caso de los bordes anchos y discontinuos ).
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.bkorigin {
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkorigin" id="borderBox"><p>border-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado center">
        <article>
        <div class="bkorigin" id="borderBox"><p>border-box</p></div>        </article>
</div> 

<h4>padding-box</h4>
<p>Si <code>background-origin: padding-box;</code> la imagen de fondo empieza al margen exterior del relleno ( <em class="gem">padding</em> ). Si la propiedad <code>background-origin</code> no esta declarada, <code>padding-box</code> es el valor por defecto.</p>
<div class="large-12 g_panel css">
        <article>	
         <pre><code class="language-css">
.bkorigin {
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkorigin" id="paddingBox"><p>padding-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkorigin" id="paddingBox"><p>padding-box</p></div>        </article>
</div> 

<h4>content-box</h4>
<p>Si <code>background-origin: content-box;</code> la imagen empieza al margen exterior del contenido de la caja.</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">
.bkorigin {
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bkorigin" id="contentBox"><p>content-box</p></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bkorigin" id="contentBox"><p>content-box</p></div>        </article>
</div> 
