...
<head>
  ...
  <meta name="description" content="Un ejemplo de maquetaci&oacute;n web utilizando cajas flexibles (flexbox). Como verificar los resultados." />
  <meta name="keywords" content="flexbox, flex-box, ejemplo,  maquetaci&oacute;n, layout, cajas flexibles, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Maquetaci&oacute;n flex" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-maquetacion.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Un ejemplo de maquetaci&oacute;n web utilizando cajas flexibles (flexbox). Como verificar los resultados." /> 
  
  <title>Maquetaci&oacute;n flex</title>
  ...
  <link rel="canonical" href="flex-maquetacion.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-maquetacion.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-maquetacion.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="flex-maquetacion">
<h2 class="page_title">Maquetaci&oacute;n flex</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Maquetaci&oacute;n flex&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-maquetacion.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-maquetacion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-maquetacion.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><em class="gem">Vea un ejemplo <a class="link_to" target="_blank"  href="ejemplos/flexbox-layout-test.html">de maquetaci&oacute;n flex</a></em></p>
<h4>En el CSS</h4>

<p>En el siguiente ejemplo los nombres de las clases CSS sugieren la funcionalidad flex. <br />
Por ejemplo: la clase <code>.flex-container</code> transforma una caja cualquiera en un contenedor flex ( <code>display: flex;</code> ). Los contenedores flex verticales llevan la clase <code>.column</code> ya que <code>flex-direction: column</code>. Por de otra parte los contenedores flex horizontales ( <code>.row</code> ) tienen asignada tambi&eacute;n la clase <code>.justify-space-between</code> donde:</p>
<blockquote><pre>.justify-space-between{ justify-content:space-between; }</pre></blockquote>


<p>Hemos dividido el c&oacute;digo CSS en 3 partes</p>
<ul class="no-bullet">
<li><strong>&nbsp;general</strong>: incluye colores, tipo y tama&ntilde;o de fuente,  tipo de caja, m&aacute;rgenes, rellenos etc. . . </li>
<li><strong>.flexbox</strong>: para los navegadores que soportan flexbox. <br />
Incluye los estilos que transforman las cajas de nuestra p&aacute;gina, en contenedores o &iacute;tems flex. Todos estos estilos empiezan con <code>.flexbox</code>, la clase que <a class="link_to" target="_blank"  href="http://modernizr.com/">modernizr</a> da al <code>&lt;html&gt;</code> en navegadores que soportan flexbox.</li>
<li><strong>.no-flexbox</strong>: para navegadores antiguos que <strong>NO</strong> soportan flexbox.<br />
Incluye los estilos que transforman las cajas de nuestra p&aacute;gina, en cajas flotantes. Todos estos estilos empiezan con <code>.no-flexbox</code>, la clase que <a class="link_to" target="_blank"  href="http://modernizr.com/">modernizr</a> da al <code>&lt;html&gt;</code> en navegadores que <code>NO</code> soportan flexbox.</li>
</ul>
 <p><em class="gem"><a class="link_to" target="_blank" href="ejemplos/css/flexbox-styles.css">vea el CSS de este ejemplo</a></em></p> 

<h4>Planificar la maqueta web</h4>
<div class="large-12 text-center">
<p><a target="_blank"  href="ejemplos/flexbox-layout-test.html">
<img src="images/flex-layout.jpg" alt="Ejemplo de maquetaci&oacute;n flex" /></a></p>
</div>
<p>En el <code>&lt;body&gt;</code> de la p&aacute;gina creamos un <code>#contenedor</code> para la maqueta. Le damos una clase de <code>.flex-container</code> y otra de .<code>column</code> ya que queremos transformarlo en un contenedor flex vertical.<br />
Dentro del contenedor flex colocamos tres elementos, tres &iacute;tems flex: un <code>#encabezado &lt;header&gt;</code>, una <code>&lt;section&gt;</code>, y un <code>#pie &lt;footer&gt;</code>.</p>
<blockquote>
  <pre>
&lt;div id="contenedor" <span class="str">class="flex-container column"</span>&gt;
...
<p>A continuaci&oacute;n transformamos la <code>&lt;section&gt;</code> en un contenedor flex horizontal. Para esto le damos una clase de <code>.flex-container</code> y otra de <code>.row</code>. Queremos que los elementos dentro de la <code>&lt;section&gt;</code> aparecan distribuidos uniformemente: al principio, en el centro y al final del contenedor flex. Para esto le damos tambi&eacute;n la clase de <code>.justify-space-between</code>.<br />
Dentro de <code>&lt;section&gt;</code> colocamos otros tres elementos, que se transforman autom&aacute;ticamente en &iacute;tems flex: una barra <code>#lateral &lt;aside&gt;</code>, una <code>&lt;section&gt; #central</code>  y otra caja <code>&lt;nav&gt;</code> donde colocaremos la navegaci&oacute;n o el men&uacute;.</p>
<blockquote>
<pre>
&lt;div id="contenedor" <span class="str">class="flex-container column"</span>&gt;  
&lt;header id="encabezado"&gt;&lt;/header&gt;  
&lt;section <span class="str">class="flex-container justify-space-between row"</span>&gt;      
...
<h6>Podemos anidar contenedores flex</h6>
<p>Es interesante ver que los &iacute;tems flex pueden ser a la vez contenedores flex. Esto nos permite  anidar cajas flex dentro de otras cajas flex sin m&aacute;s complicaciones, ya que ninguna de las propiedades de este m&oacute;dulo es heredada, excepto si as&iacute; especificado ( <code>inherit</code>).</p>
<p>Tambi&eacute;n transformamos la <code>&lt;section&gt; #central</code> en un contenedor flex horizontal. Para esto le damos una clase de <code>.flex-container</code> y otra de <code>.row</code>. Asimismo le damos la clase <code>.wrap</code> ya que queremos que los &iacute;tems flex de la secci&oacute;n <code>#central</code> aparezcan colocados en varias l&iacute;neas.</p>
<p>Vea la estructura general:</p>
<blockquote>
  <pre>
&lt;div id="contenedor" <span class="str">class="flex-container column"</span>&gt; 
&lt;header id="encabezado"&gt;&lt;/header&gt; 
&lt;section <span class="str">class="flex-container justify-space-between row"</span>&gt;   
    &lt;aside id="lateral" <span class="str">class="flex-container column"</span>&gt;&lt;/aside&gt;  
        &lt;section id="central"&gt;        
        &lt;div id="escaparate" <span class="str">class="flex-container justify-space-between wrap row"</span>&gt;
        &lt;/div&gt;
        &lt;/section&gt;
    &lt;nav id="nav"&gt;
    &lt;ul <span class="str">class="flex-container column"</span>&gt;&lt;/ul&gt;
    &lt;/nav&gt; 
    &lt;/section&gt;
&lt;footer id="pie"&gt;&lt;/footer&gt;
&lt;/div&gt;</pre>
</blockquote>
<p><em class="gem">Vea un ejemplo de <a class="link_to" target="_blank"  href="ejemplos/flexbox-layout-test.html">maquetaci&oacute;n flex</a></em></p>
<p><strong>Sugerencia</strong>: podemos trabajar utilizando la clase <code>.no-cssreflections</code>. Firefox no soporta los reflejos CSS, y podemos verificar f&aacute;cilmente la viabilidad del c&oacute;digo en Firefox. Cuando todo est&eacute; como queremos podemos cambiar la clase <code>.no-cssreflections</code> por <code>.no-flexbox</code>.</p>
<h4>Como verificar los resultados</h4>
<p>En el internet podemos encontrar varias p&aacute;ginas web que nos ayudan a verificar nuestra &quot;creaci&oacute;n&quot; en varios navegadores. He aqu&iacute; algunas de ellas:</p>
<ul class="no-bullet">
<li><a class="link_to" target="_blank" href="http://www.browserstack.com/screenshots">Browser Screenshots for Quick Testing</a></li><li>
<a class="link_to" target="_blank" href="http://browsershots.org/">Cross Platform Browser Test - Browsershots</a></li><li>
<a class="link_to" target="_blank" href="http://netrenderer.com/">IE NetRenderer - Browser Compatibility Check</a></li>
</ul> 
