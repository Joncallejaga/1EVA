...
<head>
  ...
  <meta name="description" content="En el CSS3 podemos dar formato a las casillas de verificaci&oacute:n ( checkbox ) y a los botones de radio." />
  <meta name="keywords" content="tutorial, html5, css, css3, checkbox, button, radio, bot&oacute;n, botones, form, formulario,s&iacute;mbolos, ASCII, Unicode, pseudoelemento, before, checked,border-radius,background-clip"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Casillas de verificaci&oacute;n" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/checkbox-estilo.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="En el CSS3 podemos dar formato a las casillas de verificaci&oacute:n ( checkbox ) y a los botones de radio." /> 
  
  <title>Casillas de verificaci&oacute;n</title>
  ...
  <link rel="canonical" href="checkbox-estilo.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="checkbox-estilo.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="checkbox-estilo.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="checkbox-estilo">
<h2 class="page_title">Casillas de verificaci&oacute;n</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Casillas de verificaci&oacute;n&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcheckbox-estilo.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcheckbox-estilo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fcheckbox-estilo.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>En el CSS3 podemos dar formato a las casillas de verificación ( <code>checkbox</code> ) y a los botones de radio, o casi. De hecho podemos construir una nueva casilla de verificación, o un nuevo botón de radio  y esconder a los que vienen de fábrica.
Para esto utilizamos <a class="link_to" target="_blank" href="selectores-before-after.php">el pseudoelemento :before</a>.</p>
<h4>Casillas de verificación</h4>
<p>Queremos dar formato a la etiqueta <code>&lt;label&gt;</code> vinculada a la casilla de verificación. </p>
<blockquote><pre>input[ type=checkbox ] + label</pre></blockquote>
<p>Este selector apunta las etiquetas <code>&lt;label&gt;</code>  situadas inmediatamente después ( <code>+</code> ) de un input de tipo <code>checkbox</code>. Delante ( <code>before</code> ) de estas etiquetas construimos un pseudoelemento: la nueva casilla de verificación.</p>
<blockquote>
  <pre>   
  <strong>input[ type=checkbox ] + label:before {</strong>
	content: "";
	display:inline-block;  
	width:20px; 
	height:20px; 
	...
	position:absolute;  
	left:8px;
<strong>}</strong></pre></blockquote>

<p>Cuando al hacer clic sobre la etiqueta <code>&lt;label&gt;</code> marcamos la casilla de verificación ( la original, la que tenemos oculta ) el contenido del pseudoelemento <code>:before</code> cambia a <code>content: "\02713";</code> ( el símbolo "visto": &#10003; ).</p>

<blockquote>
  <pre>
<strong>input[ type=checkbox ]:checked + label:before{</strong> 
  content: <strong class="str">"\02713"</strong>; 
  color:red;
<strong>}</strong></pre></blockquote>

<p><em class="gem">Para saber más acerca del uso de símbolos en el CSS lea este articulo: <a class="link_to" target="_blank" href="../utiles/glyphs.php">Símbolos ASCII y Unicode</a></em></p>


<h4>Botones de radio</h4>
<p>En el caso de los botones de radio queremos que sean redondos. Para esto, además del CSS ya utilizado para los checkbox,  utilizamos <code>border-radius:100px;</code>  No importa que un radio de 100px sea demasiado grande. El navegador calcula el radio idóneo, y transforma el pseudoelemento en un circulo.</p>

<blockquote>
  <pre><strong>input[ type=radio ] + label:before{</strong> border-radius:100px;<strong>}</strong></pre></blockquote>

<p>Cuando al hacer clic sobre la etiqueta <code>&lt;label&gt;</code> marcamos el botón de radio,  el background del pseudoelemento <code>:before</code> cambia a rojo, pero con un toque especial. Si <code>background-clip: content-box;</code> el fondo ( <code>background</code> ) aparece solo dentro del contenido de la caja.</p>

<blockquote>
  <pre>
<strong>input[ type=radio ]:checked + label:before{</strong>
       padding:4px;
       background-clip : content-box;
       background-color:red;
<strong>}</strong></pre></blockquote>
  
<p><em class="gem">Lea más acerca de <a class="link_to" target="_blank" href="background-clip.php">background-clip</a></em></p>
...
<form id="demo">
<fieldset>   
<p><input type="checkbox" name="chec[]" id="checkbox1" checked /><label for="checkbox1">checkbox 1</label></p>
<p><input type="checkbox" name="chec[]" id="checkbox2" /><label for="checkbox2">checkbox 2</label></p>
</fieldset>
<fieldset> 
<p><input type="radio" name="rad" id="radio1" checked /><label for="radio1">botón de radio 1</label></p>
<p><input type="radio" name="rad" id="radio2" /><label for="radio2">botón de radio 2</label></p>
</fieldset> 
</form>
</code></pre>
        </article>
