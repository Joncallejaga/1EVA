...
<head>
  ...
  <meta name="description" content="La propiedad align-items es una propiedad del contenedor flex y controla el alineamiento de los elementos de una caja flexible ( flexbox items ) a lo largo de su eje transversal." />
  <meta name="keywords" content="flexbox, flex-box, contenedor flex, align-items,flex-start, flex-end, center, baseline, stretch, IE10, -ms-flex-align, start, end, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="align-items" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-align-items.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad align-items es una propiedad del contenedor flex y controla el alineamiento de los elementos de una caja flexible ( flexbox items ) a lo largo de su eje transversal." /> 
  ...
  <link rel="canonical" href="flex-align-items.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-align-items.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-align-items.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad align-items</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=align-items&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-items.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-items.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-items.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos controlar el alineamiento de los elementos de una caja flexible a lo largo de su <a class="link_to" target="_blank" href="flex-direction.php">eje transversal</a> con <code>align-items</code>.</p>

<p>La propiedad <code>align-items</code> es <span class="str">una propiedad del contenedor flex</span> y puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor { align-items: flex-start | flex-end | center | baseline | stretch; }</em>
</p>
</article>
</div>
...
<p><code>center</code>: los elementos aparecen agrupados al centro ( <em class="gem">center</em> ) de la caja.</p>
...
<p><code>baseline</code>: los elementos aparecen alineados relativamente a su <a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/L&iacute;nea_de_base_(tipograf&iacute;a)">l&iacute;nea de base</a> ( <em class="gem">baseline</em> ).</p>


<div class="large-12 text-center"><img class="flex-img" src="images/flex-align-items.gif" width="450" height="183" alt="flex align-items" /></div>
<h4>Para los usuarios de IE10 </h4>
<p>Para que los usuarios de IE10 tengan una experiencia similar utilizamos la propiedad <code>-ms-flex-align</code> cuyos posibles valores son:</p>
<p>
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al principio ( <em class="gem">start</em> ) del eje transversal de la caja flex utilizamos <code>align-items: flex-start;</code></p>
<blockquote>
<pre>
.flex-container.flex-start{
	-webkit-align-items: flex-start;
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al final ( <em class="gem">end</em> ) del eje transversal de la caja flex utilizamos <code>align-items: flex-end;</code></p>
<blockquote>
<pre>
.flex-container.flex-end{
	-webkit-align-items: flex-end;
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados en el centro ( <em class="gem">center</em> ) de la caja flex utilizamos <code>align-items: center;</code></p>
<blockquote>
<pre>
.flex-container.center{
	-webkit-align-items: center;
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) de la caja flex aparezcan  estirados ( <em class="gem">stretched</em> )  ocupando el espacio restante, utilizamos <code>align-items: stretch;</code></p>
<blockquote>
<pre>
.flex-container.stretch{
	-webkit-align-items: stretch;
...
<p>Si utilizamos <code>align-items: baseline;</code> los elementos ( <em class="gem">items</em> ) aparecen distribuidos uniformemente: al principio, en el centro y al final del contenedor flex.</p>
<blockquote>
<pre>
.flex-container.baseline{
	-webkit-align-items: baseline;
...
<div class="large-12 g_panel html">
        <article>
         <pre><code class="language-markup"><div class="flex-container baseline">
<div class="flex-item"><p>1</p></div>
	<div class="flex-item"><h1>2</h1></div>
	<div class="flex-item"><h3>3</h3></div>
	<div class="flex-item"><p>4</p></div>
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#align-items-property">the align-items property</a><br />
