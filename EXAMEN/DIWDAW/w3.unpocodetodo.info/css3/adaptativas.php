...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como realizar una tabla adaptativa utilizando solo html y css." />
  <meta name="keywords" content="tutorial, html5, css, css3, trucos, tablas, tabla adaptativa, responsive table, puntos de discontinuidad"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Tablas adaptativas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/adaptativas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como realizar una tabla adaptativa utilizando solo html y css." /> 
  
  <title>Tablas adaptativas</title>
  ...
  <link rel="canonical" href="adaptativas.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="adaptativas.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="adaptativas.php#top">&#8682;</a></b>
</div>
...
<article> 
<!--<section id="tables" class="large-12">-->    
<section id="adaptativas" class="large-12">
<h2 class="page_title">Tablas adaptativas <small>(Responsive table)</small></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Tablas adaptativas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fadaptativas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fadaptativas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fadaptativas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p><mark>Una tabla adaptativa</mark> <em class="en gem">(responsive table)</em> cambia su aspecto al cambiar el tama&ntilde;o la ventana del navegador.<br />
Podemos realizar una tabla adaptativa utilizando solo <abbr title="HyperText Markup Language">html</abbr> y <abbr title="cascading style sheets">css</abbr>.<br />
<em class="gem">Una idea desarrollada por <a target="_blank" class="link_to" href="http://css-tricks.com/examples/ResponsiveTables/responsive.php">Chris Coyier <!--&#8611;--></a></em></p>
<p>CONSEJO: cambia el tama&ntilde;o de la ventana del navegador para ver como cambia el aspecto de la tabla.</p>
...
<tbody>
  ...
  <tr>
    ...
    <td>Libro</td>
    <td>Eric Berne</td>
    <td>232 p&aacute;ginas</td>
    <td>1.076,28&euro;</td>
  </tr>
</tbody>
</table>        
		<p>La tabla tiene asignada una clase ( <code>class="resp"</code> ).
        Tambi&eacute;n tiene un <code>&lt;thead&gt;</code> y un <code>&lt;tbody&gt;</code>.
        </p>
...
<tbody>
  ...
  <tr>
    ...
    <td>1.076,28&euro;</td>
        ...
        <p>A continuaci&oacute;n, se crean en el CSS las reglas que dan estilo a las tablas en general.</p>
...
table tr:nth-of-type(even) {
  background: #f9f9f9;
        ...
        <p>Y ahora lo m&aacute;s importante: las reglas que dar&aacute;n estilo a las tablas en tama&ntilde;os de pantalla situados debajo del <mark>punto de discontinuidad</mark> definido <em class="en gem">(breakpoint)</em> - en este caso  768px.</p>
...
@media only screen and (max-width: 768px) {
	...
	.resp td:before {
	  ...
	  font-weight: bold;
        ...
        <p><em class="gem">M&aacute;s informaci&oacute;n sobre los <a class="link_to" href="media-query.php">@media query</a></em></p>        
        <p>Por fin reemplazaremos el contenido de los <code>&lt;th&gt;</code> con el mismo texto insertado <mark>antes de</mark> <em class="gem en">(:before)</em> <code>&lt;td&gt;</code>.<br />Observe por favor el formato que tienen los diacr&iacute;ticos, utilizados con la propiedad <mark>contenido</mark> <em class="gem en">(content:)</em>.</p>
        
        <!--<p><em class="gem">M&aacute;s informaci&oacute;n sobre <mark>el en&eacute;simo de su tipo</mark> <a href="#" class="link_to">:nth-of-type(n)</a></em></p>-->
