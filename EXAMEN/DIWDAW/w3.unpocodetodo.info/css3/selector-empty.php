...
<head>
  ...
  <meta name="description" content="El pseudo-selector :empty ( nuevo en CSS3 )�selecciona elementos HTML vac�os, pero..." />
  <meta name="keywords" content="tutorial, html5, css, css3, selector,pseudo-selector, :empty,vac&iacute;o"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El selector :empty" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selector-empty.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El pseudo-selector :empty ( nuevo en CSS3 )�selecciona elementos HTML vac�os, pero..." /> 
  
  <title>El selector :empty</title>
  ...
  <link rel="canonical" href="selector-empty.php"> 
 
  <style>table#ejemplo tr{ background:white;}table#ejemplo{ width:500px; margin:10px auto;}table#ejemplo td{ border:1px solid #d9d9d9; border-collapse:collapse; text-align:center; padding:.5em;}table#ejemplo td:empty{ background-image:url(images/pattern.png);}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selector-empty.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selector-empty.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="selector-empty"><h2 class="page_title">El selector :empty</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El selector :empty&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-empty.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-empty.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-empty.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El pseudo-selector <code>:empty</code> ( nuevo en CSS3 )  selecciona elementos HTML vacíos, pero no a todos:</p><p><strong>Selecciona</strong>:</p><blockquote><pre>  &lt;td&gt;&lt;/td&gt;  &lt;td&gt;<span class="com">&lt;!--comentario--&gt;</span>&lt;/td&gt;</pre></blockquote><p><strong>No selecciona</strong>:</p><blockquote><pre>  &lt;td&gt;  &lt;/td&gt;<span class="com">&lt;!--un espacio en blanco--&gt;</span>  &lt;td&gt;<span class="str">&amp;nbsp;</span>&lt;/td&gt;</pre></blockquote><h4>Veamos un ejemplo:</h4><p>En el siguiente ejemplo queremos aplicar una trama   ( <code>background-image:url(images/pattern.png)</code> )   a las celdas vac&iacute;as ( <code>td:empty</code> ).</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">table#ejemplo{ width:500px; margin:10px auto;}table#ejemplo td{ border:1px solid #d9d9d9; border-collapse:collapse; text-align:center; padding:.5em;}table#ejemplo td:empty{ background-image:url(images/pattern.png);}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><table id="ejemplo">  <tr>    <td>1</td>    <td>2</td>    <td></td>    <td>4</td>  </tr>  <tr>    <td>5</td>    <td>6</td>    <td>7</td>    <td><!--casilla nº 8--></td>  </tr>  <tr>    <td>9</td>    <td>10</td>    <td>11</td>    <td> </td>  </tr>  <tr>    <td>&nbsp;</td>    <td>14</td>    <td>15</td>    <td>16</td>  </tr></table></code></pre>        </article></div><p>Observamos que las casillas 3 ( <code>&lt;td&gt;&lt;/td&gt;</code> ) y 8  ( <code>&lt;td&gt;&lt;!--casilla nº 8--&gt;&lt;/td&gt;</code> ) tienen la trama como imagen de fondo, mientras que las celdas 12 ( <code>&lt;td&gt; &lt;/td&gt;</code> ) y 13 ( <code>&lt;td&gt;&amp;nbsp;&lt;/td&gt;</code> ) quedan sin estilo</p><div class="large-12 g_panel resultado">        <article>        <table id="ejemplo">  <tr>    <td>1</td>    <td>2</td>    <td></td>    <td>4</td>  </tr>  <tr>    <td>5</td>    <td>6</td>    <td>7</td>    <td><!--casilla nº 8--></td>  </tr>  <tr>    <td>9</td>    <td>10</td>    <td>11</td>    <td> </td>  </tr>  <tr>    <td>&nbsp;</td>    <td>14</td>    <td>15</td>    <td>16</td>  </tr></table>        </article></div><h4>Ojo</h4><p>El selector <code>:empty</code> selecciona elementos como <code>&lt;img&gt;</code>, <code>&lt;hr&gt;</code>, <code>&lt;input type="text"&gt;</code> o <code>&lt;textarea&gt;</code> vacíos. Tambi&eacute;n lo puede ser un elemento <code>&lt;canvas&gt;</code> aunque hayamos utilizado javascript para dibujar algo dentro.</p><h4>El soporte en los navegadores</h4> <p>El soporte en los navegadores para el pseudo-selector <a class="link_to" target="_blank" href="http://caniuse.com/#search=empty">:empty</a> es muy bueno.</p>            </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="selector-nth-child.php">El en&eacute;simo hijo</a></em></li><li>- <em class="gem"><a class="link_to" href="selectores-first-last-only.php">El primero, el &uacute;ltimo, el &uacute;nico</a></em></li><li>- <em class="gem"><a class="link_to" href="selectores-before-after.php">::before y ::after</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-checked.php">El selector :checked</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-target.php">El selector :target</a></em></li><li>- <em class="gem">El selector :empty</em></li><li>- <em class="gem"><a class="link_to" href="selector-not.php">El selector :not()</a></em></li><li>- <em class="gem"><a class="link_to" href="seleccion.php">El selector  ::selection</a></em></li><li>- <em class="gem"><a class="link_to" href="placeholder.php">Marcadores de posici&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="pseudo-elemento-first-letter.php">La primera letra</a></em></li><li>- <em class="gem"><a class="link_to" href="link_visited_hover_active.php">:link, :visited, :hover y :active</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- El soporte en los navegadores para el pseudo-selector <a class="link_to" target="_blank" href="http://caniuse.com/#search=empty">:empty</a><br></em></p>
</article></div></div>
