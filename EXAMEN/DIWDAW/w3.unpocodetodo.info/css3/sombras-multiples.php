...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Aplicar sombras m&uacute;ltiples" />
  <meta name="keywords" content="tutorial, html5, css, css3, text-shadow, texto sombreado, sombra de texto, texto con sombra, sombra, shadow, sombras css"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Sombras m&uacute;ltiples" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/sombras-multiples.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Aplicar sombras m&uacute;ltiples" /> 
  
  <title>Sombras m&uacute;ltiples</title>
  ...
  <link rel="canonical" href="sombras-multiples.php"> 
 
  <style>#sombrah1 {  background-color: cornsilk;  height: 100%;  text-align: center;}#sombrah1 h1 {  color: white;  font-family: Georgia, 'Times New Roman', Times, serif;  font-size: 36px;  text-shadow: 1px 1px black, 1px -1px black, -1px -1px black, -1px 1px black;}.resultado article{ background-color:cornsilk;};</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="sombras-multiples.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="sombras-multiples.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="sombras-multiples"><h2 class="page_title">Sombras m&uacute;ltiples</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Sombras m&uacute;ltiples&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsombras-multiples.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsombras-multiples.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fsombras-multiples.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4 id="h4_1">Letras con contorno</h4><p>En SVG podemos f&aacute;cilmente marcar el contorno de las letras utilizando <a class="link_to" target="_blank" href="../svg/texto.php">el atributo stroke</a>. Tambi&eacute;n lo podemos hacer en CSS aplicando cuatro sombras solidas al texto:</p><blockquote><pre>text-shadow: 1px 1px <strong class="str">0px</strong> black, 1px -1px <strong class="str">0px</strong> black, -1px -1px <strong class="str">0px</strong> black, -1px 1px <strong class="str">0p</strong>x black;</pre></blockquote><p>No hay que olvidar que el desenfoque ( <em class="gem">blur</em> ) es opcional y que el valor por defecto es 0. Por lo tanto podemos escribir: </p><blockquote><pre>text-shadow: 1px 1px black, 1px -1px black, -1px -1px black, -1px 1px black;</pre></blockquote><p>Veamos un ejemplo:</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><div id="sombrah1"><h1>SOMBRA</h1></div></code></pre>        </article></div><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">#sombrah1 {  background-color: cornsilk;  height: 100%;  text-align: center;}#sombrah1 h1 {  color: white;  font-family: Georgia, 'Times New Roman', Times, serif;  font-size: 36px;  text-shadow: 1px 1px black, 1px -1px black, -1px -1px black, -1px 1px black;}</code></pre>        </article></div>       <div class="large-12 g_panel resultado">        <article>        <div id="sombrah1"><h1>SOMBRA</h1></div>        </article></div><h4 id="h4_2">Texto tridimensional</h4><p>Tambi&eacute;n podemos crear la ilusi&oacute;n de texto tridimensional utilizando las sombras m&uacute;ltiples de CSS3:<br>Observe que para dar relieve utilizamos sombras solidas, donde el desenfoque es 0, y también el desplazamiento vertical es 0. El desplazamiento horizontal crece en un pixel con cada nueva sombra aplicada, y el color de la sombra va de gris claro: <code>rgb(200, 200, 200)</code> a más oscuro:  <code>rgb(190, 190, 190).</code></p><blockquote><pre>  text-shadow:<span class="com"> /*relieve*/</span>    0 1px 0 rgb(200, 200, 200),     0 2px 0 rgb(190, 190, 190),     0 3px 0 rgb(180, 180, 180),    0 4px 0 rgb(175, 175, 175),    0 5px 0 rgb(180, 180, 180),    0 6px 0 rgb(190, 190, 190),</pre></blockquote><p>Para rematar creamos una sombra al estilo tradicional:</p><blockquote><pre>    <span class="com">/*sombra*/</span>    5px  7px  5px rgba(0, 0, 0, .40),    5px 12px 10px rgba(0, 0, 0, .30),    5px 17px 20px rgba(0, 0, 0, .20),    5px 22px 30px rgba(0, 0, 0, .10);</pre></blockquote>  <p data-height="368" data-theme-id="11360" data-slug-hash="bVxYyB" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/bVxYyB/'>texto 3d</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h4 id="h4_3">Letras con textura</h4><p>En Photoshop podemos aplicar texturas al texto. Tambi&eacute;n es posible hacerlo utilizando <a class="link_to" target="_blank" href="background-clip.php">mascaras de texto.</a> en CSS. La mala noticia es que esto no funciona en todos los navegadores, notablemente en Firefox. Una soluci&oacute;n ser&iacute;a <a class="link_to" target="_blank" href="http://lea.verou.me/2012/05/text-masking-the-standards-way/">utilizar SVG</a> <br>  Otra soluci&oacute;n es utilizar sombras m&uacute;ltiples. Veamos c&oacute;mo:</p><p>En HTML el elemento <code>&lt;h1&gt;</code> aparece dentro del<code> &lt;div id=&quot;sombra&quot;&gt;</code>. En el CSS el texto es blanco <code>color:White</code>, y el div tiene como fondo ( <code>background-image</code> ) una textura realizada con gradientes.</p><blockquote><pre>background-image:  linear-gradient(90deg, rgba(200, 0, 0, .5) 50%, transparent 50%),  linear-gradient(rgba(200, 0, 0, .5) 50%, transparent 50%);background-size: 25px 25px;</pre></blockquote><p>Vea más ejemplos de texturas CSS: <a href="http://lea.verou.me/css3patterns/">CSS3 Patterns Gallery</a></p><p>Las letras tienen que ser blancas – esto es muy importante. De esta manera al aplicar  <code>mix-blend-mode: multiply;</code> las letras se fusionan perfectamente con el fondo. Todo lo que queda por hacer es aplicar tantas sombras como para tapar el resto del elemento. Esto lo hacemos utilizando JavaScript. Y ya está. Hay que decir que <code>mix-blend-mode</code> no es soportado por IE, y en este caso las letras se quedan blancas sobre un fondo negro.</p><p data-height="336" data-theme-id="11360" data-slug-hash="wKxBPj" data-default-tab="result" data-user="enxaneta" class='codepen'>See the Pen <a href='http://codepen.io/enxaneta/pen/wKxBPj/'>SVG Displacement Map</a> by Gabi (<a href='http://codepen.io/enxaneta'>@enxaneta</a>) on <a href='http://codepen.io'>CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="word-wrap.php">Cambio de l&iacute;nea </a></em></li><li>- <em class="gem"><a class="link_to" href="text-shadow.php">Texto con sombra</a></em></li><li>- <em class="gem">Sombras m&uacute;ltiples</em></li><li>- <em class="gem"><a class="link_to" href="font-icons.php">Que son los Icon Fonts</a></em></li><li>- <em class="gem"><a class="link_to" href="columnas-css3.php">Columnas m&uacute;ltiples</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- El soporte de  <a class="link_to" target="_blank" href="http://caniuse.com/#search=text-shadow">text-shadow</a> en los navegadores.<br>
- Lea Verou: <a class="link_to" target="_blank"  href="http://lea.verou.me/css3patterns/">CSS3 Patterns Gallery</a></em></p>
</article></div></div>
