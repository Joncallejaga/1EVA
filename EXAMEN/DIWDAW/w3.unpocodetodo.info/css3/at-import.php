...
<head>
  ...
  <meta name="description" content="La declaración &#64;import permite importar una hoja de estilos externa dentro de otra hoja de estilos." />
  <meta name="keywords" content="regla-at, at-rule,CSS, import, importar, media "/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La regla-at &#64;import" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/at-import.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La declaración &#64;import permite importar una hoja de estilos externa dentro de otra hoja de estilos." /> 
  
  <title>La regla-at &#64;import</title>
  ...
  <link rel="canonical" href="at-import.php"> 
 
  <style>table#ejemplo tr{ background:white;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="at-import.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="at-import.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="at-import"><h2 class="page_title">La regla-at &#64;import</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La regla-at &#64;import&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-import.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-import.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-import.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La declaraci&oacute;n <code>@import</code> permite importar una hoja de estilos externa dentro de otra hoja de estilos.</p><h4>La sintaxis</h4><p>El url a utilizar puede aparecer dentro de una anotaci&oacute;n funcional url(), o sencillamente entre comillas:</p><blockquote><pre>@import url(ruta/estilos.css);@import 'ruta/estilos.css';</pre></blockquote><h4>La posici&oacute;n dentro de una hoja de estilos</h4><p>Las declaraciones <code>@import</code> tienen que preceder cualquier otra regla de la hoja de estilos, con una excepci&oacute;n: puede ser precedidaÂ  y tiene que ser precedida por la declaraci&oacute;n<code> @charsert</code>.</p><blockquote><pre>@charset "utf-8"; @import url(ruta/estilos.css);</pre></blockquote><h4>@import y @media</h4><p>Tampoco puede ser utilizada dentro de un bloque <code>@media</code>, aunque s&iacute; es posible importar una hoja de estilos externa para ser utilizada con un cierto tipo de media.</p><blockquote><pre>@import url(estilos/print.css) <strong>print</strong>;. . . .@media print {/* las reglas CSS van aqu&iacute; */}</pre></blockquote><h4>Para tener en cuenta</h4><p>La declaraci&oacute;n <code>@import</code> puede tener un efecto negativo en el rendimiento de la p&aacute;gina.</p><h4>Algunos ejemplos</h4><blockquote><pre>  @import url("print.css") print;  @import url("speech.css") speech;  @import 'custom.css';  @import url("chrome://communicator/skin/");  @import "common.css" screen;  @import url('landscape.css') screen and (orientation:landscape);  @import url(https://fonts.googleapis.com/css?family=Raleway:400);  @import 'https://fonts.googleapis.com/css?family=Raleway:400)';</pre></blockquote>         </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem">La regla-at &#64;import</em></li><li>- <em class="gem"><a class="link_to" href="at-namespace.php">La regla-at &#64;namespace</a></em></li><li>- <em class="gem"><a class="link_to" href="font-face.php">La declaraci&oacute;n @font-face</a></em></li><li>- <em class="gem"><a class="link_to" href="at-keyframes.php">La regla-at &#64;keyframes</a></em></li><li>- <em class="gem"><a class="link_to" href="media-query.php">&#64;media-query</a></em></li><li>- <em class="gem"><a class="link_to" href="supports.php">La regla-at &#64;supports</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- Sara Soueidan: <a class="link_to" target="_blank" href="https://tympanus.net/codrops/css_reference/import/">&#64;import</a><br></em></p>
</article></div></div>
