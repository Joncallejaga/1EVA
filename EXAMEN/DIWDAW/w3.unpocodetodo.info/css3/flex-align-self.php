...
<head>
  ...
  <meta name="description" content="La propiedad align-self reposiciona elementos individuales relativamente al eje transversal de la caja. Es una propiedad de los &iacute;tems del contenedor flex." />
  <meta name="keywords" content="flexbox, flex-box, &iacute;tems flex, align-self, flex-start, flex-end, center, baseline, stretch, IE10, -ms-flex-align,start, end, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="align-self" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-align-self.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad align-self reposiciona elementos individuales relativamente al eje transversal de la caja. Es una propiedad de los &iacute;tems del contenedor flex." /> 
  ...
  <link rel="canonical" href="flex-align-self.php"> 
...
}img.flex-img{ margin-bottom:2em;}
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-align-self.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-align-self.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad align-self</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=align-self&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-self.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-self.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-align-self.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>align-self</code> reposiciona elementos individuales relativamente al <a class="link_to" target="_blank" href="flex-direction.php">eje transversal</a> de la caja. Generalmente se trata de elementos posicionados con <code>align-items</code>.</p>

<p>La propiedad <code>align-self</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex y puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.item { align-self: flex-start | flex-end | center | baseline | stretch; }</em>
</p>
</article>
</div>

<p><code>flex-start</code>: el elemento aparece al principio ( <em class="gem">start</em> ) del eje transversal.</p>
<p><code>flex-end</code>: el elemento aparece  al final ( <em class="gem">end</em> ) del eje transversal.</p>
<p><code>center</code>:   el elemento reposicionado aparece en el centro ( <em class="gem">center</em> ) de la caja flex.</p>
<p><code>stretch</code> ( el valor por defecto ):   el elemento aparece estirado ( <em class="gem">stretched</em> ) para ocupar el espacio restante.</p>
...
<div class="large-12 text-center"><img class="flex-img" src="images/flex-align-self.gif" width="450" height="183" alt="flex align-self" /></div>
...
<p>Si queremos que el elemento ( <em class="gem">item</em> ) aparezca al principio ( <em class="gem">start</em> ) del eje transversal de la caja flex utilizamos <code>align-self: flex-start;</code></p>
<blockquote>
<pre>
.flex-container .flex-start{
	-webkit-align-self: flex-start;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container">
...
<h4>align-items: flex-start</h4>
<p>Si queremos que el elemento ( <em class="gem">item</em> ) aparezca  al final ( <em class="gem">end</em> ) del eje transversal de la caja flex utilizamos <code>align-self: flex-end;</code></p>
<blockquote>
<pre>
.flex-container .flex-end{
	-webkit-align-self: flex-end;
...
<div class="flex-item"><p>1</p></div>
	<div class="flex-item"><p>2</p></div>
	<div class="flex-item flex-end"><p>3</p></div>
	<div class="flex-item"><p>4</p></div>
</div>
</code></pre>
        </article>
...
<p>Si queremos que el elemento ( <em class="gem">item</em> ) aparezca  en el centro ( <em class="gem">center</em> ) de la caja flex utilizamos <code>align-self: center;</code></p>
<blockquote>
<pre>
.flex-container .center{
	-webkit-align-self: center;
...
<div class="flex-item"><p>1</p></div>
	<div class="flex-item"><p>2</p></div>
	<div class="flex-item center"><p>3</p></div>
	<div class="flex-item"><p>4</p></div>
</div>
</code></pre>
        </article>
...
<p>Si queremos que el elemento ( <em class="gem">item</em> ) aparezca  estirado ( <em class="gem">stretched</em> )  ocupando el espacio restante, utilizamos <code>align-self: stretch;</code></p>
<blockquote>
<pre>
.flex-container .stretch{
	-webkit-align-self: stretch;
...
<div class="flex-item"><p>1</p></div>
	<div class="flex-item"><p>2</p></div>
	<div class="flex-item stretch"><p>3</p></div>
	<div class="flex-item"><p>4</p></div>
</div>
</code></pre>
        </article>
...
<p>Si utilizamos <code>align-self: baseline;</code> los elementos ( <em class="gem">items</em> ) aparecen alineados relativamente relativamente a su <a class="link_to" target="_blank" href="http://es.wikipedia.org/wiki/L&iacute;nea_de_base_(tipograf&iacute;a)">l&iacute;nea de base</a> ( <em class="gem">baseline</em> ).</p>
<blockquote>
<pre>
.flex-container .baseline{
	-webkit-align-self: baseline;
...
<div class="flex-item"><p>1</p></div>
	<div class="flex-item"><p>2</p></div>
	<div class="flex-item baseline"><p>3</p></div>
	<div class="flex-item"><p>4</p></div>
</div>
</code></pre>
        </article>
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#align-items-property">the align-self property</a><br />
