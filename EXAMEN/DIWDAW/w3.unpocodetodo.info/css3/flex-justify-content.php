...
<head>
  ...
  <meta name="description" content="La propiedad justify-content es una propiedad del contenedor flex y controla el alineamiento de los elementos de una caja flexible ( flexbox items ) a lo largo de su eje principal" />
  <meta name="keywords" content="flexbox, flex-box, contenedor flex, justify-content, flex-start, flex-end, center, stretch, space-between, space-around, IE10, �ms-flex-line-pack, start, justify, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="justify-content" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-justify-content.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad justify-content es una propiedad del contenedor flex y controla el alineamiento de los elementos de una caja flexible ( flexbox items ) a lo largo de su eje principal" /> 
  ...
  <link rel="canonical" href="flex-justify-content.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-justify-content.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-justify-content.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad justify-content</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=justify-content&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-justify-content.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-justify-content.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-justify-content.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos controlar el alineamiento de los elementos de una caja flexible ( <em class="gem">flexbox</em> ) a lo largo de su <a class="link_to" target="_blank" href="flex-direction.php">eje principal</a> con <code>justify-content</code>.</p>
 
<p>La propiedad <code>justify-content</code> es <span class="str">una propiedad del contenedor flex</span> y  puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor { justify-content: flex-start | flex-end | center | space-between | space-around; }</em>
</p>
</article>
</div>

<p><code>flex-start</code> ( el valor por defecto ): los elementos aparecen agrupados al principio ( <em class="gem">start</em> ) del eje principal.</p>
<p><code>flex-end</code>: los elementos aparecen agrupados al final ( <em class="gem">end</em> ) del eje principal.</p>
...
<div class="large-12 text-center"><img class="flex-img" src="images/flex-justify-content.gif" width="459" height="125" alt="flex justify-content" /></div>
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al principio ( <em class="gem">start</em> ) del eje principal de la caja flex utilizamos <code>justify-content: flex-start;</code></p>
<blockquote>
<pre>
.flex-container.flex-start{
	-webkit-justify-content: flex-start;
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados al final ( <em class="gem">end</em> ) del eje principal de la caja flex utilizamos <code>justify-content: flex-end;</code></p>
<blockquote>
<pre>
.flex-container.flex-end{
	-webkit-justify-content: flex-end;
...
<p>Si queremos que los elementos ( <em class="gem">items</em> ) aparezcan agrupados en el centro ( <em class="gem">center</em> ) de la caja flex utilizamos <code>justify-content: center;</code></p>
<blockquote>
<pre>
.flex-container.center{
	-webkit-justify-content: center;
...
<p>Si utilizamos <code>justify-content: space-between;</code> los elementos ( <em class="gem">items</em> ) aparecen distribuidos uniformemente: al principio, en el centro y al final del contenedor flex.</p>
<blockquote>
<pre>
.flex-container.space-between{
	-webkit-justify-content: space-between;
...
<p>Si utilizamos <code>justify-content: space-around;</code> los elementos ( <em class="gem">items</em> ) aparecen distribuidos uniformemente, y con un espacio igual entre ellos.</p>
<blockquote>
<pre>
.flex-container.space-around{
	-webkit-justify-content: space-around;
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#justify-content-property">the justify-content property</a><br />
