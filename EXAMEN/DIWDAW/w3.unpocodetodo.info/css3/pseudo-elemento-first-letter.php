...
<head>
  ...
  <meta name="description" content="El selector ::first-letter nos permite dar un  formato especial a pa primera letra de un elemento HTML." />
  <meta name="keywords" content="HTML5, CSS3,selector,::first-letter,::first-line"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La primera letra" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/pseudo-elemento-first-letter.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El selector ::first-letter nos permite dar un  formato especial a pa primera letra de un elemento HTML." /> 
  
  <title>La primera letra</title>
  ...
  <link rel="canonical" href="pseudo-elemento-first-letter.php"> 
 
  <style>iframe{ margin-bottom:2em; } .capitular{white-space:normal;}.capitular{  display:block;  width:20em;  margin:1em auto;}.capitular::first-letter{  color:red;  font-weight:bold;}._before::before{	content: 'Before: '}.letra.capitular::first-letter{  color:red;  font-size:400%;  display:block;  float:left;  padding:0 .1em 0 0;  margin:-.4em 0 -.6em 0;}.primera-linea::first-line{  font-variant: small-caps;  letter-spacing: .07em;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="pseudo-elemento-first-letter.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="pseudo-elemento-first-letter.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="pseudo-elemento-first-letter"><h2 class="page_title">La primera letra</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La primera letra&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fpseudo-elemento-first-letter.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fpseudo-elemento-first-letter.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fpseudo-elemento-first-letter.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>El pseudo-elemento ::first-letter </h4><p>El pseudo-elemento <code>::first-letter</code> permite dar formato a la primera letra de un elemento, sin tener que ponerlo dentro de otro elemento ( un elemento <code>&lt;span&gt;</code> por ejemplo ).</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">.capitular{  display:block;  width:20em;  margin:1em auto;}.capitular::first-letter{  color:red;  font-weight:bold;}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="capitular">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p></code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <p class="capitular">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p>        </article></div><h4>El pseudo-elemento ::first-letter y el pseudo-elemento ::before</h4><p><strong>¡OJO!</strong> Si el dicho elemento tiene un pseudo-elemento <code>::before</code> cuyo contenido es texto, el CSS considera la primera letra de este texto como pseudo-elemento <code>::first-letter</code>.</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">._before::before{	content: 'Before: '}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="capitular _before">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p></code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <p class="capitular _before">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p>        </article></div><h4>Crear un efecto de letra capitular</h4><p>Para crear un efecto de <a class="link_to" target="_blank" href="https://es.wikipedia.org/wiki/Letra_capital">letra capitular</a> necesitamos flotar el pseudo-elemento <code>::first-letter</code> a la izquierda:</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">.letra.capitular::first-letter{  color:red;  font-size:400%;  display:block;  float:left;  padding:0 .1em 0 0;  margin:-.4em 0 -.6em 0;}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="letra capitular">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p></code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <p class="letra capitular">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p>        </article></div><h4>El pseudo-elemento ::first-line</h4> <p>En el CSS existe otro pseudo-elemento parecido que nos permite dar formato a la primera l&iacute;nea de texto: el pseudo-elemento <code>::first-line</code>:</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">.primera-linea::first-line{  font-variant: small-caps;  letter-spacing: .07em;}</code></pre>        </article></div>       <div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><p class="letra capitular primera-linea">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p></code></pre>        </article></div><div class="large-12 g_panel resultado">        <article>        <p class="letra capitular primera-linea">Arthur Eric Rowton Gill conocido como Eric Gill fue un tip&oacute;grafo y escultor ingl&eacute;s, conocido por su aportaci&oacute;n en el campo de la tipograf&iacute;a, donde cre&oacute; su famosa familia de tipos Gill Sans.</p>        </article></div>          </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="selector-nth-child.php">El en&eacute;simo hijo</a></em></li><li>- <em class="gem"><a class="link_to" href="selectores-first-last-only.php">El primero, el &uacute;ltimo, el &uacute;nico</a></em></li><li>- <em class="gem"><a class="link_to" href="selectores-before-after.php">::before y ::after</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-checked.php">El selector :checked</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-target.php">El selector :target</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-empty.php">El selector :empty</a></em></li><li>- <em class="gem"><a class="link_to" href="selector-not.php">El selector :not()</a></em></li><li>- <em class="gem"><a class="link_to" href="seleccion.php">El selector  ::selection</a></em></li><li>- <em class="gem"><a class="link_to" href="placeholder.php">Marcadores de posici&oacute;n</a></em></li><li>- <em class="gem">La primera letra</em></li><li>- <em class="gem"><a class="link_to" href="link_visited_hover_active.php">:link, :visited, :hover y :active</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- <a class="link_to" target="_blank" href="http://codepen.io/enxaneta/pen/WrEVjL/">Un ejemplo </a> pr&aacute;ctico: "Eric Gill tip&oacute;grafo y escultor".</em></p>
</article></div></div>
