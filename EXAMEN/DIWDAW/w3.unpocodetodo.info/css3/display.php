...
<head>
  ...
  <meta name="description" content="Material acerca de las caracter&iacute;sticas de CSS. Entender la propiedad display." />
  <meta name="keywords" content="tutorial, html5, css, css3, trucos,display, block, inline, none, inline-block, list-item, table, table-row, table-cell, inline-table, table-column, table-column-group, table-footer-group, table-header-group, table-row-group, flex, inline-flex, grid, inline-grid, run-in"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Entender la propiedad display" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/display.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las caracter&iacute;sticas de CSS. Entender la propiedad display." /> 
  
  <title>Entender la propiedad display</title>
  ...
  <link rel="canonical" href="display.php"> 
 
  <style>
#display .container { background-color: #cccccc; padding:10px; width:600px; margin:20px auto 40px auto; line-height:180%}
#display .block { background-color: #ddd; border:1px solid #bbb; padding:10px; margin:5px;}
#display .group { background-color: #eee; border:1px solid #ccc; padding: 8px; margin: 5px; }
#display .alone { background-color: #fff; border:1px solid #ddd; padding: 6px; margin: 5px; }
#display select{width:110px; margin:0;}
#b4g1a1{ width:150px;}
@media only screen and (max-width: 768px) {
#display 	.container { width:320px; padding:3px;}
#display 	.block { padding:3px;}
#display  .group { padding:3px; }
#display .alone { padding:3px;}
#display select{width:80px;}
}
</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="display.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="display">
<h2 class="page_title">Entender la propiedad display<!--Entender la propiedad display--></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Entender la propiedad display&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fdisplay.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fdisplay.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fdisplay.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>display</code> nos permite definir como ser&aacute; mostrado un cierto elemento HTML.</p>
<div class="row"> 
<div class="large-12 columns">
<div class="g_panel sintaxis">
        <article>
								<em class="gem">display : 
        block <span class="normal">|</span> inline <span class="normal">|</span> none <span class="normal">|</span> 
        inline-block <span class="normal">|</span> list-item <span class="normal">|</span> table <span class="normal">|</span> 
        table-row <span class="normal">|</span> table-cell <span class="normal">|</span> inline-table <span class="normal">|</span> table-column <span class="normal">|</span> 
        table-column-group <span class="normal">|</span> table-footer-group <span class="normal">|</span> 
        table-header-group <span class="normal">|</span>  table-row-group <span class="normal">|</span> 
        flex <span class="normal">|</span> inline-flex <span class="normal">|</span> grid <span class="normal">|</span> 
        inline-grid <span class="normal">|</span> run-in
        </em>  
        </article>
</div>
</div>
...
<h6>display : block</h6>
<p>El elemento es mostrado como un elemento <code>block</code>, o sea como los p&aacute;rrafos o encabezados siempre fueron mostrados.
Un elemento <code>block</code> siempre tiene algo de espacio por encima y debajo, que lo separa de los dem&aacute;s elementos, 
y no acepta ning&uacute;n otro elemento a su lado - si no est&aacute; indicado de otra manera (<code>float</code>).
</p>
<p>CONSEJO:<br><em class="gem">En los siguientes ejemplos, cambiando la opci&oacute;n de los <code>&lt;select&gt;</code> cambia tambi&eacute;n el valor de la propiedad <code>display</code>.</em></p>
<div class="container" id="c1">
    
   <div class="block" id="b1">
      <div class="group" id="b1g1">
        <div class="alone" id="b1g1a1">
        </div>
        <div class="alone" id="b1g1a2">
        </div>
    </div><!--<div class="group">-->
    </div><!--<div id="b1">-->
...
<h6>display : inline</h6>
<p>El elemento aparece en l&iacute;nea por ejemplo dentro de un elemento block.<br />
Ejemplos de elementos definidos como inline:<code> &lt;span&gt;</code>, <code>&lt;em&gt;</code>, <code>&lt;strong&gt;</code>, etc...<br />
Cuando un elemento <code>inline</code> se encuentra entre dos elementos block, el elemento inline se comporta como un <em class="gem">block an&oacute;nimo</em>, de m&iacute;nima anchura 
(por ejemplo la anchura del texto dentro de este elemento.)
</p>
<div class="container" id="c2">
    
   <div class="block" id="b2">
      <div class="group" id="b2g1">
        <div class="alone" id="b2g1a1">
        </div>
        <div class="alone" id="b2g1a2">
        </div>
    </div><!--<div class="group">-->
    </div><!--<div id="b2">-->
  ...
  <h6>display : none</h6>
  <p>Se utiliza para ocultar un elemento. Tampoco ser&aacute; visible en el siguiente ejemplo (<code>&lt;div id="b3g1a2"&gt;</code>).</p>
<div class="container" id="c3">
    
   <div class="block" id="b3">
      <div class="group" id="b3g1">
        <div class="alone" id="b3g1a1">
        </div>
        <div class="alone" id="b3g1a2">
        </div>
    </div><!--<div class="group">-->
    </div><!--<div id="b3">-->
    
  </div><!-- <div class="container">-->
  <h6>display : inline-block</h6>
  <p>El elemento aparece en l&iacute;nea pero se comporta como un elemento block.
Un elemento <code>inline-block</code> resulta muy &uacute;til cuando queremos dar una anchura al elemento. 
En el siguiente ejemplo la anchura del elemento <code>inline-block</code> es de <code>150px</code>.</p>
<div class="container" id="c4">
    
   <div class="block" id="b4">
      <div class="group" id="b4g1">...En un lugar de la Mancha de cuyo nombre no quiero acordarme, 
no ha mucho tiempo que vivía un hidalgo de los de lanza en astillero, 
adarga antigua, rocín flaco y galgo corredor. 
        <div class="alone" id="b4g1a1">Una olla de algo 
        </div>m&aacute;s vaca que carnero, salpic&oacute;n las m&aacute;s noches, 
duelos y quebrantos los s&aacute;bados, lentejas los viernes, 
algún palomino de añadidura los domingos.
  ...
  <h6>display : list-item</h6>
  <p>El elemento se comporta como un elemento de lista <code>&lt;li&gt;</code>, 
  lo que quiere decir que tendr&aacute; una vi&ntilde;eta <em class="gem">(bullet)</em> delante 
  (excepto en algunos navegadores muy antiguos).</p>
<div class="container" id="c5">
    
   <div class="block" id="b5">
      <div class="group" id="b5g1">
        <div class="alone" id="b5g1a1">
        </div>
        <div class="alone" id="b5g1a2">
        </div>
    </div><!--<div class="group">-->
    </div><!--<div id="b3">-->
    
  </div><!-- <div class="container">-->
  <h6>display : table | table-row | table-cell</h6>
  <p>El elemento se comportar&aacute; como una tabla. Los elementos anidados tendr&iacute;an que mostrarse como elementos de tabla 
  (<code>display:table-row;</code>, <code>display:table-cell</code>), imitando de esta manera el comportamiento de una tabla.</p>
<div class="container" id="c6">
    
   <div class="block" id="b6">
      <div class="group" id="b6g1">
        <div class="alone" id="b6g1a1">
        </div>
        <div class="alone" id="b6g1a2">
        </div>
    </div><!--<div class="group">-->


      <div class="group" id="b6g2">
        <div class="alone" id="b6g2a1">
        </div>
        <div class="alone" id="b6g2a2">
        </div>
    </div><!--<div class="group">-->
    </div><!--<div id="b6">-->
    
  </div><!-- <div class="container">-->  
<h6>Pa probar to lo que queramos</h6>
<p>A continuaci&oacute;n podemos testar jugando o jugar testando la propiedad <code>display</code>.<br />
<em class="gem">Cambiando la opci&oacute;n de los <code>&lt;select&gt;</code> cambia tambi&eacute;n el valor de la propiedad <code>display</code>.</em></p>
  <div class="container" id="c7">
    
    <div class="block" id="b7">
      <div class="group" id="b7g1">
        <div class="alone" id="b7g1a1">
        </div>
        <div class="alone" id="b7g1a2">
        </div>
    </div>
      <div class="group" id="b7g2">
        <div class="alone" id="b7g2a1">
        </div>
        <div class="alone" id="b7g2a2">
        </div>
    </div>
    </div><!--<div id="b1">-->
    
    <div class="block" id="b8">
      <div class="group" id="b8g1">
        <div class="alone" id="b8g1a1">
        </div>
        <div class="alone" id="b8g1a2">
        </div>
    </div>
          
    <div class="alone" id="b8a1">
    </div>
    </div><!--<div id="b2">-->
...
<p><a href="../index.html">w3.unpo&lt;code&gt;todo.info</a> utiliza una estructura generada con <a target="_blank" href="http://foundation.zurb.com/">foundation</a></p>
  ...
  $('button').click(function() {
    $('.linear').toggleClass('hovered');
    $('.ease').toggleClass('hovered');
    $('.ease-in').toggleClass('hovered');
    $('.ease-out').toggleClass('hovered');
    $('.ease-in-out').toggleClass('hovered')
  });
  $('#display .container div').each(function(index) {
    var divId = $(this).attr('id');
    $(this).prepend('<select name="' + divId + '" id="select' + divId + '"><option value="block">block</option><option value="inline">inline</option><option value="none">none</option><option value="inline-block">inline-block</option><option value="list-item">list-item</option><option value="table">table</option><option value="table-row">table-row</option><option value="table-cell">table-cell</option></select>')
  });

  function setDisplay(id, display) {
    $('#display .container ' + id + ' option[value=' + display + ']').attr('selected', true);
    $('#display .container ' + id + ',#display .container ' + id + ' div').css('display', display)
  }
  setDisplay('#b2g1a1', 'inline');
  setDisplay('#b2g1a2', 'inline');
  setDisplay('#b3g1a2', 'none');
  setDisplay('#b4g1a1', 'inline-block');
  setDisplay('#b5', 'list-item');
  setDisplay('#b6', 'table');
  setDisplay('#b6g1', 'table-row');
  setDisplay('#b6g2', 'table-row');
  setDisplay('#b6g1a1', 'table-cell');
  setDisplay('#b6g1a2', 'table-cell');
  setDisplay('#b6g2a1', 'table-cell');
  setDisplay('#b6g2a2', 'table-cell');
  $('#display .container select').change(function() {
    $(this).parent().css('display', $(this).val())
  })
});
</script><script>
