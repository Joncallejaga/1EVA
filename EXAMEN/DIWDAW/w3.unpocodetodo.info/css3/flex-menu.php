...
<head>
  ...
  <meta name="description" content="C&oacute;mo crear un men� b�sico utilizando flexbox." />
  <meta name="keywords" content="Flexbox, cajas flexibles,men&uacute;,menu, display: flex, justify-content, flex-wrap"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Men&uacute; b&aacute;sico flexbox" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-menu.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo crear un men� b�sico utilizando flexbox." /> 
  
  <title>Men&uacute; b&aacute;sico flexbox</title>
  ...
  <link rel="canonical" href="flex-menu.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-menu.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-menu.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="flex-menu"><h2 class="page_title">Men&uacute; b&aacute;sico flexbox</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Men&uacute; b&aacute;sico flexbox&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-menu.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-menu.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-menu.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>A continuaci&oacute;n queremos crear un men&uacute; b&aacute;sico utilizando flexbox. Para que las cosas sean sencillas y claras, no voy a utilizar prefijos. Sin embargo en el <code>&lt;head&gt;</code> del documento hay una referencia hacia  <a target="_blank" class="link_to" href="https://leaverou.github.io/prefixfree/">-prefix-free</a> , una librer&iacute;a que trabaja "entre bastidores" a&ntilde;adiendo los prefijos necesarios para que el c&oacute;digo  funcione correctamente.</p><p><strong>El HTML utilizado</strong> no es nada especial: dentro de un elemento <code>&lt;nav&gt;</code> hay una lista no ordenada <code>&lt;ul&gt;</code>: el men&uacute; en s&iacute;.</p><div class="large-12 g_panel html">        <article>        <pre><code class="language-markup"><nav>  <ul>    <li><a href="flex-menu.php#">Index</a></li>    <li><a href="flex-menu.php#">Nosotros</a></li>    <li><a href="flex-menu.php#">Servicios</a></li>    <li><a href="flex-menu.php#">Cont&aacute;ctanos</a></li>  </ul></nav></code></pre>        </article></div>  <p><strong>En el CSS</strong> abordamos primero los estilos generales. Estos son tambi&eacute;n los estilos que dar&aacute;n formato al men&uacute; en los m&oacute;viles. Nada complicado como ya lo puede ver.</p><div class="large-12 g_panel css">        <article>										<pre><code class="language-css">/*primero en el m&oacute;vil (mobile first)*/nav {  padding: 1em;  font-family: font-family: Verdana, Geneva, sans-serif;  -webkit-font-smoothing: antialiased;  -moz-osx-font-smoothing: grayscale;}nav ul {  list-style: none;  padding: 0;  margin: 0;  background: #333;}nav li a {  color: white;  display: block;  text-decoration: none;  padding: .5em 1em;}nav li a:hover {  background: tomato;  color: white;}</code></pre>        </article></div> <p data-height="300" data-theme-id="11360" data-slug-hash="128a910b889d3dec5dd6ad8538d80ec7" data-default-tab="css,result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/128a910b889d3dec5dd6ad8538d80ec7/">flexbox menu #0</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script> <p>A continuaci&oacute;n van los estilos para pantallas con una anchura m&aacute;s grande de 480px: <code>@media screen and (min-width: 480px)</code> y aqu&iacute; finalmente utilizamos flexbox:<div class="large-12 g_panel css">        <article>										<pre><code class="language-css"> @media screen and (min-width: 480px) {    nav ul {      display: flex;    }  }</code></pre>        </article></div> <p data-height="200" data-theme-id="11360" data-slug-hash="2c32d9d2ac980b458fdda839f5e55470" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/2c32d9d2ac980b458fdda839f5e55470/">flexbox menu #1</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script>   ¡Y eso es todo! Pero – claro est&aacute; – lo podemos mejorar.</p><h4>&iquest;Como mejorarlo?</h4><p>En el ejemplo anterior los elementos se han alineado a la izquierda porque en flexbox este es el estilo por defecto: <code>justify-content: flex-start;</code>. Si queremos que la alineaci&oacute;n se haga a la derecha tenemos que a&ntilde;adir esta l&iacute;nea de c&oacute;digo:</p><blockquote><pre>@media screen and (min-width: 480px) {    nav ul {      display: flex;      <span class="str">justify-content: flex-end;</span>    }}</pre></blockquote><p><em class="gem">Lea m&aacute;s acerca de <a target="_blank" class="link_to" href="flex-justify-content.php">justify-content</a></em></p><p data-height="200" data-theme-id="11360" data-slug-hash="b0664d95b7e9a5fd04e4fb4bc4c7d686" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/b0664d95b7e9a5fd04e4fb4bc4c7d686/">flexbox menu #2</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><p>Si por el contrario queremos que los elementos se agrupen en el centro tenemos que a&ntilde;adir esta otra l&iacute;nea de c&oacute;digo:</p><blockquote><pre>@media screen and (min-width: 480px) {    nav ul {      display: flex;      <span class="str">justify-content: center;</span>    }  } </pre></blockquote><p data-height="200" data-theme-id="11360" data-slug-hash="59d04ba2612e84c687595d79c420eda9" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/59d04ba2612e84c687595d79c420eda9/">flexbox menu #3</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script>  <p>Y si queremos que los elementos aparezcan espaciados de forma uniforme podemos utilizar <code>justify-content:space-around;</code> o <code>justify-content:space-between;</code> </p><!--4--><p data-height="200" data-theme-id="11360" data-slug-hash="5cd0f5ee6929cafb19803915ba6a3737" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/5cd0f5ee6929cafb19803915ba6a3737/">flexbox menu #3</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><p>Hasta ahora las cosas han ido de maravilla, pero este &uacute;ltimo ejemplo tiene una cosa que no me gusta: al pasar con el rat&oacute;n por encima de los elementos del men&uacute; podemos ver que hay un mont&oacute;n de espacio entre estos elementos. Para eliminarlo necesitamos estirar estos elementos y hacerlos que ocupen todo el espacio disponible. Y flexbox nos lo pone muy f&aacute;cil.</p><p>El valor por defecto de <a class="link_to" target="_blank" href="flex-abreviado.php">flex-grow</a> es cero (0), lo que quiere decir que el elemento no puede crecer. Si todos los &iacute;tems de una caja tienen el mismo valor, por ejemplo <code>flex-grow:1;</code> quiere decir que todos los &iacute;tems tienen que crecer  en igual proporci&oacute;n, hasta ocupar todo el espacio disponible. Exactamente lo que necesitamos. Y para que las cosas queden todav&iacute;a mejor utilizamos tambi&eacute;n <code>text-align:center</code>.</p><blockquote><pre>nav li{      <span class="str">flex-grow:1;</span>      text-align:center;    }</pre></blockquote> <p>Y como que los &iacute;tems ocupan todo el espacio disponible ya no necesitamos <code>justify-content</code>.</p> <blockquote><pre>  nav ul {    display: flex;    <del>justify-content:space-around;</del>  }</pre></blockquote>    <p data-height="200" data-theme-id="11360" data-slug-hash="c7e9315e3e4be634a517811422012ade" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/c7e9315e3e4be634a517811422012ade/">flexbox menu #5</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><p>Ahora al pasar con el rat&oacute;n por encima del men&uacute; podemos ver que los elementos ocupan todo el espacio disponible. ¡Mucho mejor!</p><p>En todos estos ejemplos hemos tenido solo cuatro &iacute;tems en el men&uacute;. Pero que pasa si hay m&aacute;s elementos, tantos que ya no entran en una sola l&iacute;nea. Y esto puede pasar f&aacute;cilmente en pantallas peque&ntilde;as.</p><p>En este caso necesitamos que los elementos puedan cambiar de l&iacute;nea y para esto a&ntilde;adimos esta otra regla:<br><a href="flex-wrap.php">flex-wrap: wrap;</a></p><blockquote><pre>  nav ul {    display: flex;    <span class="str">flex-wrap:wrap;</span>  }</pre></blockquote>  <p>Por favor cambie el tama&ntilde;o de la ventana para ver el cambio de l&iacute;nea.</p><p data-height="200" data-theme-id="11360" data-slug-hash="3d9b37126a8b209a2502483e0409e27f" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/3d9b37126a8b209a2502483e0409e27f/">flexbox menu #6</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script></section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="flex-box.php">Flexbox - una introducci&oacute;n</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-direction.php">flex-direction</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-wrap.php">flex-wrap</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-items.php">align-items</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-justify-content.php">justify-content</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-content.php">align-content</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-align-self.php">align-self</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-abreviado.php">flex</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-order.php">order</a></em></li><li>- <em class="gem"><a class="link_to" href="ejemplos/flexbox-playground.html">Entender flexbox</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-modernizr.php">C&oacute;mo utilizar Modernizr</a></em></li><li>- <em class="gem">Men&uacute; b&aacute;sico flexbox</em></li><li>- <em class="gem"><a class="link_to" href="flex-tarjetas.php">Cuadricula flexbox</a></em></li><li>- <em class="gem"><a class="link_to" href="flex-maquetacion.php">Maquetaci&oacute;n flex</a></em></li></ul></article></div></div>
