...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. La chuleta con las unidades css" />
  <meta name="keywords" content="tutorial, html5, css, css3, referencia css, chuleta css, unidades css, %, em, ex, ch, rem, vw, vh, vmin, vmax,cm, mm, Q, in, pt, pc, px, deg, grad, rad. turn, s, ms"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Unidades CSS" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/unidades-css.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. La chuleta con las unidades css" /> 
  ...
  <link rel="canonical" href="unidades-css.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="unidades-css.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="unidades-css.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="unidades-css"><h2 class="page_title">Unidades CSS</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Unidades CSS&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Funidades-css.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Funidades-css.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Funidades-css.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<div class="large-12" id="chuletacss3"><h4>Unidades relativas</h4><p>Las unidades relativas especifican el valor de la longitud relativo al valor de otra longitud. Las hojas de estilo que utilizan unidades relativas pueden ser redimensionadas f&aacute;cilmente.</p><table class="cheatsheet selectors">  <thead>    <tr>      <th>Unidad</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>    </tr>    </thead>    <tbody>    <tr>      <td>%</td>      <td><code style="white-space: nowrap;">p {<br>font-size:16px;<br>line-height:150%;<br>}</code></td>      <td>El valor de una propiedad expresado en porcentajes.<br>Relativo a otro valor, normalmente un valor heredado del elemento padre.<br>Utilizados para unidades de <strong>longitud, &aacute;ngulos, tiempo, números, frecuencia</strong>.</td>    </tr>     <tr>      <td>em</td>      <td><code style="white-space: nowrap;">span {<br>display:inline-block;<br>width:5em;<br>}</code></td>      <td>Representa el tamaño de una letra <strong>"M"</strong> de la fuente del elemento.</td>    </tr>    <tr>      <td>ex</td>      <td><code style="white-space: nowrap;">span {<br>display:inline-block;<br>width:5ex;<br>}</code></td>      <td>Representa la altura de una letra <strong>"x"</strong> de la fuente del elemento.</td>    </tr>    <tr>      <td>ch</td>      <td><code style="white-space: nowrap;">span {<br>display:inline-block;<br>width:5ch;<br>}</code></td>      <td>Representa el tamaño de <strong>"0"</strong> (ZERO, U+0030) de la fuente del elemento.</td>    </tr>    <tr>      <td>rem</td><td><code style="white-space: nowrap;">h1 {<br>font-size:2rem;<br>}</code></td>      <td>Representa el tamaño de fuente del elemento raiz. ( En el HTML el tamaño de fuente del elemento &lt;html&gt; )</td>    </tr>    <tr>      <td>vw</td>      <td><code style="white-space: nowrap;">div {<br>width:50vw;<br>}</code></td>      <td>Represemta el 1% de la anchura del viewport</td>    </tr>    <tr>      <td>vh</td>      <td><code style="white-space: nowrap;">div {<br>height:50vh;<br>}</code></td>      <td>Represemta el 1% de la altura del viewport</td>    </tr>    <tr>      <td>vmin</td><td><code style="white-space: nowrap;">div {<br>width:50vmin;<br>}</code>      <td>Representa el menor entre <code>vw</code> y <code>vh</code></td>    </tr>    <tr>      <td>vmax</td><td><code style="white-space: nowrap;">div {<br>width:50vmax;<br>}</code>      <td>Representa el mayor entre <code>vw</code> y <code>vh</code></td>    </tr></tbody></table><h4>Unidades absolutas</h4><p>Las unidades absolutas son fijas en relaci&oacute;n con otras. Estas medidas son dadas en unidades f&iacute;sicas conocidas como cent&iacute;metros, mil&iacute;metros  pulgadas,  o pixeles , y pueden ser muy útiles en diseños de p&aacute;gina con dimensiones fijas.</p><table class="cheatsheet selectors">  <thead>    <tr>      <th>Unidad</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>    </tr>    </thead>    <tbody>    <tr>      <td>cm</td>      <td><code>h2{line-height:3cm;}</code></td>      <td>1 cm = 96 px/2.54<br>      1 cm = 37.79528 px</td>    </tr>    <tr>      <td>mm</td>      <td><code>h3{word-spacing:4mm;}</code></td>      <td>1mm = 1/10 cm<br>      1 mm = 3.779528 px</td>    </tr>    <tr>      <td>Q</td>      <td><code>h3{letter-spacing:1Q;}</code></td>      <td>un cuarto de mil&iacute;metro<br>      1 Q = 1/40 cm<br>      1 Q =  0.94 px</td>    </tr>    <tr>      <td>in</td>      <td><code>h1{margin: 0.5in;}</code></td>      <td>      1 pulgada = 2.54cm<br>      1 pulgada = 96px o<br>      1 pulgada = 72pt      </td>    </tr>    <tr>      <td>pc</td>      <td><code>h4{font-size:1pc;}</code></td>      <td>El <strong>c&iacute;cero</strong> o <strong>pica</strong> es una unidad de medida tipogr&aacute;fica de aproximativamente 1/6 pulgadas<br>      1 pc = 16 px</td>    </tr>    <tr>      <td>pt</td>      <td><code>h4{font-size:12pt;}</code></td>      <td>1pt = 1/72 in<br>      1 pt = 1.333333 px</td>    </tr>    <tr>      <td>px</td>      <td><code>p  { font-size: 12px </code>}</td>      <td>P&iacute;xeles</td>    </tr></tbody></table><h4>Unidades para &aacute;ngulos</h4><p>Utilizadas para crear gradientes o para trasformaciones CSS (rotate).</p><table class="cheatsheet selectors">  <thead>    <tr>      <th>Unidad</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>    </tr>    </thead>    <tbody>    <tr>      <td>deg</td>      <td><code>.giro{transform: rotate(-90deg);}</code></td>      <td>Grado sexagesimal. Hay 360 grados en un circulo completo.</td>    </tr>    <tr>      <td>grad</td>      <td><code>.giro{transform: rotate(-100grad);}</code></td>      <td>Grado centesimal o gon, tambi&eacute;n llamado gradi&aacute;n. Hay 400 gradianes en un circulo completo.</td>    </tr>    <tr>      <td>rad</td>      <td><code>.giro{transform: rotate(-1.57rad);}</code></td>      <td>Radi&aacute;n. Hay <code>2*Math.PI</code> radianes en un circulo completo.</td>    </tr>    <tr>      <td>turn</td>      <td><code>.giro{transform: rotate(-.25turn);}</code></td>      <td>Un giro completo de 360deg</td>    </tr>    </tbody></table><h4>Unidades de tiempo</h4><p>En CSS el tiempo se expresa en segundos ( <code>s</code> ) o milisegundos ( <code>ms</code> ), y es utilizado para crear animaciones y transiciones.</p><table class="cheatsheet selectors">  <thead>    <tr>      <th>Unidad</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>    </tr>    </thead>    <tbody>    <tr>      <td>s</td>      <td><code>div {<br>    transition-duration: .5s;<br>}</code></td>      <td>Segundo</td>    </tr>    <tr>      <td>ms</td>      <td><code>div {<br>    transition-duration: 500ms;<br>}</code></td>      <td>Milisegundo. Hay 1000 milisegundos en un segundo  </td>    </tr>   </tbody></table><!--<table class="cheatsheet selectors">  <thead>    <tr>      <th>Unidad</th>      <th>Ejemplo</th>      <th>Descripci&oacute;n</th>    </tr>    </thead>    <tbody>    <tr>      <td>Hz</td>      <td></td>      <td>Hercio</td>    </tr>    <tr>      <td>kHz</td>      <td></td>      <td>Kilohercio. Hay 1000 hercios en un kilohercio</td>    </tr>   </tbody></table> -->      </div>   </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-12 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="chuletacss3.php">Referencia CSS3</a></em></li><li>- <em class="gem"><a class="link_to" href="chuleta-selectores-css3.php">Selectores CSS</a></em></li><li>- <em class="gem">Unidades CSS</em></li><li>- <em class="gem"><a class="link_to" href="cascada.php">Cascada y especificidad</a></em></li></ul></article></div></div>
