...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como especificar los colores rgb y rgba." />
  <meta name="keywords" content="colores, color, hex, rgb, hsl, rojo, verde, azul, transparencia, alpha"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Colores rgb y rgba" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/rgb.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como especificar los colores rgb y rgba." /> 
  ...
  <link rel="canonical" href="rgb.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="rgb.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="rgb">
<h2 class="page_title">Colores rgb y rgba</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Colores rgb y rgba&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Frgb.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Frgb.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Frgb.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El CSS nos permite especificar los colores de varias maneras. 
Algunas de estas posibilidades nos permiten representar los colores como una mezcla de los tres colores b&aacute;sicos:</p>
<blockquote><p>r – red (rojo),
g – green (verde),
b – blue (azul)
</p></blockquote>
<p>De aqu&iacute; el nombre de colores RGB.
Mezclando estos tres colores en diferentes proporciones podemos obtener toda la gama de colores existentes.</p>
<blockquote><p><span class="normal">Por ejemplo:</span><br /> Si queremos un anaranjado, podemos mezclar rojo al 100% y verde  al 60%, dejando el azul en 0%</p></blockquote>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#porcentajes {
  width: 100px;
  height: 100px;
  background-color: rgb(100%, 60%, 0%);
}</code></pre>
...
<div class="large-12 g_panel resultado">
        <article>
        <div class="content-box" id="porcentajes" style="margin:30px auto;"></div>
        </article>
</div>
<p><em class="gem">M&aacute;s informaci&oacute;n sobre <a class="link_to" target="_blank" href="selectores-before-after.php">:before</a></em></p>

<p>Tambi&eacute;n podemos especificar los tres colores b&aacute;sicos como valores num&eacute;ricos entre 0 y 255. ( Esto tiene que ver con el n&uacute;mero de valores que puede ser almacenado en un byte ).
De hecho es mucho m&aacute;s com&uacute;n utilizar n&uacute;meros de 0 a 255 que porcentajes.</p>   
<blockquote><p>
<span class="normal">Por ejemplo:</span><br /> Si queremos especificar el mismo anaranjado de antes, utilizando valores num&eacute;ricos en lugar de porcentajes, as&iacute; es como tenemos que hacerlo:
<br />
100% = 255<br />
60% = (60*255)/100 = 153<br />
0% = 0<br />
color:rgb(255, 153,0);
</p></blockquote>  
...
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#numerico {
  width: 100px;
  height: 100px;
  background-color: rgb(255, 153, 0);
}</code></pre>
...
<div class="large-12 g_panel resultado">
        <article>
        <div class="content-box" id="numerico" style="margin:30px auto;"></div>
        </article>
</div>


<h4>RGBA</h4>
<p>En el css3 adem&aacute;s de los c&oacute;digos <code>rgb</code> podemos utilizar los c&oacute;digos <code>rgba</code> donde <strong>a</strong> representa el valor <code>alpha</code> ( como en <em class="gem">transparencia alpha</em> ).
...
<div class="large-12 g_panel resultado">
        <article>
        <div class="content-box" id="container">
        <div id="alpha1">#alpha1</div>
        <div id="alpha2">#alpha2</div>
        </div>
        </article>
</div>


<p><em class="gem">M&aacute;s informaci&oacute;n sobre <a class="link_to" href="transparencias.php#h4_rgba">transparencias rgba</a><br>
