...
<head>
  ...
  <meta name="description" content="Entender la declaraci&oacute;n @font-face" />
  <meta name="keywords" content="font-face, font, fuente, fuentes, eot, woff, ttf, truetype, svg, font-family"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La declaraci&oacute;n @font-face" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/font-face.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Entender la declaraci&oacute;n @font-face" /> 
  
  <title>La declaraci&oacute;n @font-face</title>
  ...
  <link rel="canonical" href="font-face.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="font-face.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="font-face.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La declaraci&oacute;n @font-face</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La declaraci&oacute;n @font-face&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ffont-face.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ffont-face.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ffont-face.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La declaraci&oacute;n <code>@font-face</code> nos permite utilizar fuentes personalizadas, como por ejemplo las que podemos importar de <em class="gem"><a class="link_to" target="_blank" href="http://www.fontsquirrel.com/">fontsquirrel.com</a></em> o de otros sitios como:
<ul class="no-bullet push-1">
  <li><em class="gem"><a class="link_to" target="_blank" href="http://www.urbanfonts.com/">www.urbanfonts.com</a></em></li>
  <li><em class="gem"><a class="link_to" target="_blank" href="http://www.dafont.com/es/">www.dafont.com/es</a></em></li>
  <li><em class="gem"><a class="link_to" target="_blank" href="http://www.fontspace.com/">www.fontspace.com</a></em></li>
  <li><em class="gem"><a class="link_to" target="_blank" href="http://www.1001freefonts.com/">www.1001freefonts.com</a> (y estos son solo unos cuantos)</em> </li>
</ul>
</p>
<p>La sintaxis utilizada es muy parecida a la de <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/media-query.php">@mediaquery</a> o de <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/animacionescss.php">@keyframes</a>. Una regla que define las fuentes a utilizar empieza con la palabra clave <code>@font-face</code>.</p>
<blockquote><pre>@font-face{
      font-family: "Fuente Encabezados Grandes";
      src: url('ruta/carpetas/fuente.woff') format('woff');
  }</pre></blockquote>
<p>La primera parte de la declaraci&oacute;n: <code>font-family: "Fuente Encabezados Grandes"</code> define el nombre de la fuente, que puede ser cualquier cosa. En este caso la llamamos "Fuente Encabezados Grandes" porque la queremos utilizar para los encabezados grandes, pero la podemos llamar como queramos. Utilizamos este nombre para establecer el tipo de fuente de los encabezados ( en este caso ):</p>
<blockquote><pre>h1{ font-family: "Fuente Encabezados Grandes", sans-serif;}</pre></blockquote>
<p>El atributo <code>src</code>, indica, como sabemos, donde se encuentra alojada la fuente.
  La ruta puede ser hacia una carpeta local o hacia una fuente externa como por ejemplo en el caso de las <a class="link_to" target="_blank"  href="http://fonts.googleapis.com/css?family=Open+Sans">fuentes de Google</a></p>
  <blockquote><pre>@font-face{
      font-family: "Fuente Encabezados Grandes";
      <span class="str">src: url('ruta/carpetas/fuente.woff')</span> format('woff');
  }</pre></blockquote>
<p>En lo que concierne el formato utilizado, en este caso utilizamos <code>woff</code> – el acr&oacute;nimo de <em class="gem">Web Open Font Format</em>, un formato desarrollado por Mozilla.</p>
<p>El <a class="link_to" target="_blank" href="http://caniuse.com/#search=woff">soporte para fuentes 'woff'</a> es muy bueno y casi bastar&iacute;a con esto, pero la declaraci&oacute;n <code>@font-face</code> soporta atributos <code>src</code> m&uacute;ltiples, y generalmente las fuentes que podemos descargar por ah&iacute; vienen en varios formatos para una mejor compatibilidad con los dem&aacute;s navegadores. As&iacute; que una declaraci&oacute;n <code>@font-face</code> puede tener este aspecto:</p>
<blockquote><pre>
@font-face{
     font-family: "Fuente Encabezados Grandes"<span class="str">;</span>
     <span class="str">src:</span> url('ruta/carpetas/fuente.eot') format('eot');
     <span class="str">src:</span> url('ruta/carpetas/fuente.eot?#iefix') format('eot')<span class="str">,</span>
          url('ruta/carpetas/fuente.woff') format('woff')<span class="str">,</span>
          url('ruta/carpetas/fuente.ttf) format('truetype')<span class="str">,</span> 
          url('ruta/carpetas/fuente.svg) format(svg);
      font-weight: normal;
      font-style:normal;
}</pre></blockquote>
<p>Veamos uno por uno los formatos utilizados:</p>
<p>El formato <code>.eot</code> ( <em class="gem"><a class="link_to" target="_blank"  href="http://caniuse.com/#feat=eot">Embedded Open Type</a></em> ) fue desarrollado por Microsoft y es el &uacute;nico formato reconocido por los navegadores de tipo IE8 y m&aacute;s antiguos.<br />
Al escribir la declaraci&oacute;n <code>@font-face</code> tenemos que hacerlo de tal manera, que cada navegador encuentre el formato que necesita.<br />
Empezamos utilizando el formato <code>.eot</code> y lo ponemos como &uacute;nico valor del atributo <code>src</code>.</p>
<blockquote><pre>src: url('ruta/carpetas/fuente.eot') format('eot');</pre></blockquote>
<p> A continuaci&oacute;n escribimos esto:</p>
<blockquote><pre>src: url('ruta/carpetas/fuente.eot<span class="str">?#iefix'</span>) format('eot'),
          url('ruta/carpetas/fuente.woff') format('woff'),
          url('ruta/carpetas/fuente.ttf) format('truetype'),
          url('ruta/carpetas/fuente.svg) format(svg);</pre></blockquote>
<p>El peque&ntilde;o par&aacute;metro URL, destacado arriba en rojo, har&aacute; que los navegadores de tipo IE antiguos ignoren el resto de la declaraci&oacute;n.
  A continuaci&oacute;n viene el formato <code>woff</code> ( <em class="gem"><a class="link_to" target="_blank"  href="http://caniuse.com/#feat=woff">Web Open Font Format</a></em> ) soportado por la mayor&iacute;a de los navegadores modernos incluso IE &gt; 8.
  Tambi&eacute;n hay los formatos <code>.ttf</code> ( <em class="gem"><a class="link_to" target="_blank"  href="http://caniuse.com/#feat=ttf">TrueType Font</a></em> ) y <code>.otf</code> ( <em class="gem"><a class="link_to" target="_blank"  href="http://caniuse.com/#feat=ttf">OpenType Font</a></em>) muy interesantes sobre todo para los tip&oacute;grafos, y el formato <code>.svg</code> ( <em class="gem">Scalabe Vector Graphics </em>) para Safari m&oacute;vil.</p>
<p>Este es tambi&eacute;n el formato recomendado por <em class="gem"><a class="link_to" target="_blank" href="http://www.fontsquirrel.com/">fontsquirrel.com</a></em>.</p>
<blockquote><pre>@font-face{
              font-family: "Fuente Encabezados Grandes"<span class="str">;</span>
              <span class="str">src:</span> url('ruta/carpetas/fuente.eot') format('eot');
              <span class="str">src:</span> url('ruta/carpetas/fuente.eot?#iefix') format('eot')<span class="str">,</span>
...
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="at-import.php">La regla-at &#64;import</a></em></li><li>- <em class="gem"><a class="link_to" href="at-namespace.php">La regla-at &#64;namespace</a></em></li><li>- <em class="gem">La declaraci&oacute;n @font-face</em></li><li>- <em class="gem"><a class="link_to" href="at-keyframes.php">La regla-at &#64;keyframes</a></em></li><li>- <em class="gem"><a class="link_to" href="media-query.php">&#64;media-query</a></em></li><li>- <em class="gem"><a class="link_to" href="supports.php">La regla-at &#64;supports</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- css-tricks: <a class="link_to" target="_blank" href="http://css-tricks.com/snippets/css/using-font-face/">Using @font-face</a><br />
- The <a class="link_to" target="_blank" href="http://tympanus.net/codrops/css_reference/font-face/">@font-face CSS at-rule</a> by Sara Soueidan<br />
- El soporte en los navegadores de <a class="link_to" target="_blank" href="http://caniuse.com/#search=font-face">@font-face</a><br /></em></p>
</article></div></div>
