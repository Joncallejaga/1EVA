...
<head>
  ...
  <meta name="description" content="El grid layout. Algunas palabras clave." />
  <meta name="keywords" content="grid,layout, fr, una fracci&oacute;n de grid, el m&eacute;todo repeat(),las palabras clave start y end, l&iacute;neas y carriles, track."/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Algunas palabras clave" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/grid-palabras-clave.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El grid layout. Algunas palabras clave." /> 
  
  <title>Algunas palabras clave</title>
  ...
  <link rel="canonical" href="grid-palabras-clave.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="grid-palabras-clave.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="grid-palabras-clave.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="grid-palabras-clave"><h2 class="page_title">Algunas palabras clave</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Algunas palabras clave&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-palabras-clave.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-palabras-clave.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgrid-palabras-clave.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4 id="fraccion">Una fracci&oacute;n de grid</h4><div class="large-12"><p>Aunque podemos utilizar cualquier otras unidades para longitud disponibles en CSS ( <code>px, %, em, rem</code> . . .etc ), es importante saber que el grid tiene una unidad especifica: <code>fr</code> que representa una fracci&oacute;n del espacio disponible dentro del contenedor grid.</p> <p>Veamos un caso muy sencillo.  Si queremos crear una estructura de 3 columnas , podemos escribir:</p><blockquote><pre>grid-template-columns:1fr 1fr 1fr;</pre></blockquote><p>En este caso cada una de las tres columnas tiene una anchura de 33.33%.<br>Si queremos que la columna central sea mas ancha podemos escribir:</p><blockquote><pre>grid-template-columns:1fr 2fr 1fr;</pre></blockquote><p>Esta vez dividimos el espacio disponible por 4 ( 1fr + 2fr + 1fr == 4fr ), y en este caso la primera y la tercera columna tendr&aacute;n una anchura de 25%, mientras que la columna central tendr&aacute; una anchura de 50%.</p><p>No es absolutamente necesario utilizar n&uacute;meros &iacute;ntegros. Tambi&eacute;n podemos usar n&uacute;meros decimales. Por ejemplo esta es una declaraci&oacute;n perfectamente v&aacute;lida, i el resultado es id&eacute;ntico al de antes:</p><blockquote><pre>grid-template-columns:<span class="str">0.5</span>fr 1fr <span class="str">0.5</span>fr;</pre></blockquote><p>Tampoco es necesario utilizar exclusivamente fracciones de grid ( <code>fr</code> ). Podemos utilizar cualquier combinaci&oacute;n de unidades de longitud, seg&uacute;n sea necesario.</p><p>En este caso:</p><blockquote><pre>grid-template-columns:<span class="str">1fr</span> 100px 10em;</pre></blockquote><p>la primera columna ocupa todo el espacio disponible dentro del contenedor grid, y es equivalente a:</p><blockquote><pre>grid-template-columns:<span class="str">calc(100% - 100px - 10em)</span> 100px 10em;</pre></blockquote><p>En este caso, tambi&eacute;n podemos utilizar la palabra clave <code>auto</code> con el mismo efecto:</p><blockquote><pre>grid-template-columns:<span class="str">auto</span> 100px 10em;</pre></blockquote></div><h4 id="metodoRepeat">El m&eacute;todo repeat()</h4><div class="large-12"><p>Para no repetirnos tanto ( <code>grid-template-rows:1fr 1fr 1fr;</code> ) podemos utilizar el  m&eacute;todo <code>repeat()</code>:</p><blockquote><pre>grid-template-columns: repeat(<span class="str">3</span>, 1fr);</pre></blockquote><p>donde el primer argumento ( <code>3</code> ) especifica cuantas veces tiene que repetirse la sucesi&oacute;n especificada por el segundo argumento ( <code>1fr</code> ).</p><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">#cuadricula {  display: grid;  /*grid-template-columns:1fr 1fr 1fr;*/  grid-template-columns: repeat(3, 1fr);  grid-gap:1em;}</code></pre></article></div><p>Tambi&eacute;n podemos repetir una sucesi&oacute;n de columnas:</p><blockquote><pre>grid-template-columns: repeat(<span class="str">3</span>, 1fr .5fr);</pre></blockquote><p>y esto es equivalente a:</p><blockquote><pre>grid-template-columns: 1fr .5fr 1fr .5fr 1fr .5fr;</pre></blockquote><p>O podemos utilizar una combinaci&oacute;n, por ejemplo algo as&iacute;:</p><blockquote><pre>grid-template-columns: repeat(3, 1fr .5fr) <span class="str">1fr</span>;</pre></blockquote><p>que es equivalente a:</p><blockquote><pre>grid-template-columns: 1fr .5fr 1fr .5fr 1fr .5fr  <span class="str">1fr</span>;</pre></blockquote></div><h4 id="maxMinContent">Las palabras clave max-content y min-content</h4><div class="large-12"><p>Si utilizamos <code>max-content</code> para definir una columna o una fila, esto quiere decir que esta tendr&aacute; el <em class="gem">tama&ntilde;o</em> ( anchura para columnas o altura para filas ) m&iacute;nimo necesario para encajar el contenido m&aacute;ximo.<br>Si utilizamos <code>min-conten</code>t, esto quiere decir el carril ( fila o columna ) tendr&aacute; el tama&ntilde;o  m&iacute;nimo necesario para que no haya overflow.</p><p data-height="400" data-theme-id="11360" data-slug-hash="ryeBBY" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="The min-content & max-content #1 (columns)" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/ryeBBY/">The min-content & max-content #1 (columns)</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>En el siguiente ejemplo la propiedad <code>grid-template-rows</code> crea una primera fila ( <em class="gem">row</em> ) que tiene una altura de 6em, y una segunda fila cuya altura depende del contenido de los &iacute;tems de esta ( <code>max-content</code> ).</p><p>Por de otra parte el contenido del div naranja es una lista cuyos elementos &lt;li&gt; pueden ser editados.</p><blockquote><pre>&lt;li contenteditable="true"&gt;</pre></blockquote><p>En el CSS los elementos li tienen <code>white-space: nowrap;</code> para prevenir los saltos de l&iacute;nea.</p><blockquote><pre>li{white-space: nowrap;}</pre></blockquote><p>Por favor edite los elementos de lista para ver <code>min-content</code> in acci&oacute;n. Empiece por el elemento de lista m&aacute;s largo.</p><p data-height="410" data-theme-id="11360" data-slug-hash="79e0dc80e344096eb81b8eb3f216cf0e" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="GRID:  min-content max-content" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/79e0dc80e344096eb81b8eb3f216cf0e/">GRID:  min-content max-content</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></div><h4 id="startEnd">Las palabras clave start y end</h4><div class="large-12"><p>Dos de las palabras clave muy utilizadas: <code>start</code> ( <em class="gem">inicio</em> ) y <code>end</code> ( <em class="gem">final</em> ) pueden crear una cierta confusi&oacute;n. Es importante saber que en idiomas como el castellano, con un sistema de escritura de izquierda a derecha <code>direction: ltr;</code> ( <em class="gem">left to right</em> ), la palabra clave <code>start</code> se refiere a la <mark>izquierda</mark> para columnas y <mark>arriba</mark> para filas. De la misma manera la palabra clave <code>end</code> se refiere a la <mark>derecha</mark> del contenedor grid para columnas y <mark>abajo</mark> para filas. </p><p data-height="510" data-theme-id="11360" data-slug-hash="ryLZPM" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="Grid keywords end, start &  text direction" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/ryLZPM/">Grid keywords end, start &amp; text direction</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script></div><h4 id="lineasycarriles">L&iacute;neas y carriles</h4><div class="large-12"><p>Cuando definimos las columnas y las filas ( <em class="gem">tracks</em> o carriles ) de un contenedor grid, autom&aacute;ticamente definimos las l&iacute;neas ( <em class="gem">lines</em> ) de este.</p><p data-height="476" data-theme-id="11360" data-slug-hash="peogjL" data-default-tab="result" data-user="enxaneta" data-embed-version="2" data-pen-title="Grid: Important Terminology ( SVG)" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/peogjL/">Grid: Important Terminology ( SVG)</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="https://production-assets.codepen.io/assets/embed/ei.js"></script><p>En idiomas como el castellano, con un sistema de escritura de izquierda a derecha ( <code>direction: ltr;</code> ) , la primera l&iacute;nea vertical coincide con el borde izquierdo del contenedor grid, y la podemos referenciar utilizando el n&uacute;mero 1. De la misma manera la primera l&iacute;nea horizontal coincide con el borde superior del contenedor grid, y de nuevo la podemos referenciar utilizando el n&uacute;mero 1.</p><p>Si no nos gusta utilizar n&uacute;meros, o, si por alguna raz&oacute;n consideramos que pueden crear confusi&oacute;n, podemos dar nombres a las l&iacute;neas utilizando esta sintaxis:</p><p>grid-template-columns: <span class="str">[col-1-a]</span> 1fr <span class="str">[col-1-z col-2-a]</span> 1fr <span class="str">[col-2-z col-3-a]</span> 1fr <span class="str">[col-3-z]</span>;</p><p>En este ejemplo la primera l&iacute;nea se llama <code>col-1-a</code>, pero la podemos referenciar tambi&eacute;n utilizando el n&uacute;mero 1. La segunda l&iacute;nea tiene dos nombres: <code>col-1-z</code> y <code>col-2-a</code> que aparecen en el c&oacute;digo separados por un espacio en blanco ( <code>[col-1-z col-2-a]</code> ). Exactamente como antes, tambi&eacute;n la podemos referenciar por el n&uacute;mero de orden, 2 en este caso.</p><p>¿Y para que necesitamos todos estos nombres? Los necesitamos al definir la posici&oacute;n y extensi&oacute;n de los &iacute;tems grid, con las propiedades <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/css3/grid.php#gArea">grid-area</a>, <code>grid-row-start</code>, <code>grid-column-start</code>,  <code>grid-row-end</code> y/o <code>grid-column-end</code>.</p></div>     </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="grid-contenedor.php">Propiedades del contenedor </a></em></li><li>- <em class="gem"><a class="link_to" href="grid-declaraciones-abreviadas.php">grid-template y grid</a></em></li><li>- <em class="gem"><a class="link_to" href="grid-items.php">Propiedades de los &iacute;tems</a></em></li><li>- <em class="gem">Algunas palabras clave</em></li></ul></article></div></div>
