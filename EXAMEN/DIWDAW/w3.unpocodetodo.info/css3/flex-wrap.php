...
<head>
  ...
  <meta name="description" content="La propiedad flex-wrap es una propiedad del contenedor flex y especifica si puede haber un cambio de l&iacute;nea ( wrap ) o no ( nowrap )." />
  <meta name="keywords" content="flexbox, flex-box, contenedor flex, caja flex,  nowrap, wrap, wrap-reverse, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="flex-wrap" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-wrap.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad flex-wrap es una propiedad del contenedor flex y especifica si puede haber un cambio de l&iacute;nea ( wrap ) o no ( nowrap )." /> 
  ...
  <link rel="canonical" href="flex-wrap.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-wrap.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-wrap.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad flex-wrap</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=flex-wrap&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-wrap.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-wrap.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-wrap.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>flex-wrap</code> es <span class="str">una propiedad del contenedor flex</span> y especifica si puede haber un cambio de l&iacute;nea ( <code>wrap</code> ) o no ( <code>nowrap</code> ). El valor por defecto es<code> nowrap.</code>
La propiedad <code>flex-wrap </code>puede tomar una de estas valores:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.contenedor { flex-wrap: nowrap | wrap | wrap-reverse; }</em>
</p>
</article>
</div>


<p><code>nowrap</code> ( el valor por defecto ): los elementos flex aparecen en una sola l&iacute;nea. En ciertas circumstancias los elementos flex aparecen redimensionados para que puedan acomodarse dentro del contenedor flex. En otras circumstancias el contenedor flex puede desbordar ( <code>overflow</code> ). </p>
<p><code>wrap</code>: indica al CSS que puede haber cambio de l&iacute;nea.  Los elementos flex aparecen colocados en varias l&iacute;neas.</p>
<p><code>wrap-reverse</code>: igual que <code>wrap</code> pero las l&iacute;neas de elementos flex aparecen ordenadas en sentido contrario.</p>
<div class="large-12 text-center"><img class="flex-img" src="images/flex-wrap-reverse.gif" width="450" height="83" alt="flex align-content" /></div>

<h4>flex-wrap: nowrap <small>(el valor por defecto)</small></h4> 
<p>Si <code>flex-wrap: nowrap</code>, no puede haber cambio de l&iacute;nea y los elementos flex aparecen en una sola l&iacute;nea. En ciertas circumstancias los elementos flex aparecen redimensionados para que puedan acomodarse dentro del contenedor flex. En otras circumstancias el contenedor flex puede desbordar ( <code>overflow</code> ).</p>
<blockquote>
<pre>
.flex-container.nowrap{
   -webkit-flex-wrap: nowrap;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container nowrap">
...
<p>Si <code>flex-wrap: wrap</code>, el CSS entiende  que puede haber un cambio de l&iacute;nea.  Los elementos flex aparecen colocados en varias l&iacute;neas, tantas como sea necesario.</p>
<blockquote>
<pre>
.flex-container.wrap{
   -webkit-flex-wrap: wrap;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container wrap">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<p>Si <code>flex-wrap: wrap-reverse</code>, el CSS entiende que puede haber un cambio de l&iacute;nea. Los elementos flex aparecen colocados en varias l&iacute;neas, pero en orden contrario.</p>
<blockquote>
<pre>
.flex-container.wrap-reverse{
   -webkit-flex-wrap: wrap-reverse;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="flex-container wrap-reverse">
   <div class="flex-item"><p>1</p></div>
   <div class="flex-item"><p>2</p></div>
   <div class="flex-item"><p>3</p></div>
   <div class="flex-item"><p>4</p></div>
...
<h4 id="flexFlow">La propiedad flex-flow</h4>
<p>La propiedad <code>flex-flow</code> es <span class="str">una propiedad del contenedor flex</span>.</p>
<p>Para que podamos escribir menos c&oacute;digo, el CSS nos permite abreviar las dos propiedades: <a class="link_to" target="_blank" href="flex-direction.php">flex-direction</a> y <code>flex-wrap</code> ( opcional ) en una sola: <code>flex-flow</code>. El valor por defecto es <code>row nowrap</code>.</p>
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#flex-wrap-property">Flex Line Wrapping: the flex-wrap property</a><br />
