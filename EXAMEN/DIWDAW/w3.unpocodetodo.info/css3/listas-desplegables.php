...
<head>
  ...
  <meta name="description" content="Podemos construir listas desplegables con solo unas cuantas l&iacute;neas de CSS y sin JavaScript. El selector :checked es muy &uacute;til en este caso." />
  <meta name="keywords" content="tutorial, html5, css, css3, pseudoelemento, before, checked,listas, desplegables"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Listas desplegables" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/listas-desplegables.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Podemos construir listas desplegables con solo unas cuantas l&iacute;neas de CSS y sin JavaScript. El selector :checked es muy &uacute;til en este caso." /> 
  ...
  <link rel="canonical" href="listas-desplegables.php"> 
 
  <style>#menu{ width: 100px; margin: 20px auto;font-size:14px!important;}
#menu label{font-size:14px!important;}
...
#menu input:checked ~ ul{display:block;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="listas-desplegables.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="listas-desplegables.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="listas-desplegables">
<h2 class="page_title">Listas desplegables</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Listas desplegables&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flistas-desplegables.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flistas-desplegables.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flistas-desplegables.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Podemos construir listas desplegables con solo unas cuantas líneas de CSS y sin JavaScript. Especialmente el selector <a class="link_to" target="_blank" href="selector-checked.php">:checked</a> es muy útil en este caso. </p>
<h4>En el HTML</h4>
<p>En el HTML construimos una serie de listas anidadas.  Primero habrá una lista <code>&lt;ul class="menu"&gt;</code>. Todas las listas anidadas  dentro llevan la clase <code>"interior"</code>.  Los elementos <code>&lt;li&gt;</code> que llevan una lista <code>&lt;ul class="interior"&gt;</code> anidada tienen esta estructura:</p>


<blockquote><pre>
&lt;li&gt;&lt;input type="checkbox" name="list" id=<span class="str">"Id"</span>/&gt;&lt;label for=<span class="str">"Id"</span>&gt;Nivel 2&lt;/label&gt;
    &lt;ul class="interior"&gt;
        . . . . . 
    &lt;/ul&gt;
&lt;/li&gt;
...
<p>El <code>&lt;input type="checkbox"&gt;</code> tiene asignado un <code>id="Id"</code> ( muy importante ). El atributo <code>for</code> de la etiqueta <code>&lt;label&gt;</code> tiene como valor  el mismo <code>"Id"</code>.</p>
...
<ul id="menu">
   ...
   <ul class="interior">
         <li><input type="checkbox" name="list" id="nivel2-1" /><label for="nivel2-1">Nivel 2</label>
           <ul class="interior">
             <li><a href="listas-desplegables.php#r">Nivel 3</a></li>
             <li><a href="listas-desplegables.php#r">Nivel 3</a></li>
            </ul>
         </li>
         ...
         <li><a href="listas-desplegables.php#r">Nivel 2</a></li>
      </ul>
   </li>
   ...
   <li><a href="listas-desplegables.php#r">Nivel 1</a></li>
</ul>
</code></pre>
        </article>
</div> 
<h4>En el CSS</h4>
<p>En el CSS las dos líneas de código que más interesan son:</p>

<blockquote><pre>
.interior{ display:none; } <span class="com">/* oculta las listas anidadas */</span>
input:checked <strong class="str">~</strong> ul{display:block;}
</pre></blockquote>

<p>La tilde <code>~</code>  selecciona cada <code>&lt;ul&gt;</code> precedido por un <code>&lt;input type="checkbox"&gt;</code> marcado ( <em class="gem">checked</em> ). O sea: al marcar la casilla de verificación la lista anidada cambia de <code>display:none;</code> a <code>display:block;</code> de oculta a visible.</p>
...
#menu input:checked ~ label:before{ content:"\025be";}
#menu .interior{display: none;}
#menu input:checked ~ ul{display:block;}</code></pre>								
        </article>
</div>

<div class="large-12 g_panel resultado" id="r">
        <article>
...
<p><em class="gem">
- El selector <a class="link_to"target="_blank" href="selector-checked.php">:checked</a></em></p>
</article></div></div>
