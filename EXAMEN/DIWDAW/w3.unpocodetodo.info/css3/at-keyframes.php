...
<head>
  ...
  <meta name="description" content="La regla-at &#64;keyframes se utiliza para definir una secuencia de fotogramas de una animaci&oacute;n CSS." />
  <meta name="keywords" content="regla-at, at-rule,CSS, palabras clave, from, to"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="La regla-at &#64;keyframes" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/at-keyframes.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La regla-at &#64;keyframes se utiliza para definir una secuencia de fotogramas de una animaci&oacute;n CSS." /> 
  
  <title>La regla-at &#64;keyframes</title>
  ...
  <link rel="canonical" href="at-keyframes.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="at-keyframes.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="at-keyframes.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="at-keyframes"><h2 class="page_title">La regla-at &#64;keyframes</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=La regla-at &#64;keyframes&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-keyframes.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-keyframes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fat-keyframes.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La regla-at <code>@keyframes</code> se utiliza para definir una secuencia de fotogramas de una animaci&oacute;n CSS.</p><h4>La sintaxis</h4><p>Como las dem&aacute;s reglas-at, <code>@keyframes</code> es un bloque de c&oacute;digo que empieza con la palabra clave <code>@keyframes</code> seguida por el nombre de la animaci&oacute;n. A continuaci&oacute;n entre llaves <code>{}</code> aparecen todas las reglas CSS que definen una secuencia de fotogramas.</p><blockquote><pre>@keyframes nombreAnimacion {           <span class="com">/*las reglas para nombreAnimacion */</span>}</pre></blockquote><p>Veamos un caso pr&aacute;ctico: una animaci&oacute;n donde el color de fondo de un elemento HTML cambiar&aacute; de rojo ( <code>#f00</code> ) a rojo oscuro <code>(#e00</code> ). La animaci&oacute;n cuenta con dos fotogramas: al principio ( <code>0%</code> ) y al final ( <code>100%</code> ).</p><blockquote><pre>@keyframes cambiarColor {          <code>0%</code>   { background-color: #f00;}          <code>100%</code> { background-color: #e00;}  }</pre></blockquote><p><strong>¡Ojo!:</strong> los selectores de las fotogramas <code>0%</code> y <code>100%</code> son porcentajes y tienen que llevar el s&iacute;mbolo %. Tambi&eacute;n podemos utilizar como selectores las palabras clave <code>from</code> ( desde ) en lugar de 0% y <code>to</code> ( hasta ) en lugar de 100%.</p><blockquote><pre>@keyframes cambiarColor {          <code>from</code> { background-color: #f00;}          <code>to</code>   { background-color: #e00;}  }</pre></blockquote><p>En el caso de que queramos que el color parpadee podemos escribir algo as&iacute;:</p><blockquote><pre>@keyframes cambiarColor {          0%   { background-color: #f00;}       25%  { background-color: #e00;}         50%  { background-color: #f00;}       75%  { background-color: #e00;}         100% { background-color: #f00;}}</pre></blockquote><p>O para evitar tanta verbosidad podemos abreviar todo este c&oacute;digo as&iacute;:</p><blockquote><pre>@keyframes cambiarColor {          0%,  50% ,  100%    { background-color: #f00;}        25%, 75%            { background-color: #e00;} }</pre></blockquote><p>Tambi&eacute;n podemos animar varias propiedades a la vez. </p><blockquote><pre>@keyframes latido {          0%,  50% ,  100%    {          color: #e00;         transform:scale(1);         }       25%, 75%            {          color: #f00;         transform:scale(1.25);         }  }</pre></blockquote><p>Es importante que las propiedades modificadas en el bloque de c&oacute;digo <code>@keyframes </code>puedan ser animadas ( <code>animatables</code> ).   De lo contrario estas reglas ser&aacute;n ignoradas. . .  con una excepci&oacute;n. </p><p>La propiedad <code>animation-timing-function</code> ( <em class="gem">funci&oacute;n de temporizador de la animaci&oacute;n</em> ) puede ser utilizada en el bloque de c&oacute;digo <code>@keyframes</code> para especificar la curva de velocidad de la animaci&oacute;n.</p><blockquote><pre>@keyframes latido {          0%,  50% ,  100%    {          color: #e00;         transform:scale(1);         <span class="str">animation-timing-function: ease-in;</span>;    }       25%, 75%            {          color: #f00;         transform:scale(1.25);         <span class="str">animation-timing-function: ease-out;</span>;    }  }</pre></blockquote><p data-height="300" data-theme-id="11360" data-slug-hash="5f6afbd648088ee969e627fd9b59e073" data-default-tab="css,result" data-user="enxaneta" data-pen-title="@keyframes latido" class="codepen">See the Pen <a href="https://codepen.io/enxaneta/pen/5f6afbd648088ee969e627fd9b59e073/">@keyframes latido</a> by Gabi (<a href="https://codepen.io/enxaneta">@enxaneta</a>) on <a href="https://codepen.io">CodePen</a>.</p><script async src="https://static.codepen.io/assets/embed/ei.js"></script><p>Actualmente las reglas-at <code>@keyframes</code> est&aacute;n <a target="_blank" class="link_to" href="https://caniuse.com/%23feat=css-animation">soportadas en todos los navegadores modernos</a>. Para soporte en los navegadores antiguos es recomendable utilizar una librer&iacute;a JavaScript externa como por ejemplo <a  target="_blank" class="link_to" href="https://leaverou.github.io/prefixfree/">prefixfree</a></p>        </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="at-import.php">La regla-at &#64;import</a></em></li><li>- <em class="gem"><a class="link_to" href="at-namespace.php">La regla-at &#64;namespace</a></em></li><li>- <em class="gem"><a class="link_to" href="font-face.php">La declaraci&oacute;n @font-face</a></em></li><li>- <em class="gem">La regla-at &#64;keyframes</em></li><li>- <em class="gem"><a class="link_to" href="media-query.php">&#64;media-query</a></em></li><li>- <em class="gem"><a class="link_to" href="supports.php">La regla-at &#64;supports</a></em></li></ul></article></div></div>

<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Enlaces &uacute;tiles</h4>
<p><em class="gem">
- Sara Soueidan: <a class="link_to" target="_blank" href="https://tympanus.net/codrops/css_reference/keyframes/">The &#64;keyframes CSS at-rule is used to define the behavior of one cycle of a CSS animation</a><br></em></p>
</article></div></div>
