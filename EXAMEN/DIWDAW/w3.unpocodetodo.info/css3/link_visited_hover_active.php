...
<head>
  ...
  <meta name="description" content="Las pseudo clases :link, :visited, :hover y :active son de las primeras pseudo clases implementadas en CSS" />
  <meta name="keywords" content="CSS, selectores, link, visited, hover, active, pseudo clases,"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content=":link, :visited, :hover y :active" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/link_visited_hover_active.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Las pseudo clases :link, :visited, :hover y :active son de las primeras pseudo clases implementadas en CSS" /> 
  
  <title>:link, :visited, :hover y :active</title>
  ...
  <link rel="canonical" href="link_visited_hover_active.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="link_visited_hover_active.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="link_visited_hover_active.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="link_visited_hover_active">
<h2 class="page_title">:link, :visited, :hover y :active</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=:link, :visited, :hover y :active&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flink_visited_hover_active.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flink_visited_hover_active.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Flink_visited_hover_active.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Las pseudo clases <code>:link</code>, <code>:visited</code>, <code>:hover</code> y <code>:active</code> son de las primeras pseudo clases implementadas en CSS.</p>


<h4>La pseudo clase :link</h4>

<p>La pseudo clase <code>:link</code> se utiliza para seleccionar y dar estilo a los enlaces que no fueron visitados. Importante: la pseudo clase <code>:link</code> selecciona solo a los elementos <code>&lt;a</code>&gt; que tienen un atributo <code>href</code>.</p>

<blockquote><pre>
  <span class="com">&lt;!-- :link selecciona este elemento --&gt;</span>
  &lt;a href="http://w3.unpocodetodo.info"&gt;unpocodetodo.info&lt;/a&gt;
  
  <span class="com">&lt;!-- :link no selecciona este elemento --&gt;</span>
  &lt;a&gt;No hay atributo hrefe&lt;/a&gt;</pre></blockquote>
  
  
<h4>La pseudo clase ::visited</h4>

<p>La pseudo clase <code>::visited</code> se utiliza para seleccionar y dar estilo a los enlaces que ya fueron visitados.</p>
...
<h4>La pseudo clase ::hover</h4>

<p>La pseudo clase <code>::hover</code> se utiliza para seleccionar y dar estilo al pasar con el rat&oacute;n por encima de un elemento, y se utiliza normalmente para enlaces <code>&lt;a&gt;</code> pero puede ser utilizada tambi&eacute;n para otros elementos.  </p>
...
<h4>La pseudo clase :active</h4>

<p>La pseudo clase <code>:active</code> especifica y selecciona un elemento activo, y se utiliza normalmente para enlaces <code>&lt;a&gt;</code> pero puede ser utilizada para otros elementos. Decimos que el elemento es activo cuando el usuario hace clic en este elemento pero antes de levantar el dedo del bot&oacute;n del rat&oacute;n: o sea en <code>"mousedown"</code>.</p>
...
<p>Cuando utilizamos la pseudo clase <code>:active</code>  para un enlace, la utilizamos junto con <code>:link</code>, <code>:visited</code>, y <code>:hover</code>.</p>
<p>Hay que tener en cuenta que un elemento puede recibir estilos de dos pseudo clases a la vez: <code>:visited</code> y <code>:active</code> o <code>:link</code> y <code>:active</code>. Para no sobreescribir los estilos, cuando utilizamos las cuatro pseudo clases mencionadas arriba, normalmente las ponemos en el siguiente orden:</p>
