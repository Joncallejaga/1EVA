...
<head>
  ...
  <meta name="description" content="El selector :not ( una pseudo-clase ) selecciona aquellos elementos que NO son representados por el argumento." />
  <meta name="keywords" content="tutorial, html5, css, css3, selector,pseudo-selector, :not, svg,audio"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="El selector :not()" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/selector-not.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="El selector :not ( una pseudo-clase ) selecciona aquellos elementos que NO son representados por el argumento." /> 
  
  <title>El selector :not()</title>
  ...
  <link rel="canonical" href="selector-not.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="selector-not.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="selector-not.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="selector-not">
<h2 class="page_title">El selector :not()</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=El selector :not()&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-not.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-not.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselector-not.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>El selector <code>:not</code> ( una pseudo-clase ) selecciona aquellos elementos que NO son representados por el argumento. 
Dicho de otra manera <code>p:not(.excepcion)</code> selecciona todos aquellos p&aacute;rrafos que NO tienen asignada la clase <code>.excepcion</code>.</p>
<h4>El argumento</h4>
<p>El argumento, o sea lo que aparece entre par&eacute;ntesis puede ser:</p>
<ul class="no-bullet">
  <li>- un elemento HTML:</li>
  <li><blockquote><pre>:not(p){. . .}</pre></blockquote></li>
  <li>- un atributo:</li>
  <li><blockquote><pre>input:not([type="range"]){. . .}</pre></blockquote></li>
  <li>- una clase:</li>
  <li><blockquote><pre>p:not(.excepcion){. . .}</pre></blockquote></li>
  <li>- un id:</li>
  <li><blockquote><pre>p:not(#destacado){. . .}</pre></blockquote></li>
  <li>- una pseudo-clase ( pero NO un pseudo-elemento como <code>:first-letter</code> o <code>:first-line</code> )</li>
  <li><blockquote><pre>p:not(:nth-child(3)){. . .}</pre></blockquote></li>
  <!--<li>- tambi&eacute;n podemos encadenar varios elementos separados por una coma ( , ):</li>
  <li><blockquote><pre>p:not(.foo, .bar){. . .}</pre></blockquote></li>-->
</ul>  
<h4>Especificidad</h4>

<p>A diferencia de otras pseudo-clases, el selector <code>:not</code> no computa a efectos de especificidad. </p>
<h4>Algunos ejemplos muy &uacute;tiles</h4>

<p>El soporte de <a class="link_to" target="_blank" href="http://w3.unpocodetodo.info/svg/introduccion.php">SVG</a> en IE9 vino con sorpresa: problemas de overflow. Para corregir este problema: </p>
<blockquote><pre>svg:not(:root){ overflow:hidden; }</pre></blockquote>
<p>Puede encontrar esta l&iacute;nea de c&oacute;digo en <a class="link_to" target="_blank" href="http://necolas.github.io/normalize.css/">normalize.css</a>, <a class="link_to" target="_blank" href="https://html5boilerplate.com/">Boilerplate</a>, <a class="link_to" target="_blank" href="http://foundation.zurb.com/">Foundation de Zurb</a>, etc. . .</p>
<p>Otra l&iacute;nea de c&oacute;digo que se ve mucho por ah&iacute; es:</p>
<blockquote><pre>audio:not([controls]) { display: none; height: 0; }</pre></blockquote>
<p>Sin esta l&iacute;nea de c&oacute;digo, en los navegadores modernos los elementos <code>&lt;audio&gt;</code> aparecen sin controladores. Tambi&eacute;n elimina el exceso de <code>height</code> en los dispositivos iOS 5</p>
<p>Vea otros ejemplos en <a class="link_to" target="_blank" href="http://codepen.io/grayghostvisuals/pen/lnkuL">Codepen.io</a></p>

<h4>El soporte en los navegadores</h4> 
<p>El soporte en los navegadores para el pseudo-selector <a class="link_to" target="_blank" href="http://caniuse.com/#feat=css-sel3">:not</a> es muy bueno.</p>        
