...
<head>
  ...
  <meta name="description" content="C&oacute;mo cabiar el aspecto de los elementos &lt;select&gt; con CSS3." />
  <meta name="keywords" content="tutorial, html5, css, css3, select, option, CSS, pseudo-elemento, after, content, s&iacute;mbolos, pointer-events"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Elementos &lt;select&gt; con estilo" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/select.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo cabiar el aspecto de los elementos &lt;select&gt; con CSS3." /> 
  
  <title>Elementos &lt;select&gt; con estilo</title>
  ...
  <link rel="canonical" href="select.php"> 
...
#select .resultado .caja {
   margin:20px auto 30px auto;
}
#select .resultado div.ejemplo{width: 250px; margin:20px auto; height:30px;}
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="select.php#"><span></span></a></li>
          </ul>
...
<article>
<section id="select">
<h2 class="page_title">Elementos &lt;select&gt; con estilo</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Elementos &lt;select&gt; con estilo&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselect.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselect.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fselect.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Para cambiar el aspecto de los elementos <code>&lt;select&gt;</code> tenemos que eliminar primero los estilos que vienen predefinidos "de fabrica".</p>
<blockquote>
  <pre>select {
     background: transparent;
     border: none;
  ...
     height: 30px;
     padding: 5px;
     <span class="str">width: 250px;</span>
  }
</pre></blockquote>
<p>En Google Chrome, los <code>&lt;select&gt;</code> enfocados ( <em class="gem">on focus</em> ) tienen una "sombra" azulada. Para eliminarla utilizamos esta regla:</p>

<blockquote><pre>
select:focus{ outline: none;}
<span class="com">/* elimina la "sombra" azulada que aparece en Google Chrome */</span></pre></blockquote>
...
<div class="ejemplo">
  <select>
    <option>La primera opci&oacute;n</option>
    <option>La segunda opci&oacute;n</option>
    <option>La tercera opci&oacute;n</option>
  </select>
</div>
        </article>
</div>    
  
<p>El bot&oacute;n  que controla la aparici&oacute;n y la desaparici&oacute;n de los <code>&lt;option&gt;</code> es imposible de cambiar. De hecho este bot&oacute;n tiene solo una funci&oacute;n est&eacute;tica, ya que podemos desplegar las opciones haciendo clic en cualquier punto del <code>&lt;select&gt;</code>.  As&iacute; que podemos taparlo y construir otro en su lugar.</p>
<p>Para taparlo ponemos el <code>&lt;select&gt;</code> dentro de una <code>.caja</code> cuya anchura <code>width</code> es m&aacute;s peque&ntilde;a que la anchura del <code>&lt;select&gt;</code>.</p>
...
<blockquote>
  ...
     border:1px solid #d9d9d9;
     height:30px;
     <span class="str">width: 230px;
     overflow: hidden;</span>
     position:relative;
  }</pre></blockquote>
  
<p>Y despu&eacute;s construimos el nuevo "bot&oacute;n" utilizando el <a class="link_to" target="_blank" href="selectores-before-after.php">pseudo-elemento ::after</a>. En este ejemplo utilizamos <code>content:"\025be";</code> que es este s&iacute;mbolo: &#9662;, pero podemos utilizar cualquier otro s&iacute;mbolo, o incluso im&aacute;genes: <code>content: url(flecha.gif);</code>.</p>
<p><em class="gem">M&aacute;s <a class="link_to" target="_blank" href="../utiles/glyphs.php">s&iacute;mbolos ASCII y Unicode</a> para utilizar en el HTML, javaScript y CSS</em></p>
<blockquote><pre>.caja::after{
     <span class="str">content:"\025be";</span>
     display:table-cell;
     text-align:center;
     padding-top:7px;
     width:30px;
  ...
     top:0;
     right:0px;
     <span class="str">pointer-events: none;</span>
  }</pre></blockquote>
...
En nuestro caso, el pseudo-elemento <code>::after</code>, que est&aacute; encima del <code>&lt;select&gt;</code>, interfiere en la funcionalidad de este y no nos deja desplegar las opciones. Para que esto no pase utilizamos <code>pointer-events: none</code>, para inhabilitar los eventos del rat&oacute;n encima del pseudo-elemento.</p>
