...
<head>
  ...
  <meta property="og:title" content="Animaciones con @keyframes" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/animacionescss.php" /> 
  ...
  <link rel="canonical" href="animacionescss.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="animacionescss.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="animacionescss.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="animacionescss">
<h2 class="page_title">Animaciones con @keyframes</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Animaciones con @keyframes&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fanimacionescss.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fanimacionescss.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fanimacionescss.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Las <a class="link_to" target="_blank" href="transitions.php">transiciones</a> son fant&aacute;sticas para animaciones sencillas. Para cosas m&aacute;s complicadas tenemos las animaciones CSS3 especificadas en el m&oacute;dulo <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-animations/">CSS Animations</a></p>
<p>Veamos un ejemplo: a continuaci&oacute;n queremos animar al elemento <code>.animable</code>. A decir la verdad ser&aacute; una animaci&oacute;n b&aacute;sica que, en solo dos fotogramas, cambiar&aacute; el color de fondo. Para esto designamos el nombre ( <code>animation-name: cambiarColor</code> ) y la duraci&oacute;n de la animaci&oacute;n ( <code>animation-duration: 5s</code> ). La tercera regla ( <code>animation-iteration-count: infinite</code> ) nos dice que la animaci&oacute;n se repite indefinidamente. </p>
<blockquote><pre>.animable {
    animation-name: cambiarColor;
    animation-duration: 5s;
    animation-iteration-count: infinite;
  }</pre></blockquote>
<p>Necesitamos utilizar prefijos para que la animaci&oacute;n funcione correctamente en varios navegadores.</p>
<blockquote><pre>.animable {
    <span class="str">-webkit-</span>animation-name: cambiarColor;
    animation-name: cambiarColor;
    <span class="str">-webkit-</span>animation-duration: 5s;
    animation-duration: 5s;
    <span class="str">-webkit-</span>animation-iteration-count: infinite;
    animation-iteration-count: infinite;
  }</pre></blockquote>
<p>Claro que si queremos ser precavidos podemos utilizar tambi&eacute;n<code> –moz-</code> y <code>–o-</code>, aunque el soporte actual de las animaciones nos permite utilizar solo <code>–webkit-</code>. Despu&eacute;s de todo, utilizamos las animaciones para mejorar la experiencia del usuario, y la falta de animaci&oacute;n no tiene que interferir con la funcionalidad.
</p><em class="gem">Vea <a class="link_to" target="_blank" href="http://caniuse.com/#feat=css-animation">el soporte de las animaciones CSS3</a> en los navegadores.</em></p>
<h4>@keyframes</h4>
<p>Ya sabemos que  una animaci&oacute;n se compone  de una secuencia de fotogramas ( <em class="gem">keyframes</em> ). Veamos c&oacute;mo definirlas en el CSS3.<br />
  La sintaxis utilizada es muy parecida a la de <code>@media-query</code> o de <code>@font-face</code>. 
  Una regla que define las fotogramas a utilizar empieza con la palabra clave <code>@keyframes</code> seguida por el nombre de la animaci&oacute;n: <code>cambiarColor</code> en este caso. A continuaci&oacute;n entre llaves <code>{}</code> aparecen las fotogramas. </p>
<blockquote><pre>@keyframes cambiarColor {   
      <span class="com">/*las fotogramas para cambiarColor */</span>
  }</pre></blockquote>
<p>Durante la animaci&oacute;n el color de fondo del elemento <code>.animable</code> cambiar&aacute; de amarillo ( <code>#ffffef</code> ) a blanco ( <code>#fff</code> ). La animaci&oacute;n cuenta con dos fotogramas: al principio ( <code>0%</code> ) y al final ( <code>100%</code> ) de los 5 segundos de duraci&oacute;n.</p>
<blockquote><pre>@keyframes cambiarColor {   
     <span class="str">0%</span>   { background-color: #ffffef;}   
     <span class="str">100%</span> { background-color: #fff;}  
  }</pre></blockquote>
<p><strong>¡Ojo!</strong>: los selectores de las fotogramas <code>0%</code> y <code>100%</code> son porcentajes y tienen que llevar el s&iacute;mbolo <code>%</code>. Tambi&eacute;n podemos utilizar como selectores las palabras clave <code>from</code> ( <em class="gem">desde</em> ) en lugar de <code>0%</code> y <code>to</code> ( <em class="gem">hasta</em> ) en lugar de <code>100%</code>.</p>
<blockquote><pre>@keyframes cambiarColor {   
     <span class="str">from</span> { background-color: #ffffef;}   
     <span class="str">to</span>   { background-color: #fff;}  
  }</pre></blockquote>
<p>Y de nuevo: necesitamos utilizar prefijos para que la animaci&oacute;n funcione correctamente en varios navegadores.</p>
<blockquote><pre>@<span class="str">-webkit-</span>keyframes cambiarColor {   
...
<div class="large-12 g_panel css">
        <article>								
		<pre><code class="language-css">.animable {
  width: 250px;
  height: 150px;
  border: 1px solid #d9d9d9;
  margin: 0 auto;
...
<h4>Otras propiedades de las animaciones CSS3</h4>
<table class="cheatsheet referencia">
  ...
  <tbody>
    <tr>
      <td>@keyframes</td>
      <td>@keyframes nombre_animacion<br />
    ...
    <tr>
      ...
      <td>Especifica como debe comportarse el elemento cuando la animaci&oacute;n esta en pausa.<br />
        Si <code>animation-fill-mode: none</code>, el elemento vuelve al punto de partida.
        Si<code> animation-fill-mode: forwards</code> el elemento se queda en el punto donde acab&oacute; la animaci&oacute;n.
      </td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td>El estado de la animaci&oacute;n. Especifica si la animaci&oacute;n est&aacute; en ejecuci&oacute;n o en pausa</td>
      </tr>
  </tbody>
</table> 
<h4>La declaraci&oacute;n abreviada</h4>
<p>La declaraci&oacute;n abreviada establece todas las propiedades de la animaci&oacute;n en una sola declaraci&oacute;n, y tiene este aspecto:</p>
<blockquote>
  <pre>animation: nombre duraci&oacute;n <a class="link_to" target="_blank" href="animacionescss1.php#a_easing">funci&oacute;n-de-temporizador</a> <a class="link_to" target="_blank" href="animacionescss1.php#a_delay">demora</a> <a class="link_to" target="_blank" href="animacionescss1.php#a_iter">n&uacute;mero-de-iteraciones</a> <a class="link_to" target="_blank" href="animacionescss1.php#a_dir">direcci&oacute;n</a> <a class="link_to" target="_blank" href="animacionescss1.php#a_fill">fill-mode</a> <a class="link_to" target="_blank" href="animacionescss1.php#a_play">estado-de-la-animaci&oacute;n</a>;</pre></blockquote>


<h4 id="yellow-fade-technique">Un caso pr&aacute;ctico</h4>
<p>Una de las m&aacute;s &uacute;tiles aplicaciones de <code>@keyframes</code> es "la t&eacute;cnica del amarillo desvaneciente" ( <a class="link_to" target="_blank" href="https://signalvnoise.com/archives/000558.php">The Yellow Fade Technique</a>  ). Se trata de una forma elegante de atraer la atenci&oacute;n del usuario hacia una cierta zona en la p&aacute;gina. Veamos c&oacute;mo.</p>
<p>Todos sabemos c&oacute;mo enlazar a un elemento con un <code>id</code> especificado dentro de una p&aacute;gina ( el atributo <code>name</code> ya no es compatible con HTML5 ).</p>
<blockquote><p>
&lt;p id="arriba"&gt;Arriba&lt;/p&gt;<br />
. . . .<br />
&lt;a <span class="str">href="#arriba"</span>&gt;Ir arriba&lt;/a&gt;
</p></blockquote>
<p>El elemento enlazado es un elemento de destino, o un elemento "target". Podemos dar formato al elemento de destino utilizando el selector <code>:target</code> de CSS3.</p>
 <blockquote><pre>
 :target {
    border: 1px solid #d9d9d9;
 ...
 <p>En el siguiente <a class="link_to" target="_blank" href="ejemplos/target-keyframes.html">ejemplo</a> utilizamos el selector <code>:target</code> para animar el fondo ( <em class="gem">background</em> ) y el borde del <code>&lt;article&gt;</code> enlazado.</p>
<p><strong>El html</strong> tiene una estructura b&aacute;sica: hay 6 enlaces <code>&lt;a&gt;</code> hacia sendos art&iacute;culos <code>&lt;article&gt;</code> situados en la p&aacute;gina. Los art&iacute;culos tienen asignados un <code>id</code> para poder ser enlazados. Al hacer clic sobre uno de los enlaces el usuario ser&aacute; dirigido hacia el articulo de destino.</p>
 <div class="g_panel html">
        <article>
        <pre><code class="language-markup">
<p><a href="animacionescss.php#articulo1">Ir a art&iacute;culo 1</a></p>
<p><a href="animacionescss.php#articulo2">Ir a art&iacute;culo 2</a></p>
<p><a href="animacionescss.php#articulo3">Ir a art&iacute;culo 3</a></p>
<p><a href="animacionescss.php#articulo4">Ir a art&iacute;culo 4</a></p>
<p><a href="animacionescss.php#articulo5">Ir a art&iacute;culo 5</a></p>
<p><a href="animacionescss.php#articulo6">Ir a art&iacute;culo 6</a></p>
<div class="articles">
<article id="articulo1">. . .</article>
<article id="articulo2">. . .</article>
<article id="articulo3">. . .</article>
<article id="articulo4">. . .</article>
<article id="articulo5">. . .</article>
<article id="articulo6">. . .</article>
</div></code></pre>
        </article>
</div>

<p><strong>En el CSS</strong> utilizamos el selector <code>:target</code> para cambiar el color de fondo del <code>&lt;article&gt;</code> enlazado a amarillo ( <code>#ffffef</code> ). Utilizando <code>@keyframe</code> hacemos que el color desvanezca en una animaci&oacute;n que dura 2 segundos. La propiedad <code>animation-timing-function</code> especifica la curva de velocidad de la animaci&oacute;n a trav&eacute;s de una funci&oacute;n de temporizaci&oacute;n ( en este caso <code>ease-out</code> ).</p>
<p><em class="gem">Lea m&aacute;s acerca de <a class="link_to" target="_blank" href="animacionescss1.php#a_easing">funciones de temporizaci&oacute;n</a>.</em></p>
<div class="large-12 g_panel css">
        <article>								
...
article:target{
  ...
  animation-timing-function: <span class="str">ease-out</span>;
}
...
<!--<blockquote><pre>
article<span class="str">:target</span>{
  -webkit-animation-name: articleTarget; 
  animation-name: articleTarget;
...
-->
<p><strong>DEMO</strong>: <em class="gem">La t&eacute;cnica del amarillo desvaneciente - <a class="link_to" target="_blank" href="ejemplos/target-keyframes.html"> un ejemplo pr&aacute;ctico</a></em></p>
