...
<head>
  ...
  <meta property="og:title" content="Gradientes radiales" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/gradientes-radiales.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="C&oacute;mo generar gradientes lineales con CSS3." /> 
  
  <title>Gradientes radiales</title>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="gradientes-radiales.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="gradientes-radiales.php#top">&#8682;</a></b>
</div>
...
<div class="large-12 g_panel"><article><section id="gradientes-radiales"><h2 class="page_title">Gradientes radiales</h2><svg style="display:none">
<defs>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Gradientes radiales&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgradientes-radiales.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgradientes-radiales.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fgradientes-radiales.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Si en el caso de los gradientes lineales, la transici&oacute;n del color pasa a lo largo de una l&iacute;nea ( la direcci&oacute;n del degradado ), en el caso de los gradientes radiales, estos emergen del centro de un circulo o una elipse, y se propagan hacia la periferia esta.<br />Exactamente como en el caso de <a class="link_to" target="_blank" href="gradientes-lineales.php">los gradientes lineales</a> la sintaxis cambi&oacute;, y es importante entender c&oacute;mo.</p><p><strong>La sintaxis antigua</strong> va siempre con prefijos: <code>-webkit-</code> ( Chrome10+, Safari5.1+ )</p><div class="g_panel sintaxis"><article><h6 hidden="">undefined</h6><p class="sintaxis"><em class="gem">background: -webkit-radial-gradient(<span>posici&oacute;n en x e y</span>, <span>forma</span> <span>tama&ntilde;o</span>, <span>color-stops</span>);</em></p></article></div><blockquote><pre>background: -webkit-radial-gradient(60px 70px, circle farthest-side, #F06, #000);</pre></blockquote><p><strong>La nueva sintaxis</strong> va sin prefijos.</p><div class="g_panel sintaxis"><article><h6 hidden="">undefined</h6><p class="sintaxis"><em class="gem">background: radial-gradient(<span>tama&ntilde;o</span> <span>forma</span> <strong class="str">at</strong> <span>posici&oacute;n en x e y</span>, <span>color-stops</span>);</em></p></article></div><blockquote><pre>background: radial-gradient(farthest-side circle <span class="str">at</span> 60px 70px, #F06, #000);</pre></blockquote><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">.r{	background: -webkit-radial-gradient( 60px 70px, circle farthest-side, #F06, #000 );	background: radial-gradient( farthest-side circle at 60px 70px, #F06, #000 );	}</code></pre>								        </article></div><div class="large-12 g_panel resultado">        <article>        <div class="ejemplo r"></div>        </article>										</div><h5>La posici&oacute;n <small>( opcional )</small></h5><blockquote><pre>background: -webkit-radial-gradient(<span class="str">60px 70px</span>, circle farthest-side, #F06, #000);background: radial-gradient(farthest-side circle at <span class="str">60px 70px</span>, #F06, #000);</pre></blockquote><p>El par&aacute;metro destacado en rojo arriba, determina la <strong>posici&oacute;n</strong> del centro del degradado, situado, en este caso, a <code>x = 60px</code> e <code>y = 70px</code> respecto a la esquina izquierda arriba del elemento. Si declaramos solo el valor de la coordenada <code>x</code>, CSS interpreta que <code>y = 50%</code>. Si no especificamos la posici&oacute;n del centro, el degradado emerge del centro del elemento (<code>x = 50%; y = 50%</code>)</p><p>Tambi&eacute;n podemos utilizar palabras clave ( <code>left</code>, <code>right</code>, <code>top</code>, <code>bottom</code> ). En este ejemplo <code>at left bottom</code> sit&uacute;a el centro del degradado en la esquina izquierda ( <code>left</code> ) inferior ( <code>bottom</code> ) del elemento.</p><blockquote><pre>background: -webkit-radial-gradient(<span class="str">left bottom</span>, circle farthest-side , #F06, #000);background: radial-gradient(circle farthest-side <span class="str"><strong>at</strong> left bottom</span>, #F06, #000);</pre></blockquote><p data-height="490" data-theme-id="11360" data-slug-hash="8c82ce3b78a092a144e558b48beb8f79" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/8c82ce3b78a092a144e558b48beb8f79/">CSS radial-gradient posición</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h5>La forma <small>( opcional )</small></h5><p>El segundo par&aacute;metro ( tambi&eacute;n opcional ) puede ser <code>circle</code> ( circulo ) o <code>ellipse</code> ( elipse ), e indica la forma final que tendr&aacute; el gradiente. Si no especificamos la <strong>forma</strong>, o si la caja es un cuadrado, obtendremos un gradiente circular.</p><blockquote><pre>background: -webkit-radial-gradient(60px 70px, <span class="str">circle</span> farthest-side, #F06, #000);background: radial-gradient(farthest-side <span class="str">circle</span> at 60px 70px, #F06, #000);</pre></blockquote><blockquote><pre>background: -webkit-radial-gradient(60px 70px, <span class="str">ellipse</span> farthest-side, #F06, #000);background: radial-gradient(farthest-side <span class="str">ellipse</span> at 60px 70px, #F06, #000);</pre></blockquote><p data-height="525" data-theme-id="11360" data-slug-hash="ac2dcdfc120e0001ff073df85ee11753" data-default-tab="result" data-user="enxaneta" data-embed-version="2" class="codepen">See the Pen <a href="http://codepen.io/enxaneta/pen/ac2dcdfc120e0001ff073df85ee11753/">CSS radial-gradient circle-ellipse</a> by Gabi (<a href="http://codepen.io/enxaneta">@enxaneta</a>) on <a href="http://codepen.io">CodePen</a>.</p><script async src="http://assets.codepen.io/assets/embed/ei.js"></script><h5>El tama&ntilde;o <small>( opcional )</small></h5><blockquote><pre>background: -webkit-radial-gradient(60px 70px, circle <span class="str">farthest-side</span>, #F06, #000);background: radial-gradient(<span class="str">farthest-side</span> circle at 60px 70px, #F06, #000);</pre></blockquote><p>El par&aacute;metro destacado en rojo determina el tama&ntilde;o del gradiente, o sea: hasta donde se extiende. Podemos utilizar una las siguientes palabras clave ( <em class="gem">keywords</em> ):</p><p><strong>closest-side</strong> ( el lado m&aacute;s cercano ): el gradiente se extiende hasta tocar el lado m&aacute;s cercano.<br />  <strong>farthest-side</strong> ( el lado m&aacute;s alejado ): el gradiente se extiende hasta tocar el lado m&aacute;s alejado.<br />  <strong>closest-corner</strong> ( la esquina m&aacute;s cercana ): el gradiente se extiende hasta tocar la esquina m&aacute;s cercana.<br />  <strong>farthest-corner</strong> ( la esquina m&aacute;s lejana ): el gradiente se extiende hasta tocar la esquina m&aacute;s lejana.</p><p>Si no especificamos el tama&ntilde;o el gradiente se extiende por defecto hasta tocar la esquina m&aacute;s lejana ( <code>farthest-corner</code> ).</p><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">.s{	background: -webkit-radial-gradient( left bottom, circle farthest-corner, #F06, #000 );	background: radial-gradient( farthest-corner circle at left bottom,  #F06, #000 );	}</code></pre>								        </article></div><div class="large-12 g_panel resultado">        <article>        <div class="ejemplo s"></div>        </article>										</div>  <p>Probablemente algunos piensan que no puede ser! Que la esquina mas lejana es negra-negra. Pero no es as&iacute;. Si hacemos una captura de pantalla del gradiente y abrimos la imagen en Photoshop – por ejemplo - podemos observar que el color del m&aacute;s alejado pixel es <code>#070003</code>, lo que equivale a <code>hsl(334,100%,1%)</code>; Ahora cambiamos la luminosidad del color hsl de <code>1%</code> a <code>50%</code> y transformamos de nuevo a hex. El resultado: <code>#ff006e</code> es casi el mismo color que utilizamos para el gradiente.<br />Naturalmente entre capturas de pantalla Photoshop y transformaciones perdimos algunos puntos. Sin embargo esto demuestra que el color fucsia sigue all&iacute;, aunque muy oscurecido ( luminosidad 1% ).</p><p><em class="gem">Lea m&aacute;s acerca de los <a class="link_to" target="_blank" href="hsl.php">colores hsl y hsla</a></em></p><p>Tambi&eacute;n podemos <strong>indicar expl&iacute;citamente el tama&ntilde;o</strong> del gradiente ( aunque esto parece no funcionar en <code>-webkit-</code> ).Si la forma es un circulo ( <code>circle</code> ) podemos indicar el radio de este.</p><blockquote><pre><del>background: -webkit-radial-gradient(60px 70px, circle <span class="str">150px</span>, #F06, #000);</del>background: radial-gradient(<span class="str">150px</span> circle at 60px 70px, #F06, #000);</pre></blockquote><p>Si la forma es una elipse ( <code>ellipse</code> ) podemos indicar los radios <code>rx</code> y <code>ry</code> (&nbsp;<code>75px</code> y respectivamente <code>50px</code> en este caso&nbsp;).</p><blockquote><pre><del>background: -webkit-radial-gradient(60px 70px, ellipse <span class="str">75px 100px</span>, #F06, #000);</del>background: radial-gradient(<span class="str">75px 100px</span> ellipse  at 60px 70px, #F06, #000);</pre></blockquote><div class="large-12 g_panel css">        <article>        <pre><code class="language-css">.t{    background: radial-gradient(75px 100px ellipse  at 60px 70px, #F06, #000);	}</code></pre>								        </article></div><div class="large-12 g_panel resultado">        <article>        <div class="ejemplo t"></div>        </article>										</div><h5>Los color-stop</h5><p>Los <code>color-stop</code> ( similares a los color-stop de los gradientes lineales ) representan puntos a lo largo del radio del gradiente ( <em class="gem">gradient ray </em>), donde el color cambia. Habr&aacute; que tener en cuenta que el punto correspondiente a <code>0%</code> est&aacute; ubicado en el centro de la elipse. Exactamente como en el caso de los gradientes lineales, si no especificamos el porcentaje, el CSS considera que el primer <code>color-stop</code> empieza al <code>0%</code> y el &uacute;ltimo <code>color-stop</code> acaba al <code>100%</code>.</p><blockquote><pre>background: -webkit-radial-gradient(circle farthest-side, <span class="str">#F06 0%</span>, <span class="str">#000 100%</span>);background: radial-gradient( farthest-side circle <span class="str">#F06 0%</span>, <span class="str">#000 100%</span>);</pre></blockquote>      </section></article></div><!--<div class="large-12 g_panel">-->
<div class="row">
<div class="large-6 columns"><div class="large-12 g_panel no-before"><article>
<h4>Art&iacute;culos relacionados </h4>
<ul class="no-bullet"><li>- <em class="gem"><a class="link_to" href="background-clip.php">background-clip</a></em></li><li>- <em class="gem"><a class="link_to" href="bordes-transparentes.php">Bordes transparentes</a></em></li><li>- <em class="gem"><a class="link_to" href="background-origin.php">background-origin</a></em></li><li>- <em class="gem"><a class="link_to" href="background-size.php">background-size</a></em></li><li>- <em class="gem"><a class="link_to" href="background-multiple.php">Fondos m&uacute;ltiples</a></em></li><li>- <em class="gem"><a class="link_to" href="gradientes-lineales.php">Gradientes lineales</a></em></li><li>- <em class="gem">Gradientes radiales</em></li></ul></article></div></div>
...
- Otro generador online de degradados o <a href="http://www.cssmatic.com/es/gradient-generator">gradientes en CSS</a> ( cssmatic.com )<br />
