...
<head>
  ...
  <meta name="description" content="La propiedad background-size nos permite redimensionar las im&aacute;genes de fondo en CSS3." />
  <meta name="keywords" content="tutorial, html5, css, css3, background-size, contain, cover, auto, nuevo tama&ntilde;o, redimensionar, imagen"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="background-size" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/background-size.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad background-size nos permite redimensionar las im&aacute;genes de fondo en CSS3." /> 
  ...
  <link rel="canonical" href="background-size.php"> 
 
  <style>.bgsize{box-sizing: content-box; margin:0 auto;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
	background-image:url(images/flores.jpg);}#contain{background-size:contain;}#cover{background-size:cover;}#unSoloParametro{background-size:100px;}#pixeles{background-size:150px 80px;}#auto{background-size:150px auto;}</style><script>
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="background-size.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="background-size.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad background-size</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=background-size&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-size.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-size.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fbackground-size.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>La propiedad <code>background-size</code> nos permite redimensionar las im&aacute;genes de fondo. El valor de la propiedad <code>background-size</code> puede ser una palabra clave o el tama&ntilde;o de la imagen redimensionada.</p>

<h4>Palabras clave <small>( contain o cover )</small></h4>
<p>El valor de <code>background-size</code> puede ser una de estas palabras clave: <code>contain</code> o <code>cover</code>.</p>
<p>Si <code>background-size: contain</code>: la caja contiene la imagen. La imagen aparece  integralmente en la caja y es redimensionada proporcionalmente, al tama&ntilde;o m&aacute;ximo: o bien es tan alta como la caja, o es tan ancha como la caja.</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#contain{background-size:contain;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
	background-image:url(images/flores.jpg);}</code></pre>								
        </article>
</div>       
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bgsize" id="contain"></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bgsize" id="contain"></div>        </article>
</div> 
<p>Si <code>background-size: cover</code>: la imagen es redimensionada proporcionalmente y cubre toda la caja. Parte de la imagen puede no aparecer en pantalla.</p>
<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#cover{background-size:cover;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bgsize" id="cover"></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bgsize" id="cover"></div>        </article>
</div> 
<h4>Dimensiones</h4>
<p>Si no utilizamos una de estas palabras clave tenemos que indicar el tama&ntilde;o de la imagen redimensionada. En este caso la sintaxis de la propiedad <code>background-size</code>  es la siguiente:</p>

<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">background-size: tama&ntilde;oX[ tama&ntilde;oY];
</em>
</p>
</article>
</div>

<p>El segundo valor de <code>background-size</code> es opcional,  y si no est&aacute; especificado la imagen  ser&aacute; redimensionada proporcionalmente.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#unSoloParametro{background-size:100px;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bgsize" id="unSoloParametro"></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bgsize" id="unSoloParametro"></div>        </article>
</div> 

<p>Los par&aacute;metros <code>tama&ntilde;oX</code> y <code>tama&ntilde;oY</code> pueden ser valores num&eacute;ricos positivos expresados en <code>px</code>, en <code>em</code> en porcentajes ( <code>%</code> ) o en otras unidades aceptables en el CSS. Especificar los dos par&aacute;metros a la vez nos permite deformar la imagen.</p>
<div class="large-12 g_panel css">
        <article>	
        <pre><code class="language-css">#pixeles{background-size:150px 80px;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bgsize" id="pixeles"></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bgsize" id="pixeles"></div>        </article>
</div> 
<h4>La palabra clave auto</h4>
<p>Los par&aacute;metros <code>tama&ntilde;oX</code> y <code>tama&ntilde;oY</code> tambi&eacute;n pueden tomar como valor la palabra <code>auto</code>. La palabra clave <code>auto</code>: redimensiona la imagen guardando las proporciones. Si tanto el valor de  <code>tama&ntilde;oX</code> como el de <code>tama&ntilde;oY</code> son <code>auto</code>, la imagen conserva su tama&ntilde;o inicial. Este es el valor por defecto.</p>
<p>Si solo uno de los dos par&aacute;metros es <code>auto</code>,  el CSS calcula su valor por tal de  guardar las proporciones.</p>

<div class="large-12 g_panel css">
        <article>
        <pre><code class="language-css">#auto{background-size:150px auto;}
.bgsize{
	width:300px; 
	height:200px; 
	border:1px solid black;
...
<div class="large-12 g_panel html">
        <article>
        <pre><code class="language-markup"><div class="bgsize" id="auto"></div></code></pre>
        </article>
</div>

<div class="large-12 g_panel resultado">
        <article>
        <div class="bgsize" id="auto"></div>        </article>
</div> 
