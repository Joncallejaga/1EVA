...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Opacidad y transparencias" />
  <meta name="keywords" content="tutorial, html5, css, css3, opacidad, opacity, alpha, rgb, rgba, hsl, hsla"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Opacidad y transparencias" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/transparencias.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Opacidad y transparencias" /> 
  
  <title>Opacidad y transparencias</title>
  ...
  <link rel="canonical" href="transparencias.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="transparencias.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="transparencias.php#top">&#8682;</a></b>
</div>
...
<article>
<section id="transparencias">
<h2 class="page_title">Opacidad y transparencias</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Opacidad y transparencias&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransparencias.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransparencias.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Ftransparencias.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4>Opacidad  <small>( opacity )</small></h4>
<!--<div class="row"> 
<div class="large-12 columns">
<div class="g_panel sintaxis">
<article>

<p class="sintaxis"><em class="gem">opacity: <span>valor alpha</span>;</em><br />
</p>
</article>
</div>
</div>
</div>-->
<p>La propiedad <code>opacity</code> especifica la opacidad / transparencia de un elemento, y puede tener valores entre 1 ( totalmente opaco ) y 0 ( totalmente transparente ).</p>
...
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#opacidad {
  opacity: .5;
  background-color: rgb(0, 0, 0);
  height: 2em;
  width: 150px;
...
<div class="large-6 columns">
<div class="g_panel resultado">
        <article>
		<div class="img_container">
        <div id="opacidad" class="content-box">#opacidad</div>
        <img src="images/enfeinada.jpg" width="150" height="260" alt="enfeinada" class="demo" />
        </div
        ></article>
</div>
</div>
...
<p>En el ejemplo anterior no solo la caja ( <code>#opacidad</code> ) es transparente, sino tambi&eacute;n el texto dentro de la caja. 
Esto pasa porque la opacidad afecta tambi&eacute;n a los elementos hijos.<br />
Claro esta que los elementos hijos pueden tener su propia opacidad con valores entre 0 y 1, pero siempre relativo a la opacidad del padre. <br>
Por ejemplo: si la caja padre tiene una <mark>opacidad declarada</mark> de 0.5, y la caja hijo tiene tambi&eacute;n una <mark>opacidad declarada</mark> de 0.5, la <mark>opacidad real</mark> 
del hijo es de 0.5 * 0.5 = 0.25.</p>
...
<h4 id="h4_rgba">Transparencias rgba</h4>
<p>Ya sabemos que podemos especificar los colores en el css utilizando c&oacute;digos <em class="gem"><a class="link_to" href="rgb.php">rgb</a></em></p> 
<blockquote><p>background-color:rgb( 255 , 0 , 0);</p></blockquote>

<p>En el css3 adem&aacute;s de los c&oacute;digos <em class="gem"><a class="link_to" href="rgb.php">rgb</a></em> podemos utilizar los c&oacute;digos <code>rgba</code> donde <strong>a</strong> representa el valor <code>alpha</code> ( como en <em class="gem">transparencia alpha</em> ).
De hecho el par&aacute;metro <code>alpha</code> representa la opacidad y es un n&uacute;mero decimal de 0.0 ( <em class="gem">completamente transparente</em> ) a 1.0 ( <em class="gem">totalmente opaco</em> ).
</p>
...
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#alpha {
  background-color: rgba(0, 0, 0, .5);
  height: 2em;
  width: 150px;
  position: absolute;
...
<div class="g_panel resultado">
        <article>
		<div class="img_container">
		<div id="alpha" class="content-box">#alpha</div>
		<img src="images/enfeinada.jpg" width="150" height="260" alt="enfeinada" class="demo" />
 		</div>
        </article>
</div>
...
<p>Los navegadores antiguos ( IE8 ) no soportan los colores <code>rgba</code>, por lo cual es aconsejable facilitar tambi&eacute;n un color sin transparencia:</p>
...
<p>De esta manera los navegadores antiguos  utilizar&aacute;n la primera l&iacute;nea de c&oacute;digo ( que entienden ) e ignorar&aacute;n la segunda l&iacute;nea de c&oacute;digo 
( que no saben como interpretar ), mientras que los navegadores nuevos se quedar&aacute;n con la segunda l&iacute;nea de c&oacute;digo 
( seg&uacute;n las reglas del css ).</p>
<p>Tambi&eacute;n podemos utilizar los porcentajes en el <code>rgba</code>, pero alpha tiene que quedar-se como un n&uacute;mero decimal.</p>
<blockquote><p>background-color: rgba(100%,0%,0%,.8);</p></blockquote>
<p><em class="gem">M&aacute;s informaci&oacute;n sobre el soporte de<a class="link_to" target="_blank" href="http://caniuse.com/#search=rgba"> rgba</a> en los navegadores</em></p>
<h4>Transparencias hsla</h4>
<p>Tambi&eacute;n sabemos como especificar los colores en el css utilizando c&oacute;digos <em class="gem"><a class="link_to" target="_blank" href="hsl.php">hsl</a></em> </p>
<blockquote><p>background-color: hsl(0, 100%, 50%); /* rojo */</p></blockquote>
<p>Adem&aacute;s de los c&oacute;digos <em class="gem"><a class="link_to" target="_blank" href="hsl.php">hsl</a></em> podemos utilizar los c&oacute;digos <code>hsla</code> donde <strong>a</strong>, 
exactamente como en el caso de <code>rgba</code>, representa el valor <code>alpha</code>.</p>
<blockquote><p>background-color: hsl(0, 100%, 50%, .8);</p></blockquote>
