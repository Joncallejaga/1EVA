...
<head>
  ...
  <meta name="description" content="La propiedad order controla el orden en que aparecen los ítems del contenedor flex." />
  <meta name="keywords" content="flexbox, flex-box, &iacute;tems flex, order, CSS3, HTML5"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="order" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/flex-order.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="La propiedad order controla el orden en que aparecen los ítems del contenedor flex." /> 
  ...
  <link rel="canonical" href="flex-order.php"> 
     ...
     <div class="row">
        <nav class="top-bar">
          <ul class="title-area">
            ...
            <li class="toggle-topbar menu-icon"><a href="flex-order.php#"><span></span></a></li>
          </ul>
...
<div id="up">
<b><a href="flex-order.php#top">&#8682;</a></b>
</div>
...
<h2 class="page_title">La propiedad order</h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=order&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-order.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-order.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fflex-order.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<p>Por defecto los elementos flex, como todos los elementos HTML aparecen en el mismo orden que en el c&oacute;digo. En cajas flex podemos alterar este orden utilizando la propiedad <code>order</code>.</p>
<p>La propiedad <code>order</code> es <span class="str">una propiedad de los &iacute;tems</span> del contenedor flex y su valor es generalmente un n&uacute;mero entero, positivo o negativo.</p>
<div class="g_panel sintaxis">
<article>
<p class="sintaxis"><em class="gem">.item { order: n&uacute;mero | initial | inherit; }</em>
</p>
</article>
</div>
<p>El valor por defecto de <code>order</code> es 0. Todos los elementos flex con el mismo valor, aparecen en el mismo orden que en el c&oacute;digo. En el siguiente ejemplo el tercer elemento <code>.flex-item</code> tiene el orden <code>order:-1</code>, lo que hace que se desplace delante de los dem&aacute;s elementos <code>.flex-item</code> que tienen el orden <code>order: 0</code> ( el valor por defecto ).</p>
<p>Por de otra parte el primer elemento <code>.flex-item</code> tiene el orden <code>order: 1</code>, y por lo tanto aparece detr&aacute;s de los dem&aacute;s elementos.</p>
<blockquote><pre>
.flex-item:nth-of-type(3){ order:-1; background-color:yellow;}
.flex-item:nth-of-type(1){ order: 1; background-color:tomato;}
</pre></blockquote>
...
<p><strong class="str">Advertencia</strong>: el orden depende en &uacute;ltima instancia de la direcci&oacute;n de los elementos dentro del contenedor flex ( establecidaÂ  con <a class="link_to" target="_blank" href="flex-direction.php">flex-direction</a>, <a class="link_to" target="_blank" href="flex-wrap.php">flex-wrap</a> o <a  class="link_to" target="_blank" href="flex-wrap.php#flexFlow">flex-flow</a> ).<br />
  La &uacute;nica diferencia entre el siguiente ejemplo y el ejemplo anterior es le direcci&oacute;n de los elementos determinada por la propiedad <code>flex-direction</code>.</p>
<blockquote><p>.flex-container.row-reverse { flex-direction : row-reverse;}</p></blockquote>
...
- La especificaci&oacute;n w3.org: <a class="link_to" target="_blank" href="http://www.w3.org/TR/css3-flexbox/#order-property"> Display Order: the order property</a><br />
