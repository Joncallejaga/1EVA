...
<head>
  ...
  <meta name="description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como dibujar formas geometricas en el css. " />
  <meta name="keywords" content="tutorial, html5, css, css3, trucos, circulo, &oacute;valo, ovalo,  tri&aacute;ngulo, triangulo, estrella :before, :after"/>
  <meta name="author" content="enxaneta.info" />
  <meta property="og:title" content="Dibujar formas geometricas" /> 
  <meta property="og:type" content="website" /> 
  <meta property="og:image" content="http://w3.unpocodetodo.info/images/w3_og.png" /> 
  <meta property="og:url" content="http://w3.unpocodetodo.info/css3/formas-geometricas.php" /> 
  <meta property="og:site_name" content="w3.unpocodetodo.info" /> 
  <meta property="og:description" content="Material acerca de las nuevas caracter&iacute;sticas de CSS3. Como dibujar formas geometricas en el css. " /> 
  
  <title>Dibujar formas geometricas</title>
...
<h2 class="page_title">Dibujar formas geometricas <small>en el css</small></h2>
...
<a class="js-social-share" href="https://twitter.com/intent/tweet/?text=Dibujar formas geometricas&url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fformas-geometricas.php&via=w3unpocodetodo&hashtags=web,development" target="_blank">
...
<li>
<!--GOOGLE-->
<a class="js-social-share" href="https://plus.google.com/share?url=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fformas-geometricas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<li>
<!--FACEBOOK-->
<a class="js-social-share" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fw3.unpocodetodo.info%2Fcss3%2Fformas-geometricas.php" target="_blank">
<svg width="30" height="30" style="display:inline-block;">
...
<h4 id="h4_circulo">Como dibujar un circulo</h4>
<p>Para dibujar un circulo crearemos una caja cuadrada  ( <code>&lt;div id="circulo"&gt;</code> ) con un <code>border-radius</code> muy grande, algo disparatado como 1000px. 
De hecho cualquier valor <mark> &gt;= 50%</mark> tendría que funcionar.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#circulo {
  width: 150px;
  height: 150px;
  background: #8AC007;
  border-radius: 1000px;
...
<p><em class="gem">M&aacute;s informaci&oacute;n sobre: <a class="link_to" href="border-radius.php">border-radius</a></em></p> 
</div>
<div class="large-4 columns">
<div class="content-box" id="circulo" style="margin:10px auto;"></div>
</div>

</div><!--<div class="row">  circulo-->   

<h4 id="h4_ovalo">Como dibujar un &oacute;valo</h4>
<p>Para dibujar un &oacute;valo crearemos una caja rectangular  (<code>&lt;div id="ovalo"&gt;</code>) con un <code>border-radius</code> as&iacute;metrico igual con 50% de su base / 50% de su altura.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#ovalo {
  width: 200px;
  height: 100px;
  background: #8AC007;
  border-radius: 100px/50px;
...
<div class="large-4 columns">
<div class="content-box" id="ovalo" style="margin:40px auto;"></div>
</div>

</div><!--<div class="row">  ovalo-->  

<h4 id="h4_triangulo">Como dibujar un triangulo</h4>
<p>Antes de empezar a dibujar un triangulo miremos un poco la propiedad <code>border</code>. </p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#triangulo_test {
  width: 50px;
  height: 50px;
  border: 30px solid #000;
  border-bottom: 30px solid #8AC007;
...
<!--<p style="clear:both"><em class="gem">M&aacute;s informaci&oacute;n sobre: <a class="link_to" href="border-radius.php">border-radius</a></em></p> -->
</div>
<div class="large-4 columns">
<div class="content-box" id="triangulo_test" style="margin:40px auto;"></div>
</div>
</div><!--<div class="row"> triangulo test--> 
 
<p>Observamos que los bordes se juntan en bisel. Sabiendo esto, ya es muy f&aacute;cil construir un triangulo. </p>  
<div class="row"> <!--1-->
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#triangulo1 {
  width: 75px;
  height: 0px;
  border-top: 75px solid transparent;
  border-bottom: 75px solid transparent;
...
<div class="large-4 columns">
<div class="content-box" id="triangulo1" style="margin:25px 0 25px 75px;"></div>
</div>
</div><!--<div class="row"> triangulo1--> 

<div class="row"><!--2--> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#triangulo2 {
  width: 50px;
  height: 0px;
  border-top: 25px solid transparent;
  border-bottom: 25px solid transparent;
...
<div class="large-4 columns">
<div class="content-box" id="triangulo2" style="margin:75px;"></div>
</div>
</div><!--<div class="row">  triangulo2--> 
  
<div class="row"><!--3-->  
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#triangulo3 {
  width: 75px;
  height: 0px;
  border-top: 75px solid transparent;
  border-left: 75px solid #8AC007;
...
<div class="large-4 columns">
<div class="content-box" id="triangulo3" style="margin:50px 0 50px 75px;"></div>
</div>
</div><!--<div class="row">  triangulo3-->

<h4 id="h4_estrella6">Como dibujar una estrella de 6 puntas</h4>
<p>Para dibujar formas geom&eacute;tricas complejas utilizaremos los pseudoselectores <code>:before</code> y <code>:after</code> para generar formas geom&eacute;tricas adyacentes, 
que combinaremos con la de la caja principal.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#estrella6{
width:1px;
height:1px;
border-bottom:100px solid #8AC007;
border-left:55px solid transparent;
...
position:relative;
bottom:-30px/*30%*/;
left:-55px/*55%*/;}</code></pre>
        </article>
</div>
<!--<p><em class="gem">M&aacute;s informaci&oacute;n sobre <a class="link_to" target="_blank" href="http://www.w3schools.com/cssref/sel_before.asp">:before</a></em></p> -->
</div><!--<div class="large-8 columns">-->
<div class="large-4 columns">
<div class="content-box" id="estrella6" style="margin:50px auto;"></div>
</div><!--<div class="large-4 columns">-->
</div><!--<div class="row"> estrella6-->

<h4 id="h4_estrella5">Como dibujar una estrella de 5 puntas</h4>
<p>Utilizaremos de nuevo los pseudoselectores <code>:before</code> y <code>:after</code> para generar formas geom&eacute;tricas adyacentes, que combinaremos con la de la caja principal.</p>
<div class="row"> 
<div class="large-8 columns">
<div class="g_panel css">
        <article>
        <pre><code class="language-css">#estrella5{
margin:10px;	
width:1px;
height:1px;
border-bottom:140px solid red;
...
<div class="large-4 columns">
<div class="content-box" id="estrella5" style="margin:50px auto;"></div>
</div><!--<div class="large-4 columns">-->
</div><!--<div class="row"> estrella5--> 
