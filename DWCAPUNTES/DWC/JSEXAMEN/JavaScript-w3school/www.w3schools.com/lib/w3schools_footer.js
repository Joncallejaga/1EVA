...
(function () {
  ...
  for (i = 0; i < x.length; i++) {
    if (d.indexOf(x[i].href) >= 0) {
      ...
      if (x[i].parentElement.className.indexOf("ref_overview") > -1) {
       ...
       if (x[i].href == d.substr(0, d.indexOf("../../external.html?link=https://www.w3schools.com/tags/")) + "/tags/tag_" + c + ".asp") {
         x[i].className = "active";
       }
  ...
  for (i = 0; i < x.length; i++) {
    ...
    b = x[i].pathname;
    if ((x[i].parentNode.tagName == "LI" || x[i].parentNode.className.indexOf("w3-bar") > -1) && a.substr(0, a.indexOf("../../external.html?link=https://www.w3schools.com/",1)) ==  b.substr(0, b.indexOf("../../external.html?link=https://www.w3schools.com/",1))) {
      x[i].className += " active";
    }
  }
  if (window.addEventListener) { 
...
function sendErr() {
  ...
  xmlhttp.open("POST.html", "../../external.html?link=https://www.w3schools.com/err_sup.asp", true);
...
function w3CodeColorize(x, lang) {
  ...
  function getDotPos(txt, func) {
    var x, i, j, s, e, arr = [".","<", " ", ";", "(", "+", ")", "[", "]", ",", "&", ":", "{", "}", "../../external.html?link=https://www.w3schools.com/" ,"-", "*", "|", "%"];
    s = txt.indexOf(".");
    if (s > -1) {
      x = txt.substr(s + 1);
  ...
  function getNumPos(txt, func) {
    var arr = ["<br>", " ", ";", "(", "+", ")", "[", "]", ",", "&", ":", "{", "}", "../../external.html?link=https://www.w3schools.com/" ,"-", "*", "|", "%", "="], i, j, c, startpos = 0, endpos, word;
